...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_codigo_documento_cond" name="codigo_documento_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigo_documento'), this, 'codigo_documento')">
      ...
      <br><span id="id_hide_codigo_documento"  <?php echo $str_hide_codigo_documento?>><?php
      if ($codigo_documento != "")
      {
      $codigo_documento_look = substr($this->Db->qstr($codigo_documento), 1, -1); 
      $nmgp_def_dados = array(); 
