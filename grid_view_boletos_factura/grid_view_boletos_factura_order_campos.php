...
<?php
   ...
   $Ord_Cmp = new grid_view_boletos_factura_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_view_boletos_factura_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["qrboleto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['labels']["qrboleto"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['labels']["qrboleto"] : "Qrboleto";
   $tab_ger_campos['idproducto'] = "on";
   $tab_def_campos['idproducto'] = "idproducto";
   $tab_labels["idproducto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['labels']["idproducto"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['labels']["idproducto"] : "Idproducto";
   $tab_ger_campos['fecha_registro'] = "on";
   $tab_def_campos['fecha_registro'] = "fecha_registro";
   $tab_labels["fecha_registro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['labels']["fecha_registro"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['labels']["fecha_registro"] : "Fecha Registro";
   $tab_ger_campos['fecha_entrada'] = "on";
   $tab_def_campos['fecha_entrada'] = "fecha_entrada";
   $tab_labels["fecha_entrada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['labels']["fecha_entrada"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['labels']["fecha_entrada"] : "Fecha Entrada";
   $tab_ger_campos['fecha_salida'] = "on";
   $tab_def_campos['fecha_salida'] = "fecha_salida";
   $tab_labels["fecha_salida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['labels']["fecha_salida"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['labels']["fecha_salida"] : "Fecha Salida";
   $tab_ger_campos['codrfid'] = "on";
   $tab_def_campos['codrfid'] = "codrfid";
   $tab_labels["codrfid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['labels']["codrfid"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['labels']["codrfid"] : "Codrfid";
   $tab_ger_campos['factura'] = "on";
   $tab_def_campos['factura'] = "factura";
   $tab_labels["factura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['labels']["factura"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['labels']["factura"] : "Factura";
   $tab_ger_campos['cliente'] = "on";
   $tab_def_campos['cliente'] = "cliente";
   $tab_labels["cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['labels']["cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['labels']["cliente"] : "Cliente";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_view_boletos_factura_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_view_boletos_factura']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
