<?php
@session_start() ;
$_SESSION['scriptcase']['grid_view_boletos_factura']['sc_process_barr'] = true;
require_once('../grid_view_boletos_factura/index.php');
unset($_SESSION['scriptcase']['grid_view_boletos_factura']['sc_process_barr']);
$ExportCtrl = new grid_view_boletos_factura_export_control;
$ExportCtrl->Export_barr();

class grid_view_boletos_factura_export_control
{
