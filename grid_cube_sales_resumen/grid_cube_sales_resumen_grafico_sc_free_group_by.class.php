...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $prep_label    = array();
      $prep_label['fecha'] = "" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "";
      $prep_label['fecha_scgb_24'] = "" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYWEEK'] . "";
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['contr_label_graf'][$cmp_gb]) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['contr_label_graf'][$cmp_gb]))
          {
             $this->label[$x] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['contr_label_graf'][$cmp_gb];
          }
          $x++;
      }
   }
