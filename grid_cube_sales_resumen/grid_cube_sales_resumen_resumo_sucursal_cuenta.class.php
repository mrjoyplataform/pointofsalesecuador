...
class grid_cube_sales_resumen_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_cube_sales_resumen']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_cube_sales_resumen']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['contr_total_geral'] == "OK")
      {
          $this->array_total_fecha = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['arr_total']['fecha'];
          $this->array_total_sucursal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['arr_total']['sucursal'];
          $this->array_total_cuenta = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['arr_total']['cuenta'];
      }
      else
      {
          $this->array_total_fecha = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['arr_total']['fecha'] = $this->array_total_fecha;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['arr_total']['sucursal'] = $this->array_total_sucursal;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['arr_total']['cuenta'] = $this->array_total_cuenta;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['json_use_label'])
       {
          $Lab_fecha = "fecha";
       ...
       {
       $Lab_fecha = "Fecha";
       $Lab_fecha =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", $Lab_fecha);
       $Lab_sucursal = "Sucursal";
       $Lab_cuenta = "Cuenta";
       }
       $this->comp_field = array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['labels']['fecha'] = $Lab_fecha; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['labels']['sucursal'] = $Lab_sucursal; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['labels']['cuenta'] = $Lab_cuenta; 

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['labels']['cuenta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['labels']['cuenta'] = "Cuenta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['labels']['sucursal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['labels']['sucursal'] = "Sucursal"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['labels']['product_name']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['labels']['product_name'] = "Product Name"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['labels']['fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['labels']['fecha'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['labels']['valor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['labels']['valor'] = "Valor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['labels']['cantidad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['labels']['cantidad'] = "Cantidad"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['labels']['idproduct']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['labels']['idproduct'] = "Idproduct"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['labels']['fecha_scgb_24']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['labels']['fecha_scgb_24'] = "Fecha"; 
       }
       //-----
       $this->comp_field_nm = array(
           'fecha' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['summarizing_fields_order']['sucursal_cuenta']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['summarizing_fields_order']['sucursal_cuenta'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['summarizing_fields_order']['sucursal_cuenta'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['summarizing_fields_display']['sucursal_cuenta'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['summarizing_fields_display']['sucursal_cuenta'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['summarizing_fields_display']['sucursal_cuenta'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['summarizing_fields_display']['sucursal_cuenta'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['summarizing_fields_display']['sucursal_cuenta'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['summarizing_fields_display']['sucursal_cuenta'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['summarizing_fields_display']['sucursal_cuenta'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_fecha as $i_fecha => $d_fecha) {
           if (!in_array($i_fecha, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_fecha[3] ] = $d_fecha[2];
               $this->comp_label[0][ $d_fecha[3] ] = $d_fecha[2];
           }
           foreach ($this->array_total_sucursal[$i_fecha] as $i_sucursal => $d_sucursal) {
               if (!in_array($i_sucursal, $this->comp_label[1][ $d_fecha[3] ], true)) {
                   $this->comp_index[1][ $d_sucursal[3] ] = $d_sucursal[2];
                   $this->comp_label[1][ $d_fecha[3] ][ $d_sucursal[3] ] = $d_sucursal[2];
               }
               foreach ($this->array_total_cuenta[$i_fecha][$i_sucursal] as $i_cuenta => $d_cuenta) {
                   if (!in_array($i_cuenta, $this->comp_label[2][ $d_fecha[3] ][ $d_sucursal[3] ], true)) {
                       $this->comp_index[2][ $d_cuenta[3] ] = $d_cuenta[2];
                       $this->comp_label[2][ $d_fecha[3] ][ $d_sucursal[3] ][ $d_cuenta[3] ] = $d_cuenta[2];
                   }
               }
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_tabular_label'];
       ...
       foreach ($this->comp_label[0] as $i_fecha => $l_fecha) {
           ...
           foreach ($this->comp_label[1][$i_fecha] as $i_sucursal => $l_sucursal) {
               if (isset($this->array_total_sucursal[$i_fecha][$i_sucursal])) {
                   $this->comp_group[$i_fecha][$i_sucursal] = array();
               }
               foreach ($this->comp_label[2][$i_fecha][$i_sucursal] as $i_cuenta => $l_cuenta) {
                   if (isset($this->array_total_cuenta[$i_fecha][$i_sucursal][$i_cuenta])) {
                       $this->comp_group[$i_fecha][$i_sucursal][$i_cuenta] = array();
                   }
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       ...
       elseif (2 == $level) {
           $return = $this->array_total_cuenta;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_cube_sales_resumen@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           ...
           '2|1' => array(
               ...
               'field_x'  => 'cuenta',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_cuenta)),
               'label_y'  => $this->getChartText(strip_tags("Valor (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           'T|1' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_cube_sales_resumen_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_cube_sales_resumen_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
               ...
               if (isset($columns['colspan']) && 1 < $columns['colspan']) {
                   for ($i = 0; $i < $columns['colspan'] - 1; $i++) {
                       $s_class_fix_fld_idx = $fixedColumnCount + $i;
                       $nm_saida->saida("  <td" . $s_style . " class=\"" . $s_class_v . $s_class_fix_fld . $s_class_fix_fld_idx . $css . "\"" . $colspan . "" . $rowspan . ">&nbsp;</td>\r\n");
                   }
               }
           }
           $nm_saida->saida(" </tr>\r\n");
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order_start'][$iYAxysIndex])
                       {
                       ...
                       $nm_saida->saida("    &nbsp;<span class=\"sc-op-fix-col sc-op-fix-col-notfixed\" id=\"sc-fld-fix-col-{$fixedColumnCount}\"><i class=\"fas fa-thumbtack\"></i></span>\r\n");
                       $nm_saida->saida("  </td>\r\n");
                       $fixedColumnCount++;
                   }
               }
               else
               {
                   ...
                   $nm_saida->saida("   " . $apl_cab_resumo . "\r\n");
                       ...
                       $nm_saida->saida("    &nbsp;<span class=\"sc-op-fix-col sc-op-fix-col-notfixed\" id=\"sc-fld-fix-col-0\"><i class=\"fas fa-thumbtack\"></i></span>\r\n");
               $nm_saida->saida("  </td>\r\n");
               }
               $b_display = true;
           }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      {
         $this->monta_html_ini();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_cube_sales_resumen_total.class.php"); 
      }
      ...
      $this->Total   = new grid_cube_sales_resumen_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_sucursal_cuenta("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_fecha);
      ksort($this->array_total_sucursal);
      ksort($this->array_total_cuenta);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " cube_sales_resumen</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['doc_word'])
{
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['proc_mobile']) {
            $colNotFixedCssVisibility = 'visible';
            $colNotFixedHoverOpacity = '1';
        } else {
            $colNotFixedCssVisibility = 'hidden';
            $colNotFixedHoverOpacity = '1';
        }
           $nm_saida->saida("<style>\r\n");
           ...
           $nm_saida->saida("    visibility: " . $colNotFixedCssVisibility . ";\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida(".scGridSummaryLabel:hover .sc-op-fix-col-notfixed {\r\n");
           $nm_saida->saida("    opacity: " . $colNotFixedHoverOpacity . ";\r\n");
           $nm_saida->saida("    visibility: visible;\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("</style>\r\n");
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("var scFixColRes_left = 0, scFixColRes_list = [], scFixColRes_selectedFields = [];\r\n");
           $nm_saida->saida("function scFixColRes()\r\n");
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    var i;\r\n");
           $nm_saida->saida("    scFixColRes_left = 0;\r\n");
           $nm_saida->saida("    scFixColRes_list = [];\r\n");
           $nm_saida->saida("    scFixColRes_addControlColumns();\r\n");
           $nm_saida->saida("    scFixColRes_addFieldColumns();\r\n");
           $nm_saida->saida("    for (i = 0; i < scFixColRes_list.length; i++) {\r\n");
           $nm_saida->saida("        scFixColRes_fix(scFixColRes_list[i].type, scFixColRes_list[i].name);\r\n");
           $nm_saida->saida("    }\r\n");
           $nm_saida->saida("    scFixColRes_fixTop();\r\n");
           $nm_saida->saida("    scSummaryFixZindexCornerCells();\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("function scFixColRes_clear()\r\n");
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    scFixColRes_selectedFields = [];\r\n");
           $nm_saida->saida("    $(\".sc-col-fld\").css({\r\n");
           $nm_saida->saida("        \"position\": \"static\",\r\n");
           $nm_saida->saida("        \"left\": \"auto\"\r\n");
           $nm_saida->saida("    }).removeClass(\"sc-col-is-fixed\");\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("function scFixColRes_addControlColumns()\r\n");
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    scFixColRes_list.push({\"type\": \"op\", \"name\": \"seq\"});\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("function scFixColRes_addFieldColumns()\r\n");
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    var i;\r\n");
           $nm_saida->saida("    for (i = 0; i < scFixColRes_selectedFields.length; i++) {\r\n");
           $nm_saida->saida("        scFixColRes_list.push({\"type\": \"fld\", \"name\": scFixColRes_selectedFields[i]});\r\n");
           $nm_saida->saida("    }\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("function scFixColRes_fix(type, columnName)\r\n");
           $nm_saida->saida("{\r\n");
           ...
           $nm_saida->saida("            'left': scFixColRes_left,\r\n");
           $nm_saida->saida("            'z-index': 2\r\n");
           $nm_saida->saida("        }).addClass(\"sc-col-is-fixed\");\r\n");
           $nm_saida->saida("    }\r\n");
           $nm_saida->saida("    scFixColRes_left += thisWidth;\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("function scFixColRes_fixTop()\r\n");
           $nm_saida->saida("{\r\n");
           ...
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("function scFixColRes_clickColumn(columnId)\r\n");
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    var action;\r\n");
           $nm_saida->saida("    action = scFixColRes_fixColumns(columnId);\r\n");
           $nm_saida->saida("    scFixColRes_saveConfig(columnId, action);\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("function scFixColRes_fixColumns(columnId)\r\n");
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    var action;\r\n");
           $nm_saida->saida("    action = scFixColRes_setControlState(columnId);\r\n");
           $nm_saida->saida("    scFixColRes_clear();\r\n");
           $nm_saida->saida("    scFixColRes_addFixedCells();\r\n");
           $nm_saida->saida("    scFixColRes();\r\n");
           $nm_saida->saida("    return action;\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("function scFixColRes_setControlState(columnId)\r\n");
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    var i, fixColLength, action;\r\n");
           ...
           $nm_saida->saida("            $(\"#sc-fld-fix-col-\" + i).removeClass(\"sc-op-fix-col-notfixed\").addClass(\"sc-op-fix-col-fixed\");\r\n");
           $nm_saida->saida("        }\r\n");
           $nm_saida->saida("    } else {\r\n");
           $nm_saida->saida("        action = \"off\";\r\n");
           $nm_saida->saida("        fixColLength = $(\".sc-op-fix-col\").length;\r\n");
           $nm_saida->saida("        for (i = columnId; i < fixColLength; i++) {\r\n");
           $nm_saida->saida("            $(\"#sc-fld-fix-col-\" + i).removeClass(\"sc-op-fix-col-fixed\").addClass(\"sc-op-fix-col-notfixed\");\r\n");
           $nm_saida->saida("        }\r\n");
           $nm_saida->saida("    }\r\n");
           $nm_saida->saida("    return action;\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("function scFixColRes_addFixedCells()\r\n");
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    selectedFields = $(\".sc-op-fix-col.sc-op-fix-col-fixed\");\r\n");
           $nm_saida->saida("    for (i = 0; i < selectedFields.length; i++) {\r\n");
           $nm_saida->saida("        scFixColRes_selectedFields.push($(selectedFields[i]).attr(\"id\").substr(15));\r\n");
           $nm_saida->saida("    }\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("function scFixColRes_saveConfig(index, action)\r\n");
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    $.ajax({\r\n");
           ...
           $nm_saida->saida("            nmgp_opcao: \"ajax_fixed_columns_summary_save\",\r\n");
           ...
           $nm_saida->saida("    });\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("function scFixColRes_loadState()\r\n");
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    $.ajax({\r\n");
           $nm_saida->saida("        url: \"index.php\",\r\n");
           $nm_saida->saida("        dataType: \"json\",\r\n");
           ...
           $nm_saida->saida("        data: {\r\n");
           $nm_saida->saida("            script_case_init: \"" . $this->Ini->sc_page . "\",\r\n");
           $nm_saida->saida("            nmgp_opcao: \"ajax_fixed_columns_summary_load\"\r\n");
           $nm_saida->saida("        }\r\n");
           $nm_saida->saida("    }).done(function(data, textStatus, jqXHR) {\r\n");
           $nm_saida->saida("        if (typeof data.status !== undefined && \"ok\" == data.status) {\r\n");
           $nm_saida->saida("            scFixColRes_fixColumns(data.last_index);\r\n");
           $nm_saida->saida("        }\r\n");
           $nm_saida->saida("    });\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("function scFixColRes_addClickControl()\r\n");
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    $(\".sc-op-fix-col\").on(\"click\", function() {\r\n");
           $nm_saida->saida("        scFixColRes_clickColumn($(this).attr(\"id\").substr(15));\r\n");
           $nm_saida->saida("    });\r\n");
           $nm_saida->saida("}\r\n");
           $nm_saida->saida("$(function()\r\n");
           $nm_saida->saida("{\r\n");
           $nm_saida->saida("    scFixColRes();\r\n");
           $nm_saida->saida("    scFixColRes_addClickControl();\r\n");
           $nm_saida->saida("    scFixColRes_loadState();\r\n");
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_cube_sales_resumen/grid_cube_sales_resumen_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_cube_sales_resumen_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_cube_sales_resumen_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_cube_sales_resumen_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['num_css'] . '.css');
     ...
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "nm_gp_xls_conf('xlsx', 'resume', '','S');", "nm_gp_xls_conf('xlsx', 'resume', '','S');", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_cube_sales_resumen/grid_cube_sales_resumen_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_cube_sales_resumen/grid_cube_sales_resumen_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_cube_sales_resumen/grid_cube_sales_resumen_config_graf_flash.php?nome_apl=grid_cube_sales_resumen&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_cube_sales_resumen/grid_cube_sales_resumen_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_cube_sales_resumen/grid_cube_sales_resumen_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_cube_sales_resumen_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rpdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['pdf'][] = "Rpdf_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_cube_sales_resumen/grid_cube_sales_resumen_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_cube_sales_resumen&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxls_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xls'][] = "Rxls_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "nm_gp_xls_conf('xlsx', 'resume', '','S');", "nm_gp_xls_conf('xlsx', 'resume', '','S');", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xml'][] = "Rxml_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_cube_sales_resumen/grid_cube_sales_resumen_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_cube_sales_resumen']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_cube_sales_resumen']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_cube_sales_resumen_config_pivot.php?nome_apl=grid_cube_sales_resumen&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_cube_sales_resumen_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_cube_sales_resumen/grid_cube_sales_resumen_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_valor, $quebra_fecha, $quebra_sucursal, $quebra_cuenta, $quebra_fecha_orig, $quebra_sucursal_orig, $quebra_cuenta_orig)
   {
      ...
      if (!isset($this->array_total_fecha[$quebra_fecha_orig]))
      {
         ...
         $this->array_total_fecha[$quebra_fecha_orig][2] = $quebra_fecha;
         $this->array_total_fecha[$quebra_fecha_orig][3] = $quebra_fecha_orig;
      }
      else
      {
         $this->array_total_fecha[$quebra_fecha_orig][0]++;
         $this->array_total_fecha[$quebra_fecha_orig][1] = bcadd($this->array_total_fecha[$quebra_fecha_orig][1], $sum_valor, 10);
      }
      //----- Sucursal
      if (!isset($this->array_total_sucursal[$quebra_fecha_orig][$quebra_sucursal_orig]))
      {
         $this->array_total_sucursal[$quebra_fecha_orig][$quebra_sucursal_orig][0] = 1;
         $this->array_total_sucursal[$quebra_fecha_orig][$quebra_sucursal_orig][1] = $sum_valor;
         $this->array_total_sucursal[$quebra_fecha_orig][$quebra_sucursal_orig][2] = $quebra_sucursal;
         $this->array_total_sucursal[$quebra_fecha_orig][$quebra_sucursal_orig][3] = $quebra_sucursal_orig;
      }
      else
      {
         $this->array_total_sucursal[$quebra_fecha_orig][$quebra_sucursal_orig][0]++;
         $this->array_total_sucursal[$quebra_fecha_orig][$quebra_sucursal_orig][1] = bcadd($this->array_total_sucursal[$quebra_fecha_orig][$quebra_sucursal_orig][1], $sum_valor, 10);
      }
      //----- Cuenta
      if (!isset($this->array_total_cuenta[$quebra_fecha_orig][$quebra_sucursal_orig][$quebra_cuenta_orig]))
      {
         $this->array_total_cuenta[$quebra_fecha_orig][$quebra_sucursal_orig][$quebra_cuenta_orig][0] = 1;
         $this->array_total_cuenta[$quebra_fecha_orig][$quebra_sucursal_orig][$quebra_cuenta_orig][1] = $sum_valor;
         $this->array_total_cuenta[$quebra_fecha_orig][$quebra_sucursal_orig][$quebra_cuenta_orig][2] = $quebra_cuenta;
         $this->array_total_cuenta[$quebra_fecha_orig][$quebra_sucursal_orig][$quebra_cuenta_orig][3] = $quebra_cuenta_orig;
      }
      else
      {
         $this->array_total_cuenta[$quebra_fecha_orig][$quebra_sucursal_orig][$quebra_cuenta_orig][0]++;
         $this->array_total_cuenta[$quebra_fecha_orig][$quebra_sucursal_orig][$quebra_cuenta_orig][1] = bcadd($this->array_total_cuenta[$quebra_fecha_orig][$quebra_sucursal_orig][$quebra_cuenta_orig][1], $sum_valor, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $format       = $this->Ini->Get_Gb_date_format('', 'cuenta');
     $campos_order = $this->Ini->Get_date_order_groupby("cuenta", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->cuenta = $rs_res->fields[0] ;  
            $this->sucursal = $rs_res->fields[1] ;  
            $this->product_name = $rs_res->fields[2] ;  
            ...
            $this->look_cuenta = $this->cuenta; 
            $this->Lookup->lookup_cuenta($this->look_cuenta, $this->cuenta) ; 
            ...
            $this->fecha = $this->Ini->GB_date_format($TP_Time . $this->fecha, $Format_tst, $Prefix_dat, "N", "F/Y");
            $this->sucursal_orig = $this->sucursal;
            $this->cuenta_orig = $this->cuenta;
            $this->cuenta = $this->look_cuenta ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->valor, $this->fecha, $this->sucursal, $this->cuenta, $this->fecha_orig,  $this->sucursal_orig,  $this->cuenta_orig);
            }
   }
//
