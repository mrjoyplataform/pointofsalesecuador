<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cube_sales_resumen']['sc_process_barr'] = true;
require_once('../grid_cube_sales_resumen/index.php');
unset($_SESSION['scriptcase']['grid_cube_sales_resumen']['sc_process_barr']);
$ExportCtrl = new grid_cube_sales_resumen_export_control;
$ExportCtrl->Export_barr();

class grid_cube_sales_resumen_export_control
{
