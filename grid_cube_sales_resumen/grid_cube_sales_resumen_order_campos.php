...
<?php
   ...
   $Ord_Cmp = new grid_cube_sales_resumen_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_cube_sales_resumen_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['cuenta'] = "cuenta";
   $tab_labels["cuenta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['labels']["cuenta"])) ? $_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['labels']["cuenta"] : "Cuenta";
   $tab_ger_campos['sucursal'] = "on";
   $tab_def_campos['sucursal'] = "sucursal";
   $tab_labels["sucursal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['labels']["sucursal"])) ? $_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['labels']["sucursal"] : "Sucursal";
   $tab_ger_campos['product_name'] = "on";
   $tab_def_campos['product_name'] = "product_name";
   $tab_labels["product_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['labels']["product_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['labels']["product_name"] : "Product Name";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['labels']["valor"] : "Valor";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['labels']["cantidad"] : "Cantidad";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_cube_sales_resumen_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_cube_sales_resumen']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
