...
class grid_cube_sales_resumen_resumo
{
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_fecha_scgb_24 = array();
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['tot_geral'][3];
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['arr_total']['fecha_scgb_24'] = $this->array_total_fecha_scgb_24;
   ...
   function completeMatrix()
   {
       ...
       {
          $Lab_fecha = "fecha";
          $Lab_fecha_scgb_24 = "fecha_scgb_24";
       ...
       $Lab_fecha_scgb_24 = "Fecha";
       $Lab_fecha_scgb_24 =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYWEEK'] . "", $Lab_fecha_scgb_24);
       $Lab_sucursal = "Sucursal";
       $Lab_cuenta = "Cuenta";
       }
       $prep_field = array();
       ...
       $prep_field['fecha_scgb_24'] = $Lab_fecha_scgb_24;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['labels']['fecha_scgb_24'] = $Lab_fecha_scgb_24; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['fecha_scgb_24']['alin'] = "''";
       $Arr_parms['fecha_scgb_24']['link'] = "S";
       $Arr_parms['sucursal']['alin'] = "''";
       $Arr_parms['sucursal']['link'] = "S";
       $Arr_parms['cuenta']['alin'] = "''";
       $Arr_parms['cuenta']['link'] = "S";
       ...
       $Arr_parms['fecha_scgb_24']['fill'] = "true";
       $Arr_parms['fecha_scgb_24']['order'] = "value";
       $Arr_parms['fecha_scgb_24']['order_start'] = 'asc';
       $Arr_parms['fecha_scgb_24']['order_invert'] = 'false';
       $Arr_parms['fecha_scgb_24']['order_enabled'] = 'true';
       $Arr_parms['fecha_scgb_24']['order_datatype'] = 'date';
       ...
       $Arr_parms['cuenta']['fill'] = "true";
       $Arr_parms['cuenta']['order'] = "label";
       $Arr_parms['cuenta']['order_start'] = 'asc';
       $Arr_parms['cuenta']['order_invert'] = 'false';
       $Arr_parms['cuenta']['order_enabled'] = 'true';
       $Arr_parms['cuenta']['order_datatype'] = 'varchar';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       $prep_links_fl['fecha_scgb_24'] = array(0 => 'fecha_scgb_24', 1 => '@aspass@');
       $prep_links_fl['sucursal'] = array(0 => 'sucursal', 1 => '@aspass@');
       $prep_links_fl['cuenta'] = array(0 => 'cuenta', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['pivot_order_level'] = 0;
       }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fecha_scgb_24',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_fecha_scgb_24)),
               'label_y'  => $this->getChartText(strip_tags("Valor (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
...
{ 
   ...
   $nm_saida->saida("          nm_submit_modal(\"" . $this->Ini->path_link . "grid_cube_sales_resumen/grid_cube_sales_resumen_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['SC_Gb_Free_cmp']))
      {
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_valor, $sum_cantidad, $quebra_fecha, $quebra_fecha_scgb_24, $quebra_sucursal, $quebra_cuenta, $quebra_fecha_orig, $quebra_fecha_scgb_24_orig, $quebra_sucursal_orig, $quebra_cuenta_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cube_sales_resumen']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_valor . ';
              $this->' . $arr_name . '[2] = ' . $sum_cantidad . ';
          ...
          {
              $this->' . $arr_name . '[0]++;
              $this->' . $arr_name . '[1] = bcadd($this->' . $arr_name . '[1], ' . $sum_valor . ', 10);
              $this->' . $arr_name . '[2] = bcadd($this->' . $arr_name . '[2], ' . $sum_cantidad . ', 10);
          }
          ');
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->fecha_scgb_24_orig = $this->fecha_scgb_24;
            $this->sucursal_orig = $this->sucursal;
            $this->cuenta_orig = $this->cuenta;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->valor, $this->cantidad, $this->fecha, $this->fecha_scgb_24, $this->sucursal, $this->cuenta, $this->fecha_orig,  $this->fecha_scgb_24_orig,  $this->sucursal_orig,  $this->cuenta_orig);
            }
   }
//
