...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____chart_view_venta_dia"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____chart_view_venta_dia"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_view_venta_dia']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_view_venta_dia']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_view_venta_dia']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_view_venta_dia']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_view_venta_dia']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_view_venta_dia</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_view_venta_dia']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_view_venta_dia']['embutida_filho'] as $ind => $sc_init)
          {
