<?php
@session_start() ;
$_SESSION['scriptcase']['chart_view_venta_dia']['sc_process_barr'] = true;
require_once('../chart_view_venta_dia/index.php');
unset($_SESSION['scriptcase']['chart_view_venta_dia']['sc_process_barr']);
$ExportCtrl = new chart_view_venta_dia_export_control;
$ExportCtrl->Export_barr();

class chart_view_venta_dia_export_control
{
