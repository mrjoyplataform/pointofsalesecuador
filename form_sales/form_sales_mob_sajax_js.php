  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sales_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_sales
  function do_ajax_form_sales_mob_validate_id_sales()
  {
    var nomeCampo_id_sales = "id_sales";
    var var_id_sales = scAjaxGetFieldHidden(nomeCampo_id_sales);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sales_mob_validate_id_sales(var_id_sales, var_script_case_init, do_ajax_form_sales_mob_validate_id_sales_cb);
  } // do_ajax_form_sales_mob_validate_id_sales

  function do_ajax_form_sales_mob_validate_id_sales_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_sales";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sales_mob_validate_id_sales_cb

  // ---------- Validate datesales
  function do_ajax_form_sales_mob_validate_datesales()
  {
    var nomeCampo_datesales = "datesales";
    var var_datesales = scAjaxGetFieldText(nomeCampo_datesales);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sales_mob_validate_datesales(var_datesales, var_script_case_init, do_ajax_form_sales_mob_validate_datesales_cb);
  } // do_ajax_form_sales_mob_validate_datesales

  function do_ajax_form_sales_mob_validate_datesales_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "datesales";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sales_mob_validate_datesales_cb

  // ---------- Validate id_status
  function do_ajax_form_sales_mob_validate_id_status()
  {
    var nomeCampo_id_status = "id_status";
    var var_id_status = scAjaxGetFieldSelect(nomeCampo_id_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sales_mob_validate_id_status(var_id_status, var_script_case_init, do_ajax_form_sales_mob_validate_id_status_cb);
  } // do_ajax_form_sales_mob_validate_id_status

  function do_ajax_form_sales_mob_validate_id_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sales_mob_validate_id_status_cb

  // ---------- Validate sales_price
  function do_ajax_form_sales_mob_validate_sales_price()
  {
    var nomeCampo_sales_price = "sales_price";
    var var_sales_price = scAjaxGetFieldText(nomeCampo_sales_price);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sales_mob_validate_sales_price(var_sales_price, var_script_case_init, do_ajax_form_sales_mob_validate_sales_price_cb);
  } // do_ajax_form_sales_mob_validate_sales_price

  function do_ajax_form_sales_mob_validate_sales_price_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sales_price";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sales_mob_validate_sales_price_cb

  // ---------- Validate sales_discount
  function do_ajax_form_sales_mob_validate_sales_discount()
  {
    var nomeCampo_sales_discount = "sales_discount";
    var var_sales_discount = scAjaxGetFieldText(nomeCampo_sales_discount);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sales_mob_validate_sales_discount(var_sales_discount, var_script_case_init, do_ajax_form_sales_mob_validate_sales_discount_cb);
  } // do_ajax_form_sales_mob_validate_sales_discount

  function do_ajax_form_sales_mob_validate_sales_discount_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sales_discount";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sales_mob_validate_sales_discount_cb

  // ---------- Validate total
  function do_ajax_form_sales_mob_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldText(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sales_mob_validate_total(var_total, var_script_case_init, do_ajax_form_sales_mob_validate_total_cb);
  } // do_ajax_form_sales_mob_validate_total

  function do_ajax_form_sales_mob_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sales_mob_validate_total_cb

  // ---------- Validate detail
  function do_ajax_form_sales_mob_validate_detail()
  {
    var nomeCampo_detail = "detail";
    var var_detail = scAjaxGetFieldText(nomeCampo_detail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sales_mob_validate_detail(var_detail, var_script_case_init, do_ajax_form_sales_mob_validate_detail_cb);
  } // do_ajax_form_sales_mob_validate_detail

  function do_ajax_form_sales_mob_validate_detail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detail";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sales_mob_validate_detail_cb

  // ---------- Event onchange sales_discount
  function do_ajax_form_sales_mob_event_sales_discount_onchange()
  {
    var var_total = scAjaxGetFieldText("total");
    var var_sales_price = scAjaxGetFieldText("sales_price");
    var var_sales_discount = scAjaxGetFieldText("sales_discount");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sales_mob_event_sales_discount_onchange(var_total, var_sales_price, var_sales_discount, var_script_case_init, do_ajax_form_sales_mob_event_sales_discount_onchange_cb);
  } // do_ajax_form_sales_mob_event_sales_discount_onchange

  function do_ajax_form_sales_mob_event_sales_discount_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "sales_discount";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sales_mob_event_sales_discount_onchange_cb_after_alert);
  } // do_ajax_form_sales_mob_event_sales_discount_onchange_cb
  function do_ajax_form_sales_mob_event_sales_discount_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_sales_mob_event_sales_discount_onchange_cb_after_alert

  // ---------- Event onchange sales_price
  function do_ajax_form_sales_mob_event_sales_price_onchange()
  {
    var var_total = scAjaxGetFieldText("total");
    var var_sales_price = scAjaxGetFieldText("sales_price");
    var var_sales_discount = scAjaxGetFieldText("sales_discount");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sales_mob_event_sales_price_onchange(var_total, var_sales_price, var_sales_discount, var_script_case_init, do_ajax_form_sales_mob_event_sales_price_onchange_cb);
  } // do_ajax_form_sales_mob_event_sales_price_onchange

  function do_ajax_form_sales_mob_event_sales_price_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "sales_price";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sales_mob_event_sales_price_onchange_cb_after_alert);
  } // do_ajax_form_sales_mob_event_sales_price_onchange_cb
  function do_ajax_form_sales_mob_event_sales_price_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_sales_mob_event_sales_price_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sales_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sales_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_sales = scAjaxGetFieldHidden("id_sales");
    var var_datesales = scAjaxGetFieldText("datesales");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sales_mob_submit_form(var_id_sales, var_datesales, var_id_status, var_sales_price, var_sales_discount, var_total, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_sales_mob_submit_form_cb);
  } // do_ajax_form_sales_mob_submit_form

  function do_ajax_form_sales_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_sales");
      scAjaxHideErrorDisplay("datesales");
      scAjaxHideErrorDisplay("id_status");
      scAjaxHideErrorDisplay("sales_price");
      scAjaxHideErrorDisplay("sales_discount");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sales_mob_submit_form_cb_after_alert);
  } // do_ajax_form_sales_mob_submit_form_cb
  function do_ajax_form_sales_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sales_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_sales_detail_mob"] = "off";

  function do_ajax_form_sales_mob_navigate_form()
  {
    perform_ajax_form_sales_mob_navigate_form();
  }

  function perform_ajax_form_sales_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("total");
    scAjaxHideErrorDisplay("detail");
    var var_id_sales = document.F2.id_sales.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_sales_detail_mob"] = "on";
    x_ajax_form_sales_mob_navigate_form(var_id_sales, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sales_mob_navigate_form_cb);
  } // do_ajax_form_sales_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sales_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sales_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_sales.value = scAjaxGetKeyValue("id_sales");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_sales_detail_mob"] && "nmsc_iframe_liga_form_sales_detail_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_sales_detail_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_sales_detail_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_sales_detail_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_sales_detail_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_sales_detail_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sales_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_sales_mob_navigate_form_cb
  function do_ajax_form_sales_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sales_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sales_mob_navigate_form_cb_after_alert

  function sc_hide_form_sales_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_sales_detail_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "id_sales";
  ajax_field_list[1] = "datesales";
  ajax_field_list[2] = "id_status";
  ajax_field_list[3] = "sales_price";
  ajax_field_list[4] = "sales_discount";
  ...
  var ajax_error_list = {
    "id_sales": {"label": "<?php echo $this->Ini->Nm_lang['lang_sales_fld_id_sales'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "datesales": {"label": "<?php echo $this->Ini->Nm_lang['lang_sales_fld_datesales'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_status": {"label": "<?php echo $this->Ini->Nm_lang['lang_sales_fld_id_status'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sales_price": {"label": "<?php echo $this->Ini->Nm_lang['lang_sales_fld_sales_price'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sales_discount": {"label": "<?php echo $this->Ini->Nm_lang['lang_sales_fld_sales_discount'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "total": {"label": "<?php echo $this->Ini->Nm_lang['lang_sales_fld_total'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "datesales": new Array(),
    "id_status": new Array(),
    "sales_price": new Array(),
    "sales_discount": new Array(),
    "total": new Array(),
    "detail": new Array()
  };
  ajax_field_mult["id_sales"][1] = "id_sales";
  ajax_field_mult["datesales"][1] = "datesales";
  ajax_field_mult["id_status"][1] = "id_status";
  ajax_field_mult["sales_price"][1] = "sales_price";
  ajax_field_mult["sales_discount"][1] = "sales_discount";
  ajax_field_mult["total"][1] = "total";
  ajax_field_mult["detail"][1] = "detail";

  var ajax_field_id = {
    "id_sales": new Array("hidden_field_label_id_sales", "hidden_field_data_id_sales"),
    "datesales": new Array("hidden_field_label_datesales", "hidden_field_data_datesales"),
    "id_status": new Array("hidden_field_label_id_status", "hidden_field_data_id_status"),
    "sales_price": new Array("hidden_field_label_sales_price", "hidden_field_data_sales_price"),
    "sales_discount": new Array("hidden_field_label_sales_discount", "hidden_field_data_sales_discount"),
