  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sales" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_sales
  function do_ajax_form_sales_validate_id_sales()
  {
    var nomeCampo_id_sales = "id_sales";
    var var_id_sales = scAjaxGetFieldHidden(nomeCampo_id_sales);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sales_validate_id_sales(var_id_sales, var_script_case_init, do_ajax_form_sales_validate_id_sales_cb);
  } // do_ajax_form_sales_validate_id_sales

  function do_ajax_form_sales_validate_id_sales_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sales_validate_id_sales_cb

  // ---------- Validate datesales
  function do_ajax_form_sales_validate_datesales()
  {
    var nomeCampo_datesales = "datesales";
    var var_datesales = scAjaxGetFieldText(nomeCampo_datesales);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sales_validate_datesales(var_datesales, var_script_case_init, do_ajax_form_sales_validate_datesales_cb);
  } // do_ajax_form_sales_validate_datesales

  function do_ajax_form_sales_validate_datesales_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sales_validate_datesales_cb

  // ---------- Validate id_status
  function do_ajax_form_sales_validate_id_status()
  {
    var nomeCampo_id_status = "id_status";
    var var_id_status = scAjaxGetFieldSelect(nomeCampo_id_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sales_validate_id_status(var_id_status, var_script_case_init, do_ajax_form_sales_validate_id_status_cb);
  } // do_ajax_form_sales_validate_id_status

  function do_ajax_form_sales_validate_id_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sales_validate_id_status_cb

  // ---------- Validate sales_price
  function do_ajax_form_sales_validate_sales_price()
  {
    var nomeCampo_sales_price = "sales_price";
    var var_sales_price = scAjaxGetFieldText(nomeCampo_sales_price);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sales_validate_sales_price(var_sales_price, var_script_case_init, do_ajax_form_sales_validate_sales_price_cb);
  } // do_ajax_form_sales_validate_sales_price

  function do_ajax_form_sales_validate_sales_price_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sales_validate_sales_price_cb

  // ---------- Validate sales_discount
  function do_ajax_form_sales_validate_sales_discount()
  {
    var nomeCampo_sales_discount = "sales_discount";
    var var_sales_discount = scAjaxGetFieldText(nomeCampo_sales_discount);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sales_validate_sales_discount(var_sales_discount, var_script_case_init, do_ajax_form_sales_validate_sales_discount_cb);
  } // do_ajax_form_sales_validate_sales_discount

  function do_ajax_form_sales_validate_sales_discount_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sales_validate_sales_discount_cb

  // ---------- Validate total
  function do_ajax_form_sales_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldText(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sales_validate_total(var_total, var_script_case_init, do_ajax_form_sales_validate_total_cb);
  } // do_ajax_form_sales_validate_total

  function do_ajax_form_sales_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sales_validate_total_cb

  // ---------- Validate detail
  function do_ajax_form_sales_validate_detail()
  {
    var nomeCampo_detail = "detail";
    var var_detail = scAjaxGetFieldText(nomeCampo_detail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sales_validate_detail(var_detail, var_script_case_init, do_ajax_form_sales_validate_detail_cb);
  } // do_ajax_form_sales_validate_detail

  function do_ajax_form_sales_validate_detail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detail";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sales_validate_detail_cb

  // ---------- Event onchange sales_discount
  function do_ajax_form_sales_event_sales_discount_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_sales_event_sales_discount_onchange(var_total, var_sales_price, var_sales_discount, var_script_case_init, do_ajax_form_sales_event_sales_discount_onchange_cb);
  } // do_ajax_form_sales_event_sales_discount_onchange

  function do_ajax_form_sales_event_sales_discount_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "sales_discount";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sales_event_sales_discount_onchange_cb_after_alert);
  } // do_ajax_form_sales_event_sales_discount_onchange_cb
  function do_ajax_form_sales_event_sales_discount_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_sales_event_sales_discount_onchange_cb_after_alert

  // ---------- Event onchange sales_price
  function do_ajax_form_sales_event_sales_price_onchange()
  {
    var var_total = scAjaxGetFieldText("total");
    var var_sales_price = scAjaxGetFieldText("sales_price");
    var var_sales_discount = scAjaxGetFieldText("sales_discount");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sales_event_sales_price_onchange(var_total, var_sales_price, var_sales_discount, var_script_case_init, do_ajax_form_sales_event_sales_price_onchange_cb);
  } // do_ajax_form_sales_event_sales_price_onchange

  function do_ajax_form_sales_event_sales_price_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "sales_price";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sales_event_sales_price_onchange_cb_after_alert);
  } // do_ajax_form_sales_event_sales_price_onchange_cb
  function do_ajax_form_sales_event_sales_price_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_sales_event_sales_price_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sales_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sales_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sales_submit_form(var_id_sales, var_datesales, var_id_status, var_sales_price, var_sales_discount, var_total, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_sales_submit_form_cb);
  } // do_ajax_form_sales_submit_form

  function do_ajax_form_sales_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sales_submit_form_cb_after_alert);
  } // do_ajax_form_sales_submit_form_cb
  function do_ajax_form_sales_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sales_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_sales_detail"] = "off";

  function do_ajax_form_sales_navigate_form()
  {
    perform_ajax_form_sales_navigate_form();
  }

  function perform_ajax_form_sales_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_sales_detail"] = "on";
    x_ajax_form_sales_navigate_form(var_id_sales, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sales_navigate_form_cb);
  } // do_ajax_form_sales_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sales']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sales_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_sales_detail"] && "nmsc_iframe_liga_form_sales_detail" != scMasterDetailIframe["nmsc_iframe_liga_form_sales_detail"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_sales_detail"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_sales_detail').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_sales_detail').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_sales_detail').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sales_navigate_form_cb_after_alert);
  } // do_ajax_form_sales_navigate_form_cb
  function do_ajax_form_sales_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_sales_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sales_navigate_form_cb_after_alert

  function sc_hide_form_sales_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_sales_detail"])
    {
      return true;
    }
    return false;
