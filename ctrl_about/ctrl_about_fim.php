...
//----- 
   ...
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['ctrl_about']))
   {
      unset($_SESSION['sc_session'][$script_case_init]['ctrl_about']['sc_redir_atualiz']);
      unset($_SESSION['sc_session'][$script_case_init]['ctrl_about']['sc_redir_insert']);
   }
   $fecha_janela = false;
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['ctrl_about']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['ctrl_about']['sc_outra_jan'])
   {
   ...
   if (isset($_SESSION['sc_session'][$script_case_init]['ctrl_about']['nm_run_menu']) && $_SESSION['sc_session'][$script_case_init]['ctrl_about']['nm_run_menu'] == 2)
   {
       $fecha_janela   = true;
       $fecha_aba_menu = true;
   }
   ...
   {
       if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['ctrl_about']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['ctrl_about']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['ctrl_about']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['ctrl_about']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['ctrl_about']['db_changed'])
           {
               if (isset($_SESSION['sc_session'][$script_case_init]['ctrl_about']['lig_iframe_modal']))
               {
                   $iframe_master = $_SESSION['sc_session'][$script_case_init]['ctrl_about']['lig_iframe_modal'];
                   ...
                   unset($_SESSION['sc_session'][$script_case_init]['ctrl_about']['lig_iframe_modal']);
               }
               else
               {
       ...
       {
           if (!isset($script_case_init) || is_array($script_case_init) || !isset($_SESSION['sc_session'][$script_case_init]['ctrl_about']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['ctrl_about']['db_changed'])
           {
       ...
       if (isset($_SESSION['sc_session'][$script_case_init]['ctrl_about']['lig_iframe_modal']))
       {
           $Save_modal = $_SESSION['sc_session'][$script_case_init]['ctrl_about']['lig_iframe_modal'];
           nm_limpa_arr_session();
           $_SESSION['sc_session'][$script_case_init]['ctrl_about']['lig_iframe_modal'] = $Save_modal;
       }
       else
       {
           nm_limpa_arr_session();
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['ctrl_about']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['ctrl_about']['embutida_filho'] as $ind => $sc_init)
          {
