  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_devices_leds_effects" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_devices_leds_effects_form();
	}
...
?>
  ...
  function do_ajax_form_devices_leds_effects_validate_cod_device_(iNumLinha)
  {
    var nomeCampo_cod_device_ = "cod_device_" + iNumLinha;
    var var_cod_device_ = scAjaxGetFieldHidden(nomeCampo_cod_device_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_effects_validate_cod_device_(var_cod_device_, iNumLinha, var_script_case_init, do_ajax_form_devices_leds_effects_validate_cod_device__cb);
  } // do_ajax_form_devices_leds_effects_validate_cod_device_

  function do_ajax_form_devices_leds_effects_validate_cod_device__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_effects_validate_cod_device__cb

  // ---------- Validate device_name_
  function do_ajax_form_devices_leds_effects_validate_device_name_(iNumLinha)
  {
    var nomeCampo_device_name_ = "device_name_" + iNumLinha;
    var var_device_name_ = scAjaxGetFieldText(nomeCampo_device_name_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_effects_validate_device_name_(var_device_name_, iNumLinha, var_script_case_init, do_ajax_form_devices_leds_effects_validate_device_name__cb);
  } // do_ajax_form_devices_leds_effects_validate_device_name_

  function do_ajax_form_devices_leds_effects_validate_device_name__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_effects_validate_device_name__cb

  // ---------- Validate ledstripe1_
  function do_ajax_form_devices_leds_effects_validate_ledstripe1_(iNumLinha)
  {
    var nomeCampo_ledstripe1_ = "ledstripe1_" + iNumLinha;
    var var_ledstripe1_ = scAjaxGetFieldSelect(nomeCampo_ledstripe1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_effects_validate_ledstripe1_(var_ledstripe1_, iNumLinha, var_script_case_init, do_ajax_form_devices_leds_effects_validate_ledstripe1__cb);
  } // do_ajax_form_devices_leds_effects_validate_ledstripe1_

  function do_ajax_form_devices_leds_effects_validate_ledstripe1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_effects_validate_ledstripe1__cb

  // ---------- Validate ledstripe2_
  function do_ajax_form_devices_leds_effects_validate_ledstripe2_(iNumLinha)
  {
    var nomeCampo_ledstripe2_ = "ledstripe2_" + iNumLinha;
    var var_ledstripe2_ = scAjaxGetFieldText(nomeCampo_ledstripe2_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_effects_validate_ledstripe2_(var_ledstripe2_, iNumLinha, var_script_case_init, do_ajax_form_devices_leds_effects_validate_ledstripe2__cb);
  } // do_ajax_form_devices_leds_effects_validate_ledstripe2_

  function do_ajax_form_devices_leds_effects_validate_ledstripe2__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_effects_validate_ledstripe2__cb

  // ---------- Validate ledstripe3_
  function do_ajax_form_devices_leds_effects_validate_ledstripe3_(iNumLinha)
  {
    var nomeCampo_ledstripe3_ = "ledstripe3_" + iNumLinha;
    var var_ledstripe3_ = scAjaxGetFieldText(nomeCampo_ledstripe3_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_effects_validate_ledstripe3_(var_ledstripe3_, iNumLinha, var_script_case_init, do_ajax_form_devices_leds_effects_validate_ledstripe3__cb);
  } // do_ajax_form_devices_leds_effects_validate_ledstripe3_

  function do_ajax_form_devices_leds_effects_validate_ledstripe3__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ledstripe3_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ledstripe3_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ledstripe3_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ledstripe3_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_effects_validate_ledstripe3__cb

  // ---------- Validate ledstripe4_
  function do_ajax_form_devices_leds_effects_validate_ledstripe4_(iNumLinha)
  {
    var nomeCampo_ledstripe4_ = "ledstripe4_" + iNumLinha;
    var var_ledstripe4_ = scAjaxGetFieldText(nomeCampo_ledstripe4_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_effects_validate_ledstripe4_(var_ledstripe4_, iNumLinha, var_script_case_init, do_ajax_form_devices_leds_effects_validate_ledstripe4__cb);
  } // do_ajax_form_devices_leds_effects_validate_ledstripe4_

  function do_ajax_form_devices_leds_effects_validate_ledstripe4__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ledstripe4_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ledstripe4_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ledstripe4_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ledstripe4_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_effects_validate_ledstripe4__cb

  // ---------- Validate color_
  function do_ajax_form_devices_leds_effects_validate_color_(iNumLinha)
  {
    var nomeCampo_color_ = "color_" + iNumLinha;
    var var_color_ = scAjaxGetFieldText(nomeCampo_color_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_effects_validate_color_(var_color_, iNumLinha, var_script_case_init, do_ajax_form_devices_leds_effects_validate_color__cb);
  } // do_ajax_form_devices_leds_effects_validate_color_

  function do_ajax_form_devices_leds_effects_validate_color__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_effects_validate_color__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_devices_leds_effects_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_devices_leds_effects_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_devices_leds_effects_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_devices_leds_effects_add_new_line_cb);
  } // do_ajax_form_devices_leds_effects_add_new_line

  function do_ajax_form_devices_leds_effects_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_devices_leds_effects_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_devices_leds_effects_backup_line(iNumLinha)
  {
    var var_cod_device_ = scAjaxGetFieldHidden("cod_device_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_effects_backup_line(var_cod_device_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_devices_leds_effects_backup_line_cb);
  } // do_ajax_form_devices_leds_effects_backup_line

  function do_ajax_form_devices_leds_effects_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_devices_leds_effects_backup_line_cb

  function do_ajax_form_devices_leds_effects_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_devices_leds_effects_cancel_insert

  function do_ajax_form_devices_leds_effects_cancel_update(iSeqVert)
  {
    do_ajax_form_devices_leds_effects_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_devices_leds_effects_cancel_update

  function do_ajax_form_devices_leds_effects_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_devices_leds_effects_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_devices_leds_effects_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_devices_leds_effects_table_refresh(var_cod_device_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_devices_leds_effects_table_refresh_cb);
  } //  do_ajax_form_devices_leds_effects_table_refresh

  function do_ajax_form_devices_leds_effects_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_devices_leds_effects_table_refresh_cb_after_alert);
  } // do_ajax_form_devices_leds_effects_table_refresh_cb
  function do_ajax_form_devices_leds_effects_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_devices_leds_effects_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_devices_leds_effects_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_devices_leds_effects_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_ledstripe1_ = scAjaxGetFieldSelect("ledstripe1_" + iNumLinha);
    var var_ledstripe2_ = scAjaxGetFieldText("ledstripe2_" + iNumLinha);
    var var_ledstripe3_ = scAjaxGetFieldText("ledstripe3_" + iNumLinha);
    var var_ledstripe4_ = scAjaxGetFieldText("ledstripe4_" + iNumLinha);
...
?>
    x_ajax_form_devices_leds_effects_submit_form(var_cod_device_, var_device_name_, var_ledstripe1_, var_ledstripe2_, var_ledstripe3_, var_ledstripe4_, var_color_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_devices_leds_effects_submit_form_cb);
  } // do_ajax_form_devices_leds_effects_submit_form

  function do_ajax_form_devices_leds_effects_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("ledstripe3_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ledstripe4_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_devices_leds_effects_submit_form_cb_after_alert);
  } // do_ajax_form_devices_leds_effects_submit_form_cb
  function do_ajax_form_devices_leds_effects_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_devices_leds_effects_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_devices_leds_effects_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_devices_leds_effects_navigate_form, function() {});
    } else {
      perform_ajax_form_devices_leds_effects_navigate_form();
    }
  }

  function perform_ajax_form_devices_leds_effects_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("ledstripe3_" + iNavForm);
      scAjaxHideErrorDisplay("ledstripe4_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_devices_leds_effects_navigate_form(var_cod_device_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_devices_leds_effects_navigate_form_cb);
  } // do_ajax_form_devices_leds_effects_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_effects']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_devices_leds_effects_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_devices_leds_effects_navigate_form_cb_after_alert);
  } // do_ajax_form_devices_leds_effects_navigate_form_cb
  function do_ajax_form_devices_leds_effects_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_devices_leds_effects_navigate_form_cb_after_alert

    function sc_form_devices_leds_effects_get_last_line_number()
    {
    ...
    } //sc_form_devices_leds_effects_get_last_line_number

  function sc_hide_form_devices_leds_effects_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ledstripe3_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ledstripe4_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["ledstripe3_" + iNumLinha] = {"label": "Ledstripe 3<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ledstripe4_" + iNumLinha] = {"label": "Ledstripe 4<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["ledstripe3_"][iNumLinha] = "ledstripe3_" + iNumLinha;
    ajax_field_mult["ledstripe4_"][iNumLinha] = "ledstripe4_" + iNumLinha;
    ...
    ajax_field_id["ledstripe3_" + iNumLinha] = new Array("hidden_field_label_ledstripe3_", "hidden_field_data_ledstripe3_" + iNumLinha);
    ajax_field_id["ledstripe4_" + iNumLinha] = new Array("hidden_field_label_ledstripe4_", "hidden_field_data_ledstripe4_" + iNumLinha);
    ...
    ajax_error_count["ledstripe3_" + iNumLinha] = "off";
    ajax_error_count["ledstripe4_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["ledstripe3_" + iNumLinha] = "off";
    ajax_read_only["ledstripe4_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["ledstripe3_" + iNumLinha] = "on";
    ajax_read_only["ledstripe4_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["ledstripe3_" + iNumLinha] = null;
    ajax_error_list["ledstripe4_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    ...
    "ledstripe3_": new Array(),
    "ledstripe4_": new Array(),
    "color_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["ledstripe3_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ledstripe3_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ledstripe3_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ledstripe3_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ledstripe3_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ledstripe4_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ledstripe4_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ledstripe4_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ledstripe4_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ledstripe4_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['device_name_'])) ? $this->nmgp_cmp_readonly['device_name_'] : 'on';
?>
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ledstripe3_'])) ? $this->nmgp_cmp_readonly['ledstripe3_'] : 'off';
?>
    scAjaxFieldRead("ledstripe3_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ledstripe4_'])) ? $this->nmgp_cmp_readonly['ledstripe4_'] : 'off';
?>
    scAjaxFieldRead("ledstripe4_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("ledstripe3_" + iSeq, "on");
    scAjaxFieldRead("ledstripe4_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["cod_device_" + iRow] || "on" == ajax_error_count["device_name_" + iRow] || "on" == ajax_error_count["ledstripe1_" + iRow] || "on" == ajax_error_count["ledstripe2_" + iRow] || "on" == ajax_error_count["ledstripe3_" + iRow] || "on" == ajax_error_count["ledstripe4_" + iRow] || "on" == ajax_error_count["color_" + iRow]))
    {
      ...
      $("#hidden_field_data_ledstripe3_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ledstripe4_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["cod_device_" + iRow] && "off" == ajax_error_count["device_name_" + iRow] && "off" == ajax_error_count["ledstripe1_" + iRow] && "off" == ajax_error_count["ledstripe2_" + iRow] && "off" == ajax_error_count["ledstripe3_" + iRow] && "off" == ajax_error_count["ledstripe4_" + iRow] && "off" == ajax_error_count["color_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["ledstripe3_" + iRow] = "off";
        ajax_error_count["ledstripe4_" + iRow] = "off";
      ...
      $("#hidden_field_data_ledstripe3_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ledstripe4_" + iRow).removeClass("scFormErrorLine");
