<?php
@session_start() ;
$_SESSION['scriptcase']['grid_devices_uhf_monitor']['sc_process_barr'] = true;
require_once('../grid_devices_uhf_monitor/index.php');
unset($_SESSION['scriptcase']['grid_devices_uhf_monitor']['sc_process_barr']);
$ExportCtrl = new grid_devices_uhf_monitor_export_control;
$ExportCtrl->Export_barr();

class grid_devices_uhf_monitor_export_control
{
