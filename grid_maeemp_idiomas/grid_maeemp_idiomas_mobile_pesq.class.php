...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nivel_cond" name="nivel_cond" onChange="nm_campos_between(document.getElementById('id_vis_nivel'), this, 'nivel')">
      ...
      <br><span id="id_hide_nivel"  <?php echo $str_hide_nivel?>><?php
      if ($nivel != "")
      {
      $nivel_look = substr($this->Db->qstr($nivel), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_codigo_empleado_cond" name="codigo_empleado_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigo_empleado'), this, 'codigo_empleado')">
      ...
      <br><span id="id_hide_codigo_empleado"  <?php echo $str_hide_codigo_empleado?>><?php
      if ($codigo_empleado != "")
      {
      $codigo_empleado_look = substr($this->Db->qstr($codigo_empleado), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idioma_cond" name="idioma_cond" onChange="nm_campos_between(document.getElementById('id_vis_idioma'), this, 'idioma')">
      ...
      <br><span id="id_hide_idioma"  <?php echo $str_hide_idioma?>><?php
      if ($idioma != "")
      {
      $idioma_look = substr($this->Db->qstr($idioma), 1, -1); 
      $nmgp_def_dados = array(); 
