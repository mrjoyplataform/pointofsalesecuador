<?php
@session_start() ;
$_SESSION['scriptcase']['grid_maeemp_idiomas']['sc_process_barr'] = true;
require_once('../grid_maeemp_idiomas/index.php');
unset($_SESSION['scriptcase']['grid_maeemp_idiomas']['sc_process_barr']);
$ExportCtrl = new grid_maeemp_idiomas_export_control;
$ExportCtrl->Export_barr();

class grid_maeemp_idiomas_export_control
{
