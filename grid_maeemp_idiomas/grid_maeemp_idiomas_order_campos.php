...
<?php
   ...
   $Ord_Cmp = new grid_maeemp_idiomas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_maeemp_idiomas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['labels']["id"] : "Id";
   $tab_ger_campos['codigo_empleado'] = "on";
   $tab_def_campos['codigo_empleado'] = "codigo_empleado";
   $tab_labels["codigo_empleado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['labels']["codigo_empleado"])) ? $_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['labels']["codigo_empleado"] : "Codigo Empleado";
   $tab_ger_campos['idioma'] = "on";
   $tab_def_campos['idioma'] = "idioma";
   $tab_labels["idioma"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['labels']["idioma"])) ? $_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['labels']["idioma"] : "Idioma";
   $tab_ger_campos['nivel'] = "on";
   $tab_def_campos['nivel'] = "nivel";
   $tab_labels["nivel"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['labels']["nivel"])) ? $_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['labels']["nivel"] : "Nivel";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_maeemp_idiomas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_maeemp_idiomas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
