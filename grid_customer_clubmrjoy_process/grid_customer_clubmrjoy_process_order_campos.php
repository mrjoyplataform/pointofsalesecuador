...
<?php
   ...
   $Ord_Cmp = new grid_customer_clubmrjoy_process_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_customer_clubmrjoy_process_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['idreg'] = "on";
   $tab_def_campos['idreg'] = "idreg";
   $tab_labels["idreg"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["idreg"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["idreg"] : "Idreg";
   $tab_ger_campos['idcustomer'] = "on";
   $tab_def_campos['idcustomer'] = "idcustomer";
   $tab_labels["idcustomer"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["idcustomer"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["idcustomer"] : "Idcustomer";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "nombre";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["nombre"] : "Nombre";
   $tab_ger_campos['correo'] = "on";
   $tab_def_campos['correo'] = "correo";
   $tab_labels["correo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["correo"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["correo"] : "Correo";
   $tab_ger_campos['celular'] = "on";
   $tab_def_campos['celular'] = "celular";
   $tab_labels["celular"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["celular"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["celular"] : "Celular";
   $tab_ger_campos['idinterno'] = "on";
   $tab_def_campos['idinterno'] = "idinterno";
   $tab_labels["idinterno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["idinterno"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["idinterno"] : "Idinterno";
   $tab_ger_campos['direccion'] = "on";
   $tab_def_campos['direccion'] = "direccion";
   $tab_labels["direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["direccion"] : "Direccion";
   $tab_ger_campos['tipodoc'] = "on";
   $tab_def_campos['tipodoc'] = "tipodoc";
   $tab_labels["tipodoc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["tipodoc"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["tipodoc"] : "Tipodoc";
   $tab_ger_campos['ult_fecha'] = "on";
   $tab_def_campos['ult_fecha'] = "ult_fecha";
   $tab_labels["ult_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["ult_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["ult_fecha"] : "Ult Fecha";
   $tab_ger_campos['local_centro'] = "on";
   $tab_def_campos['local_centro'] = "local_centro";
   $tab_labels["local_centro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["local_centro"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["local_centro"] : "Local Centro";
   $tab_ger_campos['cliente_tipo'] = "on";
   $tab_def_campos['cliente_tipo'] = "cliente_tipo";
   $tab_labels["cliente_tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["cliente_tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["cliente_tipo"] : "Cliente Tipo";
   $tab_ger_campos['afiliado_desde'] = "on";
   $tab_def_campos['afiliado_desde'] = "afiliado_desde";
   $tab_labels["afiliado_desde"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["afiliado_desde"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["afiliado_desde"] : "Afiliado Desde";
   $tab_ger_campos['sector'] = "on";
   $tab_def_campos['sector'] = "sector";
   $tab_labels["sector"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["sector"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["sector"] : "Sector";
   $tab_ger_campos['estado'] = "on";
   $tab_def_campos['estado'] = "estado";
   $tab_labels["estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["estado"] : "Estado";
   $tab_ger_campos['uniqueid'] = "on";
   $tab_def_campos['uniqueid'] = "uniqueid";
   $tab_labels["uniqueid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["uniqueid"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["uniqueid"] : "Uniqueid";
   $tab_ger_campos['ciudad'] = "on";
   $tab_def_campos['ciudad'] = "ciudad";
   $tab_labels["ciudad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["ciudad"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["ciudad"] : "Ciudad";
   $tab_ger_campos['pais'] = "on";
   $tab_def_campos['pais'] = "pais";
   $tab_labels["pais"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["pais"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["pais"] : "Pais";
   $tab_ger_campos['fecha1'] = "on";
   $tab_def_campos['fecha1'] = "fecha1";
   $tab_labels["fecha1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["fecha1"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["fecha1"] : "Fecha 1";
   $tab_ger_campos['fecha2'] = "on";
   $tab_def_campos['fecha2'] = "fecha2";
   $tab_labels["fecha2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["fecha2"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["fecha2"] : "Fecha 2";
   $tab_ger_campos['fecha3'] = "on";
   $tab_def_campos['fecha3'] = "fecha3";
   $tab_labels["fecha3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["fecha3"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['labels']["fecha3"] : "Fecha 3";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_customer_clubmrjoy_process_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_customer_clubmrjoy_process']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
