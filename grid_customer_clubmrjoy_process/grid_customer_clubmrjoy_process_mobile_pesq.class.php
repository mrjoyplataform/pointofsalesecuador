...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "afiliado_desde";$Nm_datas[] = "afiliado_desde";$Nm_numeric[] = "idreg";$Nm_numeric[] = "estado";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_fecha3_cond" name="fecha3_cond" onChange="nm_campos_between(document.getElementById('id_vis_fecha3'), this, 'fecha3')">
      ...
      <br><span id="id_hide_fecha3"  <?php echo $str_hide_fecha3?>><?php
      if ($fecha3 != "")
      {
      $fecha3_look = substr($this->Db->qstr($fecha3), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idreg_cond" name="idreg_cond" onChange="nm_campos_between(document.getElementById('id_vis_idreg'), this, 'idreg')">
      ...
      <br><span id="id_hide_idreg"  <?php echo $str_hide_idreg?>><INPUT  type="text" id="SC_idreg" name="idreg" value="<?php echo NM_encode_input($idreg) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idcustomer_cond" name="idcustomer_cond" onChange="nm_campos_between(document.getElementById('id_vis_idcustomer'), this, 'idcustomer')">
