...
class grid_customer_clubmrjoy_process_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_customer_clubmrjoy_process_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_customer_clubmrjoy_process_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_customer_clubmrjoy_process_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_fecha3')
      {
          $fecha3 = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_fecha3($fecha3);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_customer_clubmrjoy_process/grid_customer_clubmrjoy_process_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_customer_clubmrjoy_process_ajax_search.js"></script>
 <script type="text/javascript" src="grid_customer_clubmrjoy_process_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_customer_clubmrjoy_process_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_customer_clubmrjoy_process']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_customer_clubmrjoy_process']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_fecha3_cond#NMF#' + search_get_sel_txt('SC_fecha3_cond') + '@NMF@';
  str_out += 'SC_fecha3#NMF#' + search_get_text('SC_fecha3') + '@NMF@';
  str_out += 'id_ac_fecha3#NMF#' + search_get_text('id_ac_fecha3') + '@NMF@';
  str_out += 'SC_idreg_cond#NMF#' + search_get_sel_txt('SC_idreg_cond') + '@NMF@';
  str_out += 'SC_idreg#NMF#' + search_get_text('SC_idreg') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   ...
   scClass = $("#id_ac_fecha3").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_fecha3").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_fecha3",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $fecha3_cond, $fecha3, $fecha3_autocomp,
             $idreg_cond, $idreg,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $fecha3 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']['fecha3']; 
          $fecha3_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']['fecha3_cond']; 
          $idreg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']['idreg']; 
          $idreg_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']['idreg_cond']; 
          $idcustomer = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']['idcustomer']; 
          $idcustomer_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']['idcustomer_cond']; 
          $nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']['nombre']; 
          $nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']['nombre_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']['NM_operador']; 
          if (strtoupper($idreg_cond) != "II" && strtoupper($idreg_cond) != "QP" && strtoupper($idreg_cond) != "NP" && strtoupper($idreg_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idreg, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($fecha3_cond) || empty($fecha3_cond))
      {
         $fecha3_cond = "qp";
      }
      if (!isset($idreg_cond) || empty($idreg_cond))
      {
         $idreg_cond = "gt";
      }
      ...
      $str_hide_fecha3 = (in_array($fecha3_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idreg = (in_array($idreg_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($fecha3) || $fecha3 == "")
      {
          $fecha3 = "";
      }
      if (isset($fecha3) && !empty($fecha3))
      {
...
?>
<?php
   if (is_file("grid_customer_clubmrjoy_process_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_customer_clubmrjoy_process']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_customer_clubmrjoy_process']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_fecha3_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fecha3'])) ? $this->New_label['fecha3'] : "Fecha 3"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_fecha3_cond" name="fecha3_cond" onChange="nm_campos_between(document.getElementById('id_vis_fecha3'), this, 'fecha3')">
       <OPTION value="qp" <?php if ("qp" == $fecha3_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $fecha3_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $fecha3_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $fecha3_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fecha3" <?php echo $str_hide_fecha3?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['fecha3'])) ? $this->New_label['fecha3'] : "Fecha 3";
 $nmgp_tab_label .= "fecha3?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $fecha3;
      }
?>
<INPUT  type="text" id="SC_fecha3" name="fecha3" value="<?php echo NM_encode_input($fecha3) ?>"  size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_fecha3" name="fecha3_autocomp" size="45"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_idreg_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['idreg'])) ? $this->New_label['idreg'] : "Idreg"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_idreg_cond" name="idreg_cond" onChange="nm_campos_between(document.getElementById('id_vis_idreg'), this, 'idreg')">
       <OPTION value="gt" <?php if ("gt" == $idreg_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idreg_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idreg_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idreg" <?php echo $str_hide_idreg?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['idreg'])) ? $this->New_label['idreg'] : "Idreg";
 $nmgp_tab_label .= "idreg?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_idreg" name="idreg" value="<?php echo NM_encode_input($idreg) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_idcustomer_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idcustomer'])) ? $this->New_label['idcustomer'] : "Idcustomer"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idcustomer_cond" name="idcustomer_cond" onChange="nm_campos_between(document.getElementById('id_vis_idcustomer'), this, 'idcustomer')">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idcustomer" name="idcustomer_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nombre" name="nombre_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 145, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.fecha3_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_fecha3'), document.F1.fecha3_cond, 'fecha3');
   document.F1.fecha3.value = "";
   document.F1.fecha3_autocomp.value = "";
   document.F1.idreg_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idreg'), document.F1.idreg_cond, 'idreg');
   document.F1.idreg.value = "";
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_customer_clubmrjoy_process/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_fecha3_cond'] = 'cond';
      $tp_fields['SC_fecha3'] = 'text_aut';
      $tp_fields['id_ac_fecha3'] = 'text_aut';
      $tp_fields['SC_idreg_cond'] = 'cond';
      $tp_fields['SC_idreg'] = 'text';
   ...
   {
      global $fecha3_cond, $fecha3, $fecha3_autocomp,
             $idreg_cond, $idreg,
             $idcustomer_cond, $idcustomer, $idcustomer_autocomp,
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($fecha3_autocomp) && empty($fecha3))
      {
          $fecha3 = $fecha3_autocomp;
      }
      ...
      $fecha3_cond_salva = $fecha3_cond; 
      if (!isset($fecha3_input_2) || $fecha3_input_2 == "")
      {
          $fecha3_input_2 = $fecha3;
      }
      $idreg_cond_salva = $idreg_cond; 
      if (!isset($idreg_input_2) || $idreg_input_2 == "")
      {
          $idreg_input_2 = $idreg;
      }
      ...
      if ($idreg_cond != "in")
      {
          nm_limpa_numero($idreg, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']['fecha3'] = $fecha3; 
      if (is_array($fecha3) && !empty($fecha3))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['Grid_search'][$I_Grid]['val'][0] = $fecha3;
      }
      elseif ($fecha3_cond_salva == "nu" || $fecha3_cond_salva == "nn" || $fecha3_cond_salva == "ep" || $fecha3_cond_salva == "ne" || !empty($fecha3))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['Grid_search'][$I_Grid]['val'][0][0] = $fecha3;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']['fecha3_cond'] = $fecha3_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['Grid_search'][$I_Grid]['cmp'] = "fecha3"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['Grid_search'][$I_Grid]['opc'] = $fecha3_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq']['fecha3'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']['idreg'] = $idreg; 
      if (is_array($idreg) && !empty($idreg))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['Grid_search'][$I_Grid]['val'][0] = $idreg;
      }
      elseif ($idreg_cond_salva == "nu" || $idreg_cond_salva == "nn" || $idreg_cond_salva == "ep" || $idreg_cond_salva == "ne" || !empty($idreg))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['Grid_search'][$I_Grid]['val'][0][0] = $idreg;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']['idreg_cond'] = $idreg_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['Grid_search'][$I_Grid]['cmp'] = "idreg"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['Grid_search'][$I_Grid]['opc'] = $idreg_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq']['idreg'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']['idcustomer'] = $idcustomer; 
      if (is_array($idcustomer) && !empty($idcustomer))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['Grid_search'][$I_Grid]['val'][0] = $idcustomer;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['Grid_search'][$I_Grid]['val'][0][0] = $idcustomer;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']['idcustomer_cond'] = $idcustomer_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['Grid_search'][$I_Grid]['cmp'] = "idcustomer"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['Grid_search'][$I_Grid]['opc'] = $idcustomer_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq']['idcustomer'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']['nombre'] = $nombre; 
      if (is_array($nombre) && !empty($nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['Grid_search'][$I_Grid]['val'][0] = $nombre;
      }
      elseif ($nombre_cond_salva == "nu" || $nombre_cond_salva == "nn" || $nombre_cond_salva == "ep" || $nombre_cond_salva == "ne" || !empty($nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['Grid_search'][$I_Grid]['val'][0][0] = $nombre;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']['nombre_cond'] = $nombre_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['Grid_search'][$I_Grid]['cmp'] = "nombre"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['Grid_search'][$I_Grid]['opc'] = $nombre_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['grid_pesq']['nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($fecha3 != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['fecha3'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['fecha3'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['fecha3'] = $fecha3;
      }
      $Conteudo = $idreg;
      if (strtoupper($idreg_cond) != "II" && strtoupper($idreg_cond) != "QP" && strtoupper($idreg_cond) != "NP" && strtoupper($idreg_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['idreg'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($idcustomer != '') {
      $idcustomer_look = substr($this->Db->qstr($idcustomer), 1, -1); 
      $nmgp_def_dados = array(); 
    ...
    if ($nombre != '') {
      ...
      if (isset($fecha3) || $fecha3_cond == "nu" || $fecha3_cond == "nn" || $fecha3_cond == "ep" || $fecha3_cond == "ne")
      {
         $this->monta_condicao("fecha3", $fecha3_cond, $fecha3, "", "fecha3");
      }

      //----- $idreg
      $this->Date_part = false;
      if (isset($idreg) || $idreg_cond == "nu" || $idreg_cond == "nn" || $idreg_cond == "ep" || $idreg_cond == "ne")
      {
         $this->monta_condicao("idreg", $idreg_cond, $idreg, "", "idreg");
      }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_clubmrjoy_process']['cond_pesq'] .= $this->NM_operador;
