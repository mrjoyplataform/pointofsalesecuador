...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "linea";$Nm_numeric[] = "cantidad";$Nm_numeric[] = "precio_unitario";$Nm_numeric[] = "porcentaje_iva";$Nm_numeric[] = "valor_iva";$Nm_numeric[] = "descuento";$Nm_numeric[] = "precio_total_sin_impuesto";$Nm_numeric[] = "id";$Nm_numeric[] = "linea";$Nm_numeric[] = "cantidad";$Nm_numeric[] = "precio_unitario";$Nm_numeric[] = "porcentaje_iva";$Nm_numeric[] = "valor_iva";$Nm_numeric[] = "descuento";$Nm_numeric[] = "precio_total_sin_impuesto";
...
<HTML>
<HEAD>
 <TITLE> v_ele_facturas_detalle</TITLE>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_codigo_principal_cond" name="codigo_principal_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigo_principal'), this, 'codigo_principal')">
      ...
      <br><span id="id_hide_codigo_principal"  <?php echo $str_hide_codigo_principal?>><?php
      if ($codigo_principal != "")
      {
      $codigo_principal_look = substr($this->Db->qstr($codigo_principal), 1, -1); 
      $nmgp_def_dados = array(); 
