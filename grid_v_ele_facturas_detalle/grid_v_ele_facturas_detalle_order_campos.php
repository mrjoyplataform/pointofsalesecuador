...
<?php
   ...
   $Ord_Cmp = new grid_v_ele_facturas_detalle_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_ele_facturas_detalle_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['labels']["numero"] : "Numero";
   $tab_ger_campos['codigo_principal'] = "on";
   $tab_def_campos['codigo_principal'] = "codigo_principal";
   $tab_labels["codigo_principal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['labels']["codigo_principal"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['labels']["codigo_principal"] : "Codigo Principal";
   $tab_ger_campos['descripcion'] = "on";
   $tab_def_campos['descripcion'] = "descripcion";
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['labels']["descripcion"] : "Descripcion";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['labels']["cantidad"] : "Cantidad";
   $tab_ger_campos['precio_unitario'] = "on";
   $tab_def_campos['precio_unitario'] = "precio_unitario";
   $tab_labels["precio_unitario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['labels']["precio_unitario"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['labels']["precio_unitario"] : "Precio Unitario";
   $tab_ger_campos['valor_iva'] = "on";
   $tab_def_campos['valor_iva'] = "valor_iva";
   $tab_labels["valor_iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['labels']["valor_iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['labels']["valor_iva"] : "Valor Iva";
   $tab_ger_campos['descuento'] = "on";
   $tab_def_campos['descuento'] = "descuento";
   $tab_labels["descuento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['labels']["descuento"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['labels']["descuento"] : "Descuento";
   $tab_ger_campos['precio_total_sin_impuesto'] = "on";
   $tab_def_campos['precio_total_sin_impuesto'] = "precio_total_sin_impuesto";
   $tab_labels["precio_total_sin_impuesto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['labels']["precio_total_sin_impuesto"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['labels']["precio_total_sin_impuesto"] : "Precio Total Sin Impuesto";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_ele_facturas_detalle_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_ele_facturas_detalle']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
