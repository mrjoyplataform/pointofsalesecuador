<?php
@session_start() ;
$_SESSION['scriptcase']['grid_view_boletos_satisfaction_dia']['sc_process_barr'] = true;
require_once('../grid_view_boletos_satisfaction_dia/index.php');
unset($_SESSION['scriptcase']['grid_view_boletos_satisfaction_dia']['sc_process_barr']);
$ExportCtrl = new grid_view_boletos_satisfaction_dia_export_control;
$ExportCtrl->Export_barr();

class grid_view_boletos_satisfaction_dia_export_control
{
