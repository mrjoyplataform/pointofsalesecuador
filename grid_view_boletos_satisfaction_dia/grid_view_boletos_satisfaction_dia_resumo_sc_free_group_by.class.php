...
class grid_view_boletos_satisfaction_dia_resumo
{
   ...
   var $array_total_fecha_califica;
   var $array_total_califica;
   var $array_total_idproducto;
   var $array_total_fecha_califica_scgb_32;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_fecha_califica         = array();
      $this->array_total_califica               = array();
      $this->array_total_idproducto             = array();
      $this->array_total_fecha_califica_scgb_32 = array();
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['tot_geral'][3];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['tot_geral'][1];
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['arr_total']['fecha_califica'] = $this->array_total_fecha_califica;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['arr_total']['fecha_califica_scgb_32'] = $this->array_total_fecha_califica_scgb_32;
   ...
   function completeMatrix()
   {
       ...
       {
          $Lab_fecha_califica = "fecha_califica";
          $Lab_califica = "califica";
          $Lab_idproducto = "idproducto";
          $Lab_fecha_califica_scgb_32 = "fecha_califica_scgb_32";
       }
       else
       {
       $Lab_fecha_califica = "Fecha Califica";
       $Lab_fecha_califica =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", $Lab_fecha_califica);
       $Lab_califica = "Califica";
       $Lab_idproducto = "Idproducto";
       $Lab_fecha_califica_scgb_32 = "Fecha Califica";
       $Lab_fecha_califica_scgb_32 =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYY'] . "", $Lab_fecha_califica_scgb_32);
       }
       $prep_field = array();
       $prep_field['fecha_califica'] = $Lab_fecha_califica;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['fecha_califica'] = $Lab_fecha_califica; 
       $prep_field['califica'] = $Lab_califica;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['califica'] = $Lab_califica; 
       $prep_field['idproducto'] = $Lab_idproducto;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['idproducto'] = $Lab_idproducto; 
       $prep_field['fecha_califica_scgb_32'] = $Lab_fecha_califica_scgb_32;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['fecha_califica_scgb_32'] = $Lab_fecha_califica_scgb_32; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       $this->comp_sum = array(
           2 => "Jugador",
           3 => "Visitante",
           4 => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "jugador", 'show' => true),
           3 => array('field' => "visitante", 'show' => true),
           4 => array('field' => "nm_count", 'show' => false),
       );
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['fecha_califica']['alin'] = "''";
       $Arr_parms['fecha_califica']['link'] = "S";
       $Arr_parms['califica']['alin'] = "''";
       $Arr_parms['califica']['link'] = "S";
       $Arr_parms['idproducto']['alin'] = "''";
       $Arr_parms['idproducto']['link'] = "S";
       $Arr_parms['fecha_califica_scgb_32']['alin'] = "''";
       $Arr_parms['fecha_califica_scgb_32']['link'] = "S";
       $Arr_parms['fecha_califica']['fill'] = "false";
       $Arr_parms['fecha_califica']['order'] = "value";
       $Arr_parms['fecha_califica']['order_start'] = 'asc';
       $Arr_parms['fecha_califica']['order_invert'] = 'false';
       $Arr_parms['fecha_califica']['order_enabled'] = 'true';
       $Arr_parms['fecha_califica']['order_datatype'] = 'datetime';
       $Arr_parms['califica']['fill'] = "false";
       $Arr_parms['califica']['order'] = "label";
       $Arr_parms['califica']['order_start'] = 'asc';
       $Arr_parms['califica']['order_invert'] = 'false';
       $Arr_parms['califica']['order_enabled'] = 'true';
       $Arr_parms['califica']['order_datatype'] = 'int';
       $Arr_parms['idproducto']['fill'] = "false";
       $Arr_parms['idproducto']['order'] = "label";
       $Arr_parms['idproducto']['order_start'] = 'asc';
       $Arr_parms['idproducto']['order_invert'] = 'false';
       $Arr_parms['idproducto']['order_enabled'] = 'true';
       $Arr_parms['idproducto']['order_datatype'] = 'int';
       $Arr_parms['fecha_califica_scgb_32']['fill'] = "true";
       $Arr_parms['fecha_califica_scgb_32']['order'] = "value";
       $Arr_parms['fecha_califica_scgb_32']['order_start'] = 'asc';
       $Arr_parms['fecha_califica_scgb_32']['order_invert'] = 'false';
       $Arr_parms['fecha_califica_scgb_32']['order_enabled'] = 'true';
       $Arr_parms['fecha_califica_scgb_32']['order_datatype'] = 'datetime';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['fecha_califica'] = array(0 => 'fecha_califica', 1 => '@aspass@');
       $prep_links_fl['califica'] = array(0 => 'califica', 1 => '');
       $prep_links_fl['idproducto'] = array(0 => 'idproducto', 1 => '');
       $prep_links_fl['fecha_califica_scgb_32'] = array(0 => 'fecha_califica_scgb_32', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order_level'] = 0;
       }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           'fecha_califica' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Jugador")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fecha_califica',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_fecha_califica)),
           ...
           'fecha_califica_scgb_32' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Jugador")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fecha_califica_scgb_32',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_fecha_califica_scgb_32)),
               'label_y'  => $this->getChartText(strip_tags("Jugador")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
...
{ 
   ...
   $nm_saida->saida("          nm_submit_modal(\"" . $this->Ini->path_link . "grid_view_boletos_satisfaction_dia/grid_view_boletos_satisfaction_dia_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['SC_Gb_Free_cmp']))
      {
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_jugador, $sum_visitante, $quebra_fecha_califica, $quebra_califica, $quebra_idproducto, $quebra_fecha_califica_scgb_32, $quebra_fecha_califica_orig, $quebra_califica_orig, $quebra_idproducto_orig, $quebra_fecha_califica_scgb_32_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          $cmp_look   = "Cmp_formt";
          $cmp_orig   = "Cmp_arg";
          if (empty($sum_jugador)) {$sum_jugador = '0';}
          if (empty($sum_visitante)) {$sum_visitante = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_jugador . ';
              $this->' . $arr_name . '[2] = ' . $sum_visitante . ';
              $this->' . $arr_name . '[3] = 1;
          ...
          {
              $this->' . $arr_name . '[0]++;
              $this->' . $arr_name . '[1] = bcadd($this->' . $arr_name . '[1], ' . $sum_jugador . ', 10);
              $this->' . $arr_name . '[2] = bcadd($this->' . $arr_name . '[2], ' . $sum_visitante . ', 10);
              $this->' . $arr_name . '[3]++;
          }
          ');
      }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->fecha_califica_orig = $this->fecha_califica;
            $this->califica_orig = $this->califica;
            $this->idproducto_orig = $this->idproducto;
            $this->fecha_califica_scgb_32_orig = $this->fecha_califica_scgb_32;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->jugador, $this->visitante, $this->fecha_califica, $this->califica, $this->idproducto, $this->fecha_califica_scgb_32, $this->fecha_califica_orig,  $this->califica_orig,  $this->idproducto_orig,  $this->fecha_califica_scgb_32_orig);
            }
   }
//
