...
class grid_view_boletos_satisfaction_dia_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_califica;
   var $array_total_idproducto;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_califica   = array();
      $this->array_total_idproducto = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_view_boletos_satisfaction_dia']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_view_boletos_satisfaction_dia']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['contr_total_geral'] == "OK")
      {
          $this->array_total_califica = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['arr_total']['califica'];
          $this->array_total_idproducto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['arr_total']['idproducto'];
      }
      else
      {
          $this->array_total_califica = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['tot_geral'][2];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['tot_geral'][3];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['tot_geral'][4];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['tot_geral'][5];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['arr_total']['califica'] = $this->array_total_califica;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['arr_total']['idproducto'] = $this->array_total_idproducto;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['json_use_label'])
       {
          $Lab_califica = "califica";
          $Lab_idproducto = "idproducto";
       }
       else
       {
       $Lab_califica = "Califica";
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['califica'] = $Lab_califica; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['idproducto'] = $Lab_idproducto; 

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['fecha_califica']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['fecha_califica'] = "Fecha Califica"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['fecha_registro']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['fecha_registro'] = "Fecha Registro"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['idproducto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['idproducto'] = "Idproducto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['califica']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['califica'] = "Califica"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['cliente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['cliente'] = "Cliente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['idcliente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['idcliente'] = "Idcliente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['telefono'] = "Telefono"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['cliente_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['cliente_email'] = "Cliente Email"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['serie']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['serie'] = "Serie"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['fecha_entrada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['fecha_entrada'] = "Fecha Entrada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['fecha_salida']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['fecha_salida'] = "Fecha Salida"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['entrada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['entrada'] = "Entrada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['jugador']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['jugador'] = "Jugador"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['visitante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['visitante'] = "Visitante"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['qrboleto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['qrboleto'] = "Qrboleto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['idsale']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['idsale'] = "Idsale"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['estado'] = "Estado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['nombre'] = "Nombre"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['fecha_nacimiento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['fecha_nacimiento'] = "Fecha Nacimiento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['genero']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['genero'] = "Genero"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['username']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['username'] = "Username"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['fecha_activacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['fecha_activacion'] = "Fecha Activacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['producto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['producto'] = "Producto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['minutos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['minutos'] = "Minutos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['fecha_califica_scgb_32']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['labels']['fecha_califica_scgb_32'] = "Fecha Califica"; 
       }
       //-----
       $this->comp_field_nm = array(
           'califica' => 0,
       ...
       $this->comp_sum = array(
           ...
           3 => "Califica (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")",
           4 => "Califica (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           5 => "Jugador",
           6 => "Visitante",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['summarizing_fields_order']['califica']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['summarizing_fields_order']['califica'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['summarizing_fields_order']['califica'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['summarizing_fields_display']['califica'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['summarizing_fields_display']['califica'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['summarizing_fields_display']['califica'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['summarizing_fields_display']['califica'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['summarizing_fields_display']['califica'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['summarizing_fields_display']['califica'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['summarizing_fields_display']['califica'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           3 => array('field' => "califica", 'show' => true),
           4 => array('field' => "califica", 'show' => true),
           5 => array('field' => "jugador", 'show' => true),
           6 => array('field' => "visitante", 'show' => true),
       );
       ...
       //-----
       foreach ($this->array_total_califica as $i_califica => $d_califica) {
           if (!in_array($i_califica, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_califica[7] ] = $d_califica[6];
               $this->comp_label[0][ $d_califica[7] ] = $d_califica[6];
           }
           foreach ($this->array_total_idproducto[$i_califica] as $i_idproducto => $d_idproducto) {
               if (!in_array($i_idproducto, $this->comp_label[1][ $d_califica[7] ], true)) {
                   $this->comp_index[1][ $d_idproducto[7] ] = $d_idproducto[6];
                   $this->comp_label[1][ $d_califica[7] ][ $d_idproducto[7] ] = $d_idproducto[6];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'califica', 'prot' => ''),
           array('name' => 'idproducto', 'prot' => ''),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_califica => $l_califica) {
           if (isset($this->array_total_califica[$i_califica])) {
               $this->comp_group[$i_califica] = array();
           }
           foreach ($this->comp_label[1][$i_califica] as $i_idproducto => $l_idproducto) {
               if (isset($this->array_total_idproducto[$i_califica][$i_idproducto])) {
                   $this->comp_group[$i_califica][$i_idproducto] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_califica;
       }
       elseif (1 == $level) {
           $return = $this->array_total_idproducto;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_view_boletos_satisfaction_dia@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_califica)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           '0|2' => array(
               'title'    => $this->getChartText(strip_tags("Califica (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'califica',
               'field_y'  => $this->comp_sum_nm[3],
               'label_x'  => $this->getChartText(strip_tags($Lab_califica)),
               'label_y'  => $this->getChartText(strip_tags("Califica (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
               'format'   => $this->formatChartValue(2),
           ),
           '0|3' => array(
               'title'    => $this->getChartText(strip_tags("Califica (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'califica',
               'field_y'  => $this->comp_sum_nm[4],
               'label_x'  => $this->getChartText(strip_tags($Lab_califica)),
               'label_y'  => $this->getChartText(strip_tags("Califica (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(3),
           ),
           '0|4' => array(
               'title'    => $this->getChartText(strip_tags("Jugador")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'califica',
               'field_y'  => $this->comp_sum_nm[5],
               'label_x'  => $this->getChartText(strip_tags($Lab_califica)),
               'label_y'  => $this->getChartText(strip_tags("Jugador")),
               'format'   => $this->formatChartValue(4),
           ),
           '0|5' => array(
               'title'    => $this->getChartText(strip_tags("Visitante")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'califica',
               'field_y'  => $this->comp_sum_nm[6],
               'label_x'  => $this->getChartText(strip_tags($Lab_califica)),
               'label_y'  => $this->getChartText(strip_tags("Visitante")),
           ...
           '1|1' => array(
               ...
               'field_x'  => 'idproducto',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_idproducto)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           '1|2' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_view_boletos_satisfaction_dia_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_view_boletos_satisfaction_dia_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_view_boletos_satisfaction_dia_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_califica("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_califica);
      ksort($this->array_total_idproducto);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " view_boletos_satisfaction</TITLE>\r\n");
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_view_boletos_satisfaction_dia/grid_view_boletos_satisfaction_dia_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_view_boletos_satisfaction_dia_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_view_boletos_satisfaction_dia_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_view_boletos_satisfaction_dia_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['num_css'] . '.css');
     ...
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_view_boletos_satisfaction_dia/grid_view_boletos_satisfaction_dia_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_view_boletos_satisfaction_dia/grid_view_boletos_satisfaction_dia_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_view_boletos_satisfaction_dia&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_view_boletos_satisfaction_dia/grid_view_boletos_satisfaction_dia_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_view_boletos_satisfaction_dia/grid_view_boletos_satisfaction_dia_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_view_boletos_satisfaction_dia/grid_view_boletos_satisfaction_dia_config_graf_flash.php?nome_apl=grid_view_boletos_satisfaction_dia&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_view_boletos_satisfaction_dia/grid_view_boletos_satisfaction_dia_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_view_boletos_satisfaction_dia/grid_view_boletos_satisfaction_dia_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + G)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_view_boletos_satisfaction_dia_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rpdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['pdf'][] = "Rpdf_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_view_boletos_satisfaction_dia/grid_view_boletos_satisfaction_dia_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_view_boletos_satisfaction_dia&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rword_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['word'][] = "Rword_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_view_boletos_satisfaction_dia/grid_view_boletos_satisfaction_dia_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xml'][] = "Rxml_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_view_boletos_satisfaction_dia/grid_view_boletos_satisfaction_dia_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rcsv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['csv'][] = "Rcsv_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_view_boletos_satisfaction_dia/grid_view_boletos_satisfaction_dia_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_view_boletos_satisfaction_dia']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_view_boletos_satisfaction_dia']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_view_boletos_satisfaction_dia_config_pivot.php?nome_apl=grid_view_boletos_satisfaction_dia&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_view_boletos_satisfaction_dia_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_view_boletos_satisfaction_dia/grid_view_boletos_satisfaction_dia_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $fecha_califica = $Busca_temp['fecha_califica']; 
          $tmp_pos = strpos($fecha_califica, "##@@");
          if ($tmp_pos !== false && !is_array($fecha_califica))
          {
              $fecha_califica = substr($fecha_califica, 0, $tmp_pos);
          }
          $fecha_califica_2 = $Busca_temp['fecha_califica_input_2']; 
      } 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['cond_pesq'], 0, $trab_pos);
     ...
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['proc_pdf_vert']) {
      ...
      $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " view_boletos_satisfaction</div>\r\n");
   ...
   //---- 
   function adiciona_registro($avg_califica, $sum_califica, $sum_jugador, $sum_visitante, $quebra_califica, $quebra_idproducto, $quebra_califica_orig, $quebra_idproducto_orig)
   {
      //----- Califica
      if (!isset($this->array_total_califica[$quebra_califica_orig]))
      {
         $this->array_total_califica[$quebra_califica_orig][0] = 1;
         $this->array_total_califica[$quebra_califica_orig][1] = $avg_califica;
         $this->array_total_califica[$quebra_califica_orig][2] = $sum_califica;
         $this->array_total_califica[$quebra_califica_orig][3] = $sum_jugador;
         $this->array_total_califica[$quebra_califica_orig][4] = $sum_visitante;
         $this->array_total_califica[$quebra_califica_orig][5] = 1;
         $this->array_total_califica[$quebra_califica_orig][6] = $quebra_califica;
         $this->array_total_califica[$quebra_califica_orig][7] = $quebra_califica_orig;
      }
      else
      {
         $this->array_total_califica[$quebra_califica_orig][0]++;
         $this->array_total_califica[$quebra_califica_orig][1] = bcadd($this->array_total_califica[$quebra_califica_orig][1], $avg_califica, 10);
         $this->array_total_califica[$quebra_califica_orig][2] = bcadd($this->array_total_califica[$quebra_califica_orig][2], $sum_califica, 10);
         $this->array_total_califica[$quebra_califica_orig][3] = bcadd($this->array_total_califica[$quebra_califica_orig][3], $sum_jugador, 10);
         $this->array_total_califica[$quebra_califica_orig][4] = bcadd($this->array_total_califica[$quebra_califica_orig][4], $sum_visitante, 10);
         $this->array_total_califica[$quebra_califica_orig][5]++;
      }
      //----- Idproducto
      if (!isset($this->array_total_idproducto[$quebra_califica_orig][$quebra_idproducto_orig]))
      {
         $this->array_total_idproducto[$quebra_califica_orig][$quebra_idproducto_orig][0] = 1;
         $this->array_total_idproducto[$quebra_califica_orig][$quebra_idproducto_orig][1] = $avg_califica;
         $this->array_total_idproducto[$quebra_califica_orig][$quebra_idproducto_orig][2] = $sum_califica;
         $this->array_total_idproducto[$quebra_califica_orig][$quebra_idproducto_orig][3] = $sum_jugador;
         $this->array_total_idproducto[$quebra_califica_orig][$quebra_idproducto_orig][4] = $sum_visitante;
         $this->array_total_idproducto[$quebra_califica_orig][$quebra_idproducto_orig][5] = 1;
         $this->array_total_idproducto[$quebra_califica_orig][$quebra_idproducto_orig][6] = $quebra_idproducto;
         $this->array_total_idproducto[$quebra_califica_orig][$quebra_idproducto_orig][7] = $quebra_idproducto_orig;
      }
      else
      {
         $this->array_total_idproducto[$quebra_califica_orig][$quebra_idproducto_orig][0]++;
         $this->array_total_idproducto[$quebra_califica_orig][$quebra_idproducto_orig][1] = bcadd($this->array_total_idproducto[$quebra_califica_orig][$quebra_idproducto_orig][1], $avg_califica, 10);
         $this->array_total_idproducto[$quebra_califica_orig][$quebra_idproducto_orig][2] = bcadd($this->array_total_idproducto[$quebra_califica_orig][$quebra_idproducto_orig][2], $sum_califica, 10);
         $this->array_total_idproducto[$quebra_califica_orig][$quebra_idproducto_orig][3] = bcadd($this->array_total_idproducto[$quebra_califica_orig][$quebra_idproducto_orig][3], $sum_jugador, 10);
         $this->array_total_idproducto[$quebra_califica_orig][$quebra_idproducto_orig][4] = bcadd($this->array_total_idproducto[$quebra_califica_orig][$quebra_idproducto_orig][4], $sum_visitante, 10);
         $this->array_total_idproducto[$quebra_califica_orig][$quebra_idproducto_orig][5]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'califica');
     $campos_order = $this->Ini->Get_date_order_groupby("califica", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'idproducto');
     $campos_order = $this->Ini->Get_date_order_groupby("idproducto", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->fecha_califica = $rs_res->fields[0] ;  
            $this->fecha_registro = $rs_res->fields[1] ;  
            $this->idproducto = $rs_res->fields[2] ;  
            $this->califica = $rs_res->fields[3] ;  
            $this->cliente = $rs_res->fields[4] ;  
            $this->idcliente = $rs_res->fields[5] ;  
            $this->telefono = $rs_res->fields[6] ;  
            $this->cliente_email = $rs_res->fields[7] ;  
            $this->serie = $rs_res->fields[8] ;  
            $this->fecha_entrada = $rs_res->fields[9] ;  
            $this->fecha_salida = $rs_res->fields[10] ;  
            $this->entrada = $rs_res->fields[11] ;  
            $this->jugador = $rs_res->fields[12] ;  
            $this->visitante = $rs_res->fields[13] ;  
            $this->qrboleto = $rs_res->fields[14] ;  
            $this->idsale = $rs_res->fields[15] ;  
            $this->estado = $rs_res->fields[16] ;  
            $this->nombre = $rs_res->fields[17] ;  
            ...
            $this->califica_orig = $this->califica;
            $this->idproducto_orig = $this->idproducto;
            $this->idproducto = $this->look_idproducto ;
            $this->califica = $this->look_califica ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->califica, $this->califica, $this->jugador, $this->visitante, $this->califica, $this->idproducto, $this->califica_orig,  $this->idproducto_orig);
            }
   }
//
