...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->NM_tit_val[1]     = strip_tags("Jugador");
      $this->NM_ind_val[1]     = 1;
      $this->array_decimais[1] = 0;
      $this->NM_tit_val[2]     = strip_tags("Visitante");
      $this->NM_ind_val[2]     = 2;
      ...
      $this->label    = array();
      $prep_label    = array();
      $prep_label['fecha_califica'] = "" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "";
      $prep_label['califica'] = "Califica";
      $prep_label['idproducto'] = "Idproducto";
      $prep_label['fecha_califica_scgb_32'] = "" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYY'] . "";
      $x = 0;
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['contr_label_graf'][$cmp_gb]) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['contr_label_graf'][$cmp_gb]))
          {
             $this->label[$x] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['contr_label_graf'][$cmp_gb];
          }
          $x++;
      }
   }
