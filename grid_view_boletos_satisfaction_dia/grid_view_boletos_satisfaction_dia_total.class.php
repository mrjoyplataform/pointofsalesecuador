...
class grid_view_boletos_satisfaction_dia_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_view_boletos_satisfaction_dia']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_view_boletos_satisfaction_dia']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $idproducto, $califica;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(jugador), sum(visitante) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['tot_geral'][2] = $rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $rt->fields[2] = (string)$rt->fields[2]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['tot_geral'][3] = $rt->fields[2]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['contr_total_geral'] = "OK";
   } 

   //---- 
   function quebra_geral_califica($res_limit=false)
   {
      global $nada, $nm_lang , $idproducto, $califica;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['contr_total_geral'] == "OK") 
      { 
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), avg(califica), sum(califica), sum(jugador), sum(visitante) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['where_pesq']; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), avg(califica), sum(califica), sum(jugador), sum(visitante) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['tot_geral'][4] = $rt->fields[3]; 
      $rt->fields[4] = str_replace(",", ".", $rt->fields[4]);
      $rt->fields[4] = (string)$rt->fields[4]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['tot_geral'][5] = $rt->fields[4]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['contr_total_geral'] = "OK";
   } 

   //-----  fecha_califica
   function quebra_fecha_califica_sc_free_group_by($fecha_califica, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $idproducto, $califica;
      $tot_fecha_califica = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(jugador), sum(visitante) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['where_pesq']; 
      } 
      ...
      $tot_fecha_califica[0] = NM_encode_input(sc_strip_script($fecha_califica)) ; 
      $tot_fecha_califica[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_fecha_califica[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_fecha_califica[3] = (string)$rt->fields[2]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_fecha_califica;
   } 

   //-----  califica
   function quebra_califica_sc_free_group_by($califica, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $idproducto, $califica;
      $tot_califica = array() ;  
      ...
      $tot_califica[0] = NM_encode_input(sc_strip_script($califica)) ; 
      $tot_califica[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_califica[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_califica[3] = (string)$rt->fields[2]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_califica;
   } 

   //-----  idproducto
   function quebra_idproducto_sc_free_group_by($idproducto, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $idproducto, $califica;
      $tot_idproducto = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(jugador), sum(visitante) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['where_pesq']; 
      } 
      ...
      $tot_idproducto[0] = NM_encode_input(sc_strip_script($idproducto)) ; 
      $tot_idproducto[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_idproducto[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_idproducto[3] = (string)$rt->fields[2]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_idproducto;
   } 

   //-----  fecha_califica_scgb_32
   function quebra_fecha_califica_scgb_32_sc_free_group_by($fecha_califica_scgb_32, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $idproducto, $califica;
      $tot_fecha_califica_scgb_32 = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(jugador), sum(visitante) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['where_pesq']; 
      } 
      ...
      $tot_fecha_califica_scgb_32[0] = NM_encode_input(sc_strip_script($fecha_califica_scgb_32)) ; 
      $tot_fecha_califica_scgb_32[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_fecha_califica_scgb_32[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_fecha_califica_scgb_32[3] = (string)$rt->fields[2]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_fecha_califica_scgb_32;
   } 

   //-----  califica
   function quebra_califica_califica($califica, $arg_sum_califica) 
   {
      global $tot_califica, $idproducto, $califica;
      $tot_califica = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), avg(califica), sum(califica), sum(jugador), sum(visitante) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['where_pesq']; 
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['where_pesq'])) 
      { 
         $nm_comando .= " where califica" . $arg_sum_califica ; 
      } 
      else 
      { 
         $nm_comando .= " and califica" . $arg_sum_califica ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
      ...
      $tot_califica[3] = (string)$rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $tot_califica[4] = (string)$rt->fields[3]; 
      $rt->fields[4] = str_replace(",", ".", $rt->fields[4]);
      $tot_califica[5] = (string)$rt->fields[4]; 
      $rt->Close(); 
   } 

   //-----  idproducto
   function quebra_idproducto_califica($califica, $idproducto, $arg_sum_califica, $arg_sum_idproducto) 
   {
      global $tot_idproducto, $idproducto, $califica;
      $tot_idproducto = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), avg(califica), sum(califica), sum(jugador), sum(visitante) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['where_pesq']; 
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['where_pesq'])) 
      { 
         $nm_comando .= " where califica" . $arg_sum_califica . " and idproducto" . $arg_sum_idproducto ; 
      } 
      else 
      { 
         $nm_comando .= " and califica" . $arg_sum_califica . " and idproducto" . $arg_sum_idproducto ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
      ...
      $tot_idproducto[3] = (string)$rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $tot_idproducto[4] = (string)$rt->fields[3]; 
      $rt->fields[4] = str_replace(",", ".", $rt->fields[4]);
      $tot_idproducto[5] = (string)$rt->fields[4]; 
      $rt->Close(); 
   } 
   ...
   {
      global $nm_lang, $idproducto, $califica;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('fecha_califica' => "fecha_califica",'califica' => "califica",'idproducto' => "idproducto",'fecha_califica_scgb_32' => "fecha_califica");
      $cmps_quebra_atual = array();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['SC_Gb_Free_cmp'] as $cmp => $resto)
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_sc_free_group_by($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $cmp_sql_tp_num = array('idsale' => 'N','idproducto' => 'N','estado' => 'N','entrada' => 'N','jugador' => 'N','visitante' => 'N','minutos' => 'N','califica' => 'N');
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
         $cmd_simp = "select count(*), sum(jugador), sum(visitante)#@#cmps_quebras#@# from " . $this->Ini->nm_tabela . " " . $where_ok;
         $comando  = "select count(*), sum(SC_metric1), sum(SC_metric2)#@#cmps_quebras#@# from (";
         $comando .= "select jugador as SC_metric1,visitante as SC_metric2, " . $cmps_quebras1 . " from " . $this->Ini->nm_tabela . " " .  $where_ok . ") SC_sel1 INNER JOIN (";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
      ...
      $format_dimensions['fecha_califica']['reg'] = "N";
      $format_dimensions['fecha_califica']['msk'] = "F/Y";
      $format_dimensions['califica']['reg'] = "S";
      $format_dimensions['califica']['msk'] = "";
      $format_dimensions['idproducto']['reg'] = "S";
      $format_dimensions['idproducto']['msk'] = "";
      $format_dimensions['fecha_califica_scgb_32']['reg'] = "S";
      $format_dimensions['fecha_califica_scgb_32']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              ...
              if ($Cada_dim == "califica") {
                  $this->Lookup->lookup_sc_free_group_by_califica($$Cada_dim,  $califica);
              }
              if ($Cada_dim == "idproducto") {
                  $this->Lookup->lookup_sc_free_group_by_idproducto($$Cada_dim,  $idproducto);
              }
              if (null === $$Cada_dim)
              {
                  $$Cada_dim = '';
   ...
   //----- 
   function Calc_resumo_califica($destino_resumo)
   {
      global $nm_lang, $idproducto, $califica;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['sql_tot_res']);
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['where_pesq'];
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('califica' => "califica",'idproducto' => "idproducto");
      $cmps_quebra_atual = array("califica","idproducto");
      $ult_cmp_quebra_atual = $cmps_quebra_atual[(count($cmps_quebra_atual) - 1)];
      $arr_tots = "";
      $join     = "";
      $group    = "";
      ...
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          ...
          $this->Res_Totaliza_califica($ind_qb, $cmp_gb, $arr_tots, $group, $join, $cmps_gb, $cmps_gb1, $cmps_gb2, $cmps_gbS, $cmp_dim, $cmps_quebra_atual, $cmp_sql_def);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
   ...
   function Res_Totaliza_califica($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      $sc_having = ((isset($parms_sub_sel['having']))) ? "  having " . $parms_sub_sel['having'] : "";
      $Tem_estat_manual = false;
      $where_ok = $this->sc_where_atual;
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
         $cmd_simp = "select count(*), avg(califica), sum(califica), sum(jugador), sum(visitante)#@#cmps_quebras#@# from " . $this->Ini->nm_tabela . " " . $where_ok;
         $comando  = "select count(*), avg(SC_metric1), sum(SC_metric1), sum(SC_metric2), sum(SC_metric3)#@#cmps_quebras#@# from (";
         $comando .= "select califica as SC_metric1,jugador as SC_metric2,visitante as SC_metric3, " . $cmps_quebras1 . " from " . $this->Ini->nm_tabela . " " .  $where_ok . ") SC_sel1 INNER JOIN (";
         $comando .= "select " . $cmps_quebras2 . " from " . $this->Ini->nm_tabela . " " .  $where_ok . " group by " . $group . $sc_having . ") SC_sel2 ";
         $comando .= " ON " . $join;
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      ...
      while (!$rt->EOF)
      {
          ...
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              $prep_look  = $Cada_dim . "_SC_look";
              $$prep_look = $rt->fields[$Ind_sql];
              $SC_prep = $this->Ini->Get_format_dimension($Ind_sql, 'califica', $Cada_dim, $rt, $format_dimensions[$Cada_dim]['reg'], $format_dimensions[$Cada_dim]['msk']);
              $SC_orig = $Cada_dim . "_orig";
              $SC_graf = "val_grafico_" . $Cada_dim;
              $$Cada_dim = $SC_prep['fmt'];
              $$SC_orig = $SC_prep['orig'];
              if ($Cada_dim == "califica") {
                  $this->Lookup->lookup_califica_califica($$Cada_dim,  $califica);
              }
              if ($Cada_dim == "idproducto") {
                  $this->Lookup->lookup_califica_idproducto($$Cada_dim,  $idproducto);
              }
              if (null === $$Cada_dim)
              {
                  $$Cada_dim = '';
          ...
          {
              $where_ok = (empty($this->sc_where_atual)) ? " where " . $sql_where : $this->sc_where_atual . " and " . $sql_where;
              $vl_statistic = $this->Calc_statist_manual_califica($where_ok);
              foreach ($vl_statistic as $ind => $val)
              {
                  $rt->fields[$ind] = $val;
              }
