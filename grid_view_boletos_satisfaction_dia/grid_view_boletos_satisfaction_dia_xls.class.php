...
class grid_view_boletos_satisfaction_dia_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_view_boletos_satisfaction_dia/grid_view_boletos_satisfaction_dia_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_view_boletos_satisfaction_dia_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_view_boletos_satisfaction_dia.zip";
          $this->Arquivo   .= "_grid_view_boletos_satisfaction_dia" . $this->Xls_tp;
          $this->Tit_doc    = "grid_view_boletos_satisfaction_dia" . $this->Xls_tp;
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      while (!$rs->EOF)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['SC_Ind_Groupby'] == "sc_free_group_by")
         {
          ...
          {  
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_fecha_califica()
   {
      ...
      if (!empty($this->fecha_califica))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fecha_califica, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fecha_califica, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- fecha_registro
   ...
   function NM_export_califica()
   {
         ...
         if (is_numeric($this->look_califica))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_califica);
         $this->Xls_col++;
   }
   //----- cliente
   ...
   function NM_export_fecha_entrada()
   {
      ...
      if (!empty($this->fecha_entrada))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fecha_entrada, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fecha_entrada, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- fecha_salida
   function NM_export_fecha_salida()
   {
      ...
      if (!empty($this->fecha_salida))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fecha_salida, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fecha_salida, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- entrada
   ...
   function NM_export_qrboleto()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->qrboleto, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->qrboleto, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- idsale
   function NM_export_idsale()
   {
         ...
         if (is_numeric($this->idsale))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->idsale);
         $this->Xls_col++;
   }
   //----- estado
   ...
   //----- fecha_califica
   function NM_sub_cons_fecha_califica()
   {
      if (!empty($this->fecha_califica))
      {
         if (substr($this->fecha_califica, 10, 1) == "-") 
         ...
         $this->fecha_califica = NM_charset_to_utf8($this->fecha_califica);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fecha_califica;
   ...
   //----- califica
   function NM_sub_cons_califica()
   {
         $this->look_califica = NM_charset_to_utf8($this->look_califica);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_califica;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- fecha_entrada
   function NM_sub_cons_fecha_entrada()
   {
      if (!empty($this->fecha_entrada))
      {
         if (substr($this->fecha_entrada, 10, 1) == "-") 
         ...
         $this->fecha_entrada = NM_charset_to_utf8($this->fecha_entrada);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fecha_entrada;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- fecha_salida
   function NM_sub_cons_fecha_salida()
   {
      if (!empty($this->fecha_salida))
      {
         if (substr($this->fecha_salida, 10, 1) == "-") 
         ...
         $this->fecha_salida = NM_charset_to_utf8($this->fecha_salida);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fecha_salida;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- qrboleto
   function NM_sub_cons_qrboleto()
   {
         $this->qrboleto = html_entity_decode($this->qrboleto, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->qrboleto = strip_tags($this->qrboleto);
         $this->qrboleto = NM_charset_to_utf8($this->qrboleto);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->qrboleto;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- idsale
   function NM_sub_cons_idsale()
   {
         $this->idsale = NM_charset_to_utf8($this->idsale);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->idsale;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['nolabel'])
       {
 ...
 function quebra_idproducto_califica($califica, $idproducto) 
 {
   ...
   function quebra_fecha_califica_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       $temp_cmp = "";
       $cont_col = 0;
       foreach ($this->campos_quebra_fecha_califica as $cada_campo) {
           if ($cont_col == $lim_col) {
   ...
   function quebra_fecha_califica_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['field_order'] as $Cada_cmp)
       {
           if (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_califica_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
   ...
   function quebra_califica_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
   ...
   function quebra_idproducto_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
   ...
   function quebra_idproducto_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
   ...
   function quebra_fecha_califica_scgb_32_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       $temp_cmp = "";
       $cont_col = 0;
       foreach ($this->campos_quebra_fecha_califica_scgb_32 as $cada_campo) {
           if ($cont_col == $lim_col) {
               $temp_cmp = html_entity_decode($temp_cmp, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
               $temp_cmp = strip_tags($temp_cmp);
               $temp_cmp = NM_charset_to_utf8($temp_cmp);
   ...
   function quebra_fecha_califica_scgb_32_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
   ...
   function quebra_califica_califica_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
   ...
   function quebra_idproducto_califica_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> view_boletos_satisfaction :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction_dia']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
