  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ele_documentos_electronicos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_ele_documentos_electronicos_mob_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_ele_documentos_electronicos_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ele_documentos_electronicos_mob_validate_id(var_id, var_script_case_init, do_ajax_form_ele_documentos_electronicos_mob_validate_id_cb);
  } // do_ajax_form_ele_documentos_electronicos_mob_validate_id

  function do_ajax_form_ele_documentos_electronicos_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ele_documentos_electronicos_mob_validate_id_cb

  // ---------- Validate codigo
  function do_ajax_form_ele_documentos_electronicos_mob_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ele_documentos_electronicos_mob_validate_codigo(var_codigo, var_script_case_init, do_ajax_form_ele_documentos_electronicos_mob_validate_codigo_cb);
  } // do_ajax_form_ele_documentos_electronicos_mob_validate_codigo

  function do_ajax_form_ele_documentos_electronicos_mob_validate_codigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ele_documentos_electronicos_mob_validate_codigo_cb

  // ---------- Validate numero
  function do_ajax_form_ele_documentos_electronicos_mob_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ele_documentos_electronicos_mob_validate_numero(var_numero, var_script_case_init, do_ajax_form_ele_documentos_electronicos_mob_validate_numero_cb);
  } // do_ajax_form_ele_documentos_electronicos_mob_validate_numero

  function do_ajax_form_ele_documentos_electronicos_mob_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ele_documentos_electronicos_mob_validate_numero_cb

  // ---------- Validate numero_autorizacion
  function do_ajax_form_ele_documentos_electronicos_mob_validate_numero_autorizacion()
  {
    var nomeCampo_numero_autorizacion = "numero_autorizacion";
    var var_numero_autorizacion = scAjaxGetFieldText(nomeCampo_numero_autorizacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ele_documentos_electronicos_mob_validate_numero_autorizacion(var_numero_autorizacion, var_script_case_init, do_ajax_form_ele_documentos_electronicos_mob_validate_numero_autorizacion_cb);
  } // do_ajax_form_ele_documentos_electronicos_mob_validate_numero_autorizacion

  function do_ajax_form_ele_documentos_electronicos_mob_validate_numero_autorizacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero_autorizacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ele_documentos_electronicos_mob_validate_numero_autorizacion_cb

  // ---------- Validate fecha_autorizacion
  function do_ajax_form_ele_documentos_electronicos_mob_validate_fecha_autorizacion()
  {
    var nomeCampo_fecha_autorizacion = "fecha_autorizacion";
    var var_fecha_autorizacion = scAjaxGetFieldText(nomeCampo_fecha_autorizacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ele_documentos_electronicos_mob_validate_fecha_autorizacion(var_fecha_autorizacion, var_script_case_init, do_ajax_form_ele_documentos_electronicos_mob_validate_fecha_autorizacion_cb);
  } // do_ajax_form_ele_documentos_electronicos_mob_validate_fecha_autorizacion

  function do_ajax_form_ele_documentos_electronicos_mob_validate_fecha_autorizacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha_autorizacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ele_documentos_electronicos_mob_validate_fecha_autorizacion_cb

  // ---------- Validate observacion
  function do_ajax_form_ele_documentos_electronicos_mob_validate_observacion()
  {
    var nomeCampo_observacion = "observacion";
    var var_observacion = scAjaxGetFieldText(nomeCampo_observacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ele_documentos_electronicos_mob_validate_observacion(var_observacion, var_script_case_init, do_ajax_form_ele_documentos_electronicos_mob_validate_observacion_cb);
  } // do_ajax_form_ele_documentos_electronicos_mob_validate_observacion

  function do_ajax_form_ele_documentos_electronicos_mob_validate_observacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ele_documentos_electronicos_mob_validate_observacion_cb

  // ---------- Validate estado
  function do_ajax_form_ele_documentos_electronicos_mob_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldText(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ele_documentos_electronicos_mob_validate_estado(var_estado, var_script_case_init, do_ajax_form_ele_documentos_electronicos_mob_validate_estado_cb);
  } // do_ajax_form_ele_documentos_electronicos_mob_validate_estado

  function do_ajax_form_ele_documentos_electronicos_mob_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ele_documentos_electronicos_mob_validate_estado_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_ele_documentos_electronicos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_ele_documentos_electronicos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_numero_autorizacion = scAjaxGetFieldText("numero_autorizacion");
    var var_fecha_autorizacion = scAjaxGetFieldText("fecha_autorizacion");
    ...
    scAjaxProcOn();
    x_ajax_form_ele_documentos_electronicos_mob_submit_form(var_id, var_codigo, var_numero, var_numero_autorizacion, var_fecha_autorizacion, var_observacion, var_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ele_documentos_electronicos_mob_submit_form_cb);
  } // do_ajax_form_ele_documentos_electronicos_mob_submit_form

  function do_ajax_form_ele_documentos_electronicos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("numero_autorizacion");
      scAjaxHideErrorDisplay("fecha_autorizacion");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_ele_documentos_electronicos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_ele_documentos_electronicos_mob_submit_form_cb
  function do_ajax_form_ele_documentos_electronicos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ele_documentos_electronicos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_ele_documentos_electronicos_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_ele_documentos_electronicos_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_ele_documentos_electronicos_mob_navigate_form();
    }
  }

  function perform_ajax_form_ele_documentos_electronicos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_ele_documentos_electronicos_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ele_documentos_electronicos_mob_navigate_form_cb);
  } // do_ajax_form_ele_documentos_electronicos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ele_documentos_electronicos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ele_documentos_electronicos_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ele_documentos_electronicos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_ele_documentos_electronicos_mob_navigate_form_cb
  function do_ajax_form_ele_documentos_electronicos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_ele_documentos_electronicos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_ele_documentos_electronicos_mob_navigate_form_cb_after_alert

  function sc_hide_form_ele_documentos_electronicos_mob_form()
  {
  ...
  ajax_field_list[3] = "numero_autorizacion";
  ajax_field_list[4] = "fecha_autorizacion";
  ...
  var ajax_error_list = {
    ...
    "numero_autorizacion": {"label": "Numero Autorizacion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha_autorizacion": {"label": "Fecha Autorizacion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "codigo": new Array(),
    "numero": new Array(),
    "numero_autorizacion": new Array(),
    "fecha_autorizacion": new Array(),
  ...
  ajax_field_mult["numero_autorizacion"][1] = "numero_autorizacion";
  ajax_field_mult["fecha_autorizacion"][1] = "fecha_autorizacion";
  ...
  var ajax_field_id = {
    ...
    "numero_autorizacion": new Array("hidden_field_label_numero_autorizacion", "hidden_field_data_numero_autorizacion"),
    "fecha_autorizacion": new Array("hidden_field_label_fecha_autorizacion", "hidden_field_data_fecha_autorizacion"),
  ...
  var ajax_read_only = {
    ...
    "codigo": "off",
    "numero": "off",
    "numero_autorizacion": "off",
    "fecha_autorizacion": "off",
    "observacion": "off",
    "estado": "off"
  };
