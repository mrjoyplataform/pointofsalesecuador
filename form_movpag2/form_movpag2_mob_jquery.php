...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_fecdoc43_hora' + iSeqRow).bind('blur', function() { sc_form_movpag2_fecdoc43_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_movpag2_fecdoc43_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_fedoc43_hora' + iSeqRow).bind('blur', function() { sc_form_movpag2_fedoc43_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_movpag2_fedoc43_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_movpag2_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecdoc43" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_movpag2_mob_validate_fecdoc43(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fedoc43" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_movpag2_mob_validate_fedoc43(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_feccobro43" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_movpag2_mob_validate_feccobro43(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fectransfer43" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_movpag2_mob_validate_fectransfer43(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fecvencompra43" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_movpag2_mob_validate_fecvencompra43(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fecvenret43" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_movpag2_mob_validate_fecvenret43(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_movpag2_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
