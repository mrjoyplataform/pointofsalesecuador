...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_movpag2']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_movpag2']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_movpag2']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_movpag2']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_movpag2']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_movpag2']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_movpag2']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_movpag2']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_movpag2']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_movpag2']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_movpag2']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_movpag2']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_movpag2']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_movpag2']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_movpag2']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_movpag2']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_movpag2']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_movpag2_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_movpag2']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_movpag2']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_movpag2'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_movpag2']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_movpag2']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_movpag2') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_movpag2']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " movpag2";
      ...
      $_SESSION['scriptcase']['error_icon']['form_movpag2']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_movpag2'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_movpag2']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_movpag2']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_movpag2']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_movpag2']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_movpag2']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_movpag2']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movpag2']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_movpag2']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_movpag2']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_movpag2']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_movpag2'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_movpag2'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movpag2']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_movpag2']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_movpag2']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movpag2']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_movpag2']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_movpag2']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movpag2']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_movpag2']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_movpag2']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dados_form'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_movpag2", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_movpag2/form_movpag2_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_movpag2_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_movpag2_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_movpag2_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_movpag2/form_movpag2_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_movpag2_erro.class.php"); 
      }
      $this->Erro      = new form_movpag2_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['opcao']))
         { 
             if ($this->codcte43 != "" || $this->tipodoc43 != "" || $this->numdoc43 != "" || $this->ocurren43 != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_movpag2']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_movpag2']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_movpag2']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_movpag2.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_movpag2_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_movpag2"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_movpag2']) || !is_array($this->NM_ajax_info['errList']['geral_form_movpag2']))
              {
                  $this->NM_ajax_info['errList']['geral_form_movpag2'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_movpag2'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_codcte43(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['codcte43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['codcte43'] == "on")) 
      { 
          if ($this->codcte43 == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_tipodoc43(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['tipodoc43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['tipodoc43'] == "on")) 
      { 
          if ($this->tipodoc43 == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_numdoc43(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['numdoc43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['numdoc43'] == "on")) 
      { 
          if ($this->numdoc43 == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_ocurren43(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['ocurren43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['ocurren43'] == "on")) 
      { 
          if ($this->ocurren43 == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_credgast43(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['credgast43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['credgast43'] == "on")) 
      { 
          if ($this->credgast43 == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_cvanulado43(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['cvanulado43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['cvanulado43'] == "on")) 
      { 
          if ($this->cvanulado43 == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_conta43(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['conta43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['conta43'] == "on")) 
      { 
          if ($this->conta43 == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_cont43(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['cont43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['cont43'] == "on")) 
      { 
          if ($this->cont43 == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_tipo_pago(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['tipo_pago']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['tipo_pago'] == "on")) 
      { 
          if ($this->tipo_pago == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_numero_transferencia(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['numero_transferencia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['numero_transferencia'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_aprobacion_transferencia(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['aprobacion_transferencia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['aprobacion_transferencia'] == "on")) 
      { 
    ...
    function ValidateField_banco(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['banco']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['banco'] == "on")) 
      { 
          if ($this->banco == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_valor_superior_al_maximo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['valor_superior_al_maximo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['valor_superior_al_maximo'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_contrato_garantia(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->contrato_garantia, 3, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['codcte43']['keyVal'] = form_movpag2_pack_protect_string($this->nmgp_dados_form['codcte43']);
              $this->NM_ajax_info['fldList']['tipodoc43']['keyVal'] = form_movpag2_pack_protect_string($this->nmgp_dados_form['tipodoc43']);
              $this->NM_ajax_info['fldList']['numdoc43']['keyVal'] = form_movpag2_pack_protect_string($this->nmgp_dados_form['numdoc43']);
              $this->NM_ajax_info['fldList']['ocurren43']['keyVal'] = form_movpag2_pack_protect_string($this->nmgp_dados_form['ocurren43']);
          }
   } // ajax_return_values
   ...
   function ajax_return_values_distribucion_retencion($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['parms'] = "codcte43?#?$this->codcte43?@?tipodoc43?#?$this->tipodoc43?@?numdoc43?#?$this->numdoc43?@?ocurren43?#?$this->ocurren43?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
      ...
      { 
          ...
          $qt_geral_reg_form_movpag2 = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['total'] = $qt_geral_reg_form_movpag2;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->codcte43) && !empty($this->tipodoc43) && !empty($this->numdoc43) && !empty($this->ocurren43))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_movpag2 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_start'] > $qt_geral_reg_form_movpag2)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_start'] = $qt_geral_reg_form_movpag2; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_movpag2) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_start'] < $qt_geral_reg_form_movpag2;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_movpag2_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_movpag2 = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['total'] = $qt_geral_reg_form_movpag2;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_movpag2_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_movpag2_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_movpag2_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['ordem_ord'] == " desc") {
