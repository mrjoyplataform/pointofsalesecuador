...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_movpag2/form_movpag2_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_movpag2_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_movpag2_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['link_info']['remove_border']) {
...
<?php
 include_once("form_movpag2_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_movpag2'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_movpag2'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_codcte43_label" id="hidden_field_label_codcte43" style="<?php echo $sStyleHidden_codcte43; ?>"><span id="id_label_codcte43"><?php echo $this->nm_new_label['codcte43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['codcte43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['codcte43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_numdoc43_label" id="hidden_field_label_numdoc43" style="<?php echo $sStyleHidden_numdoc43; ?>"><span id="id_label_numdoc43"><?php echo $this->nm_new_label['numdoc43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['numdoc43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['numdoc43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ocurren43_label" id="hidden_field_label_ocurren43" style="<?php echo $sStyleHidden_ocurren43; ?>"><span id="id_label_ocurren43"><?php echo $this->nm_new_label['ocurren43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['ocurren43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['ocurren43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_credgast43_label" id="hidden_field_label_credgast43" style="<?php echo $sStyleHidden_credgast43; ?>"><span id="id_label_credgast43"><?php echo $this->nm_new_label['credgast43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['credgast43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['credgast43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cvanulado43_label" id="hidden_field_label_cvanulado43" style="<?php echo $sStyleHidden_cvanulado43; ?>"><span id="id_label_cvanulado43"><?php echo $this->nm_new_label['cvanulado43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['cvanulado43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['cvanulado43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_conta43_label" id="hidden_field_label_conta43" style="<?php echo $sStyleHidden_conta43; ?>"><span id="id_label_conta43"><?php echo $this->nm_new_label['conta43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['conta43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['conta43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cont43_label" id="hidden_field_label_cont43" style="<?php echo $sStyleHidden_cont43; ?>"><span id="id_label_cont43"><?php echo $this->nm_new_label['cont43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['cont43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['cont43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_cont43_line" id="hidden_field_data_cont43" style="<?php echo $sStyleHidden_cont43; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cont43_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipo_pago_label" id="hidden_field_label_tipo_pago" style="<?php echo $sStyleHidden_tipo_pago; ?>"><span id="id_label_tipo_pago"><?php echo $this->nm_new_label['tipo_pago']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['tipo_pago']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['tipo_pago'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_tipo_pago_line" id="hidden_field_data_tipo_pago" style="<?php echo $sStyleHidden_tipo_pago; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_pago_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_numero_transferencia_label" id="hidden_field_label_numero_transferencia" style="<?php echo $sStyleHidden_numero_transferencia; ?>"><span id="id_label_numero_transferencia"><?php echo $this->nm_new_label['numero_transferencia']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['numero_transferencia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['numero_transferencia'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_aprobacion_transferencia_label" id="hidden_field_label_aprobacion_transferencia" style="<?php echo $sStyleHidden_aprobacion_transferencia; ?>"><span id="id_label_aprobacion_transferencia"><?php echo $this->nm_new_label['aprobacion_transferencia']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['aprobacion_transferencia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['aprobacion_transferencia'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_aprobacion_transferencia_line" id="hidden_field_data_aprobacion_transferencia" style="<?php echo $sStyleHidden_aprobacion_transferencia; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_aprobacion_transferencia_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_banco_label" id="hidden_field_label_banco" style="<?php echo $sStyleHidden_banco; ?>"><span id="id_label_banco"><?php echo $this->nm_new_label['banco']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['banco']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['banco'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_valor_superior_al_maximo_label" id="hidden_field_label_valor_superior_al_maximo" style="<?php echo $sStyleHidden_valor_superior_al_maximo; ?>"><span id="id_label_valor_superior_al_maximo"><?php echo $this->nm_new_label['valor_superior_al_maximo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['valor_superior_al_maximo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['php_cmp_required']['valor_superior_al_maximo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_contrato_garantia_label" id="hidden_field_label_contrato_garantia" style="<?php echo $sStyleHidden_contrato_garantia; ?>"><span id="id_label_contrato_garantia"><?php echo $this->nm_new_label['contrato_garantia']; ?></span></TD>
    <TD class="scFormDataOdd css_contrato_garantia_line" id="hidden_field_data_contrato_garantia" style="<?php echo $sStyleHidden_contrato_garantia; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_contrato_garantia_line" style="vertical-align: top;padding: 0px">
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_movpag2");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_movpag2");
 parent.scAjaxDetailHeight("form_movpag2", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag2']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
