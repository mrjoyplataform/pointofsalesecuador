...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____pdfreport_boletos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____pdfreport_boletos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pdfreport_boletos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['pdfreport_boletos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pdfreport_boletos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['pdfreport_boletos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['pdfreport_boletos']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['pdfreport_boletos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['pdfreport_boletos']['embutida_filho'] as $ind => $sc_init)
          {
