...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_rp01seccion_cond" name="rp01seccion_cond" onChange="nm_campos_between(document.getElementById('id_vis_rp01seccion'), this, 'rp01seccion')">
      ...
      <br><span id="id_hide_rp01seccion"  <?php echo $str_hide_rp01seccion?>><?php
      if ($rp01seccion != "")
      {
      $rp01seccion_look = substr($this->Db->qstr($rp01seccion), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_rp01noemp_cond" name="rp01noemp_cond" onChange="nm_campos_between(document.getElementById('id_vis_rp01noemp'), this, 'rp01noemp')">
      ...
      <br><span id="id_hide_rp01noemp"  <?php echo $str_hide_rp01noemp?>><?php
      if ($rp01noemp != "")
      {
      $rp01noemp_look = substr($this->Db->qstr($rp01noemp), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_rp01division_cond" name="rp01division_cond" onChange="nm_campos_between(document.getElementById('id_vis_rp01division'), this, 'rp01division')">
      ...
      <br><span id="id_hide_rp01division"  <?php echo $str_hide_rp01division?>><?php
      if ($rp01division != "")
      {
      $rp01division_look = substr($this->Db->qstr($rp01division), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_rp01depto_cond" name="rp01depto_cond" onChange="nm_campos_between(document.getElementById('id_vis_rp01depto'), this, 'rp01depto')">
      ...
      <br><span id="id_hide_rp01depto"  <?php echo $str_hide_rp01depto?>><?php
      if ($rp01depto != "")
      {
      $rp01depto_look = substr($this->Db->qstr($rp01depto), 1, -1); 
      $nmgp_def_dados = array(); 
