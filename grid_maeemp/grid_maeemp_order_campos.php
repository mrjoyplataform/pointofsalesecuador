...
<?php
   ...
   $Ord_Cmp = new grid_maeemp_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_maeemp_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_maeemp']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_maeemp']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['rp01noemp'] = "rp01noemp";
   $tab_labels["rp01noemp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maeemp']['labels']["rp01noemp"])) ? $_SESSION['sc_session'][$sc_init]['grid_maeemp']['labels']["rp01noemp"] : "Rp 0 1noemp";
   $tab_ger_campos['rp01division'] = "on";
   $tab_def_campos['rp01division'] = "rp01division";
   $tab_labels["rp01division"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maeemp']['labels']["rp01division"])) ? $_SESSION['sc_session'][$sc_init]['grid_maeemp']['labels']["rp01division"] : "Rp 0 1division";
   $tab_ger_campos['rp01depto'] = "on";
   $tab_def_campos['rp01depto'] = "rp01depto";
   $tab_labels["rp01depto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maeemp']['labels']["rp01depto"])) ? $_SESSION['sc_session'][$sc_init]['grid_maeemp']['labels']["rp01depto"] : "Rp 0 1depto";
   $tab_ger_campos['rp01seccion'] = "on";
   $tab_def_campos['rp01seccion'] = "rp01seccion";
   $tab_labels["rp01seccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maeemp']['labels']["rp01seccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_maeemp']['labels']["rp01seccion"] : "Rp 0 1seccion";
   $tab_ger_campos['rp01noemp1'] = "on";
   $tab_def_campos['rp01noemp1'] = "rp01noemp1";
   $tab_labels["rp01noemp1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maeemp']['labels']["rp01noemp1"])) ? $_SESSION['sc_session'][$sc_init]['grid_maeemp']['labels']["rp01noemp1"] : "Rp 0 1noemp 1";
   $tab_ger_campos['rp01nombreemp'] = "on";
   $tab_def_campos['rp01nombreemp'] = "rp01nombreemp";
   $tab_labels["rp01nombreemp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maeemp']['labels']["rp01nombreemp"])) ? $_SESSION['sc_session'][$sc_init]['grid_maeemp']['labels']["rp01nombreemp"] : "Rp 0 1nombreemp";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_maeemp']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_maeemp']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_maeemp']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_maeemp']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_maeemp']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_maeemp']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_maeemp']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_maeemp']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_maeemp']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_maeemp']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_maeemp']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_maeemp']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_maeemp_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_maeemp']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_maeemp']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_maeemp']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_maeemp']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_maeemp']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
