...
class grid_maeemp_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_maeemp_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_maeemp_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_maeemp_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_rp01seccion')
      {
          $rp01seccion = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_rp01seccion($rp01seccion);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_rp01noemp')
      {
          $rp01noemp = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_rp01noemp($rp01noemp);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_rp01division')
      {
          $rp01division = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_rp01division($rp01division);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_rp01depto')
      {
          $rp01depto = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_rp01depto($rp01depto);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "rp01fechastatus";$Nm_datas[] = "rp01fechastatus";$Nm_datas[] = "rp01fechanacimiento";$Nm_datas[] = "rp01fechanacimiento";$Nm_datas[] = "rp01fechaingreso";$Nm_datas[] = "rp01fechaingreso";$Nm_datas[] = "rp01fechareingreso";$Nm_datas[] = "rp01fechareingreso";$Nm_datas[] = "rp01fechahijos0";$Nm_datas[] = "rp01fechahijos0";$Nm_datas[] = "rp01fechahijos1";$Nm_datas[] = "rp01fechahijos1";$Nm_datas[] = "rp01fechahijos2";$Nm_datas[] = "rp01fechahijos2";$Nm_datas[] = "rp01fechahijos3";$Nm_datas[] = "rp01fechahijos3";$Nm_datas[] = "rp01fechahijos4";$Nm_datas[] = "rp01fechahijos4";$Nm_datas[] = "rp01fechahijos5";$Nm_datas[] = "rp01fechahijos5";$Nm_datas[] = "rp01fechahijos6";$Nm_datas[] = "rp01fechahijos6";$Nm_datas[] = "rp01fechahijos7";$Nm_datas[] = "rp01fechahijos7";$Nm_datas[] = "rp01fechahijos8";$Nm_datas[] = "rp01fechahijos8";$Nm_datas[] = "rp01fechahijos9";$Nm_datas[] = "rp01fechahijos9";$Nm_datas[] = "rp01fechaultvacacion";$Nm_datas[] = "rp01fechaultvacacion";$Nm_datas[] = "rp01fecmodsdosal";$Nm_datas[] = "rp01fecmodsdosal";$Nm_datas[] = "rp01fecmodficha";$Nm_datas[] = "rp01fecmodficha";$Nm_datas[] = "rp01fechaUID";$Nm_datas[] = "rp01fechaUID";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> maeemp</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_maeemp/grid_maeemp_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_maeemp_ajax_search.js"></script>
 <script type="text/javascript" src="grid_maeemp_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_maeemp_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_maeemp']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_maeemp']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_rp01seccion_cond#NMF#' + search_get_sel_txt('SC_rp01seccion_cond') + '@NMF@';
  str_out += 'SC_rp01seccion#NMF#' + search_get_text('SC_rp01seccion') + '@NMF@';
  str_out += 'id_ac_rp01seccion#NMF#' + search_get_text('id_ac_rp01seccion') + '@NMF@';
  str_out += 'SC_rp01noemp_cond#NMF#' + search_get_sel_txt('SC_rp01noemp_cond') + '@NMF@';
  str_out += 'SC_rp01noemp#NMF#' + search_get_text('SC_rp01noemp') + '@NMF@';
  str_out += 'id_ac_rp01noemp#NMF#' + search_get_text('id_ac_rp01noemp') + '@NMF@';
  str_out += 'SC_rp01division_cond#NMF#' + search_get_sel_txt('SC_rp01division_cond') + '@NMF@';
  str_out += 'SC_rp01division#NMF#' + search_get_text('SC_rp01division') + '@NMF@';
  str_out += 'id_ac_rp01division#NMF#' + search_get_text('id_ac_rp01division') + '@NMF@';
  str_out += 'SC_rp01depto_cond#NMF#' + search_get_sel_txt('SC_rp01depto_cond') + '@NMF@';
  str_out += 'SC_rp01depto#NMF#' + search_get_text('SC_rp01depto') + '@NMF@';
  str_out += 'id_ac_rp01depto#NMF#' + search_get_text('id_ac_rp01depto') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_rp01noemp").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_rp01noemp").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_rp01noemp",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_rp01noemp").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_rp01noemp").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_rp01division").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_rp01division").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_rp01division",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_rp01division").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_rp01division").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_rp01depto").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_rp01depto").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_rp01depto",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_rp01depto").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_rp01depto").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_rp01seccion").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_rp01seccion").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_rp01seccion",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_rp01seccion").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> maeemp</div>
...
<?php
   ...
   {
      global 
             $rp01seccion_cond, $rp01seccion, $rp01seccion_autocomp,
             $rp01noemp_cond, $rp01noemp, $rp01noemp_autocomp,
             $rp01division_cond, $rp01division, $rp01division_autocomp,
             $rp01depto_cond, $rp01depto, $rp01depto_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $rp01seccion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']['rp01seccion']; 
          $rp01seccion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']['rp01seccion_cond']; 
          $rp01noemp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']['rp01noemp']; 
          $rp01noemp_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']['rp01noemp_cond']; 
          $rp01division = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']['rp01division']; 
          $rp01division_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']['rp01division_cond']; 
          $rp01depto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']['rp01depto']; 
          $rp01depto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']['rp01depto_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']['NM_operador']; 
      } 
      if (!isset($rp01seccion_cond) || empty($rp01seccion_cond))
      {
         $rp01seccion_cond = "qp";
      }
      if (!isset($rp01noemp_cond) || empty($rp01noemp_cond))
      {
         $rp01noemp_cond = "qp";
      }
      if (!isset($rp01division_cond) || empty($rp01division_cond))
      {
         $rp01division_cond = "qp";
      }
      if (!isset($rp01depto_cond) || empty($rp01depto_cond))
      {
         $rp01depto_cond = "qp";
      }
      ...
      $str_hide_rp01seccion = (in_array($rp01seccion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_rp01noemp = (in_array($rp01noemp_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_rp01division = (in_array($rp01division_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_rp01depto = (in_array($rp01depto_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($rp01seccion) || $rp01seccion == "")
      {
          $rp01seccion = "";
      }
      if (isset($rp01seccion) && !empty($rp01seccion))
      {
         $tmp_pos = strpos($rp01seccion, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $rp01seccion = substr($rp01seccion, 0, $tmp_pos);
         }
      }
      if (!isset($rp01noemp) || $rp01noemp == "")
      {
          $rp01noemp = "";
      }
      if (isset($rp01noemp) && !empty($rp01noemp))
      {
         $tmp_pos = strpos($rp01noemp, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $rp01noemp = substr($rp01noemp, 0, $tmp_pos);
         }
      }
      if (!isset($rp01division) || $rp01division == "")
      {
          $rp01division = "";
      }
      if (isset($rp01division) && !empty($rp01division))
      {
         $tmp_pos = strpos($rp01division, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $rp01division = substr($rp01division, 0, $tmp_pos);
         }
      }
      if (!isset($rp01depto) || $rp01depto == "")
      {
          $rp01depto = "";
      }
      if (isset($rp01depto) && !empty($rp01depto))
      {
         $tmp_pos = strpos($rp01depto, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $rp01depto = substr($rp01depto, 0, $tmp_pos);
         }
      }
?>
 <?php
...
?>
<?php
   if (is_file("grid_maeemp_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_maeemp']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_maeemp']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_rp01seccion_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['rp01seccion'])) ? $this->New_label['rp01seccion'] : "Rp 0 1seccion"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_rp01seccion_cond" name="rp01seccion_cond" onChange="nm_campos_between(document.getElementById('id_vis_rp01seccion'), this, 'rp01seccion')">
       <OPTION value="qp" <?php if ("qp" == $rp01seccion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $rp01seccion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $rp01seccion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $rp01seccion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_rp01seccion" <?php echo $str_hide_rp01seccion?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['rp01seccion'])) ? $this->New_label['rp01seccion'] : "Rp 0 1seccion";
 $nmgp_tab_label .= "rp01seccion?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $rp01seccion;
      }
?>
<INPUT  type="text" id="SC_rp01seccion" name="rp01seccion" value="<?php echo NM_encode_input($rp01seccion) ?>"  size=4 alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_rp01seccion" name="rp01seccion_autocomp" size="4"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_rp01noemp_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['rp01noemp'])) ? $this->New_label['rp01noemp'] : "Rp 0 1noemp"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_rp01noemp_cond" name="rp01noemp_cond" onChange="nm_campos_between(document.getElementById('id_vis_rp01noemp'), this, 'rp01noemp')">
       <OPTION value="qp" <?php if ("qp" == $rp01noemp_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $rp01noemp_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $rp01noemp_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $rp01noemp_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_rp01noemp" <?php echo $str_hide_rp01noemp?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['rp01noemp'])) ? $this->New_label['rp01noemp'] : "Rp 0 1noemp";
 $nmgp_tab_label .= "rp01noemp?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $rp01noemp;
      }
?>
<INPUT  type="text" id="SC_rp01noemp" name="rp01noemp" value="<?php echo NM_encode_input($rp01noemp) ?>"  size=25 alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_rp01noemp" name="rp01noemp_autocomp" size="25"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_rp01division_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['rp01division'])) ? $this->New_label['rp01division'] : "Rp 0 1division"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_rp01division_cond" name="rp01division_cond" onChange="nm_campos_between(document.getElementById('id_vis_rp01division'), this, 'rp01division')">
       <OPTION value="qp" <?php if ("qp" == $rp01division_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $rp01division_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $rp01division_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $rp01division_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_rp01division" <?php echo $str_hide_rp01division?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['rp01division'])) ? $this->New_label['rp01division'] : "Rp 0 1division";
 $nmgp_tab_label .= "rp01division?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $rp01division;
      }
?>
<INPUT  type="text" id="SC_rp01division" name="rp01division" value="<?php echo NM_encode_input($rp01division) ?>"  size=4 alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_rp01division" name="rp01division_autocomp" size="4"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_rp01depto_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['rp01depto'])) ? $this->New_label['rp01depto'] : "Rp 0 1depto"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_rp01depto_cond" name="rp01depto_cond" onChange="nm_campos_between(document.getElementById('id_vis_rp01depto'), this, 'rp01depto')">
       <OPTION value="qp" <?php if ("qp" == $rp01depto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $rp01depto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $rp01depto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $rp01depto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_rp01depto" <?php echo $str_hide_rp01depto?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['rp01depto'])) ? $this->New_label['rp01depto'] : "Rp 0 1depto";
 $nmgp_tab_label .= "rp01depto?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $rp01depto;
      }
?>
<INPUT  type="text" id="SC_rp01depto" name="rp01depto" value="<?php echo NM_encode_input($rp01depto) ?>"  size=4 alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_rp01depto" name="rp01depto_autocomp" size="4"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.rp01seccion_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_rp01seccion'), document.F1.rp01seccion_cond, 'rp01seccion');
   document.F1.rp01seccion.value = "";
   document.F1.rp01seccion_autocomp.value = "";
   document.F1.rp01noemp_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_rp01noemp'), document.F1.rp01noemp_cond, 'rp01noemp');
   document.F1.rp01noemp.value = "";
   document.F1.rp01noemp_autocomp.value = "";
   document.F1.rp01division_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_rp01division'), document.F1.rp01division_cond, 'rp01division');
   document.F1.rp01division.value = "";
   document.F1.rp01division_autocomp.value = "";
   document.F1.rp01depto_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_rp01depto'), document.F1.rp01depto_cond, 'rp01depto');
   document.F1.rp01depto.value = "";
   document.F1.rp01depto_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_rp01seccion_cond'] = 'cond';
      $tp_fields['SC_rp01seccion'] = 'text_aut';
      $tp_fields['id_ac_rp01seccion'] = 'text_aut';
      $tp_fields['SC_rp01noemp_cond'] = 'cond';
      $tp_fields['SC_rp01noemp'] = 'text_aut';
      $tp_fields['id_ac_rp01noemp'] = 'text_aut';
      $tp_fields['SC_rp01division_cond'] = 'cond';
      $tp_fields['SC_rp01division'] = 'text_aut';
      $tp_fields['id_ac_rp01division'] = 'text_aut';
      $tp_fields['SC_rp01depto_cond'] = 'cond';
      $tp_fields['SC_rp01depto'] = 'text_aut';
      $tp_fields['id_ac_rp01depto'] = 'text_aut';
   ...
   {
      global $rp01seccion_cond, $rp01seccion, $rp01seccion_autocomp,
             $rp01noemp_cond, $rp01noemp, $rp01noemp_autocomp,
             $rp01division_cond, $rp01division, $rp01division_autocomp,
             $rp01depto_cond, $rp01depto, $rp01depto_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($rp01seccion_autocomp) && empty($rp01seccion))
      {
          $rp01seccion = $rp01seccion_autocomp;
      }
      if (!empty($rp01noemp_autocomp) && empty($rp01noemp))
      {
          $rp01noemp = $rp01noemp_autocomp;
      }
      if (!empty($rp01division_autocomp) && empty($rp01division))
      {
          $rp01division = $rp01division_autocomp;
      }
      if (!empty($rp01depto_autocomp) && empty($rp01depto))
      {
          $rp01depto = $rp01depto_autocomp;
      }
      $rp01seccion_cond_salva = $rp01seccion_cond; 
      if (!isset($rp01seccion_input_2) || $rp01seccion_input_2 == "")
      {
          $rp01seccion_input_2 = $rp01seccion;
      }
      $rp01noemp_cond_salva = $rp01noemp_cond; 
      if (!isset($rp01noemp_input_2) || $rp01noemp_input_2 == "")
      {
          $rp01noemp_input_2 = $rp01noemp;
      }
      $rp01division_cond_salva = $rp01division_cond; 
      if (!isset($rp01division_input_2) || $rp01division_input_2 == "")
      {
          $rp01division_input_2 = $rp01division;
      }
      $rp01depto_cond_salva = $rp01depto_cond; 
      if (!isset($rp01depto_input_2) || $rp01depto_input_2 == "")
      {
          $rp01depto_input_2 = $rp01depto;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']['rp01seccion'] = $rp01seccion; 
      if (is_array($rp01seccion) && !empty($rp01seccion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['Grid_search'][$I_Grid]['val'][0] = $rp01seccion;
      }
      elseif ($rp01seccion_cond_salva == "nu" || $rp01seccion_cond_salva == "nn" || $rp01seccion_cond_salva == "ep" || $rp01seccion_cond_salva == "ne" || !empty($rp01seccion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['Grid_search'][$I_Grid]['val'][0][0] = $rp01seccion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']['rp01seccion_cond'] = $rp01seccion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['Grid_search'][$I_Grid]['cmp'] = "rp01seccion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['Grid_search'][$I_Grid]['opc'] = $rp01seccion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq']['rp01seccion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']['rp01noemp'] = $rp01noemp; 
      if (is_array($rp01noemp) && !empty($rp01noemp))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['Grid_search'][$I_Grid]['val'][0] = $rp01noemp;
      }
      elseif ($rp01noemp_cond_salva == "nu" || $rp01noemp_cond_salva == "nn" || $rp01noemp_cond_salva == "ep" || $rp01noemp_cond_salva == "ne" || !empty($rp01noemp))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['Grid_search'][$I_Grid]['val'][0][0] = $rp01noemp;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']['rp01noemp_cond'] = $rp01noemp_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['Grid_search'][$I_Grid]['cmp'] = "rp01noemp"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['Grid_search'][$I_Grid]['opc'] = $rp01noemp_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq']['rp01noemp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']['rp01division'] = $rp01division; 
      if (is_array($rp01division) && !empty($rp01division))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['Grid_search'][$I_Grid]['val'][0] = $rp01division;
      }
      elseif ($rp01division_cond_salva == "nu" || $rp01division_cond_salva == "nn" || $rp01division_cond_salva == "ep" || $rp01division_cond_salva == "ne" || !empty($rp01division))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['Grid_search'][$I_Grid]['val'][0][0] = $rp01division;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']['rp01division_cond'] = $rp01division_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['Grid_search'][$I_Grid]['cmp'] = "rp01division"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['Grid_search'][$I_Grid]['opc'] = $rp01division_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq']['rp01division'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']['rp01depto'] = $rp01depto; 
      if (is_array($rp01depto) && !empty($rp01depto))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['Grid_search'][$I_Grid]['val'][0] = $rp01depto;
      }
      elseif ($rp01depto_cond_salva == "nu" || $rp01depto_cond_salva == "nn" || $rp01depto_cond_salva == "ep" || $rp01depto_cond_salva == "ne" || !empty($rp01depto))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['Grid_search'][$I_Grid]['val'][0][0] = $rp01depto;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']['rp01depto_cond'] = $rp01depto_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['Grid_search'][$I_Grid]['cmp'] = "rp01depto"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['Grid_search'][$I_Grid]['opc'] = $rp01depto_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['grid_pesq']['rp01depto'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($rp01seccion != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['rp01seccion'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['rp01seccion'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['rp01seccion'] = $rp01seccion;
      }
      $nmgp_def_dados = array();
    if ($rp01noemp != '') {
      $rp01noemp_look = substr($this->Db->qstr($rp01noemp), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['rp01noemp'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['rp01noemp'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['rp01noemp'] = $rp01noemp;
      }
      $nmgp_def_dados = array();
    if ($rp01division != '') {
      $rp01division_look = substr($this->Db->qstr($rp01division), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['rp01division'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['rp01division'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['rp01division'] = $rp01division;
      }
      $nmgp_def_dados = array();
    if ($rp01depto != '') {
      $rp01depto_look = substr($this->Db->qstr($rp01depto), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['rp01depto'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['rp01depto'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['rp01depto'] = $rp01depto;
      }

      //----- $rp01seccion
      $this->Date_part = false;
      if (isset($rp01seccion) || $rp01seccion_cond == "nu" || $rp01seccion_cond == "nn" || $rp01seccion_cond == "ep" || $rp01seccion_cond == "ne")
      {
         $this->monta_condicao("rp01seccion", $rp01seccion_cond, $rp01seccion, "", "rp01seccion");
      }

      //----- $rp01noemp
      $this->Date_part = false;
      if (isset($rp01noemp) || $rp01noemp_cond == "nu" || $rp01noemp_cond == "nn" || $rp01noemp_cond == "ep" || $rp01noemp_cond == "ne")
      {
         $this->monta_condicao("rp01noemp", $rp01noemp_cond, $rp01noemp, "", "rp01noemp");
      }

      //----- $rp01division
      $this->Date_part = false;
      if (isset($rp01division) || $rp01division_cond == "nu" || $rp01division_cond == "nn" || $rp01division_cond == "ep" || $rp01division_cond == "ne")
      {
         $this->monta_condicao("rp01division", $rp01division_cond, $rp01division, "", "rp01division");
      }

      //----- $rp01depto
      $this->Date_part = false;
      if (isset($rp01depto) || $rp01depto_cond == "nu" || $rp01depto_cond == "nn" || $rp01depto_cond == "ep" || $rp01depto_cond == "ne")
      {
         $this->monta_condicao("rp01depto", $rp01depto_cond, $rp01depto, "", "rp01depto");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maeemp']['cond_pesq'] .= $this->NM_operador;
