<?php
@session_start() ;
$_SESSION['scriptcase']['chart_product']['sc_process_barr'] = true;
require_once('../chart_product/index.php');
unset($_SESSION['scriptcase']['chart_product']['sc_process_barr']);
$ExportCtrl = new chart_product_export_control;
$ExportCtrl->Export_barr();

class chart_product_export_control
{
