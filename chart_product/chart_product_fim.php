...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____chart_product"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____chart_product"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_product']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_product']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_product']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_product']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_product']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_product']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_product']['embutida_filho'] as $ind => $sc_init)
          {
