<?php
@session_start() ;
$_SESSION['scriptcase']['grid_saldos_kardex_fix']['sc_process_barr'] = true;
require_once('../grid_saldos_kardex_fix/index.php');
unset($_SESSION['scriptcase']['grid_saldos_kardex_fix']['sc_process_barr']);
$ExportCtrl = new grid_saldos_kardex_fix_export_control;
$ExportCtrl->Export_barr();

class grid_saldos_kardex_fix_export_control
{
