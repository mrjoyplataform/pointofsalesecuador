...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_saldos_kardex_fix"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_saldos_kardex_fix"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_saldos_kardex_fix']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_saldos_kardex_fix']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_saldos_kardex_fix']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_saldos_kardex_fix']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_saldos_kardex_fix']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_saldos_kardex_fix</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_saldos_kardex_fix']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_saldos_kardex_fix']['embutida_filho'] as $ind => $sc_init)
          {
