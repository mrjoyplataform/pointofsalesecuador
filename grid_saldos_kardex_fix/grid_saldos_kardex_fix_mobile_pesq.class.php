...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_product";$Nm_numeric[] = "id_category";$Nm_numeric[] = "stock";$Nm_numeric[] = "id_status";$Nm_numeric[] = "";$Nm_numeric[] = "id_product";$Nm_numeric[] = "id_category";$Nm_numeric[] = "stock";$Nm_numeric[] = "id_status";$Nm_numeric[] = "";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_stock_cond" name="stock_cond" onChange="nm_campos_between(document.getElementById('id_vis_stock'), this, 'stock')">
