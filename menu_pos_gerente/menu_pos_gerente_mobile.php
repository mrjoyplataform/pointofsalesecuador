...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["menu_pos_gerente"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menu_pos_gerente"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menu_pos_gerente"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    <style>
    <?php
    if(isset($menu_pos_gerente_menuData["data"]) && is_array($menu_pos_gerente_menuData["data"]) && !empty($menu_pos_gerente_menuData["data"]))
    {
        foreach($menu_pos_gerente_menuData["data"] as $arr_item)
        {
   ...
   <TABLE width="100%" class="scMenuHHeader" cellpadding="0" cellspacing="0">
    ...
    <?php
        escreveMenuMobile($menu_pos_gerente_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
