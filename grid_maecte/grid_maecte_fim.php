...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_maecte"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_maecte"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_maecte'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_maecte']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_maecte']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_maecte']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_maecte']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_maecte']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_maecte']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_maecte']['embutida_filho'] as $ind => $sc_init)
          {
