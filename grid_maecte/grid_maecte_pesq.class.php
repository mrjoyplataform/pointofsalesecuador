...
class grid_maecte_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_maecte_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_maecte_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_maecte_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nomcte01')
      {
          $nomcte01 = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nomcte01($nomcte01);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "fecing01";$Nm_datas[] = "fecing01";$Nm_datas[] = "fechanace01";$Nm_datas[] = "fechanace01";$Nm_datas[] = "fecvenp01";$Nm_datas[] = "fecvenp01";$Nm_datas[] = "fecha_ingreso_empresa";$Nm_datas[] = "fecha_ingreso_empresa";$Nm_datas[] = "fecha_salida_empresa_actividad";$Nm_datas[] = "fecha_salida_empresa_actividad";$Nm_datas[] = "fecha_inicio_actividad";$Nm_datas[] = "fecha_inicio_actividad";$Nm_datas[] = "fecha_ingreso_empresa_actividad";$Nm_datas[] = "fecha_ingreso_empresa_actividad";$Nm_datas[] = "fecha_ingreso_empresa_actividad2";$Nm_datas[] = "fecha_ingreso_empresa_actividad2";$Nm_datas[] = "fecha_salida_empresa_actividad2";$Nm_datas[] = "fecha_salida_empresa_actividad2";$Nm_datas[] = "fecha_inicio_actividad2";$Nm_datas[] = "fecha_inicio_actividad2";$Nm_datas[] = "fecha_constitucion_empresa";$Nm_datas[] = "fecha_constitucion_empresa";$Nm_datas[] = "fecha_compra";$Nm_datas[] = "fecha_compra";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> maecte</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_maecte/grid_maecte_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_maecte_ajax_search.js"></script>
 <script type="text/javascript" src="grid_maecte_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_maecte_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_maecte']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_maecte']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_nomcte01_cond#NMF#' + search_get_sel_txt('SC_nomcte01_cond') + '@NMF@';
  str_out += 'SC_nomcte01#NMF#' + search_get_text('SC_nomcte01') + '@NMF@';
  str_out += 'id_ac_nomcte01#NMF#' + search_get_text('id_ac_nomcte01') + '@NMF@';
  str_out += 'SC_codcte01_cond#NMF#' + search_get_sel_txt('SC_codcte01_cond') + '@NMF@';
  str_out += 'SC_codcte01#NMF#' + search_get_text('SC_codcte01') + '@NMF@';
  str_out += 'SC_tipo_cliente_cond#NMF#' + search_get_sel_txt('SC_tipo_cliente_cond') + '@NMF@';
  str_out += 'SC_tipo_cliente#NMF#' + search_get_text('SC_tipo_cliente') + '@NMF@';
  str_out += 'SC_id_nacionalidad_cond#NMF#' + search_get_sel_txt('SC_id_nacionalidad_cond') + '@NMF@';
  str_out += 'SC_id_nacionalidad#NMF#' + search_get_text('SC_id_nacionalidad') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_nomcte01").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_nomcte01").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nomcte01",
          max_itens: "10",
          cod_desc: "N",
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> maecte</div>
...
<?php
   ...
   {
      global 
             $nomcte01_cond, $nomcte01, $nomcte01_autocomp,
             $codcte01_cond, $codcte01,
             $tipo_cliente_cond, $tipo_cliente,
             $id_nacionalidad_cond, $id_nacionalidad,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $nomcte01 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']['nomcte01']; 
          $nomcte01_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']['nomcte01_cond']; 
          $codcte01 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']['codcte01']; 
          $codcte01_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']['codcte01_cond']; 
          $tipo_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']['tipo_cliente']; 
          $tipo_cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']['tipo_cliente_cond']; 
          $id_nacionalidad = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']['id_nacionalidad']; 
          $id_nacionalidad_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']['id_nacionalidad_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']['NM_operador']; 
          if (strtoupper($codcte01_cond) != "II" && strtoupper($codcte01_cond) != "QP" && strtoupper($codcte01_cond) != "NP" && strtoupper($codcte01_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($codcte01, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($tipo_cliente_cond) != "II" && strtoupper($tipo_cliente_cond) != "QP" && strtoupper($tipo_cliente_cond) != "NP" && strtoupper($tipo_cliente_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($tipo_cliente, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($id_nacionalidad_cond) != "II" && strtoupper($id_nacionalidad_cond) != "QP" && strtoupper($id_nacionalidad_cond) != "NP" && strtoupper($id_nacionalidad_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_nacionalidad, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($nomcte01_cond) || empty($nomcte01_cond))
      {
         $nomcte01_cond = "qp";
      }
      if (!isset($codcte01_cond) || empty($codcte01_cond))
      {
         $codcte01_cond = "gt";
      }
      if (!isset($tipo_cliente_cond) || empty($tipo_cliente_cond))
      {
         $tipo_cliente_cond = "gt";
      }
      if (!isset($id_nacionalidad_cond) || empty($id_nacionalidad_cond))
      {
         $id_nacionalidad_cond = "gt";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_nomcte01 = (in_array($nomcte01_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_codcte01 = (in_array($codcte01_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_tipo_cliente = (in_array($tipo_cliente_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_nacionalidad = (in_array($id_nacionalidad_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($nomcte01) || $nomcte01 == "")
      {
          $nomcte01 = "";
      }
      if (isset($nomcte01) && !empty($nomcte01))
      {
         $tmp_pos = strpos($nomcte01, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nomcte01 = substr($nomcte01, 0, $tmp_pos);
         }
      }
      if (!isset($codcte01) || $codcte01 == "")
      {
          $codcte01 = "";
      }
      if (isset($codcte01) && !empty($codcte01))
      {
         $tmp_pos = strpos($codcte01, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $codcte01 = substr($codcte01, 0, $tmp_pos);
         }
      }
      ...
      if (isset($tipo_cliente) && !empty($tipo_cliente))
      {
         $tmp_pos = strpos($tipo_cliente, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $tipo_cliente = substr($tipo_cliente, 0, $tmp_pos);
         }
      }
      if (!isset($id_nacionalidad) || $id_nacionalidad == "")
      {
          $id_nacionalidad = "";
      }
      if (isset($id_nacionalidad) && !empty($id_nacionalidad))
      {
         $tmp_pos = strpos($id_nacionalidad, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_nacionalidad = substr($id_nacionalidad, 0, $tmp_pos);
         }
      }
?>
 <?php
...
?>
<?php
   if (is_file("grid_maecte_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_maecte']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_maecte']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_nomcte01_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['nomcte01'])) ? $this->New_label['nomcte01'] : "Nomcte 01"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_nomcte01_cond" name="nomcte01_cond" onChange="nm_campos_between(document.getElementById('id_vis_nomcte01'), this, 'nomcte01')">
       <OPTION value="qp" <?php if ("qp" == $nomcte01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nomcte01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nomcte01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nomcte01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nomcte01" <?php echo $str_hide_nomcte01?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['nomcte01'])) ? $this->New_label['nomcte01'] : "Nomcte 01";
 $nmgp_tab_label .= "nomcte01?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $nomcte01;
      }
?>
<INPUT  type="text" id="SC_nomcte01" name="nomcte01" value="<?php echo NM_encode_input($nomcte01) ?>"  size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nomcte01" name="nomcte01_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_codcte01_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['codcte01'])) ? $this->New_label['codcte01'] : "Codcte 01"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_codcte01_cond" name="codcte01_cond" onChange="nm_campos_between(document.getElementById('id_vis_codcte01'), this, 'codcte01')">
       <OPTION value="gt" <?php if ("gt" == $codcte01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $codcte01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $codcte01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_codcte01" <?php echo $str_hide_codcte01?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['codcte01'])) ? $this->New_label['codcte01'] : "Codcte 01";
 $nmgp_tab_label .= "codcte01?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_codcte01" name="codcte01" value="<?php echo NM_encode_input($codcte01) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_tipo_cliente_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['tipo_cliente'])) ? $this->New_label['tipo_cliente'] : "Tipo Cliente"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_tipo_cliente_cond" name="tipo_cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_tipo_cliente'), this, 'tipo_cliente')">
       <OPTION value="gt" <?php if ("gt" == $tipo_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $tipo_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $tipo_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tipo_cliente" <?php echo $str_hide_tipo_cliente?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['tipo_cliente'])) ? $this->New_label['tipo_cliente'] : "Tipo Cliente";
 $nmgp_tab_label .= "tipo_cliente?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_tipo_cliente" name="tipo_cliente" value="<?php echo NM_encode_input($tipo_cliente) ?>" size=3 alt="{datatype: 'integer', maxLength: 3, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_id_nacionalidad_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['id_nacionalidad'])) ? $this->New_label['id_nacionalidad'] : "Id Nacionalidad"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_nacionalidad_cond" name="id_nacionalidad_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_nacionalidad'), this, 'id_nacionalidad')">
       <OPTION value="gt" <?php if ("gt" == $id_nacionalidad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_nacionalidad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_nacionalidad_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_nacionalidad" <?php echo $str_hide_id_nacionalidad?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['id_nacionalidad'])) ? $this->New_label['id_nacionalidad'] : "Id Nacionalidad";
 $nmgp_tab_label .= "id_nacionalidad?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_id_nacionalidad" name="id_nacionalidad" value="<?php echo NM_encode_input($id_nacionalidad) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.nomcte01_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nomcte01'), document.F1.nomcte01_cond, 'nomcte01');
   document.F1.nomcte01.value = "";
   document.F1.nomcte01_autocomp.value = "";
   document.F1.codcte01_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_codcte01'), document.F1.codcte01_cond, 'codcte01');
   document.F1.codcte01.value = "";
   document.F1.tipo_cliente_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_tipo_cliente'), document.F1.tipo_cliente_cond, 'tipo_cliente');
   document.F1.tipo_cliente.value = "";
   document.F1.id_nacionalidad_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_id_nacionalidad'), document.F1.id_nacionalidad_cond, 'id_nacionalidad');
   document.F1.id_nacionalidad.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_nomcte01_cond'] = 'cond';
      $tp_fields['SC_nomcte01'] = 'text_aut';
      $tp_fields['id_ac_nomcte01'] = 'text_aut';
      $tp_fields['SC_codcte01_cond'] = 'cond';
      $tp_fields['SC_codcte01'] = 'text';
      $tp_fields['SC_tipo_cliente_cond'] = 'cond';
      $tp_fields['SC_tipo_cliente'] = 'text';
      $tp_fields['SC_id_nacionalidad_cond'] = 'cond';
      $tp_fields['SC_id_nacionalidad'] = 'text';
   ...
   {
      global $nomcte01_cond, $nomcte01, $nomcte01_autocomp,
             $codcte01_cond, $codcte01,
             $tipo_cliente_cond, $tipo_cliente,
             $id_nacionalidad_cond, $id_nacionalidad, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($nomcte01_autocomp) && empty($nomcte01))
      {
          $nomcte01 = $nomcte01_autocomp;
      }
      $nomcte01_cond_salva = $nomcte01_cond; 
      if (!isset($nomcte01_input_2) || $nomcte01_input_2 == "")
      {
          $nomcte01_input_2 = $nomcte01;
      }
      $codcte01_cond_salva = $codcte01_cond; 
      if (!isset($codcte01_input_2) || $codcte01_input_2 == "")
      {
          $codcte01_input_2 = $codcte01;
      }
      $tipo_cliente_cond_salva = $tipo_cliente_cond; 
      if (!isset($tipo_cliente_input_2) || $tipo_cliente_input_2 == "")
      {
          $tipo_cliente_input_2 = $tipo_cliente;
      }
      $id_nacionalidad_cond_salva = $id_nacionalidad_cond; 
      if (!isset($id_nacionalidad_input_2) || $id_nacionalidad_input_2 == "")
      {
          $id_nacionalidad_input_2 = $id_nacionalidad;
      }
      if ($codcte01_cond != "in")
      {
          nm_limpa_numero($codcte01, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($tipo_cliente_cond != "in")
      {
          nm_limpa_numero($tipo_cliente, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($id_nacionalidad_cond != "in")
      {
          nm_limpa_numero($id_nacionalidad, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']['nomcte01'] = $nomcte01; 
      if (is_array($nomcte01) && !empty($nomcte01))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['Grid_search'][$I_Grid]['val'][0] = $nomcte01;
      }
      elseif ($nomcte01_cond_salva == "nu" || $nomcte01_cond_salva == "nn" || $nomcte01_cond_salva == "ep" || $nomcte01_cond_salva == "ne" || !empty($nomcte01))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['Grid_search'][$I_Grid]['val'][0][0] = $nomcte01;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']['nomcte01_cond'] = $nomcte01_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['Grid_search'][$I_Grid]['cmp'] = "nomcte01"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['Grid_search'][$I_Grid]['opc'] = $nomcte01_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq']['nomcte01'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']['codcte01'] = $codcte01; 
      if (is_array($codcte01) && !empty($codcte01))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['Grid_search'][$I_Grid]['val'][0] = $codcte01;
      }
      elseif ($codcte01_cond_salva == "nu" || $codcte01_cond_salva == "nn" || $codcte01_cond_salva == "ep" || $codcte01_cond_salva == "ne" || !empty($codcte01))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['Grid_search'][$I_Grid]['val'][0][0] = $codcte01;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']['codcte01_cond'] = $codcte01_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['Grid_search'][$I_Grid]['cmp'] = "codcte01"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['Grid_search'][$I_Grid]['opc'] = $codcte01_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq']['codcte01'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']['tipo_cliente'] = $tipo_cliente; 
      if (is_array($tipo_cliente) && !empty($tipo_cliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['Grid_search'][$I_Grid]['val'][0] = $tipo_cliente;
      }
      elseif ($tipo_cliente_cond_salva == "nu" || $tipo_cliente_cond_salva == "nn" || $tipo_cliente_cond_salva == "ep" || $tipo_cliente_cond_salva == "ne" || !empty($tipo_cliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['Grid_search'][$I_Grid]['val'][0][0] = $tipo_cliente;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']['tipo_cliente_cond'] = $tipo_cliente_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['Grid_search'][$I_Grid]['cmp'] = "tipo_cliente"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['Grid_search'][$I_Grid]['opc'] = $tipo_cliente_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq']['tipo_cliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']['id_nacionalidad'] = $id_nacionalidad; 
      if (is_array($id_nacionalidad) && !empty($id_nacionalidad))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['Grid_search'][$I_Grid]['val'][0] = $id_nacionalidad;
      }
      elseif ($id_nacionalidad_cond_salva == "nu" || $id_nacionalidad_cond_salva == "nn" || $id_nacionalidad_cond_salva == "ep" || $id_nacionalidad_cond_salva == "ne" || !empty($id_nacionalidad))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['Grid_search'][$I_Grid]['val'][0][0] = $id_nacionalidad;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']['id_nacionalidad_cond'] = $id_nacionalidad_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['Grid_search'][$I_Grid]['cmp'] = "id_nacionalidad"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['Grid_search'][$I_Grid]['opc'] = $id_nacionalidad_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['grid_pesq']['id_nacionalidad'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($nomcte01 != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nomcte01'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['nomcte01'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nomcte01'] = $nomcte01;
      }
      $Conteudo = $codcte01;
      if (strtoupper($codcte01_cond) != "II" && strtoupper($codcte01_cond) != "QP" && strtoupper($codcte01_cond) != "NP" && strtoupper($codcte01_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['codcte01'] = $Conteudo;
      $Conteudo = $tipo_cliente;
      if (strtoupper($tipo_cliente_cond) != "II" && strtoupper($tipo_cliente_cond) != "QP" && strtoupper($tipo_cliente_cond) != "NP" && strtoupper($tipo_cliente_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['tipo_cliente'] = $Conteudo;
      $Conteudo = $id_nacionalidad;
      if (strtoupper($id_nacionalidad_cond) != "II" && strtoupper($id_nacionalidad_cond) != "QP" && strtoupper($id_nacionalidad_cond) != "NP" && strtoupper($id_nacionalidad_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['id_nacionalidad'] = $Conteudo;

      //----- $nomcte01
      $this->Date_part = false;
      if (isset($nomcte01) || $nomcte01_cond == "nu" || $nomcte01_cond == "nn" || $nomcte01_cond == "ep" || $nomcte01_cond == "ne")
      {
         $this->monta_condicao("nomcte01", $nomcte01_cond, $nomcte01, "", "nomcte01");
      }

      //----- $codcte01
      $this->Date_part = false;
      if (isset($codcte01) || $codcte01_cond == "nu" || $codcte01_cond == "nn" || $codcte01_cond == "ep" || $codcte01_cond == "ne")
      {
         $this->monta_condicao("codcte01", $codcte01_cond, $codcte01, "", "codcte01");
      }

      //----- $tipo_cliente
      $this->Date_part = false;
      if (isset($tipo_cliente) || $tipo_cliente_cond == "nu" || $tipo_cliente_cond == "nn" || $tipo_cliente_cond == "ep" || $tipo_cliente_cond == "ne")
      {
         $this->monta_condicao("tipo_cliente", $tipo_cliente_cond, $tipo_cliente, "", "tipo_cliente");
      }

      //----- $id_nacionalidad
      $this->Date_part = false;
      if (isset($id_nacionalidad) || $id_nacionalidad_cond == "nu" || $id_nacionalidad_cond == "nn" || $id_nacionalidad_cond == "ep" || $id_nacionalidad_cond == "ne")
      {
         $this->monta_condicao("id_nacionalidad", $id_nacionalidad_cond, $id_nacionalidad, "", "id_nacionalidad");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecte']['cond_pesq'] .= $this->NM_operador;
