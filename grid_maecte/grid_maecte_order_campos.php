...
<?php
   ...
   $Ord_Cmp = new grid_maecte_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_maecte_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_maecte']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_maecte']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['codcte01'] = "codcte01";
   $tab_labels["codcte01"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maecte']['labels']["codcte01"])) ? $_SESSION['sc_session'][$sc_init]['grid_maecte']['labels']["codcte01"] : "Codcte 01";
   $tab_ger_campos['tipo_cliente'] = "on";
   $tab_def_campos['tipo_cliente'] = "tipo_cliente";
   $tab_labels["tipo_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maecte']['labels']["tipo_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_maecte']['labels']["tipo_cliente"] : "Tipo Cliente";
   $tab_ger_campos['id_nacionalidad'] = "on";
   $tab_def_campos['id_nacionalidad'] = "id_nacionalidad";
   $tab_labels["id_nacionalidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maecte']['labels']["id_nacionalidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_maecte']['labels']["id_nacionalidad"] : "Id Nacionalidad";
   $tab_ger_campos['nomcte01'] = "on";
   $tab_def_campos['nomcte01'] = "nomcte01";
   $tab_labels["nomcte01"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maecte']['labels']["nomcte01"])) ? $_SESSION['sc_session'][$sc_init]['grid_maecte']['labels']["nomcte01"] : "Nomcte 01";
   $tab_ger_campos['primer_nombre'] = "on";
   $tab_def_campos['primer_nombre'] = "primer_nombre";
   $tab_labels["primer_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maecte']['labels']["primer_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_maecte']['labels']["primer_nombre"] : "Primer Nombre";
   $tab_ger_campos['segundo_nombre'] = "on";
   $tab_def_campos['segundo_nombre'] = "segundo_nombre";
   $tab_labels["segundo_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maecte']['labels']["segundo_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_maecte']['labels']["segundo_nombre"] : "Segundo Nombre";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_maecte']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_maecte']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_maecte']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_maecte']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_maecte']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_maecte']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_maecte']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_maecte']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_maecte']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_maecte']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_maecte']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_maecte']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_maecte_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_maecte']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_maecte']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_maecte']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_maecte']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_maecte']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
