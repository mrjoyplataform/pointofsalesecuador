<?php
@session_start() ;
$_SESSION['scriptcase']['grid_maecte']['sc_process_barr'] = true;
require_once('../grid_maecte/index.php');
unset($_SESSION['scriptcase']['grid_maecte']['sc_process_barr']);
$ExportCtrl = new grid_maecte_export_control;
$ExportCtrl->Export_barr();

class grid_maecte_export_control
{
