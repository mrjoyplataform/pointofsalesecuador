...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nomcte01_cond" name="nomcte01_cond" onChange="nm_campos_between(document.getElementById('id_vis_nomcte01'), this, 'nomcte01')">
      ...
      <br><span id="id_hide_nomcte01"  <?php echo $str_hide_nomcte01?>><?php
      if ($nomcte01 != "")
      {
      $nomcte01_look = substr($this->Db->qstr($nomcte01), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_codcte01_cond" name="codcte01_cond" onChange="nm_campos_between(document.getElementById('id_vis_codcte01'), this, 'codcte01')">
      ...
      <br><span id="id_hide_codcte01"  <?php echo $str_hide_codcte01?>><INPUT  type="text" id="SC_codcte01" name="codcte01" value="<?php echo NM_encode_input($codcte01) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_tipo_cliente_cond" name="tipo_cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_tipo_cliente'), this, 'tipo_cliente')">
      ...
      <br><span id="id_hide_tipo_cliente"  <?php echo $str_hide_tipo_cliente?>><INPUT  type="text" id="SC_tipo_cliente" name="tipo_cliente" value="<?php echo NM_encode_input($tipo_cliente) ?>" size=3 alt="{datatype: 'integer', maxLength: 3, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_id_nacionalidad_cond" name="id_nacionalidad_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_nacionalidad'), this, 'id_nacionalidad')">
      ...
      <br><span id="id_hide_id_nacionalidad"  <?php echo $str_hide_id_nacionalidad?>><INPUT  type="text" id="SC_id_nacionalidad" name="id_nacionalidad" value="<?php echo NM_encode_input($id_nacionalidad) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
