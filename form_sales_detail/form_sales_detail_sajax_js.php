  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sales_detail" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sales_detail_form();
	}
...
?>
  ...
  function do_ajax_form_sales_detail_validate_id_product_(iNumLinha)
  {
    var nomeCampo_id_product_ = "id_product_" + iNumLinha;
    var var_id_product_ = scAjaxGetFieldSelect(nomeCampo_id_product_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sales_detail_validate_id_product_(var_id_product_, iNumLinha, var_script_case_init, do_ajax_form_sales_detail_validate_id_product__cb);
  } // do_ajax_form_sales_detail_validate_id_product_

  function do_ajax_form_sales_detail_validate_id_product__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sales_detail_validate_id_product__cb

  // ---------- Validate quantity_
  function do_ajax_form_sales_detail_validate_quantity_(iNumLinha)
  {
    var nomeCampo_quantity_ = "quantity_" + iNumLinha;
    var var_quantity_ = scAjaxGetFieldText(nomeCampo_quantity_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sales_detail_validate_quantity_(var_quantity_, iNumLinha, var_script_case_init, do_ajax_form_sales_detail_validate_quantity__cb);
  } // do_ajax_form_sales_detail_validate_quantity_

  function do_ajax_form_sales_detail_validate_quantity__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sales_detail_validate_quantity__cb

  // ---------- Validate unit_value_
  function do_ajax_form_sales_detail_validate_unit_value_(iNumLinha)
  {
    var nomeCampo_unit_value_ = "unit_value_" + iNumLinha;
    var var_unit_value_ = scAjaxGetFieldText(nomeCampo_unit_value_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sales_detail_validate_unit_value_(var_unit_value_, iNumLinha, var_script_case_init, do_ajax_form_sales_detail_validate_unit_value__cb);
  } // do_ajax_form_sales_detail_validate_unit_value_

  function do_ajax_form_sales_detail_validate_unit_value__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "unit_value_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "unit_value_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sales_detail_validate_unit_value__cb

  // ---------- Validate discount_
  function do_ajax_form_sales_detail_validate_discount_(iNumLinha)
  {
    var nomeCampo_discount_ = "discount_" + iNumLinha;
    var var_discount_ = scAjaxGetFieldText(nomeCampo_discount_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sales_detail_validate_discount_(var_discount_, iNumLinha, var_script_case_init, do_ajax_form_sales_detail_validate_discount__cb);
  } // do_ajax_form_sales_detail_validate_discount_

  function do_ajax_form_sales_detail_validate_discount__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sales_detail_validate_discount__cb

  // ---------- Validate item_total_
  function do_ajax_form_sales_detail_validate_item_total_(iNumLinha)
  {
    var nomeCampo_item_total_ = "item_total_" + iNumLinha;
    var var_item_total_ = scAjaxGetFieldText(nomeCampo_item_total_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sales_detail_validate_item_total_(var_item_total_, iNumLinha, var_script_case_init, do_ajax_form_sales_detail_validate_item_total__cb);
  } // do_ajax_form_sales_detail_validate_item_total_

  function do_ajax_form_sales_detail_validate_item_total__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "item_total_" + iLineNumber;
    }
    else
    {
      sFieldValid = "item_total_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "item_total_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "item_total_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sales_detail_validate_item_total__cb

  // ---------- Validate id_sales_detail_
  function do_ajax_form_sales_detail_validate_id_sales_detail_(iNumLinha)
  {
    var nomeCampo_id_sales_detail_ = "id_sales_detail_" + iNumLinha;
    var var_id_sales_detail_ = scAjaxGetFieldHidden(nomeCampo_id_sales_detail_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sales_detail_validate_id_sales_detail_(var_id_sales_detail_, iNumLinha, var_script_case_init, do_ajax_form_sales_detail_validate_id_sales_detail__cb);
  } // do_ajax_form_sales_detail_validate_id_sales_detail_

  function do_ajax_form_sales_detail_validate_id_sales_detail__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_sales_detail_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_sales_detail_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "id_sales_detail_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_sales_detail_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sales_detail_validate_id_sales_detail__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sales_detail_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sales_detail_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sales_detail_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sales_detail_add_new_line_cb);
  } // do_ajax_form_sales_detail_add_new_line

  function do_ajax_form_sales_detail_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sales_detail_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sales_detail_backup_line(iNumLinha)
  {
    var var_id_sales_detail_ = scAjaxGetFieldHidden("id_sales_detail_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sales_detail_backup_line(var_id_sales_detail_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sales_detail_backup_line_cb);
  } // do_ajax_form_sales_detail_backup_line

  function do_ajax_form_sales_detail_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sales_detail_backup_line_cb

  function do_ajax_form_sales_detail_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sales_detail_cancel_insert

  function do_ajax_form_sales_detail_cancel_update(iSeqVert)
  {
    do_ajax_form_sales_detail_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sales_detail_cancel_update

  function do_ajax_form_sales_detail_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sales_detail_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sales_detail_table_refresh()
  {
    var var_id_sales_detail_ = document.F2.id_sales_detail_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sales_detail_table_refresh(var_id_sales_detail_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sales_detail_table_refresh_cb);
  } //  do_ajax_form_sales_detail_table_refresh

  function do_ajax_form_sales_detail_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_sales_detail_.value = scAjaxGetKeyValue("id_sales_detail_");
    ...
    scAjaxAlert(do_ajax_form_sales_detail_table_refresh_cb_after_alert);
  } // do_ajax_form_sales_detail_table_refresh_cb
  function do_ajax_form_sales_detail_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_sales_detail_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sales_detail_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sales_detail_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_unit_value_ = scAjaxGetFieldText("unit_value_" + iNumLinha);
    var var_discount_ = scAjaxGetFieldText("discount_" + iNumLinha);
    var var_item_total_ = scAjaxGetFieldText("item_total_" + iNumLinha);
    var var_id_sales_detail_ = scAjaxGetFieldHidden("id_sales_detail_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sales_detail_submit_form(var_id_product_, var_quantity_, var_unit_value_, var_discount_, var_item_total_, var_id_sales_detail_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_sales_detail_submit_form_cb);
  } // do_ajax_form_sales_detail_submit_form

  function do_ajax_form_sales_detail_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("unit_value_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("discount_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("item_total_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("id_sales_detail_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sales_detail_submit_form_cb_after_alert);
  } // do_ajax_form_sales_detail_submit_form_cb
  function do_ajax_form_sales_detail_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sales_detail_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sales_detail_navigate_form()
  {
    perform_ajax_form_sales_detail_navigate_form();
  }

  function perform_ajax_form_sales_detail_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sales_detail_cancel_insert(sc_form_sales_detail_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("unit_value_" + iNavForm);
      scAjaxHideErrorDisplay("discount_" + iNavForm);
      scAjaxHideErrorDisplay("item_total_" + iNavForm);
      scAjaxHideErrorDisplay("id_sales_detail_" + iNavForm);
    }
    var var_id_sales_detail_ = document.F2.id_sales_detail_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sales_detail_navigate_form(var_id_sales_detail_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sales_detail_navigate_form_cb);
  } // do_ajax_form_sales_detail_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sales_detail']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sales_detail_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_sales_detail_.value = scAjaxGetKeyValue("id_sales_detail_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sales_detail_navigate_form_cb_after_alert);
  } // do_ajax_form_sales_detail_navigate_form_cb
  function do_ajax_form_sales_detail_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_sales_detail_navigate_form_cb_after_alert

    function sc_form_sales_detail_get_last_line_number()
    {
    ...
    } //sc_form_sales_detail_get_last_line_number

  function sc_hide_form_sales_detail_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "item_total_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_sales_detail_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_product_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sales_detail_fld_id_product'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["quantity_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sales_detail_fld_quantity'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["unit_value_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sales_detail_fld_unit_value'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["discount_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sales_detail_fld_discount'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["item_total_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sales_detail_fld_item_total'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["id_sales_detail_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_sales_detail_fld_id_sales_detail'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["item_total_"][iNumLinha] = "item_total_" + iNumLinha;
    ajax_field_mult["id_sales_detail_"][iNumLinha] = "id_sales_detail_" + iNumLinha;
    ...
    ajax_field_id["item_total_" + iNumLinha] = new Array("hidden_field_label_item_total_", "hidden_field_data_item_total_" + iNumLinha);
    ...
    ajax_error_count["item_total_" + iNumLinha] = "off";
    ajax_error_count["id_sales_detail_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["item_total_" + iNumLinha] = "off";
    ajax_read_only["id_sales_detail_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ...
    ajax_read_only["item_total_" + iNumLinha] = "on";
    ajax_read_only["id_sales_detail_" + iNumLinha] = "on";
<?php
}
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["item_total_" + iNumLinha] = null;
    ajax_error_list["id_sales_detail_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "discount_": new Array(),
    "item_total_": new Array(),
    "id_sales_detail_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["item_total_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["item_total_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["item_total_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["item_total_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["item_total_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["id_sales_detail_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_sales_detail_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_sales_detail_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_sales_detail_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_sales_detail_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['item_total_'])) ? $this->nmgp_cmp_readonly['item_total_'] : 'off';
?>
    scAjaxFieldRead("item_total_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_sales_detail_'])) ? $this->nmgp_cmp_readonly['id_sales_detail_'] : 'on';
?>
    scAjaxFieldRead("id_sales_detail_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("item_total_" + iSeq, "on");
    scAjaxFieldRead("id_sales_detail_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_product_" + iRow] || "on" == ajax_error_count["quantity_" + iRow] || "on" == ajax_error_count["unit_value_" + iRow] || "on" == ajax_error_count["discount_" + iRow] || "on" == ajax_error_count["item_total_" + iRow] || "on" == ajax_error_count["id_sales_detail_" + iRow]))
    {
      ...
      $("#hidden_field_data_item_total_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_sales_detail_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_product_" + iRow] && "off" == ajax_error_count["quantity_" + iRow] && "off" == ajax_error_count["unit_value_" + iRow] && "off" == ajax_error_count["discount_" + iRow] && "off" == ajax_error_count["item_total_" + iRow] && "off" == ajax_error_count["id_sales_detail_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["item_total_" + iRow] = "off";
        ajax_error_count["id_sales_detail_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_item_total_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_id_sales_detail_" + iRow).removeClass("scFormErrorLine");
    }
  }
