  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_empleados_main" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_empleados_main_form();
	}
...
?>
  ...
  // ---------- Validate idempleado
  function do_ajax_form_empleados_main_validate_idempleado()
  {
    var nomeCampo_idempleado = "idempleado";
    var var_idempleado = scAjaxGetFieldText(nomeCampo_idempleado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleados_main_validate_idempleado(var_idempleado, var_script_case_init, do_ajax_form_empleados_main_validate_idempleado_cb);
  } // do_ajax_form_empleados_main_validate_idempleado

  function do_ajax_form_empleados_main_validate_idempleado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idempleado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleados_main_validate_idempleado_cb

  // ---------- Validate nombre
  function do_ajax_form_empleados_main_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleados_main_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_empleados_main_validate_nombre_cb);
  } // do_ajax_form_empleados_main_validate_nombre

  function do_ajax_form_empleados_main_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleados_main_validate_nombre_cb

  // ---------- Validate activo
  function do_ajax_form_empleados_main_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldRadio(nomeCampo_activo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleados_main_validate_activo(var_activo, var_script_case_init, do_ajax_form_empleados_main_validate_activo_cb);
  } // do_ajax_form_empleados_main_validate_activo

  function do_ajax_form_empleados_main_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleados_main_validate_activo_cb

  // ---------- Validate cargo
  function do_ajax_form_empleados_main_validate_cargo()
  {
    var nomeCampo_cargo = "cargo";
    var var_cargo = scAjaxGetFieldText(nomeCampo_cargo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleados_main_validate_cargo(var_cargo, var_script_case_init, do_ajax_form_empleados_main_validate_cargo_cb);
  } // do_ajax_form_empleados_main_validate_cargo

  function do_ajax_form_empleados_main_validate_cargo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cargo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleados_main_validate_cargo_cb

  // ---------- Validate menu_default
  function do_ajax_form_empleados_main_validate_menu_default()
  {
    var nomeCampo_menu_default = "menu_default";
    var var_menu_default = scAjaxGetFieldSelect(nomeCampo_menu_default);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleados_main_validate_menu_default(var_menu_default, var_script_case_init, do_ajax_form_empleados_main_validate_menu_default_cb);
  } // do_ajax_form_empleados_main_validate_menu_default

  function do_ajax_form_empleados_main_validate_menu_default_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "menu_default";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleados_main_validate_menu_default_cb

  // ---------- Validate admin
  function do_ajax_form_empleados_main_validate_admin()
  {
    var nomeCampo_admin = "admin";
    var var_admin = scAjaxGetFieldRadio(nomeCampo_admin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleados_main_validate_admin(var_admin, var_script_case_init, do_ajax_form_empleados_main_validate_admin_cb);
  } // do_ajax_form_empleados_main_validate_admin

  function do_ajax_form_empleados_main_validate_admin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "admin";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleados_main_validate_admin_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_empleados_main_submit_page_0(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_empleados_main_submit_page_0(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      url: "form_empleados_main.php",
      method: "POST",
      dataType: "json",
      data: {
        idempleado: scAjaxGetFieldText("idempleado"),
        nombre: scAjaxGetFieldText("nombre"),
        activo: scAjaxGetFieldRadio("activo"),
        cargo: scAjaxGetFieldText("cargo"),
        menu_default: scAjaxGetFieldSelect("menu_default"),
        admin: scAjaxGetFieldRadio("admin"),
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_empleados_main_submit_page_cb_0(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_empleados_main_submit_page_0

  function do_ajax_form_empleados_main_submit_page_cb_0(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
  ...
  } // do_ajax_form_empleados_main_submit_page_cb_0

  function do_ajax_form_empleados_main_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_empleados_main_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idempleado = scAjaxGetFieldText("idempleado");
    var var_nombre = scAjaxGetFieldText("nombre");
    var var_activo = scAjaxGetFieldRadio("activo");
    var var_cargo = scAjaxGetFieldText("cargo");
    var var_menu_default = scAjaxGetFieldSelect("menu_default");
    var var_admin = scAjaxGetFieldRadio("admin");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_empleados_main_submit_form(var_idempleado, var_nombre, var_activo, var_cargo, var_menu_default, var_admin, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_empleados_main_submit_form_cb);
  } // do_ajax_form_empleados_main_submit_form

  function do_ajax_form_empleados_main_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxUpdateErrors("valid");
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idempleado");
      scAjaxHideErrorDisplay("nombre");
      scAjaxHideErrorDisplay("activo");
      scAjaxHideErrorDisplay("cargo");
      scAjaxHideErrorDisplay("menu_default");
      scAjaxHideErrorDisplay("admin");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_empleados_main_submit_form_cb_after_alert);
  } // do_ajax_form_empleados_main_submit_form_cb
  function do_ajax_form_empleados_main_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_empleados_main_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_empleados_main_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_empleados_main_navigate_form, function() {});
    } else {
      perform_ajax_form_empleados_main_navigate_form();
    }
  }

  function perform_ajax_form_empleados_main_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("menu_default");
    scAjaxHideErrorDisplay("admin");
    var var_idempleado = document.F2.idempleado.value;
    ...
    scAjaxProcOn();
    x_ajax_form_empleados_main_navigate_form(var_idempleado, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_empleados_main_navigate_form_cb);
  } // do_ajax_form_empleados_main_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleados_main']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_empleados_main_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idempleado.value = scAjaxGetKeyValue("idempleado");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_empleados_main_navigate_form_cb_after_alert);
  } // do_ajax_form_empleados_main_navigate_form_cb
  function do_ajax_form_empleados_main_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_empleados_main_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_empleados_main_navigate_form_cb_after_alert

  function sc_hide_form_empleados_main_form()
  {
  ...
  ajax_field_list[0] = "idempleado";
  ajax_field_list[1] = "nombre";
  ajax_field_list[2] = "activo";
  ajax_field_list[3] = "cargo";
  ajax_field_list[4] = "menu_default";
  ajax_field_list[5] = "admin";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idempleado": {"label": "Idempleado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "menu_default": {"label": "Menu Default", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "admin": {"label": "Admin", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "idempleado": new Array(),
    "nombre": new Array(),
    "activo": new Array(),
    "cargo": new Array(),
    "menu_default": new Array(),
    "admin": new Array()
  };
  ajax_field_mult["idempleado"][1] = "idempleado";
  ajax_field_mult["nombre"][1] = "nombre";
  ajax_field_mult["activo"][1] = "activo";
  ajax_field_mult["cargo"][1] = "cargo";
  ajax_field_mult["menu_default"][1] = "menu_default";
  ajax_field_mult["admin"][1] = "admin";

  var ajax_field_id = {
    "idempleado": new Array("hidden_field_label_idempleado", "hidden_field_data_idempleado"),
    ...
    "menu_default": new Array("hidden_field_label_menu_default", "hidden_field_data_menu_default"),
    "admin": new Array("hidden_field_label_admin", "hidden_field_data_admin")
  };
