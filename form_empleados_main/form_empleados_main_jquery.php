...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idempleado' + iSeqRow).bind('blur', function() { sc_form_empleados_main_idempleado_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_empleados_main_idempleado_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_empleados_main_idempleado_onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre' + iSeqRow).bind('blur', function() { sc_form_empleados_main_nombre_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_empleados_main_nombre_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_empleados_main_nombre_onfocus(this, iSeqRow) });
  $('#id_sc_field_activo' + iSeqRow).bind('blur', function() { sc_form_empleados_main_activo_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_empleados_main_activo_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_empleados_main_activo_onfocus(this, iSeqRow) });
  $('#id_sc_field_codigo' + iSeqRow).bind('change', function() { sc_form_empleados_main_codigo_onchange(this, iSeqRow) });
  $('#id_sc_field_cargo' + iSeqRow).bind('blur', function() { sc_form_empleados_main_cargo_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_empleados_main_cargo_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_empleados_main_cargo_onfocus(this, iSeqRow) });
  $('#id_sc_field_menu_default' + iSeqRow).bind('blur', function() { sc_form_empleados_main_menu_default_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_empleados_main_menu_default_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_empleados_main_menu_default_onfocus(this, iSeqRow) });
  $('#id_sc_field_admin' + iSeqRow).bind('blur', function() { sc_form_empleados_main_admin_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_empleados_main_admin_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_empleados_main_admin_onfocus(this, iSeqRow) });
...
function sc_form_empleados_main_idempleado_onblur(oThis, iSeqRow) {
  do_ajax_form_empleados_main_validate_idempleado();
  scCssBlur(oThis);
}

function sc_form_empleados_main_idempleado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_empleados_main_idempleado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_empleados_main_nombre_onblur(oThis, iSeqRow) {
  do_ajax_form_empleados_main_validate_nombre();
  scCssBlur(oThis);
}

function sc_form_empleados_main_nombre_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_empleados_main_nombre_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_empleados_main_activo_onblur(oThis, iSeqRow) {
  do_ajax_form_empleados_main_validate_activo();
  scCssBlur(oThis);
}

function sc_form_empleados_main_activo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_empleados_main_activo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_empleados_main_codigo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_empleados_main_cargo_onblur(oThis, iSeqRow) {
  do_ajax_form_empleados_main_validate_cargo();
  scCssBlur(oThis);
}

function sc_form_empleados_main_cargo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_empleados_main_cargo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_empleados_main_menu_default_onblur(oThis, iSeqRow) {
  do_ajax_form_empleados_main_validate_menu_default();
  scCssBlur(oThis);
}

function sc_form_empleados_main_menu_default_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_empleados_main_menu_default_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_empleados_main_admin_onblur(oThis, iSeqRow) {
  do_ajax_form_empleados_main_validate_admin();
  scCssBlur(oThis);
}

function sc_form_empleados_main_admin_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_empleados_main_admin_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_empleados_main_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_empleados_main')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
...
var wizardActualStep = <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleados_main']['form_wizard']['actual_step']; ?>;
var wizardTotalSteps = <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_empleados_main']['form_wizard']['total_steps']; ?>;
...
function scJQWizardValidateStep(stepGoTo)
{
    if (0 == wizardActualStep) {
        do_ajax_form_empleados_main_submit_page_0(stepGoTo);
    }
}
...
{
    $("#form_empleados_main_form" + stepNo).css({
        "width": "1px",
        "height": "0",
        "display": "none",
        "overflow": "scroll",
