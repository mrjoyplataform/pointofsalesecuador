...
<?php
   ...
   $Ord_Cmp = new grid_v_ele_impuestos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_ele_impuestos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['labels']["id"] : "Id";
   $tab_ger_campos['codigo'] = "on";
   $tab_def_campos['codigo'] = "codigo";
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['labels']["codigo"] : "Codigo";
   $tab_ger_campos['numero'] = "on";
   $tab_def_campos['numero'] = "numero";
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['labels']["numero"] : "Numero";
   $tab_ger_campos['codigo_impuesto'] = "on";
   $tab_def_campos['codigo_impuesto'] = "codigo_impuesto";
   $tab_labels["codigo_impuesto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['labels']["codigo_impuesto"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['labels']["codigo_impuesto"] : "Codigo Impuesto";
   $tab_ger_campos['codigo_porcentaje'] = "on";
   $tab_def_campos['codigo_porcentaje'] = "codigo_porcentaje";
   $tab_labels["codigo_porcentaje"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['labels']["codigo_porcentaje"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['labels']["codigo_porcentaje"] : "Codigo Porcentaje";
   $tab_ger_campos['base_imponible'] = "on";
   $tab_def_campos['base_imponible'] = "base_imponible";
   $tab_labels["base_imponible"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['labels']["base_imponible"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['labels']["base_imponible"] : "Base Imponible";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_ele_impuestos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_ele_impuestos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
