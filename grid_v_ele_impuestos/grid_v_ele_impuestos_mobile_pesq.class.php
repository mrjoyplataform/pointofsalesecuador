...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "base_imponible";$Nm_numeric[] = "tarifa";$Nm_numeric[] = "valor";$Nm_numeric[] = "id";$Nm_numeric[] = "base_imponible";$Nm_numeric[] = "tarifa";$Nm_numeric[] = "valor";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_codigo_impuesto_cond" name="codigo_impuesto_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigo_impuesto'), this, 'codigo_impuesto')">
      ...
      <br><span id="id_hide_codigo_impuesto"  <?php echo $str_hide_codigo_impuesto?>><?php
      if ($codigo_impuesto != "")
      {
      $codigo_impuesto_look = substr($this->Db->qstr($codigo_impuesto), 1, -1); 
      $nmgp_def_dados = array(); 
