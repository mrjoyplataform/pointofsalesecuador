  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_product_combo" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_product_combo_form();
	}
...
?>
  ...
  // ---------- Validate idproducto_
  function do_ajax_form_product_combo_validate_idproducto_(iNumLinha)
  {
    var nomeCampo_idproducto_ = "idproducto_" + iNumLinha;
    var var_idproducto_ = scAjaxGetFieldText(nomeCampo_idproducto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_combo_validate_idproducto_(var_idproducto_, iNumLinha, var_script_case_init, do_ajax_form_product_combo_validate_idproducto__cb);
  } // do_ajax_form_product_combo_validate_idproducto_

  function do_ajax_form_product_combo_validate_idproducto__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idproducto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idproducto_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idproducto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idproducto_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_combo_validate_idproducto__cb

  // ---------- Validate idproducto_receta_
  function do_ajax_form_product_combo_validate_idproducto_receta_(iNumLinha)
  {
    var nomeCampo_idproducto_receta_ = "idproducto_receta_" + iNumLinha;
    var var_idproducto_receta_ = scAjaxGetFieldSelect(nomeCampo_idproducto_receta_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_combo_validate_idproducto_receta_(var_idproducto_receta_, iNumLinha, var_script_case_init, do_ajax_form_product_combo_validate_idproducto_receta__cb);
  } // do_ajax_form_product_combo_validate_idproducto_receta_

  function do_ajax_form_product_combo_validate_idproducto_receta__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idproducto_receta_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idproducto_receta_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idproducto_receta_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idproducto_receta_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_combo_validate_idproducto_receta__cb

  // ---------- Validate cantidad_
  function do_ajax_form_product_combo_validate_cantidad_(iNumLinha)
  {
    var nomeCampo_cantidad_ = "cantidad_" + iNumLinha;
    var var_cantidad_ = scAjaxGetFieldText(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_combo_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_product_combo_validate_cantidad__cb);
  } // do_ajax_form_product_combo_validate_cantidad_

  function do_ajax_form_product_combo_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_combo_validate_cantidad__cb

  // ---------- Validate unidad_
  function do_ajax_form_product_combo_validate_unidad_(iNumLinha)
  {
    var nomeCampo_unidad_ = "unidad_" + iNumLinha;
    var var_unidad_ = scAjaxGetFieldSelect(nomeCampo_unidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_combo_validate_unidad_(var_unidad_, iNumLinha, var_script_case_init, do_ajax_form_product_combo_validate_unidad__cb);
  } // do_ajax_form_product_combo_validate_unidad_

  function do_ajax_form_product_combo_validate_unidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_combo_validate_unidad__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_product_combo_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_product_combo_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_product_combo_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_product_combo_add_new_line_cb);
  } // do_ajax_form_product_combo_add_new_line

  function do_ajax_form_product_combo_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_product_combo_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_product_combo_backup_line(iNumLinha)
  {
    var var_idproducto_ = scAjaxGetFieldText("idproducto_" + iNumLinha);
    var var_idproducto_receta_ = scAjaxGetFieldSelect("idproducto_receta_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_combo_backup_line(var_idproducto_, var_idproducto_receta_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_product_combo_backup_line_cb);
  } // do_ajax_form_product_combo_backup_line

  function do_ajax_form_product_combo_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_product_combo_backup_line_cb

  function do_ajax_form_product_combo_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_product_combo_cancel_insert

  function do_ajax_form_product_combo_cancel_update(iSeqVert)
  {
    do_ajax_form_product_combo_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_product_combo_cancel_update

  function do_ajax_form_product_combo_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_product_combo_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_product_combo_table_refresh()
  {
    var var_idproducto_ = document.F2.idproducto_.value;
    var var_idproducto_receta_ = document.F2.idproducto_receta_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_product_combo_table_refresh(var_idproducto_, var_idproducto_receta_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_product_combo_table_refresh_cb);
  } //  do_ajax_form_product_combo_table_refresh

  function do_ajax_form_product_combo_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idproducto_.value = scAjaxGetKeyValue("idproducto_");
    document.F2.idproducto_receta_.value = scAjaxGetKeyValue("idproducto_receta_");
    ...
    scAjaxAlert(do_ajax_form_product_combo_table_refresh_cb_after_alert);
  } // do_ajax_form_product_combo_table_refresh_cb
  function do_ajax_form_product_combo_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_product_combo_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_product_combo_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_product_combo_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_unidad_ = scAjaxGetFieldSelect("unidad_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_product_combo_submit_form(var_idproducto_, var_idproducto_receta_, var_cantidad_, var_unidad_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_product_combo_submit_form_cb);
  } // do_ajax_form_product_combo_submit_form

  function do_ajax_form_product_combo_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("idproducto_receta_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_product_combo_submit_form_cb_after_alert);
  } // do_ajax_form_product_combo_submit_form_cb
  function do_ajax_form_product_combo_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_product_combo_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_product_combo_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_product_combo_navigate_form, function() {});
    } else {
      perform_ajax_form_product_combo_navigate_form();
    }
  }

  function perform_ajax_form_product_combo_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_product_combo_cancel_insert(sc_form_product_combo_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("idproducto_receta_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_product_combo_navigate_form(var_idproducto_, var_idproducto_receta_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_product_combo_navigate_form_cb);
  } // do_ajax_form_product_combo_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_combo']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_product_combo_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idproducto_.value = scAjaxGetKeyValue("idproducto_" + var_last_index);
    document.F2.idproducto_receta_.value = scAjaxGetKeyValue("idproducto_receta_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_product_combo_navigate_form_cb_after_alert);
  } // do_ajax_form_product_combo_navigate_form_cb
  function do_ajax_form_product_combo_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_product_combo_navigate_form_cb_after_alert

    function sc_form_product_combo_get_last_line_number()
    {
    ...
    } //sc_form_product_combo_get_last_line_number

  function sc_hide_form_product_combo_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idproducto_receta_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cantidad_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "unidad_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idproducto_" + iNumLinha] = {"label": "Idproducto<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idproducto_receta_" + iNumLinha] = {"label": "Idproducto Receta<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["idproducto_receta_"][iNumLinha] = "idproducto_receta_" + iNumLinha;
    ajax_field_mult["cantidad_"][iNumLinha] = "cantidad_" + iNumLinha;
    ajax_field_mult["unidad_"][iNumLinha] = "unidad_" + iNumLinha;
    ajax_field_id["idproducto_receta_" + iNumLinha] = new Array("hidden_field_label_idproducto_receta_", "hidden_field_data_idproducto_receta_" + iNumLinha);
    ...
    ajax_error_count["idproducto_receta_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["idproducto_receta_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["idproducto_receta_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idproducto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idproducto_" + iNumLinha]["onblur"] = new Array();
      ...
      ajax_error_list["idproducto_receta_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idproducto_receta_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idproducto_receta_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idproducto_receta_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idproducto_receta_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idproducto_'])) ? $this->nmgp_cmp_readonly['idproducto_'] : 'on';
?>
    scAjaxFieldRead("idproducto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idproducto_receta_'])) ? $this->nmgp_cmp_readonly['idproducto_receta_'] : 'on';
?>
    scAjaxFieldRead("idproducto_receta_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("idproducto_receta_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idproducto_" + iRow] || "on" == ajax_error_count["idproducto_receta_" + iRow] || "on" == ajax_error_count["cantidad_" + iRow] || "on" == ajax_error_count["unidad_" + iRow]))
    {
      ...
      $("#hidden_field_data_idproducto_receta_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idproducto_" + iRow] && "off" == ajax_error_count["idproducto_receta_" + iRow] && "off" == ajax_error_count["cantidad_" + iRow] && "off" == ajax_error_count["unidad_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idproducto_" + iRow] = "off";
        ajax_error_count["idproducto_receta_" + iRow] = "off";
      ...
      $("#hidden_field_data_idproducto_receta_" + iRow).removeClass("scFormErrorLine");
