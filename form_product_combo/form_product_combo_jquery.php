...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["idproducto_receta_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["idproducto_receta_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["idproducto_receta_" + iSeqRow]["change"]) {
    return true;
  }
...
function scEventControl_onFocus(oField, iSeq) {
  ...
  if ("idproducto_receta_" + iSeq == fieldName) {
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idproducto_' + iSeqRow).bind('blur', function() { sc_form_product_combo_idproducto__onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_product_combo_idproducto__onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_product_combo_idproducto__onfocus(this, iSeqRow) });
  $('#id_sc_field_idproducto_receta_' + iSeqRow).bind('blur', function() { sc_form_product_combo_idproducto_receta__onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_form_product_combo_idproducto_receta__onchange(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_product_combo_idproducto_receta__onfocus(this, iSeqRow) });
  $('#id_sc_field_cantidad_' + iSeqRow).bind('blur', function() { sc_form_product_combo_cantidad__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_product_combo_cantidad__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_product_combo_cantidad__onfocus(this, iSeqRow) });
  $('#id_sc_field_unidad_' + iSeqRow).bind('blur', function() { sc_form_product_combo_unidad__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_product_combo_unidad__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_product_combo_unidad__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_product_combo_idproducto__onblur(oThis, iSeqRow) {
  do_ajax_form_product_combo_validate_idproducto_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_product_combo_idproducto__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_product_combo_idproducto__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_product_combo_idproducto_receta__onblur(oThis, iSeqRow) {
  do_ajax_form_product_combo_validate_idproducto_receta_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_product_combo_idproducto_receta__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_product_combo_idproducto_receta__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_product_combo_cantidad__onblur(oThis, iSeqRow) {
  do_ajax_form_product_combo_validate_cantidad_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_product_combo_cantidad__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_product_combo_cantidad__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_product_combo_unidad__onblur(oThis, iSeqRow) {
  do_ajax_form_product_combo_validate_unidad_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_product_combo_unidad__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_product_combo_unidad__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function displayChange_block_0(status) {
	...
	displayChange_field("idproducto_receta_", "", status);
...
function displayChange_row(row, status) {
	...
	displayChange_field_idproducto_receta_(row, status);
...
function displayChange_field_idproducto_receta_(row, status) {
    var fieldId;
}
...
function scHidePage(pageNo) {
	$("#id_form_product_combo_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_product_combo')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
