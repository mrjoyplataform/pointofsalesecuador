...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_movpag"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_movpag"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_movpag'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_movpag']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_movpag']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_movpag']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_movpag']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_movpag']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_movpag']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_movpag']['embutida_filho'] as $ind => $sc_init)
          {
