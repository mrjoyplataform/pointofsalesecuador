<?php
@session_start() ;
$_SESSION['scriptcase']['grid_movpag']['sc_process_barr'] = true;
require_once('../grid_movpag/index.php');
unset($_SESSION['scriptcase']['grid_movpag']['sc_process_barr']);
$ExportCtrl = new grid_movpag_export_control;
$ExportCtrl->Export_barr();

class grid_movpag_export_control
{
