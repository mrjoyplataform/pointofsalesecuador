...
<?php
   ...
   $Ord_Cmp = new grid_movpag_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_movpag_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_movpag']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_movpag']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codcte43"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movpag']['labels']["codcte43"])) ? $_SESSION['sc_session'][$sc_init]['grid_movpag']['labels']["codcte43"] : "Codcte 43";
   $tab_ger_campos['tipodoc43'] = "on";
   $tab_def_campos['tipodoc43'] = "tipodoc43";
   $tab_labels["tipodoc43"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movpag']['labels']["tipodoc43"])) ? $_SESSION['sc_session'][$sc_init]['grid_movpag']['labels']["tipodoc43"] : "Tipodoc 43";
   $tab_ger_campos['numdoc43'] = "on";
   $tab_def_campos['numdoc43'] = "numdoc43";
   $tab_labels["numdoc43"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movpag']['labels']["numdoc43"])) ? $_SESSION['sc_session'][$sc_init]['grid_movpag']['labels']["numdoc43"] : "Numdoc 43";
   $tab_ger_campos['ocurren43'] = "on";
   $tab_def_campos['ocurren43'] = "ocurren43";
   $tab_labels["ocurren43"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movpag']['labels']["ocurren43"])) ? $_SESSION['sc_session'][$sc_init]['grid_movpag']['labels']["ocurren43"] : "Ocurren 43";
   $tab_ger_campos['cocte43'] = "on";
   $tab_def_campos['cocte43'] = "cocte43";
   $tab_labels["cocte43"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movpag']['labels']["cocte43"])) ? $_SESSION['sc_session'][$sc_init]['grid_movpag']['labels']["cocte43"] : "Cocte 43";
   $tab_ger_campos['fecdoc43'] = "on";
   $tab_def_campos['fecdoc43'] = "fecdoc43";
   $tab_labels["fecdoc43"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movpag']['labels']["fecdoc43"])) ? $_SESSION['sc_session'][$sc_init]['grid_movpag']['labels']["fecdoc43"] : "Fecdoc 43";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_movpag']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_movpag']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_movpag']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_movpag']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_movpag']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_movpag']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_movpag']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_movpag']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_movpag']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_movpag']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_movpag']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_movpag']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_movpag_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_movpag']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_movpag']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_movpag']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_movpag']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_movpag']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
