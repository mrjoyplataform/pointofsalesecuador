<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tarjetasrfid_consulta']['sc_process_barr'] = true;
require_once('../grid_tarjetasrfid_consulta/index.php');
unset($_SESSION['scriptcase']['grid_tarjetasrfid_consulta']['sc_process_barr']);
$ExportCtrl = new grid_tarjetasrfid_consulta_export_control;
$ExportCtrl->Export_barr();

class grid_tarjetasrfid_consulta_export_control
{
