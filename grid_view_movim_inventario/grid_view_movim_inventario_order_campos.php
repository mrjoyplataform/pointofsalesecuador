...
<?php
   ...
   $Ord_Cmp = new grid_view_movim_inventario_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_view_movim_inventario_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id_product"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["id_product"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["id_product"] : "Id Product";
   $tab_ger_campos['product_name'] = "on";
   $tab_def_campos['product_name'] = "product_name";
   $tab_labels["product_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["product_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["product_name"] : "Product Name";
   $tab_ger_campos['quantity'] = "on";
   $tab_def_campos['quantity'] = "quantity";
   $tab_labels["quantity"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["quantity"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["quantity"] : "Quantity";
   $tab_ger_campos['iddoc'] = "on";
   $tab_def_campos['iddoc'] = "iddoc";
   $tab_labels["iddoc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["iddoc"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["iddoc"] : "Iddoc";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["tipo"] : "Tipo";
   $tab_ger_campos['unit_cost'] = "on";
   $tab_def_campos['unit_cost'] = "unit_cost";
   $tab_labels["unit_cost"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["unit_cost"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["unit_cost"] : "Unit Cost";
   $tab_ger_campos['unit_venta'] = "on";
   $tab_def_campos['unit_venta'] = "unit_venta";
   $tab_labels["unit_venta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["unit_venta"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["unit_venta"] : "Unit Venta";
   $tab_ger_campos['costo_unit_venta'] = "on";
   $tab_def_campos['costo_unit_venta'] = "costo_unit_venta";
   $tab_labels["costo_unit_venta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["costo_unit_venta"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["costo_unit_venta"] : "Costo Unit Venta";
   $tab_ger_campos['costo_compra'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['costo_compra'] = "costo_compra";
   }
   else
   {
       $tab_def_campos['costo_compra'] = "(unit_cost*quantity)";
   }
   $tab_labels["costo_compra"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["costo_compra"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["costo_compra"] : "Costo Compra";
   $tab_ger_campos['valor_venta'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['valor_venta'] = "valor_venta";
   }
   else
   {
       $tab_def_campos['valor_venta'] = "(unit_venta*abs(quantity))";
   }
   $tab_labels["valor_venta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["valor_venta"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["valor_venta"] : "Valor Venta";
   $tab_ger_campos['costo_venta'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['costo_venta'] = "costo_venta";
   }
   else
   {
       $tab_def_campos['costo_venta'] = "(costo_unit_venta*abs(quantity))";
   }
   $tab_labels["costo_venta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["costo_venta"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['labels']["costo_venta"] : "Costo Venta";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_view_movim_inventario_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_view_movim_inventario']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
