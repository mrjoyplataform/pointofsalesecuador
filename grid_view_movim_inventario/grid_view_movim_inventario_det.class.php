<?php
//--- 
class grid_view_movim_inventario_det
{
   var $Ini;
   var $Erro;
   var $Db;
 ...
 function monta_det()
 {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['seq_dir'] = 0; 
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['sub_dir'] = array(); 
   ...
   { 
       $nmgp_select = "SELECT id_product, quantity, iddoc, fecha, tipo, product_name, unit_cost, unit_venta, costo_unit_venta, (unit_cost*quantity) as costo_compra, (unit_venta*abs(quantity)) as valor_venta, (costo_unit_venta*abs(quantity)) as costo_venta from " . $this->Ini->nm_tabela; 
   } 
   ...
   { 
       $nmgp_select = "SELECT id_product, quantity, iddoc, TO_DATE(TO_CHAR(fecha, 'yyyy-mm-dd hh24:mi:ss'), 'yyyy-mm-dd hh24:mi:ss'), tipo, product_name, unit_cost, unit_venta, costo_unit_venta, (unit_cost*quantity) as costo_compra, (unit_venta*abs(quantity)) as valor_venta, (costo_unit_venta*abs(quantity)) as costo_venta from " . $this->Ini->nm_tabela; 
   } 
   ...
   $parms_det = explode("*PDet*", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['chave_det']) ; 
   ...
   {
       $nmgp_select .= " where  id_product = $parms_det[0] and product_name = '$parms_det[1]' and quantity = $parms_det[2] and iddoc = $parms_det[3] and fecha = '$parms_det[4]' and tipo = '$parms_det[5]' and unit_cost = $parms_det[6] and unit_venta = $parms_det[7] and costo_unit_venta = $parms_det[8]" ;  
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
   {
       $nmgp_select .= " where  id_product = $parms_det[0] and product_name = '$parms_det[1]' and quantity = $parms_det[2] and iddoc = $parms_det[3] and fecha = '$parms_det[4]' and tipo = '$parms_det[5]' and unit_cost = $parms_det[6] and unit_venta = $parms_det[7] and costo_unit_venta = $parms_det[8]" ;  
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['cmp_acum']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['cmp_acum']))
   {
       $parms_acum = explode(";", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['cmp_acum']);
...
$nm_saida->saida("</script>\r\n");
   ...
   if (($this->Ini->sc_export_ajax || $this->Ini->Export_det_zip) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['det_print'] == "print")
   {
       ...
       $NM_css_cmp  = $this->Ini->path_link . "grid_view_movim_inventario/grid_view_movim_inventario_det_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css";
   ...
   elseif (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['det_print'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
   {
       ...
       $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_view_movim_inventario/grid_view_movim_inventario_det_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
   }
   else
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pdf_det'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['det_print'] != "print")
   {
   ...
   $nm_saida->saida("</HEAD>\r\n");
    $removeMargin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['link_info']['remove_margin'] ? 'margin: 0;' : '';
    $removeBorder = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['link_info']['remove_border'] ? 'border-width: 0' : '';
   if (!$this->Ini->Export_html_zip && !$this->Ini->Export_det_zip && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['det_print'] == "print")
   {
       $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['link_info']['compact_mode']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['link_info']['compact_mode']) {
   ...
   $conteudo = trim(sc_strip_script($this->id_product)); 
   ...
   $conteudo = trim(NM_encode_input(sc_strip_script($this->iddoc))); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'iddoc', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'iddoc', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_iddoc_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_iddoc_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['opcao'] == "pdf")
   ...
   $conteudo = trim(sc_strip_script($this->product_name)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
   ...
   $conteudo = trim(NM_encode_input(sc_strip_script($this->unit_venta))); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'unit_venta', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'unit_venta', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_unit_venta_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_unit_venta_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['opcao'] == "pdf")
   ...
   $conteudo = trim(NM_encode_input(sc_strip_script($this->costo_unit_venta))); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'costo_unit_venta', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'costo_unit_venta', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_costo_unit_venta_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_costo_unit_venta_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['opcao'] == "pdf")
   ...
   $conteudo = trim(NM_encode_input(sc_strip_script($this->costo_compra))); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'costo_compra', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'costo_compra', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_costo_compra_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_costo_compra_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['opcao'] == "pdf")
   ...
   $conteudo = trim(NM_encode_input(sc_strip_script($this->valor_venta))); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'valor_venta', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'valor_venta', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_valor_venta_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_valor_venta_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['opcao'] == "pdf")
   ...
   $conteudo = trim(NM_encode_input(sc_strip_script($this->costo_venta))); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'costo_venta', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'costo_venta', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_costo_venta_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_costo_venta_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("</TABLE>\r\n");
   if(isset($_SESSION['scriptcase']['proc_mobile']) && $_SESSION['scriptcase']['proc_mobile'])
...
//--- 
   ...
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       NovaJanela = window.open (\"grid_view_movim_inventario_doc.php?nmgp_parms=\" + campo1, \"ScriptCase\", \"resizable\");\r\n");
   $nm_saida->saida("   }\r\n");
   ...
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   $nm_saida->saida("           window.location = \"" . $this->Ini->path_link . "grid_view_movim_inventario/index.php?nmgp_opcao=pdf_det&nmgp_tipo_pdf=\" + z + \"&nmgp_parms_pdf=\" + p +  \"&nmgp_graf_pdf=\" + g + \"&Det_use_pass_pdf=\" + use_pass_pdf + \"&Det_pdf_zip=\" + pdf_zip + \"&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "\";\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("   }\r\n");
   ...
   {
      global $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['det_print'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pdf_det']) 
   { 
       ...
       if ($this->nmgp_botoes['det_pdf'] == "on")
       {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Dpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_view_movim_inventario/grid_view_movim_inventario_config_pdf.php?nm_opc=pdf_det&nm_target=0&nm_cor=cor&papel=8&orientacao=1&largura=1200&conf_larg=S&conf_fonte=10&language=es&conf_socor=N&sc_ver_93=" . s . "&password=n&pdf_zip=N&KeepThis=false&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
       if ($this->nmgp_botoes['det_print'] == "on")
       {
         $this->nm_btn_exist['det_print'][] = "Dprint_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Dprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_view_movim_inventario/grid_view_movim_inventario_config_print.php?nm_opc=detalhe&nm_cor=CO&password=n&language=es&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
