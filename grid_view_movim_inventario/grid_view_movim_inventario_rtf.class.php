...
class grid_view_movim_inventario_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_view_movim_inventario.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['rtf_name']);
      }
   ...
   function NM_export_unit_venta()
   {
         ...
         $this->unit_venta = str_replace('<', '&lt;', $this->unit_venta);
         $this->unit_venta = str_replace('>', '&gt;', $this->unit_venta);
         $this->Texto_tag .= "<td>" . $this->unit_venta . "</td>\r\n";
   }
   //----- costo_unit_venta
   function NM_export_costo_unit_venta()
   {
         ...
         $this->costo_unit_venta = str_replace('<', '&lt;', $this->costo_unit_venta);
         $this->costo_unit_venta = str_replace('>', '&gt;', $this->costo_unit_venta);
         $this->Texto_tag .= "<td>" . $this->costo_unit_venta . "</td>\r\n";
   }
   //----- costo_compra
   function NM_export_costo_compra()
   {
         ...
         $this->costo_compra = str_replace('<', '&lt;', $this->costo_compra);
         $this->costo_compra = str_replace('>', '&gt;', $this->costo_compra);
         $this->Texto_tag .= "<td>" . $this->costo_compra . "</td>\r\n";
   }
   //----- valor_venta
   function NM_export_valor_venta()
   {
         ...
         $this->valor_venta = str_replace('<', '&lt;', $this->valor_venta);
         $this->valor_venta = str_replace('>', '&gt;', $this->valor_venta);
         $this->Texto_tag .= "<td>" . $this->valor_venta . "</td>\r\n";
   }
   //----- costo_venta
   function NM_export_costo_venta()
   {
         ...
         $this->costo_venta = str_replace('<', '&lt;', $this->costo_venta);
         $this->costo_venta = str_replace('>', '&gt;', $this->costo_venta);
         $this->Texto_tag .= "<td>" . $this->costo_venta . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>KARDEX INVENTARIOS :: RTF</TITLE>
