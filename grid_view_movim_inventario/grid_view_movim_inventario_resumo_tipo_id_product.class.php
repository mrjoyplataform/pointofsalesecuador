...
class grid_view_movim_inventario_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_id_product = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_view_movim_inventario']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_view_movim_inventario']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['contr_total_geral'] == "OK")
      {
          $this->array_total_tipo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['arr_total']['tipo'];
          $this->array_total_id_product = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['arr_total']['id_product'];
      }
      else
      {
          $this->array_total_tipo = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['tot_geral'][3];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['tot_geral'][4];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['tot_geral'][5];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['tot_geral'][6];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['tot_geral'][7];
      $this->array_total_geral[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['tot_geral'][8];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['arr_total']['tipo'] = $this->array_total_tipo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['arr_total']['id_product'] = $this->array_total_id_product;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['json_use_label'])
       {
          $Lab_tipo = "tipo";
          $Lab_id_product = "id_product";
       }
       else
       {
       $Lab_tipo = "Tipo";
       $Lab_id_product = "Id Product";
       }
       $this->comp_field = array(
           $Lab_tipo,
           $Lab_id_product,
       );
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['tipo'] = $Lab_tipo; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['id_product'] = $Lab_id_product; 

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['id_product']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['id_product'] = "Id Product"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['product_name']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['product_name'] = "Product Name"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['quantity']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['quantity'] = "Quantity"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['iddoc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['iddoc'] = "Iddoc"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['fecha'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['tipo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['tipo'] = "Tipo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['unit_cost']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['unit_cost'] = "Unit Cost"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['unit_venta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['unit_venta'] = "Unit Venta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['costo_unit_venta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['costo_unit_venta'] = "Costo Unit Venta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['costo_compra']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['costo_compra'] = "Costo Compra"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['valor_venta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['valor_venta'] = "Valor Venta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['costo_venta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['labels']['costo_venta'] = "Costo Venta"; 
       }
       //-----
       $this->comp_field_nm = array(
           'tipo' => 0,
       ...
       $this->comp_sum = array(
           ...
           3 => "Unit Cost (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")",
           4 => "Unit Venta (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")",
           5 => "Costo Unit Venta (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")",
           6 => "Costo Compra (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           7 => "Valor Venta (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           8 => "Costo Venta (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['summarizing_fields_order']['tipo_id_product']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['summarizing_fields_order']['tipo_id_product'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['summarizing_fields_order']['tipo_id_product'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['summarizing_fields_display']['tipo_id_product'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['summarizing_fields_display']['tipo_id_product'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['summarizing_fields_display']['tipo_id_product'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['summarizing_fields_display']['tipo_id_product'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['summarizing_fields_display']['tipo_id_product'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['summarizing_fields_display']['tipo_id_product'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['summarizing_fields_display']['tipo_id_product'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           3 => array('field' => "unit_cost", 'show' => true),
           4 => array('field' => "unit_venta", 'show' => true),
           5 => array('field' => "costo_unit_venta", 'show' => true),
           6 => array('field' => "costo_compra", 'show' => true),
           7 => array('field' => "valor_venta", 'show' => true),
           8 => array('field' => "costo_venta", 'show' => true),
       );
       ...
       $this->comp_sum_css = array(
           2 => "css_quantity_sum",
           3 => "css_unit_cost_avg",
           4 => "css_unit_venta_avg",
           5 => "css_costo_unit_venta_avg",
           6 => "css_costo_compra_sum",
           7 => "css_valor_venta_sum",
           8 => "css_costo_venta_sum",
       );
       ...
       foreach ($this->array_total_tipo as $i_tipo => $d_tipo) {
           if (!in_array($i_tipo, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_tipo[9] ] = $d_tipo[8];
               $this->comp_label[0][ $d_tipo[9] ] = $d_tipo[8];
           }
           foreach ($this->array_total_id_product[$i_tipo] as $i_id_product => $d_id_product) {
               if (!in_array($i_id_product, $this->comp_label[1][ $d_tipo[9] ], true)) {
                   $this->comp_index[1][ $d_id_product[9] ] = $d_id_product[8];
                   $this->comp_label[1][ $d_tipo[9] ][ $d_id_product[9] ] = $d_id_product[8];
               }
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_tabular_label'];
       ...
       foreach ($this->comp_label[0] as $i_tipo => $l_tipo) {
           ...
           foreach ($this->comp_label[1][$i_tipo] as $i_id_product => $l_id_product) {
               if (isset($this->array_total_id_product[$i_tipo][$i_id_product])) {
                   $this->comp_group[$i_tipo][$i_id_product] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       ...
       elseif (1 == $level) {
           $return = $this->array_total_id_product;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_view_movim_inventario@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           ...
           '0|2' => array(
               'title'    => $this->getChartText(strip_tags("Unit Cost (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'tipo',
               'field_y'  => $this->comp_sum_nm[3],
               'label_x'  => $this->getChartText(strip_tags($Lab_tipo)),
               'label_y'  => $this->getChartText(strip_tags("Unit Cost (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
               'format'   => $this->formatChartValue(2),
           ),
           '0|3' => array(
               'title'    => $this->getChartText(strip_tags("Unit Venta (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'tipo',
               'field_y'  => $this->comp_sum_nm[4],
               'label_x'  => $this->getChartText(strip_tags($Lab_tipo)),
               'label_y'  => $this->getChartText(strip_tags("Unit Venta (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
               'format'   => $this->formatChartValue(3),
           ),
           '0|4' => array(
               'title'    => $this->getChartText(strip_tags("Costo Unit Venta (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'tipo',
               'field_y'  => $this->comp_sum_nm[5],
               'label_x'  => $this->getChartText(strip_tags($Lab_tipo)),
               'label_y'  => $this->getChartText(strip_tags("Costo Unit Venta (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
               'format'   => $this->formatChartValue(4),
           ),
           '0|5' => array(
               'title'    => $this->getChartText(strip_tags("Costo Compra (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'tipo',
               'field_y'  => $this->comp_sum_nm[6],
               'label_x'  => $this->getChartText(strip_tags($Lab_tipo)),
               'label_y'  => $this->getChartText(strip_tags("Costo Compra (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(5),
           ),
           '0|6' => array(
               'title'    => $this->getChartText(strip_tags("Valor Venta (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'tipo',
               'field_y'  => $this->comp_sum_nm[7],
               'label_x'  => $this->getChartText(strip_tags($Lab_tipo)),
               'label_y'  => $this->getChartText(strip_tags("Valor Venta (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(6),
           ),
           '0|7' => array(
               'title'    => $this->getChartText(strip_tags("Costo Venta (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'tipo',
               'field_y'  => $this->comp_sum_nm[8],
               'label_x'  => $this->getChartText(strip_tags($Lab_tipo)),
               'label_y'  => $this->getChartText(strip_tags("Costo Venta (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
           ...
           '1|1' => array(
               ...
               'field_x'  => 'id_product',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_id_product)),
               'label_y'  => $this->getChartText(strip_tags("Quantity (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '1|2' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_view_movim_inventario_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_view_movim_inventario_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['proc_pdf_vert']){ 
   ...
   function formatValue($total, $valor_campo)
   {
       ...
       if ($total == 1)
       {
           nmgp_Form_Num_Val($valor_campo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "2", "S", "", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']);
       }
       if ($total == 2)
       {
           nmgp_Form_Num_Val($valor_campo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "1", "", "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']);
       }
       if ($total == 3)
       {
           nmgp_Form_Num_Val($valor_campo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "1", "", "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']);
       ...
       if ($total == 5)
       {
           nmgp_Form_Num_Val($valor_campo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "4", "S", "", "", "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']);
       }
       if ($total == 6)
       {
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function resumo_final()
   {
      ...
      if (!$this->NM_res_sem_reg && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['opcao'] != "pdf")
      {
          $this->grafico_bot();
      }
      if ("out" == $this->NM_tipo)
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_view_movim_inventario_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_tipo_id_product("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_tipo);
      ksort($this->array_total_id_product);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_view_movim_inventario/grid_view_movim_inventario_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_view_movim_inventario_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_view_movim_inventario_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_view_movim_inventario_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['num_css'] . '.css');
     ...
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_view_movim_inventario/grid_view_movim_inventario_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_view_movim_inventario&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_view_movim_inventario/grid_view_movim_inventario_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_view_movim_inventario/grid_view_movim_inventario_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_view_movim_inventario/grid_view_movim_inventario_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_view_movim_inventario/grid_view_movim_inventario_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_view_movim_inventario/grid_view_movim_inventario_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_view_movim_inventario_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xml'][] = "Rxml_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_view_movim_inventario/grid_view_movim_inventario_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rcsv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['csv'][] = "Rcsv_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_view_movim_inventario/grid_view_movim_inventario_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_view_movim_inventario']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_view_movim_inventario']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_view_movim_inventario_config_pivot.php?nome_apl=grid_view_movim_inventario&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_view_movim_inventario_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_view_movim_inventario/grid_view_movim_inventario_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_bot()
 {
   ...
   $bPDF = false;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new grid_view_movim_inventario_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
           ...
           grid_view_movim_inventario_pdf_progress_call("\n", $this->Ini->Nm_lang);
           grid_view_movim_inventario_pdf_progress_call("\n", $this->Ini->Nm_lang);
           grid_view_movim_inventario_pdf_progress_call("100\n", $this->Ini->Nm_lang);
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['pivot_charts'] as $chart_index => $chart_data)
       {
           ...
           if ($bPDF)
           {
               ...
               if ($this->progress_fp)
               {
                   grid_view_movim_inventario_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "/" . $iChartTotal . "...\n", $this->Ini->Nm_lang, true);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['ajax_nav'])
      {
       ...
       $nm_saida->saida("</TABLE>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_movim_inventario']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   //---- 
   function adiciona_registro($sum_quantity, $avg_unit_cost, $avg_unit_venta, $avg_costo_unit_venta, $sum_costo_compra, $sum_valor_venta, $sum_costo_venta, $quebra_tipo, $quebra_id_product, $quebra_tipo_orig, $quebra_id_product_orig)
   {
      //----- Tipo
      if (!isset($this->array_total_tipo[$quebra_tipo_orig]))
      {
         $this->array_total_tipo[$quebra_tipo_orig][0] = 1;
         $this->array_total_tipo[$quebra_tipo_orig][1] = $sum_quantity;
         $this->array_total_tipo[$quebra_tipo_orig][2] = $avg_unit_cost;
         $this->array_total_tipo[$quebra_tipo_orig][3] = $avg_unit_venta;
         $this->array_total_tipo[$quebra_tipo_orig][4] = $avg_costo_unit_venta;
         $this->array_total_tipo[$quebra_tipo_orig][5] = $sum_costo_compra;
         $this->array_total_tipo[$quebra_tipo_orig][6] = $sum_valor_venta;
         $this->array_total_tipo[$quebra_tipo_orig][7] = $sum_costo_venta;
         $this->array_total_tipo[$quebra_tipo_orig][8] = $quebra_tipo;
         $this->array_total_tipo[$quebra_tipo_orig][9] = $quebra_tipo_orig;
      }
      else
      {
         $this->array_total_tipo[$quebra_tipo_orig][0]++;
         $this->array_total_tipo[$quebra_tipo_orig][1] = bcadd($this->array_total_tipo[$quebra_tipo_orig][1], $sum_quantity, 10);
         $this->array_total_tipo[$quebra_tipo_orig][2] = bcadd($this->array_total_tipo[$quebra_tipo_orig][2], $avg_unit_cost, 10);
         $this->array_total_tipo[$quebra_tipo_orig][3] = bcadd($this->array_total_tipo[$quebra_tipo_orig][3], $avg_unit_venta, 10);
         $this->array_total_tipo[$quebra_tipo_orig][4] = bcadd($this->array_total_tipo[$quebra_tipo_orig][4], $avg_costo_unit_venta, 10);
         $this->array_total_tipo[$quebra_tipo_orig][5] = bcadd($this->array_total_tipo[$quebra_tipo_orig][5], $sum_costo_compra, 10);
         $this->array_total_tipo[$quebra_tipo_orig][6] = bcadd($this->array_total_tipo[$quebra_tipo_orig][6], $sum_valor_venta, 10);
         $this->array_total_tipo[$quebra_tipo_orig][7] = bcadd($this->array_total_tipo[$quebra_tipo_orig][7], $sum_costo_venta, 10);
      }
      //----- Id Product
      if (!isset($this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig]))
      {
         $this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][0] = 1;
         $this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][1] = $sum_quantity;
         $this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][2] = $avg_unit_cost;
         $this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][3] = $avg_unit_venta;
         $this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][4] = $avg_costo_unit_venta;
         $this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][5] = $sum_costo_compra;
         $this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][6] = $sum_valor_venta;
         $this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][7] = $sum_costo_venta;
         $this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][8] = $quebra_id_product;
         $this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][9] = $quebra_id_product_orig;
      }
      else
      {
         $this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][0]++;
         $this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][1] = bcadd($this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][1], $sum_quantity, 10);
         $this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][2] = bcadd($this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][2], $avg_unit_cost, 10);
         $this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][3] = bcadd($this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][3], $avg_unit_venta, 10);
         $this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][4] = bcadd($this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][4], $avg_costo_unit_venta, 10);
         $this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][5] = bcadd($this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][5], $sum_costo_compra, 10);
         $this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][6] = bcadd($this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][6], $sum_valor_venta, 10);
         $this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][7] = bcadd($this->array_total_id_product[$quebra_tipo_orig][$quebra_id_product_orig][7], $sum_costo_venta, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $format       = $this->Ini->Get_Gb_date_format('', 'id_product');
     $campos_order = $this->Ini->Get_date_order_groupby("id_product", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->id_product_orig = $this->id_product;
            $this->id_product = $this->look_id_product ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->quantity, $this->unit_cost, $this->unit_venta, $this->costo_unit_venta, $this->costo_compra, $this->valor_venta, $this->costo_venta, $this->tipo, $this->id_product, $this->tipo_orig,  $this->id_product_orig);
            }
   }
//
