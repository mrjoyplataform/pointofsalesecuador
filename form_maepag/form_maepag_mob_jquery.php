...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_fecing01_hora' + iSeqRow).bind('blur', function() { sc_form_maepag_fecing01_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_maepag_fecing01_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_maepag_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecing01" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_maepag_mob_validate_fecing01(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fecvencdoc01" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_maepag_mob_validate_fecvencdoc01(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_maepag_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
