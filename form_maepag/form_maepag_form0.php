...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_maepag/form_maepag_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_maepag_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_maepag_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['link_info']['remove_border']) {
...
<?php
 include_once("form_maepag_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_maepag'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_maepag'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_codcte01_label" id="hidden_field_label_codcte01" style="<?php echo $sStyleHidden_codcte01; ?>"><span id="id_label_codcte01"><?php echo $this->nm_new_label['codcte01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['codcte01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['codcte01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_codcte01_line" id="hidden_field_data_codcte01" style="<?php echo $sStyleHidden_codcte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_codcte01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nomcte01_label" id="hidden_field_label_nomcte01" style="<?php echo $sStyleHidden_nomcte01; ?>"><span id="id_label_nomcte01"><?php echo $this->nm_new_label['nomcte01']; ?></span></TD>
    <TD class="scFormDataOdd css_nomcte01_line" id="hidden_field_data_nomcte01" style="<?php echo $sStyleHidden_nomcte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nomcte01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cv1cte01_label" id="hidden_field_label_cv1cte01" style="<?php echo $sStyleHidden_cv1cte01; ?>"><span id="id_label_cv1cte01"><?php echo $this->nm_new_label['cv1cte01']; ?></span></TD>
    <TD class="scFormDataOdd css_cv1cte01_line" id="hidden_field_data_cv1cte01" style="<?php echo $sStyleHidden_cv1cte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cv1cte01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cv2cte01_label" id="hidden_field_label_cv2cte01" style="<?php echo $sStyleHidden_cv2cte01; ?>"><span id="id_label_cv2cte01"><?php echo $this->nm_new_label['cv2cte01']; ?></span></TD>
    <TD class="scFormDataOdd css_cv2cte01_line" id="hidden_field_data_cv2cte01" style="<?php echo $sStyleHidden_cv2cte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cv2cte01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipcte01_label" id="hidden_field_label_tipcte01" style="<?php echo $sStyleHidden_tipcte01; ?>"><span id="id_label_tipcte01"><?php echo $this->nm_new_label['tipcte01']; ?></span></TD>
    <TD class="scFormDataOdd css_tipcte01_line" id="hidden_field_data_tipcte01" style="<?php echo $sStyleHidden_tipcte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipcte01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ofienccte01_label" id="hidden_field_label_ofienccte01" style="<?php echo $sStyleHidden_ofienccte01; ?>"><span id="id_label_ofienccte01"><?php echo $this->nm_new_label['ofienccte01']; ?></span></TD>
    <TD class="scFormDataOdd css_ofienccte01_line" id="hidden_field_data_ofienccte01" style="<?php echo $sStyleHidden_ofienccte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ofienccte01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_vendcte01_label" id="hidden_field_label_vendcte01" style="<?php echo $sStyleHidden_vendcte01; ?>"><span id="id_label_vendcte01"><?php echo $this->nm_new_label['vendcte01']; ?></span></TD>
    <TD class="scFormDataOdd css_vendcte01_line" id="hidden_field_data_vendcte01" style="<?php echo $sStyleHidden_vendcte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vendcte01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cobrcte01_label" id="hidden_field_label_cobrcte01" style="<?php echo $sStyleHidden_cobrcte01; ?>"><span id="id_label_cobrcte01"><?php echo $this->nm_new_label['cobrcte01']; ?></span></TD>
    <TD class="scFormDataOdd css_cobrcte01_line" id="hidden_field_data_cobrcte01" style="<?php echo $sStyleHidden_cobrcte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cobrcte01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_loccte01_label" id="hidden_field_label_loccte01" style="<?php echo $sStyleHidden_loccte01; ?>"><span id="id_label_loccte01"><?php echo $this->nm_new_label['loccte01']; ?></span></TD>
    <TD class="scFormDataOdd css_loccte01_line" id="hidden_field_data_loccte01" style="<?php echo $sStyleHidden_loccte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_loccte01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dircte01_label" id="hidden_field_label_dircte01" style="<?php echo $sStyleHidden_dircte01; ?>"><span id="id_label_dircte01"><?php echo $this->nm_new_label['dircte01']; ?></span></TD>
    <TD class="scFormDataOdd css_dircte01_line" id="hidden_field_data_dircte01" style="<?php echo $sStyleHidden_dircte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dircte01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_telcte01_label" id="hidden_field_label_telcte01" style="<?php echo $sStyleHidden_telcte01; ?>"><span id="id_label_telcte01"><?php echo $this->nm_new_label['telcte01']; ?></span></TD>
    <TD class="scFormDataOdd css_telcte01_line" id="hidden_field_data_telcte01" style="<?php echo $sStyleHidden_telcte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_telcte01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cascte01_label" id="hidden_field_label_cascte01" style="<?php echo $sStyleHidden_cascte01; ?>"><span id="id_label_cascte01"><?php echo $this->nm_new_label['cascte01']; ?></span></TD>
    <TD class="scFormDataOdd css_cascte01_line" id="hidden_field_data_cascte01" style="<?php echo $sStyleHidden_cascte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cascte01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fecing01_label" id="hidden_field_label_fecing01" style="<?php echo $sStyleHidden_fecing01; ?>"><span id="id_label_fecing01"><?php echo $this->nm_new_label['fecing01']; ?></span></TD>
    <TD class="scFormDataOdd css_fecing01_line" id="hidden_field_data_fecing01" style="<?php echo $sStyleHidden_fecing01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecing01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_condpag01_label" id="hidden_field_label_condpag01" style="<?php echo $sStyleHidden_condpag01; ?>"><span id="id_label_condpag01"><?php echo $this->nm_new_label['condpag01']; ?></span></TD>
    <TD class="scFormDataOdd css_condpag01_line" id="hidden_field_data_condpag01" style="<?php echo $sStyleHidden_condpag01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_condpag01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_desctocte01_label" id="hidden_field_label_desctocte01" style="<?php echo $sStyleHidden_desctocte01; ?>"><span id="id_label_desctocte01"><?php echo $this->nm_new_label['desctocte01']; ?></span></TD>
    <TD class="scFormDataOdd css_desctocte01_line" id="hidden_field_data_desctocte01" style="<?php echo $sStyleHidden_desctocte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_desctocte01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_limcred01_label" id="hidden_field_label_limcred01" style="<?php echo $sStyleHidden_limcred01; ?>"><span id="id_label_limcred01"><?php echo $this->nm_new_label['limcred01']; ?></span></TD>
    <TD class="scFormDataOdd css_limcred01_line" id="hidden_field_data_limcred01" style="<?php echo $sStyleHidden_limcred01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_limcred01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_desppar01_label" id="hidden_field_label_desppar01" style="<?php echo $sStyleHidden_desppar01; ?>"><span id="id_label_desppar01"><?php echo $this->nm_new_label['desppar01']; ?></span></TD>
    <TD class="scFormDataOdd css_desppar01_line" id="hidden_field_data_desppar01" style="<?php echo $sStyleHidden_desppar01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_desppar01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cheqpro01_label" id="hidden_field_label_cheqpro01" style="<?php echo $sStyleHidden_cheqpro01; ?>"><span id="id_label_cheqpro01"><?php echo $this->nm_new_label['cheqpro01']; ?></span></TD>
    <TD class="scFormDataOdd css_cheqpro01_line" id="hidden_field_data_cheqpro01" style="<?php echo $sStyleHidden_cheqpro01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cheqpro01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sdoeje01_label" id="hidden_field_label_sdoeje01" style="<?php echo $sStyleHidden_sdoeje01; ?>"><span id="id_label_sdoeje01"><?php echo $this->nm_new_label['sdoeje01']; ?></span></TD>
    <TD class="scFormDataOdd css_sdoeje01_line" id="hidden_field_data_sdoeje01" style="<?php echo $sStyleHidden_sdoeje01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sdoeje01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sdoant01_label" id="hidden_field_label_sdoant01" style="<?php echo $sStyleHidden_sdoant01; ?>"><span id="id_label_sdoant01"><?php echo $this->nm_new_label['sdoant01']; ?></span></TD>
    <TD class="scFormDataOdd css_sdoant01_line" id="hidden_field_data_sdoant01" style="<?php echo $sStyleHidden_sdoant01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sdoant01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sdoact01_label" id="hidden_field_label_sdoact01" style="<?php echo $sStyleHidden_sdoact01; ?>"><span id="id_label_sdoact01"><?php echo $this->nm_new_label['sdoact01']; ?></span></TD>
    <TD class="scFormDataOdd css_sdoact01_line" id="hidden_field_data_sdoact01" style="<?php echo $sStyleHidden_sdoact01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sdoact01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_acudbm01_label" id="hidden_field_label_acudbm01" style="<?php echo $sStyleHidden_acudbm01; ?>"><span id="id_label_acudbm01"><?php echo $this->nm_new_label['acudbm01']; ?></span></TD>
    <TD class="scFormDataOdd css_acudbm01_line" id="hidden_field_data_acudbm01" style="<?php echo $sStyleHidden_acudbm01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_acudbm01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_acucrm01_label" id="hidden_field_label_acucrm01" style="<?php echo $sStyleHidden_acucrm01; ?>"><span id="id_label_acucrm01"><?php echo $this->nm_new_label['acucrm01']; ?></span></TD>
    <TD class="scFormDataOdd css_acucrm01_line" id="hidden_field_data_acucrm01" style="<?php echo $sStyleHidden_acucrm01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_acucrm01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_acudbe01_label" id="hidden_field_label_acudbe01" style="<?php echo $sStyleHidden_acudbe01; ?>"><span id="id_label_acudbe01"><?php echo $this->nm_new_label['acudbe01']; ?></span></TD>
    <TD class="scFormDataOdd css_acudbe01_line" id="hidden_field_data_acudbe01" style="<?php echo $sStyleHidden_acudbe01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_acudbe01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_acucre01_label" id="hidden_field_label_acucre01" style="<?php echo $sStyleHidden_acucre01; ?>"><span id="id_label_acucre01"><?php echo $this->nm_new_label['acucre01']; ?></span></TD>
    <TD class="scFormDataOdd css_acucre01_line" id="hidden_field_data_acucre01" style="<?php echo $sStyleHidden_acucre01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_acucre01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_comentcte01_label" id="hidden_field_label_comentcte01" style="<?php echo $sStyleHidden_comentcte01; ?>"><span id="id_label_comentcte01"><?php echo $this->nm_new_label['comentcte01']; ?></span></TD>
    <TD class="scFormDataOdd css_comentcte01_line" id="hidden_field_data_comentcte01" style="<?php echo $sStyleHidden_comentcte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_comentcte01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_statuscte01_label" id="hidden_field_label_statuscte01" style="<?php echo $sStyleHidden_statuscte01; ?>"><span id="id_label_statuscte01"><?php echo $this->nm_new_label['statuscte01']; ?></span></TD>
    <TD class="scFormDataOdd css_statuscte01_line" id="hidden_field_data_statuscte01" style="<?php echo $sStyleHidden_statuscte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_statuscte01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_identcte01_label" id="hidden_field_label_identcte01" style="<?php echo $sStyleHidden_identcte01; ?>"><span id="id_label_identcte01"><?php echo $this->nm_new_label['identcte01']; ?></span></TD>
    <TD class="scFormDataOdd css_identcte01_line" id="hidden_field_data_identcte01" style="<?php echo $sStyleHidden_identcte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_identcte01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cordcte01_label" id="hidden_field_label_cordcte01" style="<?php echo $sStyleHidden_cordcte01; ?>"><span id="id_label_cordcte01"><?php echo $this->nm_new_label['cordcte01']; ?></span></TD>
    <TD class="scFormDataOdd css_cordcte01_line" id="hidden_field_data_cordcte01" style="<?php echo $sStyleHidden_cordcte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cordcte01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_limcant01_label" id="hidden_field_label_limcant01" style="<?php echo $sStyleHidden_limcant01; ?>"><span id="id_label_limcant01"><?php echo $this->nm_new_label['limcant01']; ?></span></TD>
    <TD class="scFormDataOdd css_limcant01_line" id="hidden_field_data_limcant01" style="<?php echo $sStyleHidden_limcant01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_limcant01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pagleg01_label" id="hidden_field_label_pagleg01" style="<?php echo $sStyleHidden_pagleg01; ?>"><span id="id_label_pagleg01"><?php echo $this->nm_new_label['pagleg01']; ?></span></TD>
    <TD class="scFormDataOdd css_pagleg01_line" id="hidden_field_data_pagleg01" style="<?php echo $sStyleHidden_pagleg01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pagleg01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_telcte01b_label" id="hidden_field_label_telcte01b" style="<?php echo $sStyleHidden_telcte01b; ?>"><span id="id_label_telcte01b"><?php echo $this->nm_new_label['telcte01b']; ?></span></TD>
    <TD class="scFormDataOdd css_telcte01b_line" id="hidden_field_data_telcte01b" style="<?php echo $sStyleHidden_telcte01b; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_telcte01b_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_telcte01c_label" id="hidden_field_label_telcte01c" style="<?php echo $sStyleHidden_telcte01c; ?>"><span id="id_label_telcte01c"><?php echo $this->nm_new_label['telcte01c']; ?></span></TD>
    <TD class="scFormDataOdd css_telcte01c_line" id="hidden_field_data_telcte01c" style="<?php echo $sStyleHidden_telcte01c; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_telcte01c_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_emailcte01_label" id="hidden_field_label_emailcte01" style="<?php echo $sStyleHidden_emailcte01; ?>"><span id="id_label_emailcte01"><?php echo $this->nm_new_label['emailcte01']; ?></span></TD>
    <TD class="scFormDataOdd css_emailcte01_line" id="hidden_field_data_emailcte01" style="<?php echo $sStyleHidden_emailcte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emailcte01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ctacgcte01_label" id="hidden_field_label_ctacgcte01" style="<?php echo $sStyleHidden_ctacgcte01; ?>"><span id="id_label_ctacgcte01"><?php echo $this->nm_new_label['ctacgcte01']; ?></span></TD>
    <TD class="scFormDataOdd css_ctacgcte01_line" id="hidden_field_data_ctacgcte01" style="<?php echo $sStyleHidden_ctacgcte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ctacgcte01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_obsercte01_label" id="hidden_field_label_obsercte01" style="<?php echo $sStyleHidden_obsercte01; ?>"><span id="id_label_obsercte01"><?php echo $this->nm_new_label['obsercte01']; ?></span></TD>
    <TD class="scFormDataOdd css_obsercte01_line" id="hidden_field_data_obsercte01" style="<?php echo $sStyleHidden_obsercte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_obsercte01_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_totexceso01_label" id="hidden_field_label_totexceso01" style="<?php echo $sStyleHidden_totexceso01; ?>"><span id="id_label_totexceso01"><?php echo $this->nm_new_label['totexceso01']; ?></span></TD>
    <TD class="scFormDataOdd css_totexceso01_line" id="hidden_field_data_totexceso01" style="<?php echo $sStyleHidden_totexceso01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_totexceso01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_imagencte01_label" id="hidden_field_label_imagencte01" style="<?php echo $sStyleHidden_imagencte01; ?>"><span id="id_label_imagencte01"><?php echo $this->nm_new_label['imagencte01']; ?></span></TD>
    <TD class="scFormDataOdd css_imagencte01_line" id="hidden_field_data_imagencte01" style="<?php echo $sStyleHidden_imagencte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_imagencte01_line" style="vertical-align: top;padding: 0px">
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_idcli_line" id="hidden_field_data_idcli" style="<?php echo $sStyleHidden_idcli; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idcli_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_idcli" class="css_idcli_line" style="<?php echo $sStyleReadLab_idcli; ?>"><?php echo $this->form_format_readonly("idcli", $this->form_encode_input($this->idcli)); ?></span><span id="id_read_off_idcli" class="css_read_off_idcli" style="<?php echo $sStyleReadInp_idcli; ?>"><input type="hidden" name="idcli" value="<?php echo $this->form_encode_input($idcli) . "\">"?><span id="id_ajax_label_idcli"><?php echo nl2br($idcli); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_catcte01_label" id="hidden_field_label_catcte01" style="<?php echo $sStyleHidden_catcte01; ?>"><span id="id_label_catcte01"><?php echo $this->nm_new_label['catcte01']; ?></span></TD>
    <TD class="scFormDataOdd css_catcte01_line" id="hidden_field_data_catcte01" style="<?php echo $sStyleHidden_catcte01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_catcte01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_numautosri01_label" id="hidden_field_label_numautosri01" style="<?php echo $sStyleHidden_numautosri01; ?>"><span id="id_label_numautosri01"><?php echo $this->nm_new_label['numautosri01']; ?></span></TD>
    <TD class="scFormDataOdd css_numautosri01_line" id="hidden_field_data_numautosri01" style="<?php echo $sStyleHidden_numautosri01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_numautosri01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_seriedoc01_label" id="hidden_field_label_seriedoc01" style="<?php echo $sStyleHidden_seriedoc01; ?>"><span id="id_label_seriedoc01"><?php echo $this->nm_new_label['seriedoc01']; ?></span></TD>
    <TD class="scFormDataOdd css_seriedoc01_line" id="hidden_field_data_seriedoc01" style="<?php echo $sStyleHidden_seriedoc01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_seriedoc01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fecvencdoc01_label" id="hidden_field_label_fecvencdoc01" style="<?php echo $sStyleHidden_fecvencdoc01; ?>"><span id="id_label_fecvencdoc01"><?php echo $this->nm_new_label['fecvencdoc01']; ?></span></TD>
    <TD class="scFormDataOdd css_fecvencdoc01_line" id="hidden_field_data_fecvencdoc01" style="<?php echo $sStyleHidden_fecvencdoc01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecvencdoc01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_repleg01_label" id="hidden_field_label_repleg01" style="<?php echo $sStyleHidden_repleg01; ?>"><span id="id_label_repleg01"><?php echo $this->nm_new_label['repleg01']; ?></span></TD>
    <TD class="scFormDataOdd css_repleg01_line" id="hidden_field_data_repleg01" style="<?php echo $sStyleHidden_repleg01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_repleg01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_coddest01_label" id="hidden_field_label_coddest01" style="<?php echo $sStyleHidden_coddest01; ?>"><span id="id_label_coddest01"><?php echo $this->nm_new_label['coddest01']; ?></span></TD>
    <TD class="scFormDataOdd css_coddest01_line" id="hidden_field_data_coddest01" style="<?php echo $sStyleHidden_coddest01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_coddest01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_longitud01_label" id="hidden_field_label_longitud01" style="<?php echo $sStyleHidden_longitud01; ?>"><span id="id_label_longitud01"><?php echo $this->nm_new_label['longitud01']; ?></span></TD>
    <TD class="scFormDataOdd css_longitud01_line" id="hidden_field_data_longitud01" style="<?php echo $sStyleHidden_longitud01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_longitud01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_latitud01_label" id="hidden_field_label_latitud01" style="<?php echo $sStyleHidden_latitud01; ?>"><span id="id_label_latitud01"><?php echo $this->nm_new_label['latitud01']; ?></span></TD>
    <TD class="scFormDataOdd css_latitud01_line" id="hidden_field_data_latitud01" style="<?php echo $sStyleHidden_latitud01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_latitud01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_zoom01_label" id="hidden_field_label_zoom01" style="<?php echo $sStyleHidden_zoom01; ?>"><span id="id_label_zoom01"><?php echo $this->nm_new_label['zoom01']; ?></span></TD>
    <TD class="scFormDataOdd css_zoom01_line" id="hidden_field_data_zoom01" style="<?php echo $sStyleHidden_zoom01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_zoom01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_coniva01_label" id="hidden_field_label_coniva01" style="<?php echo $sStyleHidden_coniva01; ?>"><span id="id_label_coniva01"><?php echo $this->nm_new_label['coniva01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['coniva01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['coniva01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_coniva01_line" id="hidden_field_data_coniva01" style="<?php echo $sStyleHidden_coniva01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_coniva01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_conret01_label" id="hidden_field_label_conret01" style="<?php echo $sStyleHidden_conret01; ?>"><span id="id_label_conret01"><?php echo $this->nm_new_label['conret01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['conret01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['conret01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_conret01_line" id="hidden_field_data_conret01" style="<?php echo $sStyleHidden_conret01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_conret01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipo_identificacion_label" id="hidden_field_label_tipo_identificacion" style="<?php echo $sStyleHidden_tipo_identificacion; ?>"><span id="id_label_tipo_identificacion"><?php echo $this->nm_new_label['tipo_identificacion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['tipo_identificacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['tipo_identificacion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_tipo_identificacion_line" id="hidden_field_data_tipo_identificacion" style="<?php echo $sStyleHidden_tipo_identificacion; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_identificacion_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_es_padre_label" id="hidden_field_label_es_padre" style="<?php echo $sStyleHidden_es_padre; ?>"><span id="id_label_es_padre"><?php echo $this->nm_new_label['es_padre']; ?></span></TD>
    <TD class="scFormDataOdd css_es_padre_line" id="hidden_field_data_es_padre" style="<?php echo $sStyleHidden_es_padre; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_es_padre_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_bonos_label" id="hidden_field_label_bonos" style="<?php echo $sStyleHidden_bonos; ?>"><span id="id_label_bonos"><?php echo $this->nm_new_label['bonos']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['bonos']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['bonos'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_bonos_line" id="hidden_field_data_bonos" style="<?php echo $sStyleHidden_bonos; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bonos_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_rendimiento_label" id="hidden_field_label_rendimiento" style="<?php echo $sStyleHidden_rendimiento; ?>"><span id="id_label_rendimiento"><?php echo $this->nm_new_label['rendimiento']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['rendimiento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['rendimiento'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_rendimiento_line" id="hidden_field_data_rendimiento" style="<?php echo $sStyleHidden_rendimiento; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rendimiento_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_parterel01_label" id="hidden_field_label_parterel01" style="<?php echo $sStyleHidden_parterel01; ?>"><span id="id_label_parterel01"><?php echo $this->nm_new_label['parterel01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['parterel01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['parterel01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_parterel01_line" id="hidden_field_data_parterel01" style="<?php echo $sStyleHidden_parterel01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_parterel01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_clase_contribuyente_label" id="hidden_field_label_clase_contribuyente" style="<?php echo $sStyleHidden_clase_contribuyente; ?>"><span id="id_label_clase_contribuyente"><?php echo $this->nm_new_label['clase_contribuyente']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['clase_contribuyente']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['clase_contribuyente'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_clase_contribuyente_line" id="hidden_field_data_clase_contribuyente" style="<?php echo $sStyleHidden_clase_contribuyente; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_clase_contribuyente_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipo_contribuyente_label" id="hidden_field_label_tipo_contribuyente" style="<?php echo $sStyleHidden_tipo_contribuyente; ?>"><span id="id_label_tipo_contribuyente"><?php echo $this->nm_new_label['tipo_contribuyente']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['tipo_contribuyente']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['tipo_contribuyente'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_tipo_contribuyente_line" id="hidden_field_data_tipo_contribuyente" style="<?php echo $sStyleHidden_tipo_contribuyente; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_contribuyente_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_lleva_contabilidad_label" id="hidden_field_label_lleva_contabilidad" style="<?php echo $sStyleHidden_lleva_contabilidad; ?>"><span id="id_label_lleva_contabilidad"><?php echo $this->nm_new_label['lleva_contabilidad']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['lleva_contabilidad']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['lleva_contabilidad'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_lleva_contabilidad_line" id="hidden_field_data_lleva_contabilidad" style="<?php echo $sStyleHidden_lleva_contabilidad; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_lleva_contabilidad_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ctacgant01_label" id="hidden_field_label_ctacgant01" style="<?php echo $sStyleHidden_ctacgant01; ?>"><span id="id_label_ctacgant01"><?php echo $this->nm_new_label['ctacgant01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['ctacgant01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['ctacgant01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_ctacgant01_line" id="hidden_field_data_ctacgant01" style="<?php echo $sStyleHidden_ctacgant01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ctacgant01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_residentefiscal01_label" id="hidden_field_label_residentefiscal01" style="<?php echo $sStyleHidden_residentefiscal01; ?>"><span id="id_label_residentefiscal01"><?php echo $this->nm_new_label['residentefiscal01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['residentefiscal01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['residentefiscal01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_residentefiscal01_line" id="hidden_field_data_residentefiscal01" style="<?php echo $sStyleHidden_residentefiscal01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_residentefiscal01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_es_cliente_label" id="hidden_field_label_es_cliente" style="<?php echo $sStyleHidden_es_cliente; ?>"><span id="id_label_es_cliente"><?php echo $this->nm_new_label['es_cliente']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['es_cliente']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['es_cliente'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_es_cliente_line" id="hidden_field_data_es_cliente" style="<?php echo $sStyleHidden_es_cliente; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_es_cliente_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_grupos_label" id="hidden_field_label_grupos" style="<?php echo $sStyleHidden_grupos; ?>"><span id="id_label_grupos"><?php echo $this->nm_new_label['grupos']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['grupos']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['grupos'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_grupos_line" id="hidden_field_data_grupos" style="<?php echo $sStyleHidden_grupos; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_grupos_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_codigo_banco_label" id="hidden_field_label_codigo_banco" style="<?php echo $sStyleHidden_codigo_banco; ?>"><span id="id_label_codigo_banco"><?php echo $this->nm_new_label['codigo_banco']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipo_cuenta_banco_label" id="hidden_field_label_tipo_cuenta_banco" style="<?php echo $sStyleHidden_tipo_cuenta_banco; ?>"><span id="id_label_tipo_cuenta_banco"><?php echo $this->nm_new_label['tipo_cuenta_banco']; ?></span></TD>
    <TD class="scFormDataOdd css_tipo_cuenta_banco_line" id="hidden_field_data_tipo_cuenta_banco" style="<?php echo $sStyleHidden_tipo_cuenta_banco; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_cuenta_banco_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nro_cuenta_banco_label" id="hidden_field_label_nro_cuenta_banco" style="<?php echo $sStyleHidden_nro_cuenta_banco; ?>"><span id="id_label_nro_cuenta_banco"><?php echo $this->nm_new_label['nro_cuenta_banco']; ?></span></TD>
    <TD class="scFormDataOdd css_nro_cuenta_banco_line" id="hidden_field_data_nro_cuenta_banco" style="<?php echo $sStyleHidden_nro_cuenta_banco; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nro_cuenta_banco_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pago_transferencia_label" id="hidden_field_label_pago_transferencia" style="<?php echo $sStyleHidden_pago_transferencia; ?>"><span id="id_label_pago_transferencia"><?php echo $this->nm_new_label['pago_transferencia']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['pago_transferencia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['php_cmp_required']['pago_transferencia'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_pago_transferencia_line" id="hidden_field_data_pago_transferencia" style="<?php echo $sStyleHidden_pago_transferencia; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pago_transferencia_line" style="vertical-align: top;padding: 0px">
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_maepag");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_maepag");
 parent.scAjaxDetailHeight("form_maepag", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_maepag']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
