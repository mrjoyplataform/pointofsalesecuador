...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_numero_autorizacion_cond" name="numero_autorizacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_numero_autorizacion'), this, 'numero_autorizacion')">
