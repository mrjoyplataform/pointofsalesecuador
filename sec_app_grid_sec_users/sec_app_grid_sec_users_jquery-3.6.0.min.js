...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        if (!SC_Proc_Mobile) {
            document.getElementById('nmsc_iframe_liga_A_sec_app_grid_sec_users').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_E_sec_app_grid_sec_users').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_D_sec_app_grid_sec_users').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_B_sec_app_grid_sec_users').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_A_sec_app_grid_sec_users').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_E_sec_app_grid_sec_users').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_D_sec_app_grid_sec_users').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_B_sec_app_grid_sec_users').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_A_sec_app_grid_sec_users').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_E_sec_app_grid_sec_users').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_D_sec_app_grid_sec_users').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_B_sec_app_grid_sec_users').style.width  = '0px';
        }
        if (oResp["setValue"]) {
