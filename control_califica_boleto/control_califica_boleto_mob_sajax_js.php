  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_califica_boleto_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_califica_boleto_mob_form();
	}
...
?>
  ...
  // ---------- Validate logomr
  function do_ajax_control_califica_boleto_mob_validate_logomr()
  {
    var nomeCampo_logomr = "logomr";
    var var_logomr = scAjaxGetFieldText(nomeCampo_logomr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_califica_boleto_mob_validate_logomr(var_logomr, var_script_case_init, do_ajax_control_califica_boleto_mob_validate_logomr_cb);
  } // do_ajax_control_califica_boleto_mob_validate_logomr

  function do_ajax_control_califica_boleto_mob_validate_logomr_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_califica_boleto_mob_validate_logomr_cb

  // ---------- Validate titulo
  function do_ajax_control_califica_boleto_mob_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldHidden(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_califica_boleto_mob_validate_titulo(var_titulo, var_script_case_init, do_ajax_control_califica_boleto_mob_validate_titulo_cb);
  } // do_ajax_control_califica_boleto_mob_validate_titulo

  function do_ajax_control_califica_boleto_mob_validate_titulo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "titulo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_califica_boleto_mob_validate_titulo_cb

  // ---------- Validate val1
  function do_ajax_control_califica_boleto_mob_validate_val1()
  {
    var nomeCampo_val1 = "val1";
    var var_val1 = scAjaxGetFieldText(nomeCampo_val1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_califica_boleto_mob_validate_val1(var_val1, var_script_case_init, do_ajax_control_califica_boleto_mob_validate_val1_cb);
  } // do_ajax_control_califica_boleto_mob_validate_val1

  function do_ajax_control_califica_boleto_mob_validate_val1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "val1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_califica_boleto_mob_validate_val1_cb

  // ---------- Validate val2
  function do_ajax_control_califica_boleto_mob_validate_val2()
  {
    var nomeCampo_val2 = "val2";
    var var_val2 = scAjaxGetFieldText(nomeCampo_val2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_califica_boleto_mob_validate_val2(var_val2, var_script_case_init, do_ajax_control_califica_boleto_mob_validate_val2_cb);
  } // do_ajax_control_califica_boleto_mob_validate_val2

  function do_ajax_control_califica_boleto_mob_validate_val2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "val2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_califica_boleto_mob_validate_val2_cb

  // ---------- Validate val3
  function do_ajax_control_califica_boleto_mob_validate_val3()
  {
    var nomeCampo_val3 = "val3";
    var var_val3 = scAjaxGetFieldText(nomeCampo_val3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_califica_boleto_mob_validate_val3(var_val3, var_script_case_init, do_ajax_control_califica_boleto_mob_validate_val3_cb);
  } // do_ajax_control_califica_boleto_mob_validate_val3

  function do_ajax_control_califica_boleto_mob_validate_val3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "val3";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_califica_boleto_mob_validate_val3_cb

  // ---------- Validate val4
  function do_ajax_control_califica_boleto_mob_validate_val4()
  {
    var nomeCampo_val4 = "val4";
    var var_val4 = scAjaxGetFieldText(nomeCampo_val4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_califica_boleto_mob_validate_val4(var_val4, var_script_case_init, do_ajax_control_califica_boleto_mob_validate_val4_cb);
  } // do_ajax_control_califica_boleto_mob_validate_val4

  function do_ajax_control_califica_boleto_mob_validate_val4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "val4";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_califica_boleto_mob_validate_val4_cb

  // ---------- Validate val5
  function do_ajax_control_califica_boleto_mob_validate_val5()
  {
    var nomeCampo_val5 = "val5";
    var var_val5 = scAjaxGetFieldText(nomeCampo_val5);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_califica_boleto_mob_validate_val5(var_val5, var_script_case_init, do_ajax_control_califica_boleto_mob_validate_val5_cb);
  } // do_ajax_control_califica_boleto_mob_validate_val5

  function do_ajax_control_califica_boleto_mob_validate_val5_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "val5";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_califica_boleto_mob_validate_val5_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_califica_boleto_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_califica_boleto_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_logomr = "";
    ...
    scAjaxProcOn();
    x_ajax_control_califica_boleto_mob_submit_form(var_logomr, var_titulo, var_val1, var_val2, var_val3, var_val4, var_val5, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_califica_boleto_mob_submit_form_cb);
  } // do_ajax_control_califica_boleto_mob_submit_form

  function do_ajax_control_califica_boleto_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_califica_boleto_mob_submit_form_cb_after_alert);
  } // do_ajax_control_califica_boleto_mob_submit_form_cb
  function do_ajax_control_califica_boleto_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_califica_boleto_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_califica_boleto_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_control_califica_boleto_mob_navigate_form, function() {});
    } else {
      perform_ajax_control_califica_boleto_mob_navigate_form();
    }
  }

  function perform_ajax_control_califica_boleto_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_califica_boleto_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_califica_boleto_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_califica_boleto_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_califica_boleto_mob_navigate_form_cb
  function do_ajax_control_califica_boleto_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_califica_boleto_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_califica_boleto_mob_navigate_form_cb_after_alert

  function sc_hide_control_califica_boleto_mob_form()
  {
  ...
  ajax_field_list[0] = "logomr";
  ajax_field_list[1] = "titulo";
  ajax_field_list[2] = "val1";
  ajax_field_list[3] = "val2";
  ajax_field_list[4] = "val3";
  ajax_field_list[5] = "val4";
  ajax_field_list[6] = "val5";
  ...
  var ajax_error_list = {
    "logomr": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "titulo": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "val1": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "val2": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "val3": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "val4": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "val5": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["logomr"][1] = "logomr";
  ajax_field_mult["titulo"][1] = "titulo";
  ajax_field_mult["val1"][1] = "val1";
  ajax_field_mult["val2"][1] = "val2";
  ajax_field_mult["val3"][1] = "val3";
  ajax_field_mult["val4"][1] = "val4";
  ajax_field_mult["val5"][1] = "val5";

  var ajax_field_id = {
    "logomr": new Array("hidden_field_label_logomr", "hidden_field_data_logomr"),
    "titulo": new Array("hidden_field_label_titulo", "hidden_field_data_titulo"),
    "val1": new Array("hidden_field_label_val1", "hidden_field_data_val1"),
    "val2": new Array("hidden_field_label_val2", "hidden_field_data_val2"),
    "val3": new Array("hidden_field_label_val3", "hidden_field_data_val3"),
    "val4": new Array("hidden_field_label_val4", "hidden_field_data_val4"),
    "val5": new Array("hidden_field_label_val5", "hidden_field_data_val5")
  };
