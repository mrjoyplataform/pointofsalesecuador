...
class grid_movcte2_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_movcte2_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_movcte2_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_movcte2_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_ocurren43')
      {
          $ocurren43 = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_ocurren43($ocurren43);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_codcte43')
      {
          $codcte43 = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_codcte43($codcte43);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_tipodoc43')
      {
          $tipodoc43 = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_tipodoc43($tipodoc43);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_numdoc43')
      {
          $numdoc43 = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_numdoc43($numdoc43);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "fecdoc43";$Nm_datas[] = "fecdoc43";$Nm_datas[] = "fedoc43";$Nm_datas[] = "fedoc43";$Nm_datas[] = "feccobro43";$Nm_datas[] = "feccobro43";$Nm_datas[] = "fectransfer43";$Nm_datas[] = "fectransfer43";$Nm_datas[] = "fecvendoc43";$Nm_datas[] = "fecvendoc43";$Nm_datas[] = "fecvenret43";$Nm_datas[] = "fecvenret43";$Nm_datas[] = "fecha_creacion_del_65";$Nm_datas[] = "fecha_creacion_del_65";$Nm_datas[] = "fecha_adicional";$Nm_datas[] = "fecha_adicional";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> movcte2</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_movcte2/grid_movcte2_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_movcte2_ajax_search.js"></script>
 <script type="text/javascript" src="grid_movcte2_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_movcte2_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_movcte2']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_movcte2']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_ocurren43_cond#NMF#' + search_get_sel_txt('SC_ocurren43_cond') + '@NMF@';
  str_out += 'SC_ocurren43#NMF#' + search_get_text('SC_ocurren43') + '@NMF@';
  str_out += 'id_ac_ocurren43#NMF#' + search_get_text('id_ac_ocurren43') + '@NMF@';
  str_out += 'SC_codcte43_cond#NMF#' + search_get_sel_txt('SC_codcte43_cond') + '@NMF@';
  str_out += 'SC_codcte43#NMF#' + search_get_text('SC_codcte43') + '@NMF@';
  str_out += 'id_ac_codcte43#NMF#' + search_get_text('id_ac_codcte43') + '@NMF@';
  str_out += 'SC_tipodoc43_cond#NMF#' + search_get_sel_txt('SC_tipodoc43_cond') + '@NMF@';
  str_out += 'SC_tipodoc43#NMF#' + search_get_text('SC_tipodoc43') + '@NMF@';
  str_out += 'id_ac_tipodoc43#NMF#' + search_get_text('id_ac_tipodoc43') + '@NMF@';
  str_out += 'SC_numdoc43_cond#NMF#' + search_get_sel_txt('SC_numdoc43_cond') + '@NMF@';
  str_out += 'SC_numdoc43#NMF#' + search_get_text('SC_numdoc43') + '@NMF@';
  str_out += 'id_ac_numdoc43#NMF#' + search_get_text('id_ac_numdoc43') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_codcte43").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_codcte43").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_codcte43",
          max_itens: "10",
          cod_desc: "N",
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_codcte43").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_tipodoc43").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_tipodoc43").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_tipodoc43",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_tipodoc43").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_tipodoc43").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_numdoc43").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_numdoc43").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_numdoc43",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_numdoc43").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_ocurren43").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_ocurren43").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_ocurren43",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_ocurren43").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> movcte2</div>
...
<?php
   ...
   {
      global 
             $ocurren43_cond, $ocurren43, $ocurren43_autocomp,
             $codcte43_cond, $codcte43, $codcte43_autocomp,
             $tipodoc43_cond, $tipodoc43, $tipodoc43_autocomp,
             $numdoc43_cond, $numdoc43, $numdoc43_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $ocurren43 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']['ocurren43']; 
          $ocurren43_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']['ocurren43_cond']; 
          $codcte43 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']['codcte43']; 
          $codcte43_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']['codcte43_cond']; 
          $tipodoc43 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']['tipodoc43']; 
          $tipodoc43_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']['tipodoc43_cond']; 
          $numdoc43 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']['numdoc43']; 
          $numdoc43_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']['numdoc43_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']['NM_operador']; 
      } 
      if (!isset($ocurren43_cond) || empty($ocurren43_cond))
      {
         $ocurren43_cond = "qp";
      }
      if (!isset($codcte43_cond) || empty($codcte43_cond))
      {
         $codcte43_cond = "qp";
      }
      if (!isset($tipodoc43_cond) || empty($tipodoc43_cond))
      {
         $tipodoc43_cond = "qp";
      }
      if (!isset($numdoc43_cond) || empty($numdoc43_cond))
      {
         $numdoc43_cond = "qp";
      }
      ...
      $str_hide_ocurren43 = (in_array($ocurren43_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_codcte43 = (in_array($codcte43_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_tipodoc43 = (in_array($tipodoc43_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_numdoc43 = (in_array($numdoc43_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($ocurren43) || $ocurren43 == "")
      {
          $ocurren43 = "";
      }
      if (isset($ocurren43) && !empty($ocurren43))
      {
         $tmp_pos = strpos($ocurren43, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $ocurren43 = substr($ocurren43, 0, $tmp_pos);
         }
      }
      if (!isset($codcte43) || $codcte43 == "")
      {
          $codcte43 = "";
      }
      if (isset($codcte43) && !empty($codcte43))
      {
         $tmp_pos = strpos($codcte43, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $codcte43 = substr($codcte43, 0, $tmp_pos);
         }
      }
      if (!isset($tipodoc43) || $tipodoc43 == "")
      {
          $tipodoc43 = "";
      }
      if (isset($tipodoc43) && !empty($tipodoc43))
      {
         $tmp_pos = strpos($tipodoc43, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $tipodoc43 = substr($tipodoc43, 0, $tmp_pos);
         }
      }
      if (!isset($numdoc43) || $numdoc43 == "")
      {
          $numdoc43 = "";
      }
      if (isset($numdoc43) && !empty($numdoc43))
      {
         $tmp_pos = strpos($numdoc43, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $numdoc43 = substr($numdoc43, 0, $tmp_pos);
         }
      }
?>
 <?php
...
?>
<?php
   if (is_file("grid_movcte2_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_movcte2']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_movcte2']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_ocurren43_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['ocurren43'])) ? $this->New_label['ocurren43'] : "Ocurren 43"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_ocurren43_cond" name="ocurren43_cond" onChange="nm_campos_between(document.getElementById('id_vis_ocurren43'), this, 'ocurren43')">
       <OPTION value="qp" <?php if ("qp" == $ocurren43_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $ocurren43_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $ocurren43_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $ocurren43_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ocurren43" <?php echo $str_hide_ocurren43?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['ocurren43'])) ? $this->New_label['ocurren43'] : "Ocurren 43";
 $nmgp_tab_label .= "ocurren43?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $ocurren43;
      }
?>
<INPUT  type="text" id="SC_ocurren43" name="ocurren43" value="<?php echo NM_encode_input($ocurren43) ?>"  size=4 alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_ocurren43" name="ocurren43_autocomp" size="4"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_codcte43_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['codcte43'])) ? $this->New_label['codcte43'] : "Codcte 43"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_codcte43_cond" name="codcte43_cond" onChange="nm_campos_between(document.getElementById('id_vis_codcte43'), this, 'codcte43')">
       <OPTION value="qp" <?php if ("qp" == $codcte43_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $codcte43_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $codcte43_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $codcte43_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_codcte43" <?php echo $str_hide_codcte43?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['codcte43'])) ? $this->New_label['codcte43'] : "Codcte 43";
 $nmgp_tab_label .= "codcte43?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $codcte43;
      }
?>
<INPUT  type="text" id="SC_codcte43" name="codcte43" value="<?php echo NM_encode_input($codcte43) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_codcte43" name="codcte43_autocomp" size="20"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_tipodoc43_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['tipodoc43'])) ? $this->New_label['tipodoc43'] : "Tipodoc 43"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_tipodoc43_cond" name="tipodoc43_cond" onChange="nm_campos_between(document.getElementById('id_vis_tipodoc43'), this, 'tipodoc43')">
       <OPTION value="qp" <?php if ("qp" == $tipodoc43_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $tipodoc43_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $tipodoc43_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $tipodoc43_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tipodoc43" <?php echo $str_hide_tipodoc43?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['tipodoc43'])) ? $this->New_label['tipodoc43'] : "Tipodoc 43";
 $nmgp_tab_label .= "tipodoc43?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $tipodoc43;
      }
?>
<INPUT  type="text" id="SC_tipodoc43" name="tipodoc43" value="<?php echo NM_encode_input($tipodoc43) ?>"  size=4 alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_tipodoc43" name="tipodoc43_autocomp" size="4"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_numdoc43_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['numdoc43'])) ? $this->New_label['numdoc43'] : "Numdoc 43"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_numdoc43_cond" name="numdoc43_cond" onChange="nm_campos_between(document.getElementById('id_vis_numdoc43'), this, 'numdoc43')">
       <OPTION value="qp" <?php if ("qp" == $numdoc43_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $numdoc43_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $numdoc43_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $numdoc43_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_numdoc43" <?php echo $str_hide_numdoc43?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['numdoc43'])) ? $this->New_label['numdoc43'] : "Numdoc 43";
 $nmgp_tab_label .= "numdoc43?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $numdoc43;
      }
?>
<INPUT  type="text" id="SC_numdoc43" name="numdoc43" value="<?php echo NM_encode_input($numdoc43) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_numdoc43" name="numdoc43_autocomp" size="20"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.ocurren43_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_ocurren43'), document.F1.ocurren43_cond, 'ocurren43');
   document.F1.ocurren43.value = "";
   document.F1.ocurren43_autocomp.value = "";
   document.F1.codcte43_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_codcte43'), document.F1.codcte43_cond, 'codcte43');
   document.F1.codcte43.value = "";
   document.F1.codcte43_autocomp.value = "";
   document.F1.tipodoc43_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_tipodoc43'), document.F1.tipodoc43_cond, 'tipodoc43');
   document.F1.tipodoc43.value = "";
   document.F1.tipodoc43_autocomp.value = "";
   document.F1.numdoc43_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_numdoc43'), document.F1.numdoc43_cond, 'numdoc43');
   document.F1.numdoc43.value = "";
   document.F1.numdoc43_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_ocurren43_cond'] = 'cond';
      $tp_fields['SC_ocurren43'] = 'text_aut';
      $tp_fields['id_ac_ocurren43'] = 'text_aut';
      $tp_fields['SC_codcte43_cond'] = 'cond';
      $tp_fields['SC_codcte43'] = 'text_aut';
      $tp_fields['id_ac_codcte43'] = 'text_aut';
      $tp_fields['SC_tipodoc43_cond'] = 'cond';
      $tp_fields['SC_tipodoc43'] = 'text_aut';
      $tp_fields['id_ac_tipodoc43'] = 'text_aut';
      $tp_fields['SC_numdoc43_cond'] = 'cond';
      $tp_fields['SC_numdoc43'] = 'text_aut';
      $tp_fields['id_ac_numdoc43'] = 'text_aut';
   ...
   {
      global $ocurren43_cond, $ocurren43, $ocurren43_autocomp,
             $codcte43_cond, $codcte43, $codcte43_autocomp,
             $tipodoc43_cond, $tipodoc43, $tipodoc43_autocomp,
             $numdoc43_cond, $numdoc43, $numdoc43_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($ocurren43_autocomp) && empty($ocurren43))
      {
          $ocurren43 = $ocurren43_autocomp;
      }
      if (!empty($codcte43_autocomp) && empty($codcte43))
      {
          $codcte43 = $codcte43_autocomp;
      }
      if (!empty($tipodoc43_autocomp) && empty($tipodoc43))
      {
          $tipodoc43 = $tipodoc43_autocomp;
      }
      if (!empty($numdoc43_autocomp) && empty($numdoc43))
      {
          $numdoc43 = $numdoc43_autocomp;
      }
      $ocurren43_cond_salva = $ocurren43_cond; 
      if (!isset($ocurren43_input_2) || $ocurren43_input_2 == "")
      {
          $ocurren43_input_2 = $ocurren43;
      }
      $codcte43_cond_salva = $codcte43_cond; 
      if (!isset($codcte43_input_2) || $codcte43_input_2 == "")
      {
          $codcte43_input_2 = $codcte43;
      }
      $tipodoc43_cond_salva = $tipodoc43_cond; 
      if (!isset($tipodoc43_input_2) || $tipodoc43_input_2 == "")
      {
          $tipodoc43_input_2 = $tipodoc43;
      }
      $numdoc43_cond_salva = $numdoc43_cond; 
      if (!isset($numdoc43_input_2) || $numdoc43_input_2 == "")
      {
          $numdoc43_input_2 = $numdoc43;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']['ocurren43'] = $ocurren43; 
      if (is_array($ocurren43) && !empty($ocurren43))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['Grid_search'][$I_Grid]['val'][0] = $ocurren43;
      }
      elseif ($ocurren43_cond_salva == "nu" || $ocurren43_cond_salva == "nn" || $ocurren43_cond_salva == "ep" || $ocurren43_cond_salva == "ne" || !empty($ocurren43))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['Grid_search'][$I_Grid]['val'][0][0] = $ocurren43;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']['ocurren43_cond'] = $ocurren43_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['Grid_search'][$I_Grid]['cmp'] = "ocurren43"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['Grid_search'][$I_Grid]['opc'] = $ocurren43_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq']['ocurren43'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']['codcte43'] = $codcte43; 
      if (is_array($codcte43) && !empty($codcte43))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['Grid_search'][$I_Grid]['val'][0] = $codcte43;
      }
      elseif ($codcte43_cond_salva == "nu" || $codcte43_cond_salva == "nn" || $codcte43_cond_salva == "ep" || $codcte43_cond_salva == "ne" || !empty($codcte43))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['Grid_search'][$I_Grid]['val'][0][0] = $codcte43;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']['codcte43_cond'] = $codcte43_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['Grid_search'][$I_Grid]['cmp'] = "codcte43"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['Grid_search'][$I_Grid]['opc'] = $codcte43_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq']['codcte43'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']['tipodoc43'] = $tipodoc43; 
      if (is_array($tipodoc43) && !empty($tipodoc43))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['Grid_search'][$I_Grid]['val'][0] = $tipodoc43;
      }
      elseif ($tipodoc43_cond_salva == "nu" || $tipodoc43_cond_salva == "nn" || $tipodoc43_cond_salva == "ep" || $tipodoc43_cond_salva == "ne" || !empty($tipodoc43))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['Grid_search'][$I_Grid]['val'][0][0] = $tipodoc43;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']['tipodoc43_cond'] = $tipodoc43_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['Grid_search'][$I_Grid]['cmp'] = "tipodoc43"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['Grid_search'][$I_Grid]['opc'] = $tipodoc43_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq']['tipodoc43'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']['numdoc43'] = $numdoc43; 
      if (is_array($numdoc43) && !empty($numdoc43))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['Grid_search'][$I_Grid]['val'][0] = $numdoc43;
      }
      elseif ($numdoc43_cond_salva == "nu" || $numdoc43_cond_salva == "nn" || $numdoc43_cond_salva == "ep" || $numdoc43_cond_salva == "ne" || !empty($numdoc43))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['Grid_search'][$I_Grid]['val'][0][0] = $numdoc43;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']['numdoc43_cond'] = $numdoc43_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['Grid_search'][$I_Grid]['cmp'] = "numdoc43"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['Grid_search'][$I_Grid]['opc'] = $numdoc43_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['grid_pesq']['numdoc43'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($ocurren43 != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['ocurren43'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['ocurren43'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['ocurren43'] = $ocurren43;
      }
      $nmgp_def_dados = array();
    if ($codcte43 != '') {
      $codcte43_look = substr($this->Db->qstr($codcte43), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['codcte43'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['codcte43'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['codcte43'] = $codcte43;
      }
      $nmgp_def_dados = array();
    if ($tipodoc43 != '') {
      $tipodoc43_look = substr($this->Db->qstr($tipodoc43), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['tipodoc43'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['tipodoc43'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['tipodoc43'] = $tipodoc43;
      }
      $nmgp_def_dados = array();
    if ($numdoc43 != '') {
      $numdoc43_look = substr($this->Db->qstr($numdoc43), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['numdoc43'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['numdoc43'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['numdoc43'] = $numdoc43;
      }

      //----- $ocurren43
      $this->Date_part = false;
      if (isset($ocurren43) || $ocurren43_cond == "nu" || $ocurren43_cond == "nn" || $ocurren43_cond == "ep" || $ocurren43_cond == "ne")
      {
         $this->monta_condicao("ocurren43", $ocurren43_cond, $ocurren43, "", "ocurren43");
      }

      //----- $codcte43
      $this->Date_part = false;
      if (isset($codcte43) || $codcte43_cond == "nu" || $codcte43_cond == "nn" || $codcte43_cond == "ep" || $codcte43_cond == "ne")
      {
         $this->monta_condicao("codcte43", $codcte43_cond, $codcte43, "", "codcte43");
      }

      //----- $tipodoc43
      $this->Date_part = false;
      if (isset($tipodoc43) || $tipodoc43_cond == "nu" || $tipodoc43_cond == "nn" || $tipodoc43_cond == "ep" || $tipodoc43_cond == "ne")
      {
         $this->monta_condicao("tipodoc43", $tipodoc43_cond, $tipodoc43, "", "tipodoc43");
      }

      //----- $numdoc43
      $this->Date_part = false;
      if (isset($numdoc43) || $numdoc43_cond == "nu" || $numdoc43_cond == "nn" || $numdoc43_cond == "ep" || $numdoc43_cond == "ne")
      {
         $this->monta_condicao("numdoc43", $numdoc43_cond, $numdoc43, "", "numdoc43");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['cond_pesq'] .= $this->NM_operador;
