<?php
@session_start() ;
$_SESSION['scriptcase']['grid_movcte2']['sc_process_barr'] = true;
require_once('../grid_movcte2/index.php');
unset($_SESSION['scriptcase']['grid_movcte2']['sc_process_barr']);
$ExportCtrl = new grid_movcte2_export_control;
$ExportCtrl->Export_barr();

class grid_movcte2_export_control
{
