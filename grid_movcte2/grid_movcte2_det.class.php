...
class grid_movcte2_det
{
 ...
 function monta_det()
 {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['seq_dir'] = 0; 
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['sub_dir'] = array(); 
   ...
   $parms_det = explode("*PDet*", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['chave_det']) ; 
   ...
   {
       $nmgp_select .= " where  tipodoc43 = '$parms_det[0]' and numdoc43 = '$parms_det[1]' and ocurren43 = '$parms_det[2]'" ;  
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
   {
       $nmgp_select .= " where  tipodoc43 = '$parms_det[0]' and numdoc43 = '$parms_det[1]' and ocurren43 = '$parms_det[2]'" ;  
   ...
   $this->porccomision1 = $rs->fields[47] ;  
   ...
   $this->porccomision2 = $rs->fields[48] ;  
   ...
   $this->porcdesctocomision1 = $rs->fields[49] ;  
   ...
   $this->porcdesctocomision2 = $rs->fields[50] ;  
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['cmp_acum']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['cmp_acum']))
   {
       $parms_acum = explode(";", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['cmp_acum']);
...
//--- 
   ...
   $nm_saida->saida("<HEAD>\r\n");
   $nm_saida->saida("   <TITLE>" . $this->Ini->Nm_lang['lang_othr_detl_title'] . " movcte2</TITLE>\r\n");
...
$nm_saida->saida("</script>\r\n");
   ...
   if (($this->Ini->sc_export_ajax || $this->Ini->Export_det_zip) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['det_print'] == "print")
   {
       ...
       $NM_css_cmp  = $this->Ini->path_link . "grid_movcte2/grid_movcte2_det_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css";
   ...
   elseif (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['det_print'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
   {
       ...
       $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_movcte2/grid_movcte2_det_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
   }
   else
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['pdf_det'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['det_print'] != "print")
   {
   ...
   $nm_saida->saida("</HEAD>\r\n");
    $removeMargin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['link_info']['remove_margin'] ? 'margin: 0;' : '';
    $removeBorder = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['link_info']['remove_border'] ? 'border-width: 0' : '';
   if (!$this->Ini->Export_html_zip && !$this->Ini->Export_det_zip && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['det_print'] == "print")
   {
       $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['link_info']['compact_mode']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['link_info']['compact_mode']) {
   ...
   $SC_Label = (isset($this->New_label['fecvendoc43'])) ? $this->New_label['fecvendoc43'] : "Fecvendoc 43"; 
   $conteudo = trim(NM_encode_input(sc_strip_script($this->fecvendoc43))); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'fecvendoc43', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'fecvendoc43', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_fecvendoc43_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_fecvendoc43_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_cvanulado43_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_conta43_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['relacioncob43'])) ? $this->New_label['relacioncob43'] : "Relacioncob 43"; 
   $conteudo = trim(sc_strip_script($this->relacioncob43)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'relacioncob43', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'relacioncob43', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_relacioncob43_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_relacioncob43_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['estadocob43'])) ? $this->New_label['estadocob43'] : "Estadocob 43"; 
   $conteudo = trim(sc_strip_script($this->estadocob43)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'estadocob43', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'estadocob43', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_estadocob43_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_estadocob43_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['nuevocodpago43'])) ? $this->New_label['nuevocodpago43'] : "Nuevocodpago 43"; 
   $conteudo = trim(sc_strip_script($this->nuevocodpago43)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'nuevocodpago43', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'nuevocodpago43', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_nuevocodpago43_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_nuevocodpago43_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['porccomision1'])) ? $this->New_label['porccomision1'] : "Porccomision 1"; 
   $conteudo = trim(NM_encode_input(sc_strip_script($this->porccomision1))); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'porccomision1', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'porccomision1', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_porccomision1_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_porccomision1_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['porccomision2'])) ? $this->New_label['porccomision2'] : "Porccomision 2"; 
   $conteudo = trim(NM_encode_input(sc_strip_script($this->porccomision2))); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'porccomision2', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'porccomision2', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_porccomision2_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_porccomision2_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['porcdesctocomision1'])) ? $this->New_label['porcdesctocomision1'] : "Porcdesctocomision 1"; 
   $conteudo = trim(NM_encode_input(sc_strip_script($this->porcdesctocomision1))); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'porcdesctocomision1', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'porcdesctocomision1', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_porcdesctocomision1_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_porcdesctocomision1_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['porcdesctocomision2'])) ? $this->New_label['porcdesctocomision2'] : "Porcdesctocomision 2"; 
   $conteudo = trim(NM_encode_input(sc_strip_script($this->porcdesctocomision2))); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'porcdesctocomision2', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'porcdesctocomision2', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_porcdesctocomision2_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_porcdesctocomision2_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['ope43'])) ? $this->New_label['ope43'] : "Ope 43"; 
   $conteudo = trim(sc_strip_script($this->ope43)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'ope43', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'ope43', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_ope43_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_ope43_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['tfin43'])) ? $this->New_label['tfin43'] : "Tfin 43"; 
   $conteudo = trim(sc_strip_script($this->tfin43)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'tfin43', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'tfin43', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_tfin43_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_tfin43_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['fin43'])) ? $this->New_label['fin43'] : "Fin 43"; 
   $conteudo = trim(sc_strip_script($this->fin43)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'fin43', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'fin43', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_fin43_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_fin43_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['ban43'])) ? $this->New_label['ban43'] : "Ban 43"; 
   $conteudo = trim(sc_strip_script($this->ban43)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'ban43', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'ban43', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_ban43_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_ban43_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['cobrador43'])) ? $this->New_label['cobrador43'] : "Cobrador 43"; 
   $conteudo = trim(sc_strip_script($this->cobrador43)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'cobrador43', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'cobrador43', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_cobrador43_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_cobrador43_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['coordinador43'])) ? $this->New_label['coordinador43'] : "Coordinador 43"; 
   $conteudo = trim(sc_strip_script($this->coordinador43)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'coordinador43', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'coordinador43', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_coordinador43_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_coordinador43_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['cierre'])) ? $this->New_label['cierre'] : "Cierre"; 
   $conteudo = trim(sc_strip_script($this->cierre)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'cierre', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'cierre', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_cierre_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_cierre_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['idcierre'])) ? $this->New_label['idcierre'] : "Idcierre"; 
   $conteudo = trim(sc_strip_script($this->idcierre)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'idcierre', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'idcierre', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_idcierre_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_idcierre_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['num_bco_dep'])) ? $this->New_label['num_bco_dep'] : "Num Bco Dep"; 
   $conteudo = trim(sc_strip_script($this->num_bco_dep)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'num_bco_dep', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'num_bco_dep', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_num_bco_dep_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_num_bco_dep_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['num_deposito'])) ? $this->New_label['num_deposito'] : "Num Deposito"; 
   $conteudo = trim(sc_strip_script($this->num_deposito)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'num_deposito', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'num_deposito', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_num_deposito_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_num_deposito_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['num_doc_cont'])) ? $this->New_label['num_doc_cont'] : "Num Doc Cont"; 
   $conteudo = trim(sc_strip_script($this->num_doc_cont)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'num_doc_cont', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'num_doc_cont', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_num_doc_cont_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_num_doc_cont_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['tip_doc_cont'])) ? $this->New_label['tip_doc_cont'] : "Tip Doc Cont"; 
   $conteudo = trim(sc_strip_script($this->tip_doc_cont)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'tip_doc_cont', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'tip_doc_cont', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_tip_doc_cont_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_tip_doc_cont_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['datosretcliente'])) ? $this->New_label['datosretcliente'] : "Datos Ret Cliente"; 
   $conteudo = trim(sc_strip_script($this->datosretcliente)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'datosretcliente', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'datosretcliente', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_datosretcliente_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_datosretcliente_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['valoresretcliente'])) ? $this->New_label['valoresretcliente'] : "Valores Ret Cliente"; 
   $conteudo = trim(sc_strip_script($this->valoresretcliente)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'valoresretcliente', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'valoresretcliente', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_valoresretcliente_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_valoresretcliente_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['beneficiario43'])) ? $this->New_label['beneficiario43'] : "Beneficiario 43"; 
   $conteudo = trim(sc_strip_script($this->beneficiario43)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'beneficiario43', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'beneficiario43', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_beneficiario43_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_beneficiario43_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['numero_cuenta'])) ? $this->New_label['numero_cuenta'] : "Numero Cuenta"; 
   $conteudo = trim(sc_strip_script($this->numero_cuenta)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'numero_cuenta', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'numero_cuenta', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_numero_cuenta_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_numero_cuenta_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['fecha_creacion_del_65'])) ? $this->New_label['fecha_creacion_del_65'] : "Fecha Creacion Del 65"; 
   $conteudo = trim(NM_encode_input(sc_strip_script($this->fecha_creacion_del_65))); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'fecha_creacion_del_65', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'fecha_creacion_del_65', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_fecha_creacion_del_65_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_fecha_creacion_del_65_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $conteudo = trim(sc_strip_script($this->adicional)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
   ...
   $SC_Label = (isset($this->New_label['fecha_adicional'])) ? $this->New_label['fecha_adicional'] : "Fecha Adicional"; 
   $conteudo = trim(NM_encode_input(sc_strip_script($this->fecha_adicional))); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'fecha_adicional', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'fecha_adicional', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_fecha_adicional_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_fecha_adicional_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['id_cotizacion'])) ? $this->New_label['id_cotizacion'] : "Id Cotizacion"; 
   $conteudo = trim(sc_strip_script($this->id_cotizacion)); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'id_cotizacion', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'id_cotizacion', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_id_cotizacion_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_id_cotizacion_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['id_cuotas_tabla_pagos'])) ? $this->New_label['id_cuotas_tabla_pagos'] : "Id Cuotas Tabla Pagos"; 
   $conteudo = trim(NM_encode_input(sc_strip_script($this->id_cuotas_tabla_pagos))); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'id_cuotas_tabla_pagos', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'id_cuotas_tabla_pagos', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_id_cuotas_tabla_pagos_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_id_cuotas_tabla_pagos_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $SC_Label = (isset($this->New_label['institucion'])) ? $this->New_label['institucion'] : "Institucion"; 
   $conteudo = trim(NM_encode_input(sc_strip_script($this->institucion))); 
   $conteudo_original = $conteudo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'institucion', $str_tem_display); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'institucion', $str_tem_display); 
          } 
              $conteudo = $str_tem_display; 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_institucion_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_institucion_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['opcao'] == "pdf")
   ...
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_estado_electronico_det_line\"  " . $this->SC_nowrap . " ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("</TABLE>\r\n");
   if(isset($_SESSION['scriptcase']['proc_mobile']) && $_SESSION['scriptcase']['proc_mobile'])
...
//--- 
   ...
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       NovaJanela = window.open (\"grid_movcte2_doc.php?nmgp_parms=\" + campo1, \"ScriptCase\", \"resizable\");\r\n");
   $nm_saida->saida("   }\r\n");
   ...
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   $nm_saida->saida("           window.location = \"" . $this->Ini->path_link . "grid_movcte2/index.php?nmgp_opcao=pdf_det&nmgp_tipo_pdf=\" + z + \"&nmgp_parms_pdf=\" + p +  \"&nmgp_graf_pdf=\" + g + \"&Det_use_pass_pdf=\" + use_pass_pdf + \"&Det_pdf_zip=\" + pdf_zip + \"&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "\";\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("   }\r\n");
   ...
   {
      global $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['det_print'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_movcte2']['pdf_det']) 
   { 
       ...
       if ($this->nmgp_botoes['det_pdf'] == "on")
       {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Dpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_movcte2/grid_movcte2_config_pdf.php?nm_opc=pdf_det&nm_target=0&nm_cor=cor&papel=1&orientacao=1&largura=1200&conf_larg=S&conf_fonte=10&language=es&conf_socor=N&sc_ver_93=" . s . "&password=n&pdf_zip=N&KeepThis=false&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
       if ($this->nmgp_botoes['det_print'] == "on")
       {
         $this->nm_btn_exist['det_print'][] = "Dprint_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Dprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_movcte2/grid_movcte2_config_print.php?nm_opc=detalhe&nm_cor=CO&password=n&language=es&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
