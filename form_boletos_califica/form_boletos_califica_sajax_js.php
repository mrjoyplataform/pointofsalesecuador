  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_boletos_califica" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_boletos_califica_form();
	}
...
?>
  ...
  // ---------- Validate idcalifica_
  function do_ajax_form_boletos_califica_validate_idcalifica_(iNumLinha)
  {
    var nomeCampo_idcalifica_ = "idcalifica_" + iNumLinha;
    var var_idcalifica_ = scAjaxGetFieldText(nomeCampo_idcalifica_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_boletos_califica_validate_idcalifica_(var_idcalifica_, iNumLinha, var_script_case_init, do_ajax_form_boletos_califica_validate_idcalifica__cb);
  } // do_ajax_form_boletos_califica_validate_idcalifica_

  function do_ajax_form_boletos_califica_validate_idcalifica__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idcalifica_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idcalifica_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idcalifica_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idcalifica_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_boletos_califica_validate_idcalifica__cb

  // ---------- Validate descrip_
  function do_ajax_form_boletos_califica_validate_descrip_(iNumLinha)
  {
    var nomeCampo_descrip_ = "descrip_" + iNumLinha;
    var var_descrip_ = scAjaxGetFieldText(nomeCampo_descrip_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_boletos_califica_validate_descrip_(var_descrip_, iNumLinha, var_script_case_init, do_ajax_form_boletos_califica_validate_descrip__cb);
  } // do_ajax_form_boletos_califica_validate_descrip_

  function do_ajax_form_boletos_califica_validate_descrip__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_boletos_califica_validate_descrip__cb

  // ---------- Validate valor_
  function do_ajax_form_boletos_califica_validate_valor_(iNumLinha)
  {
    var nomeCampo_valor_ = "valor_" + iNumLinha;
    var var_valor_ = scAjaxGetFieldText(nomeCampo_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_boletos_califica_validate_valor_(var_valor_, iNumLinha, var_script_case_init, do_ajax_form_boletos_califica_validate_valor__cb);
  } // do_ajax_form_boletos_califica_validate_valor_

  function do_ajax_form_boletos_califica_validate_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_boletos_califica_validate_valor__cb

  // ---------- Validate orden_
  function do_ajax_form_boletos_califica_validate_orden_(iNumLinha)
  {
    var nomeCampo_orden_ = "orden_" + iNumLinha;
    var var_orden_ = scAjaxGetFieldText(nomeCampo_orden_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_boletos_califica_validate_orden_(var_orden_, iNumLinha, var_script_case_init, do_ajax_form_boletos_califica_validate_orden__cb);
  } // do_ajax_form_boletos_califica_validate_orden_

  function do_ajax_form_boletos_califica_validate_orden__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_boletos_califica_validate_orden__cb

  // ---------- Validate imagen_
  function do_ajax_form_boletos_califica_validate_imagen_(iNumLinha)
  {
    var nomeCampo_imagen_ = "imagen_" + iNumLinha;
    var var_imagen_ = scAjaxGetFieldText(nomeCampo_imagen_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_boletos_califica_validate_imagen_(var_imagen_, iNumLinha, var_script_case_init, do_ajax_form_boletos_califica_validate_imagen__cb);
  } // do_ajax_form_boletos_califica_validate_imagen_

  function do_ajax_form_boletos_califica_validate_imagen__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_boletos_califica_validate_imagen__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_boletos_califica_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_boletos_califica_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_boletos_califica_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_boletos_califica_add_new_line_cb);
  } // do_ajax_form_boletos_califica_add_new_line

  function do_ajax_form_boletos_califica_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    eval("var_ajax_img_imagen_" + iAjaxNewLine + " = '';");
  } // do_ajax_form_boletos_califica_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_boletos_califica_backup_line(iNumLinha)
  {
    var var_idcalifica_ = scAjaxGetFieldText("idcalifica_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_boletos_califica_backup_line(var_idcalifica_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_boletos_califica_backup_line_cb);
  } // do_ajax_form_boletos_califica_backup_line

  function do_ajax_form_boletos_califica_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_boletos_califica_backup_line_cb

  function do_ajax_form_boletos_califica_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_boletos_califica_cancel_insert

  function do_ajax_form_boletos_califica_cancel_update(iSeqVert)
  {
    do_ajax_form_boletos_califica_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_boletos_califica_cancel_update

  function do_ajax_form_boletos_califica_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_boletos_califica_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_boletos_califica_table_refresh()
  {
    var var_idcalifica_ = document.F2.idcalifica_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_boletos_califica_table_refresh(var_idcalifica_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_boletos_califica_table_refresh_cb);
  } //  do_ajax_form_boletos_califica_table_refresh

  function do_ajax_form_boletos_califica_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idcalifica_.value = scAjaxGetKeyValue("idcalifica_");
    ...
    scAjaxAlert(do_ajax_form_boletos_califica_table_refresh_cb_after_alert);
  } // do_ajax_form_boletos_califica_table_refresh_cb
  function do_ajax_form_boletos_califica_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_boletos_califica_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_boletos_califica_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_boletos_califica_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_imagen__ul_name = scAjaxSpecCharProtect(eval('document.F1.imagen__ul_name' + iNumLinha + '.value'));
    var var_imagen__ul_type = eval('document.F1.imagen__ul_type' + iNumLinha + '.value');
    var var_imagen__limpa = eval('document.F1.imagen__limpa' + iNumLinha + '.checked') ? "S" : "N";
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_boletos_califica_submit_form(var_idcalifica_, var_descrip_, var_valor_, var_orden_, var_imagen_, var_imagen__ul_name, var_imagen__ul_type, var_imagen__limpa, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_boletos_califica_submit_form_cb);
  } // do_ajax_form_boletos_califica_submit_form

  function do_ajax_form_boletos_califica_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idcalifica_" + sc_num_ult_line);
...
<?php
        ...
        {
?>
          if (document.F1.elements["imagen__limpa" + sc_num_ult_line] && document.F1.elements["imagen__limpa" + sc_num_ult_line].checked)
          {
            var oImgTemp = {0: {"value" : ""}};
            scAjaxSetFieldImage("imagen_" + sc_num_ult_line, oImgTemp, "", "", "", "N");
            document.F1.elements["imagen__limpa" + sc_num_ult_line].checked = false;
          }
<?php
        }
?>
      }
      eval("if (document.F1.imagen__ul_name" + sc_num_ult_line + ") document.F1.imagen__ul_name" + sc_num_ult_line + ".value = ''");
      eval("if (document.F1.imagen__ul_type" + sc_num_ult_line + ") document.F1.imagen__ul_type" + sc_num_ult_line + ".value = ''");
    }
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_boletos_califica_submit_form_cb_after_alert);
  } // do_ajax_form_boletos_califica_submit_form_cb
  function do_ajax_form_boletos_califica_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_boletos_califica_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_boletos_califica_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_boletos_califica_navigate_form, function() {});
    } else {
      perform_ajax_form_boletos_califica_navigate_form();
    }
  }

  function perform_ajax_form_boletos_califica_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_boletos_califica_cancel_insert(sc_form_boletos_califica_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idcalifica_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_boletos_califica_navigate_form(var_idcalifica_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_boletos_califica_navigate_form_cb);
  } // do_ajax_form_boletos_califica_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_califica']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_boletos_califica_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idcalifica_.value = scAjaxGetKeyValue("idcalifica_" + var_last_index);
    ...
    {
      eval("if (document.F1.imagen__ul_name" + iImg + ") document.F1.imagen__ul_name" + iImg + ".value = ''");
      eval("if (document.F1.imagen__ul_type" + iImg + ") document.F1.imagen__ul_type" + iImg + ".value = ''");
    }
    scAjaxSetBtnVars();
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_boletos_califica_navigate_form_cb_after_alert);
  } // do_ajax_form_boletos_califica_navigate_form_cb
  function do_ajax_form_boletos_califica_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_boletos_califica_navigate_form_cb_after_alert

    function sc_form_boletos_califica_get_last_line_number()
    {
    ...
    } //sc_form_boletos_califica_get_last_line_number

  function sc_hide_form_boletos_califica_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idcalifica_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_error_list["idcalifica_" + iNumLinha] = {"label": "Idcalifica<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["imagen_" + iNumLinha] = {"label": "Imagen<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idcalifica_"][iNumLinha] = "idcalifica_" + iNumLinha;
    ...
    ajax_field_id["idcalifica_" + iNumLinha] = new Array("hidden_field_label_idcalifica_", "hidden_field_data_idcalifica_" + iNumLinha);
    ...
    ajax_error_count["idcalifica_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["idcalifica_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["idcalifica_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idcalifica_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idcalifica_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idcalifica_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idcalifica_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idcalifica_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idcalifica_'])) ? $this->nmgp_cmp_readonly['idcalifica_'] : 'on';
?>
    scAjaxFieldRead("idcalifica_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("idcalifica_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idcalifica_" + iRow] || "on" == ajax_error_count["descrip_" + iRow] || "on" == ajax_error_count["valor_" + iRow] || "on" == ajax_error_count["orden_" + iRow] || "on" == ajax_error_count["imagen_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idcalifica_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idcalifica_" + iRow] && "off" == ajax_error_count["descrip_" + iRow] && "off" == ajax_error_count["valor_" + iRow] && "off" == ajax_error_count["orden_" + iRow] && "off" == ajax_error_count["imagen_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idcalifica_" + iRow] = "off";
      ...
      $("#hidden_field_data_idcalifica_" + iRow).removeClass("scFormErrorLine");
