...
class grid_customer_bk_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_customer_bk.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_bk']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_bk']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_bk']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_bk']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_bk']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_bk']['rtf_name']);
      }
   ...
   function NM_export_numvisitas()
   {
         ...
         $this->numvisitas = str_replace('<', '&lt;', $this->numvisitas);
         $this->numvisitas = str_replace('>', '&gt;', $this->numvisitas);
         $this->Texto_tag .= "<td>" . $this->numvisitas . "</td>\r\n";
   }
   //----- totalventa
   function NM_export_totalventa()
   {
         ...
         $this->totalventa = str_replace('<', '&lt;', $this->totalventa);
         $this->totalventa = str_replace('>', '&gt;', $this->totalventa);
         $this->Texto_tag .= "<td>" . $this->totalventa . "</td>\r\n";
   }
   //----- idinterno
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_bk']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer_bk']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> customer :: RTF</TITLE>
