...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____chart_view_ventas_turno"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____chart_view_ventas_turno"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_view_ventas_turno']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_view_ventas_turno']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_view_ventas_turno']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_view_ventas_turno']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_view_ventas_turno']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_view_ventas_turno</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_view_ventas_turno']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_view_ventas_turno']['embutida_filho'] as $ind => $sc_init)
          {
