<?php
@session_start() ;
$_SESSION['scriptcase']['cubesales']['sc_process_barr'] = true;
require_once('../cubesales/index.php');
unset($_SESSION['scriptcase']['cubesales']['sc_process_barr']);
$ExportCtrl = new cubesales_export_control;
$ExportCtrl->Export_barr();

class cubesales_export_control
{
