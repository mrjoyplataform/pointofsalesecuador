  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_pago_importes_tarjeta" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_pago_importes_tarjeta_form();
	}
...
?>
  ...
  // ---------- Validate formapago
  function do_ajax_control_pago_importes_tarjeta_validate_formapago()
  {
    var nomeCampo_formapago = "formapago";
    var var_formapago = scAjaxGetFieldSelect(nomeCampo_formapago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_pago_importes_tarjeta_validate_formapago(var_formapago, var_script_case_init, do_ajax_control_pago_importes_tarjeta_validate_formapago_cb);
  } // do_ajax_control_pago_importes_tarjeta_validate_formapago

  function do_ajax_control_pago_importes_tarjeta_validate_formapago_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_pago_importes_tarjeta_validate_formapago_cb

  // ---------- Validate importe_recibido
  function do_ajax_control_pago_importes_tarjeta_validate_importe_recibido()
  {
    var nomeCampo_importe_recibido = "importe_recibido";
    var var_importe_recibido = scAjaxGetFieldHidden(nomeCampo_importe_recibido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_pago_importes_tarjeta_validate_importe_recibido(var_importe_recibido, var_script_case_init, do_ajax_control_pago_importes_tarjeta_validate_importe_recibido_cb);
  } // do_ajax_control_pago_importes_tarjeta_validate_importe_recibido

  function do_ajax_control_pago_importes_tarjeta_validate_importe_recibido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_pago_importes_tarjeta_validate_importe_recibido_cb

  // ---------- Validate importe_pagar
  function do_ajax_control_pago_importes_tarjeta_validate_importe_pagar()
  {
    var nomeCampo_importe_pagar = "importe_pagar";
    var var_importe_pagar = scAjaxGetFieldHidden(nomeCampo_importe_pagar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_pago_importes_tarjeta_validate_importe_pagar(var_importe_pagar, var_script_case_init, do_ajax_control_pago_importes_tarjeta_validate_importe_pagar_cb);
  } // do_ajax_control_pago_importes_tarjeta_validate_importe_pagar

  function do_ajax_control_pago_importes_tarjeta_validate_importe_pagar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_pago_importes_tarjeta_validate_importe_pagar_cb

  // ---------- Event onchange importe_recibido
  function do_ajax_control_pago_importes_tarjeta_event_importe_recibido_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_control_pago_importes_tarjeta_event_importe_recibido_onchange(var_importe_recibido, var_importe_pagar, var_formapago, var_cambio, var_fatan, var_script_case_init, do_ajax_control_pago_importes_tarjeta_event_importe_recibido_onchange_cb);
  } // do_ajax_control_pago_importes_tarjeta_event_importe_recibido_onchange

  function do_ajax_control_pago_importes_tarjeta_event_importe_recibido_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "importe_recibido";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_pago_importes_tarjeta_event_importe_recibido_onchange_cb_after_alert);
  } // do_ajax_control_pago_importes_tarjeta_event_importe_recibido_onchange_cb
  function do_ajax_control_pago_importes_tarjeta_event_importe_recibido_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_pago_importes_tarjeta_event_importe_recibido_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_pago_importes_tarjeta_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_pago_importes_tarjeta_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_formapago = scAjaxGetFieldSelect("formapago");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_control_pago_importes_tarjeta_submit_form(var_formapago, var_importe_recibido, var_importe_pagar, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_control_pago_importes_tarjeta_submit_form_cb);
  } // do_ajax_control_pago_importes_tarjeta_submit_form

  function do_ajax_control_pago_importes_tarjeta_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_pago_importes_tarjeta_submit_form_cb_after_alert);
  } // do_ajax_control_pago_importes_tarjeta_submit_form_cb
  function do_ajax_control_pago_importes_tarjeta_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_pago_importes_tarjeta_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_pago_importes_tarjeta_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_control_pago_importes_tarjeta_navigate_form, function() {});
    } else {
      perform_ajax_control_pago_importes_tarjeta_navigate_form();
    }
  }

  function perform_ajax_control_pago_importes_tarjeta_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_pago_importes_tarjeta_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_importes_tarjeta']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_pago_importes_tarjeta_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_pago_importes_tarjeta_navigate_form_cb_after_alert);
  } // do_ajax_control_pago_importes_tarjeta_navigate_form_cb
  function do_ajax_control_pago_importes_tarjeta_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_control_pago_importes_tarjeta_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_pago_importes_tarjeta_navigate_form_cb_after_alert

  function sc_hide_control_pago_importes_tarjeta_form()
  {
