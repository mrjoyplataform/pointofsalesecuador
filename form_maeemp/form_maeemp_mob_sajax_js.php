  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_maeemp_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate rp01noemp
  function do_ajax_form_maeemp_mob_validate_rp01noemp()
  {
    var nomeCampo_rp01noemp = "rp01noemp";
    var var_rp01noemp = scAjaxGetFieldText(nomeCampo_rp01noemp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01noemp(var_rp01noemp, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01noemp_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01noemp

  function do_ajax_form_maeemp_mob_validate_rp01noemp_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01noemp_cb

  // ---------- Validate rp01division
  function do_ajax_form_maeemp_mob_validate_rp01division()
  {
    var nomeCampo_rp01division = "rp01division";
    var var_rp01division = scAjaxGetFieldText(nomeCampo_rp01division);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01division(var_rp01division, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01division_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01division

  function do_ajax_form_maeemp_mob_validate_rp01division_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01division_cb

  // ---------- Validate rp01depto
  function do_ajax_form_maeemp_mob_validate_rp01depto()
  {
    var nomeCampo_rp01depto = "rp01depto";
    var var_rp01depto = scAjaxGetFieldText(nomeCampo_rp01depto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01depto(var_rp01depto, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01depto_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01depto

  function do_ajax_form_maeemp_mob_validate_rp01depto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01depto_cb

  // ---------- Validate rp01seccion
  function do_ajax_form_maeemp_mob_validate_rp01seccion()
  {
    var nomeCampo_rp01seccion = "rp01seccion";
    var var_rp01seccion = scAjaxGetFieldText(nomeCampo_rp01seccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01seccion(var_rp01seccion, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01seccion_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01seccion

  function do_ajax_form_maeemp_mob_validate_rp01seccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01seccion_cb

  // ---------- Validate rp01noemp1
  function do_ajax_form_maeemp_mob_validate_rp01noemp1()
  {
    var nomeCampo_rp01noemp1 = "rp01noemp1";
    var var_rp01noemp1 = scAjaxGetFieldText(nomeCampo_rp01noemp1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01noemp1(var_rp01noemp1, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01noemp1_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01noemp1

  function do_ajax_form_maeemp_mob_validate_rp01noemp1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01noemp1_cb

  // ---------- Validate rp01nombreemp
  function do_ajax_form_maeemp_mob_validate_rp01nombreemp()
  {
    var nomeCampo_rp01nombreemp = "rp01nombreemp";
    var var_rp01nombreemp = scAjaxGetFieldText(nomeCampo_rp01nombreemp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01nombreemp(var_rp01nombreemp, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01nombreemp_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01nombreemp

  function do_ajax_form_maeemp_mob_validate_rp01nombreemp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01nombreemp_cb

  // ---------- Validate rp01categoria
  function do_ajax_form_maeemp_mob_validate_rp01categoria()
  {
    var nomeCampo_rp01categoria = "rp01categoria";
    var var_rp01categoria = scAjaxGetFieldText(nomeCampo_rp01categoria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01categoria(var_rp01categoria, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01categoria_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01categoria

  function do_ajax_form_maeemp_mob_validate_rp01categoria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01categoria_cb

  // ---------- Validate rp01turno
  function do_ajax_form_maeemp_mob_validate_rp01turno()
  {
    var nomeCampo_rp01turno = "rp01turno";
    var var_rp01turno = scAjaxGetFieldText(nomeCampo_rp01turno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01turno(var_rp01turno, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01turno_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01turno

  function do_ajax_form_maeemp_mob_validate_rp01turno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01turno_cb

  // ---------- Validate rp01statusemp
  function do_ajax_form_maeemp_mob_validate_rp01statusemp()
  {
    var nomeCampo_rp01statusemp = "rp01statusemp";
    var var_rp01statusemp = scAjaxGetFieldText(nomeCampo_rp01statusemp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01statusemp(var_rp01statusemp, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01statusemp_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01statusemp

  function do_ajax_form_maeemp_mob_validate_rp01statusemp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01statusemp_cb

  // ---------- Validate rp01fechastatus
  function do_ajax_form_maeemp_mob_validate_rp01fechastatus()
  {
    var nomeCampo_rp01fechastatus = "rp01fechastatus";
    var var_rp01fechastatus = scAjaxGetFieldText(nomeCampo_rp01fechastatus);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01fechastatus(var_rp01fechastatus, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01fechastatus_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01fechastatus

  function do_ajax_form_maeemp_mob_validate_rp01fechastatus_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01fechastatus_cb

  // ---------- Validate rp01causaretiro
  function do_ajax_form_maeemp_mob_validate_rp01causaretiro()
  {
    var nomeCampo_rp01causaretiro = "rp01causaretiro";
    var var_rp01causaretiro = scAjaxGetFieldText(nomeCampo_rp01causaretiro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01causaretiro(var_rp01causaretiro, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01causaretiro_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01causaretiro

  function do_ajax_form_maeemp_mob_validate_rp01causaretiro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01causaretiro_cb

  // ---------- Validate rp01direccion
  function do_ajax_form_maeemp_mob_validate_rp01direccion()
  {
    var nomeCampo_rp01direccion = "rp01direccion";
    var var_rp01direccion = scAjaxGetFieldText(nomeCampo_rp01direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01direccion(var_rp01direccion, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01direccion_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01direccion

  function do_ajax_form_maeemp_mob_validate_rp01direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01direccion_cb

  // ---------- Validate rp01telefono
  function do_ajax_form_maeemp_mob_validate_rp01telefono()
  {
    var nomeCampo_rp01telefono = "rp01telefono";
    var var_rp01telefono = scAjaxGetFieldText(nomeCampo_rp01telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01telefono(var_rp01telefono, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01telefono_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01telefono

  function do_ajax_form_maeemp_mob_validate_rp01telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01telefono_cb

  // ---------- Validate rp01lugarnacimiento
  function do_ajax_form_maeemp_mob_validate_rp01lugarnacimiento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01lugarnacimiento(var_rp01lugarnacimiento, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01lugarnacimiento_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01lugarnacimiento

  function do_ajax_form_maeemp_mob_validate_rp01lugarnacimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01lugarnacimiento_cb

  // ---------- Validate rp01fechanacimiento
  function do_ajax_form_maeemp_mob_validate_rp01fechanacimiento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01fechanacimiento(var_rp01fechanacimiento, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01fechanacimiento_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01fechanacimiento

  function do_ajax_form_maeemp_mob_validate_rp01fechanacimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01fechanacimiento_cb

  // ---------- Validate rp01nacionalidad
  function do_ajax_form_maeemp_mob_validate_rp01nacionalidad()
  {
    var nomeCampo_rp01nacionalidad = "rp01nacionalidad";
    var var_rp01nacionalidad = scAjaxGetFieldText(nomeCampo_rp01nacionalidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01nacionalidad(var_rp01nacionalidad, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01nacionalidad_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01nacionalidad

  function do_ajax_form_maeemp_mob_validate_rp01nacionalidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01nacionalidad_cb

  // ---------- Validate rp01cedula
  function do_ajax_form_maeemp_mob_validate_rp01cedula()
  {
    var nomeCampo_rp01cedula = "rp01cedula";
    var var_rp01cedula = scAjaxGetFieldText(nomeCampo_rp01cedula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01cedula(var_rp01cedula, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01cedula_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01cedula

  function do_ajax_form_maeemp_mob_validate_rp01cedula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01cedula_cb

  // ---------- Validate rp01noiess
  function do_ajax_form_maeemp_mob_validate_rp01noiess()
  {
    var nomeCampo_rp01noiess = "rp01noiess";
    var var_rp01noiess = scAjaxGetFieldText(nomeCampo_rp01noiess);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01noiess(var_rp01noiess, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01noiess_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01noiess

  function do_ajax_form_maeemp_mob_validate_rp01noiess_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01noiess_cb

  // ---------- Validate rp01sexo
  function do_ajax_form_maeemp_mob_validate_rp01sexo()
  {
    var nomeCampo_rp01sexo = "rp01sexo";
    var var_rp01sexo = scAjaxGetFieldText(nomeCampo_rp01sexo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01sexo(var_rp01sexo, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01sexo_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01sexo

  function do_ajax_form_maeemp_mob_validate_rp01sexo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01sexo_cb

  // ---------- Validate rp01nolibreta
  function do_ajax_form_maeemp_mob_validate_rp01nolibreta()
  {
    var nomeCampo_rp01nolibreta = "rp01nolibreta";
    var var_rp01nolibreta = scAjaxGetFieldText(nomeCampo_rp01nolibreta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01nolibreta(var_rp01nolibreta, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01nolibreta_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01nolibreta

  function do_ajax_form_maeemp_mob_validate_rp01nolibreta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01nolibreta_cb

  // ---------- Validate rp01profesion
  function do_ajax_form_maeemp_mob_validate_rp01profesion()
  {
    var nomeCampo_rp01profesion = "rp01profesion";
    var var_rp01profesion = scAjaxGetFieldText(nomeCampo_rp01profesion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01profesion(var_rp01profesion, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01profesion_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01profesion

  function do_ajax_form_maeemp_mob_validate_rp01profesion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01profesion_cb

  // ---------- Validate rp01fechaingreso
  function do_ajax_form_maeemp_mob_validate_rp01fechaingreso()
  {
    var nomeCampo_rp01fechaingreso = "rp01fechaingreso";
    var var_rp01fechaingreso = scAjaxGetFieldText(nomeCampo_rp01fechaingreso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01fechaingreso(var_rp01fechaingreso, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01fechaingreso_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01fechaingreso

  function do_ajax_form_maeemp_mob_validate_rp01fechaingreso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01fechaingreso_cb

  // ---------- Validate rp01fechareingreso
  function do_ajax_form_maeemp_mob_validate_rp01fechareingreso()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01fechareingreso(var_rp01fechareingreso, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01fechareingreso_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01fechareingreso

  function do_ajax_form_maeemp_mob_validate_rp01fechareingreso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01fechareingreso_cb

  // ---------- Validate rp01cargo
  function do_ajax_form_maeemp_mob_validate_rp01cargo()
  {
    var nomeCampo_rp01cargo = "rp01cargo";
    var var_rp01cargo = scAjaxGetFieldText(nomeCampo_rp01cargo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01cargo(var_rp01cargo, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01cargo_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01cargo

  function do_ajax_form_maeemp_mob_validate_rp01cargo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01cargo_cb

  // ---------- Validate rp01estadocivil
  function do_ajax_form_maeemp_mob_validate_rp01estadocivil()
  {
    var nomeCampo_rp01estadocivil = "rp01estadocivil";
    var var_rp01estadocivil = scAjaxGetFieldText(nomeCampo_rp01estadocivil);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01estadocivil(var_rp01estadocivil, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01estadocivil_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01estadocivil

  function do_ajax_form_maeemp_mob_validate_rp01estadocivil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01estadocivil_cb

  // ---------- Validate rp01rebajaxcasado
  function do_ajax_form_maeemp_mob_validate_rp01rebajaxcasado()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01rebajaxcasado(var_rp01rebajaxcasado, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01rebajaxcasado_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01rebajaxcasado

  function do_ajax_form_maeemp_mob_validate_rp01rebajaxcasado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01rebajaxcasado_cb

  // ---------- Validate rp01nombreconyuge
  function do_ajax_form_maeemp_mob_validate_rp01nombreconyuge()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01nombreconyuge(var_rp01nombreconyuge, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01nombreconyuge_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01nombreconyuge

  function do_ajax_form_maeemp_mob_validate_rp01nombreconyuge_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01nombreconyuge_cb

  // ---------- Validate rp01nombrepadre
  function do_ajax_form_maeemp_mob_validate_rp01nombrepadre()
  {
    var nomeCampo_rp01nombrepadre = "rp01nombrepadre";
    var var_rp01nombrepadre = scAjaxGetFieldText(nomeCampo_rp01nombrepadre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01nombrepadre(var_rp01nombrepadre, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01nombrepadre_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01nombrepadre

  function do_ajax_form_maeemp_mob_validate_rp01nombrepadre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01nombrepadre_cb

  // ---------- Validate rp01nombremadre
  function do_ajax_form_maeemp_mob_validate_rp01nombremadre()
  {
    var nomeCampo_rp01nombremadre = "rp01nombremadre";
    var var_rp01nombremadre = scAjaxGetFieldText(nomeCampo_rp01nombremadre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01nombremadre(var_rp01nombremadre, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01nombremadre_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01nombremadre

  function do_ajax_form_maeemp_mob_validate_rp01nombremadre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01nombremadre_cb

  // ---------- Validate rp01nohijos
  function do_ajax_form_maeemp_mob_validate_rp01nohijos()
  {
    var nomeCampo_rp01nohijos = "rp01nohijos";
    var var_rp01nohijos = scAjaxGetFieldText(nomeCampo_rp01nohijos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01nohijos(var_rp01nohijos, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01nohijos_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01nohijos

  function do_ajax_form_maeemp_mob_validate_rp01nohijos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01nohijos_cb

  // ---------- Validate rp01fechahijos0
  function do_ajax_form_maeemp_mob_validate_rp01fechahijos0()
  {
    var nomeCampo_rp01fechahijos0 = "rp01fechahijos0";
    var var_rp01fechahijos0 = scAjaxGetFieldText(nomeCampo_rp01fechahijos0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01fechahijos0(var_rp01fechahijos0, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01fechahijos0_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01fechahijos0

  function do_ajax_form_maeemp_mob_validate_rp01fechahijos0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01fechahijos0_cb

  // ---------- Validate rp01sexohijos0
  function do_ajax_form_maeemp_mob_validate_rp01sexohijos0()
  {
    var nomeCampo_rp01sexohijos0 = "rp01sexohijos0";
    var var_rp01sexohijos0 = scAjaxGetFieldText(nomeCampo_rp01sexohijos0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01sexohijos0(var_rp01sexohijos0, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01sexohijos0_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01sexohijos0

  function do_ajax_form_maeemp_mob_validate_rp01sexohijos0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01sexohijos0_cb

  // ---------- Validate rp01fechahijos1
  function do_ajax_form_maeemp_mob_validate_rp01fechahijos1()
  {
    var nomeCampo_rp01fechahijos1 = "rp01fechahijos1";
    var var_rp01fechahijos1 = scAjaxGetFieldText(nomeCampo_rp01fechahijos1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01fechahijos1(var_rp01fechahijos1, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01fechahijos1_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01fechahijos1

  function do_ajax_form_maeemp_mob_validate_rp01fechahijos1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01fechahijos1_cb

  // ---------- Validate rp01sexohijos1
  function do_ajax_form_maeemp_mob_validate_rp01sexohijos1()
  {
    var nomeCampo_rp01sexohijos1 = "rp01sexohijos1";
    var var_rp01sexohijos1 = scAjaxGetFieldText(nomeCampo_rp01sexohijos1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01sexohijos1(var_rp01sexohijos1, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01sexohijos1_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01sexohijos1

  function do_ajax_form_maeemp_mob_validate_rp01sexohijos1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01sexohijos1_cb

  // ---------- Validate rp01fechahijos2
  function do_ajax_form_maeemp_mob_validate_rp01fechahijos2()
  {
    var nomeCampo_rp01fechahijos2 = "rp01fechahijos2";
    var var_rp01fechahijos2 = scAjaxGetFieldText(nomeCampo_rp01fechahijos2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01fechahijos2(var_rp01fechahijos2, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01fechahijos2_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01fechahijos2

  function do_ajax_form_maeemp_mob_validate_rp01fechahijos2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01fechahijos2_cb

  // ---------- Validate rp01sexohijos2
  function do_ajax_form_maeemp_mob_validate_rp01sexohijos2()
  {
    var nomeCampo_rp01sexohijos2 = "rp01sexohijos2";
    var var_rp01sexohijos2 = scAjaxGetFieldText(nomeCampo_rp01sexohijos2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01sexohijos2(var_rp01sexohijos2, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01sexohijos2_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01sexohijos2

  function do_ajax_form_maeemp_mob_validate_rp01sexohijos2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01sexohijos2_cb

  // ---------- Validate rp01fechahijos3
  function do_ajax_form_maeemp_mob_validate_rp01fechahijos3()
  {
    var nomeCampo_rp01fechahijos3 = "rp01fechahijos3";
    var var_rp01fechahijos3 = scAjaxGetFieldText(nomeCampo_rp01fechahijos3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01fechahijos3(var_rp01fechahijos3, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01fechahijos3_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01fechahijos3

  function do_ajax_form_maeemp_mob_validate_rp01fechahijos3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01fechahijos3_cb

  // ---------- Validate rp01sexohijos3
  function do_ajax_form_maeemp_mob_validate_rp01sexohijos3()
  {
    var nomeCampo_rp01sexohijos3 = "rp01sexohijos3";
    var var_rp01sexohijos3 = scAjaxGetFieldText(nomeCampo_rp01sexohijos3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01sexohijos3(var_rp01sexohijos3, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01sexohijos3_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01sexohijos3

  function do_ajax_form_maeemp_mob_validate_rp01sexohijos3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01sexohijos3_cb

  // ---------- Validate rp01fechahijos4
  function do_ajax_form_maeemp_mob_validate_rp01fechahijos4()
  {
    var nomeCampo_rp01fechahijos4 = "rp01fechahijos4";
    var var_rp01fechahijos4 = scAjaxGetFieldText(nomeCampo_rp01fechahijos4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01fechahijos4(var_rp01fechahijos4, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01fechahijos4_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01fechahijos4

  function do_ajax_form_maeemp_mob_validate_rp01fechahijos4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01fechahijos4_cb

  // ---------- Validate rp01sexohijos4
  function do_ajax_form_maeemp_mob_validate_rp01sexohijos4()
  {
    var nomeCampo_rp01sexohijos4 = "rp01sexohijos4";
    var var_rp01sexohijos4 = scAjaxGetFieldText(nomeCampo_rp01sexohijos4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01sexohijos4(var_rp01sexohijos4, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01sexohijos4_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01sexohijos4

  function do_ajax_form_maeemp_mob_validate_rp01sexohijos4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01sexohijos4_cb

  // ---------- Validate rp01fechahijos5
  function do_ajax_form_maeemp_mob_validate_rp01fechahijos5()
  {
    var nomeCampo_rp01fechahijos5 = "rp01fechahijos5";
    var var_rp01fechahijos5 = scAjaxGetFieldText(nomeCampo_rp01fechahijos5);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01fechahijos5(var_rp01fechahijos5, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01fechahijos5_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01fechahijos5

  function do_ajax_form_maeemp_mob_validate_rp01fechahijos5_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01fechahijos5_cb

  // ---------- Validate rp01sexohijos5
  function do_ajax_form_maeemp_mob_validate_rp01sexohijos5()
  {
    var nomeCampo_rp01sexohijos5 = "rp01sexohijos5";
    var var_rp01sexohijos5 = scAjaxGetFieldText(nomeCampo_rp01sexohijos5);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01sexohijos5(var_rp01sexohijos5, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01sexohijos5_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01sexohijos5

  function do_ajax_form_maeemp_mob_validate_rp01sexohijos5_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01sexohijos5_cb

  // ---------- Validate rp01fechahijos6
  function do_ajax_form_maeemp_mob_validate_rp01fechahijos6()
  {
    var nomeCampo_rp01fechahijos6 = "rp01fechahijos6";
    var var_rp01fechahijos6 = scAjaxGetFieldText(nomeCampo_rp01fechahijos6);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01fechahijos6(var_rp01fechahijos6, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01fechahijos6_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01fechahijos6

  function do_ajax_form_maeemp_mob_validate_rp01fechahijos6_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01fechahijos6_cb

  // ---------- Validate rp01sexohijos6
  function do_ajax_form_maeemp_mob_validate_rp01sexohijos6()
  {
    var nomeCampo_rp01sexohijos6 = "rp01sexohijos6";
    var var_rp01sexohijos6 = scAjaxGetFieldText(nomeCampo_rp01sexohijos6);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01sexohijos6(var_rp01sexohijos6, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01sexohijos6_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01sexohijos6

  function do_ajax_form_maeemp_mob_validate_rp01sexohijos6_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01sexohijos6_cb

  // ---------- Validate rp01fechahijos7
  function do_ajax_form_maeemp_mob_validate_rp01fechahijos7()
  {
    var nomeCampo_rp01fechahijos7 = "rp01fechahijos7";
    var var_rp01fechahijos7 = scAjaxGetFieldText(nomeCampo_rp01fechahijos7);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01fechahijos7(var_rp01fechahijos7, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01fechahijos7_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01fechahijos7

  function do_ajax_form_maeemp_mob_validate_rp01fechahijos7_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01fechahijos7_cb

  // ---------- Validate rp01sexohijos7
  function do_ajax_form_maeemp_mob_validate_rp01sexohijos7()
  {
    var nomeCampo_rp01sexohijos7 = "rp01sexohijos7";
    var var_rp01sexohijos7 = scAjaxGetFieldText(nomeCampo_rp01sexohijos7);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01sexohijos7(var_rp01sexohijos7, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01sexohijos7_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01sexohijos7

  function do_ajax_form_maeemp_mob_validate_rp01sexohijos7_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01sexohijos7_cb

  // ---------- Validate rp01fechahijos8
  function do_ajax_form_maeemp_mob_validate_rp01fechahijos8()
  {
    var nomeCampo_rp01fechahijos8 = "rp01fechahijos8";
    var var_rp01fechahijos8 = scAjaxGetFieldText(nomeCampo_rp01fechahijos8);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01fechahijos8(var_rp01fechahijos8, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01fechahijos8_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01fechahijos8

  function do_ajax_form_maeemp_mob_validate_rp01fechahijos8_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01fechahijos8_cb

  // ---------- Validate rp01sexohijos8
  function do_ajax_form_maeemp_mob_validate_rp01sexohijos8()
  {
    var nomeCampo_rp01sexohijos8 = "rp01sexohijos8";
    var var_rp01sexohijos8 = scAjaxGetFieldText(nomeCampo_rp01sexohijos8);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01sexohijos8(var_rp01sexohijos8, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01sexohijos8_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01sexohijos8

  function do_ajax_form_maeemp_mob_validate_rp01sexohijos8_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01sexohijos8_cb

  // ---------- Validate rp01fechahijos9
  function do_ajax_form_maeemp_mob_validate_rp01fechahijos9()
  {
    var nomeCampo_rp01fechahijos9 = "rp01fechahijos9";
    var var_rp01fechahijos9 = scAjaxGetFieldText(nomeCampo_rp01fechahijos9);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01fechahijos9(var_rp01fechahijos9, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01fechahijos9_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01fechahijos9

  function do_ajax_form_maeemp_mob_validate_rp01fechahijos9_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01fechahijos9_cb

  // ---------- Validate rp01sexohijos9
  function do_ajax_form_maeemp_mob_validate_rp01sexohijos9()
  {
    var nomeCampo_rp01sexohijos9 = "rp01sexohijos9";
    var var_rp01sexohijos9 = scAjaxGetFieldText(nomeCampo_rp01sexohijos9);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01sexohijos9(var_rp01sexohijos9, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01sexohijos9_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01sexohijos9

  function do_ajax_form_maeemp_mob_validate_rp01sexohijos9_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01sexohijos9_cb

  // ---------- Validate rp01cargaspadres
  function do_ajax_form_maeemp_mob_validate_rp01cargaspadres()
  {
    var nomeCampo_rp01cargaspadres = "rp01cargaspadres";
    var var_rp01cargaspadres = scAjaxGetFieldText(nomeCampo_rp01cargaspadres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01cargaspadres(var_rp01cargaspadres, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01cargaspadres_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01cargaspadres

  function do_ajax_form_maeemp_mob_validate_rp01cargaspadres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01cargaspadres_cb

  // ---------- Validate rp01otrascargas
  function do_ajax_form_maeemp_mob_validate_rp01otrascargas()
  {
    var nomeCampo_rp01otrascargas = "rp01otrascargas";
    var var_rp01otrascargas = scAjaxGetFieldText(nomeCampo_rp01otrascargas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01otrascargas(var_rp01otrascargas, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01otrascargas_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01otrascargas

  function do_ajax_form_maeemp_mob_validate_rp01otrascargas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01otrascargas_cb

  // ---------- Validate rp01formapago
  function do_ajax_form_maeemp_mob_validate_rp01formapago()
  {
    var nomeCampo_rp01formapago = "rp01formapago";
    var var_rp01formapago = scAjaxGetFieldText(nomeCampo_rp01formapago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01formapago(var_rp01formapago, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01formapago_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01formapago

  function do_ajax_form_maeemp_mob_validate_rp01formapago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01formapago_cb

  // ---------- Validate rp01nobancoemp
  function do_ajax_form_maeemp_mob_validate_rp01nobancoemp()
  {
    var nomeCampo_rp01nobancoemp = "rp01nobancoemp";
    var var_rp01nobancoemp = scAjaxGetFieldText(nomeCampo_rp01nobancoemp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01nobancoemp(var_rp01nobancoemp, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01nobancoemp_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01nobancoemp

  function do_ajax_form_maeemp_mob_validate_rp01nobancoemp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01nobancoemp_cb

  // ---------- Validate rp01ctabancoemp
  function do_ajax_form_maeemp_mob_validate_rp01ctabancoemp()
  {
    var nomeCampo_rp01ctabancoemp = "rp01ctabancoemp";
    var var_rp01ctabancoemp = scAjaxGetFieldText(nomeCampo_rp01ctabancoemp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01ctabancoemp(var_rp01ctabancoemp, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01ctabancoemp_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01ctabancoemp

  function do_ajax_form_maeemp_mob_validate_rp01ctabancoemp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01ctabancoemp_cb

  // ---------- Validate rp01tipoctabco
  function do_ajax_form_maeemp_mob_validate_rp01tipoctabco()
  {
    var nomeCampo_rp01tipoctabco = "rp01tipoctabco";
    var var_rp01tipoctabco = scAjaxGetFieldText(nomeCampo_rp01tipoctabco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01tipoctabco(var_rp01tipoctabco, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01tipoctabco_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01tipoctabco

  function do_ajax_form_maeemp_mob_validate_rp01tipoctabco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01tipoctabco_cb

  // ---------- Validate rp01fechaultvacacion
  function do_ajax_form_maeemp_mob_validate_rp01fechaultvacacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01fechaultvacacion(var_rp01fechaultvacacion, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01fechaultvacacion_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01fechaultvacacion

  function do_ajax_form_maeemp_mob_validate_rp01fechaultvacacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01fechaultvacacion_cb

  // ---------- Validate rp01aporte
  function do_ajax_form_maeemp_mob_validate_rp01aporte()
  {
    var nomeCampo_rp01aporte = "rp01aporte";
    var var_rp01aporte = scAjaxGetFieldText(nomeCampo_rp01aporte);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01aporte(var_rp01aporte, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01aporte_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01aporte

  function do_ajax_form_maeemp_mob_validate_rp01aporte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01aporte_cb

  // ---------- Validate rp01socio
  function do_ajax_form_maeemp_mob_validate_rp01socio()
  {
    var nomeCampo_rp01socio = "rp01socio";
    var var_rp01socio = scAjaxGetFieldText(nomeCampo_rp01socio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01socio(var_rp01socio, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01socio_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01socio

  function do_ajax_form_maeemp_mob_validate_rp01socio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01socio_cb

  // ---------- Validate rp01transporte
  function do_ajax_form_maeemp_mob_validate_rp01transporte()
  {
    var nomeCampo_rp01transporte = "rp01transporte";
    var var_rp01transporte = scAjaxGetFieldText(nomeCampo_rp01transporte);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01transporte(var_rp01transporte, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01transporte_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01transporte

  function do_ajax_form_maeemp_mob_validate_rp01transporte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01transporte_cb

  // ---------- Validate rp01recibeporc
  function do_ajax_form_maeemp_mob_validate_rp01recibeporc()
  {
    var nomeCampo_rp01recibeporc = "rp01recibeporc";
    var var_rp01recibeporc = scAjaxGetFieldText(nomeCampo_rp01recibeporc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01recibeporc(var_rp01recibeporc, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01recibeporc_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01recibeporc

  function do_ajax_form_maeemp_mob_validate_rp01recibeporc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01recibeporc_cb

  // ---------- Validate rp01sueldoanterior
  function do_ajax_form_maeemp_mob_validate_rp01sueldoanterior()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01sueldoanterior(var_rp01sueldoanterior, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01sueldoanterior_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01sueldoanterior

  function do_ajax_form_maeemp_mob_validate_rp01sueldoanterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01sueldoanterior_cb

  // ---------- Validate rp01sueldosalario
  function do_ajax_form_maeemp_mob_validate_rp01sueldosalario()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01sueldosalario(var_rp01sueldosalario, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01sueldosalario_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01sueldosalario

  function do_ajax_form_maeemp_mob_validate_rp01sueldosalario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01sueldosalario_cb

  // ---------- Validate rp01fecmodsdosal
  function do_ajax_form_maeemp_mob_validate_rp01fecmodsdosal()
  {
    var nomeCampo_rp01fecmodsdosal = "rp01fecmodsdosal";
    var var_rp01fecmodsdosal = scAjaxGetFieldText(nomeCampo_rp01fecmodsdosal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01fecmodsdosal(var_rp01fecmodsdosal, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01fecmodsdosal_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01fecmodsdosal

  function do_ajax_form_maeemp_mob_validate_rp01fecmodsdosal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01fecmodsdosal_cb

  // ---------- Validate rp01fecmodficha
  function do_ajax_form_maeemp_mob_validate_rp01fecmodficha()
  {
    var nomeCampo_rp01fecmodficha = "rp01fecmodficha";
    var var_rp01fecmodficha = scAjaxGetFieldText(nomeCampo_rp01fecmodficha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01fecmodficha(var_rp01fecmodficha, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01fecmodficha_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01fecmodficha

  function do_ajax_form_maeemp_mob_validate_rp01fecmodficha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01fecmodficha_cb

  // ---------- Validate rp01faltasinjust
  function do_ajax_form_maeemp_mob_validate_rp01faltasinjust()
  {
    var nomeCampo_rp01faltasinjust = "rp01faltasinjust";
    var var_rp01faltasinjust = scAjaxGetFieldText(nomeCampo_rp01faltasinjust);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01faltasinjust(var_rp01faltasinjust, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01faltasinjust_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01faltasinjust

  function do_ajax_form_maeemp_mob_validate_rp01faltasinjust_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01faltasinjust_cb

  // ---------- Validate rp01ingresos1er
  function do_ajax_form_maeemp_mob_validate_rp01ingresos1er()
  {
    var nomeCampo_rp01ingresos1er = "rp01ingresos1er";
    var var_rp01ingresos1er = scAjaxGetFieldText(nomeCampo_rp01ingresos1er);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01ingresos1er(var_rp01ingresos1er, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01ingresos1er_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01ingresos1er

  function do_ajax_form_maeemp_mob_validate_rp01ingresos1er_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01ingresos1er_cb

  // ---------- Validate rp01basesocialvalor
  function do_ajax_form_maeemp_mob_validate_rp01basesocialvalor()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01basesocialvalor(var_rp01basesocialvalor, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01basesocialvalor_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01basesocialvalor

  function do_ajax_form_maeemp_mob_validate_rp01basesocialvalor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01basesocialvalor_cb

  // ---------- Validate rp01basesocialtiempo
  function do_ajax_form_maeemp_mob_validate_rp01basesocialtiempo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01basesocialtiempo(var_rp01basesocialtiempo, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01basesocialtiempo_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01basesocialtiempo

  function do_ajax_form_maeemp_mob_validate_rp01basesocialtiempo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01basesocialtiempo_cb

  // ---------- Validate rp0114vopagoacum
  function do_ajax_form_maeemp_mob_validate_rp0114vopagoacum()
  {
    var nomeCampo_rp0114vopagoacum = "rp0114vopagoacum";
    var var_rp0114vopagoacum = scAjaxGetFieldText(nomeCampo_rp0114vopagoacum);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp0114vopagoacum(var_rp0114vopagoacum, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp0114vopagoacum_cb);
  } // do_ajax_form_maeemp_mob_validate_rp0114vopagoacum

  function do_ajax_form_maeemp_mob_validate_rp0114vopagoacum_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp0114vopagoacum_cb

  // ---------- Validate rp0115vopagoacum
  function do_ajax_form_maeemp_mob_validate_rp0115vopagoacum()
  {
    var nomeCampo_rp0115vopagoacum = "rp0115vopagoacum";
    var var_rp0115vopagoacum = scAjaxGetFieldText(nomeCampo_rp0115vopagoacum);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp0115vopagoacum(var_rp0115vopagoacum, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp0115vopagoacum_cb);
  } // do_ajax_form_maeemp_mob_validate_rp0115vopagoacum

  function do_ajax_form_maeemp_mob_validate_rp0115vopagoacum_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp0115vopagoacum_cb

  // ---------- Validate rp01cverrorliq
  function do_ajax_form_maeemp_mob_validate_rp01cverrorliq()
  {
    var nomeCampo_rp01cverrorliq = "rp01cverrorliq";
    var var_rp01cverrorliq = scAjaxGetFieldText(nomeCampo_rp01cverrorliq);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01cverrorliq(var_rp01cverrorliq, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01cverrorliq_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01cverrorliq

  function do_ajax_form_maeemp_mob_validate_rp01cverrorliq_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01cverrorliq_cb

  // ---------- Validate rp01porcentliq
  function do_ajax_form_maeemp_mob_validate_rp01porcentliq()
  {
    var nomeCampo_rp01porcentliq = "rp01porcentliq";
    var var_rp01porcentliq = scAjaxGetFieldText(nomeCampo_rp01porcentliq);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01porcentliq(var_rp01porcentliq, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01porcentliq_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01porcentliq

  function do_ajax_form_maeemp_mob_validate_rp01porcentliq_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01porcentliq_cb

  // ---------- Validate rp01tiposangre
  function do_ajax_form_maeemp_mob_validate_rp01tiposangre()
  {
    var nomeCampo_rp01tiposangre = "rp01tiposangre";
    var var_rp01tiposangre = scAjaxGetFieldText(nomeCampo_rp01tiposangre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01tiposangre(var_rp01tiposangre, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01tiposangre_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01tiposangre

  function do_ajax_form_maeemp_mob_validate_rp01tiposangre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01tiposangre_cb

  // ---------- Validate rp01ingresos2do
  function do_ajax_form_maeemp_mob_validate_rp01ingresos2do()
  {
    var nomeCampo_rp01ingresos2do = "rp01ingresos2do";
    var var_rp01ingresos2do = scAjaxGetFieldText(nomeCampo_rp01ingresos2do);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01ingresos2do(var_rp01ingresos2do, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01ingresos2do_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01ingresos2do

  function do_ajax_form_maeemp_mob_validate_rp01ingresos2do_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01ingresos2do_cb

  // ---------- Validate rp01provdiremp
  function do_ajax_form_maeemp_mob_validate_rp01provdiremp()
  {
    var nomeCampo_rp01provdiremp = "rp01provdiremp";
    var var_rp01provdiremp = scAjaxGetFieldText(nomeCampo_rp01provdiremp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01provdiremp(var_rp01provdiremp, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01provdiremp_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01provdiremp

  function do_ajax_form_maeemp_mob_validate_rp01provdiremp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01provdiremp_cb

  // ---------- Validate rp01cantondiremp
  function do_ajax_form_maeemp_mob_validate_rp01cantondiremp()
  {
    var nomeCampo_rp01cantondiremp = "rp01cantondiremp";
    var var_rp01cantondiremp = scAjaxGetFieldText(nomeCampo_rp01cantondiremp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01cantondiremp(var_rp01cantondiremp, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01cantondiremp_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01cantondiremp

  function do_ajax_form_maeemp_mob_validate_rp01cantondiremp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01cantondiremp_cb

  // ---------- Validate rp01ciudaddiremp
  function do_ajax_form_maeemp_mob_validate_rp01ciudaddiremp()
  {
    var nomeCampo_rp01ciudaddiremp = "rp01ciudaddiremp";
    var var_rp01ciudaddiremp = scAjaxGetFieldText(nomeCampo_rp01ciudaddiremp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01ciudaddiremp(var_rp01ciudaddiremp, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01ciudaddiremp_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01ciudaddiremp

  function do_ajax_form_maeemp_mob_validate_rp01ciudaddiremp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01ciudaddiremp_cb

  // ---------- Validate rp01codocupacion
  function do_ajax_form_maeemp_mob_validate_rp01codocupacion()
  {
    var nomeCampo_rp01codocupacion = "rp01codocupacion";
    var var_rp01codocupacion = scAjaxGetFieldText(nomeCampo_rp01codocupacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01codocupacion(var_rp01codocupacion, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01codocupacion_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01codocupacion

  function do_ajax_form_maeemp_mob_validate_rp01codocupacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01codocupacion_cb

  // ---------- Validate uid
  function do_ajax_form_maeemp_mob_validate_uid()
  {
    var nomeCampo_uid = "uid";
    var var_uid = scAjaxGetFieldText(nomeCampo_uid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_uid(var_uid, var_script_case_init, do_ajax_form_maeemp_mob_validate_uid_cb);
  } // do_ajax_form_maeemp_mob_validate_uid

  function do_ajax_form_maeemp_mob_validate_uid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "uid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_uid_cb

  // ---------- Validate block
  function do_ajax_form_maeemp_mob_validate_block()
  {
    var nomeCampo_block = "block";
    var var_block = scAjaxGetFieldText(nomeCampo_block);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_block(var_block, var_script_case_init, do_ajax_form_maeemp_mob_validate_block_cb);
  } // do_ajax_form_maeemp_mob_validate_block

  function do_ajax_form_maeemp_mob_validate_block_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "block";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_block_cb

  // ---------- Validate ultimoacceso
  function do_ajax_form_maeemp_mob_validate_ultimoacceso()
  {
    var nomeCampo_ultimoacceso = "ultimoacceso";
    var var_ultimoacceso = scAjaxGetFieldText(nomeCampo_ultimoacceso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_ultimoacceso(var_ultimoacceso, var_script_case_init, do_ajax_form_maeemp_mob_validate_ultimoacceso_cb);
  } // do_ajax_form_maeemp_mob_validate_ultimoacceso

  function do_ajax_form_maeemp_mob_validate_ultimoacceso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_ultimoacceso_cb

  // ---------- Validate rp01foto
  function do_ajax_form_maeemp_mob_validate_rp01foto()
  {
    var nomeCampo_rp01foto = "rp01foto";
    var var_rp01foto = scAjaxGetFieldText(nomeCampo_rp01foto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01foto(var_rp01foto, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01foto_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01foto

  function do_ajax_form_maeemp_mob_validate_rp01foto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01foto_cb

  // ---------- Validate rp01ctacontable
  function do_ajax_form_maeemp_mob_validate_rp01ctacontable()
  {
    var nomeCampo_rp01ctacontable = "rp01ctacontable";
    var var_rp01ctacontable = scAjaxGetFieldText(nomeCampo_rp01ctacontable);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01ctacontable(var_rp01ctacontable, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01ctacontable_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01ctacontable

  function do_ajax_form_maeemp_mob_validate_rp01ctacontable_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01ctacontable_cb

  // ---------- Validate rp01email
  function do_ajax_form_maeemp_mob_validate_rp01email()
  {
    var nomeCampo_rp01email = "rp01email";
    var var_rp01email = scAjaxGetFieldText(nomeCampo_rp01email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01email(var_rp01email, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01email_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01email

  function do_ajax_form_maeemp_mob_validate_rp01email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01email_cb

  // ---------- Validate rp01passwd
  function do_ajax_form_maeemp_mob_validate_rp01passwd()
  {
    var nomeCampo_rp01passwd = "rp01passwd";
    var var_rp01passwd = scAjaxGetFieldText(nomeCampo_rp01passwd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01passwd(var_rp01passwd, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01passwd_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01passwd

  function do_ajax_form_maeemp_mob_validate_rp01passwd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01passwd_cb

  // ---------- Validate rp01huella
  function do_ajax_form_maeemp_mob_validate_rp01huella()
  {
    var nomeCampo_rp01huella = "rp01huella";
    var var_rp01huella = scAjaxGetFieldText(nomeCampo_rp01huella);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01huella(var_rp01huella, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01huella_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01huella

  function do_ajax_form_maeemp_mob_validate_rp01huella_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01huella_cb

  // ---------- Validate rp01recibefr
  function do_ajax_form_maeemp_mob_validate_rp01recibefr()
  {
    var nomeCampo_rp01recibefr = "rp01recibefr";
    var var_rp01recibefr = scAjaxGetFieldText(nomeCampo_rp01recibefr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01recibefr(var_rp01recibefr, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01recibefr_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01recibefr

  function do_ajax_form_maeemp_mob_validate_rp01recibefr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01recibefr_cb

  // ---------- Validate rp01recibedt
  function do_ajax_form_maeemp_mob_validate_rp01recibedt()
  {
    var nomeCampo_rp01recibedt = "rp01recibedt";
    var var_rp01recibedt = scAjaxGetFieldText(nomeCampo_rp01recibedt);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01recibedt(var_rp01recibedt, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01recibedt_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01recibedt

  function do_ajax_form_maeemp_mob_validate_rp01recibedt_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01recibedt_cb

  // ---------- Validate rp01recibedc
  function do_ajax_form_maeemp_mob_validate_rp01recibedc()
  {
    var nomeCampo_rp01recibedc = "rp01recibedc";
    var var_rp01recibedc = scAjaxGetFieldText(nomeCampo_rp01recibedc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01recibedc(var_rp01recibedc, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01recibedc_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01recibedc

  function do_ajax_form_maeemp_mob_validate_rp01recibedc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01recibedc_cb

  // ---------- Validate rp01uid
  function do_ajax_form_maeemp_mob_validate_rp01uid()
  {
    var nomeCampo_rp01uid = "rp01uid";
    var var_rp01uid = scAjaxGetFieldText(nomeCampo_rp01uid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01uid(var_rp01uid, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01uid_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01uid

  function do_ajax_form_maeemp_mob_validate_rp01uid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rp01uid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01uid_cb

  // ---------- Validate rp01fechauid
  function do_ajax_form_maeemp_mob_validate_rp01fechauid()
  {
    var nomeCampo_rp01fechauid = "rp01fechauid";
    var var_rp01fechauid = scAjaxGetFieldText(nomeCampo_rp01fechauid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01fechauid(var_rp01fechauid, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01fechauid_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01fechauid

  function do_ajax_form_maeemp_mob_validate_rp01fechauid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01fechauid_cb

  // ---------- Validate rp01obs
  function do_ajax_form_maeemp_mob_validate_rp01obs()
  {
    var nomeCampo_rp01obs = "rp01obs";
    var var_rp01obs = scAjaxGetFieldText(nomeCampo_rp01obs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01obs(var_rp01obs, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01obs_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01obs

  function do_ajax_form_maeemp_mob_validate_rp01obs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rp01obs";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01obs_cb

  // ---------- Validate rp01cauliq
  function do_ajax_form_maeemp_mob_validate_rp01cauliq()
  {
    var nomeCampo_rp01cauliq = "rp01cauliq";
    var var_rp01cauliq = scAjaxGetFieldText(nomeCampo_rp01cauliq);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01cauliq(var_rp01cauliq, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01cauliq_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01cauliq

  function do_ajax_form_maeemp_mob_validate_rp01cauliq_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01cauliq_cb

  // ---------- Validate rp01discapacidad
  function do_ajax_form_maeemp_mob_validate_rp01discapacidad()
  {
    var nomeCampo_rp01discapacidad = "rp01discapacidad";
    var var_rp01discapacidad = scAjaxGetFieldText(nomeCampo_rp01discapacidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01discapacidad(var_rp01discapacidad, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01discapacidad_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01discapacidad

  function do_ajax_form_maeemp_mob_validate_rp01discapacidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01discapacidad_cb

  // ---------- Validate rp01conadis
  function do_ajax_form_maeemp_mob_validate_rp01conadis()
  {
    var nomeCampo_rp01conadis = "rp01conadis";
    var var_rp01conadis = scAjaxGetFieldText(nomeCampo_rp01conadis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01conadis(var_rp01conadis, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01conadis_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01conadis

  function do_ajax_form_maeemp_mob_validate_rp01conadis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01conadis_cb

  // ---------- Validate rp01tpdiscapacidad
  function do_ajax_form_maeemp_mob_validate_rp01tpdiscapacidad()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01tpdiscapacidad(var_rp01tpdiscapacidad, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01tpdiscapacidad_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01tpdiscapacidad

  function do_ajax_form_maeemp_mob_validate_rp01tpdiscapacidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01tpdiscapacidad_cb

  // ---------- Validate rp01prdiscapacidad
  function do_ajax_form_maeemp_mob_validate_rp01prdiscapacidad()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01prdiscapacidad(var_rp01prdiscapacidad, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01prdiscapacidad_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01prdiscapacidad

  function do_ajax_form_maeemp_mob_validate_rp01prdiscapacidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01prdiscapacidad_cb

  // ---------- Validate rp01freserva
  function do_ajax_form_maeemp_mob_validate_rp01freserva()
  {
    var nomeCampo_rp01freserva = "rp01freserva";
    var var_rp01freserva = scAjaxGetFieldText(nomeCampo_rp01freserva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01freserva(var_rp01freserva, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01freserva_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01freserva

  function do_ajax_form_maeemp_mob_validate_rp01freserva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01freserva_cb

  // ---------- Validate rp01codsectorial
  function do_ajax_form_maeemp_mob_validate_rp01codsectorial()
  {
    var nomeCampo_rp01codsectorial = "rp01codsectorial";
    var var_rp01codsectorial = scAjaxGetFieldText(nomeCampo_rp01codsectorial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01codsectorial(var_rp01codsectorial, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01codsectorial_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01codsectorial

  function do_ajax_form_maeemp_mob_validate_rp01codsectorial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01codsectorial_cb

  // ---------- Validate anticipoporvalor
  function do_ajax_form_maeemp_mob_validate_anticipoporvalor()
  {
    var nomeCampo_anticipoporvalor = "anticipoporvalor";
    var var_anticipoporvalor = scAjaxGetFieldText(nomeCampo_anticipoporvalor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_anticipoporvalor(var_anticipoporvalor, var_script_case_init, do_ajax_form_maeemp_mob_validate_anticipoporvalor_cb);
  } // do_ajax_form_maeemp_mob_validate_anticipoporvalor

  function do_ajax_form_maeemp_mob_validate_anticipoporvalor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_anticipoporvalor_cb

  // ---------- Validate tipidret
  function do_ajax_form_maeemp_mob_validate_tipidret()
  {
    var nomeCampo_tipidret = "tipidret";
    var var_tipidret = scAjaxGetFieldText(nomeCampo_tipidret);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_tipidret(var_tipidret, var_script_case_init, do_ajax_form_maeemp_mob_validate_tipidret_cb);
  } // do_ajax_form_maeemp_mob_validate_tipidret

  function do_ajax_form_maeemp_mob_validate_tipidret_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_tipidret_cb

  // ---------- Validate residenciatrab
  function do_ajax_form_maeemp_mob_validate_residenciatrab()
  {
    var nomeCampo_residenciatrab = "residenciatrab";
    var var_residenciatrab = scAjaxGetFieldText(nomeCampo_residenciatrab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_residenciatrab(var_residenciatrab, var_script_case_init, do_ajax_form_maeemp_mob_validate_residenciatrab_cb);
  } // do_ajax_form_maeemp_mob_validate_residenciatrab

  function do_ajax_form_maeemp_mob_validate_residenciatrab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_residenciatrab_cb

  // ---------- Validate paisresidencia
  function do_ajax_form_maeemp_mob_validate_paisresidencia()
  {
    var nomeCampo_paisresidencia = "paisresidencia";
    var var_paisresidencia = scAjaxGetFieldText(nomeCampo_paisresidencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_paisresidencia(var_paisresidencia, var_script_case_init, do_ajax_form_maeemp_mob_validate_paisresidencia_cb);
  } // do_ajax_form_maeemp_mob_validate_paisresidencia

  function do_ajax_form_maeemp_mob_validate_paisresidencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_paisresidencia_cb

  // ---------- Validate aplicaconvenio
  function do_ajax_form_maeemp_mob_validate_aplicaconvenio()
  {
    var nomeCampo_aplicaconvenio = "aplicaconvenio";
    var var_aplicaconvenio = scAjaxGetFieldText(nomeCampo_aplicaconvenio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_aplicaconvenio(var_aplicaconvenio, var_script_case_init, do_ajax_form_maeemp_mob_validate_aplicaconvenio_cb);
  } // do_ajax_form_maeemp_mob_validate_aplicaconvenio

  function do_ajax_form_maeemp_mob_validate_aplicaconvenio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_aplicaconvenio_cb

  // ---------- Validate tipotrabajdiscap
  function do_ajax_form_maeemp_mob_validate_tipotrabajdiscap()
  {
    var nomeCampo_tipotrabajdiscap = "tipotrabajdiscap";
    var var_tipotrabajdiscap = scAjaxGetFieldText(nomeCampo_tipotrabajdiscap);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_tipotrabajdiscap(var_tipotrabajdiscap, var_script_case_init, do_ajax_form_maeemp_mob_validate_tipotrabajdiscap_cb);
  } // do_ajax_form_maeemp_mob_validate_tipotrabajdiscap

  function do_ajax_form_maeemp_mob_validate_tipotrabajdiscap_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_tipotrabajdiscap_cb

  // ---------- Validate porcentajediscap
  function do_ajax_form_maeemp_mob_validate_porcentajediscap()
  {
    var nomeCampo_porcentajediscap = "porcentajediscap";
    var var_porcentajediscap = scAjaxGetFieldText(nomeCampo_porcentajediscap);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_porcentajediscap(var_porcentajediscap, var_script_case_init, do_ajax_form_maeemp_mob_validate_porcentajediscap_cb);
  } // do_ajax_form_maeemp_mob_validate_porcentajediscap

  function do_ajax_form_maeemp_mob_validate_porcentajediscap_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_porcentajediscap_cb

  // ---------- Validate tipiddiscap
  function do_ajax_form_maeemp_mob_validate_tipiddiscap()
  {
    var nomeCampo_tipiddiscap = "tipiddiscap";
    var var_tipiddiscap = scAjaxGetFieldText(nomeCampo_tipiddiscap);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_tipiddiscap(var_tipiddiscap, var_script_case_init, do_ajax_form_maeemp_mob_validate_tipiddiscap_cb);
  } // do_ajax_form_maeemp_mob_validate_tipiddiscap

  function do_ajax_form_maeemp_mob_validate_tipiddiscap_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_tipiddiscap_cb

  // ---------- Validate iddiscap
  function do_ajax_form_maeemp_mob_validate_iddiscap()
  {
    var nomeCampo_iddiscap = "iddiscap";
    var var_iddiscap = scAjaxGetFieldText(nomeCampo_iddiscap);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_iddiscap(var_iddiscap, var_script_case_init, do_ajax_form_maeemp_mob_validate_iddiscap_cb);
  } // do_ajax_form_maeemp_mob_validate_iddiscap

  function do_ajax_form_maeemp_mob_validate_iddiscap_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_iddiscap_cb

  // ---------- Validate rp01varias_secciones
  function do_ajax_form_maeemp_mob_validate_rp01varias_secciones()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01varias_secciones(var_rp01varias_secciones, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01varias_secciones_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01varias_secciones

  function do_ajax_form_maeemp_mob_validate_rp01varias_secciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01varias_secciones_cb

  // ---------- Validate rp01cc
  function do_ajax_form_maeemp_mob_validate_rp01cc()
  {
    var nomeCampo_rp01cc = "rp01cc";
    var var_rp01cc = scAjaxGetFieldText(nomeCampo_rp01cc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01cc(var_rp01cc, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01cc_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01cc

  function do_ajax_form_maeemp_mob_validate_rp01cc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rp01cc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01cc_cb

  // ---------- Validate rp01observacion
  function do_ajax_form_maeemp_mob_validate_rp01observacion()
  {
    var nomeCampo_rp01observacion = "rp01observacion";
    var var_rp01observacion = scAjaxGetFieldText(nomeCampo_rp01observacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01observacion(var_rp01observacion, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01observacion_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01observacion

  function do_ajax_form_maeemp_mob_validate_rp01observacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01observacion_cb

  // ---------- Validate rp01iessconyugue
  function do_ajax_form_maeemp_mob_validate_rp01iessconyugue()
  {
    var nomeCampo_rp01iessconyugue = "rp01iessconyugue";
    var var_rp01iessconyugue = scAjaxGetFieldText(nomeCampo_rp01iessconyugue);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01iessconyugue(var_rp01iessconyugue, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01iessconyugue_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01iessconyugue

  function do_ajax_form_maeemp_mob_validate_rp01iessconyugue_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01iessconyugue_cb

  // ---------- Validate rp01tiporefrigerio
  function do_ajax_form_maeemp_mob_validate_rp01tiporefrigerio()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01tiporefrigerio(var_rp01tiporefrigerio, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01tiporefrigerio_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01tiporefrigerio

  function do_ajax_form_maeemp_mob_validate_rp01tiporefrigerio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01tiporefrigerio_cb

  // ---------- Validate idiomas
  function do_ajax_form_maeemp_mob_validate_idiomas()
  {
    var nomeCampo_idiomas = "idiomas";
    var var_idiomas = scAjaxGetFieldText(nomeCampo_idiomas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_idiomas(var_idiomas, var_script_case_init, do_ajax_form_maeemp_mob_validate_idiomas_cb);
  } // do_ajax_form_maeemp_mob_validate_idiomas

  function do_ajax_form_maeemp_mob_validate_idiomas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idiomas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_idiomas_cb

  // ---------- Validate emergencias
  function do_ajax_form_maeemp_mob_validate_emergencias()
  {
    var nomeCampo_emergencias = "emergencias";
    var var_emergencias = scAjaxGetFieldText(nomeCampo_emergencias);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_emergencias(var_emergencias, var_script_case_init, do_ajax_form_maeemp_mob_validate_emergencias_cb);
  } // do_ajax_form_maeemp_mob_validate_emergencias

  function do_ajax_form_maeemp_mob_validate_emergencias_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_emergencias_cb

  // ---------- Validate rp01tipojornada
  function do_ajax_form_maeemp_mob_validate_rp01tipojornada()
  {
    var nomeCampo_rp01tipojornada = "rp01tipojornada";
    var var_rp01tipojornada = scAjaxGetFieldText(nomeCampo_rp01tipojornada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01tipojornada(var_rp01tipojornada, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01tipojornada_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01tipojornada

  function do_ajax_form_maeemp_mob_validate_rp01tipojornada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01tipojornada_cb

  // ---------- Validate rp01numero_horas
  function do_ajax_form_maeemp_mob_validate_rp01numero_horas()
  {
    var nomeCampo_rp01numero_horas = "rp01numero_horas";
    var var_rp01numero_horas = scAjaxGetFieldText(nomeCampo_rp01numero_horas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01numero_horas(var_rp01numero_horas, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01numero_horas_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01numero_horas

  function do_ajax_form_maeemp_mob_validate_rp01numero_horas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01numero_horas_cb

  // ---------- Validate rp01emailpersonal
  function do_ajax_form_maeemp_mob_validate_rp01emailpersonal()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01emailpersonal(var_rp01emailpersonal, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01emailpersonal_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01emailpersonal

  function do_ajax_form_maeemp_mob_validate_rp01emailpersonal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01emailpersonal_cb

  // ---------- Validate rp01supervisadopor
  function do_ajax_form_maeemp_mob_validate_rp01supervisadopor()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01supervisadopor(var_rp01supervisadopor, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01supervisadopor_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01supervisadopor

  function do_ajax_form_maeemp_mob_validate_rp01supervisadopor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01supervisadopor_cb

  // ---------- Validate rp01zonaderiesgo
  function do_ajax_form_maeemp_mob_validate_rp01zonaderiesgo()
  {
    var nomeCampo_rp01zonaderiesgo = "rp01zonaderiesgo";
    var var_rp01zonaderiesgo = scAjaxGetFieldText(nomeCampo_rp01zonaderiesgo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01zonaderiesgo(var_rp01zonaderiesgo, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01zonaderiesgo_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01zonaderiesgo

  function do_ajax_form_maeemp_mob_validate_rp01zonaderiesgo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01zonaderiesgo_cb

  // ---------- Validate rp01refpersnom1
  function do_ajax_form_maeemp_mob_validate_rp01refpersnom1()
  {
    var nomeCampo_rp01refpersnom1 = "rp01refpersnom1";
    var var_rp01refpersnom1 = scAjaxGetFieldText(nomeCampo_rp01refpersnom1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01refpersnom1(var_rp01refpersnom1, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01refpersnom1_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01refpersnom1

  function do_ajax_form_maeemp_mob_validate_rp01refpersnom1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01refpersnom1_cb

  // ---------- Validate rp01refpersparen1
  function do_ajax_form_maeemp_mob_validate_rp01refpersparen1()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01refpersparen1(var_rp01refpersparen1, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01refpersparen1_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01refpersparen1

  function do_ajax_form_maeemp_mob_validate_rp01refpersparen1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01refpersparen1_cb

  // ---------- Validate rp01refperstel1
  function do_ajax_form_maeemp_mob_validate_rp01refperstel1()
  {
    var nomeCampo_rp01refperstel1 = "rp01refperstel1";
    var var_rp01refperstel1 = scAjaxGetFieldText(nomeCampo_rp01refperstel1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01refperstel1(var_rp01refperstel1, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01refperstel1_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01refperstel1

  function do_ajax_form_maeemp_mob_validate_rp01refperstel1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01refperstel1_cb

  // ---------- Validate rp01refpersnom2
  function do_ajax_form_maeemp_mob_validate_rp01refpersnom2()
  {
    var nomeCampo_rp01refpersnom2 = "rp01refpersnom2";
    var var_rp01refpersnom2 = scAjaxGetFieldText(nomeCampo_rp01refpersnom2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01refpersnom2(var_rp01refpersnom2, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01refpersnom2_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01refpersnom2

  function do_ajax_form_maeemp_mob_validate_rp01refpersnom2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01refpersnom2_cb

  // ---------- Validate rp01refpersparen2
  function do_ajax_form_maeemp_mob_validate_rp01refpersparen2()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01refpersparen2(var_rp01refpersparen2, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01refpersparen2_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01refpersparen2

  function do_ajax_form_maeemp_mob_validate_rp01refpersparen2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01refpersparen2_cb

  // ---------- Validate rp01refperstel2
  function do_ajax_form_maeemp_mob_validate_rp01refperstel2()
  {
    var nomeCampo_rp01refperstel2 = "rp01refperstel2";
    var var_rp01refperstel2 = scAjaxGetFieldText(nomeCampo_rp01refperstel2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01refperstel2(var_rp01refperstel2, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01refperstel2_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01refperstel2

  function do_ajax_form_maeemp_mob_validate_rp01refperstel2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01refperstel2_cb

  // ---------- Validate rp01tipovivienda
  function do_ajax_form_maeemp_mob_validate_rp01tipovivienda()
  {
    var nomeCampo_rp01tipovivienda = "rp01tipovivienda";
    var var_rp01tipovivienda = scAjaxGetFieldText(nomeCampo_rp01tipovivienda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01tipovivienda(var_rp01tipovivienda, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01tipovivienda_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01tipovivienda

  function do_ajax_form_maeemp_mob_validate_rp01tipovivienda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01tipovivienda_cb

  // ---------- Validate rp01serviciosbasicos
  function do_ajax_form_maeemp_mob_validate_rp01serviciosbasicos()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01serviciosbasicos(var_rp01serviciosbasicos, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01serviciosbasicos_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01serviciosbasicos

  function do_ajax_form_maeemp_mob_validate_rp01serviciosbasicos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01serviciosbasicos_cb

  // ---------- Validate rp01viviendadetalle
  function do_ajax_form_maeemp_mob_validate_rp01viviendadetalle()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01viviendadetalle(var_rp01viviendadetalle, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01viviendadetalle_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01viviendadetalle

  function do_ajax_form_maeemp_mob_validate_rp01viviendadetalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01viviendadetalle_cb

  // ---------- Validate rp01dormitorios
  function do_ajax_form_maeemp_mob_validate_rp01dormitorios()
  {
    var nomeCampo_rp01dormitorios = "rp01dormitorios";
    var var_rp01dormitorios = scAjaxGetFieldText(nomeCampo_rp01dormitorios);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01dormitorios(var_rp01dormitorios, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01dormitorios_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01dormitorios

  function do_ajax_form_maeemp_mob_validate_rp01dormitorios_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01dormitorios_cb

  // ---------- Validate rp01sala
  function do_ajax_form_maeemp_mob_validate_rp01sala()
  {
    var nomeCampo_rp01sala = "rp01sala";
    var var_rp01sala = scAjaxGetFieldText(nomeCampo_rp01sala);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01sala(var_rp01sala, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01sala_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01sala

  function do_ajax_form_maeemp_mob_validate_rp01sala_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01sala_cb

  // ---------- Validate rp01comedor
  function do_ajax_form_maeemp_mob_validate_rp01comedor()
  {
    var nomeCampo_rp01comedor = "rp01comedor";
    var var_rp01comedor = scAjaxGetFieldText(nomeCampo_rp01comedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01comedor(var_rp01comedor, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01comedor_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01comedor

  function do_ajax_form_maeemp_mob_validate_rp01comedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01comedor_cb

  // ---------- Validate rp01banos
  function do_ajax_form_maeemp_mob_validate_rp01banos()
  {
    var nomeCampo_rp01banos = "rp01banos";
    var var_rp01banos = scAjaxGetFieldText(nomeCampo_rp01banos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01banos(var_rp01banos, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01banos_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01banos

  function do_ajax_form_maeemp_mob_validate_rp01banos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01banos_cb

  // ---------- Validate rp01estudiosrealizados
  function do_ajax_form_maeemp_mob_validate_rp01estudiosrealizados()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01estudiosrealizados(var_rp01estudiosrealizados, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01estudiosrealizados_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01estudiosrealizados

  function do_ajax_form_maeemp_mob_validate_rp01estudiosrealizados_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01estudiosrealizados_cb

  // ---------- Validate rp01ruta1
  function do_ajax_form_maeemp_mob_validate_rp01ruta1()
  {
    var nomeCampo_rp01ruta1 = "rp01ruta1";
    var var_rp01ruta1 = scAjaxGetFieldText(nomeCampo_rp01ruta1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01ruta1(var_rp01ruta1, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01ruta1_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01ruta1

  function do_ajax_form_maeemp_mob_validate_rp01ruta1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01ruta1_cb

  // ---------- Validate rp01ruta2
  function do_ajax_form_maeemp_mob_validate_rp01ruta2()
  {
    var nomeCampo_rp01ruta2 = "rp01ruta2";
    var var_rp01ruta2 = scAjaxGetFieldText(nomeCampo_rp01ruta2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01ruta2(var_rp01ruta2, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01ruta2_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01ruta2

  function do_ajax_form_maeemp_mob_validate_rp01ruta2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01ruta2_cb

  // ---------- Validate rp01ruta3
  function do_ajax_form_maeemp_mob_validate_rp01ruta3()
  {
    var nomeCampo_rp01ruta3 = "rp01ruta3";
    var var_rp01ruta3 = scAjaxGetFieldText(nomeCampo_rp01ruta3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01ruta3(var_rp01ruta3, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01ruta3_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01ruta3

  function do_ajax_form_maeemp_mob_validate_rp01ruta3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01ruta3_cb

  // ---------- Validate rp01actividadesextras
  function do_ajax_form_maeemp_mob_validate_rp01actividadesextras()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_mob_validate_rp01actividadesextras(var_rp01actividadesextras, var_script_case_init, do_ajax_form_maeemp_mob_validate_rp01actividadesextras_cb);
  } // do_ajax_form_maeemp_mob_validate_rp01actividadesextras

  function do_ajax_form_maeemp_mob_validate_rp01actividadesextras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_mob_validate_rp01actividadesextras_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_maeemp_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_maeemp_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_maeemp_mob_submit_form_cb_after_alert);
  } // do_ajax_form_maeemp_mob_submit_form_cb
  function do_ajax_form_maeemp_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_maeemp_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_maeemp_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_maeemp_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_maeemp_mob_navigate_form();
    }
  }

  function perform_ajax_form_maeemp_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_maeemp_mob_navigate_form(var_rp01noemp, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_maeemp_mob_navigate_form_cb);
  } // do_ajax_form_maeemp_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_maeemp_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_maeemp_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_maeemp_mob_navigate_form_cb
  function do_ajax_form_maeemp_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_maeemp_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_maeemp_mob_navigate_form_cb_after_alert

  function sc_hide_form_maeemp_mob_form()
  {
