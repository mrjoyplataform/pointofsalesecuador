...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_maeemp/form_maeemp_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_maeemp_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_maeemp_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['form_maeemp']['error_buffer']) && '' != $_SESSION['scriptcase']['form_maeemp']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_maeemp']['error_buffer'];
}
...
<?php
 include_once("form_maeemp_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_maeemp_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_maeemp_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_maeemp_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
?>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01noemp_line" id="hidden_field_data_rp01noemp" style="<?php echo $sStyleHidden_rp01noemp; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01noemp_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01noemp_label" style=""><span id="id_label_rp01noemp"><?php echo $this->nm_new_label['rp01noemp']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01noemp']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01noemp'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01division_line" id="hidden_field_data_rp01division" style="<?php echo $sStyleHidden_rp01division; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01division_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01division_label" style=""><span id="id_label_rp01division"><?php echo $this->nm_new_label['rp01division']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01depto_line" id="hidden_field_data_rp01depto" style="<?php echo $sStyleHidden_rp01depto; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01depto_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01depto_label" style=""><span id="id_label_rp01depto"><?php echo $this->nm_new_label['rp01depto']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01seccion_line" id="hidden_field_data_rp01seccion" style="<?php echo $sStyleHidden_rp01seccion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01seccion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01seccion_label" style=""><span id="id_label_rp01seccion"><?php echo $this->nm_new_label['rp01seccion']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01noemp1_line" id="hidden_field_data_rp01noemp1" style="<?php echo $sStyleHidden_rp01noemp1; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01noemp1_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01noemp1_label" style=""><span id="id_label_rp01noemp1"><?php echo $this->nm_new_label['rp01noemp1']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01nombreemp_line" id="hidden_field_data_rp01nombreemp" style="<?php echo $sStyleHidden_rp01nombreemp; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01nombreemp_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01nombreemp_label" style=""><span id="id_label_rp01nombreemp"><?php echo $this->nm_new_label['rp01nombreemp']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01categoria_line" id="hidden_field_data_rp01categoria" style="<?php echo $sStyleHidden_rp01categoria; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01categoria_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01categoria_label" style=""><span id="id_label_rp01categoria"><?php echo $this->nm_new_label['rp01categoria']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01turno_line" id="hidden_field_data_rp01turno" style="<?php echo $sStyleHidden_rp01turno; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01turno_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01turno_label" style=""><span id="id_label_rp01turno"><?php echo $this->nm_new_label['rp01turno']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01statusemp_line" id="hidden_field_data_rp01statusemp" style="<?php echo $sStyleHidden_rp01statusemp; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01statusemp_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01statusemp_label" style=""><span id="id_label_rp01statusemp"><?php echo $this->nm_new_label['rp01statusemp']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01fechastatus_line" id="hidden_field_data_rp01fechastatus" style="<?php echo $sStyleHidden_rp01fechastatus; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01fechastatus_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01fechastatus_label" style=""><span id="id_label_rp01fechastatus"><?php echo $this->nm_new_label['rp01fechastatus']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01causaretiro_line" id="hidden_field_data_rp01causaretiro" style="<?php echo $sStyleHidden_rp01causaretiro; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01causaretiro_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01causaretiro_label" style=""><span id="id_label_rp01causaretiro"><?php echo $this->nm_new_label['rp01causaretiro']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01direccion_line" id="hidden_field_data_rp01direccion" style="<?php echo $sStyleHidden_rp01direccion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01direccion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01direccion_label" style=""><span id="id_label_rp01direccion"><?php echo $this->nm_new_label['rp01direccion']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01telefono_line" id="hidden_field_data_rp01telefono" style="<?php echo $sStyleHidden_rp01telefono; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01telefono_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01telefono_label" style=""><span id="id_label_rp01telefono"><?php echo $this->nm_new_label['rp01telefono']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01lugarnacimiento_line" id="hidden_field_data_rp01lugarnacimiento" style="<?php echo $sStyleHidden_rp01lugarnacimiento; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01lugarnacimiento_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01lugarnacimiento_label" style=""><span id="id_label_rp01lugarnacimiento"><?php echo $this->nm_new_label['rp01lugarnacimiento']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01fechanacimiento_line" id="hidden_field_data_rp01fechanacimiento" style="<?php echo $sStyleHidden_rp01fechanacimiento; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01fechanacimiento_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01fechanacimiento_label" style=""><span id="id_label_rp01fechanacimiento"><?php echo $this->nm_new_label['rp01fechanacimiento']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01nacionalidad_line" id="hidden_field_data_rp01nacionalidad" style="<?php echo $sStyleHidden_rp01nacionalidad; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01nacionalidad_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01nacionalidad_label" style=""><span id="id_label_rp01nacionalidad"><?php echo $this->nm_new_label['rp01nacionalidad']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01cedula_line" id="hidden_field_data_rp01cedula" style="<?php echo $sStyleHidden_rp01cedula; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01cedula_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01cedula_label" style=""><span id="id_label_rp01cedula"><?php echo $this->nm_new_label['rp01cedula']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01noiess_line" id="hidden_field_data_rp01noiess" style="<?php echo $sStyleHidden_rp01noiess; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01noiess_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01noiess_label" style=""><span id="id_label_rp01noiess"><?php echo $this->nm_new_label['rp01noiess']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01sexo_line" id="hidden_field_data_rp01sexo" style="<?php echo $sStyleHidden_rp01sexo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01sexo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01sexo_label" style=""><span id="id_label_rp01sexo"><?php echo $this->nm_new_label['rp01sexo']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01nolibreta_line" id="hidden_field_data_rp01nolibreta" style="<?php echo $sStyleHidden_rp01nolibreta; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01nolibreta_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01nolibreta_label" style=""><span id="id_label_rp01nolibreta"><?php echo $this->nm_new_label['rp01nolibreta']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01profesion_line" id="hidden_field_data_rp01profesion" style="<?php echo $sStyleHidden_rp01profesion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01profesion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01profesion_label" style=""><span id="id_label_rp01profesion"><?php echo $this->nm_new_label['rp01profesion']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01fechaingreso_line" id="hidden_field_data_rp01fechaingreso" style="<?php echo $sStyleHidden_rp01fechaingreso; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01fechaingreso_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01fechaingreso_label" style=""><span id="id_label_rp01fechaingreso"><?php echo $this->nm_new_label['rp01fechaingreso']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01fechareingreso_line" id="hidden_field_data_rp01fechareingreso" style="<?php echo $sStyleHidden_rp01fechareingreso; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01fechareingreso_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01fechareingreso_label" style=""><span id="id_label_rp01fechareingreso"><?php echo $this->nm_new_label['rp01fechareingreso']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01cargo_line" id="hidden_field_data_rp01cargo" style="<?php echo $sStyleHidden_rp01cargo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01cargo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01cargo_label" style=""><span id="id_label_rp01cargo"><?php echo $this->nm_new_label['rp01cargo']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01estadocivil_line" id="hidden_field_data_rp01estadocivil" style="<?php echo $sStyleHidden_rp01estadocivil; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01estadocivil_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01estadocivil_label" style=""><span id="id_label_rp01estadocivil"><?php echo $this->nm_new_label['rp01estadocivil']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01rebajaxcasado_line" id="hidden_field_data_rp01rebajaxcasado" style="<?php echo $sStyleHidden_rp01rebajaxcasado; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01rebajaxcasado_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01rebajaxcasado_label" style=""><span id="id_label_rp01rebajaxcasado"><?php echo $this->nm_new_label['rp01rebajaxcasado']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01nombreconyuge_line" id="hidden_field_data_rp01nombreconyuge" style="<?php echo $sStyleHidden_rp01nombreconyuge; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01nombreconyuge_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01nombreconyuge_label" style=""><span id="id_label_rp01nombreconyuge"><?php echo $this->nm_new_label['rp01nombreconyuge']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01nombrepadre_line" id="hidden_field_data_rp01nombrepadre" style="<?php echo $sStyleHidden_rp01nombrepadre; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01nombrepadre_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01nombrepadre_label" style=""><span id="id_label_rp01nombrepadre"><?php echo $this->nm_new_label['rp01nombrepadre']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01nombremadre_line" id="hidden_field_data_rp01nombremadre" style="<?php echo $sStyleHidden_rp01nombremadre; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01nombremadre_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01nombremadre_label" style=""><span id="id_label_rp01nombremadre"><?php echo $this->nm_new_label['rp01nombremadre']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01nohijos_line" id="hidden_field_data_rp01nohijos" style="<?php echo $sStyleHidden_rp01nohijos; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01nohijos_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01nohijos_label" style=""><span id="id_label_rp01nohijos"><?php echo $this->nm_new_label['rp01nohijos']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01fechahijos0_line" id="hidden_field_data_rp01fechahijos0" style="<?php echo $sStyleHidden_rp01fechahijos0; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01fechahijos0_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01fechahijos0_label" style=""><span id="id_label_rp01fechahijos0"><?php echo $this->nm_new_label['rp01fechahijos0']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01sexohijos0_line" id="hidden_field_data_rp01sexohijos0" style="<?php echo $sStyleHidden_rp01sexohijos0; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01sexohijos0_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01sexohijos0_label" style=""><span id="id_label_rp01sexohijos0"><?php echo $this->nm_new_label['rp01sexohijos0']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01fechahijos1_line" id="hidden_field_data_rp01fechahijos1" style="<?php echo $sStyleHidden_rp01fechahijos1; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01fechahijos1_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01fechahijos1_label" style=""><span id="id_label_rp01fechahijos1"><?php echo $this->nm_new_label['rp01fechahijos1']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01sexohijos1_line" id="hidden_field_data_rp01sexohijos1" style="<?php echo $sStyleHidden_rp01sexohijos1; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01sexohijos1_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01sexohijos1_label" style=""><span id="id_label_rp01sexohijos1"><?php echo $this->nm_new_label['rp01sexohijos1']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01fechahijos2_line" id="hidden_field_data_rp01fechahijos2" style="<?php echo $sStyleHidden_rp01fechahijos2; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01fechahijos2_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01fechahijos2_label" style=""><span id="id_label_rp01fechahijos2"><?php echo $this->nm_new_label['rp01fechahijos2']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01sexohijos2_line" id="hidden_field_data_rp01sexohijos2" style="<?php echo $sStyleHidden_rp01sexohijos2; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01sexohijos2_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01sexohijos2_label" style=""><span id="id_label_rp01sexohijos2"><?php echo $this->nm_new_label['rp01sexohijos2']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01fechahijos3_line" id="hidden_field_data_rp01fechahijos3" style="<?php echo $sStyleHidden_rp01fechahijos3; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01fechahijos3_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01fechahijos3_label" style=""><span id="id_label_rp01fechahijos3"><?php echo $this->nm_new_label['rp01fechahijos3']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01sexohijos3_line" id="hidden_field_data_rp01sexohijos3" style="<?php echo $sStyleHidden_rp01sexohijos3; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01sexohijos3_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01sexohijos3_label" style=""><span id="id_label_rp01sexohijos3"><?php echo $this->nm_new_label['rp01sexohijos3']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01fechahijos4_line" id="hidden_field_data_rp01fechahijos4" style="<?php echo $sStyleHidden_rp01fechahijos4; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01fechahijos4_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01fechahijos4_label" style=""><span id="id_label_rp01fechahijos4"><?php echo $this->nm_new_label['rp01fechahijos4']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01sexohijos4_line" id="hidden_field_data_rp01sexohijos4" style="<?php echo $sStyleHidden_rp01sexohijos4; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01sexohijos4_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01sexohijos4_label" style=""><span id="id_label_rp01sexohijos4"><?php echo $this->nm_new_label['rp01sexohijos4']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01fechahijos5_line" id="hidden_field_data_rp01fechahijos5" style="<?php echo $sStyleHidden_rp01fechahijos5; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01fechahijos5_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01fechahijos5_label" style=""><span id="id_label_rp01fechahijos5"><?php echo $this->nm_new_label['rp01fechahijos5']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01sexohijos5_line" id="hidden_field_data_rp01sexohijos5" style="<?php echo $sStyleHidden_rp01sexohijos5; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01sexohijos5_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01sexohijos5_label" style=""><span id="id_label_rp01sexohijos5"><?php echo $this->nm_new_label['rp01sexohijos5']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01fechahijos6_line" id="hidden_field_data_rp01fechahijos6" style="<?php echo $sStyleHidden_rp01fechahijos6; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01fechahijos6_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01fechahijos6_label" style=""><span id="id_label_rp01fechahijos6"><?php echo $this->nm_new_label['rp01fechahijos6']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01sexohijos6_line" id="hidden_field_data_rp01sexohijos6" style="<?php echo $sStyleHidden_rp01sexohijos6; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01sexohijos6_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01sexohijos6_label" style=""><span id="id_label_rp01sexohijos6"><?php echo $this->nm_new_label['rp01sexohijos6']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01fechahijos7_line" id="hidden_field_data_rp01fechahijos7" style="<?php echo $sStyleHidden_rp01fechahijos7; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01fechahijos7_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01fechahijos7_label" style=""><span id="id_label_rp01fechahijos7"><?php echo $this->nm_new_label['rp01fechahijos7']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01sexohijos7_line" id="hidden_field_data_rp01sexohijos7" style="<?php echo $sStyleHidden_rp01sexohijos7; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01sexohijos7_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01sexohijos7_label" style=""><span id="id_label_rp01sexohijos7"><?php echo $this->nm_new_label['rp01sexohijos7']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01fechahijos8_line" id="hidden_field_data_rp01fechahijos8" style="<?php echo $sStyleHidden_rp01fechahijos8; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01fechahijos8_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01fechahijos8_label" style=""><span id="id_label_rp01fechahijos8"><?php echo $this->nm_new_label['rp01fechahijos8']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01sexohijos8_line" id="hidden_field_data_rp01sexohijos8" style="<?php echo $sStyleHidden_rp01sexohijos8; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01sexohijos8_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01sexohijos8_label" style=""><span id="id_label_rp01sexohijos8"><?php echo $this->nm_new_label['rp01sexohijos8']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01fechahijos9_line" id="hidden_field_data_rp01fechahijos9" style="<?php echo $sStyleHidden_rp01fechahijos9; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01fechahijos9_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01fechahijos9_label" style=""><span id="id_label_rp01fechahijos9"><?php echo $this->nm_new_label['rp01fechahijos9']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01sexohijos9_line" id="hidden_field_data_rp01sexohijos9" style="<?php echo $sStyleHidden_rp01sexohijos9; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01sexohijos9_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01sexohijos9_label" style=""><span id="id_label_rp01sexohijos9"><?php echo $this->nm_new_label['rp01sexohijos9']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01cargaspadres_line" id="hidden_field_data_rp01cargaspadres" style="<?php echo $sStyleHidden_rp01cargaspadres; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01cargaspadres_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01cargaspadres_label" style=""><span id="id_label_rp01cargaspadres"><?php echo $this->nm_new_label['rp01cargaspadres']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01otrascargas_line" id="hidden_field_data_rp01otrascargas" style="<?php echo $sStyleHidden_rp01otrascargas; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01otrascargas_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01otrascargas_label" style=""><span id="id_label_rp01otrascargas"><?php echo $this->nm_new_label['rp01otrascargas']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01formapago_line" id="hidden_field_data_rp01formapago" style="<?php echo $sStyleHidden_rp01formapago; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01formapago_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01formapago_label" style=""><span id="id_label_rp01formapago"><?php echo $this->nm_new_label['rp01formapago']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01nobancoemp_line" id="hidden_field_data_rp01nobancoemp" style="<?php echo $sStyleHidden_rp01nobancoemp; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01nobancoemp_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01nobancoemp_label" style=""><span id="id_label_rp01nobancoemp"><?php echo $this->nm_new_label['rp01nobancoemp']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01ctabancoemp_line" id="hidden_field_data_rp01ctabancoemp" style="<?php echo $sStyleHidden_rp01ctabancoemp; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01ctabancoemp_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01ctabancoemp_label" style=""><span id="id_label_rp01ctabancoemp"><?php echo $this->nm_new_label['rp01ctabancoemp']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01tipoctabco_line" id="hidden_field_data_rp01tipoctabco" style="<?php echo $sStyleHidden_rp01tipoctabco; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01tipoctabco_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01tipoctabco_label" style=""><span id="id_label_rp01tipoctabco"><?php echo $this->nm_new_label['rp01tipoctabco']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01tipoctabco']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01tipoctabco'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01fechaultvacacion_line" id="hidden_field_data_rp01fechaultvacacion" style="<?php echo $sStyleHidden_rp01fechaultvacacion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01fechaultvacacion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01fechaultvacacion_label" style=""><span id="id_label_rp01fechaultvacacion"><?php echo $this->nm_new_label['rp01fechaultvacacion']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01aporte_line" id="hidden_field_data_rp01aporte" style="<?php echo $sStyleHidden_rp01aporte; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01aporte_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01aporte_label" style=""><span id="id_label_rp01aporte"><?php echo $this->nm_new_label['rp01aporte']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01socio_line" id="hidden_field_data_rp01socio" style="<?php echo $sStyleHidden_rp01socio; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01socio_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01socio_label" style=""><span id="id_label_rp01socio"><?php echo $this->nm_new_label['rp01socio']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01transporte_line" id="hidden_field_data_rp01transporte" style="<?php echo $sStyleHidden_rp01transporte; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01transporte_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01transporte_label" style=""><span id="id_label_rp01transporte"><?php echo $this->nm_new_label['rp01transporte']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01recibeporc_line" id="hidden_field_data_rp01recibeporc" style="<?php echo $sStyleHidden_rp01recibeporc; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01recibeporc_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01recibeporc_label" style=""><span id="id_label_rp01recibeporc"><?php echo $this->nm_new_label['rp01recibeporc']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01sueldoanterior_line" id="hidden_field_data_rp01sueldoanterior" style="<?php echo $sStyleHidden_rp01sueldoanterior; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01sueldoanterior_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01sueldoanterior_label" style=""><span id="id_label_rp01sueldoanterior"><?php echo $this->nm_new_label['rp01sueldoanterior']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01sueldosalario_line" id="hidden_field_data_rp01sueldosalario" style="<?php echo $sStyleHidden_rp01sueldosalario; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01sueldosalario_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01sueldosalario_label" style=""><span id="id_label_rp01sueldosalario"><?php echo $this->nm_new_label['rp01sueldosalario']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01fecmodsdosal_line" id="hidden_field_data_rp01fecmodsdosal" style="<?php echo $sStyleHidden_rp01fecmodsdosal; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01fecmodsdosal_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01fecmodsdosal_label" style=""><span id="id_label_rp01fecmodsdosal"><?php echo $this->nm_new_label['rp01fecmodsdosal']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01fecmodficha_line" id="hidden_field_data_rp01fecmodficha" style="<?php echo $sStyleHidden_rp01fecmodficha; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01fecmodficha_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01fecmodficha_label" style=""><span id="id_label_rp01fecmodficha"><?php echo $this->nm_new_label['rp01fecmodficha']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01faltasinjust_line" id="hidden_field_data_rp01faltasinjust" style="<?php echo $sStyleHidden_rp01faltasinjust; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01faltasinjust_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01faltasinjust_label" style=""><span id="id_label_rp01faltasinjust"><?php echo $this->nm_new_label['rp01faltasinjust']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01ingresos1er_line" id="hidden_field_data_rp01ingresos1er" style="<?php echo $sStyleHidden_rp01ingresos1er; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01ingresos1er_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01ingresos1er_label" style=""><span id="id_label_rp01ingresos1er"><?php echo $this->nm_new_label['rp01ingresos1er']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01basesocialvalor_line" id="hidden_field_data_rp01basesocialvalor" style="<?php echo $sStyleHidden_rp01basesocialvalor; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01basesocialvalor_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01basesocialvalor_label" style=""><span id="id_label_rp01basesocialvalor"><?php echo $this->nm_new_label['rp01basesocialvalor']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01basesocialtiempo_line" id="hidden_field_data_rp01basesocialtiempo" style="<?php echo $sStyleHidden_rp01basesocialtiempo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01basesocialtiempo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01basesocialtiempo_label" style=""><span id="id_label_rp01basesocialtiempo"><?php echo $this->nm_new_label['rp01basesocialtiempo']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp0114vopagoacum_line" id="hidden_field_data_rp0114vopagoacum" style="<?php echo $sStyleHidden_rp0114vopagoacum; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp0114vopagoacum_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp0114vopagoacum_label" style=""><span id="id_label_rp0114vopagoacum"><?php echo $this->nm_new_label['rp0114vopagoacum']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp0115vopagoacum_line" id="hidden_field_data_rp0115vopagoacum" style="<?php echo $sStyleHidden_rp0115vopagoacum; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp0115vopagoacum_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp0115vopagoacum_label" style=""><span id="id_label_rp0115vopagoacum"><?php echo $this->nm_new_label['rp0115vopagoacum']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01cverrorliq_line" id="hidden_field_data_rp01cverrorliq" style="<?php echo $sStyleHidden_rp01cverrorliq; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01cverrorliq_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01cverrorliq_label" style=""><span id="id_label_rp01cverrorliq"><?php echo $this->nm_new_label['rp01cverrorliq']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01porcentliq_line" id="hidden_field_data_rp01porcentliq" style="<?php echo $sStyleHidden_rp01porcentliq; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01porcentliq_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01porcentliq_label" style=""><span id="id_label_rp01porcentliq"><?php echo $this->nm_new_label['rp01porcentliq']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01tiposangre_line" id="hidden_field_data_rp01tiposangre" style="<?php echo $sStyleHidden_rp01tiposangre; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01tiposangre_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01tiposangre_label" style=""><span id="id_label_rp01tiposangre"><?php echo $this->nm_new_label['rp01tiposangre']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01ingresos2do_line" id="hidden_field_data_rp01ingresos2do" style="<?php echo $sStyleHidden_rp01ingresos2do; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01ingresos2do_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01ingresos2do_label" style=""><span id="id_label_rp01ingresos2do"><?php echo $this->nm_new_label['rp01ingresos2do']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01provdiremp_line" id="hidden_field_data_rp01provdiremp" style="<?php echo $sStyleHidden_rp01provdiremp; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01provdiremp_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01provdiremp_label" style=""><span id="id_label_rp01provdiremp"><?php echo $this->nm_new_label['rp01provdiremp']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01cantondiremp_line" id="hidden_field_data_rp01cantondiremp" style="<?php echo $sStyleHidden_rp01cantondiremp; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01cantondiremp_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01cantondiremp_label" style=""><span id="id_label_rp01cantondiremp"><?php echo $this->nm_new_label['rp01cantondiremp']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01ciudaddiremp_line" id="hidden_field_data_rp01ciudaddiremp" style="<?php echo $sStyleHidden_rp01ciudaddiremp; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01ciudaddiremp_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01ciudaddiremp_label" style=""><span id="id_label_rp01ciudaddiremp"><?php echo $this->nm_new_label['rp01ciudaddiremp']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01codocupacion_line" id="hidden_field_data_rp01codocupacion" style="<?php echo $sStyleHidden_rp01codocupacion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01codocupacion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01codocupacion_label" style=""><span id="id_label_rp01codocupacion"><?php echo $this->nm_new_label['rp01codocupacion']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01foto_line" id="hidden_field_data_rp01foto" style="<?php echo $sStyleHidden_rp01foto; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01foto_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01foto_label" style=""><span id="id_label_rp01foto"><?php echo $this->nm_new_label['rp01foto']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01foto']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01foto'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01ctacontable_line" id="hidden_field_data_rp01ctacontable" style="<?php echo $sStyleHidden_rp01ctacontable; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01ctacontable_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01ctacontable_label" style=""><span id="id_label_rp01ctacontable"><?php echo $this->nm_new_label['rp01ctacontable']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01ctacontable']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01ctacontable'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01email_line" id="hidden_field_data_rp01email" style="<?php echo $sStyleHidden_rp01email; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01email_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01email_label" style=""><span id="id_label_rp01email"><?php echo $this->nm_new_label['rp01email']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01email'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01passwd_line" id="hidden_field_data_rp01passwd" style="<?php echo $sStyleHidden_rp01passwd; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01passwd_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01passwd_label" style=""><span id="id_label_rp01passwd"><?php echo $this->nm_new_label['rp01passwd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01passwd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01passwd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01huella_line" id="hidden_field_data_rp01huella" style="<?php echo $sStyleHidden_rp01huella; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01huella_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01huella_label" style=""><span id="id_label_rp01huella"><?php echo $this->nm_new_label['rp01huella']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01huella']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01huella'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01recibefr_line" id="hidden_field_data_rp01recibefr" style="<?php echo $sStyleHidden_rp01recibefr; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01recibefr_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01recibefr_label" style=""><span id="id_label_rp01recibefr"><?php echo $this->nm_new_label['rp01recibefr']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01recibefr']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01recibefr'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01recibedt_line" id="hidden_field_data_rp01recibedt" style="<?php echo $sStyleHidden_rp01recibedt; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01recibedt_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01recibedt_label" style=""><span id="id_label_rp01recibedt"><?php echo $this->nm_new_label['rp01recibedt']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01recibedc_line" id="hidden_field_data_rp01recibedc" style="<?php echo $sStyleHidden_rp01recibedc; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01recibedc_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01recibedc_label" style=""><span id="id_label_rp01recibedc"><?php echo $this->nm_new_label['rp01recibedc']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01uid_line" id="hidden_field_data_rp01uid" style="<?php echo $sStyleHidden_rp01uid; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01uid_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01uid_label" style=""><span id="id_label_rp01uid"><?php echo $this->nm_new_label['rp01uid']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01fechauid_line" id="hidden_field_data_rp01fechauid" style="<?php echo $sStyleHidden_rp01fechauid; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01fechauid_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01fechauid_label" style=""><span id="id_label_rp01fechauid"><?php echo $this->nm_new_label['rp01fechauid']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01obs_line" id="hidden_field_data_rp01obs" style="<?php echo $sStyleHidden_rp01obs; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01obs_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01obs_label" style=""><span id="id_label_rp01obs"><?php echo $this->nm_new_label['rp01obs']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01obs']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01obs'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01cauliq_line" id="hidden_field_data_rp01cauliq" style="<?php echo $sStyleHidden_rp01cauliq; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01cauliq_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01cauliq_label" style=""><span id="id_label_rp01cauliq"><?php echo $this->nm_new_label['rp01cauliq']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01cauliq']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01cauliq'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01discapacidad_line" id="hidden_field_data_rp01discapacidad" style="<?php echo $sStyleHidden_rp01discapacidad; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01discapacidad_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01discapacidad_label" style=""><span id="id_label_rp01discapacidad"><?php echo $this->nm_new_label['rp01discapacidad']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01discapacidad']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01discapacidad'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01conadis_line" id="hidden_field_data_rp01conadis" style="<?php echo $sStyleHidden_rp01conadis; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01conadis_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01conadis_label" style=""><span id="id_label_rp01conadis"><?php echo $this->nm_new_label['rp01conadis']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01conadis']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01conadis'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01tpdiscapacidad_line" id="hidden_field_data_rp01tpdiscapacidad" style="<?php echo $sStyleHidden_rp01tpdiscapacidad; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01tpdiscapacidad_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01tpdiscapacidad_label" style=""><span id="id_label_rp01tpdiscapacidad"><?php echo $this->nm_new_label['rp01tpdiscapacidad']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01tpdiscapacidad']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01tpdiscapacidad'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01prdiscapacidad_line" id="hidden_field_data_rp01prdiscapacidad" style="<?php echo $sStyleHidden_rp01prdiscapacidad; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01prdiscapacidad_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01prdiscapacidad_label" style=""><span id="id_label_rp01prdiscapacidad"><?php echo $this->nm_new_label['rp01prdiscapacidad']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01prdiscapacidad']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01prdiscapacidad'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01freserva_line" id="hidden_field_data_rp01freserva" style="<?php echo $sStyleHidden_rp01freserva; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01freserva_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01freserva_label" style=""><span id="id_label_rp01freserva"><?php echo $this->nm_new_label['rp01freserva']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01freserva']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01freserva'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01codsectorial_line" id="hidden_field_data_rp01codsectorial" style="<?php echo $sStyleHidden_rp01codsectorial; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01codsectorial_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01codsectorial_label" style=""><span id="id_label_rp01codsectorial"><?php echo $this->nm_new_label['rp01codsectorial']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01codsectorial']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01codsectorial'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_anticipoporvalor_line" id="hidden_field_data_anticipoporvalor" style="<?php echo $sStyleHidden_anticipoporvalor; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_anticipoporvalor_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_anticipoporvalor_label" style=""><span id="id_label_anticipoporvalor"><?php echo $this->nm_new_label['anticipoporvalor']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['anticipoporvalor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['anticipoporvalor'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tipidret_line" id="hidden_field_data_tipidret" style="<?php echo $sStyleHidden_tipidret; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipidret_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tipidret_label" style=""><span id="id_label_tipidret"><?php echo $this->nm_new_label['tipidret']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_residenciatrab_line" id="hidden_field_data_residenciatrab" style="<?php echo $sStyleHidden_residenciatrab; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_residenciatrab_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_residenciatrab_label" style=""><span id="id_label_residenciatrab"><?php echo $this->nm_new_label['residenciatrab']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_paisresidencia_line" id="hidden_field_data_paisresidencia" style="<?php echo $sStyleHidden_paisresidencia; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_paisresidencia_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_paisresidencia_label" style=""><span id="id_label_paisresidencia"><?php echo $this->nm_new_label['paisresidencia']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_aplicaconvenio_line" id="hidden_field_data_aplicaconvenio" style="<?php echo $sStyleHidden_aplicaconvenio; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_aplicaconvenio_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_aplicaconvenio_label" style=""><span id="id_label_aplicaconvenio"><?php echo $this->nm_new_label['aplicaconvenio']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tipotrabajdiscap_line" id="hidden_field_data_tipotrabajdiscap" style="<?php echo $sStyleHidden_tipotrabajdiscap; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipotrabajdiscap_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tipotrabajdiscap_label" style=""><span id="id_label_tipotrabajdiscap"><?php echo $this->nm_new_label['tipotrabajdiscap']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_porcentajediscap_line" id="hidden_field_data_porcentajediscap" style="<?php echo $sStyleHidden_porcentajediscap; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_porcentajediscap_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_porcentajediscap_label" style=""><span id="id_label_porcentajediscap"><?php echo $this->nm_new_label['porcentajediscap']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tipiddiscap_line" id="hidden_field_data_tipiddiscap" style="<?php echo $sStyleHidden_tipiddiscap; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipiddiscap_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tipiddiscap_label" style=""><span id="id_label_tipiddiscap"><?php echo $this->nm_new_label['tipiddiscap']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_iddiscap_line" id="hidden_field_data_iddiscap" style="<?php echo $sStyleHidden_iddiscap; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_iddiscap_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_iddiscap_label" style=""><span id="id_label_iddiscap"><?php echo $this->nm_new_label['iddiscap']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01cc_line" id="hidden_field_data_rp01cc" style="<?php echo $sStyleHidden_rp01cc; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01cc_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01cc_label" style=""><span id="id_label_rp01cc"><?php echo $this->nm_new_label['rp01cc']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01observacion_line" id="hidden_field_data_rp01observacion" style="<?php echo $sStyleHidden_rp01observacion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01observacion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01observacion_label" style=""><span id="id_label_rp01observacion"><?php echo $this->nm_new_label['rp01observacion']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01iessconyugue_line" id="hidden_field_data_rp01iessconyugue" style="<?php echo $sStyleHidden_rp01iessconyugue; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01iessconyugue_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01iessconyugue_label" style=""><span id="id_label_rp01iessconyugue"><?php echo $this->nm_new_label['rp01iessconyugue']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01tiporefrigerio_line" id="hidden_field_data_rp01tiporefrigerio" style="<?php echo $sStyleHidden_rp01tiporefrigerio; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01tiporefrigerio_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01tiporefrigerio_label" style=""><span id="id_label_rp01tiporefrigerio"><?php echo $this->nm_new_label['rp01tiporefrigerio']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idiomas_line" id="hidden_field_data_idiomas" style="<?php echo $sStyleHidden_idiomas; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idiomas_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idiomas_label" style=""><span id="id_label_idiomas"><?php echo $this->nm_new_label['idiomas']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_emergencias_line" id="hidden_field_data_emergencias" style="<?php echo $sStyleHidden_emergencias; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emergencias_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_emergencias_label" style=""><span id="id_label_emergencias"><?php echo $this->nm_new_label['emergencias']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01tipojornada_line" id="hidden_field_data_rp01tipojornada" style="<?php echo $sStyleHidden_rp01tipojornada; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01tipojornada_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01tipojornada_label" style=""><span id="id_label_rp01tipojornada"><?php echo $this->nm_new_label['rp01tipojornada']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01tipojornada']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['php_cmp_required']['rp01tipojornada'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01numero_horas_line" id="hidden_field_data_rp01numero_horas" style="<?php echo $sStyleHidden_rp01numero_horas; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01numero_horas_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01numero_horas_label" style=""><span id="id_label_rp01numero_horas"><?php echo $this->nm_new_label['rp01numero_horas']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01emailpersonal_line" id="hidden_field_data_rp01emailpersonal" style="<?php echo $sStyleHidden_rp01emailpersonal; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01emailpersonal_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01emailpersonal_label" style=""><span id="id_label_rp01emailpersonal"><?php echo $this->nm_new_label['rp01emailpersonal']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01supervisadopor_line" id="hidden_field_data_rp01supervisadopor" style="<?php echo $sStyleHidden_rp01supervisadopor; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01supervisadopor_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01supervisadopor_label" style=""><span id="id_label_rp01supervisadopor"><?php echo $this->nm_new_label['rp01supervisadopor']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01zonaderiesgo_line" id="hidden_field_data_rp01zonaderiesgo" style="<?php echo $sStyleHidden_rp01zonaderiesgo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01zonaderiesgo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01zonaderiesgo_label" style=""><span id="id_label_rp01zonaderiesgo"><?php echo $this->nm_new_label['rp01zonaderiesgo']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01refpersnom1_line" id="hidden_field_data_rp01refpersnom1" style="<?php echo $sStyleHidden_rp01refpersnom1; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01refpersnom1_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01refpersnom1_label" style=""><span id="id_label_rp01refpersnom1"><?php echo $this->nm_new_label['rp01refpersnom1']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01refpersparen1_line" id="hidden_field_data_rp01refpersparen1" style="<?php echo $sStyleHidden_rp01refpersparen1; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01refpersparen1_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01refpersparen1_label" style=""><span id="id_label_rp01refpersparen1"><?php echo $this->nm_new_label['rp01refpersparen1']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01refperstel1_line" id="hidden_field_data_rp01refperstel1" style="<?php echo $sStyleHidden_rp01refperstel1; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01refperstel1_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01refperstel1_label" style=""><span id="id_label_rp01refperstel1"><?php echo $this->nm_new_label['rp01refperstel1']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01refpersnom2_line" id="hidden_field_data_rp01refpersnom2" style="<?php echo $sStyleHidden_rp01refpersnom2; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01refpersnom2_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01refpersnom2_label" style=""><span id="id_label_rp01refpersnom2"><?php echo $this->nm_new_label['rp01refpersnom2']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01refpersparen2_line" id="hidden_field_data_rp01refpersparen2" style="<?php echo $sStyleHidden_rp01refpersparen2; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01refpersparen2_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01refpersparen2_label" style=""><span id="id_label_rp01refpersparen2"><?php echo $this->nm_new_label['rp01refpersparen2']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01refperstel2_line" id="hidden_field_data_rp01refperstel2" style="<?php echo $sStyleHidden_rp01refperstel2; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01refperstel2_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01refperstel2_label" style=""><span id="id_label_rp01refperstel2"><?php echo $this->nm_new_label['rp01refperstel2']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01tipovivienda_line" id="hidden_field_data_rp01tipovivienda" style="<?php echo $sStyleHidden_rp01tipovivienda; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01tipovivienda_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01tipovivienda_label" style=""><span id="id_label_rp01tipovivienda"><?php echo $this->nm_new_label['rp01tipovivienda']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01serviciosbasicos_line" id="hidden_field_data_rp01serviciosbasicos" style="<?php echo $sStyleHidden_rp01serviciosbasicos; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01serviciosbasicos_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01serviciosbasicos_label" style=""><span id="id_label_rp01serviciosbasicos"><?php echo $this->nm_new_label['rp01serviciosbasicos']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01viviendadetalle_line" id="hidden_field_data_rp01viviendadetalle" style="<?php echo $sStyleHidden_rp01viviendadetalle; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01viviendadetalle_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01viviendadetalle_label" style=""><span id="id_label_rp01viviendadetalle"><?php echo $this->nm_new_label['rp01viviendadetalle']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01dormitorios_line" id="hidden_field_data_rp01dormitorios" style="<?php echo $sStyleHidden_rp01dormitorios; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01dormitorios_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01dormitorios_label" style=""><span id="id_label_rp01dormitorios"><?php echo $this->nm_new_label['rp01dormitorios']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01sala_line" id="hidden_field_data_rp01sala" style="<?php echo $sStyleHidden_rp01sala; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01sala_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01sala_label" style=""><span id="id_label_rp01sala"><?php echo $this->nm_new_label['rp01sala']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01comedor_line" id="hidden_field_data_rp01comedor" style="<?php echo $sStyleHidden_rp01comedor; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01comedor_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01comedor_label" style=""><span id="id_label_rp01comedor"><?php echo $this->nm_new_label['rp01comedor']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01banos_line" id="hidden_field_data_rp01banos" style="<?php echo $sStyleHidden_rp01banos; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01banos_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01banos_label" style=""><span id="id_label_rp01banos"><?php echo $this->nm_new_label['rp01banos']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01estudiosrealizados_line" id="hidden_field_data_rp01estudiosrealizados" style="<?php echo $sStyleHidden_rp01estudiosrealizados; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01estudiosrealizados_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01estudiosrealizados_label" style=""><span id="id_label_rp01estudiosrealizados"><?php echo $this->nm_new_label['rp01estudiosrealizados']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01ruta1_line" id="hidden_field_data_rp01ruta1" style="<?php echo $sStyleHidden_rp01ruta1; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01ruta1_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01ruta1_label" style=""><span id="id_label_rp01ruta1"><?php echo $this->nm_new_label['rp01ruta1']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01ruta2_line" id="hidden_field_data_rp01ruta2" style="<?php echo $sStyleHidden_rp01ruta2; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01ruta2_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01ruta2_label" style=""><span id="id_label_rp01ruta2"><?php echo $this->nm_new_label['rp01ruta2']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01ruta3_line" id="hidden_field_data_rp01ruta3" style="<?php echo $sStyleHidden_rp01ruta3; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01ruta3_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01ruta3_label" style=""><span id="id_label_rp01ruta3"><?php echo $this->nm_new_label['rp01ruta3']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rp01actividadesextras_line" id="hidden_field_data_rp01actividadesextras" style="<?php echo $sStyleHidden_rp01actividadesextras; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rp01actividadesextras_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rp01actividadesextras_label" style=""><span id="id_label_rp01actividadesextras"><?php echo $this->nm_new_label['rp01actividadesextras']; ?></span></span><br>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
    dbParentFrame[0].contentWindow.scAjaxDetailValue('<?php echo $cmp_master ?>', '<?php echo $val_master ?>');
<?php
        }
        unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['masterValue']);
?>
}
<?php
    }
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_maeemp_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_maeemp_mob");
 parent.scAjaxDetailHeight("form_maeemp_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
{
<?php
if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['sc_modal'])
{
?>
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
