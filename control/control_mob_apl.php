...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['fec']))
          {
              $this->fec = $this->NM_ajax_info['param']['fec'];
          }
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['control_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['control_mob']['opc_ant'] = "inicio";
      }
      ...
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['buttonStatus'];
      }
...
//
   ...
   function loadFieldConfig()
   {
      ...
      //-- fec
      $this->field_config['fec']                 = array();
      $this->field_config['fec']['date_format']  = $_SESSION['scriptcase']['reg_conf']['date_format'];
      $this->field_config['fec']['date_sep']     = $_SESSION['scriptcase']['reg_conf']['date_sep'];
      $this->field_config['fec']['date_display'] = "ddmmyyyy";
      $this->new_date_format('DT', 'fec');
   }
...
//
      ...
      {
          if ('validate_fec' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'fec');
          }
...
//
      ...
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          if ($Campos_Crit == "" && empty($Campos_Falta) && $this->Campos_Mens_erro == "" && !isset($this->bok) && $this->nmgp_opcao != "recarga")
          {
              ...
              { 
                  $fec = $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['campos'][0]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      elseif (isset($this->bok) && $this->bok == "OK")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['campos'][0] = $this->fec; 
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "control_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="control_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="control_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="control_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'fec' == $filtro)) || (is_array($filtro) && in_array('fec', $filtro)))
        $this->ValidateField_fec($Campos_Crit, $Campos_Falta, $Campos_Erros);
//-- converter datas   
          $this->nm_converte_datas();
//---
    ...
    function ValidateField_fec(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      nm_limpa_data($this->fec, $this->field_config['fec']['date_sep']) ; 
      $trab_dt_min = ""; 
      $trab_dt_max = ""; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          $guarda_datahora = $this->field_config['fec']['date_format']; 
          if (false !== strpos($guarda_datahora, ';')) $this->field_config['fec']['date_format'] = substr($guarda_datahora, 0, strpos($guarda_datahora, ';'));
          $Format_Data = $this->field_config['fec']['date_format']; 
          nm_limpa_data($Format_Data, $this->field_config['fec']['date_sep']) ; 
          if (trim($this->fec) != "")  
          { 
              if ($teste_validade->Data($this->fec, $Format_Data, $trab_dt_min, $trab_dt_max) == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "fec; " ; 
                  if (!isset($Campos_Erros['fec']))
                  {
                      $Campos_Erros['fec'] = array();
                  }
                  $Campos_Erros['fec'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['fec']) || !is_array($this->NM_ajax_info['errList']['fec']))
                  {
                      $this->NM_ajax_info['errList']['fec'] = array();
                  }
                  $this->NM_ajax_info['errList']['fec'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
          $this->field_config['fec']['date_format'] = $guarda_datahora; 
       } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'fec';
   ...
   function nm_guardar_campos()
   {
    global
           $sc_seq_vert;
    $this->nmgp_dados_form['fec'] = (strlen(trim($this->fec)) > 19) ? str_replace(".", ":", $this->fec) : trim($this->fec);
   ...
   function nm_tira_formatacao()
   {
      ...
      $this->Before_unformat['fec'] = $this->fec;
      nm_limpa_data($this->fec, $this->field_config['fec']['date_sep']) ; 
   }
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      if ((!empty($this->fec) && 'null' != $this->fec) || (!empty($format_fields) && isset($format_fields['fec'])))
      {
          nm_volta_data($this->fec, $this->field_config['fec']['date_format']) ; 
          nmgp_Form_Datas($this->fec, $this->field_config['fec']['date_format'], $this->field_config['fec']['date_sep']) ;  
      }
      elseif ('null' == $this->fec || '' == $this->fec)
      {
          $this->fec = '';
      }
   }
...
//-- 
   function nm_converte_datas($use_null = true, $bForce = false)
   {
      if ($this->fec != "")  
      {
     nm_conv_form_data($this->fec, $this->field_config['fec']['date_format'], "AAAAMMDD", array($this->field_config['fec']['date_sep'])) ;  
      }
   }
//
   ...
   function ajax_return_values()
   {
          ...
          //----- fec
   function ajax_return_values_fec($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("fec", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->fec);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['fec'] = array(
                       'row'    => '',
               'type'    => 'text',
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['opc_ant'] = "";
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['control_mob']['ordem_ord'] == " desc") {
