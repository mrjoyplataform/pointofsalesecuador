...
?>
  ...
  // ---------- Validate fec
  function do_ajax_control_mob_validate_fec()
  {
    var nomeCampo_fec = "fec";
    var var_fec = scAjaxGetFieldText(nomeCampo_fec);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_mob_validate_fec(var_fec, var_script_case_init, do_ajax_control_mob_validate_fec_cb);
  } // do_ajax_control_mob_validate_fec

  function do_ajax_control_mob_validate_fec_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_mob_validate_fec_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_control_mob_submit_form()
  {
    ...
    scAjaxHideMessage();
    var var_fec = scAjaxGetFieldText("fec");
    ...
    scAjaxProcOn();
    x_ajax_control_mob_submit_form(var_fec, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_mob_submit_form_cb);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_mob_submit_form_cb_after_alert);
  } // do_ajax_control_mob_submit_form_cb
  function do_ajax_control_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_mob_submit_form_cb_after_alert
  ...
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_control_mob_navigate_form, function() {});
    } else {
      perform_ajax_control_mob_navigate_form();
    }
  }

  function perform_ajax_control_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
...
?>
  function do_ajax_control_mob_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_mob_navigate_form_cb
  function do_ajax_control_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_control_mob_navigate_form_cb_after_alert
  ...
  ajax_field_list[0] = "fec";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "fec": {"label": "fec", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["fec"][1] = "fec";

  var ajax_field_id = {
    "fec": new Array("hidden_field_label_fec", "hidden_field_data_fec")
  };
