...
//
   ...
   $_SESSION['scriptcase']['control_mob']['glo_nm_perfil']          = "conn_pos";
   ...
   $_SESSION['scriptcase']['control_mob']['glo_nm_path_cache']  = "";
   ...
   //check cache
   if(empty($_SESSION['scriptcase']['control_mob']['glo_nm_path_cache']))
   {
           /*check cache*/$_SESSION['scriptcase']['control_mob']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
   }
   //check doc
...
// 
      ...
      $this->path_cache      = $_SESSION['scriptcase']['control_mob']['glo_nm_path_cache'];
      ...
      if (isset($_SESSION['scriptcase']['control_mob']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['control_mob']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['control_mob']['actual_lang']) || $_SESSION['scriptcase']['control_mob']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['control_mob']['actual_lang'] = $this->str_lang;
      ...
      if (isset($_SESSION['scriptcase']['user_logout']))
      {
          foreach ($_SESSION['scriptcase']['user_logout'] as $ind => $parms)
          {
              if (isset($_SESSION[$parms['V']]) && $_SESSION[$parms['V']] == $parms['U'])
              {
                  ...
                  {
                      $inicial_control_mob->contr_control_mob->NM_ajax_info['redir']['action']  = $nm_apl_dest;
...
<?php
      ...
      if (isset($_SESSION['scriptcase']['control_mob']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['control_mob']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['control_mob']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['control_mob']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['control_mob']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['control_mob']['session_timeout']);
      ...
      {
          $inicial_control_mob->contr_control_mob->NM_ajax_info['redir']['action']  = "control_mob.php";
          $inicial_control_mob->contr_control_mob->NM_ajax_info['redir']['target']  = "_self";
          $inicial_control_mob->contr_control_mob->NM_ajax_info['redir']['metodo']  = "post";
          $inicial_control_mob->contr_control_mob->NM_ajax_info['redir']['script_case_init']  = $this->sc_page;
          control_mob_pack_ajax_response();
          exit;
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['control_mob']['session_timeout']['redir']))
      {
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['under_dashboard']))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              ...
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              ...
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['control_mob']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['control_mob']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['control_mob']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['control_mob']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['control_mob']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['control_mob']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['control_mob']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['control_mob']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['control_mob']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['control_mob']['link_info']['remove_border'] = true;
        }
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['control_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'pointofsales', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['control_mob']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['control_mob']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['control_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'pointofsales', 1, $this->force_db_utf8);
    }
    else {
...
//
    ...
    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']) && !isset($_SESSION['scriptcase']['control_mob']['session_timeout']['redir']))
    {
        if ('ajax_control_mob_validate_fec' == $_POST['rs'])
        {
    ...
    else
    {
        ...
        elseif ($_SESSION['sc_session'][$script_case_init]['control_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['control_mob']['run_iframe'] != "R")
        {
           ...
           $nm_url_saida = str_replace("_fim.php", ".php", $nm_url_saida); 
            ...
            {
                $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['control_mob']['retorno_edit'] . "?script_case_init=" . $script_case_init;  
                $nm_apl_dependente = 1 ; 
                $nm_saida_global = $nm_url_saida;
            } 
        ...
        { 
            if (!empty($nmgp_url_saida) && empty($_SESSION['sc_session'][$script_case_init]['control_mob']['retorno_edit'])) 
            {
                $_SESSION['sc_session'][$script_case_init]['control_mob']['retorno_edit'] = $nmgp_url_saida . "?script_case_init=" . $script_case_init; 
            } 
        } 
    ...
    sajax_init();
    //$sajax_debug_mode = 1;
    sajax_export("ajax_control_mob_validate_fec");
    ...
    if (isset($_POST['wizard_action']) && 'change_step' == $_POST['wizard_action']) {
        $inicial_control_mob->contr_control_mob->NM_ajax_info['param']['buffer_output'] = true;
        ob_start();
    }
...
//
    ...
    function ajax_control_mob_validate_fec($fec, $script_case_init)
    {
        global $inicial_control_mob;
        //register_shutdown_function("control_mob_pack_ajax_response");
        $inicial_control_mob->contr_control_mob->NM_ajax_flag          = true;
        $inicial_control_mob->contr_control_mob->NM_ajax_opcao         = 'validate_fec';
    ...
    function ajax_control_mob_submit_form($fec, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_control_mob;
        //register_shutdown_function("control_mob_pack_ajax_response");
        $inicial_control_mob->contr_control_mob->NM_ajax_flag          = true;
   ...
   function control_mob_pack_ajax_response()
   {
      ...
      if (isset($inicial_control_mob->contr_control_mob->NM_ajax_info['wizard']))
      {
          $aResp['wizard'] = $inicial_control_mob->contr_control_mob->NM_ajax_info['wizard'];
      }
...
//-----
      {
         ...
         if (isset($inicial_control_mob->contr_control_mob->NM_ajax_info['btnDisabled']) && '' != $inicial_control_mob->contr_control_mob->NM_ajax_info['btnDisabled'])
         {
            control_mob_pack_btn_disabled($aResp);
         }
         if (isset($inicial_control_mob->contr_control_mob->NM_ajax_info['btnLabel']) && '' != $inicial_control_mob->contr_control_mob->NM_ajax_info['btnLabel'])
         {
            control_mob_pack_btn_label($aResp);
         }
         if (isset($inicial_control_mob->contr_control_mob->NM_ajax_info['varList']) && !empty($inicial_control_mob->contr_control_mob->NM_ajax_info['varList']))
         {
            control_mob_pack_var_list($aResp);
         }
         ...
         if (isset($inicial_control_mob->contr_control_mob->NM_ajax_info['event_field']) && '' != $inicial_control_mob->contr_control_mob->NM_ajax_info['event_field'])
         {
            $aResp['eventField'] = $inicial_control_mob->contr_control_mob->NM_ajax_info['event_field'];
         }
         else
         {
   ...
   function control_mob_pack_ajax_set_fields(&$aResp)
   {
      ...
      foreach ($inicial_control_mob->contr_control_mob->NM_ajax_info['fldList'] as $sField => $aData)
      {
         ...
         {
            $aField['docReadonly'] = control_mob_pack_protect_string($aData['docReadonly']);
         }
   ...
   function control_mob_pack_var_list(&$aResp)
   {
      global $inicial_control_mob;
      foreach ($inicial_control_mob->contr_control_mob->NM_ajax_info['varList'] as $varData)
      {
         $aResp['varList'][] = array('index' => key($varData),
                                      'value' => current($varData));
      }
   } // control_mob_pack_var_list
   ...
   function control_mob_pack_btn_disabled(&$aResp)
   {
      global $inicial_control_mob;
      $aResp['btnDisabled'] = array();
      foreach ($inicial_control_mob->contr_control_mob->NM_ajax_info['btnDisabled'] as $btnName => $btnStatus) {
        $aResp['btnDisabled'][$btnName] = $btnStatus;
      }
   } // control_mob_pack_ajax_alert

   function control_mob_pack_btn_label(&$aResp)
   {
      global $inicial_control_mob;
      $aResp['btnLabel'] = array();
      foreach ($inicial_control_mob->contr_control_mob->NM_ajax_info['btnLabel'] as $btnName => $btnLabel) {
   ...
   function control_mob_pack_ajax_alert(&$aResp)
   {
      global $inicial_control_mob;
// PHP 8.0
      if (!isset($inicial_control_mob->contr_control_mob->NM_ajax_info['ajaxAlert']['message'])) {
          $inicial_control_mob->contr_control_mob->NM_ajax_info['ajaxAlert']['message'] = '';
      }
      if (!isset($inicial_control_mob->contr_control_mob->NM_ajax_info['ajaxAlert']['params'])) {
          $inicial_control_mob->contr_control_mob->NM_ajax_info['ajaxAlert']['params'] = '';
      }
//---
      $aResp['ajaxAlert'] = array('message' => $inicial_control_mob->contr_control_mob->NM_ajax_info['ajaxAlert']['message'], 'params' =>  $inicial_control_mob->contr_control_mob->NM_ajax_info['ajaxAlert']['params']);
   } // control_mob_pack_ajax_alert
   ...
   function control_mob_pack_ajax_message(&$aResp)
   {
      global $inicial_control_mob;
// PHP 8.0
      if (!isset($inicial_control_mob->contr_control_mob->NM_ajax_info['ajaxMessage']['message'])) {
          $inicial_control_mob->contr_control_mob->NM_ajax_info['ajaxMessage']['message'] = '';
      }
      if (!isset($inicial_control_mob->contr_control_mob->NM_ajax_info['ajaxMessage']['title'])) {
          $inicial_control_mob->contr_control_mob->NM_ajax_info['ajaxMessage']['title'] = '';
      }
//---
      $aResp['ajaxMessage'] = array('message'      => control_mob_pack_protect_string($inicial_control_mob->contr_control_mob->NM_ajax_info['ajaxMessage']['message']),
                                    ...
                                    'toast'        => isset($inicial_control_mob->contr_control_mob->NM_ajax_info['ajaxMessage']['toast'])        ? $inicial_control_mob->contr_control_mob->NM_ajax_info['ajaxMessage']['toast']        : 'N',
                                    'toast_pos'    => isset($inicial_control_mob->contr_control_mob->NM_ajax_info['ajaxMessage']['toast_pos'])    ? $inicial_control_mob->contr_control_mob->NM_ajax_info['ajaxMessage']['toast_pos']    : '',
                                    'type'         => isset($inicial_control_mob->contr_control_mob->NM_ajax_info['ajaxMessage']['type'])         ? $inicial_control_mob->contr_control_mob->NM_ajax_info['ajaxMessage']['type']         : '',
