...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_foto3_cond" name="foto3_cond" onChange="nm_campos_between(document.getElementById('id_vis_foto3'), this, 'foto3')">
      ...
      <br><span id="id_hide_foto3"  <?php echo $str_hide_foto3?>><INPUT  type="text" id="SC_foto3" name="foto3" value="<?php echo NM_encode_input($foto3) ?>" size="50" maxlength="32767" class="scFilterObjectOdd">
 </TD>
