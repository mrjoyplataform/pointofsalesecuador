<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_devices']['glo_nm_path_imag_temp'] . "/sc_apl_default_pointofsales.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_devices_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_devices_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_devices']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_devices']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["cod_device"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["cod_device"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["cod_device"] : "Cod Device";
   $tab_ger_campos['cod_activo'] = "on";
   $tab_def_campos['cod_activo'] = "cod_activo";
   $tab_labels["cod_activo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["cod_activo"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["cod_activo"] : "Cod Activo";
   $tab_ger_campos['cod_grupo'] = "on";
   $tab_def_campos['cod_grupo'] = "cod_grupo";
   $tab_labels["cod_grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["cod_grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["cod_grupo"] : "Cod Grupo";
   $tab_ger_campos['device_name'] = "on";
   $tab_def_campos['device_name'] = "device_name";
   $tab_labels["device_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["device_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["device_name"] : "Device Name";
   $tab_ger_campos['activa'] = "on";
   $tab_def_campos['activa'] = "activa";
   $tab_labels["activa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["activa"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["activa"] : "Activa";
   $tab_ger_campos['estado'] = "on";
   $tab_def_campos['estado'] = "estado";
   $tab_labels["estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["estado"] : "Estado";
   $tab_ger_campos['ult_rfid'] = "on";
   $tab_def_campos['ult_rfid'] = "ult_rfid";
   $tab_labels["ult_rfid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["ult_rfid"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["ult_rfid"] : "Ult Rfid";
   $tab_ger_campos['ult_fecha'] = "on";
   $tab_def_campos['ult_fecha'] = "ult_fecha";
   $tab_labels["ult_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["ult_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["ult_fecha"] : "Ult Fecha";
   $tab_ger_campos['valor_default'] = "on";
   $tab_def_campos['valor_default'] = "valor_default";
   $tab_labels["valor_default"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["valor_default"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["valor_default"] : "Valor Default";
   $tab_ger_campos['acepta_tiempo'] = "on";
   $tab_def_campos['acepta_tiempo'] = "acepta_tiempo";
   $tab_labels["acepta_tiempo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["acepta_tiempo"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["acepta_tiempo"] : "Acepta Tiempo";
   $tab_ger_campos['acepta_tokens'] = "on";
   $tab_def_campos['acepta_tokens'] = "acepta_tokens";
   $tab_labels["acepta_tokens"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["acepta_tokens"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["acepta_tokens"] : "Acepta Tokens";
   $tab_ger_campos['dev_ip'] = "on";
   $tab_def_campos['dev_ip'] = "dev_ip";
   $tab_labels["dev_ip"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["dev_ip"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["dev_ip"] : "Dev Ip";
   $tab_ger_campos['tipo_dev'] = "on";
   $tab_def_campos['tipo_dev'] = "tipo_dev";
   $tab_labels["tipo_dev"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["tipo_dev"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["tipo_dev"] : "Tipo Dev";
   $tab_ger_campos['direccion_torno'] = "on";
   $tab_def_campos['direccion_torno'] = "direccion_torno";
   $tab_labels["direccion_torno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["direccion_torno"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["direccion_torno"] : "Direccion Torno";
   $tab_ger_campos['timeout_rfid'] = "on";
   $tab_def_campos['timeout_rfid'] = "timeout_rfid";
   $tab_labels["timeout_rfid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["timeout_rfid"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["timeout_rfid"] : "Timeout Rfid";
   $tab_ger_campos['discapacitado'] = "on";
   $tab_def_campos['discapacitado'] = "discapacitado";
   $tab_labels["discapacitado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["discapacitado"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["discapacitado"] : "Discapacitado";
   $tab_ger_campos['numcaja'] = "on";
   $tab_def_campos['numcaja'] = "numcaja";
   $tab_labels["numcaja"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["numcaja"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["numcaja"] : "Numcaja";
   $tab_ger_campos['empleado'] = "on";
   $tab_def_campos['empleado'] = "empleado";
   $tab_labels["empleado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["empleado"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["empleado"] : "Empleado";
   $tab_ger_campos['tokens'] = "on";
   $tab_def_campos['tokens'] = "tokens";
   $tab_labels["tokens"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["tokens"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["tokens"] : "Tokens";
   $tab_ger_campos['serialrfid'] = "on";
   $tab_def_campos['serialrfid'] = "serialrfid";
   $tab_labels["serialrfid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["serialrfid"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["serialrfid"] : "Serialrfid";
   $tab_ger_campos['bidireccion'] = "on";
   $tab_def_campos['bidireccion'] = "bidireccion";
   $tab_labels["bidireccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["bidireccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["bidireccion"] : "Bidireccion";
   $tab_ger_campos['cod_devicee'] = "on";
   $tab_def_campos['cod_devicee'] = "cod_deviceE";
   $tab_labels["cod_devicee"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["cod_devicee"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["cod_devicee"] : "Cod Device E";
   $tab_ger_campos['url_1'] = "on";
   $tab_def_campos['url_1'] = "url_1";
   $tab_labels["url_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["url_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["url_1"] : "Url 1";
   $tab_ger_campos['url_2'] = "on";
   $tab_def_campos['url_2'] = "url_2";
   $tab_labels["url_2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["url_2"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["url_2"] : "Url 2";
   $tab_ger_campos['url_3'] = "on";
   $tab_def_campos['url_3'] = "url_3";
   $tab_labels["url_3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["url_3"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["url_3"] : "Url 3";
   $tab_ger_campos['foto1'] = "on";
   $tab_def_campos['foto1'] = "foto1";
   $tab_labels["foto1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["foto1"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["foto1"] : "Foto 1";
   $tab_ger_campos['foto2'] = "on";
   $tab_def_campos['foto2'] = "foto2";
   $tab_labels["foto2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["foto2"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["foto2"] : "Foto 2";
   $tab_ger_campos['foto3'] = "on";
   $tab_def_campos['foto3'] = "foto3";
   $tab_labels["foto3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["foto3"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['labels']["foto3"] : "Foto 3";
   $tab_ger_campos['url_1'] = "none";
   $tab_ger_campos['url_2'] = "none";
   $tab_ger_campos['url_3'] = "none";
   $tab_ger_campos['foto1'] = "none";
   $tab_ger_campos['foto2'] = "none";
   $tab_ger_campos['foto3'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_devices']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_devices']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_devices']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_devices']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_devices']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_devices']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_devices']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_devices']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_devices']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_devices']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_devices_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_devices']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_devices']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_devices']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_devices']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_devices']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
