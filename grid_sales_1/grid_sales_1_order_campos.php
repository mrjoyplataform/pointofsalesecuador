...
<?php
   ...
   $Ord_Cmp = new grid_sales_1_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_sales_1_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sales_1']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sales_1']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id_sales"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_1']['labels']["id_sales"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_1']['labels']["id_sales"] : "Id Sales";
   $tab_ger_campos['sales_price'] = "on";
   $tab_def_campos['sales_price'] = "sales_price";
   $tab_labels["sales_price"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_1']['labels']["sales_price"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_1']['labels']["sales_price"] : "Sales Price";
   $tab_ger_campos['sales_discount'] = "on";
   $tab_def_campos['sales_discount'] = "sales_discount";
   $tab_labels["sales_discount"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_1']['labels']["sales_discount"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_1']['labels']["sales_discount"] : "Sales Discount";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_1']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_1']['labels']["total"] : "Total";
   $tab_ger_campos['datesales'] = "on";
   $tab_def_campos['datesales'] = "datesales";
   $tab_labels["datesales"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_1']['labels']["datesales"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_1']['labels']["datesales"] : "Datesales";
   $tab_ger_campos['id_status'] = "on";
   $tab_def_campos['id_status'] = "id_status";
   $tab_labels["id_status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_1']['labels']["id_status"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_1']['labels']["id_status"] : "Id Status";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_sales_1']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_sales_1']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_sales_1']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sales_1']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sales_1']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_sales_1']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_sales_1']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_sales_1']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_sales_1']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_sales_1']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_sales_1']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_sales_1']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_sales_1_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_sales_1']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_sales_1']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_sales_1']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_sales_1']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_sales_1']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
