<?php
@session_start() ;
$_SESSION['scriptcase']['grid_att_registro']['sc_process_barr'] = true;
require_once('../grid_att_registro/index.php');
unset($_SESSION['scriptcase']['grid_att_registro']['sc_process_barr']);
$ExportCtrl = new grid_att_registro_export_control;
$ExportCtrl->Export_barr();

class grid_att_registro_export_control
{
