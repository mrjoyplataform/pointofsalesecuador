<?php
@session_start() ;
$_SESSION['scriptcase']['grid_maecom']['sc_process_barr'] = true;
require_once('../grid_maecom/index.php');
unset($_SESSION['scriptcase']['grid_maecom']['sc_process_barr']);
$ExportCtrl = new grid_maecom_export_control;
$ExportCtrl->Export_barr();

class grid_maecom_export_control
{
