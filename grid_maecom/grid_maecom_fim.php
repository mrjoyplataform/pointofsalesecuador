...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_maecom"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_maecom"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_maecom'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_maecom']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_maecom']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_maecom']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_maecom']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_maecom']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_maecom']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_maecom']['embutida_filho'] as $ind => $sc_init)
          {
