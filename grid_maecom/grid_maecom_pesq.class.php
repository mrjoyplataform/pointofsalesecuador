...
class grid_maecom_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_maecom_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_maecom_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_maecom_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nomcte31')
      {
          $nomcte31 = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nomcte31($nomcte31);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_tipodocto31')
      {
          $tipodocto31 = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_tipodocto31($tipodocto31);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nofact31')
      {
          $nofact31 = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nofact31($nofact31);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nocte31')
      {
          $nocte31 = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nocte31($nocte31);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "fecfact31";$Nm_datas[] = "fecfact31";$Nm_datas[] = "fecped31";$Nm_datas[] = "fecped31";$Nm_datas[] = "fectrasfer31";$Nm_datas[] = "fectrasfer31";$Nm_datas[] = "fecdocpr31";$Nm_datas[] = "fecdocpr31";$Nm_datas[] = "fecvencidocpr";$Nm_datas[] = "fecvencidocpr";$Nm_datas[] = "fecemb";$Nm_datas[] = "fecemb";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> maecom</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_maecom/grid_maecom_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_maecom_ajax_search.js"></script>
 <script type="text/javascript" src="grid_maecom_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_maecom_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_maecom']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_maecom']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_nomcte31_cond#NMF#' + search_get_sel_txt('SC_nomcte31_cond') + '@NMF@';
  str_out += 'SC_nomcte31#NMF#' + search_get_text('SC_nomcte31') + '@NMF@';
  str_out += 'id_ac_nomcte31#NMF#' + search_get_text('id_ac_nomcte31') + '@NMF@';
  str_out += 'SC_tipodocto31_cond#NMF#' + search_get_sel_txt('SC_tipodocto31_cond') + '@NMF@';
  str_out += 'SC_tipodocto31#NMF#' + search_get_text('SC_tipodocto31') + '@NMF@';
  str_out += 'id_ac_tipodocto31#NMF#' + search_get_text('id_ac_tipodocto31') + '@NMF@';
  str_out += 'SC_nofact31_cond#NMF#' + search_get_sel_txt('SC_nofact31_cond') + '@NMF@';
  str_out += 'SC_nofact31#NMF#' + search_get_text('SC_nofact31') + '@NMF@';
  str_out += 'id_ac_nofact31#NMF#' + search_get_text('id_ac_nofact31') + '@NMF@';
  str_out += 'SC_nocte31_cond#NMF#' + search_get_sel_txt('SC_nocte31_cond') + '@NMF@';
  str_out += 'SC_nocte31#NMF#' + search_get_text('SC_nocte31') + '@NMF@';
  str_out += 'id_ac_nocte31#NMF#' + search_get_text('id_ac_nocte31') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_tipodocto31").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_tipodocto31").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_tipodocto31",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_tipodocto31").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_tipodocto31").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_nofact31").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_nofact31").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nofact31",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nofact31").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_nocte31").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_nocte31").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nocte31",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nocte31").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_nomcte31").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_nomcte31").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nomcte31",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> maecom</div>
...
<?php
   ...
   {
      global 
             $nomcte31_cond, $nomcte31, $nomcte31_autocomp,
             $tipodocto31_cond, $tipodocto31, $tipodocto31_autocomp,
             $nofact31_cond, $nofact31, $nofact31_autocomp,
             $nocte31_cond, $nocte31, $nocte31_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $nomcte31 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']['nomcte31']; 
          $nomcte31_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']['nomcte31_cond']; 
          $tipodocto31 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']['tipodocto31']; 
          $tipodocto31_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']['tipodocto31_cond']; 
          $nofact31 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']['nofact31']; 
          $nofact31_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']['nofact31_cond']; 
          $nocte31 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']['nocte31']; 
          $nocte31_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']['nocte31_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']['NM_operador']; 
      } 
      if (!isset($nomcte31_cond) || empty($nomcte31_cond))
      {
         $nomcte31_cond = "qp";
      }
      if (!isset($tipodocto31_cond) || empty($tipodocto31_cond))
      {
         $tipodocto31_cond = "qp";
      }
      if (!isset($nofact31_cond) || empty($nofact31_cond))
      {
         $nofact31_cond = "qp";
      }
      if (!isset($nocte31_cond) || empty($nocte31_cond))
      {
         $nocte31_cond = "qp";
      }
      ...
      $str_hide_nomcte31 = (in_array($nomcte31_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_tipodocto31 = (in_array($tipodocto31_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nofact31 = (in_array($nofact31_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nocte31 = (in_array($nocte31_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($nomcte31) || $nomcte31 == "")
      {
          $nomcte31 = "";
      }
      if (isset($nomcte31) && !empty($nomcte31))
      {
         $tmp_pos = strpos($nomcte31, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nomcte31 = substr($nomcte31, 0, $tmp_pos);
         }
      }
      if (!isset($tipodocto31) || $tipodocto31 == "")
      {
          $tipodocto31 = "";
      }
      if (isset($tipodocto31) && !empty($tipodocto31))
      {
         $tmp_pos = strpos($tipodocto31, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $tipodocto31 = substr($tipodocto31, 0, $tmp_pos);
         }
      }
      if (!isset($nofact31) || $nofact31 == "")
      {
          $nofact31 = "";
      }
      if (isset($nofact31) && !empty($nofact31))
      {
         $tmp_pos = strpos($nofact31, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nofact31 = substr($nofact31, 0, $tmp_pos);
         }
      }
      if (!isset($nocte31) || $nocte31 == "")
      {
          $nocte31 = "";
      }
      if (isset($nocte31) && !empty($nocte31))
      {
         $tmp_pos = strpos($nocte31, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nocte31 = substr($nocte31, 0, $tmp_pos);
         }
      }
?>
 <?php
...
?>
<?php
   if (is_file("grid_maecom_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_maecom']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_maecom']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_nomcte31_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['nomcte31'])) ? $this->New_label['nomcte31'] : "Nomcte 31"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_nomcte31_cond" name="nomcte31_cond" onChange="nm_campos_between(document.getElementById('id_vis_nomcte31'), this, 'nomcte31')">
       <OPTION value="qp" <?php if ("qp" == $nomcte31_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nomcte31_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nomcte31_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nomcte31_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nomcte31" <?php echo $str_hide_nomcte31?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['nomcte31'])) ? $this->New_label['nomcte31'] : "Nomcte 31";
 $nmgp_tab_label .= "nomcte31?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $nomcte31;
      }
?>
<INPUT  type="text" id="SC_nomcte31" name="nomcte31" value="<?php echo NM_encode_input($nomcte31) ?>"  size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nomcte31" name="nomcte31_autocomp" size="45"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_tipodocto31_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['tipodocto31'])) ? $this->New_label['tipodocto31'] : "Tipodocto 31"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_tipodocto31_cond" name="tipodocto31_cond" onChange="nm_campos_between(document.getElementById('id_vis_tipodocto31'), this, 'tipodocto31')">
       <OPTION value="qp" <?php if ("qp" == $tipodocto31_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $tipodocto31_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $tipodocto31_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $tipodocto31_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tipodocto31" <?php echo $str_hide_tipodocto31?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['tipodocto31'])) ? $this->New_label['tipodocto31'] : "Tipodocto 31";
 $nmgp_tab_label .= "tipodocto31?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $tipodocto31;
      }
?>
<INPUT  type="text" id="SC_tipodocto31" name="tipodocto31" value="<?php echo NM_encode_input($tipodocto31) ?>"  size=2 alt="{datatype: 'text', maxLength: 2, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_tipodocto31" name="tipodocto31_autocomp" size="2"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 2, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_nofact31_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['nofact31'])) ? $this->New_label['nofact31'] : "Nofact 31"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_nofact31_cond" name="nofact31_cond" onChange="nm_campos_between(document.getElementById('id_vis_nofact31'), this, 'nofact31')">
       <OPTION value="qp" <?php if ("qp" == $nofact31_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nofact31_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nofact31_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nofact31_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nofact31" <?php echo $str_hide_nofact31?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['nofact31'])) ? $this->New_label['nofact31'] : "Nofact 31";
 $nmgp_tab_label .= "nofact31?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $nofact31;
      }
?>
<INPUT  type="text" id="SC_nofact31" name="nofact31" value="<?php echo NM_encode_input($nofact31) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nofact31" name="nofact31_autocomp" size="20"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_nocte31_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nocte31'])) ? $this->New_label['nocte31'] : "Nocte 31"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_nocte31_cond" name="nocte31_cond" onChange="nm_campos_between(document.getElementById('id_vis_nocte31'), this, 'nocte31')">
       <OPTION value="qp" <?php if ("qp" == $nocte31_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nocte31_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nocte31_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nocte31_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nocte31" <?php echo $str_hide_nocte31?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['nocte31'])) ? $this->New_label['nocte31'] : "Nocte 31";
 $nmgp_tab_label .= "nocte31?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $nocte31;
      }
?>
<INPUT  type="text" id="SC_nocte31" name="nocte31" value="<?php echo NM_encode_input($nocte31) ?>"  size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nocte31" name="nocte31_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.nomcte31_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nomcte31'), document.F1.nomcte31_cond, 'nomcte31');
   document.F1.nomcte31.value = "";
   document.F1.nomcte31_autocomp.value = "";
   document.F1.tipodocto31_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_tipodocto31'), document.F1.tipodocto31_cond, 'tipodocto31');
   document.F1.tipodocto31.value = "";
   document.F1.tipodocto31_autocomp.value = "";
   document.F1.nofact31_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nofact31'), document.F1.nofact31_cond, 'nofact31');
   document.F1.nofact31.value = "";
   document.F1.nofact31_autocomp.value = "";
   document.F1.nocte31_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nocte31'), document.F1.nocte31_cond, 'nocte31');
   document.F1.nocte31.value = "";
   document.F1.nocte31_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_nomcte31_cond'] = 'cond';
      $tp_fields['SC_nomcte31'] = 'text_aut';
      $tp_fields['id_ac_nomcte31'] = 'text_aut';
      $tp_fields['SC_tipodocto31_cond'] = 'cond';
      $tp_fields['SC_tipodocto31'] = 'text_aut';
      $tp_fields['id_ac_tipodocto31'] = 'text_aut';
      $tp_fields['SC_nofact31_cond'] = 'cond';
      $tp_fields['SC_nofact31'] = 'text_aut';
      $tp_fields['id_ac_nofact31'] = 'text_aut';
      $tp_fields['SC_nocte31_cond'] = 'cond';
      $tp_fields['SC_nocte31'] = 'text_aut';
      $tp_fields['id_ac_nocte31'] = 'text_aut';
   ...
   {
      global $nomcte31_cond, $nomcte31, $nomcte31_autocomp,
             $tipodocto31_cond, $tipodocto31, $tipodocto31_autocomp,
             $nofact31_cond, $nofact31, $nofact31_autocomp,
             $nocte31_cond, $nocte31, $nocte31_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($nomcte31_autocomp) && empty($nomcte31))
      {
          $nomcte31 = $nomcte31_autocomp;
      }
      if (!empty($tipodocto31_autocomp) && empty($tipodocto31))
      {
          $tipodocto31 = $tipodocto31_autocomp;
      }
      if (!empty($nofact31_autocomp) && empty($nofact31))
      {
          $nofact31 = $nofact31_autocomp;
      }
      if (!empty($nocte31_autocomp) && empty($nocte31))
      {
          $nocte31 = $nocte31_autocomp;
      }
      $nomcte31_cond_salva = $nomcte31_cond; 
      if (!isset($nomcte31_input_2) || $nomcte31_input_2 == "")
      {
          $nomcte31_input_2 = $nomcte31;
      }
      $tipodocto31_cond_salva = $tipodocto31_cond; 
      if (!isset($tipodocto31_input_2) || $tipodocto31_input_2 == "")
      {
          $tipodocto31_input_2 = $tipodocto31;
      }
      $nofact31_cond_salva = $nofact31_cond; 
      if (!isset($nofact31_input_2) || $nofact31_input_2 == "")
      {
          $nofact31_input_2 = $nofact31;
      }
      $nocte31_cond_salva = $nocte31_cond; 
      if (!isset($nocte31_input_2) || $nocte31_input_2 == "")
      {
          $nocte31_input_2 = $nocte31;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']['nomcte31'] = $nomcte31; 
      if (is_array($nomcte31) && !empty($nomcte31))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['Grid_search'][$I_Grid]['val'][0] = $nomcte31;
      }
      elseif ($nomcte31_cond_salva == "nu" || $nomcte31_cond_salva == "nn" || $nomcte31_cond_salva == "ep" || $nomcte31_cond_salva == "ne" || !empty($nomcte31))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['Grid_search'][$I_Grid]['val'][0][0] = $nomcte31;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']['nomcte31_cond'] = $nomcte31_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['Grid_search'][$I_Grid]['cmp'] = "nomcte31"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['Grid_search'][$I_Grid]['opc'] = $nomcte31_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq']['nomcte31'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']['tipodocto31'] = $tipodocto31; 
      if (is_array($tipodocto31) && !empty($tipodocto31))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['Grid_search'][$I_Grid]['val'][0] = $tipodocto31;
      }
      elseif ($tipodocto31_cond_salva == "nu" || $tipodocto31_cond_salva == "nn" || $tipodocto31_cond_salva == "ep" || $tipodocto31_cond_salva == "ne" || !empty($tipodocto31))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['Grid_search'][$I_Grid]['val'][0][0] = $tipodocto31;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']['tipodocto31_cond'] = $tipodocto31_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['Grid_search'][$I_Grid]['cmp'] = "tipodocto31"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['Grid_search'][$I_Grid]['opc'] = $tipodocto31_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq']['tipodocto31'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']['nofact31'] = $nofact31; 
      if (is_array($nofact31) && !empty($nofact31))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['Grid_search'][$I_Grid]['val'][0] = $nofact31;
      }
      elseif ($nofact31_cond_salva == "nu" || $nofact31_cond_salva == "nn" || $nofact31_cond_salva == "ep" || $nofact31_cond_salva == "ne" || !empty($nofact31))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['Grid_search'][$I_Grid]['val'][0][0] = $nofact31;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']['nofact31_cond'] = $nofact31_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['Grid_search'][$I_Grid]['cmp'] = "nofact31"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['Grid_search'][$I_Grid]['opc'] = $nofact31_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq']['nofact31'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']['nocte31'] = $nocte31; 
      if (is_array($nocte31) && !empty($nocte31))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['Grid_search'][$I_Grid]['val'][0] = $nocte31;
      }
      elseif ($nocte31_cond_salva == "nu" || $nocte31_cond_salva == "nn" || $nocte31_cond_salva == "ep" || $nocte31_cond_salva == "ne" || !empty($nocte31))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['Grid_search'][$I_Grid]['val'][0][0] = $nocte31;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']['nocte31_cond'] = $nocte31_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['Grid_search'][$I_Grid]['cmp'] = "nocte31"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['Grid_search'][$I_Grid]['opc'] = $nocte31_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['grid_pesq']['nocte31'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($nomcte31 != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nomcte31'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['nomcte31'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nomcte31'] = $nomcte31;
      }
      $nmgp_def_dados = array();
    if ($tipodocto31 != '') {
      $tipodocto31_look = substr($this->Db->qstr($tipodocto31), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['tipodocto31'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['tipodocto31'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['tipodocto31'] = $tipodocto31;
      }
      $nmgp_def_dados = array();
    if ($nofact31 != '') {
      $nofact31_look = substr($this->Db->qstr($nofact31), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nofact31'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['nofact31'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nofact31'] = $nofact31;
      }
      $nmgp_def_dados = array();
    if ($nocte31 != '') {
      $nocte31_look = substr($this->Db->qstr($nocte31), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nocte31'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['nocte31'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nocte31'] = $nocte31;
      }

      //----- $nomcte31
      $this->Date_part = false;
      if (isset($nomcte31) || $nomcte31_cond == "nu" || $nomcte31_cond == "nn" || $nomcte31_cond == "ep" || $nomcte31_cond == "ne")
      {
         $this->monta_condicao("nomcte31", $nomcte31_cond, $nomcte31, "", "nomcte31");
      }

      //----- $tipodocto31
      $this->Date_part = false;
      if (isset($tipodocto31) || $tipodocto31_cond == "nu" || $tipodocto31_cond == "nn" || $tipodocto31_cond == "ep" || $tipodocto31_cond == "ne")
      {
         $this->monta_condicao("tipodocto31", $tipodocto31_cond, $tipodocto31, "", "tipodocto31");
      }

      //----- $nofact31
      $this->Date_part = false;
      if (isset($nofact31) || $nofact31_cond == "nu" || $nofact31_cond == "nn" || $nofact31_cond == "ep" || $nofact31_cond == "ne")
      {
         $this->monta_condicao("nofact31", $nofact31_cond, $nofact31, "", "nofact31");
      }

      //----- $nocte31
      $this->Date_part = false;
      if (isset($nocte31) || $nocte31_cond == "nu" || $nocte31_cond == "nn" || $nocte31_cond == "ep" || $nocte31_cond == "ne")
      {
         $this->monta_condicao("nocte31", $nocte31_cond, $nocte31, "", "nocte31");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maecom']['cond_pesq'] .= $this->NM_operador;
