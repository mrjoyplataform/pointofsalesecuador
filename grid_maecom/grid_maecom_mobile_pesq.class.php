...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nomcte31_cond" name="nomcte31_cond" onChange="nm_campos_between(document.getElementById('id_vis_nomcte31'), this, 'nomcte31')">
      ...
      <br><span id="id_hide_nomcte31"  <?php echo $str_hide_nomcte31?>><?php
      if ($nomcte31 != "")
      {
      $nomcte31_look = substr($this->Db->qstr($nomcte31), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_tipodocto31_cond" name="tipodocto31_cond" onChange="nm_campos_between(document.getElementById('id_vis_tipodocto31'), this, 'tipodocto31')">
      ...
      <br><span id="id_hide_tipodocto31"  <?php echo $str_hide_tipodocto31?>><?php
      if ($tipodocto31 != "")
      {
      $tipodocto31_look = substr($this->Db->qstr($tipodocto31), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nofact31_cond" name="nofact31_cond" onChange="nm_campos_between(document.getElementById('id_vis_nofact31'), this, 'nofact31')">
      ...
      <br><span id="id_hide_nofact31"  <?php echo $str_hide_nofact31?>><?php
      if ($nofact31 != "")
      {
      $nofact31_look = substr($this->Db->qstr($nofact31), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nocte31_cond" name="nocte31_cond" onChange="nm_campos_between(document.getElementById('id_vis_nocte31'), this, 'nocte31')">
      ...
      <br><span id="id_hide_nocte31"  <?php echo $str_hide_nocte31?>><?php
      if ($nocte31 != "")
      {
      $nocte31_look = substr($this->Db->qstr($nocte31), 1, -1); 
      $nmgp_def_dados = array(); 
