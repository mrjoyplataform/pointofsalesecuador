...
<?php
   ...
   $Ord_Cmp = new grid_maecom_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_maecom_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_maecom']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_maecom']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['tipodocto31'] = "tipodocto31";
   $tab_labels["tipodocto31"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maecom']['labels']["tipodocto31"])) ? $_SESSION['sc_session'][$sc_init]['grid_maecom']['labels']["tipodocto31"] : "Tipodocto 31";
   $tab_ger_campos['nofact31'] = "on";
   $tab_def_campos['nofact31'] = "nofact31";
   $tab_labels["nofact31"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maecom']['labels']["nofact31"])) ? $_SESSION['sc_session'][$sc_init]['grid_maecom']['labels']["nofact31"] : "Nofact 31";
   $tab_ger_campos['nocte31'] = "on";
   $tab_def_campos['nocte31'] = "nocte31";
   $tab_labels["nocte31"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maecom']['labels']["nocte31"])) ? $_SESSION['sc_session'][$sc_init]['grid_maecom']['labels']["nocte31"] : "Nocte 31";
   $tab_ger_campos['nomcte31'] = "on";
   $tab_def_campos['nomcte31'] = "nomcte31";
   $tab_labels["nomcte31"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maecom']['labels']["nomcte31"])) ? $_SESSION['sc_session'][$sc_init]['grid_maecom']['labels']["nomcte31"] : "Nomcte 31";
   $tab_ger_campos['localid31'] = "on";
   $tab_def_campos['localid31'] = "localid31";
   $tab_labels["localid31"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maecom']['labels']["localid31"])) ? $_SESSION['sc_session'][$sc_init]['grid_maecom']['labels']["localid31"] : "Localid 31";
   $tab_ger_campos['cvectenegro31'] = "on";
   $tab_def_campos['cvectenegro31'] = "cvectenegro31";
   $tab_labels["cvectenegro31"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maecom']['labels']["cvectenegro31"])) ? $_SESSION['sc_session'][$sc_init]['grid_maecom']['labels']["cvectenegro31"] : "Cvectenegro 31";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_maecom']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_maecom']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_maecom']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_maecom']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_maecom']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_maecom']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_maecom']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_maecom']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_maecom']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_maecom']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_maecom']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_maecom']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_maecom_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_maecom']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_maecom']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_maecom']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_maecom']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_maecom']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
