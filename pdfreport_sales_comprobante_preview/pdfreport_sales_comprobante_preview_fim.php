...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____pdfreport_sales_comprobante_preview"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____pdfreport_sales_comprobante_preview"]);
   }
   ...
   $fecha_janela = false;
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pdfreport_sales_comprobante_preview']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['pdfreport_sales_comprobante_preview']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pdfreport_sales_comprobante_preview']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['pdfreport_sales_comprobante_preview']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['pdfreport_sales_comprobante_preview']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>pdfreport_sales_comprobante_preview</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['pdfreport_sales_comprobante_preview']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['pdfreport_sales_comprobante_preview']['embutida_filho'] as $ind => $sc_init)
          {
