<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_sales_comprobante_preview']['sc_process_barr'] = true;
require_once('../pdfreport_sales_comprobante_preview/index.php');
unset($_SESSION['scriptcase']['pdfreport_sales_comprobante_preview']['sc_process_barr']);
$ExportCtrl = new pdfreport_sales_comprobante_preview_export_control;
$ExportCtrl->Export_barr();

class pdfreport_sales_comprobante_preview_export_control
{
