<?php
class pdfreport_sales_comprobante_preview_grid
{
   var $Ini;
   var $Erro;
   var $Pdf;
...
//
   ...
   $_SESSION['scriptcase']['pdfreport_sales_comprobante_preview']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("pdfreport_sales_comprobante_preview", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['campos_busca'];
   ...
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['where_pesq_filtro'];
   $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
   $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
   $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
   $_SESSION['scriptcase']['contr_link_emb'] = $this->nm_location;
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_sales_comprobante_preview']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_sales_comprobante_preview']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_sales_comprobante_preview']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_sales_comprobante_preview']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['where_pesq'];  
//----- 
   ...
   $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['where_pesq']; 
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['id_sales'] = "Id Sales";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['sales_price'] = "Sales Price";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['sales_discount'] = "Sales Discount";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['total'] = "Total";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['datesales'] = "Datesales";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['id_status'] = "Id Status";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['idcaja'] = "Idcaja";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['idcliente'] = "Idcliente";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['cliente'] = "Cliente";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['direccion'] = "Direccion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['telefono'] = "Telefono";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['factura'] = "Factura";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['serie'] = "Serie";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['clave_acceso'] = "Clave Acceso";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['enviosri'] = "Enviosri";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['fechaenvio'] = "Fechaenvio";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['uniqueid'] = "Uniqueid";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['estado'] = "Estado";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['fechaid'] = "Fechaid";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['importe_recibido'] = "Importe Recibido";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['codigoid'] = "Codigoid";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['totalsinimpuestos'] = "Total Sin Impuestos";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['totaldescuento'] = "Total Descuento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['baseimponible'] = "Base Imponible";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['valoriva'] = "Valoriva";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['importetotal'] = "Importe Total";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['idpago'] = "Idpago";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['totalpago'] = "Totalpago";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['cliente_email'] = "Cliente Email";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['idempleado'] = "Idempleado";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['idturno'] = "Idturno";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['facturaxml'] = "Facturaxml";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['facturaxml64'] = "Facturaxml 64";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['codpago_sri'] = "Codpago Sri";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['lineas'] = "lineas";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['lineas_item_total'] = "Item Total";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['lineas_producto'] = "Producto";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['lineas_quantity'] = "Quantity";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['labels']['logo'] = "logo";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_sales_comprobante_preview']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_sales_comprobante_preview']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_sales_comprobante_preview']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       $this->Pdf->Output('/data/php7.3/wwwroot/mrjoy/boletos/comprobante' . $_SESSION['uid'] . '.pdf', 'F');
...
// 
   ...
   {  
      ...
      $this->Pdf->AddPage();
      $this->Pdf_init();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['qt_col_grid']) 
      {  
          ...
          $this->totalsinimpuestos[$this->nm_grid_colunas] =  str_replace(",", ".", $this->totalsinimpuestos[$this->nm_grid_colunas]);
          ...
          $this->baseimponible[$this->nm_grid_colunas] =  str_replace(",", ".", $this->baseimponible[$this->nm_grid_colunas]);
          ...
          if (empty($this->clave_acceso[$this->nm_grid_colunas]) || $this->clave_acceso[$this->nm_grid_colunas] == "none" || $this->clave_acceso[$this->nm_grid_colunas] == "*nm*") 
          { 
          ...
          { 
              $this->clave_acceso[$this->nm_grid_colunas] = "<span class=\"scErrorLine\">" . $this->Ini->Nm_lang['lang_errm_gd'] . "</span>";
              $out_clave_acceso = "" ; 
          } 
          else   
          { 
              $out_clave_acceso = $this->Ini->path_imag_temp . "/sc_clave_acceso_" . $_SESSION['scriptcase']['sc_num_img'] . session_id() . ".png";   
              QRcode::png($this->clave_acceso[$this->nm_grid_colunas], $this->Ini->root . $out_clave_acceso, 0,1,2);
              $_SESSION['scriptcase']['sc_num_img']++;
          } 
              $this->clave_acceso[$this->nm_grid_colunas] = $this->NM_raiz_img . $out_clave_acceso;
          ...
          { 
              ...
              QRcode::png($this->uniqueid[$this->nm_grid_colunas], $this->Ini->root . $out_uniqueid, 0,1,2);
              $_SESSION['scriptcase']['sc_num_img']++;
          } 
          ...
          { 
              nmgp_Form_Num_Val($this->totalsinimpuestos[$this->nm_grid_colunas], $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "2", $_SESSION['scriptcase']['reg_conf']['monet_simb'], "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
          } 
          ...
          { 
              nmgp_Form_Num_Val($this->baseimponible[$this->nm_grid_colunas], $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "2", $_SESSION['scriptcase']['reg_conf']['monet_simb'], "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
          } 
          ...
          { 
              nmgp_Form_Num_Val($this->valoriva[$this->nm_grid_colunas], $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "2", $_SESSION['scriptcase']['reg_conf']['monet_simb'], "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
          } 
          ...
          { 
            ...
            $cell_logo = array('posx' => '33.318185416662466', 'posy' => '0', 'data' => $this->logo[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_autorizacion = array('posx' => '0.26183166666663443', 'posy' => '6.5667995833325055', 'data' => $this->clave_acceso[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '7', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_datesales = array('posx' => '0.5291666666666', 'posy' => '0.48947916666660535', 'data' => $this->datesales[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '7', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_serie = array('posx' => '0', 'posy' => '14.794626874998137', 'data' => $this->serie[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '7', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_idcliente = array('posx' => '0', 'posy' => '19.133872916664252', 'data' => $this->idcliente[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '7', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_cliente = array('posx' => '0', 'posy' => '23.838958333330325', 'data' => $this->cliente[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '7', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_direccion = array('posx' => '0', 'posy' => '28.808627083329704', 'data' => $this->direccion[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '7', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_telefono = array('posx' => '44.4499999999944', 'posy' => '19.486562499997543', 'data' => $this->telefono[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '7', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_cliente_email = array('posx' => '0', 'posy' => '33.3374999999958', 'data' => $this->cliente_email[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '7', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_lineas_quantity = array('posx' => '0.26183166666663443', 'posy' => '45.19586041666096', 'data' => $this->lineas_quantity[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '8', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            $cell_lineas_item_total = array('posx' => '55', 'posy' => '45.19586041666096', 'data' => $this->lineas_item_total[$this->nm_grid_colunas], 'width'      => '3', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '8', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            $cell_lineas_producto = array('posx' => '7.632488333332371', 'posy' => '45.19586041666096', 'data' => $this->lineas_producto[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '7', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            $cell_total_label = array('posx' => '0', 'posy' => '90', 'data' => $this->SC_conv_utf8('TOTAL:'), 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '9', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            $cell_valoriva = array('posx' => '55', 'posy' => '83.37867499998949', 'data' => $this->valoriva[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '8', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_subtotal = array('posx' => '55', 'posy' => '76.19629583332372', 'data' => $this->totalsinimpuestos[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '8', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_importeTotal = array('posx' => '55', 'posy' => '90.2633979166553', 'data' => $this->importetotal[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '8', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            ...
            if (isset($cell_autorizacion['data']) && !empty($cell_autorizacion['data']) && is_file($cell_autorizacion['data']))
            {
                $Finfo_img = finfo_open(FILEINFO_MIME_TYPE);
                $Tipo_img  = finfo_file($Finfo_img, $cell_autorizacion['data']);
                finfo_close($Finfo_img);
                if (substr($Tipo_img, 0, 5) == "image")
                {
                    $this->Pdf->Image($cell_autorizacion['data'], $cell_autorizacion['posx'], $cell_autorizacion['posy'], 0, 0);
                }
            }
            ...
            $this->Pdf->SetY(45.19586041666096);
 ...
 function grid_saida_html()
 {
   ...
   echo "<HEAD>\r\n";
   echo " <TITLE>" . $this->Ini->Nm_lang['lang_othr_chart_title'] . " sales</TITLE>\r\n";
   ...
   echo "                  action=\"pdfreport_sales_comprobante_preview_fim.php\"\r\n"; 
   echo "                  target=\"_self\">\r\n"; 
   ...
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0, $opc="")
   {
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['iframe_print']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_preview']['iframe_print'] )
      {
          $target = "_parent";
      }
   ?>
