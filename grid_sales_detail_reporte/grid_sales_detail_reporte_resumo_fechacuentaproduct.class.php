...
class grid_sales_detail_reporte_resumo
{
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['summarizing_fields_order']['fechacuentaproduct']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['summarizing_fields_order']['fechacuentaproduct'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['summarizing_fields_order']['fechacuentaproduct'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['summarizing_fields_display']['fechacuentaproduct'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['summarizing_fields_display']['fechacuentaproduct'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['summarizing_fields_display']['fechacuentaproduct'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['summarizing_fields_display']['fechacuentaproduct'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['summarizing_fields_display']['fechacuentaproduct'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['summarizing_fields_display']['fechacuentaproduct'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['summarizing_fields_display']['fechacuentaproduct'] as $i_sum => $d_sum)
           {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_fechacuentaproduct("res");
