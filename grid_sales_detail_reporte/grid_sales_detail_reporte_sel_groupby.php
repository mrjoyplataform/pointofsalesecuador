<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_sales_detail_reporte']['glo_nm_path_imag_temp'] . "/sc_apl_default_pointofsales.txt"))
       {
?>
...
<?php
   ...
   $Sel_Groupby = new grid_sales_detail_reporte_sel_Groupby(); 
   $Sel_Groupby->Sel_Groupby_init();
   
class grid_sales_detail_reporte_sel_Groupby
{
function Sel_Groupby_init()
{
   ...
   if ($this->restore) {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['dados_orig_gb']['all']['SC_Ind_Groupby'];
   }
   else {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['SC_Ind_Groupby'];
   }
...
function Sel_processa_out($sel_groupby)
{
   ...
   {
       if (count($campos_sel) != count($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['SC_Gb_Free_cmp']))
       {
       ...
       {
          $Arr_temp = array();
           foreach ($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['SC_Gb_Free_cmp'] as $Cada_cmp => $Resto)
           {
               $Arr_temp[] = $Cada_cmp;
           }
   ...
   {
       $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['SC_Ind_Groupby']     = $sel_groupby;
       $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['contr_array_resumo'] = "NAO";
       $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['contr_total_geral']  = "NAO";
       unset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['ordem_quebra']);
       unset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['ordem_select']);
       unset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['tot_geral']);
       unset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['Page_break_PDF']);
       unset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['arr_total']);
       unset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['pivot_group_by']);
       unset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['pivot_x_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['pivot_y_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['pivot_fill']);
       unset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['pivot_order']);
       unset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['pivot_order_col']);
       unset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['pivot_order_level']);
       unset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['pivot_order_sort']);
       unset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['pivot_order_start']);
       unset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['pivot_tabular']);
           $tab_arr_groubby_cmp = array();
           $tab_arr_groubby_sql = array();
           $tab_arr_groubby_cmp['fechatrans'] = array('cmp' => "fechatrans", 'ind' => 0, 'format' => "YYYYMMDD2");
           $tab_arr_groubby_cmp['cuentaventa'] = array('cmp' => "cuentaventa", 'ind' => 1, 'format' => "");
           $tab_arr_groubby_cmp['producto'] = array('cmp' => "producto", 'ind' => 2, 'format' => "");
           $tab_arr_groubby_sql[0] = array('cmp' => "fechatrans", 'ord' => 'asc');
           $tab_arr_groubby_sql[1] = array('cmp' => "cuentaventa", 'ord' => 'asc');
           $tab_arr_groubby_sql[2] = array('cmp' => "producto", 'ord' => 'asc');
           $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['SC_Gb_Free_cmp']  = array();
           $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['SC_Gb_Free_sql']  = array();
           $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['SC_Gb_date_format']['sc_free_group_by'] = array();
           $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['SC_Gb_Free_orig'] = array();
           foreach ($campos_sel as $cada_cmp)
           {
               if (!empty($cada_cmp))
               {
                   $ind = $tab_arr_groubby_cmp[$cada_cmp]['ind'];
                   $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['SC_Gb_Free_cmp'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['cmp'];
                   $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['SC_Gb_Free_sql'][$cada_cmp][$tab_arr_groubby_sql[$ind]['cmp']] = $tab_arr_groubby_sql[$ind]['ord'];
                   $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['SC_Gb_date_format']['sc_free_group_by'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['format'];
               }
           }
   }
   if ($sel_groupby == "sc_free_group_by")
   {
       ...
       $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['pivot_x_axys'] = $xaxys_list;
       $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['pivot_y_axys'] = $yaxys_list;
   }
   if ($opc_ret == "resumo" && !empty($this->summ_fields))
   {
       $summ_fields = explode("@?@", $this->summ_fields);
       if(isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['summarizing_fields_display'][ $sel_groupby ]))
       {
           foreach ($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['summarizing_fields_display'][ $sel_groupby ] as $i_sum => $d_sum)
           {
               $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['summarizing_fields_display'][ $sel_groupby ][$i_sum]['display'] = in_array($i_sum, $summ_fields);
           }
       }
       $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['summarizing_fields_order'][ $sel_groupby ] = $summ_fields;
       $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['summarizing_drill_down'] = $this->drill_down;
   }
?>
    <script language="javascript"> 
<?php
...
function Sel_processa_form()
{
   ...
   $arr_campos_free['fechatrans'] = "" . sprintf("" . $this->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", "Fechatrans") . "";
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> sales_detail</TITLE>
...
?>
 <script language="javascript" type="text/javascript">
  function scSubmitGroupBy(sPos) {
   $.ajax({
    type: "POST",
    url: "grid_sales_detail_reporte_sel_groupby.php",
    data: {
...
<?php
if ($this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['dados_orig_gb']['res']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['dados_orig_gb']['res']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
...
elseif (!$this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
        if(is_array($_arr_fields))
        {
            foreach ($_arr_fields as $_key_total => $d_field)
...
{
  $max_height = 1;
  if ($this->restore && isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['dados_orig_gb']['res']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['dados_orig_gb']['res']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
  ...
  elseif (!$this->restore && isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
      if (count($_i_sum) > $max_height)
      {
          $max_height = count($_i_sum);
...
<?php
if ($bSummaryPage && $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['SC_Ind_Groupby'] == "sc_free_group_by") {
?>
   if (fieldList == "") {
...
<?php
    ...
    $iTabCount            = 1;
    foreach ($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['SC_All_Groupby'] as $QB => $Tp)
    {
        if (!in_array($QB, $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['SC_Groupby_hide']))
        {
...
<?php
     if (!in_array("consolidadoy", $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['SC_Groupby_hide']))
     {
         $this->static_gb_ok = "sc_id_sel_groupby_consolidadoy";
        if ($groupby_atual == "consolidadoy")
        {
            $check = " checked";
            $bStartFree = false;
            $this->static_gb_ok = "sc_id_sel_groupby_consolidadoy";
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();change_actual_static("sc_id_sel_groupby_consolidadoy");display_btn_restore_gb();' name="sel_groupby" value="consolidadoy" id="sc_id_sel_groupby_consolidadoy"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_consolidadoy">
        Resumen consolidado Y
<?php
    $prep_labels = array();
...
?>
<?php
     if (!in_array("consolidado", $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['SC_Groupby_hide']))
     {
        if ($groupby_atual == "consolidado")
        {
            $check = " checked";
            $bStartFree = false;
            $this->static_gb_ok = "sc_id_sel_groupby_consolidado";
        }
        else
        {
            $check = "";
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();change_actual_static("sc_id_sel_groupby_consolidado");display_btn_restore_gb();' name="sel_groupby" value="consolidado" id="sc_id_sel_groupby_consolidado"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_consolidado">
        Resumen consolidado X
<?php
    $prep_labels = array();
    $prep_labels[] = "Cuentaventa";
    $prep_labels[] = "Producto";
...
?>
<?php
     if (!in_array("fechatrans_cuentaventa_producto", $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['SC_Groupby_hide']))
     {
        if ($groupby_atual == "fechatrans_cuentaventa_producto")
        {
            $check = " checked";
            $bStartFree = false;
            $this->static_gb_ok = "sc_id_sel_groupby_fechatrans_cuentaventa_producto";
        }
        else
        {
            $check = "";
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();change_actual_static("sc_id_sel_groupby_fechatrans_cuentaventa_producto");display_btn_restore_gb();' name="sel_groupby" value="fechatrans_cuentaventa_producto" id="sc_id_sel_groupby_fechatrans_cuentaventa_producto"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_fechatrans_cuentaventa_producto">
        Valor por dias
<?php
    $prep_labels = array();
...
?>
<?php
     if (!in_array("fechacuentaproduct", $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['SC_Groupby_hide']))
     {
        if ($groupby_atual == "fechacuentaproduct")
        {
            $check = " checked";
            $bStartFree = false;
            $this->static_gb_ok = "sc_id_sel_groupby_fechacuentaproduct";
        }
        else
        {
            $check = "";
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();change_actual_static("sc_id_sel_groupby_fechacuentaproduct");display_btn_restore_gb();' name="sel_groupby" value="fechacuentaproduct" id="sc_id_sel_groupby_fechacuentaproduct"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_fechacuentaproduct">
        Cantidad por dias
<?php
    $prep_labels = array();
    $prep_labels[] = sprintf("" . $this->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", "Fechatrans");
...
?>
  <td>
<?php
     if (!in_array("sc_free_group_by", $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['SC_Groupby_hide']))
     {
...
<?php
        ...
        $arr_tmp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] : $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['SC_Gb_Free_cmp'];
...
<?php
        ...
        {
            if ($this->restore) {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['dados_orig_gb']['res']['pivot_x_axys']);
            }
            else {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['pivot_x_axys']);
            }
        }
...
<?php
        if ($bSummaryPage)
        {
            ...
            {
                $arr_pivot_x_axys = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['dados_orig_gb']['res']['pivot_x_axys'] : $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['pivot_x_axys'];
...
<?php
   ...
   if ($bSummaryPage)
   {
       ...
       if (!isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['summarizing_fields_control'])) {
           $arr_filds = array();
       }
       else {
           $arr_filds = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['dados_orig_gb']['res']['summarizing_fields_control'] : $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['summarizing_fields_control'];
       }
    if (isset($arr_filds))
    {
?>
...
<?php
          if (!isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['summarizing_fields_display'])) {
              $arr_disp = array();
          }
          else {
                 $arr_disp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['dados_orig_gb']['res']['summarizing_fields_display'] : $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['summarizing_fields_display'];
          }
          if (!isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['summarizing_fields_order'])) {
              $arr_ord = array();
          }
          else {
              $arr_ord  = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['dados_orig_gb']['res']['summarizing_fields_order']   : $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['summarizing_fields_order'];
          }
...
<script type="text/javascript">
   ...
   if ($this->restore) {
       $oJson = new Services_JSON();
        ob_end_clean();
        if ($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['dados_orig_gb']['all']['SC_Ind_Groupby'] == "sc_free_group_by") {
           $this->Arr_result['run_js'][] = "scShowFree()";
        } else {
           $this->Arr_result['set_var'][] = array('var' => 'actual_static_gb', 'value' => $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['dados_orig_gb']['all']['SC_Ind_Groupby']);
...
<?php
   $disp_rest = "none";
   foreach ($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['dados_orig_gb'] as $tp => $fields) {
       foreach ($fields as $name => $data) {
           if (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte'][$name])) {
               if ($tp == "all" && ($name != "SC_Gb_Free_cmp" || $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte']['SC_Ind_Groupby'] == "sc_free_group_by")) {
                   if ($data != $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte'][$name]) {
                       $disp_rest = "";
                       break;
                   }
               }
               elseif ($tp == "res" && $bSummaryPage && $data != $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte'][$name]) {
                   $disp_rest = "";
                   break;
               }
           }
