...
class grid_sales_detail_reporte_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_sales_detail_reporte']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_sales_detail_reporte']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['contr_total_geral'] == "OK")
      {
          $this->array_total_fechatrans = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['arr_total']['fechatrans'];
          $this->array_total_cuentaventa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['arr_total']['cuentaventa'];
          $this->array_total_producto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['arr_total']['producto'];
      }
      else
      {
          $this->array_total_fechatrans = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['tot_geral'][3];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['arr_total']['fechatrans'] = $this->array_total_fechatrans;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['arr_total']['cuentaventa'] = $this->array_total_cuentaventa;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['arr_total']['producto'] = $this->array_total_producto;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['json_use_label'])
       {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['fechatrans'] = $Lab_fechatrans; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['cuentaventa'] = $Lab_cuentaventa; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['producto'] = $Lab_producto; 

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['id_sales']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['id_sales'] = "Id Sales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['fechatrans']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['fechatrans'] = "Fechatrans"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['codproducto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['codproducto'] = "Codproducto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['producto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['producto'] = "Producto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['quantity']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['quantity'] = "Quantity"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['item_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['item_total'] = "Item Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['valor_siniva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['valor_siniva'] = "Valor Siniva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['valor_unitario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['valor_unitario'] = "Valor Unitario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['cuentaventa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['cuentaventa'] = "Cuentaventa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['idcaja']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['idcaja'] = "Idcaja"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['factura']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['factura'] = "Factura"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['uniqueid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['uniqueid'] = "Uniqueid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['entrada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['entrada'] = "Entrada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['jugador']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['jugador'] = "Jugador"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['visitante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['visitante'] = "Visitante"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['tarjeta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['tarjeta'] = "Tarjeta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['tokens']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['tokens'] = "Tokens"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['minutos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['minutos'] = "Minutos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['comida']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['comida'] = "Comida"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['tarjetarfid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['tarjetarfid'] = "Tarjetarfid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['rfid_pulsera']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['rfid_pulsera'] = "Rfid Pulsera"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['id_sales_detail']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['id_sales_detail'] = "Id Sales Detail"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['unit_cost']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['unit_cost'] = "Unit Cost"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['unit_value']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['unit_value'] = "Unit Value"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['discount']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['discount'] = "Discount"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['id_product']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['id_product'] = "Id Product"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['uniqueidtrans']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['uniqueidtrans'] = "Uniqueidtrans"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['labels']['estado'] = "Estado"; 
       }
       //-----
       $this->comp_field_nm = array(
           'fechatrans' => 0,
       ...
       //-----
       $this->comp_sum = array(
           2 => "Item Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['summarizing_fields_order']['fechatrans_cuentaventa_producto']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['summarizing_fields_order']['fechatrans_cuentaventa_producto'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['summarizing_fields_order']['fechatrans_cuentaventa_producto'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['summarizing_fields_display']['fechatrans_cuentaventa_producto'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['summarizing_fields_display']['fechatrans_cuentaventa_producto'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['summarizing_fields_display']['fechatrans_cuentaventa_producto'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['summarizing_fields_display']['fechatrans_cuentaventa_producto'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['summarizing_fields_display']['fechatrans_cuentaventa_producto'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['summarizing_fields_display']['fechatrans_cuentaventa_producto'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['summarizing_fields_display']['fechatrans_cuentaventa_producto'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "item_total", 'show' => true),
           3 => array('field' => "quantity", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_item_total_sum",
           3 => "css_quantity_sum",
       );
       ...
       foreach ($this->array_total_fechatrans as $i_fechatrans => $d_fechatrans) {
           ...
           foreach ($this->array_total_cuentaventa[$i_fechatrans] as $i_cuentaventa => $d_cuentaventa) {
               if (!in_array($i_cuentaventa, $this->comp_label[1][ $d_fechatrans[4] ], true)) {
                   $this->comp_index[1][ $d_cuentaventa[4] ] = $d_cuentaventa[3];
                   $this->comp_label[1][ $d_fechatrans[4] ][ $d_cuentaventa[4] ] = $d_cuentaventa[3];
               }
               foreach ($this->array_total_producto[$i_fechatrans][$i_cuentaventa] as $i_producto => $d_producto) {
                   if (!in_array($i_producto, $this->comp_label[2][ $d_fechatrans[4] ][ $d_cuentaventa[4] ], true)) {
                       $this->comp_index[2][ $d_producto[4] ] = $d_producto[3];
                       $this->comp_label[2][ $d_fechatrans[4] ][ $d_cuentaventa[4] ][ $d_producto[4] ] = $d_producto[3];
                   }
               }
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_tabular_label'];
       ...
       foreach ($this->comp_label[0] as $i_fechatrans => $l_fechatrans) {
           ...
           foreach ($this->comp_label[1][$i_fechatrans] as $i_cuentaventa => $l_cuentaventa) {
               if (isset($this->array_total_cuentaventa[$i_fechatrans][$i_cuentaventa])) {
                   $this->comp_group[$i_fechatrans][$i_cuentaventa] = array();
               }
               foreach ($this->comp_label[2][$i_fechatrans][$i_cuentaventa] as $i_producto => $l_producto) {
                   if (isset($this->array_total_producto[$i_fechatrans][$i_cuentaventa][$i_producto])) {
                       $this->comp_group[$i_fechatrans][$i_cuentaventa][$i_producto] = array();
                   }
               }
           }
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_sales_detail_reporte@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_sales_detail_reporte_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_sales_detail_reporte_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_sales_detail_reporte_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_fechatrans_cuentaventa_producto("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_sales_detail_reporte/grid_sales_detail_reporte_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_sales_detail_reporte_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_sales_detail_reporte_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_sales_detail_reporte_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['num_css'] . '.css');
     ...
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_sales_detail_reporte/grid_sales_detail_reporte_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_sales_detail_reporte/grid_sales_detail_reporte_config_graf_flash.php?nome_apl=grid_sales_detail_reporte&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_sales_detail_reporte_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_sales_detail_reporte']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_sales_detail_reporte']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_sales_detail_reporte_config_pivot.php?nome_apl=grid_sales_detail_reporte&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_sales_detail_reporte_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_sales_detail_reporte/grid_sales_detail_reporte_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   //---- 
   function adiciona_registro($sum_quantity, $sum_item_total, $quebra_fechatrans, $quebra_cuentaventa, $quebra_producto, $quebra_fechatrans_orig, $quebra_cuentaventa_orig, $quebra_producto_orig)
   {
      ...
      if (!isset($this->array_total_fechatrans[$quebra_fechatrans_orig]))
      {
         ...
         $this->array_total_fechatrans[$quebra_fechatrans_orig][2] = $sum_item_total;
      ...
      else
      {
         ...
         $this->array_total_fechatrans[$quebra_fechatrans_orig][2] = bcadd($this->array_total_fechatrans[$quebra_fechatrans_orig][2], $sum_item_total, 10);
      }
      //----- Cuentaventa
      if (!isset($this->array_total_cuentaventa[$quebra_fechatrans_orig][$quebra_cuentaventa_orig]))
      {
         $this->array_total_cuentaventa[$quebra_fechatrans_orig][$quebra_cuentaventa_orig][0] = 1;
         $this->array_total_cuentaventa[$quebra_fechatrans_orig][$quebra_cuentaventa_orig][1] = $sum_quantity;
         $this->array_total_cuentaventa[$quebra_fechatrans_orig][$quebra_cuentaventa_orig][2] = $sum_item_total;
         $this->array_total_cuentaventa[$quebra_fechatrans_orig][$quebra_cuentaventa_orig][3] = $quebra_cuentaventa;
         $this->array_total_cuentaventa[$quebra_fechatrans_orig][$quebra_cuentaventa_orig][4] = $quebra_cuentaventa_orig;
      }
      else
      {
         $this->array_total_cuentaventa[$quebra_fechatrans_orig][$quebra_cuentaventa_orig][0]++;
         $this->array_total_cuentaventa[$quebra_fechatrans_orig][$quebra_cuentaventa_orig][1] = bcadd($this->array_total_cuentaventa[$quebra_fechatrans_orig][$quebra_cuentaventa_orig][1], $sum_quantity, 10);
         $this->array_total_cuentaventa[$quebra_fechatrans_orig][$quebra_cuentaventa_orig][2] = bcadd($this->array_total_cuentaventa[$quebra_fechatrans_orig][$quebra_cuentaventa_orig][2], $sum_item_total, 10);
      }
      //----- Producto
      if (!isset($this->array_total_producto[$quebra_fechatrans_orig][$quebra_cuentaventa_orig][$quebra_producto_orig]))
      {
         $this->array_total_producto[$quebra_fechatrans_orig][$quebra_cuentaventa_orig][$quebra_producto_orig][0] = 1;
         $this->array_total_producto[$quebra_fechatrans_orig][$quebra_cuentaventa_orig][$quebra_producto_orig][1] = $sum_quantity;
         $this->array_total_producto[$quebra_fechatrans_orig][$quebra_cuentaventa_orig][$quebra_producto_orig][2] = $sum_item_total;
         $this->array_total_producto[$quebra_fechatrans_orig][$quebra_cuentaventa_orig][$quebra_producto_orig][3] = $quebra_producto;
         $this->array_total_producto[$quebra_fechatrans_orig][$quebra_cuentaventa_orig][$quebra_producto_orig][4] = $quebra_producto_orig;
      }
      else
      {
         $this->array_total_producto[$quebra_fechatrans_orig][$quebra_cuentaventa_orig][$quebra_producto_orig][0]++;
         $this->array_total_producto[$quebra_fechatrans_orig][$quebra_cuentaventa_orig][$quebra_producto_orig][1] = bcadd($this->array_total_producto[$quebra_fechatrans_orig][$quebra_cuentaventa_orig][$quebra_producto_orig][1], $sum_quantity, 10);
         $this->array_total_producto[$quebra_fechatrans_orig][$quebra_cuentaventa_orig][$quebra_producto_orig][2] = bcadd($this->array_total_producto[$quebra_fechatrans_orig][$quebra_cuentaventa_orig][$quebra_producto_orig][2], $sum_item_total, 10);
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->quantity, $this->item_total, $this->fechatrans, $this->cuentaventa, $this->producto, $this->fechatrans_orig,  $this->cuentaventa_orig,  $this->producto_orig);
            }
   }
//
