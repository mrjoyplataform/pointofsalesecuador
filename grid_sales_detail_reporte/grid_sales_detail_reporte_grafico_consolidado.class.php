...
<?php
   ...
   function inicializa_vars()
   {
      ...
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['contr_label_graf']['cuentaventa'];
      }
      $this->label[1] = "Producto";
      ...
      {
         $this->label[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte']['contr_label_graf']['producto'];
      }
   }
