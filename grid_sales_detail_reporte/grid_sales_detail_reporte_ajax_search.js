...
Table_sv_fil[0] = "fechatrans";
Table_sv_fil[1] = "producto";
Table_sv_fil[2] = "id_product";
function ajax_select_filter(parm)
{
    ...
    $.ajax({
     ...
     .done(function(json_sel_fil) {
        ...
        if ($("#SC_fechatrans_cond") && search_get_sel_txt("SC_fechatrans_cond").substring(0, 3) == "bi_") {
            formata_bi_fechatrans(search_get_sel_txt("SC_fechatrans_cond"), SC_fechatrans_bi_opc, SC_fechatrans_bi_dt);
        }
