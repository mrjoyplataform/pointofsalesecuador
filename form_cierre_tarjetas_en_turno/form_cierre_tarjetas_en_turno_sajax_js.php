  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cierre_tarjetas_en_turno" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cierre_tarjetas_en_turno_form();
	}
...
?>
  ...
  // ---------- Validate idtarjetac_
  function do_ajax_form_cierre_tarjetas_en_turno_validate_idtarjetac_(iNumLinha)
  {
    var nomeCampo_idtarjetac_ = "idtarjetac_" + iNumLinha;
    var var_idtarjetac_ = scAjaxGetFieldText(nomeCampo_idtarjetac_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_tarjetas_en_turno_validate_idtarjetac_(var_idtarjetac_, iNumLinha, var_script_case_init, do_ajax_form_cierre_tarjetas_en_turno_validate_idtarjetac__cb);
  } // do_ajax_form_cierre_tarjetas_en_turno_validate_idtarjetac_

  function do_ajax_form_cierre_tarjetas_en_turno_validate_idtarjetac__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idtarjetac_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idtarjetac_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idtarjetac_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idtarjetac_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_tarjetas_en_turno_validate_idtarjetac__cb

  // ---------- Validate lote_
  function do_ajax_form_cierre_tarjetas_en_turno_validate_lote_(iNumLinha)
  {
    var nomeCampo_lote_ = "lote_" + iNumLinha;
    var var_lote_ = scAjaxGetFieldText(nomeCampo_lote_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_tarjetas_en_turno_validate_lote_(var_lote_, iNumLinha, var_script_case_init, do_ajax_form_cierre_tarjetas_en_turno_validate_lote__cb);
  } // do_ajax_form_cierre_tarjetas_en_turno_validate_lote_

  function do_ajax_form_cierre_tarjetas_en_turno_validate_lote__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_tarjetas_en_turno_validate_lote__cb

  // ---------- Validate voucher_
  function do_ajax_form_cierre_tarjetas_en_turno_validate_voucher_(iNumLinha)
  {
    var nomeCampo_voucher_ = "voucher_" + iNumLinha;
    var var_voucher_ = scAjaxGetFieldText(nomeCampo_voucher_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_tarjetas_en_turno_validate_voucher_(var_voucher_, iNumLinha, var_script_case_init, do_ajax_form_cierre_tarjetas_en_turno_validate_voucher__cb);
  } // do_ajax_form_cierre_tarjetas_en_turno_validate_voucher_

  function do_ajax_form_cierre_tarjetas_en_turno_validate_voucher__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "voucher_" + iLineNumber;
    }
    else
    {
      sFieldValid = "voucher_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "voucher_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "voucher_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_tarjetas_en_turno_validate_voucher__cb

  // ---------- Validate valor_
  function do_ajax_form_cierre_tarjetas_en_turno_validate_valor_(iNumLinha)
  {
    var nomeCampo_valor_ = "valor_" + iNumLinha;
    var var_valor_ = scAjaxGetFieldText(nomeCampo_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_tarjetas_en_turno_validate_valor_(var_valor_, iNumLinha, var_script_case_init, do_ajax_form_cierre_tarjetas_en_turno_validate_valor__cb);
  } // do_ajax_form_cierre_tarjetas_en_turno_validate_valor_

  function do_ajax_form_cierre_tarjetas_en_turno_validate_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_tarjetas_en_turno_validate_valor__cb

  // ---------- Validate idturno_
  function do_ajax_form_cierre_tarjetas_en_turno_validate_idturno_(iNumLinha)
  {
    var nomeCampo_idturno_ = "idturno_" + iNumLinha;
    var var_idturno_ = scAjaxGetFieldText(nomeCampo_idturno_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_tarjetas_en_turno_validate_idturno_(var_idturno_, iNumLinha, var_script_case_init, do_ajax_form_cierre_tarjetas_en_turno_validate_idturno__cb);
  } // do_ajax_form_cierre_tarjetas_en_turno_validate_idturno_

  function do_ajax_form_cierre_tarjetas_en_turno_validate_idturno__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idturno_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idturno_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idturno_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idturno_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_tarjetas_en_turno_validate_idturno__cb

  // ---------- Validate fecha_
  function do_ajax_form_cierre_tarjetas_en_turno_validate_fecha_(iNumLinha)
  {
    var nomeCampo_fecha_ = "fecha_" + iNumLinha;
    var var_fecha_ = scAjaxGetFieldText(nomeCampo_fecha_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_tarjetas_en_turno_validate_fecha_(var_fecha_, iNumLinha, var_script_case_init, do_ajax_form_cierre_tarjetas_en_turno_validate_fecha__cb);
  } // do_ajax_form_cierre_tarjetas_en_turno_validate_fecha_

  function do_ajax_form_cierre_tarjetas_en_turno_validate_fecha__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_tarjetas_en_turno_validate_fecha__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_cierre_tarjetas_en_turno_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_cierre_tarjetas_en_turno_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cierre_tarjetas_en_turno_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_cierre_tarjetas_en_turno_add_new_line_cb);
  } // do_ajax_form_cierre_tarjetas_en_turno_add_new_line

  function do_ajax_form_cierre_tarjetas_en_turno_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_cierre_tarjetas_en_turno_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_cierre_tarjetas_en_turno_backup_line(iNumLinha)
  {
    var var_idturno_ = scAjaxGetFieldText("idturno_" + iNumLinha);
    var var_fecha_ = scAjaxGetFieldText("fecha_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_tarjetas_en_turno_backup_line(var_idturno_, var_fecha_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_cierre_tarjetas_en_turno_backup_line_cb);
  } // do_ajax_form_cierre_tarjetas_en_turno_backup_line

  function do_ajax_form_cierre_tarjetas_en_turno_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_cierre_tarjetas_en_turno_backup_line_cb

  function do_ajax_form_cierre_tarjetas_en_turno_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_cierre_tarjetas_en_turno_cancel_insert

  function do_ajax_form_cierre_tarjetas_en_turno_cancel_update(iSeqVert)
  {
    do_ajax_form_cierre_tarjetas_en_turno_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_cierre_tarjetas_en_turno_cancel_update

  function do_ajax_form_cierre_tarjetas_en_turno_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_cierre_tarjetas_en_turno_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_cierre_tarjetas_en_turno_table_refresh()
  {
    var var_idturno_ = document.F2.idturno_.value;
    var var_fecha_ = document.F2.fecha_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_cierre_tarjetas_en_turno_table_refresh(var_idturno_, var_fecha_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cierre_tarjetas_en_turno_table_refresh_cb);
  } //  do_ajax_form_cierre_tarjetas_en_turno_table_refresh

  function do_ajax_form_cierre_tarjetas_en_turno_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idturno_.value = scAjaxGetKeyValue("idturno_");
    document.F2.fecha_.value = scAjaxGetKeyValue("fecha_");
    ...
    scAjaxAlert(do_ajax_form_cierre_tarjetas_en_turno_table_refresh_cb_after_alert);
  } // do_ajax_form_cierre_tarjetas_en_turno_table_refresh_cb
  function do_ajax_form_cierre_tarjetas_en_turno_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("b");
    sc_insert_open = false;
  } // do_ajax_form_cierre_tarjetas_en_turno_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_cierre_tarjetas_en_turno_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_cierre_tarjetas_en_turno_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_idtarjetac_ = scAjaxGetFieldText("idtarjetac_" + iNumLinha);
    var var_lote_ = scAjaxGetFieldText("lote_" + iNumLinha);
    var var_voucher_ = scAjaxGetFieldText("voucher_" + iNumLinha);
...
?>
    x_ajax_form_cierre_tarjetas_en_turno_submit_form(var_idtarjetac_, var_lote_, var_voucher_, var_valor_, var_idturno_, var_fecha_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_cierre_tarjetas_en_turno_submit_form_cb);
  } // do_ajax_form_cierre_tarjetas_en_turno_submit_form

  function do_ajax_form_cierre_tarjetas_en_turno_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idtarjetac_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("lote_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("voucher_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("valor_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idturno_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cierre_tarjetas_en_turno_submit_form_cb_after_alert);
  } // do_ajax_form_cierre_tarjetas_en_turno_submit_form_cb
  function do_ajax_form_cierre_tarjetas_en_turno_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cierre_tarjetas_en_turno_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cierre_tarjetas_en_turno_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_cierre_tarjetas_en_turno_navigate_form, function() {});
    } else {
      perform_ajax_form_cierre_tarjetas_en_turno_navigate_form();
    }
  }

  function perform_ajax_form_cierre_tarjetas_en_turno_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_cierre_tarjetas_en_turno_cancel_insert(sc_form_cierre_tarjetas_en_turno_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idtarjetac_" + iNavForm);
      scAjaxHideErrorDisplay("lote_" + iNavForm);
      scAjaxHideErrorDisplay("voucher_" + iNavForm);
      scAjaxHideErrorDisplay("valor_" + iNavForm);
      scAjaxHideErrorDisplay("idturno_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cierre_tarjetas_en_turno_navigate_form(var_idturno_, var_fecha_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cierre_tarjetas_en_turno_navigate_form_cb);
  } // do_ajax_form_cierre_tarjetas_en_turno_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cierre_tarjetas_en_turno']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cierre_tarjetas_en_turno_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idturno_.value = scAjaxGetKeyValue("idturno_" + var_last_index);
    document.F2.fecha_.value = scAjaxGetKeyValue("fecha_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cierre_tarjetas_en_turno_navigate_form_cb_after_alert);
  } // do_ajax_form_cierre_tarjetas_en_turno_navigate_form_cb
  function do_ajax_form_cierre_tarjetas_en_turno_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_cierre_tarjetas_en_turno_navigate_form_cb_after_alert

    function sc_form_cierre_tarjetas_en_turno_get_last_line_number()
    {
    ...
    } //sc_form_cierre_tarjetas_en_turno_get_last_line_number

  function sc_hide_form_cierre_tarjetas_en_turno_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idtarjetac_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "lote_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "voucher_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "valor_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idturno_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fecha_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idtarjetac_" + iNumLinha] = {"label": "Idtarjetac<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["voucher_" + iNumLinha] = {"label": "Voucher<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["idturno_" + iNumLinha] = {"label": "Idturno<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fecha_" + iNumLinha] = {"label": "Fecha<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idtarjetac_"][iNumLinha] = "idtarjetac_" + iNumLinha;
    ajax_field_mult["lote_"][iNumLinha] = "lote_" + iNumLinha;
    ajax_field_mult["voucher_"][iNumLinha] = "voucher_" + iNumLinha;
    ajax_field_mult["valor_"][iNumLinha] = "valor_" + iNumLinha;
    ajax_field_mult["idturno_"][iNumLinha] = "idturno_" + iNumLinha;
    ajax_field_mult["fecha_"][iNumLinha] = "fecha_" + iNumLinha;
    ajax_field_id["idtarjetac_" + iNumLinha] = new Array("hidden_field_label_idtarjetac_", "hidden_field_data_idtarjetac_" + iNumLinha);
    ajax_field_id["lote_" + iNumLinha] = new Array("hidden_field_label_lote_", "hidden_field_data_lote_" + iNumLinha);
    ajax_field_id["voucher_" + iNumLinha] = new Array("hidden_field_label_voucher_", "hidden_field_data_voucher_" + iNumLinha);
    ajax_field_id["valor_" + iNumLinha] = new Array("hidden_field_label_valor_", "hidden_field_data_valor_" + iNumLinha);
    ajax_error_count["idtarjetac_" + iNumLinha] = "off";
    ajax_error_count["lote_" + iNumLinha] = "off";
    ajax_error_count["voucher_" + iNumLinha] = "off";
    ajax_error_count["valor_" + iNumLinha] = "off";
    ajax_error_count["idturno_" + iNumLinha] = "off";
    ajax_error_count["fecha_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idtarjetac_" + iNumLinha] = "off";
    ajax_read_only["lote_" + iNumLinha] = "off";
    ajax_read_only["voucher_" + iNumLinha] = "off";
    ajax_read_only["valor_" + iNumLinha] = "off";
    ajax_read_only["idturno_" + iNumLinha] = "on";
...
{
?>
    ajax_read_only["idtarjetac_" + iNumLinha] = "on";
    ajax_read_only["lote_" + iNumLinha] = "on";
    ajax_read_only["voucher_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["idtarjetac_" + iNumLinha] = null;
    ajax_error_list["lote_" + iNumLinha] = null;
    ajax_error_list["voucher_" + iNumLinha] = null;
    ajax_error_list["valor_" + iNumLinha] = null;
    ajax_error_list["idturno_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idtarjetac_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idtarjetac_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idtarjetac_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idtarjetac_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idtarjetac_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["voucher_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["voucher_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["voucher_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["voucher_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["voucher_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["idturno_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idturno_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idturno_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idturno_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idturno_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idtarjetac_'])) ? $this->nmgp_cmp_readonly['idtarjetac_'] : 'off';
?>
    scAjaxFieldRead("idtarjetac_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['voucher_'])) ? $this->nmgp_cmp_readonly['voucher_'] : 'off';
?>
    scAjaxFieldRead("voucher_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idturno_'])) ? $this->nmgp_cmp_readonly['idturno_'] : 'on';
?>
    scAjaxFieldRead("idturno_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fecha_'])) ? $this->nmgp_cmp_readonly['fecha_'] : 'on';
?>
  ...
  {
    scAjaxFieldRead("idtarjetac_" + iSeq, "on");
    scAjaxFieldRead("lote_" + iSeq, "on");
    scAjaxFieldRead("voucher_" + iSeq, "on");
    scAjaxFieldRead("valor_" + iSeq, "on");
    scAjaxFieldRead("idturno_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idtarjetac_" + iRow] || "on" == ajax_error_count["lote_" + iRow] || "on" == ajax_error_count["voucher_" + iRow] || "on" == ajax_error_count["valor_" + iRow] || "on" == ajax_error_count["idturno_" + iRow] || "on" == ajax_error_count["fecha_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idtarjetac_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_lote_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_voucher_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_valor_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idturno_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idtarjetac_" + iRow] && "off" == ajax_error_count["lote_" + iRow] && "off" == ajax_error_count["voucher_" + iRow] && "off" == ajax_error_count["valor_" + iRow] && "off" == ajax_error_count["idturno_" + iRow] && "off" == ajax_error_count["fecha_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idtarjetac_" + iRow] = "off";
        ajax_error_count["lote_" + iRow] = "off";
        ajax_error_count["voucher_" + iRow] = "off";
        ajax_error_count["valor_" + iRow] = "off";
        ajax_error_count["idturno_" + iRow] = "off";
      ...
      $("#hidden_field_data_idtarjetac_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_lote_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_voucher_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_valor_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idturno_" + iRow).removeClass("scFormErrorLine");
