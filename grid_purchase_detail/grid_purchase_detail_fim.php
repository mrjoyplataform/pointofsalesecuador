...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_purchase_detail"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_purchase_detail"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_purchase_detail']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_purchase_detail']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_purchase_detail']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_purchase_detail']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_purchase_detail']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_purchase_detail</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_purchase_detail']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_purchase_detail']['embutida_filho'] as $ind => $sc_init)
          {
