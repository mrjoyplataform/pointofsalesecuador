...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_purchase_detail";$Nm_numeric[] = "id_purchase";$Nm_numeric[] = "unit_cost";$Nm_numeric[] = "quantity";$Nm_numeric[] = "id_product";$Nm_numeric[] = "id_purchase_detail";$Nm_numeric[] = "id_purchase";$Nm_numeric[] = "unit_cost";$Nm_numeric[] = "quantity";$Nm_numeric[] = "id_product";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_purchase_detail_cond" name="id_purchase_detail_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_purchase_detail'), this, 'id_purchase_detail')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_quantity_cond" name="quantity_cond" onChange="nm_campos_between(document.getElementById('id_vis_quantity'), this, 'quantity')">
      ...
      <br><span id="id_hide_quantity"  <?php echo $str_hide_quantity?>><INPUT  type="text" id="SC_quantity" name="quantity" value="<?php echo NM_encode_input($quantity) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
