<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tarjetasmovim']['sc_process_barr'] = true;
require_once('../grid_tarjetasmovim/index.php');
unset($_SESSION['scriptcase']['grid_tarjetasmovim']['sc_process_barr']);
$ExportCtrl = new grid_tarjetasmovim_export_control;
$ExportCtrl->Export_barr();

class grid_tarjetasmovim_export_control
{
