...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_color_cond" name="color_cond" onChange="nm_campos_between(document.getElementById('id_vis_color'), this, 'color')">
      ...
      <br><span id="id_hide_color"  <?php echo $str_hide_color?>><?php
      if ($color != "")
      {
      $color_look = substr($this->Db->qstr($color), 1, -1); 
      $nmgp_def_dados = array(); 
