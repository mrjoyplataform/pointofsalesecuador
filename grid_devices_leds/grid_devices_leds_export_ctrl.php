<?php
@session_start() ;
$_SESSION['scriptcase']['grid_devices_leds']['sc_process_barr'] = true;
require_once('../grid_devices_leds/index.php');
unset($_SESSION['scriptcase']['grid_devices_leds']['sc_process_barr']);
$ExportCtrl = new grid_devices_leds_export_control;
$ExportCtrl->Export_barr();

class grid_devices_leds_export_control
{
