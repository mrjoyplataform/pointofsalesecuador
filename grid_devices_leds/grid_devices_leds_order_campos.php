...
<?php
   ...
   $Ord_Cmp = new grid_devices_leds_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_devices_leds_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_devices_leds']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_devices_leds']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["cod_device"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices_leds']['labels']["cod_device"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices_leds']['labels']["cod_device"] : "Cod Device";
   $tab_ger_campos['device_name'] = "on";
   $tab_def_campos['device_name'] = "device_name";
   $tab_labels["device_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices_leds']['labels']["device_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices_leds']['labels']["device_name"] : "Device Name";
   $tab_ger_campos['ledstripe1'] = "on";
   $tab_def_campos['ledstripe1'] = "ledstripe1";
   $tab_labels["ledstripe1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices_leds']['labels']["ledstripe1"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices_leds']['labels']["ledstripe1"] : "Ledstripe 1";
   $tab_ger_campos['ledstripe2'] = "on";
   $tab_def_campos['ledstripe2'] = "ledstripe2";
   $tab_labels["ledstripe2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices_leds']['labels']["ledstripe2"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices_leds']['labels']["ledstripe2"] : "Ledstripe 2";
   $tab_ger_campos['ledstripe3'] = "on";
   $tab_def_campos['ledstripe3'] = "ledstripe3";
   $tab_labels["ledstripe3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices_leds']['labels']["ledstripe3"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices_leds']['labels']["ledstripe3"] : "Ledstripe 3";
   $tab_ger_campos['ledstripe4'] = "on";
   $tab_def_campos['ledstripe4'] = "ledstripe4";
   $tab_labels["ledstripe4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices_leds']['labels']["ledstripe4"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices_leds']['labels']["ledstripe4"] : "Ledstripe 4";
   $tab_ger_campos['color'] = "on";
   $tab_def_campos['color'] = "color";
   $tab_labels["color"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devices_leds']['labels']["color"])) ? $_SESSION['sc_session'][$sc_init]['grid_devices_leds']['labels']["color"] : "Color";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_devices_leds']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_devices_leds']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_devices_leds']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_devices_leds']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_devices_leds']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_devices_leds']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_devices_leds']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_devices_leds']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_devices_leds']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_devices_leds']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_devices_leds']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_devices_leds']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_devices_leds_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_devices_leds']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_devices_leds']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_devices_leds']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_devices_leds']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_devices_leds']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
