  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_nombre_registro_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_nombre_registro_mob_form();
	}
...
?>
  ...
  // ---------- Validate nombre
  function do_ajax_control_nombre_registro_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_nombre_registro_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_control_nombre_registro_mob_validate_nombre_cb);
  } // do_ajax_control_nombre_registro_mob_validate_nombre

  function do_ajax_control_nombre_registro_mob_validate_nombre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nombre_registro_mob_validate_nombre_cb

  // ---------- Validate genero
  function do_ajax_control_nombre_registro_mob_validate_genero()
  {
    var nomeCampo_genero = "genero";
    var var_genero = scAjaxGetFieldText(nomeCampo_genero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_nombre_registro_mob_validate_genero(var_genero, var_script_case_init, do_ajax_control_nombre_registro_mob_validate_genero_cb);
  } // do_ajax_control_nombre_registro_mob_validate_genero

  function do_ajax_control_nombre_registro_mob_validate_genero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "genero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nombre_registro_mob_validate_genero_cb

  // ---------- Validate fecha_cumple
  function do_ajax_control_nombre_registro_mob_validate_fecha_cumple()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_nombre_registro_mob_validate_fecha_cumple(var_fecha_cumple, var_fecha_cumple_dia, var_fecha_cumple_mes, var_fecha_cumple_ano, var_script_case_init, do_ajax_control_nombre_registro_mob_validate_fecha_cumple_cb);
  } // do_ajax_control_nombre_registro_mob_validate_fecha_cumple

  function do_ajax_control_nombre_registro_mob_validate_fecha_cumple_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nombre_registro_mob_validate_fecha_cumple_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_nombre_registro_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_nombre_registro_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_control_nombre_registro_mob_submit_form(var_nombre, var_genero, var_fecha_cumple_mes, var_fecha_cumple_dia, var_fecha_cumple_ano, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_control_nombre_registro_mob_submit_form_cb);
  } // do_ajax_control_nombre_registro_mob_submit_form

  function do_ajax_control_nombre_registro_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_nombre_registro_mob_submit_form_cb_after_alert);
  } // do_ajax_control_nombre_registro_mob_submit_form_cb
  function do_ajax_control_nombre_registro_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_nombre_registro_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_nombre_registro_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_control_nombre_registro_mob_navigate_form, function() {});
    } else {
      perform_ajax_control_nombre_registro_mob_navigate_form();
    }
  }

  function perform_ajax_control_nombre_registro_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_nombre_registro_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_nombre_registro_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_nombre_registro_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_nombre_registro_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_nombre_registro_mob_navigate_form_cb
  function do_ajax_control_nombre_registro_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('nombre');
...
{
?>
    do_ajax_control_nombre_registro_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_nombre_registro_mob_navigate_form_cb_after_alert

  function sc_hide_control_nombre_registro_mob_form()
  {
  ...
  var ajax_error_list = {
    "nombre": {"label": "Nombre o Apodo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
