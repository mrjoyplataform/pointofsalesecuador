<?php
@session_start() ;
$_SESSION['scriptcase']['grid_supplier']['sc_process_barr'] = true;
require_once('../grid_supplier/index.php');
unset($_SESSION['scriptcase']['grid_supplier']['sc_process_barr']);
$ExportCtrl = new grid_supplier_export_control;
$ExportCtrl->Export_barr();

class grid_supplier_export_control
{
