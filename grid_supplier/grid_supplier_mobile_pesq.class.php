...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_supplier";$Nm_numeric[] = "id_supplier";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_telephone_cond" name="telephone_cond" onChange="nm_campos_between(document.getElementById('id_vis_telephone'), this, 'telephone')">
      ...
      <br><span id="id_hide_telephone"  <?php echo $str_hide_telephone?>><?php
      if ($telephone != "")
      {
      $telephone_look = substr($this->Db->qstr($telephone), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_supplier_name_cond" name="supplier_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_supplier_name'), this, 'supplier_name')">
      ...
      <br><span id="id_hide_supplier_name"  <?php echo $str_hide_supplier_name?>><?php
      if ($supplier_name != "")
      {
      $supplier_name_look = substr($this->Db->qstr($supplier_name), 1, -1); 
      $nmgp_def_dados = array(); 
