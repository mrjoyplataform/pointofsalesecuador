...
<?php
   ...
   $Ord_Cmp = new grid_supplier_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_supplier_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_supplier']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_supplier']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id_supplier"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_supplier']['labels']["id_supplier"])) ? $_SESSION['sc_session'][$sc_init]['grid_supplier']['labels']["id_supplier"] : "" . $this->Nm_lang['lang_supplier_fld_id_supplier'] . "";
   $tab_ger_campos['idproveedor'] = "on";
   $tab_def_campos['idproveedor'] = "idproveedor";
   $tab_labels["idproveedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_supplier']['labels']["idproveedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_supplier']['labels']["idproveedor"] : "Idproveedor";
   $tab_ger_campos['supplier_name'] = "on";
   $tab_def_campos['supplier_name'] = "supplier_name";
   $tab_labels["supplier_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_supplier']['labels']["supplier_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_supplier']['labels']["supplier_name"] : "" . $this->Nm_lang['lang_supplier_fld_supplier_name'] . "";
   $tab_ger_campos['address'] = "on";
   $tab_def_campos['address'] = "address";
   $tab_labels["address"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_supplier']['labels']["address"])) ? $_SESSION['sc_session'][$sc_init]['grid_supplier']['labels']["address"] : "" . $this->Nm_lang['lang_supplier_fld_address'] . "";
   $tab_ger_campos['telephone'] = "on";
   $tab_def_campos['telephone'] = "telephone";
   $tab_labels["telephone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_supplier']['labels']["telephone"])) ? $_SESSION['sc_session'][$sc_init]['grid_supplier']['labels']["telephone"] : "" . $this->Nm_lang['lang_supplier_fld_telephone'] . "";
   $tab_ger_campos['contact'] = "on";
   $tab_def_campos['contact'] = "contact";
   $tab_labels["contact"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_supplier']['labels']["contact"])) ? $_SESSION['sc_session'][$sc_init]['grid_supplier']['labels']["contact"] : "" . $this->Nm_lang['lang_supplier_fld_contact'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_supplier']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_supplier']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_supplier']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_supplier']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_supplier']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_supplier']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_supplier']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_supplier']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_supplier']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_supplier']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_supplier']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_supplier']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_supplier_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_supplier']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_supplier']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_supplier']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_supplier']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_supplier']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
