<?php
@session_start() ;
$_SESSION['scriptcase']['chart_tarjetasmovim_odoo']['sc_process_barr'] = true;
require_once('../chart_tarjetasmovim_odoo/index.php');
unset($_SESSION['scriptcase']['chart_tarjetasmovim_odoo']['sc_process_barr']);
$ExportCtrl = new chart_tarjetasmovim_odoo_export_control;
$ExportCtrl->Export_barr();

class chart_tarjetasmovim_odoo_export_control
{
