...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_codigo_principal_cond" name="codigo_principal_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigo_principal'), this, 'codigo_principal')">
