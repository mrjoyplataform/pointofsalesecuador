  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cierre_conteo" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cierre_conteo_form();
	}
...
?>
  ...
  // ---------- Validate tipovalor_
  function do_ajax_form_cierre_conteo_validate_tipovalor_(iNumLinha)
  {
    var nomeCampo_tipovalor_ = "tipovalor_" + iNumLinha;
    var var_tipovalor_ = scAjaxGetFieldSelect(nomeCampo_tipovalor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_conteo_validate_tipovalor_(var_tipovalor_, iNumLinha, var_script_case_init, do_ajax_form_cierre_conteo_validate_tipovalor__cb);
  } // do_ajax_form_cierre_conteo_validate_tipovalor_

  function do_ajax_form_cierre_conteo_validate_tipovalor__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "tipovalor_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tipovalor_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "tipovalor_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tipovalor_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_conteo_validate_tipovalor__cb

  // ---------- Validate cantidad_
  function do_ajax_form_cierre_conteo_validate_cantidad_(iNumLinha)
  {
    var nomeCampo_cantidad_ = "cantidad_" + iNumLinha;
    var var_cantidad_ = scAjaxGetFieldText(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_conteo_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_cierre_conteo_validate_cantidad__cb);
  } // do_ajax_form_cierre_conteo_validate_cantidad_

  function do_ajax_form_cierre_conteo_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_conteo_validate_cantidad__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_cierre_conteo_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_cierre_conteo_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cierre_conteo_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_cierre_conteo_add_new_line_cb);
  } // do_ajax_form_cierre_conteo_add_new_line

  function do_ajax_form_cierre_conteo_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_cierre_conteo_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_cierre_conteo_backup_line(iNumLinha)
  {
    var var_fecha_ = scAjaxGetFieldText("fecha_" + iNumLinha);
    var var_idturno_ = scAjaxGetFieldText("idturno_" + iNumLinha);
    var var_tipovalor_ = scAjaxGetFieldSelect("tipovalor_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_conteo_backup_line(var_fecha_, var_idturno_, var_tipovalor_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_cierre_conteo_backup_line_cb);
  } // do_ajax_form_cierre_conteo_backup_line

  function do_ajax_form_cierre_conteo_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_cierre_conteo_backup_line_cb

  function do_ajax_form_cierre_conteo_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_cierre_conteo_cancel_insert

  function do_ajax_form_cierre_conteo_cancel_update(iSeqVert)
  {
    do_ajax_form_cierre_conteo_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_cierre_conteo_cancel_update

  function do_ajax_form_cierre_conteo_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_cierre_conteo_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_cierre_conteo_table_refresh()
  {
    var var_fecha_ = document.F2.fecha_.value;
    var var_idturno_ = document.F2.idturno_.value;
    var var_tipovalor_ = document.F2.tipovalor_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_cierre_conteo_table_refresh(var_fecha_, var_idturno_, var_tipovalor_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cierre_conteo_table_refresh_cb);
  } //  do_ajax_form_cierre_conteo_table_refresh

  function do_ajax_form_cierre_conteo_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.tipovalor_.value = scAjaxGetKeyValue("tipovalor_");
    ...
    scAjaxAlert(do_ajax_form_cierre_conteo_table_refresh_cb_after_alert);
  } // do_ajax_form_cierre_conteo_table_refresh_cb
  function do_ajax_form_cierre_conteo_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_cierre_conteo_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_cierre_conteo_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_cierre_conteo_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_cierre_conteo_submit_form(var_tipovalor_, var_cantidad_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_cierre_conteo_submit_form_cb);
  } // do_ajax_form_cierre_conteo_submit_form

  function do_ajax_form_cierre_conteo_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tipovalor_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cierre_conteo_submit_form_cb_after_alert);
  } // do_ajax_form_cierre_conteo_submit_form_cb
  function do_ajax_form_cierre_conteo_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cierre_conteo_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cierre_conteo_navigate_form()
  {
    perform_ajax_form_cierre_conteo_navigate_form();
  }

  function perform_ajax_form_cierre_conteo_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("tipovalor_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cierre_conteo_navigate_form(var_fecha_, var_idturno_, var_tipovalor_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cierre_conteo_navigate_form_cb);
  } // do_ajax_form_cierre_conteo_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cierre_conteo']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cierre_conteo_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.tipovalor_.value = scAjaxGetKeyValue("tipovalor_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cierre_conteo_navigate_form_cb_after_alert);
  } // do_ajax_form_cierre_conteo_navigate_form_cb
  function do_ajax_form_cierre_conteo_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_cierre_conteo_navigate_form_cb_after_alert

    function sc_form_cierre_conteo_get_last_line_number()
    {
    ...
    } //sc_form_cierre_conteo_get_last_line_number

  function sc_hide_form_cierre_conteo_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "tipovalor_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cantidad_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["tipovalor_" + iNumLinha] = {"label": "Tipovalor<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["tipovalor_"][iNumLinha] = "tipovalor_" + iNumLinha;
    ajax_field_mult["cantidad_"][iNumLinha] = "cantidad_" + iNumLinha;
    ajax_field_id["tipovalor_" + iNumLinha] = new Array("hidden_field_label_tipovalor_", "hidden_field_data_tipovalor_" + iNumLinha);
    ajax_field_id["cantidad_" + iNumLinha] = new Array("hidden_field_label_cantidad_", "hidden_field_data_cantidad_" + iNumLinha);
    ajax_error_count["tipovalor_" + iNumLinha] = "off";
    ajax_error_count["cantidad_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["tipovalor_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["tipovalor_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["tipovalor_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tipovalor_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tipovalor_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tipovalor_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tipovalor_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tipovalor_'])) ? $this->nmgp_cmp_readonly['tipovalor_'] : 'on';
?>
    scAjaxFieldRead("tipovalor_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("tipovalor_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tipovalor_" + iRow] || "on" == ajax_error_count["cantidad_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tipovalor_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tipovalor_" + iRow] && "off" == ajax_error_count["cantidad_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tipovalor_" + iRow] = "off";
      ...
      $("#hidden_field_data_tipovalor_" + iRow).removeClass("scFormErrorLine");
