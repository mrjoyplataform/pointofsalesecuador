...
function scEventControl_init(iSeqRow) {
  scEventControl_data["tipovalor_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["cantidad_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}

function scEventControl_active(iSeqRow) {
  if (scEventControl_data["tipovalor_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["tipovalor_" + iSeqRow]["change"]) {
    return true;
  }
...
function scEventControl_onCalculator_cantidad_() {
  if (!_scCalculatorControl["id_sc_field_cantidad_"]) {
    _scCalculatorBlurOk["id_sc_field_cantidad_"] = true;
    do_ajax_form_cierre_conteo_event_cantidad__onblur();
  }
} // scEventControl_onCalculator_cantidad_

var scEventControl_data = {};

function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_fecha_' + iSeqRow).bind('change', function() { sc_form_cierre_conteo_fecha__onchange(this, iSeqRow) });
  $('#id_sc_field_idturno_' + iSeqRow).bind('change', function() { sc_form_cierre_conteo_idturno__onchange(this, iSeqRow) });
  $('#id_sc_field_tipovalor_' + iSeqRow).bind('blur', function() { sc_form_cierre_conteo_tipovalor__onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_cierre_conteo_tipovalor__onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_cierre_conteo_tipovalor__onfocus(this, iSeqRow) });
  $('#id_sc_field_cantidad_' + iSeqRow).bind('blur', function() { sc_form_cierre_conteo_cantidad__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_cierre_conteo_cantidad__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_cierre_conteo_cantidad__onfocus(this, iSeqRow) });
  $('#id_sc_field_valor_' + iSeqRow).bind('change', function() { sc_form_cierre_conteo_valor__onchange(this, iSeqRow) });
  $('#id_sc_field_usuario_' + iSeqRow).bind('change', function() { sc_form_cierre_conteo_usuario__onchange(this, iSeqRow) });
  $('#id_sc_field_estado_' + iSeqRow).bind('change', function() { sc_form_cierre_conteo_estado__onchange(this, iSeqRow) });
  $('#id_sc_field_fecharegistro_' + iSeqRow).bind('change', function() { sc_form_cierre_conteo_fecharegistro__onchange(this, iSeqRow) });
  $('#id_sc_field_fecharegistro__hora' + iSeqRow).bind('change', function() { sc_form_cierre_conteo_fecharegistro__hora_onchange(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_cierre_conteo_fecha__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_cierre_conteo_idturno__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_cierre_conteo_tipovalor__onblur(oThis, iSeqRow) {
  do_ajax_form_cierre_conteo_validate_tipovalor_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_cierre_conteo_tipovalor__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_cierre_conteo_tipovalor__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_cierre_conteo_cantidad__onblur(oThis, iSeqRow) {
  do_ajax_form_cierre_conteo_validate_cantidad_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_cierre_conteo_cantidad__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_cierre_conteo_cantidad__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_cierre_conteo_valor__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_cierre_conteo_usuario__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_cierre_conteo_estado__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_cierre_conteo_fecharegistro__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_cierre_conteo_fecharegistro__hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function displayChange_block_0(status) {
	displayChange_field("tipovalor_", "", status);
	displayChange_field("cantidad_", "", status);
}

function displayChange_row(row, status) {
	displayChange_field_tipovalor_(row, status);
...
function displayChange_field_tipovalor_(row, status) {
    var fieldId;
}
...
function scHidePage(pageNo) {
	$("#id_form_cierre_conteo_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecha_" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_cierre_conteo_validate_fecha_(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fecharegistro_" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_cierre_conteo_validate_fecharegistro_(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQCalculatorAdd(iSeqRow) {
  _scCalculatorBlurOk["id_sc_field_fecharegistro_" + iSeqRow] = true;
  $("#id_sc_field_cantidad_" + iSeqRow).calculator({
    onOpen: function(value, inst) {
      if (typeof _scCalculatorControl !== "undefined") {
        if (!_scCalculatorControl["id_sc_field_cantidad_" + iSeqRow]) {
          _scCalculatorControl["id_sc_field_cantidad_" + iSeqRow] = true;
        }
      }
      value = scJQCalculatorUnformat(value, "#id_sc_field_cantidad_" + iSeqRow, '<?php echo str_replace("'", "\'", $this->field_config['cantidad_']['symbol_grp']); ?>', <?php echo $this->field_config['cantidad_']['symbol_fmt']; ?>, '', '');
      $(this).val(value);
    },
    onClose: function(value, inst) {
      ...
      if (typeof _scCalculatorControl !== "undefined") {
        if (_scCalculatorControl["id_sc_field_cantidad_" + iSeqRow]) {
          _scCalculatorControl["id_sc_field_cantidad_" + iSeqRow] = null;
        }
      }
      value = scJQCalculatorFormat(value, "#id_sc_field_cantidad_" + iSeqRow, '<?php echo str_replace("'", "\'", $this->field_config['cantidad_']['symbol_grp']); ?>', <?php echo $this->field_config['cantidad_']['symbol_fmt']; ?>, '', 0, '');
      $(this).val(value);
      if (oldValue != value) {
        $(this).trigger('change');
      }
...
function scJQSpinAdd(iSeqRow) {
  $("#id_sc_field_cantidad_" + iSeqRow).spinner({
    max: 99999,
    min: 0,
    step: 1,
    page: 5,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_cierre_conteo')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
