  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cierre_egresos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cierre_egresos_form();
	}
...
?>
  ...
  // ---------- Validate tipoe_
  function do_ajax_form_cierre_egresos_validate_tipoe_(iNumLinha)
  {
    var nomeCampo_tipoe_ = "tipoe_" + iNumLinha;
    var var_tipoe_ = scAjaxGetFieldSelect(nomeCampo_tipoe_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_egresos_validate_tipoe_(var_tipoe_, iNumLinha, var_script_case_init, do_ajax_form_cierre_egresos_validate_tipoe__cb);
  } // do_ajax_form_cierre_egresos_validate_tipoe_

  function do_ajax_form_cierre_egresos_validate_tipoe__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "tipoe_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tipoe_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "tipoe_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tipoe_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_egresos_validate_tipoe__cb

  // ---------- Validate valor_
  function do_ajax_form_cierre_egresos_validate_valor_(iNumLinha)
  {
    var nomeCampo_valor_ = "valor_" + iNumLinha;
    var var_valor_ = scAjaxGetFieldText(nomeCampo_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_egresos_validate_valor_(var_valor_, iNumLinha, var_script_case_init, do_ajax_form_cierre_egresos_validate_valor__cb);
  } // do_ajax_form_cierre_egresos_validate_valor_

  function do_ajax_form_cierre_egresos_validate_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_egresos_validate_valor__cb

  // ---------- Validate observacion_
  function do_ajax_form_cierre_egresos_validate_observacion_(iNumLinha)
  {
    var nomeCampo_observacion_ = "observacion_" + iNumLinha;
    var var_observacion_ = scAjaxGetFieldText(nomeCampo_observacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_egresos_validate_observacion_(var_observacion_, iNumLinha, var_script_case_init, do_ajax_form_cierre_egresos_validate_observacion__cb);
  } // do_ajax_form_cierre_egresos_validate_observacion_

  function do_ajax_form_cierre_egresos_validate_observacion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_egresos_validate_observacion__cb

  // ---------- Validate percod_
  function do_ajax_form_cierre_egresos_validate_percod_(iNumLinha)
  {
    var nomeCampo_percod_ = "percod_" + iNumLinha;
    var var_percod_ = scAjaxGetFieldSelect(nomeCampo_percod_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_egresos_validate_percod_(var_percod_, iNumLinha, var_script_case_init, do_ajax_form_cierre_egresos_validate_percod__cb);
  } // do_ajax_form_cierre_egresos_validate_percod_

  function do_ajax_form_cierre_egresos_validate_percod__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "percod_" + iLineNumber;
    }
    else
    {
      sFieldValid = "percod_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "percod_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "percod_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_egresos_validate_percod__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_cierre_egresos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_cierre_egresos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cierre_egresos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_cierre_egresos_add_new_line_cb);
  } // do_ajax_form_cierre_egresos_add_new_line

  function do_ajax_form_cierre_egresos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_cierre_egresos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_cierre_egresos_backup_line(iNumLinha)
  {
    var var_ideg_ = scAjaxGetFieldText("ideg_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_egresos_backup_line(var_ideg_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_cierre_egresos_backup_line_cb);
  } // do_ajax_form_cierre_egresos_backup_line

  function do_ajax_form_cierre_egresos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_cierre_egresos_backup_line_cb

  function do_ajax_form_cierre_egresos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_cierre_egresos_cancel_insert

  function do_ajax_form_cierre_egresos_cancel_update(iSeqVert)
  {
    do_ajax_form_cierre_egresos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_cierre_egresos_cancel_update

  function do_ajax_form_cierre_egresos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_cierre_egresos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_cierre_egresos_table_refresh()
  {
    var var_ideg_ = document.F2.ideg_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_cierre_egresos_table_refresh(var_ideg_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cierre_egresos_table_refresh_cb);
  } //  do_ajax_form_cierre_egresos_table_refresh

  function do_ajax_form_cierre_egresos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.ideg_.value = scAjaxGetKeyValue("ideg_");
    ...
    scAjaxAlert(do_ajax_form_cierre_egresos_table_refresh_cb_after_alert);
  } // do_ajax_form_cierre_egresos_table_refresh_cb
  function do_ajax_form_cierre_egresos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_cierre_egresos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_cierre_egresos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_cierre_egresos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_tipoe_ = scAjaxGetFieldSelect("tipoe_" + iNumLinha);
    var var_valor_ = scAjaxGetFieldText("valor_" + iNumLinha);
    var var_observacion_ = scAjaxGetFieldText("observacion_" + iNumLinha);
    var var_percod_ = scAjaxGetFieldSelect("percod_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_cierre_egresos_submit_form(var_tipoe_, var_valor_, var_observacion_, var_percod_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_cierre_egresos_submit_form_cb);
  } // do_ajax_form_cierre_egresos_submit_form

  function do_ajax_form_cierre_egresos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cierre_egresos_submit_form_cb_after_alert);
  } // do_ajax_form_cierre_egresos_submit_form_cb
  function do_ajax_form_cierre_egresos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cierre_egresos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cierre_egresos_navigate_form()
  {
    perform_ajax_form_cierre_egresos_navigate_form();
  }

  function perform_ajax_form_cierre_egresos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cierre_egresos_navigate_form(var_ideg_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cierre_egresos_navigate_form_cb);
  } // do_ajax_form_cierre_egresos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cierre_egresos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cierre_egresos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.ideg_.value = scAjaxGetKeyValue("ideg_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cierre_egresos_navigate_form_cb_after_alert);
  } // do_ajax_form_cierre_egresos_navigate_form_cb
  function do_ajax_form_cierre_egresos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_cierre_egresos_navigate_form_cb_after_alert

    function sc_form_cierre_egresos_get_last_line_number()
    {
    ...
    } //sc_form_cierre_egresos_get_last_line_number

  function sc_hide_form_cierre_egresos_form()
  {
  ...
  function do_ajax_form_cierre_egresos_lkpedt_refresh_tipoe_(iSeq)
  {
    var var_tipoe_ = scAjaxGetFieldSelect("tipoe_");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_row = iSeq;
    var nmgp_refresh_fields = "tipoe_";
    x_ajax_form_cierre_egresos_lkpedt_refresh_tipoe_(var_tipoe_, nmgp_refresh_row, nmgp_refresh_fields, var_script_case_init, do_ajax_form_cierre_egresos_lkpedt_refresh_tipoe__cb);
  } // do_ajax_form_cierre_egresos_lkpedt_refresh_tipoe_

  function do_ajax_form_cierre_egresos_lkpedt_refresh_tipoe__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_cierre_egresos_lkpedt_refresh_tipoe__cb

  function do_ajax_form_cierre_egresos_lkpedt_refresh_percod_(iSeq)
  {
    var var_percod_ = scAjaxGetFieldSelect("percod_");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_row = iSeq;
    var nmgp_refresh_fields = "percod_";
    x_ajax_form_cierre_egresos_lkpedt_refresh_percod_(var_percod_, nmgp_refresh_row, nmgp_refresh_fields, var_script_case_init, do_ajax_form_cierre_egresos_lkpedt_refresh_percod__cb);
  } // do_ajax_form_cierre_egresos_lkpedt_refresh_percod_

  function do_ajax_form_cierre_egresos_lkpedt_refresh_percod__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_cierre_egresos_lkpedt_refresh_percod__cb
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "tipoe_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "valor_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "observacion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "percod_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["tipoe_" + iNumLinha] = {"label": "Tipoe<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["observacion_" + iNumLinha] = {"label": "Observacion<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["percod_" + iNumLinha] = {"label": "Percod<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["tipoe_"][iNumLinha] = "tipoe_" + iNumLinha;
    ajax_field_mult["valor_"][iNumLinha] = "valor_" + iNumLinha;
    ajax_field_mult["observacion_"][iNumLinha] = "observacion_" + iNumLinha;
    ajax_field_mult["percod_"][iNumLinha] = "percod_" + iNumLinha;
    ajax_field_id["tipoe_" + iNumLinha] = new Array("hidden_field_label_tipoe_", "hidden_field_data_tipoe_" + iNumLinha);
    ...
    ajax_field_id["percod_" + iNumLinha] = new Array("hidden_field_label_percod_", "hidden_field_data_percod_" + iNumLinha);
    ajax_error_count["tipoe_" + iNumLinha] = "off";
    ajax_error_count["valor_" + iNumLinha] = "off";
    ajax_error_count["observacion_" + iNumLinha] = "off";
    ajax_error_count["percod_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["tipoe_" + iNumLinha] = "off";
    ajax_read_only["valor_" + iNumLinha] = "off";
    ajax_read_only["observacion_" + iNumLinha] = "off";
    ajax_read_only["percod_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["tipoe_" + iNumLinha] = "on";
    ajax_read_only["valor_" + iNumLinha] = "on";
    ajax_read_only["observacion_" + iNumLinha] = "on";
    ajax_read_only["percod_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["tipoe_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tipoe_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tipoe_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tipoe_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tipoe_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["percod_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["percod_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["percod_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["percod_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["percod_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tipoe_'])) ? $this->nmgp_cmp_readonly['tipoe_'] : 'off';
?>
    scAjaxFieldRead("tipoe_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['percod_'])) ? $this->nmgp_cmp_readonly['percod_'] : 'off';
?>
    scAjaxFieldRead("percod_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("tipoe_" + iSeq, "on");
    scAjaxFieldRead("valor_" + iSeq, "on");
    scAjaxFieldRead("observacion_" + iSeq, "on");
    scAjaxFieldRead("percod_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tipoe_" + iRow] || "on" == ajax_error_count["valor_" + iRow] || "on" == ajax_error_count["observacion_" + iRow] || "on" == ajax_error_count["percod_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tipoe_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_valor_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_observacion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_percod_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tipoe_" + iRow] && "off" == ajax_error_count["valor_" + iRow] && "off" == ajax_error_count["observacion_" + iRow] && "off" == ajax_error_count["percod_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tipoe_" + iRow] = "off";
        ajax_error_count["valor_" + iRow] = "off";
        ajax_error_count["observacion_" + iRow] = "off";
        ajax_error_count["percod_" + iRow] = "off";
      }
