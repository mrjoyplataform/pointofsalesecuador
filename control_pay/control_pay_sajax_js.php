  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_pay" == sTestField)
        {
...
?>
  ...
  // ---------- Validate logo
  function do_ajax_control_pay_validate_logo()
  {
  } // do_ajax_control_pay_validate_logo

  function do_ajax_control_pay_validate_logo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_pay_validate_logo_cb

  // ---------- Validate fpago
  function do_ajax_control_pay_validate_fpago()
  {
    var nomeCampo_fpago = "fpago";
    var var_fpago = scAjaxGetFieldRadio(nomeCampo_fpago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_pay_validate_fpago(var_fpago, var_script_case_init, do_ajax_control_pay_validate_fpago_cb);
  } // do_ajax_control_pay_validate_fpago

  function do_ajax_control_pay_validate_fpago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fpago";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_pay_validate_fpago_cb

  // ---------- Validate total
  function do_ajax_control_pay_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldHidden(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_pay_validate_total(var_total, var_script_case_init, do_ajax_control_pay_validate_total_cb);
  } // do_ajax_control_pay_validate_total

  function do_ajax_control_pay_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_pay_validate_total_cb

  // ---------- Validate paga
  function do_ajax_control_pay_validate_paga()
  {
    var nomeCampo_paga = "paga";
    var var_paga = scAjaxGetFieldText(nomeCampo_paga);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_pay_validate_paga(var_paga, var_script_case_init, do_ajax_control_pay_validate_paga_cb);
  } // do_ajax_control_pay_validate_paga

  function do_ajax_control_pay_validate_paga_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "paga";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_pay_validate_paga_cb

  // ---------- Event onclick fpago
  function do_ajax_control_pay_event_fpago_onclick()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_control_pay_event_fpago_onclick(var_fpago, var_paga, var_total, var_script_case_init, do_ajax_control_pay_event_fpago_onclick_cb);
  } // do_ajax_control_pay_event_fpago_onclick

  function do_ajax_control_pay_event_fpago_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fpago";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_pay_event_fpago_onclick_cb_after_alert);
  } // do_ajax_control_pay_event_fpago_onclick_cb
  function do_ajax_control_pay_event_fpago_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_pay_event_fpago_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_pay_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_pay_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_control_pay_submit_form(var_logo, var_fpago, var_total, var_paga, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_control_pay_submit_form_cb);
  } // do_ajax_control_pay_submit_form

  function do_ajax_control_pay_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_pay_submit_form_cb_after_alert);
  } // do_ajax_control_pay_submit_form_cb
  function do_ajax_control_pay_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_pay_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_pay_navigate_form()
  {
    perform_ajax_control_pay_navigate_form();
  }

  function perform_ajax_control_pay_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_pay_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_pay']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_pay_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_pay_navigate_form_cb_after_alert);
  } // do_ajax_control_pay_navigate_form_cb
  function do_ajax_control_pay_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('paga');
...
{
?>
    do_ajax_control_pay_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_pay_navigate_form_cb_after_alert

  function sc_hide_control_pay_form()
  {
