  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_pay_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate logo
  function do_ajax_control_pay_mob_validate_logo()
  {
  } // do_ajax_control_pay_mob_validate_logo

  function do_ajax_control_pay_mob_validate_logo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_pay_mob_validate_logo_cb

  // ---------- Validate fpago
  function do_ajax_control_pay_mob_validate_fpago()
  {
    var nomeCampo_fpago = "fpago";
    var var_fpago = scAjaxGetFieldRadio(nomeCampo_fpago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_pay_mob_validate_fpago(var_fpago, var_script_case_init, do_ajax_control_pay_mob_validate_fpago_cb);
  } // do_ajax_control_pay_mob_validate_fpago

  function do_ajax_control_pay_mob_validate_fpago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fpago";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_pay_mob_validate_fpago_cb

  // ---------- Validate total
  function do_ajax_control_pay_mob_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldHidden(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_pay_mob_validate_total(var_total, var_script_case_init, do_ajax_control_pay_mob_validate_total_cb);
  } // do_ajax_control_pay_mob_validate_total

  function do_ajax_control_pay_mob_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_pay_mob_validate_total_cb

  // ---------- Validate paga
  function do_ajax_control_pay_mob_validate_paga()
  {
    var nomeCampo_paga = "paga";
    var var_paga = scAjaxGetFieldText(nomeCampo_paga);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_pay_mob_validate_paga(var_paga, var_script_case_init, do_ajax_control_pay_mob_validate_paga_cb);
  } // do_ajax_control_pay_mob_validate_paga

  function do_ajax_control_pay_mob_validate_paga_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "paga";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_pay_mob_validate_paga_cb

  // ---------- Event onclick fpago
  function do_ajax_control_pay_mob_event_fpago_onclick()
  {
    var var_fpago = scAjaxGetFieldRadio("fpago");
    var var_paga = scAjaxGetFieldText("paga");
    var var_total = scAjaxGetFieldHidden("total");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_control_pay_mob_event_fpago_onclick(var_fpago, var_paga, var_total, var_script_case_init, do_ajax_control_pay_mob_event_fpago_onclick_cb);
  } // do_ajax_control_pay_mob_event_fpago_onclick

  function do_ajax_control_pay_mob_event_fpago_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fpago";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_pay_mob_event_fpago_onclick_cb_after_alert);
  } // do_ajax_control_pay_mob_event_fpago_onclick_cb
  function do_ajax_control_pay_mob_event_fpago_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_pay_mob_event_fpago_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_pay_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_pay_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_logo = scAjaxGetFieldHidden("logo");
    var var_fpago = scAjaxGetFieldRadio("fpago");
    var var_total = scAjaxGetFieldHidden("total");
    var var_paga = scAjaxGetFieldText("paga");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_control_pay_mob_submit_form(var_logo, var_fpago, var_total, var_paga, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_control_pay_mob_submit_form_cb);
  } // do_ajax_control_pay_mob_submit_form

  function do_ajax_control_pay_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_pay_mob_submit_form_cb_after_alert);
  } // do_ajax_control_pay_mob_submit_form_cb
  function do_ajax_control_pay_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_pay_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_pay_mob_navigate_form()
  {
    perform_ajax_control_pay_mob_navigate_form();
  }

  function perform_ajax_control_pay_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_pay_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_pay_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_pay_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_pay_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_pay_mob_navigate_form_cb
  function do_ajax_control_pay_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('paga');
...
{
?>
    do_ajax_control_pay_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_pay_mob_navigate_form_cb_after_alert

  function sc_hide_control_pay_mob_form()
  {
  ...
  ajax_field_list[1] = "fpago";
  ajax_field_list[2] = "total";
  ajax_field_list[3] = "paga";
  ...
  var ajax_error_list = {
    ...
    "fpago": {"label": "fpago", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "paga": {"label": "<?php echo $this->Ini->Nm_lang['lang_paid'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["fpago"][1] = "fpago";
  ajax_field_mult["total"][1] = "total";
  ajax_field_mult["paga"][1] = "paga";

  var ajax_field_id = {
    "logo": new Array("hidden_field_label_logo", "hidden_field_data_logo"),
    "fpago": new Array("hidden_field_label_fpago", "hidden_field_data_fpago"),
    "total": new Array("hidden_field_label_total", "hidden_field_data_total"),
    "paga": new Array("hidden_field_label_paga", "hidden_field_data_paga")
  };
