...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_xml_compras_detalles"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_xml_compras_detalles"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_xml_compras_detalles'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_xml_compras_detalles']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_xml_compras_detalles']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_xml_compras_detalles']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_xml_compras_detalles']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_xml_compras_detalles']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_xml_compras_detalles</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_xml_compras_detalles']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_xml_compras_detalles']['embutida_filho'] as $ind => $sc_init)
          {
