...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = " #lowerI#";
      $nm_fim_lower = "#lowerF#";
      $Nm_numeric[] = "idlinea";$Nm_numeric[] = "cantidad";$Nm_numeric[] = "preciounitario";$Nm_numeric[] = "descuento";$Nm_numeric[] = "preciototalsinimpuesto";$Nm_numeric[] = "idlinea";$Nm_numeric[] = "cantidad";$Nm_numeric[] = "preciounitario";$Nm_numeric[] = "descuento";$Nm_numeric[] = "preciototalsinimpuesto";
...
<HTML>
<HEAD>
 <TITLE> xml_compras_detalles</TITLE>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_codigoprincipal_cond" name="codigoprincipal_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigoprincipal'), this, 'codigoprincipal')">
      ...
      <br><span id="id_hide_codigoprincipal"  <?php echo $str_hide_codigoprincipal?>><?php
      if ($codigoprincipal != "")
      {
      $codigoprincipal_look = substr($this->Db->qstr($codigoprincipal), 1, -1); 
      $nmgp_def_dados = array(); 
