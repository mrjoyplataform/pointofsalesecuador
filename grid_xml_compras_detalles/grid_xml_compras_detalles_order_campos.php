...
<?php
   ...
   $Ord_Cmp = new grid_xml_compras_detalles_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_xml_compras_detalles_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idlinea'] = "idlinea";
   $tab_labels["idlinea"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['labels']["idlinea"])) ? $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['labels']["idlinea"] : "Idlinea";
   $tab_ger_campos['codigoprincipal'] = "on";
   $tab_def_campos['codigoprincipal'] = "codigoPrincipal";
   $tab_labels["codigoprincipal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['labels']["codigoprincipal"])) ? $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['labels']["codigoprincipal"] : "Codigo Principal";
   $tab_ger_campos['descripcion'] = "on";
   $tab_def_campos['descripcion'] = "descripcion";
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['labels']["descripcion"] : "Descripcion";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['labels']["cantidad"] : "Cantidad";
   $tab_ger_campos['preciounitario'] = "on";
   $tab_def_campos['preciounitario'] = "precioUnitario";
   $tab_labels["preciounitario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['labels']["preciounitario"])) ? $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['labels']["preciounitario"] : "Precio Unitario";
   $tab_ger_campos['preciototalsinimpuesto'] = "on";
   $tab_def_campos['preciototalsinimpuesto'] = "precioTotalSinImpuesto";
   $tab_labels["preciototalsinimpuesto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['labels']["preciototalsinimpuesto"])) ? $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['labels']["preciototalsinimpuesto"] : "Precio Total Sin Impuesto";
   $tab_ger_campos['impuestos'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['impuestos'] = "impuestos";
   }
   else
   {
       $tab_def_campos['impuestos'] = "";
   }
   $tab_labels["impuestos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['labels']["impuestos"])) ? $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['labels']["impuestos"] : "impuestos";
   $tab_ger_campos['impuestos'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_xml_compras_detalles_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
