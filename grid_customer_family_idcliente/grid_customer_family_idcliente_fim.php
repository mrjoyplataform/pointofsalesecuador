...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_customer_family_idcliente"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_customer_family_idcliente"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_customer_family_idcliente']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_customer_family_idcliente']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_customer_family_idcliente']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_customer_family_idcliente']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_customer_family_idcliente']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_customer_family_idcliente</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_customer_family_idcliente']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_customer_family_idcliente']['embutida_filho'] as $ind => $sc_init)
          {
