<?php
@session_start() ;
$_SESSION['scriptcase']['grid_sales_temp_uid']['sc_process_barr'] = true;
require_once('../grid_sales_temp_uid/index.php');
unset($_SESSION['scriptcase']['grid_sales_temp_uid']['sc_process_barr']);
$ExportCtrl = new grid_sales_temp_uid_export_control;
$ExportCtrl->Export_barr();

class grid_sales_temp_uid_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> sales_temp</TITLE>
