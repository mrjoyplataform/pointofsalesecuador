...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_purchase"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_purchase"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_purchase']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_purchase']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_purchase']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_purchase']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_purchase']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_purchase']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_purchase']['embutida_filho'] as $ind => $sc_init)
          {
