<?php
@session_start() ;
$_SESSION['scriptcase']['grid_purchase']['sc_process_barr'] = true;
require_once('../grid_purchase/index.php');
unset($_SESSION['scriptcase']['grid_purchase']['sc_process_barr']);
$ExportCtrl = new grid_purchase_export_control;
$ExportCtrl->Export_barr();

class grid_purchase_export_control
{
