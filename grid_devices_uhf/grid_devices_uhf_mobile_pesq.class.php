...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "iddevice";$Nm_numeric[] = "estado";$Nm_numeric[] = "iddevice";$Nm_numeric[] = "estado";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_dataid_cond" name="dataid_cond" onChange="nm_campos_between(document.getElementById('id_vis_dataid'), this, 'dataid')">
      ...
      <br><span id="id_hide_dataid"  <?php echo $str_hide_dataid?>><?php
      if ($dataid != "")
      {
      $dataid_look = substr($this->Db->qstr($dataid), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_iddevice_cond" name="iddevice_cond" onChange="nm_campos_between(document.getElementById('id_vis_iddevice'), this, 'iddevice')">
      ...
      <br><span id="id_hide_iddevice"  <?php echo $str_hide_iddevice?>><INPUT  type="text" id="SC_iddevice" name="iddevice" value="<?php echo NM_encode_input($iddevice) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
