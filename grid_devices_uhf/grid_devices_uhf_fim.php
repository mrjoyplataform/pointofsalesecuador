...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_devices_uhf"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_devices_uhf"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_devices_uhf']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_devices_uhf']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_devices_uhf']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_devices_uhf']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_devices_uhf']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_devices_uhf']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_devices_uhf']['embutida_filho'] as $ind => $sc_init)
          {
