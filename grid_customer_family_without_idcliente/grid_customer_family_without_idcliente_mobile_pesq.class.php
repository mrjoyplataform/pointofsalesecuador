...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fecha_nacimiento";$Nm_datas[] = "fecha_nacimiento";$Nm_numeric[] = "idfamily";$Nm_numeric[] = "edad_actual";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idfamily_cond" name="idfamily_cond" onChange="nm_campos_between(document.getElementById('id_vis_idfamily'), this, 'idfamily')">
      ...
      <br><span id="id_hide_idfamily"  <?php echo $str_hide_idfamily?>><INPUT  type="text" id="SC_idfamily" name="idfamily" value="<?php echo NM_encode_input($idfamily) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_parentesco_cond" name="parentesco_cond" onChange="nm_campos_between(document.getElementById('id_vis_parentesco'), this, 'parentesco')">
      ...
      <br><span id="id_hide_parentesco"  <?php echo $str_hide_parentesco?>><?php
      if ($parentesco != "")
      {
      $parentesco_look = substr($this->Db->qstr($parentesco), 1, -1); 
      $nmgp_def_dados = array(); 
