...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_product_listado"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_product_listado"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_product_listado']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_product_listado']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_product_listado']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_product_listado']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_product_listado']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_product_listado</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_product_listado']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_product_listado']['embutida_filho'] as $ind => $sc_init)
          {
