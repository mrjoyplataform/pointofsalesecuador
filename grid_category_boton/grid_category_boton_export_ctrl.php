<?php
@session_start() ;
$_SESSION['scriptcase']['grid_category_boton']['sc_process_barr'] = true;
require_once('../grid_category_boton/index.php');
unset($_SESSION['scriptcase']['grid_category_boton']['sc_process_barr']);
$ExportCtrl = new grid_category_boton_export_control;
$ExportCtrl->Export_barr();

class grid_category_boton_export_control
{
