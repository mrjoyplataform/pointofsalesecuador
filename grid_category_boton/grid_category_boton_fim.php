...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_category_boton"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_category_boton"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_category_boton']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_category_boton']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_category_boton']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_category_boton']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_category_boton']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_category_boton</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_category_boton']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_category_boton']['embutida_filho'] as $ind => $sc_init)
          {
