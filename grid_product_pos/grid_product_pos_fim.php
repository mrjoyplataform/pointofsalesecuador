...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_product_pos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_product_pos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_product_pos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_product_pos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_product_pos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_product_pos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_product_pos']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_product_pos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_product_pos']['embutida_filho'] as $ind => $sc_init)
          {
