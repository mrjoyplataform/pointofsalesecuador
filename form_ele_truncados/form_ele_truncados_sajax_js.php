  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ele_truncados" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_ele_truncados_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_ele_truncados_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ele_truncados_validate_id(var_id, var_script_case_init, do_ajax_form_ele_truncados_validate_id_cb);
  } // do_ajax_form_ele_truncados_validate_id

  function do_ajax_form_ele_truncados_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ele_truncados_validate_id_cb

  // ---------- Validate codigo
  function do_ajax_form_ele_truncados_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ele_truncados_validate_codigo(var_codigo, var_script_case_init, do_ajax_form_ele_truncados_validate_codigo_cb);
  } // do_ajax_form_ele_truncados_validate_codigo

  function do_ajax_form_ele_truncados_validate_codigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ele_truncados_validate_codigo_cb

  // ---------- Validate fecha
  function do_ajax_form_ele_truncados_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ele_truncados_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_ele_truncados_validate_fecha_cb);
  } // do_ajax_form_ele_truncados_validate_fecha

  function do_ajax_form_ele_truncados_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ele_truncados_validate_fecha_cb

  // ---------- Validate numero
  function do_ajax_form_ele_truncados_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ele_truncados_validate_numero(var_numero, var_script_case_init, do_ajax_form_ele_truncados_validate_numero_cb);
  } // do_ajax_form_ele_truncados_validate_numero

  function do_ajax_form_ele_truncados_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ele_truncados_validate_numero_cb

  // ---------- Validate observacion
  function do_ajax_form_ele_truncados_validate_observacion()
  {
    var nomeCampo_observacion = "observacion";
    var var_observacion = scAjaxGetFieldText(nomeCampo_observacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ele_truncados_validate_observacion(var_observacion, var_script_case_init, do_ajax_form_ele_truncados_validate_observacion_cb);
  } // do_ajax_form_ele_truncados_validate_observacion

  function do_ajax_form_ele_truncados_validate_observacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ele_truncados_validate_observacion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_ele_truncados_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_ele_truncados_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_ele_truncados_submit_form(var_id, var_codigo, var_fecha, var_numero, var_observacion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ele_truncados_submit_form_cb);
  } // do_ajax_form_ele_truncados_submit_form

  function do_ajax_form_ele_truncados_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_ele_truncados_submit_form_cb_after_alert);
  } // do_ajax_form_ele_truncados_submit_form_cb
  function do_ajax_form_ele_truncados_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ele_truncados_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_ele_truncados_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_ele_truncados_navigate_form, function() {});
    } else {
      perform_ajax_form_ele_truncados_navigate_form();
    }
  }

  function perform_ajax_form_ele_truncados_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_ele_truncados_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ele_truncados_navigate_form_cb);
  } // do_ajax_form_ele_truncados_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ele_truncados']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ele_truncados_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ele_truncados_navigate_form_cb_after_alert);
  } // do_ajax_form_ele_truncados_navigate_form_cb
  function do_ajax_form_ele_truncados_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_ele_truncados_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_ele_truncados_navigate_form_cb_after_alert

  function sc_hide_form_ele_truncados_form()
  {
