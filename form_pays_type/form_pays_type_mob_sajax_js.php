  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pays_type_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_pays_type_mob_form();
	}
...
?>
  ...
  // ---------- Validate idpays_type
  function do_ajax_form_pays_type_mob_validate_idpays_type()
  {
    var nomeCampo_idpays_type = "idpays_type";
    var var_idpays_type = scAjaxGetFieldText(nomeCampo_idpays_type);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pays_type_mob_validate_idpays_type(var_idpays_type, var_script_case_init, do_ajax_form_pays_type_mob_validate_idpays_type_cb);
  } // do_ajax_form_pays_type_mob_validate_idpays_type

  function do_ajax_form_pays_type_mob_validate_idpays_type_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idpays_type";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pays_type_mob_validate_idpays_type_cb

  // ---------- Validate descrip
  function do_ajax_form_pays_type_mob_validate_descrip()
  {
    var nomeCampo_descrip = "descrip";
    var var_descrip = scAjaxGetFieldText(nomeCampo_descrip);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pays_type_mob_validate_descrip(var_descrip, var_script_case_init, do_ajax_form_pays_type_mob_validate_descrip_cb);
  } // do_ajax_form_pays_type_mob_validate_descrip

  function do_ajax_form_pays_type_mob_validate_descrip_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "descrip";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pays_type_mob_validate_descrip_cb

  // ---------- Validate imagen
  function do_ajax_form_pays_type_mob_validate_imagen()
  {
    var nomeCampo_imagen = "imagen";
    var var_imagen = scAjaxGetFieldText(nomeCampo_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pays_type_mob_validate_imagen(var_imagen, var_script_case_init, do_ajax_form_pays_type_mob_validate_imagen_cb);
  } // do_ajax_form_pays_type_mob_validate_imagen

  function do_ajax_form_pays_type_mob_validate_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "imagen";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pays_type_mob_validate_imagen_cb

  // ---------- Validate tipo
  function do_ajax_form_pays_type_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldText(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pays_type_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_pays_type_mob_validate_tipo_cb);
  } // do_ajax_form_pays_type_mob_validate_tipo

  function do_ajax_form_pays_type_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pays_type_mob_validate_tipo_cb

  // ---------- Validate efectivo
  function do_ajax_form_pays_type_mob_validate_efectivo()
  {
    var nomeCampo_efectivo = "efectivo";
    var var_efectivo = scAjaxGetFieldText(nomeCampo_efectivo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pays_type_mob_validate_efectivo(var_efectivo, var_script_case_init, do_ajax_form_pays_type_mob_validate_efectivo_cb);
  } // do_ajax_form_pays_type_mob_validate_efectivo

  function do_ajax_form_pays_type_mob_validate_efectivo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "efectivo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pays_type_mob_validate_efectivo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_pays_type_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pays_type_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idpays_type = scAjaxGetFieldText("idpays_type");
    var var_descrip = scAjaxGetFieldText("descrip");
    var var_imagen = scAjaxGetFieldText("imagen");
    var var_tipo = scAjaxGetFieldText("tipo");
    var var_efectivo = scAjaxGetFieldText("efectivo");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_pays_type_mob_submit_form(var_idpays_type, var_descrip, var_imagen, var_tipo, var_efectivo, var_imagen_ul_name, var_imagen_ul_type, var_imagen_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_pays_type_mob_submit_form_cb);
  } // do_ajax_form_pays_type_mob_submit_form

  function do_ajax_form_pays_type_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idpays_type");
      scAjaxHideErrorDisplay("descrip");
      scAjaxHideErrorDisplay("imagen");
      scAjaxHideErrorDisplay("tipo");
      scAjaxHideErrorDisplay("efectivo");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_pays_type_mob_submit_form_cb_after_alert);
  } // do_ajax_form_pays_type_mob_submit_form_cb
  function do_ajax_form_pays_type_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pays_type_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_pays_type_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_pays_type_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_pays_type_mob_navigate_form();
    }
  }

  function perform_ajax_form_pays_type_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("tipo");
    scAjaxHideErrorDisplay("efectivo");
    var var_idpays_type = document.F2.idpays_type.value;
    ...
    scAjaxProcOn();
    x_ajax_form_pays_type_mob_navigate_form(var_idpays_type, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pays_type_mob_navigate_form_cb);
  } // do_ajax_form_pays_type_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pays_type_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pays_type_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idpays_type.value = scAjaxGetKeyValue("idpays_type");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pays_type_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_pays_type_mob_navigate_form_cb
  function do_ajax_form_pays_type_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_pays_type_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_pays_type_mob_navigate_form_cb_after_alert

  function sc_hide_form_pays_type_mob_form()
  {
  ...
  ajax_field_list[0] = "idpays_type";
  ajax_field_list[1] = "descrip";
  ajax_field_list[2] = "imagen";
  ajax_field_list[3] = "tipo";
  ajax_field_list[4] = "efectivo";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idpays_type": {"label": "Idpays Type", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "descrip": {"label": "Descrip", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "efectivo": {"label": "Efectivo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "idpays_type": new Array(),
    "descrip": new Array(),
    "imagen": new Array(),
    "tipo": new Array(),
    "efectivo": new Array()
  };
  ajax_field_mult["idpays_type"][1] = "idpays_type";
  ajax_field_mult["descrip"][1] = "descrip";
  ajax_field_mult["imagen"][1] = "imagen";
  ajax_field_mult["tipo"][1] = "tipo";
  ajax_field_mult["efectivo"][1] = "efectivo";

  var ajax_field_id = {
    "idpays_type": new Array("hidden_field_label_idpays_type", "hidden_field_data_idpays_type"),
    "descrip": new Array("hidden_field_label_descrip", "hidden_field_data_descrip"),
    ...
    "efectivo": new Array("hidden_field_label_efectivo", "hidden_field_data_efectivo")
  };
