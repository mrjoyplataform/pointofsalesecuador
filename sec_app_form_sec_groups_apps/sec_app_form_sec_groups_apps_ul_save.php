...
if (!isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['sec_app_form_sec_groups_apps']['upload_field_info']) || !isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['sec_app_form_sec_groups_apps']['upload_field_info'][ $_POST['param_field'] ]))
{
    exit;
}

$aUploadInfo = $_SESSION['sc_session'][ $_POST['param_seq'] ]['sec_app_form_sec_groups_apps']['upload_field_info'][ $_POST['param_field'] ];
