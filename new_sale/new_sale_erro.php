...
$old_error_handler = set_error_handler("new_sale_scriptcase_error_handler");

function new_sale_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['new_sale']['contr_erro']) && $_SESSION['scriptcase']['new_sale']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_new_sale->contr_new_sale->Apl_com_erro = true;
            if ($inicial_new_sale->contr_new_sale->NM_ajax_flag)
            {
                $inicial_new_sale->contr_new_sale->NM_ajax_info['errList']['geral_new_sale'][] = $msg;
                return;
            }
            new_sale_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function new_sale_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['new_sale'])  && '' != $_SESSION['scriptcase']['error_icon']['new_sale'])  ? $_SESSION['scriptcase']['error_icon']['new_sale']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['new_sale']) && '' != $_SESSION['scriptcase']['error_span_title']['new_sale']) ? $_SESSION['scriptcase']['error_span_title']['new_sale'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['new_sale']) && '' != $_SESSION['scriptcase']['error_icon_title']['new_sale']) ? $_SESSION['scriptcase']['error_icon_title']['new_sale'] : '';
?>
