  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_new_sale_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate pos
  function do_ajax_new_sale_mob_validate_pos()
  {
  } // do_ajax_new_sale_mob_validate_pos

  function do_ajax_new_sale_mob_validate_pos_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_new_sale_mob_validate_pos_cb

  // ---------- Validate last_sale
  function do_ajax_new_sale_mob_validate_last_sale()
  {
  } // do_ajax_new_sale_mob_validate_last_sale

  function do_ajax_new_sale_mob_validate_last_sale_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "last_sale";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_new_sale_mob_validate_last_sale_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_new_sale_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_new_sale_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_pos = scAjaxGetFieldHidden("pos");
    var var_last_sale = scAjaxGetFieldHidden("last_sale");
    ...
    scAjaxProcOn();
    x_ajax_new_sale_mob_submit_form(var_pos, var_last_sale, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_new_sale_mob_submit_form_cb);
  } // do_ajax_new_sale_mob_submit_form

  function do_ajax_new_sale_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_new_sale_mob_submit_form_cb_after_alert);
  } // do_ajax_new_sale_mob_submit_form_cb
  function do_ajax_new_sale_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_new_sale_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_new_sale_mob_navigate_form()
  {
    perform_ajax_new_sale_mob_navigate_form();
  }

  function perform_ajax_new_sale_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_new_sale_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['new_sale_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_new_sale_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_new_sale_mob_navigate_form_cb_after_alert);
  } // do_ajax_new_sale_mob_navigate_form_cb
  function do_ajax_new_sale_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_new_sale_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_new_sale_mob_navigate_form_cb_after_alert

  function sc_hide_new_sale_mob_form()
  {
  ...
  ajax_field_list[0] = "pos";
  ajax_field_list[1] = "last_sale";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "pos": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "last_sale": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["pos"][1] = "pos";
  ajax_field_mult["last_sale"][1] = "last_sale";

  var ajax_field_id = {
    "pos": new Array("hidden_field_label_pos", "hidden_field_data_pos"),
    "last_sale": new Array("hidden_field_label_last_sale", "hidden_field_data_last_sale")
  };
