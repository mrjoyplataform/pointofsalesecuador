...
class grid_detail_sales_todo_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_detail_sales_todo/grid_detail_sales_todo_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_detail_sales_todo_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_detail_sales_todo.zip";
          $this->Arquivo   .= "_grid_detail_sales_todo" . $this->Xls_tp;
          $this->Tit_doc    = "grid_detail_sales_todo" . $this->Xls_tp;
          $this->Tit_zip    = "grid_detail_sales_todo.zip";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      while (!$rs->EOF)
      {
         ...
         elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['SC_Ind_Groupby'] == "_NM_SC_")
         {
          ...
          {  
              if (isset($this->view_sales_detail_group_todo_producto_Old) && !$prim_gb)
              {
              ...
              if (isset($this->view_sales_detail_group_todo_cuentaventa_Old) && !$prim_gb)
              {
              ...
              if (isset($this->view_sales_detail_group_todo_fecha_Old) && !$prim_gb)
              {
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_view_sales_detail_group_todo_fecha()
   {
         ...
         $this->view_sales_detail_group_todo_fecha = substr($this->view_sales_detail_group_todo_fecha, 0, 10);
         if (empty($this->view_sales_detail_group_todo_fecha) || $this->view_sales_detail_group_todo_fecha == "0000-00-00")
         {
             if ($this->Use_phpspreadsheet) {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->view_sales_detail_group_todo_fecha, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
             }
             else {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->view_sales_detail_group_todo_fecha, PHPExcel_Cell_DataType::TYPE_STRING);
             }
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->view_sales_detail_group_todo_fecha);
   ...
   function NM_export_view_sales_detail_group_todo_cantidad()
   {
         ...
         if (is_numeric($this->view_sales_detail_group_todo_cantidad))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->view_sales_detail_group_todo_cantidad);
         $this->Xls_col++;
   }
   ...
   function NM_export_view_sales_detail_group_todo_unit_value()
   {
         ...
         if (is_numeric($this->view_sales_detail_group_todo_unit_value))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->view_sales_detail_group_todo_unit_value);
         $this->Xls_col++;
   }
   ...
   function NM_export_view_sales_detail_group_todo_producto()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->view_sales_detail_group_todo_producto, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->view_sales_detail_group_todo_producto, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- valor
   ...
   function NM_export_view_sales_detail_group_todo_cuentaventa()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->view_sales_detail_group_todo_cuentaventa, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->view_sales_detail_group_todo_cuentaventa, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sales_idcliente
   function NM_export_sales_idcliente()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sales_idcliente, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sales_idcliente, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sales_cliente
   function NM_export_sales_cliente()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sales_cliente, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sales_cliente, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sales_factura
   function NM_export_sales_factura()
   {
         ...
         if (is_numeric($this->sales_factura))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->sales_factura);
         $this->Xls_col++;
   }
   //----- customer_nombre
   function NM_export_customer_nombre()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->customer_nombre, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->customer_nombre, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- customer_correo
   function NM_export_customer_correo()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->customer_correo, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->customer_correo, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- customer_celular
   function NM_export_customer_celular()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->customer_celular, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->customer_celular, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- customer_direccion
   function NM_export_customer_direccion()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->customer_direccion, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->customer_direccion, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- customer_idcustomer
   function NM_export_customer_idcustomer()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->customer_idcustomer, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->customer_idcustomer, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- view_sales_detail_group_todo_fecha
   function NM_sub_cons_view_sales_detail_group_todo_fecha()
   {
         $this->view_sales_detail_group_todo_fecha = substr($this->view_sales_detail_group_todo_fecha, 0, 10);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->view_sales_detail_group_todo_fecha;
   ...
   //----- view_sales_detail_group_todo_cantidad
   function NM_sub_cons_view_sales_detail_group_todo_cantidad()
   {
         $this->view_sales_detail_group_todo_cantidad = NM_charset_to_utf8($this->view_sales_detail_group_todo_cantidad);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->view_sales_detail_group_todo_cantidad;
   ...
   //----- view_sales_detail_group_todo_unit_value
   function NM_sub_cons_view_sales_detail_group_todo_unit_value()
   {
         $this->view_sales_detail_group_todo_unit_value = NM_charset_to_utf8($this->view_sales_detail_group_todo_unit_value);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->view_sales_detail_group_todo_unit_value;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
   ...
   //----- view_sales_detail_group_todo_producto
   function NM_sub_cons_view_sales_detail_group_todo_producto()
   {
         $this->view_sales_detail_group_todo_producto = html_entity_decode($this->view_sales_detail_group_todo_producto, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->view_sales_detail_group_todo_producto = strip_tags($this->view_sales_detail_group_todo_producto);
         $this->view_sales_detail_group_todo_producto = NM_charset_to_utf8($this->view_sales_detail_group_todo_producto);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->view_sales_detail_group_todo_producto;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- view_sales_detail_group_todo_cuentaventa
   function NM_sub_cons_view_sales_detail_group_todo_cuentaventa()
   {
         $this->view_sales_detail_group_todo_cuentaventa = html_entity_decode($this->view_sales_detail_group_todo_cuentaventa, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->view_sales_detail_group_todo_cuentaventa = strip_tags($this->view_sales_detail_group_todo_cuentaventa);
         $this->view_sales_detail_group_todo_cuentaventa = NM_charset_to_utf8($this->view_sales_detail_group_todo_cuentaventa);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->view_sales_detail_group_todo_cuentaventa;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- sales_idcliente
   function NM_sub_cons_sales_idcliente()
   {
         $this->sales_idcliente = html_entity_decode($this->sales_idcliente, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sales_idcliente = strip_tags($this->sales_idcliente);
         $this->sales_idcliente = NM_charset_to_utf8($this->sales_idcliente);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sales_idcliente;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- sales_cliente
   function NM_sub_cons_sales_cliente()
   {
         $this->sales_cliente = html_entity_decode($this->sales_cliente, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sales_cliente = strip_tags($this->sales_cliente);
         $this->sales_cliente = NM_charset_to_utf8($this->sales_cliente);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sales_cliente;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- sales_factura
   function NM_sub_cons_sales_factura()
   {
         $this->sales_factura = NM_charset_to_utf8($this->sales_factura);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sales_factura;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- customer_nombre
   function NM_sub_cons_customer_nombre()
   {
         $this->customer_nombre = html_entity_decode($this->customer_nombre, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->customer_nombre = strip_tags($this->customer_nombre);
         $this->customer_nombre = NM_charset_to_utf8($this->customer_nombre);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->customer_nombre;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- customer_correo
   function NM_sub_cons_customer_correo()
   {
         $this->customer_correo = html_entity_decode($this->customer_correo, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->customer_correo = strip_tags($this->customer_correo);
         $this->customer_correo = NM_charset_to_utf8($this->customer_correo);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->customer_correo;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- customer_celular
   function NM_sub_cons_customer_celular()
   {
         $this->customer_celular = html_entity_decode($this->customer_celular, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->customer_celular = strip_tags($this->customer_celular);
         $this->customer_celular = NM_charset_to_utf8($this->customer_celular);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->customer_celular;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- customer_direccion
   function NM_sub_cons_customer_direccion()
   {
         $this->customer_direccion = html_entity_decode($this->customer_direccion, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->customer_direccion = strip_tags($this->customer_direccion);
         $this->customer_direccion = NM_charset_to_utf8($this->customer_direccion);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->customer_direccion;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- customer_idcustomer
   function NM_sub_cons_customer_idcustomer()
   {
         $this->customer_idcustomer = html_entity_decode($this->customer_idcustomer, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->customer_idcustomer = strip_tags($this->customer_idcustomer);
         $this->customer_idcustomer = NM_charset_to_utf8($this->customer_idcustomer);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->customer_idcustomer;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['nolabel'])
       {
 ...
 function quebra_view_sales_detail_group_todo_producto_inicial($view_sales_detail_group_todo_fecha, $view_sales_detail_group_todo_cuentaventa, $view_sales_detail_group_todo_producto) 
 {
   ...
   function quebra_view_sales_detail_group_todo_fecha_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
   ...
   function quebra_view_sales_detail_group_todo_fecha_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_view_sales_detail_group_todo_fecha_view_sales_detail_group_todo_cantidad;
               $prim_cmp = false;
           ...
           {
               $Format_Num = "#,##0.00";
               $Cmp_Tot    = $this->sum_view_sales_detail_group_todo_fecha_valor;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_view_sales_detail_group_todo_fecha_scgb_255_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       $temp_cmp = "";
       $cont_col = 0;
       foreach ($this->campos_quebra_view_sales_detail_group_todo_fecha_scgb_255 as $cada_campo) {
           if ($cont_col == $lim_col) {
               $temp_cmp = html_entity_decode($temp_cmp, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
               $temp_cmp = strip_tags($temp_cmp);
               $temp_cmp = NM_charset_to_utf8($temp_cmp);
   ...
   function quebra_view_sales_detail_group_todo_fecha_scgb_255_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_view_sales_detail_group_todo_fecha_scgb_255_view_sales_detail_group_todo_cantidad;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
           ...
           {
               $Format_Num = "#,##0.00";
               $Cmp_Tot    = $this->sum_view_sales_detail_group_todo_fecha_scgb_255_valor;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
   ...
   function quebra_view_sales_detail_group_todo_producto_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
   ...
   function quebra_view_sales_detail_group_todo_producto_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_view_sales_detail_group_todo_producto_view_sales_detail_group_todo_cantidad;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
           ...
           {
               $Format_Num = "#,##0.00";
               $Cmp_Tot    = $this->sum_view_sales_detail_group_todo_producto_valor;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
   ...
   function quebra_sales_cliente_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       $temp_cmp = "";
       $cont_col = 0;
       foreach ($this->campos_quebra_sales_cliente as $cada_campo) {
           if ($cont_col == $lim_col) {
               $temp_cmp = html_entity_decode($temp_cmp, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
               $temp_cmp = strip_tags($temp_cmp);
               $temp_cmp = NM_charset_to_utf8($temp_cmp);
   ...
   function quebra_sales_cliente_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_sales_cliente_view_sales_detail_group_todo_cantidad;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
           ...
           {
               $Format_Num = "#,##0.00";
               $Cmp_Tot    = $this->sum_sales_cliente_valor;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
   ...
   function quebra_view_sales_detail_group_todo_cuentaventa_inicial_bot()
   {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_view_sales_detail_group_todo_cuentaventa_view_sales_detail_group_todo_cantidad;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
           ...
           {
               $Format_Num = "#,##0.00";
               $Cmp_Tot    = $this->sum_view_sales_detail_group_todo_cuentaventa_valor;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
   ...
   function quebra_geral_sc_free_group_by_bot()
   {
       ...
       $prim_cmp = true;
       $mens_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['tot_geral'][1] . ")";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['field_order'] as $Cada_cmp)
       {
           if ($Cada_cmp == "view_sales_detail_group_todo_cantidad" && (!isset($this->NM_cmp_hidden['view_sales_detail_group_todo_cantidad']) || $this->NM_cmp_hidden['view_sales_detail_group_todo_cantidad'] != "off"))
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['tot_geral'][2];
               $prim_cmp = false;
           ...
           {
               $Format_Num = "#,##0.00";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['tot_geral'][3];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['xls_file'] = $this->Xls_f;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
