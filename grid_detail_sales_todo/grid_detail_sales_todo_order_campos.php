...
<?php
   ...
   $Ord_Cmp = new grid_detail_sales_todo_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detail_sales_todo_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['view_sales_detail_group_todo_fecha'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['view_sales_detail_group_todo_fecha'] = "cmp_maior_30_1";
   }
   else
   {
       $tab_def_campos['view_sales_detail_group_todo_fecha'] = "view_sales_detail_group_todo.fecha";
   }
   $tab_labels["view_sales_detail_group_todo_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["view_sales_detail_group_todo_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["view_sales_detail_group_todo_fecha"] : "Fecha";
   $tab_ger_campos['view_sales_detail_group_todo_cantidad'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['view_sales_detail_group_todo_cantidad'] = "cmp_maior_30_2";
   }
   else
   {
       $tab_def_campos['view_sales_detail_group_todo_cantidad'] = "view_sales_detail_group_todo.cantidad";
   }
   $tab_labels["view_sales_detail_group_todo_cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["view_sales_detail_group_todo_cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["view_sales_detail_group_todo_cantidad"] : "Cantidad";
   $tab_ger_campos['view_sales_detail_group_todo_unit_value'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['view_sales_detail_group_todo_unit_value'] = "cmp_maior_30_3";
   }
   else
   {
       $tab_def_campos['view_sales_detail_group_todo_unit_value'] = "view_sales_detail_group_todo.unit_value";
   }
   $tab_labels["view_sales_detail_group_todo_unit_value"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["view_sales_detail_group_todo_unit_value"])) ? $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["view_sales_detail_group_todo_unit_value"] : "Unit Value";
   $tab_ger_campos['view_sales_detail_group_todo_producto'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['view_sales_detail_group_todo_producto'] = "cmp_maior_30_4";
   }
   else
   {
       $tab_def_campos['view_sales_detail_group_todo_producto'] = "view_sales_detail_group_todo.producto";
   }
   $tab_labels["view_sales_detail_group_todo_producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["view_sales_detail_group_todo_producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["view_sales_detail_group_todo_producto"] : "Producto";
   ...
   {
       $tab_def_campos['valor'] = "unit_value*cantidad";
   }
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["valor"] : "Valor";
   $tab_ger_campos['view_sales_detail_group_todo_cuentaventa'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['view_sales_detail_group_todo_cuentaventa'] = "cmp_maior_30_5";
   }
   else
   {
       $tab_def_campos['view_sales_detail_group_todo_cuentaventa'] = "view_sales_detail_group_todo.cuentaventa";
   }
   $tab_labels["view_sales_detail_group_todo_cuentaventa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["view_sales_detail_group_todo_cuentaventa"])) ? $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["view_sales_detail_group_todo_cuentaventa"] : "Cuentaventa";
   $tab_ger_campos['sales_idcliente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['sales_idcliente'] = "sales_idcliente";
   }
   else
   {
       $tab_def_campos['sales_idcliente'] = "sales.idcliente";
   }
   $tab_labels["sales_idcliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["sales_idcliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["sales_idcliente"] : "Idcliente";
   $tab_ger_campos['sales_cliente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['sales_cliente'] = "sales_cliente";
   }
   else
   {
       $tab_def_campos['sales_cliente'] = "sales.cliente";
   }
   $tab_labels["sales_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["sales_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["sales_cliente"] : "Cliente";
   $tab_ger_campos['sales_factura'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['sales_factura'] = "sales_factura";
   }
   else
   {
       $tab_def_campos['sales_factura'] = "sales.factura";
   }
   $tab_labels["sales_factura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["sales_factura"])) ? $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["sales_factura"] : "Factura";
   $tab_ger_campos['customer_nombre'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['customer_nombre'] = "customer_nombre";
   }
   else
   {
       $tab_def_campos['customer_nombre'] = "customer.nombre";
   }
   $tab_labels["customer_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["customer_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["customer_nombre"] : "Nombre";
   $tab_ger_campos['customer_correo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['customer_correo'] = "customer_correo";
   }
   else
   {
       $tab_def_campos['customer_correo'] = "customer.correo";
   }
   $tab_labels["customer_correo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["customer_correo"])) ? $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["customer_correo"] : "Correo";
   $tab_ger_campos['customer_celular'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['customer_celular'] = "customer_celular";
   }
   else
   {
       $tab_def_campos['customer_celular'] = "customer.celular";
   }
   $tab_labels["customer_celular"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["customer_celular"])) ? $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["customer_celular"] : "Celular";
   $tab_ger_campos['customer_direccion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['customer_direccion'] = "customer_direccion";
   }
   else
   {
       $tab_def_campos['customer_direccion'] = "customer.direccion";
   }
   $tab_labels["customer_direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["customer_direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["customer_direccion"] : "Direccion";
   $tab_ger_campos['customer_idcustomer'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['customer_idcustomer'] = "customer_idcustomer";
   }
   else
   {
       $tab_def_campos['customer_idcustomer'] = "customer.idcustomer";
   }
   $tab_labels["customer_idcustomer"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["customer_idcustomer"])) ? $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['labels']["customer_idcustomer"] : "Idcustomer";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detail_sales_todo_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detail_sales_todo']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
