...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_view_sales_detail_group_todo_fecha_cond" name="view_sales_detail_group_todo_fecha_cond" onChange="nm_campos_between(document.getElementById('id_vis_view_sales_detail_group_todo_fecha'), this, 'view_sales_detail_group_todo_fecha')">
      ...
      <br><span id="id_hide_view_sales_detail_group_todo_fecha"  <?php echo $str_hide_view_sales_detail_group_todo_fecha?>>
<SPAN id="Nm_bi_dados_view_sales_detail_group_todo_fecha" style="display:none"></SPAN>
<SPAN id="opc_bi_TP_view_sales_detail_group_todo_fecha"  style="display:''">
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_view_sales_detail_group_todo_fecha"  <?php echo $str_display_view_sales_detail_group_todo_fecha; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_view_sales_detail_group_todo_id_product"  <?php echo $str_hide_view_sales_detail_group_todo_id_product?>>
<?php
...
?>
   <span id="idAjaxSelect_view_sales_detail_group_todo_id_product">
      <SELECT class="scFilterObjectEven" id="SC_view_sales_detail_group_todo_id_product" name="view_sales_detail_group_todo_id_product[]"  size="7" multiple>
<?php
         ...
         if (!empty($nm_opcao))
         {
            ...
            if (is_array($view_sales_detail_group_todo_id_product) && !empty($view_sales_detail_group_todo_id_product))
            {
               ...
               foreach ($view_sales_detail_group_todo_id_product as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $view_sales_detail_group_todo_id_product_sel = "selected";
                       break;
                   }
               }
            }
...
?>
 ...
 function limpa_form()
 {
   ...
   {
      if (document.F1.elements[i].name == 'view_sales_detail_group_todo_id_product[]')
      {
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "view_sales_detail_group_todo_id_product" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
