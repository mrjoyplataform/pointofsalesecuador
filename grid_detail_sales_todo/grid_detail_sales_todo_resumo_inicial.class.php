...
class grid_detail_sales_todo_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_view_sales_detail_group_todo_fecha;
   var $array_total_view_sales_detail_group_todo_cuentaventa;
   var $array_total_view_sales_detail_group_todo_producto;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_view_sales_detail_group_todo_fecha       = array();
      $this->array_total_view_sales_detail_group_todo_cuentaventa = array();
      $this->array_total_view_sales_detail_group_todo_producto    = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_detail_sales_todo']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_detail_sales_todo']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['contr_total_geral'] == "OK")
      {
          $this->array_total_view_sales_detail_group_todo_fecha = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['arr_total']['view_sales_detail_group_todo_fecha'];
          $this->array_total_view_sales_detail_group_todo_cuentaventa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['arr_total']['view_sales_detail_group_todo_cuentaventa'];
          $this->array_total_view_sales_detail_group_todo_producto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['arr_total']['view_sales_detail_group_todo_producto'];
      }
      else
      {
          $this->array_total_view_sales_detail_group_todo_fecha = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['tot_geral'][3];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['arr_total']['view_sales_detail_group_todo_fecha'] = $this->array_total_view_sales_detail_group_todo_fecha;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['arr_total']['view_sales_detail_group_todo_cuentaventa'] = $this->array_total_view_sales_detail_group_todo_cuentaventa;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['arr_total']['view_sales_detail_group_todo_producto'] = $this->array_total_view_sales_detail_group_todo_producto;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_use_label'])
       {
          $Lab_view_sales_detail_group_todo_fecha = "view_sales_detail_group_todo.fecha";
          $Lab_view_sales_detail_group_todo_cuentaventa = "view_sales_detail_group_todo.cuentaventa";
          $Lab_view_sales_detail_group_todo_producto = "view_sales_detail_group_todo.producto";
       }
       else
       {
       $Lab_view_sales_detail_group_todo_fecha = "Fecha";
       $Lab_view_sales_detail_group_todo_fecha =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", $Lab_view_sales_detail_group_todo_fecha);
       $Lab_view_sales_detail_group_todo_cuentaventa = "Cuentaventa";
       $Lab_view_sales_detail_group_todo_producto = "Producto";
       }
       $this->comp_field = array(
           $Lab_view_sales_detail_group_todo_fecha,
           $Lab_view_sales_detail_group_todo_cuentaventa,
           $Lab_view_sales_detail_group_todo_producto,
       );
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_fecha'] = $Lab_view_sales_detail_group_todo_fecha; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_cuentaventa'] = $Lab_view_sales_detail_group_todo_cuentaventa; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_producto'] = $Lab_view_sales_detail_group_todo_producto; 

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_fecha'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_cantidad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_cantidad'] = "Cantidad"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_unit_value']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_unit_value'] = "Unit Value"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_producto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_producto'] = "Producto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['valor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['valor'] = "Valor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_cuentaventa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_cuentaventa'] = "Cuentaventa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_idcliente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_idcliente'] = "Idcliente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_cliente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_cliente'] = "Cliente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_factura']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_factura'] = "Factura"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['customer_nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['customer_nombre'] = "Nombre"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['customer_correo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['customer_correo'] = "Correo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['customer_celular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['customer_celular'] = "Celular"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['customer_direccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['customer_direccion'] = "Direccion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['customer_idcustomer']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['customer_idcustomer'] = "Idcustomer"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_id_product']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_id_product'] = "Id Product"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_uniqueid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_uniqueid'] = "Uniqueid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_fecha_scgb_255']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_fecha_scgb_255'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_entrada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_entrada'] = "Entrada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_jugador']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_jugador'] = "Jugador"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_visitante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_visitante'] = "Visitante"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_tarjeta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_tarjeta'] = "Tarjeta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_tokens']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_tokens'] = "Tokens"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_minutos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_minutos'] = "Minutos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_comida']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_comida'] = "Comida"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_id_sales']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_id_sales'] = "Id Sales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_sales_price']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_sales_price'] = "Sales Price"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_sales_discount']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_sales_discount'] = "Sales Discount"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_total'] = "Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_datesales']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_datesales'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_id_status']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_id_status'] = "Id Status"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_idcaja']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_idcaja'] = "Idcaja"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_direccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_direccion'] = "Direccion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_telefono'] = "Telefono"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_serie']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_serie'] = "Serie"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_clave_acceso']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_clave_acceso'] = "Clave Acceso"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_enviosri']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_enviosri'] = "Enviosri"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_fechaenvio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_fechaenvio'] = "Fechaenvio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_uniqueid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_uniqueid'] = "Uniqueid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_estado'] = "Estado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_fechaid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_fechaid'] = "Fechaid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_importe_recibido']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_importe_recibido'] = "Importe Recibido"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_codigoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_codigoid'] = "Codigoid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_totalsinimpuestos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_totalsinimpuestos'] = "Total Sin Impuestos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_totaldescuento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_totaldescuento'] = "Total Descuento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_baseimponible']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_baseimponible'] = "Base Imponible"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_valoriva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_valoriva'] = "Valoriva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_importetotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_importetotal'] = "Importe Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_idpago']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_idpago'] = "Idpago"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_totalpago']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_totalpago'] = "Totalpago"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_cliente_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_cliente_email'] = "Cliente Email"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_idempleado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_idempleado'] = "Idempleado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_idturno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_idturno'] = "Idturno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_facturaxml']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_facturaxml'] = "Facturaxml"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_facturaxml64']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_facturaxml64'] = "Facturaxml 64"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_codpago_sri']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_codpago_sri'] = "Codpago Sri"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_imprime']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_imprime'] = "Imprime"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_comprobante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_comprobante'] = "Comprobante"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_facturapdf']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_facturapdf'] = "Facturapdf"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['customer_idinterno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['customer_idinterno'] = "Idinterno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['customer_tipodoc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['customer_tipodoc'] = "Tipodoc"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['customer_ult_fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['customer_ult_fecha'] = "Ult Fecha"; 
       }
       //-----
       $this->comp_field_nm = array(
           'view_sales_detail_group_todo_fecha' => 0,
           'view_sales_detail_group_todo_cuentaventa' => 1,
           'view_sales_detail_group_todo_producto' => 2,
       );
       ...
       //-----
       $this->comp_sum = array(
           2 => "Valor (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           3 => "Cantidad (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['summarizing_fields_order']['inicial']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['summarizing_fields_order']['inicial'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['summarizing_fields_order']['inicial'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['summarizing_fields_display']['inicial'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['summarizing_fields_display']['inicial'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['summarizing_fields_display']['inicial'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['summarizing_fields_display']['inicial'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['summarizing_fields_display']['inicial'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['summarizing_fields_display']['inicial'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['summarizing_fields_display']['inicial'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "valor", 'show' => true),
           3 => array('field' => "view_sales_detail_group_todo_cantidad", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_valor_sum",
           3 => "css_view_sales_detail_group_todo_cantidad_sum",
       );

       //-----
       $this->comp_sum_nm = array(
           2 => "valor_sum",
           3 => "view_sales_detail_group_todo_cantidad_sum",
       );

       //-----
       foreach ($this->array_total_view_sales_detail_group_todo_fecha as $i_view_sales_detail_group_todo_fecha => $d_view_sales_detail_group_todo_fecha) {
           if (!in_array($i_view_sales_detail_group_todo_fecha, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_view_sales_detail_group_todo_fecha[4] ] = $d_view_sales_detail_group_todo_fecha[3];
               $this->comp_label[0][ $d_view_sales_detail_group_todo_fecha[4] ] = $d_view_sales_detail_group_todo_fecha[3];
           }
           foreach ($this->array_total_view_sales_detail_group_todo_cuentaventa[$i_view_sales_detail_group_todo_fecha] as $i_view_sales_detail_group_todo_cuentaventa => $d_view_sales_detail_group_todo_cuentaventa) {
               if (!in_array($i_view_sales_detail_group_todo_cuentaventa, $this->comp_label[1][ $d_view_sales_detail_group_todo_fecha[4] ], true)) {
                   $this->comp_index[1][ $d_view_sales_detail_group_todo_cuentaventa[4] ] = $d_view_sales_detail_group_todo_cuentaventa[3];
                   $this->comp_label[1][ $d_view_sales_detail_group_todo_fecha[4] ][ $d_view_sales_detail_group_todo_cuentaventa[4] ] = $d_view_sales_detail_group_todo_cuentaventa[3];
               }
               foreach ($this->array_total_view_sales_detail_group_todo_producto[$i_view_sales_detail_group_todo_fecha][$i_view_sales_detail_group_todo_cuentaventa] as $i_view_sales_detail_group_todo_producto => $d_view_sales_detail_group_todo_producto) {
                   if (!in_array($i_view_sales_detail_group_todo_producto, $this->comp_label[2][ $d_view_sales_detail_group_todo_fecha[4] ][ $d_view_sales_detail_group_todo_cuentaventa[4] ], true)) {
                       $this->comp_index[2][ $d_view_sales_detail_group_todo_producto[4] ] = $d_view_sales_detail_group_todo_producto[3];
                       $this->comp_label[2][ $d_view_sales_detail_group_todo_fecha[4] ][ $d_view_sales_detail_group_todo_cuentaventa[4] ][ $d_view_sales_detail_group_todo_producto[4] ] = $d_view_sales_detail_group_todo_producto[3];
                   }
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'view_sales_detail_group_todo_fecha', 'prot' => '@aspass@'),
           array('name' => 'view_sales_detail_group_todo_cuentaventa', 'prot' => '@aspass@'),
           array('name' => 'view_sales_detail_group_todo_producto', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_view_sales_detail_group_todo_fecha => $l_view_sales_detail_group_todo_fecha) {
           if (isset($this->array_total_view_sales_detail_group_todo_fecha[$i_view_sales_detail_group_todo_fecha])) {
               $this->comp_group[$i_view_sales_detail_group_todo_fecha] = array();
           }
           foreach ($this->comp_label[1][$i_view_sales_detail_group_todo_fecha] as $i_view_sales_detail_group_todo_cuentaventa => $l_view_sales_detail_group_todo_cuentaventa) {
               if (isset($this->array_total_view_sales_detail_group_todo_cuentaventa[$i_view_sales_detail_group_todo_fecha][$i_view_sales_detail_group_todo_cuentaventa])) {
                   $this->comp_group[$i_view_sales_detail_group_todo_fecha][$i_view_sales_detail_group_todo_cuentaventa] = array();
               }
               foreach ($this->comp_label[2][$i_view_sales_detail_group_todo_fecha][$i_view_sales_detail_group_todo_cuentaventa] as $i_view_sales_detail_group_todo_producto => $l_view_sales_detail_group_todo_producto) {
                   if (isset($this->array_total_view_sales_detail_group_todo_producto[$i_view_sales_detail_group_todo_fecha][$i_view_sales_detail_group_todo_cuentaventa][$i_view_sales_detail_group_todo_producto])) {
                       $this->comp_group[$i_view_sales_detail_group_todo_fecha][$i_view_sales_detail_group_todo_cuentaventa][$i_view_sales_detail_group_todo_producto] = array();
                   }
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_view_sales_detail_group_todo_fecha;
       }
       elseif (1 == $level) {
           $return = $this->array_total_view_sales_detail_group_todo_cuentaventa;
       }
       elseif (2 == $level) {
           $return = $this->array_total_view_sales_detail_group_todo_producto;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_detail_sales_todo@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               'title'    => $this->getChartText(strip_tags("Valor (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'view_sales_detail_group_todo.fecha',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_view_sales_detail_group_todo_fecha)),
               'label_y'  => $this->getChartText(strip_tags("Valor (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
           ...
           '1|1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'view_sales_detail_group_todo.cuentaventa',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_view_sales_detail_group_todo_cuentaventa)),
               'label_y'  => $this->getChartText(strip_tags("Valor (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '1|2' => array(
           ...
           '2|1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'view_sales_detail_group_todo.producto',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_view_sales_detail_group_todo_producto)),
               'label_y'  => $this->getChartText(strip_tags("Valor (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2|2' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_detail_sales_todo_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_detail_sales_todo_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_detail_sales_todo_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_inicial("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_view_sales_detail_group_todo_fecha);
      ksort($this->array_total_view_sales_detail_group_todo_cuentaventa);
      ksort($this->array_total_view_sales_detail_group_todo_producto);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_detail_sales_todo/grid_detail_sales_todo_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_detail_sales_todo_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_detail_sales_todo_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_detail_sales_todo_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['num_css'] . '.css');
     ...
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_detail_sales_todo/grid_detail_sales_todo_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_detail_sales_todo/grid_detail_sales_todo_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_detail_sales_todo&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_detail_sales_todo/grid_detail_sales_todo_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_detail_sales_todo/grid_detail_sales_todo_config_graf_flash.php?nome_apl=grid_detail_sales_todo&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_detail_sales_todo_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rpdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['pdf'][] = "Rpdf_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_detail_sales_todo/grid_detail_sales_todo_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_detail_sales_todo&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rword_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['word'][] = "Rword_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_detail_sales_todo/grid_detail_sales_todo_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_detail_sales_todo']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_detail_sales_todo']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_detail_sales_todo_config_pivot.php?nome_apl=grid_detail_sales_todo&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_detail_sales_todo_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_detail_sales_todo/grid_detail_sales_todo_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $view_sales_detail_group_todo_fecha = $Busca_temp['view_sales_detail_group_todo_fecha']; 
          $tmp_pos = strpos($view_sales_detail_group_todo_fecha, "##@@");
          if ($tmp_pos !== false && !is_array($view_sales_detail_group_todo_fecha))
          {
              $view_sales_detail_group_todo_fecha = substr($view_sales_detail_group_todo_fecha, 0, $tmp_pos);
          }
          $view_sales_detail_group_todo_fecha_2 = $Busca_temp['view_sales_detail_group_todo_fecha_input_2']; 
          $view_sales_detail_group_todo_id_product = $Busca_temp['view_sales_detail_group_todo_id_product']; 
          $tmp_pos = strpos($view_sales_detail_group_todo_id_product, "##@@");
          if ($tmp_pos !== false && !is_array($view_sales_detail_group_todo_id_product))
          {
              $view_sales_detail_group_todo_id_product = substr($view_sales_detail_group_todo_id_product, 0, $tmp_pos);
          }
      } 
   ...
   //---- 
   function adiciona_registro($sum_view_sales_detail_group_todo_cantidad, $sum_valor, $quebra_view_sales_detail_group_todo_fecha, $quebra_view_sales_detail_group_todo_cuentaventa, $quebra_view_sales_detail_group_todo_producto, $quebra_view_sales_detail_group_todo_fecha_orig, $quebra_view_sales_detail_group_todo_cuentaventa_orig, $quebra_view_sales_detail_group_todo_producto_orig)
   {
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "
      if (!isset($this->array_total_view_sales_detail_group_todo_fecha[$quebra_view_sales_detail_group_todo_fecha_orig]))
      {
         $this->array_total_view_sales_detail_group_todo_fecha[$quebra_view_sales_detail_group_todo_fecha_orig][0] = 1;
         $this->array_total_view_sales_detail_group_todo_fecha[$quebra_view_sales_detail_group_todo_fecha_orig][1] = $sum_view_sales_detail_group_todo_cantidad;
         $this->array_total_view_sales_detail_group_todo_fecha[$quebra_view_sales_detail_group_todo_fecha_orig][2] = $sum_valor;
         $this->array_total_view_sales_detail_group_todo_fecha[$quebra_view_sales_detail_group_todo_fecha_orig][3] = $quebra_view_sales_detail_group_todo_fecha;
         $this->array_total_view_sales_detail_group_todo_fecha[$quebra_view_sales_detail_group_todo_fecha_orig][4] = $quebra_view_sales_detail_group_todo_fecha_orig;
      }
      else
      {
         $this->array_total_view_sales_detail_group_todo_fecha[$quebra_view_sales_detail_group_todo_fecha_orig][0]++;
         $this->array_total_view_sales_detail_group_todo_fecha[$quebra_view_sales_detail_group_todo_fecha_orig][1] = bcadd($this->array_total_view_sales_detail_group_todo_fecha[$quebra_view_sales_detail_group_todo_fecha_orig][1], $sum_view_sales_detail_group_todo_cantidad, 10);
         $this->array_total_view_sales_detail_group_todo_fecha[$quebra_view_sales_detail_group_todo_fecha_orig][2] = bcadd($this->array_total_view_sales_detail_group_todo_fecha[$quebra_view_sales_detail_group_todo_fecha_orig][2], $sum_valor, 10);
      }
      //----- Cuentaventa
      if (!isset($this->array_total_view_sales_detail_group_todo_cuentaventa[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig]))
      {
         $this->array_total_view_sales_detail_group_todo_cuentaventa[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig][0] = 1;
         $this->array_total_view_sales_detail_group_todo_cuentaventa[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig][1] = $sum_view_sales_detail_group_todo_cantidad;
         $this->array_total_view_sales_detail_group_todo_cuentaventa[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig][2] = $sum_valor;
         $this->array_total_view_sales_detail_group_todo_cuentaventa[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig][3] = $quebra_view_sales_detail_group_todo_cuentaventa;
         $this->array_total_view_sales_detail_group_todo_cuentaventa[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig][4] = $quebra_view_sales_detail_group_todo_cuentaventa_orig;
      }
      else
      {
         $this->array_total_view_sales_detail_group_todo_cuentaventa[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig][0]++;
         $this->array_total_view_sales_detail_group_todo_cuentaventa[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig][1] = bcadd($this->array_total_view_sales_detail_group_todo_cuentaventa[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig][1], $sum_view_sales_detail_group_todo_cantidad, 10);
         $this->array_total_view_sales_detail_group_todo_cuentaventa[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig][2] = bcadd($this->array_total_view_sales_detail_group_todo_cuentaventa[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig][2], $sum_valor, 10);
      }
      //----- Producto
      if (!isset($this->array_total_view_sales_detail_group_todo_producto[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig][$quebra_view_sales_detail_group_todo_producto_orig]))
      {
         $this->array_total_view_sales_detail_group_todo_producto[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig][$quebra_view_sales_detail_group_todo_producto_orig][0] = 1;
         $this->array_total_view_sales_detail_group_todo_producto[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig][$quebra_view_sales_detail_group_todo_producto_orig][1] = $sum_view_sales_detail_group_todo_cantidad;
         $this->array_total_view_sales_detail_group_todo_producto[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig][$quebra_view_sales_detail_group_todo_producto_orig][2] = $sum_valor;
         $this->array_total_view_sales_detail_group_todo_producto[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig][$quebra_view_sales_detail_group_todo_producto_orig][3] = $quebra_view_sales_detail_group_todo_producto;
         $this->array_total_view_sales_detail_group_todo_producto[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig][$quebra_view_sales_detail_group_todo_producto_orig][4] = $quebra_view_sales_detail_group_todo_producto_orig;
      }
      else
      {
         $this->array_total_view_sales_detail_group_todo_producto[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig][$quebra_view_sales_detail_group_todo_producto_orig][0]++;
         $this->array_total_view_sales_detail_group_todo_producto[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig][$quebra_view_sales_detail_group_todo_producto_orig][1] = bcadd($this->array_total_view_sales_detail_group_todo_producto[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig][$quebra_view_sales_detail_group_todo_producto_orig][1], $sum_view_sales_detail_group_todo_cantidad, 10);
         $this->array_total_view_sales_detail_group_todo_producto[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig][$quebra_view_sales_detail_group_todo_producto_orig][2] = bcadd($this->array_total_view_sales_detail_group_todo_producto[$quebra_view_sales_detail_group_todo_fecha_orig][$quebra_view_sales_detail_group_todo_cuentaventa_orig][$quebra_view_sales_detail_group_todo_producto_orig][2], $sum_valor, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'view_sales_detail_group_todo_fecha');
     $campos_order = $this->Ini->Get_date_order_groupby("view_sales_detail_group_todo.fecha", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'view_sales_detail_group_todo_cuentaventa');
     $campos_order = $this->Ini->Get_date_order_groupby("view_sales_detail_group_todo.cuentaventa", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'view_sales_detail_group_todo_producto');
     $campos_order = $this->Ini->Get_date_order_groupby("view_sales_detail_group_todo.producto", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->view_sales_detail_group_todo_fecha = $rs_res->fields[0] ;  
            $this->view_sales_detail_group_todo_cantidad = $rs_res->fields[1] ;  
            $this->view_sales_detail_group_todo_cantidad =  str_replace(",", ".", $this->view_sales_detail_group_todo_cantidad);
            $this->view_sales_detail_group_todo_unit_value = $rs_res->fields[2] ;  
            $this->view_sales_detail_group_todo_unit_value =  str_replace(",", ".", $this->view_sales_detail_group_todo_unit_value);
            $this->view_sales_detail_group_todo_producto = $rs_res->fields[3] ;  
            $this->valor = $rs_res->fields[4] ;  
            $this->valor =  str_replace(",", ".", $this->valor);
            $this->view_sales_detail_group_todo_cuentaventa = $rs_res->fields[5] ;  
            $this->sales_idcliente = $rs_res->fields[6] ;  
            $this->sales_cliente = $rs_res->fields[7] ;  
            $this->sales_factura = $rs_res->fields[8] ;  
            $this->customer_nombre = $rs_res->fields[9] ;  
            $this->customer_correo = $rs_res->fields[10] ;  
            $this->customer_celular = $rs_res->fields[11] ;  
            $this->customer_direccion = $rs_res->fields[12] ;  
            $this->customer_idcustomer = $rs_res->fields[13] ;  
            ...
            $this->view_sales_detail_group_todo_fecha_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->view_sales_detail_group_todo_fecha, $Format_tst);
            $this->view_sales_detail_group_todo_fecha = $this->Ini->GB_date_format($TP_Time . $this->view_sales_detail_group_todo_fecha, $Format_tst, $Prefix_dat, "N", "F/Y");
            $this->view_sales_detail_group_todo_cuentaventa_orig = $this->view_sales_detail_group_todo_cuentaventa;
            $this->view_sales_detail_group_todo_producto_orig = $this->view_sales_detail_group_todo_producto;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->view_sales_detail_group_todo_cantidad, $this->valor, $this->view_sales_detail_group_todo_fecha, $this->view_sales_detail_group_todo_cuentaventa, $this->view_sales_detail_group_todo_producto, $this->view_sales_detail_group_todo_fecha_orig,  $this->view_sales_detail_group_todo_cuentaventa_orig,  $this->view_sales_detail_group_todo_producto_orig);
            }
   }
//
