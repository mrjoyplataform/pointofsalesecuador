...
class grid_detail_sales_todo_json
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_detail_sales_todo/grid_detail_sales_todo_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_format'];
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_return']);
      ...
      $this->Arquivo     .= ".json";
      $this->Tit_doc      = "grid_detail_sales_todo.json";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_name'] .= ".json";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_name']);
      }
      ...
      { 
          ...
          { 
              ...
              require_once($this->Ini->path_aplicacao . "grid_detail_sales_todo_res_json.class.php");
              $this->Res = new grid_detail_sales_todo_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_res_grid']);
          } 
      }
   ...
   function NM_export_view_sales_detail_group_todo_fecha()
   {
         ...
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->view_sales_detail_group_todo_fecha;
   }
   ...
   function NM_export_view_sales_detail_group_todo_cantidad()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->view_sales_detail_group_todo_cantidad;
   }
   ...
   function NM_export_view_sales_detail_group_todo_unit_value()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->view_sales_detail_group_todo_unit_value;
   }
   ...
   function NM_export_view_sales_detail_group_todo_producto()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->view_sales_detail_group_todo_producto;
   }
   //----- valor
   ...
   function NM_export_view_sales_detail_group_todo_cuentaventa()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->view_sales_detail_group_todo_cuentaventa;
   }
   //----- sales_idcliente
   function NM_export_sales_idcliente()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->sales_idcliente;
   }
   //----- sales_cliente
   function NM_export_sales_cliente()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->sales_cliente;
   }
   //----- sales_factura
   function NM_export_sales_factura()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->sales_factura;
   }
   //----- customer_nombre
   function NM_export_customer_nombre()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->customer_nombre;
   }
   //----- customer_correo
   function NM_export_customer_correo()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->customer_correo;
   }
   //----- customer_celular
   function NM_export_customer_celular()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->customer_celular;
   }
   //----- customer_direccion
   function NM_export_customer_direccion()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->customer_direccion;
   }
   //----- customer_idcustomer
   function NM_export_customer_idcustomer()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->customer_idcustomer;
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
