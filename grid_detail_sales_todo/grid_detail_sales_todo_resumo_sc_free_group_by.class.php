...
class grid_detail_sales_todo_resumo
{
   ...
   var $array_total_view_sales_detail_group_todo_fecha_scgb_255;
   var $array_total_view_sales_detail_group_todo_producto;
   var $array_total_sales_cliente;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_view_sales_detail_group_todo_fecha_scgb_255 = array();
      $this->array_total_view_sales_detail_group_todo_producto       = array();
      $this->array_total_sales_cliente                               = array();
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['tot_geral'][3];
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['arr_total']['view_sales_detail_group_todo_fecha_scgb_255'] = $this->array_total_view_sales_detail_group_todo_fecha_scgb_255;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['arr_total']['sales_cliente'] = $this->array_total_sales_cliente;
   ...
   function completeMatrix()
   {
       ...
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['json_use_label'])
       {
          ...
          $Lab_view_sales_detail_group_todo_fecha_scgb_255 = "view_sales_detail_group_todo_fecha_scgb_255";
          $Lab_view_sales_detail_group_todo_producto = "view_sales_detail_group_todo.producto";
          $Lab_sales_cliente = "sales.cliente";
       }
       else
       {
       $Lab_view_sales_detail_group_todo_fecha = "Fecha";
       $Lab_view_sales_detail_group_todo_fecha =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", $Lab_view_sales_detail_group_todo_fecha);
       $Lab_view_sales_detail_group_todo_fecha_scgb_255 = "Fecha";
       $Lab_view_sales_detail_group_todo_fecha_scgb_255 =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYWEEK'] . "", $Lab_view_sales_detail_group_todo_fecha_scgb_255);
       $Lab_view_sales_detail_group_todo_producto = "Producto";
       $Lab_sales_cliente = "Cliente";
       }
       $prep_field = array();
       $prep_field['view_sales_detail_group_todo_fecha'] = $Lab_view_sales_detail_group_todo_fecha;
       ...
       $prep_field['view_sales_detail_group_todo_fecha_scgb_255'] = $Lab_view_sales_detail_group_todo_fecha_scgb_255;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['view_sales_detail_group_todo_fecha_scgb_255'] = $Lab_view_sales_detail_group_todo_fecha_scgb_255; 
       $prep_field['view_sales_detail_group_todo_producto'] = $Lab_view_sales_detail_group_todo_producto;
       ...
       $prep_field['sales_cliente'] = $Lab_sales_cliente;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['labels']['sales_cliente'] = $Lab_sales_cliente; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       $this->comp_sum = array(
           ...
           3 => "Valor (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "view_sales_detail_group_todo_cantidad", 'show' => true),
           3 => array('field' => "valor", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_view_sales_detail_group_todo_cantidad_sum",
           3 => "css_valor_sum",
       );

       //-----
       $this->comp_sum_nm = array(
           2 => "view_sales_detail_group_todo_cantidad_sum",
           3 => "valor_sum",
       );
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['view_sales_detail_group_todo_fecha']['alin'] = "''";
       $Arr_parms['view_sales_detail_group_todo_fecha']['link'] = "S";
       $Arr_parms['view_sales_detail_group_todo_fecha_scgb_255']['alin'] = "''";
       $Arr_parms['view_sales_detail_group_todo_fecha_scgb_255']['link'] = "S";
       $Arr_parms['view_sales_detail_group_todo_producto']['alin'] = "''";
       $Arr_parms['view_sales_detail_group_todo_producto']['link'] = "S";
       $Arr_parms['sales_cliente']['alin'] = "''";
       $Arr_parms['sales_cliente']['link'] = "S";
       $Arr_parms['view_sales_detail_group_todo_fecha']['fill'] = "true";
       $Arr_parms['view_sales_detail_group_todo_fecha']['order'] = "value";
       $Arr_parms['view_sales_detail_group_todo_fecha']['order_start'] = 'asc';
       $Arr_parms['view_sales_detail_group_todo_fecha']['order_invert'] = 'false';
       $Arr_parms['view_sales_detail_group_todo_fecha']['order_enabled'] = 'true';
       $Arr_parms['view_sales_detail_group_todo_fecha']['order_datatype'] = 'date';
       $Arr_parms['view_sales_detail_group_todo_fecha_scgb_255']['fill'] = "true";
       $Arr_parms['view_sales_detail_group_todo_fecha_scgb_255']['order'] = "value";
       $Arr_parms['view_sales_detail_group_todo_fecha_scgb_255']['order_start'] = 'asc';
       $Arr_parms['view_sales_detail_group_todo_fecha_scgb_255']['order_invert'] = 'false';
       $Arr_parms['view_sales_detail_group_todo_fecha_scgb_255']['order_enabled'] = 'true';
       $Arr_parms['view_sales_detail_group_todo_fecha_scgb_255']['order_datatype'] = 'date';
       $Arr_parms['view_sales_detail_group_todo_producto']['fill'] = "true";
       $Arr_parms['view_sales_detail_group_todo_producto']['order'] = "label";
       $Arr_parms['view_sales_detail_group_todo_producto']['order_start'] = 'asc';
       $Arr_parms['view_sales_detail_group_todo_producto']['order_invert'] = 'false';
       $Arr_parms['view_sales_detail_group_todo_producto']['order_enabled'] = 'true';
       $Arr_parms['view_sales_detail_group_todo_producto']['order_datatype'] = 'varchar';
       $Arr_parms['sales_cliente']['fill'] = "true";
       $Arr_parms['sales_cliente']['order'] = "label";
       $Arr_parms['sales_cliente']['order_start'] = 'asc';
       $Arr_parms['sales_cliente']['order_invert'] = 'false';
       $Arr_parms['sales_cliente']['order_enabled'] = 'true';
       $Arr_parms['sales_cliente']['order_datatype'] = 'varchar';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['view_sales_detail_group_todo_fecha'] = array(0 => 'view_sales_detail_group_todo_fecha', 1 => '@aspass@');
       $prep_links_fl['view_sales_detail_group_todo_fecha_scgb_255'] = array(0 => 'view_sales_detail_group_todo_fecha_scgb_255', 1 => '@aspass@');
       $prep_links_fl['view_sales_detail_group_todo_producto'] = array(0 => 'view_sales_detail_group_todo_producto', 1 => '@aspass@');
       $prep_links_fl['sales_cliente'] = array(0 => 'sales_cliente', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['pivot_order_level'] = 0;
       }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           'view_sales_detail_group_todo_fecha_scgb_255' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Cantidad (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'view_sales_detail_group_todo_fecha_scgb_255',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_view_sales_detail_group_todo_fecha_scgb_255)),
               'label_y'  => $this->getChartText(strip_tags("Cantidad (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           'view_sales_detail_group_todo_producto' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Cantidad (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'view_sales_detail_group_todo_producto',
               'field_y'  => $this->comp_sum_nm[2],
           ...
           '1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'sales_cliente',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_sales_cliente)),
               'label_y'  => $this->getChartText(strip_tags("Cantidad (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
...
{ 
   ...
   $nm_saida->saida("          nm_submit_modal(\"" . $this->Ini->path_link . "grid_detail_sales_todo/grid_detail_sales_todo_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['SC_Gb_Free_cmp']))
      {
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_view_sales_detail_group_todo_cantidad, $sum_valor, $quebra_view_sales_detail_group_todo_fecha, $quebra_view_sales_detail_group_todo_fecha_scgb_255, $quebra_view_sales_detail_group_todo_producto, $quebra_sales_cliente, $quebra_view_sales_detail_group_todo_fecha_orig, $quebra_view_sales_detail_group_todo_fecha_scgb_255_orig, $quebra_view_sales_detail_group_todo_producto_orig, $quebra_sales_cliente_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          $cmp_look   = "Cmp_formt";
          $cmp_orig   = "Cmp_arg";
          if (empty($sum_view_sales_detail_group_todo_cantidad)) {$sum_view_sales_detail_group_todo_cantidad = '0';}
          if (empty($sum_valor)) {$sum_valor = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_view_sales_detail_group_todo_cantidad . ';
              $this->' . $arr_name . '[2] = ' . $sum_valor . ';
          ...
          {
              $this->' . $arr_name . '[0]++;
              $this->' . $arr_name . '[1] = bcadd($this->' . $arr_name . '[1], ' . $sum_view_sales_detail_group_todo_cantidad . ', 10);
              $this->' . $arr_name . '[2] = bcadd($this->' . $arr_name . '[2], ' . $sum_valor . ', 10);
          }
          ');
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->view_sales_detail_group_todo_fecha_orig = $this->view_sales_detail_group_todo_fecha;
            $this->view_sales_detail_group_todo_fecha_scgb_255_orig = $this->view_sales_detail_group_todo_fecha_scgb_255;
            $this->view_sales_detail_group_todo_producto_orig = $this->view_sales_detail_group_todo_producto;
            $this->sales_cliente_orig = $this->sales_cliente;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->view_sales_detail_group_todo_cantidad, $this->valor, $this->view_sales_detail_group_todo_fecha, $this->view_sales_detail_group_todo_fecha_scgb_255, $this->view_sales_detail_group_todo_producto, $this->sales_cliente, $this->view_sales_detail_group_todo_fecha_orig,  $this->view_sales_detail_group_todo_fecha_scgb_255_orig,  $this->view_sales_detail_group_todo_producto_orig,  $this->sales_cliente_orig);
            }
   }
//
