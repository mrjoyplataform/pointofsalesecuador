...
Table_sv_fil[0] = "view_sales_detail_group_todo_fecha";
Table_sv_fil[1] = "view_sales_detail_group_todo_id_product";
function ajax_select_filter(parm)
{
    ...
    $.ajax({
     ...
     .done(function(json_sel_fil) {
        ...
        if ($("#SC_view_sales_detail_group_todo_fecha_cond") && search_get_sel_txt("SC_view_sales_detail_group_todo_fecha_cond").substring(0, 3) == "bi_") {
            formata_bi_view_sales_detail_group_todo_fecha(search_get_sel_txt("SC_view_sales_detail_group_todo_fecha_cond"), SC_view_sales_detail_group_todo_fecha_bi_opc, SC_view_sales_detail_group_todo_fecha_bi_dt);
        }
