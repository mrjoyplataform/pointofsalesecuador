...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $prep_label    = array();
      $prep_label['view_sales_detail_group_todo_fecha'] = "" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "";
      $prep_label['view_sales_detail_group_todo_fecha_scgb_255'] = "" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYWEEK'] . "";
      $prep_label['view_sales_detail_group_todo_producto'] = "Producto";
      $prep_label['sales_cliente'] = "Cliente";
      $x = 0;
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['contr_label_graf'][$cmp_gb]) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['contr_label_graf'][$cmp_gb]))
          {
             $this->label[$x] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detail_sales_todo']['contr_label_graf'][$cmp_gb];
          }
          $x++;
      }
   }
