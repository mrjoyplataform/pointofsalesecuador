<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detail_sales_todo']['sc_process_barr'] = true;
require_once('../grid_detail_sales_todo/index.php');
unset($_SESSION['scriptcase']['grid_detail_sales_todo']['sc_process_barr']);
$ExportCtrl = new grid_detail_sales_todo_export_control;
$ExportCtrl->Export_barr();

class grid_detail_sales_todo_export_control
{
