...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_detail_sales_todo"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_detail_sales_todo"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detail_sales_todo']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detail_sales_todo']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detail_sales_todo']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detail_sales_todo']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detail_sales_todo']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detail_sales_todo</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detail_sales_todo']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detail_sales_todo']['embutida_filho'] as $ind => $sc_init)
          {
