<?php
@session_start() ;
$_SESSION['scriptcase']['grid_xml_compras_hdr']['sc_process_barr'] = true;
require_once('../grid_xml_compras_hdr/index.php');
unset($_SESSION['scriptcase']['grid_xml_compras_hdr']['sc_process_barr']);
$ExportCtrl = new grid_xml_compras_hdr_export_control;
$ExportCtrl->Export_barr();

class grid_xml_compras_hdr_export_control
{
