...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = " #lowerI#";
      $nm_fim_lower = "#lowerF#";
      $Nm_datas[] = "fechaEmision";$Nm_datas[] = "fechaEmision";$Nm_numeric[] = "totalsinimpuestos";$Nm_numeric[] = "totaldescuento";$Nm_numeric[] = "totalconimpuestos";$Nm_numeric[] = "propina";$Nm_numeric[] = "importetotal";$Nm_numeric[] = "estado";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_fechaemision_cond" name="fechaemision_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechaemision'), this, 'fechaemision')">
      ...
      <br><span id="id_hide_fechaemision"  <?php echo $str_hide_fechaemision?>>
<SPAN id="Nm_bi_dados_fechaemision" style="display:none"></SPAN>
<SPAN id="opc_bi_TP_fechaemision"  style="display:''">
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_fechaemision"  <?php echo $str_display_fechaemision; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_razonsocial_cond" name="razonsocial_cond" onChange="nm_campos_between(document.getElementById('id_vis_razonsocial'), this, 'razonsocial')">
      ...
      <br><span id="id_hide_razonsocial"  <?php echo $str_hide_razonsocial?>><?php
      if ($razonsocial != "")
      {
      $razonsocial_look = substr($this->Db->qstr($razonsocial), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_ruc_cond" name="ruc_cond" onChange="nm_campos_between(document.getElementById('id_vis_ruc'), this, 'ruc')">
      ...
      <br><span id="id_hide_ruc"  <?php echo $str_hide_ruc?>><?php
      if ($ruc != "")
      {
      $ruc_look = substr($this->Db->qstr($ruc), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_tipodoc_cond" name="tipodoc_cond" onChange="nm_campos_between(document.getElementById('id_vis_tipodoc'), this, 'tipodoc')">
      ...
      <br><span id="id_hide_tipodoc"  <?php echo $str_hide_tipodoc?>><?php
      if ($tipodoc != "")
      {
      $tipodoc_look = substr($this->Db->qstr($tipodoc), 1, -1); 
      $nmgp_def_dados = array(); 
