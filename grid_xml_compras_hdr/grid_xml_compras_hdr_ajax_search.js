...
Table_sv_fil[0] = "fechaemision";
Table_sv_fil[1] = "razonsocial";
Table_sv_fil[2] = "ruc";
Table_sv_fil[3] = "tipodoc";
function ajax_select_filter(parm)
{
    ...
    $.ajax({
     ...
     .done(function(json_sel_fil) {
        ...
        if ($("#SC_fechaemision_cond") && search_get_sel_txt("SC_fechaemision_cond").substring(0, 3) == "bi_") {
            formata_bi_fechaemision(search_get_sel_txt("SC_fechaemision_cond"), SC_fechaemision_bi_opc, SC_fechaemision_bi_dt);
        }
