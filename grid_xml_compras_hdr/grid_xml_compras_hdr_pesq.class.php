...
class grid_xml_compras_hdr_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_xml_compras_hdr_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_xml_compras_hdr_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_xml_compras_hdr_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_razonsocial')
      {
          $razonsocial = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_razonsocial($razonsocial);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_ruc')
      {
          $ruc = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_ruc($ruc);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_tipodoc')
      {
          $tipodoc = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_tipodoc($tipodoc);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      $Nm_datas[] = "fechaEmision";$Nm_datas[] = "fechaEmision";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> xml_compras_hdr</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_xml_compras_hdr/grid_xml_compras_hdr_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_xml_compras_hdr_ajax_search.js"></script>
 <script type="text/javascript" src="grid_xml_compras_hdr_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_xml_compras_hdr_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_xml_compras_hdr']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_xml_compras_hdr']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_fechaemision_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_fechaemision_dia').value + '/';
          var_dt_ini += document.getElementById('SC_fechaemision_mes').value + '/';
          var_dt_ini += document.getElementById('SC_fechaemision_ano').value;
          document.getElementById('sc_fechaemision_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_fechaemision_dia').value = aParts[0];
          document.getElementById('SC_fechaemision_mes').value = aParts[1];
          document.getElementById('SC_fechaemision_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_fechaemision_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_fechaemision_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_fechaemision_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_fechaemision_input_2_ano').value;
          document.getElementById('sc_fechaemision_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_fechaemision_input_2_dia').value = aParts[0];
          document.getElementById('SC_fechaemision_input_2_mes').value = aParts[1];
          document.getElementById('SC_fechaemision_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_fechaemision_cond#NMF#' + search_get_sel_txt('SC_fechaemision_cond') + '@NMF@';
  opc = search_get_sel_txt('SC_fechaemision_cond');
  if (opc.substring(0, 3) != "bi_")
  {
      str_out += 'SC_fechaemision_dia#NMF#' + search_get_sel_txt('SC_fechaemision_dia') + '@NMF@';
      str_out += 'SC_fechaemision_mes#NMF#' + search_get_sel_txt('SC_fechaemision_mes') + '@NMF@';
      str_out += 'SC_fechaemision_ano#NMF#' + search_get_sel_txt('SC_fechaemision_ano') + '@NMF@';
      str_out += 'SC_fechaemision_input_2_dia#NMF#' + search_get_sel_txt('SC_fechaemision_input_2_dia') + '@NMF@';
      str_out += 'SC_fechaemision_input_2_mes#NMF#' + search_get_sel_txt('SC_fechaemision_input_2_mes') + '@NMF@';
      str_out += 'SC_fechaemision_input_2_ano#NMF#' + search_get_sel_txt('SC_fechaemision_input_2_ano') + '@NMF@';
  }
  str_out += 'SC_razonsocial_cond#NMF#' + search_get_sel_txt('SC_razonsocial_cond') + '@NMF@';
  str_out += 'SC_razonsocial#NMF#' + search_get_text('SC_razonsocial') + '@NMF@';
  str_out += 'id_ac_razonsocial#NMF#' + search_get_text('id_ac_razonsocial') + '@NMF@';
  str_out += 'SC_ruc_cond#NMF#' + search_get_sel_txt('SC_ruc_cond') + '@NMF@';
  str_out += 'SC_ruc#NMF#' + search_get_text('SC_ruc') + '@NMF@';
  str_out += 'id_ac_ruc#NMF#' + search_get_text('id_ac_ruc') + '@NMF@';
  str_out += 'SC_tipodoc_cond#NMF#' + search_get_sel_txt('SC_tipodoc_cond') + '@NMF@';
  str_out += 'SC_tipodoc#NMF#' + search_get_text('SC_tipodoc') + '@NMF@';
  str_out += 'id_ac_tipodoc#NMF#' + search_get_text('id_ac_tipodoc') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_tipodoc").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_tipodoc").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_tipodoc",
          max_itens: "10",
          cod_desc: "N",
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_tipodoc").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_ruc").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_ruc").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_ruc",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
   ...
   scClass = $("#id_ac_razonsocial").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_razonsocial").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_razonsocial",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_razonsocial").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> xml_compras_hdr</div>
...
<?php
   ...
   {
      global 
             $fechaemision_cond, $fechaemision, $fechaemision_dia, $fechaemision_mes, $fechaemision_ano, $fechaemision_input_2_dia, $fechaemision_input_2_mes, $fechaemision_input_2_ano,
             $razonsocial_cond, $razonsocial, $razonsocial_autocomp,
             $ruc_cond, $ruc, $ruc_autocomp,
             $tipodoc_cond, $tipodoc, $tipodoc_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $fechaemision_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['fechaemision_dia']; 
          $fechaemision_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['fechaemision_mes']; 
          $fechaemision_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['fechaemision_ano']; 
          $fechaemision_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['fechaemision_input_2_dia']; 
          $fechaemision_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['fechaemision_input_2_mes']; 
          $fechaemision_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['fechaemision_input_2_ano']; 
          $fechaemision_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['fechaemision_cond']; 
          $razonsocial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['razonsocial']; 
          $razonsocial_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['razonsocial_cond']; 
          $ruc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['ruc']; 
          $ruc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['ruc_cond']; 
          $tipodoc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['tipodoc']; 
          $tipodoc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['tipodoc_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['NM_operador']; 
      } 
      if (!isset($fechaemision_cond) || empty($fechaemision_cond))
      {
         $fechaemision_cond = "eq";
      }
      if (!isset($razonsocial_cond) || empty($razonsocial_cond))
      {
         $razonsocial_cond = "qp";
      }
      if (!isset($ruc_cond) || empty($ruc_cond))
      {
         $ruc_cond = "qp";
      }
      if (!isset($tipodoc_cond) || empty($tipodoc_cond))
      {
         $tipodoc_cond = "qp";
      }
      if (isset($fechaemision_cond) && substr($fechaemision_cond, 0, 3) == "bi_")
      {
         $Temp_cond = $fechaemision_cond;
         $this->Ini->process_cond_bi($Temp_cond, $BI_data1, $BI_data2);
         $fechaemision_dia = substr($BI_data1, 0, 2);
         $fechaemision_mes = substr($BI_data1, 2, 2);
         $fechaemision_ano = substr($BI_data1, 4, 4);
         if (strlen($BI_data1) > 8)
         {
             $fechaemision_hor = substr($BI_data1, 8, 2);
             $fechaemision_min = substr($BI_data1, 10, 2);
             $fechaemision_seg = substr($BI_data1, 12, 2);
         }
         $fechaemision_input_2_dia = substr($BI_data2, 0, 2);
         $fechaemision_input_2_mes = substr($BI_data2, 2, 2);
         $fechaemision_input_2_ano = substr($BI_data2, 4, 4);
         if (strlen($BI_data2) > 8)
         {
             $fechaemision_input_2_hor = substr($BI_data2, 8, 2);
             $fechaemision_input_2_min = substr($BI_data2, 10, 2);
             $fechaemision_input_2_seg = substr($BI_data2, 12, 2);
         }
         $Script_BI .= "  formata_bi_fechaemision('" . $fechaemision_cond . "', '" . $Temp_cond . "', '" . $BI_data1 . "');\r\n";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_fechaemision = (in_array($fechaemision_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_razonsocial = (in_array($razonsocial_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_ruc = (in_array($ruc_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_tipodoc = (in_array($tipodoc_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_fechaemision = ('bw' == $fechaemision_cond || 'bi_' == substr($fechaemision_cond, 0, 3)) ? $display_aberto : $display_fechado;
      $str_display_razonsocial = ('bw' == $razonsocial_cond) ? $display_aberto : $display_fechado;
      $str_display_ruc = ('bw' == $ruc_cond) ? $display_aberto : $display_fechado;
      $str_display_tipodoc = ('bw' == $tipodoc_cond) ? $display_aberto : $display_fechado;

      if (!isset($fechaemision) || $fechaemision == "")
      {
          $fechaemision = "";
      }
      if (isset($fechaemision) && !empty($fechaemision))
      {
      ...
      if (isset($razonsocial) && !empty($razonsocial))
      {
      ...
      if (isset($tipodoc) && !empty($tipodoc))
      {
...
?>
<?php
   if (is_file("grid_xml_compras_hdr_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_xml_compras_hdr']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_xml_compras_hdr']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_fechaemision_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fechaemision'])) ? $this->New_label['fechaemision'] : "Fecha Emision"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_fechaemision_cond" name="fechaemision_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechaemision'), this, 'fechaemision')">
       <optgroup label="<?php echo $this->Ini->Nm_lang['lang_srch_nrml'] ?>">
       <OPTION value="eq" <?php if ("eq" == $fechaemision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $fechaemision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $fechaemision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $fechaemision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
       <optgroup label="<?php echo $this->Ini->Nm_lang['lang_srch_spec'] ?>">
       <OPTION value="bi_current_year" <?php if ("bi_current_year" == $fechaemision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_summary_current_year'] ?></OPTION>
       <OPTION value="bi_LY" <?php if ("bi_LY" == $fechaemision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_year'] ?></OPTION>
       <OPTION value="bi_este_mes_full" <?php if ("bi_este_mes_full" == $fechaemision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_este_mes_full'] ?></OPTION>
       <OPTION value="bi_UM" <?php if ("bi_UM" == $fechaemision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_mnth'] ?></OPTION>
       <OPTION value="bi_current_week" <?php if ("bi_current_week" == $fechaemision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_summary_current_week'] ?></OPTION>
       <OPTION value="bi_last_week" <?php if ("bi_last_week" == $fechaemision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_summary_last_week'] ?></OPTION>
       <OPTION value="bi_HJ" <?php if ("bi_HJ" == $fechaemision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_tday'] ?></OPTION>
       <OPTION value="bi_OT" <?php if ("bi_OT" == $fechaemision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_yest'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd"><SPAN id="Nm_bi_dados_fechaemision" style="display:none"></SPAN>
      <TABLE  id="opc_bi_TP_fechaemision"  style=display:  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fechaemision" <?php echo $str_hide_fechaemision?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['fechaemision'])) ? $this->New_label['fechaemision'] : "Fecha Emision";
 $nmgp_tab_label .= "fechaemision?#?" . $SC_Label . "?@?";
...
<?php
  ...
  {
?>
<span id='id_date_part_fechaemision_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechaemision_dia" name="fechaemision_dia" value="<?php echo NM_encode_input($fechaemision_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechaemision_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechaemision_mes" name="fechaemision_mes" value="<?php echo NM_encode_input($fechaemision_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechaemision_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechaemision_ano" name="fechaemision_ano" value="<?php echo NM_encode_input($fechaemision_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_fechaemision_jq">
</span>
...
?>
        <SPAN id="id_css_fechaemision"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_fechaemision"  <?php echo $str_display_fechaemision; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_fechaemision_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechaemision_input_2_dia" name="fechaemision_input_2_dia" value="<?php echo NM_encode_input($fechaemision_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechaemision_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechaemision_input_2_mes" name="fechaemision_input_2_mes" value="<?php echo NM_encode_input($fechaemision_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechaemision_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechaemision_input_2_ano" name="fechaemision_input_2_ano" value="<?php echo NM_encode_input($fechaemision_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_fechaemision_jq2">
</span>
...
?>
      ...
      <TD id='SC_razonsocial_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['razonsocial'])) ? $this->New_label['razonsocial'] : "Razon Social"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_razonsocial_cond" name="razonsocial_cond" onChange="nm_campos_between(document.getElementById('id_vis_razonsocial'), this, 'razonsocial')">
       <OPTION value="qp" <?php if ("qp" == $razonsocial_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $razonsocial_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $razonsocial_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $razonsocial_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_razonsocial" <?php echo $str_hide_razonsocial?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['razonsocial'])) ? $this->New_label['razonsocial'] : "Razon Social";
 $nmgp_tab_label .= "razonsocial?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $razonsocial;
      }
?>
<INPUT  type="text" id="SC_razonsocial" name="razonsocial" value="<?php echo NM_encode_input($razonsocial) ?>"  size=50 alt="{datatype: 'text', maxLength: 250, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_razonsocial" name="razonsocial_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 250, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_ruc_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['ruc'])) ? $this->New_label['ruc'] : "Ruc"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_ruc_cond" name="ruc_cond" onChange="nm_campos_between(document.getElementById('id_vis_ruc'), this, 'ruc')">
       <OPTION value="qp" <?php if ("qp" == $ruc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $ruc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $ruc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $ruc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ruc" <?php echo $str_hide_ruc?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['ruc'])) ? $this->New_label['ruc'] : "Ruc";
 $nmgp_tab_label .= "ruc?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_ruc" name="ruc" value="<?php echo NM_encode_input($ruc) ?>"  size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_ruc" name="ruc_autocomp" size="45"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_tipodoc_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['tipodoc'])) ? $this->New_label['tipodoc'] : "Tipodoc"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_tipodoc_cond" name="tipodoc_cond" onChange="nm_campos_between(document.getElementById('id_vis_tipodoc'), this, 'tipodoc')">
       <OPTION value="qp" <?php if ("qp" == $tipodoc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $tipodoc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $tipodoc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $tipodoc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tipodoc" <?php echo $str_hide_tipodoc?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['tipodoc'])) ? $this->New_label['tipodoc'] : "Tipodoc";
 $nmgp_tab_label .= "tipodoc?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $tipodoc;
      }
?>
<INPUT  type="text" id="SC_tipodoc" name="tipodoc" value="<?php echo NM_encode_input($tipodoc) ?>"  size=2 alt="{datatype: 'text', maxLength: 2, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_tipodoc" name="tipodoc_autocomp" size="2"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 2, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.fechaemision_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_fechaemision'), document.F1.fechaemision_cond, 'fechaemision');
   document.F1.fechaemision_dia.value = "";
   document.F1.fechaemision_mes.value = "";
   document.F1.fechaemision_ano.value = "";
   document.F1.fechaemision_input_2_dia.value = "";
   document.F1.fechaemision_input_2_mes.value = "";
   document.F1.fechaemision_input_2_ano.value = "";
   document.F1.razonsocial_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_razonsocial'), document.F1.razonsocial_cond, 'razonsocial');
   document.F1.razonsocial.value = "";
   document.F1.razonsocial_autocomp.value = "";
   document.F1.ruc_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_ruc'), document.F1.ruc_cond, 'ruc');
   document.F1.ruc.value = "";
   document.F1.ruc_autocomp.value = "";
   document.F1.tipodoc_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_tipodoc'), document.F1.tipodoc_cond, 'tipodoc');
   document.F1.tipodoc.value = "";
   document.F1.tipodoc_autocomp.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_fechaemision_dia').bind('change', function() {sc_grid_xml_compras_hdr_valida_dia(this)});
    $('#SC_fechaemision_input_2_dia').bind('change', function() {sc_grid_xml_compras_hdr_valida_dia(this)});
    $('#SC_fechaemision_input_2_mes').bind('change', function() {sc_grid_xml_compras_hdr_valida_mes(this)});
    $('#SC_fechaemision_mes').bind('change', function() {sc_grid_xml_compras_hdr_valida_mes(this)});
 }
 function sc_grid_xml_compras_hdr_valida_dia(obj)
 {
 ...
 function sc_grid_xml_compras_hdr_valida_mes(obj)
 {
...
function formata_bi_fechaemision(opc, opc_bi, dt_fmt)
{
   if (opc.substring(0,3) != "bi_")
   {
       document.getElementById('Nm_bi_dados_fechaemision').style.display = 'none';
       document.getElementById('opc_bi_TP_fechaemision').style.display = '';
       return;
   }
   if (opc == "bi_TP")
   {
       document.getElementById('Nm_bi_dados_fechaemision').style.display = 'none';
       document.getElementById('opc_bi_TP_fechaemision').style.display = 'none';
       return;
   }
<?php
   $date_format_show = "";
   ...
   {
       $date_format_show .= (!$Prim) ? " + '" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . "' + ": "";
       $date_format_show .= ($Cada_d == "d") ? "document.F1.fechaemision_dia.value" : "";
       $date_format_show .= ($Cada_d == "m") ? "document.F1.fechaemision_mes.value" : "";
       $date_format_show .= ($Cada_d == "Y") ? "document.F1.fechaemision_ano.value" : "";
       $Prim = false;
   }
?> 
...
<?php
   ...
   {
       $date_format_show .= (!$Prim) ? " + '" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . "' + ": "";
       $date_format_show .= ($Cada_d == "d") ? "document.F1.fechaemision_input_2_dia.value" : "";
       $date_format_show .= ($Cada_d == "m") ? "document.F1.fechaemision_input_2_mes.value" : "";
       $date_format_show .= ($Cada_d == "Y") ? "document.F1.fechaemision_input_2_ano.value" : "";
       $Prim = false;
   }
?> 
       saida += <?php echo $date_format_show ?>;
   }
   document.getElementById('Nm_bi_dados_fechaemision').innerHTML = saida;
   document.getElementById('opc_bi_TP_fechaemision').style.display = 'none';
   document.getElementById('Nm_bi_dados_fechaemision').style.display = '';
}
<?php
  echo $Script_BI;
?>
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_fechaemision_cond'] = 'cond';
      $tp_fields['SC_fechaemision_dia'] = 'text';
      $tp_fields['SC_fechaemision_mes'] = 'text';
      $tp_fields['SC_fechaemision_ano'] = 'text';
      $tp_fields['SC_fechaemision_input_2_dia'] = 'text';
      $tp_fields['SC_fechaemision_input_2_mes'] = 'text';
      $tp_fields['SC_fechaemision_input_2_ano'] = 'text';
      $tp_fields['SC_razonsocial_cond'] = 'cond';
      $tp_fields['SC_razonsocial'] = 'text_aut';
      $tp_fields['id_ac_razonsocial'] = 'text_aut';
      $tp_fields['SC_ruc_cond'] = 'cond';
      $tp_fields['SC_ruc'] = 'text_aut';
      $tp_fields['id_ac_ruc'] = 'text_aut';
      $tp_fields['SC_tipodoc_cond'] = 'cond';
      $tp_fields['SC_tipodoc'] = 'text_aut';
      $tp_fields['id_ac_tipodoc'] = 'text_aut';
      ...
      if (is_file($NM_patch))
      {
          ...
          foreach ($NMcmp_filter as $Cada_cmp)
          {
              ...
              else
              {
                  ...
                  if ($Cada_cmp[0] == 'SC_fechaemision_cond')
                  {
                      $opc = $Cada_cmp[1];
   ...
   {
      global $fechaemision_cond, $fechaemision, $fechaemision_dia, $fechaemision_mes, $fechaemision_ano, $fechaemision_input_2_dia, $fechaemision_input_2_mes, $fechaemision_input_2_ano,
             $razonsocial_cond, $razonsocial, $razonsocial_autocomp,
             $ruc_cond, $ruc, $ruc_autocomp,
             $tipodoc_cond, $tipodoc, $tipodoc_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($razonsocial_autocomp) && empty($razonsocial))
      {
          $razonsocial = $razonsocial_autocomp;
      }
      if (!empty($ruc_autocomp) && empty($ruc))
      {
          $ruc = $ruc_autocomp;
      }
      if (!empty($tipodoc_autocomp) && empty($tipodoc))
      {
          $tipodoc = $tipodoc_autocomp;
      }
      $fechaemision_cond_salva = $fechaemision_cond; 
      if (!isset($fechaemision_input_2_dia) || $fechaemision_input_2_dia == "")
      {
          $fechaemision_input_2_dia = $fechaemision_dia;
      }
      if (!isset($fechaemision_input_2_mes) || $fechaemision_input_2_mes == "")
      {
          $fechaemision_input_2_mes = $fechaemision_mes;
      }
      if (!isset($fechaemision_input_2_ano) || $fechaemision_input_2_ano == "")
      {
          $fechaemision_input_2_ano = $fechaemision_ano;
      }
      $razonsocial_cond_salva = $razonsocial_cond; 
      if (!isset($razonsocial_input_2) || $razonsocial_input_2 == "")
      {
          $razonsocial_input_2 = $razonsocial;
      }
      $ruc_cond_salva = $ruc_cond; 
      if (!isset($ruc_input_2) || $ruc_input_2 == "")
      {
          $ruc_input_2 = $ruc;
      }
      $tipodoc_cond_salva = $tipodoc_cond; 
      if (!isset($tipodoc_input_2) || $tipodoc_input_2 == "")
      {
          $tipodoc_input_2 = $tipodoc;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['fechaemision_dia'] = $fechaemision_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['fechaemision_mes'] = $fechaemision_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['fechaemision_ano'] = $fechaemision_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['fechaemision_input_2_dia'] = $fechaemision_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['fechaemision_input_2_mes'] = $fechaemision_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['fechaemision_input_2_ano'] = $fechaemision_input_2_ano; 
      if (!empty($fechaemision_dia) || !empty($fechaemision_mes) || !empty($fechaemision_ano) || $fechaemision_cond_salva == "nu" || $fechaemision_cond_salva == "nn" || $fechaemision_cond_salva == "ep" || $fechaemision_cond_salva == "ne")
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $fechaemision_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $fechaemision_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $fechaemision_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $fechaemision_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $fechaemision_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $fechaemision_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['fechaemision_cond'] = $fechaemision_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid]['cmp'] = "fechaemision"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid]['opc'] = $fechaemision_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq']['fechaemision'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['razonsocial'] = $razonsocial; 
      if (is_array($razonsocial) && !empty($razonsocial))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid]['val'][0] = $razonsocial;
      }
      elseif ($razonsocial_cond_salva == "nu" || $razonsocial_cond_salva == "nn" || $razonsocial_cond_salva == "ep" || $razonsocial_cond_salva == "ne" || !empty($razonsocial))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid]['val'][0][0] = $razonsocial;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['razonsocial_cond'] = $razonsocial_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid]['cmp'] = "razonsocial"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid]['opc'] = $razonsocial_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq']['razonsocial'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['ruc'] = $ruc; 
      if (is_array($ruc) && !empty($ruc))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid]['val'][0] = $ruc;
      }
      elseif ($ruc_cond_salva == "nu" || $ruc_cond_salva == "nn" || $ruc_cond_salva == "ep" || $ruc_cond_salva == "ne" || !empty($ruc))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid]['val'][0][0] = $ruc;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['ruc_cond'] = $ruc_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid]['cmp'] = "ruc"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid]['opc'] = $ruc_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq']['ruc'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['tipodoc'] = $tipodoc; 
      if (is_array($tipodoc) && !empty($tipodoc))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid]['val'][0] = $tipodoc;
      }
      elseif ($tipodoc_cond_salva == "nu" || $tipodoc_cond_salva == "nn" || $tipodoc_cond_salva == "ep" || $tipodoc_cond_salva == "ne" || !empty($tipodoc))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid]['val'][0][0] = $tipodoc;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['tipodoc_cond'] = $tipodoc_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid]['cmp'] = "tipodoc"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid]['opc'] = $tipodoc_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq']['tipodoc'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($razonsocial != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['razonsocial'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['razonsocial'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['razonsocial'] = $razonsocial;
      }
      $nmgp_def_dados = array();
    if ($ruc != '') {
      $ruc_look = substr($this->Db->qstr($ruc), 1, -1); 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['ruc'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['ruc'] = $ruc;
      }
      $nmgp_def_dados = array();
    if ($tipodoc != '') {
      $tipodoc_look = substr($this->Db->qstr($tipodoc), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['tipodoc'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['tipodoc'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['tipodoc'] = $tipodoc;
      }

      //----- $fechaemision
      $this->Date_part = false;
      if ($fechaemision_cond != "bi_TP")
      {
          $fechaemision_cond = strtoupper($fechaemision_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $fechaemision_ano;
          $Dtxt .= $fechaemision_mes;
          $Dtxt .= $fechaemision_dia;
          $val[0]['ano'] = $fechaemision_ano;
          $val[0]['mes'] = $fechaemision_mes;
          $val[0]['dia'] = $fechaemision_dia;
          if ($fechaemision_cond == "BW")
          {
              $val[1]['ano'] = $fechaemision_input_2_ano;
              $val[1]['mes'] = $fechaemision_input_2_mes;
              $val[1]['dia'] = $fechaemision_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $fechaemision_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $fechaemision_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $fechaemision = $val[0];
          $this->cmp_formatado['fechaemision'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['fechaemision'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['fechaemision'], "YYYY-MM-DD");
          $this->cmp_formatado['fechaemision'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($fechaemision_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $fechaemision_input_2     = $val[1];
              $this->cmp_formatado['fechaemision_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']['fechaemision_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['fechaemision_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['fechaemision_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $fechaemision_cond == "NU" || $fechaemision_cond == "NN"|| $fechaemision_cond == "EP"|| $fechaemision_cond == "NE")
          {
              $this->monta_condicao("fechaEmision", $fechaemision_cond, $fechaemision, $fechaemision_input_2, 'fechaemision', 'DATE');
          }
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq']['fechaemision']['label'] = $nmgp_tab_label['fechaemision'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq']['fechaemision']['descr'] = $nmgp_tab_label['fechaemision'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['grid_pesq']['fechaemision']['hint']  = $nmgp_tab_label['fechaemision'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }

      //----- $razonsocial
      $this->Date_part = false;
      if (isset($razonsocial) || $razonsocial_cond == "nu" || $razonsocial_cond == "nn" || $razonsocial_cond == "ep" || $razonsocial_cond == "ne")
      {
         $this->monta_condicao("razonSocial", $razonsocial_cond, $razonsocial, "", "razonsocial");
      }

      //----- $ruc
      $this->Date_part = false;
      if (isset($ruc) || $ruc_cond == "nu" || $ruc_cond == "nn" || $ruc_cond == "ep" || $ruc_cond == "ne")
      {
         $this->monta_condicao("ruc", $ruc_cond, $ruc, "", "ruc");
      }

      //----- $tipodoc
      $this->Date_part = false;
      if (isset($tipodoc) || $tipodoc_cond == "nu" || $tipodoc_cond == "nn" || $tipodoc_cond == "ep" || $tipodoc_cond == "ne")
      {
         $this->monta_condicao("tipodoc", $tipodoc_cond, $tipodoc, "", "tipodoc");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr']['cond_pesq'] .= $this->NM_operador;
