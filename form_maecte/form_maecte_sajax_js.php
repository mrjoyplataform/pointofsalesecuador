  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_maecte" == sTestField)
        {
...
?>
  ...
  // ---------- Validate codcte01
  function do_ajax_form_maecte_validate_codcte01()
  {
    var nomeCampo_codcte01 = "codcte01";
    var var_codcte01 = scAjaxGetFieldHidden(nomeCampo_codcte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_codcte01(var_codcte01, var_script_case_init, do_ajax_form_maecte_validate_codcte01_cb);
  } // do_ajax_form_maecte_validate_codcte01

  function do_ajax_form_maecte_validate_codcte01_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_codcte01_cb

  // ---------- Validate tipo_cliente
  function do_ajax_form_maecte_validate_tipo_cliente()
  {
    var nomeCampo_tipo_cliente = "tipo_cliente";
    var var_tipo_cliente = scAjaxGetFieldText(nomeCampo_tipo_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_tipo_cliente(var_tipo_cliente, var_script_case_init, do_ajax_form_maecte_validate_tipo_cliente_cb);
  } // do_ajax_form_maecte_validate_tipo_cliente

  function do_ajax_form_maecte_validate_tipo_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_tipo_cliente_cb

  // ---------- Validate id_nacionalidad
  function do_ajax_form_maecte_validate_id_nacionalidad()
  {
    var nomeCampo_id_nacionalidad = "id_nacionalidad";
    var var_id_nacionalidad = scAjaxGetFieldText(nomeCampo_id_nacionalidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_nacionalidad(var_id_nacionalidad, var_script_case_init, do_ajax_form_maecte_validate_id_nacionalidad_cb);
  } // do_ajax_form_maecte_validate_id_nacionalidad

  function do_ajax_form_maecte_validate_id_nacionalidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_nacionalidad_cb

  // ---------- Validate nomcte01
  function do_ajax_form_maecte_validate_nomcte01()
  {
    var nomeCampo_nomcte01 = "nomcte01";
    var var_nomcte01 = scAjaxGetFieldText(nomeCampo_nomcte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_nomcte01(var_nomcte01, var_script_case_init, do_ajax_form_maecte_validate_nomcte01_cb);
  } // do_ajax_form_maecte_validate_nomcte01

  function do_ajax_form_maecte_validate_nomcte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_nomcte01_cb

  // ---------- Validate primer_nombre
  function do_ajax_form_maecte_validate_primer_nombre()
  {
    var nomeCampo_primer_nombre = "primer_nombre";
    var var_primer_nombre = scAjaxGetFieldText(nomeCampo_primer_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_primer_nombre(var_primer_nombre, var_script_case_init, do_ajax_form_maecte_validate_primer_nombre_cb);
  } // do_ajax_form_maecte_validate_primer_nombre

  function do_ajax_form_maecte_validate_primer_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_primer_nombre_cb

  // ---------- Validate segundo_nombre
  function do_ajax_form_maecte_validate_segundo_nombre()
  {
    var nomeCampo_segundo_nombre = "segundo_nombre";
    var var_segundo_nombre = scAjaxGetFieldText(nomeCampo_segundo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_segundo_nombre(var_segundo_nombre, var_script_case_init, do_ajax_form_maecte_validate_segundo_nombre_cb);
  } // do_ajax_form_maecte_validate_segundo_nombre

  function do_ajax_form_maecte_validate_segundo_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_segundo_nombre_cb

  // ---------- Validate primer_apellido
  function do_ajax_form_maecte_validate_primer_apellido()
  {
    var nomeCampo_primer_apellido = "primer_apellido";
    var var_primer_apellido = scAjaxGetFieldText(nomeCampo_primer_apellido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_primer_apellido(var_primer_apellido, var_script_case_init, do_ajax_form_maecte_validate_primer_apellido_cb);
  } // do_ajax_form_maecte_validate_primer_apellido

  function do_ajax_form_maecte_validate_primer_apellido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_primer_apellido_cb

  // ---------- Validate segundo_apellido
  function do_ajax_form_maecte_validate_segundo_apellido()
  {
    var nomeCampo_segundo_apellido = "segundo_apellido";
    var var_segundo_apellido = scAjaxGetFieldText(nomeCampo_segundo_apellido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_segundo_apellido(var_segundo_apellido, var_script_case_init, do_ajax_form_maecte_validate_segundo_apellido_cb);
  } // do_ajax_form_maecte_validate_segundo_apellido

  function do_ajax_form_maecte_validate_segundo_apellido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_segundo_apellido_cb

  // ---------- Validate cv1cte01
  function do_ajax_form_maecte_validate_cv1cte01()
  {
    var nomeCampo_cv1cte01 = "cv1cte01";
    var var_cv1cte01 = scAjaxGetFieldText(nomeCampo_cv1cte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_cv1cte01(var_cv1cte01, var_script_case_init, do_ajax_form_maecte_validate_cv1cte01_cb);
  } // do_ajax_form_maecte_validate_cv1cte01

  function do_ajax_form_maecte_validate_cv1cte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_cv1cte01_cb

  // ---------- Validate cv2cte01
  function do_ajax_form_maecte_validate_cv2cte01()
  {
    var nomeCampo_cv2cte01 = "cv2cte01";
    var var_cv2cte01 = scAjaxGetFieldText(nomeCampo_cv2cte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_cv2cte01(var_cv2cte01, var_script_case_init, do_ajax_form_maecte_validate_cv2cte01_cb);
  } // do_ajax_form_maecte_validate_cv2cte01

  function do_ajax_form_maecte_validate_cv2cte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_cv2cte01_cb

  // ---------- Validate tipcte01
  function do_ajax_form_maecte_validate_tipcte01()
  {
    var nomeCampo_tipcte01 = "tipcte01";
    var var_tipcte01 = scAjaxGetFieldText(nomeCampo_tipcte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_tipcte01(var_tipcte01, var_script_case_init, do_ajax_form_maecte_validate_tipcte01_cb);
  } // do_ajax_form_maecte_validate_tipcte01

  function do_ajax_form_maecte_validate_tipcte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_tipcte01_cb

  // ---------- Validate ofienccte01
  function do_ajax_form_maecte_validate_ofienccte01()
  {
    var nomeCampo_ofienccte01 = "ofienccte01";
    var var_ofienccte01 = scAjaxGetFieldText(nomeCampo_ofienccte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_ofienccte01(var_ofienccte01, var_script_case_init, do_ajax_form_maecte_validate_ofienccte01_cb);
  } // do_ajax_form_maecte_validate_ofienccte01

  function do_ajax_form_maecte_validate_ofienccte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_ofienccte01_cb

  // ---------- Validate vendcte01
  function do_ajax_form_maecte_validate_vendcte01()
  {
    var nomeCampo_vendcte01 = "vendcte01";
    var var_vendcte01 = scAjaxGetFieldText(nomeCampo_vendcte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_vendcte01(var_vendcte01, var_script_case_init, do_ajax_form_maecte_validate_vendcte01_cb);
  } // do_ajax_form_maecte_validate_vendcte01

  function do_ajax_form_maecte_validate_vendcte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_vendcte01_cb

  // ---------- Validate cobrcte01
  function do_ajax_form_maecte_validate_cobrcte01()
  {
    var nomeCampo_cobrcte01 = "cobrcte01";
    var var_cobrcte01 = scAjaxGetFieldText(nomeCampo_cobrcte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_cobrcte01(var_cobrcte01, var_script_case_init, do_ajax_form_maecte_validate_cobrcte01_cb);
  } // do_ajax_form_maecte_validate_cobrcte01

  function do_ajax_form_maecte_validate_cobrcte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_cobrcte01_cb

  // ---------- Validate loccte01
  function do_ajax_form_maecte_validate_loccte01()
  {
    var nomeCampo_loccte01 = "loccte01";
    var var_loccte01 = scAjaxGetFieldText(nomeCampo_loccte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_loccte01(var_loccte01, var_script_case_init, do_ajax_form_maecte_validate_loccte01_cb);
  } // do_ajax_form_maecte_validate_loccte01

  function do_ajax_form_maecte_validate_loccte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_loccte01_cb

  // ---------- Validate dircte01
  function do_ajax_form_maecte_validate_dircte01()
  {
    var nomeCampo_dircte01 = "dircte01";
    var var_dircte01 = scAjaxGetFieldText(nomeCampo_dircte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_dircte01(var_dircte01, var_script_case_init, do_ajax_form_maecte_validate_dircte01_cb);
  } // do_ajax_form_maecte_validate_dircte01

  function do_ajax_form_maecte_validate_dircte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_dircte01_cb

  // ---------- Validate sector
  function do_ajax_form_maecte_validate_sector()
  {
    var nomeCampo_sector = "sector";
    var var_sector = scAjaxGetFieldText(nomeCampo_sector);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_sector(var_sector, var_script_case_init, do_ajax_form_maecte_validate_sector_cb);
  } // do_ajax_form_maecte_validate_sector

  function do_ajax_form_maecte_validate_sector_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sector";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_sector_cb

  // ---------- Validate calle_principal
  function do_ajax_form_maecte_validate_calle_principal()
  {
    var nomeCampo_calle_principal = "calle_principal";
    var var_calle_principal = scAjaxGetFieldText(nomeCampo_calle_principal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_calle_principal(var_calle_principal, var_script_case_init, do_ajax_form_maecte_validate_calle_principal_cb);
  } // do_ajax_form_maecte_validate_calle_principal

  function do_ajax_form_maecte_validate_calle_principal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_calle_principal_cb

  // ---------- Validate no
  function do_ajax_form_maecte_validate_no()
  {
    var nomeCampo_no = "no";
    var var_no = scAjaxGetFieldText(nomeCampo_no);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_no(var_no, var_script_case_init, do_ajax_form_maecte_validate_no_cb);
  } // do_ajax_form_maecte_validate_no

  function do_ajax_form_maecte_validate_no_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "no";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_no_cb

  // ---------- Validate calle_secundaria
  function do_ajax_form_maecte_validate_calle_secundaria()
  {
    var nomeCampo_calle_secundaria = "calle_secundaria";
    var var_calle_secundaria = scAjaxGetFieldText(nomeCampo_calle_secundaria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_calle_secundaria(var_calle_secundaria, var_script_case_init, do_ajax_form_maecte_validate_calle_secundaria_cb);
  } // do_ajax_form_maecte_validate_calle_secundaria

  function do_ajax_form_maecte_validate_calle_secundaria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_calle_secundaria_cb

  // ---------- Validate id_pais
  function do_ajax_form_maecte_validate_id_pais()
  {
    var nomeCampo_id_pais = "id_pais";
    var var_id_pais = scAjaxGetFieldText(nomeCampo_id_pais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_pais(var_id_pais, var_script_case_init, do_ajax_form_maecte_validate_id_pais_cb);
  } // do_ajax_form_maecte_validate_id_pais

  function do_ajax_form_maecte_validate_id_pais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_pais";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_pais_cb

  // ---------- Validate id_provincia
  function do_ajax_form_maecte_validate_id_provincia()
  {
    var nomeCampo_id_provincia = "id_provincia";
    var var_id_provincia = scAjaxGetFieldText(nomeCampo_id_provincia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_provincia(var_id_provincia, var_script_case_init, do_ajax_form_maecte_validate_id_provincia_cb);
  } // do_ajax_form_maecte_validate_id_provincia

  function do_ajax_form_maecte_validate_id_provincia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_provincia_cb

  // ---------- Validate id_ciudad
  function do_ajax_form_maecte_validate_id_ciudad()
  {
    var nomeCampo_id_ciudad = "id_ciudad";
    var var_id_ciudad = scAjaxGetFieldText(nomeCampo_id_ciudad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_ciudad(var_id_ciudad, var_script_case_init, do_ajax_form_maecte_validate_id_ciudad_cb);
  } // do_ajax_form_maecte_validate_id_ciudad

  function do_ajax_form_maecte_validate_id_ciudad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_ciudad_cb

  // ---------- Validate id_canton
  function do_ajax_form_maecte_validate_id_canton()
  {
    var nomeCampo_id_canton = "id_canton";
    var var_id_canton = scAjaxGetFieldText(nomeCampo_id_canton);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_canton(var_id_canton, var_script_case_init, do_ajax_form_maecte_validate_id_canton_cb);
  } // do_ajax_form_maecte_validate_id_canton

  function do_ajax_form_maecte_validate_id_canton_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_canton_cb

  // ---------- Validate telcte01
  function do_ajax_form_maecte_validate_telcte01()
  {
    var nomeCampo_telcte01 = "telcte01";
    var var_telcte01 = scAjaxGetFieldText(nomeCampo_telcte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_telcte01(var_telcte01, var_script_case_init, do_ajax_form_maecte_validate_telcte01_cb);
  } // do_ajax_form_maecte_validate_telcte01

  function do_ajax_form_maecte_validate_telcte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_telcte01_cb

  // ---------- Validate cascte01
  function do_ajax_form_maecte_validate_cascte01()
  {
    var nomeCampo_cascte01 = "cascte01";
    var var_cascte01 = scAjaxGetFieldText(nomeCampo_cascte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_cascte01(var_cascte01, var_script_case_init, do_ajax_form_maecte_validate_cascte01_cb);
  } // do_ajax_form_maecte_validate_cascte01

  function do_ajax_form_maecte_validate_cascte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_cascte01_cb

  // ---------- Validate ci_conyuge
  function do_ajax_form_maecte_validate_ci_conyuge()
  {
    var nomeCampo_ci_conyuge = "ci_conyuge";
    var var_ci_conyuge = scAjaxGetFieldText(nomeCampo_ci_conyuge);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_ci_conyuge(var_ci_conyuge, var_script_case_init, do_ajax_form_maecte_validate_ci_conyuge_cb);
  } // do_ajax_form_maecte_validate_ci_conyuge

  function do_ajax_form_maecte_validate_ci_conyuge_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_ci_conyuge_cb

  // ---------- Validate conyuge_tipo_identidad
  function do_ajax_form_maecte_validate_conyuge_tipo_identidad()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_conyuge_tipo_identidad(var_conyuge_tipo_identidad, var_script_case_init, do_ajax_form_maecte_validate_conyuge_tipo_identidad_cb);
  } // do_ajax_form_maecte_validate_conyuge_tipo_identidad

  function do_ajax_form_maecte_validate_conyuge_tipo_identidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_conyuge_tipo_identidad_cb

  // ---------- Validate conyuge_primer_nombre
  function do_ajax_form_maecte_validate_conyuge_primer_nombre()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_conyuge_primer_nombre(var_conyuge_primer_nombre, var_script_case_init, do_ajax_form_maecte_validate_conyuge_primer_nombre_cb);
  } // do_ajax_form_maecte_validate_conyuge_primer_nombre

  function do_ajax_form_maecte_validate_conyuge_primer_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_conyuge_primer_nombre_cb

  // ---------- Validate conyuge_segundo_nombre
  function do_ajax_form_maecte_validate_conyuge_segundo_nombre()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_conyuge_segundo_nombre(var_conyuge_segundo_nombre, var_script_case_init, do_ajax_form_maecte_validate_conyuge_segundo_nombre_cb);
  } // do_ajax_form_maecte_validate_conyuge_segundo_nombre

  function do_ajax_form_maecte_validate_conyuge_segundo_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_conyuge_segundo_nombre_cb

  // ---------- Validate conyuge_primer_apellido
  function do_ajax_form_maecte_validate_conyuge_primer_apellido()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_conyuge_primer_apellido(var_conyuge_primer_apellido, var_script_case_init, do_ajax_form_maecte_validate_conyuge_primer_apellido_cb);
  } // do_ajax_form_maecte_validate_conyuge_primer_apellido

  function do_ajax_form_maecte_validate_conyuge_primer_apellido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_conyuge_primer_apellido_cb

  // ---------- Validate conyuge_segundo_apellido
  function do_ajax_form_maecte_validate_conyuge_segundo_apellido()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_conyuge_segundo_apellido(var_conyuge_segundo_apellido, var_script_case_init, do_ajax_form_maecte_validate_conyuge_segundo_apellido_cb);
  } // do_ajax_form_maecte_validate_conyuge_segundo_apellido

  function do_ajax_form_maecte_validate_conyuge_segundo_apellido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_conyuge_segundo_apellido_cb

  // ---------- Validate conyuge_profesion
  function do_ajax_form_maecte_validate_conyuge_profesion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_conyuge_profesion(var_conyuge_profesion, var_script_case_init, do_ajax_form_maecte_validate_conyuge_profesion_cb);
  } // do_ajax_form_maecte_validate_conyuge_profesion

  function do_ajax_form_maecte_validate_conyuge_profesion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_conyuge_profesion_cb

  // ---------- Validate id_tipo_documento
  function do_ajax_form_maecte_validate_id_tipo_documento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_tipo_documento(var_id_tipo_documento, var_script_case_init, do_ajax_form_maecte_validate_id_tipo_documento_cb);
  } // do_ajax_form_maecte_validate_id_tipo_documento

  function do_ajax_form_maecte_validate_id_tipo_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_tipo_documento_cb

  // ---------- Validate repleg01
  function do_ajax_form_maecte_validate_repleg01()
  {
    var nomeCampo_repleg01 = "repleg01";
    var var_repleg01 = scAjaxGetFieldText(nomeCampo_repleg01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_repleg01(var_repleg01, var_script_case_init, do_ajax_form_maecte_validate_repleg01_cb);
  } // do_ajax_form_maecte_validate_repleg01

  function do_ajax_form_maecte_validate_repleg01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_repleg01_cb

  // ---------- Validate fecing01
  function do_ajax_form_maecte_validate_fecing01()
  {
    var nomeCampo_fecing01 = "fecing01";
    var var_fecing01 = scAjaxGetFieldText(nomeCampo_fecing01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_fecing01(var_fecing01, var_script_case_init, do_ajax_form_maecte_validate_fecing01_cb);
  } // do_ajax_form_maecte_validate_fecing01

  function do_ajax_form_maecte_validate_fecing01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_fecing01_cb

  // ---------- Validate condpag01
  function do_ajax_form_maecte_validate_condpag01()
  {
    var nomeCampo_condpag01 = "condpag01";
    var var_condpag01 = scAjaxGetFieldText(nomeCampo_condpag01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_condpag01(var_condpag01, var_script_case_init, do_ajax_form_maecte_validate_condpag01_cb);
  } // do_ajax_form_maecte_validate_condpag01

  function do_ajax_form_maecte_validate_condpag01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_condpag01_cb

  // ---------- Validate desctocte01
  function do_ajax_form_maecte_validate_desctocte01()
  {
    var nomeCampo_desctocte01 = "desctocte01";
    var var_desctocte01 = scAjaxGetFieldText(nomeCampo_desctocte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_desctocte01(var_desctocte01, var_script_case_init, do_ajax_form_maecte_validate_desctocte01_cb);
  } // do_ajax_form_maecte_validate_desctocte01

  function do_ajax_form_maecte_validate_desctocte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_desctocte01_cb

  // ---------- Validate limcred01
  function do_ajax_form_maecte_validate_limcred01()
  {
    var nomeCampo_limcred01 = "limcred01";
    var var_limcred01 = scAjaxGetFieldText(nomeCampo_limcred01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_limcred01(var_limcred01, var_script_case_init, do_ajax_form_maecte_validate_limcred01_cb);
  } // do_ajax_form_maecte_validate_limcred01

  function do_ajax_form_maecte_validate_limcred01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_limcred01_cb

  // ---------- Validate desppar01
  function do_ajax_form_maecte_validate_desppar01()
  {
    var nomeCampo_desppar01 = "desppar01";
    var var_desppar01 = scAjaxGetFieldText(nomeCampo_desppar01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_desppar01(var_desppar01, var_script_case_init, do_ajax_form_maecte_validate_desppar01_cb);
  } // do_ajax_form_maecte_validate_desppar01

  function do_ajax_form_maecte_validate_desppar01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_desppar01_cb

  // ---------- Validate cheqpro01
  function do_ajax_form_maecte_validate_cheqpro01()
  {
    var nomeCampo_cheqpro01 = "cheqpro01";
    var var_cheqpro01 = scAjaxGetFieldText(nomeCampo_cheqpro01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_cheqpro01(var_cheqpro01, var_script_case_init, do_ajax_form_maecte_validate_cheqpro01_cb);
  } // do_ajax_form_maecte_validate_cheqpro01

  function do_ajax_form_maecte_validate_cheqpro01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_cheqpro01_cb

  // ---------- Validate sdoeje01
  function do_ajax_form_maecte_validate_sdoeje01()
  {
    var nomeCampo_sdoeje01 = "sdoeje01";
    var var_sdoeje01 = scAjaxGetFieldText(nomeCampo_sdoeje01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_sdoeje01(var_sdoeje01, var_script_case_init, do_ajax_form_maecte_validate_sdoeje01_cb);
  } // do_ajax_form_maecte_validate_sdoeje01

  function do_ajax_form_maecte_validate_sdoeje01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_sdoeje01_cb

  // ---------- Validate sdoant01
  function do_ajax_form_maecte_validate_sdoant01()
  {
    var nomeCampo_sdoant01 = "sdoant01";
    var var_sdoant01 = scAjaxGetFieldText(nomeCampo_sdoant01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_sdoant01(var_sdoant01, var_script_case_init, do_ajax_form_maecte_validate_sdoant01_cb);
  } // do_ajax_form_maecte_validate_sdoant01

  function do_ajax_form_maecte_validate_sdoant01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_sdoant01_cb

  // ---------- Validate sdoact01
  function do_ajax_form_maecte_validate_sdoact01()
  {
    var nomeCampo_sdoact01 = "sdoact01";
    var var_sdoact01 = scAjaxGetFieldText(nomeCampo_sdoact01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_sdoact01(var_sdoact01, var_script_case_init, do_ajax_form_maecte_validate_sdoact01_cb);
  } // do_ajax_form_maecte_validate_sdoact01

  function do_ajax_form_maecte_validate_sdoact01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_sdoact01_cb

  // ---------- Validate acudbm01
  function do_ajax_form_maecte_validate_acudbm01()
  {
    var nomeCampo_acudbm01 = "acudbm01";
    var var_acudbm01 = scAjaxGetFieldText(nomeCampo_acudbm01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_acudbm01(var_acudbm01, var_script_case_init, do_ajax_form_maecte_validate_acudbm01_cb);
  } // do_ajax_form_maecte_validate_acudbm01

  function do_ajax_form_maecte_validate_acudbm01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_acudbm01_cb

  // ---------- Validate acucrm01
  function do_ajax_form_maecte_validate_acucrm01()
  {
    var nomeCampo_acucrm01 = "acucrm01";
    var var_acucrm01 = scAjaxGetFieldText(nomeCampo_acucrm01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_acucrm01(var_acucrm01, var_script_case_init, do_ajax_form_maecte_validate_acucrm01_cb);
  } // do_ajax_form_maecte_validate_acucrm01

  function do_ajax_form_maecte_validate_acucrm01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_acucrm01_cb

  // ---------- Validate acudbe01
  function do_ajax_form_maecte_validate_acudbe01()
  {
    var nomeCampo_acudbe01 = "acudbe01";
    var var_acudbe01 = scAjaxGetFieldText(nomeCampo_acudbe01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_acudbe01(var_acudbe01, var_script_case_init, do_ajax_form_maecte_validate_acudbe01_cb);
  } // do_ajax_form_maecte_validate_acudbe01

  function do_ajax_form_maecte_validate_acudbe01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_acudbe01_cb

  // ---------- Validate acucre01
  function do_ajax_form_maecte_validate_acucre01()
  {
    var nomeCampo_acucre01 = "acucre01";
    var var_acucre01 = scAjaxGetFieldText(nomeCampo_acucre01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_acucre01(var_acucre01, var_script_case_init, do_ajax_form_maecte_validate_acucre01_cb);
  } // do_ajax_form_maecte_validate_acucre01

  function do_ajax_form_maecte_validate_acucre01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_acucre01_cb

  // ---------- Validate comentcte01
  function do_ajax_form_maecte_validate_comentcte01()
  {
    var nomeCampo_comentcte01 = "comentcte01";
    var var_comentcte01 = scAjaxGetFieldText(nomeCampo_comentcte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_comentcte01(var_comentcte01, var_script_case_init, do_ajax_form_maecte_validate_comentcte01_cb);
  } // do_ajax_form_maecte_validate_comentcte01

  function do_ajax_form_maecte_validate_comentcte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_comentcte01_cb

  // ---------- Validate statuscte01
  function do_ajax_form_maecte_validate_statuscte01()
  {
    var nomeCampo_statuscte01 = "statuscte01";
    var var_statuscte01 = scAjaxGetFieldText(nomeCampo_statuscte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_statuscte01(var_statuscte01, var_script_case_init, do_ajax_form_maecte_validate_statuscte01_cb);
  } // do_ajax_form_maecte_validate_statuscte01

  function do_ajax_form_maecte_validate_statuscte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_statuscte01_cb

  // ---------- Validate identcte01
  function do_ajax_form_maecte_validate_identcte01()
  {
    var nomeCampo_identcte01 = "identcte01";
    var var_identcte01 = scAjaxGetFieldText(nomeCampo_identcte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_identcte01(var_identcte01, var_script_case_init, do_ajax_form_maecte_validate_identcte01_cb);
  } // do_ajax_form_maecte_validate_identcte01

  function do_ajax_form_maecte_validate_identcte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_identcte01_cb

  // ---------- Validate cordcte01
  function do_ajax_form_maecte_validate_cordcte01()
  {
    var nomeCampo_cordcte01 = "cordcte01";
    var var_cordcte01 = scAjaxGetFieldText(nomeCampo_cordcte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_cordcte01(var_cordcte01, var_script_case_init, do_ajax_form_maecte_validate_cordcte01_cb);
  } // do_ajax_form_maecte_validate_cordcte01

  function do_ajax_form_maecte_validate_cordcte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_cordcte01_cb

  // ---------- Validate limcant01
  function do_ajax_form_maecte_validate_limcant01()
  {
    var nomeCampo_limcant01 = "limcant01";
    var var_limcant01 = scAjaxGetFieldText(nomeCampo_limcant01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_limcant01(var_limcant01, var_script_case_init, do_ajax_form_maecte_validate_limcant01_cb);
  } // do_ajax_form_maecte_validate_limcant01

  function do_ajax_form_maecte_validate_limcant01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_limcant01_cb

  // ---------- Validate pagleg01
  function do_ajax_form_maecte_validate_pagleg01()
  {
    var nomeCampo_pagleg01 = "pagleg01";
    var var_pagleg01 = scAjaxGetFieldText(nomeCampo_pagleg01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_pagleg01(var_pagleg01, var_script_case_init, do_ajax_form_maecte_validate_pagleg01_cb);
  } // do_ajax_form_maecte_validate_pagleg01

  function do_ajax_form_maecte_validate_pagleg01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_pagleg01_cb

  // ---------- Validate telcte01b
  function do_ajax_form_maecte_validate_telcte01b()
  {
    var nomeCampo_telcte01b = "telcte01b";
    var var_telcte01b = scAjaxGetFieldText(nomeCampo_telcte01b);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_telcte01b(var_telcte01b, var_script_case_init, do_ajax_form_maecte_validate_telcte01b_cb);
  } // do_ajax_form_maecte_validate_telcte01b

  function do_ajax_form_maecte_validate_telcte01b_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_telcte01b_cb

  // ---------- Validate telcte01c
  function do_ajax_form_maecte_validate_telcte01c()
  {
    var nomeCampo_telcte01c = "telcte01c";
    var var_telcte01c = scAjaxGetFieldText(nomeCampo_telcte01c);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_telcte01c(var_telcte01c, var_script_case_init, do_ajax_form_maecte_validate_telcte01c_cb);
  } // do_ajax_form_maecte_validate_telcte01c

  function do_ajax_form_maecte_validate_telcte01c_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_telcte01c_cb

  // ---------- Validate emailcte01
  function do_ajax_form_maecte_validate_emailcte01()
  {
    var nomeCampo_emailcte01 = "emailcte01";
    var var_emailcte01 = scAjaxGetFieldText(nomeCampo_emailcte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_emailcte01(var_emailcte01, var_script_case_init, do_ajax_form_maecte_validate_emailcte01_cb);
  } // do_ajax_form_maecte_validate_emailcte01

  function do_ajax_form_maecte_validate_emailcte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_emailcte01_cb

  // ---------- Validate calle_principal_exterior
  function do_ajax_form_maecte_validate_calle_principal_exterior()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_calle_principal_exterior(var_calle_principal_exterior, var_script_case_init, do_ajax_form_maecte_validate_calle_principal_exterior_cb);
  } // do_ajax_form_maecte_validate_calle_principal_exterior

  function do_ajax_form_maecte_validate_calle_principal_exterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_calle_principal_exterior_cb

  // ---------- Validate no_exterior
  function do_ajax_form_maecte_validate_no_exterior()
  {
    var nomeCampo_no_exterior = "no_exterior";
    var var_no_exterior = scAjaxGetFieldText(nomeCampo_no_exterior);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_no_exterior(var_no_exterior, var_script_case_init, do_ajax_form_maecte_validate_no_exterior_cb);
  } // do_ajax_form_maecte_validate_no_exterior

  function do_ajax_form_maecte_validate_no_exterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_no_exterior_cb

  // ---------- Validate calle_secundaria_exterior
  function do_ajax_form_maecte_validate_calle_secundaria_exterior()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_calle_secundaria_exterior(var_calle_secundaria_exterior, var_script_case_init, do_ajax_form_maecte_validate_calle_secundaria_exterior_cb);
  } // do_ajax_form_maecte_validate_calle_secundaria_exterior

  function do_ajax_form_maecte_validate_calle_secundaria_exterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_calle_secundaria_exterior_cb

  // ---------- Validate id_pais_exterior
  function do_ajax_form_maecte_validate_id_pais_exterior()
  {
    var nomeCampo_id_pais_exterior = "id_pais_exterior";
    var var_id_pais_exterior = scAjaxGetFieldText(nomeCampo_id_pais_exterior);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_pais_exterior(var_id_pais_exterior, var_script_case_init, do_ajax_form_maecte_validate_id_pais_exterior_cb);
  } // do_ajax_form_maecte_validate_id_pais_exterior

  function do_ajax_form_maecte_validate_id_pais_exterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_pais_exterior_cb

  // ---------- Validate id_ciudad_exterior
  function do_ajax_form_maecte_validate_id_ciudad_exterior()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_ciudad_exterior(var_id_ciudad_exterior, var_script_case_init, do_ajax_form_maecte_validate_id_ciudad_exterior_cb);
  } // do_ajax_form_maecte_validate_id_ciudad_exterior

  function do_ajax_form_maecte_validate_id_ciudad_exterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_ciudad_exterior_cb

  // ---------- Validate codigo_postal_exterior
  function do_ajax_form_maecte_validate_codigo_postal_exterior()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_codigo_postal_exterior(var_codigo_postal_exterior, var_script_case_init, do_ajax_form_maecte_validate_codigo_postal_exterior_cb);
  } // do_ajax_form_maecte_validate_codigo_postal_exterior

  function do_ajax_form_maecte_validate_codigo_postal_exterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_codigo_postal_exterior_cb

  // ---------- Validate sector_exterior
  function do_ajax_form_maecte_validate_sector_exterior()
  {
    var nomeCampo_sector_exterior = "sector_exterior";
    var var_sector_exterior = scAjaxGetFieldText(nomeCampo_sector_exterior);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_sector_exterior(var_sector_exterior, var_script_case_init, do_ajax_form_maecte_validate_sector_exterior_cb);
  } // do_ajax_form_maecte_validate_sector_exterior

  function do_ajax_form_maecte_validate_sector_exterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_sector_exterior_cb

  // ---------- Validate telefono_exterior
  function do_ajax_form_maecte_validate_telefono_exterior()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_telefono_exterior(var_telefono_exterior, var_script_case_init, do_ajax_form_maecte_validate_telefono_exterior_cb);
  } // do_ajax_form_maecte_validate_telefono_exterior

  function do_ajax_form_maecte_validate_telefono_exterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_telefono_exterior_cb

  // ---------- Validate celular_exterior
  function do_ajax_form_maecte_validate_celular_exterior()
  {
    var nomeCampo_celular_exterior = "celular_exterior";
    var var_celular_exterior = scAjaxGetFieldText(nomeCampo_celular_exterior);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_celular_exterior(var_celular_exterior, var_script_case_init, do_ajax_form_maecte_validate_celular_exterior_cb);
  } // do_ajax_form_maecte_validate_celular_exterior

  function do_ajax_form_maecte_validate_celular_exterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_celular_exterior_cb

  // ---------- Validate email_exterior
  function do_ajax_form_maecte_validate_email_exterior()
  {
    var nomeCampo_email_exterior = "email_exterior";
    var var_email_exterior = scAjaxGetFieldText(nomeCampo_email_exterior);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_email_exterior(var_email_exterior, var_script_case_init, do_ajax_form_maecte_validate_email_exterior_cb);
  } // do_ajax_form_maecte_validate_email_exterior

  function do_ajax_form_maecte_validate_email_exterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_email_exterior_cb

  // ---------- Validate emailaltcte01
  function do_ajax_form_maecte_validate_emailaltcte01()
  {
    var nomeCampo_emailaltcte01 = "emailaltcte01";
    var var_emailaltcte01 = scAjaxGetFieldText(nomeCampo_emailaltcte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_emailaltcte01(var_emailaltcte01, var_script_case_init, do_ajax_form_maecte_validate_emailaltcte01_cb);
  } // do_ajax_form_maecte_validate_emailaltcte01

  function do_ajax_form_maecte_validate_emailaltcte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_emailaltcte01_cb

  // ---------- Validate ctacgcte01
  function do_ajax_form_maecte_validate_ctacgcte01()
  {
    var nomeCampo_ctacgcte01 = "ctacgcte01";
    var var_ctacgcte01 = scAjaxGetFieldText(nomeCampo_ctacgcte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_ctacgcte01(var_ctacgcte01, var_script_case_init, do_ajax_form_maecte_validate_ctacgcte01_cb);
  } // do_ajax_form_maecte_validate_ctacgcte01

  function do_ajax_form_maecte_validate_ctacgcte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_ctacgcte01_cb

  // ---------- Validate obsercte01
  function do_ajax_form_maecte_validate_obsercte01()
  {
    var nomeCampo_obsercte01 = "obsercte01";
    var var_obsercte01 = scAjaxGetFieldText(nomeCampo_obsercte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_obsercte01(var_obsercte01, var_script_case_init, do_ajax_form_maecte_validate_obsercte01_cb);
  } // do_ajax_form_maecte_validate_obsercte01

  function do_ajax_form_maecte_validate_obsercte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_obsercte01_cb

  // ---------- Validate totexceso01
  function do_ajax_form_maecte_validate_totexceso01()
  {
    var nomeCampo_totexceso01 = "totexceso01";
    var var_totexceso01 = scAjaxGetFieldText(nomeCampo_totexceso01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_totexceso01(var_totexceso01, var_script_case_init, do_ajax_form_maecte_validate_totexceso01_cb);
  } // do_ajax_form_maecte_validate_totexceso01

  function do_ajax_form_maecte_validate_totexceso01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_totexceso01_cb

  // ---------- Validate imagencte01
  function do_ajax_form_maecte_validate_imagencte01()
  {
    var nomeCampo_imagencte01 = "imagencte01";
    var var_imagencte01 = scAjaxGetFieldText(nomeCampo_imagencte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_imagencte01(var_imagencte01, var_script_case_init, do_ajax_form_maecte_validate_imagencte01_cb);
  } // do_ajax_form_maecte_validate_imagencte01

  function do_ajax_form_maecte_validate_imagencte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_imagencte01_cb

  // ---------- Validate block
  function do_ajax_form_maecte_validate_block()
  {
    var nomeCampo_block = "block";
    var var_block = scAjaxGetFieldText(nomeCampo_block);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_block(var_block, var_script_case_init, do_ajax_form_maecte_validate_block_cb);
  } // do_ajax_form_maecte_validate_block

  function do_ajax_form_maecte_validate_block_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "block";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_block_cb

  // ---------- Validate uid
  function do_ajax_form_maecte_validate_uid()
  {
    var nomeCampo_uid = "uid";
    var var_uid = scAjaxGetFieldText(nomeCampo_uid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_uid(var_uid, var_script_case_init, do_ajax_form_maecte_validate_uid_cb);
  } // do_ajax_form_maecte_validate_uid

  function do_ajax_form_maecte_validate_uid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "uid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_uid_cb

  // ---------- Validate ultimoacceso
  function do_ajax_form_maecte_validate_ultimoacceso()
  {
    var nomeCampo_ultimoacceso = "ultimoacceso";
    var var_ultimoacceso = scAjaxGetFieldText(nomeCampo_ultimoacceso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_ultimoacceso(var_ultimoacceso, var_script_case_init, do_ajax_form_maecte_validate_ultimoacceso_cb);
  } // do_ajax_form_maecte_validate_ultimoacceso

  function do_ajax_form_maecte_validate_ultimoacceso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_ultimoacceso_cb

  // ---------- Validate idcli
  function do_ajax_form_maecte_validate_idcli()
  {
    var nomeCampo_idcli = "idcli";
    var var_idcli = scAjaxGetFieldText(nomeCampo_idcli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_idcli(var_idcli, var_script_case_init, do_ajax_form_maecte_validate_idcli_cb);
  } // do_ajax_form_maecte_validate_idcli

  function do_ajax_form_maecte_validate_idcli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idcli";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_idcli_cb

  // ---------- Validate catcte01
  function do_ajax_form_maecte_validate_catcte01()
  {
    var nomeCampo_catcte01 = "catcte01";
    var var_catcte01 = scAjaxGetFieldText(nomeCampo_catcte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_catcte01(var_catcte01, var_script_case_init, do_ajax_form_maecte_validate_catcte01_cb);
  } // do_ajax_form_maecte_validate_catcte01

  function do_ajax_form_maecte_validate_catcte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_catcte01_cb

  // ---------- Validate transferido
  function do_ajax_form_maecte_validate_transferido()
  {
    var nomeCampo_transferido = "transferido";
    var var_transferido = scAjaxGetFieldText(nomeCampo_transferido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_transferido(var_transferido, var_script_case_init, do_ajax_form_maecte_validate_transferido_cb);
  } // do_ajax_form_maecte_validate_transferido

  function do_ajax_form_maecte_validate_transferido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_transferido_cb

  // ---------- Validate password
  function do_ajax_form_maecte_validate_password()
  {
    var nomeCampo_password = "password";
    var var_password = scAjaxGetFieldText(nomeCampo_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_password(var_password, var_script_case_init, do_ajax_form_maecte_validate_password_cb);
  } // do_ajax_form_maecte_validate_password

  function do_ajax_form_maecte_validate_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_password_cb

  // ---------- Validate showroom
  function do_ajax_form_maecte_validate_showroom()
  {
    var nomeCampo_showroom = "showroom";
    var var_showroom = scAjaxGetFieldText(nomeCampo_showroom);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_showroom(var_showroom, var_script_case_init, do_ajax_form_maecte_validate_showroom_cb);
  } // do_ajax_form_maecte_validate_showroom

  function do_ajax_form_maecte_validate_showroom_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_showroom_cb

  // ---------- Validate orden
  function do_ajax_form_maecte_validate_orden()
  {
    var nomeCampo_orden = "orden";
    var var_orden = scAjaxGetFieldText(nomeCampo_orden);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_orden(var_orden, var_script_case_init, do_ajax_form_maecte_validate_orden_cb);
  } // do_ajax_form_maecte_validate_orden

  function do_ajax_form_maecte_validate_orden_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "orden";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_orden_cb

  // ---------- Validate website
  function do_ajax_form_maecte_validate_website()
  {
    var nomeCampo_website = "website";
    var var_website = scAjaxGetFieldText(nomeCampo_website);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_website(var_website, var_script_case_init, do_ajax_form_maecte_validate_website_cb);
  } // do_ajax_form_maecte_validate_website

  function do_ajax_form_maecte_validate_website_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "website";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_website_cb

  // ---------- Validate longitud01
  function do_ajax_form_maecte_validate_longitud01()
  {
    var nomeCampo_longitud01 = "longitud01";
    var var_longitud01 = scAjaxGetFieldText(nomeCampo_longitud01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_longitud01(var_longitud01, var_script_case_init, do_ajax_form_maecte_validate_longitud01_cb);
  } // do_ajax_form_maecte_validate_longitud01

  function do_ajax_form_maecte_validate_longitud01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_longitud01_cb

  // ---------- Validate latitud01
  function do_ajax_form_maecte_validate_latitud01()
  {
    var nomeCampo_latitud01 = "latitud01";
    var var_latitud01 = scAjaxGetFieldText(nomeCampo_latitud01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_latitud01(var_latitud01, var_script_case_init, do_ajax_form_maecte_validate_latitud01_cb);
  } // do_ajax_form_maecte_validate_latitud01

  function do_ajax_form_maecte_validate_latitud01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_latitud01_cb

  // ---------- Validate zoom01
  function do_ajax_form_maecte_validate_zoom01()
  {
    var nomeCampo_zoom01 = "zoom01";
    var var_zoom01 = scAjaxGetFieldText(nomeCampo_zoom01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_zoom01(var_zoom01, var_script_case_init, do_ajax_form_maecte_validate_zoom01_cb);
  } // do_ajax_form_maecte_validate_zoom01

  function do_ajax_form_maecte_validate_zoom01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "zoom01";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_zoom01_cb

  // ---------- Validate acceder
  function do_ajax_form_maecte_validate_acceder()
  {
    var nomeCampo_acceder = "acceder";
    var var_acceder = scAjaxGetFieldText(nomeCampo_acceder);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_acceder(var_acceder, var_script_case_init, do_ajax_form_maecte_validate_acceder_cb);
  } // do_ajax_form_maecte_validate_acceder

  function do_ajax_form_maecte_validate_acceder_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "acceder";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_acceder_cb

  // ---------- Validate coniva01
  function do_ajax_form_maecte_validate_coniva01()
  {
    var nomeCampo_coniva01 = "coniva01";
    var var_coniva01 = scAjaxGetFieldText(nomeCampo_coniva01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_coniva01(var_coniva01, var_script_case_init, do_ajax_form_maecte_validate_coniva01_cb);
  } // do_ajax_form_maecte_validate_coniva01

  function do_ajax_form_maecte_validate_coniva01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_coniva01_cb

  // ---------- Validate idemp01
  function do_ajax_form_maecte_validate_idemp01()
  {
    var nomeCampo_idemp01 = "idemp01";
    var var_idemp01 = scAjaxGetFieldText(nomeCampo_idemp01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_idemp01(var_idemp01, var_script_case_init, do_ajax_form_maecte_validate_idemp01_cb);
  } // do_ajax_form_maecte_validate_idemp01

  function do_ajax_form_maecte_validate_idemp01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idemp01";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_idemp01_cb

  // ---------- Validate codprov01
  function do_ajax_form_maecte_validate_codprov01()
  {
    var nomeCampo_codprov01 = "codprov01";
    var var_codprov01 = scAjaxGetFieldText(nomeCampo_codprov01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_codprov01(var_codprov01, var_script_case_init, do_ajax_form_maecte_validate_codprov01_cb);
  } // do_ajax_form_maecte_validate_codprov01

  function do_ajax_form_maecte_validate_codprov01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_codprov01_cb

  // ---------- Validate celular01
  function do_ajax_form_maecte_validate_celular01()
  {
    var nomeCampo_celular01 = "celular01";
    var var_celular01 = scAjaxGetFieldText(nomeCampo_celular01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_celular01(var_celular01, var_script_case_init, do_ajax_form_maecte_validate_celular01_cb);
  } // do_ajax_form_maecte_validate_celular01

  function do_ajax_form_maecte_validate_celular01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_celular01_cb

  // ---------- Validate dircliente01
  function do_ajax_form_maecte_validate_dircliente01()
  {
    var nomeCampo_dircliente01 = "dircliente01";
    var var_dircliente01 = scAjaxGetFieldText(nomeCampo_dircliente01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_dircliente01(var_dircliente01, var_script_case_init, do_ajax_form_maecte_validate_dircliente01_cb);
  } // do_ajax_form_maecte_validate_dircliente01

  function do_ajax_form_maecte_validate_dircliente01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_dircliente01_cb

  // ---------- Validate razcte01
  function do_ajax_form_maecte_validate_razcte01()
  {
    var nomeCampo_razcte01 = "razcte01";
    var var_razcte01 = scAjaxGetFieldText(nomeCampo_razcte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_razcte01(var_razcte01, var_script_case_init, do_ajax_form_maecte_validate_razcte01_cb);
  } // do_ajax_form_maecte_validate_razcte01

  function do_ajax_form_maecte_validate_razcte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_razcte01_cb

  // ---------- Validate ruc01
  function do_ajax_form_maecte_validate_ruc01()
  {
    var nomeCampo_ruc01 = "ruc01";
    var var_ruc01 = scAjaxGetFieldText(nomeCampo_ruc01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_ruc01(var_ruc01, var_script_case_init, do_ajax_form_maecte_validate_ruc01_cb);
  } // do_ajax_form_maecte_validate_ruc01

  function do_ajax_form_maecte_validate_ruc01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ruc01";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_ruc01_cb

  // ---------- Validate timenegocio01
  function do_ajax_form_maecte_validate_timenegocio01()
  {
    var nomeCampo_timenegocio01 = "timenegocio01";
    var var_timenegocio01 = scAjaxGetFieldText(nomeCampo_timenegocio01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_timenegocio01(var_timenegocio01, var_script_case_init, do_ajax_form_maecte_validate_timenegocio01_cb);
  } // do_ajax_form_maecte_validate_timenegocio01

  function do_ajax_form_maecte_validate_timenegocio01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_timenegocio01_cb

  // ---------- Validate refbanc01
  function do_ajax_form_maecte_validate_refbanc01()
  {
    var nomeCampo_refbanc01 = "refbanc01";
    var var_refbanc01 = scAjaxGetFieldText(nomeCampo_refbanc01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_refbanc01(var_refbanc01, var_script_case_init, do_ajax_form_maecte_validate_refbanc01_cb);
  } // do_ajax_form_maecte_validate_refbanc01

  function do_ajax_form_maecte_validate_refbanc01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_refbanc01_cb

  // ---------- Validate refcom01
  function do_ajax_form_maecte_validate_refcom01()
  {
    var nomeCampo_refcom01 = "refcom01";
    var var_refcom01 = scAjaxGetFieldText(nomeCampo_refcom01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_refcom01(var_refcom01, var_script_case_init, do_ajax_form_maecte_validate_refcom01_cb);
  } // do_ajax_form_maecte_validate_refcom01

  function do_ajax_form_maecte_validate_refcom01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_refcom01_cb

  // ---------- Validate tarjcred01
  function do_ajax_form_maecte_validate_tarjcred01()
  {
    var nomeCampo_tarjcred01 = "tarjcred01";
    var var_tarjcred01 = scAjaxGetFieldText(nomeCampo_tarjcred01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_tarjcred01(var_tarjcred01, var_script_case_init, do_ajax_form_maecte_validate_tarjcred01_cb);
  } // do_ajax_form_maecte_validate_tarjcred01

  function do_ajax_form_maecte_validate_tarjcred01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_tarjcred01_cb

  // ---------- Validate firmaut01
  function do_ajax_form_maecte_validate_firmaut01()
  {
    var nomeCampo_firmaut01 = "firmaut01";
    var var_firmaut01 = scAjaxGetFieldText(nomeCampo_firmaut01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_firmaut01(var_firmaut01, var_script_case_init, do_ajax_form_maecte_validate_firmaut01_cb);
  } // do_ajax_form_maecte_validate_firmaut01

  function do_ajax_form_maecte_validate_firmaut01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_firmaut01_cb

  // ---------- Validate precte01
  function do_ajax_form_maecte_validate_precte01()
  {
    var nomeCampo_precte01 = "precte01";
    var var_precte01 = scAjaxGetFieldText(nomeCampo_precte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_precte01(var_precte01, var_script_case_init, do_ajax_form_maecte_validate_precte01_cb);
  } // do_ajax_form_maecte_validate_precte01

  function do_ajax_form_maecte_validate_precte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_precte01_cb

  // ---------- Validate cuotasven01
  function do_ajax_form_maecte_validate_cuotasven01()
  {
    var nomeCampo_cuotasven01 = "cuotasven01";
    var var_cuotasven01 = scAjaxGetFieldText(nomeCampo_cuotasven01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_cuotasven01(var_cuotasven01, var_script_case_init, do_ajax_form_maecte_validate_cuotasven01_cb);
  } // do_ajax_form_maecte_validate_cuotasven01

  function do_ajax_form_maecte_validate_cuotasven01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_cuotasven01_cb

  // ---------- Validate diasven01
  function do_ajax_form_maecte_validate_diasven01()
  {
    var nomeCampo_diasven01 = "diasven01";
    var var_diasven01 = scAjaxGetFieldText(nomeCampo_diasven01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_diasven01(var_diasven01, var_script_case_init, do_ajax_form_maecte_validate_diasven01_cb);
  } // do_ajax_form_maecte_validate_diasven01

  function do_ajax_form_maecte_validate_diasven01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_diasven01_cb

  // ---------- Validate fechanace01
  function do_ajax_form_maecte_validate_fechanace01()
  {
    var nomeCampo_fechanace01 = "fechanace01";
    var var_fechanace01 = scAjaxGetFieldText(nomeCampo_fechanace01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_fechanace01(var_fechanace01, var_script_case_init, do_ajax_form_maecte_validate_fechanace01_cb);
  } // do_ajax_form_maecte_validate_fechanace01

  function do_ajax_form_maecte_validate_fechanace01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_fechanace01_cb

  // ---------- Validate sexo01
  function do_ajax_form_maecte_validate_sexo01()
  {
    var nomeCampo_sexo01 = "sexo01";
    var var_sexo01 = scAjaxGetFieldText(nomeCampo_sexo01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_sexo01(var_sexo01, var_script_case_init, do_ajax_form_maecte_validate_sexo01_cb);
  } // do_ajax_form_maecte_validate_sexo01

  function do_ajax_form_maecte_validate_sexo01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sexo01";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_sexo01_cb

  // ---------- Validate estadocivil01
  function do_ajax_form_maecte_validate_estadocivil01()
  {
    var nomeCampo_estadocivil01 = "estadocivil01";
    var var_estadocivil01 = scAjaxGetFieldText(nomeCampo_estadocivil01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_estadocivil01(var_estadocivil01, var_script_case_init, do_ajax_form_maecte_validate_estadocivil01_cb);
  } // do_ajax_form_maecte_validate_estadocivil01

  function do_ajax_form_maecte_validate_estadocivil01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_estadocivil01_cb

  // ---------- Validate dirgestion01
  function do_ajax_form_maecte_validate_dirgestion01()
  {
    var nomeCampo_dirgestion01 = "dirgestion01";
    var var_dirgestion01 = scAjaxGetFieldText(nomeCampo_dirgestion01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_dirgestion01(var_dirgestion01, var_script_case_init, do_ajax_form_maecte_validate_dirgestion01_cb);
  } // do_ajax_form_maecte_validate_dirgestion01

  function do_ajax_form_maecte_validate_dirgestion01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_dirgestion01_cb

  // ---------- Validate numhijos01
  function do_ajax_form_maecte_validate_numhijos01()
  {
    var nomeCampo_numhijos01 = "numhijos01";
    var var_numhijos01 = scAjaxGetFieldText(nomeCampo_numhijos01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_numhijos01(var_numhijos01, var_script_case_init, do_ajax_form_maecte_validate_numhijos01_cb);
  } // do_ajax_form_maecte_validate_numhijos01

  function do_ajax_form_maecte_validate_numhijos01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_numhijos01_cb

  // ---------- Validate estsop01
  function do_ajax_form_maecte_validate_estsop01()
  {
    var nomeCampo_estsop01 = "estsop01";
    var var_estsop01 = scAjaxGetFieldText(nomeCampo_estsop01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_estsop01(var_estsop01, var_script_case_init, do_ajax_form_maecte_validate_estsop01_cb);
  } // do_ajax_form_maecte_validate_estsop01

  function do_ajax_form_maecte_validate_estsop01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_estsop01_cb

  // ---------- Validate notick01
  function do_ajax_form_maecte_validate_notick01()
  {
    var nomeCampo_notick01 = "notick01";
    var var_notick01 = scAjaxGetFieldText(nomeCampo_notick01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_notick01(var_notick01, var_script_case_init, do_ajax_form_maecte_validate_notick01_cb);
  } // do_ajax_form_maecte_validate_notick01

  function do_ajax_form_maecte_validate_notick01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_notick01_cb

  // ---------- Validate chequece
  function do_ajax_form_maecte_validate_chequece()
  {
    var nomeCampo_chequece = "chequece";
    var var_chequece = scAjaxGetFieldText(nomeCampo_chequece);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_chequece(var_chequece, var_script_case_init, do_ajax_form_maecte_validate_chequece_cb);
  } // do_ajax_form_maecte_validate_chequece

  function do_ajax_form_maecte_validate_chequece_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_chequece_cb

  // ---------- Validate solcre
  function do_ajax_form_maecte_validate_solcre()
  {
    var nomeCampo_solcre = "solcre";
    var var_solcre = scAjaxGetFieldText(nomeCampo_solcre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_solcre(var_solcre, var_script_case_init, do_ajax_form_maecte_validate_solcre_cb);
  } // do_ajax_form_maecte_validate_solcre

  function do_ajax_form_maecte_validate_solcre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "solcre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_solcre_cb

  // ---------- Validate promocte01
  function do_ajax_form_maecte_validate_promocte01()
  {
    var nomeCampo_promocte01 = "promocte01";
    var var_promocte01 = scAjaxGetFieldText(nomeCampo_promocte01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_promocte01(var_promocte01, var_script_case_init, do_ajax_form_maecte_validate_promocte01_cb);
  } // do_ajax_form_maecte_validate_promocte01

  function do_ajax_form_maecte_validate_promocte01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_promocte01_cb

  // ---------- Validate pagare01
  function do_ajax_form_maecte_validate_pagare01()
  {
    var nomeCampo_pagare01 = "pagare01";
    var var_pagare01 = scAjaxGetFieldText(nomeCampo_pagare01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_pagare01(var_pagare01, var_script_case_init, do_ajax_form_maecte_validate_pagare01_cb);
  } // do_ajax_form_maecte_validate_pagare01

  function do_ajax_form_maecte_validate_pagare01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_pagare01_cb

  // ---------- Validate valorpagare01
  function do_ajax_form_maecte_validate_valorpagare01()
  {
    var nomeCampo_valorpagare01 = "valorpagare01";
    var var_valorpagare01 = scAjaxGetFieldText(nomeCampo_valorpagare01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_valorpagare01(var_valorpagare01, var_script_case_init, do_ajax_form_maecte_validate_valorpagare01_cb);
  } // do_ajax_form_maecte_validate_valorpagare01

  function do_ajax_form_maecte_validate_valorpagare01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_valorpagare01_cb

  // ---------- Validate garante01
  function do_ajax_form_maecte_validate_garante01()
  {
    var nomeCampo_garante01 = "garante01";
    var var_garante01 = scAjaxGetFieldText(nomeCampo_garante01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_garante01(var_garante01, var_script_case_init, do_ajax_form_maecte_validate_garante01_cb);
  } // do_ajax_form_maecte_validate_garante01

  function do_ajax_form_maecte_validate_garante01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_garante01_cb

  // ---------- Validate fecvenp01
  function do_ajax_form_maecte_validate_fecvenp01()
  {
    ...
    setTimeout(function() {
      var var_fecvenp01 = scAjaxGetFieldText(nomeCampo_fecvenp01);
      x_ajax_form_maecte_validate_fecvenp01(var_fecvenp01, var_script_case_init, do_ajax_form_maecte_validate_fecvenp01_cb);
    }, 200);
  } // do_ajax_form_maecte_validate_fecvenp01

  function do_ajax_form_maecte_validate_fecvenp01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_fecvenp01_cb

  // ---------- Validate ctacgant01
  function do_ajax_form_maecte_validate_ctacgant01()
  {
    var nomeCampo_ctacgant01 = "ctacgant01";
    var var_ctacgant01 = scAjaxGetFieldText(nomeCampo_ctacgant01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_ctacgant01(var_ctacgant01, var_script_case_init, do_ajax_form_maecte_validate_ctacgant01_cb);
  } // do_ajax_form_maecte_validate_ctacgant01

  function do_ajax_form_maecte_validate_ctacgant01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_ctacgant01_cb

  // ---------- Validate dsn
  function do_ajax_form_maecte_validate_dsn()
  {
    var nomeCampo_dsn = "dsn";
    var var_dsn = scAjaxGetFieldText(nomeCampo_dsn);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_dsn(var_dsn, var_script_case_init, do_ajax_form_maecte_validate_dsn_cb);
  } // do_ajax_form_maecte_validate_dsn

  function do_ajax_form_maecte_validate_dsn_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dsn";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_dsn_cb

  // ---------- Validate residente
  function do_ajax_form_maecte_validate_residente()
  {
    var nomeCampo_residente = "residente";
    var var_residente = scAjaxGetFieldText(nomeCampo_residente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_residente(var_residente, var_script_case_init, do_ajax_form_maecte_validate_residente_cb);
  } // do_ajax_form_maecte_validate_residente

  function do_ajax_form_maecte_validate_residente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_residente_cb

  // ---------- Validate medio_contacto
  function do_ajax_form_maecte_validate_medio_contacto()
  {
    var nomeCampo_medio_contacto = "medio_contacto";
    var var_medio_contacto = scAjaxGetFieldText(nomeCampo_medio_contacto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_medio_contacto(var_medio_contacto, var_script_case_init, do_ajax_form_maecte_validate_medio_contacto_cb);
  } // do_ajax_form_maecte_validate_medio_contacto

  function do_ajax_form_maecte_validate_medio_contacto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_medio_contacto_cb

  // ---------- Validate separacion_bienes
  function do_ajax_form_maecte_validate_separacion_bienes()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_separacion_bienes(var_separacion_bienes, var_script_case_init, do_ajax_form_maecte_validate_separacion_bienes_cb);
  } // do_ajax_form_maecte_validate_separacion_bienes

  function do_ajax_form_maecte_validate_separacion_bienes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_separacion_bienes_cb

  // ---------- Validate disolucion_conyugal
  function do_ajax_form_maecte_validate_disolucion_conyugal()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_disolucion_conyugal(var_disolucion_conyugal, var_script_case_init, do_ajax_form_maecte_validate_disolucion_conyugal_cb);
  } // do_ajax_form_maecte_validate_disolucion_conyugal

  function do_ajax_form_maecte_validate_disolucion_conyugal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_disolucion_conyugal_cb

  // ---------- Validate capitulaciones
  function do_ajax_form_maecte_validate_capitulaciones()
  {
    var nomeCampo_capitulaciones = "capitulaciones";
    var var_capitulaciones = scAjaxGetFieldText(nomeCampo_capitulaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_capitulaciones(var_capitulaciones, var_script_case_init, do_ajax_form_maecte_validate_capitulaciones_cb);
  } // do_ajax_form_maecte_validate_capitulaciones

  function do_ajax_form_maecte_validate_capitulaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_capitulaciones_cb

  // ---------- Validate numero_carga_familiar
  function do_ajax_form_maecte_validate_numero_carga_familiar()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_numero_carga_familiar(var_numero_carga_familiar, var_script_case_init, do_ajax_form_maecte_validate_numero_carga_familiar_cb);
  } // do_ajax_form_maecte_validate_numero_carga_familiar

  function do_ajax_form_maecte_validate_numero_carga_familiar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_numero_carga_familiar_cb

  // ---------- Validate nivel_educacion
  function do_ajax_form_maecte_validate_nivel_educacion()
  {
    var nomeCampo_nivel_educacion = "nivel_educacion";
    var var_nivel_educacion = scAjaxGetFieldText(nomeCampo_nivel_educacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_nivel_educacion(var_nivel_educacion, var_script_case_init, do_ajax_form_maecte_validate_nivel_educacion_cb);
  } // do_ajax_form_maecte_validate_nivel_educacion

  function do_ajax_form_maecte_validate_nivel_educacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_nivel_educacion_cb

  // ---------- Validate profesion
  function do_ajax_form_maecte_validate_profesion()
  {
    var nomeCampo_profesion = "profesion";
    var var_profesion = scAjaxGetFieldText(nomeCampo_profesion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_profesion(var_profesion, var_script_case_init, do_ajax_form_maecte_validate_profesion_cb);
  } // do_ajax_form_maecte_validate_profesion

  function do_ajax_form_maecte_validate_profesion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_profesion_cb

  // ---------- Validate envio_correspondencia
  function do_ajax_form_maecte_validate_envio_correspondencia()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_envio_correspondencia(var_envio_correspondencia, var_script_case_init, do_ajax_form_maecte_validate_envio_correspondencia_cb);
  } // do_ajax_form_maecte_validate_envio_correspondencia

  function do_ajax_form_maecte_validate_envio_correspondencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_envio_correspondencia_cb

  // ---------- Validate nombre_arrendador
  function do_ajax_form_maecte_validate_nombre_arrendador()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_nombre_arrendador(var_nombre_arrendador, var_script_case_init, do_ajax_form_maecte_validate_nombre_arrendador_cb);
  } // do_ajax_form_maecte_validate_nombre_arrendador

  function do_ajax_form_maecte_validate_nombre_arrendador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_nombre_arrendador_cb

  // ---------- Validate apellido_arrendador
  function do_ajax_form_maecte_validate_apellido_arrendador()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_apellido_arrendador(var_apellido_arrendador, var_script_case_init, do_ajax_form_maecte_validate_apellido_arrendador_cb);
  } // do_ajax_form_maecte_validate_apellido_arrendador

  function do_ajax_form_maecte_validate_apellido_arrendador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_apellido_arrendador_cb

  // ---------- Validate id_vivienda
  function do_ajax_form_maecte_validate_id_vivienda()
  {
    var nomeCampo_id_vivienda = "id_vivienda";
    var var_id_vivienda = scAjaxGetFieldText(nomeCampo_id_vivienda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_vivienda(var_id_vivienda, var_script_case_init, do_ajax_form_maecte_validate_id_vivienda_cb);
  } // do_ajax_form_maecte_validate_id_vivienda

  function do_ajax_form_maecte_validate_id_vivienda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_vivienda_cb

  // ---------- Validate telefono_arrendador
  function do_ajax_form_maecte_validate_telefono_arrendador()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_telefono_arrendador(var_telefono_arrendador, var_script_case_init, do_ajax_form_maecte_validate_telefono_arrendador_cb);
  } // do_ajax_form_maecte_validate_telefono_arrendador

  function do_ajax_form_maecte_validate_telefono_arrendador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_telefono_arrendador_cb

  // ---------- Validate nombres_referencia
  function do_ajax_form_maecte_validate_nombres_referencia()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_nombres_referencia(var_nombres_referencia, var_script_case_init, do_ajax_form_maecte_validate_nombres_referencia_cb);
  } // do_ajax_form_maecte_validate_nombres_referencia

  function do_ajax_form_maecte_validate_nombres_referencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_nombres_referencia_cb

  // ---------- Validate apellidos_referencia
  function do_ajax_form_maecte_validate_apellidos_referencia()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_apellidos_referencia(var_apellidos_referencia, var_script_case_init, do_ajax_form_maecte_validate_apellidos_referencia_cb);
  } // do_ajax_form_maecte_validate_apellidos_referencia

  function do_ajax_form_maecte_validate_apellidos_referencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_apellidos_referencia_cb

  // ---------- Validate parentesco
  function do_ajax_form_maecte_validate_parentesco()
  {
    var nomeCampo_parentesco = "parentesco";
    var var_parentesco = scAjaxGetFieldText(nomeCampo_parentesco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_parentesco(var_parentesco, var_script_case_init, do_ajax_form_maecte_validate_parentesco_cb);
  } // do_ajax_form_maecte_validate_parentesco

  function do_ajax_form_maecte_validate_parentesco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_parentesco_cb

  // ---------- Validate celular_ref
  function do_ajax_form_maecte_validate_celular_ref()
  {
    var nomeCampo_celular_ref = "celular_ref";
    var var_celular_ref = scAjaxGetFieldText(nomeCampo_celular_ref);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_celular_ref(var_celular_ref, var_script_case_init, do_ajax_form_maecte_validate_celular_ref_cb);
  } // do_ajax_form_maecte_validate_celular_ref

  function do_ajax_form_maecte_validate_celular_ref_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_celular_ref_cb

  // ---------- Validate telefono_convencional_ref
  function do_ajax_form_maecte_validate_telefono_convencional_ref()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_telefono_convencional_ref(var_telefono_convencional_ref, var_script_case_init, do_ajax_form_maecte_validate_telefono_convencional_ref_cb);
  } // do_ajax_form_maecte_validate_telefono_convencional_ref

  function do_ajax_form_maecte_validate_telefono_convencional_ref_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_telefono_convencional_ref_cb

  // ---------- Validate id_ocupacion
  function do_ajax_form_maecte_validate_id_ocupacion()
  {
    var nomeCampo_id_ocupacion = "id_ocupacion";
    var var_id_ocupacion = scAjaxGetFieldText(nomeCampo_id_ocupacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_ocupacion(var_id_ocupacion, var_script_case_init, do_ajax_form_maecte_validate_id_ocupacion_cb);
  } // do_ajax_form_maecte_validate_id_ocupacion

  function do_ajax_form_maecte_validate_id_ocupacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_ocupacion_cb

  // ---------- Validate fecha_ingreso_empresa
  function do_ajax_form_maecte_validate_fecha_ingreso_empresa()
  {
    ...
    setTimeout(function() {
      var var_fecha_ingreso_empresa = scAjaxGetFieldText(nomeCampo_fecha_ingreso_empresa);
      x_ajax_form_maecte_validate_fecha_ingreso_empresa(var_fecha_ingreso_empresa, var_script_case_init, do_ajax_form_maecte_validate_fecha_ingreso_empresa_cb);
    }, 200);
  } // do_ajax_form_maecte_validate_fecha_ingreso_empresa

  function do_ajax_form_maecte_validate_fecha_ingreso_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_fecha_ingreso_empresa_cb

  // ---------- Validate nombre_empresa
  function do_ajax_form_maecte_validate_nombre_empresa()
  {
    var nomeCampo_nombre_empresa = "nombre_empresa";
    var var_nombre_empresa = scAjaxGetFieldText(nomeCampo_nombre_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_nombre_empresa(var_nombre_empresa, var_script_case_init, do_ajax_form_maecte_validate_nombre_empresa_cb);
  } // do_ajax_form_maecte_validate_nombre_empresa

  function do_ajax_form_maecte_validate_nombre_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_nombre_empresa_cb

  // ---------- Validate ciudad_empresa
  function do_ajax_form_maecte_validate_ciudad_empresa()
  {
    var nomeCampo_ciudad_empresa = "ciudad_empresa";
    var var_ciudad_empresa = scAjaxGetFieldText(nomeCampo_ciudad_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_ciudad_empresa(var_ciudad_empresa, var_script_case_init, do_ajax_form_maecte_validate_ciudad_empresa_cb);
  } // do_ajax_form_maecte_validate_ciudad_empresa

  function do_ajax_form_maecte_validate_ciudad_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_ciudad_empresa_cb

  // ---------- Validate provincia_empresa
  function do_ajax_form_maecte_validate_provincia_empresa()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_provincia_empresa(var_provincia_empresa, var_script_case_init, do_ajax_form_maecte_validate_provincia_empresa_cb);
  } // do_ajax_form_maecte_validate_provincia_empresa

  function do_ajax_form_maecte_validate_provincia_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_provincia_empresa_cb

  // ---------- Validate direccion_empresa
  function do_ajax_form_maecte_validate_direccion_empresa()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_direccion_empresa(var_direccion_empresa, var_script_case_init, do_ajax_form_maecte_validate_direccion_empresa_cb);
  } // do_ajax_form_maecte_validate_direccion_empresa

  function do_ajax_form_maecte_validate_direccion_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_direccion_empresa_cb

  // ---------- Validate cargo_empresa
  function do_ajax_form_maecte_validate_cargo_empresa()
  {
    var nomeCampo_cargo_empresa = "cargo_empresa";
    var var_cargo_empresa = scAjaxGetFieldText(nomeCampo_cargo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_cargo_empresa(var_cargo_empresa, var_script_case_init, do_ajax_form_maecte_validate_cargo_empresa_cb);
  } // do_ajax_form_maecte_validate_cargo_empresa

  function do_ajax_form_maecte_validate_cargo_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_cargo_empresa_cb

  // ---------- Validate telefono_empresa
  function do_ajax_form_maecte_validate_telefono_empresa()
  {
    var nomeCampo_telefono_empresa = "telefono_empresa";
    var var_telefono_empresa = scAjaxGetFieldText(nomeCampo_telefono_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_telefono_empresa(var_telefono_empresa, var_script_case_init, do_ajax_form_maecte_validate_telefono_empresa_cb);
  } // do_ajax_form_maecte_validate_telefono_empresa

  function do_ajax_form_maecte_validate_telefono_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_telefono_empresa_cb

  // ---------- Validate ext_empresa
  function do_ajax_form_maecte_validate_ext_empresa()
  {
    var nomeCampo_ext_empresa = "ext_empresa";
    var var_ext_empresa = scAjaxGetFieldText(nomeCampo_ext_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_ext_empresa(var_ext_empresa, var_script_case_init, do_ajax_form_maecte_validate_ext_empresa_cb);
  } // do_ajax_form_maecte_validate_ext_empresa

  function do_ajax_form_maecte_validate_ext_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_ext_empresa_cb

  // ---------- Validate id_tipo_contrato_actividad
  function do_ajax_form_maecte_validate_id_tipo_contrato_actividad()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_tipo_contrato_actividad(var_id_tipo_contrato_actividad, var_script_case_init, do_ajax_form_maecte_validate_id_tipo_contrato_actividad_cb);
  } // do_ajax_form_maecte_validate_id_tipo_contrato_actividad

  function do_ajax_form_maecte_validate_id_tipo_contrato_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_tipo_contrato_actividad_cb

  // ---------- Validate empresa_jubilo_actividad
  function do_ajax_form_maecte_validate_empresa_jubilo_actividad()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_empresa_jubilo_actividad(var_empresa_jubilo_actividad, var_script_case_init, do_ajax_form_maecte_validate_empresa_jubilo_actividad_cb);
  } // do_ajax_form_maecte_validate_empresa_jubilo_actividad

  function do_ajax_form_maecte_validate_empresa_jubilo_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_empresa_jubilo_actividad_cb

  // ---------- Validate fecha_salida_empresa_actividad
  function do_ajax_form_maecte_validate_fecha_salida_empresa_actividad()
  {
    ...
    setTimeout(function() {
      var var_fecha_salida_empresa_actividad = scAjaxGetFieldText(nomeCampo_fecha_salida_empresa_actividad);
      x_ajax_form_maecte_validate_fecha_salida_empresa_actividad(var_fecha_salida_empresa_actividad, var_script_case_init, do_ajax_form_maecte_validate_fecha_salida_empresa_actividad_cb);
    }, 200);
  } // do_ajax_form_maecte_validate_fecha_salida_empresa_actividad

  function do_ajax_form_maecte_validate_fecha_salida_empresa_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_fecha_salida_empresa_actividad_cb

  // ---------- Validate cargo_salida_empresa_actividad
  function do_ajax_form_maecte_validate_cargo_salida_empresa_actividad()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_cargo_salida_empresa_actividad(var_cargo_salida_empresa_actividad, var_script_case_init, do_ajax_form_maecte_validate_cargo_salida_empresa_actividad_cb);
  } // do_ajax_form_maecte_validate_cargo_salida_empresa_actividad

  function do_ajax_form_maecte_validate_cargo_salida_empresa_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_cargo_salida_empresa_actividad_cb

  // ---------- Validate fecha_inicio_actividad
  function do_ajax_form_maecte_validate_fecha_inicio_actividad()
  {
    ...
    setTimeout(function() {
      var var_fecha_inicio_actividad = scAjaxGetFieldText(nomeCampo_fecha_inicio_actividad);
      x_ajax_form_maecte_validate_fecha_inicio_actividad(var_fecha_inicio_actividad, var_script_case_init, do_ajax_form_maecte_validate_fecha_inicio_actividad_cb);
    }, 200);
  } // do_ajax_form_maecte_validate_fecha_inicio_actividad

  function do_ajax_form_maecte_validate_fecha_inicio_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_fecha_inicio_actividad_cb

  // ---------- Validate fecha_ingreso_empresa_actividad
  function do_ajax_form_maecte_validate_fecha_ingreso_empresa_actividad()
  {
    ...
    setTimeout(function() {
      var var_fecha_ingreso_empresa_actividad = scAjaxGetFieldText(nomeCampo_fecha_ingreso_empresa_actividad);
      x_ajax_form_maecte_validate_fecha_ingreso_empresa_actividad(var_fecha_ingreso_empresa_actividad, var_script_case_init, do_ajax_form_maecte_validate_fecha_ingreso_empresa_actividad_cb);
    }, 200);
  } // do_ajax_form_maecte_validate_fecha_ingreso_empresa_actividad

  function do_ajax_form_maecte_validate_fecha_ingreso_empresa_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_fecha_ingreso_empresa_actividad_cb

  // ---------- Validate nombre_empresa_actividad
  function do_ajax_form_maecte_validate_nombre_empresa_actividad()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_nombre_empresa_actividad(var_nombre_empresa_actividad, var_script_case_init, do_ajax_form_maecte_validate_nombre_empresa_actividad_cb);
  } // do_ajax_form_maecte_validate_nombre_empresa_actividad

  function do_ajax_form_maecte_validate_nombre_empresa_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_nombre_empresa_actividad_cb

  // ---------- Validate institucion_actividad
  function do_ajax_form_maecte_validate_institucion_actividad()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_institucion_actividad(var_institucion_actividad, var_script_case_init, do_ajax_form_maecte_validate_institucion_actividad_cb);
  } // do_ajax_form_maecte_validate_institucion_actividad

  function do_ajax_form_maecte_validate_institucion_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_institucion_actividad_cb

  // ---------- Validate ciudad_actividad
  function do_ajax_form_maecte_validate_ciudad_actividad()
  {
    var nomeCampo_ciudad_actividad = "ciudad_actividad";
    var var_ciudad_actividad = scAjaxGetFieldText(nomeCampo_ciudad_actividad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_ciudad_actividad(var_ciudad_actividad, var_script_case_init, do_ajax_form_maecte_validate_ciudad_actividad_cb);
  } // do_ajax_form_maecte_validate_ciudad_actividad

  function do_ajax_form_maecte_validate_ciudad_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_ciudad_actividad_cb

  // ---------- Validate provincia_actividad
  function do_ajax_form_maecte_validate_provincia_actividad()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_provincia_actividad(var_provincia_actividad, var_script_case_init, do_ajax_form_maecte_validate_provincia_actividad_cb);
  } // do_ajax_form_maecte_validate_provincia_actividad

  function do_ajax_form_maecte_validate_provincia_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_provincia_actividad_cb

  // ---------- Validate direccion_actividad
  function do_ajax_form_maecte_validate_direccion_actividad()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_direccion_actividad(var_direccion_actividad, var_script_case_init, do_ajax_form_maecte_validate_direccion_actividad_cb);
  } // do_ajax_form_maecte_validate_direccion_actividad

  function do_ajax_form_maecte_validate_direccion_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_direccion_actividad_cb

  // ---------- Validate calle_principal_actividad
  function do_ajax_form_maecte_validate_calle_principal_actividad()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_calle_principal_actividad(var_calle_principal_actividad, var_script_case_init, do_ajax_form_maecte_validate_calle_principal_actividad_cb);
  } // do_ajax_form_maecte_validate_calle_principal_actividad

  function do_ajax_form_maecte_validate_calle_principal_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_calle_principal_actividad_cb

  // ---------- Validate no_actividad
  function do_ajax_form_maecte_validate_no_actividad()
  {
    var nomeCampo_no_actividad = "no_actividad";
    var var_no_actividad = scAjaxGetFieldText(nomeCampo_no_actividad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_no_actividad(var_no_actividad, var_script_case_init, do_ajax_form_maecte_validate_no_actividad_cb);
  } // do_ajax_form_maecte_validate_no_actividad

  function do_ajax_form_maecte_validate_no_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_no_actividad_cb

  // ---------- Validate calle_secundaria_actividad
  function do_ajax_form_maecte_validate_calle_secundaria_actividad()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_calle_secundaria_actividad(var_calle_secundaria_actividad, var_script_case_init, do_ajax_form_maecte_validate_calle_secundaria_actividad_cb);
  } // do_ajax_form_maecte_validate_calle_secundaria_actividad

  function do_ajax_form_maecte_validate_calle_secundaria_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_calle_secundaria_actividad_cb

  // ---------- Validate sector_actividad
  function do_ajax_form_maecte_validate_sector_actividad()
  {
    var nomeCampo_sector_actividad = "sector_actividad";
    var var_sector_actividad = scAjaxGetFieldText(nomeCampo_sector_actividad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_sector_actividad(var_sector_actividad, var_script_case_init, do_ajax_form_maecte_validate_sector_actividad_cb);
  } // do_ajax_form_maecte_validate_sector_actividad

  function do_ajax_form_maecte_validate_sector_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_sector_actividad_cb

  // ---------- Validate pais_actividad
  function do_ajax_form_maecte_validate_pais_actividad()
  {
    var nomeCampo_pais_actividad = "pais_actividad";
    var var_pais_actividad = scAjaxGetFieldText(nomeCampo_pais_actividad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_pais_actividad(var_pais_actividad, var_script_case_init, do_ajax_form_maecte_validate_pais_actividad_cb);
  } // do_ajax_form_maecte_validate_pais_actividad

  function do_ajax_form_maecte_validate_pais_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_pais_actividad_cb

  // ---------- Validate actividad
  function do_ajax_form_maecte_validate_actividad()
  {
    var nomeCampo_actividad = "actividad";
    var var_actividad = scAjaxGetFieldText(nomeCampo_actividad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_actividad(var_actividad, var_script_case_init, do_ajax_form_maecte_validate_actividad_cb);
  } // do_ajax_form_maecte_validate_actividad

  function do_ajax_form_maecte_validate_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_actividad_cb

  // ---------- Validate telefono_actividad
  function do_ajax_form_maecte_validate_telefono_actividad()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_telefono_actividad(var_telefono_actividad, var_script_case_init, do_ajax_form_maecte_validate_telefono_actividad_cb);
  } // do_ajax_form_maecte_validate_telefono_actividad

  function do_ajax_form_maecte_validate_telefono_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_telefono_actividad_cb

  // ---------- Validate cargo_actividad
  function do_ajax_form_maecte_validate_cargo_actividad()
  {
    var nomeCampo_cargo_actividad = "cargo_actividad";
    var var_cargo_actividad = scAjaxGetFieldText(nomeCampo_cargo_actividad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_cargo_actividad(var_cargo_actividad, var_script_case_init, do_ajax_form_maecte_validate_cargo_actividad_cb);
  } // do_ajax_form_maecte_validate_cargo_actividad

  function do_ajax_form_maecte_validate_cargo_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_cargo_actividad_cb

  // ---------- Validate ext_actividad
  function do_ajax_form_maecte_validate_ext_actividad()
  {
    var nomeCampo_ext_actividad = "ext_actividad";
    var var_ext_actividad = scAjaxGetFieldText(nomeCampo_ext_actividad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_ext_actividad(var_ext_actividad, var_script_case_init, do_ajax_form_maecte_validate_ext_actividad_cb);
  } // do_ajax_form_maecte_validate_ext_actividad

  function do_ajax_form_maecte_validate_ext_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_ext_actividad_cb

  // ---------- Validate fecha_ingreso_empresa_actividad2
  function do_ajax_form_maecte_validate_fecha_ingreso_empresa_actividad2()
  {
    ...
    setTimeout(function() {
      var var_fecha_ingreso_empresa_actividad2 = scAjaxGetFieldText(nomeCampo_fecha_ingreso_empresa_actividad2);
      x_ajax_form_maecte_validate_fecha_ingreso_empresa_actividad2(var_fecha_ingreso_empresa_actividad2, var_script_case_init, do_ajax_form_maecte_validate_fecha_ingreso_empresa_actividad2_cb);
    }, 200);
  } // do_ajax_form_maecte_validate_fecha_ingreso_empresa_actividad2

  function do_ajax_form_maecte_validate_fecha_ingreso_empresa_actividad2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_fecha_ingreso_empresa_actividad2_cb

  // ---------- Validate nombre_empresa_actividad2
  function do_ajax_form_maecte_validate_nombre_empresa_actividad2()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_nombre_empresa_actividad2(var_nombre_empresa_actividad2, var_script_case_init, do_ajax_form_maecte_validate_nombre_empresa_actividad2_cb);
  } // do_ajax_form_maecte_validate_nombre_empresa_actividad2

  function do_ajax_form_maecte_validate_nombre_empresa_actividad2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_nombre_empresa_actividad2_cb

  // ---------- Validate institucion_actividad2
  function do_ajax_form_maecte_validate_institucion_actividad2()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_institucion_actividad2(var_institucion_actividad2, var_script_case_init, do_ajax_form_maecte_validate_institucion_actividad2_cb);
  } // do_ajax_form_maecte_validate_institucion_actividad2

  function do_ajax_form_maecte_validate_institucion_actividad2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_institucion_actividad2_cb

  // ---------- Validate ciudad_actividad2
  function do_ajax_form_maecte_validate_ciudad_actividad2()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_ciudad_actividad2(var_ciudad_actividad2, var_script_case_init, do_ajax_form_maecte_validate_ciudad_actividad2_cb);
  } // do_ajax_form_maecte_validate_ciudad_actividad2

  function do_ajax_form_maecte_validate_ciudad_actividad2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_ciudad_actividad2_cb

  // ---------- Validate provincia_actividad2
  function do_ajax_form_maecte_validate_provincia_actividad2()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_provincia_actividad2(var_provincia_actividad2, var_script_case_init, do_ajax_form_maecte_validate_provincia_actividad2_cb);
  } // do_ajax_form_maecte_validate_provincia_actividad2

  function do_ajax_form_maecte_validate_provincia_actividad2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_provincia_actividad2_cb

  // ---------- Validate direccion_actividad2
  function do_ajax_form_maecte_validate_direccion_actividad2()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_direccion_actividad2(var_direccion_actividad2, var_script_case_init, do_ajax_form_maecte_validate_direccion_actividad2_cb);
  } // do_ajax_form_maecte_validate_direccion_actividad2

  function do_ajax_form_maecte_validate_direccion_actividad2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_direccion_actividad2_cb

  // ---------- Validate calle_principal_actividad2
  function do_ajax_form_maecte_validate_calle_principal_actividad2()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_calle_principal_actividad2(var_calle_principal_actividad2, var_script_case_init, do_ajax_form_maecte_validate_calle_principal_actividad2_cb);
  } // do_ajax_form_maecte_validate_calle_principal_actividad2

  function do_ajax_form_maecte_validate_calle_principal_actividad2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_calle_principal_actividad2_cb

  // ---------- Validate no_actividad2
  function do_ajax_form_maecte_validate_no_actividad2()
  {
    var nomeCampo_no_actividad2 = "no_actividad2";
    var var_no_actividad2 = scAjaxGetFieldText(nomeCampo_no_actividad2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_no_actividad2(var_no_actividad2, var_script_case_init, do_ajax_form_maecte_validate_no_actividad2_cb);
  } // do_ajax_form_maecte_validate_no_actividad2

  function do_ajax_form_maecte_validate_no_actividad2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_no_actividad2_cb

  // ---------- Validate calle_secundaria_actividad2
  function do_ajax_form_maecte_validate_calle_secundaria_actividad2()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_calle_secundaria_actividad2(var_calle_secundaria_actividad2, var_script_case_init, do_ajax_form_maecte_validate_calle_secundaria_actividad2_cb);
  } // do_ajax_form_maecte_validate_calle_secundaria_actividad2

  function do_ajax_form_maecte_validate_calle_secundaria_actividad2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_calle_secundaria_actividad2_cb

  // ---------- Validate sector_actividad2
  function do_ajax_form_maecte_validate_sector_actividad2()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_sector_actividad2(var_sector_actividad2, var_script_case_init, do_ajax_form_maecte_validate_sector_actividad2_cb);
  } // do_ajax_form_maecte_validate_sector_actividad2

  function do_ajax_form_maecte_validate_sector_actividad2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_sector_actividad2_cb

  // ---------- Validate fecha_salida_empresa_actividad2
  function do_ajax_form_maecte_validate_fecha_salida_empresa_actividad2()
  {
    ...
    setTimeout(function() {
      var var_fecha_salida_empresa_actividad2 = scAjaxGetFieldText(nomeCampo_fecha_salida_empresa_actividad2);
      x_ajax_form_maecte_validate_fecha_salida_empresa_actividad2(var_fecha_salida_empresa_actividad2, var_script_case_init, do_ajax_form_maecte_validate_fecha_salida_empresa_actividad2_cb);
    }, 200);
  } // do_ajax_form_maecte_validate_fecha_salida_empresa_actividad2

  function do_ajax_form_maecte_validate_fecha_salida_empresa_actividad2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_fecha_salida_empresa_actividad2_cb

  // ---------- Validate fecha_inicio_actividad2
  function do_ajax_form_maecte_validate_fecha_inicio_actividad2()
  {
    ...
    setTimeout(function() {
      var var_fecha_inicio_actividad2 = scAjaxGetFieldText(nomeCampo_fecha_inicio_actividad2);
      x_ajax_form_maecte_validate_fecha_inicio_actividad2(var_fecha_inicio_actividad2, var_script_case_init, do_ajax_form_maecte_validate_fecha_inicio_actividad2_cb);
    }, 200);
  } // do_ajax_form_maecte_validate_fecha_inicio_actividad2

  function do_ajax_form_maecte_validate_fecha_inicio_actividad2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_fecha_inicio_actividad2_cb

  // ---------- Validate actividad2
  function do_ajax_form_maecte_validate_actividad2()
  {
    var nomeCampo_actividad2 = "actividad2";
    var var_actividad2 = scAjaxGetFieldText(nomeCampo_actividad2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_actividad2(var_actividad2, var_script_case_init, do_ajax_form_maecte_validate_actividad2_cb);
  } // do_ajax_form_maecte_validate_actividad2

  function do_ajax_form_maecte_validate_actividad2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_actividad2_cb

  // ---------- Validate telefono_actividad2
  function do_ajax_form_maecte_validate_telefono_actividad2()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_telefono_actividad2(var_telefono_actividad2, var_script_case_init, do_ajax_form_maecte_validate_telefono_actividad2_cb);
  } // do_ajax_form_maecte_validate_telefono_actividad2

  function do_ajax_form_maecte_validate_telefono_actividad2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_telefono_actividad2_cb

  // ---------- Validate ext_actividad2
  function do_ajax_form_maecte_validate_ext_actividad2()
  {
    var nomeCampo_ext_actividad2 = "ext_actividad2";
    var var_ext_actividad2 = scAjaxGetFieldText(nomeCampo_ext_actividad2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_ext_actividad2(var_ext_actividad2, var_script_case_init, do_ajax_form_maecte_validate_ext_actividad2_cb);
  } // do_ajax_form_maecte_validate_ext_actividad2

  function do_ajax_form_maecte_validate_ext_actividad2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_ext_actividad2_cb

  // ---------- Validate cargo_actividad2
  function do_ajax_form_maecte_validate_cargo_actividad2()
  {
    var nomeCampo_cargo_actividad2 = "cargo_actividad2";
    var var_cargo_actividad2 = scAjaxGetFieldText(nomeCampo_cargo_actividad2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_cargo_actividad2(var_cargo_actividad2, var_script_case_init, do_ajax_form_maecte_validate_cargo_actividad2_cb);
  } // do_ajax_form_maecte_validate_cargo_actividad2

  function do_ajax_form_maecte_validate_cargo_actividad2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_cargo_actividad2_cb

  // ---------- Validate id_tipo_contrato_actividad2
  function do_ajax_form_maecte_validate_id_tipo_contrato_actividad2()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_tipo_contrato_actividad2(var_id_tipo_contrato_actividad2, var_script_case_init, do_ajax_form_maecte_validate_id_tipo_contrato_actividad2_cb);
  } // do_ajax_form_maecte_validate_id_tipo_contrato_actividad2

  function do_ajax_form_maecte_validate_id_tipo_contrato_actividad2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_tipo_contrato_actividad2_cb

  // ---------- Validate empresa_jubilo_actividad2
  function do_ajax_form_maecte_validate_empresa_jubilo_actividad2()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_empresa_jubilo_actividad2(var_empresa_jubilo_actividad2, var_script_case_init, do_ajax_form_maecte_validate_empresa_jubilo_actividad2_cb);
  } // do_ajax_form_maecte_validate_empresa_jubilo_actividad2

  function do_ajax_form_maecte_validate_empresa_jubilo_actividad2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_empresa_jubilo_actividad2_cb

  // ---------- Validate sueldo
  function do_ajax_form_maecte_validate_sueldo()
  {
    var nomeCampo_sueldo = "sueldo";
    var var_sueldo = scAjaxGetFieldText(nomeCampo_sueldo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_sueldo(var_sueldo, var_script_case_init, do_ajax_form_maecte_validate_sueldo_cb);
  } // do_ajax_form_maecte_validate_sueldo

  function do_ajax_form_maecte_validate_sueldo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sueldo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_sueldo_cb

  // ---------- Validate arriendos
  function do_ajax_form_maecte_validate_arriendos()
  {
    var nomeCampo_arriendos = "arriendos";
    var var_arriendos = scAjaxGetFieldText(nomeCampo_arriendos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_arriendos(var_arriendos, var_script_case_init, do_ajax_form_maecte_validate_arriendos_cb);
  } // do_ajax_form_maecte_validate_arriendos

  function do_ajax_form_maecte_validate_arriendos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_arriendos_cb

  // ---------- Validate dividendo_utilidades_ultimo_ano
  function do_ajax_form_maecte_validate_dividendo_utilidades_ultimo_ano()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_dividendo_utilidades_ultimo_ano(var_dividendo_utilidades_ultimo_ano, var_script_case_init, do_ajax_form_maecte_validate_dividendo_utilidades_ultimo_ano_cb);
  } // do_ajax_form_maecte_validate_dividendo_utilidades_ultimo_ano

  function do_ajax_form_maecte_validate_dividendo_utilidades_ultimo_ano_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_dividendo_utilidades_ultimo_ano_cb

  // ---------- Validate id_otros_ingresos
  function do_ajax_form_maecte_validate_id_otros_ingresos()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_otros_ingresos(var_id_otros_ingresos, var_script_case_init, do_ajax_form_maecte_validate_id_otros_ingresos_cb);
  } // do_ajax_form_maecte_validate_id_otros_ingresos

  function do_ajax_form_maecte_validate_id_otros_ingresos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_otros_ingresos_cb

  // ---------- Validate arriendo_hipoteca
  function do_ajax_form_maecte_validate_arriendo_hipoteca()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_arriendo_hipoteca(var_arriendo_hipoteca, var_script_case_init, do_ajax_form_maecte_validate_arriendo_hipoteca_cb);
  } // do_ajax_form_maecte_validate_arriendo_hipoteca

  function do_ajax_form_maecte_validate_arriendo_hipoteca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_arriendo_hipoteca_cb

  // ---------- Validate prestamos
  function do_ajax_form_maecte_validate_prestamos()
  {
    var nomeCampo_prestamos = "prestamos";
    var var_prestamos = scAjaxGetFieldText(nomeCampo_prestamos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_prestamos(var_prestamos, var_script_case_init, do_ajax_form_maecte_validate_prestamos_cb);
  } // do_ajax_form_maecte_validate_prestamos

  function do_ajax_form_maecte_validate_prestamos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_prestamos_cb

  // ---------- Validate tarjetas_creditos
  function do_ajax_form_maecte_validate_tarjetas_creditos()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_tarjetas_creditos(var_tarjetas_creditos, var_script_case_init, do_ajax_form_maecte_validate_tarjetas_creditos_cb);
  } // do_ajax_form_maecte_validate_tarjetas_creditos

  function do_ajax_form_maecte_validate_tarjetas_creditos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_tarjetas_creditos_cb

  // ---------- Validate gastos_familiares
  function do_ajax_form_maecte_validate_gastos_familiares()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_gastos_familiares(var_gastos_familiares, var_script_case_init, do_ajax_form_maecte_validate_gastos_familiares_cb);
  } // do_ajax_form_maecte_validate_gastos_familiares

  function do_ajax_form_maecte_validate_gastos_familiares_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_gastos_familiares_cb

  // ---------- Validate id_otros_gastos
  function do_ajax_form_maecte_validate_id_otros_gastos()
  {
    var nomeCampo_id_otros_gastos = "id_otros_gastos";
    var var_id_otros_gastos = scAjaxGetFieldText(nomeCampo_id_otros_gastos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_otros_gastos(var_id_otros_gastos, var_script_case_init, do_ajax_form_maecte_validate_id_otros_gastos_cb);
  } // do_ajax_form_maecte_validate_id_otros_gastos

  function do_ajax_form_maecte_validate_id_otros_gastos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_otros_gastos_cb

  // ---------- Validate depositos_bancos
  function do_ajax_form_maecte_validate_depositos_bancos()
  {
    var nomeCampo_depositos_bancos = "depositos_bancos";
    var var_depositos_bancos = scAjaxGetFieldText(nomeCampo_depositos_bancos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_depositos_bancos(var_depositos_bancos, var_script_case_init, do_ajax_form_maecte_validate_depositos_bancos_cb);
  } // do_ajax_form_maecte_validate_depositos_bancos

  function do_ajax_form_maecte_validate_depositos_bancos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_depositos_bancos_cb

  // ---------- Validate cuentas_documentos
  function do_ajax_form_maecte_validate_cuentas_documentos()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_cuentas_documentos(var_cuentas_documentos, var_script_case_init, do_ajax_form_maecte_validate_cuentas_documentos_cb);
  } // do_ajax_form_maecte_validate_cuentas_documentos

  function do_ajax_form_maecte_validate_cuentas_documentos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_cuentas_documentos_cb

  // ---------- Validate mercaderias
  function do_ajax_form_maecte_validate_mercaderias()
  {
    var nomeCampo_mercaderias = "mercaderias";
    var var_mercaderias = scAjaxGetFieldText(nomeCampo_mercaderias);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_mercaderias(var_mercaderias, var_script_case_init, do_ajax_form_maecte_validate_mercaderias_cb);
  } // do_ajax_form_maecte_validate_mercaderias

  function do_ajax_form_maecte_validate_mercaderias_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_mercaderias_cb

  // ---------- Validate maquinarias_vehiculos
  function do_ajax_form_maecte_validate_maquinarias_vehiculos()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_maquinarias_vehiculos(var_maquinarias_vehiculos, var_script_case_init, do_ajax_form_maecte_validate_maquinarias_vehiculos_cb);
  } // do_ajax_form_maecte_validate_maquinarias_vehiculos

  function do_ajax_form_maecte_validate_maquinarias_vehiculos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_maquinarias_vehiculos_cb

  // ---------- Validate terrenos_edificios
  function do_ajax_form_maecte_validate_terrenos_edificios()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_terrenos_edificios(var_terrenos_edificios, var_script_case_init, do_ajax_form_maecte_validate_terrenos_edificios_cb);
  } // do_ajax_form_maecte_validate_terrenos_edificios

  function do_ajax_form_maecte_validate_terrenos_edificios_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_terrenos_edificios_cb

  // ---------- Validate acciones_bonos_cedulas
  function do_ajax_form_maecte_validate_acciones_bonos_cedulas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_acciones_bonos_cedulas(var_acciones_bonos_cedulas, var_script_case_init, do_ajax_form_maecte_validate_acciones_bonos_cedulas_cb);
  } // do_ajax_form_maecte_validate_acciones_bonos_cedulas

  function do_ajax_form_maecte_validate_acciones_bonos_cedulas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_acciones_bonos_cedulas_cb

  // ---------- Validate id_otros_activos
  function do_ajax_form_maecte_validate_id_otros_activos()
  {
    var nomeCampo_id_otros_activos = "id_otros_activos";
    var var_id_otros_activos = scAjaxGetFieldText(nomeCampo_id_otros_activos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_otros_activos(var_id_otros_activos, var_script_case_init, do_ajax_form_maecte_validate_id_otros_activos_cb);
  } // do_ajax_form_maecte_validate_id_otros_activos

  function do_ajax_form_maecte_validate_id_otros_activos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_otros_activos_cb

  // ---------- Validate cuentas_por_pagar
  function do_ajax_form_maecte_validate_cuentas_por_pagar()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_cuentas_por_pagar(var_cuentas_por_pagar, var_script_case_init, do_ajax_form_maecte_validate_cuentas_por_pagar_cb);
  } // do_ajax_form_maecte_validate_cuentas_por_pagar

  function do_ajax_form_maecte_validate_cuentas_por_pagar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_cuentas_por_pagar_cb

  // ---------- Validate prestamos_banco_menos_ano
  function do_ajax_form_maecte_validate_prestamos_banco_menos_ano()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_prestamos_banco_menos_ano(var_prestamos_banco_menos_ano, var_script_case_init, do_ajax_form_maecte_validate_prestamos_banco_menos_ano_cb);
  } // do_ajax_form_maecte_validate_prestamos_banco_menos_ano

  function do_ajax_form_maecte_validate_prestamos_banco_menos_ano_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_prestamos_banco_menos_ano_cb

  // ---------- Validate prestamos_banco_mas_ano
  function do_ajax_form_maecte_validate_prestamos_banco_mas_ano()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_prestamos_banco_mas_ano(var_prestamos_banco_mas_ano, var_script_case_init, do_ajax_form_maecte_validate_prestamos_banco_mas_ano_cb);
  } // do_ajax_form_maecte_validate_prestamos_banco_mas_ano

  function do_ajax_form_maecte_validate_prestamos_banco_mas_ano_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_prestamos_banco_mas_ano_cb

  // ---------- Validate deudas_tarjetas_creditos
  function do_ajax_form_maecte_validate_deudas_tarjetas_creditos()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_deudas_tarjetas_creditos(var_deudas_tarjetas_creditos, var_script_case_init, do_ajax_form_maecte_validate_deudas_tarjetas_creditos_cb);
  } // do_ajax_form_maecte_validate_deudas_tarjetas_creditos

  function do_ajax_form_maecte_validate_deudas_tarjetas_creditos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_deudas_tarjetas_creditos_cb

  // ---------- Validate id_otras_obligaciones
  function do_ajax_form_maecte_validate_id_otras_obligaciones()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_otras_obligaciones(var_id_otras_obligaciones, var_script_case_init, do_ajax_form_maecte_validate_id_otras_obligaciones_cb);
  } // do_ajax_form_maecte_validate_id_otras_obligaciones

  function do_ajax_form_maecte_validate_id_otras_obligaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_otras_obligaciones_cb

  // ---------- Validate deudor
  function do_ajax_form_maecte_validate_deudor()
  {
    var nomeCampo_deudor = "deudor";
    var var_deudor = scAjaxGetFieldText(nomeCampo_deudor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_deudor(var_deudor, var_script_case_init, do_ajax_form_maecte_validate_deudor_cb);
  } // do_ajax_form_maecte_validate_deudor

  function do_ajax_form_maecte_validate_deudor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "deudor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_deudor_cb

  // ---------- Validate monto
  function do_ajax_form_maecte_validate_monto()
  {
    var nomeCampo_monto = "monto";
    var var_monto = scAjaxGetFieldText(nomeCampo_monto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_monto(var_monto, var_script_case_init, do_ajax_form_maecte_validate_monto_cb);
  } // do_ajax_form_maecte_validate_monto

  function do_ajax_form_maecte_validate_monto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "monto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_monto_cb

  // ---------- Validate descripcion
  function do_ajax_form_maecte_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_maecte_validate_descripcion_cb);
  } // do_ajax_form_maecte_validate_descripcion

  function do_ajax_form_maecte_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_descripcion_cb

  // ---------- Validate placa
  function do_ajax_form_maecte_validate_placa()
  {
    var nomeCampo_placa = "placa";
    var var_placa = scAjaxGetFieldText(nomeCampo_placa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_placa(var_placa, var_script_case_init, do_ajax_form_maecte_validate_placa_cb);
  } // do_ajax_form_maecte_validate_placa

  function do_ajax_form_maecte_validate_placa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "placa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_placa_cb

  // ---------- Validate valor_maquinaria_vehiculo
  function do_ajax_form_maecte_validate_valor_maquinaria_vehiculo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_valor_maquinaria_vehiculo(var_valor_maquinaria_vehiculo, var_script_case_init, do_ajax_form_maecte_validate_valor_maquinaria_vehiculo_cb);
  } // do_ajax_form_maecte_validate_valor_maquinaria_vehiculo

  function do_ajax_form_maecte_validate_valor_maquinaria_vehiculo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_valor_maquinaria_vehiculo_cb

  // ---------- Validate a_nombre_de
  function do_ajax_form_maecte_validate_a_nombre_de()
  {
    var nomeCampo_a_nombre_de = "a_nombre_de";
    var var_a_nombre_de = scAjaxGetFieldText(nomeCampo_a_nombre_de);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_a_nombre_de(var_a_nombre_de, var_script_case_init, do_ajax_form_maecte_validate_a_nombre_de_cb);
  } // do_ajax_form_maecte_validate_a_nombre_de

  function do_ajax_form_maecte_validate_a_nombre_de_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_a_nombre_de_cb

  // ---------- Validate ubicacion
  function do_ajax_form_maecte_validate_ubicacion()
  {
    var nomeCampo_ubicacion = "ubicacion";
    var var_ubicacion = scAjaxGetFieldText(nomeCampo_ubicacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_ubicacion(var_ubicacion, var_script_case_init, do_ajax_form_maecte_validate_ubicacion_cb);
  } // do_ajax_form_maecte_validate_ubicacion

  function do_ajax_form_maecte_validate_ubicacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_ubicacion_cb

  // ---------- Validate valor_propiedad
  function do_ajax_form_maecte_validate_valor_propiedad()
  {
    var nomeCampo_valor_propiedad = "valor_propiedad";
    var var_valor_propiedad = scAjaxGetFieldText(nomeCampo_valor_propiedad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_valor_propiedad(var_valor_propiedad, var_script_case_init, do_ajax_form_maecte_validate_valor_propiedad_cb);
  } // do_ajax_form_maecte_validate_valor_propiedad

  function do_ajax_form_maecte_validate_valor_propiedad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_valor_propiedad_cb

  // ---------- Validate empresa
  function do_ajax_form_maecte_validate_empresa()
  {
    var nomeCampo_empresa = "empresa";
    var var_empresa = scAjaxGetFieldText(nomeCampo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_empresa(var_empresa, var_script_case_init, do_ajax_form_maecte_validate_empresa_cb);
  } // do_ajax_form_maecte_validate_empresa

  function do_ajax_form_maecte_validate_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "empresa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_empresa_cb

  // ---------- Validate valor_mercado
  function do_ajax_form_maecte_validate_valor_mercado()
  {
    var nomeCampo_valor_mercado = "valor_mercado";
    var var_valor_mercado = scAjaxGetFieldText(nomeCampo_valor_mercado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_valor_mercado(var_valor_mercado, var_script_case_init, do_ajax_form_maecte_validate_valor_mercado_cb);
  } // do_ajax_form_maecte_validate_valor_mercado

  function do_ajax_form_maecte_validate_valor_mercado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_valor_mercado_cb

  // ---------- Validate institucion_bancaria
  function do_ajax_form_maecte_validate_institucion_bancaria()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_institucion_bancaria(var_institucion_bancaria, var_script_case_init, do_ajax_form_maecte_validate_institucion_bancaria_cb);
  } // do_ajax_form_maecte_validate_institucion_bancaria

  function do_ajax_form_maecte_validate_institucion_bancaria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_institucion_bancaria_cb

  // ---------- Validate monto_banco
  function do_ajax_form_maecte_validate_monto_banco()
  {
    var nomeCampo_monto_banco = "monto_banco";
    var var_monto_banco = scAjaxGetFieldText(nomeCampo_monto_banco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_monto_banco(var_monto_banco, var_script_case_init, do_ajax_form_maecte_validate_monto_banco_cb);
  } // do_ajax_form_maecte_validate_monto_banco

  function do_ajax_form_maecte_validate_monto_banco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_monto_banco_cb

  // ---------- Validate institucion_finaciera
  function do_ajax_form_maecte_validate_institucion_finaciera()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_institucion_finaciera(var_institucion_finaciera, var_script_case_init, do_ajax_form_maecte_validate_institucion_finaciera_cb);
  } // do_ajax_form_maecte_validate_institucion_finaciera

  function do_ajax_form_maecte_validate_institucion_finaciera_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_institucion_finaciera_cb

  // ---------- Validate monto_institucion_finaciera
  function do_ajax_form_maecte_validate_monto_institucion_finaciera()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_monto_institucion_finaciera(var_monto_institucion_finaciera, var_script_case_init, do_ajax_form_maecte_validate_monto_institucion_finaciera_cb);
  } // do_ajax_form_maecte_validate_monto_institucion_finaciera

  function do_ajax_form_maecte_validate_monto_institucion_finaciera_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_monto_institucion_finaciera_cb

  // ---------- Validate id_cliente_juridico
  function do_ajax_form_maecte_validate_id_cliente_juridico()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_cliente_juridico(var_id_cliente_juridico, var_script_case_init, do_ajax_form_maecte_validate_id_cliente_juridico_cb);
  } // do_ajax_form_maecte_validate_id_cliente_juridico

  function do_ajax_form_maecte_validate_id_cliente_juridico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_cliente_juridico_cb

  // ---------- Validate nombre_completo_empresa
  function do_ajax_form_maecte_validate_nombre_completo_empresa()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_nombre_completo_empresa(var_nombre_completo_empresa, var_script_case_init, do_ajax_form_maecte_validate_nombre_completo_empresa_cb);
  } // do_ajax_form_maecte_validate_nombre_completo_empresa

  function do_ajax_form_maecte_validate_nombre_completo_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_nombre_completo_empresa_cb

  // ---------- Validate es_empresa_extranjera
  function do_ajax_form_maecte_validate_es_empresa_extranjera()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_es_empresa_extranjera(var_es_empresa_extranjera, var_script_case_init, do_ajax_form_maecte_validate_es_empresa_extranjera_cb);
  } // do_ajax_form_maecte_validate_es_empresa_extranjera

  function do_ajax_form_maecte_validate_es_empresa_extranjera_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_es_empresa_extranjera_cb

  // ---------- Validate pais_empresa
  function do_ajax_form_maecte_validate_pais_empresa()
  {
    var nomeCampo_pais_empresa = "pais_empresa";
    var var_pais_empresa = scAjaxGetFieldText(nomeCampo_pais_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_pais_empresa(var_pais_empresa, var_script_case_init, do_ajax_form_maecte_validate_pais_empresa_cb);
  } // do_ajax_form_maecte_validate_pais_empresa

  function do_ajax_form_maecte_validate_pais_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_pais_empresa_cb

  // ---------- Validate fecha_constitucion_empresa
  function do_ajax_form_maecte_validate_fecha_constitucion_empresa()
  {
    ...
    setTimeout(function() {
      var var_fecha_constitucion_empresa = scAjaxGetFieldText(nomeCampo_fecha_constitucion_empresa);
      x_ajax_form_maecte_validate_fecha_constitucion_empresa(var_fecha_constitucion_empresa, var_script_case_init, do_ajax_form_maecte_validate_fecha_constitucion_empresa_cb);
    }, 200);
  } // do_ajax_form_maecte_validate_fecha_constitucion_empresa

  function do_ajax_form_maecte_validate_fecha_constitucion_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_fecha_constitucion_empresa_cb

  // ---------- Validate id_oficina
  function do_ajax_form_maecte_validate_id_oficina()
  {
    var nomeCampo_id_oficina = "id_oficina";
    var var_id_oficina = scAjaxGetFieldText(nomeCampo_id_oficina);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_oficina(var_id_oficina, var_script_case_init, do_ajax_form_maecte_validate_id_oficina_cb);
  } // do_ajax_form_maecte_validate_id_oficina

  function do_ajax_form_maecte_validate_id_oficina_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_oficina_cb

  // ---------- Validate id_tipo_actividad
  function do_ajax_form_maecte_validate_id_tipo_actividad()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_tipo_actividad(var_id_tipo_actividad, var_script_case_init, do_ajax_form_maecte_validate_id_tipo_actividad_cb);
  } // do_ajax_form_maecte_validate_id_tipo_actividad

  function do_ajax_form_maecte_validate_id_tipo_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_tipo_actividad_cb

  // ---------- Validate especifique_otros
  function do_ajax_form_maecte_validate_especifique_otros()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_especifique_otros(var_especifique_otros, var_script_case_init, do_ajax_form_maecte_validate_especifique_otros_cb);
  } // do_ajax_form_maecte_validate_especifique_otros

  function do_ajax_form_maecte_validate_especifique_otros_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_especifique_otros_cb

  // ---------- Validate direccion_correspondencia
  function do_ajax_form_maecte_validate_direccion_correspondencia()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_direccion_correspondencia(var_direccion_correspondencia, var_script_case_init, do_ajax_form_maecte_validate_direccion_correspondencia_cb);
  } // do_ajax_form_maecte_validate_direccion_correspondencia

  function do_ajax_form_maecte_validate_direccion_correspondencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_direccion_correspondencia_cb

  // ---------- Validate calle_principal_correspondencia
  function do_ajax_form_maecte_validate_calle_principal_correspondencia()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_calle_principal_correspondencia(var_calle_principal_correspondencia, var_script_case_init, do_ajax_form_maecte_validate_calle_principal_correspondencia_cb);
  } // do_ajax_form_maecte_validate_calle_principal_correspondencia

  function do_ajax_form_maecte_validate_calle_principal_correspondencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_calle_principal_correspondencia_cb

  // ---------- Validate no_correspondencia
  function do_ajax_form_maecte_validate_no_correspondencia()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_no_correspondencia(var_no_correspondencia, var_script_case_init, do_ajax_form_maecte_validate_no_correspondencia_cb);
  } // do_ajax_form_maecte_validate_no_correspondencia

  function do_ajax_form_maecte_validate_no_correspondencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_no_correspondencia_cb

  // ---------- Validate calle_secundaria_correspondencia
  function do_ajax_form_maecte_validate_calle_secundaria_correspondencia()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_calle_secundaria_correspondencia(var_calle_secundaria_correspondencia, var_script_case_init, do_ajax_form_maecte_validate_calle_secundaria_correspondencia_cb);
  } // do_ajax_form_maecte_validate_calle_secundaria_correspondencia

  function do_ajax_form_maecte_validate_calle_secundaria_correspondencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_calle_secundaria_correspondencia_cb

  // ---------- Validate id_ciudad_correspondencia
  function do_ajax_form_maecte_validate_id_ciudad_correspondencia()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_ciudad_correspondencia(var_id_ciudad_correspondencia, var_script_case_init, do_ajax_form_maecte_validate_id_ciudad_correspondencia_cb);
  } // do_ajax_form_maecte_validate_id_ciudad_correspondencia

  function do_ajax_form_maecte_validate_id_ciudad_correspondencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_ciudad_correspondencia_cb

  // ---------- Validate nombre_empresa_solicitante
  function do_ajax_form_maecte_validate_nombre_empresa_solicitante()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_nombre_empresa_solicitante(var_nombre_empresa_solicitante, var_script_case_init, do_ajax_form_maecte_validate_nombre_empresa_solicitante_cb);
  } // do_ajax_form_maecte_validate_nombre_empresa_solicitante

  function do_ajax_form_maecte_validate_nombre_empresa_solicitante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_nombre_empresa_solicitante_cb

  // ---------- Validate cargo_empresa_solicitante
  function do_ajax_form_maecte_validate_cargo_empresa_solicitante()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_cargo_empresa_solicitante(var_cargo_empresa_solicitante, var_script_case_init, do_ajax_form_maecte_validate_cargo_empresa_solicitante_cb);
  } // do_ajax_form_maecte_validate_cargo_empresa_solicitante

  function do_ajax_form_maecte_validate_cargo_empresa_solicitante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_cargo_empresa_solicitante_cb

  // ---------- Validate celular_empresa_solicitante
  function do_ajax_form_maecte_validate_celular_empresa_solicitante()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_celular_empresa_solicitante(var_celular_empresa_solicitante, var_script_case_init, do_ajax_form_maecte_validate_celular_empresa_solicitante_cb);
  } // do_ajax_form_maecte_validate_celular_empresa_solicitante

  function do_ajax_form_maecte_validate_celular_empresa_solicitante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_celular_empresa_solicitante_cb

  // ---------- Validate telefono_empresa_solicitante
  function do_ajax_form_maecte_validate_telefono_empresa_solicitante()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_telefono_empresa_solicitante(var_telefono_empresa_solicitante, var_script_case_init, do_ajax_form_maecte_validate_telefono_empresa_solicitante_cb);
  } // do_ajax_form_maecte_validate_telefono_empresa_solicitante

  function do_ajax_form_maecte_validate_telefono_empresa_solicitante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_telefono_empresa_solicitante_cb

  // ---------- Validate mail_empresa_solicitante
  function do_ajax_form_maecte_validate_mail_empresa_solicitante()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_mail_empresa_solicitante(var_mail_empresa_solicitante, var_script_case_init, do_ajax_form_maecte_validate_mail_empresa_solicitante_cb);
  } // do_ajax_form_maecte_validate_mail_empresa_solicitante

  function do_ajax_form_maecte_validate_mail_empresa_solicitante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_mail_empresa_solicitante_cb

  // ---------- Validate saldo_empresa_solicitante
  function do_ajax_form_maecte_validate_saldo_empresa_solicitante()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_saldo_empresa_solicitante(var_saldo_empresa_solicitante, var_script_case_init, do_ajax_form_maecte_validate_saldo_empresa_solicitante_cb);
  } // do_ajax_form_maecte_validate_saldo_empresa_solicitante

  function do_ajax_form_maecte_validate_saldo_empresa_solicitante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_saldo_empresa_solicitante_cb

  // ---------- Validate nombre_referencia_comerciales
  function do_ajax_form_maecte_validate_nombre_referencia_comerciales()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_nombre_referencia_comerciales(var_nombre_referencia_comerciales, var_script_case_init, do_ajax_form_maecte_validate_nombre_referencia_comerciales_cb);
  } // do_ajax_form_maecte_validate_nombre_referencia_comerciales

  function do_ajax_form_maecte_validate_nombre_referencia_comerciales_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_nombre_referencia_comerciales_cb

  // ---------- Validate fecha_compra
  function do_ajax_form_maecte_validate_fecha_compra()
  {
    ...
    setTimeout(function() {
      var var_fecha_compra = scAjaxGetFieldText(nomeCampo_fecha_compra);
      x_ajax_form_maecte_validate_fecha_compra(var_fecha_compra, var_script_case_init, do_ajax_form_maecte_validate_fecha_compra_cb);
    }, 200);
  } // do_ajax_form_maecte_validate_fecha_compra

  function do_ajax_form_maecte_validate_fecha_compra_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_fecha_compra_cb

  // ---------- Validate telefono_referencia_comerciales
  function do_ajax_form_maecte_validate_telefono_referencia_comerciales()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_telefono_referencia_comerciales(var_telefono_referencia_comerciales, var_script_case_init, do_ajax_form_maecte_validate_telefono_referencia_comerciales_cb);
  } // do_ajax_form_maecte_validate_telefono_referencia_comerciales

  function do_ajax_form_maecte_validate_telefono_referencia_comerciales_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_telefono_referencia_comerciales_cb

  // ---------- Validate ventas
  function do_ajax_form_maecte_validate_ventas()
  {
    var nomeCampo_ventas = "ventas";
    var var_ventas = scAjaxGetFieldText(nomeCampo_ventas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_ventas(var_ventas, var_script_case_init, do_ajax_form_maecte_validate_ventas_cb);
  } // do_ajax_form_maecte_validate_ventas

  function do_ajax_form_maecte_validate_ventas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ventas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_ventas_cb

  // ---------- Validate comisiones
  function do_ajax_form_maecte_validate_comisiones()
  {
    var nomeCampo_comisiones = "comisiones";
    var var_comisiones = scAjaxGetFieldText(nomeCampo_comisiones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_comisiones(var_comisiones, var_script_case_init, do_ajax_form_maecte_validate_comisiones_cb);
  } // do_ajax_form_maecte_validate_comisiones

  function do_ajax_form_maecte_validate_comisiones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_comisiones_cb

  // ---------- Validate gastos_operativos
  function do_ajax_form_maecte_validate_gastos_operativos()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_gastos_operativos(var_gastos_operativos, var_script_case_init, do_ajax_form_maecte_validate_gastos_operativos_cb);
  } // do_ajax_form_maecte_validate_gastos_operativos

  function do_ajax_form_maecte_validate_gastos_operativos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_gastos_operativos_cb

  // ---------- Validate gastos_administrativos
  function do_ajax_form_maecte_validate_gastos_administrativos()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_gastos_administrativos(var_gastos_administrativos, var_script_case_init, do_ajax_form_maecte_validate_gastos_administrativos_cb);
  } // do_ajax_form_maecte_validate_gastos_administrativos

  function do_ajax_form_maecte_validate_gastos_administrativos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_gastos_administrativos_cb

  // ---------- Validate pago_cuotas_prestamo
  function do_ajax_form_maecte_validate_pago_cuotas_prestamo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_pago_cuotas_prestamo(var_pago_cuotas_prestamo, var_script_case_init, do_ajax_form_maecte_validate_pago_cuotas_prestamo_cb);
  } // do_ajax_form_maecte_validate_pago_cuotas_prestamo

  function do_ajax_form_maecte_validate_pago_cuotas_prestamo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_pago_cuotas_prestamo_cb

  // ---------- Validate funcionario
  function do_ajax_form_maecte_validate_funcionario()
  {
    var nomeCampo_funcionario = "funcionario";
    var var_funcionario = scAjaxGetFieldText(nomeCampo_funcionario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_funcionario(var_funcionario, var_script_case_init, do_ajax_form_maecte_validate_funcionario_cb);
  } // do_ajax_form_maecte_validate_funcionario

  function do_ajax_form_maecte_validate_funcionario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_funcionario_cb

  // ---------- Validate funcionario_detalle
  function do_ajax_form_maecte_validate_funcionario_detalle()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_funcionario_detalle(var_funcionario_detalle, var_script_case_init, do_ajax_form_maecte_validate_funcionario_detalle_cb);
  } // do_ajax_form_maecte_validate_funcionario_detalle

  function do_ajax_form_maecte_validate_funcionario_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_funcionario_detalle_cb

  // ---------- Validate miembro_politico
  function do_ajax_form_maecte_validate_miembro_politico()
  {
    var nomeCampo_miembro_politico = "miembro_politico";
    var var_miembro_politico = scAjaxGetFieldText(nomeCampo_miembro_politico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_miembro_politico(var_miembro_politico, var_script_case_init, do_ajax_form_maecte_validate_miembro_politico_cb);
  } // do_ajax_form_maecte_validate_miembro_politico

  function do_ajax_form_maecte_validate_miembro_politico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_miembro_politico_cb

  // ---------- Validate miembro_politico_detalle
  function do_ajax_form_maecte_validate_miembro_politico_detalle()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_miembro_politico_detalle(var_miembro_politico_detalle, var_script_case_init, do_ajax_form_maecte_validate_miembro_politico_detalle_cb);
  } // do_ajax_form_maecte_validate_miembro_politico_detalle

  function do_ajax_form_maecte_validate_miembro_politico_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_miembro_politico_detalle_cb

  // ---------- Validate ejecutivo_gobierno
  function do_ajax_form_maecte_validate_ejecutivo_gobierno()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_ejecutivo_gobierno(var_ejecutivo_gobierno, var_script_case_init, do_ajax_form_maecte_validate_ejecutivo_gobierno_cb);
  } // do_ajax_form_maecte_validate_ejecutivo_gobierno

  function do_ajax_form_maecte_validate_ejecutivo_gobierno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_ejecutivo_gobierno_cb

  // ---------- Validate ejecutivo_gobierno_detalle
  function do_ajax_form_maecte_validate_ejecutivo_gobierno_detalle()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_ejecutivo_gobierno_detalle(var_ejecutivo_gobierno_detalle, var_script_case_init, do_ajax_form_maecte_validate_ejecutivo_gobierno_detalle_cb);
  } // do_ajax_form_maecte_validate_ejecutivo_gobierno_detalle

  function do_ajax_form_maecte_validate_ejecutivo_gobierno_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_ejecutivo_gobierno_detalle_cb

  // ---------- Validate familiar_gobierno
  function do_ajax_form_maecte_validate_familiar_gobierno()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_familiar_gobierno(var_familiar_gobierno, var_script_case_init, do_ajax_form_maecte_validate_familiar_gobierno_cb);
  } // do_ajax_form_maecte_validate_familiar_gobierno

  function do_ajax_form_maecte_validate_familiar_gobierno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_familiar_gobierno_cb

  // ---------- Validate familiar_gobierno_detalle
  function do_ajax_form_maecte_validate_familiar_gobierno_detalle()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_familiar_gobierno_detalle(var_familiar_gobierno_detalle, var_script_case_init, do_ajax_form_maecte_validate_familiar_gobierno_detalle_cb);
  } // do_ajax_form_maecte_validate_familiar_gobierno_detalle

  function do_ajax_form_maecte_validate_familiar_gobierno_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_familiar_gobierno_detalle_cb

  // ---------- Validate familiar_gobierno_detalle_quien
  function do_ajax_form_maecte_validate_familiar_gobierno_detalle_quien()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_familiar_gobierno_detalle_quien(var_familiar_gobierno_detalle_quien, var_script_case_init, do_ajax_form_maecte_validate_familiar_gobierno_detalle_quien_cb);
  } // do_ajax_form_maecte_validate_familiar_gobierno_detalle_quien

  function do_ajax_form_maecte_validate_familiar_gobierno_detalle_quien_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_familiar_gobierno_detalle_quien_cb

  // ---------- Validate otros_ingresos
  function do_ajax_form_maecte_validate_otros_ingresos()
  {
    var nomeCampo_otros_ingresos = "otros_ingresos";
    var var_otros_ingresos = scAjaxGetFieldText(nomeCampo_otros_ingresos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_otros_ingresos(var_otros_ingresos, var_script_case_init, do_ajax_form_maecte_validate_otros_ingresos_cb);
  } // do_ajax_form_maecte_validate_otros_ingresos

  function do_ajax_form_maecte_validate_otros_ingresos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_otros_ingresos_cb

  // ---------- Validate otros_gastos
  function do_ajax_form_maecte_validate_otros_gastos()
  {
    var nomeCampo_otros_gastos = "otros_gastos";
    var var_otros_gastos = scAjaxGetFieldText(nomeCampo_otros_gastos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_otros_gastos(var_otros_gastos, var_script_case_init, do_ajax_form_maecte_validate_otros_gastos_cb);
  } // do_ajax_form_maecte_validate_otros_gastos

  function do_ajax_form_maecte_validate_otros_gastos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_otros_gastos_cb

  // ---------- Validate otros_activos
  function do_ajax_form_maecte_validate_otros_activos()
  {
    var nomeCampo_otros_activos = "otros_activos";
    var var_otros_activos = scAjaxGetFieldText(nomeCampo_otros_activos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_otros_activos(var_otros_activos, var_script_case_init, do_ajax_form_maecte_validate_otros_activos_cb);
  } // do_ajax_form_maecte_validate_otros_activos

  function do_ajax_form_maecte_validate_otros_activos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_otros_activos_cb

  // ---------- Validate otras_obligaciones
  function do_ajax_form_maecte_validate_otras_obligaciones()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_otras_obligaciones(var_otras_obligaciones, var_script_case_init, do_ajax_form_maecte_validate_otras_obligaciones_cb);
  } // do_ajax_form_maecte_validate_otras_obligaciones

  function do_ajax_form_maecte_validate_otras_obligaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_otras_obligaciones_cb

  // ---------- Validate sector_direccion_empresa
  function do_ajax_form_maecte_validate_sector_direccion_empresa()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_sector_direccion_empresa(var_sector_direccion_empresa, var_script_case_init, do_ajax_form_maecte_validate_sector_direccion_empresa_cb);
  } // do_ajax_form_maecte_validate_sector_direccion_empresa

  function do_ajax_form_maecte_validate_sector_direccion_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_sector_direccion_empresa_cb

  // ---------- Validate sector_direccion_empresa_correo
  function do_ajax_form_maecte_validate_sector_direccion_empresa_correo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_sector_direccion_empresa_correo(var_sector_direccion_empresa_correo, var_script_case_init, do_ajax_form_maecte_validate_sector_direccion_empresa_correo_cb);
  } // do_ajax_form_maecte_validate_sector_direccion_empresa_correo

  function do_ajax_form_maecte_validate_sector_direccion_empresa_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_sector_direccion_empresa_correo_cb

  // ---------- Validate extranjero_nombres_referencia
  function do_ajax_form_maecte_validate_extranjero_nombres_referencia()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_extranjero_nombres_referencia(var_extranjero_nombres_referencia, var_script_case_init, do_ajax_form_maecte_validate_extranjero_nombres_referencia_cb);
  } // do_ajax_form_maecte_validate_extranjero_nombres_referencia

  function do_ajax_form_maecte_validate_extranjero_nombres_referencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_extranjero_nombres_referencia_cb

  // ---------- Validate extranjero_apellidos_referencia
  function do_ajax_form_maecte_validate_extranjero_apellidos_referencia()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_extranjero_apellidos_referencia(var_extranjero_apellidos_referencia, var_script_case_init, do_ajax_form_maecte_validate_extranjero_apellidos_referencia_cb);
  } // do_ajax_form_maecte_validate_extranjero_apellidos_referencia

  function do_ajax_form_maecte_validate_extranjero_apellidos_referencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_extranjero_apellidos_referencia_cb

  // ---------- Validate extranjero_parentesco
  function do_ajax_form_maecte_validate_extranjero_parentesco()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_extranjero_parentesco(var_extranjero_parentesco, var_script_case_init, do_ajax_form_maecte_validate_extranjero_parentesco_cb);
  } // do_ajax_form_maecte_validate_extranjero_parentesco

  function do_ajax_form_maecte_validate_extranjero_parentesco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_extranjero_parentesco_cb

  // ---------- Validate extranjero_celular_ref
  function do_ajax_form_maecte_validate_extranjero_celular_ref()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_extranjero_celular_ref(var_extranjero_celular_ref, var_script_case_init, do_ajax_form_maecte_validate_extranjero_celular_ref_cb);
  } // do_ajax_form_maecte_validate_extranjero_celular_ref

  function do_ajax_form_maecte_validate_extranjero_celular_ref_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_extranjero_celular_ref_cb

  // ---------- Validate extranjero_telefono_convencional_ref
  function do_ajax_form_maecte_validate_extranjero_telefono_convencional_ref()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_extranjero_telefono_convencional_ref(var_extranjero_telefono_convencional_ref, var_script_case_init, do_ajax_form_maecte_validate_extranjero_telefono_convencional_ref_cb);
  } // do_ajax_form_maecte_validate_extranjero_telefono_convencional_ref

  function do_ajax_form_maecte_validate_extranjero_telefono_convencional_ref_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_extranjero_telefono_convencional_ref_cb

  // ---------- Validate cargo_representante_legal
  function do_ajax_form_maecte_validate_cargo_representante_legal()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_cargo_representante_legal(var_cargo_representante_legal, var_script_case_init, do_ajax_form_maecte_validate_cargo_representante_legal_cb);
  } // do_ajax_form_maecte_validate_cargo_representante_legal

  function do_ajax_form_maecte_validate_cargo_representante_legal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_cargo_representante_legal_cb

  // ---------- Validate direccion_extranjero
  function do_ajax_form_maecte_validate_direccion_extranjero()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_direccion_extranjero(var_direccion_extranjero, var_script_case_init, do_ajax_form_maecte_validate_direccion_extranjero_cb);
  } // do_ajax_form_maecte_validate_direccion_extranjero

  function do_ajax_form_maecte_validate_direccion_extranjero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_direccion_extranjero_cb

  // ---------- Validate relacion_dependencia_principal
  function do_ajax_form_maecte_validate_relacion_dependencia_principal()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_relacion_dependencia_principal(var_relacion_dependencia_principal, var_script_case_init, do_ajax_form_maecte_validate_relacion_dependencia_principal_cb);
  } // do_ajax_form_maecte_validate_relacion_dependencia_principal

  function do_ajax_form_maecte_validate_relacion_dependencia_principal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_relacion_dependencia_principal_cb

  // ---------- Validate correo_corporativo_principal
  function do_ajax_form_maecte_validate_correo_corporativo_principal()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_correo_corporativo_principal(var_correo_corporativo_principal, var_script_case_init, do_ajax_form_maecte_validate_correo_corporativo_principal_cb);
  } // do_ajax_form_maecte_validate_correo_corporativo_principal

  function do_ajax_form_maecte_validate_correo_corporativo_principal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_correo_corporativo_principal_cb

  // ---------- Validate relacion_dependencia_secundaria
  function do_ajax_form_maecte_validate_relacion_dependencia_secundaria()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_relacion_dependencia_secundaria(var_relacion_dependencia_secundaria, var_script_case_init, do_ajax_form_maecte_validate_relacion_dependencia_secundaria_cb);
  } // do_ajax_form_maecte_validate_relacion_dependencia_secundaria

  function do_ajax_form_maecte_validate_relacion_dependencia_secundaria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_relacion_dependencia_secundaria_cb

  // ---------- Validate correo_corporativo_secundario
  function do_ajax_form_maecte_validate_correo_corporativo_secundario()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_correo_corporativo_secundario(var_correo_corporativo_secundario, var_script_case_init, do_ajax_form_maecte_validate_correo_corporativo_secundario_cb);
  } // do_ajax_form_maecte_validate_correo_corporativo_secundario

  function do_ajax_form_maecte_validate_correo_corporativo_secundario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_correo_corporativo_secundario_cb

  // ---------- Validate actividad_secundaria
  function do_ajax_form_maecte_validate_actividad_secundaria()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_actividad_secundaria(var_actividad_secundaria, var_script_case_init, do_ajax_form_maecte_validate_actividad_secundaria_cb);
  } // do_ajax_form_maecte_validate_actividad_secundaria

  function do_ajax_form_maecte_validate_actividad_secundaria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_actividad_secundaria_cb

  // ---------- Validate id_pais_empresa
  function do_ajax_form_maecte_validate_id_pais_empresa()
  {
    var nomeCampo_id_pais_empresa = "id_pais_empresa";
    var var_id_pais_empresa = scAjaxGetFieldText(nomeCampo_id_pais_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_pais_empresa(var_id_pais_empresa, var_script_case_init, do_ajax_form_maecte_validate_id_pais_empresa_cb);
  } // do_ajax_form_maecte_validate_id_pais_empresa

  function do_ajax_form_maecte_validate_id_pais_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_pais_empresa_cb

  // ---------- Validate id_provincia_empresa
  function do_ajax_form_maecte_validate_id_provincia_empresa()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_provincia_empresa(var_id_provincia_empresa, var_script_case_init, do_ajax_form_maecte_validate_id_provincia_empresa_cb);
  } // do_ajax_form_maecte_validate_id_provincia_empresa

  function do_ajax_form_maecte_validate_id_provincia_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_provincia_empresa_cb

  // ---------- Validate id_pais_correo
  function do_ajax_form_maecte_validate_id_pais_correo()
  {
    var nomeCampo_id_pais_correo = "id_pais_correo";
    var var_id_pais_correo = scAjaxGetFieldText(nomeCampo_id_pais_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_pais_correo(var_id_pais_correo, var_script_case_init, do_ajax_form_maecte_validate_id_pais_correo_cb);
  } // do_ajax_form_maecte_validate_id_pais_correo

  function do_ajax_form_maecte_validate_id_pais_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_pais_correo_cb

  // ---------- Validate id_provincia_correo
  function do_ajax_form_maecte_validate_id_provincia_correo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_provincia_correo(var_id_provincia_correo, var_script_case_init, do_ajax_form_maecte_validate_id_provincia_correo_cb);
  } // do_ajax_form_maecte_validate_id_provincia_correo

  function do_ajax_form_maecte_validate_id_provincia_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_provincia_correo_cb

  // ---------- Validate apellido_empresa_solicitante
  function do_ajax_form_maecte_validate_apellido_empresa_solicitante()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_apellido_empresa_solicitante(var_apellido_empresa_solicitante, var_script_case_init, do_ajax_form_maecte_validate_apellido_empresa_solicitante_cb);
  } // do_ajax_form_maecte_validate_apellido_empresa_solicitante

  function do_ajax_form_maecte_validate_apellido_empresa_solicitante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_apellido_empresa_solicitante_cb

  // ---------- Validate pais_actividad2
  function do_ajax_form_maecte_validate_pais_actividad2()
  {
    var nomeCampo_pais_actividad2 = "pais_actividad2";
    var var_pais_actividad2 = scAjaxGetFieldText(nomeCampo_pais_actividad2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_pais_actividad2(var_pais_actividad2, var_script_case_init, do_ajax_form_maecte_validate_pais_actividad2_cb);
  } // do_ajax_form_maecte_validate_pais_actividad2

  function do_ajax_form_maecte_validate_pais_actividad2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_pais_actividad2_cb

  // ---------- Validate id_provincia_exterior
  function do_ajax_form_maecte_validate_id_provincia_exterior()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_provincia_exterior(var_id_provincia_exterior, var_script_case_init, do_ajax_form_maecte_validate_id_provincia_exterior_cb);
  } // do_ajax_form_maecte_validate_id_provincia_exterior

  function do_ajax_form_maecte_validate_id_provincia_exterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_provincia_exterior_cb

  // ---------- Validate pais_independiente
  function do_ajax_form_maecte_validate_pais_independiente()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_pais_independiente(var_pais_independiente, var_script_case_init, do_ajax_form_maecte_validate_pais_independiente_cb);
  } // do_ajax_form_maecte_validate_pais_independiente

  function do_ajax_form_maecte_validate_pais_independiente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_pais_independiente_cb

  // ---------- Validate tipo_contrato_otros_actividad_principal
  function do_ajax_form_maecte_validate_tipo_contrato_otros_actividad_principal()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_tipo_contrato_otros_actividad_principal(var_tipo_contrato_otros_actividad_principal, var_script_case_init, do_ajax_form_maecte_validate_tipo_contrato_otros_actividad_principal_cb);
  } // do_ajax_form_maecte_validate_tipo_contrato_otros_actividad_principal

  function do_ajax_form_maecte_validate_tipo_contrato_otros_actividad_principal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_tipo_contrato_otros_actividad_principal_cb

  // ---------- Validate actividadeconomica
  function do_ajax_form_maecte_validate_actividadeconomica()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_actividadeconomica(var_actividadeconomica, var_script_case_init, do_ajax_form_maecte_validate_actividadeconomica_cb);
  } // do_ajax_form_maecte_validate_actividadeconomica

  function do_ajax_form_maecte_validate_actividadeconomica_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_actividadeconomica_cb

  // ---------- Validate clasesujeto
  function do_ajax_form_maecte_validate_clasesujeto()
  {
    var nomeCampo_clasesujeto = "clasesujeto";
    var var_clasesujeto = scAjaxGetFieldText(nomeCampo_clasesujeto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_clasesujeto(var_clasesujeto, var_script_case_init, do_ajax_form_maecte_validate_clasesujeto_cb);
  } // do_ajax_form_maecte_validate_clasesujeto

  function do_ajax_form_maecte_validate_clasesujeto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_clasesujeto_cb

  // ---------- Validate provincia
  function do_ajax_form_maecte_validate_provincia()
  {
    var nomeCampo_provincia = "provincia";
    var var_provincia = scAjaxGetFieldText(nomeCampo_provincia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_provincia(var_provincia, var_script_case_init, do_ajax_form_maecte_validate_provincia_cb);
  } // do_ajax_form_maecte_validate_provincia

  function do_ajax_form_maecte_validate_provincia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_provincia_cb

  // ---------- Validate parroquia
  function do_ajax_form_maecte_validate_parroquia()
  {
    var nomeCampo_parroquia = "parroquia";
    var var_parroquia = scAjaxGetFieldText(nomeCampo_parroquia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_parroquia(var_parroquia, var_script_case_init, do_ajax_form_maecte_validate_parroquia_cb);
  } // do_ajax_form_maecte_validate_parroquia

  function do_ajax_form_maecte_validate_parroquia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_parroquia_cb

  // ---------- Validate canton
  function do_ajax_form_maecte_validate_canton()
  {
    var nomeCampo_canton = "canton";
    var var_canton = scAjaxGetFieldText(nomeCampo_canton);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_canton(var_canton, var_script_case_init, do_ajax_form_maecte_validate_canton_cb);
  } // do_ajax_form_maecte_validate_canton

  function do_ajax_form_maecte_validate_canton_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "canton";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_canton_cb

  // ---------- Validate demandajudicial
  function do_ajax_form_maecte_validate_demandajudicial()
  {
    var nomeCampo_demandajudicial = "demandajudicial";
    var var_demandajudicial = scAjaxGetFieldText(nomeCampo_demandajudicial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_demandajudicial(var_demandajudicial, var_script_case_init, do_ajax_form_maecte_validate_demandajudicial_cb);
  } // do_ajax_form_maecte_validate_demandajudicial

  function do_ajax_form_maecte_validate_demandajudicial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_demandajudicial_cb

  // ---------- Validate vdemandajudicial
  function do_ajax_form_maecte_validate_vdemandajudicial()
  {
    var nomeCampo_vdemandajudicial = "vdemandajudicial";
    var var_vdemandajudicial = scAjaxGetFieldText(nomeCampo_vdemandajudicial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_vdemandajudicial(var_vdemandajudicial, var_script_case_init, do_ajax_form_maecte_validate_vdemandajudicial_cb);
  } // do_ajax_form_maecte_validate_vdemandajudicial

  function do_ajax_form_maecte_validate_vdemandajudicial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_vdemandajudicial_cb

  // ---------- Validate carteracastigada
  function do_ajax_form_maecte_validate_carteracastigada()
  {
    var nomeCampo_carteracastigada = "carteracastigada";
    var var_carteracastigada = scAjaxGetFieldText(nomeCampo_carteracastigada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_carteracastigada(var_carteracastigada, var_script_case_init, do_ajax_form_maecte_validate_carteracastigada_cb);
  } // do_ajax_form_maecte_validate_carteracastigada

  function do_ajax_form_maecte_validate_carteracastigada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_carteracastigada_cb

  // ---------- Validate vcarteracastigada
  function do_ajax_form_maecte_validate_vcarteracastigada()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_vcarteracastigada(var_vcarteracastigada, var_script_case_init, do_ajax_form_maecte_validate_vcarteracastigada_cb);
  } // do_ajax_form_maecte_validate_vcarteracastigada

  function do_ajax_form_maecte_validate_vcarteracastigada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_vcarteracastigada_cb

  // ---------- Validate accesoexterno01
  function do_ajax_form_maecte_validate_accesoexterno01()
  {
    var nomeCampo_accesoexterno01 = "accesoexterno01";
    var var_accesoexterno01 = scAjaxGetFieldText(nomeCampo_accesoexterno01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_accesoexterno01(var_accesoexterno01, var_script_case_init, do_ajax_form_maecte_validate_accesoexterno01_cb);
  } // do_ajax_form_maecte_validate_accesoexterno01

  function do_ajax_form_maecte_validate_accesoexterno01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_accesoexterno01_cb

  // ---------- Validate referencia
  function do_ajax_form_maecte_validate_referencia()
  {
    var nomeCampo_referencia = "referencia";
    var var_referencia = scAjaxGetFieldText(nomeCampo_referencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_referencia(var_referencia, var_script_case_init, do_ajax_form_maecte_validate_referencia_cb);
  } // do_ajax_form_maecte_validate_referencia

  function do_ajax_form_maecte_validate_referencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_referencia_cb

  // ---------- Validate id_pais_empleado_dir_desempeno
  function do_ajax_form_maecte_validate_id_pais_empleado_dir_desempeno()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_pais_empleado_dir_desempeno(var_id_pais_empleado_dir_desempeno, var_script_case_init, do_ajax_form_maecte_validate_id_pais_empleado_dir_desempeno_cb);
  } // do_ajax_form_maecte_validate_id_pais_empleado_dir_desempeno

  function do_ajax_form_maecte_validate_id_pais_empleado_dir_desempeno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_pais_empleado_dir_desempeno_cb

  // ---------- Validate id_provincia_empleado_dir_desempeno
  function do_ajax_form_maecte_validate_id_provincia_empleado_dir_desempeno()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_provincia_empleado_dir_desempeno(var_id_provincia_empleado_dir_desempeno, var_script_case_init, do_ajax_form_maecte_validate_id_provincia_empleado_dir_desempeno_cb);
  } // do_ajax_form_maecte_validate_id_provincia_empleado_dir_desempeno

  function do_ajax_form_maecte_validate_id_provincia_empleado_dir_desempeno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_provincia_empleado_dir_desempeno_cb

  // ---------- Validate id_ciudad_empleado_dir_desempeno
  function do_ajax_form_maecte_validate_id_ciudad_empleado_dir_desempeno()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_ciudad_empleado_dir_desempeno(var_id_ciudad_empleado_dir_desempeno, var_script_case_init, do_ajax_form_maecte_validate_id_ciudad_empleado_dir_desempeno_cb);
  } // do_ajax_form_maecte_validate_id_ciudad_empleado_dir_desempeno

  function do_ajax_form_maecte_validate_id_ciudad_empleado_dir_desempeno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_ciudad_empleado_dir_desempeno_cb

  // ---------- Validate razon_social
  function do_ajax_form_maecte_validate_razon_social()
  {
    var nomeCampo_razon_social = "razon_social";
    var var_razon_social = scAjaxGetFieldText(nomeCampo_razon_social);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_razon_social(var_razon_social, var_script_case_init, do_ajax_form_maecte_validate_razon_social_cb);
  } // do_ajax_form_maecte_validate_razon_social

  function do_ajax_form_maecte_validate_razon_social_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_razon_social_cb

  // ---------- Validate parterel01
  function do_ajax_form_maecte_validate_parterel01()
  {
    var nomeCampo_parterel01 = "parterel01";
    var var_parterel01 = scAjaxGetFieldText(nomeCampo_parterel01);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_parterel01(var_parterel01, var_script_case_init, do_ajax_form_maecte_validate_parterel01_cb);
  } // do_ajax_form_maecte_validate_parterel01

  function do_ajax_form_maecte_validate_parterel01_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_parterel01_cb

  // ---------- Validate origen_fondos
  function do_ajax_form_maecte_validate_origen_fondos()
  {
    var nomeCampo_origen_fondos = "origen_fondos";
    var var_origen_fondos = scAjaxGetFieldText(nomeCampo_origen_fondos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_origen_fondos(var_origen_fondos, var_script_case_init, do_ajax_form_maecte_validate_origen_fondos_cb);
  } // do_ajax_form_maecte_validate_origen_fondos

  function do_ajax_form_maecte_validate_origen_fondos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_origen_fondos_cb

  // ---------- Validate tipo_identificacion
  function do_ajax_form_maecte_validate_tipo_identificacion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_tipo_identificacion(var_tipo_identificacion, var_script_case_init, do_ajax_form_maecte_validate_tipo_identificacion_cb);
  } // do_ajax_form_maecte_validate_tipo_identificacion

  function do_ajax_form_maecte_validate_tipo_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_tipo_identificacion_cb

  // ---------- Validate id_actividad
  function do_ajax_form_maecte_validate_id_actividad()
  {
    var nomeCampo_id_actividad = "id_actividad";
    var var_id_actividad = scAjaxGetFieldText(nomeCampo_id_actividad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecte_validate_id_actividad(var_id_actividad, var_script_case_init, do_ajax_form_maecte_validate_id_actividad_cb);
  } // do_ajax_form_maecte_validate_id_actividad

  function do_ajax_form_maecte_validate_id_actividad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecte_validate_id_actividad_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_maecte_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_maecte_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
  ...
  function do_ajax_form_maecte_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecte']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecte']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecte']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_maecte_submit_form_cb_after_alert);
  } // do_ajax_form_maecte_submit_form_cb
  function do_ajax_form_maecte_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_maecte_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_maecte_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_maecte_navigate_form, function() {});
    } else {
      perform_ajax_form_maecte_navigate_form();
    }
  }

  function perform_ajax_form_maecte_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_maecte_navigate_form(var_codcte01, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_maecte_navigate_form_cb);
  } // do_ajax_form_maecte_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecte']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_maecte_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_maecte_navigate_form_cb_after_alert);
  } // do_ajax_form_maecte_navigate_form_cb
  function do_ajax_form_maecte_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_maecte_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_maecte_navigate_form_cb_after_alert

  function sc_hide_form_maecte_form()
  {
