...
class pdfreport_sales_xls
{
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if (!is_file($this->Ini->root . $this->Ini->path_link . "pdfreport_sales/pdfreport_sales_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new pdfreport_sales_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_pdfreport_sales.zip";
          $this->Arquivo   .= "_pdfreport_sales" . $this->Xls_tp;
          $this->Tit_doc    = "pdfreport_sales" . $this->Xls_tp;
          $this->Tit_zip    = "pdfreport_sales.zip";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_lineas_id_sales_detail()
   {
         ...
         if (is_numeric($this->lineas_id_sales_detail))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->lineas_id_sales_detail);
         $this->Xls_col++;
   }
   //----- lineas_id_sales
   function NM_export_lineas_id_sales()
   {
         ...
         if (is_numeric($this->lineas_id_sales))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->lineas_id_sales);
         $this->Xls_col++;
   }
   //----- lineas_unit_cost
   function NM_export_lineas_unit_cost()
   {
         ...
         if (is_numeric($this->lineas_unit_cost))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->lineas_unit_cost);
         $this->Xls_col++;
   }
   //----- lineas_unit_value
   function NM_export_lineas_unit_value()
   {
         ...
         if (is_numeric($this->lineas_unit_value))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->lineas_unit_value);
         $this->Xls_col++;
   }
   //----- lineas_quantity
   ...
   function NM_export_lineas_discount()
   {
         ...
         if (is_numeric($this->lineas_discount))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->lineas_discount);
         $this->Xls_col++;
   }
   //----- lineas_item_total
   ...
   function NM_export_lineas_id_product()
   {
         ...
         if (is_numeric($this->lineas_id_product))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->lineas_id_product);
         $this->Xls_col++;
   }
   //----- id_sales
   ...
   //----- lineas_id_sales_detail
   function NM_sub_cons_lineas_id_sales_detail()
   {
         $this->lineas_id_sales_detail = NM_charset_to_utf8($this->lineas_id_sales_detail);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lineas_id_sales_detail;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- lineas_id_sales
   function NM_sub_cons_lineas_id_sales()
   {
         $this->lineas_id_sales = NM_charset_to_utf8($this->lineas_id_sales);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lineas_id_sales;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- lineas_unit_cost
   function NM_sub_cons_lineas_unit_cost()
   {
         $this->lineas_unit_cost = NM_charset_to_utf8($this->lineas_unit_cost);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lineas_unit_cost;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- lineas_unit_value
   function NM_sub_cons_lineas_unit_value()
   {
         $this->lineas_unit_value = NM_charset_to_utf8($this->lineas_unit_value);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lineas_unit_value;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- lineas_discount
   function NM_sub_cons_lineas_discount()
   {
         $this->lineas_discount = NM_charset_to_utf8($this->lineas_discount);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lineas_discount;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- lineas_id_product
   function NM_sub_cons_lineas_id_product()
   {
         $this->lineas_id_product = NM_charset_to_utf8($this->lineas_id_product);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lineas_id_product;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['xls_file'] = $this->Xls_f;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
