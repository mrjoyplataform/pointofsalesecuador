...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fecha_autorizacion";$Nm_datas[] = "fecha_autorizacion";$Nm_numeric[] = "id";
...
<HTML>
<HEAD>
 <TITLE> ele_documentos_electronicos</TITLE>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_id"  <?php echo $str_hide_id?>><INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_numero_autorizacion_cond" name="numero_autorizacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_numero_autorizacion'), this, 'numero_autorizacion')">
      ...
      <br><span id="id_hide_numero_autorizacion"  <?php echo $str_hide_numero_autorizacion?>><?php
