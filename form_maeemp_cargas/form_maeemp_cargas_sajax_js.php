  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_maeemp_cargas" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_maeemp_cargas_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_maeemp_cargas_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_cargas_validate_id(var_id, var_script_case_init, do_ajax_form_maeemp_cargas_validate_id_cb);
  } // do_ajax_form_maeemp_cargas_validate_id

  function do_ajax_form_maeemp_cargas_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_cargas_validate_id_cb

  // ---------- Validate codigo_empleado
  function do_ajax_form_maeemp_cargas_validate_codigo_empleado()
  {
    var nomeCampo_codigo_empleado = "codigo_empleado";
    var var_codigo_empleado = scAjaxGetFieldText(nomeCampo_codigo_empleado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_cargas_validate_codigo_empleado(var_codigo_empleado, var_script_case_init, do_ajax_form_maeemp_cargas_validate_codigo_empleado_cb);
  } // do_ajax_form_maeemp_cargas_validate_codigo_empleado

  function do_ajax_form_maeemp_cargas_validate_codigo_empleado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_cargas_validate_codigo_empleado_cb

  // ---------- Validate tipo
  function do_ajax_form_maeemp_cargas_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldText(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_cargas_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_maeemp_cargas_validate_tipo_cb);
  } // do_ajax_form_maeemp_cargas_validate_tipo

  function do_ajax_form_maeemp_cargas_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_cargas_validate_tipo_cb

  // ---------- Validate nombre
  function do_ajax_form_maeemp_cargas_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_cargas_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_maeemp_cargas_validate_nombre_cb);
  } // do_ajax_form_maeemp_cargas_validate_nombre

  function do_ajax_form_maeemp_cargas_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_cargas_validate_nombre_cb

  // ---------- Validate genero
  function do_ajax_form_maeemp_cargas_validate_genero()
  {
    var nomeCampo_genero = "genero";
    var var_genero = scAjaxGetFieldText(nomeCampo_genero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_cargas_validate_genero(var_genero, var_script_case_init, do_ajax_form_maeemp_cargas_validate_genero_cb);
  } // do_ajax_form_maeemp_cargas_validate_genero

  function do_ajax_form_maeemp_cargas_validate_genero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "genero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_cargas_validate_genero_cb

  // ---------- Validate fecha_nacimiento
  function do_ajax_form_maeemp_cargas_validate_fecha_nacimiento()
  {
    ...
    setTimeout(function() {
      var var_fecha_nacimiento = scAjaxGetFieldText(nomeCampo_fecha_nacimiento);
      x_ajax_form_maeemp_cargas_validate_fecha_nacimiento(var_fecha_nacimiento, var_script_case_init, do_ajax_form_maeemp_cargas_validate_fecha_nacimiento_cb);
    }, 200);
  } // do_ajax_form_maeemp_cargas_validate_fecha_nacimiento

  function do_ajax_form_maeemp_cargas_validate_fecha_nacimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_cargas_validate_fecha_nacimiento_cb

  // ---------- Validate discapacidad
  function do_ajax_form_maeemp_cargas_validate_discapacidad()
  {
    var nomeCampo_discapacidad = "discapacidad";
    var var_discapacidad = scAjaxGetFieldText(nomeCampo_discapacidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_cargas_validate_discapacidad(var_discapacidad, var_script_case_init, do_ajax_form_maeemp_cargas_validate_discapacidad_cb);
  } // do_ajax_form_maeemp_cargas_validate_discapacidad

  function do_ajax_form_maeemp_cargas_validate_discapacidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_cargas_validate_discapacidad_cb

  // ---------- Validate observacion
  function do_ajax_form_maeemp_cargas_validate_observacion()
  {
    var nomeCampo_observacion = "observacion";
    var var_observacion = scAjaxGetFieldText(nomeCampo_observacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_cargas_validate_observacion(var_observacion, var_script_case_init, do_ajax_form_maeemp_cargas_validate_observacion_cb);
  } // do_ajax_form_maeemp_cargas_validate_observacion

  function do_ajax_form_maeemp_cargas_validate_observacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_cargas_validate_observacion_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_maeemp_cargas_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_maeemp_cargas_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_maeemp_cargas_submit_form(var_id, var_codigo_empleado, var_tipo, var_nombre, var_genero, var_fecha_nacimiento, var_discapacidad, var_observacion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_maeemp_cargas_submit_form_cb);
  } // do_ajax_form_maeemp_cargas_submit_form

  function do_ajax_form_maeemp_cargas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_maeemp_cargas_submit_form_cb_after_alert);
  } // do_ajax_form_maeemp_cargas_submit_form_cb
  function do_ajax_form_maeemp_cargas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_maeemp_cargas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_maeemp_cargas_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_maeemp_cargas_navigate_form, function() {});
    } else {
      perform_ajax_form_maeemp_cargas_navigate_form();
    }
  }

  function perform_ajax_form_maeemp_cargas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_maeemp_cargas_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_maeemp_cargas_navigate_form_cb);
  } // do_ajax_form_maeemp_cargas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_cargas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_maeemp_cargas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_maeemp_cargas_navigate_form_cb_after_alert);
  } // do_ajax_form_maeemp_cargas_navigate_form_cb
  function do_ajax_form_maeemp_cargas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_maeemp_cargas_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_maeemp_cargas_navigate_form_cb_after_alert

  function sc_hide_form_maeemp_cargas_form()
  {
