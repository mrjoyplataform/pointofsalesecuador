...
Table_sv_fil[0] = "numvisitas";
Table_sv_fil[1] = "fechault";
Table_sv_fil[2] = "tipodoc";
Table_sv_fil[3] = "idcustomer";
Table_sv_fil[4] = "nombre";
Table_sv_fil[5] = "correo";
Table_sv_fil[6] = "idempleado";
function ajax_select_filter(parm)
{
    ...
    $.ajax({
     ...
     .done(function(json_sel_fil) {
        ...
        if ($("#SC_fechault_cond") && search_get_sel_txt("SC_fechault_cond").substring(0, 3) == "bi_") {
            formata_bi_fechault(search_get_sel_txt("SC_fechault_cond"), SC_fechault_bi_opc, SC_fechault_bi_dt);
        }
