<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['grid_customer']['glo_nm_perfil']          = "conn_pos";
   $_SESSION['scriptcase']['grid_customer']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['grid_customer']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['grid_customer']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['grid_customer']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['grid_customer']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['grid_customer']['glo_nm_path_doc']        = "";
...
// 
    ...
    if (!$_SESSION['sc_session'][$this->sc_page]['grid_customer']['embutida'])
    {
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_customer']['grid_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['grid_customer']['grid_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['grid_customer']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_ch_bi_dyn_search")
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_customer']['dyn_search_ch_bi']['cmp'] = $_POST['field'];
          $_SESSION['sc_session'][$this->sc_page]['grid_customer']['dyn_search_ch_bi']['opc'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['grid_customer']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
      if (isset($_GET['nmgp_opcao']) && $_GET['nmgp_opcao'] == "ajax_aut_comp_dyn_search")
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_customer']['dyn_search_aut_comp']['cmp'] = $_GET['field'];
          $_SESSION['sc_session'][$this->sc_page]['grid_customer']['opcao'] = $_GET['origem'];
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_customer']['glo_nm_conexao'], $this->root . $this->path_prod, 'pointofsales', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle($linhas = 0)
   {
       ...
       { 
           ...
           foreach ($todo as $param)
           {
                ...
                { 
                    ...
                    if ($cadapar[0] == "ult_fecha")
                    {
                        $cadapar[1]  = str_replace("@aspass@", "", $cadapar[1]);
                        $Format_tst  = $this->Ini->Get_Gb_date_format('sc_free_group_by', 'ult_fecha');
                    ...
                    elseif ($cadapar[0] == "ult_fecha_scgb_35")
                    {
                        $cadapar[0] = str_replace("ult_fecha_scgb_35", "ult_fecha", $cadapar[0]);
                        $cadapar[1]  = str_replace("@aspass@", "", $cadapar[1]);
                        $Format_tst  = $this->Ini->Get_Gb_date_format('sc_free_group_by', 'ult_fecha_scgb_35');
                        $Temp_arg    = $this->Ini->Get_date_arg_sum($cadapar[1], $Format_tst, $cadapar[0], true);
                        $Temp_sql    = ($Temp_arg == " is null") ? $cadapar[0] : $this->Ini->Get_sql_date_groupby($cadapar[0], $Format_tst);
                        $Temp_parms .= $Temp_sql;
                        $Temp_parms .= $Temp_arg;
                    }
                    elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Gb_Free_orig'][$cadapar[0]]))
                    {
                        list ($Sql_orig, $Sql_order) = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Gb_Free_sql'][$cadapar[0]];
                        $cadapar[1]  = str_replace("@aspass@", "", $cadapar[1]);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['where_resumo'] = $Temp_parms;
       } 
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['sc_modal']))
      {
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['emb_lig_aba'] = $this->Ini->Init_apl_lig;
          }
          ...
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_customer']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('grid_customer') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_customer']['label'] = "" . $this->Ini->Nm_lang['lang_othr_grid_title'] . " customer";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Gb_date_format'] = array();
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Gb_prefix_date_format']['sc_free_group_by']['ult_fecha'] = "" . $this->Ini->Nm_lang['lang_othr_valueYYYYMMDD2'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Gb_date_format']['sc_free_group_by']['ult_fecha'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Gb_date_format']['sc_free_group_by']['ult_fecha'] = 'YYYYMMDD2';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Gb_prefix_date_format']['sc_free_group_by']['ult_fecha_scgb_35'] = "" . $this->Ini->Nm_lang['lang_othr_valueYYYYWEEK'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Gb_date_format']['sc_free_group_by']['ult_fecha_scgb_35'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Gb_date_format']['sc_free_group_by']['ult_fecha_scgb_35'] = 'YYYYWEEK';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_All_Groupby'] = array('_NM_SC_' => 'grid', 'sc_free_group_by' => 'all');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Ind_Groupby'] = $Ind;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Gb_Free_cmp'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Gb_Free_cmp']  = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Gb_Free_sql']  = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Gb_Free_orig'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Gb_Free_cmp']['idempleado'] = "idempleado";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Gb_Free_sql']['idempleado']["idempleado"] = 'asc';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['Labels_GB'] = array();
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Ind_Groupby'] == "sc_free_group_by")
      {
          $Arr_free_labels = array();
          $Arr_free_labels['idempleado'] = "Idempleado";
          $Arr_free_labels['ult_fecha'] = "" . sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", "Ult Fecha") . "";
          $Arr_free_labels['ult_fecha_scgb_35'] = "" . sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYWEEK'] . "", "Ult Fecha") . "";
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Gb_Free_cmp'] as $Field => $Label)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['Labels_GB'][] = $Arr_free_labels[$Field];
          }
      }
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Ind_Groupby'] == "_NM_SC_")
      {
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['summarizing_fields_display']['sc_free_group_by']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['summarizing_fields_display']['sc_free_group_by'][2] = array('label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['summarizing_fields_order']['sc_free_group_by'][] = 2;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['summarizing_fields_display']['sc_free_group_by'][3] = array('label' => "Totalventa (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['summarizing_fields_order']['sc_free_group_by'][] = 3;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['summarizing_fields_control']['sc_free_group_by']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['summarizing_fields_control']['sc_free_group_by'] = array(
               array(
                   'cmp_res' => "NM_Count",
               ...
               array(
                   'cmp_res' => "totalventa",
                   'label' => "Totalventa (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
                   'label_field' => "Totalventa",
                   'options' => array(
                       array('op' => 'S', 'index' => '3', 'label' => "" . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . "", 'abbrev' => "Sum"),
                   ),
                   'select' => "<select class=\"sc-ui-select-totalventa\" onChange=\"scSummChange($(this))\"><option value=\"3\" class=\"sc-ui-select-option-S\">" . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . "</option></select>",
               ),
           );
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['pivot_x_axys'];
          }
      }
      $this->Ini->Apl_resumo  = "grid_customer_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "grid_customer_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Ind_Groupby'] . ".class.php"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_Gb_Free_orig']["ult_fecha_scgb_35"] = 'ult_fecha';
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['pdf_det'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['opcao'] = 'pdf';
          $_SESSION['sc_session'][$script_case_init]['grid_customer']['opc_pdf']['pdf_zip'] = (isset($Det_pdf_zip) && !empty($Det_pdf_zip)) ? $Det_pdf_zip : "N";
          if ($Det_use_pass_pdf != "__APL__")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['use_pass_pdf'] = $Det_use_pass_pdf;
          } 
          $nmgp_opcao = 'pdf';
      }
      if ($nmgp_opcao == 'pdf')
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['graf_disp']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['graf_disp']        = array('Bar', 'Pie', 'Line', 'Area');
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_tipo']        = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_larg']        = '800';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_alt']         = '600';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['graf_opc_atual']   = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['graf_mod_allowed'] = array(1, 2);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['graf_order']       = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_font'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['graf_subtitle_val'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['chartpallet']       = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['graf_exibe_val']    = '0';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['paletteColors']     = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_barra_orien'] = 'Vertical';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_barra_forma'] = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_barra_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_barra_sobre'] = 'No';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_barra_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_barra_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_barra_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_barra_funil'] = 'N';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_pizza_forma'] = 'Pie';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_pizza_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_pizza_orden'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_pizza_explo'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_pizza_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_linha_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_linha_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_linha_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_area_forma']  = 'Area';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_area_empil']  = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_area_inver']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_area_agrup']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_marca_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_marca_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_gauge_forma'] = 'Circular';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_radar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_radar_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_polar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_funil_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_funil_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_pyram_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_pyram_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['cfg_graf']['graf_pyram_forma'] = 'S';
      }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['field_order'][] = "idcustomer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['field_order'][] = "nombre";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['field_order'][] = "correo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['field_order'][] = "celular";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['field_order'][] = "direccion";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['field_order'][] = "tipodoc";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['field_order'][] = "ult_fecha";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['field_order'][] = "fechault";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['field_order'][] = "numvisitas";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['field_order'][] = "totalventa";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['field_order'][] = "idempleado";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['field_order'][] = "idinterno";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['usr_cmp_sel']['idinterno'] = "off";
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['where_orig'])) && !isset($_POST['reload_comb_chart']))
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['det_print'] = "";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['opcao'] == "det_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['opcao']     = "detalhe";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['det_print'] = "print";
          if (!empty($nmgp_password)) {
          ...
          {
              $this->Ini->Export_img_zip = true;
              $nm_arquivo_html = "/sc_grid_customer_det_" . session_id() . ".html";
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_html);
          }
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['opcao'] == "fast_search")  
      { 
          $this->SC_fast_search($GLOBALS["nmgp_fast_search"], $GLOBALS["nmgp_cond_fast_search"], $GLOBALS["nmgp_arg_fast_search"]);
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['where_pesq_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['where_pesq'])
          { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['opcao'] == "grid_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['opcao'] == "grid_search_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['opcao'] == "grid_search")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['opcao'] == "grid_search_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['orig_pesq'] = 'res';
          } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['opcao'] == "grid_search_change_fil" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['opcao'] == "grid_search_change_fil_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['opcao'] == "grid_search_change_fil")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['opcao'] == "grid_search_change_fil_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['orig_pesq'] = 'res';
          } 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
...
//----------------------------------->
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['opcao'] == "xls_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_customer/grid_customer_res_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_customer_res_xls.class.php"); 
          } 
          $this->xls  = new grid_customer_res_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['opcao'] == "xml_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_customer/grid_customer_res_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_customer_res_xml.class.php"); 
          } 
          $this->xml  = new grid_customer_res_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['opcao'] == "csv_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_customer/grid_customer_res_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_customer_res_csv.class.php"); 
          } 
          $this->csv  = new grid_customer_res_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['opcao'] == "rtf_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_customer/grid_customer_res_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_customer_res_rtf.class.php"); 
          } 
          $this->rtf  = new grid_customer_res_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      ...
      { 
          ...
          { 
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['dashboard_refresh_after_chart'])) {
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['opcao'] == "detalhe" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['pdf_det'])  
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['embutida'])
              { 
                  require_once($this->Ini->path_embutida . "grid_customer/grid_customer_det.class.php"); 
              } 
              else 
              { 
                  require_once($this->Ini->path_aplicacao . "grid_customer_det.class.php"); 
              } 
              $this->det  = new grid_customer_det();
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['embutida'])
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['ajax_nav'])
         {
             ...
             {
                 $this->Ini->Arr_result['setVar'][] = array('var' => 'scQtReg', 'value' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['qt_reg_grid']);
             }
             $_SESSION['scriptcase']['saida_var'] = false;
             $oJson = new Services_JSON();
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (empty($data_search)) 
      {
          ...
          {
              $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['where_orig']; 
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['where_pesq_filtro'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['where_pesq_filtro'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['where_pesq_filtro'] . ")"; 
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['where_pesq'] = $tmp_cmd;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['where_pesq_fast'] = $comando;
      $tmp_cmd = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['where_orig'])) 
      {
          $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['where_orig']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['fast_search'][0] = $in_fields;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['fast_search'][2] = $sv_data;
   }
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      if (isset($Nm_datas[$campo_join]) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['SC_sep_date']))
      {
   ...
   function SC_proc_grid_search($Parms)
   {
       ...
       $Cmps_check_return = array('idempleado');
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['tmp_busca'] = array();
       foreach ($tmp as $cada_f)
       {
           $dats = explode("_DYN_", $cada_f);
           if ($dats[1] == "del_grid_search_all")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['grid_pesq'] as $ind => $dados)
               {
                   $this->proc_del_grid_search($ind, true);
               }
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['grid_pesq']);
               continue;
           }
           ...
           if (in_array($fields[$ix]['field'], $Cmps_check_return))
           {
               ...
               {
                   if (trim($Cada_val) != '' && !in_array($Cada_val, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['psq_check_ret'][$fields[$ix]['field']]))
                   {
                       $Temp = ob_get_clean();
                       $this->Ini->Arr_result['htmOutput'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['labels'][$fields[$ix]['field']] . " : " . NM_charset_to_utf8($this->Ini->Nm_lang['lang_errm_ajax_data']);
                       $oJson = new Services_JSON();
                       echo $oJson->encode($this->Ini->Arr_result);
                       $this->close_emb();
                       exit;
           ...
           if (!isset($busca[$dats[0]]))
           {
               ...
               if ($dats[0] == "fechault")
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['tmp_busca'][$dats[0] . '_' . $tp] = $vl;
                   }
                   if (!empty($val1))
                   {
                       foreach ($val1 as $tp => $vl)
                       {
                          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['tmp_busca'][$dats[0] . '_input_2_' . $tp] = $vl;
                       }
                   }
               }
               elseif ($dats[0] == "idempleado")
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['tmp_busca'][$dats[0]] = $fields[$ix]['vls'][0];
                   if (isset($fields[$ix]['vls'][1]))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['tmp_busca'][$dats[0] . '_input_2'] = $fields[$ix]['vls'][1];
                   }
               }
               else
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['tmp_busca'][$dats[0]] = (isset($fields[$ix]['vls'][0])) ? $fields[$ix]['vls'][0][0] : "";
                   if (isset($fields[$ix]['vls'][1]))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['tmp_busca'][$dats[0] . '_input_2'] = $fields[$ix]['vls'][1][0];
                   }
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['tmp_busca'][$dats[0] . '_cond'] = $dats[1];
           }
           $ix++;
      }
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['tmp_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['tmp_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['tmp_busca'] as $ind => $dados)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['campos_busca'][$ind] = $dados;
      }
      if (!$_SESSION['scriptcase']['proc_mobile']) 
      { 
          require_once($this->Ini->path_aplicacao . "grid_customer_pesq.class.php"); 
   ...
   function proc_del_grid_search($cmp_del, $del_all)
   {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['campos_busca'][$cmp_del . "_dia"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['campos_busca'][$cmp_del . "_mes"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['campos_busca'][$cmp_del . "_ano"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['campos_busca'][$cmp_del . "_input_2_dia"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['campos_busca'][$cmp_del . "_input_2_mes"] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['campos_busca'][$cmp_del . "_input_2_ano"] = "";
      }
      elseif (is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['campos_busca'][$cmp_del]))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['campos_busca'][$cmp_del] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['campos_busca'][$cmp_del . "_input_2"] = array();
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['campos_busca'][$cmp_del] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['campos_busca'][$cmp_del . "_input_2"] = "";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['campos_busca'][$cmp_del . "_cond"] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer']['grid_pesq'][$cmp_del]);
   }
...
<?php
 ...
 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer'][$path_doc_md5][0] = $nm_arquivo_pdf_det;
 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_customer'][$path_doc_md5][1] = "grid_customer_det.pdf";
?>
 <link rel="shortcut icon" href="../_lib/img/scriptcase__NM__ico__NM__favicon.ico">
  <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_all ?>_export.css" /> 
  <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_all ?>_export<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_customer']['glo_nm_path_imag_temp'] . "/sc_apl_default_pointofsales.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_customer']['glo_nm_path_imag_temp'] . "/sc_apl_default_pointofsales.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_pointofsales'])) {
               $_SESSION['scriptcase']['grid_customer']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_pointofsales'];
           }
       }
   }
   ...
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/grid_customer/'))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_customer']['initialize'] = true;
   }
   else
   ...
   {
       $_SESSION['sc_session'][$script_case_init]['grid_customer']['orig_pesq'] = $nmgp_orig_pesq;
   }
   ...
   { 
       ...
       if ($_SESSION['sc_session'][$script_case_init]['grid_customer']['opcao'] == "detalhe" && isset($nmgp_chave_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_customer']['chave_det'] = $nmgp_chave_det;
           $_SESSION['sc_session'][$script_case_init]['grid_customer']['cmp_acum']  = $nmgp_parm_acum;
       }   
       if (isset($Sc_seq_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_customer']['Sc_seq_det'] = $Sc_seq_det;
       } 
...
// 
      ...
      if ('ajax_ch_bi_search' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['grid_customer']['opcao'] = "busca";
          $contr_grid_customer->NM_ajax_flag = true;
          $contr_grid_customer->NM_ajax_opcao = "ajax_ch_bi_search";
      }
