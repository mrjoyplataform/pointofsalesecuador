...
function ajax_select_filter(parm)
{
    ...
    $.ajax({
     ...
     .done(function(json_sel_fil) {
        ...
        if ($("#SC_fecha_califica_cond") && search_get_sel_txt("SC_fecha_califica_cond").substring(0, 3) == "bi_") {
            formata_bi_fecha_califica(search_get_sel_txt("SC_fecha_califica_cond"), SC_fecha_califica_bi_opc, SC_fecha_califica_bi_dt);
        }
