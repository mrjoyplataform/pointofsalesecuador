<?php
@session_start() ;
$_SESSION['scriptcase']['grid_view_boletos_satisfaction']['sc_process_barr'] = true;
require_once('../grid_view_boletos_satisfaction/index.php');
unset($_SESSION['scriptcase']['grid_view_boletos_satisfaction']['sc_process_barr']);
$ExportCtrl = new grid_view_boletos_satisfaction_export_control;
$ExportCtrl->Export_barr();

class grid_view_boletos_satisfaction_export_control
{
