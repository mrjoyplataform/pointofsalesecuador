...
class grid_view_boletos_satisfaction_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['tot_geral'][3];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['tot_geral'][1];
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['arr_total']['fecha_califica'] = $this->array_total_fecha_califica;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['arr_total']['fecha_califica_scgb_32'] = $this->array_total_fecha_califica_scgb_32;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['labels']['fecha_califica'] = $Lab_fecha_califica; 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['labels']['fecha_califica_scgb_32'] = $Lab_fecha_califica_scgb_32; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['pivot_order_level'] = 0;
       }
   ...
   function buildChart()
   {
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
...
{ 
   ...
   $nm_saida->saida("          nm_submit_modal(\"" . $this->Ini->path_link . "grid_view_boletos_satisfaction/grid_view_boletos_satisfaction_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['SC_Gb_Free_cmp']))
      {
...
//--- 
   ...
   function adiciona_registro($sum_jugador, $sum_visitante, $quebra_fecha_califica, $quebra_califica, $quebra_idproducto, $quebra_fecha_califica_scgb_32, $quebra_fecha_califica_orig, $quebra_califica_orig, $quebra_idproducto_orig, $quebra_fecha_califica_scgb_32_orig)
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_satisfaction']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
