  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_customer_family" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_customer_family_form();
	}
...
?>
  ...
  // ---------- Validate idfamily_
  function do_ajax_form_customer_family_validate_idfamily_(iNumLinha)
  {
    var nomeCampo_idfamily_ = "idfamily_" + iNumLinha;
    var var_idfamily_ = scAjaxGetFieldHidden(nomeCampo_idfamily_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_family_validate_idfamily_(var_idfamily_, iNumLinha, var_script_case_init, do_ajax_form_customer_family_validate_idfamily__cb);
  } // do_ajax_form_customer_family_validate_idfamily_

  function do_ajax_form_customer_family_validate_idfamily__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idfamily_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idfamily_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idfamily_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idfamily_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_family_validate_idfamily__cb

  // ---------- Validate nombre_
  function do_ajax_form_customer_family_validate_nombre_(iNumLinha)
  {
    var nomeCampo_nombre_ = "nombre_" + iNumLinha;
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_family_validate_nombre_(var_nombre_, iNumLinha, var_script_case_init, do_ajax_form_customer_family_validate_nombre__cb);
  } // do_ajax_form_customer_family_validate_nombre_

  function do_ajax_form_customer_family_validate_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_family_validate_nombre__cb

  // ---------- Validate parentesco_
  function do_ajax_form_customer_family_validate_parentesco_(iNumLinha)
  {
    var nomeCampo_parentesco_ = "parentesco_" + iNumLinha;
    var var_parentesco_ = scAjaxGetFieldSelect(nomeCampo_parentesco_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_family_validate_parentesco_(var_parentesco_, iNumLinha, var_script_case_init, do_ajax_form_customer_family_validate_parentesco__cb);
  } // do_ajax_form_customer_family_validate_parentesco_

  function do_ajax_form_customer_family_validate_parentesco__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "parentesco_" + iLineNumber;
    }
    else
    {
      sFieldValid = "parentesco_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "parentesco_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "parentesco_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_family_validate_parentesco__cb

  // ---------- Validate fecha_nacimiento_
  function do_ajax_form_customer_family_validate_fecha_nacimiento_(iNumLinha)
  {
    var nomeCampo_fecha_nacimiento_ = "fecha_nacimiento_" + iNumLinha;
    var nomeCampo_fecha_nacimiento__dia = "fecha_nacimiento__dia" + iNumLinha;
    var nomeCampo_fecha_nacimiento__mes = "fecha_nacimiento__mes" + iNumLinha;
    var nomeCampo_fecha_nacimiento__ano = "fecha_nacimiento__ano" + iNumLinha;
    var var_fecha_nacimiento_ = scAjaxGetFieldText(nomeCampo_fecha_nacimiento_);
    var var_fecha_nacimiento__dia = scAjaxGetFieldText(nomeCampo_fecha_nacimiento__dia);
    var var_fecha_nacimiento__mes = scAjaxGetFieldText(nomeCampo_fecha_nacimiento__mes);
    var var_fecha_nacimiento__ano = scAjaxGetFieldText(nomeCampo_fecha_nacimiento__ano);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_family_validate_fecha_nacimiento_(var_fecha_nacimiento_, var_fecha_nacimiento__dia, var_fecha_nacimiento__mes, var_fecha_nacimiento__ano, iNumLinha, var_script_case_init, do_ajax_form_customer_family_validate_fecha_nacimiento__cb);
  } // do_ajax_form_customer_family_validate_fecha_nacimiento_

  function do_ajax_form_customer_family_validate_fecha_nacimiento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fecha_nacimiento_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fecha_nacimiento_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fecha_nacimiento_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fecha_nacimiento_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_family_validate_fecha_nacimiento__cb

  // ---------- Validate sexo_
  function do_ajax_form_customer_family_validate_sexo_(iNumLinha)
  {
    var nomeCampo_sexo_ = "sexo_" + iNumLinha;
    var var_sexo_ = scAjaxGetFieldRadio(nomeCampo_sexo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_family_validate_sexo_(var_sexo_, iNumLinha, var_script_case_init, do_ajax_form_customer_family_validate_sexo__cb);
  } // do_ajax_form_customer_family_validate_sexo_

  function do_ajax_form_customer_family_validate_sexo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "sexo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "sexo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_family_validate_sexo__cb

  // ---------- Validate email_
  function do_ajax_form_customer_family_validate_email_(iNumLinha)
  {
    var nomeCampo_email_ = "email_" + iNumLinha;
    var var_email_ = scAjaxGetFieldText(nomeCampo_email_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_family_validate_email_(var_email_, iNumLinha, var_script_case_init, do_ajax_form_customer_family_validate_email__cb);
  } // do_ajax_form_customer_family_validate_email_

  function do_ajax_form_customer_family_validate_email__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_family_validate_email__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_customer_family_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_customer_family_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_customer_family_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_customer_family_add_new_line_cb);
  } // do_ajax_form_customer_family_add_new_line

  function do_ajax_form_customer_family_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_customer_family_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_customer_family_backup_line(iNumLinha)
  {
    var var_idfamily_ = scAjaxGetFieldHidden("idfamily_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_family_backup_line(var_idfamily_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_customer_family_backup_line_cb);
  } // do_ajax_form_customer_family_backup_line

  function do_ajax_form_customer_family_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_customer_family_backup_line_cb

  function do_ajax_form_customer_family_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_customer_family_cancel_insert

  function do_ajax_form_customer_family_cancel_update(iSeqVert)
  {
    do_ajax_form_customer_family_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_customer_family_cancel_update

  function do_ajax_form_customer_family_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_customer_family_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_customer_family_table_refresh()
  {
    var var_idfamily_ = document.F2.idfamily_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_customer_family_table_refresh(var_idfamily_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_customer_family_table_refresh_cb);
  } //  do_ajax_form_customer_family_table_refresh

  function do_ajax_form_customer_family_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idfamily_.value = scAjaxGetKeyValue("idfamily_");
    ...
    scAjaxAlert(do_ajax_form_customer_family_table_refresh_cb_after_alert);
  } // do_ajax_form_customer_family_table_refresh_cb
  function do_ajax_form_customer_family_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_customer_family_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_customer_family_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_customer_family_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_parentesco_ = scAjaxGetFieldSelect("parentesco_" + iNumLinha);
    var var_fecha_nacimiento__mes = scAjaxGetFieldSelect("fecha_nacimiento_" + iNumLinha + "_mes");
    var var_fecha_nacimiento__dia = scAjaxGetFieldSelect("fecha_nacimiento_" + iNumLinha + "_dia");
    var var_fecha_nacimiento__ano = scAjaxGetFieldSelect("fecha_nacimiento_" + iNumLinha + "_ano");
    var var_sexo_ = scAjaxGetFieldRadio("sexo_" + iNumLinha);
...
?>
    x_ajax_form_customer_family_submit_form(var_idfamily_, var_nombre_, var_parentesco_, var_fecha_nacimiento__mes, var_fecha_nacimiento__dia, var_fecha_nacimiento__ano, var_sexo_, var_email_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_customer_family_submit_form_cb);
  } // do_ajax_form_customer_family_submit_form

  function do_ajax_form_customer_family_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idfamily_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nombre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("parentesco_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fecha_nacimiento_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("sexo_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_customer_family_submit_form_cb_after_alert);
  } // do_ajax_form_customer_family_submit_form_cb
  function do_ajax_form_customer_family_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_customer_family_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_customer_family_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_customer_family_navigate_form, function() {});
    } else {
      perform_ajax_form_customer_family_navigate_form();
    }
  }

  function perform_ajax_form_customer_family_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("idfamily_" + iNavForm);
      scAjaxHideErrorDisplay("nombre_" + iNavForm);
      scAjaxHideErrorDisplay("parentesco_" + iNavForm);
      scAjaxHideErrorDisplay("fecha_nacimiento_" + iNavForm);
      scAjaxHideErrorDisplay("sexo_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_customer_family_navigate_form(var_idfamily_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_customer_family_navigate_form_cb);
  } // do_ajax_form_customer_family_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_family']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_customer_family_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idfamily_.value = scAjaxGetKeyValue("idfamily_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_customer_family_navigate_form_cb_after_alert);
  } // do_ajax_form_customer_family_navigate_form_cb
  function do_ajax_form_customer_family_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_customer_family_navigate_form_cb_after_alert

    function sc_form_customer_family_get_last_line_number()
    {
    ...
    } //sc_form_customer_family_get_last_line_number

  function sc_hide_form_customer_family_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idfamily_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nombre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "parentesco_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fecha_nacimiento_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sexo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "email_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idfamily_" + iNumLinha] = {"label": "Idfamily<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["parentesco_" + iNumLinha] = {"label": "Parentesco<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fecha_nacimiento_" + iNumLinha] = {"label": "Fecha Nacimiento<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["sexo_" + iNumLinha] = {"label": "Sexo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["idfamily_"][iNumLinha] = "idfamily_" + iNumLinha;
    ajax_field_mult["nombre_"][iNumLinha] = "nombre_" + iNumLinha;
    ajax_field_mult["parentesco_"][iNumLinha] = "parentesco_" + iNumLinha;
    ajax_field_mult["fecha_nacimiento_"][iNumLinha] = "fecha_nacimiento_" + iNumLinha;
    ajax_field_mult["sexo_"][iNumLinha] = "sexo_" + iNumLinha;
    ...
    ajax_field_id["parentesco_" + iNumLinha] = new Array("hidden_field_label_parentesco_", "hidden_field_data_parentesco_" + iNumLinha);
    ajax_field_id["fecha_nacimiento_" + iNumLinha] = new Array("hidden_field_label_fecha_nacimiento_", "hidden_field_data_fecha_nacimiento_" + iNumLinha);
    ajax_field_id["sexo_" + iNumLinha] = new Array("hidden_field_label_sexo_", "hidden_field_data_sexo_" + iNumLinha);
    ajax_field_id["email_" + iNumLinha] = new Array("hidden_field_label_email_", "hidden_field_data_email_" + iNumLinha);
    ajax_error_count["idfamily_" + iNumLinha] = "off";
    ajax_error_count["nombre_" + iNumLinha] = "off";
    ajax_error_count["parentesco_" + iNumLinha] = "off";
    ajax_error_count["fecha_nacimiento_" + iNumLinha] = "off";
    ajax_error_count["sexo_" + iNumLinha] = "off";
    ajax_error_count["email_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idfamily_" + iNumLinha] = "on";
    ajax_read_only["nombre_" + iNumLinha] = "off";
    ajax_read_only["parentesco_" + iNumLinha] = "off";
    ajax_read_only["fecha_nacimiento_" + iNumLinha] = "off";
    ajax_read_only["sexo_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["parentesco_" + iNumLinha] = "on";
    ajax_read_only["fecha_nacimiento_" + iNumLinha] = "on";
    ajax_read_only["sexo_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["idfamily_" + iNumLinha] = null;
    ajax_error_list["nombre_" + iNumLinha] = null;
    ajax_error_list["parentesco_" + iNumLinha] = null;
    ajax_error_list["fecha_nacimiento_" + iNumLinha] = null;
    ajax_error_list["sexo_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "idfamily_": new Array(),
    "nombre_": new Array(),
    "parentesco_": new Array(),
    "fecha_nacimiento_": new Array(),
    "sexo_": new Array(),
    "email_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idfamily_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idfamily_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idfamily_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idfamily_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idfamily_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["parentesco_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["parentesco_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["parentesco_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["parentesco_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["parentesco_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fecha_nacimiento_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fecha_nacimiento_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fecha_nacimiento_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fecha_nacimiento_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fecha_nacimiento_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["sexo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["sexo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["sexo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["sexo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["sexo_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idfamily_'])) ? $this->nmgp_cmp_readonly['idfamily_'] : 'on';
?>
    scAjaxFieldRead("idfamily_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['parentesco_'])) ? $this->nmgp_cmp_readonly['parentesco_'] : 'off';
?>
    scAjaxFieldRead("parentesco_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fecha_nacimiento_'])) ? $this->nmgp_cmp_readonly['fecha_nacimiento_'] : 'off';
?>
    scAjaxFieldRead("fecha_nacimiento_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sexo_'])) ? $this->nmgp_cmp_readonly['sexo_'] : 'off';
?>
    scAjaxFieldRead("sexo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("idfamily_" + iSeq, "on");
    scAjaxFieldRead("nombre_" + iSeq, "on");
    scAjaxFieldRead("parentesco_" + iSeq, "on");
    scAjaxFieldRead("fecha_nacimiento_" + iSeq, "on");
    scAjaxFieldRead("sexo_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idfamily_" + iRow] || "on" == ajax_error_count["nombre_" + iRow] || "on" == ajax_error_count["parentesco_" + iRow] || "on" == ajax_error_count["fecha_nacimiento_" + iRow] || "on" == ajax_error_count["sexo_" + iRow] || "on" == ajax_error_count["email_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idfamily_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nombre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_parentesco_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fecha_nacimiento_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sexo_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idfamily_" + iRow] && "off" == ajax_error_count["nombre_" + iRow] && "off" == ajax_error_count["parentesco_" + iRow] && "off" == ajax_error_count["fecha_nacimiento_" + iRow] && "off" == ajax_error_count["sexo_" + iRow] && "off" == ajax_error_count["email_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idfamily_" + iRow] = "off";
        ajax_error_count["nombre_" + iRow] = "off";
        ajax_error_count["parentesco_" + iRow] = "off";
        ajax_error_count["fecha_nacimiento_" + iRow] = "off";
        ajax_error_count["sexo_" + iRow] = "off";
      ...
      $("#hidden_field_data_idfamily_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nombre_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_parentesco_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fecha_nacimiento_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_sexo_" + iRow).removeClass("scFormErrorLine");
