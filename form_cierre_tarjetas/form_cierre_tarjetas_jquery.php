...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idturno_' + iSeqRow).bind('change', function() { sc_form_cierre_tarjetas_idturno__onchange(this, iSeqRow) });
  $('#id_sc_field_fecha_' + iSeqRow).bind('change', function() { sc_form_cierre_tarjetas_fecha__onchange(this, iSeqRow) });
  $('#id_sc_field_fecha__hora' + iSeqRow).bind('change', function() { sc_form_cierre_tarjetas_fecha__hora_onchange(this, iSeqRow) });
  $('#id_sc_field_lote_' + iSeqRow).bind('blur', function() { sc_form_cierre_tarjetas_lote__onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_cierre_tarjetas_lote__onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_cierre_tarjetas_lote__onfocus(this, iSeqRow) });
  $('#id_sc_field_voucher_' + iSeqRow).bind('blur', function() { sc_form_cierre_tarjetas_voucher__onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_cierre_tarjetas_voucher__onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_cierre_tarjetas_voucher__onfocus(this, iSeqRow) });
  $('#id_sc_field_valor_' + iSeqRow).bind('blur', function() { sc_form_cierre_tarjetas_valor__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_cierre_tarjetas_valor__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_cierre_tarjetas_valor__onfocus(this, iSeqRow) });
  $('#id_sc_field_idtarjetac_' + iSeqRow).bind('blur', function() { sc_form_cierre_tarjetas_idtarjetac__onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_cierre_tarjetas_idtarjetac__onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_cierre_tarjetas_idtarjetac__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_cierre_tarjetas_idturno__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_cierre_tarjetas_fecha__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_cierre_tarjetas_fecha__hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_cierre_tarjetas_lote__onblur(oThis, iSeqRow) {
  do_ajax_form_cierre_tarjetas_validate_lote_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_cierre_tarjetas_lote__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_cierre_tarjetas_lote__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_cierre_tarjetas_voucher__onblur(oThis, iSeqRow) {
  do_ajax_form_cierre_tarjetas_validate_voucher_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_cierre_tarjetas_voucher__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_cierre_tarjetas_voucher__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_cierre_tarjetas_valor__onblur(oThis, iSeqRow) {
  do_ajax_form_cierre_tarjetas_validate_valor_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_cierre_tarjetas_valor__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_cierre_tarjetas_valor__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_cierre_tarjetas_idtarjetac__onblur(oThis, iSeqRow) {
  do_ajax_form_cierre_tarjetas_validate_idtarjetac_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_cierre_tarjetas_idtarjetac__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_cierre_tarjetas_idtarjetac__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function scHidePage(pageNo) {
	$("#id_form_cierre_tarjetas_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecha_" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_cierre_tarjetas_validate_fecha_(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_cierre_tarjetas')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
