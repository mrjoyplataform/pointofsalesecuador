  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cierre_tarjetas" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cierre_tarjetas_form();
	}
...
?>
  ...
  function do_ajax_form_cierre_tarjetas_validate_idtarjetac_(iNumLinha)
  {
    var nomeCampo_idtarjetac_ = "idtarjetac_" + iNumLinha;
    var var_idtarjetac_ = scAjaxGetFieldText(nomeCampo_idtarjetac_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_tarjetas_validate_idtarjetac_(var_idtarjetac_, iNumLinha, var_script_case_init, do_ajax_form_cierre_tarjetas_validate_idtarjetac__cb);
  } // do_ajax_form_cierre_tarjetas_validate_idtarjetac_

  function do_ajax_form_cierre_tarjetas_validate_idtarjetac__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_tarjetas_validate_idtarjetac__cb

  // ---------- Validate lote_
  function do_ajax_form_cierre_tarjetas_validate_lote_(iNumLinha)
  {
    var nomeCampo_lote_ = "lote_" + iNumLinha;
    var var_lote_ = scAjaxGetFieldText(nomeCampo_lote_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_tarjetas_validate_lote_(var_lote_, iNumLinha, var_script_case_init, do_ajax_form_cierre_tarjetas_validate_lote__cb);
  } // do_ajax_form_cierre_tarjetas_validate_lote_

  function do_ajax_form_cierre_tarjetas_validate_lote__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_tarjetas_validate_lote__cb

  // ---------- Validate voucher_
  function do_ajax_form_cierre_tarjetas_validate_voucher_(iNumLinha)
  {
    var nomeCampo_voucher_ = "voucher_" + iNumLinha;
    var var_voucher_ = scAjaxGetFieldText(nomeCampo_voucher_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_tarjetas_validate_voucher_(var_voucher_, iNumLinha, var_script_case_init, do_ajax_form_cierre_tarjetas_validate_voucher__cb);
  } // do_ajax_form_cierre_tarjetas_validate_voucher_

  function do_ajax_form_cierre_tarjetas_validate_voucher__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_tarjetas_validate_voucher__cb

  // ---------- Validate valor_
  function do_ajax_form_cierre_tarjetas_validate_valor_(iNumLinha)
  {
    var nomeCampo_valor_ = "valor_" + iNumLinha;
    var var_valor_ = scAjaxGetFieldText(nomeCampo_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_tarjetas_validate_valor_(var_valor_, iNumLinha, var_script_case_init, do_ajax_form_cierre_tarjetas_validate_valor__cb);
  } // do_ajax_form_cierre_tarjetas_validate_valor_

  function do_ajax_form_cierre_tarjetas_validate_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_tarjetas_validate_valor__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_cierre_tarjetas_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_cierre_tarjetas_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cierre_tarjetas_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_cierre_tarjetas_add_new_line_cb);
  } // do_ajax_form_cierre_tarjetas_add_new_line

  function do_ajax_form_cierre_tarjetas_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_cierre_tarjetas_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_cierre_tarjetas_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_tarjetas_backup_line(var_idturno_, var_fecha_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_cierre_tarjetas_backup_line_cb);
  } // do_ajax_form_cierre_tarjetas_backup_line

  function do_ajax_form_cierre_tarjetas_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_cierre_tarjetas_backup_line_cb

  function do_ajax_form_cierre_tarjetas_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_cierre_tarjetas_cancel_insert

  function do_ajax_form_cierre_tarjetas_cancel_update(iSeqVert)
  {
    do_ajax_form_cierre_tarjetas_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_cierre_tarjetas_cancel_update

  function do_ajax_form_cierre_tarjetas_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_cierre_tarjetas_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_cierre_tarjetas_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_cierre_tarjetas_table_refresh(var_idturno_, var_fecha_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cierre_tarjetas_table_refresh_cb);
  } //  do_ajax_form_cierre_tarjetas_table_refresh

  function do_ajax_form_cierre_tarjetas_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_cierre_tarjetas_table_refresh_cb_after_alert);
  } // do_ajax_form_cierre_tarjetas_table_refresh_cb
  function do_ajax_form_cierre_tarjetas_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("b");
    sc_insert_open = false;
  } // do_ajax_form_cierre_tarjetas_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_cierre_tarjetas_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_cierre_tarjetas_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_cierre_tarjetas_submit_form(var_idtarjetac_, var_lote_, var_voucher_, var_valor_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_cierre_tarjetas_submit_form_cb);
  } // do_ajax_form_cierre_tarjetas_submit_form

  function do_ajax_form_cierre_tarjetas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cierre_tarjetas_submit_form_cb_after_alert);
  } // do_ajax_form_cierre_tarjetas_submit_form_cb
  function do_ajax_form_cierre_tarjetas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cierre_tarjetas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cierre_tarjetas_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_cierre_tarjetas_navigate_form, function() {});
    } else {
      perform_ajax_form_cierre_tarjetas_navigate_form();
    }
  }

  function perform_ajax_form_cierre_tarjetas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cierre_tarjetas_navigate_form(var_idturno_, var_fecha_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cierre_tarjetas_navigate_form_cb);
  } // do_ajax_form_cierre_tarjetas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cierre_tarjetas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cierre_tarjetas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cierre_tarjetas_navigate_form_cb_after_alert);
  } // do_ajax_form_cierre_tarjetas_navigate_form_cb
  function do_ajax_form_cierre_tarjetas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_cierre_tarjetas_navigate_form_cb_after_alert

    function sc_form_cierre_tarjetas_get_last_line_number()
    {
    ...
    } //sc_form_cierre_tarjetas_get_last_line_number

  function sc_hide_form_cierre_tarjetas_form()
  {
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idtarjetac_" + iRow] || "on" == ajax_error_count["lote_" + iRow] || "on" == ajax_error_count["voucher_" + iRow] || "on" == ajax_error_count["valor_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idtarjetac_" + iRow] && "off" == ajax_error_count["lote_" + iRow] && "off" == ajax_error_count["voucher_" + iRow] && "off" == ajax_error_count["valor_" + iRow]))
    {
      if (bErrorRow)
      {
