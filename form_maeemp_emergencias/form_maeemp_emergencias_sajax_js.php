  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_maeemp_emergencias" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_maeemp_emergencias_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_maeemp_emergencias_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_emergencias_validate_id(var_id, var_script_case_init, do_ajax_form_maeemp_emergencias_validate_id_cb);
  } // do_ajax_form_maeemp_emergencias_validate_id

  function do_ajax_form_maeemp_emergencias_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_emergencias_validate_id_cb

  // ---------- Validate codigo_empleado
  function do_ajax_form_maeemp_emergencias_validate_codigo_empleado()
  {
    var nomeCampo_codigo_empleado = "codigo_empleado";
    var var_codigo_empleado = scAjaxGetFieldText(nomeCampo_codigo_empleado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_emergencias_validate_codigo_empleado(var_codigo_empleado, var_script_case_init, do_ajax_form_maeemp_emergencias_validate_codigo_empleado_cb);
  } // do_ajax_form_maeemp_emergencias_validate_codigo_empleado

  function do_ajax_form_maeemp_emergencias_validate_codigo_empleado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_emergencias_validate_codigo_empleado_cb

  // ---------- Validate nombre
  function do_ajax_form_maeemp_emergencias_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_emergencias_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_maeemp_emergencias_validate_nombre_cb);
  } // do_ajax_form_maeemp_emergencias_validate_nombre

  function do_ajax_form_maeemp_emergencias_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_emergencias_validate_nombre_cb

  // ---------- Validate tipo_parentesco
  function do_ajax_form_maeemp_emergencias_validate_tipo_parentesco()
  {
    var nomeCampo_tipo_parentesco = "tipo_parentesco";
    var var_tipo_parentesco = scAjaxGetFieldText(nomeCampo_tipo_parentesco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_emergencias_validate_tipo_parentesco(var_tipo_parentesco, var_script_case_init, do_ajax_form_maeemp_emergencias_validate_tipo_parentesco_cb);
  } // do_ajax_form_maeemp_emergencias_validate_tipo_parentesco

  function do_ajax_form_maeemp_emergencias_validate_tipo_parentesco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_emergencias_validate_tipo_parentesco_cb

  // ---------- Validate telefono
  function do_ajax_form_maeemp_emergencias_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maeemp_emergencias_validate_telefono(var_telefono, var_script_case_init, do_ajax_form_maeemp_emergencias_validate_telefono_cb);
  } // do_ajax_form_maeemp_emergencias_validate_telefono

  function do_ajax_form_maeemp_emergencias_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maeemp_emergencias_validate_telefono_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_maeemp_emergencias_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_maeemp_emergencias_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_maeemp_emergencias_submit_form(var_id, var_codigo_empleado, var_nombre, var_tipo_parentesco, var_telefono, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_maeemp_emergencias_submit_form_cb);
  } // do_ajax_form_maeemp_emergencias_submit_form

  function do_ajax_form_maeemp_emergencias_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_maeemp_emergencias_submit_form_cb_after_alert);
  } // do_ajax_form_maeemp_emergencias_submit_form_cb
  function do_ajax_form_maeemp_emergencias_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_maeemp_emergencias_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_maeemp_emergencias_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_maeemp_emergencias_navigate_form, function() {});
    } else {
      perform_ajax_form_maeemp_emergencias_navigate_form();
    }
  }

  function perform_ajax_form_maeemp_emergencias_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_maeemp_emergencias_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_maeemp_emergencias_navigate_form_cb);
  } // do_ajax_form_maeemp_emergencias_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_maeemp_emergencias']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_maeemp_emergencias_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_maeemp_emergencias_navigate_form_cb_after_alert);
  } // do_ajax_form_maeemp_emergencias_navigate_form_cb
  function do_ajax_form_maeemp_emergencias_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_maeemp_emergencias_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_maeemp_emergencias_navigate_form_cb_after_alert

  function sc_hide_form_maeemp_emergencias_form()
  {
