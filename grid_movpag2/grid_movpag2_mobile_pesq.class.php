...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fecdoc43";$Nm_datas[] = "fecdoc43";$Nm_datas[] = "fedoc43";$Nm_datas[] = "fedoc43";$Nm_datas[] = "feccobro43";$Nm_datas[] = "feccobro43";$Nm_datas[] = "fectransfer43";$Nm_datas[] = "fectransfer43";$Nm_datas[] = "fecvencompra43";$Nm_datas[] = "fecvencompra43";$Nm_datas[] = "fecvenret43";$Nm_datas[] = "fecvenret43";$Nm_numeric[] = "totdoc43";$Nm_numeric[] = "valdivisa43";$Nm_numeric[] = "valdivisaori43";$Nm_numeric[] = "valini43";$Nm_numeric[] = "numcuotasord43";$Nm_numeric[] = "valormov43";$Nm_numeric[] = "saldoregmov43";$Nm_numeric[] = "valorabono43";$Nm_numeric[] = "saldoexceso43";$Nm_numeric[] = "saldocte43";$Nm_numeric[] = "uid";$Nm_numeric[] = "numero_transferencia";$Nm_numeric[] = "valor_superior_al_maximo";$Nm_numeric[] = "contrato_garantia";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_ocurren43_cond" name="ocurren43_cond" onChange="nm_campos_between(document.getElementById('id_vis_ocurren43'), this, 'ocurren43')">
      ...
      <br><span id="id_hide_ocurren43"  <?php echo $str_hide_ocurren43?>><?php
      if ($ocurren43 != "")
      {
      $ocurren43_look = substr($this->Db->qstr($ocurren43), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_codcte43_cond" name="codcte43_cond" onChange="nm_campos_between(document.getElementById('id_vis_codcte43'), this, 'codcte43')">
      ...
      <br><span id="id_hide_codcte43"  <?php echo $str_hide_codcte43?>><?php
      if ($codcte43 != "")
      {
      $codcte43_look = substr($this->Db->qstr($codcte43), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_tipodoc43_cond" name="tipodoc43_cond" onChange="nm_campos_between(document.getElementById('id_vis_tipodoc43'), this, 'tipodoc43')">
      ...
      <br><span id="id_hide_tipodoc43"  <?php echo $str_hide_tipodoc43?>><?php
      if ($tipodoc43 != "")
      {
      $tipodoc43_look = substr($this->Db->qstr($tipodoc43), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_numdoc43_cond" name="numdoc43_cond" onChange="nm_campos_between(document.getElementById('id_vis_numdoc43'), this, 'numdoc43')">
      ...
      <br><span id="id_hide_numdoc43"  <?php echo $str_hide_numdoc43?>><?php
      if ($numdoc43 != "")
      {
      $numdoc43_look = substr($this->Db->qstr($numdoc43), 1, -1); 
      $nmgp_def_dados = array(); 
