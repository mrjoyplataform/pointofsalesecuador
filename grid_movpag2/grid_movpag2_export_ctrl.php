<?php
@session_start() ;
$_SESSION['scriptcase']['grid_movpag2']['sc_process_barr'] = true;
require_once('../grid_movpag2/index.php');
unset($_SESSION['scriptcase']['grid_movpag2']['sc_process_barr']);
$ExportCtrl = new grid_movpag2_export_control;
$ExportCtrl->Export_barr();

class grid_movpag2_export_control
{
