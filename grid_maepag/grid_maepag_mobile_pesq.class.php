...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cv2cte01_cond" name="cv2cte01_cond" onChange="nm_campos_between(document.getElementById('id_vis_cv2cte01'), this, 'cv2cte01')">
      ...
      <br><span id="id_hide_cv2cte01"  <?php echo $str_hide_cv2cte01?>><?php
      if ($cv2cte01 != "")
      {
      $cv2cte01_look = substr($this->Db->qstr($cv2cte01), 1, -1); 
      $nmgp_def_dados = array(); 
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_codcte01"  <?php echo $str_hide_codcte01?>><?php
      if ($codcte01 != "")
      {
      $codcte01_look = substr($this->Db->qstr($codcte01), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_cv1cte01_cond" name="cv1cte01_cond" onChange="nm_campos_between(document.getElementById('id_vis_cv1cte01'), this, 'cv1cte01')">
      ...
      <br><span id="id_hide_cv1cte01"  <?php echo $str_hide_cv1cte01?>><?php
      if ($cv1cte01 != "")
      {
      $cv1cte01_look = substr($this->Db->qstr($cv1cte01), 1, -1); 
      $nmgp_def_dados = array(); 
