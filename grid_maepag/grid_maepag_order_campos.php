...
<?php
   ...
   $Ord_Cmp = new grid_maepag_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_maepag_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_maepag']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_maepag']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codcte01"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maepag']['labels']["codcte01"])) ? $_SESSION['sc_session'][$sc_init]['grid_maepag']['labels']["codcte01"] : "Codcte 01";
   $tab_ger_campos['nomcte01'] = "on";
   $tab_def_campos['nomcte01'] = "nomcte01";
   $tab_labels["nomcte01"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maepag']['labels']["nomcte01"])) ? $_SESSION['sc_session'][$sc_init]['grid_maepag']['labels']["nomcte01"] : "Nomcte 01";
   $tab_ger_campos['cv1cte01'] = "on";
   $tab_def_campos['cv1cte01'] = "cv1cte01";
   $tab_labels["cv1cte01"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maepag']['labels']["cv1cte01"])) ? $_SESSION['sc_session'][$sc_init]['grid_maepag']['labels']["cv1cte01"] : "Cv 1cte 01";
   $tab_ger_campos['cv2cte01'] = "on";
   $tab_def_campos['cv2cte01'] = "cv2cte01";
   $tab_labels["cv2cte01"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maepag']['labels']["cv2cte01"])) ? $_SESSION['sc_session'][$sc_init]['grid_maepag']['labels']["cv2cte01"] : "Cv 2cte 01";
   $tab_ger_campos['tipcte01'] = "on";
   $tab_def_campos['tipcte01'] = "tipcte01";
   $tab_labels["tipcte01"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maepag']['labels']["tipcte01"])) ? $_SESSION['sc_session'][$sc_init]['grid_maepag']['labels']["tipcte01"] : "Tipcte 01";
   $tab_ger_campos['ofienccte01'] = "on";
   $tab_def_campos['ofienccte01'] = "ofienccte01";
   $tab_labels["ofienccte01"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maepag']['labels']["ofienccte01"])) ? $_SESSION['sc_session'][$sc_init]['grid_maepag']['labels']["ofienccte01"] : "Ofienccte 01";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_maepag']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_maepag']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_maepag']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_maepag']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_maepag']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_maepag']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_maepag']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_maepag']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_maepag']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_maepag']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_maepag']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_maepag']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_maepag_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_maepag']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_maepag']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_maepag']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_maepag']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_maepag']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
