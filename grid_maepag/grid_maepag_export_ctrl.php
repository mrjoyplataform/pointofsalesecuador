<?php
@session_start() ;
$_SESSION['scriptcase']['grid_maepag']['sc_process_barr'] = true;
require_once('../grid_maepag/index.php');
unset($_SESSION['scriptcase']['grid_maepag']['sc_process_barr']);
$ExportCtrl = new grid_maepag_export_control;
$ExportCtrl->Export_barr();

class grid_maepag_export_control
{
