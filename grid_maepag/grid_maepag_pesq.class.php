...
class grid_maepag_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_maepag_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_maepag_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_maepag_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_cv2cte01')
      {
          $cv2cte01 = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_cv2cte01($cv2cte01);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_codcte01')
      {
          $codcte01 = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_codcte01($codcte01);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_cv1cte01')
      {
          $cv1cte01 = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_cv1cte01($cv1cte01);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "fecing01";$Nm_datas[] = "fecing01";$Nm_datas[] = "fecvencdoc01";$Nm_datas[] = "fecvencdoc01";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> maepag</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_maepag/grid_maepag_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_maepag_ajax_search.js"></script>
 <script type="text/javascript" src="grid_maepag_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_maepag_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_maepag']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_maepag']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_cv2cte01_cond#NMF#' + search_get_sel_txt('SC_cv2cte01_cond') + '@NMF@';
  str_out += 'SC_cv2cte01#NMF#' + search_get_text('SC_cv2cte01') + '@NMF@';
  str_out += 'id_ac_cv2cte01#NMF#' + search_get_text('id_ac_cv2cte01') + '@NMF@';
  ...
  str_out += 'id_ac_codcte01#NMF#' + search_get_text('id_ac_codcte01') + '@NMF@';
  ...
  str_out += 'SC_cv1cte01_cond#NMF#' + search_get_sel_txt('SC_cv1cte01_cond') + '@NMF@';
  str_out += 'SC_cv1cte01#NMF#' + search_get_text('SC_cv1cte01') + '@NMF@';
  str_out += 'id_ac_cv1cte01#NMF#' + search_get_text('id_ac_cv1cte01') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_codcte01").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_codcte01").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_codcte01",
          max_itens: "10",
          cod_desc: "N",
   ...
   scClass = $("#id_ac_cv1cte01").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_cv1cte01").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_cv1cte01",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_cv1cte01").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_cv2cte01").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_cv2cte01").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_cv2cte01",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> maepag</div>
...
<?php
   ...
   {
      global 
             $cv2cte01_cond, $cv2cte01, $cv2cte01_autocomp,
             $codcte01_cond, $codcte01, $codcte01_autocomp,
             $nomcte01_cond, $nomcte01, $nomcte01_autocomp,
             $cv1cte01_cond, $cv1cte01, $cv1cte01_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $cv2cte01 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']['cv2cte01']; 
          $cv2cte01_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']['cv2cte01_cond']; 
          $codcte01 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']['codcte01']; 
          $codcte01_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']['codcte01_cond']; 
          $nomcte01 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']['nomcte01']; 
          $nomcte01_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']['nomcte01_cond']; 
          $cv1cte01 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']['cv1cte01']; 
          $cv1cte01_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']['cv1cte01_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']['NM_operador']; 
      } 
      if (!isset($cv2cte01_cond) || empty($cv2cte01_cond))
      {
         $cv2cte01_cond = "qp";
      }
      ...
      if (!isset($cv1cte01_cond) || empty($cv1cte01_cond))
      {
         $cv1cte01_cond = "qp";
      }
      ...
      $str_hide_cv2cte01 = (in_array($cv2cte01_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_hide_cv1cte01 = (in_array($cv1cte01_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($cv2cte01) || $cv2cte01 == "")
      {
          $cv2cte01 = "";
      }
      if (isset($cv2cte01) && !empty($cv2cte01))
      {
         $tmp_pos = strpos($cv2cte01, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $cv2cte01 = substr($cv2cte01, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($cv1cte01) || $cv1cte01 == "")
      {
          $cv1cte01 = "";
      }
      if (isset($cv1cte01) && !empty($cv1cte01))
      {
         $tmp_pos = strpos($cv1cte01, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $cv1cte01 = substr($cv1cte01, 0, $tmp_pos);
         }
      }
?>
 <?php
...
?>
<?php
   if (is_file("grid_maepag_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_maepag']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_maepag']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_cv2cte01_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['cv2cte01'])) ? $this->New_label['cv2cte01'] : "Cv 2cte 01"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_cv2cte01_cond" name="cv2cte01_cond" onChange="nm_campos_between(document.getElementById('id_vis_cv2cte01'), this, 'cv2cte01')">
       <OPTION value="qp" <?php if ("qp" == $cv2cte01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $cv2cte01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cv2cte01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $cv2cte01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cv2cte01" <?php echo $str_hide_cv2cte01?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['cv2cte01'])) ? $this->New_label['cv2cte01'] : "Cv 2cte 01";
 $nmgp_tab_label .= "cv2cte01?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $cv2cte01;
      }
?>
<INPUT  type="text" id="SC_cv2cte01" name="cv2cte01" value="<?php echo NM_encode_input($cv2cte01) ?>"  size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cv2cte01" name="cv2cte01_autocomp" size="1"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_codcte01_cond" name="codcte01_cond" onChange="nm_campos_between(document.getElementById('id_vis_codcte01'), this, 'codcte01')">
       <OPTION value="qp" <?php if ("qp" == $codcte01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $codcte01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $codcte01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $codcte01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
      ...
      {
          $sAutocompValue = $codcte01;
      }
?>
<INPUT  type="text" id="SC_codcte01" name="codcte01" value="<?php echo NM_encode_input($codcte01) ?>"  size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_codcte01" name="codcte01_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<INPUT  type="text" id="SC_nomcte01" name="nomcte01" value="<?php echo NM_encode_input($nomcte01) ?>"  size=50 alt="{datatype: 'text', maxLength: 80, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nomcte01" name="nomcte01_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 80, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_cv1cte01_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['cv1cte01'])) ? $this->New_label['cv1cte01'] : "Cv 1cte 01"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_cv1cte01_cond" name="cv1cte01_cond" onChange="nm_campos_between(document.getElementById('id_vis_cv1cte01'), this, 'cv1cte01')">
       <OPTION value="qp" <?php if ("qp" == $cv1cte01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $cv1cte01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cv1cte01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $cv1cte01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cv1cte01" <?php echo $str_hide_cv1cte01?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['cv1cte01'])) ? $this->New_label['cv1cte01'] : "Cv 1cte 01";
 $nmgp_tab_label .= "cv1cte01?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $cv1cte01;
      }
?>
<INPUT  type="text" id="SC_cv1cte01" name="cv1cte01" value="<?php echo NM_encode_input($cv1cte01) ?>"  size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cv1cte01" name="cv1cte01_autocomp" size="1"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.cv2cte01_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_cv2cte01'), document.F1.cv2cte01_cond, 'cv2cte01');
   document.F1.cv2cte01.value = "";
   document.F1.cv2cte01_autocomp.value = "";
   document.F1.codcte01_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_codcte01'), document.F1.codcte01_cond, 'codcte01');
   document.F1.codcte01.value = "";
   document.F1.codcte01_autocomp.value = "";
   ...
   document.F1.cv1cte01_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_cv1cte01'), document.F1.cv1cte01_cond, 'cv1cte01');
   document.F1.cv1cte01.value = "";
   document.F1.cv1cte01_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_cv2cte01_cond'] = 'cond';
      $tp_fields['SC_cv2cte01'] = 'text_aut';
      $tp_fields['id_ac_cv2cte01'] = 'text_aut';
      $tp_fields['SC_codcte01_cond'] = 'cond';
      $tp_fields['SC_codcte01'] = 'text_aut';
      $tp_fields['id_ac_codcte01'] = 'text_aut';
      $tp_fields['SC_nomcte01_cond'] = 'cond';
      $tp_fields['SC_nomcte01'] = 'text_aut';
      $tp_fields['id_ac_nomcte01'] = 'text_aut';
      $tp_fields['SC_cv1cte01_cond'] = 'cond';
      $tp_fields['SC_cv1cte01'] = 'text_aut';
      $tp_fields['id_ac_cv1cte01'] = 'text_aut';
   ...
   {
      global $cv2cte01_cond, $cv2cte01, $cv2cte01_autocomp,
             $codcte01_cond, $codcte01, $codcte01_autocomp,
             $nomcte01_cond, $nomcte01, $nomcte01_autocomp,
             $cv1cte01_cond, $cv1cte01, $cv1cte01_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($cv2cte01_autocomp) && empty($cv2cte01))
      {
          $cv2cte01 = $cv2cte01_autocomp;
      }
      if (!empty($codcte01_autocomp) && empty($codcte01))
      {
          $codcte01 = $codcte01_autocomp;
      }
      if (!empty($nomcte01_autocomp) && empty($nomcte01))
      {
          $nomcte01 = $nomcte01_autocomp;
      }
      if (!empty($cv1cte01_autocomp) && empty($cv1cte01))
      {
          $cv1cte01 = $cv1cte01_autocomp;
      }
      $cv2cte01_cond_salva = $cv2cte01_cond; 
      if (!isset($cv2cte01_input_2) || $cv2cte01_input_2 == "")
      {
          $cv2cte01_input_2 = $cv2cte01;
      }
      ...
      $cv1cte01_cond_salva = $cv1cte01_cond; 
      if (!isset($cv1cte01_input_2) || $cv1cte01_input_2 == "")
      {
          $cv1cte01_input_2 = $cv1cte01;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']['cv2cte01'] = $cv2cte01; 
      if (is_array($cv2cte01) && !empty($cv2cte01))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['Grid_search'][$I_Grid]['val'][0] = $cv2cte01;
      }
      elseif ($cv2cte01_cond_salva == "nu" || $cv2cte01_cond_salva == "nn" || $cv2cte01_cond_salva == "ep" || $cv2cte01_cond_salva == "ne" || !empty($cv2cte01))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['Grid_search'][$I_Grid]['val'][0][0] = $cv2cte01;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']['cv2cte01_cond'] = $cv2cte01_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['Grid_search'][$I_Grid]['cmp'] = "cv2cte01"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['Grid_search'][$I_Grid]['opc'] = $cv2cte01_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq']['cv2cte01'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']['codcte01'] = $codcte01; 
      if (is_array($codcte01) && !empty($codcte01))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['Grid_search'][$I_Grid]['val'][0] = $codcte01;
      }
      elseif ($codcte01_cond_salva == "nu" || $codcte01_cond_salva == "nn" || $codcte01_cond_salva == "ep" || $codcte01_cond_salva == "ne" || !empty($codcte01))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['Grid_search'][$I_Grid]['val'][0][0] = $codcte01;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']['codcte01_cond'] = $codcte01_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['Grid_search'][$I_Grid]['cmp'] = "codcte01"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['Grid_search'][$I_Grid]['opc'] = $codcte01_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq']['codcte01'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']['nomcte01'] = $nomcte01; 
      if (is_array($nomcte01) && !empty($nomcte01))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['Grid_search'][$I_Grid]['val'][0] = $nomcte01;
      }
      elseif ($nomcte01_cond_salva == "nu" || $nomcte01_cond_salva == "nn" || $nomcte01_cond_salva == "ep" || $nomcte01_cond_salva == "ne" || !empty($nomcte01))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['Grid_search'][$I_Grid]['val'][0][0] = $nomcte01;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']['nomcte01_cond'] = $nomcte01_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['Grid_search'][$I_Grid]['cmp'] = "nomcte01"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['Grid_search'][$I_Grid]['opc'] = $nomcte01_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq']['nomcte01'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']['cv1cte01'] = $cv1cte01; 
      if (is_array($cv1cte01) && !empty($cv1cte01))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['Grid_search'][$I_Grid]['val'][0] = $cv1cte01;
      }
      elseif ($cv1cte01_cond_salva == "nu" || $cv1cte01_cond_salva == "nn" || $cv1cte01_cond_salva == "ep" || $cv1cte01_cond_salva == "ne" || !empty($cv1cte01))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['Grid_search'][$I_Grid]['val'][0][0] = $cv1cte01;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']['cv1cte01_cond'] = $cv1cte01_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['Grid_search'][$I_Grid]['cmp'] = "cv1cte01"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['Grid_search'][$I_Grid]['opc'] = $cv1cte01_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['grid_pesq']['cv1cte01'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($cv2cte01 != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['cv2cte01'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['cv2cte01'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['cv2cte01'] = $cv2cte01;
      }
      $nmgp_def_dados = array();
    if ($codcte01 != '') {
      $codcte01_look = substr($this->Db->qstr($codcte01), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['codcte01'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['codcte01'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['codcte01'] = $codcte01;
      }
      $nmgp_def_dados = array();
    if ($nomcte01 != '') {
      $nomcte01_look = substr($this->Db->qstr($nomcte01), 1, -1); 
    ...
    if ($cv1cte01 != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['cv1cte01'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['cv1cte01'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['cv1cte01'] = $cv1cte01;
      }

      //----- $cv2cte01
      $this->Date_part = false;
      if (isset($cv2cte01) || $cv2cte01_cond == "nu" || $cv2cte01_cond == "nn" || $cv2cte01_cond == "ep" || $cv2cte01_cond == "ne")
      {
         $this->monta_condicao("cv2cte01", $cv2cte01_cond, $cv2cte01, "", "cv2cte01");
      }
      ...
      //----- $cv1cte01
      $this->Date_part = false;
      if (isset($cv1cte01) || $cv1cte01_cond == "nu" || $cv1cte01_cond == "nn" || $cv1cte01_cond == "ep" || $cv1cte01_cond == "ne")
      {
         $this->monta_condicao("cv1cte01", $cv1cte01_cond, $cv1cte01, "", "cv1cte01");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepag']['cond_pesq'] .= $this->NM_operador;
