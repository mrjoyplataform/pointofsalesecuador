...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_movcte2/form_movcte2_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_movcte2_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_movcte2_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['form_movcte2']['error_buffer']) && '' != $_SESSION['scriptcase']['form_movcte2']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_movcte2']['error_buffer'];
}
...
<?php
 include_once("form_movcte2_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_movcte2_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_movcte2_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_movcte2_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fecvendoc43_line" id="hidden_field_data_fecvendoc43" style="<?php echo $sStyleHidden_fecvendoc43; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecvendoc43_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fecvendoc43_label" style=""><span id="id_label_fecvendoc43"><?php echo $this->nm_new_label['fecvendoc43']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_relacioncob43_line" id="hidden_field_data_relacioncob43" style="<?php echo $sStyleHidden_relacioncob43; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_relacioncob43_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_relacioncob43_label" style=""><span id="id_label_relacioncob43"><?php echo $this->nm_new_label['relacioncob43']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_estadocob43_line" id="hidden_field_data_estadocob43" style="<?php echo $sStyleHidden_estadocob43; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_estadocob43_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_estadocob43_label" style=""><span id="id_label_estadocob43"><?php echo $this->nm_new_label['estadocob43']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nuevocodpago43_line" id="hidden_field_data_nuevocodpago43" style="<?php echo $sStyleHidden_nuevocodpago43; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nuevocodpago43_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nuevocodpago43_label" style=""><span id="id_label_nuevocodpago43"><?php echo $this->nm_new_label['nuevocodpago43']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_porccomision1_line" id="hidden_field_data_porccomision1" style="<?php echo $sStyleHidden_porccomision1; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_porccomision1_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_porccomision1_label" style=""><span id="id_label_porccomision1"><?php echo $this->nm_new_label['porccomision1']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_porccomision2_line" id="hidden_field_data_porccomision2" style="<?php echo $sStyleHidden_porccomision2; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_porccomision2_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_porccomision2_label" style=""><span id="id_label_porccomision2"><?php echo $this->nm_new_label['porccomision2']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_porcdesctocomision1_line" id="hidden_field_data_porcdesctocomision1" style="<?php echo $sStyleHidden_porcdesctocomision1; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_porcdesctocomision1_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_porcdesctocomision1_label" style=""><span id="id_label_porcdesctocomision1"><?php echo $this->nm_new_label['porcdesctocomision1']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_porcdesctocomision2_line" id="hidden_field_data_porcdesctocomision2" style="<?php echo $sStyleHidden_porcdesctocomision2; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_porcdesctocomision2_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_porcdesctocomision2_label" style=""><span id="id_label_porcdesctocomision2"><?php echo $this->nm_new_label['porcdesctocomision2']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ope43_line" id="hidden_field_data_ope43" style="<?php echo $sStyleHidden_ope43; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ope43_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ope43_label" style=""><span id="id_label_ope43"><?php echo $this->nm_new_label['ope43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['ope43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['ope43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tfin43_line" id="hidden_field_data_tfin43" style="<?php echo $sStyleHidden_tfin43; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tfin43_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tfin43_label" style=""><span id="id_label_tfin43"><?php echo $this->nm_new_label['tfin43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['tfin43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['tfin43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fin43_line" id="hidden_field_data_fin43" style="<?php echo $sStyleHidden_fin43; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fin43_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fin43_label" style=""><span id="id_label_fin43"><?php echo $this->nm_new_label['fin43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['fin43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['fin43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ban43_line" id="hidden_field_data_ban43" style="<?php echo $sStyleHidden_ban43; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ban43_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ban43_label" style=""><span id="id_label_ban43"><?php echo $this->nm_new_label['ban43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['ban43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['ban43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cobrador43_line" id="hidden_field_data_cobrador43" style="<?php echo $sStyleHidden_cobrador43; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cobrador43_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cobrador43_label" style=""><span id="id_label_cobrador43"><?php echo $this->nm_new_label['cobrador43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['cobrador43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['cobrador43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_coordinador43_line" id="hidden_field_data_coordinador43" style="<?php echo $sStyleHidden_coordinador43; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_coordinador43_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_coordinador43_label" style=""><span id="id_label_coordinador43"><?php echo $this->nm_new_label['coordinador43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['coordinador43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['coordinador43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cierre_line" id="hidden_field_data_cierre" style="<?php echo $sStyleHidden_cierre; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cierre_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cierre_label" style=""><span id="id_label_cierre"><?php echo $this->nm_new_label['cierre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['cierre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['cierre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idcierre_line" id="hidden_field_data_idcierre" style="<?php echo $sStyleHidden_idcierre; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idcierre_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idcierre_label" style=""><span id="id_label_idcierre"><?php echo $this->nm_new_label['idcierre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['idcierre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['idcierre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_num_bco_dep_line" id="hidden_field_data_num_bco_dep" style="<?php echo $sStyleHidden_num_bco_dep; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_num_bco_dep_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_num_bco_dep_label" style=""><span id="id_label_num_bco_dep"><?php echo $this->nm_new_label['num_bco_dep']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['num_bco_dep']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['num_bco_dep'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_num_deposito_line" id="hidden_field_data_num_deposito" style="<?php echo $sStyleHidden_num_deposito; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_num_deposito_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_num_deposito_label" style=""><span id="id_label_num_deposito"><?php echo $this->nm_new_label['num_deposito']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['num_deposito']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['num_deposito'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_num_doc_cont_line" id="hidden_field_data_num_doc_cont" style="<?php echo $sStyleHidden_num_doc_cont; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_num_doc_cont_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_num_doc_cont_label" style=""><span id="id_label_num_doc_cont"><?php echo $this->nm_new_label['num_doc_cont']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['num_doc_cont']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['num_doc_cont'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tip_doc_cont_line" id="hidden_field_data_tip_doc_cont" style="<?php echo $sStyleHidden_tip_doc_cont; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tip_doc_cont_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tip_doc_cont_label" style=""><span id="id_label_tip_doc_cont"><?php echo $this->nm_new_label['tip_doc_cont']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['tip_doc_cont']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['tip_doc_cont'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_datosretcliente_line" id="hidden_field_data_datosretcliente" style="<?php echo $sStyleHidden_datosretcliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_datosretcliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_datosretcliente_label" style=""><span id="id_label_datosretcliente"><?php echo $this->nm_new_label['datosretcliente']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['datosretcliente']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['datosretcliente'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_valoresretcliente_line" id="hidden_field_data_valoresretcliente" style="<?php echo $sStyleHidden_valoresretcliente; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valoresretcliente_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_valoresretcliente_label" style=""><span id="id_label_valoresretcliente"><?php echo $this->nm_new_label['valoresretcliente']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['valoresretcliente']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['valoresretcliente'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_beneficiario43_line" id="hidden_field_data_beneficiario43" style="<?php echo $sStyleHidden_beneficiario43; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_beneficiario43_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_beneficiario43_label" style=""><span id="id_label_beneficiario43"><?php echo $this->nm_new_label['beneficiario43']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fecha_creacion_del_65_line" id="hidden_field_data_fecha_creacion_del_65" style="<?php echo $sStyleHidden_fecha_creacion_del_65; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecha_creacion_del_65_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fecha_creacion_del_65_label" style=""><span id="id_label_fecha_creacion_del_65"><?php echo $this->nm_new_label['fecha_creacion_del_65']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fecha_adicional_line" id="hidden_field_data_fecha_adicional" style="<?php echo $sStyleHidden_fecha_adicional; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecha_adicional_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fecha_adicional_label" style=""><span id="id_label_fecha_adicional"><?php echo $this->nm_new_label['fecha_adicional']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_cotizacion_line" id="hidden_field_data_id_cotizacion" style="<?php echo $sStyleHidden_id_cotizacion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_cotizacion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_cotizacion_label" style=""><span id="id_label_id_cotizacion"><?php echo $this->nm_new_label['id_cotizacion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['id_cotizacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['id_cotizacion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_institucion_line" id="hidden_field_data_institucion" style="<?php echo $sStyleHidden_institucion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_institucion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_institucion_label" style=""><span id="id_label_institucion"><?php echo $this->nm_new_label['institucion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['institucion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['php_cmp_required']['institucion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_movcte2_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_movcte2_mob");
 parent.scAjaxDetailHeight("form_movcte2_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_movcte2_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
