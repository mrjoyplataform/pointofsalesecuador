...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_cierre_conteo"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_cierre_conteo"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_cierre_conteo'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cierre_conteo']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cierre_conteo']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cierre_conteo']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cierre_conteo']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cierre_conteo']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_cierre_conteo</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cierre_conteo']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cierre_conteo']['embutida_filho'] as $ind => $sc_init)
          {
