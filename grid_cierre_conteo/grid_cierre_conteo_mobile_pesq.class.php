...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fecha";$Nm_datas[] = "fecha";$Nm_numeric[] = "codgrupo";$Nm_numeric[] = "tipovalor";$Nm_numeric[] = "cantidad";$Nm_numeric[] = "valor";$Nm_numeric[] = "estado";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_cantidad"  <?php echo $str_hide_cantidad?>><INPUT  type="text" id="SC_cantidad" name="cantidad" value="<?php echo NM_encode_input($cantidad) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_codgrupo_cond" name="codgrupo_cond" onChange="nm_campos_between(document.getElementById('id_vis_codgrupo'), this, 'codgrupo')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_tipovalor_cond" name="tipovalor_cond" onChange="nm_campos_between(document.getElementById('id_vis_tipovalor'), this, 'tipovalor')">
