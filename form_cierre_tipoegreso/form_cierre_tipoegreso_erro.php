...
$old_error_handler = set_error_handler("form_cierre_tipoegreso_scriptcase_error_handler");

function form_cierre_tipoegreso_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_cierre_tipoegreso']['contr_erro']) && $_SESSION['scriptcase']['form_cierre_tipoegreso']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_cierre_tipoegreso->contr_form_cierre_tipoegreso->Apl_com_erro = true;
            if ($inicial_form_cierre_tipoegreso->contr_form_cierre_tipoegreso->NM_ajax_flag)
            {
                $inicial_form_cierre_tipoegreso->contr_form_cierre_tipoegreso->NM_ajax_info['errList']['geral_form_cierre_tipoegreso'][] = $msg;
                return;
            }
            form_cierre_tipoegreso_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_cierre_tipoegreso_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_cierre_tipoegreso'])  && '' != $_SESSION['scriptcase']['error_icon']['form_cierre_tipoegreso'])  ? $_SESSION['scriptcase']['error_icon']['form_cierre_tipoegreso']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_cierre_tipoegreso']) && '' != $_SESSION['scriptcase']['error_close']['form_cierre_tipoegreso']) ? $_SESSION['scriptcase']['error_close']['form_cierre_tipoegreso'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_cierre_tipoegreso']) && '' != $_SESSION['scriptcase']['error_span_title']['form_cierre_tipoegreso']) ? $_SESSION['scriptcase']['error_span_title']['form_cierre_tipoegreso'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_cierre_tipoegreso']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_cierre_tipoegreso']) ? $_SESSION['scriptcase']['error_icon_title']['form_cierre_tipoegreso'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_cierre_tipoegreso']['error_buffer'] .= ob_get_flush();
}
