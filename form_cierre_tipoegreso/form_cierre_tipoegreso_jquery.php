...
function scEventControl_init(iSeqRow) {
  scEventControl_data["idegreso_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
...
function scEventControl_active(iSeqRow) {
  if (scEventControl_data["idegreso_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["idegreso_" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idegreso_' + iSeqRow).bind('blur', function() { sc_form_cierre_tipoegreso_idegreso__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_cierre_tipoegreso_idegreso__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_cierre_tipoegreso_idegreso__onfocus(this, iSeqRow) });
  $('#id_sc_field_descrip_' + iSeqRow).bind('blur', function() { sc_form_cierre_tipoegreso_descrip__onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_cierre_tipoegreso_descrip__onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_cierre_tipoegreso_descrip__onfocus(this, iSeqRow) });
  $('#id_sc_field_activo_' + iSeqRow).bind('blur', function() { sc_form_cierre_tipoegreso_activo__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_cierre_tipoegreso_activo__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_cierre_tipoegreso_activo__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_cierre_tipoegreso_idegreso__onblur(oThis, iSeqRow) {
  do_ajax_form_cierre_tipoegreso_validate_idegreso_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_cierre_tipoegreso_idegreso__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_cierre_tipoegreso_idegreso__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_cierre_tipoegreso_descrip__onblur(oThis, iSeqRow) {
  do_ajax_form_cierre_tipoegreso_validate_descrip_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_cierre_tipoegreso_descrip__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_cierre_tipoegreso_descrip__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_cierre_tipoegreso_activo__onblur(oThis, iSeqRow) {
  do_ajax_form_cierre_tipoegreso_validate_activo_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_cierre_tipoegreso_activo__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_cierre_tipoegreso_activo__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function displayChange_block_0(status) {
	displayChange_field("idegreso_", "", status);
	displayChange_field("descrip_", "", status);
	displayChange_field("activo_", "", status);
}

function displayChange_row(row, status) {
	displayChange_field_idegreso_(row, status);
...
function displayChange_field_idegreso_(row, status) {
    var fieldId;
}
...
function scHidePage(pageNo) {
	$("#id_form_cierre_tipoegreso_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_cierre_tipoegreso')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
