  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cierre_tipoegreso" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cierre_tipoegreso_form();
	}
...
?>
  ...
  // ---------- Validate idegreso_
  function do_ajax_form_cierre_tipoegreso_validate_idegreso_(iNumLinha)
  {
    var nomeCampo_idegreso_ = "idegreso_" + iNumLinha;
    var var_idegreso_ = scAjaxGetFieldText(nomeCampo_idegreso_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_tipoegreso_validate_idegreso_(var_idegreso_, iNumLinha, var_script_case_init, do_ajax_form_cierre_tipoegreso_validate_idegreso__cb);
  } // do_ajax_form_cierre_tipoegreso_validate_idegreso_

  function do_ajax_form_cierre_tipoegreso_validate_idegreso__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idegreso_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idegreso_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idegreso_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idegreso_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_tipoegreso_validate_idegreso__cb

  // ---------- Validate descrip_
  function do_ajax_form_cierre_tipoegreso_validate_descrip_(iNumLinha)
  {
    var nomeCampo_descrip_ = "descrip_" + iNumLinha;
    var var_descrip_ = scAjaxGetFieldText(nomeCampo_descrip_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_tipoegreso_validate_descrip_(var_descrip_, iNumLinha, var_script_case_init, do_ajax_form_cierre_tipoegreso_validate_descrip__cb);
  } // do_ajax_form_cierre_tipoegreso_validate_descrip_

  function do_ajax_form_cierre_tipoegreso_validate_descrip__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_tipoegreso_validate_descrip__cb

  // ---------- Validate activo_
  function do_ajax_form_cierre_tipoegreso_validate_activo_(iNumLinha)
  {
    var nomeCampo_activo_ = "activo_" + iNumLinha;
    var var_activo_ = scAjaxGetFieldText(nomeCampo_activo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_tipoegreso_validate_activo_(var_activo_, iNumLinha, var_script_case_init, do_ajax_form_cierre_tipoegreso_validate_activo__cb);
  } // do_ajax_form_cierre_tipoegreso_validate_activo_

  function do_ajax_form_cierre_tipoegreso_validate_activo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_tipoegreso_validate_activo__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_cierre_tipoegreso_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_cierre_tipoegreso_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cierre_tipoegreso_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_cierre_tipoegreso_add_new_line_cb);
  } // do_ajax_form_cierre_tipoegreso_add_new_line

  function do_ajax_form_cierre_tipoegreso_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_cierre_tipoegreso_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_cierre_tipoegreso_backup_line(iNumLinha)
  {
    var var_idegreso_ = scAjaxGetFieldText("idegreso_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_tipoegreso_backup_line(var_idegreso_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_cierre_tipoegreso_backup_line_cb);
  } // do_ajax_form_cierre_tipoegreso_backup_line

  function do_ajax_form_cierre_tipoegreso_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_cierre_tipoegreso_backup_line_cb

  function do_ajax_form_cierre_tipoegreso_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_cierre_tipoegreso_cancel_insert

  function do_ajax_form_cierre_tipoegreso_cancel_update(iSeqVert)
  {
    do_ajax_form_cierre_tipoegreso_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_cierre_tipoegreso_cancel_update

  function do_ajax_form_cierre_tipoegreso_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_cierre_tipoegreso_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_cierre_tipoegreso_table_refresh()
  {
    var var_idegreso_ = document.F2.idegreso_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_cierre_tipoegreso_table_refresh(var_idegreso_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cierre_tipoegreso_table_refresh_cb);
  } //  do_ajax_form_cierre_tipoegreso_table_refresh

  function do_ajax_form_cierre_tipoegreso_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idegreso_.value = scAjaxGetKeyValue("idegreso_");
    ...
    scAjaxAlert(do_ajax_form_cierre_tipoegreso_table_refresh_cb_after_alert);
  } // do_ajax_form_cierre_tipoegreso_table_refresh_cb
  function do_ajax_form_cierre_tipoegreso_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_cierre_tipoegreso_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_cierre_tipoegreso_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_cierre_tipoegreso_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_cierre_tipoegreso_submit_form(var_idegreso_, var_descrip_, var_activo_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_cierre_tipoegreso_submit_form_cb);
  } // do_ajax_form_cierre_tipoegreso_submit_form

  function do_ajax_form_cierre_tipoegreso_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idegreso_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cierre_tipoegreso_submit_form_cb_after_alert);
  } // do_ajax_form_cierre_tipoegreso_submit_form_cb
  function do_ajax_form_cierre_tipoegreso_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cierre_tipoegreso_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cierre_tipoegreso_navigate_form()
  {
    perform_ajax_form_cierre_tipoegreso_navigate_form();
  }

  function perform_ajax_form_cierre_tipoegreso_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("idegreso_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cierre_tipoegreso_navigate_form(var_idegreso_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cierre_tipoegreso_navigate_form_cb);
  } // do_ajax_form_cierre_tipoegreso_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cierre_tipoegreso']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cierre_tipoegreso_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idegreso_.value = scAjaxGetKeyValue("idegreso_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cierre_tipoegreso_navigate_form_cb_after_alert);
  } // do_ajax_form_cierre_tipoegreso_navigate_form_cb
  function do_ajax_form_cierre_tipoegreso_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_cierre_tipoegreso_navigate_form_cb_after_alert

    function sc_form_cierre_tipoegreso_get_last_line_number()
    {
    ...
    } //sc_form_cierre_tipoegreso_get_last_line_number

  function sc_hide_form_cierre_tipoegreso_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idegreso_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "descrip_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "activo_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idegreso_" + iNumLinha] = {"label": "Idegreso<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["idegreso_"][iNumLinha] = "idegreso_" + iNumLinha;
    ajax_field_mult["descrip_"][iNumLinha] = "descrip_" + iNumLinha;
    ajax_field_mult["activo_"][iNumLinha] = "activo_" + iNumLinha;
    ajax_field_id["idegreso_" + iNumLinha] = new Array("hidden_field_label_idegreso_", "hidden_field_data_idegreso_" + iNumLinha);
    ...
    ajax_error_count["idegreso_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["idegreso_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["idegreso_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idegreso_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idegreso_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idegreso_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idegreso_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idegreso_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idegreso_'])) ? $this->nmgp_cmp_readonly['idegreso_'] : 'on';
?>
    scAjaxFieldRead("idegreso_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("idegreso_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idegreso_" + iRow] || "on" == ajax_error_count["descrip_" + iRow] || "on" == ajax_error_count["activo_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idegreso_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idegreso_" + iRow] && "off" == ajax_error_count["descrip_" + iRow] && "off" == ajax_error_count["activo_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idegreso_" + iRow] = "off";
      ...
      $("#hidden_field_data_idegreso_" + iRow).removeClass("scFormErrorLine");
