...
Table_sv_fil[2] = "razon_social";
Table_sv_fil[3] = "documento";
function ajax_select_filter(parm)
{
    ...
    $.ajax({
     ...
     .done(function(json_sel_fil) {
        ...
        if ($("#SC_fecha_cond") && search_get_sel_txt("SC_fecha_cond").substring(0, 3) == "bi_") {
            formata_bi_fecha(search_get_sel_txt("SC_fecha_cond"), SC_fecha_bi_opc, SC_fecha_bi_dt);
        }
