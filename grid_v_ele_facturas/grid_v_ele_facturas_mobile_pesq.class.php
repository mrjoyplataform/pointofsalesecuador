...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fecha";$Nm_datas[] = "fecha";$Nm_numeric[] = "id";$Nm_numeric[] = "total_sin_iva";$Nm_numeric[] = "total_con_iva";$Nm_numeric[] = "iva";$Nm_numeric[] = "ice";$Nm_numeric[] = "descuentos";$Nm_numeric[] = "total";
...
<SPAN id="Nm_bi_dados_fecha" style="display:none"></SPAN>
<SPAN id="opc_bi_TP_fecha"  style="display:''">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_numero_cond" name="numero_cond" onChange="nm_campos_between(document.getElementById('id_vis_numero'), this, 'numero')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_documento_cond" name="documento_cond" onChange="nm_campos_between(document.getElementById('id_vis_documento'), this, 'documento')">
