...
class grid_xml_compras_hdr_id_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_xml_compras_hdr_id']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_xml_compras_hdr_id']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['contr_total_geral'] == "OK")
      {
          $this->array_total_identificacioncomprador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['arr_total']['identificacioncomprador'];
          $this->array_total_tipodoc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['arr_total']['tipodoc'];
      }
      else
      {
          $this->array_total_identificacioncomprador = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['tot_geral'][3];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['arr_total']['identificacioncomprador'] = $this->array_total_identificacioncomprador;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['arr_total']['tipodoc'] = $this->array_total_tipodoc;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['json_use_label'])
       {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['claveacceso']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['claveacceso'] = "Clave Acceso"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['tipodoc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['tipodoc'] = "Tipodoc"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['documento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['documento'] = "Documento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['codigobarras']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['codigobarras'] = ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['ruc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['ruc'] = "Ruc"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['razonsocial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['razonsocial'] = "Razon Social"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['fechaemision']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['fechaemision'] = "Fecha Emision"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['totalsinimpuestos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['totalsinimpuestos'] = "Total Sin Impuestos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['importetotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['importetotal'] = "Importe Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['dirmatriz']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['dirmatriz'] = "Dir Matriz"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['estado'] = "Estado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['txtline']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['txtline'] = "Txtline"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['detalles']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['detalles'] = "Detalles"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['impuestos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['impuestos'] = "impuestos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['ambiente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['ambiente'] = "Ambiente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['tipoemision']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['tipoemision'] = "Tipo Emision"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['nombrecomercial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['nombrecomercial'] = "Nombre Comercial"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['coddoc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['coddoc'] = "Cod Doc"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['estab']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['estab'] = "Estab"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['ptoemi']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['ptoemi'] = "Pto Emi"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['secuencial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['secuencial'] = "Secuencial"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['direstablecimiento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['direstablecimiento'] = "Dir Establecimiento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['obligadocontabilidad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['obligadocontabilidad'] = "Obligado Contabilidad"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['tipoidentificacioncomprador']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['tipoidentificacioncomprador'] = "Tipo Identificacion Comprador"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['razonsocialcomprador']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['razonsocialcomprador'] = "Razon Social Comprador"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['identificacioncomprador']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['identificacioncomprador'] = "Identificacion Comprador"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['totaldescuento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['totaldescuento'] = "Total Descuento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['totalconimpuestos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['totalconimpuestos'] = "Total Con Impuestos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['propina']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['propina'] = "Propina"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['moneda']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['moneda'] = "Moneda"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['fecharegistro']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['labels']['fecharegistro'] = "Fecharegistro"; 
       }
       //-----
       $this->comp_field_nm = array(
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['summarizing_fields_order']['identificacionComprador']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['summarizing_fields_order']['identificacionComprador'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['summarizing_fields_order']['identificacionComprador'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['summarizing_fields_display']['identificacionComprador'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['summarizing_fields_display']['identificacionComprador'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['summarizing_fields_display']['identificacionComprador'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['summarizing_fields_display']['identificacionComprador'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['summarizing_fields_display']['identificacionComprador'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['summarizing_fields_display']['identificacionComprador'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['summarizing_fields_display']['identificacionComprador'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_xml_compras_hdr_id@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_xml_compras_hdr_id_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_xml_compras_hdr_id_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_xml_compras_hdr_id_total.class.php"); 
      }
      ...
      $this->Total   = new grid_xml_compras_hdr_id_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_xml_compras_hdr_id/grid_xml_compras_hdr_id_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_xml_compras_hdr_id_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_xml_compras_hdr_id_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_xml_compras_hdr_id_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['num_css'] . '.css');
     ...
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_xml_compras_hdr_id/grid_xml_compras_hdr_id_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_xml_compras_hdr_id&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_xml_compras_hdr_id/grid_xml_compras_hdr_id_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_xml_compras_hdr_id/grid_xml_compras_hdr_id_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_xml_compras_hdr_id/grid_xml_compras_hdr_id_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_xml_compras_hdr_id/grid_xml_compras_hdr_id_config_graf_flash.php?nome_apl=grid_xml_compras_hdr_id&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_xml_compras_hdr_id_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rpdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['pdf'][] = "Rpdf_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_xml_compras_hdr_id/grid_xml_compras_hdr_id_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_xml_compras_hdr_id&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xml'][] = "Rxml_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_xml_compras_hdr_id/grid_xml_compras_hdr_id_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rcsv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['csv'][] = "Rcsv_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_xml_compras_hdr_id/grid_xml_compras_hdr_id_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_xml_compras_hdr_id']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_xml_compras_hdr_id']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_xml_compras_hdr_id_config_pivot.php?nome_apl=grid_xml_compras_hdr_id&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_xml_compras_hdr_id_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_xml_compras_hdr_id/grid_xml_compras_hdr_id_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_hdr_id']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->claveacceso = $rs_res->fields[0] ;  
            $this->tipodoc = $rs_res->fields[1] ;  
            $this->documento = $rs_res->fields[2] ;  
            $this->codigobarras = $rs_res->fields[3] ;  
            $this->ruc = $rs_res->fields[4] ;  
            $this->razonsocial = $rs_res->fields[5] ;  
            $this->fechaemision = $rs_res->fields[6] ;  
            $this->totalsinimpuestos = $rs_res->fields[7] ;  
            $this->totalsinimpuestos =  str_replace(",", ".", $this->totalsinimpuestos);
            $this->importetotal = $rs_res->fields[8] ;  
