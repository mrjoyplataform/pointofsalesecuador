...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_xml_compras_hdr_id"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_xml_compras_hdr_id"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_xml_compras_hdr_id']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_xml_compras_hdr_id']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_xml_compras_hdr_id']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_xml_compras_hdr_id']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_xml_compras_hdr_id']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_xml_compras_hdr_id</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_xml_compras_hdr_id']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_xml_compras_hdr_id']['embutida_filho'] as $ind => $sc_init)
          {
