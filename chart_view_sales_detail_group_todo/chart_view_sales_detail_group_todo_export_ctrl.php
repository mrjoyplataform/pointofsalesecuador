<?php
@session_start() ;
$_SESSION['scriptcase']['chart_view_sales_detail_group_todo']['sc_process_barr'] = true;
require_once('../chart_view_sales_detail_group_todo/index.php');
unset($_SESSION['scriptcase']['chart_view_sales_detail_group_todo']['sc_process_barr']);
$ExportCtrl = new chart_view_sales_detail_group_todo_export_control;
$ExportCtrl->Export_barr();

class chart_view_sales_detail_group_todo_export_control
{
