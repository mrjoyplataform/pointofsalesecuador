...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_devices_read_rfid"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_devices_read_rfid"]);
   }
   ...
   if (isset($_SESSION['scriptcase']['refresh']['grid_devices_read_rfid']))
   {
       unset($_SESSION['scriptcase']['refresh']['grid_devices_read_rfid']);
   }
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_devices_read_rfid']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_devices_read_rfid']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_devices_read_rfid']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_devices_read_rfid']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_devices_read_rfid']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_devices_read_rfid</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_devices_read_rfid']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_devices_read_rfid']['embutida_filho'] as $ind => $sc_init)
          {
