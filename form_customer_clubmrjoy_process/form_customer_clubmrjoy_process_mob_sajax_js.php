  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_customer_clubmrjoy_process_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_customer_clubmrjoy_process_mob_form();
	}
...
?>
  ...
  // ---------- Validate idreg
  function do_ajax_form_customer_clubmrjoy_process_mob_validate_idreg()
  {
    var nomeCampo_idreg = "idreg";
    var var_idreg = scAjaxGetFieldHidden(nomeCampo_idreg);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_process_mob_validate_idreg(var_idreg, var_script_case_init, do_ajax_form_customer_clubmrjoy_process_mob_validate_idreg_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_idreg

  function do_ajax_form_customer_clubmrjoy_process_mob_validate_idreg_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_idreg_cb

  // ---------- Validate idcustomer
  function do_ajax_form_customer_clubmrjoy_process_mob_validate_idcustomer()
  {
    var nomeCampo_idcustomer = "idcustomer";
    var var_idcustomer = scAjaxGetFieldText(nomeCampo_idcustomer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_process_mob_validate_idcustomer(var_idcustomer, var_script_case_init, do_ajax_form_customer_clubmrjoy_process_mob_validate_idcustomer_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_idcustomer

  function do_ajax_form_customer_clubmrjoy_process_mob_validate_idcustomer_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_idcustomer_cb

  // ---------- Validate nombre
  function do_ajax_form_customer_clubmrjoy_process_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_process_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_customer_clubmrjoy_process_mob_validate_nombre_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_nombre

  function do_ajax_form_customer_clubmrjoy_process_mob_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_nombre_cb

  // ---------- Validate correo
  function do_ajax_form_customer_clubmrjoy_process_mob_validate_correo()
  {
    var nomeCampo_correo = "correo";
    var var_correo = scAjaxGetFieldText(nomeCampo_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_process_mob_validate_correo(var_correo, var_script_case_init, do_ajax_form_customer_clubmrjoy_process_mob_validate_correo_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_correo

  function do_ajax_form_customer_clubmrjoy_process_mob_validate_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "correo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_correo_cb

  // ---------- Validate celular
  function do_ajax_form_customer_clubmrjoy_process_mob_validate_celular()
  {
    var nomeCampo_celular = "celular";
    var var_celular = scAjaxGetFieldText(nomeCampo_celular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_process_mob_validate_celular(var_celular, var_script_case_init, do_ajax_form_customer_clubmrjoy_process_mob_validate_celular_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_celular

  function do_ajax_form_customer_clubmrjoy_process_mob_validate_celular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "celular";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_celular_cb

  // ---------- Validate idinterno
  function do_ajax_form_customer_clubmrjoy_process_mob_validate_idinterno()
  {
    var nomeCampo_idinterno = "idinterno";
    var var_idinterno = scAjaxGetFieldText(nomeCampo_idinterno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_process_mob_validate_idinterno(var_idinterno, var_script_case_init, do_ajax_form_customer_clubmrjoy_process_mob_validate_idinterno_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_idinterno

  function do_ajax_form_customer_clubmrjoy_process_mob_validate_idinterno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_idinterno_cb

  // ---------- Validate direccion
  function do_ajax_form_customer_clubmrjoy_process_mob_validate_direccion()
  {
    var nomeCampo_direccion = "direccion";
    var var_direccion = scAjaxGetFieldText(nomeCampo_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_process_mob_validate_direccion(var_direccion, var_script_case_init, do_ajax_form_customer_clubmrjoy_process_mob_validate_direccion_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_direccion

  function do_ajax_form_customer_clubmrjoy_process_mob_validate_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_direccion_cb

  // ---------- Validate tipodoc
  function do_ajax_form_customer_clubmrjoy_process_mob_validate_tipodoc()
  {
    var nomeCampo_tipodoc = "tipodoc";
    var var_tipodoc = scAjaxGetFieldText(nomeCampo_tipodoc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_process_mob_validate_tipodoc(var_tipodoc, var_script_case_init, do_ajax_form_customer_clubmrjoy_process_mob_validate_tipodoc_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_tipodoc

  function do_ajax_form_customer_clubmrjoy_process_mob_validate_tipodoc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipodoc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_tipodoc_cb

  // ---------- Validate ult_fecha
  function do_ajax_form_customer_clubmrjoy_process_mob_validate_ult_fecha()
  {
    var nomeCampo_ult_fecha = "ult_fecha";
    var var_ult_fecha = scAjaxGetFieldText(nomeCampo_ult_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_process_mob_validate_ult_fecha(var_ult_fecha, var_script_case_init, do_ajax_form_customer_clubmrjoy_process_mob_validate_ult_fecha_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_ult_fecha

  function do_ajax_form_customer_clubmrjoy_process_mob_validate_ult_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_ult_fecha_cb

  // ---------- Validate local_centro
  function do_ajax_form_customer_clubmrjoy_process_mob_validate_local_centro()
  {
    var nomeCampo_local_centro = "local_centro";
    var var_local_centro = scAjaxGetFieldText(nomeCampo_local_centro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_process_mob_validate_local_centro(var_local_centro, var_script_case_init, do_ajax_form_customer_clubmrjoy_process_mob_validate_local_centro_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_local_centro

  function do_ajax_form_customer_clubmrjoy_process_mob_validate_local_centro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_local_centro_cb

  // ---------- Validate cliente_tipo
  function do_ajax_form_customer_clubmrjoy_process_mob_validate_cliente_tipo()
  {
    var nomeCampo_cliente_tipo = "cliente_tipo";
    var var_cliente_tipo = scAjaxGetFieldText(nomeCampo_cliente_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_process_mob_validate_cliente_tipo(var_cliente_tipo, var_script_case_init, do_ajax_form_customer_clubmrjoy_process_mob_validate_cliente_tipo_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_cliente_tipo

  function do_ajax_form_customer_clubmrjoy_process_mob_validate_cliente_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_cliente_tipo_cb

  // ---------- Validate afiliado_desde
  function do_ajax_form_customer_clubmrjoy_process_mob_validate_afiliado_desde()
  {
    var nomeCampo_afiliado_desde = "afiliado_desde";
    var var_afiliado_desde = scAjaxGetFieldText(nomeCampo_afiliado_desde);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_process_mob_validate_afiliado_desde(var_afiliado_desde, var_script_case_init, do_ajax_form_customer_clubmrjoy_process_mob_validate_afiliado_desde_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_afiliado_desde

  function do_ajax_form_customer_clubmrjoy_process_mob_validate_afiliado_desde_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_afiliado_desde_cb

  // ---------- Validate sector
  function do_ajax_form_customer_clubmrjoy_process_mob_validate_sector()
  {
    var nomeCampo_sector = "sector";
    var var_sector = scAjaxGetFieldText(nomeCampo_sector);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_process_mob_validate_sector(var_sector, var_script_case_init, do_ajax_form_customer_clubmrjoy_process_mob_validate_sector_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_sector

  function do_ajax_form_customer_clubmrjoy_process_mob_validate_sector_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sector";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_sector_cb

  // ---------- Validate estado
  function do_ajax_form_customer_clubmrjoy_process_mob_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldText(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_process_mob_validate_estado(var_estado, var_script_case_init, do_ajax_form_customer_clubmrjoy_process_mob_validate_estado_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_estado

  function do_ajax_form_customer_clubmrjoy_process_mob_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_estado_cb

  // ---------- Validate uniqueid
  function do_ajax_form_customer_clubmrjoy_process_mob_validate_uniqueid()
  {
    var nomeCampo_uniqueid = "uniqueid";
    var var_uniqueid = scAjaxGetFieldText(nomeCampo_uniqueid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_process_mob_validate_uniqueid(var_uniqueid, var_script_case_init, do_ajax_form_customer_clubmrjoy_process_mob_validate_uniqueid_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_uniqueid

  function do_ajax_form_customer_clubmrjoy_process_mob_validate_uniqueid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_uniqueid_cb

  // ---------- Validate ciudad
  function do_ajax_form_customer_clubmrjoy_process_mob_validate_ciudad()
  {
    var nomeCampo_ciudad = "ciudad";
    var var_ciudad = scAjaxGetFieldText(nomeCampo_ciudad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_process_mob_validate_ciudad(var_ciudad, var_script_case_init, do_ajax_form_customer_clubmrjoy_process_mob_validate_ciudad_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_ciudad

  function do_ajax_form_customer_clubmrjoy_process_mob_validate_ciudad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ciudad";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_ciudad_cb

  // ---------- Validate pais
  function do_ajax_form_customer_clubmrjoy_process_mob_validate_pais()
  {
    var nomeCampo_pais = "pais";
    var var_pais = scAjaxGetFieldText(nomeCampo_pais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_process_mob_validate_pais(var_pais, var_script_case_init, do_ajax_form_customer_clubmrjoy_process_mob_validate_pais_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_pais

  function do_ajax_form_customer_clubmrjoy_process_mob_validate_pais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pais";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_pais_cb

  // ---------- Validate fecha1
  function do_ajax_form_customer_clubmrjoy_process_mob_validate_fecha1()
  {
    var nomeCampo_fecha1 = "fecha1";
    var var_fecha1 = scAjaxGetFieldText(nomeCampo_fecha1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_process_mob_validate_fecha1(var_fecha1, var_script_case_init, do_ajax_form_customer_clubmrjoy_process_mob_validate_fecha1_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_fecha1

  function do_ajax_form_customer_clubmrjoy_process_mob_validate_fecha1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_fecha1_cb

  // ---------- Validate fecha2
  function do_ajax_form_customer_clubmrjoy_process_mob_validate_fecha2()
  {
    var nomeCampo_fecha2 = "fecha2";
    var var_fecha2 = scAjaxGetFieldText(nomeCampo_fecha2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_process_mob_validate_fecha2(var_fecha2, var_script_case_init, do_ajax_form_customer_clubmrjoy_process_mob_validate_fecha2_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_fecha2

  function do_ajax_form_customer_clubmrjoy_process_mob_validate_fecha2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_fecha2_cb

  // ---------- Validate fecha3
  function do_ajax_form_customer_clubmrjoy_process_mob_validate_fecha3()
  {
    var nomeCampo_fecha3 = "fecha3";
    var var_fecha3 = scAjaxGetFieldText(nomeCampo_fecha3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_process_mob_validate_fecha3(var_fecha3, var_script_case_init, do_ajax_form_customer_clubmrjoy_process_mob_validate_fecha3_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_fecha3

  function do_ajax_form_customer_clubmrjoy_process_mob_validate_fecha3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha3";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_process_mob_validate_fecha3_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_customer_clubmrjoy_process_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_customer_clubmrjoy_process_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_customer_clubmrjoy_process_mob_submit_form(var_idreg, var_idcustomer, var_nombre, var_correo, var_celular, var_idinterno, var_direccion, var_tipodoc, var_ult_fecha, var_local_centro, var_cliente_tipo, var_afiliado_desde, var_sector, var_estado, var_uniqueid, var_ciudad, var_pais, var_fecha1, var_fecha2, var_fecha3, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_customer_clubmrjoy_process_mob_submit_form_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_submit_form

  function do_ajax_form_customer_clubmrjoy_process_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_customer_clubmrjoy_process_mob_submit_form_cb_after_alert);
  } // do_ajax_form_customer_clubmrjoy_process_mob_submit_form_cb
  function do_ajax_form_customer_clubmrjoy_process_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_customer_clubmrjoy_process_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_customer_clubmrjoy_process_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_customer_clubmrjoy_process_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_customer_clubmrjoy_process_mob_navigate_form();
    }
  }

  function perform_ajax_form_customer_clubmrjoy_process_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_customer_clubmrjoy_process_mob_navigate_form(var_idreg, var_idcustomer, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_customer_clubmrjoy_process_mob_navigate_form_cb);
  } // do_ajax_form_customer_clubmrjoy_process_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy_process_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_customer_clubmrjoy_process_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_customer_clubmrjoy_process_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_customer_clubmrjoy_process_mob_navigate_form_cb
  function do_ajax_form_customer_clubmrjoy_process_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_customer_clubmrjoy_process_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_customer_clubmrjoy_process_mob_navigate_form_cb_after_alert

  function sc_hide_form_customer_clubmrjoy_process_mob_form()
  {
