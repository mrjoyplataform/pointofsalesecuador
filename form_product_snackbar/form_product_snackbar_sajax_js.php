  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_product_snackbar" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_product_snackbar_form();
	}
...
?>
  ...
  function do_ajax_form_product_snackbar_validate_product_name()
  {
    var nomeCampo_product_name = "product_name";
    var var_product_name = scAjaxGetFieldText(nomeCampo_product_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_product_name(var_product_name, var_script_case_init, do_ajax_form_product_snackbar_validate_product_name_cb);
  } // do_ajax_form_product_snackbar_validate_product_name

  function do_ajax_form_product_snackbar_validate_product_name_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_product_name_cb

  // ---------- Validate id_category
  function do_ajax_form_product_snackbar_validate_id_category()
  {
    var nomeCampo_id_category = "id_category";
    var var_id_category = scAjaxGetFieldSelect(nomeCampo_id_category);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_id_category(var_id_category, var_script_case_init, do_ajax_form_product_snackbar_validate_id_category_cb);
  } // do_ajax_form_product_snackbar_validate_id_category

  function do_ajax_form_product_snackbar_validate_id_category_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_id_category_cb

  // ---------- Validate product_code
  function do_ajax_form_product_snackbar_validate_product_code()
  {
    var nomeCampo_product_code = "product_code";
    var var_product_code = scAjaxGetFieldText(nomeCampo_product_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_product_code(var_product_code, var_script_case_init, do_ajax_form_product_snackbar_validate_product_code_cb);
  } // do_ajax_form_product_snackbar_validate_product_code

  function do_ajax_form_product_snackbar_validate_product_code_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_product_code_cb

  // ---------- Validate dateproduct
  function do_ajax_form_product_snackbar_validate_dateproduct()
  {
    var nomeCampo_dateproduct = "dateproduct";
    var var_dateproduct = scAjaxGetFieldHidden(nomeCampo_dateproduct);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_dateproduct(var_dateproduct, var_script_case_init, do_ajax_form_product_snackbar_validate_dateproduct_cb);
  } // do_ajax_form_product_snackbar_validate_dateproduct

  function do_ajax_form_product_snackbar_validate_dateproduct_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_dateproduct_cb

  // ---------- Validate product_cost
  function do_ajax_form_product_snackbar_validate_product_cost()
  {
    var nomeCampo_product_cost = "product_cost";
    var var_product_cost = scAjaxGetFieldText(nomeCampo_product_cost);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_product_cost(var_product_cost, var_script_case_init, do_ajax_form_product_snackbar_validate_product_cost_cb);
  } // do_ajax_form_product_snackbar_validate_product_cost

  function do_ajax_form_product_snackbar_validate_product_cost_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_product_cost_cb

  // ---------- Validate stock
  function do_ajax_form_product_snackbar_validate_stock()
  {
    var nomeCampo_stock = "stock";
    var var_stock = scAjaxGetFieldHidden(nomeCampo_stock);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_stock(var_stock, var_script_case_init, do_ajax_form_product_snackbar_validate_stock_cb);
  } // do_ajax_form_product_snackbar_validate_stock

  function do_ajax_form_product_snackbar_validate_stock_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "stock";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_stock_cb

  // ---------- Validate poriva
  function do_ajax_form_product_snackbar_validate_poriva()
  {
    var nomeCampo_poriva = "poriva";
    var var_poriva = scAjaxGetFieldText(nomeCampo_poriva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_poriva(var_poriva, var_script_case_init, do_ajax_form_product_snackbar_validate_poriva_cb);
  } // do_ajax_form_product_snackbar_validate_poriva

  function do_ajax_form_product_snackbar_validate_poriva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "poriva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_poriva_cb

  // ---------- Validate product_value
  function do_ajax_form_product_snackbar_validate_product_value()
  {
    var nomeCampo_product_value = "product_value";
    var var_product_value = scAjaxGetFieldText(nomeCampo_product_value);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_product_value(var_product_value, var_script_case_init, do_ajax_form_product_snackbar_validate_product_value_cb);
  } // do_ajax_form_product_snackbar_validate_product_value

  function do_ajax_form_product_snackbar_validate_product_value_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_product_value_cb

  // ---------- Validate discount
  function do_ajax_form_product_snackbar_validate_discount()
  {
    var nomeCampo_discount = "discount";
    var var_discount = scAjaxGetFieldText(nomeCampo_discount);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_discount(var_discount, var_script_case_init, do_ajax_form_product_snackbar_validate_discount_cb);
  } // do_ajax_form_product_snackbar_validate_discount

  function do_ajax_form_product_snackbar_validate_discount_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_discount_cb

  // ---------- Validate precioventa
  function do_ajax_form_product_snackbar_validate_precioventa()
  {
    var nomeCampo_precioventa = "precioventa";
    var var_precioventa = scAjaxGetFieldText(nomeCampo_precioventa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_precioventa(var_precioventa, var_script_case_init, do_ajax_form_product_snackbar_validate_precioventa_cb);
  } // do_ajax_form_product_snackbar_validate_precioventa

  function do_ajax_form_product_snackbar_validate_precioventa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_precioventa_cb

  // ---------- Validate puntoventa
  function do_ajax_form_product_snackbar_validate_puntoventa()
  {
    var nomeCampo_puntoventa = "puntoventa";
    var var_puntoventa = scAjaxGetFieldRadio(nomeCampo_puntoventa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_puntoventa(var_puntoventa, var_script_case_init, do_ajax_form_product_snackbar_validate_puntoventa_cb);
  } // do_ajax_form_product_snackbar_validate_puntoventa

  function do_ajax_form_product_snackbar_validate_puntoventa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_puntoventa_cb

  // ---------- Validate kiosko
  function do_ajax_form_product_snackbar_validate_kiosko()
  {
    var nomeCampo_kiosko = "kiosko";
    var var_kiosko = scAjaxGetFieldRadio(nomeCampo_kiosko);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_kiosko(var_kiosko, var_script_case_init, do_ajax_form_product_snackbar_validate_kiosko_cb);
  } // do_ajax_form_product_snackbar_validate_kiosko

  function do_ajax_form_product_snackbar_validate_kiosko_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "kiosko";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_kiosko_cb

  // ---------- Validate orden
  function do_ajax_form_product_snackbar_validate_orden()
  {
    var nomeCampo_orden = "orden";
    var var_orden = scAjaxGetFieldText(nomeCampo_orden);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_orden(var_orden, var_script_case_init, do_ajax_form_product_snackbar_validate_orden_cb);
  } // do_ajax_form_product_snackbar_validate_orden

  function do_ajax_form_product_snackbar_validate_orden_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "orden";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_orden_cb

  // ---------- Validate id_status
  function do_ajax_form_product_snackbar_validate_id_status()
  {
    var nomeCampo_id_status = "id_status";
    var var_id_status = scAjaxGetFieldSelect(nomeCampo_id_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_id_status(var_id_status, var_script_case_init, do_ajax_form_product_snackbar_validate_id_status_cb);
  } // do_ajax_form_product_snackbar_validate_id_status

  function do_ajax_form_product_snackbar_validate_id_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_id_status_cb

  // ---------- Validate cuentaventa
  function do_ajax_form_product_snackbar_validate_cuentaventa()
  {
    var nomeCampo_cuentaventa = "cuentaventa";
    var var_cuentaventa = scAjaxGetFieldSelect(nomeCampo_cuentaventa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_cuentaventa(var_cuentaventa, var_script_case_init, do_ajax_form_product_snackbar_validate_cuentaventa_cb);
  } // do_ajax_form_product_snackbar_validate_cuentaventa

  function do_ajax_form_product_snackbar_validate_cuentaventa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_cuentaventa_cb

  // ---------- Validate unidad
  function do_ajax_form_product_snackbar_validate_unidad()
  {
    var nomeCampo_unidad = "unidad";
    var var_unidad = scAjaxGetFieldText(nomeCampo_unidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_unidad(var_unidad, var_script_case_init, do_ajax_form_product_snackbar_validate_unidad_cb);
  } // do_ajax_form_product_snackbar_validate_unidad

  function do_ajax_form_product_snackbar_validate_unidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "unidad";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_unidad_cb

  // ---------- Validate cuentacompra
  function do_ajax_form_product_snackbar_validate_cuentacompra()
  {
    var nomeCampo_cuentacompra = "cuentacompra";
    var var_cuentacompra = scAjaxGetFieldText(nomeCampo_cuentacompra);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_cuentacompra(var_cuentacompra, var_script_case_init, do_ajax_form_product_snackbar_validate_cuentacompra_cb);
  } // do_ajax_form_product_snackbar_validate_cuentacompra

  function do_ajax_form_product_snackbar_validate_cuentacompra_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_cuentacompra_cb

  // ---------- Validate tipoitem
  function do_ajax_form_product_snackbar_validate_tipoitem()
  {
    var nomeCampo_tipoitem = "tipoitem";
    var var_tipoitem = scAjaxGetFieldText(nomeCampo_tipoitem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_tipoitem(var_tipoitem, var_script_case_init, do_ajax_form_product_snackbar_validate_tipoitem_cb);
  } // do_ajax_form_product_snackbar_validate_tipoitem

  function do_ajax_form_product_snackbar_validate_tipoitem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_tipoitem_cb

  // ---------- Validate image
  function do_ajax_form_product_snackbar_validate_image()
  {
    var nomeCampo_image = "image";
    var var_image = scAjaxGetFieldText(nomeCampo_image);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_image(var_image, var_script_case_init, do_ajax_form_product_snackbar_validate_image_cb);
  } // do_ajax_form_product_snackbar_validate_image

  function do_ajax_form_product_snackbar_validate_image_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "image";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_image_cb

  // ---------- Validate service
  function do_ajax_form_product_snackbar_validate_service()
  {
    var nomeCampo_service = "service";
    var var_service = scAjaxGetFieldRadio(nomeCampo_service);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_service(var_service, var_script_case_init, do_ajax_form_product_snackbar_validate_service_cb);
  } // do_ajax_form_product_snackbar_validate_service

  function do_ajax_form_product_snackbar_validate_service_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "service";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_service_cb

  // ---------- Validate jugador
  function do_ajax_form_product_snackbar_validate_jugador()
  {
    var nomeCampo_jugador = "jugador";
    var var_jugador = scAjaxGetFieldRadio(nomeCampo_jugador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_jugador(var_jugador, var_script_case_init, do_ajax_form_product_snackbar_validate_jugador_cb);
  } // do_ajax_form_product_snackbar_validate_jugador

  function do_ajax_form_product_snackbar_validate_jugador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jugador";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_jugador_cb

  // ---------- Validate entrada
  function do_ajax_form_product_snackbar_validate_entrada()
  {
    var nomeCampo_entrada = "entrada";
    var var_entrada = scAjaxGetFieldRadio(nomeCampo_entrada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_entrada(var_entrada, var_script_case_init, do_ajax_form_product_snackbar_validate_entrada_cb);
  } // do_ajax_form_product_snackbar_validate_entrada

  function do_ajax_form_product_snackbar_validate_entrada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "entrada";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_entrada_cb

  // ---------- Validate visitante
  function do_ajax_form_product_snackbar_validate_visitante()
  {
    var nomeCampo_visitante = "visitante";
    var var_visitante = scAjaxGetFieldRadio(nomeCampo_visitante);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_visitante(var_visitante, var_script_case_init, do_ajax_form_product_snackbar_validate_visitante_cb);
  } // do_ajax_form_product_snackbar_validate_visitante

  function do_ajax_form_product_snackbar_validate_visitante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_visitante_cb

  // ---------- Validate minutos
  function do_ajax_form_product_snackbar_validate_minutos()
  {
    var nomeCampo_minutos = "minutos";
    var var_minutos = scAjaxGetFieldText(nomeCampo_minutos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_minutos(var_minutos, var_script_case_init, do_ajax_form_product_snackbar_validate_minutos_cb);
  } // do_ajax_form_product_snackbar_validate_minutos

  function do_ajax_form_product_snackbar_validate_minutos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "minutos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_minutos_cb

  // ---------- Validate tarjeta
  function do_ajax_form_product_snackbar_validate_tarjeta()
  {
    var nomeCampo_tarjeta = "tarjeta";
    var var_tarjeta = scAjaxGetFieldRadio(nomeCampo_tarjeta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_tarjeta(var_tarjeta, var_script_case_init, do_ajax_form_product_snackbar_validate_tarjeta_cb);
  } // do_ajax_form_product_snackbar_validate_tarjeta

  function do_ajax_form_product_snackbar_validate_tarjeta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tarjeta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_tarjeta_cb

  // ---------- Validate tokens
  function do_ajax_form_product_snackbar_validate_tokens()
  {
    var nomeCampo_tokens = "tokens";
    var var_tokens = scAjaxGetFieldText(nomeCampo_tokens);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_tokens(var_tokens, var_script_case_init, do_ajax_form_product_snackbar_validate_tokens_cb);
  } // do_ajax_form_product_snackbar_validate_tokens

  function do_ajax_form_product_snackbar_validate_tokens_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tokens";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_tokens_cb

  // ---------- Validate comida
  function do_ajax_form_product_snackbar_validate_comida()
  {
    var nomeCampo_comida = "comida";
    var var_comida = scAjaxGetFieldRadio(nomeCampo_comida);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_comida(var_comida, var_script_case_init, do_ajax_form_product_snackbar_validate_comida_cb);
  } // do_ajax_form_product_snackbar_validate_comida

  function do_ajax_form_product_snackbar_validate_comida_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "comida";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_comida_cb

  // ---------- Validate score
  function do_ajax_form_product_snackbar_validate_score()
  {
    var nomeCampo_score = "score";
    var var_score = scAjaxGetFieldText(nomeCampo_score);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_score(var_score, var_script_case_init, do_ajax_form_product_snackbar_validate_score_cb);
  } // do_ajax_form_product_snackbar_validate_score

  function do_ajax_form_product_snackbar_validate_score_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "score";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_score_cb

  // ---------- Validate combos_recetas
  function do_ajax_form_product_snackbar_validate_combos_recetas()
  {
    var nomeCampo_combos_recetas = "combos_recetas";
    var var_combos_recetas = scAjaxGetFieldText(nomeCampo_combos_recetas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_product_snackbar_validate_combos_recetas(var_combos_recetas, var_script_case_init, do_ajax_form_product_snackbar_validate_combos_recetas_cb);
  } // do_ajax_form_product_snackbar_validate_combos_recetas

  function do_ajax_form_product_snackbar_validate_combos_recetas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_product_snackbar_validate_combos_recetas_cb

  // ---------- Event onclick precioventa
  function do_ajax_form_product_snackbar_event_precioventa_onclick()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_product_snackbar_event_precioventa_onclick(var_poriva, var_precioventa, var_product_value, var_script_case_init, do_ajax_form_product_snackbar_event_precioventa_onclick_cb);
  } // do_ajax_form_product_snackbar_event_precioventa_onclick

  function do_ajax_form_product_snackbar_event_precioventa_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "precioventa";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_product_snackbar_event_precioventa_onclick_cb_after_alert);
  } // do_ajax_form_product_snackbar_event_precioventa_onclick_cb
  function do_ajax_form_product_snackbar_event_precioventa_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_product_snackbar_event_precioventa_onclick_cb_after_alert

  // ---------- Event onclick product_value
  function do_ajax_form_product_snackbar_event_product_value_onclick()
  {
    var var_poriva = scAjaxGetFieldText("poriva");
    var var_precioventa = scAjaxGetFieldText("precioventa");
    var var_product_value = scAjaxGetFieldText("product_value");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_product_snackbar_event_product_value_onclick(var_poriva, var_precioventa, var_product_value, var_script_case_init, do_ajax_form_product_snackbar_event_product_value_onclick_cb);
  } // do_ajax_form_product_snackbar_event_product_value_onclick

  function do_ajax_form_product_snackbar_event_product_value_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "product_value";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_product_snackbar_event_product_value_onclick_cb_after_alert);
  } // do_ajax_form_product_snackbar_event_product_value_onclick_cb
  function do_ajax_form_product_snackbar_event_product_value_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_product_snackbar_event_product_value_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_product_snackbar_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_product_snackbar_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_product_snackbar_submit_form(var_product_name, var_id_category, var_product_code, var_dateproduct, var_product_cost, var_stock, var_poriva, var_product_value, var_discount, var_precioventa, var_puntoventa, var_kiosko, var_orden, var_id_status, var_cuentaventa, var_unidad, var_cuentacompra, var_tipoitem, var_image, var_service, var_jugador, var_entrada, var_visitante, var_minutos, var_tarjeta, var_tokens, var_comida, var_score, var_image_ul_name, var_image_ul_type, var_image_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_product_snackbar_submit_form_cb);
  } // do_ajax_form_product_snackbar_submit_form

  function do_ajax_form_product_snackbar_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_product_snackbar_submit_form_cb_after_alert);
  } // do_ajax_form_product_snackbar_submit_form_cb
  function do_ajax_form_product_snackbar_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_product_snackbar_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_product_combo"] = "off";

  function do_ajax_form_product_snackbar_navigate_form()
  {
    perform_ajax_form_product_snackbar_navigate_form();
  }

  function perform_ajax_form_product_snackbar_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_product_snackbar_navigate_form(var_id_product, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_product_snackbar_navigate_form_cb);
  } // do_ajax_form_product_snackbar_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_product_snackbar_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_product_snackbar_navigate_form_cb_after_alert);
  } // do_ajax_form_product_snackbar_navigate_form_cb
  function do_ajax_form_product_snackbar_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_product_snackbar_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_product_snackbar_navigate_form_cb_after_alert

  function sc_hide_form_product_snackbar_form()
  {
