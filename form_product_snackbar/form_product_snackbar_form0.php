...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("Productos"); } else { echo strip_tags("Productos"); } ?></TITLE>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_product_snackbar/form_product_snackbar_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_product_snackbar_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_product_snackbar_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['link_info']['remove_border']) {
...
<?php
 include_once("form_product_snackbar_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_product_snackbar'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_product_snackbar'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['copy']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['copy']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['copy']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['copy']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['copy'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } 
?> 
<?php $sStyleHidden_product_name_dumb = ('' == $sStyleHidden_product_name) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_product_name_dumb" style="<?php echo $sStyleHidden_product_name_dumb; ?>"></TD>
<?php $sStyleHidden_id_category_dumb = ('' == $sStyleHidden_id_category) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_id_category_dumb" style="<?php echo $sStyleHidden_id_category_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } 
?> 
<?php $sStyleHidden_product_code_dumb = ('' == $sStyleHidden_product_code) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_product_code_dumb" style="<?php echo $sStyleHidden_product_code_dumb; ?>"></TD>
<?php $sStyleHidden_dateproduct_dumb = ('' == $sStyleHidden_dateproduct) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_dateproduct_dumb" style="<?php echo $sStyleHidden_dateproduct_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } 
?> 
<?php $sStyleHidden_product_cost_dumb = ('' == $sStyleHidden_product_cost) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_product_cost_dumb" style="<?php echo $sStyleHidden_product_cost_dumb; ?>"></TD>
...
<?php } 
?> 
<?php $sStyleHidden_poriva_dumb = ('' == $sStyleHidden_poriva) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_poriva_dumb" style="<?php echo $sStyleHidden_poriva_dumb; ?>"></TD>
<?php $sStyleHidden_product_value_dumb = ('' == $sStyleHidden_product_value) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_product_value_dumb" style="<?php echo $sStyleHidden_product_value_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } 
?> 
<?php $sStyleHidden_discount_dumb = ('' == $sStyleHidden_discount) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_discount_dumb" style="<?php echo $sStyleHidden_discount_dumb; ?>"></TD>
<?php $sStyleHidden_precioventa_dumb = ('' == $sStyleHidden_precioventa) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_precioventa_dumb" style="<?php echo $sStyleHidden_precioventa_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_puntoventa'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_puntoventa'][] = '0'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_kiosko'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_kiosko'][] = '0'; ?>
...
<?php } 
?> 
<?php $sStyleHidden_puntoventa_dumb = ('' == $sStyleHidden_puntoventa) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_puntoventa_dumb" style="<?php echo $sStyleHidden_puntoventa_dumb; ?>"></TD>
<?php $sStyleHidden_kiosko_dumb = ('' == $sStyleHidden_kiosko) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_kiosko_dumb" style="<?php echo $sStyleHidden_kiosko_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $sStyleHidden_id_status_dumb = ('' == $sStyleHidden_id_status) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_id_status_dumb" style="<?php echo $sStyleHidden_id_status_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } 
?> 
<?php $sStyleHidden_cuentaventa_dumb = ('' == $sStyleHidden_cuentaventa) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_cuentaventa_dumb" style="<?php echo $sStyleHidden_cuentaventa_dumb; ?>"></TD>
<?php $sStyleHidden_unidad_dumb = ('' == $sStyleHidden_unidad) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_unidad_dumb" style="<?php echo $sStyleHidden_unidad_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<div id="id_sc_dragdrop_image" class="scFormDataDragNDrop"  style="<?php echo $sStyleReadInp_image ?>"><i class='fas fa-cloud-upload-alt'></i><br/>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_service'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_service'][] = '0'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_jugador'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_jugador'][] = '0'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_entrada'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_entrada'][] = '0'; ?>
...
<?php } 
?> 
<?php $sStyleHidden_service_dumb = ('' == $sStyleHidden_service) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_service_dumb" style="<?php echo $sStyleHidden_service_dumb; ?>"></TD>
<?php $sStyleHidden_jugador_dumb = ('' == $sStyleHidden_jugador) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_jugador_dumb" style="<?php echo $sStyleHidden_jugador_dumb; ?>"></TD>
<?php $sStyleHidden_entrada_dumb = ('' == $sStyleHidden_entrada) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_entrada_dumb" style="<?php echo $sStyleHidden_entrada_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_visitante'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_visitante'][] = '0'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_tarjeta'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_tarjeta'][] = '0'; ?>
...
<?php $sStyleHidden_minutos_dumb = ('' == $sStyleHidden_minutos) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_minutos_dumb" style="<?php echo $sStyleHidden_minutos_dumb; ?>"></TD>
<?php $sStyleHidden_tarjeta_dumb = ('' == $sStyleHidden_tarjeta) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_tarjeta_dumb" style="<?php echo $sStyleHidden_tarjeta_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_comida'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_comida'][] = '0'; ?>
...
<?php $sStyleHidden_tokens_dumb = ('' == $sStyleHidden_tokens) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_tokens_dumb" style="<?php echo $sStyleHidden_tokens_dumb; ?>"></TD>
<?php $sStyleHidden_comida_dumb = ('' == $sStyleHidden_comida) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_comida_dumb" style="<?php echo $sStyleHidden_comida_dumb; ?>"></TD>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Combos_Recetas'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Combos_Recetas'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Combos_Recetas'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['embutida_parms'] = "idprod*scin" . $this->nmgp_dados_form['id_product'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_snackbar']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_product_snackbar_empty.htm' : $this->Ini->link_form_product_combo_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=400';
if (isset($this->Ini->sc_lig_target['C_@scinf_Combos_Recetas']) && 'nmsc_iframe_liga_form_product_combo' != $this->Ini->sc_lig_target['C_@scinf_Combos_Recetas'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_Combos_Recetas'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_product_combo"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="400" width="100%" name="nmsc_iframe_liga_form_product_combo"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_product_snackbar");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_product_snackbar");
 parent.scAjaxDetailHeight("form_product_snackbar", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
