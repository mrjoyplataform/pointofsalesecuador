<?php
//
class form_product_snackbar_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_product_snackbar_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_product_snackbar']['upload_field_info']['image'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_product_snackbar',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_product_snackbar']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_product_snackbar'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_product_snackbar']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_product_snackbar']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_product_snackbar') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_product_snackbar']['label'] = "Productos";
      ...
      $_SESSION['scriptcase']['error_icon']['form_product_snackbar']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_product_snackbar'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['upload_field_ul_name'][$this->image_ul_name]))
          {
              $this->NM_ajax_info['param']['image_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['upload_field_ul_name'][$this->image_ul_name];
          }
      ...
      elseif (isset($this->image_ul_name) && '' != $this->image_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['upload_field_ul_name'][$this->image_ul_name]))
          {
              $this->image_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['upload_field_ul_name'][$this->image_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_product_snackbar']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_form_insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_product_snackbar'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_product_snackbar'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['insert'] != '')
      {
          ...
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['insert'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_product_snackbar", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_product_snackbar/form_product_snackbar_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_product_snackbar_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_product_snackbar_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_product_snackbar_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_product_snackbar/form_product_snackbar_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_product_snackbar_erro.class.php"); 
      }
      $this->Erro      = new form_product_snackbar_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['opcao']))
         { 
             if ($this->id_product != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_product_snackbar']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['total']);
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_product_snackbar.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_product_snackbar_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_product_snackbar"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_product_snackbar', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'form_product_snackbar', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'form_product_snackbar', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//---
    ...
    function ValidateField_product_name(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['php_cmp_required']['product_name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['php_cmp_required']['product_name'] == "on")) 
      { 
    ...
    function ValidateField_id_category(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->id_category == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['php_cmp_required']['id_category']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['php_cmp_required']['id_category'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->id_category) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_id_category']) && !in_array($this->id_category, $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_id_category']))
          {
              $hasError = true;
    ...
    function ValidateField_product_code(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['php_cmp_required']['product_code']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['php_cmp_required']['product_code'] == "on")) 
      { 
    ...
    function ValidateField_puntoventa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->puntoventa != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_puntoventa']) && !in_array($this->puntoventa, $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_puntoventa']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_kiosko(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->kiosko != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_kiosko']) && !in_array($this->kiosko, $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_kiosko']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_id_status(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_status) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_id_status']) && !in_array($this->id_status, $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_id_status']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_cuentaventa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->cuentaventa == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['php_cmp_required']['cuentaventa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['php_cmp_required']['cuentaventa'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->cuentaventa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_cuentaventa']) && !in_array($this->cuentaventa, $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_cuentaventa']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['cuentaventa']))
    ...
    function ValidateField_service(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->service != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_service']) && !in_array($this->service, $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_service']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_jugador(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->jugador != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_jugador']) && !in_array($this->jugador, $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_jugador']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_entrada(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->entrada != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_entrada']) && !in_array($this->entrada, $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_entrada']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_visitante(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->visitante != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_visitante']) && !in_array($this->visitante, $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_visitante']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_tarjeta(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->tarjeta != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_tarjeta']) && !in_array($this->tarjeta, $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_tarjeta']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_comida(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->comida != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_comida']) && !in_array($this->comida, $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_comida']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
//--------------------------------------------------------------------------------------
   function upload_img_doc(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros, $filtro = '') 
   {
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      if ($this->nmgp_opcao == "incluir" && $this->image == "" &&  $this->image_limpa != "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dados_clone']['image']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dados_clone']['image']))
      { 
          $this->image = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dados_clone']['image'];
      } 
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'form_product_snackbar_doc_name.php';
              }
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dados_form']['image']) && $this->image_limpa != "S")
          {
              $this->image = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dados_form']['image'];
          }
      } 
   }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_product']['keyVal'] = form_product_snackbar_pack_protect_string($this->nmgp_dados_form['id_product']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['foreign_key']['idproducto'] = $this->nmgp_dados_form['id_product'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['where_filter'] = "idproducto = " . $this->nmgp_dados_form['id_product'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['where_detal']  = "idproducto = " . $this->nmgp_dados_form['id_product'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['form_product_combo_script_case_init'] ]['form_product_combo']['total']);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_id_category']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_id_category'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_id_category']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_id_category'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_product_snackbar_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_product_snackbar_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_id_category'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_category']['valList'][$i] = form_product_snackbar_pack_protect_string($v);
          }
...
$aLookup[] = array(form_product_snackbar_pack_protect_string('1') => str_replace('<', '&lt;',form_product_snackbar_pack_protect_string("SI")));
$aLookup[] = array(form_product_snackbar_pack_protect_string('0') => str_replace('<', '&lt;',form_product_snackbar_pack_protect_string("NO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_puntoventa'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_puntoventa'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['puntoventa']['valList'][$i] = form_product_snackbar_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_product_snackbar_pack_protect_string('1') => str_replace('<', '&lt;',form_product_snackbar_pack_protect_string("SI")));
$aLookup[] = array(form_product_snackbar_pack_protect_string('0') => str_replace('<', '&lt;',form_product_snackbar_pack_protect_string("NO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_kiosko'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_kiosko'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['kiosko']['valList'][$i] = form_product_snackbar_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_id_status']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_id_status'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_id_status']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_id_status'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_id_status'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_status']['valList'][$i] = form_product_snackbar_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_cuentaventa']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_cuentaventa'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_cuentaventa']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_cuentaventa'] = array(); 
}
$aLookup[] = array(form_product_snackbar_pack_protect_string('') => str_replace('<', '&lt;',form_product_snackbar_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_cuentaventa'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_product_snackbar_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_product_snackbar_pack_protect_string(NM_charset_to_utf8($rs->fields[0] . " - " . $rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[0] . " - " . $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_cuentaventa'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['cuentaventa']['valList'][$i] = form_product_snackbar_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_product_snackbar_pack_protect_string('1') => str_replace('<', '&lt;',form_product_snackbar_pack_protect_string("SI")));
$aLookup[] = array(form_product_snackbar_pack_protect_string('0') => str_replace('<', '&lt;',form_product_snackbar_pack_protect_string("NO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_service'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_service'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['service']['valList'][$i] = form_product_snackbar_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_product_snackbar_pack_protect_string('1') => str_replace('<', '&lt;',form_product_snackbar_pack_protect_string("SI")));
$aLookup[] = array(form_product_snackbar_pack_protect_string('0') => str_replace('<', '&lt;',form_product_snackbar_pack_protect_string("NO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_jugador'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_jugador'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['jugador']['valList'][$i] = form_product_snackbar_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_product_snackbar_pack_protect_string('1') => str_replace('<', '&lt;',form_product_snackbar_pack_protect_string("SI")));
$aLookup[] = array(form_product_snackbar_pack_protect_string('0') => str_replace('<', '&lt;',form_product_snackbar_pack_protect_string("NO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_entrada'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_entrada'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['entrada']['valList'][$i] = form_product_snackbar_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_product_snackbar_pack_protect_string('1') => str_replace('<', '&lt;',form_product_snackbar_pack_protect_string("SI")));
$aLookup[] = array(form_product_snackbar_pack_protect_string('0') => str_replace('<', '&lt;',form_product_snackbar_pack_protect_string("NO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_visitante'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_visitante'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['visitante']['valList'][$i] = form_product_snackbar_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_product_snackbar_pack_protect_string('1') => str_replace('<', '&lt;',form_product_snackbar_pack_protect_string("SI")));
$aLookup[] = array(form_product_snackbar_pack_protect_string('0') => str_replace('<', '&lt;',form_product_snackbar_pack_protect_string("NO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_tarjeta'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_tarjeta'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['tarjeta']['valList'][$i] = form_product_snackbar_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_product_snackbar_pack_protect_string('1') => str_replace('<', '&lt;',form_product_snackbar_pack_protect_string("SI")));
$aLookup[] = array(form_product_snackbar_pack_protect_string('0') => str_replace('<', '&lt;',form_product_snackbar_pack_protect_string("NO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_comida'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['Lookup_comida'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['comida']['valList'][$i] = form_product_snackbar_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_combos_recetas($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao != "incluir")  
      {
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dados_clone']['image']);
      }
    ...
    if ("excluir" == $this->nmgp_opcao) {
      $this->sc_evento = $this->nmgp_opcao;
      $_SESSION['scriptcase']['form_product_snackbar']['contr_erro'] = 'on';
              /* loss_detail */
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      {
...
;
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_product_snackbar';
...
$_SESSION['scriptcase']['form_product_snackbar']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['image_salva'] = array(
                      'row'     => '',
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['parms'] = "id_product?#?$this->id_product?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_product_snackbar = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['total'] = $qt_geral_reg_form_product_snackbar;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id_product))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_product_snackbar = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_start'] > $qt_geral_reg_form_product_snackbar)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_start'] = $qt_geral_reg_form_product_snackbar; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_product_snackbar) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['empty_filter'] = true;
                  return; 
              }
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['parms'] = "id_product?#?$this->id_product?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['sub_dir'][0]  = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_start'] < $qt_geral_reg_form_product_snackbar;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dados_select'];
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dados_clone']['image'] = $this->nmgp_dados_select['image'];  
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dados_select'];
...
// 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
       ...
       if (isset($temp_out1_image))
       {
        ...
        $this->initFormPages();
    include_once("form_product_snackbar_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['table_refresh'])
        {
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_product_snackbar = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['total'] = $qt_geral_reg_form_product_snackbar;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_product_snackbar_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_product_snackbar_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_product_snackbar_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_product_snackbar']['ordem_ord'] == " desc") {
