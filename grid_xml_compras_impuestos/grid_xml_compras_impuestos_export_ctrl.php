<?php
@session_start() ;
$_SESSION['scriptcase']['grid_xml_compras_impuestos']['sc_process_barr'] = true;
require_once('../grid_xml_compras_impuestos/index.php');
unset($_SESSION['scriptcase']['grid_xml_compras_impuestos']['sc_process_barr']);
$ExportCtrl = new grid_xml_compras_impuestos_export_control;
$ExportCtrl->Export_barr();

class grid_xml_compras_impuestos_export_control
{
