  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_supplier_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_supplier_mob_form();
	}
...
?>
  ...
  // ---------- Validate idproveedor
  function do_ajax_form_supplier_mob_validate_idproveedor()
  {
    var nomeCampo_idproveedor = "idproveedor";
    var var_idproveedor = scAjaxGetFieldText(nomeCampo_idproveedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_supplier_mob_validate_idproveedor(var_idproveedor, var_script_case_init, do_ajax_form_supplier_mob_validate_idproveedor_cb);
  } // do_ajax_form_supplier_mob_validate_idproveedor

  function do_ajax_form_supplier_mob_validate_idproveedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idproveedor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_supplier_mob_validate_idproveedor_cb

  // ---------- Validate supplier_name
  function do_ajax_form_supplier_mob_validate_supplier_name()
  {
    var nomeCampo_supplier_name = "supplier_name";
    var var_supplier_name = scAjaxGetFieldText(nomeCampo_supplier_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_supplier_mob_validate_supplier_name(var_supplier_name, var_script_case_init, do_ajax_form_supplier_mob_validate_supplier_name_cb);
  } // do_ajax_form_supplier_mob_validate_supplier_name

  function do_ajax_form_supplier_mob_validate_supplier_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "supplier_name";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_supplier_mob_validate_supplier_name_cb

  // ---------- Validate address
  function do_ajax_form_supplier_mob_validate_address()
  {
    var nomeCampo_address = "address";
    var var_address = scAjaxGetFieldText(nomeCampo_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_supplier_mob_validate_address(var_address, var_script_case_init, do_ajax_form_supplier_mob_validate_address_cb);
  } // do_ajax_form_supplier_mob_validate_address

  function do_ajax_form_supplier_mob_validate_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "address";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_supplier_mob_validate_address_cb

  // ---------- Validate telephone
  function do_ajax_form_supplier_mob_validate_telephone()
  {
    var nomeCampo_telephone = "telephone";
    var var_telephone = scAjaxGetFieldText(nomeCampo_telephone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_supplier_mob_validate_telephone(var_telephone, var_script_case_init, do_ajax_form_supplier_mob_validate_telephone_cb);
  } // do_ajax_form_supplier_mob_validate_telephone

  function do_ajax_form_supplier_mob_validate_telephone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "telephone";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_supplier_mob_validate_telephone_cb

  // ---------- Validate contact
  function do_ajax_form_supplier_mob_validate_contact()
  {
    var nomeCampo_contact = "contact";
    var var_contact = scAjaxGetFieldText(nomeCampo_contact);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_supplier_mob_validate_contact(var_contact, var_script_case_init, do_ajax_form_supplier_mob_validate_contact_cb);
  } // do_ajax_form_supplier_mob_validate_contact

  function do_ajax_form_supplier_mob_validate_contact_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "contact";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_supplier_mob_validate_contact_cb

  // ---------- Validate email
  function do_ajax_form_supplier_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_supplier_mob_validate_email(var_email, var_script_case_init, do_ajax_form_supplier_mob_validate_email_cb);
  } // do_ajax_form_supplier_mob_validate_email

  function do_ajax_form_supplier_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_supplier_mob_validate_email_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_supplier_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_supplier_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idproveedor = scAjaxGetFieldText("idproveedor");
    var var_supplier_name = scAjaxGetFieldText("supplier_name");
    var var_address = scAjaxGetFieldText("address");
    var var_telephone = scAjaxGetFieldText("telephone");
    var var_contact = scAjaxGetFieldText("contact");
    var var_email = scAjaxGetFieldText("email");
    var var_id_supplier = scAjaxGetFieldText("id_supplier");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_supplier_mob_submit_form(var_idproveedor, var_supplier_name, var_address, var_telephone, var_contact, var_email, var_id_supplier, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_supplier_mob_submit_form_cb);
  } // do_ajax_form_supplier_mob_submit_form

  function do_ajax_form_supplier_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idproveedor");
      scAjaxHideErrorDisplay("supplier_name");
      scAjaxHideErrorDisplay("address");
      scAjaxHideErrorDisplay("telephone");
      scAjaxHideErrorDisplay("contact");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_supplier_mob_submit_form_cb_after_alert);
  } // do_ajax_form_supplier_mob_submit_form_cb
  function do_ajax_form_supplier_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_supplier_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_supplier_mob_navigate_form()
  {
    perform_ajax_form_supplier_mob_navigate_form();
  }

  function perform_ajax_form_supplier_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("contact");
    scAjaxHideErrorDisplay("email");
    var var_id_supplier = document.F2.id_supplier.value;
    ...
    scAjaxProcOn();
    x_ajax_form_supplier_mob_navigate_form(var_id_supplier, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_supplier_mob_navigate_form_cb);
  } // do_ajax_form_supplier_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_supplier_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_supplier_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_supplier.value = scAjaxGetKeyValue("id_supplier");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_supplier_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_supplier_mob_navigate_form_cb
  function do_ajax_form_supplier_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_supplier_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_supplier_mob_navigate_form_cb_after_alert

  function sc_hide_form_supplier_mob_form()
  {
  ...
  ajax_field_list[0] = "idproveedor";
  ajax_field_list[1] = "supplier_name";
  ajax_field_list[2] = "address";
  ajax_field_list[3] = "telephone";
  ajax_field_list[4] = "contact";
  ...
  var ajax_error_list = {
    "idproveedor": {"label": "Idproveedor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "supplier_name": {"label": "<?php echo $this->Ini->Nm_lang['lang_supplier_fld_supplier_name'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "address": {"label": "<?php echo $this->Ini->Nm_lang['lang_supplier_fld_address'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "telephone": {"label": "<?php echo $this->Ini->Nm_lang['lang_supplier_fld_telephone'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "contact": {"label": "<?php echo $this->Ini->Nm_lang['lang_supplier_fld_contact'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "email": {"label": "<?php echo $this->Ini->Nm_lang['lang_supplier_fld_email'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "idproveedor": new Array(),
    "supplier_name": new Array(),
    "address": new Array(),
    "telephone": new Array(),
    "contact": new Array(),
    "email": new Array()
  };
  ajax_field_mult["idproveedor"][1] = "idproveedor";
  ajax_field_mult["supplier_name"][1] = "supplier_name";
  ajax_field_mult["address"][1] = "address";
  ajax_field_mult["telephone"][1] = "telephone";
  ajax_field_mult["contact"][1] = "contact";
  ajax_field_mult["email"][1] = "email";

  var ajax_field_id = {
    "idproveedor": new Array("hidden_field_label_idproveedor", "hidden_field_data_idproveedor"),
    "supplier_name": new Array("hidden_field_label_supplier_name", "hidden_field_data_supplier_name"),
    "address": new Array("hidden_field_label_address", "hidden_field_data_address"),
    "telephone": new Array("hidden_field_label_telephone", "hidden_field_data_telephone"),
    "contact": new Array("hidden_field_label_contact", "hidden_field_data_contact"),
