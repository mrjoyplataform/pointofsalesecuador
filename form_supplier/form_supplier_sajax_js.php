  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_supplier" == sTestField)
        {
...
?>
  ...
  function do_ajax_form_supplier_validate_idproveedor()
  {
    var nomeCampo_idproveedor = "idproveedor";
    var var_idproveedor = scAjaxGetFieldText(nomeCampo_idproveedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_supplier_validate_idproveedor(var_idproveedor, var_script_case_init, do_ajax_form_supplier_validate_idproveedor_cb);
  } // do_ajax_form_supplier_validate_idproveedor

  function do_ajax_form_supplier_validate_idproveedor_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_supplier_validate_idproveedor_cb

  // ---------- Validate supplier_name
  function do_ajax_form_supplier_validate_supplier_name()
  {
    var nomeCampo_supplier_name = "supplier_name";
    var var_supplier_name = scAjaxGetFieldText(nomeCampo_supplier_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_supplier_validate_supplier_name(var_supplier_name, var_script_case_init, do_ajax_form_supplier_validate_supplier_name_cb);
  } // do_ajax_form_supplier_validate_supplier_name

  function do_ajax_form_supplier_validate_supplier_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_supplier_validate_supplier_name_cb

  // ---------- Validate address
  function do_ajax_form_supplier_validate_address()
  {
    var nomeCampo_address = "address";
    var var_address = scAjaxGetFieldText(nomeCampo_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_supplier_validate_address(var_address, var_script_case_init, do_ajax_form_supplier_validate_address_cb);
  } // do_ajax_form_supplier_validate_address

  function do_ajax_form_supplier_validate_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "address";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_supplier_validate_address_cb

  // ---------- Validate telephone
  function do_ajax_form_supplier_validate_telephone()
  {
    var nomeCampo_telephone = "telephone";
    var var_telephone = scAjaxGetFieldText(nomeCampo_telephone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_supplier_validate_telephone(var_telephone, var_script_case_init, do_ajax_form_supplier_validate_telephone_cb);
  } // do_ajax_form_supplier_validate_telephone

  function do_ajax_form_supplier_validate_telephone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_supplier_validate_telephone_cb

  // ---------- Validate contact
  function do_ajax_form_supplier_validate_contact()
  {
    var nomeCampo_contact = "contact";
    var var_contact = scAjaxGetFieldText(nomeCampo_contact);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_supplier_validate_contact(var_contact, var_script_case_init, do_ajax_form_supplier_validate_contact_cb);
  } // do_ajax_form_supplier_validate_contact

  function do_ajax_form_supplier_validate_contact_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "contact";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_supplier_validate_contact_cb

  // ---------- Validate email
  function do_ajax_form_supplier_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_supplier_validate_email(var_email, var_script_case_init, do_ajax_form_supplier_validate_email_cb);
  } // do_ajax_form_supplier_validate_email

  function do_ajax_form_supplier_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_supplier_validate_email_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_supplier_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_supplier_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_supplier_submit_form(var_idproveedor, var_supplier_name, var_address, var_telephone, var_contact, var_email, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_supplier_submit_form_cb);
  } // do_ajax_form_supplier_submit_form

  function do_ajax_form_supplier_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_supplier_submit_form_cb_after_alert);
  } // do_ajax_form_supplier_submit_form_cb
  function do_ajax_form_supplier_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_supplier_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_supplier_navigate_form()
  {
    perform_ajax_form_supplier_navigate_form();
  }

  function perform_ajax_form_supplier_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_supplier_navigate_form(var_id_supplier, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_supplier_navigate_form_cb);
  } // do_ajax_form_supplier_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_supplier']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_supplier_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_supplier_navigate_form_cb_after_alert);
  } // do_ajax_form_supplier_navigate_form_cb
  function do_ajax_form_supplier_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_supplier_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_supplier_navigate_form_cb_after_alert

  function sc_hide_form_supplier_form()
  {
