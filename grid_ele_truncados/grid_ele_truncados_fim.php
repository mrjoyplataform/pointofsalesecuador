...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_ele_truncados"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_ele_truncados"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_ele_truncados'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ele_truncados']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_ele_truncados']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ele_truncados']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_ele_truncados']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_ele_truncados']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_ele_truncados</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_ele_truncados']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_ele_truncados']['embutida_filho'] as $ind => $sc_init)
          {
