  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_point_of_sale_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_point_of_sale_mob_form();
	}
...
?>
  ...
  // ---------- Validate qty
  function do_ajax_point_of_sale_mob_validate_qty()
  {
    var nomeCampo_qty = "qty";
    var var_qty = scAjaxGetFieldText(nomeCampo_qty);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_point_of_sale_mob_validate_qty(var_qty, var_script_case_init, do_ajax_point_of_sale_mob_validate_qty_cb);
  } // do_ajax_point_of_sale_mob_validate_qty

  function do_ajax_point_of_sale_mob_validate_qty_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_point_of_sale_mob_validate_qty_cb

  // ---------- Validate product
  function do_ajax_point_of_sale_mob_validate_product()
  {
  } // do_ajax_point_of_sale_mob_validate_product

  function do_ajax_point_of_sale_mob_validate_product_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "product";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_point_of_sale_mob_validate_product_cb

  // ---------- Validate lbl_product
  function do_ajax_point_of_sale_mob_validate_lbl_product()
  {
  } // do_ajax_point_of_sale_mob_validate_lbl_product

  function do_ajax_point_of_sale_mob_validate_lbl_product_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lbl_product";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_point_of_sale_mob_validate_lbl_product_cb

  // ---------- Validate p_img
  function do_ajax_point_of_sale_mob_validate_p_img()
  {
  } // do_ajax_point_of_sale_mob_validate_p_img

  function do_ajax_point_of_sale_mob_validate_p_img_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "p_img";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_point_of_sale_mob_validate_p_img_cb

  // ---------- Validate ord_value
  function do_ajax_point_of_sale_mob_validate_ord_value()
  {
    var nomeCampo_ord_value = "ord_value";
    var var_ord_value = scAjaxGetFieldText(nomeCampo_ord_value);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_point_of_sale_mob_validate_ord_value(var_ord_value, var_script_case_init, do_ajax_point_of_sale_mob_validate_ord_value_cb);
  } // do_ajax_point_of_sale_mob_validate_ord_value

  function do_ajax_point_of_sale_mob_validate_ord_value_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ord_value";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_point_of_sale_mob_validate_ord_value_cb

  // ---------- Validate ord_discount
  function do_ajax_point_of_sale_mob_validate_ord_discount()
  {
    var nomeCampo_ord_discount = "ord_discount";
    var var_ord_discount = scAjaxGetFieldText(nomeCampo_ord_discount);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_point_of_sale_mob_validate_ord_discount(var_ord_discount, var_script_case_init, do_ajax_point_of_sale_mob_validate_ord_discount_cb);
  } // do_ajax_point_of_sale_mob_validate_ord_discount

  function do_ajax_point_of_sale_mob_validate_ord_discount_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ord_discount";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_point_of_sale_mob_validate_ord_discount_cb

  // ---------- Validate total
  function do_ajax_point_of_sale_mob_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldText(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_point_of_sale_mob_validate_total(var_total, var_script_case_init, do_ajax_point_of_sale_mob_validate_total_cb);
  } // do_ajax_point_of_sale_mob_validate_total

  function do_ajax_point_of_sale_mob_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_point_of_sale_mob_validate_total_cb

  // ---------- Event onchange product
  function do_ajax_point_of_sale_mob_event_product_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_point_of_sale_mob_event_product_onchange(var_script_case_init, do_ajax_point_of_sale_mob_event_product_onchange_cb);
  } // do_ajax_point_of_sale_mob_event_product_onchange

  function do_ajax_point_of_sale_mob_event_product_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "product";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_point_of_sale_mob_event_product_onchange_cb_after_alert);
  } // do_ajax_point_of_sale_mob_event_product_onchange_cb
  function do_ajax_point_of_sale_mob_event_product_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_point_of_sale_mob_event_product_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_point_of_sale_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_point_of_sale_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_qty = scAjaxGetFieldText("qty");
    var var_product = scAjaxGetFieldText("product");
    var var_lbl_product = scAjaxGetFieldHidden("lbl_product");
    var var_p_img = scAjaxGetFieldHidden("p_img");
    var var_ord_value = scAjaxGetFieldText("ord_value");
    var var_ord_discount = scAjaxGetFieldText("ord_discount");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_point_of_sale_mob_submit_form(var_qty, var_product, var_lbl_product, var_p_img, var_ord_value, var_ord_discount, var_total, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_point_of_sale_mob_submit_form_cb);
  } // do_ajax_point_of_sale_mob_submit_form

  function do_ajax_point_of_sale_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_point_of_sale_mob_submit_form_cb_after_alert);
  } // do_ajax_point_of_sale_mob_submit_form_cb
  function do_ajax_point_of_sale_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_point_of_sale_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_point_of_sale_mob_navigate_form()
  {
    perform_ajax_point_of_sale_mob_navigate_form();
  }

  function perform_ajax_point_of_sale_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_point_of_sale_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_point_of_sale_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_point_of_sale_mob_navigate_form_cb_after_alert);
  } // do_ajax_point_of_sale_mob_navigate_form_cb
  function do_ajax_point_of_sale_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_point_of_sale_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_point_of_sale_mob_navigate_form_cb_after_alert

  function sc_hide_point_of_sale_mob_form()
  {
  ...
  ajax_field_list[0] = "qty";
  ajax_field_list[1] = "product";
  ajax_field_list[2] = "lbl_product";
  ajax_field_list[3] = "p_img";
  ajax_field_list[4] = "ord_value";
  ajax_field_list[5] = "ord_discount";
  ...
  var ajax_error_list = {
    "qty": {"label": "<?php echo $this->Ini->Nm_lang['lang_sales_detail_fld_quantity'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "product": {"label": "<?php echo $this->Ini->Nm_lang['lang_product_fld_product_code'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lbl_product": {"label": "<?php echo $this->Ini->Nm_lang['lang_last_inserted'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "p_img": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ord_value": {"label": "<?php echo $this->Ini->Nm_lang['lang_sales_fld_sales_price'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ord_discount": {"label": "<?php echo $this->Ini->Nm_lang['lang_sales_fld_sales_discount'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "qty": new Array(),
    "product": new Array(),
    "lbl_product": new Array(),
    "p_img": new Array(),
    "ord_value": new Array(),
    "ord_discount": new Array(),
    "total": new Array()
  };
  ajax_field_mult["qty"][1] = "qty";
  ajax_field_mult["product"][1] = "product";
  ajax_field_mult["lbl_product"][1] = "lbl_product";
  ajax_field_mult["p_img"][1] = "p_img";
  ajax_field_mult["ord_value"][1] = "ord_value";
  ajax_field_mult["ord_discount"][1] = "ord_discount";
  ajax_field_mult["total"][1] = "total";

  var ajax_field_id = {
    "qty": new Array("hidden_field_label_qty", "hidden_field_data_qty"),
    "product": new Array("hidden_field_label_product", "hidden_field_data_product"),
    "lbl_product": new Array("hidden_field_label_lbl_product", "hidden_field_data_lbl_product"),
    "p_img": new Array("hidden_field_label_p_img", "hidden_field_data_p_img"),
    "ord_value": new Array("hidden_field_label_ord_value", "hidden_field_data_ord_value"),
    "ord_discount": new Array("hidden_field_label_ord_discount", "hidden_field_data_ord_discount"),
