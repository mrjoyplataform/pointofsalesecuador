...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>point_of_sale/point_of_sale_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('point_of_sale_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-product", elem).on("focus", function() {
   ...
   change: function (event, ui) {
    ...
    if ("" == $(this).val()) {
     do_ajax_point_of_sale_event_product_onchange(sRow);
    }
   },
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['link_info']['remove_border']) {
...
<?php
 include_once("point_of_sale_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['point_of_sale'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['point_of_sale'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['empty_filter'] = true;
       }
  }
?>
...
<?php } 
?> 
<?php $sStyleHidden_qty_dumb = ('' == $sStyleHidden_qty) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_qty_dumb" style="<?php echo $sStyleHidden_qty_dumb; ?>"></TD>
<?php $sStyleHidden_product_dumb = ('' == $sStyleHidden_product) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_product_dumb" style="<?php echo $sStyleHidden_product_dumb; ?>"></TD>
...
<?php $sStyleHidden_lbl_product_dumb = ('' == $sStyleHidden_lbl_product) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_lbl_product_dumb" style="<?php echo $sStyleHidden_lbl_product_dumb; ?>"></TD>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['btn_disabled']['ok']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['btn_disabled']['ok']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['btn_label']['ok']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['btn_label']['ok']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['btn_label']['ok'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['btn_disabled']['pay']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['btn_disabled']['pay']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['btn_label']['pay']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['btn_label']['pay']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['btn_label']['pay'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "pay", "scBtnFn_pay()", "scBtnFn_pay()", "sc_pay_bot", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
...
?>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("point_of_sale");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("point_of_sale");
 parent.scAjaxDetailHeight("point_of_sale", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['point_of_sale']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
