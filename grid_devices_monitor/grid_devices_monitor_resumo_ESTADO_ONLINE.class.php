...
class grid_devices_monitor_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_estado_online;
   var $array_total_cod_grupo;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_estado_online = array();
      $this->array_total_cod_grupo     = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_devices_monitor']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_devices_monitor']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['contr_total_geral'] == "OK")
      {
          $this->array_total_estado_online = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['arr_total']['estado_online'];
          $this->array_total_cod_grupo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['arr_total']['cod_grupo'];
      }
      else
      {
          $this->array_total_estado_online = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['arr_total']['estado_online'] = $this->array_total_estado_online;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['arr_total']['cod_grupo'] = $this->array_total_cod_grupo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['json_use_label'])
       {
          $Lab_estado_online = "ESTADO_ONLINE";
          $Lab_cod_grupo = "cod_grupo";
       }
       else
       {
       $Lab_estado_online = "ESTADO ONLINE";
       $Lab_cod_grupo = "Grupo";
       }
       $this->comp_field = array(
           $Lab_estado_online,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['cod_device']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['cod_device'] = "Cod Device"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['device_name']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['device_name'] = "Device Name"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['ult_rfid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['ult_rfid'] = "Ult Rfid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['ult_fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['ult_fecha'] = "Ult Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['estado'] = "Estado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['segundos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['segundos'] = "Segundos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['estado_online']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['estado_online'] = "ESTADO ONLINE"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['cod_activo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['cod_activo'] = "Cod Activo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['cod_grupo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['cod_grupo'] = "Cod Grupo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['activa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['activa'] = "Activa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['valor_default']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['valor_default'] = "Valor Default"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['acepta_tiempo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['acepta_tiempo'] = "Acepta Tiempo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['acepta_tokens']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['acepta_tokens'] = "Acepta Tokens"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['dev_ip']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['dev_ip'] = "Dev Ip"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['tipo_dev']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['tipo_dev'] = "Tipo Dev"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['direccion_torno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['direccion_torno'] = "Direccion Torno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['timeout_rfid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['timeout_rfid'] = "Timeout Rfid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['discapacitado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['discapacitado'] = "Discapacitado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['numcaja']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['numcaja'] = "Numcaja"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['empleado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['empleado'] = "Empleado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['tokens']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['tokens'] = "Tokens"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['serialrfid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['serialrfid'] = "Serialrfid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['bidireccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['bidireccion'] = "Bidireccion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['cod_devicee']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['cod_devicee'] = "Cod Device E"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['url_1']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['url_1'] = "Url 1"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['url_2']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['url_2'] = "Url 2"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['url_3']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['labels']['url_3'] = "Url 3"; 
       }
       //-----
       $this->comp_field_nm = array(
           'estado_online' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['summarizing_fields_order']['ESTADO_ONLINE']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['summarizing_fields_order']['ESTADO_ONLINE'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['summarizing_fields_order']['ESTADO_ONLINE'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['summarizing_fields_display']['ESTADO_ONLINE'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['summarizing_fields_display']['ESTADO_ONLINE'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['summarizing_fields_display']['ESTADO_ONLINE'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['summarizing_fields_display']['ESTADO_ONLINE'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['summarizing_fields_display']['ESTADO_ONLINE'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['summarizing_fields_display']['ESTADO_ONLINE'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['summarizing_fields_display']['ESTADO_ONLINE'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_estado_online as $i_estado_online => $d_estado_online) {
           if (!in_array($i_estado_online, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_estado_online[3] ] = $d_estado_online[2];
               $this->comp_label[0][ $d_estado_online[3] ] = $d_estado_online[2];
           }
           foreach ($this->array_total_cod_grupo[$i_estado_online] as $i_cod_grupo => $d_cod_grupo) {
               if (!in_array($i_cod_grupo, $this->comp_label[1][ $d_estado_online[3] ], true)) {
                   $this->comp_index[1][ $d_cod_grupo[3] ] = $d_cod_grupo[2];
                   $this->comp_label[1][ $d_estado_online[3] ][ $d_cod_grupo[3] ] = $d_cod_grupo[2];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'estado_online', 'prot' => '@aspass@'),
           array('name' => 'cod_grupo', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_estado_online => $l_estado_online) {
           if (isset($this->array_total_estado_online[$i_estado_online])) {
               $this->comp_group[$i_estado_online] = array();
           }
           foreach ($this->comp_label[1][$i_estado_online] as $i_cod_grupo => $l_cod_grupo) {
               if (isset($this->array_total_cod_grupo[$i_estado_online][$i_cod_grupo])) {
                   $this->comp_group[$i_estado_online][$i_cod_grupo] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_estado_online;
       }
       elseif (1 == $level) {
           $return = $this->array_total_cod_grupo;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_devices_monitor@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'ESTADO_ONLINE',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_estado_online)),
           ...
           '1|1' => array(
               ...
               'field_x'  => 'cod_grupo',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_cod_grupo)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           'T|1' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_devices_monitor_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_devices_monitor_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_devices_monitor_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_ESTADO_ONLINE("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_estado_online);
      ksort($this->array_total_cod_grupo);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " devices</TITLE>\r\n");
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_devices_monitor/grid_devices_monitor_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_devices_monitor_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_devices_monitor_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_devices_monitor_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['num_css'] . '.css');
     ...
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['embutida'])
      {
         ...
         $NM_btn  = false;
         $NM_Gbtn = false;
      if ($this->nmgp_botoes['reload'] == 'on' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['opc_psq'] && !$this->grid_emb_form)
      {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_devices_monitor/grid_devices_monitor_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_devices_monitor&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_devices_monitor/grid_devices_monitor_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_devices_monitor/grid_devices_monitor_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_devices_monitor/grid_devices_monitor_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_devices_monitor/grid_devices_monitor_config_graf_flash.php?nome_apl=grid_devices_monitor&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_devices_monitor_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rpdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['pdf'][] = "Rpdf_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_devices_monitor/grid_devices_monitor_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_devices_monitor&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xml'][] = "Rxml_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_devices_monitor/grid_devices_monitor_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rcsv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['csv'][] = "Rcsv_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_devices_monitor/grid_devices_monitor_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_devices_monitor']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_devices_monitor']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_devices_monitor_config_pivot.php?nome_apl=grid_devices_monitor&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_devices_monitor_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_devices_monitor/grid_devices_monitor_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_monitor']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $cod_device = $Busca_temp['cod_device']; 
          $tmp_pos = strpos($cod_device, "##@@");
          if ($tmp_pos !== false && !is_array($cod_device))
          {
              $cod_device = substr($cod_device, 0, $tmp_pos);
          }
          $cod_activo = $Busca_temp['cod_activo']; 
          $tmp_pos = strpos($cod_activo, "##@@");
          if ($tmp_pos !== false && !is_array($cod_activo))
          {
              $cod_activo = substr($cod_activo, 0, $tmp_pos);
          }
          $cod_grupo = $Busca_temp['cod_grupo']; 
          $tmp_pos = strpos($cod_grupo, "##@@");
          if ($tmp_pos !== false && !is_array($cod_grupo))
          {
              $cod_grupo = substr($cod_grupo, 0, $tmp_pos);
          }
      } 
   ...
   //---- 
   function adiciona_registro($quebra_estado_online, $quebra_cod_grupo, $quebra_estado_online_orig, $quebra_cod_grupo_orig)
   {
      //----- ESTADO ONLINE
      if (!isset($this->array_total_estado_online[$quebra_estado_online_orig]))
      {
         $this->array_total_estado_online[$quebra_estado_online_orig][0] = 1;
         $this->array_total_estado_online[$quebra_estado_online_orig][1] = 1;
         $this->array_total_estado_online[$quebra_estado_online_orig][2] = $quebra_estado_online;
         $this->array_total_estado_online[$quebra_estado_online_orig][3] = $quebra_estado_online_orig;
      }
      else
      {
         $this->array_total_estado_online[$quebra_estado_online_orig][0]++;
         $this->array_total_estado_online[$quebra_estado_online_orig][2]++;
      }
      //----- Cod Grupo
      if (!isset($this->array_total_cod_grupo[$quebra_estado_online_orig][$quebra_cod_grupo_orig]))
      {
         $this->array_total_cod_grupo[$quebra_estado_online_orig][$quebra_cod_grupo_orig][0] = 1;
         $this->array_total_cod_grupo[$quebra_estado_online_orig][$quebra_cod_grupo_orig][1] = 1;
         $this->array_total_cod_grupo[$quebra_estado_online_orig][$quebra_cod_grupo_orig][2] = $quebra_cod_grupo;
         $this->array_total_cod_grupo[$quebra_estado_online_orig][$quebra_cod_grupo_orig][3] = $quebra_cod_grupo_orig;
      }
      else
      {
         $this->array_total_cod_grupo[$quebra_estado_online_orig][$quebra_cod_grupo_orig][0]++;
         $this->array_total_cod_grupo[$quebra_estado_online_orig][$quebra_cod_grupo_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'estado_online');
     $campos_order = $this->Ini->Get_date_order_groupby("ESTADO_ONLINE", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'cod_grupo');
     $campos_order = $this->Ini->Get_date_order_groupby("cod_grupo", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->cod_device = $rs_res->fields[0] ;  
            $this->device_name = $rs_res->fields[1] ;  
            $this->ult_rfid = $rs_res->fields[2] ;  
            $this->ult_fecha = $rs_res->fields[3] ;  
            $this->estado = $rs_res->fields[4] ;  
            $this->segundos = $rs_res->fields[5] ;  
            $this->estado_online = $rs_res->fields[6] ;  
            $this->cod_activo = $rs_res->fields[7] ;  
            $this->cod_grupo = $rs_res->fields[8] ;  
            $this->activa = $rs_res->fields[9] ;  
            $this->valor_default = $rs_res->fields[10] ;  
            $this->valor_default =  str_replace(",", ".", $this->valor_default);
            $this->acepta_tiempo = $rs_res->fields[11] ;  
            $this->acepta_tokens = $rs_res->fields[12] ;  
            $this->dev_ip = $rs_res->fields[13] ;  
            $this->tipo_dev = $rs_res->fields[14] ;  
            $this->direccion_torno = $rs_res->fields[15] ;  
            $this->timeout_rfid = $rs_res->fields[16] ;  
            $this->discapacitado = $rs_res->fields[17] ;  
            $this->numcaja = $rs_res->fields[18] ;  
            $this->empleado = $rs_res->fields[19] ;  
            $this->tokens = $rs_res->fields[20] ;  
            $this->tokens =  str_replace(",", ".", $this->tokens);
            $this->serialrfid = $rs_res->fields[21] ;  
            $this->bidireccion = $rs_res->fields[22] ;  
            $this->cod_devicee = $rs_res->fields[23] ;  
            $this->url_1 = $rs_res->fields[24] ;  
            $this->url_2 = $rs_res->fields[25] ;  
            $this->url_3 = $rs_res->fields[26] ;  
            $this->estado_online_orig = $this->estado_online;
            $this->cod_grupo_orig = $this->cod_grupo;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->estado_online, $this->cod_grupo, $this->estado_online_orig,  $this->cod_grupo_orig);
            }
   }
//
