...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cod_device_cond" name="cod_device_cond" onChange="nm_campos_between(document.getElementById('id_vis_cod_device'), this, 'cod_device')">
      ...
      <br><span id="id_hide_cod_device"  <?php echo $str_hide_cod_device?>><INPUT  type="text" id="SC_cod_device" name="cod_device" value="<?php echo NM_encode_input($cod_device) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_cod_activo_cond" name="cod_activo_cond" onChange="nm_campos_between(document.getElementById('id_vis_cod_activo'), this, 'cod_activo')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cod_grupo_cond" name="cod_grupo_cond" onChange="nm_campos_between(document.getElementById('id_vis_cod_grupo'), this, 'cod_grupo')">
