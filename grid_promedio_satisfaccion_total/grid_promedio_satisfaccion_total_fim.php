...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_promedio_satisfaccion_total"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_promedio_satisfaccion_total"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_promedio_satisfaccion_total']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_promedio_satisfaccion_total']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_promedio_satisfaccion_total']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_promedio_satisfaccion_total']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_promedio_satisfaccion_total']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_promedio_satisfaccion_total</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_promedio_satisfaccion_total']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_promedio_satisfaccion_total']['embutida_filho'] as $ind => $sc_init)
          {
