...
class grid_promedio_satisfaccion_total_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_promedio_satisfaccion_total']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_promedio_satisfaccion_total']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $idproducto, $promedio_califica;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), avg(cantidad), avg(promedio_califica) from (SELECT *,(select imagen from boletos_califica where valor=promedio_califica) as califica FROM view_boletos_califca ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['where_pesq']; 
      } 
      else 
      { 
          $nm_comando = "select count(*), avg(cantidad), avg(promedio_califica) from (SELECT *,(select imagen from boletos_califica where valor=promedio_califica) as califica FROM view_boletos_califca ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['tot_geral'][2] = $rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $rt->fields[2] = (string)$rt->fields[2]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['tot_geral'][3] = $rt->fields[2]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['contr_total_geral'] = "OK";
   } 
   ...
   function quebra_geral_califica($res_limit=false)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*) from (SELECT *,(select imagen from boletos_califica where valor=promedio_califica) as califica FROM view_boletos_califca ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['where_pesq']; 
      } 
      else 
      { 
          $nm_comando = "select count(*) from (SELECT *,(select imagen from boletos_califica where valor=promedio_califica) as califica FROM view_boletos_califca ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['where_pesq']; 
   ...
   function quebra_fecha_sc_free_group_by($fecha, $Where_qb, $Cmp_Name) 
   {
      ...
      global $$Var_name_gb, $idproducto, $promedio_califica;
      $tot_fecha = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), avg(cantidad), avg(promedio_califica) from (SELECT *,(select imagen from boletos_califica where valor=promedio_califica) as califica FROM view_boletos_califca ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['where_pesq']; 
   ...
   //-----  idproducto
   function quebra_idproducto_califica($idproducto, $arg_sum_idproducto) 
   {
      global $tot_idproducto, $idproducto, $promedio_califica;
      $tot_idproducto = array() ;  
      $tot_idproducto[0] = $idproducto ; 
   }

   //----- 
   function Calc_resumo_sc_free_group_by($destino_resumo)
   {
      global $nm_lang, $idproducto, $promedio_califica;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('fecha' => "fecha",'idproducto' => "idproducto");
      $cmps_quebra_atual = array();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['SC_Gb_Free_cmp'] as $cmp => $resto)
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_sc_free_group_by($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $cmp_sql_tp_num = array('idproducto' => 'N','promedio_califica' => 'N','cantidad' => 'N');
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
         $cmd_simp = "select count(*), avg(cantidad), avg(promedio_califica)#@#cmps_quebras#@# from (SELECT *,(select imagen from boletos_califica where valor=promedio_califica) as califica FROM view_boletos_califca ) sc_sel_esp " . $where_ok;
         $comando  = "select count(*), avg(SC_metric1), avg(SC_metric2)#@#cmps_quebras#@# from (";
         $comando .= "select cantidad as SC_metric1,promedio_califica as SC_metric2, " . $cmps_quebras1 . " from (SELECT *,(select imagen from boletos_califica where valor=promedio_califica) as califica FROM view_boletos_califca ) sc_sel_esp1 " . $where_ok . ") SC_sel1 INNER JOIN (";
         $comando .= "select " . $cmps_quebras2 . " from (SELECT *,(select imagen from boletos_califica where valor=promedio_califica) as califica FROM view_boletos_califca ) sc_sel_esp2 " . $where_ok . " group by " . $group . $sc_having . ") SC_sel2 ";
         $comando .= " ON " . $join;
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
   ...
   function Calc_resumo_califica($destino_resumo)
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['where_pesq'];
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('idproducto' => "idproducto");
      $cmps_quebra_atual = array("idproducto");
      $ult_cmp_quebra_atual = $cmps_quebra_atual[(count($cmps_quebra_atual) - 1)];
      $arr_tots = "";
      $join     = "";
      $group    = "";
   ...
   function Res_Totaliza_califica($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
         $cmd_simp = "select count(*)#@#cmps_quebras#@# from (SELECT *,(select imagen from boletos_califica where valor=promedio_califica) as califica FROM view_boletos_califca ) sc_sel_esp " . $where_ok;
         $comando  = "select count(*)#@#cmps_quebras#@# from (";
         $comando .= "select " . $cmps_quebras1 . " from (SELECT *,(select imagen from boletos_califica where valor=promedio_califica) as califica FROM view_boletos_califca ) sc_sel_esp1 " . $where_ok . ") SC_sel1 INNER JOIN (";
         $comando .= "select " . $cmps_quebras2 . " from (SELECT *,(select imagen from boletos_califica where valor=promedio_califica) as califica FROM view_boletos_califca ) sc_sel_esp2 " . $where_ok . " group by " . $group . $sc_having . ") SC_sel2 ";
         $comando .= " ON " . $join;
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
