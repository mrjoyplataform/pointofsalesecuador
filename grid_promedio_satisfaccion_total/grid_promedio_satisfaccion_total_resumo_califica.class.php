...
class grid_promedio_satisfaccion_total_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_idproducto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['arr_total']['idproducto'];
      }
      else
      {
          $this->array_total_idproducto = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['summarizing_fields_order']['califica']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['summarizing_fields_order']['califica'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['summarizing_fields_order']['califica'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['summarizing_fields_display']['califica'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['summarizing_fields_display']['califica'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['summarizing_fields_display']['califica'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['summarizing_fields_display']['califica'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['summarizing_fields_display']['califica'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['summarizing_fields_display']['califica'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['summarizing_fields_display']['califica'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_idproducto as $i_idproducto => $d_idproducto) {
           if (!in_array($i_idproducto, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_idproducto[2] ] = $d_idproducto[1];
               $this->comp_label[0][ $d_idproducto[2] ] = $d_idproducto[1];
           }
       }
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion_total']['pivot_order_level'] = -1;
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_idproducto => $l_idproducto) {
           if (isset($this->array_total_idproducto[$i_idproducto])) {
               $this->comp_group[$i_idproducto] = array();
           }
       }
...
{ 
   ...
   //---- 
   function adiciona_registro($quebra_idproducto, $quebra_idproducto_orig)
   {
      //----- Idproducto
      if (!isset($this->array_total_idproducto[$quebra_idproducto_orig]))
      {
         $this->array_total_idproducto[$quebra_idproducto_orig][0] = 1;
         $this->array_total_idproducto[$quebra_idproducto_orig][1] = $quebra_idproducto;
         $this->array_total_idproducto[$quebra_idproducto_orig][2] = $quebra_idproducto_orig;
      }
      else
      {
         $this->array_total_idproducto[$quebra_idproducto_orig][0]++;
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->idproducto, $this->idproducto_orig);
            }
   }
//
