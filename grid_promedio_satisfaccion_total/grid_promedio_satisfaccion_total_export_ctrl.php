<?php
@session_start() ;
$_SESSION['scriptcase']['grid_promedio_satisfaccion_total']['sc_process_barr'] = true;
require_once('../grid_promedio_satisfaccion_total/index.php');
unset($_SESSION['scriptcase']['grid_promedio_satisfaccion_total']['sc_process_barr']);
$ExportCtrl = new grid_promedio_satisfaccion_total_export_control;
$ExportCtrl->Export_barr();

class grid_promedio_satisfaccion_total_export_control
{
