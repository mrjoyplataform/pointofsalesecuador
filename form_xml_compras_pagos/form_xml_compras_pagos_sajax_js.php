  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_xml_compras_pagos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_xml_compras_pagos_form();
	}
...
?>
  ...
  // ---------- Validate idlinea_
  function do_ajax_form_xml_compras_pagos_validate_idlinea_(iNumLinha)
  {
    var nomeCampo_idlinea_ = "idlinea_" + iNumLinha;
    var var_idlinea_ = scAjaxGetFieldText(nomeCampo_idlinea_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_pagos_validate_idlinea_(var_idlinea_, iNumLinha, var_script_case_init, do_ajax_form_xml_compras_pagos_validate_idlinea__cb);
  } // do_ajax_form_xml_compras_pagos_validate_idlinea_

  function do_ajax_form_xml_compras_pagos_validate_idlinea__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_pagos_validate_idlinea__cb

  // ---------- Validate claveacceso_
  function do_ajax_form_xml_compras_pagos_validate_claveacceso_(iNumLinha)
  {
    var nomeCampo_claveacceso_ = "claveacceso_" + iNumLinha;
    var var_claveacceso_ = scAjaxGetFieldText(nomeCampo_claveacceso_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_pagos_validate_claveacceso_(var_claveacceso_, iNumLinha, var_script_case_init, do_ajax_form_xml_compras_pagos_validate_claveacceso__cb);
  } // do_ajax_form_xml_compras_pagos_validate_claveacceso_

  function do_ajax_form_xml_compras_pagos_validate_claveacceso__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_pagos_validate_claveacceso__cb

  // ---------- Validate formapago_
  function do_ajax_form_xml_compras_pagos_validate_formapago_(iNumLinha)
  {
    var nomeCampo_formapago_ = "formapago_" + iNumLinha;
    var var_formapago_ = scAjaxGetFieldText(nomeCampo_formapago_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_pagos_validate_formapago_(var_formapago_, iNumLinha, var_script_case_init, do_ajax_form_xml_compras_pagos_validate_formapago__cb);
  } // do_ajax_form_xml_compras_pagos_validate_formapago_

  function do_ajax_form_xml_compras_pagos_validate_formapago__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "formapago_" + iLineNumber;
    }
    else
    {
      sFieldValid = "formapago_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "formapago_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "formapago_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_pagos_validate_formapago__cb

  // ---------- Validate total_
  function do_ajax_form_xml_compras_pagos_validate_total_(iNumLinha)
  {
    var nomeCampo_total_ = "total_" + iNumLinha;
    var var_total_ = scAjaxGetFieldText(nomeCampo_total_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_pagos_validate_total_(var_total_, iNumLinha, var_script_case_init, do_ajax_form_xml_compras_pagos_validate_total__cb);
  } // do_ajax_form_xml_compras_pagos_validate_total_

  function do_ajax_form_xml_compras_pagos_validate_total__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_pagos_validate_total__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_xml_compras_pagos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_xml_compras_pagos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_xml_compras_pagos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_xml_compras_pagos_add_new_line_cb);
  } // do_ajax_form_xml_compras_pagos_add_new_line

  function do_ajax_form_xml_compras_pagos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_xml_compras_pagos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_xml_compras_pagos_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_pagos_backup_line(var_idlinea_, var_claveacceso_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_xml_compras_pagos_backup_line_cb);
  } // do_ajax_form_xml_compras_pagos_backup_line

  function do_ajax_form_xml_compras_pagos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_xml_compras_pagos_backup_line_cb

  function do_ajax_form_xml_compras_pagos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_xml_compras_pagos_cancel_insert

  function do_ajax_form_xml_compras_pagos_cancel_update(iSeqVert)
  {
    do_ajax_form_xml_compras_pagos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_xml_compras_pagos_cancel_update

  function do_ajax_form_xml_compras_pagos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_xml_compras_pagos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_xml_compras_pagos_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_xml_compras_pagos_table_refresh(var_idlinea_, var_claveacceso_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_xml_compras_pagos_table_refresh_cb);
  } //  do_ajax_form_xml_compras_pagos_table_refresh

  function do_ajax_form_xml_compras_pagos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_xml_compras_pagos_table_refresh_cb_after_alert);
  } // do_ajax_form_xml_compras_pagos_table_refresh_cb
  function do_ajax_form_xml_compras_pagos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_xml_compras_pagos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_xml_compras_pagos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_xml_compras_pagos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_idlinea_ = scAjaxGetFieldText("idlinea_" + iNumLinha);
    var var_claveacceso_ = scAjaxGetFieldText("claveacceso_" + iNumLinha);
    var var_formapago_ = scAjaxGetFieldText("formapago_" + iNumLinha);
...
?>
    x_ajax_form_xml_compras_pagos_submit_form(var_idlinea_, var_claveacceso_, var_formapago_, var_total_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_xml_compras_pagos_submit_form_cb);
  } // do_ajax_form_xml_compras_pagos_submit_form

  function do_ajax_form_xml_compras_pagos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("formapago_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_xml_compras_pagos_submit_form_cb_after_alert);
  } // do_ajax_form_xml_compras_pagos_submit_form_cb
  function do_ajax_form_xml_compras_pagos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_xml_compras_pagos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_xml_compras_pagos_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_xml_compras_pagos_navigate_form, function() {});
    } else {
      perform_ajax_form_xml_compras_pagos_navigate_form();
    }
  }

  function perform_ajax_form_xml_compras_pagos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_xml_compras_pagos_cancel_insert(sc_form_xml_compras_pagos_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("formapago_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_xml_compras_pagos_navigate_form(var_idlinea_, var_claveacceso_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_xml_compras_pagos_navigate_form_cb);
  } // do_ajax_form_xml_compras_pagos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_pagos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_xml_compras_pagos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_xml_compras_pagos_navigate_form_cb_after_alert);
  } // do_ajax_form_xml_compras_pagos_navigate_form_cb
  function do_ajax_form_xml_compras_pagos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_xml_compras_pagos_navigate_form_cb_after_alert

    function sc_form_xml_compras_pagos_get_last_line_number()
    {
    ...
    } //sc_form_xml_compras_pagos_get_last_line_number

  function sc_hide_form_xml_compras_pagos_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "formapago_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["formapago_" + iNumLinha] = {"label": "Forma Pago<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["formapago_"][iNumLinha] = "formapago_" + iNumLinha;
    ...
    ajax_field_id["formapago_" + iNumLinha] = new Array("hidden_field_label_formapago_", "hidden_field_data_formapago_" + iNumLinha);
    ...
    ajax_error_count["formapago_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["formapago_" + iNumLinha] = "off";
...
?>
    ajax_read_only["idlinea_" + iNumLinha] = "on";
    ajax_read_only["claveacceso_" + iNumLinha] = "on";
    ajax_read_only["formapago_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["formapago_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["formapago_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["formapago_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["formapago_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["formapago_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["formapago_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['formapago_'])) ? $this->nmgp_cmp_readonly['formapago_'] : 'off';
?>
    scAjaxFieldRead("formapago_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("formapago_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idlinea_" + iRow] || "on" == ajax_error_count["claveacceso_" + iRow] || "on" == ajax_error_count["formapago_" + iRow] || "on" == ajax_error_count["total_" + iRow]))
    {
      ...
      $("#hidden_field_data_formapago_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idlinea_" + iRow] && "off" == ajax_error_count["claveacceso_" + iRow] && "off" == ajax_error_count["formapago_" + iRow] && "off" == ajax_error_count["total_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idlinea_" + iRow] = "off";
        ajax_error_count["claveacceso_" + iRow] = "off";
        ajax_error_count["formapago_" + iRow] = "off";
      ...
      $("#hidden_field_data_formapago_" + iRow).removeClass("scFormErrorLine");
