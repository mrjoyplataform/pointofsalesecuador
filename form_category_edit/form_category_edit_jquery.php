...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["category_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["category_" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_category_' + iSeqRow).bind('blur', function() { sc_form_category_edit_id_category__onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_category_edit_id_category__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_category_edit_id_category__onfocus(this, iSeqRow) });
  $('#id_sc_field_category_' + iSeqRow).bind('blur', function() { sc_form_category_edit_category__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_category_edit_category__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_category_edit_category__onfocus(this, iSeqRow) });
  $('#id_sc_field_image_' + iSeqRow).bind('blur', function() { sc_form_category_edit_image__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_category_edit_image__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_category_edit_image__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_category_edit_id_category__onblur(oThis, iSeqRow) {
  do_ajax_form_category_edit_validate_id_category_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_category_edit_id_category__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_category_edit_id_category__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_category_edit_category__onblur(oThis, iSeqRow) {
  do_ajax_form_category_edit_validate_category_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_category_edit_category__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_category_edit_category__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_category_edit_image__onblur(oThis, iSeqRow) {
  scCssBlur(oThis, iSeqRow);
}

function sc_form_category_edit_image__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_category_edit_image__onfocus(oThis, iSeqRow) {
  scCssFocus(oThis, iSeqRow);
}
...
function scHidePage(pageNo) {
	$("#id_form_category_edit_form" + pageNo).hide();
}
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_image_" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_category_edit_ul_save.php",
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_category_edit')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
