  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_category_edit" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_category_edit_form();
	}
...
?>
  ...
  function do_ajax_form_category_edit_validate_id_category_(iNumLinha)
  {
    ...
    x_ajax_form_category_edit_validate_id_category_(var_id_category_, iNumLinha, var_script_case_init, do_ajax_form_category_edit_validate_id_category__cb);
  } // do_ajax_form_category_edit_validate_id_category_

  function do_ajax_form_category_edit_validate_id_category__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_category_edit_validate_id_category__cb

  // ---------- Validate category_
  function do_ajax_form_category_edit_validate_category_(iNumLinha)
  {
    var nomeCampo_category_ = "category_" + iNumLinha;
    var var_category_ = scAjaxGetFieldText(nomeCampo_category_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_category_edit_validate_category_(var_category_, iNumLinha, var_script_case_init, do_ajax_form_category_edit_validate_category__cb);
  } // do_ajax_form_category_edit_validate_category_

  function do_ajax_form_category_edit_validate_category__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "category_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "category_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_category_edit_validate_category__cb

  // ---------- Validate image_
  function do_ajax_form_category_edit_validate_image_(iNumLinha)
  {
    var nomeCampo_image_ = "image_" + iNumLinha;
    var var_image_ = scAjaxGetFieldText(nomeCampo_image_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_category_edit_validate_image_(var_image_, iNumLinha, var_script_case_init, do_ajax_form_category_edit_validate_image__cb);
  } // do_ajax_form_category_edit_validate_image_

  function do_ajax_form_category_edit_validate_image__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_category_edit_validate_image__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_category_edit_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_category_edit_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_category_edit_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_category_edit_add_new_line_cb);
  } // do_ajax_form_category_edit_add_new_line

  function do_ajax_form_category_edit_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_category_edit_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_category_edit_backup_line(iNumLinha)
  {
    var var_id_category_ = scAjaxGetFieldHidden("id_category_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_category_edit_backup_line(var_id_category_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_category_edit_backup_line_cb);
  } // do_ajax_form_category_edit_backup_line

  function do_ajax_form_category_edit_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_category_edit_backup_line_cb

  function do_ajax_form_category_edit_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_category_edit_cancel_insert

  function do_ajax_form_category_edit_cancel_update(iSeqVert)
  {
    do_ajax_form_category_edit_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_category_edit_cancel_update

  function do_ajax_form_category_edit_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_category_edit_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_category_edit_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_category_edit_table_refresh(var_id_category_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_category_edit_table_refresh_cb);
  } //  do_ajax_form_category_edit_table_refresh

  function do_ajax_form_category_edit_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_category_edit_table_refresh_cb_after_alert);
  } // do_ajax_form_category_edit_table_refresh_cb
  function do_ajax_form_category_edit_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_category_edit_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_category_edit_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_category_edit_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_category_edit_submit_form(var_id_category_, var_category_, var_image_, var_image__ul_name, var_image__ul_type, var_image__limpa, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_category_edit_submit_form_cb);
  } // do_ajax_form_category_edit_submit_form

  function do_ajax_form_category_edit_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("category_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_category_edit_submit_form_cb_after_alert);
  } // do_ajax_form_category_edit_submit_form_cb
  function do_ajax_form_category_edit_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_category_edit_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_category_edit_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_category_edit_navigate_form, function() {});
    } else {
      perform_ajax_form_category_edit_navigate_form();
    }
  }

  function perform_ajax_form_category_edit_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_category_edit_cancel_insert(sc_form_category_edit_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("category_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_category_edit_navigate_form(var_id_category_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_category_edit_navigate_form_cb);
  } // do_ajax_form_category_edit_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_category_edit']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_category_edit_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_category_edit_navigate_form_cb_after_alert);
  } // do_ajax_form_category_edit_navigate_form_cb
  function do_ajax_form_category_edit_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_category_edit_navigate_form_cb_after_alert

    function sc_form_category_edit_get_last_line_number()
    {
    ...
    } //sc_form_category_edit_get_last_line_number

  function sc_hide_form_category_edit_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_error_list["id_category_" + iNumLinha] = {"label": "Id Category<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["category_" + iNumLinha] = {"label": "Category<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["image_" + iNumLinha] = {"label": "Image<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_category_" + iRow] || "on" == ajax_error_count["category_" + iRow] || "on" == ajax_error_count["image_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_category_" + iRow] && "off" == ajax_error_count["category_" + iRow] && "off" == ajax_error_count["image_" + iRow]))
    {
      if (bErrorRow)
      {
