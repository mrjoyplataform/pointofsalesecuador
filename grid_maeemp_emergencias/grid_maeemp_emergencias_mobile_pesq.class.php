...
<HTML>
<HEAD>
 <TITLE> maeemp_emergencias</TITLE>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_tipo_parentesco_cond" name="tipo_parentesco_cond" onChange="nm_campos_between(document.getElementById('id_vis_tipo_parentesco'), this, 'tipo_parentesco')">
      ...
      <br><span id="id_hide_tipo_parentesco"  <?php echo $str_hide_tipo_parentesco?>><?php
      if ($tipo_parentesco != "")
      {
      $tipo_parentesco_look = substr($this->Db->qstr($tipo_parentesco), 1, -1); 
      $nmgp_def_dados = array(); 
