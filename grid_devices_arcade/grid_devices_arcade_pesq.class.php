...
class grid_devices_arcade_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_devices_arcade_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_devices_arcade_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_devices_arcade_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_typereader')
      {
          $typereader = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_typereader($typereader);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_cod_activo')
      {
          $cod_activo = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_cod_activo($cod_activo);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_cod_grupo')
      {
          $cod_grupo = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_cod_grupo($cod_grupo);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "ult_fecha";$Nm_datas[] = "ult_fecha";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> devices</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_devices_arcade/grid_devices_arcade_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_devices_arcade_ajax_search.js"></script>
 <script type="text/javascript" src="grid_devices_arcade_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_devices_arcade_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_devices_arcade']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_devices_arcade']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_typereader_cond#NMF#' + search_get_sel_txt('SC_typereader_cond') + '@NMF@';
  str_out += 'SC_typereader#NMF#' + search_get_text('SC_typereader') + '@NMF@';
  str_out += 'id_ac_typereader#NMF#' + search_get_text('id_ac_typereader') + '@NMF@';
  str_out += 'SC_cod_device_cond#NMF#' + search_get_sel_txt('SC_cod_device_cond') + '@NMF@';
  str_out += 'SC_cod_device#NMF#' + search_get_text('SC_cod_device') + '@NMF@';
  str_out += 'SC_cod_activo_cond#NMF#' + search_get_sel_txt('SC_cod_activo_cond') + '@NMF@';
  str_out += 'SC_cod_activo#NMF#' + search_get_text('SC_cod_activo') + '@NMF@';
  str_out += 'id_ac_cod_activo#NMF#' + search_get_text('id_ac_cod_activo') + '@NMF@';
  str_out += 'SC_cod_grupo_cond#NMF#' + search_get_sel_txt('SC_cod_grupo_cond') + '@NMF@';
  str_out += 'SC_cod_grupo#NMF#' + search_get_text('SC_cod_grupo') + '@NMF@';
  str_out += 'id_ac_cod_grupo#NMF#' + search_get_text('id_ac_cod_grupo') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_cod_activo").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_cod_activo").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_cod_activo",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_cod_activo").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_cod_activo").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_cod_grupo").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_cod_grupo").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_cod_grupo",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_cod_grupo").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_cod_grupo").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_typereader").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_typereader").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_typereader",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_typereader").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $typereader_cond, $typereader, $typereader_autocomp,
             $cod_device_cond, $cod_device,
             $cod_activo_cond, $cod_activo, $cod_activo_autocomp,
             $cod_grupo_cond, $cod_grupo, $cod_grupo_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $typereader = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']['typereader']; 
          $typereader_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']['typereader_cond']; 
          $cod_device = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']['cod_device']; 
          $cod_device_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']['cod_device_cond']; 
          $cod_activo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']['cod_activo']; 
          $cod_activo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']['cod_activo_cond']; 
          $cod_grupo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']['cod_grupo']; 
          $cod_grupo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']['cod_grupo_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']['NM_operador']; 
          if (strtoupper($cod_device_cond) != "II" && strtoupper($cod_device_cond) != "QP" && strtoupper($cod_device_cond) != "NP" && strtoupper($cod_device_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($cod_device, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($typereader_cond) || empty($typereader_cond))
      {
         $typereader_cond = "qp";
      }
      if (!isset($cod_device_cond) || empty($cod_device_cond))
      {
         $cod_device_cond = "gt";
      }
      if (!isset($cod_activo_cond) || empty($cod_activo_cond))
      {
         $cod_activo_cond = "qp";
      }
      if (!isset($cod_grupo_cond) || empty($cod_grupo_cond))
      {
         $cod_grupo_cond = "qp";
      }
      ...
      $str_hide_typereader = (in_array($typereader_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cod_device = (in_array($cod_device_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cod_activo = (in_array($cod_activo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cod_grupo = (in_array($cod_grupo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($typereader) || $typereader == "")
      {
          $typereader = "";
      }
      if (isset($typereader) && !empty($typereader))
      {
         $tmp_pos = strpos($typereader, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $typereader = substr($typereader, 0, $tmp_pos);
         }
      }
      if (!isset($cod_device) || $cod_device == "")
      {
          $cod_device = "";
      }
      if (isset($cod_device) && !empty($cod_device))
      {
      ...
      if (!isset($cod_activo) || $cod_activo == "")
      {
          $cod_activo = "";
      }
      if (isset($cod_activo) && !empty($cod_activo))
      {
      ...
      if (!isset($cod_grupo) || $cod_grupo == "")
      {
          $cod_grupo = "";
      }
      if (isset($cod_grupo) && !empty($cod_grupo))
      {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_typereader_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['typereader'])) ? $this->New_label['typereader'] : "Typereader"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_typereader_cond" name="typereader_cond" onChange="nm_campos_between(document.getElementById('id_vis_typereader'), this, 'typereader')">
       <OPTION value="qp" <?php if ("qp" == $typereader_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $typereader_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $typereader_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $typereader_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_typereader" <?php echo $str_hide_typereader?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['typereader'])) ? $this->New_label['typereader'] : "Typereader";
 $nmgp_tab_label .= "typereader?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $typereader;
      }
?>
<INPUT  type="text" id="SC_typereader" name="typereader" value="<?php echo NM_encode_input($typereader) ?>"  size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_typereader" name="typereader_autocomp" size="45"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_cod_device_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['cod_device'])) ? $this->New_label['cod_device'] : "Cod Device"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_cod_device_cond" name="cod_device_cond" onChange="nm_campos_between(document.getElementById('id_vis_cod_device'), this, 'cod_device')">
       <OPTION value="gt" <?php if ("gt" == $cod_device_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $cod_device_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cod_device_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cod_device" <?php echo $str_hide_cod_device?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['cod_device'])) ? $this->New_label['cod_device'] : "Cod Device";
 $nmgp_tab_label .= "cod_device?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_cod_device" name="cod_device" value="<?php echo NM_encode_input($cod_device) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_cod_activo_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['cod_activo'])) ? $this->New_label['cod_activo'] : "Cod Activo"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_cod_activo_cond" name="cod_activo_cond" onChange="nm_campos_between(document.getElementById('id_vis_cod_activo'), this, 'cod_activo')">
       <OPTION value="qp" <?php if ("qp" == $cod_activo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $cod_activo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cod_activo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $cod_activo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cod_activo" <?php echo $str_hide_cod_activo?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['cod_activo'])) ? $this->New_label['cod_activo'] : "Cod Activo";
 $nmgp_tab_label .= "cod_activo?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $cod_activo;
      }
?>
<INPUT  type="text" id="SC_cod_activo" name="cod_activo" value="<?php echo NM_encode_input($cod_activo) ?>"  size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cod_activo" name="cod_activo_autocomp" size="45"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_cod_grupo_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['cod_grupo'])) ? $this->New_label['cod_grupo'] : "Cod Grupo"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_cod_grupo_cond" name="cod_grupo_cond" onChange="nm_campos_between(document.getElementById('id_vis_cod_grupo'), this, 'cod_grupo')">
       <OPTION value="qp" <?php if ("qp" == $cod_grupo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $cod_grupo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cod_grupo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $cod_grupo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cod_grupo" <?php echo $str_hide_cod_grupo?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['cod_grupo'])) ? $this->New_label['cod_grupo'] : "Cod Grupo";
 $nmgp_tab_label .= "cod_grupo?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $cod_grupo;
      }
?>
<INPUT  type="text" id="SC_cod_grupo" name="cod_grupo" value="<?php echo NM_encode_input($cod_grupo) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cod_grupo" name="cod_grupo_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_devices_arcade_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_devices_arcade']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_devices_arcade']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.typereader_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_typereader'), document.F1.typereader_cond, 'typereader');
   document.F1.typereader.value = "";
   document.F1.typereader_autocomp.value = "";
   document.F1.cod_device_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_cod_device'), document.F1.cod_device_cond, 'cod_device');
   document.F1.cod_device.value = "";
   document.F1.cod_activo_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_cod_activo'), document.F1.cod_activo_cond, 'cod_activo');
   document.F1.cod_activo.value = "";
   document.F1.cod_activo_autocomp.value = "";
   document.F1.cod_grupo_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_cod_grupo'), document.F1.cod_grupo_cond, 'cod_grupo');
   document.F1.cod_grupo.value = "";
   document.F1.cod_grupo_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_typereader_cond'] = 'cond';
      $tp_fields['SC_typereader'] = 'text_aut';
      $tp_fields['id_ac_typereader'] = 'text_aut';
      $tp_fields['SC_cod_device_cond'] = 'cond';
      $tp_fields['SC_cod_device'] = 'text';
      $tp_fields['SC_cod_activo_cond'] = 'cond';
      $tp_fields['SC_cod_activo'] = 'text_aut';
      $tp_fields['id_ac_cod_activo'] = 'text_aut';
      $tp_fields['SC_cod_grupo_cond'] = 'cond';
      $tp_fields['SC_cod_grupo'] = 'text_aut';
      $tp_fields['id_ac_cod_grupo'] = 'text_aut';
   ...
   {
      global $typereader_cond, $typereader, $typereader_autocomp,
             $cod_device_cond, $cod_device,
             $cod_activo_cond, $cod_activo, $cod_activo_autocomp,
             $cod_grupo_cond, $cod_grupo, $cod_grupo_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($typereader_autocomp) && empty($typereader))
      {
          $typereader = $typereader_autocomp;
      }
      if (!empty($cod_activo_autocomp) && empty($cod_activo))
      {
          $cod_activo = $cod_activo_autocomp;
      }
      if (!empty($cod_grupo_autocomp) && empty($cod_grupo))
      {
          $cod_grupo = $cod_grupo_autocomp;
      }
      $typereader_cond_salva = $typereader_cond; 
      if (!isset($typereader_input_2) || $typereader_input_2 == "")
      {
          $typereader_input_2 = $typereader;
      }
      $cod_device_cond_salva = $cod_device_cond; 
      if (!isset($cod_device_input_2) || $cod_device_input_2 == "")
      {
          $cod_device_input_2 = $cod_device;
      }
      $cod_activo_cond_salva = $cod_activo_cond; 
      if (!isset($cod_activo_input_2) || $cod_activo_input_2 == "")
      {
          $cod_activo_input_2 = $cod_activo;
      }
      $cod_grupo_cond_salva = $cod_grupo_cond; 
      if (!isset($cod_grupo_input_2) || $cod_grupo_input_2 == "")
      {
          $cod_grupo_input_2 = $cod_grupo;
      }
      if ($cod_device_cond != "in")
      {
          nm_limpa_numero($cod_device, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']['typereader'] = $typereader; 
      if (is_array($typereader) && !empty($typereader))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['Grid_search'][$I_Grid]['val'][0] = $typereader;
      }
      elseif ($typereader_cond_salva == "nu" || $typereader_cond_salva == "nn" || $typereader_cond_salva == "ep" || $typereader_cond_salva == "ne" || !empty($typereader))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['Grid_search'][$I_Grid]['val'][0][0] = $typereader;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']['typereader_cond'] = $typereader_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['Grid_search'][$I_Grid]['cmp'] = "typereader"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['Grid_search'][$I_Grid]['opc'] = $typereader_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq']['typereader'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']['cod_device'] = $cod_device; 
      if (is_array($cod_device) && !empty($cod_device))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['Grid_search'][$I_Grid]['val'][0] = $cod_device;
      }
      elseif ($cod_device_cond_salva == "nu" || $cod_device_cond_salva == "nn" || $cod_device_cond_salva == "ep" || $cod_device_cond_salva == "ne" || !empty($cod_device))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['Grid_search'][$I_Grid]['val'][0][0] = $cod_device;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']['cod_device_cond'] = $cod_device_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['Grid_search'][$I_Grid]['cmp'] = "cod_device"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['Grid_search'][$I_Grid]['opc'] = $cod_device_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq']['cod_device'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']['cod_activo'] = $cod_activo; 
      if (is_array($cod_activo) && !empty($cod_activo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['Grid_search'][$I_Grid]['val'][0] = $cod_activo;
      }
      elseif ($cod_activo_cond_salva == "nu" || $cod_activo_cond_salva == "nn" || $cod_activo_cond_salva == "ep" || $cod_activo_cond_salva == "ne" || !empty($cod_activo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['Grid_search'][$I_Grid]['val'][0][0] = $cod_activo;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']['cod_activo_cond'] = $cod_activo_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['Grid_search'][$I_Grid]['cmp'] = "cod_activo"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['Grid_search'][$I_Grid]['opc'] = $cod_activo_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq']['cod_activo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']['cod_grupo'] = $cod_grupo; 
      if (is_array($cod_grupo) && !empty($cod_grupo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['Grid_search'][$I_Grid]['val'][0] = $cod_grupo;
      }
      elseif ($cod_grupo_cond_salva == "nu" || $cod_grupo_cond_salva == "nn" || $cod_grupo_cond_salva == "ep" || $cod_grupo_cond_salva == "ne" || !empty($cod_grupo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['Grid_search'][$I_Grid]['val'][0][0] = $cod_grupo;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']['cod_grupo_cond'] = $cod_grupo_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['Grid_search'][$I_Grid]['cmp'] = "cod_grupo"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['Grid_search'][$I_Grid]['opc'] = $cod_grupo_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['grid_pesq']['cod_grupo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($typereader != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['typereader'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['typereader'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['typereader'] = $typereader;
      }
      $Conteudo = $cod_device;
      if (strtoupper($cod_device_cond) != "II" && strtoupper($cod_device_cond) != "QP" && strtoupper($cod_device_cond) != "NP" && strtoupper($cod_device_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['cod_device'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($cod_activo != '') {
      $cod_activo_look = substr($this->Db->qstr($cod_activo), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['cod_activo'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['cod_activo'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['cod_activo'] = $cod_activo;
      }
      $nmgp_def_dados = array();
    if ($cod_grupo != '') {
      $cod_grupo_look = substr($this->Db->qstr($cod_grupo), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['cod_grupo'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['cod_grupo'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['cod_grupo'] = $cod_grupo;
      }

      //----- $typereader
      $this->Date_part = false;
      if (isset($typereader) || $typereader_cond == "nu" || $typereader_cond == "nn" || $typereader_cond == "ep" || $typereader_cond == "ne")
      {
         $this->monta_condicao("typereader", $typereader_cond, $typereader, "", "typereader");
      }

      //----- $cod_device
      $this->Date_part = false;
      if (isset($cod_device) || $cod_device_cond == "nu" || $cod_device_cond == "nn" || $cod_device_cond == "ep" || $cod_device_cond == "ne")
      {
         $this->monta_condicao("cod_device", $cod_device_cond, $cod_device, "", "cod_device");
      }

      //----- $cod_activo
      $this->Date_part = false;
      if (isset($cod_activo) || $cod_activo_cond == "nu" || $cod_activo_cond == "nn" || $cod_activo_cond == "ep" || $cod_activo_cond == "ne")
      {
         $this->monta_condicao("cod_activo", $cod_activo_cond, $cod_activo, "", "cod_activo");
      }

      //----- $cod_grupo
      $this->Date_part = false;
      if (isset($cod_grupo) || $cod_grupo_cond == "nu" || $cod_grupo_cond == "nn" || $cod_grupo_cond == "ep" || $cod_grupo_cond == "ne")
      {
         $this->monta_condicao("cod_grupo", $cod_grupo_cond, $cod_grupo, "", "cod_grupo");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['cond_pesq'] .= $this->NM_operador;
