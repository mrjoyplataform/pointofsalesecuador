...
class grid_devices_arcade_xls
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_devices_arcade/grid_devices_arcade_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_devices_arcade_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_devices_arcade.zip";
          $this->Arquivo   .= "_grid_devices_arcade" . $this->Xls_tp;
          $this->Tit_doc    = "grid_devices_arcade" . $this->Xls_tp;
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          if ($Cada_col == "sound" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "points" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "speak" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          if ($Cada_col == "typereader" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
   ...
   function NM_export_cod_device()
   {
         ...
         if (is_numeric($this->cod_device))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->cod_device);
         $this->Xls_col++;
   }
   //----- cod_activo
   function NM_export_cod_activo()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->cod_activo, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->cod_activo, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- cod_grupo
   function NM_export_cod_grupo()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->cod_grupo, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->cod_grupo, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- device_name
   function NM_export_device_name()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->device_name, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->device_name, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- activa
   function NM_export_activa()
   {
         ...
         if (is_numeric($this->activa))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->activa);
         $this->Xls_col++;
   }
   //----- estado
   ...
   function NM_export_ult_rfid()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ult_rfid, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ult_rfid, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- ult_fecha
   function NM_export_ult_fecha()
   {
      ...
      if (!empty($this->ult_fecha))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ult_fecha, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ult_fecha, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- valor_default
   function NM_export_valor_default()
   {
         ...
         if (is_numeric($this->valor_default))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->valor_default);
         $this->Xls_col++;
   }
   //----- acepta_tiempo
   function NM_export_acepta_tiempo()
   {
         ...
         if (is_numeric($this->acepta_tiempo))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->acepta_tiempo);
         $this->Xls_col++;
   }
   //----- acepta_tokens
   function NM_export_acepta_tokens()
   {
         ...
         if (is_numeric($this->acepta_tokens))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->acepta_tokens);
         $this->Xls_col++;
   }
   //----- dev_ip
   function NM_export_dev_ip()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->dev_ip, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->dev_ip, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- tipo_dev
   function NM_export_tipo_dev()
   {
         ...
         if (is_numeric($this->tipo_dev))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tipo_dev);
         $this->Xls_col++;
   }
   //----- direccion_torno
   function NM_export_direccion_torno()
   {
         ...
         if (is_numeric($this->direccion_torno))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->direccion_torno);
         $this->Xls_col++;
   }
   //----- timeout_rfid
   function NM_export_timeout_rfid()
   {
         ...
         if (is_numeric($this->timeout_rfid))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->timeout_rfid);
         $this->Xls_col++;
   }
   //----- discapacitado
   function NM_export_discapacitado()
   {
         ...
         if (is_numeric($this->discapacitado))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->discapacitado);
         $this->Xls_col++;
   }
   //----- numcaja
   function NM_export_numcaja()
   {
         ...
         if (is_numeric($this->numcaja))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->numcaja);
         $this->Xls_col++;
   }
   //----- empleado
   function NM_export_empleado()
   {
         ...
         if (is_numeric($this->empleado))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->empleado);
         $this->Xls_col++;
   }
   //----- tokens
   ...
   function NM_export_serialrfid()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->serialrfid, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->serialrfid, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- bidireccion
   function NM_export_bidireccion()
   {
         ...
         if (is_numeric($this->bidireccion))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->bidireccion);
         $this->Xls_col++;
   }
   //----- cod_devicee
   function NM_export_cod_devicee()
   {
         ...
         if (is_numeric($this->cod_devicee))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->cod_devicee);
         $this->Xls_col++;
   }
   //----- pin_relay1
   function NM_export_pin_relay1()
   {
         ...
         if (is_numeric($this->pin_relay1))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->pin_relay1);
         $this->Xls_col++;
   }
   //----- pin_relay2
   function NM_export_pin_relay2()
   {
         ...
         if (is_numeric($this->pin_relay2))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->pin_relay2);
         $this->Xls_col++;
   }
   //----- rfid_read
   function NM_export_rfid_read()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->rfid_read, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->rfid_read, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- rfid_estado
   function NM_export_rfid_estado()
   {
         ...
         if (is_numeric($this->rfid_estado))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->rfid_estado);
         $this->Xls_col++;
   }
   //----- rfid_fecha
   function NM_export_rfid_fecha()
   {
      ...
      if (!empty($this->rfid_fecha))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->rfid_fecha, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->rfid_fecha, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- url_accion
   function NM_export_url_accion()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->url_accion, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->url_accion, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- url_atraccion
   function NM_export_url_atraccion()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->url_atraccion, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->url_atraccion, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- uhfip
   function NM_export_uhfip()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->uhfip, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->uhfip, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- url_reader
   function NM_export_url_reader()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->url_reader, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->url_reader, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- cod_rfid900
   function NM_export_cod_rfid900()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->cod_rfid900, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->cod_rfid900, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- mensaje
   ...
   function NM_export_tipolector()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tipolector, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tipolector, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- url_accion_bg
   function NM_export_url_accion_bg()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->url_accion_bg, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->url_accion_bg, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- url_inicio
   function NM_export_url_inicio()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->url_inicio, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->url_inicio, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- ledstripe1
   function NM_export_ledstripe1()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ledstripe1, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ledstripe1, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- ledstripe2
   function NM_export_ledstripe2()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ledstripe2, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ledstripe2, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- ledstripe3
   function NM_export_ledstripe3()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ledstripe3, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ledstripe3, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- ledstripe4
   function NM_export_ledstripe4()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ledstripe4, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->ledstripe4, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- lasteffect
   function NM_export_lasteffect()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lasteffect, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->lasteffect, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- color
   function NM_export_color()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->color, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->color, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- sound
   function NM_export_sound()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->sound = html_entity_decode($this->sound, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sound = strip_tags($this->sound);
         $this->sound = NM_charset_to_utf8($this->sound);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sound, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->sound, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- points
   function NM_export_points()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->points = NM_charset_to_utf8($this->points);
         if (is_numeric($this->points))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->points);
         $this->Xls_col++;
   }
   //----- speak
   function NM_export_speak()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->speak = html_entity_decode($this->speak, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->speak = strip_tags($this->speak);
         $this->speak = NM_charset_to_utf8($this->speak);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->speak, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->speak, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- typereader
   function NM_export_typereader()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->typereader = html_entity_decode($this->typereader, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->typereader = strip_tags($this->typereader);
         $this->typereader = NM_charset_to_utf8($this->typereader);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->typereader, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->typereader, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- url_1
   function NM_export_url_1()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->url_1, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->url_1, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- url_2
   function NM_export_url_2()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->url_2, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->url_2, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- url_3
   function NM_export_url_3()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->url_3, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->url_3, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- foto1
   function NM_export_foto1()
   {
         ...
         $in_foto1 = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_foto1_" . $_SESSION['scriptcase']['sc_num_img'] . session_id() . ".jpg";
         $_SESSION['scriptcase']['sc_num_img']++;
         $arq_foto1 = fopen($in_foto1, "w");
         ...
         if (is_file($in_foto1))
         { 
             $sc_obj_img = new nm_trata_img($in_foto1);
   ...
   function NM_export_foto2()
   {
         ...
         $in_foto2 = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_foto2_" . $_SESSION['scriptcase']['sc_num_img'] . session_id() . ".jpg";
         $_SESSION['scriptcase']['sc_num_img']++;
         $arq_foto2 = fopen($in_foto2, "w");
         if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
         { 
         ...
         if (is_file($in_foto2))
         { 
             $sc_obj_img = new nm_trata_img($in_foto2);
             $nm_image_altura  = $sc_obj_img->getHeight();
             $nm_image_largura = $sc_obj_img->getWidth();
             if ($this->Use_phpspreadsheet) {
                 $objDrawing = new \PhpOffice\PhpSpreadsheet\Worksheet\Drawing();
   ...
   function NM_export_foto3()
   {
         ...
         $in_foto3 = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_foto3_" . $_SESSION['scriptcase']['sc_num_img'] . session_id() . ".jpg";
         $_SESSION['scriptcase']['sc_num_img']++;
         $arq_foto3 = fopen($in_foto3, "w");
         if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
         { 
         ...
         if (is_file($in_foto3))
         { 
             $sc_obj_img = new nm_trata_img($in_foto3);
             $nm_image_altura  = $sc_obj_img->getHeight();
             $nm_image_largura = $sc_obj_img->getWidth();
             if ($this->Use_phpspreadsheet) {
                 $objDrawing = new \PhpOffice\PhpSpreadsheet\Worksheet\Drawing();
   ...
   //----- cod_device
   function NM_sub_cons_cod_device()
   {
         $this->cod_device = NM_charset_to_utf8($this->cod_device);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->cod_device;
   ...
   //----- cod_activo
   function NM_sub_cons_cod_activo()
   {
         $this->cod_activo = html_entity_decode($this->cod_activo, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->cod_activo = strip_tags($this->cod_activo);
         $this->cod_activo = NM_charset_to_utf8($this->cod_activo);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->cod_activo;
   ...
   //----- cod_grupo
   function NM_sub_cons_cod_grupo()
   {
         $this->cod_grupo = html_entity_decode($this->cod_grupo, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->cod_grupo = strip_tags($this->cod_grupo);
         $this->cod_grupo = NM_charset_to_utf8($this->cod_grupo);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->cod_grupo;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- device_name
   function NM_sub_cons_device_name()
   {
         $this->device_name = html_entity_decode($this->device_name, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->device_name = strip_tags($this->device_name);
         $this->device_name = NM_charset_to_utf8($this->device_name);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->device_name;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- ult_rfid
   function NM_sub_cons_ult_rfid()
   {
         $this->ult_rfid = html_entity_decode($this->ult_rfid, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->ult_rfid = strip_tags($this->ult_rfid);
         $this->ult_rfid = NM_charset_to_utf8($this->ult_rfid);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->ult_rfid;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- ult_fecha
   function NM_sub_cons_ult_fecha()
   {
      if (!empty($this->ult_fecha))
      {
         if (substr($this->ult_fecha, 10, 1) == "-") 
         ...
         $this->ult_fecha = NM_charset_to_utf8($this->ult_fecha);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->ult_fecha;
   ...
   //----- valor_default
   function NM_sub_cons_valor_default()
   {
         $this->valor_default = NM_charset_to_utf8($this->valor_default);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->valor_default;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
   ...
   //----- acepta_tiempo
   function NM_sub_cons_acepta_tiempo()
   {
         $this->acepta_tiempo = NM_charset_to_utf8($this->acepta_tiempo);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->acepta_tiempo;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- acepta_tokens
   function NM_sub_cons_acepta_tokens()
   {
         $this->acepta_tokens = NM_charset_to_utf8($this->acepta_tokens);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->acepta_tokens;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- dev_ip
   function NM_sub_cons_dev_ip()
   {
         $this->dev_ip = html_entity_decode($this->dev_ip, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->dev_ip = strip_tags($this->dev_ip);
         $this->dev_ip = NM_charset_to_utf8($this->dev_ip);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->dev_ip;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- tipo_dev
   function NM_sub_cons_tipo_dev()
   {
         $this->tipo_dev = NM_charset_to_utf8($this->tipo_dev);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tipo_dev;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- direccion_torno
   function NM_sub_cons_direccion_torno()
   {
         $this->direccion_torno = NM_charset_to_utf8($this->direccion_torno);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->direccion_torno;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- timeout_rfid
   function NM_sub_cons_timeout_rfid()
   {
         $this->timeout_rfid = NM_charset_to_utf8($this->timeout_rfid);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->timeout_rfid;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- discapacitado
   function NM_sub_cons_discapacitado()
   {
         $this->discapacitado = NM_charset_to_utf8($this->discapacitado);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->discapacitado;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- numcaja
   function NM_sub_cons_numcaja()
   {
         $this->numcaja = NM_charset_to_utf8($this->numcaja);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->numcaja;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- empleado
   function NM_sub_cons_empleado()
   {
         $this->empleado = NM_charset_to_utf8($this->empleado);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->empleado;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- serialrfid
   function NM_sub_cons_serialrfid()
   {
         $this->serialrfid = html_entity_decode($this->serialrfid, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->serialrfid = strip_tags($this->serialrfid);
         $this->serialrfid = NM_charset_to_utf8($this->serialrfid);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->serialrfid;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- bidireccion
   function NM_sub_cons_bidireccion()
   {
         $this->bidireccion = NM_charset_to_utf8($this->bidireccion);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->bidireccion;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- cod_devicee
   function NM_sub_cons_cod_devicee()
   {
         $this->cod_devicee = NM_charset_to_utf8($this->cod_devicee);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->cod_devicee;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- pin_relay1
   function NM_sub_cons_pin_relay1()
   {
         $this->pin_relay1 = NM_charset_to_utf8($this->pin_relay1);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pin_relay1;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- pin_relay2
   function NM_sub_cons_pin_relay2()
   {
         $this->pin_relay2 = NM_charset_to_utf8($this->pin_relay2);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->pin_relay2;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- rfid_read
   function NM_sub_cons_rfid_read()
   {
         $this->rfid_read = html_entity_decode($this->rfid_read, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->rfid_read = strip_tags($this->rfid_read);
         $this->rfid_read = NM_charset_to_utf8($this->rfid_read);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->rfid_read;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- rfid_estado
   function NM_sub_cons_rfid_estado()
   {
         $this->rfid_estado = NM_charset_to_utf8($this->rfid_estado);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->rfid_estado;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- rfid_fecha
   function NM_sub_cons_rfid_fecha()
   {
      if (!empty($this->rfid_fecha))
      {
         if (substr($this->rfid_fecha, 10, 1) == "-") 
         ...
         $this->rfid_fecha = NM_charset_to_utf8($this->rfid_fecha);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->rfid_fecha;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- url_accion
   function NM_sub_cons_url_accion()
   {
         $this->url_accion = html_entity_decode($this->url_accion, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->url_accion = strip_tags($this->url_accion);
         $this->url_accion = NM_charset_to_utf8($this->url_accion);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->url_accion;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- url_atraccion
   function NM_sub_cons_url_atraccion()
   {
         $this->url_atraccion = html_entity_decode($this->url_atraccion, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->url_atraccion = strip_tags($this->url_atraccion);
         $this->url_atraccion = NM_charset_to_utf8($this->url_atraccion);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->url_atraccion;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- uhfip
   function NM_sub_cons_uhfip()
   {
         $this->uhfip = html_entity_decode($this->uhfip, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->uhfip = strip_tags($this->uhfip);
         $this->uhfip = NM_charset_to_utf8($this->uhfip);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->uhfip;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- url_reader
   function NM_sub_cons_url_reader()
   {
         $this->url_reader = html_entity_decode($this->url_reader, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->url_reader = strip_tags($this->url_reader);
         $this->url_reader = NM_charset_to_utf8($this->url_reader);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->url_reader;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- cod_rfid900
   function NM_sub_cons_cod_rfid900()
   {
         $this->cod_rfid900 = html_entity_decode($this->cod_rfid900, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->cod_rfid900 = strip_tags($this->cod_rfid900);
         $this->cod_rfid900 = NM_charset_to_utf8($this->cod_rfid900);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->cod_rfid900;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- tipolector
   function NM_sub_cons_tipolector()
   {
         $this->tipolector = html_entity_decode($this->tipolector, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->tipolector = strip_tags($this->tipolector);
         $this->tipolector = NM_charset_to_utf8($this->tipolector);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tipolector;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- url_accion_bg
   function NM_sub_cons_url_accion_bg()
   {
         $this->url_accion_bg = html_entity_decode($this->url_accion_bg, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->url_accion_bg = strip_tags($this->url_accion_bg);
         $this->url_accion_bg = NM_charset_to_utf8($this->url_accion_bg);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->url_accion_bg;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- url_inicio
   function NM_sub_cons_url_inicio()
   {
         $this->url_inicio = html_entity_decode($this->url_inicio, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->url_inicio = strip_tags($this->url_inicio);
         $this->url_inicio = NM_charset_to_utf8($this->url_inicio);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->url_inicio;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- ledstripe1
   function NM_sub_cons_ledstripe1()
   {
         $this->ledstripe1 = html_entity_decode($this->ledstripe1, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->ledstripe1 = strip_tags($this->ledstripe1);
         $this->ledstripe1 = NM_charset_to_utf8($this->ledstripe1);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->ledstripe1;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- ledstripe2
   function NM_sub_cons_ledstripe2()
   {
         $this->ledstripe2 = html_entity_decode($this->ledstripe2, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->ledstripe2 = strip_tags($this->ledstripe2);
         $this->ledstripe2 = NM_charset_to_utf8($this->ledstripe2);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->ledstripe2;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- ledstripe3
   function NM_sub_cons_ledstripe3()
   {
         $this->ledstripe3 = html_entity_decode($this->ledstripe3, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->ledstripe3 = strip_tags($this->ledstripe3);
         $this->ledstripe3 = NM_charset_to_utf8($this->ledstripe3);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->ledstripe3;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- ledstripe4
   function NM_sub_cons_ledstripe4()
   {
         $this->ledstripe4 = html_entity_decode($this->ledstripe4, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->ledstripe4 = strip_tags($this->ledstripe4);
         $this->ledstripe4 = NM_charset_to_utf8($this->ledstripe4);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->ledstripe4;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- lasteffect
   function NM_sub_cons_lasteffect()
   {
         $this->lasteffect = html_entity_decode($this->lasteffect, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->lasteffect = strip_tags($this->lasteffect);
         $this->lasteffect = NM_charset_to_utf8($this->lasteffect);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->lasteffect;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- color
   function NM_sub_cons_color()
   {
         $this->color = html_entity_decode($this->color, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->color = strip_tags($this->color);
         $this->color = NM_charset_to_utf8($this->color);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->color;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- sound
   function NM_sub_cons_sound()
   {
         $this->sound = html_entity_decode($this->sound, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->sound = strip_tags($this->sound);
         $this->sound = NM_charset_to_utf8($this->sound);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->sound;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- points
   function NM_sub_cons_points()
   {
         $this->points = NM_charset_to_utf8($this->points);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->points;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- speak
   function NM_sub_cons_speak()
   {
         $this->speak = html_entity_decode($this->speak, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->speak = strip_tags($this->speak);
         $this->speak = NM_charset_to_utf8($this->speak);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->speak;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- typereader
   function NM_sub_cons_typereader()
   {
         $this->typereader = html_entity_decode($this->typereader, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->typereader = strip_tags($this->typereader);
         $this->typereader = NM_charset_to_utf8($this->typereader);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->typereader;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- url_1
   function NM_sub_cons_url_1()
   {
         $this->url_1 = html_entity_decode($this->url_1, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->url_1 = strip_tags($this->url_1);
         $this->url_1 = NM_charset_to_utf8($this->url_1);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->url_1;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- url_2
   function NM_sub_cons_url_2()
   {
         $this->url_2 = html_entity_decode($this->url_2, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->url_2 = strip_tags($this->url_2);
         $this->url_2 = NM_charset_to_utf8($this->url_2);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->url_2;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- url_3
   function NM_sub_cons_url_3()
   {
         $this->url_3 = html_entity_decode($this->url_3, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->url_3 = strip_tags($this->url_3);
         $this->url_3 = NM_charset_to_utf8($this->url_3);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->url_3;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   function NM_sub_cons_foto1()
   {
         ...
         if (is_file($in_foto1))
         { 
             $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $in_foto1;
             $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
   ...
   function NM_sub_cons_foto2()
   {
         ...
         if (is_file($in_foto2))
         { 
             $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $in_foto2;
             $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
             $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "img";
             $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
             $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['name'] = "";
   ...
   function NM_sub_cons_foto3()
   {
         ...
         if (is_file($in_foto3))
         { 
             $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $in_foto3;
             $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
             $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "img";
             $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
             $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['name'] = "";
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> devices :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
