...
class grid_devices_arcade_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_devices_arcade.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['rtf_name']);
      }
   ...
   function NM_export_sound()
   {
         ...
         $this->sound = str_replace('<', '&lt;', $this->sound);
         $this->sound = str_replace('>', '&gt;', $this->sound);
         $this->Texto_tag .= "<td>" . $this->sound . "</td>\r\n";
   }
   //----- points
   function NM_export_points()
   {
         ...
         $this->points = str_replace('<', '&lt;', $this->points);
         $this->points = str_replace('>', '&gt;', $this->points);
         $this->Texto_tag .= "<td>" . $this->points . "</td>\r\n";
   }
   //----- speak
   function NM_export_speak()
   {
         ...
         $this->speak = str_replace('<', '&lt;', $this->speak);
         $this->speak = str_replace('>', '&gt;', $this->speak);
         $this->Texto_tag .= "<td>" . $this->speak . "</td>\r\n";
   }
   //----- typereader
   function NM_export_typereader()
   {
         ...
         $this->typereader = str_replace('<', '&lt;', $this->typereader);
         $this->typereader = str_replace('>', '&gt;', $this->typereader);
         $this->Texto_tag .= "<td>" . $this->typereader . "</td>\r\n";
   }
   //----- url_1
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devices_arcade']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
