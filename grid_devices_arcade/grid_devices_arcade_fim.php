...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_devices_arcade"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_devices_arcade"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_devices_arcade'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_devices_arcade']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_devices_arcade']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_devices_arcade']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_devices_arcade']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_devices_arcade']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_devices_arcade</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_devices_arcade']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_devices_arcade']['embutida_filho'] as $ind => $sc_init)
          {
