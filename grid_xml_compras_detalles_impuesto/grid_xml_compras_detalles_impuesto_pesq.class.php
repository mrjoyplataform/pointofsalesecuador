...
class grid_xml_compras_detalles_impuesto_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_xml_compras_detalles_impuesto_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_xml_compras_detalles_impuesto_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_xml_compras_detalles_impuesto_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_codigoporcentaje')
      {
          $codigoporcentaje = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_codigoporcentaje($codigoporcentaje);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_claveacceso')
      {
          $claveacceso = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_claveacceso($claveacceso);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$campo_join]);
              return;
          }
         $nm_ini_lower = "";
         $nm_fim_lower = "";
      ...
      else
      {
         ...
         $nome_sum = "xml_compras_detalles_impuesto.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> xml_compras_detalles_impuesto</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_xml_compras_detalles_impuesto/grid_xml_compras_detalles_impuesto_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_xml_compras_detalles_impuesto_ajax_search.js"></script>
 <script type="text/javascript" src="grid_xml_compras_detalles_impuesto_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_xml_compras_detalles_impuesto_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_xml_compras_detalles_impuesto']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_xml_compras_detalles_impuesto']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_codigoporcentaje_cond#NMF#' + search_get_sel_txt('SC_codigoporcentaje_cond') + '@NMF@';
  str_out += 'SC_codigoporcentaje#NMF#' + search_get_text('SC_codigoporcentaje') + '@NMF@';
  str_out += 'id_ac_codigoporcentaje#NMF#' + search_get_text('id_ac_codigoporcentaje') + '@NMF@';
  str_out += 'SC_idlinea_cond#NMF#' + search_get_sel_txt('SC_idlinea_cond') + '@NMF@';
  str_out += 'SC_idlinea#NMF#' + search_get_text('SC_idlinea') + '@NMF@';
  str_out += 'SC_claveacceso_cond#NMF#' + search_get_sel_txt('SC_claveacceso_cond') + '@NMF@';
  str_out += 'SC_claveacceso#NMF#' + search_get_text('SC_claveacceso') + '@NMF@';
  str_out += 'id_ac_claveacceso#NMF#' + search_get_text('id_ac_claveacceso') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_claveacceso").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_claveacceso").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_claveacceso",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_claveacceso").val(ui.item.value);
   ...
   scClass = $("#id_ac_codigoporcentaje").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_codigoporcentaje").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_codigoporcentaje",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_codigoporcentaje").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_codigoporcentaje").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> xml_compras_detalles_impuesto</div>
...
<?php
   ...
   {
      global 
             $codigoporcentaje_cond, $codigoporcentaje, $codigoporcentaje_autocomp,
             $idlinea_cond, $idlinea,
             $claveacceso_cond, $claveacceso, $claveacceso_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $codigoporcentaje = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']['codigoporcentaje']; 
          $codigoporcentaje_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']['codigoporcentaje_cond']; 
          $idlinea = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']['idlinea']; 
          $idlinea_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']['idlinea_cond']; 
          $claveacceso = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']['claveacceso']; 
          $claveacceso_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']['claveacceso_cond']; 
          $codigo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']['codigo']; 
          $codigo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']['codigo_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']['NM_operador']; 
          if (strtoupper($idlinea_cond) != "II" && strtoupper($idlinea_cond) != "QP" && strtoupper($idlinea_cond) != "NP" && strtoupper($idlinea_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idlinea, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($codigoporcentaje_cond) || empty($codigoporcentaje_cond))
      {
         $codigoporcentaje_cond = "qp";
      }
      if (!isset($idlinea_cond) || empty($idlinea_cond))
      {
         $idlinea_cond = "gt";
      }
      if (!isset($claveacceso_cond) || empty($claveacceso_cond))
      {
         $claveacceso_cond = "qp";
      }
      ...
      $str_hide_codigoporcentaje = (in_array($codigoporcentaje_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idlinea = (in_array($idlinea_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_claveacceso = (in_array($claveacceso_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_codigo = (in_array($codigo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($codigoporcentaje) || $codigoporcentaje == "")
      {
          $codigoporcentaje = "";
      }
      if (isset($codigoporcentaje) && !empty($codigoporcentaje))
      {
         $tmp_pos = strpos($codigoporcentaje, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $codigoporcentaje = substr($codigoporcentaje, 0, $tmp_pos);
         }
      }
      if (!isset($idlinea) || $idlinea == "")
      {
          $idlinea = "";
      }
      if (isset($idlinea) && !empty($idlinea))
      {
         $tmp_pos = strpos($idlinea, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idlinea = substr($idlinea, 0, $tmp_pos);
         }
      }
      if (!isset($claveacceso) || $claveacceso == "")
      {
          $claveacceso = "";
      }
      if (isset($claveacceso) && !empty($claveacceso))
      {
         $tmp_pos = strpos($claveacceso, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $claveacceso = substr($claveacceso, 0, $tmp_pos);
         }
      }
...
?>
<?php
   if (is_file("grid_xml_compras_detalles_impuesto_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_xml_compras_detalles_impuesto']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_xml_compras_detalles_impuesto']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_codigoporcentaje_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['codigoporcentaje'])) ? $this->New_label['codigoporcentaje'] : "Codigo Porcentaje"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_codigoporcentaje_cond" name="codigoporcentaje_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigoporcentaje'), this, 'codigoporcentaje')">
       <OPTION value="qp" <?php if ("qp" == $codigoporcentaje_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $codigoporcentaje_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $codigoporcentaje_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $codigoporcentaje_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_codigoporcentaje" <?php echo $str_hide_codigoporcentaje?> valign="top">
 ...
 $nmgp_tab_label .= "codigoporcentaje?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $codigoporcentaje;
      }
?>
<INPUT  type="text" id="SC_codigoporcentaje" name="codigoporcentaje" value="<?php echo NM_encode_input($codigoporcentaje) ?>"  size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_codigoporcentaje" name="codigoporcentaje_autocomp" size="45"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_idlinea_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['idlinea'])) ? $this->New_label['idlinea'] : "Idlinea"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_idlinea_cond" name="idlinea_cond" onChange="nm_campos_between(document.getElementById('id_vis_idlinea'), this, 'idlinea')">
       <OPTION value="gt" <?php if ("gt" == $idlinea_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idlinea_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idlinea_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idlinea" <?php echo $str_hide_idlinea?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['idlinea'])) ? $this->New_label['idlinea'] : "Idlinea";
 $nmgp_tab_label .= "idlinea?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_idlinea" name="idlinea" value="<?php echo NM_encode_input($idlinea) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_claveacceso_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['claveacceso'])) ? $this->New_label['claveacceso'] : "Clave Acceso"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_claveacceso_cond" name="claveacceso_cond" onChange="nm_campos_between(document.getElementById('id_vis_claveacceso'), this, 'claveacceso')">
       <OPTION value="qp" <?php if ("qp" == $claveacceso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $claveacceso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $claveacceso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $claveacceso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_claveacceso" <?php echo $str_hide_claveacceso?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['claveacceso'])) ? $this->New_label['claveacceso'] : "Clave Acceso";
 $nmgp_tab_label .= "claveacceso?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $claveacceso;
      }
?>
<INPUT  type="text" id="SC_claveacceso" name="claveacceso" value="<?php echo NM_encode_input($claveacceso) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_claveacceso" name="claveacceso_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<INPUT  type="text" id="SC_codigo" name="codigo" value="<?php echo NM_encode_input($codigo) ?>"  size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_codigo" name="codigo_autocomp" size="45"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.codigoporcentaje_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_codigoporcentaje'), document.F1.codigoporcentaje_cond, 'codigoporcentaje');
   document.F1.codigoporcentaje.value = "";
   document.F1.codigoporcentaje_autocomp.value = "";
   document.F1.idlinea_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idlinea'), document.F1.idlinea_cond, 'idlinea');
   document.F1.idlinea.value = "";
   document.F1.claveacceso_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_claveacceso'), document.F1.claveacceso_cond, 'claveacceso');
   document.F1.claveacceso.value = "";
   document.F1.claveacceso_autocomp.value = "";
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_xml_compras_detalles_impuesto/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_codigoporcentaje_cond'] = 'cond';
      $tp_fields['SC_codigoporcentaje'] = 'text_aut';
      $tp_fields['id_ac_codigoporcentaje'] = 'text_aut';
      $tp_fields['SC_idlinea_cond'] = 'cond';
      $tp_fields['SC_idlinea'] = 'text';
      $tp_fields['SC_claveacceso_cond'] = 'cond';
      $tp_fields['SC_claveacceso'] = 'text_aut';
      $tp_fields['id_ac_claveacceso'] = 'text_aut';
   ...
   {
      global $codigoporcentaje_cond, $codigoporcentaje, $codigoporcentaje_autocomp,
             $idlinea_cond, $idlinea,
             $claveacceso_cond, $claveacceso, $claveacceso_autocomp,
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($codigoporcentaje_autocomp) && empty($codigoporcentaje))
      {
          $codigoporcentaje = $codigoporcentaje_autocomp;
      }
      if (!empty($claveacceso_autocomp) && empty($claveacceso))
      {
          $claveacceso = $claveacceso_autocomp;
      }
      if (!empty($codigo_autocomp) && empty($codigo))
      {
          $codigo = $codigo_autocomp;
      }
      $codigoporcentaje_cond_salva = $codigoporcentaje_cond; 
      if (!isset($codigoporcentaje_input_2) || $codigoporcentaje_input_2 == "")
      {
          $codigoporcentaje_input_2 = $codigoporcentaje;
      }
      $idlinea_cond_salva = $idlinea_cond; 
      if (!isset($idlinea_input_2) || $idlinea_input_2 == "")
      {
          $idlinea_input_2 = $idlinea;
      }
      $claveacceso_cond_salva = $claveacceso_cond; 
      if (!isset($claveacceso_input_2) || $claveacceso_input_2 == "")
      {
          $claveacceso_input_2 = $claveacceso;
      }
      ...
      if ($idlinea_cond != "in")
      {
          nm_limpa_numero($idlinea, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']['codigoporcentaje'] = $codigoporcentaje; 
      if (is_array($codigoporcentaje) && !empty($codigoporcentaje))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['Grid_search'][$I_Grid]['val'][0] = $codigoporcentaje;
      }
      elseif ($codigoporcentaje_cond_salva == "nu" || $codigoporcentaje_cond_salva == "nn" || $codigoporcentaje_cond_salva == "ep" || $codigoporcentaje_cond_salva == "ne" || !empty($codigoporcentaje))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['Grid_search'][$I_Grid]['val'][0][0] = $codigoporcentaje;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']['codigoporcentaje_cond'] = $codigoporcentaje_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['Grid_search'][$I_Grid]['cmp'] = "codigoporcentaje"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['Grid_search'][$I_Grid]['opc'] = $codigoporcentaje_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq']['codigoporcentaje'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']['idlinea'] = $idlinea; 
      if (is_array($idlinea) && !empty($idlinea))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['Grid_search'][$I_Grid]['val'][0] = $idlinea;
      }
      elseif ($idlinea_cond_salva == "nu" || $idlinea_cond_salva == "nn" || $idlinea_cond_salva == "ep" || $idlinea_cond_salva == "ne" || !empty($idlinea))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['Grid_search'][$I_Grid]['val'][0][0] = $idlinea;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']['idlinea_cond'] = $idlinea_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['Grid_search'][$I_Grid]['cmp'] = "idlinea"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['Grid_search'][$I_Grid]['opc'] = $idlinea_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq']['idlinea'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']['claveacceso'] = $claveacceso; 
      if (is_array($claveacceso) && !empty($claveacceso))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['Grid_search'][$I_Grid]['val'][0] = $claveacceso;
      }
      elseif ($claveacceso_cond_salva == "nu" || $claveacceso_cond_salva == "nn" || $claveacceso_cond_salva == "ep" || $claveacceso_cond_salva == "ne" || !empty($claveacceso))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['Grid_search'][$I_Grid]['val'][0][0] = $claveacceso;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']['claveacceso_cond'] = $claveacceso_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['Grid_search'][$I_Grid]['cmp'] = "claveacceso"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['Grid_search'][$I_Grid]['opc'] = $claveacceso_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq']['claveacceso'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']['codigo'] = $codigo; 
      if (is_array($codigo) && !empty($codigo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['Grid_search'][$I_Grid]['val'][0] = $codigo;
      }
      elseif ($codigo_cond_salva == "nu" || $codigo_cond_salva == "nn" || $codigo_cond_salva == "ep" || $codigo_cond_salva == "ne" || !empty($codigo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['Grid_search'][$I_Grid]['val'][0][0] = $codigo;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']['codigo_cond'] = $codigo_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['Grid_search'][$I_Grid]['cmp'] = "codigo"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['Grid_search'][$I_Grid]['opc'] = $codigo_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['grid_pesq']['codigo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($codigoporcentaje != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['codigoporcentaje'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['codigoporcentaje'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['codigoporcentaje'] = $codigoporcentaje;
      }
      $Conteudo = $idlinea;
      if (strtoupper($idlinea_cond) != "II" && strtoupper($idlinea_cond) != "QP" && strtoupper($idlinea_cond) != "NP" && strtoupper($idlinea_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['idlinea'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($claveacceso != '') {
      $claveacceso_look = substr($this->Db->qstr($claveacceso), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['claveacceso'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['claveacceso'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['claveacceso'] = $claveacceso;
      }
      $nmgp_def_dados = array();
    if ($codigo != '') {
      $codigo_look = substr($this->Db->qstr($codigo), 1, -1); 
      ...
      if (isset($codigoporcentaje) || $codigoporcentaje_cond == "nu" || $codigoporcentaje_cond == "nn" || $codigoporcentaje_cond == "ep" || $codigoporcentaje_cond == "ne")
      {
         $this->monta_condicao("codigoPorcentaje", $codigoporcentaje_cond, $codigoporcentaje, "", "codigoporcentaje");
      }

      //----- $idlinea
      $this->Date_part = false;
      if (isset($idlinea) || $idlinea_cond == "nu" || $idlinea_cond == "nn" || $idlinea_cond == "ep" || $idlinea_cond == "ne")
      {
         $this->monta_condicao("idlinea", $idlinea_cond, $idlinea, "", "idlinea");
      }

      //----- $claveacceso
      $this->Date_part = false;
      if (isset($claveacceso) || $claveacceso_cond == "nu" || $claveacceso_cond == "nn" || $claveacceso_cond == "ep" || $claveacceso_cond == "ne")
      {
         $this->monta_condicao("claveAcceso", $claveacceso_cond, $claveacceso, "", "claveacceso");
      }
   ...
   function finaliza_resultado_ajax()
   {
    $this->Sel_case_sensitive($this->comando);
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $this->Sel_case_sensitive($this->comando);
      $this->Sel_case_sensitive($this->comando_sum);
      $this->Sel_case_sensitive($this->comando_filtro);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_xml_compras_detalles_impuesto']['cond_pesq'] .= $this->NM_operador;
