...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = " #lowerI#";
      $nm_fim_lower = "#lowerF#";
      $Nm_numeric[] = "idlinea";$Nm_numeric[] = "tarifa";$Nm_numeric[] = "baseimponible";$Nm_numeric[] = "valor";$Nm_numeric[] = "idlinea";$Nm_numeric[] = "tarifa";$Nm_numeric[] = "baseimponible";$Nm_numeric[] = "valor";
...
<HTML>
<HEAD>
 <TITLE> xml_compras_detalles_impuesto</TITLE>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_codigoporcentaje_cond" name="codigoporcentaje_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigoporcentaje'), this, 'codigoporcentaje')">
      ...
      <br><span id="id_hide_codigoporcentaje"  <?php echo $str_hide_codigoporcentaje?>><?php
      if ($codigoporcentaje != "")
      {
      $codigoporcentaje_look = substr($this->Db->qstr($codigoporcentaje), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idlinea_cond" name="idlinea_cond" onChange="nm_campos_between(document.getElementById('id_vis_idlinea'), this, 'idlinea')">
      ...
      <br><span id="id_hide_idlinea"  <?php echo $str_hide_idlinea?>><INPUT  type="text" id="SC_idlinea" name="idlinea" value="<?php echo NM_encode_input($idlinea) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_claveacceso_cond" name="claveacceso_cond" onChange="nm_campos_between(document.getElementById('id_vis_claveacceso'), this, 'claveacceso')">
      ...
      <br><span id="id_hide_claveacceso"  <?php echo $str_hide_claveacceso?>><?php
      if ($claveacceso != "")
      {
      $claveacceso_look = substr($this->Db->qstr($claveacceso), 1, -1); 
      $nmgp_def_dados = array(); 
