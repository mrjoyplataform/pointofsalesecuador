<?php
@session_start() ;
$_SESSION['scriptcase']['grid_xml_compras_detalles_impuesto']['sc_process_barr'] = true;
require_once('../grid_xml_compras_detalles_impuesto/index.php');
unset($_SESSION['scriptcase']['grid_xml_compras_detalles_impuesto']['sc_process_barr']);
$ExportCtrl = new grid_xml_compras_detalles_impuesto_export_control;
$ExportCtrl->Export_barr();

class grid_xml_compras_detalles_impuesto_export_control
{
