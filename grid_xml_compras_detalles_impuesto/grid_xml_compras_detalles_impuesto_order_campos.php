...
<?php
   ...
   $Ord_Cmp = new grid_xml_compras_detalles_impuesto_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_xml_compras_detalles_impuesto_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['tarifa'] = "tarifa";
   $tab_labels["tarifa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['labels']["tarifa"])) ? $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['labels']["tarifa"] : "Tarifa";
   $tab_ger_campos['baseimponible'] = "on";
   $tab_def_campos['baseimponible'] = "baseImponible";
   $tab_labels["baseimponible"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['labels']["baseimponible"])) ? $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['labels']["baseimponible"] : "Base Imponible";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['labels']["valor"] : "Valor";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_xml_compras_detalles_impuesto_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_xml_compras_detalles_impuesto']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
