...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____chart_reporte_sales"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____chart_reporte_sales"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_reporte_sales']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_reporte_sales']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_reporte_sales']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_reporte_sales']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_reporte_sales']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_reporte_sales</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_reporte_sales']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_reporte_sales']['embutida_filho'] as $ind => $sc_init)
          {
