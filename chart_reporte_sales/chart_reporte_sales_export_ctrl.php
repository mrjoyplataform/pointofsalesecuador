<?php
@session_start() ;
$_SESSION['scriptcase']['chart_reporte_sales']['sc_process_barr'] = true;
require_once('../chart_reporte_sales/index.php');
unset($_SESSION['scriptcase']['chart_reporte_sales']['sc_process_barr']);
$ExportCtrl = new chart_reporte_sales_export_control;
$ExportCtrl->Export_barr();

class chart_reporte_sales_export_control
{
