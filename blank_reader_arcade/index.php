<?php
   include_once('blank_reader_arcade_session.php');
   @ini_set('session.cookie_httponly', 0);
   @ini_set('session.use_only_cookies', 0);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_perfil']          = "conn_pos";
   $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class blank_reader_arcade_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "blank_reader_arcade"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['blank_reader_arcade']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['blank_reader_arcade']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['blank_reader_arcade']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/blank_reader_arcade';
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['blank_reader_arcade']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['blank_reader_arcade']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['blank_reader_arcade']['actual_lang']) || $_SESSION['scriptcase']['blank_reader_arcade']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['blank_reader_arcade']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("blank_reader_arcade_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blank_reader_arcade"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blank_reader_arcade"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['link_info']['remove_border'] = true;
        }
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['blank_reader_arcade']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['blank_reader_arcade']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['blank_reader_arcade']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['blank_reader_arcade']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "blank_reader_arcade_erro.class.php"); 
      $this->Erro = new blank_reader_arcade_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('blank_reader_arcade'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['blank_reader_arcade']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['blank_reader_arcade']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['blank_reader_arcade']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['blank_reader_arcade']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['blank_reader_arcade']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['blank_reader_arcade']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_conexao']) && $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_perfil']) && $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['blank_reader_arcade']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['blank_reader_arcade']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_conexao'], $this->root . $this->path_prod, 'pointofsales', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blank_reader_arcade']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new blank_reader_arcade_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['blank_reader_arcade']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['blank_reader_arcade']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['blank_reader_arcade']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['blank_reader_arcade'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_reader_arcade']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_reader_arcade']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('blank_reader_arcade') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_reader_arcade']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['blank_reader_arcade']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['blank_reader_arcade']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['blank_reader_arcade']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "blank_reader_arcade_erro.class.php"); 
      $this->Erro      = new blank_reader_arcade_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      header("Referrer-Policy: unsafe-url");
      $_SESSION['scriptcase']['blank_reader_arcade']['contr_erro'] = 'on';
...
if (isset($this->sc_temp_id_device)) {$_SESSION['id_device'] = $this->sc_temp_id_device;}
if (isset($this->sc_temp_codrfid)) {$_SESSION['codrfid'] = $this->sc_temp_codrfid;}
$_SESSION['scriptcase']['blank_reader_arcade']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
   ...
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0, $opc="")
   {
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['blank_reader_arcade'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['blank_reader_arcade']['iframe_print']) && $_SESSION['sc_session'][$this->Ini->sc_page]['blank_reader_arcade']['iframe_print'] )
      {
          $target = "_parent";
      }
   ?>
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_blank_reader_arcade($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_imag_temp'] . "/sc_apl_default_pointofsales.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['blank_reader_arcade']['glo_nm_path_imag_temp'] . "/sc_apl_default_pointofsales.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "blank_reader_arcade") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['blank_reader_arcade']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['blank_reader_arcade']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['blank_reader_arcade']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_pointofsales'])) {
               $_SESSION['scriptcase']['blank_reader_arcade']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_pointofsales'];
           }
       }
   }
   ...
   if (isset($_POST["id_device"])) 
   {
       ...
       nm_limpa_str_blank_reader_arcade($_SESSION["id_device"]);
   }
   ...
   if (isset($_POST["codrfid"])) 
   {
       ...
       nm_limpa_str_blank_reader_arcade($_SESSION["codrfid"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['blank_reader_arcade']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['blank_reader_arcade']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['blank_reader_arcade']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "blank_reader_arcade";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'blank_reader_arcade' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['blank_reader_arcade']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['blank_reader_arcade']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['blank_reader_arcade']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['blank_reader_arcade']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['blank_reader_arcade']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('blank_reader_arcade' == $sReferer || 'blank_reader_arcade_' == substr($sReferer, 0, 20))
       {
           $_SESSION['sc_session'][$script_case_init]['blank_reader_arcade']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'blank_reader_arcade')
   {
       $_SESSION['sc_session'][$script_case_init]['blank_reader_arcade']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['blank_reader_arcade']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/blank_reader_arcade_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_blank_reader_arcade($cadapar[1]);
   ...
   $contr_blank_reader_arcade = new blank_reader_arcade_apl();
   $contr_blank_reader_arcade->controle();
//
   function nm_limpa_str_blank_reader_arcade(&$str)
   {
   }
?>
