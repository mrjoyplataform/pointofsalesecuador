...
<?php
   ...
   $Ord_Cmp = new grid_customer_family_with_idcliente_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_customer_family_with_idcliente_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idcustomer"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['labels']["idcustomer"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['labels']["idcustomer"] : "Cliente";
   $tab_ger_campos['parentesco'] = "on";
   $tab_def_campos['parentesco'] = "parentesco";
   $tab_labels["parentesco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['labels']["parentesco"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['labels']["parentesco"] : "Parentesco";
   $tab_ger_campos['sexo'] = "on";
   $tab_def_campos['sexo'] = "sexo";
   $tab_labels["sexo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['labels']["sexo"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['labels']["sexo"] : "Sexo";
   $tab_ger_campos['fecha_nacimiento'] = "on";
   $tab_def_campos['fecha_nacimiento'] = "fecha_nacimiento";
   $tab_labels["fecha_nacimiento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['labels']["fecha_nacimiento"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['labels']["fecha_nacimiento"] : "Fecha Nacimiento";
   $tab_ger_campos['edad_actual'] = "on";
   $tab_def_campos['edad_actual'] = "EDAD_ACTUAL";
   $tab_labels["edad_actual"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['labels']["edad_actual"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['labels']["edad_actual"] : "Edad Actual";
   $tab_ger_campos['tipo_sub'] = "on";
   $tab_def_campos['tipo_sub'] = "tipo_sub";
   $tab_labels["tipo_sub"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['labels']["tipo_sub"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['labels']["tipo_sub"] : "Tipo Sub";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "nombre";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['labels']["nombre"] : "Nombre";
   $tab_ger_campos['email'] = "on";
   $tab_def_campos['email'] = "email";
   $tab_labels["email"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['labels']["email"])) ? $_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['labels']["email"] : "Email";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_customer_family_with_idcliente_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_customer_family_with_idcliente']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
