...
<HTML>
<HEAD>
 <TITLE> v_ele_contribuyentes</TITLE>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_razon_social_cond" name="razon_social_cond" onChange="nm_campos_between(document.getElementById('id_vis_razon_social'), this, 'razon_social')">
      ...
      <br><span id="id_hide_razon_social"  <?php echo $str_hide_razon_social?>><?php
      if ($razon_social != "")
      {
      $razon_social_look = substr($this->Db->qstr($razon_social), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nombre_comercial_cond" name="nombre_comercial_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombre_comercial'), this, 'nombre_comercial')">
