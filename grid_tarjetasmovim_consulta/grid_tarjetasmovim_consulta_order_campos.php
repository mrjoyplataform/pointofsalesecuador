...
<?php
   ...
   $Ord_Cmp = new grid_tarjetasmovim_consulta_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tarjetasmovim_consulta_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['tipomov'] = "tipomov";
   $tab_labels["tipomov"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['labels']["tipomov"])) ? $_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['labels']["tipomov"] : "Tipomov";
   $tab_ger_campos['idmaq'] = "on";
   $tab_def_campos['idmaq'] = "idmaq";
   $tab_labels["idmaq"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['labels']["idmaq"])) ? $_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['labels']["idmaq"] : "Idmaq";
   $tab_ger_campos['credito_tokens'] = "on";
   $tab_def_campos['credito_tokens'] = "credito_tokens";
   $tab_labels["credito_tokens"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['labels']["credito_tokens"])) ? $_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['labels']["credito_tokens"] : "Credito Tokens";
   $tab_ger_campos['debito_tokens'] = "on";
   $tab_def_campos['debito_tokens'] = "debito_tokens";
   $tab_labels["debito_tokens"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['labels']["debito_tokens"])) ? $_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['labels']["debito_tokens"] : "Debito Tokens";
   $tab_ger_campos['saldo_tokens'] = "on";
   $tab_def_campos['saldo_tokens'] = "saldo_tokens";
   $tab_labels["saldo_tokens"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['labels']["saldo_tokens"])) ? $_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['labels']["saldo_tokens"] : "Saldo Tokens";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['labels']["fecha"] : "Fecha";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tarjetasmovim_consulta_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tarjetasmovim_consulta']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
