...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "credito_tokens";$Nm_numeric[] = "debito_tokens";$Nm_numeric[] = "idmaq";$Nm_numeric[] = "numcaja";$Nm_numeric[] = "saldo_tokens";$Nm_numeric[] = "saldo_anterior";$Nm_numeric[] = "credito_tokens";$Nm_numeric[] = "debito_tokens";$Nm_numeric[] = "idmaq";$Nm_numeric[] = "numcaja";$Nm_numeric[] = "saldo_tokens";$Nm_numeric[] = "saldo_anterior";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_codtarjeta_cond" name="codtarjeta_cond" onChange="nm_campos_between(document.getElementById('id_vis_codtarjeta'), this, 'codtarjeta')">
      ...
      <br><span id="id_hide_codtarjeta"  <?php echo $str_hide_codtarjeta?>><?php
      if ($codtarjeta != "")
      {
      $codtarjeta_look = substr($this->Db->qstr($codtarjeta), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_tipomov_cond" name="tipomov_cond" onChange="nm_campos_between(document.getElementById('id_vis_tipomov'), this, 'tipomov')">
      ...
      <br><span id="id_hide_tipomov"  <?php echo $str_hide_tipomov?>><?php
      if ($tipomov != "")
      {
      $tipomov_look = substr($this->Db->qstr($tipomov), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_credito_tokens_cond" name="credito_tokens_cond" onChange="nm_campos_between(document.getElementById('id_vis_credito_tokens'), this, 'credito_tokens')">
