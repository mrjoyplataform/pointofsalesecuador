...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_maepro/form_maepro_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_maepro_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_maepro_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['form_maepro']['error_buffer']) && '' != $_SESSION['scriptcase']['form_maepro']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_maepro']['error_buffer'];
}
...
<?php
 include_once("form_maepro_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_maepro_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_maepro_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_maepro_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
?>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_codprod01_line" id="hidden_field_data_codprod01" style="<?php echo $sStyleHidden_codprod01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_codprod01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_codprod01_label" style=""><span id="id_label_codprod01"><?php echo $this->nm_new_label['codprod01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['codprod01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['codprod01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_desprod01_line" id="hidden_field_data_desprod01" style="<?php echo $sStyleHidden_desprod01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_desprod01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_desprod01_label" style=""><span id="id_label_desprod01"><?php echo $this->nm_new_label['desprod01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cve101_line" id="hidden_field_data_cve101" style="<?php echo $sStyleHidden_cve101; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cve101_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cve101_label" style=""><span id="id_label_cve101"><?php echo $this->nm_new_label['cve101']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cve201_line" id="hidden_field_data_cve201" style="<?php echo $sStyleHidden_cve201; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cve201_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cve201_label" style=""><span id="id_label_cve201"><?php echo $this->nm_new_label['cve201']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_unidmed01_line" id="hidden_field_data_unidmed01" style="<?php echo $sStyleHidden_unidmed01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_unidmed01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_unidmed01_label" style=""><span id="id_label_unidmed01"><?php echo $this->nm_new_label['unidmed01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cantmin01_line" id="hidden_field_data_cantmin01" style="<?php echo $sStyleHidden_cantmin01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cantmin01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cantmin01_label" style=""><span id="id_label_cantmin01"><?php echo $this->nm_new_label['cantmin01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cantact01_line" id="hidden_field_data_cantact01" style="<?php echo $sStyleHidden_cantact01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cantact01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cantact01_label" style=""><span id="id_label_cantact01"><?php echo $this->nm_new_label['cantact01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_valact01_line" id="hidden_field_data_valact01" style="<?php echo $sStyleHidden_valact01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valact01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_valact01_label" style=""><span id="id_label_valact01"><?php echo $this->nm_new_label['valact01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_exipromo01_line" id="hidden_field_data_exipromo01" style="<?php echo $sStyleHidden_exipromo01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_exipromo01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_exipromo01_label" style=""><span id="id_label_exipromo01"><?php echo $this->nm_new_label['exipromo01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_precuni01_line" id="hidden_field_data_precuni01" style="<?php echo $sStyleHidden_precuni01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_precuni01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_precuni01_label" style=""><span id="id_label_precuni01"><?php echo $this->nm_new_label['precuni01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pedpend01_line" id="hidden_field_data_pedpend01" style="<?php echo $sStyleHidden_pedpend01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pedpend01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pedpend01_label" style=""><span id="id_label_pedpend01"><?php echo $this->nm_new_label['pedpend01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_orden01_line" id="hidden_field_data_orden01" style="<?php echo $sStyleHidden_orden01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_orden01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_orden01_label" style=""><span id="id_label_orden01"><?php echo $this->nm_new_label['orden01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_refer01_line" id="hidden_field_data_refer01" style="<?php echo $sStyleHidden_refer01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_refer01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_refer01_label" style=""><span id="id_label_refer01"><?php echo $this->nm_new_label['refer01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_canentm01_line" id="hidden_field_data_canentm01" style="<?php echo $sStyleHidden_canentm01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_canentm01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_canentm01_label" style=""><span id="id_label_canentm01"><?php echo $this->nm_new_label['canentm01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_valentm01_line" id="hidden_field_data_valentm01" style="<?php echo $sStyleHidden_valentm01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valentm01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_valentm01_label" style=""><span id="id_label_valentm01"><?php echo $this->nm_new_label['valentm01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cansalm01_line" id="hidden_field_data_cansalm01" style="<?php echo $sStyleHidden_cansalm01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cansalm01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cansalm01_label" style=""><span id="id_label_cansalm01"><?php echo $this->nm_new_label['cansalm01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_valsalm01_line" id="hidden_field_data_valsalm01" style="<?php echo $sStyleHidden_valsalm01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valsalm01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_valsalm01_label" style=""><span id="id_label_valsalm01"><?php echo $this->nm_new_label['valsalm01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_canenta01_line" id="hidden_field_data_canenta01" style="<?php echo $sStyleHidden_canenta01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_canenta01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_canenta01_label" style=""><span id="id_label_canenta01"><?php echo $this->nm_new_label['canenta01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_valenta01_line" id="hidden_field_data_valenta01" style="<?php echo $sStyleHidden_valenta01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valenta01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_valenta01_label" style=""><span id="id_label_valenta01"><?php echo $this->nm_new_label['valenta01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cansala01_line" id="hidden_field_data_cansala01" style="<?php echo $sStyleHidden_cansala01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cansala01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cansala01_label" style=""><span id="id_label_cansala01"><?php echo $this->nm_new_label['cansala01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_valsala01_line" id="hidden_field_data_valsala01" style="<?php echo $sStyleHidden_valsala01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valsala01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_valsala01_label" style=""><span id="id_label_valsala01"><?php echo $this->nm_new_label['valsala01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fecape01_line" id="hidden_field_data_fecape01" style="<?php echo $sStyleHidden_fecape01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecape01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fecape01_label" style=""><span id="id_label_fecape01"><?php echo $this->nm_new_label['fecape01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fecult01_line" id="hidden_field_data_fecult01" style="<?php echo $sStyleHidden_fecult01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecult01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fecult01_label" style=""><span id="id_label_fecult01"><?php echo $this->nm_new_label['fecult01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fecvta01_line" id="hidden_field_data_fecvta01" style="<?php echo $sStyleHidden_fecvta01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecvta01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fecvta01_label" style=""><span id="id_label_fecvta01"><?php echo $this->nm_new_label['fecvta01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ubic01_line" id="hidden_field_data_ubic01" style="<?php echo $sStyleHidden_ubic01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ubic01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ubic01_label" style=""><span id="id_label_ubic01"><?php echo $this->nm_new_label['ubic01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_precvta01_line" id="hidden_field_data_precvta01" style="<?php echo $sStyleHidden_precvta01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_precvta01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_precvta01_label" style=""><span id="id_label_precvta01"><?php echo $this->nm_new_label['precvta01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_descto101_line" id="hidden_field_data_descto101" style="<?php echo $sStyleHidden_descto101; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_descto101_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_descto101_label" style=""><span id="id_label_descto101"><?php echo $this->nm_new_label['descto101']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_precio201_line" id="hidden_field_data_precio201" style="<?php echo $sStyleHidden_precio201; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_precio201_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_precio201_label" style=""><span id="id_label_precio201"><?php echo $this->nm_new_label['precio201']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_descto201_line" id="hidden_field_data_descto201" style="<?php echo $sStyleHidden_descto201; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_descto201_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_descto201_label" style=""><span id="id_label_descto201"><?php echo $this->nm_new_label['descto201']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_precio301_line" id="hidden_field_data_precio301" style="<?php echo $sStyleHidden_precio301; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_precio301_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_precio301_label" style=""><span id="id_label_precio301"><?php echo $this->nm_new_label['precio301']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_descto301_line" id="hidden_field_data_descto301" style="<?php echo $sStyleHidden_descto301; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_descto301_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_descto301_label" style=""><span id="id_label_descto301"><?php echo $this->nm_new_label['descto301']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_canvtam01_line" id="hidden_field_data_canvtam01" style="<?php echo $sStyleHidden_canvtam01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_canvtam01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_canvtam01_label" style=""><span id="id_label_canvtam01"><?php echo $this->nm_new_label['canvtam01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_valvtam01_line" id="hidden_field_data_valvtam01" style="<?php echo $sStyleHidden_valvtam01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valvtam01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_valvtam01_label" style=""><span id="id_label_valvtam01"><?php echo $this->nm_new_label['valvtam01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cosvtam01_line" id="hidden_field_data_cosvtam01" style="<?php echo $sStyleHidden_cosvtam01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cosvtam01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cosvtam01_label" style=""><span id="id_label_cosvtam01"><?php echo $this->nm_new_label['cosvtam01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_canvtaa01_line" id="hidden_field_data_canvtaa01" style="<?php echo $sStyleHidden_canvtaa01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_canvtaa01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_canvtaa01_label" style=""><span id="id_label_canvtaa01"><?php echo $this->nm_new_label['canvtaa01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_valvtaa01_line" id="hidden_field_data_valvtaa01" style="<?php echo $sStyleHidden_valvtaa01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valvtaa01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_valvtaa01_label" style=""><span id="id_label_valvtaa01"><?php echo $this->nm_new_label['valvtaa01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cosvtaa01_line" id="hidden_field_data_cosvtaa01" style="<?php echo $sStyleHidden_cosvtaa01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cosvtaa01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cosvtaa01_label" style=""><span id="id_label_cosvtaa01"><?php echo $this->nm_new_label['cosvtaa01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_prod1alt01_line" id="hidden_field_data_prod1alt01" style="<?php echo $sStyleHidden_prod1alt01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_prod1alt01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_prod1alt01_label" style=""><span id="id_label_prod1alt01"><?php echo $this->nm_new_label['prod1alt01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_prod2alt01_line" id="hidden_field_data_prod2alt01" style="<?php echo $sStyleHidden_prod2alt01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_prod2alt01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_prod2alt01_label" style=""><span id="id_label_prod2alt01"><?php echo $this->nm_new_label['prod2alt01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_proved101_line" id="hidden_field_data_proved101" style="<?php echo $sStyleHidden_proved101; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_proved101_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_proved101_label" style=""><span id="id_label_proved101"><?php echo $this->nm_new_label['proved101']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_proved201_line" id="hidden_field_data_proved201" style="<?php echo $sStyleHidden_proved201; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_proved201_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_proved201_label" style=""><span id="id_label_proved201"><?php echo $this->nm_new_label['proved201']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_med101_line" id="hidden_field_data_med101" style="<?php echo $sStyleHidden_med101; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_med101_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_med101_label" style=""><span id="id_label_med101"><?php echo $this->nm_new_label['med101']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_med201_line" id="hidden_field_data_med201" style="<?php echo $sStyleHidden_med201; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_med201_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_med201_label" style=""><span id="id_label_med201"><?php echo $this->nm_new_label['med201']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_med301_line" id="hidden_field_data_med301" style="<?php echo $sStyleHidden_med301; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_med301_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_med301_label" style=""><span id="id_label_med301"><?php echo $this->nm_new_label['med301']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_factor01_line" id="hidden_field_data_factor01" style="<?php echo $sStyleHidden_factor01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_factor01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_factor01_label" style=""><span id="id_label_factor01"><?php echo $this->nm_new_label['factor01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cvserie01_line" id="hidden_field_data_cvserie01" style="<?php echo $sStyleHidden_cvserie01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cvserie01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cvserie01_label" style=""><span id="id_label_cvserie01"><?php echo $this->nm_new_label['cvserie01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ctain101_line" id="hidden_field_data_ctain101" style="<?php echo $sStyleHidden_ctain101; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ctain101_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ctain101_label" style=""><span id="id_label_ctain101"><?php echo $this->nm_new_label['ctain101']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['ctain101']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['ctain101'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ctain201_line" id="hidden_field_data_ctain201" style="<?php echo $sStyleHidden_ctain201; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ctain201_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ctain201_label" style=""><span id="id_label_ctain201"><?php echo $this->nm_new_label['ctain201']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['ctain201']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['ctain201'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ctain301_line" id="hidden_field_data_ctain301" style="<?php echo $sStyleHidden_ctain301; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ctain301_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ctain301_label" style=""><span id="id_label_ctain301"><?php echo $this->nm_new_label['ctain301']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['ctain301']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['ctain301'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_porciva01_line" id="hidden_field_data_porciva01" style="<?php echo $sStyleHidden_porciva01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_porciva01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_porciva01_label" style=""><span id="id_label_porciva01"><?php echo $this->nm_new_label['porciva01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_prodsinsdo01_line" id="hidden_field_data_prodsinsdo01" style="<?php echo $sStyleHidden_prodsinsdo01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_prodsinsdo01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_prodsinsdo01_label" style=""><span id="id_label_prodsinsdo01"><?php echo $this->nm_new_label['prodsinsdo01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_sinprec01_line" id="hidden_field_data_sinprec01" style="<?php echo $sStyleHidden_sinprec01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sinprec01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_sinprec01_label" style=""><span id="id_label_sinprec01"><?php echo $this->nm_new_label['sinprec01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fotoprod01_line" id="hidden_field_data_fotoprod01" style="<?php echo $sStyleHidden_fotoprod01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fotoprod01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fotoprod01_label" style=""><span id="id_label_fotoprod01"><?php echo $this->nm_new_label['fotoprod01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_detprod01_line" id="hidden_field_data_detprod01" style="<?php echo $sStyleHidden_detprod01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_detprod01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_detprod01_label" style=""><span id="id_label_detprod01"><?php echo $this->nm_new_label['detprod01']; ?></span></span><br>
<?php
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_idpro_line" id="hidden_field_data_idpro" style="<?php echo $sStyleHidden_idpro; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idpro_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idpro_label" style=""><span id="id_label_idpro"><?php echo $this->nm_new_label['idpro']; ?></span></span><br><span id="id_read_on_idpro" class="css_idpro_line" style="<?php echo $sStyleReadLab_idpro; ?>"><?php echo $this->form_format_readonly("idpro", $this->form_encode_input($this->idpro)); ?></span><span id="id_read_off_idpro" class="css_read_off_idpro" style="<?php echo $sStyleReadInp_idpro; ?>"><input type="hidden" name="idpro" value="<?php echo $this->form_encode_input($idpro) . "\">"?><span id="id_ajax_label_idpro"><?php echo nl2br($idpro); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_catprod01_line" id="hidden_field_data_catprod01" style="<?php echo $sStyleHidden_catprod01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_catprod01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_catprod01_label" style=""><span id="id_label_catprod01"><?php echo $this->nm_new_label['catprod01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['catprod01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['catprod01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_med401_line" id="hidden_field_data_med401" style="<?php echo $sStyleHidden_med401; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_med401_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_med401_label" style=""><span id="id_label_med401"><?php echo $this->nm_new_label['med401']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_med501_line" id="hidden_field_data_med501" style="<?php echo $sStyleHidden_med501; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_med501_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_med501_label" style=""><span id="id_label_med501"><?php echo $this->nm_new_label['med501']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_prodconmed01_line" id="hidden_field_data_prodconmed01" style="<?php echo $sStyleHidden_prodconmed01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_prodconmed01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_prodconmed01_label" style=""><span id="id_label_prodconmed01"><?php echo $this->nm_new_label['prodconmed01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_factorpeso01_line" id="hidden_field_data_factorpeso01" style="<?php echo $sStyleHidden_factorpeso01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_factorpeso01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_factorpeso01_label" style=""><span id="id_label_factorpeso01"><?php echo $this->nm_new_label['factorpeso01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_codbar01_line" id="hidden_field_data_codbar01" style="<?php echo $sStyleHidden_codbar01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_codbar01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_codbar01_label" style=""><span id="id_label_codbar01"><?php echo $this->nm_new_label['codbar01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_unifrac01_line" id="hidden_field_data_unifrac01" style="<?php echo $sStyleHidden_unifrac01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_unifrac01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_unifrac01_label" style=""><span id="id_label_unifrac01"><?php echo $this->nm_new_label['unifrac01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_calidad01_line" id="hidden_field_data_calidad01" style="<?php echo $sStyleHidden_calidad01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_calidad01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_calidad01_label" style=""><span id="id_label_calidad01"><?php echo $this->nm_new_label['calidad01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['calidad01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['calidad01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_color01_line" id="hidden_field_data_color01" style="<?php echo $sStyleHidden_color01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_color01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_color01_label" style=""><span id="id_label_color01"><?php echo $this->nm_new_label['color01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['color01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['color01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_material01_line" id="hidden_field_data_material01" style="<?php echo $sStyleHidden_material01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_material01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_material01_label" style=""><span id="id_label_material01"><?php echo $this->nm_new_label['material01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['material01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['material01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_talla01_line" id="hidden_field_data_talla01" style="<?php echo $sStyleHidden_talla01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_talla01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_talla01_label" style=""><span id="id_label_talla01"><?php echo $this->nm_new_label['talla01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['talla01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['talla01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_compuesto01_line" id="hidden_field_data_compuesto01" style="<?php echo $sStyleHidden_compuesto01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_compuesto01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_compuesto01_label" style=""><span id="id_label_compuesto01"><?php echo $this->nm_new_label['compuesto01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['compuesto01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['compuesto01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_catalt01_line" id="hidden_field_data_catalt01" style="<?php echo $sStyleHidden_catalt01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_catalt01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_catalt01_label" style=""><span id="id_label_catalt01"><?php echo $this->nm_new_label['catalt01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['catalt01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['catalt01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_precfob01_line" id="hidden_field_data_precfob01" style="<?php echo $sStyleHidden_precfob01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_precfob01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_precfob01_label" style=""><span id="id_label_precfob01"><?php echo $this->nm_new_label['precfob01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['precfob01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['precfob01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_precio401_line" id="hidden_field_data_precio401" style="<?php echo $sStyleHidden_precio401; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_precio401_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_precio401_label" style=""><span id="id_label_precio401"><?php echo $this->nm_new_label['precio401']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['precio401']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['precio401'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_descto401_line" id="hidden_field_data_descto401" style="<?php echo $sStyleHidden_descto401; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_descto401_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_descto401_label" style=""><span id="id_label_descto401"><?php echo $this->nm_new_label['descto401']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['descto401']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['descto401'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_porigen01_line" id="hidden_field_data_porigen01" style="<?php echo $sStyleHidden_porigen01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_porigen01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_porigen01_label" style=""><span id="id_label_porigen01"><?php echo $this->nm_new_label['porigen01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['porigen01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['porigen01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rin01_line" id="hidden_field_data_rin01" style="<?php echo $sStyleHidden_rin01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rin01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rin01_label" style=""><span id="id_label_rin01"><?php echo $this->nm_new_label['rin01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['rin01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['rin01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_marca01_line" id="hidden_field_data_marca01" style="<?php echo $sStyleHidden_marca01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_marca01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_marca01_label" style=""><span id="id_label_marca01"><?php echo $this->nm_new_label['marca01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['marca01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['marca01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_alto01_line" id="hidden_field_data_alto01" style="<?php echo $sStyleHidden_alto01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_alto01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_alto01_label" style=""><span id="id_label_alto01"><?php echo $this->nm_new_label['alto01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['alto01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['alto01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ancho01_line" id="hidden_field_data_ancho01" style="<?php echo $sStyleHidden_ancho01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ancho01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ancho01_label" style=""><span id="id_label_ancho01"><?php echo $this->nm_new_label['ancho01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['ancho01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['ancho01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tipoletra01_line" id="hidden_field_data_tipoletra01" style="<?php echo $sStyleHidden_tipoletra01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipoletra01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tipoletra01_label" style=""><span id="id_label_tipoletra01"><?php echo $this->nm_new_label['tipoletra01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['tipoletra01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['tipoletra01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_indcarga01_line" id="hidden_field_data_indcarga01" style="<?php echo $sStyleHidden_indcarga01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_indcarga01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_indcarga01_label" style=""><span id="id_label_indcarga01"><?php echo $this->nm_new_label['indcarga01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['indcarga01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['indcarga01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_indveloc01_line" id="hidden_field_data_indveloc01" style="<?php echo $sStyleHidden_indveloc01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_indveloc01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_indveloc01_label" style=""><span id="id_label_indveloc01"><?php echo $this->nm_new_label['indveloc01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['indveloc01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['indveloc01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pr01_line" id="hidden_field_data_pr01" style="<?php echo $sStyleHidden_pr01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pr01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_pr01_label" style=""><span id="id_label_pr01"><?php echo $this->nm_new_label['pr01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['pr01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['pr01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_dis01_line" id="hidden_field_data_dis01" style="<?php echo $sStyleHidden_dis01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dis01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_dis01_label" style=""><span id="id_label_dis01"><?php echo $this->nm_new_label['dis01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['dis01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['dis01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tipocons01_line" id="hidden_field_data_tipocons01" style="<?php echo $sStyleHidden_tipocons01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipocons01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tipocons01_label" style=""><span id="id_label_tipocons01"><?php echo $this->nm_new_label['tipocons01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['tipocons01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['tipocons01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_precateg01_line" id="hidden_field_data_precateg01" style="<?php echo $sStyleHidden_precateg01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_precateg01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_precateg01_label" style=""><span id="id_label_precateg01"><?php echo $this->nm_new_label['precateg01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['precateg01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['precateg01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tipprod01_line" id="hidden_field_data_tipprod01" style="<?php echo $sStyleHidden_tipprod01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipprod01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tipprod01_label" style=""><span id="id_label_tipprod01"><?php echo $this->nm_new_label['tipprod01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['tipprod01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['tipprod01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_conversion01_line" id="hidden_field_data_conversion01" style="<?php echo $sStyleHidden_conversion01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_conversion01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_conversion01_label" style=""><span id="id_label_conversion01"><?php echo $this->nm_new_label['conversion01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['conversion01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['conversion01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_valhom01_line" id="hidden_field_data_valhom01" style="<?php echo $sStyleHidden_valhom01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valhom01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_valhom01_label" style=""><span id="id_label_valhom01"><?php echo $this->nm_new_label['valhom01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['valhom01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['valhom01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ctain401_line" id="hidden_field_data_ctain401" style="<?php echo $sStyleHidden_ctain401; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ctain401_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ctain401_label" style=""><span id="id_label_ctain401"><?php echo $this->nm_new_label['ctain401']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['ctain401']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['ctain401'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_valhom02_line" id="hidden_field_data_valhom02" style="<?php echo $sStyleHidden_valhom02; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valhom02_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_valhom02_label" style=""><span id="id_label_valhom02"><?php echo $this->nm_new_label['valhom02']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['valhom02']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['valhom02'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_valhom03_line" id="hidden_field_data_valhom03" style="<?php echo $sStyleHidden_valhom03; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valhom03_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_valhom03_label" style=""><span id="id_label_valhom03"><?php echo $this->nm_new_label['valhom03']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['valhom03']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['valhom03'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_valhom04_line" id="hidden_field_data_valhom04" style="<?php echo $sStyleHidden_valhom04; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valhom04_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_valhom04_label" style=""><span id="id_label_valhom04"><?php echo $this->nm_new_label['valhom04']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['valhom04']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['valhom04'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_statuspro01_line" id="hidden_field_data_statuspro01" style="<?php echo $sStyleHidden_statuspro01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_statuspro01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_statuspro01_label" style=""><span id="id_label_statuspro01"><?php echo $this->nm_new_label['statuspro01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['statuspro01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['statuspro01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_parara01_line" id="hidden_field_data_parara01" style="<?php echo $sStyleHidden_parara01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_parara01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_parara01_label" style=""><span id="id_label_parara01"><?php echo $this->nm_new_label['parara01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['parara01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['parara01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_prodequiv01_line" id="hidden_field_data_prodequiv01" style="<?php echo $sStyleHidden_prodequiv01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_prodequiv01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_prodequiv01_label" style=""><span id="id_label_prodequiv01"><?php echo $this->nm_new_label['prodequiv01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['prodequiv01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['prodequiv01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_regalia01_line" id="hidden_field_data_regalia01" style="<?php echo $sStyleHidden_regalia01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_regalia01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_regalia01_label" style=""><span id="id_label_regalia01"><?php echo $this->nm_new_label['regalia01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['regalia01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['regalia01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_precio501_line" id="hidden_field_data_precio501" style="<?php echo $sStyleHidden_precio501; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_precio501_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_precio501_label" style=""><span id="id_label_precio501"><?php echo $this->nm_new_label['precio501']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_descto501_line" id="hidden_field_data_descto501" style="<?php echo $sStyleHidden_descto501; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_descto501_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_descto501_label" style=""><span id="id_label_descto501"><?php echo $this->nm_new_label['descto501']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['descto501']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['descto501'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_precio601_line" id="hidden_field_data_precio601" style="<?php echo $sStyleHidden_precio601; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_precio601_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_precio601_label" style=""><span id="id_label_precio601"><?php echo $this->nm_new_label['precio601']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_descto601_line" id="hidden_field_data_descto601" style="<?php echo $sStyleHidden_descto601; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_descto601_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_descto601_label" style=""><span id="id_label_descto601"><?php echo $this->nm_new_label['descto601']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['descto601']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['descto601'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_precio701_line" id="hidden_field_data_precio701" style="<?php echo $sStyleHidden_precio701; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_precio701_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_precio701_label" style=""><span id="id_label_precio701"><?php echo $this->nm_new_label['precio701']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_descto701_line" id="hidden_field_data_descto701" style="<?php echo $sStyleHidden_descto701; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_descto701_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_descto701_label" style=""><span id="id_label_descto701"><?php echo $this->nm_new_label['descto701']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['descto701']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['descto701'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_precio801_line" id="hidden_field_data_precio801" style="<?php echo $sStyleHidden_precio801; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_precio801_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_precio801_label" style=""><span id="id_label_precio801"><?php echo $this->nm_new_label['precio801']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_descto801_line" id="hidden_field_data_descto801" style="<?php echo $sStyleHidden_descto801; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_descto801_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_descto801_label" style=""><span id="id_label_descto801"><?php echo $this->nm_new_label['descto801']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['descto801']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['descto801'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_precio901_line" id="hidden_field_data_precio901" style="<?php echo $sStyleHidden_precio901; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_precio901_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_precio901_label" style=""><span id="id_label_precio901"><?php echo $this->nm_new_label['precio901']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_descto901_line" id="hidden_field_data_descto901" style="<?php echo $sStyleHidden_descto901; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_descto901_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_descto901_label" style=""><span id="id_label_descto901"><?php echo $this->nm_new_label['descto901']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['descto901']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['descto901'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_precio1001_line" id="hidden_field_data_precio1001" style="<?php echo $sStyleHidden_precio1001; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_precio1001_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_precio1001_label" style=""><span id="id_label_precio1001"><?php echo $this->nm_new_label['precio1001']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_descto1001_line" id="hidden_field_data_descto1001" style="<?php echo $sStyleHidden_descto1001; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_descto1001_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_descto1001_label" style=""><span id="id_label_descto1001"><?php echo $this->nm_new_label['descto1001']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['descto1001']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['descto1001'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_precio1101_line" id="hidden_field_data_precio1101" style="<?php echo $sStyleHidden_precio1101; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_precio1101_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_precio1101_label" style=""><span id="id_label_precio1101"><?php echo $this->nm_new_label['precio1101']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_descto1101_line" id="hidden_field_data_descto1101" style="<?php echo $sStyleHidden_descto1101; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_descto1101_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_descto1101_label" style=""><span id="id_label_descto1101"><?php echo $this->nm_new_label['descto1101']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['descto1101']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['descto1101'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_precio1201_line" id="hidden_field_data_precio1201" style="<?php echo $sStyleHidden_precio1201; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_precio1201_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_precio1201_label" style=""><span id="id_label_precio1201"><?php echo $this->nm_new_label['precio1201']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['precio1201']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['precio1201'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_descto1201_line" id="hidden_field_data_descto1201" style="<?php echo $sStyleHidden_descto1201; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_descto1201_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_descto1201_label" style=""><span id="id_label_descto1201"><?php echo $this->nm_new_label['descto1201']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['descto1201']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['descto1201'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_submarca01_line" id="hidden_field_data_submarca01" style="<?php echo $sStyleHidden_submarca01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_submarca01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_submarca01_label" style=""><span id="id_label_submarca01"><?php echo $this->nm_new_label['submarca01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_modelo01_line" id="hidden_field_data_modelo01" style="<?php echo $sStyleHidden_modelo01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_modelo01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_modelo01_label" style=""><span id="id_label_modelo01"><?php echo $this->nm_new_label['modelo01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_clasific01_line" id="hidden_field_data_clasific01" style="<?php echo $sStyleHidden_clasific01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_clasific01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_clasific01_label" style=""><span id="id_label_clasific01"><?php echo $this->nm_new_label['clasific01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['clasific01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['clasific01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_codbarempaque01_line" id="hidden_field_data_codbarempaque01" style="<?php echo $sStyleHidden_codbarempaque01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_codbarempaque01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_codbarempaque01_label" style=""><span id="id_label_codbarempaque01"><?php echo $this->nm_new_label['codbarempaque01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_unidadempaque01_line" id="hidden_field_data_unidadempaque01" style="<?php echo $sStyleHidden_unidadempaque01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_unidadempaque01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_unidadempaque01_label" style=""><span id="id_label_unidadempaque01"><?php echo $this->nm_new_label['unidadempaque01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_dimensionempaque01_line" id="hidden_field_data_dimensionempaque01" style="<?php echo $sStyleHidden_dimensionempaque01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dimensionempaque01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_dimensionempaque01_label" style=""><span id="id_label_dimensionempaque01"><?php echo $this->nm_new_label['dimensionempaque01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_link01_line" id="hidden_field_data_link01" style="<?php echo $sStyleHidden_link01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_link01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_link01_label" style=""><span id="id_label_link01"><?php echo $this->nm_new_label['link01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['link01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['link01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_desprod201_line" id="hidden_field_data_desprod201" style="<?php echo $sStyleHidden_desprod201; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_desprod201_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_desprod201_label" style=""><span id="id_label_desprod201"><?php echo $this->nm_new_label['desprod201']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['desprod201']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['desprod201'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_desprod301_line" id="hidden_field_data_desprod301" style="<?php echo $sStyleHidden_desprod301; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_desprod301_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_desprod301_label" style=""><span id="id_label_desprod301"><?php echo $this->nm_new_label['desprod301']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['desprod301']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['desprod301'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_coefprd01_line" id="hidden_field_data_coefprd01" style="<?php echo $sStyleHidden_coefprd01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_coefprd01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_coefprd01_label" style=""><span id="id_label_coefprd01"><?php echo $this->nm_new_label['coefprd01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_infor01_line" id="hidden_field_data_infor01" style="<?php echo $sStyleHidden_infor01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_infor01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_infor01_label" style=""><span id="id_label_infor01"><?php echo $this->nm_new_label['infor01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['infor01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['infor01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_infor03_line" id="hidden_field_data_infor03" style="<?php echo $sStyleHidden_infor03; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_infor03_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_infor03_label" style=""><span id="id_label_infor03"><?php echo $this->nm_new_label['infor03']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['infor03']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['infor03'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_infor05_line" id="hidden_field_data_infor05" style="<?php echo $sStyleHidden_infor05; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_infor05_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_infor05_label" style=""><span id="id_label_infor05"><?php echo $this->nm_new_label['infor05']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['infor05']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['infor05'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_infor07_line" id="hidden_field_data_infor07" style="<?php echo $sStyleHidden_infor07; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_infor07_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_infor07_label" style=""><span id="id_label_infor07"><?php echo $this->nm_new_label['infor07']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['infor07']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['infor07'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_porcenrenta_line" id="hidden_field_data_porcenrenta" style="<?php echo $sStyleHidden_porcenrenta; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_porcenrenta_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_porcenrenta_label" style=""><span id="id_label_porcenrenta"><?php echo $this->nm_new_label['porcenrenta']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_peso_line" id="hidden_field_data_peso" style="<?php echo $sStyleHidden_peso; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_peso_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_peso_label" style=""><span id="id_label_peso"><?php echo $this->nm_new_label['peso']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['peso']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['peso'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_consignado_line" id="hidden_field_data_consignado" style="<?php echo $sStyleHidden_consignado; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_consignado_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_consignado_label" style=""><span id="id_label_consignado"><?php echo $this->nm_new_label['consignado']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['consignado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['consignado'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cant_consignado_line" id="hidden_field_data_cant_consignado" style="<?php echo $sStyleHidden_cant_consignado; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cant_consignado_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cant_consignado_label" style=""><span id="id_label_cant_consignado"><?php echo $this->nm_new_label['cant_consignado']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['cant_consignado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['cant_consignado'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_baseimpexe01_line" id="hidden_field_data_baseimpexe01" style="<?php echo $sStyleHidden_baseimpexe01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_baseimpexe01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_baseimpexe01_label" style=""><span id="id_label_baseimpexe01"><?php echo $this->nm_new_label['baseimpexe01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['baseimpexe01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['baseimpexe01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_peso01_line" id="hidden_field_data_peso01" style="<?php echo $sStyleHidden_peso01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_peso01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_peso01_label" style=""><span id="id_label_peso01"><?php echo $this->nm_new_label['peso01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['peso01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['peso01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_prodrel01_line" id="hidden_field_data_prodrel01" style="<?php echo $sStyleHidden_prodrel01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_prodrel01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_prodrel01_label" style=""><span id="id_label_prodrel01"><?php echo $this->nm_new_label['prodrel01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['prodrel01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['prodrel01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_infor02_line" id="hidden_field_data_infor02" style="<?php echo $sStyleHidden_infor02; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_infor02_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_infor02_label" style=""><span id="id_label_infor02"><?php echo $this->nm_new_label['infor02']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['infor02']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['infor02'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_infor04_line" id="hidden_field_data_infor04" style="<?php echo $sStyleHidden_infor04; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_infor04_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_infor04_label" style=""><span id="id_label_infor04"><?php echo $this->nm_new_label['infor04']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['infor04']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['infor04'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_infor06_line" id="hidden_field_data_infor06" style="<?php echo $sStyleHidden_infor06; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_infor06_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_infor06_label" style=""><span id="id_label_infor06"><?php echo $this->nm_new_label['infor06']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['infor06']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['infor06'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_infor08_line" id="hidden_field_data_infor08" style="<?php echo $sStyleHidden_infor08; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_infor08_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_infor08_label" style=""><span id="id_label_infor08"><?php echo $this->nm_new_label['infor08']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['infor08']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['php_cmp_required']['infor08'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_porcicevta01_line" id="hidden_field_data_porcicevta01" style="<?php echo $sStyleHidden_porcicevta01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_porcicevta01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_porcicevta01_label" style=""><span id="id_label_porcicevta01"><?php echo $this->nm_new_label['porcicevta01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_porcicecpra01_line" id="hidden_field_data_porcicecpra01" style="<?php echo $sStyleHidden_porcicecpra01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_porcicecpra01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_porcicecpra01_label" style=""><span id="id_label_porcicecpra01"><?php echo $this->nm_new_label['porcicecpra01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_porcptdaranc01_line" id="hidden_field_data_porcptdaranc01" style="<?php echo $sStyleHidden_porcptdaranc01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_porcptdaranc01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_porcptdaranc01_label" style=""><span id="id_label_porcptdaranc01"><?php echo $this->nm_new_label['porcptdaranc01']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ordimp01_line" id="hidden_field_data_ordimp01" style="<?php echo $sStyleHidden_ordimp01; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ordimp01_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ordimp01_label" style=""><span id="id_label_ordimp01"><?php echo $this->nm_new_label['ordimp01']; ?></span></span><br>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
    dbParentFrame[0].contentWindow.scAjaxDetailValue('<?php echo $cmp_master ?>', '<?php echo $val_master ?>');
<?php
        }
        unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['masterValue']);
?>
}
<?php
    }
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_maepro_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_maepro_mob");
 parent.scAjaxDetailHeight("form_maepro_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
{
<?php
if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['sc_modal'])
{
?>
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_maepro_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
