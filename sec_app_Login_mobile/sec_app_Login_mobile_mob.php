...
//
   if (!session_id())
   {
   include_once('sec_app_Login_mobile_mob_session.php');
   ...
   @session_start() ;
       ...
       {
          include_once('sec_app_Login_mobile.php');
          exit;
       }
   }
   ...
   $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_perfil']          = "conn_pos";
   $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_path_cache']  = "";
   $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_path_doc']        = "";
   $NM_dir_atual = getcwd();
   ...
   //check prod
   if(empty($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_path_prod']))
   {
           /*check prod*/$_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
   }
   //check img
   if(empty($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_path_imagens']))
   {
           /*check img*/$_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
   }
   //check tmp
   if(empty($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_path_imag_temp']))
   {
           /*check tmp*/$_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
   }
   //check cache
   if(empty($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_path_cache']))
   {
           /*check cache*/$_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
   }
   //check doc
   if(empty($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_path_doc']))
   {
           /*check doc*/$_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
   }
   //end check publication with the prod
//
class sec_app_Login_mobile_mob_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
// 
      ...
      $this->path_prod       = $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_path_prod'];
      $this->path_imagens    = $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_path_imag_temp'];
      $this->path_cache      = $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_path_doc'];
      ...
      if (isset($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['actual_lang']) || $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['actual_lang'] = $this->str_lang;
          setcookie('sc_actual_lang_pointofsales',$this->str_lang,'0','/');
      }
      global $inicial_sec_app_Login_mobile_mob;
      if (isset($_SESSION['scriptcase']['user_logout']))
      {
          foreach ($_SESSION['scriptcase']['user_logout'] as $ind => $parms)
          {
              if (isset($_SESSION[$parms['V']]) && $_SESSION[$parms['V']] == $parms['U'])
              {
                  ...
                  if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_flag) && $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_flag)
                  {
                      $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['redir']['action']  = $nm_apl_dest;
                      $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['redir']['target']  = $parms['T'];
                      $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['redir']['metodo']  = "post";
                      $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['redir']['script_case_init']  = $this->sc_page;
                      sec_app_Login_mobile_mob_pack_ajax_response();
                      exit;
                  }
?>
                  <html>
...
<?php
      ...
      if (isset($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['session_timeout']);
      ...
      {
          $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['redir']['action']  = "sec_app_Login_mobile_mob.php";
          $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['redir']['target']  = "_self";
          $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['redir']['metodo']  = "post";
          $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['redir']['script_case_init']  = $this->sc_page;
          sec_app_Login_mobile_mob_pack_ajax_response();
          exit;
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['session_timeout']['redir']))
      {
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['sc_outra_jan']) || $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['sc_outra_jan'] != 'sec_app_Login_mobile_mob')) 
          { 
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["sec_app_Login_mobile_mob"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["sec_app_Login_mobile_mob"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['link_info']['remove_border'] = true;
        }
...
// 
      ...
      if(function_exists('set_php_timezone'))  set_php_timezone('sec_app_Login_mobile_mob'); 
      ...
      global $inicial_sec_app_Login_mobile_mob, $NM_run_iframe;
      if ((isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_flag) && $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_flag) || (isset($_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['embutida_call']) && $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['embutida_call']) || $NM_run_iframe == 1)
      {
           $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      }
   ...
   function init2()
   {
      if (isset($_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['initialize'])  
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_app_Login_mobile_mob']['initialize'] = false;
          $this->Db->Close(); 
      } 
      $this->conectDB();
   ...
   {
      $con_devel             =  (isset($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      ...
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_conexao']) && $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_perfil']) && $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      if (isset($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_perfil'];
      }
...
// 
      if (!empty($this->nm_falta_var) || !empty($this->nm_falta_var_db) || $nm_crit_perfil)
      {
          ...
          echo "</table>";
          if (!$_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['sc_outra_jan']) || $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['sc_outra_jan'] != 'sec_app_Login_mobile_mob')) 
          { 
              if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno'])) 
              { 
?>
...
// 
  function conectDB()
  {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'pointofsales', 1, $this->force_db_utf8); 
      } 
      else 
      { 
      ...
      if (in_array(strtolower($this->nm_tpbanco), $this->nm_bases_oracle))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['decimal_db'] = "."; 
      } 
  }

  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'pointofsales', 1, $this->force_db_utf8);
    }
    else {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['sec_app_Login_mobile_mob']['SC_sep_date1'];
           }
...
function fb_return()
{
$_SESSION['scriptcase']['sec_app_Login_mobile_mob']['contr_erro'] = 'on';
...
if(!empty($this->sc_temp_facebook_error_code))
{
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_sec_app_Login_mobile_mob';
...
$_SESSION['scriptcase']['sec_app_Login_mobile_mob']['contr_erro'] = 'off';
}
...
//===============================================================================
class sec_app_Login_mobile_mob_edit
{
    var $contr_sec_app_Login_mobile_mob;
    function inicializa()
    {
        global $nm_opc_lookup, $nm_opc_php, $script_case_init;
        require_once("sec_app_Login_mobile_mob_apl.php");
        $this->contr_sec_app_Login_mobile_mob = new sec_app_Login_mobile_mob_apl();
    }
}
...
//
    ...
    if (!empty($_POST))
    {
        foreach ($_POST as $nmgp_var => $nmgp_val)
        {
             ...
             nm_limpa_str_sec_app_Login_mobile_mob($nmgp_val);
    ...
    {
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['where_filter'] = $SC_where_pdf;
    }

    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']) && !isset($_SESSION['scriptcase']['sec_app_Login_mobile_mob']['session_timeout']['redir']))
    {
        if ('ajax_sec_app_Login_mobile_mob_validate_login' == $_POST['rs'])
        {
            $login = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_sec_app_Login_mobile_mob_validate_pswd' == $_POST['rs'])
        {
            $pswd = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_sec_app_Login_mobile_mob_validate_remember_me' == $_POST['rs'])
        {
            $remember_me = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_sec_app_Login_mobile_mob_submit_form' == $_POST['rs'])
        {
            $login = NM_utf8_urldecode($_POST['rsargs'][0]);
        ...
        if ('ajax_sec_app_Login_mobile_mob_navigate_form' == $_POST['rs'])
        {
    ...
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['lig_edit_lookup']))
    { 
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['lig_edit_lookup']     = false;
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['lig_edit_lookup_cb']  = '';
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['lig_edit_lookup_row'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_call']))
    { 
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_call'] = false;
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_proc']))
    { 
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_proc'] = false;
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_liga_form_insert']))
    { 
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_liga_form_insert'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_liga_form_update']))
    { 
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_liga_form_update'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_liga_form_delete']))
    { 
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_liga_form_delete'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_liga_form_btn_nav']))
    { 
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_liga_form_btn_nav'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_liga_grid_edit']))
    { 
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_liga_grid_edit'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_liga_grid_edit_link']))
    { 
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_liga_grid_edit_link'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_liga_qtd_reg']))
    { 
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_liga_qtd_reg'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_liga_tp_pag']))
    { 
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_liga_tp_pag'] = '';
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['run_modal']))
    { 
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['run_modal'] = isset($_GET['nmgp_url_saida']) && 'modal' == $_GET['nmgp_url_saida'];
    } 
    if (isset($script_case_init) && !is_array($script_case_init) && $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_proc'])
    {
        return;
    }
    if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_parms']))
    { 
        $tmp_nmgp_parms = '';
        ...
        $nmgp_parms = $tmp_nmgp_parms . $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_parms'];
        unset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_parms']);
    } 
    ...
    { 
        ...
        while (!empty($todo[$ix]))
        {
           ...
           if (1 < sizeof($cadapar))
           {
               ...
               nm_limpa_str_sec_app_Login_mobile_mob($cadapar[1]);
    ...
    elseif (isset($script_case_init) && !empty($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['parms']))
    {
        if (!isset($nmgp_opcao) || ($nmgp_opcao != "incluir" && $nmgp_opcao != "novo" && $nmgp_opcao != "recarga" && $nmgp_opcao != "muda_form"))
        {
            $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['parms']);
            $todo  = explode("?@?", $todox);
            $ix = 0;
            while (!empty($todo[$ix]))
            {
    ...
    $salva_run = "N";
    $salva_iframe = false;
    if (isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['iframe_menu']))
    {
        $salva_iframe = $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['iframe_menu'];
        unset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['iframe_menu']);
    }
    if (isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['run_iframe']))
    {
        $salva_run = $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['run_iframe'];
        unset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['run_iframe']);
    }
    if (isset($nm_run_menu) && $nm_run_menu == 1)
    {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "sec_app_Login_mobile_mob";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'sec_app_Login_mobile_mob' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['iframe_menu']  = true;
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile']['mostra_cab']   = "S";
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['run_iframe']   = "N";
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['retorno_edit'] = "";
    }
    else
    {
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['run_iframe']  = $salva_run;
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['iframe_menu'] = $salva_iframe;
    }

    if (!isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['db_changed']))
    {
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['db_changed'] = false;
    }
    ...
    if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'sec_app_Login_mobile_mob')
    {
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['sc_outra_jan'] = true;
    ...
    if (isset($nmgp_outra_jan) && $nmgp_outra_jan == 'true')
    {
        ...
        {
            $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['sc_modal'] = true;
            $nm_url_saida = "sec_app_Login_mobile_mob_fim.php"; 
        }
        $nm_apl_dependente = 0;
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['sc_outra_jan'] = true;
    }
    ...
    if (!isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['initialize']))
    {
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['initialize'] = true;
    }
    elseif (!isset($_SERVER['HTTP_REFERER']))
    {
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['initialize'] = false;
    }
    ...
    if (isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['first_time']))
    {
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['first_time'] = false;
    }
    else
    {
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['first_time'] = true;
    }

    $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['menu_desenv'] = false;   
    if (!defined("SC_ERROR_HANDLER"))
    {
        define("SC_ERROR_HANDLER", 1);
    }
    include_once(dirname(__FILE__) . "/sec_app_Login_mobile_mob_erro.php");
    ...
    else
    {
        if (!empty($nmgp_opcao))  
        {
            $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['opcao'] = $nmgp_opcao ; 
        }
        if (isset($_POST["facebook_error_code"])) 
        {
            $_SESSION['facebook_error_code'] = $_POST["facebook_error_code"];
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['facebook_error_code']);
        }
        ...
        if (isset($_POST["facebook_error_msg"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['facebook_error_msg']);
        }
        ...
        if (isset($_POST["facebook_user"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['facebook_user']);
        }
        ...
        if (isset($_POST["facebook_email"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['facebook_email']);
        }
        ...
        if (isset($_POST["facebook_name"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['facebook_name']);
        }
        ...
        if (isset($_POST["google_error_code"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['google_error_code']);
        }
        ...
        if (isset($_POST["google_error_msg"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['google_error_msg']);
        }
        ...
        if (isset($_POST["google_user"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['google_user']);
        }
        ...
        if (isset($_POST["google_email"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['google_email']);
        }
        ...
        if (isset($_POST["google_name"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['google_name']);
        }
        ...
        if (isset($_POST["usr_login"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['usr_login']);
        }
        ...
        if (isset($_POST["usr_email"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['usr_email']);
        }
        ...
        if (isset($_POST["sett_remember_me"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['sett_remember_me']);
        }
        ...
        if (isset($_POST["sett_new_users"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['sett_new_users']);
        }
        ...
        if (isset($_POST["sett_retrieve_password"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['sett_retrieve_password']);
        }
        ...
        if (isset($_POST["usr_priv_admin"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['usr_priv_admin']);
        }
        ...
        if (isset($_POST["usr_name"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['usr_name']);
        }
        ...
        if (isset($_POST["remember_me"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['remember_me']);
        }
        ...
        if (isset($_POST["sett_enable_2fa"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['sett_enable_2fa']);
        }
        ...
        if (isset($_POST["sett_cookie_expiration_time"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['sett_cookie_expiration_time']);
        }
        ...
        if (isset($_POST["sett_session_expire"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['sett_session_expire']);
        }
        ...
        if (isset($_POST["twitter_user"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['twitter_user']);
        }
        ...
        if (isset($_POST["twitter_email"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['twitter_email']);
        }
        ...
        if (isset($_POST["twitter_name"])) 
        {
            ...
            nm_limpa_str_sec_app_Login_mobile_mob($_SESSION['twitter_name']);
        }
        ...
        if (!empty($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['volta_redirect_apl']))
        {
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['volta_redirect_apl']; 
            $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['volta_redirect_tp']; 
            $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['volta_redirect_apl'] = "";
            $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['volta_redirect_tp'] = "";
            $nm_url_saida = "sec_app_Login_mobile_mob_fim.php"; 
        }
        elseif (isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['sc_outra_jan'] == 'true')
        {
               $nm_url_saida = "sec_app_Login_mobile_mob_fim.php"; 
        }
        elseif ($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['run_iframe'] != "R")
        {
           $nm_url_saida = isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : ""; 
           $nm_url_saida = str_replace("_fim.php", ".php", $nm_url_saida); 
            $nm_saida_global = $nm_url_saida;
            if (!empty($nmgp_url_saida) && empty($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['retorno_edit'])) 
            {
                $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['retorno_edit'] = $nmgp_url_saida ; 
            } 
            if (!empty($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['retorno_edit'])) 
            {
                $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['retorno_edit'] . "?script_case_init=" . $script_case_init;  
                $nm_apl_dependente = 1 ; 
                $nm_saida_global = $nm_url_saida;
            } 
            ...
            if ($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['run_iframe'] != "R" && (!isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_call']) || !$_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['embutida_call']))
            { 
        ...
        if (empty($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['volta_tp']) && $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['run_iframe'] != "R")
        {
            $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['volta_php'] = $nm_url_saida;
            $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['volta_apl'] = $nm_saida_global;
            $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['volta_ss']  = (isset($_SESSION['scriptcase']['sc_url_saida'][$script_case_init])) ? $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] : "";
            $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['volta_dep'] = $nm_apl_dependente;
            $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['volta_tp']  = (isset($_SESSION['scriptcase']['sc_tp_saida'])) ? $_SESSION['scriptcase']['sc_tp_saida'] : "";
        }
        $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['volta_php'];
        $nm_saida_global = $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['volta_php'];
        $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['volta_dep'];
        if ($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['run_iframe'] != "R" && !empty($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['volta_ss'])) 
        { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['volta_ss'];
            $_SESSION['scriptcase']['sc_tp_saida']  = $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['volta_tp'];
        } 
        if ($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['run_iframe'] == "R") 
        { 
            if (!empty($nmgp_url_saida) && empty($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['retorno_edit'])) 
            {
                $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['retorno_edit'] = $nmgp_url_saida . "?script_case_init=" . $script_case_init; 
            } 
        } 
        if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['run_iframe'] != "R") 
        { 
            $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['menu_desenv'] = true;   
        } 
    }
    if (isset($nmgp_redir)) 
    { 
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['redir'] = $nmgp_redir;   
    } 
    if (isset($nmgp_outra_jan) && $nmgp_outra_jan == 'true')
    {
        $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['sc_outra_jan'] = true;
    ...
    if (isset($_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['sec_app_Login_mobile_mob']['sc_outra_jan'])
    {
        $nm_apl_dependente = 0;
    }
    $GLOBALS["NM_ERRO_IBASE"] = 0;  
    $inicial_sec_app_Login_mobile_mob = new sec_app_Login_mobile_mob_edit();
    $inicial_sec_app_Login_mobile_mob->inicializa();

    $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['select_html'] = array();
    $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['select_html']['remember_me'] = " onClick=\"\" ";

    if (!defined('SC_SAJAX_LOADED'))
    {
        include_once(dirname(__FILE__) . '/sec_app_Login_mobile_mob_sajax.php');
        define('SC_SAJAX_LOADED', 'YES');
    }
    if (!class_exists('Services_JSON'))
    {
        include_once(dirname(__FILE__) . '/sec_app_Login_mobile_mob_json.php');
    }
    $sajax_request_type = "POST";
    sajax_init();
    //$sajax_debug_mode = 1;
    sajax_export("ajax_sec_app_Login_mobile_mob_validate_login");
    sajax_export("ajax_sec_app_Login_mobile_mob_validate_pswd");
    sajax_export("ajax_sec_app_Login_mobile_mob_validate_remember_me");
    sajax_export("ajax_sec_app_Login_mobile_mob_submit_form");
    sajax_export("ajax_sec_app_Login_mobile_mob_navigate_form");
    sajax_handle_client_request();

    if (isset($_POST['wizard_action']) && 'change_step' == $_POST['wizard_action']) {
        $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['param']['buffer_output'] = true;
        ob_start();
    }

    $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->controle();
//
    function nm_limpa_str_sec_app_Login_mobile_mob(&$str)
    {
    }

    function ajax_sec_app_Login_mobile_mob_validate_login($login, $script_case_init)
    {
        global $inicial_sec_app_Login_mobile_mob;
        //register_shutdown_function("sec_app_Login_mobile_mob_pack_ajax_response");
        $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_flag          = true;
        $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_opcao         = 'validate_login';
        $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['param'] = array(
                  'login' => NM_utf8_urldecode($login),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        if ($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['param']['buffer_output'])
        {
            ob_start();
        }
        $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->controle();
    ...
    function ajax_sec_app_Login_mobile_mob_validate_pswd($pswd, $script_case_init)
    {
        global $inicial_sec_app_Login_mobile_mob;
        //register_shutdown_function("sec_app_Login_mobile_mob_pack_ajax_response");
        $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_flag          = true;
        $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_opcao         = 'validate_pswd';
        $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_sec_app_Login_mobile_mob_validate_remember_me($remember_me, $script_case_init)
    {
        global $inicial_sec_app_Login_mobile_mob;
        //register_shutdown_function("sec_app_Login_mobile_mob_pack_ajax_response");
        $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_flag          = true;
        $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_opcao         = 'validate_remember_me';
        $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_sec_app_Login_mobile_mob_submit_form($login, $pswd, $remember_me, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init)
    {
        global $inicial_sec_app_Login_mobile_mob;
        //register_shutdown_function("sec_app_Login_mobile_mob_pack_ajax_response");
        $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_flag          = true;
        $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_opcao         = 'submit_form';
        $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['param'] = array(
                  'login' => NM_utf8_urldecode($login),
                  'pswd' => NM_utf8_urldecode($pswd),
                  'remember_me' => NM_utf8_urldecode($remember_me),
    ...
    function ajax_sec_app_Login_mobile_mob_navigate_form($nm_form_submit, $nmgp_opcao, $nmgp_ordem, $nmgp_arg_dyn_search, $script_case_init)
    {
        global $inicial_sec_app_Login_mobile_mob;
        //register_shutdown_function("sec_app_Login_mobile_mob_pack_ajax_response");
        $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_flag          = true;
        $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_opcao         = 'navigate_form';
        $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['param'] = array(
                  'nm_form_submit' => NM_utf8_urldecode($nm_form_submit),
                  'nmgp_opcao' => NM_utf8_urldecode($nmgp_opcao),
   ...
   function sec_app_Login_mobile_mob_pack_ajax_response()
   {
      global $inicial_sec_app_Login_mobile_mob;
      $aResp = array();

      if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['wizard']))
      {
          $aResp['wizard'] = $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['wizard'];
      }
      if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['empty_filter']))
      {
          $aResp['empty_filter'] = $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['empty_filter'];
      }
      if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['dyn_search']['NM_Dynamic_Search']))
      {
          $aResp['dyn_search']['NM_Dynamic_Search'] = $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['dyn_search']['NM_Dynamic_Search'];
      }
      if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['dyn_search']['id_dyn_search_cmd_str']))
      {
          $aResp['dyn_search']['id_dyn_search_cmd_str'] = $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['dyn_search']['id_dyn_search_cmd_str'];
      }
      if ($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['calendarReload'])
      {
         $aResp['result'] = 'CALENDARRELOAD';
      }
      elseif ('' != $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['autoComp'])
      {
         $aResp['result'] = 'AUTOCOMP';
      }
//mestre_detalhe
      elseif (!empty($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['newline']))
      {
         $aResp['result'] = 'NEWLINE';
         ob_end_clean();
      }
      elseif (!empty($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['tableRefresh']))
      {
         $aResp['result'] = 'TABLEREFRESH';
      }
//-----
      elseif (!empty($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['errList']))
      {
         $aResp['result'] = 'ERROR';
      }
      elseif (!empty($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['fldList']))
      {
         $aResp['result'] = 'SET';
      }
      else
      ...
      {
         $aResp = $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['autoComp'];
      }
//mestre_detalhe
      elseif ('NEWLINE' == $aResp['result'])
      {
         $aResp = $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['newline'];
      }
      else
//-----
      {
         $aResp['ajaxRequest'] = $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_opcao;
         if ('CALENDARRELOAD' == $aResp['result'])
         {
            sec_app_Login_mobile_mob_pack_calendar_reload($aResp);
         }
         elseif ('ERROR' == $aResp['result'])
         {
            sec_app_Login_mobile_mob_pack_ajax_errors($aResp);
         }
         elseif ('SET' == $aResp['result'])
         {
            sec_app_Login_mobile_mob_pack_ajax_set_fields($aResp);
         }
         elseif ('TABLEREFRESH' == $aResp['result'])
         {
            sec_app_Login_mobile_mob_pack_ajax_set_fields($aResp);
            $aResp['tableRefresh'] = sec_app_Login_mobile_mob_pack_protect_string($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['tableRefresh']);
         }
         if ('OK' == $aResp['result'] || 'SET' == $aResp['result'])
         {
            sec_app_Login_mobile_mob_pack_ajax_ok($aResp);
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['focus']) && '' != $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['focus'])
         {
            $aResp['setFocus'] = $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['focus'];
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['closeLine']) && '' != $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['closeLine'])
         {
            $aResp['closeLine'] = $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['closeLine'];
         }
         else
         {
            $aResp['closeLine'] = 'N';
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['clearUpload']) && '' != $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['clearUpload'])
         {
            $aResp['clearUpload'] = $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['clearUpload'];
         }
         else
         {
            $aResp['clearUpload'] = 'N';
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['btnDisabled']) && '' != $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['btnDisabled'])
         {
            sec_app_Login_mobile_mob_pack_btn_disabled($aResp);
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['btnLabel']) && '' != $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['btnLabel'])
         {
            sec_app_Login_mobile_mob_pack_btn_label($aResp);
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['varList']) && !empty($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['varList']))
         {
            sec_app_Login_mobile_mob_pack_var_list($aResp);
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['masterValue']) && '' != $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['masterValue'])
         {
            sec_app_Login_mobile_mob_pack_master_value($aResp);
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxAlert']) && '' != $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxAlert'])
         {
            sec_app_Login_mobile_mob_pack_ajax_alert($aResp);
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']) && '' != $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage'])
         {
            sec_app_Login_mobile_mob_pack_ajax_message($aResp);
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxJavascript']) && '' != $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxJavascript'])
         {
            sec_app_Login_mobile_mob_pack_ajax_javascript($aResp);
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['redir']) && !empty($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['redir']))
         {
            sec_app_Login_mobile_mob_pack_ajax_redir($aResp);
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['redirExit']) && !empty($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['redirExit']))
         {
            sec_app_Login_mobile_mob_pack_ajax_redir_exit($aResp);
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['blockDisplay']) && !empty($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['blockDisplay']))
         {
            sec_app_Login_mobile_mob_pack_ajax_block_display($aResp);
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['fieldDisplay']) && !empty($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['fieldDisplay']))
         {
            sec_app_Login_mobile_mob_pack_ajax_field_display($aResp);
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['buttonDisplay']) && !empty($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['buttonDisplay']))
         {
            $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['buttonDisplay'] = $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->nmgp_botoes;
            sec_app_Login_mobile_mob_pack_ajax_button_display($aResp);
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['buttonDisplayVert']) && !empty($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['buttonDisplayVert']))
         {
            sec_app_Login_mobile_mob_pack_ajax_button_display_vert($aResp);
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['fieldLabel']) && !empty($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['fieldLabel']))
         {
            sec_app_Login_mobile_mob_pack_ajax_field_label($aResp);
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['readOnly']) && !empty($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['readOnly']))
         {
            sec_app_Login_mobile_mob_pack_ajax_readonly($aResp);
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['navStatus']) && !empty($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['navStatus']))
         {
            sec_app_Login_mobile_mob_pack_ajax_nav_status($aResp);
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['navSummary']) && !empty($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['navSummary']))
         {
            sec_app_Login_mobile_mob_pack_ajax_nav_Summary($aResp);
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['navPage']))
         {
            sec_app_Login_mobile_mob_pack_ajax_navPage($aResp);
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['btnVars']) && !empty($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['btnVars']))
         {
            sec_app_Login_mobile_mob_pack_ajax_btn_vars($aResp);
         }
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['quickSearchRes']) && $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['quickSearchRes'])
         {
         ...
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['event_field']) && '' != $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['event_field'])
         {
            $aResp['eventField'] = $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['event_field'];
         }
         else
         {
         ...
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['param']['buffer_output']) && $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['param']['buffer_output'])
         {
            ...
            {
               $aResp['htmOutput'] = sec_app_Login_mobile_mob_pack_protect_string(NM_charset_to_utf8($aResp['htmOutput']));
               ob_end_clean();
            }
         }
      }
   ...
   function sec_app_Login_mobile_mob_pack_calendar_reload(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
      $aResp['calendarReload'] = 'OK';
   } // sec_app_Login_mobile_mob_pack_calendar_reload

   function sec_app_Login_mobile_mob_pack_ajax_errors(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
      $aResp['errList'] = array();
      foreach ($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['errList'] as $sField => $aMsg)
      {
         if ('geral_sec_app_Login_mobile_mob' == $sField)
         {
             $aMsg = sec_app_Login_mobile_mob_pack_ajax_remove_erros($aMsg);
         }
         foreach ($aMsg as $sMsg)
         {
            $iNumLinha = (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['param']['nmgp_refresh_row']) && 'geral_sec_app_Login_mobile_mob' != $sField)
                       ? $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['param']['nmgp_refresh_row'] : "";
            $aResp['errList'][] = array('fldName'  => $sField,
                                        'msgText'  => sec_app_Login_mobile_mob_pack_protect_string(NM_charset_to_utf8($sMsg)),
                                        'numLinha' => $iNumLinha);
         }
      }
   } // sec_app_Login_mobile_mob_pack_ajax_errors

   function sec_app_Login_mobile_mob_pack_ajax_remove_erros($aErrors)
   {
       $aNewErrors = array();
       if (!empty($aErrors))
       {
       ...
       return $aNewErrors;
   } // sec_app_Login_mobile_mob_pack_ajax_remove_erros

   function sec_app_Login_mobile_mob_pack_ajax_ok(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
      $iNumLinha = (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['param']['nmgp_refresh_row']))
                 ? $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['param']['nmgp_refresh_row'] : "";
      $aResp['msgDisplay'] = array('msgText'  => sec_app_Login_mobile_mob_pack_protect_string($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['msgDisplay']),
                                   'numLinha' => $iNumLinha);
   } // sec_app_Login_mobile_mob_pack_ajax_ok

   function sec_app_Login_mobile_mob_pack_ajax_set_fields(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
      $iNumLinha = (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['param']['nmgp_refresh_row']))
                 ? $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['param']['nmgp_refresh_row'] : "";
      if ('' != $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['rsSize'])
      {
         $aResp['rsSize'] = $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['rsSize'];
      }
      $aResp['fldList'] = array();
      foreach ($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['fldList'] as $sField => $aData)
      {
         $aField = array();
         ...
         {
            $aField['imgFile'] = sec_app_Login_mobile_mob_pack_protect_string($aData['imgFile']);
         }
         if (isset($aData['imgOrig']))
         {
            $aField['imgOrig'] = sec_app_Login_mobile_mob_pack_protect_string($aData['imgOrig']);
         }
         if (isset($aData['imgLink']))
         {
            $aField['imgLink'] = sec_app_Login_mobile_mob_pack_protect_string($aData['imgLink']);
         }
         ...
         {
            $aField['docLink'] = sec_app_Login_mobile_mob_pack_protect_string($aData['docLink']);
         }
         if (isset($aData['docIcon']))
         {
            $aField['docIcon'] = sec_app_Login_mobile_mob_pack_protect_string($aData['docIcon']);
         }
         if (isset($aData['docReadonly']))
         {
            $aField['docReadonly'] = sec_app_Login_mobile_mob_pack_protect_string($aData['docReadonly']);
         }
         ...
         {
            $aField['imgHtml'] = sec_app_Login_mobile_mob_pack_protect_string($aData['imgHtml']);
         }
         if (isset($aData['mulHtml']))
         {
            $aField['mulHtml'] = sec_app_Login_mobile_mob_pack_protect_string($aData['mulHtml']);
         }
         ...
         foreach ($aData['valList'] as $iIndex => $sValue)
         {
            ...
            {
               $aValue['label'] = sec_app_Login_mobile_mob_pack_protect_string($aData['labList'][$iIndex]);
            }
            $aValue['value']     = ('_autocomp' != substr($sField, -9)) ? sec_app_Login_mobile_mob_pack_protect_string($sValue) : $sValue;
            ...
            if (is_array($aData['optList']))
            {
               ...
               foreach ($aData['optList'] as $aOptList)
               {
                  foreach ($aOptList as $sValue => $sLabel)
                  {
                     ...
                     $aField['optList'][] = array('value' => sec_app_Login_mobile_mob_pack_protect_string($sOpt),
                                                  'label' => sec_app_Login_mobile_mob_pack_protect_string($sLabel));
                  }
               }
            }
            else
   ...
   } // sec_app_Login_mobile_mob_pack_ajax_set_fields

   function sec_app_Login_mobile_mob_pack_ajax_redir(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
      ...
      {
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['redir'][$sTag]))
         {
            $aResp['redirInfo'][$sTag] = $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['redir'][$sTag];
         }
      }
   } // sec_app_Login_mobile_mob_pack_ajax_redir

   function sec_app_Login_mobile_mob_pack_ajax_redir_exit(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
      ...
      foreach ($aInfo as $sTag)
      {
         if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['redirExit'][$sTag]))
         {
            $aResp['redirExitInfo'][$sTag] = $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['redirExit'][$sTag];
         }
      }
   } // sec_app_Login_mobile_mob_pack_ajax_redir_exit

   function sec_app_Login_mobile_mob_pack_var_list(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
      foreach ($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['varList'] as $varData)
      {
         $aResp['varList'][] = array('index' => key($varData),
                                      'value' => current($varData));
      }
   } // sec_app_Login_mobile_mob_pack_var_list

   function sec_app_Login_mobile_mob_pack_master_value(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
      foreach ($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['masterValue'] as $sIndex => $sValue)
      {
         $aResp['masterValue'][] = array('index' => $sIndex,
                                         'value' => $sValue);
      }
   } // sec_app_Login_mobile_mob_pack_master_value

   function sec_app_Login_mobile_mob_pack_btn_disabled(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
      $aResp['btnDisabled'] = array();
      foreach ($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['btnDisabled'] as $btnName => $btnStatus) {
        $aResp['btnDisabled'][$btnName] = $btnStatus;
      }
   } // sec_app_Login_mobile_mob_pack_ajax_alert

   function sec_app_Login_mobile_mob_pack_btn_label(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
      $aResp['btnLabel'] = array();
      foreach ($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['btnLabel'] as $btnName => $btnLabel) {
        $aResp['btnLabel'][$btnName] = $btnLabel;
      }
   } // sec_app_Login_mobile_mob_pack_ajax_alert

   function sec_app_Login_mobile_mob_pack_ajax_alert(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
// PHP 8.0
      if (!isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxAlert']['message'])) {
          $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxAlert']['message'] = '';
      }
      if (!isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxAlert']['params'])) {
          $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxAlert']['params'] = '';
      }
//---
      $aResp['ajaxAlert'] = array('message' => $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxAlert']['message'], 'params' =>  $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxAlert']['params']);
   } // sec_app_Login_mobile_mob_pack_ajax_alert

   function sec_app_Login_mobile_mob_pack_ajax_message(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
// PHP 8.0
      if (!isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['message'])) {
          $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['message'] = '';
      }
      if (!isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['title'])) {
          $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['title'] = '';
      }
//---
      $aResp['ajaxMessage'] = array('message'      => sec_app_Login_mobile_mob_pack_protect_string($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['message']),
                                    'title'        => sec_app_Login_mobile_mob_pack_protect_string($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['title']),
                                    'modal'        => isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['modal'])        ? $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['modal']        : 'N',
                                    'timeout'      => isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['timeout'])      ? $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['timeout']      : '',
                                    'button'       => isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['button'])       ? $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['button']       : '',
                                    'button_label' => isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['button_label']) ? $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['button_label'] : 'Ok',
                                    'top'          => isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['top'])          ? $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['top']          : '',
                                    'left'         => isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['left'])         ? $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['left']         : '',
                                    'width'        => isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['width'])        ? $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['width']        : '',
                                    'height'       => isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['height'])       ? $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['height']       : '',
                                    'redir'        => isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['redir'])        ? $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['redir']        : '',
                                    'show_close'   => isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['show_close'])   ? $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['show_close']   : 'Y',
                                    'body_icon'    => isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['body_icon'])    ? $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['body_icon']    : 'Y',
                                    'toast'        => isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['toast'])        ? $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['toast']        : 'N',
                                    'toast_pos'    => isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['toast_pos'])    ? $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['toast_pos']    : '',
                                    'type'         => isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['type'])         ? $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['type']         : '',
                                    'redir_target' => isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['redir_target']) ? $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['redir_target'] : '',
                                    'redir_par'    => isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['redir_par'])    ? $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxMessage']['redir_par']    : '');
   } // sec_app_Login_mobile_mob_pack_ajax_message

   function sec_app_Login_mobile_mob_pack_ajax_javascript(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
      foreach ($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['ajaxJavascript'] as $aJsFunc)
      {
         $aResp['ajaxJavascript'][] = $aJsFunc;
      }
   } // sec_app_Login_mobile_mob_pack_ajax_javascript

   function sec_app_Login_mobile_mob_pack_ajax_block_display(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
      $aResp['blockDisplay'] = array();
      foreach ($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['blockDisplay'] as $sBlockName => $sBlockStatus)
      {
        $aResp['blockDisplay'][] = array($sBlockName, $sBlockStatus);
      }
   } // sec_app_Login_mobile_mob_pack_ajax_block_display

   function sec_app_Login_mobile_mob_pack_ajax_field_display(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
      $aResp['fieldDisplay'] = array();
      foreach ($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['fieldDisplay'] as $sFieldName => $sFieldStatus)
      {
        $aResp['fieldDisplay'][] = array($sFieldName, $sFieldStatus);
      }
   } // sec_app_Login_mobile_mob_pack_ajax_field_display

   function sec_app_Login_mobile_mob_pack_ajax_button_display(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
      $aResp['buttonDisplay'] = array();
      foreach ($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['buttonDisplay'] as $sButtonName => $sButtonStatus)
      {
        $aResp['buttonDisplay'][] = array($sButtonName, $sButtonStatus);
      }
   } // sec_app_Login_mobile_mob_pack_ajax_button_display

   function sec_app_Login_mobile_mob_pack_ajax_button_display_vert(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
      $aResp['buttonDisplayVert'] = array();
      foreach ($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['buttonDisplayVert'] as $aButtonData)
      {
        $aResp['buttonDisplayVert'][] = $aButtonData;
      }
   } // sec_app_Login_mobile_mob_pack_ajax_button_display

   function sec_app_Login_mobile_mob_pack_ajax_field_label(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
      $aResp['fieldLabel'] = array();
      foreach ($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['fieldLabel'] as $sFieldName => $sFieldLabel)
      {
        $aResp['fieldLabel'][] = array($sFieldName, sec_app_Login_mobile_mob_pack_protect_string($sFieldLabel));
      }
   } // sec_app_Login_mobile_mob_pack_ajax_field_label

   function sec_app_Login_mobile_mob_pack_ajax_readonly(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
      $aResp['readOnly'] = array();
      foreach ($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['readOnly'] as $sFieldName => $sFieldStatus)
      {
        $aResp['readOnly'][] = array($sFieldName, $sFieldStatus);
      }
   } // sec_app_Login_mobile_mob_pack_ajax_readonly

   function sec_app_Login_mobile_mob_pack_ajax_nav_status(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
      $aResp['navStatus'] = array();
      if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['navStatus']['ret']) && '' != $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['navStatus']['ret'])
      {
         $aResp['navStatus']['ret'] = $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['navStatus']['ret'];
      }
      if (isset($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['navStatus']['ava']) && '' != $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['navStatus']['ava'])
      {
         $aResp['navStatus']['ava'] = $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['navStatus']['ava'];
      }
   } // sec_app_Login_mobile_mob_pack_ajax_nav_status

   function sec_app_Login_mobile_mob_pack_ajax_nav_Summary(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
      $aResp['navSummary'] = array();
      $aResp['navSummary']['reg_ini'] = $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['navSummary']['reg_ini'];
      $aResp['navSummary']['reg_qtd'] = $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['navSummary']['reg_qtd'];
      $aResp['navSummary']['reg_tot'] = $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['navSummary']['reg_tot'];
   } // sec_app_Login_mobile_mob_pack_ajax_nav_Summary

   function sec_app_Login_mobile_mob_pack_ajax_navPage(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
      $aResp['navPage'] = $inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['navPage'];
   } // sec_app_Login_mobile_mob_pack_ajax_navPage


   function sec_app_Login_mobile_mob_pack_ajax_btn_vars(&$aResp)
   {
      global $inicial_sec_app_Login_mobile_mob;
      $aResp['btnVars'] = array();
      foreach ($inicial_sec_app_Login_mobile_mob->contr_sec_app_Login_mobile_mob->NM_ajax_info['btnVars'] as $sBtnName => $sBtnValue)
      {
        $aResp['btnVars'][] = array($sBtnName, sec_app_Login_mobile_mob_pack_protect_string($sBtnValue));
      }
   } // sec_app_Login_mobile_mob_pack_ajax_btn_vars

   function sec_app_Login_mobile_mob_pack_protect_string($sString)
   {
...
/*             return htmlentities($sString, ENT_COMPAT, $_SESSION['scriptcase']['charset']); */
   ...
   } // sec_app_Login_mobile_mob_pack_protect_string
?>
