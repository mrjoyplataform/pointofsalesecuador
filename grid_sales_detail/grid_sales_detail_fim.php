...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_sales_detail"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_sales_detail"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_sales_detail']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_sales_detail']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_sales_detail']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_sales_detail']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_sales_detail']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_sales_detail']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_sales_detail']['embutida_filho'] as $ind => $sc_init)
          {
