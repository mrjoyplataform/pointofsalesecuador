...
class grid_sales_detail_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_sales_detail_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_sales_detail_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_sales_detail_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> sales_detail</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_sales_detail/grid_sales_detail_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_sales_detail_ajax_search.js"></script>
 <script type="text/javascript" src="grid_sales_detail_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_sales_detail_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_sales_detail']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_sales_detail']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_id_sales_detail_cond#NMF#' + search_get_sel_txt('SC_id_sales_detail_cond') + '@NMF@';
  str_out += 'SC_id_sales_detail#NMF#' + search_get_text('SC_id_sales_detail') + '@NMF@';
  str_out += 'SC_id_sales_cond#NMF#' + search_get_sel_txt('SC_id_sales_cond') + '@NMF@';
  str_out += 'SC_id_sales#NMF#' + search_get_text('SC_id_sales') + '@NMF@';
  str_out += 'SC_unit_cost_cond#NMF#' + search_get_sel_txt('SC_unit_cost_cond') + '@NMF@';
  str_out += 'SC_unit_cost#NMF#' + search_get_text('SC_unit_cost') + '@NMF@';
  str_out += 'SC_unit_value_cond#NMF#' + search_get_sel_txt('SC_unit_value_cond') + '@NMF@';
  str_out += 'SC_unit_value#NMF#' + search_get_text('SC_unit_value') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $id_sales_detail_cond, $id_sales_detail,
             $id_sales_cond, $id_sales,
             $unit_cost_cond, $unit_cost,
             $unit_value_cond, $unit_value,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $id_sales_detail = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']['id_sales_detail']; 
          $id_sales_detail_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']['id_sales_detail_cond']; 
          $id_sales = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']['id_sales']; 
          $id_sales_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']['id_sales_cond']; 
          $unit_cost = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']['unit_cost']; 
          $unit_cost_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']['unit_cost_cond']; 
          $unit_value = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']['unit_value']; 
          $unit_value_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']['unit_value_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']['NM_operador']; 
          if (strtoupper($id_sales_detail_cond) != "II" && strtoupper($id_sales_detail_cond) != "QP" && strtoupper($id_sales_detail_cond) != "NP" && strtoupper($id_sales_detail_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_sales_detail, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($id_sales_cond) != "II" && strtoupper($id_sales_cond) != "QP" && strtoupper($id_sales_cond) != "NP" && strtoupper($id_sales_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_sales, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($unit_cost_cond) != "II" && strtoupper($unit_cost_cond) != "QP" && strtoupper($unit_cost_cond) != "NP" && strtoupper($unit_cost_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($unit_cost, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "2", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($unit_value_cond) != "II" && strtoupper($unit_value_cond) != "QP" && strtoupper($unit_value_cond) != "NP" && strtoupper($unit_value_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($unit_value, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "2", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($id_sales_detail_cond) || empty($id_sales_detail_cond))
      {
         $id_sales_detail_cond = "gt";
      }
      if (!isset($id_sales_cond) || empty($id_sales_cond))
      {
         $id_sales_cond = "gt";
      }
      if (!isset($unit_cost_cond) || empty($unit_cost_cond))
      {
         $unit_cost_cond = "gt";
      }
      if (!isset($unit_value_cond) || empty($unit_value_cond))
      {
         $unit_value_cond = "gt";
      }
      ...
      $str_hide_id_sales_detail = (in_array($id_sales_detail_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_sales = (in_array($id_sales_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_unit_cost = (in_array($unit_cost_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_unit_value = (in_array($unit_value_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($id_sales_detail) || $id_sales_detail == "")
      {
          $id_sales_detail = "";
      }
      if (isset($id_sales_detail) && !empty($id_sales_detail))
      {
         $tmp_pos = strpos($id_sales_detail, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_sales_detail = substr($id_sales_detail, 0, $tmp_pos);
         }
      }
      if (!isset($id_sales) || $id_sales == "")
      {
          $id_sales = "";
      }
      if (isset($id_sales) && !empty($id_sales))
      {
         $tmp_pos = strpos($id_sales, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_sales = substr($id_sales, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($unit_cost, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $unit_cost = substr($unit_cost, 0, $tmp_pos);
         }
      }
      if (!isset($unit_value) || $unit_value == "")
      {
          $unit_value = "";
      }
      if (isset($unit_value) && !empty($unit_value))
      {
         $tmp_pos = strpos($unit_value, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $unit_value = substr($unit_value, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_id_sales_detail_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_sales_detail'])) ? $this->New_label['id_sales_detail'] : "" . $this->Ini->Nm_lang['lang_sales_detail_fld_id_sales_detail'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_sales_detail_cond" name="id_sales_detail_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_sales_detail'), this, 'id_sales_detail')">
       <OPTION value="gt" <?php if ("gt" == $id_sales_detail_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_sales_detail_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_sales_detail_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_sales_detail" <?php echo $str_hide_id_sales_detail?> valign="top">
 ...
 $nmgp_tab_label .= "id_sales_detail?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_id_sales_detail" name="id_sales_detail" value="<?php echo NM_encode_input($id_sales_detail) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_id_sales_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['id_sales'])) ? $this->New_label['id_sales'] : "" . $this->Ini->Nm_lang['lang_sales_detail_fld_id_sales'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_sales_cond" name="id_sales_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_sales'), this, 'id_sales')">
       <OPTION value="gt" <?php if ("gt" == $id_sales_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_sales_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_sales_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_sales" <?php echo $str_hide_id_sales?> valign="top">
 ...
 $nmgp_tab_label .= "id_sales?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_id_sales" name="id_sales" value="<?php echo NM_encode_input($id_sales) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_unit_cost_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['unit_cost'])) ? $this->New_label['unit_cost'] : "" . $this->Ini->Nm_lang['lang_sales_detail_fld_unit_cost'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_unit_cost_cond" name="unit_cost_cond" onChange="nm_campos_between(document.getElementById('id_vis_unit_cost'), this, 'unit_cost')">
       <OPTION value="gt" <?php if ("gt" == $unit_cost_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $unit_cost_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $unit_cost_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_unit_cost" <?php echo $str_hide_unit_cost?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['unit_cost'])) ? $this->New_label['unit_cost'] : "" . $this->Ini->Nm_lang['lang_sales_detail_fld_unit_cost'] . "";
 $nmgp_tab_label .= "unit_cost?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_unit_cost" name="unit_cost" value="<?php echo NM_encode_input($unit_cost) ?>" size=10 alt="{datatype: 'decimal', maxLength: 10, precision: 2, decimalSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['dec_num'] ?>', thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_unit_value_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['unit_value'])) ? $this->New_label['unit_value'] : "" . $this->Ini->Nm_lang['lang_sales_detail_fld_unit_value'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_unit_value_cond" name="unit_value_cond" onChange="nm_campos_between(document.getElementById('id_vis_unit_value'), this, 'unit_value')">
       <OPTION value="gt" <?php if ("gt" == $unit_value_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $unit_value_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $unit_value_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_unit_value" <?php echo $str_hide_unit_value?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['unit_value'])) ? $this->New_label['unit_value'] : "" . $this->Ini->Nm_lang['lang_sales_detail_fld_unit_value'] . "";
 $nmgp_tab_label .= "unit_value?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_sales_detail_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['opc_psq'])
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_sales_detail_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_id_sales_detail'), document.F1.id_sales_detail_cond, 'id_sales_detail');
   document.F1.id_sales_detail.value = "";
   document.F1.id_sales_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_id_sales'), document.F1.id_sales_cond, 'id_sales');
   document.F1.id_sales.value = "";
   document.F1.unit_cost_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_unit_cost'), document.F1.unit_cost_cond, 'unit_cost');
   document.F1.unit_cost.value = "";
   document.F1.unit_value_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_unit_value'), document.F1.unit_value_cond, 'unit_value');
   document.F1.unit_value.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_id_sales_detail_cond'] = 'cond';
      $tp_fields['SC_id_sales_detail'] = 'text';
      $tp_fields['SC_id_sales_cond'] = 'cond';
      $tp_fields['SC_id_sales'] = 'text';
      $tp_fields['SC_unit_cost_cond'] = 'cond';
      $tp_fields['SC_unit_cost'] = 'text';
      $tp_fields['SC_unit_value_cond'] = 'cond';
      $tp_fields['SC_unit_value'] = 'text';
   ...
   {
      global $id_sales_detail_cond, $id_sales_detail,
             $id_sales_cond, $id_sales,
             $unit_cost_cond, $unit_cost,
             $unit_value_cond, $unit_value, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $id_sales_detail_cond_salva = $id_sales_detail_cond; 
      if (!isset($id_sales_detail_input_2) || $id_sales_detail_input_2 == "")
      {
          $id_sales_detail_input_2 = $id_sales_detail;
      }
      $id_sales_cond_salva = $id_sales_cond; 
      if (!isset($id_sales_input_2) || $id_sales_input_2 == "")
      {
          $id_sales_input_2 = $id_sales;
      }
      $unit_cost_cond_salva = $unit_cost_cond; 
      if (!isset($unit_cost_input_2) || $unit_cost_input_2 == "")
      {
          $unit_cost_input_2 = $unit_cost;
      }
      $unit_value_cond_salva = $unit_value_cond; 
      if (!isset($unit_value_input_2) || $unit_value_input_2 == "")
      {
          $unit_value_input_2 = $unit_value;
      }
      if ($id_sales_detail_cond != "in")
      {
          nm_limpa_numero($id_sales_detail, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($id_sales_cond != "in")
      {
          nm_limpa_numero($id_sales, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($unit_cost_cond != "in")
      {
          if ($C_formatado)
          {
              nm_limpa_valor($unit_cost, $_SESSION['scriptcase']['reg_conf']['dec_num'], $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
      }
      if ($unit_value_cond != "in")
      {
          if ($C_formatado)
          {
              nm_limpa_valor($unit_value, $_SESSION['scriptcase']['reg_conf']['dec_num'], $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']['id_sales_detail'] = $id_sales_detail; 
      if (is_array($id_sales_detail) && !empty($id_sales_detail))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['Grid_search'][$I_Grid]['val'][0] = $id_sales_detail;
      }
      elseif ($id_sales_detail_cond_salva == "nu" || $id_sales_detail_cond_salva == "nn" || $id_sales_detail_cond_salva == "ep" || $id_sales_detail_cond_salva == "ne" || !empty($id_sales_detail))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['Grid_search'][$I_Grid]['val'][0][0] = $id_sales_detail;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']['id_sales_detail_cond'] = $id_sales_detail_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['Grid_search'][$I_Grid]['cmp'] = "id_sales_detail"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['Grid_search'][$I_Grid]['opc'] = $id_sales_detail_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq']['id_sales_detail'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']['id_sales'] = $id_sales; 
      if (is_array($id_sales) && !empty($id_sales))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['Grid_search'][$I_Grid]['val'][0] = $id_sales;
      }
      elseif ($id_sales_cond_salva == "nu" || $id_sales_cond_salva == "nn" || $id_sales_cond_salva == "ep" || $id_sales_cond_salva == "ne" || !empty($id_sales))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['Grid_search'][$I_Grid]['val'][0][0] = $id_sales;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']['id_sales_cond'] = $id_sales_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['Grid_search'][$I_Grid]['cmp'] = "id_sales"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['Grid_search'][$I_Grid]['opc'] = $id_sales_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq']['id_sales'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']['unit_cost'] = $unit_cost; 
      if (is_array($unit_cost) && !empty($unit_cost))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['Grid_search'][$I_Grid]['val'][0] = $unit_cost;
      }
      elseif ($unit_cost_cond_salva == "nu" || $unit_cost_cond_salva == "nn" || $unit_cost_cond_salva == "ep" || $unit_cost_cond_salva == "ne" || !empty($unit_cost))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['Grid_search'][$I_Grid]['val'][0][0] = $unit_cost;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']['unit_cost_cond'] = $unit_cost_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['Grid_search'][$I_Grid]['cmp'] = "unit_cost"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['Grid_search'][$I_Grid]['opc'] = $unit_cost_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq']['unit_cost'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']['unit_value'] = $unit_value; 
      if (is_array($unit_value) && !empty($unit_value))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['Grid_search'][$I_Grid]['val'][0] = $unit_value;
      }
      elseif ($unit_value_cond_salva == "nu" || $unit_value_cond_salva == "nn" || $unit_value_cond_salva == "ep" || $unit_value_cond_salva == "ne" || !empty($unit_value))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['Grid_search'][$I_Grid]['val'][0][0] = $unit_value;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']['unit_value_cond'] = $unit_value_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['Grid_search'][$I_Grid]['cmp'] = "unit_value"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['Grid_search'][$I_Grid]['opc'] = $unit_value_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['grid_pesq']['unit_value'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca'] = $Temp_Busca;
      }
      if ($unit_cost_cond != "in" && $unit_cost_cond != "bw" && !empty($unit_cost) && !is_numeric($unit_cost))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_sales_detail_fld_unit_cost'] . "";
      }
      if ($unit_cost_cond == "bw" && ((!empty($unit_cost) && !is_numeric($unit_cost)) || (!empty($unit_cost_input_2) && !is_numeric($unit_cost_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_sales_detail_fld_unit_cost'] . "";
      }
      if ($unit_value_cond != "in" && $unit_value_cond != "bw" && !empty($unit_value) && !is_numeric($unit_value))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_sales_detail_fld_unit_value'] . "";
      }
      if ($unit_value_cond == "bw" && ((!empty($unit_value) && !is_numeric($unit_value)) || (!empty($unit_value_input_2) && !is_numeric($unit_value_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : " . $this->Ini->Nm_lang['lang_sales_detail_fld_unit_value'] . "";
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      $this->cmp_formatado['id_sales_detail'] = $Conteudo;
      $Conteudo = $id_sales;
      if (strtoupper($id_sales_cond) != "II" && strtoupper($id_sales_cond) != "QP" && strtoupper($id_sales_cond) != "NP" && strtoupper($id_sales_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['id_sales'] = $Conteudo;
      $Conteudo = $unit_cost;
      if (strtoupper($unit_cost_cond) != "II" && strtoupper($unit_cost_cond) != "QP" && strtoupper($unit_cost_cond) != "NP" && strtoupper($unit_cost_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['unit_cost'] = $Conteudo;
      $Conteudo = $unit_value;
      if (strtoupper($unit_value_cond) != "II" && strtoupper($unit_value_cond) != "QP" && strtoupper($unit_value_cond) != "NP" && strtoupper($unit_value_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "2", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['unit_value'] = $Conteudo;

      //----- $id_sales_detail
      $this->Date_part = false;
      if (isset($id_sales_detail) || $id_sales_detail_cond == "nu" || $id_sales_detail_cond == "nn" || $id_sales_detail_cond == "ep" || $id_sales_detail_cond == "ne")
      {
         $this->monta_condicao("id_sales_detail", $id_sales_detail_cond, $id_sales_detail, "", "id_sales_detail");
      }

      //----- $id_sales
      $this->Date_part = false;
      if (isset($id_sales) || $id_sales_cond == "nu" || $id_sales_cond == "nn" || $id_sales_cond == "ep" || $id_sales_cond == "ne")
      {
         $this->monta_condicao("id_sales", $id_sales_cond, $id_sales, "", "id_sales");
      }

      //----- $unit_cost
      $this->Date_part = false;
      if (isset($unit_cost) || $unit_cost_cond == "nu" || $unit_cost_cond == "nn" || $unit_cost_cond == "ep" || $unit_cost_cond == "ne")
      {
         $this->monta_condicao("unit_cost", $unit_cost_cond, $unit_cost, "", "unit_cost");
      }

      //----- $unit_value
      $this->Date_part = false;
      if (isset($unit_value) || $unit_value_cond == "nu" || $unit_value_cond == "nn" || $unit_value_cond == "ep" || $unit_value_cond == "ne")
      {
         $this->monta_condicao("unit_value", $unit_value_cond, $unit_value, "", "unit_value");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail']['cond_pesq'] .= $this->NM_operador;
