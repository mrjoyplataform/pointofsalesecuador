...
<?php
   ...
   $Ord_Cmp = new grid_sales_detail_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_sales_detail_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sales_detail']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['minus'] = "minus";
   }
   else
   {
       $tab_def_campos['minus'] = "";
   }
   $tab_labels["minus"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail']['labels']["minus"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail']['labels']["minus"] : "";
   $tab_ger_campos['more'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['more'] = "more";
   }
   else
   {
       $tab_def_campos['more'] = "";
   }
   $tab_labels["more"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail']['labels']["more"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail']['labels']["more"] : "";
   $tab_ger_campos['quantity'] = "on";
   $tab_def_campos['quantity'] = "quantity";
   $tab_labels["quantity"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail']['labels']["quantity"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail']['labels']["quantity"] : "" . $this->Nm_lang['lang_sales_detail_fld_quantity'] . "";
   $tab_ger_campos['id_product'] = "on";
   $tab_def_campos['id_product'] = "id_product";
   $tab_labels["id_product"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail']['labels']["id_product"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail']['labels']["id_product"] : "" . $this->Nm_lang['lang_sales_detail_fld_id_product'] . "";
   $tab_ger_campos['unit_value'] = "on";
   $tab_def_campos['unit_value'] = "unit_value";
   $tab_labels["unit_value"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail']['labels']["unit_value"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail']['labels']["unit_value"] : "" . $this->Nm_lang['lang_sales_detail_fld_unit_value'] . "";
   $tab_ger_campos['discount'] = "on";
   $tab_def_campos['discount'] = "discount";
   $tab_labels["discount"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail']['labels']["discount"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail']['labels']["discount"] : "" . $this->Nm_lang['lang_sales_detail_fld_discount'] . "";
   $tab_ger_campos['item_total'] = "on";
   $tab_def_campos['item_total'] = "item_total";
   $tab_labels["item_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail']['labels']["item_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail']['labels']["item_total"] : "" . $this->Nm_lang['lang_sales_detail_fld_item_total'] . "";
   $tab_ger_campos['del'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['del'] = "del";
   }
   else
   {
       $tab_def_campos['del'] = "";
   }
   $tab_labels["del"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail']['labels']["del"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail']['labels']["del"] : "";
   $tab_ger_campos['minus'] = "none";
   $tab_ger_campos['more'] = "none";
   $tab_ger_campos['del'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_sales_detail']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_sales_detail']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sales_detail']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_sales_detail']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_sales_detail']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_sales_detail']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_sales_detail']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_sales_detail']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_sales_detail']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_sales_detail_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_sales_detail']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_sales_detail']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_sales_detail']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
