...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_mm_cond" name="mm_cond" onChange="nm_campos_between(document.getElementById('id_vis_mm'), this, 'mm')">
      ...
      <br><span id="id_hide_mm"  <?php echo $str_hide_mm?>><?php
      if ($mm != "")
      {
      $mm_look = substr($this->Db->qstr($mm), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_opc_cond" name="opc_cond" onChange="nm_campos_between(document.getElementById('id_vis_opc'), this, 'opc')">
      ...
      <br><span id="id_hide_opc"  <?php echo $str_hide_opc?>><?php
      if ($opc != "")
      {
      $opc_look = substr($this->Db->qstr($opc), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_rg_cond" name="rg_cond" onChange="nm_campos_between(document.getElementById('id_vis_rg'), this, 'rg')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_opcion_cond" name="opcion_cond" onChange="nm_campos_between(document.getElementById('id_vis_opcion'), this, 'opcion')">
      ...
      <br><span id="id_hide_opcion"  <?php echo $str_hide_opcion?>><?php
      if ($opcion != "")
      {
      $opcion_look = substr($this->Db->qstr($opcion), 1, -1); 
      $nmgp_def_dados = array(); 
