<?php
@session_start() ;
$_SESSION['scriptcase']['grid_submenu_opciones']['sc_process_barr'] = true;
require_once('../grid_submenu_opciones/index.php');
unset($_SESSION['scriptcase']['grid_submenu_opciones']['sc_process_barr']);
$ExportCtrl = new grid_submenu_opciones_export_control;
$ExportCtrl->Export_barr();

class grid_submenu_opciones_export_control
{
