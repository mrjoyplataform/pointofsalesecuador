...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_submenu_opciones"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_submenu_opciones"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_submenu_opciones']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_submenu_opciones']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_submenu_opciones']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_submenu_opciones']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_submenu_opciones']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_submenu_opciones</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_submenu_opciones']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_submenu_opciones']['embutida_filho'] as $ind => $sc_init)
          {
