  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_califica_selecciona_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_califica_selecciona_mob_form();
	}
...
?>
  ...
  // ---------- Validate logomr
  function do_ajax_control_califica_selecciona_mob_validate_logomr()
  {
    var nomeCampo_logomr = "logomr";
    var var_logomr = scAjaxGetFieldText(nomeCampo_logomr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_califica_selecciona_mob_validate_logomr(var_logomr, var_script_case_init, do_ajax_control_califica_selecciona_mob_validate_logomr_cb);
  } // do_ajax_control_califica_selecciona_mob_validate_logomr

  function do_ajax_control_califica_selecciona_mob_validate_logomr_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_califica_selecciona_mob_validate_logomr_cb

  // ---------- Validate titulo
  function do_ajax_control_califica_selecciona_mob_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldHidden(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_califica_selecciona_mob_validate_titulo(var_titulo, var_script_case_init, do_ajax_control_califica_selecciona_mob_validate_titulo_cb);
  } // do_ajax_control_califica_selecciona_mob_validate_titulo

  function do_ajax_control_califica_selecciona_mob_validate_titulo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "titulo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_califica_selecciona_mob_validate_titulo_cb

  // ---------- Validate val1
  function do_ajax_control_califica_selecciona_mob_validate_val1()
  {
    var nomeCampo_val1 = "val1";
    var var_val1 = scAjaxGetFieldText(nomeCampo_val1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_califica_selecciona_mob_validate_val1(var_val1, var_script_case_init, do_ajax_control_califica_selecciona_mob_validate_val1_cb);
  } // do_ajax_control_califica_selecciona_mob_validate_val1

  function do_ajax_control_califica_selecciona_mob_validate_val1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "val1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_califica_selecciona_mob_validate_val1_cb

  // ---------- Validate val2
  function do_ajax_control_califica_selecciona_mob_validate_val2()
  {
    var nomeCampo_val2 = "val2";
    var var_val2 = scAjaxGetFieldText(nomeCampo_val2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_califica_selecciona_mob_validate_val2(var_val2, var_script_case_init, do_ajax_control_califica_selecciona_mob_validate_val2_cb);
  } // do_ajax_control_califica_selecciona_mob_validate_val2

  function do_ajax_control_califica_selecciona_mob_validate_val2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "val2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_califica_selecciona_mob_validate_val2_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_califica_selecciona_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_califica_selecciona_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_logomr = "";
    ...
    scAjaxProcOn();
    x_ajax_control_califica_selecciona_mob_submit_form(var_logomr, var_titulo, var_val1, var_val2, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_califica_selecciona_mob_submit_form_cb);
  } // do_ajax_control_califica_selecciona_mob_submit_form

  function do_ajax_control_califica_selecciona_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_califica_selecciona_mob_submit_form_cb_after_alert);
  } // do_ajax_control_califica_selecciona_mob_submit_form_cb
  function do_ajax_control_califica_selecciona_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_califica_selecciona_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_califica_selecciona_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_control_califica_selecciona_mob_navigate_form, function() {});
    } else {
      perform_ajax_control_califica_selecciona_mob_navigate_form();
    }
  }

  function perform_ajax_control_califica_selecciona_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_califica_selecciona_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_selecciona_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_califica_selecciona_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_califica_selecciona_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_califica_selecciona_mob_navigate_form_cb
  function do_ajax_control_califica_selecciona_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_califica_selecciona_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_califica_selecciona_mob_navigate_form_cb_after_alert

  function sc_hide_control_califica_selecciona_mob_form()
  {
