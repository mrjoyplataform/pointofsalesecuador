<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_boletos_preview']['sc_process_barr'] = true;
require_once('../pdfreport_boletos_preview/index.php');
unset($_SESSION['scriptcase']['pdfreport_boletos_preview']['sc_process_barr']);
$ExportCtrl = new pdfreport_boletos_preview_export_control;
$ExportCtrl->Export_barr();

class pdfreport_boletos_preview_export_control
{
