<?php
include_once('menu_mainpos_inicio_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_path_prod']      = "";
    $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_perfil']         = "";
    $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_usa_grupo']      = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class menu_mainpos_inicio_class
{
  var $Db;
 ...
 function menu_mainpos_inicio_menu()
 {
    global $menu_mainpos_inicio_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['menu_mainpos_inicio']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "menu_mainpos_inicio/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('menu_mainpos_inicio');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/menu_mainpos_inicio_erro.php");
}
include_once(dirname(__FILE__) . "/menu_mainpos_inicio_erro.class.php"); 
$this->Erro = new menu_mainpos_inicio_erro();
$str_path = substr($_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_conexao']);
}

/* Definiciones de las rutas */
$menu_mainpos_inicio_menuData         = array();
$menu_mainpos_inicio_menuData['path'] = array();
$menu_mainpos_inicio_menuData['url']  = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menu_mainpos_inicio_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menu_mainpos_inicio_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menu_mainpos_inicio_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menu_mainpos_inicio_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menu_mainpos_inicio_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menu_mainpos_inicio_menuData['url']['web']   = str_replace("\\", '/', $menu_mainpos_inicio_menuData['url']['web']);
$menu_mainpos_inicio_menuData['path']['root'] = substr($menu_mainpos_inicio_menuData['path']['sys'],  0, -1 * strlen($menu_mainpos_inicio_menuData['url']['web']));
$menu_mainpos_inicio_menuData['path']['app']  = substr($menu_mainpos_inicio_menuData['path']['sys'],  0, strrpos($menu_mainpos_inicio_menuData['path']['sys'],  '/'));
$menu_mainpos_inicio_menuData['path']['link'] = substr($menu_mainpos_inicio_menuData['path']['app'],  0, strrpos($menu_mainpos_inicio_menuData['path']['app'],  '/'));
$menu_mainpos_inicio_menuData['path']['link'] = substr($menu_mainpos_inicio_menuData['path']['link'], 0, strrpos($menu_mainpos_inicio_menuData['path']['link'], '/')) . '/';
$menu_mainpos_inicio_menuData['path']['app'] .= '/';
$menu_mainpos_inicio_menuData['url']['app']   = substr($menu_mainpos_inicio_menuData['url']['web'],  0, strrpos($menu_mainpos_inicio_menuData['url']['web'],  '/'));
$menu_mainpos_inicio_menuData['url']['link']  = substr($menu_mainpos_inicio_menuData['url']['app'],  0, strrpos($menu_mainpos_inicio_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_usa_grupo'] == "S")
{
    $menu_mainpos_inicio_menuData['url']['link']  = substr($menu_mainpos_inicio_menuData['url']['link'], 0, strrpos($menu_mainpos_inicio_menuData['url']['link'], '/'));
}
$menu_mainpos_inicio_menuData['url']['link']  .= '/';
$menu_mainpos_inicio_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['menu_mainpos_inicio']['sc_apl_link'] = $menu_mainpos_inicio_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['menu_mainpos_inicio']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['menu_mainpos_inicio']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['menu_mainpos_inicio']['actual_lang']) || $_SESSION['scriptcase']['menu_mainpos_inicio']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['menu_mainpos_inicio']['actual_lang'] = $this->str_lang;
...
include_once("menu_mainpos_inicio_toolbar.php");
...
if ($_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "menu_mainpos_inicio";
     $_SESSION['scriptcase']['menu_apls']['menu_mainpos_inicio'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_conexao']) && $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_perfil']) && $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_mainpos_inicio']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['menu_mainpos_inicio']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['menu_mainpos_inicio']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['menu_mainpos_inicio']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['menu_mainpos_inicio']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['menu_mainpos_inicio']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['menu_mainpos_inicio']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['menu_mainpos_inicio']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['menu_mainpos_inicio']['init']))
{
    $_SESSION['sc_session'][1]['menu_mainpos_inicio']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menu_mainpos_inicio']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['menu_mainpos_inicio']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menu_mainpos_inicio'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menu_mainpos_inicio'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menu_mainpos_inicio'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$this->sc_Include($path_libs . "/nm_ini_lib.php", "F", "nm_dir_normaliza") ; 
/* Dados do menu em sessao */
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menu_mainpos_inicio'))
{
    $_SESSION['sc_session'][1]['menu_mainpos_inicio']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menu_mainpos_inicio'] = "javascript:window.close()";
}
/* Menú de configuración de las variables */
$menu_mainpos_inicio_menuData['iframe'] = TRUE;
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_mainpos_inicio'];
$menu_mainpos_inicio_menuData['data'] .= "item_4|.|" . $nm_var_lab[0] . "|menu_mainpos_inicio_form_php.php?sc_item_menu=item_4&sc_apl_menu=http://mainserver/mrjoy/app/dashboardinicio/&sc_apl_link=" . urlencode($menu_mainpos_inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "|grp__NM__btn__NM__compraboton.png|" . $this->menu_mainpos_inicio_target('_self') . "|" . "\n";
$menu_mainpos_inicio_menuData['data'] .= "item_1|.|" . $nm_var_lab[1] . "|menu_mainpos_inicio_form_php.php?sc_item_menu=item_1&sc_apl_menu=http://mainserver/mrjoy/app/dashboardmapa/&sc_apl_link=" . urlencode($menu_mainpos_inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "|grp__NM__btn__NM__botonmapa.png|" . $this->menu_mainpos_inicio_target('_self') . "|" . "\n";
$menu_mainpos_inicio_menuData['data'] .= "item_2|.|" . $nm_var_lab[2] . "|menu_mainpos_inicio_form_php.php?sc_item_menu=item_2&sc_apl_menu=https://mrjoy.com.ec/ed-atracciones&sc_apl_link=" . urlencode($menu_mainpos_inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "|grp__NM__btn__NM__botonjuegos.png|" . $this->menu_mainpos_inicio_target('_self') . "|" . "\n";
$menu_mainpos_inicio_menuData['data'] .= "item_3|.|" . $nm_var_lab[3] . "|menu_mainpos_inicio_form_php.php?sc_item_menu=item_3&sc_apl_menu=http://mainserver/mrjoy/app/terminos/&sc_apl_link=" . urlencode($menu_mainpos_inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "|grp__NM__btn__NM__botonreglas.png|" . $this->menu_mainpos_inicio_target('_self') . "|" . "\n";
$menu_mainpos_inicio_menuData['data'] .= "item_5|.|" . $nm_var_lab[4] . "|menu_mainpos_inicio_form_php.php?sc_item_menu=item_5&sc_apl_menu=https://mrjoy.com.ec/ed-faq&sc_apl_link=" . urlencode($menu_mainpos_inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "|grp__NM__btn__NM__preguntasboton.png|" . $this->menu_mainpos_inicio_target('_self') . "|" . "\n";
...
$menu_mainpos_inicio_menuData['data'] = array();
$str_disabled = "N";
$str_link = "menu_mainpos_inicio_form_php.php?sc_item_menu=item_4&sc_apl_menu=http://mainserver/mrjoy/app/dashboardinicio/&sc_apl_link=" . urlencode($menu_mainpos_inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_usa_grupo'] . "";
$str_icon = "grp__NM__btn__NM__compraboton.png";
$icon_aba = "";
$icon_aba_inactive = "";
...
$menu_mainpos_inicio_menuData['data'][] = array(
    ...
    'target'   => " item-target=\"" . $this->menu_mainpos_inicio_target('_self') . "\"",
    'sc_id'    => "item_4",
...
$str_disabled = "N";
$str_link = "menu_mainpos_inicio_form_php.php?sc_item_menu=item_1&sc_apl_menu=http://mainserver/mrjoy/app/dashboardmapa/&sc_apl_link=" . urlencode($menu_mainpos_inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_usa_grupo'] . "";
$str_icon = "grp__NM__btn__NM__botonmapa.png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
{
...
$str_disabled = "N";
$str_link = "menu_mainpos_inicio_form_php.php?sc_item_menu=item_2&sc_apl_menu=https://mrjoy.com.ec/ed-atracciones&sc_apl_link=" . urlencode($menu_mainpos_inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_usa_grupo'] . "";
$str_icon = "grp__NM__btn__NM__botonjuegos.png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
{
...
$str_disabled = "N";
$str_link = "menu_mainpos_inicio_form_php.php?sc_item_menu=item_3&sc_apl_menu=http://mainserver/mrjoy/app/terminos/&sc_apl_link=" . urlencode($menu_mainpos_inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_usa_grupo'] . "";
$str_icon = "grp__NM__btn__NM__botonreglas.png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
{
...
$str_disabled = "N";
$str_link = "menu_mainpos_inicio_form_php.php?sc_item_menu=item_5&sc_apl_menu=https://mrjoy.com.ec/ed-faq&sc_apl_link=" . urlencode($menu_mainpos_inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_usa_grupo'] . "";
$str_icon = "grp__NM__btn__NM__preguntasboton.png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
{
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_mainpos_inicio']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['menu_mainpos_inicio']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'menu_mainpos_inicio');
    $menu_mainpos_inicio_menuData['data'] = $str_menu_usu;
}
if (is_file("menu_mainpos_inicio_help.txt"))
{
    $Arq_WebHelp = file("menu_mainpos_inicio_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menu_mainpos_inicio_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->menu_mainpos_inicio_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menu_mainpos_inicio']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menu_mainpos_inicio']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($menu_mainpos_inicio_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['menu_mainpos_inicio']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($menu_mainpos_inicio_menuData['data'][$i_menu]);
       }
    ...
    $menu_mainpos_inicio_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['menu_mainpos_inicio']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menu_mainpos_inicio']))
{
    $disable_menu = false;
    foreach ($menu_mainpos_inicio_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['menu_mainpos_inicio']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $menu_mainpos_inicio_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* Cabecera HTML */
if ($menu_mainpos_inicio_menuData['iframe'])
{
    $menu_mainpos_inicio_menuData['height'] = '100%';
...
<head>
 <title>menu_mainpos_inicio</title>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
{
    $menu_mainpos_inicio_menuData['height'] = '30px';
}
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="menu_mainpos_inicio_message.js"></script>
...
Iframe_atual = "menu_mainpos_inicio_iframe";
...
{
  if (str_id != "iframe_menu_mainpos_inicio")
  {
      str_id        = str_id.replace("menu_mainpos_inicio_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    ...
    if(str_target != '_blank' && $('#iframe_menu_mainpos_inicio').length)
        $('#iframe_menu_mainpos_inicio')[0].contentWindow.focus();
  }
}
</script>
<?php
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $menu_mainpos_inicio_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->menu_mainpos_inicio_escreveMenu($menu_mainpos_inicio_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Control de iframe */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $menu_mainpos_inicio_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
<?php
}
else
{
...
?>
    <div id="Iframe_control" style='width:100%; height:100%; margin:0px; padding:0px;'>
      <iframe id="iframe_menu_mainpos_inicio" name="menu_mainpos_inicio_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo ($NM_scr_iframe != "" ? $NM_scr_iframe : "http://mainserver/mrjoy/app/dashboardinicio/"); ?> " ></iframe>
<?php
}
?></div></td>
  </tr>
...
/* Control de Target */
function menu_mainpos_inicio_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function menu_mainpos_inicio_target($str_target)
{
    global $menu_mainpos_inicio_menuData;
    ...
    elseif ($menu_mainpos_inicio_menuData['iframe'])
    {
        return 'menu_mainpos_inicio_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $menu_mainpos_inicio_menuData, $path_imag_cab)
{
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "menu_mainpos_inicio_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_mainpos_inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "menu_mainpos_inicio_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_mainpos_inicio_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->menu_mainpos_inicio_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['menu_mainpos_inicio']['sc_init'][$apl_menu] = 1;
        return  1;
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_path_imag_temp'] . "/sc_apl_default_pointofsales.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu_mainpos_inicio']['glo_nm_path_imag_temp'] . "/sc_apl_default_pointofsales.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "menu_mainpos_inicio") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['menu_mainpos_inicio']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['menu_mainpos_inicio']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['menu_mainpos_inicio']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_pointofsales'])) {
            $_SESSION['scriptcase']['menu_mainpos_inicio']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_pointofsales'];
        }
    }
}
...
$contr_menu_mainpos_inicio = new menu_mainpos_inicio_class;
$contr_menu_mainpos_inicio->menu_mainpos_inicio_menu();
