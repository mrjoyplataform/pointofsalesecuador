...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["menu_mainpos_inicio"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>pictonmrjoy/pictonmrjoy_menuMobile.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>pictonmrjoy/pictonmrjoy_menuMobile<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menu_mainpos_inicio"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menu_mainpos_inicio"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    <style>
    <?php
    if(isset($menu_mainpos_inicio_menuData["data"]) && is_array($menu_mainpos_inicio_menuData["data"]) && !empty($menu_mainpos_inicio_menuData["data"]))
    {
        foreach($menu_mainpos_inicio_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($menu_mainpos_inicio_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
