...
class grid_submenu_rtf
{
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_submenu']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_submenu']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_submenu']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_submenu']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_submenu']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_submenu']['rtf_name']);
      }
   ...
   function NM_export_mm()
   {
         ...
         $this->mm = str_replace('<', '&lt;', $this->mm);
         $this->mm = str_replace('>', '&gt;', $this->mm);
         $this->Texto_tag .= "<td>" . $this->mm . "</td>\r\n";
   }
   //----- opc
   function NM_export_opc()
   {
         ...
         $this->opc = str_replace('<', '&lt;', $this->opc);
         $this->opc = str_replace('>', '&gt;', $this->opc);
         $this->Texto_tag .= "<td>" . $this->opc . "</td>\r\n";
   }
   //----- rg
   ...
   function NM_export_users()
   {
         ...
         $this->users = str_replace('<', '&lt;', $this->users);
         $this->users = str_replace('>', '&gt;', $this->users);
         $this->Texto_tag .= "<td>" . $this->users . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_submenu']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_submenu']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
