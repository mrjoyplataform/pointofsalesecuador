<?php
@session_start() ;
$_SESSION['scriptcase']['grid_submenu']['sc_process_barr'] = true;
require_once('../grid_submenu/index.php');
unset($_SESSION['scriptcase']['grid_submenu']['sc_process_barr']);
$ExportCtrl = new grid_submenu_export_control;
$ExportCtrl->Export_barr();

class grid_submenu_export_control
{
