...
class grid_turnos_abiertos_idcaja_cierre_admin_json
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_turnos_abiertos_idcaja_cierre_admin/grid_turnos_abiertos_idcaja_cierre_admin_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['json_format'];
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['json_return']);
      ...
      $this->Arquivo     .= ".json";
      $this->Tit_doc      = "grid_turnos_abiertos_idcaja_cierre_admin.json";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['json_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['json_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['json_name'] .= ".json";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['json_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['json_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['json_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['json_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['json_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['json_name']);
      }
...
$_SESSION['scriptcase']['grid_turnos_abiertos_idcaja_cierre_admin']['contr_erro'] = 'off'; 
      ...
      { 
          ...
          { 
              ...
              require_once($this->Ini->path_aplicacao . "grid_turnos_abiertos_idcaja_cierre_admin_res_json.class.php");
              $this->Res = new grid_turnos_abiertos_idcaja_cierre_admin_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['json_res_grid']);
          } 
      }
   ...
   function NM_export_idempleado()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->look_idempleado;
   }
   //----- idcaja
   ...
   function NM_export_fondo_inicial()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->fondo_inicial;
   }
   //----- entrega_efectivo
   function NM_export_entrega_efectivo()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->entrega_efectivo;
   }
   //----- ingresaefectivo
   function NM_export_ingresaefectivo()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->ingresaefectivo;
   }
   //----- entrega_tarjeta
   function NM_export_entrega_tarjeta()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->entrega_tarjeta;
   }
   //----- ingresatarjeta
   function NM_export_ingresatarjeta()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->ingresatarjeta;
   }
   //----- total_entrega
   function NM_export_total_entrega()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->total_entrega;
   }
   //----- numero_trans
   function NM_export_numero_trans()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->numero_trans;
   }
   //----- sistema_efectivo
   function NM_export_sistema_efectivo()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->sistema_efectivo;
   }
   //----- sistema_tarjeta
   function NM_export_sistema_tarjeta()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->sistema_tarjeta;
   }
   //----- sistema_total
   function NM_export_sistema_total()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->sistema_total;
   }
   //----- diferencia
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['json_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['json_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Cierre de caja turno # <?php echo $_SESSION['idturno'] ?> :: JSON</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_abiertos_idcaja_cierre_admin']['json_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
