...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['grid_turnos_abiertos_idcaja_cierre_admin']['contr_erro']) && $_SESSION['scriptcase']['grid_turnos_abiertos_idcaja_cierre_admin']['contr_erro'] == 'on')
    {
