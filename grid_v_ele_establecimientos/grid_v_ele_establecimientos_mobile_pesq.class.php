...
<HTML>
<HEAD>
 <TITLE> v_ele_establecimientos</TITLE>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nombre_comercial_cond" name="nombre_comercial_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombre_comercial'), this, 'nombre_comercial')">
      ...
      <br><span id="id_hide_nombre_comercial"  <?php echo $str_hide_nombre_comercial?>><?php
      if ($nombre_comercial != "")
      {
      $nombre_comercial_look = substr($this->Db->qstr($nombre_comercial), 1, -1); 
      $nmgp_def_dados = array(); 
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_id"  <?php echo $str_hide_id?>><INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_establecimiento_cond" name="establecimiento_cond" onChange="nm_campos_between(document.getElementById('id_vis_establecimiento'), this, 'establecimiento')">
      ...
      <br><span id="id_hide_establecimiento"  <?php echo $str_hide_establecimiento?>><?php
      if ($establecimiento != "")
      {
      $establecimiento_look = substr($this->Db->qstr($establecimiento), 1, -1); 
      $nmgp_def_dados = array(); 
