...
class grid_product_snackbar_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_id_status   = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_product_snackbar']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_product_snackbar']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['contr_total_geral'] == "OK")
      {
          $this->array_total_id_status = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['arr_total']['id_status'];
          $this->array_total_id_category = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['arr_total']['id_category'];
      }
      else
      {
          $this->array_total_id_status = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['arr_total']['id_status'] = $this->array_total_id_status;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['arr_total']['id_category'] = $this->array_total_id_category;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['json_use_label'])
       {
          $Lab_id_status = "id_status";
          $Lab_id_category = "id_category";
       }
       else
       {
       $Lab_id_status = "" . $this->Ini->Nm_lang['lang_product_fld_id_status'] . "";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['id_product']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['id_product'] = "" . $this->Ini->Nm_lang['lang_product_fld_id_product'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['product_name']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['product_name'] = "" . $this->Ini->Nm_lang['lang_product_fld_product_name'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['product_code']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['product_code'] = "" . $this->Ini->Nm_lang['lang_product_fld_product_code'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['id_status']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['id_status'] = "" . $this->Ini->Nm_lang['lang_product_fld_id_status'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['stock']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['stock'] = "" . $this->Ini->Nm_lang['lang_product_fld_stock'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['product_value']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['product_value'] = "" . $this->Ini->Nm_lang['lang_product_fld_product_value'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['kiosko']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['kiosko'] = "Kiosko"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['entrada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['entrada'] = "Entrada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['jugador']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['jugador'] = "Jugador"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['visitante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['visitante'] = "Visitante"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['service']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['service'] = "Service"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['tarjeta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['tarjeta'] = "Tarjeta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['minutos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['minutos'] = "Minutos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['tokens']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['tokens'] = "Tokens"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['comida']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['comida'] = "Comida"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['score']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['score'] = "Score"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['poriva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['poriva'] = "Poriva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['cuentaventa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['cuentaventa'] = "Cuentaventa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['unidad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['unidad'] = "Unidad"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['tipoitem']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['tipoitem'] = "Tipoitem"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['cuentacompra']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['cuentacompra'] = "Cuentacompra"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['precioventa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['precioventa'] = "Precioventa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['puntoventa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['puntoventa'] = "Puntoventa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['orden']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['orden'] = "Orden"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['id_category']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['id_category'] = "" . $this->Ini->Nm_lang['lang_product_fld_id_category'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['dateproduct']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['dateproduct'] = "" . $this->Ini->Nm_lang['lang_product_fld_dateproduct'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['product_cost']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['product_cost'] = "" . $this->Ini->Nm_lang['lang_product_fld_product_cost'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['discount']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['discount'] = "Discount"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['image']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['image'] = "" . $this->Ini->Nm_lang['lang_product_fld_image'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['arcade_clasic']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['arcade_clasic'] = "Arcade Clasic"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['ultfechaventa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['ultfechaventa'] = "Ultfechaventa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['ingrediente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['labels']['ingrediente'] = "Ingrediente"; 
       }
       //-----
       $this->comp_field_nm = array(
           'id_status' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['summarizing_fields_order']['id_category']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['summarizing_fields_order']['id_category'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['summarizing_fields_order']['id_category'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['summarizing_fields_display']['id_category'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['summarizing_fields_display']['id_category'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['summarizing_fields_display']['id_category'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['summarizing_fields_display']['id_category'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['summarizing_fields_display']['id_category'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['summarizing_fields_display']['id_category'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['summarizing_fields_display']['id_category'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_id_status as $i_id_status => $d_id_status) {
           if (!in_array($i_id_status, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_id_status[2] ] = $d_id_status[1];
               $this->comp_label[0][ $d_id_status[2] ] = $d_id_status[1];
           }
           foreach ($this->array_total_id_category[$i_id_status] as $i_id_category => $d_id_category) {
               if (!in_array($i_id_category, $this->comp_label[1][ $d_id_status[2] ], true)) {
                   $this->comp_index[1][ $d_id_category[2] ] = $d_id_category[1];
                   $this->comp_label[1][ $d_id_status[2] ][ $d_id_category[2] ] = $d_id_category[1];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'id_status', 'prot' => ''),
           array('name' => 'id_category', 'prot' => ''),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_id_status => $l_id_status) {
           if (isset($this->array_total_id_status[$i_id_status])) {
               $this->comp_group[$i_id_status] = array();
           }
           foreach ($this->comp_label[1][$i_id_status] as $i_id_category => $l_id_category) {
               if (isset($this->array_total_id_category[$i_id_status][$i_id_category])) {
                   $this->comp_group[$i_id_status][$i_id_category] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_id_status;
       }
       elseif (1 == $level) {
           $return = $this->array_total_id_category;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_product_snackbar@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_product_snackbar_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_product_snackbar_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_product_snackbar_total.class.php"); 
      }
      ...
      $this->Total   = new grid_product_snackbar_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_id_category("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_id_status);
      ksort($this->array_total_id_category);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_product_snackbar/grid_product_snackbar_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_product_snackbar_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_product_snackbar_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_product_snackbar_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['num_css'] . '.css');
     ...
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "Rjson_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_product_snackbar/grid_product_snackbar_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_json_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_json_format=N&nm_json_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_product_snackbar/grid_product_snackbar_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_product_snackbar/grid_product_snackbar_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_product_snackbar_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_product_snackbar']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_product_snackbar']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_product_snackbar_config_pivot.php?nome_apl=grid_product_snackbar&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_product_snackbar_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_product_snackbar/grid_product_snackbar_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_product_snackbar']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   //---- 
   function adiciona_registro($quebra_id_status, $quebra_id_category, $quebra_id_status_orig, $quebra_id_category_orig)
   {
      //----- id_status
      if (!isset($this->array_total_id_status[$quebra_id_status_orig]))
      {
         $this->array_total_id_status[$quebra_id_status_orig][0] = 1;
         $this->array_total_id_status[$quebra_id_status_orig][1] = $quebra_id_status;
         $this->array_total_id_status[$quebra_id_status_orig][2] = $quebra_id_status_orig;
      }
      else
      {
         $this->array_total_id_status[$quebra_id_status_orig][0]++;
      }
      //----- id_category
      if (!isset($this->array_total_id_category[$quebra_id_status_orig][$quebra_id_category_orig]))
      {
         $this->array_total_id_category[$quebra_id_status_orig][$quebra_id_category_orig][0] = 1;
         $this->array_total_id_category[$quebra_id_status_orig][$quebra_id_category_orig][1] = $quebra_id_category;
         $this->array_total_id_category[$quebra_id_status_orig][$quebra_id_category_orig][2] = $quebra_id_category_orig;
      }
      else
      {
         $this->array_total_id_category[$quebra_id_status_orig][$quebra_id_category_orig][0]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'id_status');
     $campos_order = $this->Ini->Get_date_order_groupby("id_status", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'id_category');
     $campos_order = $this->Ini->Get_date_order_groupby("id_category", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->product_code = $rs_res->fields[2] ;  
            $this->id_status = $rs_res->fields[3] ;  
            $this->stock = $rs_res->fields[4] ;  
            $this->product_value = $rs_res->fields[5] ;  
            $this->product_value =  str_replace(",", ".", $this->product_value);
            $this->kiosko = $rs_res->fields[6] ;  
            $this->entrada = $rs_res->fields[7] ;  
            $this->jugador = $rs_res->fields[8] ;  
            $this->visitante = $rs_res->fields[9] ;  
            $this->service = $rs_res->fields[10] ;  
            $this->tarjeta = $rs_res->fields[11] ;  
            $this->minutos = $rs_res->fields[12] ;  
            $this->tokens = $rs_res->fields[13] ;  
            $this->comida = $rs_res->fields[14] ;  
            $this->score = $rs_res->fields[15] ;  
            $this->poriva = $rs_res->fields[16] ;  
            $this->poriva =  str_replace(",", ".", $this->poriva);
            $this->cuentaventa = $rs_res->fields[17] ;  
            $this->unidad = $rs_res->fields[18] ;  
            $this->tipoitem = $rs_res->fields[19] ;  
            $this->cuentacompra = $rs_res->fields[20] ;  
            $this->precioventa = $rs_res->fields[21] ;  
            $this->puntoventa = $rs_res->fields[22] ;  
            $this->orden = $rs_res->fields[23] ;  
            $this->id_category = $rs_res->fields[24] ;  
            $this->dateproduct = $rs_res->fields[25] ;  
            $this->look_id_status = $this->id_status; 
            $this->Lookup->lookup_id_status($this->look_id_status, $this->id_status) ; 
            $this->id_status_orig = $this->id_status;
            $this->id_category_orig = $this->id_category;
            $this->id_status = $this->look_id_status ;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->id_status, $this->id_category, $this->id_status_orig,  $this->id_category_orig);
            }
   }
//
