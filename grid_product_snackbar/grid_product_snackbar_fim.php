...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_product_snackbar"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_product_snackbar"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_product_snackbar'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_product_snackbar']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_product_snackbar']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_product_snackbar']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_product_snackbar']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_product_snackbar']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_product_snackbar</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_product_snackbar']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_product_snackbar']['embutida_filho'] as $ind => $sc_init)
          {
