...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_id_product_cond" name="id_product_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_product'), this, 'id_product')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_product_name_cond" name="product_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_product_name'), this, 'product_name')">
      ...
      <br><span id="id_hide_product_name"  <?php echo $str_hide_product_name?>><?php
      if ($product_name != "")
      {
      $product_name_look = substr($this->Db->qstr($product_name), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_product_code_cond" name="product_code_cond" onChange="nm_campos_between(document.getElementById('id_vis_product_code'), this, 'product_code')">
      ...
      <br><span id="id_hide_product_code"  <?php echo $str_hide_product_code?>><?php
      if ($product_code != "")
      {
      $product_code_look = substr($this->Db->qstr($product_code), 1, -1); 
      $nmgp_def_dados = array(); 
