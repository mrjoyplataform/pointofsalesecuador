  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_params" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idparams_
  function do_ajax_form_params_validate_idparams_(iNumLinha)
  {
    var nomeCampo_idparams_ = "idparams_" + iNumLinha;
    var var_idparams_ = scAjaxGetFieldText(nomeCampo_idparams_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_params_validate_idparams_(var_idparams_, iNumLinha, var_script_case_init, do_ajax_form_params_validate_idparams__cb);
  } // do_ajax_form_params_validate_idparams_

  function do_ajax_form_params_validate_idparams__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idparams_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idparams_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idparams_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idparams_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_params_validate_idparams__cb

  // ---------- Validate descrip_
  function do_ajax_form_params_validate_descrip_(iNumLinha)
  {
    var nomeCampo_descrip_ = "descrip_" + iNumLinha;
    var var_descrip_ = scAjaxGetFieldText(nomeCampo_descrip_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_params_validate_descrip_(var_descrip_, iNumLinha, var_script_case_init, do_ajax_form_params_validate_descrip__cb);
  } // do_ajax_form_params_validate_descrip_

  function do_ajax_form_params_validate_descrip__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_params_validate_descrip__cb

  // ---------- Validate numerico_
  function do_ajax_form_params_validate_numerico_(iNumLinha)
  {
    var nomeCampo_numerico_ = "numerico_" + iNumLinha;
    var var_numerico_ = scAjaxGetFieldText(nomeCampo_numerico_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_params_validate_numerico_(var_numerico_, iNumLinha, var_script_case_init, do_ajax_form_params_validate_numerico__cb);
  } // do_ajax_form_params_validate_numerico_

  function do_ajax_form_params_validate_numerico__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "numerico_" + iLineNumber;
    }
    else
    {
      sFieldValid = "numerico_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "numerico_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "numerico_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_params_validate_numerico__cb

  // ---------- Validate texto_
  function do_ajax_form_params_validate_texto_(iNumLinha)
  {
    var nomeCampo_texto_ = "texto_" + iNumLinha;
    var var_texto_ = scAjaxGetFieldText(nomeCampo_texto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_params_validate_texto_(var_texto_, iNumLinha, var_script_case_init, do_ajax_form_params_validate_texto__cb);
  } // do_ajax_form_params_validate_texto_

  function do_ajax_form_params_validate_texto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "texto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "texto_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "texto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "texto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_params_validate_texto__cb

  // ---------- Validate binario_
  function do_ajax_form_params_validate_binario_(iNumLinha)
  {
    var nomeCampo_binario_ = "binario_" + iNumLinha;
    var var_binario_ = scAjaxGetFieldText(nomeCampo_binario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_params_validate_binario_(var_binario_, iNumLinha, var_script_case_init, do_ajax_form_params_validate_binario__cb);
  } // do_ajax_form_params_validate_binario_

  function do_ajax_form_params_validate_binario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "binario_" + iLineNumber;
    }
    else
    {
      sFieldValid = "binario_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "binario_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "binario_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_params_validate_binario__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_params_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_params_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_params_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_params_add_new_line_cb);
  } // do_ajax_form_params_add_new_line

  function do_ajax_form_params_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    eval("var_ajax_img_binario_" + iAjaxNewLine + " = '';");
  } // do_ajax_form_params_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_params_backup_line(iNumLinha)
  {
    var var_idparams_ = scAjaxGetFieldText("idparams_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_params_backup_line(var_idparams_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_params_backup_line_cb);
  } // do_ajax_form_params_backup_line

  function do_ajax_form_params_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_params_backup_line_cb

  function do_ajax_form_params_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_params_cancel_insert

  function do_ajax_form_params_cancel_update(iSeqVert)
  {
    do_ajax_form_params_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_params_cancel_update

  function do_ajax_form_params_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_params_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_params_table_refresh()
  {
    var var_idparams_ = document.F2.idparams_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_params_table_refresh(var_idparams_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_params_table_refresh_cb);
  } //  do_ajax_form_params_table_refresh

  function do_ajax_form_params_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idparams_.value = scAjaxGetKeyValue("idparams_");
    ...
    scAjaxAlert(do_ajax_form_params_table_refresh_cb_after_alert);
  } // do_ajax_form_params_table_refresh_cb
  function do_ajax_form_params_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_params_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_params_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_params_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_idparams_ = scAjaxGetFieldText("idparams_" + iNumLinha);
    var var_descrip_ = scAjaxGetFieldText("descrip_" + iNumLinha);
    var var_numerico_ = scAjaxGetFieldText("numerico_" + iNumLinha);
    var var_texto_ = scAjaxGetFieldText("texto_" + iNumLinha);
    var var_binario_ = scAjaxGetFieldText("binario_" + iNumLinha);
    var var_binario__ul_name = scAjaxSpecCharProtect(eval('document.F1.binario__ul_name' + iNumLinha + '.value'));
    var var_binario__ul_type = eval('document.F1.binario__ul_type' + iNumLinha + '.value');
    var var_binario__limpa = eval('document.F1.binario__limpa' + iNumLinha + '.checked') ? "S" : "N";
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_params_submit_form(var_idparams_, var_descrip_, var_numerico_, var_texto_, var_binario_, var_binario__ul_name, var_binario__ul_type, var_binario__limpa, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_params_submit_form_cb);
  } // do_ajax_form_params_submit_form

  function do_ajax_form_params_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idparams_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("descrip_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("numerico_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("texto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("binario_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
<?php
        ...
        {
?>
          if (document.F1.elements["binario__limpa" + sc_num_ult_line] && document.F1.elements["binario__limpa" + sc_num_ult_line].checked)
          {
            var oImgTemp = {0: {"value" : ""}};
            scAjaxSetFieldImage("binario_" + sc_num_ult_line, oImgTemp, "", "", "", "N");
            document.F1.elements["binario__limpa" + sc_num_ult_line].checked = false;
          }
<?php
        }
?>
      }
      eval("if (document.F1.binario__ul_name" + sc_num_ult_line + ") document.F1.binario__ul_name" + sc_num_ult_line + ".value = ''");
      eval("if (document.F1.binario__ul_type" + sc_num_ult_line + ") document.F1.binario__ul_type" + sc_num_ult_line + ".value = ''");
    }
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_params_submit_form_cb_after_alert);
  } // do_ajax_form_params_submit_form_cb
  function do_ajax_form_params_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_params_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_params_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_params_navigate_form, function() {});
    } else {
      perform_ajax_form_params_navigate_form();
    }
  }

  function perform_ajax_form_params_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_params_cancel_insert(sc_form_params_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idparams_" + iNavForm);
      scAjaxHideErrorDisplay("descrip_" + iNavForm);
      scAjaxHideErrorDisplay("numerico_" + iNavForm);
      scAjaxHideErrorDisplay("texto_" + iNavForm);
      scAjaxHideErrorDisplay("binario_" + iNavForm);
    }
    var var_idparams_ = document.F2.idparams_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_params_navigate_form(var_idparams_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_params_navigate_form_cb);
  } // do_ajax_form_params_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_params']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_params_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idparams_.value = scAjaxGetKeyValue("idparams_" + var_last_index);
    ...
    {
      eval("if (document.F1.binario__ul_name" + iImg + ") document.F1.binario__ul_name" + iImg + ".value = ''");
      eval("if (document.F1.binario__ul_type" + iImg + ") document.F1.binario__ul_type" + iImg + ".value = ''");
    }
    scAjaxSetBtnVars();
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_params_navigate_form_cb_after_alert);
  } // do_ajax_form_params_navigate_form_cb
  function do_ajax_form_params_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_params_navigate_form_cb_after_alert

    function sc_form_params_get_last_line_number()
    {
    ...
    } //sc_form_params_get_last_line_number

  function sc_hide_form_params_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idparams_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "descrip_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "numerico_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "texto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "binario_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idparams_" + iNumLinha] = {"label": "Idparams<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["descrip_" + iNumLinha] = {"label": "Descrip<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["numerico_" + iNumLinha] = {"label": "Numerico<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["texto_" + iNumLinha] = {"label": "Texto<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["binario_" + iNumLinha] = {"label": "Binario<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idparams_"][iNumLinha] = "idparams_" + iNumLinha;
    ajax_field_mult["descrip_"][iNumLinha] = "descrip_" + iNumLinha;
    ajax_field_mult["numerico_"][iNumLinha] = "numerico_" + iNumLinha;
    ajax_field_mult["texto_"][iNumLinha] = "texto_" + iNumLinha;
    ajax_field_mult["binario_"][iNumLinha] = "binario_" + iNumLinha;
    ajax_field_id["idparams_" + iNumLinha] = new Array("hidden_field_label_idparams_", "hidden_field_data_idparams_" + iNumLinha);
    ajax_field_id["descrip_" + iNumLinha] = new Array("hidden_field_label_descrip_", "hidden_field_data_descrip_" + iNumLinha);
    ajax_field_id["numerico_" + iNumLinha] = new Array("hidden_field_label_numerico_", "hidden_field_data_numerico_" + iNumLinha);
    ajax_field_id["texto_" + iNumLinha] = new Array("hidden_field_label_texto_", "hidden_field_data_texto_" + iNumLinha);
    ajax_field_id["binario_" + iNumLinha] = new Array("hidden_field_label_binario_", "hidden_field_data_binario_" + iNumLinha);
    ajax_error_count["idparams_" + iNumLinha] = "off";
    ajax_error_count["descrip_" + iNumLinha] = "off";
    ajax_error_count["numerico_" + iNumLinha] = "off";
    ajax_error_count["texto_" + iNumLinha] = "off";
    ajax_error_count["binario_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idparams_" + iNumLinha] = "on";
    ajax_read_only["descrip_" + iNumLinha] = "off";
    ajax_read_only["numerico_" + iNumLinha] = "off";
    ajax_read_only["texto_" + iNumLinha] = "off";
    ajax_read_only["binario_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["numerico_" + iNumLinha] = "on";
    ajax_read_only["texto_" + iNumLinha] = "on";
    ajax_read_only["binario_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idparams_" + iNumLinha] = null;
    ajax_error_list["descrip_" + iNumLinha] = null;
    ajax_error_list["numerico_" + iNumLinha] = null;
    ajax_error_list["texto_" + iNumLinha] = null;
    ajax_error_list["binario_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idparams_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idparams_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idparams_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idparams_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idparams_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["numerico_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["numerico_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["numerico_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["numerico_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["numerico_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["texto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["texto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["texto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["texto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["texto_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["binario_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["binario_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["binario_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["binario_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["binario_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idparams_'])) ? $this->nmgp_cmp_readonly['idparams_'] : 'on';
?>
    scAjaxFieldRead("idparams_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['numerico_'])) ? $this->nmgp_cmp_readonly['numerico_'] : 'off';
?>
    scAjaxFieldRead("numerico_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['texto_'])) ? $this->nmgp_cmp_readonly['texto_'] : 'off';
?>
    scAjaxFieldRead("texto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['binario_'])) ? $this->nmgp_cmp_readonly['binario_'] : 'off';
?>
    scAjaxFieldRead("binario_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idparams_" + iSeq, "on");
    scAjaxFieldRead("descrip_" + iSeq, "on");
    scAjaxFieldRead("numerico_" + iSeq, "on");
    scAjaxFieldRead("texto_" + iSeq, "on");
    scAjaxFieldRead("binario_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idparams_" + iRow] || "on" == ajax_error_count["descrip_" + iRow] || "on" == ajax_error_count["numerico_" + iRow] || "on" == ajax_error_count["texto_" + iRow] || "on" == ajax_error_count["binario_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idparams_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_descrip_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_numerico_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_texto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_binario_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idparams_" + iRow] && "off" == ajax_error_count["descrip_" + iRow] && "off" == ajax_error_count["numerico_" + iRow] && "off" == ajax_error_count["texto_" + iRow] && "off" == ajax_error_count["binario_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idparams_" + iRow] = "off";
        ajax_error_count["descrip_" + iRow] = "off";
        ajax_error_count["numerico_" + iRow] = "off";
        ajax_error_count["texto_" + iRow] = "off";
        ajax_error_count["binario_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idparams_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_descrip_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_numerico_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_texto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_binario_" + iRow).removeClass("scFormErrorLine");
    }
  }
