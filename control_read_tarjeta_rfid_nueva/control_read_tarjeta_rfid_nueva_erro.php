...
$old_error_handler = set_error_handler("control_read_tarjeta_rfid_nueva_scriptcase_error_handler");

function control_read_tarjeta_rfid_nueva_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['control_read_tarjeta_rfid_nueva']['contr_erro']) && $_SESSION['scriptcase']['control_read_tarjeta_rfid_nueva']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_control_read_tarjeta_rfid_nueva->contr_control_read_tarjeta_rfid_nueva->Apl_com_erro = true;
            if ($inicial_control_read_tarjeta_rfid_nueva->contr_control_read_tarjeta_rfid_nueva->NM_ajax_flag)
            {
                $inicial_control_read_tarjeta_rfid_nueva->contr_control_read_tarjeta_rfid_nueva->NM_ajax_info['errList']['geral_control_read_tarjeta_rfid_nueva'][] = $msg;
                return;
            }
            control_read_tarjeta_rfid_nueva_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function control_read_tarjeta_rfid_nueva_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['control_read_tarjeta_rfid_nueva'])  && '' != $_SESSION['scriptcase']['error_icon']['control_read_tarjeta_rfid_nueva'])  ? $_SESSION['scriptcase']['error_icon']['control_read_tarjeta_rfid_nueva']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['control_read_tarjeta_rfid_nueva']) && '' != $_SESSION['scriptcase']['error_close']['control_read_tarjeta_rfid_nueva']) ? $_SESSION['scriptcase']['error_close']['control_read_tarjeta_rfid_nueva'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['control_read_tarjeta_rfid_nueva']) && '' != $_SESSION['scriptcase']['error_span_title']['control_read_tarjeta_rfid_nueva']) ? $_SESSION['scriptcase']['error_span_title']['control_read_tarjeta_rfid_nueva'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['control_read_tarjeta_rfid_nueva']) && '' != $_SESSION['scriptcase']['error_icon_title']['control_read_tarjeta_rfid_nueva']) ? $_SESSION['scriptcase']['error_icon_title']['control_read_tarjeta_rfid_nueva'] : '';
?>
