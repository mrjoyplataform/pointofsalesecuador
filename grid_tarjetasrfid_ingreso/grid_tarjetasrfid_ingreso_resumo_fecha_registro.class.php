...
class grid_tarjetasrfid_ingreso_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_tarjetasrfid_ingreso']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_tarjetasrfid_ingreso']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['contr_total_geral'] == "OK")
      {
          $this->array_total_fecha_registro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['arr_total']['fecha_registro'];
      }
      else
      {
          $this->array_total_fecha_registro = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['arr_total']['fecha_registro'] = $this->array_total_fecha_registro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['json_use_label'])
       {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['fecha_registro']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['fecha_registro'] = "Fecha Registro"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['cantidad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['cantidad'] = "Cantidad"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['codproducto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['codproducto'] = "Codproducto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['codempleado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['codempleado'] = "Codempleado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['codrfid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['codrfid'] = "Codrfid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['estado'] = "Estado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['fecha_activacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['fecha_activacion'] = "Fecha Activacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['tokens']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['tokens'] = "Tokens"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['uidcompra']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['uidcompra'] = "Uidcompra"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['fechacompra']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['fechacompra'] = "Fechacompra"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['ultfechauso']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['ultfechauso'] = "Ultfechauso"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['puntos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['puntos'] = "Puntos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['ultarcade']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['ultarcade'] = "Ultarcade"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['valorusd']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['valorusd'] = "Valorusd"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['telefono'] = "Telefono"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['username']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['username'] = "Username"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['activa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['labels']['activa'] = "Activa"; 
       }
       //-----
       $this->comp_field_nm = array(
           'fecha_registro' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['summarizing_fields_order']['fecha_registro']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['summarizing_fields_order']['fecha_registro'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['summarizing_fields_order']['fecha_registro'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['summarizing_fields_display']['fecha_registro'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['summarizing_fields_display']['fecha_registro'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['summarizing_fields_display']['fecha_registro'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['summarizing_fields_display']['fecha_registro'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['summarizing_fields_display']['fecha_registro'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['summarizing_fields_display']['fecha_registro'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['summarizing_fields_display']['fecha_registro'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_fecha_registro as $i_fecha_registro => $d_fecha_registro) {
           if (!in_array($i_fecha_registro, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_fecha_registro[3] ] = $d_fecha_registro[2];
               $this->comp_label[0][ $d_fecha_registro[3] ] = $d_fecha_registro[2];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'fecha_registro', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_fecha_registro => $l_fecha_registro) {
           if (isset($this->array_total_fecha_registro[$i_fecha_registro])) {
               $this->comp_group[$i_fecha_registro] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_fecha_registro;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_tarjetasrfid_ingreso@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_tarjetasrfid_ingreso_total.class.php"); 
      }
      ...
      $this->Total   = new grid_tarjetasrfid_ingreso_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_fecha_registro("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_fecha_registro);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_tarjetasrfid_ingreso/grid_tarjetasrfid_ingreso_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_tarjetasrfid_ingreso_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_tarjetasrfid_ingreso_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_tarjetasrfid_ingreso_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['num_css'] . '.css');
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_tarjetasrfid_ingreso/grid_tarjetasrfid_ingreso_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_tarjetasrfid_ingreso/grid_tarjetasrfid_ingreso_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_tarjetasrfid_ingreso/grid_tarjetasrfid_ingreso_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_tarjetasrfid_ingreso/grid_tarjetasrfid_ingreso_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_tarjetasrfid_ingreso_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rpdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['pdf'][] = "Rpdf_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_tarjetasrfid_ingreso/grid_tarjetasrfid_ingreso_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_tarjetasrfid_ingreso&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rword_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['word'][] = "Rword_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_tarjetasrfid_ingreso/grid_tarjetasrfid_ingreso_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xml'][] = "Rxml_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_tarjetasrfid_ingreso/grid_tarjetasrfid_ingreso_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rcsv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['csv'][] = "Rcsv_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_tarjetasrfid_ingreso/grid_tarjetasrfid_ingreso_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rprinttop\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['print'][] = "Rprint_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_tarjetasrfid_ingreso/grid_tarjetasrfid_ingreso_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_tarjetasrfid_ingreso']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_tarjetasrfid_ingreso']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_tarjetasrfid_ingreso_config_pivot.php?nome_apl=grid_tarjetasrfid_ingreso&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_tarjetasrfid_ingreso_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_tarjetasrfid_ingreso/grid_tarjetasrfid_ingreso_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $codrfid = $Busca_temp['codrfid']; 
          $tmp_pos = strpos($codrfid, "##@@");
          if ($tmp_pos !== false && !is_array($codrfid))
          {
          ...
          $fecha_activacion = $Busca_temp['fecha_activacion']; 
          $tmp_pos = strpos($fecha_activacion, "##@@");
          if ($tmp_pos !== false && !is_array($fecha_activacion))
          {
              $fecha_activacion = substr($fecha_activacion, 0, $tmp_pos);
          }
          $fecha_activacion_2 = $Busca_temp['fecha_activacion_input_2']; 
      } 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tarjetasrfid_ingreso']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($quebra_fecha_registro, $quebra_fecha_registro_orig)
   {
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "
      if (!isset($this->array_total_fecha_registro[$quebra_fecha_registro_orig]))
      {
         $this->array_total_fecha_registro[$quebra_fecha_registro_orig][0] = 1;
         $this->array_total_fecha_registro[$quebra_fecha_registro_orig][1] = 1;
         $this->array_total_fecha_registro[$quebra_fecha_registro_orig][2] = $quebra_fecha_registro;
         $this->array_total_fecha_registro[$quebra_fecha_registro_orig][3] = $quebra_fecha_registro_orig;
      }
      else
      {
         $this->array_total_fecha_registro[$quebra_fecha_registro_orig][0]++;
         $this->array_total_fecha_registro[$quebra_fecha_registro_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'fecha_registro');
     $campos_order = $this->Ini->Get_date_order_groupby("fecha_registro", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->fecha_registro = $rs_res->fields[0] ;  
            $this->cantidad = $rs_res->fields[1] ;  
            $this->codproducto = $rs_res->fields[2] ;  
            $this->codempleado = $rs_res->fields[3] ;  
            $this->codrfid = $rs_res->fields[4] ;  
            $this->estado = $rs_res->fields[5] ;  
            $this->fecha_activacion = $rs_res->fields[6] ;  
            ...
            $this->fecha_registro_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->fecha_registro, $Format_tst);
            $this->fecha_registro = $this->Ini->GB_date_format($TP_Time . $this->fecha_registro, $Format_tst, $Prefix_dat);
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->fecha_registro, $this->fecha_registro_orig);
            }
   }
//
