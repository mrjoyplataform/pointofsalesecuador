<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tarjetasrfid_ingreso']['sc_process_barr'] = true;
require_once('../grid_tarjetasrfid_ingreso/index.php');
unset($_SESSION['scriptcase']['grid_tarjetasrfid_ingreso']['sc_process_barr']);
$ExportCtrl = new grid_tarjetasrfid_ingreso_export_control;
$ExportCtrl->Export_barr();

class grid_tarjetasrfid_ingreso_export_control
{
