<?php
@session_start() ;
$_SESSION['scriptcase']['grid_ele_parametros']['sc_process_barr'] = true;
require_once('../grid_ele_parametros/index.php');
unset($_SESSION['scriptcase']['grid_ele_parametros']['sc_process_barr']);
$ExportCtrl = new grid_ele_parametros_export_control;
$ExportCtrl->Export_barr();

class grid_ele_parametros_export_control
{
