...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_ele_parametros"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_ele_parametros"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_ele_parametros'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ele_parametros']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_ele_parametros']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_ele_parametros']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_ele_parametros']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_ele_parametros']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_ele_parametros</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_ele_parametros']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_ele_parametros']['embutida_filho'] as $ind => $sc_init)
          {
