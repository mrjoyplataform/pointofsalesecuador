...
<?php
   ...
   $Ord_Cmp = new grid_ele_parametros_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_ele_parametros_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['labels']["id"] : "Id";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "nombre";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['labels']["nombre"] : "Nombre";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['labels']["valor"] : "Valor";
   $tab_ger_campos['observacion'] = "on";
   $tab_def_campos['observacion'] = "observacion";
   $tab_labels["observacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['labels']["observacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['labels']["observacion"] : "Observacion";
   $tab_ger_campos['estado'] = "on";
   $tab_def_campos['estado'] = "estado";
   $tab_labels["estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['labels']["estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['labels']["estado"] : "Estado";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['labels']["tipo"] : "Tipo";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_ele_parametros_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_ele_parametros']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
