...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_purchase_reporte"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_purchase_reporte"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_purchase'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_purchase_reporte']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_purchase_reporte']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_purchase_reporte']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_purchase_reporte']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_purchase_reporte']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_purchase_reporte</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_purchase_reporte']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_purchase_reporte']['embutida_filho'] as $ind => $sc_init)
          {
