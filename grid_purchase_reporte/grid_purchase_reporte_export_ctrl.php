<?php
@session_start() ;
$_SESSION['scriptcase']['grid_purchase_reporte']['sc_process_barr'] = true;
require_once('../grid_purchase_reporte/index.php');
unset($_SESSION['scriptcase']['grid_purchase_reporte']['sc_process_barr']);
$ExportCtrl = new grid_purchase_reporte_export_control;
$ExportCtrl->Export_barr();

class grid_purchase_reporte_export_control
{
