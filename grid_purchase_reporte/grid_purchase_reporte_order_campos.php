...
<?php
   ...
   $Ord_Cmp = new grid_purchase_reporte_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_purchase_reporte_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['id_purchase'] = "id_purchase";
   $tab_labels["id_purchase"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['labels']["id_purchase"])) ? $_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['labels']["id_purchase"] : "" . $this->Nm_lang['lang_purchase_fld_id_purchase'] . "";
   $tab_ger_campos['datepurchase'] = "on";
   $tab_def_campos['datepurchase'] = "datepurchase";
   $tab_labels["datepurchase"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['labels']["datepurchase"])) ? $_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['labels']["datepurchase"] : "" . $this->Nm_lang['lang_purchase_fld_datepurchase'] . "";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['labels']["total"] : "" . $this->Nm_lang['lang_purchase_fld_total'] . "";
   $tab_ger_campos['id_supplier'] = "on";
   $tab_def_campos['id_supplier'] = "id_supplier";
   $tab_labels["id_supplier"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['labels']["id_supplier"])) ? $_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['labels']["id_supplier"] : "" . $this->Nm_lang['lang_purchase_fld_id_supplier'] . "";
   $tab_ger_campos['id_status'] = "on";
   $tab_def_campos['id_status'] = "id_status";
   $tab_labels["id_status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['labels']["id_status"])) ? $_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['labels']["id_status"] : "" . $this->Nm_lang['lang_purchase_fld_id_status'] . "";
   $tab_ger_campos['factura_proveedor'] = "on";
   $tab_def_campos['factura_proveedor'] = "factura_proveedor";
   $tab_labels["factura_proveedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['labels']["factura_proveedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['labels']["factura_proveedor"] : "Factura Proveedor";
   $tab_ger_campos['comment'] = "on";
   $tab_def_campos['comment'] = "comment";
   $tab_labels["comment"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['labels']["comment"])) ? $_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['labels']["comment"] : "Comment";
   $tab_ger_campos['comment'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_purchase_reporte_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_purchase_reporte']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
