...
Table_sv_fil[0] = "datepurchase";
Table_sv_fil[1] = "id_supplier";
Table_sv_fil[2] = "factura_proveedor";
function ajax_select_filter(parm)
{
    ...
    $.ajax({
     ...
     .done(function(json_sel_fil) {
        ...
        if ($("#SC_datepurchase_cond") && search_get_sel_txt("SC_datepurchase_cond").substring(0, 3) == "bi_") {
            formata_bi_datepurchase(search_get_sel_txt("SC_datepurchase_cond"), SC_datepurchase_bi_opc, SC_datepurchase_bi_dt);
        }
