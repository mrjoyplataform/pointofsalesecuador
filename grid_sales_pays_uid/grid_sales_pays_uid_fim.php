...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_sales_pays_uid"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_sales_pays_uid"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_sales_pays_uid']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_sales_pays_uid']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_sales_pays_uid']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_sales_pays_uid']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_sales_pays_uid']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_sales_pays_uid</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_sales_pays_uid']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_sales_pays_uid']['embutida_filho'] as $ind => $sc_init)
          {
