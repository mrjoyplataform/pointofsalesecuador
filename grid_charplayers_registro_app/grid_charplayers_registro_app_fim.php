...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_charplayers_registro_app"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_charplayers_registro_app"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_charplayers_registro_app']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_charplayers_registro_app']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_charplayers_registro_app']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_charplayers_registro_app']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_charplayers_registro_app']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_charplayers_registro_app</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_charplayers_registro_app']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_charplayers_registro_app']['embutida_filho'] as $ind => $sc_init)
          {
