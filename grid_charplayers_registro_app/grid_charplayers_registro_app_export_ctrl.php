<?php
@session_start() ;
$_SESSION['scriptcase']['grid_charplayers_registro_app']['sc_process_barr'] = true;
require_once('../grid_charplayers_registro_app/index.php');
unset($_SESSION['scriptcase']['grid_charplayers_registro_app']['sc_process_barr']);
$ExportCtrl = new grid_charplayers_registro_app_export_control;
$ExportCtrl->Export_barr();

class grid_charplayers_registro_app_export_control
{
...
<HEAD>
 <TITLE><?php echo $_SESSION['boletoqr'] ?></TITLE>
