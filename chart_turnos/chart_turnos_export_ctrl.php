<?php
@session_start() ;
$_SESSION['scriptcase']['chart_turnos']['sc_process_barr'] = true;
require_once('../chart_turnos/index.php');
unset($_SESSION['scriptcase']['chart_turnos']['sc_process_barr']);
$ExportCtrl = new chart_turnos_export_control;
$ExportCtrl->Export_barr();

class chart_turnos_export_control
{
