...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectOdd" alt="{autoTab: false, enterSubmit: true}" id="SC_fechatrans_cond" name="fechatrans_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechatrans'), this, 'fechatrans')">
