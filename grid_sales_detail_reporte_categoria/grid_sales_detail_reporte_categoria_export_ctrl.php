<?php
@session_start() ;
$_SESSION['scriptcase']['grid_sales_detail_reporte_categoria']['sc_process_barr'] = true;
require_once('../grid_sales_detail_reporte_categoria/index.php');
unset($_SESSION['scriptcase']['grid_sales_detail_reporte_categoria']['sc_process_barr']);
$ExportCtrl = new grid_sales_detail_reporte_categoria_export_control;
$ExportCtrl->Export_barr();

class grid_sales_detail_reporte_categoria_export_control
{
