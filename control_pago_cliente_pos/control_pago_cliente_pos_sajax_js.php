  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_pago_cliente_pos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_pago_cliente_pos_form();
	}
...
?>
  ...
  // ---------- Validate tipodoc
  function do_ajax_control_pago_cliente_pos_validate_tipodoc()
  {
    var nomeCampo_tipodoc = "tipodoc";
    var var_tipodoc = scAjaxGetFieldSelect(nomeCampo_tipodoc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_pago_cliente_pos_validate_tipodoc(var_tipodoc, var_script_case_init, do_ajax_control_pago_cliente_pos_validate_tipodoc_cb);
  } // do_ajax_control_pago_cliente_pos_validate_tipodoc

  function do_ajax_control_pago_cliente_pos_validate_tipodoc_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_pago_cliente_pos_validate_tipodoc_cb

  // ---------- Validate idcliente
  function do_ajax_control_pago_cliente_pos_validate_idcliente()
  {
    var nomeCampo_idcliente = "idcliente";
    var var_idcliente = scAjaxGetFieldText(nomeCampo_idcliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_pago_cliente_pos_validate_idcliente(var_idcliente, var_script_case_init, do_ajax_control_pago_cliente_pos_validate_idcliente_cb);
  } // do_ajax_control_pago_cliente_pos_validate_idcliente

  function do_ajax_control_pago_cliente_pos_validate_idcliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_pago_cliente_pos_validate_idcliente_cb

  // ---------- Validate cliente
  function do_ajax_control_pago_cliente_pos_validate_cliente()
  {
    var nomeCampo_cliente = "cliente";
    var var_cliente = scAjaxGetFieldText(nomeCampo_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_pago_cliente_pos_validate_cliente(var_cliente, var_script_case_init, do_ajax_control_pago_cliente_pos_validate_cliente_cb);
  } // do_ajax_control_pago_cliente_pos_validate_cliente

  function do_ajax_control_pago_cliente_pos_validate_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_pago_cliente_pos_validate_cliente_cb

  // ---------- Validate correo
  function do_ajax_control_pago_cliente_pos_validate_correo()
  {
    var nomeCampo_correo = "correo";
    var var_correo = scAjaxGetFieldText(nomeCampo_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_pago_cliente_pos_validate_correo(var_correo, var_script_case_init, do_ajax_control_pago_cliente_pos_validate_correo_cb);
  } // do_ajax_control_pago_cliente_pos_validate_correo

  function do_ajax_control_pago_cliente_pos_validate_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "correo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_pago_cliente_pos_validate_correo_cb

  // ---------- Validate telefono
  function do_ajax_control_pago_cliente_pos_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_pago_cliente_pos_validate_telefono(var_telefono, var_script_case_init, do_ajax_control_pago_cliente_pos_validate_telefono_cb);
  } // do_ajax_control_pago_cliente_pos_validate_telefono

  function do_ajax_control_pago_cliente_pos_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_pago_cliente_pos_validate_telefono_cb

  // ---------- Validate direccion
  function do_ajax_control_pago_cliente_pos_validate_direccion()
  {
    var nomeCampo_direccion = "direccion";
    var var_direccion = scAjaxGetFieldText(nomeCampo_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_pago_cliente_pos_validate_direccion(var_direccion, var_script_case_init, do_ajax_control_pago_cliente_pos_validate_direccion_cb);
  } // do_ajax_control_pago_cliente_pos_validate_direccion

  function do_ajax_control_pago_cliente_pos_validate_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_pago_cliente_pos_validate_direccion_cb

  // ---------- Event onchange idcliente
  function do_ajax_control_pago_cliente_pos_event_idcliente_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_control_pago_cliente_pos_event_idcliente_onchange(var_cliente, var_correo, var_telefono, var_direccion, var_idcliente, var_script_case_init, do_ajax_control_pago_cliente_pos_event_idcliente_onchange_cb);
  } // do_ajax_control_pago_cliente_pos_event_idcliente_onchange

  function do_ajax_control_pago_cliente_pos_event_idcliente_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idcliente";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_pago_cliente_pos_event_idcliente_onchange_cb_after_alert);
  } // do_ajax_control_pago_cliente_pos_event_idcliente_onchange_cb
  function do_ajax_control_pago_cliente_pos_event_idcliente_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_pago_cliente_pos_event_idcliente_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_pago_cliente_pos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_pago_cliente_pos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_control_pago_cliente_pos_submit_form(var_tipodoc, var_idcliente, var_cliente, var_correo, var_telefono, var_direccion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_control_pago_cliente_pos_submit_form_cb);
  } // do_ajax_control_pago_cliente_pos_submit_form

  function do_ajax_control_pago_cliente_pos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_pago_cliente_pos_submit_form_cb_after_alert);
  } // do_ajax_control_pago_cliente_pos_submit_form_cb
  function do_ajax_control_pago_cliente_pos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_pago_cliente_pos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_pago_cliente_pos_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_control_pago_cliente_pos_navigate_form, function() {});
    } else {
      perform_ajax_control_pago_cliente_pos_navigate_form();
    }
  }

  function perform_ajax_control_pago_cliente_pos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_pago_cliente_pos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_pago_cliente_pos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_pago_cliente_pos_navigate_form_cb_after_alert);
  } // do_ajax_control_pago_cliente_pos_navigate_form_cb
  function do_ajax_control_pago_cliente_pos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_control_pago_cliente_pos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_pago_cliente_pos_navigate_form_cb_after_alert

  function sc_hide_control_pago_cliente_pos_form()
  {
