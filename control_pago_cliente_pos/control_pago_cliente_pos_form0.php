...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>control_pago_cliente_pos/control_pago_cliente_pos_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("control_pago_cliente_pos_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('control_pago_cliente_pos_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['link_info']['remove_border']) {
...
<?php
 include_once("control_pago_cliente_pos_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_pago_cliente_pos'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_pago_cliente_pos'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipodoc_label" id="hidden_field_label_tipodoc" style="<?php echo $sStyleHidden_tipodoc; ?>"><span id="id_label_tipodoc"><?php echo $this->nm_new_label['tipodoc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['php_cmp_required']['tipodoc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['php_cmp_required']['tipodoc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_tipodoc_line" id="hidden_field_data_tipodoc" style="<?php echo $sStyleHidden_tipodoc; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idcliente_line" id="hidden_field_data_idcliente" style="<?php echo $sStyleHidden_idcliente; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cliente_label" id="hidden_field_label_cliente" style="<?php echo $sStyleHidden_cliente; ?>"><span id="id_label_cliente"><?php echo $this->nm_new_label['cliente']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['php_cmp_required']['cliente']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['php_cmp_required']['cliente'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_cliente_line" id="hidden_field_data_cliente" style="<?php echo $sStyleHidden_cliente; ?>">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_correo_label" id="hidden_field_label_correo" style="<?php echo $sStyleHidden_correo; ?>"><span id="id_label_correo"><?php echo $this->nm_new_label['correo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['php_cmp_required']['correo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['php_cmp_required']['correo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_telefono_label" id="hidden_field_label_telefono" style="<?php echo $sStyleHidden_telefono; ?>"><span id="id_label_telefono"><?php echo $this->nm_new_label['telefono']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['php_cmp_required']['telefono']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['php_cmp_required']['telefono'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_direccion_label" id="hidden_field_label_direccion" style="<?php echo $sStyleHidden_direccion; ?>"><span id="id_label_direccion"><?php echo $this->nm_new_label['direccion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['php_cmp_required']['direccion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['php_cmp_required']['direccion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_label']['help'];
        }
?>
...
<?php
    if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['nm_run_menu'] != 1))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_label']['exit'];
        }
?>
...
<?php
    if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_disabled']['ok']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_disabled']['ok']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_label']['ok']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_label']['ok']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['btn_label']['ok'];
        }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("control_pago_cliente_pos");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("control_pago_cliente_pos");
 parent.scAjaxDetailHeight("control_pago_cliente_pos", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['control_pago_cliente_pos']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
