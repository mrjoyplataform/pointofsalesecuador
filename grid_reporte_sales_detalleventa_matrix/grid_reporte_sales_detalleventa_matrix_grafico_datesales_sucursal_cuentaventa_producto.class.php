...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['contr_label_graf']['fechatrans']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['contr_label_graf']['fechatrans']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['contr_label_graf']['fechatrans'];
      }
      $this->label[1] = "Sucursal";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['contr_label_graf']['sucursal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['contr_label_graf']['sucursal']))
      {
         $this->label[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['contr_label_graf']['sucursal'];
      }
      $this->label[2] = "Producto";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['contr_label_graf']['producto']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['contr_label_graf']['producto']))
      {
         $this->label[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['contr_label_graf']['producto'];
      }
   }
