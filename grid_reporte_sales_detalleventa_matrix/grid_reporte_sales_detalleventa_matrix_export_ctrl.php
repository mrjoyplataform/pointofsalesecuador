<?php
@session_start() ;
$_SESSION['scriptcase']['grid_reporte_sales_detalleventa_matrix']['sc_process_barr'] = true;
require_once('../grid_reporte_sales_detalleventa_matrix/index.php');
unset($_SESSION['scriptcase']['grid_reporte_sales_detalleventa_matrix']['sc_process_barr']);
$ExportCtrl = new grid_reporte_sales_detalleventa_matrix_export_control;
$ExportCtrl->Export_barr();

class grid_reporte_sales_detalleventa_matrix_export_control
{
