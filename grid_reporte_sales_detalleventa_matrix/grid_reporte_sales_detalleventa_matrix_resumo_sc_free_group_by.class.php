...
class grid_reporte_sales_detalleventa_matrix_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_sucursal;
   var $array_total_cuentaventa;
   var $array_total_jugador;
   var $array_total_visitante;
   var $array_total_entrada;
   var $array_total_comida;
   var $array_total_producto;
   var $array_total_codproducto;
   var $array_total_idcliente;
   var $array_total_datesales;
   var $array_total_datesales_scgb_192;
   var $array_total_datesales_scgb_203;
   var $array_total_datesales_scgb_193;
   var $array_total_datesales_scgb_195;
   var $array_total_datesales_scgb_196;
   var $array_total_datesales_scgb_197;
   var $array_total_datesales_scgb_198;
   var $array_total_datesales_scgb_199;
   var $array_total_datesales_scgb_200;
   var $array_total_datesales_scgb_201;
   var $array_total_datesales_scgb_202;
   var $array_total_datesales_scgb_204;
   var $array_total_datesales_scgb_194;
   ...
   var $sc_proc_quebra_sucursal;
   var $count_sucursal;
   var $sum_sucursal_quantity;
   var $sum_sucursal_item_total;
   var $sum_sucursal_valor_siniva;
   ...
   var $sc_proc_quebra_jugador;
   var $count_jugador;
   var $sum_jugador_quantity;
   var $sum_jugador_item_total;
   var $sum_jugador_valor_siniva;
   var $sc_proc_quebra_visitante;
   var $count_visitante;
   var $sum_visitante_quantity;
   var $sum_visitante_item_total;
   var $sum_visitante_valor_siniva;
   var $sc_proc_quebra_entrada;
   var $count_entrada;
   var $sum_entrada_quantity;
   var $sum_entrada_item_total;
   var $sum_entrada_valor_siniva;
   var $sc_proc_quebra_comida;
   var $count_comida;
   var $sum_comida_quantity;
   var $sum_comida_item_total;
   var $sum_comida_valor_siniva;
   var $sc_proc_quebra_producto;
   var $count_producto;
   var $sum_producto_quantity;
   var $sum_producto_item_total;
   var $sum_producto_valor_siniva;
   var $sc_proc_quebra_codproducto;
   var $count_codproducto;
   var $sum_codproducto_quantity;
   var $sum_codproducto_item_total;
   var $sum_codproducto_valor_siniva;
   var $sc_proc_quebra_idcliente;
   var $count_idcliente;
   var $sum_idcliente_quantity;
   var $sum_idcliente_item_total;
   var $sum_idcliente_valor_siniva;
   var $sc_proc_quebra_datesales;
   var $count_datesales;
   var $sum_datesales_quantity;
   var $sum_datesales_item_total;
   var $sum_datesales_valor_siniva;
   var $sc_proc_quebra_datesales_scgb_192;
   var $count_datesales_scgb_192;
   var $sum_datesales_scgb_192_quantity;
   var $sum_datesales_scgb_192_item_total;
   var $sum_datesales_scgb_192_valor_siniva;
   var $sc_proc_quebra_datesales_scgb_203;
   var $count_datesales_scgb_203;
   var $sum_datesales_scgb_203_quantity;
   var $sum_datesales_scgb_203_item_total;
   var $sum_datesales_scgb_203_valor_siniva;
   var $sc_proc_quebra_datesales_scgb_193;
   var $count_datesales_scgb_193;
   var $sum_datesales_scgb_193_quantity;
   var $sum_datesales_scgb_193_item_total;
   var $sum_datesales_scgb_193_valor_siniva;
   var $sc_proc_quebra_datesales_scgb_195;
   var $count_datesales_scgb_195;
   var $sum_datesales_scgb_195_quantity;
   var $sum_datesales_scgb_195_item_total;
   var $sum_datesales_scgb_195_valor_siniva;
   var $sc_proc_quebra_datesales_scgb_196;
   var $count_datesales_scgb_196;
   var $sum_datesales_scgb_196_quantity;
   var $sum_datesales_scgb_196_item_total;
   var $sum_datesales_scgb_196_valor_siniva;
   var $sc_proc_quebra_datesales_scgb_197;
   var $count_datesales_scgb_197;
   var $sum_datesales_scgb_197_quantity;
   var $sum_datesales_scgb_197_item_total;
   var $sum_datesales_scgb_197_valor_siniva;
   var $sc_proc_quebra_datesales_scgb_198;
   var $count_datesales_scgb_198;
   var $sum_datesales_scgb_198_quantity;
   var $sum_datesales_scgb_198_item_total;
   var $sum_datesales_scgb_198_valor_siniva;
   var $sc_proc_quebra_datesales_scgb_199;
   var $count_datesales_scgb_199;
   var $sum_datesales_scgb_199_quantity;
   var $sum_datesales_scgb_199_item_total;
   var $sum_datesales_scgb_199_valor_siniva;
   var $sc_proc_quebra_datesales_scgb_200;
   var $count_datesales_scgb_200;
   var $sum_datesales_scgb_200_quantity;
   var $sum_datesales_scgb_200_item_total;
   var $sum_datesales_scgb_200_valor_siniva;
   var $sc_proc_quebra_datesales_scgb_201;
   var $count_datesales_scgb_201;
   var $sum_datesales_scgb_201_quantity;
   var $sum_datesales_scgb_201_item_total;
   var $sum_datesales_scgb_201_valor_siniva;
   var $sc_proc_quebra_datesales_scgb_202;
   var $count_datesales_scgb_202;
   var $sum_datesales_scgb_202_quantity;
   var $sum_datesales_scgb_202_item_total;
   var $sum_datesales_scgb_202_valor_siniva;
   var $sc_proc_quebra_datesales_scgb_204;
   var $count_datesales_scgb_204;
   var $sum_datesales_scgb_204_quantity;
   var $sum_datesales_scgb_204_item_total;
   var $sum_datesales_scgb_204_valor_siniva;
   var $sc_proc_quebra_datesales_scgb_194;
   var $count_datesales_scgb_194;
   var $sum_datesales_scgb_194_quantity;
   var $sum_datesales_scgb_194_item_total;
   var $sum_datesales_scgb_194_valor_siniva;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_sucursal           = array();
      $this->array_total_cuentaventa        = array();
      $this->array_total_jugador            = array();
      $this->array_total_visitante          = array();
      $this->array_total_entrada            = array();
      $this->array_total_comida             = array();
      $this->array_total_producto           = array();
      $this->array_total_codproducto        = array();
      $this->array_total_idcliente          = array();
      $this->array_total_datesales          = array();
      $this->array_total_datesales_scgb_192 = array();
      $this->array_total_datesales_scgb_203 = array();
      $this->array_total_datesales_scgb_193 = array();
      $this->array_total_datesales_scgb_195 = array();
      $this->array_total_datesales_scgb_196 = array();
      $this->array_total_datesales_scgb_197 = array();
      $this->array_total_datesales_scgb_198 = array();
      $this->array_total_datesales_scgb_199 = array();
      $this->array_total_datesales_scgb_200 = array();
      $this->array_total_datesales_scgb_201 = array();
      $this->array_total_datesales_scgb_202 = array();
      $this->array_total_datesales_scgb_204 = array();
      $this->array_total_datesales_scgb_194 = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['dashboard_info']['under_dashboard'] ? "off" : "on";

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_reporte_sales_detalleventa_matrix'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_reporte_sales_detalleventa_matrix'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_sales_detalleventa_matrix']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_sales_detalleventa_matrix']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_sales_detalleventa_matrix']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_reporte_sales_detalleventa_matrix']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_reporte_sales_detalleventa_matrix']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pesq_tab_label']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pesq_tab_label'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pesq_tab_label'] .= "datesales?#?" . "Datesales" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pesq_tab_label'] .= "sucursal?#?" . "Sucursal" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pesq_tab_label'] .= "cuentaventa?#?" . "Cuentaventa" . "?@?";
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['grid_search_add']))
      {
          $this->monta_css();
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pesq_tab_label'];
          ...
          $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['grid_search_add']['seq'];
          $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['grid_search_add']['cmp'];
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['grid_search_add']);
          exit;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['dyn_search_ch_bi']))
      {
          ob_start();
          $tmp_opc = $opc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['dyn_search_ch_bi']['opc'];
          $this->Ini->process_cond_bi($opc, $bi_dt1, $bi_dt2);
          $NM_func_dyn_ch_bi = "formata_bi_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['dyn_search_ch_bi']['cmp'];
          ...
          $oJson = new Services_JSON();
          echo $oJson->encode($this->Arr_result);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['dyn_search_ch_bi']);
          exit;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['opcao'] != "pdf")
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              $Arr_tot_name = "array_total_" . $cmp_gb;
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['tot_geral'][4];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['tot_geral'][3];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['sucursal'] = $this->array_total_sucursal;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['cuentaventa'] = $this->array_total_cuentaventa;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['jugador'] = $this->array_total_jugador;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['visitante'] = $this->array_total_visitante;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['entrada'] = $this->array_total_entrada;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['comida'] = $this->array_total_comida;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['producto'] = $this->array_total_producto;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['codproducto'] = $this->array_total_codproducto;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['idcliente'] = $this->array_total_idcliente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['datesales'] = $this->array_total_datesales;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['datesales_scgb_192'] = $this->array_total_datesales_scgb_192;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['datesales_scgb_203'] = $this->array_total_datesales_scgb_203;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['datesales_scgb_193'] = $this->array_total_datesales_scgb_193;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['datesales_scgb_195'] = $this->array_total_datesales_scgb_195;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['datesales_scgb_196'] = $this->array_total_datesales_scgb_196;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['datesales_scgb_197'] = $this->array_total_datesales_scgb_197;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['datesales_scgb_198'] = $this->array_total_datesales_scgb_198;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['datesales_scgb_199'] = $this->array_total_datesales_scgb_199;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['datesales_scgb_200'] = $this->array_total_datesales_scgb_200;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['datesales_scgb_201'] = $this->array_total_datesales_scgb_201;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['datesales_scgb_202'] = $this->array_total_datesales_scgb_202;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['datesales_scgb_204'] = $this->array_total_datesales_scgb_204;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['datesales_scgb_194'] = $this->array_total_datesales_scgb_194;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['json_use_label'])
       {
          $Lab_sucursal = "sucursal";
          $Lab_cuentaventa = "cuentaventa";
          $Lab_jugador = "jugador";
          $Lab_visitante = "visitante";
          $Lab_entrada = "entrada";
          $Lab_comida = "comida";
          $Lab_producto = "producto";
          $Lab_codproducto = "codproducto";
          $Lab_idcliente = "idcliente";
          $Lab_datesales = "datesales";
          $Lab_datesales_scgb_192 = "datesales_scgb_192";
          $Lab_datesales_scgb_203 = "datesales_scgb_203";
          $Lab_datesales_scgb_193 = "datesales_scgb_193";
          $Lab_datesales_scgb_195 = "datesales_scgb_195";
          $Lab_datesales_scgb_196 = "datesales_scgb_196";
          $Lab_datesales_scgb_197 = "datesales_scgb_197";
          $Lab_datesales_scgb_198 = "datesales_scgb_198";
          $Lab_datesales_scgb_199 = "datesales_scgb_199";
          $Lab_datesales_scgb_200 = "datesales_scgb_200";
          $Lab_datesales_scgb_201 = "datesales_scgb_201";
          $Lab_datesales_scgb_202 = "datesales_scgb_202";
          $Lab_datesales_scgb_204 = "datesales_scgb_204";
          $Lab_datesales_scgb_194 = "datesales_scgb_194";
       }
       else
       {
       $Lab_sucursal = "Sucursal";
       ...
       $Lab_idcliente = "Idcliente";
       $Lab_datesales = "Datesales";
       $Lab_datesales =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", $Lab_datesales);
       $Lab_datesales_scgb_192 = "Datesales";
       $Lab_datesales_scgb_192 =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYY'] . "", $Lab_datesales_scgb_192);
       $Lab_datesales_scgb_203 = "Datesales";
       $Lab_datesales_scgb_203 =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", $Lab_datesales_scgb_203);
       $Lab_datesales_scgb_193 = "Datesales";
       $Lab_datesales_scgb_193 =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_QUARTER'] . "", $Lab_datesales_scgb_193);
       $Lab_datesales_scgb_195 = "Datesales";
       $Lab_datesales_scgb_195 =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_DD'] . "", $Lab_datesales_scgb_195);
       $Lab_datesales_scgb_196 = "Datesales";
       $Lab_datesales_scgb_196 =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_SEMIANNUAL'] . "", $Lab_datesales_scgb_196);
       $Lab_datesales_scgb_197 = "Datesales";
       $Lab_datesales_scgb_197 =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYSEMIANNUAL'] . "", $Lab_datesales_scgb_197);
       $Lab_datesales_scgb_198 = "Datesales";
       $Lab_datesales_scgb_198 =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_FOURMONTHS'] . "", $Lab_datesales_scgb_198);
       $Lab_datesales_scgb_199 = "Datesales";
       $Lab_datesales_scgb_199 =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYFOURMONTHS'] . "", $Lab_datesales_scgb_199);
       $Lab_datesales_scgb_200 = "Datesales";
       $Lab_datesales_scgb_200 =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYQUARTER'] . "", $Lab_datesales_scgb_200);
       $Lab_datesales_scgb_201 = "Datesales";
       $Lab_datesales_scgb_201 =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_BIMONTHLY'] . "", $Lab_datesales_scgb_201);
       $Lab_datesales_scgb_202 = "Datesales";
       $Lab_datesales_scgb_202 =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYBIMONTHLY'] . "", $Lab_datesales_scgb_202);
       $Lab_datesales_scgb_204 = "Datesales";
       $Lab_datesales_scgb_204 =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_WEEK'] . "", $Lab_datesales_scgb_204);
       $Lab_datesales_scgb_194 = "Datesales";
       $Lab_datesales_scgb_194 =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_MM'] . "", $Lab_datesales_scgb_194);
       }
       $prep_field = array();
       $prep_field['sucursal'] = $Lab_sucursal;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['sucursal'] = $Lab_sucursal; 
       $prep_field['cuentaventa'] = $Lab_cuentaventa;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['cuentaventa'] = $Lab_cuentaventa; 
       $prep_field['jugador'] = $Lab_jugador;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['jugador'] = $Lab_jugador; 
       $prep_field['visitante'] = $Lab_visitante;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['visitante'] = $Lab_visitante; 
       $prep_field['entrada'] = $Lab_entrada;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['entrada'] = $Lab_entrada; 
       $prep_field['comida'] = $Lab_comida;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['comida'] = $Lab_comida; 
       $prep_field['producto'] = $Lab_producto;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['producto'] = $Lab_producto; 
       $prep_field['codproducto'] = $Lab_codproducto;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['codproducto'] = $Lab_codproducto; 
       $prep_field['idcliente'] = $Lab_idcliente;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['idcliente'] = $Lab_idcliente; 
       $prep_field['datesales'] = $Lab_datesales;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales'] = $Lab_datesales; 
       $prep_field['datesales_scgb_192'] = $Lab_datesales_scgb_192;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_192'] = $Lab_datesales_scgb_192; 
       $prep_field['datesales_scgb_203'] = $Lab_datesales_scgb_203;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_203'] = $Lab_datesales_scgb_203; 
       $prep_field['datesales_scgb_193'] = $Lab_datesales_scgb_193;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_193'] = $Lab_datesales_scgb_193; 
       $prep_field['datesales_scgb_195'] = $Lab_datesales_scgb_195;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_195'] = $Lab_datesales_scgb_195; 
       $prep_field['datesales_scgb_196'] = $Lab_datesales_scgb_196;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_196'] = $Lab_datesales_scgb_196; 
       $prep_field['datesales_scgb_197'] = $Lab_datesales_scgb_197;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_197'] = $Lab_datesales_scgb_197; 
       $prep_field['datesales_scgb_198'] = $Lab_datesales_scgb_198;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_198'] = $Lab_datesales_scgb_198; 
       $prep_field['datesales_scgb_199'] = $Lab_datesales_scgb_199;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_199'] = $Lab_datesales_scgb_199; 
       $prep_field['datesales_scgb_200'] = $Lab_datesales_scgb_200;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_200'] = $Lab_datesales_scgb_200; 
       $prep_field['datesales_scgb_201'] = $Lab_datesales_scgb_201;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_201'] = $Lab_datesales_scgb_201; 
       $prep_field['datesales_scgb_202'] = $Lab_datesales_scgb_202;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_202'] = $Lab_datesales_scgb_202; 
       $prep_field['datesales_scgb_204'] = $Lab_datesales_scgb_204;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_204'] = $Lab_datesales_scgb_204; 
       $prep_field['datesales_scgb_194'] = $Lab_datesales_scgb_194;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_194'] = $Lab_datesales_scgb_194; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['id_sales_detail']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['id_sales_detail'] = "Id Sales Detail"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['unit_cost']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['unit_cost'] = "Unit Cost"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['unit_value']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['unit_value'] = "Unit Value"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['quantity']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['quantity'] = "Quantity"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['discount']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['discount'] = "Discount"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['item_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['item_total'] = "Item Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['id_product']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['id_product'] = "Id Product"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['uniqueidtrans']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['uniqueidtrans'] = "Uniqueidtrans"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['fechatrans']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['fechatrans'] = "Fechatrans"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['valor_siniva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['valor_siniva'] = "Valor Siniva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['valor_unitario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['valor_unitario'] = "Valor Unitario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['codproducto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['codproducto'] = "Codproducto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['producto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['producto'] = "Producto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['entrada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['entrada'] = "Entrada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['jugador']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['jugador'] = "Jugador"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['visitante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['visitante'] = "Visitante"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['tarjeta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['tarjeta'] = "Tarjeta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['tokens']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['tokens'] = "Tokens"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['minutos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['minutos'] = "Minutos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['comida']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['comida'] = "Comida"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['cuentaventa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['cuentaventa'] = "Cuentaventa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['sucursal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['sucursal'] = "Sucursal"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['id_sales']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['id_sales'] = "Id Sales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['sales_price']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['sales_price'] = "Sales Price"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['sales_discount']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['sales_discount'] = "Sales Discount"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['total'] = "Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['id_status']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['id_status'] = "Id Status"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['idcaja']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['idcaja'] = "Idcaja"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['idcliente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['idcliente'] = "Idcliente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['cliente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['cliente'] = "Cliente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['direccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['direccion'] = "Direccion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['telefono'] = "Telefono"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['factura']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['factura'] = "Factura"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['serie']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['serie'] = "Serie"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['clave_acceso']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['clave_acceso'] = "Clave Acceso"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['enviosri']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['enviosri'] = "Enviosri"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['fechaenvio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['fechaenvio'] = "Fechaenvio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['uniqueid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['uniqueid'] = "Uniqueid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['estado'] = "Estado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['fechaid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['fechaid'] = "Fechaid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['importe_recibido']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['importe_recibido'] = "Importe Recibido"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['codigoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['codigoid'] = "Codigoid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['totalsinimpuestos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['totalsinimpuestos'] = "Total Sin Impuestos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['totaldescuento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['totaldescuento'] = "Total Descuento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['baseimponible']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['baseimponible'] = "Base Imponible"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['valoriva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['valoriva'] = "Valoriva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['importetotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['importetotal'] = "Importe Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['idpago']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['idpago'] = "Idpago"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['totalpago']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['totalpago'] = "Totalpago"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['cliente_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['cliente_email'] = "Cliente Email"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['idempleado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['idempleado'] = "Idempleado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['idturno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['idturno'] = "Idturno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['codpago_sri']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['codpago_sri'] = "Codpago Sri"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['imprime']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['imprime'] = "Imprime"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['comprobante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['comprobante'] = "Comprobante"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_192']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_192'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_203']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_203'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_193']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_193'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_195']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_195'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_196']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_196'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_197']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_197'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_198']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_198'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_199']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_199'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_200']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_200'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_201']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_201'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_202']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_202'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_204']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_204'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_194']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['datesales_scgb_194'] = "Datesales"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       $this->comp_sum = array(
           ...
           3 => "Item Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           4 => "Quantity (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           3 => array('field' => "item_total", 'show' => true),
           4 => array('field' => "quantity", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_valor_siniva_sum",
           3 => "css_item_total_sum",
           4 => "css_quantity_sum",
       );
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['sucursal']['alin'] = "''";
       $Arr_parms['sucursal']['link'] = "S";
       $Arr_parms['cuentaventa']['alin'] = "''";
       $Arr_parms['cuentaventa']['link'] = "S";
       $Arr_parms['jugador']['alin'] = "''";
       $Arr_parms['jugador']['link'] = "S";
       $Arr_parms['visitante']['alin'] = "''";
       $Arr_parms['visitante']['link'] = "S";
       $Arr_parms['entrada']['alin'] = "''";
       $Arr_parms['entrada']['link'] = "S";
       $Arr_parms['comida']['alin'] = "''";
       $Arr_parms['comida']['link'] = "S";
       $Arr_parms['producto']['alin'] = "''";
       $Arr_parms['producto']['link'] = "S";
       $Arr_parms['codproducto']['alin'] = "''";
       $Arr_parms['codproducto']['link'] = "S";
       $Arr_parms['idcliente']['alin'] = "''";
       $Arr_parms['idcliente']['link'] = "S";
       $Arr_parms['datesales']['alin'] = "''";
       $Arr_parms['datesales']['link'] = "S";
       $Arr_parms['datesales_scgb_192']['alin'] = "''";
       $Arr_parms['datesales_scgb_192']['link'] = "S";
       $Arr_parms['datesales_scgb_203']['alin'] = "''";
       $Arr_parms['datesales_scgb_203']['link'] = "S";
       $Arr_parms['datesales_scgb_193']['alin'] = "''";
       $Arr_parms['datesales_scgb_193']['link'] = "S";
       $Arr_parms['datesales_scgb_195']['alin'] = "''";
       $Arr_parms['datesales_scgb_195']['link'] = "S";
       $Arr_parms['datesales_scgb_196']['alin'] = "''";
       $Arr_parms['datesales_scgb_196']['link'] = "S";
       $Arr_parms['datesales_scgb_197']['alin'] = "''";
       $Arr_parms['datesales_scgb_197']['link'] = "S";
       $Arr_parms['datesales_scgb_198']['alin'] = "''";
       $Arr_parms['datesales_scgb_198']['link'] = "S";
       $Arr_parms['datesales_scgb_199']['alin'] = "''";
       $Arr_parms['datesales_scgb_199']['link'] = "S";
       $Arr_parms['datesales_scgb_200']['alin'] = "''";
       $Arr_parms['datesales_scgb_200']['link'] = "S";
       $Arr_parms['datesales_scgb_201']['alin'] = "''";
       $Arr_parms['datesales_scgb_201']['link'] = "S";
       $Arr_parms['datesales_scgb_202']['alin'] = "''";
       $Arr_parms['datesales_scgb_202']['link'] = "S";
       $Arr_parms['datesales_scgb_204']['alin'] = "''";
       $Arr_parms['datesales_scgb_204']['link'] = "S";
       $Arr_parms['datesales_scgb_194']['alin'] = "''";
       $Arr_parms['datesales_scgb_194']['link'] = "S";
       $Arr_parms['sucursal']['fill'] = "true";
       $Arr_parms['sucursal']['order'] = "label";
       $Arr_parms['sucursal']['order_start'] = 'asc';
       $Arr_parms['sucursal']['order_invert'] = 'false';
       $Arr_parms['sucursal']['order_enabled'] = 'true';
       $Arr_parms['sucursal']['order_datatype'] = 'varchar';
       ...
       $Arr_parms['jugador']['fill'] = "true";
       $Arr_parms['jugador']['order'] = "label";
       $Arr_parms['jugador']['order_start'] = 'asc';
       $Arr_parms['jugador']['order_invert'] = 'false';
       $Arr_parms['jugador']['order_enabled'] = 'true';
       $Arr_parms['jugador']['order_datatype'] = 'int';
       $Arr_parms['visitante']['fill'] = "true";
       $Arr_parms['visitante']['order'] = "label";
       $Arr_parms['visitante']['order_start'] = 'asc';
       $Arr_parms['visitante']['order_invert'] = 'false';
       $Arr_parms['visitante']['order_enabled'] = 'true';
       $Arr_parms['visitante']['order_datatype'] = 'int';
       $Arr_parms['entrada']['fill'] = "true";
       $Arr_parms['entrada']['order'] = "label";
       $Arr_parms['entrada']['order_start'] = 'asc';
       $Arr_parms['entrada']['order_invert'] = 'false';
       $Arr_parms['entrada']['order_enabled'] = 'true';
       $Arr_parms['entrada']['order_datatype'] = 'int';
       $Arr_parms['comida']['fill'] = "true";
       $Arr_parms['comida']['order'] = "label";
       $Arr_parms['comida']['order_start'] = 'asc';
       $Arr_parms['comida']['order_invert'] = 'false';
       $Arr_parms['comida']['order_enabled'] = 'true';
       $Arr_parms['comida']['order_datatype'] = 'int';
       ...
       $Arr_parms['codproducto']['fill'] = "true";
       $Arr_parms['codproducto']['order'] = "label";
       $Arr_parms['codproducto']['order_start'] = 'asc';
       $Arr_parms['codproducto']['order_invert'] = 'false';
       $Arr_parms['codproducto']['order_enabled'] = 'true';
       $Arr_parms['codproducto']['order_datatype'] = 'varchar';
       $Arr_parms['idcliente']['fill'] = "true";
       $Arr_parms['idcliente']['order'] = "label";
       $Arr_parms['idcliente']['order_start'] = 'asc';
       $Arr_parms['idcliente']['order_invert'] = 'false';
       $Arr_parms['idcliente']['order_enabled'] = 'true';
       $Arr_parms['idcliente']['order_datatype'] = 'varchar';
       $Arr_parms['datesales']['fill'] = "true";
       $Arr_parms['datesales']['order'] = "value";
       $Arr_parms['datesales']['order_start'] = 'asc';
       $Arr_parms['datesales']['order_invert'] = 'false';
       $Arr_parms['datesales']['order_enabled'] = 'true';
       $Arr_parms['datesales']['order_datatype'] = 'datetime';
       $Arr_parms['datesales_scgb_192']['fill'] = "true";
       $Arr_parms['datesales_scgb_192']['order'] = "value";
       $Arr_parms['datesales_scgb_192']['order_start'] = 'asc';
       $Arr_parms['datesales_scgb_192']['order_invert'] = 'false';
       $Arr_parms['datesales_scgb_192']['order_enabled'] = 'true';
       $Arr_parms['datesales_scgb_192']['order_datatype'] = 'datetime';
       $Arr_parms['datesales_scgb_203']['fill'] = "true";
       $Arr_parms['datesales_scgb_203']['order'] = "value";
       $Arr_parms['datesales_scgb_203']['order_start'] = 'asc';
       $Arr_parms['datesales_scgb_203']['order_invert'] = 'false';
       $Arr_parms['datesales_scgb_203']['order_enabled'] = 'true';
       $Arr_parms['datesales_scgb_203']['order_datatype'] = 'datetime';
       $Arr_parms['datesales_scgb_193']['fill'] = "true";
       $Arr_parms['datesales_scgb_193']['order'] = "value";
       $Arr_parms['datesales_scgb_193']['order_start'] = 'asc';
       $Arr_parms['datesales_scgb_193']['order_invert'] = 'false';
       $Arr_parms['datesales_scgb_193']['order_enabled'] = 'true';
       $Arr_parms['datesales_scgb_193']['order_datatype'] = 'datetime';
       $Arr_parms['datesales_scgb_195']['fill'] = "true";
       $Arr_parms['datesales_scgb_195']['order'] = "value";
       $Arr_parms['datesales_scgb_195']['order_start'] = 'asc';
       $Arr_parms['datesales_scgb_195']['order_invert'] = 'false';
       $Arr_parms['datesales_scgb_195']['order_enabled'] = 'true';
       $Arr_parms['datesales_scgb_195']['order_datatype'] = 'datetime';
       $Arr_parms['datesales_scgb_196']['fill'] = "true";
       $Arr_parms['datesales_scgb_196']['order'] = "value";
       $Arr_parms['datesales_scgb_196']['order_start'] = 'asc';
       $Arr_parms['datesales_scgb_196']['order_invert'] = 'false';
       $Arr_parms['datesales_scgb_196']['order_enabled'] = 'true';
       $Arr_parms['datesales_scgb_196']['order_datatype'] = 'datetime';
       $Arr_parms['datesales_scgb_197']['fill'] = "true";
       $Arr_parms['datesales_scgb_197']['order'] = "value";
       $Arr_parms['datesales_scgb_197']['order_start'] = 'asc';
       $Arr_parms['datesales_scgb_197']['order_invert'] = 'false';
       $Arr_parms['datesales_scgb_197']['order_enabled'] = 'true';
       $Arr_parms['datesales_scgb_197']['order_datatype'] = 'datetime';
       $Arr_parms['datesales_scgb_198']['fill'] = "true";
       $Arr_parms['datesales_scgb_198']['order'] = "value";
       $Arr_parms['datesales_scgb_198']['order_start'] = 'asc';
       $Arr_parms['datesales_scgb_198']['order_invert'] = 'false';
       $Arr_parms['datesales_scgb_198']['order_enabled'] = 'true';
       $Arr_parms['datesales_scgb_198']['order_datatype'] = 'datetime';
       $Arr_parms['datesales_scgb_199']['fill'] = "true";
       $Arr_parms['datesales_scgb_199']['order'] = "value";
       $Arr_parms['datesales_scgb_199']['order_start'] = 'asc';
       $Arr_parms['datesales_scgb_199']['order_invert'] = 'false';
       $Arr_parms['datesales_scgb_199']['order_enabled'] = 'true';
       $Arr_parms['datesales_scgb_199']['order_datatype'] = 'datetime';
       $Arr_parms['datesales_scgb_200']['fill'] = "true";
       $Arr_parms['datesales_scgb_200']['order'] = "value";
       $Arr_parms['datesales_scgb_200']['order_start'] = 'asc';
       $Arr_parms['datesales_scgb_200']['order_invert'] = 'false';
       $Arr_parms['datesales_scgb_200']['order_enabled'] = 'true';
       $Arr_parms['datesales_scgb_200']['order_datatype'] = 'datetime';
       $Arr_parms['datesales_scgb_201']['fill'] = "true";
       $Arr_parms['datesales_scgb_201']['order'] = "value";
       $Arr_parms['datesales_scgb_201']['order_start'] = 'asc';
       $Arr_parms['datesales_scgb_201']['order_invert'] = 'false';
       $Arr_parms['datesales_scgb_201']['order_enabled'] = 'true';
       $Arr_parms['datesales_scgb_201']['order_datatype'] = 'datetime';
       $Arr_parms['datesales_scgb_202']['fill'] = "true";
       $Arr_parms['datesales_scgb_202']['order'] = "value";
       $Arr_parms['datesales_scgb_202']['order_start'] = 'asc';
       $Arr_parms['datesales_scgb_202']['order_invert'] = 'false';
       $Arr_parms['datesales_scgb_202']['order_enabled'] = 'true';
       $Arr_parms['datesales_scgb_202']['order_datatype'] = 'datetime';
       $Arr_parms['datesales_scgb_204']['fill'] = "true";
       $Arr_parms['datesales_scgb_204']['order'] = "value";
       $Arr_parms['datesales_scgb_204']['order_start'] = 'asc';
       $Arr_parms['datesales_scgb_204']['order_invert'] = 'false';
       $Arr_parms['datesales_scgb_204']['order_enabled'] = 'true';
       $Arr_parms['datesales_scgb_204']['order_datatype'] = 'datetime';
       $Arr_parms['datesales_scgb_194']['fill'] = "true";
       $Arr_parms['datesales_scgb_194']['order'] = "value";
       $Arr_parms['datesales_scgb_194']['order_start'] = 'asc';
       $Arr_parms['datesales_scgb_194']['order_invert'] = 'false';
       $Arr_parms['datesales_scgb_194']['order_enabled'] = 'true';
       $Arr_parms['datesales_scgb_194']['order_datatype'] = 'datetime';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['sucursal'] = array(0 => 'sucursal', 1 => '@aspass@');
       $prep_links_fl['cuentaventa'] = array(0 => 'cuentaventa', 1 => '@aspass@');
       $prep_links_fl['jugador'] = array(0 => 'jugador', 1 => '');
       $prep_links_fl['visitante'] = array(0 => 'visitante', 1 => '');
       $prep_links_fl['entrada'] = array(0 => 'entrada', 1 => '');
       $prep_links_fl['comida'] = array(0 => 'comida', 1 => '');
       $prep_links_fl['producto'] = array(0 => 'producto', 1 => '@aspass@');
       $prep_links_fl['codproducto'] = array(0 => 'codproducto', 1 => '@aspass@');
       $prep_links_fl['idcliente'] = array(0 => 'idcliente', 1 => '@aspass@');
       $prep_links_fl['datesales'] = array(0 => 'datesales', 1 => '@aspass@');
       $prep_links_fl['datesales_scgb_192'] = array(0 => 'datesales_scgb_192', 1 => '@aspass@');
       $prep_links_fl['datesales_scgb_203'] = array(0 => 'datesales_scgb_203', 1 => '@aspass@');
       $prep_links_fl['datesales_scgb_193'] = array(0 => 'datesales_scgb_193', 1 => '@aspass@');
       $prep_links_fl['datesales_scgb_195'] = array(0 => 'datesales_scgb_195', 1 => '@aspass@');
       $prep_links_fl['datesales_scgb_196'] = array(0 => 'datesales_scgb_196', 1 => '@aspass@');
       $prep_links_fl['datesales_scgb_197'] = array(0 => 'datesales_scgb_197', 1 => '@aspass@');
       $prep_links_fl['datesales_scgb_198'] = array(0 => 'datesales_scgb_198', 1 => '@aspass@');
       $prep_links_fl['datesales_scgb_199'] = array(0 => 'datesales_scgb_199', 1 => '@aspass@');
       $prep_links_fl['datesales_scgb_200'] = array(0 => 'datesales_scgb_200', 1 => '@aspass@');
       $prep_links_fl['datesales_scgb_201'] = array(0 => 'datesales_scgb_201', 1 => '@aspass@');
       $prep_links_fl['datesales_scgb_202'] = array(0 => 'datesales_scgb_202', 1 => '@aspass@');
       $prep_links_fl['datesales_scgb_204'] = array(0 => 'datesales_scgb_204', 1 => '@aspass@');
       $prep_links_fl['datesales_scgb_194'] = array(0 => 'datesales_scgb_194', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_reporte_sales_detalleventa_matrix@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['proc_pdf_vert'])
   {
     $this->comp_tab_hover = true;
   }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_sucursal)),
           ...
           '1' => array(
               ...
               'field_x'  => 'jugador',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_jugador)),
               'label_y'  => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           '1' => array(
               ...
               'field_x'  => 'visitante',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_visitante)),
               'label_y'  => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           '1' => array(
               ...
               'field_x'  => 'entrada',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_entrada)),
               'label_y'  => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           '1' => array(
               ...
               'field_x'  => 'comida',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_comida)),
               'label_y'  => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           '1' => array(
               ...
               'field_x'  => 'codproducto',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_codproducto)),
               'label_y'  => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           '1' => array(
               ...
               'field_x'  => 'idcliente',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_idcliente)),
               'label_y'  => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           '1' => array(
               ...
               'field_x'  => 'datesales',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_datesales)),
               'label_y'  => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           'datesales_scgb_192' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'datesales_scgb_192',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_datesales_scgb_192)),
               'label_y'  => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           'datesales_scgb_203' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'datesales_scgb_203',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_datesales_scgb_203)),
               'label_y'  => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           'datesales_scgb_193' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'datesales_scgb_193',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_datesales_scgb_193)),
               'label_y'  => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           'datesales_scgb_195' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'datesales_scgb_195',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_datesales_scgb_195)),
               'label_y'  => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           'datesales_scgb_196' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'datesales_scgb_196',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_datesales_scgb_196)),
               'label_y'  => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           'datesales_scgb_197' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'datesales_scgb_197',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_datesales_scgb_197)),
               'label_y'  => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           'datesales_scgb_198' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'datesales_scgb_198',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_datesales_scgb_198)),
               'label_y'  => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           'datesales_scgb_199' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'datesales_scgb_199',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_datesales_scgb_199)),
               'label_y'  => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           'datesales_scgb_200' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'datesales_scgb_200',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_datesales_scgb_200)),
               'label_y'  => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           'datesales_scgb_201' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'datesales_scgb_201',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_datesales_scgb_201)),
               'label_y'  => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           'datesales_scgb_202' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'datesales_scgb_202',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_datesales_scgb_202)),
               'label_y'  => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           'datesales_scgb_204' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'datesales_scgb_204',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_datesales_scgb_204)),
               'label_y'  => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           'datesales_scgb_194' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'datesales_scgb_194',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_datesales_scgb_194)),
               'label_y'  => $this->getChartText(strip_tags("Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_charts'];
	}
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_reporte_sales_detalleventa_matrix_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_reporte_sales_detalleventa_matrix_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
         ...
         { 
            ...
            { 
                $seq_search = 1;
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['grid_pesq'] as $cmp => $def)
                {
                   $Seq_grid      = $seq_search;
                   $Cmp_grid      = $cmp;
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_reporte_sales_detalleventa_matrix']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_reporte_sales_detalleventa_matrix']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_reporte_sales_detalleventa_matrix']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_reporte_sales_detalleventa_matrix']) . "_";
               } 
           }
       }
   ...
   function inicializa_vars()
   {
      ...
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new grid_reporte_sales_detalleventa_matrix_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_grid_title'] . " reporte_sales</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_reporte_sales_detalleventa_matrix_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_reporte_sales_detalleventa_matrix_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_reporte_sales_detalleventa_matrix_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_reporte_sales_detalleventa_matrix/grid_reporte_sales_detalleventa_matrix_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_prod . "/third/jquery_plugin/thickbox/thickbox.css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_reporte_sales_detalleventa_matrix_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_reporte_sales_detalleventa_matrix_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_reporte_sales_detalleventa_matrix_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['num_css'] . '.css');
     ...
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      $nm_saida->saida("<script type=\"text/javascript\">\r\n");
      $nm_saida->saida("$(function() {\r\n");
      $nm_saida->saida("    scSetSummaryFixedHeadersCss(0);\r\n");
      $nm_saida->saida("});\r\n");
      $nm_saida->saida("function scSetSummaryFixedHeadersCss(baseTop)\r\n");
      $nm_saida->saida("{\r\n");
      $nm_saida->saida("    let rows, cols, i, j, thisTop;\r\n");
      $nm_saida->saida("    rows = $(\".sc-ui-summary-header-row\");\r\n");
      $nm_saida->saida("    thisTop = baseTop;\r\n");
      $nm_saida->saida("    for (i = 0; i < rows.length; i++) {\r\n");
      $nm_saida->saida("        cols = $(rows[i]).find(\"td\").filter(\".scGridSummaryLabel\");\r\n");
      ...
      $nm_saida->saida("    }\r\n");
      $nm_saida->saida("    scSummaryFixZindexCornerCells();\r\n");
      $nm_saida->saida("}\r\n");
      $nm_saida->saida("function scSummaryFixZindexCornerCells()\r\n");
      $nm_saida->saida("{\r\n");
      $nm_saida->saida("    let cells = $(\".sc-ui-summary-header-row\").find(\"td\");\r\n");
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $vertical_center = '';
          $nm_saida->saida(" <BODY id=\"grid_summary\" class=\"" . $this->css_scGridPage . "\" style=\"" . $remove_margin . $vertical_center . "\">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_detalleventa_matrix/grid_reporte_sales_detalleventa_matrix_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_detalleventa_matrix/grid_reporte_sales_detalleventa_matrix_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_reporte_sales_detalleventa_matrix&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=resume&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_detalleventa_matrix/grid_reporte_sales_detalleventa_matrix_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_detalleventa_matrix/grid_reporte_sales_detalleventa_matrix_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_detalleventa_matrix/grid_reporte_sales_detalleventa_matrix_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_detalleventa_matrix/grid_reporte_sales_detalleventa_matrix_config_graf_flash.php?nome_apl=grid_reporte_sales_detalleventa_matrix&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_reporte_sales_detalleventa_matrix/grid_reporte_sales_detalleventa_matrix_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_reporte_sales_detalleventa_matrix/grid_reporte_sales_detalleventa_matrix_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + G)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_reporte_sales_detalleventa_matrix_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("grid_reporte_sales_detalleventa_matrix_help.txt"); 
      ...
      if ($this->nmgp_botoes['chart_exit'] == 'on' && !$this->grid_emb_form)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bvoltar", "nm_gp_move('busca', '0', '');", "nm_gp_move('busca', '0', '');", "Rsai_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + Q)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
         $nm_saida->saida("     </TD> \r\n");
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['group_3'] == "on")
      {
          ...
          $Cod_Btn = nmButtonOutput($this->arr_buttons, "group_group_3", "scBtnGrpShow('group_3_top')", "scBtnGrpShow('group_3_top')", "sc_btgp_btn_group_3_top", "", "" . $this->Ini->Nm_lang['lang_btns_expt'] . "", "", "absmiddle", "", "", $this->Ini->path_botoes, "", "" . $this->Ini->Nm_lang['lang_btns_expt'] . "", "", "", "__sc_grp__", "text_img", "text_right", "", "", "", "", "", "", "");
          $nm_saida->saida("           $Cod_Btn\r\n");
          $NM_btn  = true;
          $NM_Gbtn = false;
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rpdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['pdf'][] = "Rpdf_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_detalleventa_matrix/grid_reporte_sales_detalleventa_matrix_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_reporte_sales_detalleventa_matrix&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rword_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['word'][] = "Rword_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_detalleventa_matrix/grid_reporte_sales_detalleventa_matrix_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xml'][] = "Rxml_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_detalleventa_matrix/grid_reporte_sales_detalleventa_matrix_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rcsv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['csv'][] = "Rcsv_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_detalleventa_matrix/grid_reporte_sales_detalleventa_matrix_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['group_4'] == "on")
      {
          ...
          $Cod_Btn = nmButtonOutput($this->arr_buttons, "group_group_4", "scBtnGrpShow('group_4_top')", "scBtnGrpShow('group_4_top')", "sc_btgp_btn_group_4_top", "", "" . $this->Ini->Nm_lang['lang_btns_expt_email_title'] . "", "", "absmiddle", "", "", $this->Ini->path_botoes, "", "" . $this->Ini->Nm_lang['lang_btns_expt_email'] . "", "", "", "__sc_grp__", "text_img", "text_right", "", "", "", "", "", "", "");
          $nm_saida->saida("           $Cod_Btn\r\n");
          $NM_btn  = true;
          $NM_Gbtn = false;
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_reporte_sales_detalleventa_matrix']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_reporte_sales_detalleventa_matrix']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_reporte_sales_detalleventa_matrix_config_pivot.php?nome_apl=grid_reporte_sales_detalleventa_matrix&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_reporte_sales_detalleventa_matrix_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_reporte_sales_detalleventa_matrix/grid_reporte_sales_detalleventa_matrix_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
      $nm_saida->saida("       }\r\n");
      $nm_saida->saida("       else\r\n");
      $nm_saida->saida("       {\r\n");
      ...
      $nm_saida->saida("               document.Fdoc_word.action = \"grid_reporte_sales_detalleventa_matrix_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("               document.Fprint.action = \"grid_reporte_sales_detalleventa_matrix_export_ctrl.php\";\r\n");
      $nm_saida->saida("           }\r\n");
      $nm_saida->saida("           else\r\n");
      $nm_saida->saida("           {\r\n");
      ...
      $nm_saida->saida("               document.Fexport.action = \"grid_reporte_sales_detalleventa_matrix_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['grid_reporte_sales_detalleventa_matrix_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_reporte_sales_detalleventa_matrix@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("          nm_submit_modal(\"" . $this->Ini->path_link . "grid_reporte_sales_detalleventa_matrix/grid_reporte_sales_detalleventa_matrix_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_reporte_sales_detalleventa_matrix_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_reporte_sales_detalleventa_matrix/grid_reporte_sales_detalleventa_matrix_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['print_all'];
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pdf_res'])
       {
           $nm_saida->saida("<TR>\r\n");
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['skip_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_charts']);
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               grid_reporte_sales_detalleventa_matrix_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['this_chart_label'] = '';
       ...
       if ($bChartFP)
       {
           ...
           grid_reporte_sales_detalleventa_matrix_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
           fwrite($this->progress_fp, 90 . "_#NM#_" . $lang_protect . "...\n");
           fclose($this->progress_fp);
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['chart_list']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['chart_list'] as $arr_chart)
       {
           $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
       $nm_saida->saida("<b><div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_btns_chrt_pdff_hint'] . "</H1></div></b>\r\n");
           $nm_saida->saida("<table><tr><td>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $datesales = $Busca_temp['datesales']; 
          $tmp_pos = strpos($datesales, "##@@");
          if ($tmp_pos !== false && !is_array($datesales))
          {
              $datesales = substr($datesales, 0, $tmp_pos);
          }
          $datesales_2 = $Busca_temp['datesales_input_2']; 
          $sucursal = $Busca_temp['sucursal']; 
          $tmp_pos = strpos($sucursal, "##@@");
          if ($tmp_pos !== false && !is_array($sucursal))
          {
              $sucursal = substr($sucursal, 0, $tmp_pos);
          }
          $cuentaventa = $Busca_temp['cuentaventa']; 
          $tmp_pos = strpos($cuentaventa, "##@@");
          if ($tmp_pos !== false && !is_array($cuentaventa))
          {
              $cuentaventa = substr($cuentaventa, 0, $tmp_pos);
          }
      } 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['cond_pesq'], 0, $trab_pos);
     ...
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['proc_pdf_vert']) {
      ...
      $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">" . $this->Ini->Nm_lang['lang_othr_grid_title'] . " reporte_sales</div>\r\n");
   ...
   //---- 
   function adiciona_registro($sum_quantity, $sum_item_total, $sum_valor_siniva, $quebra_sucursal, $quebra_cuentaventa, $quebra_jugador, $quebra_visitante, $quebra_entrada, $quebra_comida, $quebra_producto, $quebra_codproducto, $quebra_idcliente, $quebra_datesales, $quebra_datesales_scgb_192, $quebra_datesales_scgb_203, $quebra_datesales_scgb_193, $quebra_datesales_scgb_195, $quebra_datesales_scgb_196, $quebra_datesales_scgb_197, $quebra_datesales_scgb_198, $quebra_datesales_scgb_199, $quebra_datesales_scgb_200, $quebra_datesales_scgb_201, $quebra_datesales_scgb_202, $quebra_datesales_scgb_204, $quebra_datesales_scgb_194, $quebra_sucursal_orig, $quebra_cuentaventa_orig, $quebra_jugador_orig, $quebra_visitante_orig, $quebra_entrada_orig, $quebra_comida_orig, $quebra_producto_orig, $quebra_codproducto_orig, $quebra_idcliente_orig, $quebra_datesales_orig, $quebra_datesales_scgb_192_orig, $quebra_datesales_scgb_203_orig, $quebra_datesales_scgb_193_orig, $quebra_datesales_scgb_195_orig, $quebra_datesales_scgb_196_orig, $quebra_datesales_scgb_197_orig, $quebra_datesales_scgb_198_orig, $quebra_datesales_scgb_199_orig, $quebra_datesales_scgb_200_orig, $quebra_datesales_scgb_201_orig, $quebra_datesales_scgb_202_orig, $quebra_datesales_scgb_204_orig, $quebra_datesales_scgb_194_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->id_sales_detail = $rs_res->fields[0] ;  
            $this->unit_cost = $rs_res->fields[1] ;  
            $this->unit_cost =  str_replace(",", ".", $this->unit_cost);
            $this->unit_value = $rs_res->fields[2] ;  
            $this->unit_value =  str_replace(",", ".", $this->unit_value);
            $this->quantity = $rs_res->fields[3] ;  
            $this->discount = $rs_res->fields[4] ;  
            $this->discount =  str_replace(",", ".", $this->discount);
            $this->item_total = $rs_res->fields[5] ;  
            $this->item_total =  str_replace(",", ".", $this->item_total);
            $this->id_product = $rs_res->fields[6] ;  
            $this->uniqueidtrans = $rs_res->fields[7] ;  
            $this->fechatrans = $rs_res->fields[8] ;  
            $this->valor_siniva = $rs_res->fields[9] ;  
            $this->valor_unitario = $rs_res->fields[10] ;  
            $this->codproducto = $rs_res->fields[11] ;  
            $this->producto = $rs_res->fields[12] ;  
            $this->entrada = $rs_res->fields[13] ;  
            $this->jugador = $rs_res->fields[14] ;  
            $this->visitante = $rs_res->fields[15] ;  
            $this->tarjeta = $rs_res->fields[16] ;  
            $this->tokens = $rs_res->fields[17] ;  
            $this->minutos = $rs_res->fields[18] ;  
            $this->comida = $rs_res->fields[19] ;  
            $this->cuentaventa = $rs_res->fields[20] ;  
            $this->sucursal = $rs_res->fields[21] ;  
            $this->id_sales = $rs_res->fields[22] ;  
            $this->sales_price = $rs_res->fields[23] ;  
            $this->sales_price =  str_replace(",", ".", $this->sales_price);
            $this->sales_discount = $rs_res->fields[24] ;  
            $this->sales_discount =  str_replace(",", ".", $this->sales_discount);
            $this->total = $rs_res->fields[25] ;  
            $this->total =  str_replace(",", ".", $this->total);
            $this->datesales = $rs_res->fields[26] ;  
            $this->id_status = $rs_res->fields[27] ;  
            $this->idcaja = $rs_res->fields[28] ;  
            $this->idcliente = $rs_res->fields[29] ;  
            $this->cliente = $rs_res->fields[30] ;  
            $this->direccion = $rs_res->fields[31] ;  
            $this->telefono = $rs_res->fields[32] ;  
            $this->factura = $rs_res->fields[33] ;  
            $this->serie = $rs_res->fields[34] ;  
            $this->clave_acceso = $rs_res->fields[35] ;  
            $this->enviosri = $rs_res->fields[36] ;  
            $this->fechaenvio = $rs_res->fields[37] ;  
            $this->uniqueid = $rs_res->fields[38] ;  
            $this->estado = $rs_res->fields[39] ;  
            $this->fechaid = $rs_res->fields[40] ;  
            $this->importe_recibido = $rs_res->fields[41] ;  
            $this->importe_recibido =  str_replace(",", ".", $this->importe_recibido);
            $this->codigoid = $rs_res->fields[42] ;  
            $this->totalsinimpuestos = $rs_res->fields[43] ;  
            $this->totaldescuento = $rs_res->fields[44] ;  
            $this->totaldescuento =  str_replace(",", ".", $this->totaldescuento);
            $this->baseimponible = $rs_res->fields[45] ;  
            $this->valoriva = $rs_res->fields[46] ;  
            $this->importetotal = $rs_res->fields[47] ;  
            $this->importetotal =  str_replace(",", ".", $this->importetotal);
            $this->idpago = $rs_res->fields[48] ;  
            $this->totalpago = $rs_res->fields[49] ;  
            $this->totalpago =  str_replace(",", ".", $this->totalpago);
            $this->cliente_email = $rs_res->fields[50] ;  
            $this->idempleado = $rs_res->fields[51] ;  
            $this->idturno = $rs_res->fields[52] ;  
            $this->codpago_sri = $rs_res->fields[53] ;  
            $this->imprime = $rs_res->fields[54] ;  
            $this->comprobante = $rs_res->fields[55] ;  
            $this->sucursal_orig = $this->sucursal;
            $this->cuentaventa_orig = $this->cuentaventa;
            $this->jugador_orig = $this->jugador;
            $this->visitante_orig = $this->visitante;
            $this->entrada_orig = $this->entrada;
            $this->comida_orig = $this->comida;
            $this->producto_orig = $this->producto;
            $this->codproducto_orig = $this->codproducto;
            $this->idcliente_orig = $this->idcliente;
            $this->datesales_orig = $this->datesales;
            $this->datesales_scgb_192_orig = $this->datesales_scgb_192;
            $this->datesales_scgb_203_orig = $this->datesales_scgb_203;
            $this->datesales_scgb_193_orig = $this->datesales_scgb_193;
            $this->datesales_scgb_195_orig = $this->datesales_scgb_195;
            $this->datesales_scgb_196_orig = $this->datesales_scgb_196;
            $this->datesales_scgb_197_orig = $this->datesales_scgb_197;
            $this->datesales_scgb_198_orig = $this->datesales_scgb_198;
            $this->datesales_scgb_199_orig = $this->datesales_scgb_199;
            $this->datesales_scgb_200_orig = $this->datesales_scgb_200;
            $this->datesales_scgb_201_orig = $this->datesales_scgb_201;
            $this->datesales_scgb_202_orig = $this->datesales_scgb_202;
            $this->datesales_scgb_204_orig = $this->datesales_scgb_204;
            $this->datesales_scgb_194_orig = $this->datesales_scgb_194;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->quantity, $this->item_total, $this->valor_siniva, $this->sucursal, $this->cuentaventa, $this->jugador, $this->visitante, $this->entrada, $this->comida, $this->producto, $this->codproducto, $this->idcliente, $this->datesales, $this->datesales_scgb_192, $this->datesales_scgb_203, $this->datesales_scgb_193, $this->datesales_scgb_195, $this->datesales_scgb_196, $this->datesales_scgb_197, $this->datesales_scgb_198, $this->datesales_scgb_199, $this->datesales_scgb_200, $this->datesales_scgb_201, $this->datesales_scgb_202, $this->datesales_scgb_204, $this->datesales_scgb_194, $this->sucursal_orig,  $this->cuentaventa_orig,  $this->jugador_orig,  $this->visitante_orig,  $this->entrada_orig,  $this->comida_orig,  $this->producto_orig,  $this->codproducto_orig,  $this->idcliente_orig,  $this->datesales_orig,  $this->datesales_scgb_192_orig,  $this->datesales_scgb_203_orig,  $this->datesales_scgb_193_orig,  $this->datesales_scgb_195_orig,  $this->datesales_scgb_196_orig,  $this->datesales_scgb_197_orig,  $this->datesales_scgb_198_orig,  $this->datesales_scgb_199_orig,  $this->datesales_scgb_200_orig,  $this->datesales_scgb_201_orig,  $this->datesales_scgb_202_orig,  $this->datesales_scgb_204_orig,  $this->datesales_scgb_194_orig);
            }
   }
//
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
                        ...
                        if ($cmp == "datesales")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "datesales";
                           $lin_obj = $this->grid_search_datesales($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "sucursal")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "sucursal";
                           $lin_obj = $this->grid_search_sucursal($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "cuentaventa")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "cuentaventa";
                           $lin_obj = $this->grid_search_cuentaventa($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['grid_pesq']))
           { 
   ...
   {
       global $nm_saida;
       $this->Cmps_required = array('datesales');
       $lin_obj  = "";
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('datesales','sucursal','cuentaventa');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['grid_pesq']) < 3)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_datesales($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_datesales_" . $ind . "' style='display:none; z-index: 10'>";
       ...
       $lin_obj .= "       <select id='grid_search_datesales_cond_" . $ind . "' name='cond_grid_search_datesales_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle;' onChange='grid_search_change_bi(\"datesales\", $ind)'>";
       ...
       $selected = ($opc == "bi_current_quarter") ? " selected" : "";
       $lin_obj .= "        <option value='bi_current_quarter'" . $selected . ">" . $this->Ini->Nm_lang['lang_search_summary_current_quarter'] . "</option>";
       $selected = ($opc == "bi_last_quarter") ? " selected" : "";
       $lin_obj .= "        <option value='bi_last_quarter'" . $selected . ">" . $this->Ini->Nm_lang['lang_search_summary_last_quarter'] . "</option>";
       ...
       $lin_obj .= "       <span id=\"grid_datesales_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $Form_base          = "ddmmyyyy";
       $date_format_show   = "";
       ...
       if (substr($opc, 0, 3) == "bi_")
       {
           ...
           if ($opc != "bi_TP")
           {
               ...
               $this->formata_bi_datesales($opc, $bi_dt1, $bi_dt2, $tmp_opc);
           }
       }
       else
       {
       ...
       $lin_obj .= "<SPAN id=\"ID_bi_dados_grid_datesales_" . $ind . "\" style=\"display:" . $display_bi . ";\">" . $bi_dt1 . $bi_dt2 . "</SPAN>";
       $lin_obj .= "<table id=\"ID_nm_dados_grid_datesales_" . $ind . "\" style=\"display:" . $display_nm . ";\">";
       $lin_obj .= "<tr><td>";
       ...
       foreach ($Tmp_date as $Ind => $Part_date)
       {
           ...
           if (substr($Part_date, 0,1) == "y")
           {
               ...
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_datesales_ano_val_" . $ind . "' name='val_grid_search_datesales_ano_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=4 alt=\"{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "m")
           {
               $val_cmp = (isset($val_r['mes'])) ? $val_r['mes'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_datesales_mes_val_" . $ind . "' name='val_grid_search_datesales_mes_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "d")
           {
               $val_cmp = (isset($val_r['dia'])) ? $val_r['dia'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_datesales_dia_val_" . $ind . "' name='val_grid_search_datesales_dia_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
       }
       $lin_obj .= "     <input type=\"hidden\" id=\"sc_grid_datesales_jq_" . $ind . "\">";
       $lin_obj .= "&nbsp;";
       ...
       $lin_obj .= "       <span id=\"grid_datesales_in_2_" . $ind . "\" style=\"display:" . $display_in_2 . "\">";
       ...
       foreach ($Tmp_date as $Ind => $Part_date)
       {
           ...
           {
               $val_cmp = (isset($val_r['ano'])) ? $val_r['ano'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_datesales_v2__ano_val_" . $ind . "' name='val_grid_search_datesales_v2__ano_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=4 alt=\"{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "m")
           {
               $val_cmp = (isset($val_r['mes'])) ? $val_r['mes'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_datesales_v2__mes_val_" . $ind . "' name='val_grid_search_datesales_v2__mes_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "d")
           {
               $val_cmp = (isset($val_r['dia'])) ? $val_r['dia'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_datesales_v2__dia_val_" . $ind . "' name='val_grid_search_datesales_v2__dia_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
       }
       $lin_obj .= "     <input type=\"hidden\" id=\"sc_grid_datesales_v2__jq_" . $ind . "\">";
       $lin_obj .= "&nbsp;";
       $lin_obj .= "" . $date_format_show . "";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
   ...
   function grid_search_sucursal($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_sucursal_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_sucursal_cond_" . $ind . "' name='cond_grid_search_sucursal_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       $selected = ($opc == "eq") ? " selected" : "";
       $lin_obj .= "        <option value='eq'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_exac'] . "</option>";
       $lin_obj .= "       </select>";
       if ($opc == "nu" || $opc == "nn" || $opc == "ep" || $opc == "ne")
       ...
       $lin_obj .= "       <span id=\"grid_sucursal_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['psq_check_ret']['sucursal'] = array();
       $sucursal_look = substr($this->Db->qstr($sucursal), 1, -1); 
       $nmgp_def_dados  = ""; 
       $nm_comando = "SELECT codsucursal   FROM sucursales  ORDER BY nombre"; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['psq_check_ret']['sucursal'][] = trim($rs->fields[0]);
       ...
       $lin_obj .= "    <input id='grid_search_sucursal_val_" . $ind . "' name='val_grid_search_sucursal_" . $ind . "' type='hidden' value=''>";
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' style='height : auto;' id=\"grid_search_sucursal_val_" . $ind . "_orig\" name=\"val_grid_search_sucursal_" . $ind . "_orig\" size=7 multiple onDblClick=\"nm_add_sel_Grid('grid_search_sucursal_val_" . $ind . "_orig', 'grid_search_sucursal_val_" . $ind . "_dest', 'N')\">";
       $delimitador = "##@@";
          ...
          if (!empty($nm_opcao))
          {
             ...
             if (is_array($val) && !empty($val))
             {
                ...
                foreach ($val as $Dados)
                {
                    ...
                    if ($Dados === $nm_opc_cod)
                    {
                        $sucursal_sel = " disabled =\"disabled\" style=\"color: #A0A0A0\"";
                        break;
                    }
                }
             }
             ...
             {
                $sucursal_sel = ("S" == $nm_opc_sel) ? " selected" : "";
             }
             $lin_obj .= "       <OPTION value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\"" . $sucursal_sel . ">" . $nm_opc_val . "</OPTION>";
          }
       }
       $lin_obj .= "    </SELECT>";
       $lin_obj .= "   </td>";
       ...
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all_Grid('grid_search_sucursal_val_" . $ind . "_orig', 'grid_search_sucursal_val_" . $ind . "_dest', 'N');", "nm_add_all_Grid('grid_search_sucursal_val_" . $ind . "_orig', 'grid_search_sucursal_val_" . $ind . "_dest', 'N');", "G_Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");

       $lin_obj .= "   </div>";
       $lin_obj .= "   <div class='scBtnPassField'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel_Grid('grid_search_sucursal_val_" . $ind . "_orig', 'grid_search_sucursal_val_" . $ind . "_dest', 'N');", "nm_add_sel_Grid('grid_search_sucursal_val_" . $ind . "_orig', 'grid_search_sucursal_val_" . $ind . "_dest', 'N');", "G_Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");

       $lin_obj .= "   </div>";
       $lin_obj .= "   <div class='scBtnPassField'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel_Grid('grid_search_sucursal_val_" . $ind . "_dest', 'grid_search_sucursal_val_" . $ind . "_orig', 'N');", "nm_del_sel_Grid('grid_search_sucursal_val_" . $ind . "_dest', 'grid_search_sucursal_val_" . $ind . "_orig', 'N');", "G_Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");

       $lin_obj .= "   </div>";
       $lin_obj .= "   <div class='scBtnPassField'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all_Grid('grid_search_sucursal_val_" . $ind . "_dest', 'grid_search_sucursal_val_" . $ind . "_orig', 'N');", "nm_del_all_Grid('grid_search_sucursal_val_" . $ind . "_dest', 'grid_search_sucursal_val_" . $ind . "_orig', 'N');", "G_Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");

       $lin_obj .= "   </div>";
       $lin_obj .= "   </td>";
       $lin_obj .= "   <td>";
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' style='height : auto;' id=\"grid_search_sucursal_val_" . $ind . "_dest\" name=\"val_grid_search_sucursal_" . $ind . "_dest\" size=7 multiple onDblClick=\"nm_del_sel_Grid('grid_search_sucursal_val_" . $ind . "_dest', 'grid_search_sucursal_val_" . $ind . "_orig', 'N')\">";
       $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
       $nm_opcoes  = explode("?@?", $nm_opcoesx);
       foreach ($nm_opcoes as $nm_opcao)
       {
   ...
   function grid_search_cuentaventa($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_cuentaventa_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_cuentaventa_cond_" . $ind . "' name='cond_grid_search_cuentaventa_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       $selected = ($opc == "eq") ? " selected" : "";
       $lin_obj .= "        <option value='eq'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_exac'] . "</option>";
       $lin_obj .= "       </select>";
       if ($opc == "nu" || $opc == "nn" || $opc == "ep" || $opc == "ne")
       ...
       $lin_obj .= "       <span id=\"grid_cuentaventa_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['psq_check_ret']['cuentaventa'] = array();
       $cuentaventa_look = substr($this->Db->qstr($cuentaventa), 1, -1); 
       $nmgp_def_dados  = ""; 
       $nm_comando = "SELECT codigo, descrip  FROM product_categoria  ORDER BY descrip"; 
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
       $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['psq_check_ret']['cuentaventa'][] = trim($rs->fields[0]);
       ...
       $lin_obj .= "   <table style=\"padding: 0px; spacing: 0px; border-width: 0px;\"><tr><td>";
       $lin_obj .= "    <input id='grid_search_cuentaventa_val_" . $ind . "' name='val_grid_search_cuentaventa_" . $ind . "' type='hidden' value=''>";
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' style='height : auto;' id=\"grid_search_cuentaventa_val_" . $ind . "_orig\" name=\"val_grid_search_cuentaventa_" . $ind . "_orig\" size=7 multiple onDblClick=\"nm_add_sel_Grid('grid_search_cuentaventa_val_" . $ind . "_orig', 'grid_search_cuentaventa_val_" . $ind . "_dest', 'N')\">";
       $delimitador = "##@@";
       $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
       $nm_opcoes  = explode("?@?", $nm_opcoesx);
       $val = isset($val[0]) ? $val[0] : array();
          ...
          if (!empty($nm_opcao))
          {
             ...
             if (is_array($val) && !empty($val))
             {
                ...
                foreach ($val as $Dados)
                {
                    ...
                    if ($Dados === $nm_opc_cod)
                    {
                        $cuentaventa_sel = " disabled =\"disabled\" style=\"color: #A0A0A0\"";
                        break;
                    }
                }
             }
             ...
             {
                $cuentaventa_sel = ("S" == $nm_opc_sel) ? " selected" : "";
             }
             $lin_obj .= "       <OPTION value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\"" . $cuentaventa_sel . ">" . $nm_opc_val . "</OPTION>";
          }
       }
       $lin_obj .= "    </SELECT>";
       $lin_obj .= "   </td>";
       $lin_obj .= "   <td align=\"center\">";
       $lin_obj .= "   <div class='scBtnPassField'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all_Grid('grid_search_cuentaventa_val_" . $ind . "_orig', 'grid_search_cuentaventa_val_" . $ind . "_dest', 'N');", "nm_add_all_Grid('grid_search_cuentaventa_val_" . $ind . "_orig', 'grid_search_cuentaventa_val_" . $ind . "_dest', 'N');", "G_Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");

       $lin_obj .= "   </div>";
       $lin_obj .= "   <div class='scBtnPassField'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel_Grid('grid_search_cuentaventa_val_" . $ind . "_orig', 'grid_search_cuentaventa_val_" . $ind . "_dest', 'N');", "nm_add_sel_Grid('grid_search_cuentaventa_val_" . $ind . "_orig', 'grid_search_cuentaventa_val_" . $ind . "_dest', 'N');", "G_Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");

       $lin_obj .= "   </div>";
       $lin_obj .= "   <div class='scBtnPassField'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel_Grid('grid_search_cuentaventa_val_" . $ind . "_dest', 'grid_search_cuentaventa_val_" . $ind . "_orig', 'N');", "nm_del_sel_Grid('grid_search_cuentaventa_val_" . $ind . "_dest', 'grid_search_cuentaventa_val_" . $ind . "_orig', 'N');", "G_Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");

       $lin_obj .= "   </div>";
       $lin_obj .= "   <div class='scBtnPassField'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all_Grid('grid_search_cuentaventa_val_" . $ind . "_dest', 'grid_search_cuentaventa_val_" . $ind . "_orig', 'N');", "nm_del_all_Grid('grid_search_cuentaventa_val_" . $ind . "_dest', 'grid_search_cuentaventa_val_" . $ind . "_orig', 'N');", "G_Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");

       $lin_obj .= "   </div>";
       $lin_obj .= "   </td>";
       $lin_obj .= "   <td>";
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' style='height : auto;' id=\"grid_search_cuentaventa_val_" . $ind . "_dest\" name=\"val_grid_search_cuentaventa_" . $ind . "_dest\" size=7 multiple onDblClick=\"nm_del_sel_Grid('grid_search_cuentaventa_val_" . $ind . "_dest', 'grid_search_cuentaventa_val_" . $ind . "_orig', 'N')\">";
       $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
       $nm_opcoes  = explode("?@?", $nm_opcoesx);
       foreach ($nm_opcoes as $nm_opcao)
       {
   ...
   function formata_bi_datesales($opc, &$bi_dt1, &$bi_dt2, $opc_bi)
   {
       $Str_date = str_replace("a", "y", strtolower($_SESSION['scriptcase']['reg_conf']['date_format']));
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "pointofsales/grid_reporte_sales_detalleventa_matrix";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida(" function sc_grid_reporte_sales_detalleventa_matrix_valida_mes(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_reporte_sales_detalleventa_matrix_valida_dia(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['datesales_mes'] =  'sc_grid_reporte_sales_detalleventa_matrix_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['datesales_dia'] =  'sc_grid_reporte_sales_detalleventa_matrix_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['datesales_v2__mes'] =  'sc_grid_reporte_sales_detalleventa_matrix_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['datesales_v2__dia'] =  'sc_grid_reporte_sales_detalleventa_matrix_valida_dia(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['datesales_mes']", 'value' => 'sc_grid_reporte_sales_detalleventa_matrix_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['datesales_dia']", 'value' => 'sc_grid_reporte_sales_detalleventa_matrix_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['datesales_v2__mes']", 'value' => 'sc_grid_reporte_sales_detalleventa_matrix_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['datesales_v2__dia']", 'value' => 'sc_grid_reporte_sales_detalleventa_matrix_valida_dia(this)');
       } 
       ...
       $nm_saida->saida("                 if (tmp == 'datesales')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     cps[x] = 'datesales_dia';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'datesales_mes';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'datesales_v2__dia';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'datesales_v2__mes';\r\n");
       $nm_saida->saida("                 }\r\n");
       ...
       $nm_saida->saida("                     $('#sc_grid_datesales_jq_' + i).datepicker({\r\n");
       $nm_saida->saida("                        beforeShow: function(input, inst) {\r\n");
       $nm_saida->saida("                          var_dt_ini  = document.getElementById('grid_search_datesales_dia_val_' + i_calendar).value + '/';\r\n");
       $nm_saida->saida("                          var_dt_ini += document.getElementById('grid_search_datesales_mes_val_' + i_calendar).value + '/';\r\n");
       $nm_saida->saida("                          var_dt_ini += document.getElementById('grid_search_datesales_ano_val_' + i_calendar).value;\r\n");
       $nm_saida->saida("                          document.getElementById('sc_grid_datesales_jq_' + i_calendar).value = var_dt_ini;\r\n");
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        onClose: function(dateText, inst) {\r\n");
       $nm_saida->saida("                          aParts  = dateText.split(\"/\");\r\n");
       $nm_saida->saida("                          document.getElementById('grid_search_datesales_dia_val_' + i_calendar).value = aParts[0];\r\n");
       $nm_saida->saida("                          document.getElementById('grid_search_datesales_mes_val_' + i_calendar).value = aParts[1];\r\n");
       $nm_saida->saida("                          document.getElementById('grid_search_datesales_ano_val_' + i_calendar).value = aParts[2];\r\n");
       $nm_saida->saida("                        },\r\n");
       ...
       $nm_saida->saida("                     });\r\n");
       $nm_saida->saida("                     var i_calendar = i;\r\n");
       $nm_saida->saida("                     $('#sc_grid_datesales_v2__jq_' + i).datepicker({\r\n");
       $nm_saida->saida("                        beforeShow: function(input, inst) {\r\n");
       $nm_saida->saida("                          var_dt_ini  = document.getElementById('grid_search_datesales_v2__dia_val_' + i_calendar).value + '/';\r\n");
       $nm_saida->saida("                          var_dt_ini += document.getElementById('grid_search_datesales_v2__mes_val_' + i_calendar).value + '/';\r\n");
       $nm_saida->saida("                          var_dt_ini += document.getElementById('grid_search_datesales_v2__ano_val_' + i_calendar).value;\r\n");
       $nm_saida->saida("                          document.getElementById('sc_grid_datesales_v2__jq_' + i_calendar).value = var_dt_ini;\r\n");
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        onClose: function(dateText, inst) {\r\n");
       $nm_saida->saida("                          aParts  = dateText.split(\"/\");\r\n");
       $nm_saida->saida("                          document.getElementById('grid_search_datesales_v2__dia_val_' + i_calendar).value = aParts[0];\r\n");
       $nm_saida->saida("                          document.getElementById('grid_search_datesales_v2__mes_val_' + i_calendar).value = aParts[1];\r\n");
       $nm_saida->saida("                          document.getElementById('grid_search_datesales_v2__ano_val_' + i_calendar).value = aParts[2];\r\n");
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        showWeek: true,\r\n");
       $nm_saida->saida("                        numberOfMonths: 1,\r\n");
       $nm_saida->saida("                        changeMonth: true,\r\n");
       ...
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'datesales')\r\n");
       $nm_saida->saida("                 {\r\n");
       ...
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'sucursal')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     result  = grid_search_get_Dselelect(obj_dyn + i + '_dest');\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'cuentaventa')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     result  = grid_search_get_Dselelect(obj_dyn + i + '_dest');\r\n");
       $nm_saida->saida("                 }\r\n");
