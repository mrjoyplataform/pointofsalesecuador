<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_reporte_sales_detalleventa_matrix']['glo_nm_path_imag_temp'] . "/sc_apl_default_pointofsales.txt"))
       {
?>
...
<?php
   ...
   $Sel_Groupby = new grid_reporte_sales_detalleventa_matrix_sel_Groupby(); 
   $Sel_Groupby->Sel_Groupby_init();
   
class grid_reporte_sales_detalleventa_matrix_sel_Groupby
{
function Sel_Groupby_init()
{
   ...
   if ($this->restore) {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['dados_orig_gb']['all']['SC_Ind_Groupby'];
   }
   else {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['SC_Ind_Groupby'];
   }
...
function Sel_processa_out($sel_groupby)
{
   ...
   {
       if (count($campos_sel) != count($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['SC_Gb_Free_cmp']))
       {
       ...
       {
          $Arr_temp = array();
           foreach ($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['SC_Gb_Free_cmp'] as $Cada_cmp => $Resto)
           {
               $Arr_temp[] = $Cada_cmp;
           }
   ...
   {
       $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['SC_Ind_Groupby']     = $sel_groupby;
       $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['contr_array_resumo'] = "NAO";
       $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['contr_total_geral']  = "NAO";
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['ordem_quebra']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['ordem_select']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['tot_geral']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['Page_break_PDF']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['arr_total']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['pivot_group_by']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['pivot_x_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['pivot_y_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['pivot_fill']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['pivot_order']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['pivot_order_col']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['pivot_order_level']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['pivot_order_sort']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['pivot_order_start']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['pivot_tabular']);
           $tab_arr_groubby_cmp = array();
           $tab_arr_groubby_sql = array();
           $tab_arr_groubby_cmp['sucursal'] = array('cmp' => "sucursal", 'ind' => 0, 'format' => "");
           $tab_arr_groubby_cmp['cuentaventa'] = array('cmp' => "cuentaventa", 'ind' => 1, 'format' => "");
           $tab_arr_groubby_cmp['jugador'] = array('cmp' => "jugador", 'ind' => 2, 'format' => "");
           $tab_arr_groubby_cmp['visitante'] = array('cmp' => "visitante", 'ind' => 3, 'format' => "");
           $tab_arr_groubby_cmp['entrada'] = array('cmp' => "entrada", 'ind' => 4, 'format' => "");
           $tab_arr_groubby_cmp['comida'] = array('cmp' => "comida", 'ind' => 5, 'format' => "");
           $tab_arr_groubby_cmp['producto'] = array('cmp' => "producto", 'ind' => 6, 'format' => "");
           $tab_arr_groubby_cmp['codproducto'] = array('cmp' => "codproducto", 'ind' => 7, 'format' => "");
           $tab_arr_groubby_cmp['idcliente'] = array('cmp' => "idcliente", 'ind' => 8, 'format' => "");
           $tab_arr_groubby_cmp['datesales'] = array('cmp' => "datesales", 'ind' => 9, 'format' => "YYYYMMDD2");
           $tab_arr_groubby_cmp['datesales_scgb_192'] = array('cmp' => "datesales", 'ind' => 10, 'format' => "YYYY");
           $tab_arr_groubby_cmp['datesales_scgb_203'] = array('cmp' => "datesales", 'ind' => 11, 'format' => "YYYYMM");
           $tab_arr_groubby_cmp['datesales_scgb_193'] = array('cmp' => "datesales", 'ind' => 12, 'format' => "QUARTER");
           $tab_arr_groubby_cmp['datesales_scgb_195'] = array('cmp' => "datesales", 'ind' => 13, 'format' => "DD");
           $tab_arr_groubby_cmp['datesales_scgb_196'] = array('cmp' => "datesales", 'ind' => 14, 'format' => "SEMIANNUAL");
           $tab_arr_groubby_cmp['datesales_scgb_197'] = array('cmp' => "datesales", 'ind' => 15, 'format' => "YYYYSEMIANNUAL");
           $tab_arr_groubby_cmp['datesales_scgb_198'] = array('cmp' => "datesales", 'ind' => 16, 'format' => "FOURMONTHS");
           $tab_arr_groubby_cmp['datesales_scgb_199'] = array('cmp' => "datesales", 'ind' => 17, 'format' => "YYYYFOURMONTHS");
           $tab_arr_groubby_cmp['datesales_scgb_200'] = array('cmp' => "datesales", 'ind' => 18, 'format' => "YYYYQUARTER");
           $tab_arr_groubby_cmp['datesales_scgb_201'] = array('cmp' => "datesales", 'ind' => 19, 'format' => "BIMONTHLY");
           $tab_arr_groubby_cmp['datesales_scgb_202'] = array('cmp' => "datesales", 'ind' => 20, 'format' => "YYYYBIMONTHLY");
           $tab_arr_groubby_cmp['datesales_scgb_204'] = array('cmp' => "datesales", 'ind' => 21, 'format' => "WEEK");
           $tab_arr_groubby_cmp['datesales_scgb_194'] = array('cmp' => "datesales", 'ind' => 22, 'format' => "MM");
           $tab_arr_groubby_sql[0] = array('cmp' => "sucursal", 'ord' => 'asc');
           $tab_arr_groubby_sql[1] = array('cmp' => "cuentaventa", 'ord' => 'asc');
           $tab_arr_groubby_sql[2] = array('cmp' => "jugador", 'ord' => 'asc');
           $tab_arr_groubby_sql[3] = array('cmp' => "visitante", 'ord' => 'asc');
           $tab_arr_groubby_sql[4] = array('cmp' => "entrada", 'ord' => 'asc');
           $tab_arr_groubby_sql[5] = array('cmp' => "comida", 'ord' => 'asc');
           $tab_arr_groubby_sql[6] = array('cmp' => "producto", 'ord' => 'asc');
           $tab_arr_groubby_sql[7] = array('cmp' => "codproducto", 'ord' => 'asc');
           $tab_arr_groubby_sql[8] = array('cmp' => "idcliente", 'ord' => 'asc');
           $tab_arr_groubby_sql[9] = array('cmp' => "datesales", 'ord' => 'asc');
           $tab_arr_groubby_sql[10] = array('cmp' => "datesales", 'ord' => 'asc');
           $tab_arr_groubby_sql[11] = array('cmp' => "datesales", 'ord' => 'asc');
           $tab_arr_groubby_sql[12] = array('cmp' => "datesales", 'ord' => 'asc');
           $tab_arr_groubby_sql[13] = array('cmp' => "datesales", 'ord' => 'asc');
           $tab_arr_groubby_sql[14] = array('cmp' => "datesales", 'ord' => 'asc');
           $tab_arr_groubby_sql[15] = array('cmp' => "datesales", 'ord' => 'asc');
           $tab_arr_groubby_sql[16] = array('cmp' => "datesales", 'ord' => 'asc');
           $tab_arr_groubby_sql[17] = array('cmp' => "datesales", 'ord' => 'asc');
           $tab_arr_groubby_sql[18] = array('cmp' => "datesales", 'ord' => 'asc');
           $tab_arr_groubby_sql[19] = array('cmp' => "datesales", 'ord' => 'asc');
           $tab_arr_groubby_sql[20] = array('cmp' => "datesales", 'ord' => 'asc');
           $tab_arr_groubby_sql[21] = array('cmp' => "datesales", 'ord' => 'asc');
           $tab_arr_groubby_sql[22] = array('cmp' => "datesales", 'ord' => 'asc');
           $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['SC_Gb_Free_cmp']  = array();
           $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['SC_Gb_Free_sql']  = array();
           $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['SC_Gb_date_format']['sc_free_group_by'] = array();
           $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['SC_Gb_Free_orig'] = array();
           foreach ($campos_sel as $cada_cmp)
           {
               if (!empty($cada_cmp))
               {
                   $ind = $tab_arr_groubby_cmp[$cada_cmp]['ind'];
                   $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['SC_Gb_Free_cmp'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['cmp'];
                   $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['SC_Gb_Free_sql'][$cada_cmp][$tab_arr_groubby_sql[$ind]['cmp']] = $tab_arr_groubby_sql[$ind]['ord'];
                   $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['SC_Gb_date_format']['sc_free_group_by'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['format'];
               }
           }
   }
   if ($sel_groupby == "sc_free_group_by")
   {
       ...
       $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['pivot_x_axys'] = $xaxys_list;
       $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['pivot_y_axys'] = $yaxys_list;
   }
   if ($opc_ret == "resumo" && !empty($this->summ_fields))
   {
       $summ_fields = explode("@?@", $this->summ_fields);
       if(isset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display'][ $sel_groupby ]))
       {
           foreach ($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display'][ $sel_groupby ] as $i_sum => $d_sum)
           {
               $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display'][ $sel_groupby ][$i_sum]['display'] = in_array($i_sum, $summ_fields);
           }
       }
       $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_order'][ $sel_groupby ] = $summ_fields;
       $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['summarizing_drill_down'] = $this->drill_down;
   }
?>
    <script language="javascript"> 
<?php
...
function Sel_processa_form()
{
   ...
   $arr_campos_free['sucursal'] = "Sucursal";
   $arr_campos_free['cuentaventa'] = "Cuentaventa";
   $arr_campos_free['jugador'] = "Jugador";
   $arr_campos_free['visitante'] = "Visitante";
   $arr_campos_free['entrada'] = "Entrada";
   $arr_campos_free['comida'] = "Comida";
   $arr_campos_free['producto'] = "Producto";
   $arr_campos_free['codproducto'] = "Codproducto";
   $arr_campos_free['idcliente'] = "Idcliente";
   $arr_campos_free['datesales'] = "" . sprintf("" . $this->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", "Datesales") . "";
   $arr_campos_free['datesales_scgb_192'] = "" . sprintf("" . $this->Nm_lang['lang_othr_cons_title_YYYY'] . "", "Datesales") . "";
   $arr_campos_free['datesales_scgb_203'] = "" . sprintf("" . $this->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", "Datesales") . "";
   $arr_campos_free['datesales_scgb_193'] = "" . sprintf("" . $this->Nm_lang['lang_othr_cons_title_QUARTER'] . "", "Datesales") . "";
   $arr_campos_free['datesales_scgb_195'] = "" . sprintf("" . $this->Nm_lang['lang_othr_cons_title_DD'] . "", "Datesales") . "";
   $arr_campos_free['datesales_scgb_196'] = "" . sprintf("" . $this->Nm_lang['lang_othr_cons_title_SEMIANNUAL'] . "", "Datesales") . "";
   $arr_campos_free['datesales_scgb_197'] = "" . sprintf("" . $this->Nm_lang['lang_othr_cons_title_YYYYSEMIANNUAL'] . "", "Datesales") . "";
   $arr_campos_free['datesales_scgb_198'] = "" . sprintf("" . $this->Nm_lang['lang_othr_cons_title_FOURMONTHS'] . "", "Datesales") . "";
   $arr_campos_free['datesales_scgb_199'] = "" . sprintf("" . $this->Nm_lang['lang_othr_cons_title_YYYYFOURMONTHS'] . "", "Datesales") . "";
   $arr_campos_free['datesales_scgb_200'] = "" . sprintf("" . $this->Nm_lang['lang_othr_cons_title_YYYYQUARTER'] . "", "Datesales") . "";
   $arr_campos_free['datesales_scgb_201'] = "" . sprintf("" . $this->Nm_lang['lang_othr_cons_title_BIMONTHLY'] . "", "Datesales") . "";
   $arr_campos_free['datesales_scgb_202'] = "" . sprintf("" . $this->Nm_lang['lang_othr_cons_title_YYYYBIMONTHLY'] . "", "Datesales") . "";
   $arr_campos_free['datesales_scgb_204'] = "" . sprintf("" . $this->Nm_lang['lang_othr_cons_title_WEEK'] . "", "Datesales") . "";
   $arr_campos_free['datesales_scgb_194'] = "" . sprintf("" . $this->Nm_lang['lang_othr_cons_title_MM'] . "", "Datesales") . "";
...
?>
 <script language="javascript" type="text/javascript">
  function scSubmitGroupBy(sPos) {
   $.ajax({
    type: "POST",
    url: "grid_reporte_sales_detalleventa_matrix_sel_groupby.php",
    data: {
...
<?php
if ($this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['dados_orig_gb']['res']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['dados_orig_gb']['res']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
...
elseif (!$this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
        if(is_array($_arr_fields))
        {
            foreach ($_arr_fields as $_key_total => $d_field)
...
{
  $max_height = 1;
  if ($this->restore && isset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['dados_orig_gb']['res']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['dados_orig_gb']['res']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
  ...
  elseif (!$this->restore && isset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
      if (count($_i_sum) > $max_height)
      {
          $max_height = count($_i_sum);
...
<?php
if ($bSummaryPage && $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['SC_Ind_Groupby'] == "sc_free_group_by") {
?>
   if (fieldList == "") {
...
<?php
    ...
    $iTabCount            = 1;
    foreach ($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['SC_All_Groupby'] as $QB => $Tp)
    {
        if (!in_array($QB, $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['SC_Groupby_hide']))
        {
...
<?php
     if (!in_array("datesales_sucursal_cuentaventa_producto", $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['SC_Groupby_hide']))
     {
         $this->static_gb_ok = "sc_id_sel_groupby_datesales_sucursal_cuentaventa_producto";
        if ($groupby_atual == "datesales_sucursal_cuentaventa_producto")
        {
            $check = " checked";
            $bStartFree = false;
            $this->static_gb_ok = "sc_id_sel_groupby_datesales_sucursal_cuentaventa_producto";
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();change_actual_static("sc_id_sel_groupby_datesales_sucursal_cuentaventa_producto");display_btn_restore_gb();' name="sel_groupby" value="datesales_sucursal_cuentaventa_producto" id="sc_id_sel_groupby_datesales_sucursal_cuentaventa_producto"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_datesales_sucursal_cuentaventa_producto">
        datesales_sucursal_cuentaventa_producto
<?php
    $prep_labels = array();
    $prep_labels[] = sprintf("" . $this->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", "Fechatrans");
    $prep_labels[] = "Sucursal";
...
?>
<?php
     if (!in_array("_NM_SC_", $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['SC_Groupby_hide']))
     {
        if ($opc_ret != "resumo")
        {
...
?>
  <td>
<?php
     if (!in_array("sc_free_group_by", $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['SC_Groupby_hide']))
     {
...
<?php
        ...
        $arr_tmp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] : $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['SC_Gb_Free_cmp'];
...
<?php
        ...
        {
            if ($this->restore) {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['dados_orig_gb']['res']['pivot_x_axys']);
            }
            else {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['pivot_x_axys']);
            }
        }
...
<?php
        if ($bSummaryPage)
        {
            ...
            {
                $arr_pivot_x_axys = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['dados_orig_gb']['res']['pivot_x_axys'] : $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['pivot_x_axys'];
...
<?php
   ...
   if ($bSummaryPage)
   {
       ...
       if (!isset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_control'])) {
           $arr_filds = array();
       }
       else {
           $arr_filds = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['dados_orig_gb']['res']['summarizing_fields_control'] : $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_control'];
       }
    if (isset($arr_filds))
    {
?>
...
<?php
          if (!isset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display'])) {
              $arr_disp = array();
          }
          else {
                 $arr_disp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['dados_orig_gb']['res']['summarizing_fields_display'] : $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display'];
          }
          if (!isset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_order'])) {
              $arr_ord = array();
          }
          else {
              $arr_ord  = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['dados_orig_gb']['res']['summarizing_fields_order']   : $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_order'];
          }
...
<script type="text/javascript">
   ...
   if ($this->restore) {
       $oJson = new Services_JSON();
        ob_end_clean();
        if ($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['dados_orig_gb']['all']['SC_Ind_Groupby'] == "sc_free_group_by") {
           $this->Arr_result['run_js'][] = "scShowFree()";
        } else {
           $this->Arr_result['set_var'][] = array('var' => 'actual_static_gb', 'value' => $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['dados_orig_gb']['all']['SC_Ind_Groupby']);
...
<?php
   $disp_rest = "none";
   foreach ($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['dados_orig_gb'] as $tp => $fields) {
       foreach ($fields as $name => $data) {
           if (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix'][$name])) {
               if ($tp == "all" && ($name != "SC_Gb_Free_cmp" || $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix']['SC_Ind_Groupby'] == "sc_free_group_by")) {
                   if ($data != $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix'][$name]) {
                       $disp_rest = "";
                       break;
                   }
               }
               elseif ($tp == "res" && $bSummaryPage && $data != $_SESSION['sc_session'][$sc_init]['grid_reporte_sales_detalleventa_matrix'][$name]) {
                   $disp_rest = "";
                   break;
               }
           }
