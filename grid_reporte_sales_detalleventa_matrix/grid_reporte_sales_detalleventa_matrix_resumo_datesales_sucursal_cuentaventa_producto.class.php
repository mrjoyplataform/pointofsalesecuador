...
class grid_reporte_sales_detalleventa_matrix_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_fechatrans = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['fechatrans'];
          $this->array_total_sucursal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['sucursal'];
          $this->array_total_producto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['producto'];
      }
      else
      {
          $this->array_total_fechatrans = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['tot_geral'][2];
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['arr_total']['fechatrans'] = $this->array_total_fechatrans;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['labels']['fechatrans'] = $Lab_fechatrans; 
       ...
       //-----
       $this->comp_sum = array(
           2 => "Quantity (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           3 => "Valor Siniva (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_order']['datesales_sucursal_cuentaventa_producto']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_order']['datesales_sucursal_cuentaventa_producto'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_order']['datesales_sucursal_cuentaventa_producto'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display']['datesales_sucursal_cuentaventa_producto'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display']['datesales_sucursal_cuentaventa_producto'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display']['datesales_sucursal_cuentaventa_producto'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display']['datesales_sucursal_cuentaventa_producto'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display']['datesales_sucursal_cuentaventa_producto'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display']['datesales_sucursal_cuentaventa_producto'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['summarizing_fields_display']['datesales_sucursal_cuentaventa_producto'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "quantity", 'show' => true),
           3 => array('field' => "valor_siniva", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_quantity_sum",
           3 => "css_valor_siniva_sum",
       );
       ...
       //-----
       foreach ($this->array_total_fechatrans as $i_fechatrans => $d_fechatrans) {
           if (!in_array($i_fechatrans, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_fechatrans[4] ] = $d_fechatrans[3];
               $this->comp_label[0][ $d_fechatrans[4] ] = $d_fechatrans[3];
           }
           foreach ($this->array_total_sucursal[$i_fechatrans] as $i_sucursal => $d_sucursal) {
               if (!in_array($i_sucursal, $this->comp_label[1][ $d_fechatrans[4] ], true)) {
                   $this->comp_index[1][ $d_sucursal[4] ] = $d_sucursal[3];
                   $this->comp_label[1][ $d_fechatrans[4] ][ $d_sucursal[4] ] = $d_sucursal[3];
               }
               foreach ($this->array_total_producto[$i_fechatrans][$i_sucursal] as $i_producto => $d_producto) {
                   if (!in_array($i_producto, $this->comp_label[2][ $d_fechatrans[4] ][ $d_sucursal[4] ], true)) {
                       $this->comp_index[2][ $d_producto[4] ] = $d_producto[3];
                       $this->comp_label[2][ $d_fechatrans[4] ][ $d_sucursal[4] ][ $d_producto[4] ] = $d_producto[3];
                   }
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'fechatrans', 'prot' => '@aspass@'),
           array('name' => 'sucursal', 'prot' => '@aspass@'),
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['pivot_order_level'] = -1;
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_fechatrans => $l_fechatrans) {
           if (isset($this->array_total_fechatrans[$i_fechatrans])) {
               $this->comp_group[$i_fechatrans] = array();
           }
           foreach ($this->comp_label[1][$i_fechatrans] as $i_sucursal => $l_sucursal) {
               if (isset($this->array_total_sucursal[$i_fechatrans][$i_sucursal])) {
                   $this->comp_group[$i_fechatrans][$i_sucursal] = array();
               }
               foreach ($this->comp_label[2][$i_fechatrans][$i_sucursal] as $i_producto => $l_producto) {
                   if (isset($this->array_total_producto[$i_fechatrans][$i_sucursal][$i_producto])) {
                       $this->comp_group[$i_fechatrans][$i_sucursal][$i_producto] = array();
                   }
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_fechatrans;
       }
       elseif (1 == $level) {
           $return = $this->array_total_sucursal;
       }
       elseif (2 == $level) {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_detalleventa_matrix']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_datesales_sucursal_cuentaventa_producto("res");
      ...
      ksort($this->array_total_fechatrans);
      ksort($this->array_total_sucursal);
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_quantity, $sum_valor_siniva, $quebra_fechatrans, $quebra_sucursal, $quebra_producto, $quebra_fechatrans_orig, $quebra_sucursal_orig, $quebra_producto_orig)
   {
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "
      if (!isset($this->array_total_fechatrans[$quebra_fechatrans_orig]))
      {
         $this->array_total_fechatrans[$quebra_fechatrans_orig][0] = 1;
         $this->array_total_fechatrans[$quebra_fechatrans_orig][1] = $sum_quantity;
         $this->array_total_fechatrans[$quebra_fechatrans_orig][2] = $sum_valor_siniva;
         $this->array_total_fechatrans[$quebra_fechatrans_orig][3] = $quebra_fechatrans;
         $this->array_total_fechatrans[$quebra_fechatrans_orig][4] = $quebra_fechatrans_orig;
      }
      else
      {
         $this->array_total_fechatrans[$quebra_fechatrans_orig][0]++;
         $this->array_total_fechatrans[$quebra_fechatrans_orig][1] = bcadd($this->array_total_fechatrans[$quebra_fechatrans_orig][1], $sum_quantity, 10);
         $this->array_total_fechatrans[$quebra_fechatrans_orig][2] = bcadd($this->array_total_fechatrans[$quebra_fechatrans_orig][2], $sum_valor_siniva, 10);
      }
      //----- Sucursal
      if (!isset($this->array_total_sucursal[$quebra_fechatrans_orig][$quebra_sucursal_orig]))
      {
         $this->array_total_sucursal[$quebra_fechatrans_orig][$quebra_sucursal_orig][0] = 1;
         $this->array_total_sucursal[$quebra_fechatrans_orig][$quebra_sucursal_orig][1] = $sum_quantity;
         $this->array_total_sucursal[$quebra_fechatrans_orig][$quebra_sucursal_orig][2] = $sum_valor_siniva;
         $this->array_total_sucursal[$quebra_fechatrans_orig][$quebra_sucursal_orig][3] = $quebra_sucursal;
         $this->array_total_sucursal[$quebra_fechatrans_orig][$quebra_sucursal_orig][4] = $quebra_sucursal_orig;
      }
      else
      {
         $this->array_total_sucursal[$quebra_fechatrans_orig][$quebra_sucursal_orig][0]++;
         $this->array_total_sucursal[$quebra_fechatrans_orig][$quebra_sucursal_orig][1] = bcadd($this->array_total_sucursal[$quebra_fechatrans_orig][$quebra_sucursal_orig][1], $sum_quantity, 10);
         $this->array_total_sucursal[$quebra_fechatrans_orig][$quebra_sucursal_orig][2] = bcadd($this->array_total_sucursal[$quebra_fechatrans_orig][$quebra_sucursal_orig][2], $sum_valor_siniva, 10);
      }
      //----- Producto
      if (!isset($this->array_total_producto[$quebra_fechatrans_orig][$quebra_sucursal_orig][$quebra_producto_orig]))
      {
         $this->array_total_producto[$quebra_fechatrans_orig][$quebra_sucursal_orig][$quebra_producto_orig][0] = 1;
         $this->array_total_producto[$quebra_fechatrans_orig][$quebra_sucursal_orig][$quebra_producto_orig][1] = $sum_quantity;
         $this->array_total_producto[$quebra_fechatrans_orig][$quebra_sucursal_orig][$quebra_producto_orig][2] = $sum_valor_siniva;
         $this->array_total_producto[$quebra_fechatrans_orig][$quebra_sucursal_orig][$quebra_producto_orig][3] = $quebra_producto;
         $this->array_total_producto[$quebra_fechatrans_orig][$quebra_sucursal_orig][$quebra_producto_orig][4] = $quebra_producto_orig;
      }
      else
      {
         $this->array_total_producto[$quebra_fechatrans_orig][$quebra_sucursal_orig][$quebra_producto_orig][0]++;
         $this->array_total_producto[$quebra_fechatrans_orig][$quebra_sucursal_orig][$quebra_producto_orig][1] = bcadd($this->array_total_producto[$quebra_fechatrans_orig][$quebra_sucursal_orig][$quebra_producto_orig][1], $sum_quantity, 10);
         $this->array_total_producto[$quebra_fechatrans_orig][$quebra_sucursal_orig][$quebra_producto_orig][2] = bcadd($this->array_total_producto[$quebra_fechatrans_orig][$quebra_sucursal_orig][$quebra_producto_orig][2], $sum_valor_siniva, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'fechatrans');
     $campos_order = $this->Ini->Get_date_order_groupby("fechatrans", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'sucursal');
     $campos_order = $this->Ini->Get_date_order_groupby("sucursal", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'producto');
     $campos_order = $this->Ini->Get_date_order_groupby("producto", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->datesales_scgb_192 = $this->datesales;
            $this->datesales_scgb_203 = $this->datesales;
            $this->datesales_scgb_193 = $this->datesales;
            $this->datesales_scgb_195 = $this->datesales;
            $this->datesales_scgb_196 = $this->datesales;
            $this->datesales_scgb_197 = $this->datesales;
            $this->datesales_scgb_198 = $this->datesales;
            $this->datesales_scgb_199 = $this->datesales;
            $this->datesales_scgb_200 = $this->datesales;
            $this->datesales_scgb_201 = $this->datesales;
            $this->datesales_scgb_202 = $this->datesales;
            $this->datesales_scgb_204 = $this->datesales;
            $this->datesales_scgb_194 = $this->datesales;
            ...
            $Prefix_dat = $this->Ini->Get_Gb_prefix_date_format('datesales_sucursal_cuentaventa_producto', 'fechatrans');
            $TP_Time    = (in_array('fechatrans', $this->Ini->Cmp_Sql_Time)) ? "0000-00-00 " : "";
            $this->fechatrans_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->fechatrans, $Format_tst);
            $this->fechatrans = $this->Ini->GB_date_format($TP_Time . $this->fechatrans, $Format_tst, $Prefix_dat);
            $this->sucursal_orig = $this->sucursal;
            $this->producto_orig = $this->producto;
            $this->cuentaventa = $this->look_cuentaventa ;
            nmgp_Form_Num_Val($this->jugador, "", "", "0", "", "", "", "N:", "") ; 
            nmgp_Form_Num_Val($this->visitante, "", "", "0", "", "", "", "N:", "") ; 
            nmgp_Form_Num_Val($this->entrada, "", "", "0", "", "", "", "N:", "") ; 
            nmgp_Form_Num_Val($this->comida, "", "", "0", "", "", "", "N:", "") ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->quantity, $this->valor_siniva, $this->fechatrans, $this->sucursal, $this->producto, $this->fechatrans_orig,  $this->sucursal_orig,  $this->producto_orig);
            }
   }
//
