...
<?php
   ...
   $Ord_Cmp = new grid_cierre_egresos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_cierre_egresos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['ideg'] = "ideg";
   $tab_labels["ideg"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['labels']["ideg"])) ? $_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['labels']["ideg"] : "Ideg";
   $tab_ger_campos['tipoe'] = "on";
   $tab_def_campos['tipoe'] = "tipoe";
   $tab_labels["tipoe"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['labels']["tipoe"])) ? $_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['labels']["tipoe"] : "Tipoe";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['labels']["valor"] : "Valor";
   $tab_ger_campos['observacion'] = "on";
   $tab_def_campos['observacion'] = "observacion";
   $tab_labels["observacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['labels']["observacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['labels']["observacion"] : "Observacion";
   $tab_ger_campos['fecharegistro'] = "on";
   $tab_def_campos['fecharegistro'] = "fecharegistro";
   $tab_labels["fecharegistro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['labels']["fecharegistro"])) ? $_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['labels']["fecharegistro"] : "Fecharegistro";
   $tab_ger_campos['percod'] = "on";
   $tab_def_campos['percod'] = "percod";
   $tab_labels["percod"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['labels']["percod"])) ? $_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['labels']["percod"] : "Percod";
   $tab_ger_campos['documento'] = "on";
   $tab_def_campos['documento'] = "documento";
   $tab_labels["documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['labels']["documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['labels']["documento"] : "Documento";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_cierre_egresos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_cierre_egresos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
