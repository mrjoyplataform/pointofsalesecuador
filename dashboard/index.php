...
$_SESSION['scriptcase']['dashboard']['glo_nm_perfil']          = "conn_pos";
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['dashboard']['glo_nm_path_imag_temp'] . "/sc_apl_default_pointofsales.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['dashboard']['glo_nm_path_imag_temp'] . "/sc_apl_default_pointofsales.txt"));
    }
    if (isset($apl_def)) {
        ...
        if (isset($_COOKIE['sc_actual_lang_pointofsales'])) {
            $_SESSION['scriptcase']['dashboard']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_pointofsales'];
        }
    }
}
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['dashboard']['glo_nm_conexao'], $this->root . $this->path_prod, 'pointofsales', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['dashboard']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dashboard']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['dashboard']['glo_nm_conexao'], $this->root . $this->path_prod, 'pointofsales', 1, $this->force_db_utf8);
    }
    else {
...
class dashboard_control {
    ...
    function init()
    {
        ...
        {
            include_once(dirname(__FILE__) . '/dashboard_json.php');
        }
        if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "refreshWidget")
        {
            ob_start();
        ...
        $_SESSION['scriptcase']['dashboard_scinit']['dashboard']['dbifrm_widget17'] = rand(2, 10000);

        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard'] = array();

        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard']['chart_view_venta_dia'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard']['chart_view_sales_detail_group'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard']['chart_tarjetasmovim'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard']['chart_view_ventas_turno'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard']['chart_turnos'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard']['grid_promedio_satisfaccion_dia'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard']['grid_view_boletos_satisfaction_dia'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
...
<div class='grid-stack'>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="16" data-gs-width="12" data-gs-height="7"  data-gs-no-resize="1" data-gs-no-move="0" id="id-father-0">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-0">
                        <div class="widget-head widget-is-moveable" style="display:">
                            ...
                            <a href="#" class="maximize" onclick="maximizeWidget('0');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Venta por hora" /></a>
                            <h3 class="scContainerTitle">Venta por hora</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-' id="id-div-iframe-0"><iframe id="id-iframe-0" name="dbifrm_widget1" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('chart_view_venta_dia'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard"]["dbifrm_widget1"] ?>&under_dashboard=1&dashboard_app=dashboard&own_widget=dbifrm_widget1&compact_mode=0&remove_margin=0&remove_border=0" alt="60"></iframe></div>
                    </div>
                </div>
                ...
                <div  class="grid-stack-item" data-gs-x="2" data-gs-y="0" data-gs-width="2" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-2">
                ...
                <div  class="grid-stack-item" data-gs-x="4" data-gs-y="0" data-gs-width="2" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-3">
                ...
                <div  class="grid-stack-item" data-gs-x="6" data-gs-y="0" data-gs-width="2" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-4">
                ...
                <div  class="grid-stack-item" data-gs-x="8" data-gs-y="0" data-gs-width="2" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-5">
                ...
                <div  class="grid-stack-item" data-gs-x="10" data-gs-y="0" data-gs-width="2" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-6">
                ...
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="23" data-gs-width="11" data-gs-height="11"  data-gs-no-resize="1" data-gs-no-move="0" id="id-father-7">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-7">
                        <div class="widget-head widget-is-moveable" style="display:">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('7');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Venta por producto" /></a>
                            <h3 class="scContainerTitle">Venta por producto</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-' id="id-div-iframe-7"><iframe id="id-iframe-7" name="dbifrm_widget8" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('chart_view_sales_detail_group'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard"]["dbifrm_widget8"] ?>&under_dashboard=1&dashboard_app=dashboard&own_widget=dbifrm_widget8&compact_mode=1&remove_margin=1&remove_border=1" alt="60"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="34" data-gs-width="11" data-gs-height="7"  data-gs-no-resize="1" data-gs-no-move="0" id="id-father-8">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-8">
                        <div class="widget-head widget-is-moveable" style="display:">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('8');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="MAQUINAS ARCADE" /></a>
                            <h3 class="scContainerTitle">MAQUINAS ARCADE</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-' id="id-div-iframe-8"><iframe id="id-iframe-8" name="dbifrm_widget9" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('chart_tarjetasmovim'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard"]["dbifrm_widget9"] ?>&under_dashboard=1&dashboard_app=dashboard&own_widget=dbifrm_widget9&compact_mode=1&remove_margin=1&remove_border=1" alt="60"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="41" data-gs-width="11" data-gs-height="7"  data-gs-no-resize="1" data-gs-no-move="0" id="id-father-9">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-9">
                        <div class="widget-head widget-is-moveable" style="display:">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('9');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Ventas por empleado" /></a>
                            <h3 class="scContainerTitle">Ventas por empleado</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-' id="id-div-iframe-9"><iframe id="id-iframe-9" name="dbifrm_widget10" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('chart_view_ventas_turno'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard"]["dbifrm_widget10"] ?>&under_dashboard=1&dashboard_app=dashboard&own_widget=dbifrm_widget10&compact_mode=1&remove_margin=1&remove_border=1"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="48" data-gs-width="11" data-gs-height="7"  data-gs-no-resize="1" data-gs-no-move="0" id="id-father-10">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-10">
                        <div class="widget-head widget-is-moveable" style="display:">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('10');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="TURNOS DE CAJA" /></a>
                            <h3 class="scContainerTitle">TURNOS DE CAJA</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-' id="id-div-iframe-10"><iframe id="id-iframe-10" name="dbifrm_widget11" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('chart_turnos'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard"]["dbifrm_widget11"] ?>&under_dashboard=1&dashboard_app=dashboard&own_widget=dbifrm_widget11&compact_mode=1&remove_margin=1&remove_border=1" alt="60"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="55" data-gs-width="12" data-gs-height="10"  data-gs-no-resize="1" data-gs-no-move="0" id="id-father-11">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-11">
                        <div class="widget-head widget-is-moveable" style="display:">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('11');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Satisfaction del cliente" /></a>
                            <h3 class="scContainerTitle">Satisfaction del cliente</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-' id="id-div-iframe-11"><iframe id="id-iframe-11" name="dbifrm_widget12" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('grid_promedio_satisfaccion_dia'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard"]["dbifrm_widget12"] ?>&under_dashboard=1&dashboard_app=dashboard&own_widget=dbifrm_widget12&compact_mode=1&remove_margin=1&remove_border=1"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="6" data-gs-width="12" data-gs-height="10"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-12">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-12">
                        <div class="widget-head" style="display:">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('12');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Satisfaction del cliente" /></a>
                            <h3 class="scContainerTitle">Satisfaction del cliente</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-' id="id-div-iframe-12"><iframe id="id-iframe-12" name="dbifrm_widget13" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('grid_view_boletos_satisfaction_dia'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard"]["dbifrm_widget13"] ?>&under_dashboard=1&dashboard_app=dashboard&own_widget=dbifrm_widget13&compact_mode=1&remove_margin=1&remove_border=1" alt="300"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="3" data-gs-width="3" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-13">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-13">
                        <div class="widget-head" style="display:none">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('13');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Venta Semana" /></a>
                            <h3 class="scContainerTitle">Venta Semana</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none scContainerIndexMoldura scContainerIndexMoldura_widget14' style="height: 100%" id="id-div-iframe-13"><?php echo $this->getIndexContent_widget14(); ?></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="6" data-gs-y="3" data-gs-width="3" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-14">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-14">
                        <div class="widget-head" style="display:none">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('14');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Venta Mes" /></a>
                            <h3 class="scContainerTitle">Venta Mes</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none scContainerIndexMoldura scContainerIndexMoldura_widget15' style="height: 100%" id="id-div-iframe-14"><?php echo $this->getIndexContent_widget15(); ?></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="9" data-gs-y="3" data-gs-width="3" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-15">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-15">
                        <div class="widget-head" style="display:none">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('15');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Clientes Mes" /></a>
                            <h3 class="scContainerTitle">Clientes Mes</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none scContainerIndexMoldura scContainerIndexMoldura_widget16' style="height: 100%" id="id-div-iframe-15"><?php echo $this->getIndexContent_widget16(); ?></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="3" data-gs-y="3" data-gs-width="3" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-16">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-16">
                        <div class="widget-head" style="display:none">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('16');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="# Clientes Semana %" /></a>
                            <h3 class="scContainerTitle"># Clientes Semana %</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none scContainerIndexMoldura scContainerIndexMoldura_widget17' style="height: 100%" id="id-div-iframe-16"><?php echo $this->getIndexContent_widget17(); ?></div>
                    </div>
                </div></div>
...
<?php
    ...
    function getIndexContentData_widget2() {
        ...
        {
            $sSql = "SELECT SUM(clientes) FROM view_boletos_total_dia";
        }
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget2"><img src="{$this->Ini->path_imag_cab}/sys__NM__btn__NM__icono_persona.png" /><br />Clientes Adentro</span></div>
...
IDXHTML;
    ...
    function getIndexContentData_widget3() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
        {
            $sSql = "SELECT SUM(jugadores) FROM view_boletos_total_dia";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
        {
            $sSql = "SELECT SUM(\"jugadores\") FROM view_boletos_total_dia";
...
IDXHTML;
    ...
    function getIndexContentData_widget4() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
        {
            $sSql = "SELECT SUM(visitantes) FROM view_boletos_total_dia";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
        {
            $sSql = "SELECT SUM(\"visitantes\") FROM view_boletos_total_dia";
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        ...
        <div class="clearfix"><span style="clear: both" class="{$this->indexData['index_class']} {$this->indexData['index_class']}Size {$this->indexData['index_class']}_widget4 {$this->indexData['index_class']}Size_widget4">{$this->indexData['new_metric_formatted']}</span></div>
    </div>
</div>
...
IDXHTML;
    ...
    function getIndexContentData_widget5() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
        {
            $sSql = "SELECT SUM(valor) FROM view_venta_dia";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
        {
            $sSql = "SELECT SUM(\"valor\") FROM view_venta_dia";
...
IDXHTML;
    ...
    function getIndexContentData_widget6() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
        {
            $sSql = "SELECT SUM(transacciones) FROM view_venta_dia";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
        {
            $sSql = "SELECT SUM(\"transacciones\") FROM view_venta_dia";
...
IDXHTML;
    ...
    function getIndexContentData_widget7() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
        {
            $sSql = "SELECT AVG(promedioventa) FROM view_venta_dia";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
        {
            $sSql = "SELECT AVG(\"promedioventa\") FROM view_venta_dia";
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        ...
        <div class="clearfix"><span style="clear: both" class="{$this->indexData['index_class']} {$this->indexData['index_class']}Size {$this->indexData['index_class']}_widget7 {$this->indexData['index_class']}Size_widget7">{$this->indexData['new_metric_formatted']}</span></div>
    </div>
</div>
...
IDXHTML;
    ...
    function getIndexContent_widget14() {
        $bResult = $this->getIndexContentData_widget14();

        if (true !== $bResult) {
            return $bResult;
        }
        else {
            return $this->getIndexContentHtml_widget14();
        }
    } // getIndexContent_widget14

    function getIndexContentData_widget14() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
        {
            $sSql = "SELECT SUM(total), DATEPART('ww', datesales) FROM sales GROUP BY DATEPART('ww', datesales) ORDER BY DATEPART('ww', datesales) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
        {
            $sSql = "SELECT SUM(\"total\"), DATEPART(WEEK, \"datesales\") FROM sales GROUP BY DATEPART(WEEK, \"datesales\") ORDER BY DATEPART(WEEK, \"datesales\") DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
        {
            $sSql = "SELECT SUM(\"total\"), TO_CHAR(TO_DATE(\"datesales\", 'yyyy-mm-dd hh24:mi:ss'), 'WW') FROM sales GROUP BY TO_CHAR(TO_DATE(\"datesales\", 'yyyy-mm-dd hh24:mi:ss'), 'WW') ORDER BY TO_CHAR(TO_DATE(\"datesales\", 'yyyy-mm-dd hh24:mi:ss'), 'WW') DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
        {
            $sSql = "SELECT SUM(\"total\"), EXTRACT(WEEK FROM \"datesales\") FROM sales GROUP BY 2 ORDER BY EXTRACT(WEEK FROM \"datesales\") DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
        {
            $sSql = "SELECT SUM(`total`), WEEKOFYEAR(`datesales`) FROM sales GROUP BY 2 ORDER BY WEEKOFYEAR(`datesales`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite))
        {
            $sSql = "SELECT SUM(`total`), CAST((strftime('%W', `datesales`) + 1) AS INTEGER) FROM sales GROUP BY 2 ORDER BY CAST((strftime('%W', `datesales`) + 1) AS INTEGER) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
        {
            $sSql = "SELECT SUM(\"total\"), EXTRACT(WEEK FROM \"datesales\") FROM sales GROUP BY 2 ORDER BY EXTRACT(WEEK FROM \"datesales\") DESC";
        ...
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_db2))
        {
            $sSql = "SELECT SUM(total), WEEK(datesales) FROM sales GROUP BY WEEK(datesales) ORDER BY WEEK(datesales) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
        {
            $sSql = "SELECT SUM(total), DATEPART(WEEK, datesales) FROM sales GROUP BY DATEPART(WEEK, datesales) ORDER BY DATEPART(WEEK, datesales) DESC";
        ...
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
        {
            $sSql = "SELECT SUM(total), CAST(1 + (((CAST(datesales AS DATE) - MDY(1, 1, YEAR(datesales))) +  WEEKDAY(MDY(1, 1, YEAR(datesales)))) / 7) as INT) FROM sales GROUP BY 2 ORDER BY CAST(1 + (((CAST(datesales AS DATE) - MDY(1, 1, YEAR(datesales))) +  WEEKDAY(MDY(1, 1, YEAR(datesales)))) / 7) as INT) DESC";
        }
        else 
        {
            $sSql = "SELECT SUM(total), WEEK(datesales) FROM sales GROUP BY 2 ORDER BY WEEK(datesales) DESC";
        }
        ...
        $this->indexData['new_metric']    = $oRs->fields[0];
        $this->indexData['new_dimension'] = $this->formatIndexDimension_widget14($oRs->fields[1]);
        ...
        if ($oRs->EOF) {
            ...
            $this->indexData['old_dimension'] = $this->formatIndexDimension_widget14($oRs->fields[1]);
        }
        ...
        if ($this->indexData['has_old_data']) {
            ...
            $this->indexData['new_metric_formatted'] = $this->formatIndexMetric_widget14($this->indexData['new_metric']);
            $this->indexData['old_metric_formatted'] = $this->formatIndexMetric_widget14($this->indexData['old_metric']);
            $this->indexData['difference_formatted'] = $this->formatIndexMetric_widget14($this->indexData['difference']);
        ...
        return true;
    } // getIndexContentData_widget14

    function getIndexContentHtml_widget14() {
        if ($this->indexData['has_old_data']) {
            if ($this->indexData['new_metric'] > $this->indexData['old_metric']) {
                $this->indexData['icon']        = '<span class="glyphicon ' . ('' == $this->index_icon_pos ? 'glyphicon-triangle-top' : $this->index_icon_pos) . ' scContainerIndexPosIcon" aria-hidden="true"></span>';
                $this->indexData['index_class'] = 'scContainerIndexPosText';
        ...
        $this->indexData['new_metric_value'] = '<span class="' . $this->indexData['new_metric_class'] . ' ' . $this->indexData['new_metric_class'] . '_widget14">' . $this->indexData['new_metric_formatted'] . '</span>';

        $html = <<<IDXHTML
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget14">Venta % Semana</span></div>
        <div class="clearfix"><span style="float: right"><span class="scContainerIndexDimension scContainerIndexDimension_widget14">{$this->indexData['new_dimension']}{$this->indexData['new_metric_sep']}</span>{$this->indexData['new_metric_value']}</span></div>
        <div class="clearfix"><span class="{$this->indexData['index_class']}Size {$this->indexData['index_class']}Size_widget14"><span class="{$this->indexData['index_class']} {$this->indexData['index_class']}_widget14">{$this->indexData['percentage_formatted']}</span> {$this->indexData['icon']}</span></div>
...
IDXHTML;
        ...
        if ($this->indexData['has_old_data']) {
            ...
            $html .= <<<IDXHTML
        <div class="clearfix"><span style="float: right"><span class="scContainerIndexDimension scContainerIndexDimension_widget14">{$this->indexData['old_dimension']}:</span> <span class="{$this->indexData['old_metric_class']} {$this->indexData['old_metric_class']}_widget14">{$this->indexData['old_metric_formatted']}</span></span></div>
...
IDXHTML;
        ...
        return $html;
    } // getIndexContentHtml_widget14

    function formatIndexDimension_widget14($value) {
        $value = "{$this->Ini->Nm_lang['lang_othr_valueWEEK']}{$value}";

        return $value;
    } // formatIndexDimension_widget14
...
IDXHTML;
    ...
    function getIndexContentData_widget17() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
        {
            $sSql = "SELECT SUM(clientes), DATEPART('ww', fecha) FROM view_boletos_total GROUP BY DATEPART('ww', fecha) ORDER BY DATEPART('ww', fecha) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
        {
            $sSql = "SELECT SUM(\"clientes\"), DATEPART(WEEK, \"fecha\") FROM view_boletos_total GROUP BY DATEPART(WEEK, \"fecha\") ORDER BY DATEPART(WEEK, \"fecha\") DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
        {
            $sSql = "SELECT SUM(\"clientes\"), TO_CHAR(TO_DATE(\"fecha\", 'yyyy-mm-dd hh24:mi:ss'), 'WW') FROM view_boletos_total GROUP BY TO_CHAR(TO_DATE(\"fecha\", 'yyyy-mm-dd hh24:mi:ss'), 'WW') ORDER BY TO_CHAR(TO_DATE(\"fecha\", 'yyyy-mm-dd hh24:mi:ss'), 'WW') DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
        {
            $sSql = "SELECT SUM(\"clientes\"), EXTRACT(WEEK FROM \"fecha\") FROM view_boletos_total GROUP BY 2 ORDER BY EXTRACT(WEEK FROM \"fecha\") DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
        {
            $sSql = "SELECT SUM(`clientes`), WEEKOFYEAR(`fecha`) FROM view_boletos_total GROUP BY 2 ORDER BY WEEKOFYEAR(`fecha`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite))
        {
            $sSql = "SELECT SUM(`clientes`), CAST((strftime('%W', `fecha`) + 1) AS INTEGER) FROM view_boletos_total GROUP BY 2 ORDER BY CAST((strftime('%W', `fecha`) + 1) AS INTEGER) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
        {
            $sSql = "SELECT SUM(\"clientes\"), EXTRACT(WEEK FROM \"fecha\") FROM view_boletos_total GROUP BY 2 ORDER BY EXTRACT(WEEK FROM \"fecha\") DESC";
        ...
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_db2))
        {
            $sSql = "SELECT SUM(clientes), WEEK(fecha) FROM view_boletos_total GROUP BY WEEK(fecha) ORDER BY WEEK(fecha) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
        {
            $sSql = "SELECT SUM(clientes), DATEPART(WEEK, fecha) FROM view_boletos_total GROUP BY DATEPART(WEEK, fecha) ORDER BY DATEPART(WEEK, fecha) DESC";
        ...
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
        {
            $sSql = "SELECT SUM(clientes), CAST(1 + (((CAST(fecha AS DATE) - MDY(1, 1, YEAR(fecha))) +  WEEKDAY(MDY(1, 1, YEAR(fecha)))) / 7) as INT) FROM view_boletos_total GROUP BY 2 ORDER BY CAST(1 + (((CAST(fecha AS DATE) - MDY(1, 1, YEAR(fecha))) +  WEEKDAY(MDY(1, 1, YEAR(fecha)))) / 7) as INT) DESC";
        }
        else 
        {
            $sSql = "SELECT SUM(clientes), WEEK(fecha) FROM view_boletos_total GROUP BY 2 ORDER BY WEEK(fecha) DESC";
        }
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget17"># Clientes Semana %</span></div>
