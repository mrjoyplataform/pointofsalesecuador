<?php
@session_start() ;
$_SESSION['scriptcase']['grid_maepro']['sc_process_barr'] = true;
require_once('../grid_maepro/index.php');
unset($_SESSION['scriptcase']['grid_maepro']['sc_process_barr']);
$ExportCtrl = new grid_maepro_export_control;
$ExportCtrl->Export_barr();

class grid_maepro_export_control
{
