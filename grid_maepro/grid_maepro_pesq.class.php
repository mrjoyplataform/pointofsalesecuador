...
class grid_maepro_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_maepro_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_maepro_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_maepro_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_cve201')
      {
          $cve201 = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_cve201($cve201);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_codprod01')
      {
          $codprod01 = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_codprod01($codprod01);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_desprod01')
      {
          $desprod01 = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_desprod01($desprod01);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_cve101')
      {
          $cve101 = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_cve101($cve101);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   {
      $cve201 = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $cve201);
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "fecape01";$Nm_datas[] = "fecape01";$Nm_datas[] = "fecult01";$Nm_datas[] = "fecult01";$Nm_datas[] = "fecvta01";$Nm_datas[] = "fecvta01";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> maepro</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_maepro/grid_maepro_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_maepro_ajax_search.js"></script>
 <script type="text/javascript" src="grid_maepro_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_maepro_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_maepro']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_maepro']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_cve201_cond#NMF#' + search_get_sel_txt('SC_cve201_cond') + '@NMF@';
  str_out += 'SC_cve201#NMF#' + search_get_text('SC_cve201') + '@NMF@';
  str_out += 'id_ac_cve201#NMF#' + search_get_text('id_ac_cve201') + '@NMF@';
  str_out += 'SC_codprod01_cond#NMF#' + search_get_sel_txt('SC_codprod01_cond') + '@NMF@';
  str_out += 'SC_codprod01#NMF#' + search_get_text('SC_codprod01') + '@NMF@';
  str_out += 'id_ac_codprod01#NMF#' + search_get_text('id_ac_codprod01') + '@NMF@';
  str_out += 'SC_desprod01_cond#NMF#' + search_get_sel_txt('SC_desprod01_cond') + '@NMF@';
  str_out += 'SC_desprod01#NMF#' + search_get_text('SC_desprod01') + '@NMF@';
  str_out += 'id_ac_desprod01#NMF#' + search_get_text('id_ac_desprod01') + '@NMF@';
  str_out += 'SC_cve101_cond#NMF#' + search_get_sel_txt('SC_cve101_cond') + '@NMF@';
  str_out += 'SC_cve101#NMF#' + search_get_text('SC_cve101') + '@NMF@';
  str_out += 'id_ac_cve101#NMF#' + search_get_text('id_ac_cve101') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_codprod01").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_codprod01").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_codprod01",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_codprod01").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_codprod01").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_desprod01").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_desprod01").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_desprod01",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_desprod01").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_desprod01").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_cve101").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_cve101").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_cve101",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_cve101").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_cve201").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_cve201").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_cve201",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> maepro</div>
...
<?php
   ...
   {
      global 
             $cve201_cond, $cve201, $cve201_autocomp,
             $codprod01_cond, $codprod01, $codprod01_autocomp,
             $desprod01_cond, $desprod01, $desprod01_autocomp,
             $cve101_cond, $cve101, $cve101_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $cve201 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']['cve201']; 
          $cve201_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']['cve201_cond']; 
          $codprod01 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']['codprod01']; 
          $codprod01_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']['codprod01_cond']; 
          $desprod01 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']['desprod01']; 
          $desprod01_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']['desprod01_cond']; 
          $cve101 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']['cve101']; 
          $cve101_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']['cve101_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']['NM_operador']; 
      } 
      if (!isset($cve201_cond) || empty($cve201_cond))
      {
         $cve201_cond = "qp";
      }
      if (!isset($codprod01_cond) || empty($codprod01_cond))
      {
         $codprod01_cond = "qp";
      }
      if (!isset($desprod01_cond) || empty($desprod01_cond))
      {
         $desprod01_cond = "qp";
      }
      if (!isset($cve101_cond) || empty($cve101_cond))
      {
         $cve101_cond = "qp";
      }
      ...
      $str_hide_cve201 = (in_array($cve201_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_codprod01 = (in_array($codprod01_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_desprod01 = (in_array($desprod01_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cve101 = (in_array($cve101_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($cve201) || $cve201 == "")
      {
          $cve201 = "";
      }
      if (isset($cve201) && !empty($cve201))
      {
         $tmp_pos = strpos($cve201, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $cve201 = substr($cve201, 0, $tmp_pos);
         }
      }
      if (!isset($codprod01) || $codprod01 == "")
      {
          $codprod01 = "";
      }
      if (isset($codprod01) && !empty($codprod01))
      {
         $tmp_pos = strpos($codprod01, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $codprod01 = substr($codprod01, 0, $tmp_pos);
         }
      }
      if (!isset($desprod01) || $desprod01 == "")
      {
          $desprod01 = "";
      }
      if (isset($desprod01) && !empty($desprod01))
      {
         $tmp_pos = strpos($desprod01, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $desprod01 = substr($desprod01, 0, $tmp_pos);
         }
      }
      if (!isset($cve101) || $cve101 == "")
      {
          $cve101 = "";
      }
      if (isset($cve101) && !empty($cve101))
      {
         $tmp_pos = strpos($cve101, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $cve101 = substr($cve101, 0, $tmp_pos);
         }
      }
?>
 <?php
...
?>
<?php
   if (is_file("grid_maepro_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_maepro']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_maepro']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_cve201_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['cve201'])) ? $this->New_label['cve201'] : "Cve 201"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_cve201_cond" name="cve201_cond" onChange="nm_campos_between(document.getElementById('id_vis_cve201'), this, 'cve201')">
       <OPTION value="qp" <?php if ("qp" == $cve201_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $cve201_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cve201_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cve201" <?php echo $str_hide_cve201?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['cve201'])) ? $this->New_label['cve201'] : "Cve 201";
 $nmgp_tab_label .= "cve201?#?" . $SC_Label . "?@?";
...
<?php
   ...
   { 
      ...
      {
            nmgp_Form_Num_Val($cve201, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $cve201;
      }
?>
<INPUT  type="text" id="SC_cve201" name="cve201" value="<?php echo NM_encode_input($cve201) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cve201" name="cve201_autocomp" size="10"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD id='SC_codprod01_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['codprod01'])) ? $this->New_label['codprod01'] : "Codprod 01"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_codprod01_cond" name="codprod01_cond" onChange="nm_campos_between(document.getElementById('id_vis_codprod01'), this, 'codprod01')">
       <OPTION value="qp" <?php if ("qp" == $codprod01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $codprod01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $codprod01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $codprod01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_codprod01" <?php echo $str_hide_codprod01?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['codprod01'])) ? $this->New_label['codprod01'] : "Codprod 01";
 $nmgp_tab_label .= "codprod01?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $codprod01;
      }
?>
<INPUT  type="text" id="SC_codprod01" name="codprod01" value="<?php echo NM_encode_input($codprod01) ?>"  size=50 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_codprod01" name="codprod01_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_desprod01_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['desprod01'])) ? $this->New_label['desprod01'] : "Desprod 01"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_desprod01_cond" name="desprod01_cond" onChange="nm_campos_between(document.getElementById('id_vis_desprod01'), this, 'desprod01')">
       <OPTION value="qp" <?php if ("qp" == $desprod01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $desprod01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $desprod01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $desprod01_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_desprod01" <?php echo $str_hide_desprod01?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['desprod01'])) ? $this->New_label['desprod01'] : "Desprod 01";
 $nmgp_tab_label .= "desprod01?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $desprod01;
      }
?>
<INPUT  type="text" id="SC_desprod01" name="desprod01" value="<?php echo NM_encode_input($desprod01) ?>"  size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_desprod01" name="desprod01_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_cve101_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['cve101'])) ? $this->New_label['cve101'] : "Cve 101"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_cve101_cond" name="cve101_cond" onChange="nm_campos_between(document.getElementById('id_vis_cve101'), this, 'cve101')">
       <OPTION value="qp" <?php if ("qp" == $cve101_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $cve101_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cve101_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $cve101_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cve101" <?php echo $str_hide_cve101?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['cve101'])) ? $this->New_label['cve101'] : "Cve 101";
 $nmgp_tab_label .= "cve101?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $cve101;
      }
?>
<INPUT  type="text" id="SC_cve101" name="cve101" value="<?php echo NM_encode_input($cve101) ?>"  size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cve101" name="cve101_autocomp" size="1"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.cve201_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_cve201'), document.F1.cve201_cond, 'cve201');
   document.F1.cve201.value = "";
   document.F1.cve201_autocomp.value = "";
   document.F1.codprod01_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_codprod01'), document.F1.codprod01_cond, 'codprod01');
   document.F1.codprod01.value = "";
   document.F1.codprod01_autocomp.value = "";
   document.F1.desprod01_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_desprod01'), document.F1.desprod01_cond, 'desprod01');
   document.F1.desprod01.value = "";
   document.F1.desprod01_autocomp.value = "";
   document.F1.cve101_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_cve101'), document.F1.cve101_cond, 'cve101');
   document.F1.cve101.value = "";
   document.F1.cve101_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_cve201_cond'] = 'cond';
      $tp_fields['SC_cve201'] = 'text_aut';
      $tp_fields['id_ac_cve201'] = 'text_aut';
      $tp_fields['SC_codprod01_cond'] = 'cond';
      $tp_fields['SC_codprod01'] = 'text_aut';
      $tp_fields['id_ac_codprod01'] = 'text_aut';
      $tp_fields['SC_desprod01_cond'] = 'cond';
      $tp_fields['SC_desprod01'] = 'text_aut';
      $tp_fields['id_ac_desprod01'] = 'text_aut';
      $tp_fields['SC_cve101_cond'] = 'cond';
      $tp_fields['SC_cve101'] = 'text_aut';
      $tp_fields['id_ac_cve101'] = 'text_aut';
   ...
   {
      global $cve201_cond, $cve201, $cve201_autocomp,
             $codprod01_cond, $codprod01, $codprod01_autocomp,
             $desprod01_cond, $desprod01, $desprod01_autocomp,
             $cve101_cond, $cve101, $cve101_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($cve201_autocomp) && empty($cve201))
      {
          $cve201 = $cve201_autocomp;
      }
      if (!empty($codprod01_autocomp) && empty($codprod01))
      {
          $codprod01 = $codprod01_autocomp;
      }
      if (!empty($desprod01_autocomp) && empty($desprod01))
      {
          $desprod01 = $desprod01_autocomp;
      }
      if (!empty($cve101_autocomp) && empty($cve101))
      {
          $cve101 = $cve101_autocomp;
      }
      $cve201_cond_salva = $cve201_cond; 
      if (!isset($cve201_input_2) || $cve201_input_2 == "")
      {
          $cve201_input_2 = $cve201;
      }
      $codprod01_cond_salva = $codprod01_cond; 
      if (!isset($codprod01_input_2) || $codprod01_input_2 == "")
      {
          $codprod01_input_2 = $codprod01;
      }
      $desprod01_cond_salva = $desprod01_cond; 
      if (!isset($desprod01_input_2) || $desprod01_input_2 == "")
      {
          $desprod01_input_2 = $desprod01;
      }
      $cve101_cond_salva = $cve101_cond; 
      if (!isset($cve101_input_2) || $cve101_input_2 == "")
      {
          $cve101_input_2 = $cve101;
      }
      if ($cve201_cond != "in")
      {
          nm_limpa_numero($cve201, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']['cve201'] = $cve201; 
      if (is_array($cve201) && !empty($cve201))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['Grid_search'][$I_Grid]['val'][0] = $cve201;
      }
      elseif ($cve201_cond_salva == "nu" || $cve201_cond_salva == "nn" || $cve201_cond_salva == "ep" || $cve201_cond_salva == "ne" || !empty($cve201))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['Grid_search'][$I_Grid]['val'][0][0] = $cve201;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']['cve201_cond'] = $cve201_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['Grid_search'][$I_Grid]['cmp'] = "cve201"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['Grid_search'][$I_Grid]['opc'] = $cve201_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq']['cve201'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']['codprod01'] = $codprod01; 
      if (is_array($codprod01) && !empty($codprod01))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['Grid_search'][$I_Grid]['val'][0] = $codprod01;
      }
      elseif ($codprod01_cond_salva == "nu" || $codprod01_cond_salva == "nn" || $codprod01_cond_salva == "ep" || $codprod01_cond_salva == "ne" || !empty($codprod01))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['Grid_search'][$I_Grid]['val'][0][0] = $codprod01;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']['codprod01_cond'] = $codprod01_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['Grid_search'][$I_Grid]['cmp'] = "codprod01"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['Grid_search'][$I_Grid]['opc'] = $codprod01_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq']['codprod01'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']['desprod01'] = $desprod01; 
      if (is_array($desprod01) && !empty($desprod01))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['Grid_search'][$I_Grid]['val'][0] = $desprod01;
      }
      elseif ($desprod01_cond_salva == "nu" || $desprod01_cond_salva == "nn" || $desprod01_cond_salva == "ep" || $desprod01_cond_salva == "ne" || !empty($desprod01))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['Grid_search'][$I_Grid]['val'][0][0] = $desprod01;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']['desprod01_cond'] = $desprod01_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['Grid_search'][$I_Grid]['cmp'] = "desprod01"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['Grid_search'][$I_Grid]['opc'] = $desprod01_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq']['desprod01'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']['cve101'] = $cve101; 
      if (is_array($cve101) && !empty($cve101))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['Grid_search'][$I_Grid]['val'][0] = $cve101;
      }
      elseif ($cve101_cond_salva == "nu" || $cve101_cond_salva == "nn" || $cve101_cond_salva == "ep" || $cve101_cond_salva == "ne" || !empty($cve101))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['Grid_search'][$I_Grid]['val'][0][0] = $cve101;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']['cve101_cond'] = $cve101_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['Grid_search'][$I_Grid]['cmp'] = "cve101"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['Grid_search'][$I_Grid]['opc'] = $cve101_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['grid_pesq']['cve101'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca'] = $Temp_Busca;
      }
      if ($cve201_cond != "in" && $cve201_cond != "bw" && !empty($cve201) && !is_numeric($cve201))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Cve 201";
      }
      if ($cve201_cond == "bw" && ((!empty($cve201) && !is_numeric($cve201)) || (!empty($cve201_input_2) && !is_numeric($cve201_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Cve 201";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['cve201'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['cve201'] = $cmp1;
      }
      else
      {
          $cmp1 = $cve201;
    ...
    if ($codprod01 != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['codprod01'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['codprod01'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['codprod01'] = $codprod01;
      }
      $nmgp_def_dados = array();
    if ($desprod01 != '') {
      $desprod01_look = substr($this->Db->qstr($desprod01), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['desprod01'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['desprod01'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['desprod01'] = $desprod01;
      }
      $nmgp_def_dados = array();
    if ($cve101 != '') {
      $cve101_look = substr($this->Db->qstr($cve101), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['cve101'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['cve101'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['cve101'] = $cve101;
      }

      //----- $cve201
      $this->Date_part = false;
      if (isset($cve201) || $cve201_cond == "nu" || $cve201_cond == "nn" || $cve201_cond == "ep" || $cve201_cond == "ne")
      {
         $this->monta_condicao("cve201", $cve201_cond, $cve201, "", "cve201");
      }

      //----- $codprod01
      $this->Date_part = false;
      if (isset($codprod01) || $codprod01_cond == "nu" || $codprod01_cond == "nn" || $codprod01_cond == "ep" || $codprod01_cond == "ne")
      {
         $this->monta_condicao("codprod01", $codprod01_cond, $codprod01, "", "codprod01");
      }

      //----- $desprod01
      $this->Date_part = false;
      if (isset($desprod01) || $desprod01_cond == "nu" || $desprod01_cond == "nn" || $desprod01_cond == "ep" || $desprod01_cond == "ne")
      {
         $this->monta_condicao("desprod01", $desprod01_cond, $desprod01, "", "desprod01");
      }

      //----- $cve101
      $this->Date_part = false;
      if (isset($cve101) || $cve101_cond == "nu" || $cve101_cond == "nn" || $cve101_cond == "ep" || $cve101_cond == "ne")
      {
         $this->monta_condicao("cve101", $cve101_cond, $cve101, "", "cve101");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maepro']['cond_pesq'] .= $this->NM_operador;
