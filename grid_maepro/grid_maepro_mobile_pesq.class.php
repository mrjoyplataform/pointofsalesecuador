...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cve201_cond" name="cve201_cond" onChange="nm_campos_between(document.getElementById('id_vis_cve201'), this, 'cve201')">
      ...
      <br><span id="id_hide_cve201"  <?php echo $str_hide_cve201?>><?php
      if ($cve201 != "")
      {
      $cve201_look = substr($this->Db->qstr($cve201), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_codprod01_cond" name="codprod01_cond" onChange="nm_campos_between(document.getElementById('id_vis_codprod01'), this, 'codprod01')">
      ...
      <br><span id="id_hide_codprod01"  <?php echo $str_hide_codprod01?>><?php
      if ($codprod01 != "")
      {
      $codprod01_look = substr($this->Db->qstr($codprod01), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_desprod01_cond" name="desprod01_cond" onChange="nm_campos_between(document.getElementById('id_vis_desprod01'), this, 'desprod01')">
      ...
      <br><span id="id_hide_desprod01"  <?php echo $str_hide_desprod01?>><?php
      if ($desprod01 != "")
      {
      $desprod01_look = substr($this->Db->qstr($desprod01), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_cve101_cond" name="cve101_cond" onChange="nm_campos_between(document.getElementById('id_vis_cve101'), this, 'cve101')">
      ...
      <br><span id="id_hide_cve101"  <?php echo $str_hide_cve101?>><?php
      if ($cve101 != "")
      {
      $cve101_look = substr($this->Db->qstr($cve101), 1, -1); 
      $nmgp_def_dados = array(); 
