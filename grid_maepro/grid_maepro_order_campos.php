...
<?php
   ...
   $Ord_Cmp = new grid_maepro_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_maepro_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_maepro']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_maepro']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['codprod01'] = "codprod01";
   $tab_labels["codprod01"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maepro']['labels']["codprod01"])) ? $_SESSION['sc_session'][$sc_init]['grid_maepro']['labels']["codprod01"] : "Codprod 01";
   $tab_ger_campos['desprod01'] = "on";
   $tab_def_campos['desprod01'] = "desprod01";
   $tab_labels["desprod01"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maepro']['labels']["desprod01"])) ? $_SESSION['sc_session'][$sc_init]['grid_maepro']['labels']["desprod01"] : "Desprod 01";
   $tab_ger_campos['cve101'] = "on";
   $tab_def_campos['cve101'] = "cve101";
   $tab_labels["cve101"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maepro']['labels']["cve101"])) ? $_SESSION['sc_session'][$sc_init]['grid_maepro']['labels']["cve101"] : "Cve 101";
   $tab_ger_campos['cve201'] = "on";
   $tab_def_campos['cve201'] = "cve201";
   $tab_labels["cve201"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maepro']['labels']["cve201"])) ? $_SESSION['sc_session'][$sc_init]['grid_maepro']['labels']["cve201"] : "Cve 201";
   $tab_ger_campos['unidmed01'] = "on";
   $tab_def_campos['unidmed01'] = "unidmed01";
   $tab_labels["unidmed01"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maepro']['labels']["unidmed01"])) ? $_SESSION['sc_session'][$sc_init]['grid_maepro']['labels']["unidmed01"] : "Unidmed 01";
   $tab_ger_campos['cantmin01'] = "on";
   $tab_def_campos['cantmin01'] = "cantmin01";
   $tab_labels["cantmin01"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maepro']['labels']["cantmin01"])) ? $_SESSION['sc_session'][$sc_init]['grid_maepro']['labels']["cantmin01"] : "Cantmin 01";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_maepro']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_maepro']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_maepro']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_maepro']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_maepro']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_maepro']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_maepro']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_maepro']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_maepro']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_maepro']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_maepro']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_maepro']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_maepro_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_maepro']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_maepro']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_maepro']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_maepro']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_maepro']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
