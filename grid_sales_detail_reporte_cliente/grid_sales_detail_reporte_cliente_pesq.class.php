...
class grid_sales_detail_reporte_cliente_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_sales_detail_reporte_cliente_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_sales_detail_reporte_cliente_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_sales_detail_reporte_cliente_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> sales_detail</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_sales_detail_reporte_cliente/grid_sales_detail_reporte_cliente_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_sales_detail_reporte_cliente_ajax_search.js"></script>
 <script type="text/javascript" src="grid_sales_detail_reporte_cliente_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_sales_detail_reporte_cliente_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_sales_detail_reporte_cliente']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_sales_detail_reporte_cliente']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_fechatrans_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_fechatrans_dia').value + '/';
          var_dt_ini += document.getElementById('SC_fechatrans_mes').value + '/';
          var_dt_ini += document.getElementById('SC_fechatrans_ano').value;
          document.getElementById('sc_fechatrans_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_fechatrans_dia').value = aParts[0];
          document.getElementById('SC_fechatrans_mes').value = aParts[1];
          document.getElementById('SC_fechatrans_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_fechatrans_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_fechatrans_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_fechatrans_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_fechatrans_input_2_ano').value;
          document.getElementById('sc_fechatrans_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_fechatrans_input_2_dia').value = aParts[0];
          document.getElementById('SC_fechatrans_input_2_mes').value = aParts[1];
          document.getElementById('SC_fechatrans_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_fechatrans_cond#NMF#' + search_get_sel_txt('SC_fechatrans_cond') + '@NMF@';
  opc = search_get_sel_txt('SC_fechatrans_cond');
  if (opc.substring(0, 3) != "bi_")
  {
      str_out += 'SC_fechatrans_dia#NMF#' + search_get_sel_txt('SC_fechatrans_dia') + '@NMF@';
      str_out += 'SC_fechatrans_mes#NMF#' + search_get_sel_txt('SC_fechatrans_mes') + '@NMF@';
      str_out += 'SC_fechatrans_ano#NMF#' + search_get_sel_txt('SC_fechatrans_ano') + '@NMF@';
      str_out += 'SC_fechatrans_input_2_dia#NMF#' + search_get_sel_txt('SC_fechatrans_input_2_dia') + '@NMF@';
      str_out += 'SC_fechatrans_input_2_mes#NMF#' + search_get_sel_txt('SC_fechatrans_input_2_mes') + '@NMF@';
      str_out += 'SC_fechatrans_input_2_ano#NMF#' + search_get_sel_txt('SC_fechatrans_input_2_ano') + '@NMF@';
  }
  ...
  str_out += 'SC_id_product_cond#NMF#' + search_get_sel_txt('SC_id_product_cond') + '@NMF@';
  str_out += 'SC_id_product#NMF#' + search_get_selmult('SC_id_product') + '@NMF@';
...
<TABLE id="main_table" align="left" valign="top" >
<tr>
<td>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $fechatrans_cond, $fechatrans, $fechatrans_dia, $fechatrans_mes, $fechatrans_ano, $fechatrans_input_2_dia, $fechatrans_input_2_mes, $fechatrans_input_2_ano,
             $producto_cond, $producto, $producto_autocomp,
             $id_product_cond, $id_product,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $fechatrans_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['fechatrans_dia']; 
          $fechatrans_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['fechatrans_mes']; 
          $fechatrans_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['fechatrans_ano']; 
          $fechatrans_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['fechatrans_input_2_dia']; 
          $fechatrans_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['fechatrans_input_2_mes']; 
          $fechatrans_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['fechatrans_input_2_ano']; 
          $fechatrans_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['fechatrans_cond']; 
          $producto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['producto']; 
          $producto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['producto_cond']; 
          $id_product = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['id_product']; 
          $id_product_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['id_product_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['NM_operador']; 
      } 
      if (!isset($fechatrans_cond) || empty($fechatrans_cond))
      {
         $fechatrans_cond = "bi_HJ";
      }
      if (!isset($producto_cond) || empty($producto_cond))
      {
         $producto_cond = "qp";
      }
      if (!isset($id_product_cond) || empty($id_product_cond))
      {
         $id_product_cond = "gt";
      }
      if (isset($fechatrans_cond) && substr($fechatrans_cond, 0, 3) == "bi_")
      {
         $Temp_cond = $fechatrans_cond;
         $this->Ini->process_cond_bi($Temp_cond, $BI_data1, $BI_data2);
         $fechatrans_dia = substr($BI_data1, 0, 2);
         $fechatrans_mes = substr($BI_data1, 2, 2);
         $fechatrans_ano = substr($BI_data1, 4, 4);
         if (strlen($BI_data1) > 8)
         {
             $fechatrans_hor = substr($BI_data1, 8, 2);
             $fechatrans_min = substr($BI_data1, 10, 2);
             $fechatrans_seg = substr($BI_data1, 12, 2);
         }
         $fechatrans_input_2_dia = substr($BI_data2, 0, 2);
         $fechatrans_input_2_mes = substr($BI_data2, 2, 2);
         $fechatrans_input_2_ano = substr($BI_data2, 4, 4);
         if (strlen($BI_data2) > 8)
         {
             $fechatrans_input_2_hor = substr($BI_data2, 8, 2);
             $fechatrans_input_2_min = substr($BI_data2, 10, 2);
             $fechatrans_input_2_seg = substr($BI_data2, 12, 2);
         }
         $Script_BI .= "  formata_bi_fechatrans('" . $fechatrans_cond . "', '" . $Temp_cond . "', '" . $BI_data1 . "');\r\n";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_fechatrans = (in_array($fechatrans_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_producto = (in_array($producto_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_product = (in_array($id_product_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_fechatrans = ('bw' == $fechatrans_cond || 'bi_' == substr($fechatrans_cond, 0, 3)) ? $display_aberto : $display_fechado;
      $str_display_producto = ('bw' == $producto_cond) ? $display_aberto : $display_fechado;
      $str_display_id_product = ('bw' == $id_product_cond) ? $display_aberto : $display_fechado;

      // id_product
      if (is_array($id_product) && !empty($id_product))
      {
         $tmp_array = array();
         $id_product_val_str = "";
         foreach ($id_product as $tmp_val_cmp)
         {
            if ("" != $id_product_val_str)
            {
               $id_product_val_str .= ",";
            }
            ...
            $id_product_val_str .= "'$tmp_val_cmp'";
         }
         $id_product = $tmp_array;
      }
      else
      {
         $id_product_val_str = "";
      }
      if (!isset($fechatrans) || $fechatrans == "")
      {
          $fechatrans = "";
      }
      if (isset($fechatrans) && !empty($fechatrans))
      {
...
?>
 ...
 <TR align="center">
  <TD class="scFilterTableTd" id='sc_filter_toolbar_top'>
   ...
   <?php echo nmButtonOutput($this->arr_buttons, "bpesquisa", "document.F1.bprocessa.value='pesq'; setTimeout(function() {nm_submit_form()}, 200);", "document.F1.bprocessa.value='pesq'; setTimeout(function() {nm_submit_form()}, 200);", "sc_b_pesq_top", "", "" . $this->Ini->Nm_lang['lang_btns_srch_lone'] . "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Enter)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
?>
<?php
   if ($this->nmgp_botoes['clear'] == "on")
   {
?>
          <?php echo nmButtonOutput($this->arr_buttons, "blimpar", "limpa_form();", "limpa_form();", "limpa_frm_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + K)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
?>
<?php
   }
?>
...
<?php
   ...
   {
?>
          <?php echo nmButtonOutput($this->arr_buttons, "bedit_filter", "document.getElementById('Salvar_filters_top').style.display = ''; document.F1.nmgp_save_name_top.focus();", "document.getElementById('Salvar_filters_top').style.display = ''; document.F1.nmgp_save_name_top.focus();", "Ativa_save_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + E)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
?>
<?php
   }
?>
<?php
   if (is_file("grid_sales_detail_reporte_cliente_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_psq'])
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_fechatrans_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fechatrans'])) ? $this->New_label['fechatrans'] : "Fechatrans"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_fechatrans_cond" name="fechatrans_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechatrans'), this, 'fechatrans')">
       <optgroup label="<?php echo $this->Ini->Nm_lang['lang_srch_nrml'] ?>">
       <OPTION value="eq" <?php if ("eq" == $fechatrans_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $fechatrans_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $fechatrans_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $fechatrans_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
       <optgroup label="<?php echo $this->Ini->Nm_lang['lang_srch_spec'] ?>">
       <OPTION value="bi_HJ" <?php if ("bi_HJ" == $fechatrans_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_tday'] ?></OPTION>
       <OPTION value="bi_OT" <?php if ("bi_OT" == $fechatrans_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_yest'] ?></OPTION>
       <OPTION value="bi_este_mes_full" <?php if ("bi_este_mes_full" == $fechatrans_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_este_mes_full'] ?></OPTION>
       <OPTION value="bi_MM" <?php if ("bi_MM" == $fechatrans_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_this_mnth'] ?></OPTION>
       <OPTION value="bi_UM" <?php if ("bi_UM" == $fechatrans_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_mnth'] ?></OPTION>
       <OPTION value="bi_M3" <?php if ("bi_M3" == $fechatrans_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_03mo'] ?></OPTION>
       <OPTION value="bi_M6" <?php if ("bi_M6" == $fechatrans_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_06mo'] ?></OPTION>
       <OPTION value="bi_M24" <?php if ("bi_M24" == $fechatrans_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_24mo'] ?></OPTION>
       <OPTION value="bi_current_year" <?php if ("bi_current_year" == $fechatrans_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_summary_current_year'] ?></OPTION>
       <OPTION value="bi_LY" <?php if ("bi_LY" == $fechatrans_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_last_year'] ?></OPTION>
       <OPTION value="bi_CY" <?php if ("bi_CY" == $fechatrans_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_summary_current_year_today'] ?></OPTION>
       <OPTION value="bi_current_week_today" <?php if ("bi_current_week_today" == $fechatrans_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_summary_current_week_today'] ?></OPTION>
       <OPTION value="bi_current_week" <?php if ("bi_current_week" == $fechatrans_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_search_summary_current_week'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd"><SPAN id="Nm_bi_dados_fechatrans" style="display:none"></SPAN>
      <TABLE  id="opc_bi_TP_fechatrans"  style=display:  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fechatrans" <?php echo $str_hide_fechatrans?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['fechatrans'])) ? $this->New_label['fechatrans'] : "Fechatrans";
 $nmgp_tab_label .= "fechatrans?#?" . $SC_Label . "?@?";
...
<?php
  ...
  {
?>
<span id='id_date_part_fechatrans_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechatrans_dia" name="fechatrans_dia" value="<?php echo NM_encode_input($fechatrans_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechatrans_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechatrans_mes" name="fechatrans_mes" value="<?php echo NM_encode_input($fechatrans_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechatrans_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechatrans_ano" name="fechatrans_ano" value="<?php echo NM_encode_input($fechatrans_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_fechatrans_jq">
</span>
...
?>
        <SPAN id="id_css_fechatrans"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_fechatrans"  <?php echo $str_display_fechatrans; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_fechatrans_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechatrans_input_2_dia" name="fechatrans_input_2_dia" value="<?php echo NM_encode_input($fechatrans_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechatrans_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechatrans_input_2_mes" name="fechatrans_input_2_mes" value="<?php echo NM_encode_input($fechatrans_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechatrans_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechatrans_input_2_ano" name="fechatrans_input_2_ano" value="<?php echo NM_encode_input($fechatrans_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_fechatrans_jq2">
</span>
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_producto" name="producto_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_id_product_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_product'])) ? $this->New_label['id_product'] : "Id Product"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_product_cond" name="id_product_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_product'), this, 'id_product')">
       <OPTION value="eq" <?php if ("eq" == $id_product_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_product" <?php echo $str_hide_id_product?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['id_product'])) ? $this->New_label['id_product'] : "Id Product";
 $nmgp_tab_label .= "id_product?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
   <span id="idAjaxSelect_id_product">
      <SELECT class="scFilterObjectOdd" id="SC_id_product" name="id_product[]"  size="7" multiple>
<?php
...
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $id_product_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['pesq_tab_label'] = $nmgp_tab_label;
?>
<?php
   }
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.fechatrans_cond.value = 'bi_HJ';
   nm_campos_between(document.getElementById('id_vis_fechatrans'), document.F1.fechatrans_cond, 'fechatrans');
   document.F1.fechatrans_dia.value = "";
   document.F1.fechatrans_mes.value = "";
   document.F1.fechatrans_ano.value = "";
   document.F1.fechatrans_input_2_dia.value = "";
   document.F1.fechatrans_input_2_mes.value = "";
   document.F1.fechatrans_input_2_ano.value = "";
   ...
   document.F1.id_product_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_id_product'), document.F1.id_product_cond, 'id_product');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'id_product[]')
      {
 ...
 {
    if (Field == 'all' || Field == 'id_product') {
       Sc_carga_select2_id_product();
    }
 }
 function Sc_carga_select2_id_product()
 {
  $("#SC_id_product").select2(
    {
      language: {
        noResults: function() {
 ...
 {
    $('#SC_fechatrans_dia').bind('change', function() {sc_grid_sales_detail_reporte_cliente_valida_dia(this)});
    $('#SC_fechatrans_input_2_dia').bind('change', function() {sc_grid_sales_detail_reporte_cliente_valida_dia(this)});
    $('#SC_fechatrans_input_2_mes').bind('change', function() {sc_grid_sales_detail_reporte_cliente_valida_mes(this)});
    $('#SC_fechatrans_mes').bind('change', function() {sc_grid_sales_detail_reporte_cliente_valida_mes(this)});
 }
 function sc_grid_sales_detail_reporte_cliente_valida_dia(obj)
 {
 ...
 function sc_grid_sales_detail_reporte_cliente_valida_mes(obj)
 {
...
function formata_bi_fechatrans(opc, opc_bi, dt_fmt)
{
   if (opc.substring(0,3) != "bi_")
   {
       document.getElementById('Nm_bi_dados_fechatrans').style.display = 'none';
       document.getElementById('opc_bi_TP_fechatrans').style.display = '';
       return;
   }
   if (opc == "bi_TP")
   {
       document.getElementById('Nm_bi_dados_fechatrans').style.display = 'none';
       document.getElementById('opc_bi_TP_fechatrans').style.display = 'none';
       return;
   }
<?php
   $date_format_show = "";
   ...
   {
       $date_format_show .= (!$Prim) ? " + '" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . "' + ": "";
       $date_format_show .= ($Cada_d == "d") ? "document.F1.fechatrans_dia.value" : "";
       $date_format_show .= ($Cada_d == "m") ? "document.F1.fechatrans_mes.value" : "";
       $date_format_show .= ($Cada_d == "Y") ? "document.F1.fechatrans_ano.value" : "";
       $Prim = false;
   }
?> 
...
<?php
   ...
   {
       $date_format_show .= (!$Prim) ? " + '" . $_SESSION['scriptcase']['reg_conf']['date_sep'] . "' + ": "";
       $date_format_show .= ($Cada_d == "d") ? "document.F1.fechatrans_input_2_dia.value" : "";
       $date_format_show .= ($Cada_d == "m") ? "document.F1.fechatrans_input_2_mes.value" : "";
       $date_format_show .= ($Cada_d == "Y") ? "document.F1.fechatrans_input_2_ano.value" : "";
       $Prim = false;
   }
?> 
       saida += <?php echo $date_format_show ?>;
   }
   document.getElementById('Nm_bi_dados_fechatrans').innerHTML = saida;
   document.getElementById('opc_bi_TP_fechatrans').style.display = 'none';
   document.getElementById('Nm_bi_dados_fechatrans').style.display = '';
}
<?php
  echo $Script_BI;
?>
   function process_hotkeys(hotkey)
   {
      if (hotkey == 'sys_format_fi2') { 
         var output =  $('#sc_b_pesq_top').click();
         return (0 < output.length);
      }
      if (hotkey == 'sys_format_lim') { 
         var output =  $('#limpa_frm_top').click();
         return (0 < output.length);
      }
      if (hotkey == 'sys_format_edi') { 
         var output =  $('#Ativa_save_top').click();
         return (0 < output.length);
      }
      if (hotkey == 'sys_format_webh') { 
         var output =  $('#sc_b_help_top').click();
         return (0 < output.length);
      }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_sales_detail_reporte_cliente/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_fechatrans_cond'] = 'cond';
      $tp_fields['SC_fechatrans_dia'] = 'text';
      $tp_fields['SC_fechatrans_mes'] = 'text';
      $tp_fields['SC_fechatrans_ano'] = 'text';
      $tp_fields['SC_fechatrans_input_2_dia'] = 'text';
      $tp_fields['SC_fechatrans_input_2_mes'] = 'text';
      $tp_fields['SC_fechatrans_input_2_ano'] = 'text';
      $tp_fields['SC_producto_cond'] = 'cond';
      $tp_fields['SC_producto'] = 'text_aut';
      $tp_fields['id_ac_producto'] = 'text_aut';
      $tp_fields['SC_id_product_cond'] = 'cond';
      $tp_fields['SC_id_product'] = 'selmult';
      ...
      if (is_file($NM_patch))
      {
          ...
          foreach ($NMcmp_filter as $Cada_cmp)
          {
              ...
              else
              {
                  ...
                  if ($Cada_cmp[0] == 'SC_fechatrans_cond')
                  {
                      $opc = $Cada_cmp[1];
   ...
   {
      global $fechatrans_cond, $fechatrans, $fechatrans_dia, $fechatrans_mes, $fechatrans_ano, $fechatrans_input_2_dia, $fechatrans_input_2_mes, $fechatrans_input_2_ano,
             $producto_cond, $producto, $producto_autocomp,
             $id_product_cond, $id_product, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $fechatrans_cond_salva = $fechatrans_cond; 
      if (!isset($fechatrans_input_2_dia) || $fechatrans_input_2_dia == "")
      {
          $fechatrans_input_2_dia = $fechatrans_dia;
      }
      if (!isset($fechatrans_input_2_mes) || $fechatrans_input_2_mes == "")
      {
          $fechatrans_input_2_mes = $fechatrans_mes;
      }
      if (!isset($fechatrans_input_2_ano) || $fechatrans_input_2_ano == "")
      {
          $fechatrans_input_2_ano = $fechatrans_ano;
      }
      ...
      $id_product_cond_salva = $id_product_cond; 
      if (!isset($id_product_input_2) || $id_product_input_2 == "")
      {
          $id_product_input_2 = $id_product;
      }
      if (is_array($id_product)) {
          foreach ($id_product as $I => $Val) {
              $tmp_pos = strpos($Val, "##@@");
              if ($tmp_pos === false) {
                  $L_lookup = $Val;
              }
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['psq_check_ret']['id_product'])) {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['fechatrans_dia'] = $fechatrans_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['fechatrans_mes'] = $fechatrans_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['fechatrans_ano'] = $fechatrans_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['fechatrans_input_2_dia'] = $fechatrans_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['fechatrans_input_2_mes'] = $fechatrans_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['fechatrans_input_2_ano'] = $fechatrans_input_2_ano; 
      if (!empty($fechatrans_dia) || !empty($fechatrans_mes) || !empty($fechatrans_ano) || $fechatrans_cond_salva == "nu" || $fechatrans_cond_salva == "nn" || $fechatrans_cond_salva == "ep" || $fechatrans_cond_salva == "ne")
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $fechatrans_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $fechatrans_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $fechatrans_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $fechatrans_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $fechatrans_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $fechatrans_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['fechatrans_cond'] = $fechatrans_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Grid_search'][$I_Grid]['cmp'] = "fechatrans"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Grid_search'][$I_Grid]['opc'] = $fechatrans_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq']['fechatrans'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['producto'] = $producto; 
      if (is_array($producto) && !empty($producto))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Grid_search'][$I_Grid]['val'][0] = $producto;
      }
      elseif ($producto_cond_salva == "nu" || $producto_cond_salva == "nn" || $producto_cond_salva == "ep" || $producto_cond_salva == "ne" || !empty($producto))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Grid_search'][$I_Grid]['val'][0][0] = $producto;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['producto_cond'] = $producto_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Grid_search'][$I_Grid]['cmp'] = "producto"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Grid_search'][$I_Grid]['opc'] = $producto_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq']['producto'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['id_product'] = $id_product; 
      if (is_array($id_product) && !empty($id_product))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Grid_search'][$I_Grid]['val'][0] = $id_product;
      }
      elseif ($id_product_cond_salva == "nu" || $id_product_cond_salva == "nn" || $id_product_cond_salva == "ep" || $id_product_cond_salva == "ne" || !empty($id_product))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Grid_search'][$I_Grid]['val'][0][0] = $id_product;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['id_product_cond'] = $id_product_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Grid_search'][$I_Grid]['cmp'] = "id_product"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Grid_search'][$I_Grid]['opc'] = $id_product_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq']['id_product'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($producto != '') {
      ...
      $this->cmp_formatado['id_product'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['id_product'];
      $this->cmp_formatado['id_product_input_2'] = $id_product_input_2;

      //----- $fechatrans
      $this->Date_part = false;
      if ($fechatrans_cond != "bi_TP")
      {
          $fechatrans_cond = strtoupper($fechatrans_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $fechatrans_ano;
          $Dtxt .= $fechatrans_mes;
          $Dtxt .= $fechatrans_dia;
          $val[0]['ano'] = $fechatrans_ano;
          $val[0]['mes'] = $fechatrans_mes;
          $val[0]['dia'] = $fechatrans_dia;
          if ($fechatrans_cond == "BW")
          {
              $val[1]['ano'] = $fechatrans_input_2_ano;
              $val[1]['mes'] = $fechatrans_input_2_mes;
              $val[1]['dia'] = $fechatrans_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "TIMESTAMP", $fechatrans_cond, "", "data");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $fechatrans = $val[0];
          $this->cmp_formatado['fechatrans'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['fechatrans'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['fechatrans'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['fechatrans'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          if ($fechatrans_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $fechatrans_input_2     = $val[1];
              $this->cmp_formatado['fechatrans_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']['fechatrans_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['fechatrans_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['fechatrans_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          }
          if (!empty($Dtxt) || $fechatrans_cond == "NU" || $fechatrans_cond == "NN"|| $fechatrans_cond == "EP"|| $fechatrans_cond == "NE")
          {
              $this->monta_condicao("fechatrans", $fechatrans_cond, $fechatrans, $fechatrans_input_2, 'fechatrans', 'TIMESTAMP');
          }
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq']['fechatrans']['label'] = $nmgp_tab_label['fechatrans'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq']['fechatrans']['descr'] = $nmgp_tab_label['fechatrans'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq']['fechatrans']['hint']  = $nmgp_tab_label['fechatrans'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
      ...
      $this->Date_part = false;
      $nm_aspas = "";
      if ($id_product_cond == "nu" || $id_product_cond == "nn" || $id_product_cond == "ep" || $id_product_cond == "ne")
      {
          $id_product = array();
      }
      if (is_array($id_product) && count($id_product) != 0)
      {
         foreach ($id_product as $i => $dados)
         {
      ...
      if (is_array($id_product) && count($id_product) != 0)
      {
         ...
         $lim_descr   = 15;
         $lang_descr  = strlen($this->Ini->Nm_lang['lang_srch_orr_cond']);
         if ($id_product_cond == "df" || $id_product_cond == "np")
         {
             $this->comando        .= " id_product not in (";
             $this->comando_sum    .= " sales_detail.id_product not in (";
             $this->comando_filtro .= " id_product not in (";
         }
         else
         {
             $this->comando        .= " id_product in (";
             $this->comando_sum    .= " sales_detail.id_product in (";
             $this->comando_filtro .= " id_product in (";
         }
         $x                     = count($id_product);
         $xx                    = 0;
         $nm_cond               = "";
         foreach ($id_product as $i => $dados)
         {
            ...
            elseif (!$end_descr)
            {
                 $cond_descr .= " +" . (count($id_product) - $count_descr);
                 $end_descr = true;
            };
            if ($xx != ($x - 1))
            {
         ...
         $Lang_descr_final = isset($Lang_descr[$id_product_cond]) ? $Lang_descr[$id_product_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cond_pesq'] .= $nmgp_tab_label['id_product'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq']['id_product']['label'] = $nmgp_tab_label['id_product'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq']['id_product']['descr'] = $nmgp_tab_label['id_product'] . ": " . $Lang_descr_final . " " . $cond_descr;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq']['id_product']['hint'] = $nmgp_tab_label['id_product'] . ": " . $Lang_descr_final . " " . $nm_cond;
      }
      elseif (isset($id_product) || $id_product_cond == "nu" || $id_product_cond == "nn" || $id_product_cond == "ep" || $id_product_cond == "ne")
      {
         $this->monta_condicao("id_product", $id_product_cond, $id_product, "", "id_product");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "id_product" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
