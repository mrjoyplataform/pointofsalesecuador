...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_fechatrans_cond" name="fechatrans_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechatrans'), this, 'fechatrans')">
      ...
      <br><span id="id_hide_fechatrans"  <?php echo $str_hide_fechatrans?>>
<SPAN id="Nm_bi_dados_fechatrans" style="display:none"></SPAN>
<SPAN id="opc_bi_TP_fechatrans"  style="display:''">
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_fechatrans"  <?php echo $str_display_fechatrans; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_product_cond" name="id_product_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_product'), this, 'id_product')">
       <OPTION value="eq" <?php if ("eq" == $id_product_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_id_product"  <?php echo $str_hide_id_product?>>
<?php
