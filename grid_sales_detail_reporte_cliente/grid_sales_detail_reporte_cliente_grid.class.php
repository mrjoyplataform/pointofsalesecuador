<?php
class grid_sales_detail_reporte_cliente_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['charts_html'] = '';
   ...
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'])
       { 
           include_once($this->Ini->path_embutida . "grid_sales_detail_reporte_cliente/" . $this->Ini->Apl_resumo); 
       } 
       else 
       { 
           include_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
       } 
       $this->Res         = new grid_sales_detail_reporte_cliente_resumo();
       $this->Res->Db     = $this->Db;
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_sales_detail_reporte_cliente'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao_print'] != 'print')
       { 
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['save_grid']);
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['pdf_res'] && (!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']))
       {
           $this->grid();
       }
       if ($nmgrp_apl_opcao != "pdf")
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf))
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['graf_pdf'] == "S")
       { 
           if (isset($_GET['flash_graf']) && 'pdf' == $_GET['flash_graf'] && $Gera_graf)
           {
               $this->grafico_pdf_flash();
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] = "grid";
           } 
           elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] == "pdf" && $Gera_graf)
           { 
               $this->grafico_pdf();
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] = "grid";
           } 
       ...
       { 
           ...
           if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] == "pdf")
           { 
               $flag_apaga_pdf_log = FALSE;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] = "igual";
           } 
           $this->nm_fim_grid($flag_apaga_pdf_log);
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'];
 }
...
//
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_pdf']['all_label'] : "S";
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_sales_detail_reporte_cliente/grid_sales_detail_reporte_cliente_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   if (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Gb_Free_cmp']) > 1)
   {
       $this->width_tabula_quebra  = (((count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Gb_Free_cmp']) - 1) * 13) + 3) . "px";
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_sales_detail_reporte_cliente']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_sales_detail_reporte_cliente']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_sales_detail_reporte_cliente']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_sales_detail_reporte_cliente']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_sales_detail_reporte_cliente']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_sales_detail_reporte_cliente']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_sales_detail_reporte_cliente']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['mostra_edit'] = "N";
   }
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['emb_tree_no'])
   { 
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("grid_sales_detail_reporte_cliente", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq_ant'];  
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] = "muda_qt_linhas";
   } 
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_sales_detail_reporte_cliente/grid_sales_detail_reporte_cliente_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_sales_detail_reporte_cliente_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   $this->Tot         = new grid_sales_detail_reporte_cliente_total($this->Ini->sc_page);
   $this->Tot->Db     = $this->Db;
   $this->Tot->Erro   = $this->Erro;
   $this->Tot->Ini    = $this->Ini;
   $this->Tot->Lookup = $this->Lookup;
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_lin_grid'] = 20;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_sales_detail_reporte_cliente']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_sales_detail_reporte_cliente']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_sales_detail_reporte_cliente']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_sales_detail_reporte_cliente']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_sales_detail_reporte_cliente']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_sales_detail_reporte_cliente']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_sales_detail_reporte_cliente']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_sales_detail_reporte_cliente']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_quebra'] = array(); 
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Gb_Free_sql'] as $cmp_var => $resto)
           {
               ...
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_quebra'][$cmp_var][$SC_Sql_col] = $SC_Sql_order;
               }
           }
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_orig'] = "";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq_filtro'] = "";
   }   
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao']       = "igual" ; 
...
// 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['tot_geral'][1] ;  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_reg_grid'] == "all") 
   { 
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['tot_geral'][1] ;  
       $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['tot_geral'][1];
   } 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['contr_array_resumo']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['contr_array_resumo'] = "NAO";
       } 
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['tot_geral'][1];
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['sc_total'] = $rt_grid->fields[0];  
       
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Gb_Free_orig']))
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Gb_Free_orig'] as $Cmp_clone => $Cmp_orig)
           {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Ind_Groupby'] == "sc_free_group_by")
       {
           ...
           {
               $Cmp_orig = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Ind_Groupby'] == "sc_free_group_by") 
       {
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Gb_Free_cmp'] as $cmp => $sql)
           {
               $Cmp_orig   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Gb_Free_orig'][$cmp] : $cmp;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['final']; 
   ...
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_sales_detail_reporte_cliente_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_sales_detail_reporte_cliente_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_sales_detail_reporte_cliente_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_sales_detail_reporte_cliente_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_sales_detail_reporte_cliente_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($this->count_ger) . ";\r\n");
           }
           else
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("    {\r\n");
           $nm_saida->saida("        let cells = $(\".sc-ui-grid-header-row-grid_sales_detail_reporte_cliente-1\").find(\"td\");\r\n");
           ...
           $nm_saida->saida("        rows = $(\".sc-ui-grid-header-row-grid_sales_detail_reporte_cliente-1\");\r\n");
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-grid_sales_detail_reporte_cliente-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-94d387cc\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
...
$nm_saida->saida("}\r\n");
       ...
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_sales_detail_reporte_cliente_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_sales_detail_reporte_cliente_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_sales_detail_reporte_cliente_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_sales_detail_reporte_cliente/grid_sales_detail_reporte_cliente_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".grid_sales_detail_reporte_cliente_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf" && !$this->Print_All)
       { 
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida']) ? "grid_sales_detail_reporte_cliente_" : "";
   $this->css_sep = " ";
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_liga']['cab']))
   {
       return; 
   }
   $nm_cab_filtro   = ""; 
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['sv_dt_head'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['sv_dt_head']['fix'] = $nm_data_fixa;
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['sv_dt_head']['fix'] != $nm_data_fixa)
   {
       $nm_refresch_cab_rod = true;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
   ...
   { 
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['proc_pdf']) 
     { 
         $this->NM_calc_span();
           $nm_saida->saida("   <TD colspan=\"" . $this->NM_colspan . "\" class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\">\r\n");
     } 
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['proc_pdf_vert']) 
     {
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_sales_detail_reporte_cliente__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_sales_detail_reporte_cliente-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_label']) { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_psq']) { 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf") {
   $nm_saida->saida("     <TD class=\"" . $this->css_inherit_bg . ' ' . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_discount_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
     ...
     { 
         ...
         { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 $css_emb .= ".grid_sales_detail_reporte_cliente_" . substr($cada_css, 1);
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_discount()
 {
   ...
   $nm_saida->saida("</TD>\r\n");
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_cmp'] == $fieldName) {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ordem_label'] == 'desc') {
                $sortRule = 'desc';
            } else {
                $sortRule = 'asc';
            }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['id_sales'])) ? $this->New_label['id_sales'] : "Id Sales";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['id_sales'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fechatrans'])) ? $this->New_label['fechatrans'] : "Fechatrans";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['fechatrans'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['codproducto'])) ? $this->New_label['codproducto'] : "Codproducto";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['codproducto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['producto'])) ? $this->New_label['producto'] : "Producto";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['producto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['quantity'])) ? $this->New_label['quantity'] : "Quantity";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['quantity'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['item_total'])) ? $this->New_label['item_total'] : "Item Total";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['item_total'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['valor_siniva'])) ? $this->New_label['valor_siniva'] : "Valor Siniva";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['valor_siniva'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['valor_unitario'])) ? $this->New_label['valor_unitario'] : "Valor Unitario";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['valor_unitario'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cuentaventa'])) ? $this->New_label['cuentaventa'] : "Cuentaventa";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['cuentaventa'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['idcaja'])) ? $this->New_label['idcaja'] : "Idcaja";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['idcaja'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['factura'])) ? $this->New_label['factura'] : "Factura";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['factura'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['uniqueid'])) ? $this->New_label['uniqueid'] : "Uniqueid";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['uniqueid'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['entrada'])) ? $this->New_label['entrada'] : "Entrada";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['entrada'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['jugador'])) ? $this->New_label['jugador'] : "Jugador";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['jugador'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['visitante'])) ? $this->New_label['visitante'] : "Visitante";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['visitante'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tarjeta'])) ? $this->New_label['tarjeta'] : "Tarjeta";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['tarjeta'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tokens'])) ? $this->New_label['tokens'] : "Tokens";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['tokens'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['minutos'])) ? $this->New_label['minutos'] : "Minutos";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['minutos'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['comida'])) ? $this->New_label['comida'] : "Comida";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['comida'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tarjetarfid'])) ? $this->New_label['tarjetarfid'] : "Tarjetarfid";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['tarjetarfid'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['rfid_pulsera'])) ? $this->New_label['rfid_pulsera'] : "Rfid Pulsera";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['rfid_pulsera'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['id_sales_detail'])) ? $this->New_label['id_sales_detail'] : "Id Sales Detail";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['id_sales_detail'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['unit_cost'])) ? $this->New_label['unit_cost'] : "Unit Cost";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['unit_cost'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['unit_value'])) ? $this->New_label['unit_value'] : "Unit Value";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['unit_value'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['discount'])) ? $this->New_label['discount'] : "Discount";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['labels']['discount'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_sales_detail_reporte_cliente']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_sales_detail_reporte_cliente']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_sales_detail_reporte_cliente']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_sales_detail_reporte_cliente#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['force_toolbar'] = true;
           } 
...
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_grid_sales_detail_reporte_cliente#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-94d387cc\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Page_break_PDF'] = array();
       }
   }
   $this->SC_top       = array();
   $this->SC_bot       = array();
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       ...
       $this->Nivel_gbBot = count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Gb_Free_cmp']);
   ...
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_sales_detail_reporte_cliente_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $this->arg_sum_cuentaventa = " = " . $this->Db->qstr($this->cuentaventa);
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['final'] + 1; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['rows_emb']++;
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Ind_Groupby'] == "sc_free_group_by") 
          {  
              $SC_arg_Gby = array();
              ...
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Gb_Free_cmp'] as $cmp => $sql)
              {
                  $Format_tst = $this->Ini->Get_Gb_date_format('sc_free_group_by', $cmp);
                  $SC_arg_Sql[$cmp] = $sql;
                  $Fun_GB  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Gb_Free_orig'][$cmp])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Gb_Free_orig'][$cmp] : $cmp;
                  if (!empty($Format_tst))
                  {
                      $temp = $this->$cmp;
                      if (!empty($temp))
              ...
              foreach ($SC_lst_Gby as $Ind => $cmp)
              {
                  ...
                  $sql_where = "";
                  $cmp_qb     = $this->$cmp;
                  foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Gb_Free_cmp'] as $Col_Gb => $Sql)
                  {
                      $tmp        = "arg_sum_" . $Col_Gb;
                      $sql_where .= (!empty($sql_where)) ? " and " : "";
              ...
              {
                  $cmp = $SC_lst_Gby[0];
                  if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Ind_Groupby']][$cmp] == "S")
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
                  elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Page_break_PDF'][$cmp] == "S")
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
              }
          ...
          else
          {
              ...
              {
                  if ($this->nm_inicio_pag == 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_grid'])
                  {
                      $nm_houve_quebra = "N";
                  } 
              } 
              elseif (($nm_houve_quebra == "S" || ($this->nm_inicio_pag == 0)) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_grid'])
              { 
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['mostra_edit'] != "N"){ 
              ...
              $Md5_Det    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_sales_detail_reporte_cliente@SC_par@" . md5($Parms_Det);
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['Lig_Md5'][md5($Parms_Det)] = $Parms_Det;
              ...
              if ($_SESSION['scriptcase']['proc_mobile']) {
                  $Link_Det  = nmButtonOutput($this->arr_buttons, "bcons_detalhes", "nm_submit_modal('" . $this->Ini->path_link . "grid_sales_detail_reporte_cliente/index.php?nmgp_parms=" . $Md5_Det . "&nmgp_parm_acum=&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&SC_lig_apl_orig=grid_sales_detail_reporte_cliente&nmgp_opcao=detalhe&KeepThis=true&TB_iframe=true&height=440&width=630&modal=true', '" . $Sc_parent . "')", "nm_submit_modal('" . $this->Ini->path_link . "grid_sales_detail_reporte_cliente/index.php?nmgp_parms=" . $Md5_Det . "&nmgp_parm_acum=&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&SC_lig_apl_orig=grid_sales_detail_reporte_cliente&nmgp_opcao=detalhe&KeepThis=true&TB_iframe=true&height=440&width=630&modal=true', '" . $Sc_parent . "')", "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              }
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['mostra_edit'] == "N"){ 
          ...
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Ind_Groupby'] . "_bot";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_grid'])
 ...
 function NM_grid_id_sales()
 {
      ...
      if (!isset($this->NM_cmp_hidden['id_sales']) || $this->NM_cmp_hidden['id_sales'] != "off") { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'] && !empty($conteudo)) 
          { 
 ...
 function NM_calc_span()
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_pdf'] == "pdf")
   {
       $this->NM_colspan--;
   } 
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 ...
 function quebra_fechatrans_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   $tot_fechatrans = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['fechatrans'] : 0;
   ...
   $link_div   = "";
   $link_div_2 = "";
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ind_tree'];
       ...
       $link_div .= "<img id=\"b_open_grid_sales_detail_reporte_cliente_" . $this->NM_cont_body . "\" style=\"display:none\" onclick=\"document.getElementById('b_open_grid_sales_detail_reporte_cliente_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_close_grid_sales_detail_reporte_cliente_" . $this->NM_cont_body . "').style.display = ''; NM_liga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_sales_detail_reporte_cliente, 'grid_sales_detail_reporte_cliente'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">";
       $link_div .= "<img id=\"b_close_grid_sales_detail_reporte_cliente_" . $this->NM_cont_body . "\" style=\"display:''\" onclick=\"document.getElementById('b_close_grid_sales_detail_reporte_cliente_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_open_grid_sales_detail_reporte_cliente_" . $this->NM_cont_body . "').style.display = ''; NM_apaga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_sales_detail_reporte_cliente, 'grid_sales_detail_reporte_cliente'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">";
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_sales_detail_reporte_cliente'][$this->NM_cont_body][$this->Tab_Nv_tree['fechatrans']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_sales_detail_reporte_cliente_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   $this->NM_calc_span();
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['fechatrans'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_sales_detail_reporte_cliente'][$this->NM_cont_body][$this->Tab_Nv_tree['fechatrans']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_sales_detail_reporte_cliente_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
 ...
 function quebra_fechatrans_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   global 
          ...
          $nm_saida, $$Var_name_gb;
   $tot_fechatrans = $$Var_name_gb;
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['fechatrans'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ind_tree'];
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['field_order'] as $Cada_cmp)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = false;
       $nm_saida->saida("    </TBODY>");
   }
 ...
 function quebra_cuentaventa_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_cuentaventa = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['cuentaventa'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_sales_detail_reporte_cliente'][$this->NM_cont_body][$this->Tab_Nv_tree['cuentaventa']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_sales_detail_reporte_cliente_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['cuentaventa'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_sales_detail_reporte_cliente'][$this->NM_cont_body][$this->Tab_Nv_tree['cuentaventa']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_sales_detail_reporte_cliente_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_cuentaventa_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   global 
          ...
          $nm_saida, $$Var_name_gb;
   $tot_cuentaventa = $$Var_name_gb;
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['cuentaventa'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ind_tree'];
 ...
 function quebra_producto_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_producto = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['producto'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_sales_detail_reporte_cliente'][$this->NM_cont_body][$this->Tab_Nv_tree['producto']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_sales_detail_reporte_cliente_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['producto'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_sales_detail_reporte_cliente'][$this->NM_cont_body][$this->Tab_Nv_tree['producto']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_sales_detail_reporte_cliente_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_producto_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   global 
          ...
          $nm_saida, $$Var_name_gb;
   $tot_producto = $$Var_name_gb;
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['producto'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ind_tree'];
 ...
 function quebra_geral_sc_free_group_by_bot() 
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] == "pdf" && !$this->Print_All)
   {
      $nm_nivel_book_pdf = "<div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" .  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['tot_geral'][0] . "</H1></div>";
   }
   $tit_lin_sumariza      =  $nm_nivel_book_pdf . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['tot_geral'][1] . ")";
   $tit_lin_sumariza_orig =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['tot_geral'][1] . ")";
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "quantity" && (!isset($this->NM_cmp_hidden['quantity']) || $this->NM_cmp_hidden['quantity'] != "off"))
    {
      ...
      $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['tot_geral'][2] ; 
      nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
    ...
    if ($Cada_cmp == "item_total" && (!isset($this->NM_cmp_hidden['item_total']) || $this->NM_cmp_hidden['item_total'] != "off"))
    {
      ...
      $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['tot_geral'][3] ; 
      nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "2", "", "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['ajax_nav'])
          {
      ...
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_sales_detail_reporte_cliente/grid_sales_detail_reporte_cliente_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          $Tem_xls_res = "s";
          ...
          $nm_saida->saida("            <div id=\"div_xls_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "xls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_sales_detail_reporte_cliente/grid_sales_detail_reporte_cliente_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_sales_detail_reporte_cliente&nm_tp_xls=xlsx&nm_tot_xls=S&nm_res_cons=" . $Tem_xls_res . "&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xml_res = "n";
          $Tem_xml_res = "s";
          ...
          $nm_saida->saida("            <div id=\"div_xml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "xml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_sales_detail_reporte_cliente/grid_sales_detail_reporte_cliente_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_xml_res . "&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_csv_res = "n";
          $Tem_csv_res = "s";
          ...
          $nm_saida->saida("            <div id=\"div_csv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "csv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_sales_detail_reporte_cliente/grid_sales_detail_reporte_cliente_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_csv_res . "&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume,chart&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['rtf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          $Tem_pdf_res = "s";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Gb_Free_cmp']))
          ...
          $nm_saida->saida("            <div id=\"div_print_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_sales_detail_reporte_cliente/grid_sales_detail_reporte_cliente_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=RC&nm_cor=CO&password=n&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid,resume&nm_all_modules=grid,resume,chart&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['filter'] == "on"  && !$this->grid_emb_form)
      {
          ...
          if (is_file("grid_sales_detail_reporte_cliente_help.txt") && !$this->grid_emb_form)
          {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full)
      {
   ...
   function nmgp_barra_bot_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao_print'] != "print") 
      {
          ...
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_lin_grid'];
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_lin_grid'] == 5) ? " selected" : "";
              $nm_saida->saida("           <option value=\"5\" " . $obj_sel . ">5</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_lin_grid'] == 10) ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_lin_grid'] == 20) ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_lin_grid'] == 50) ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_liga']['nav']))
          {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_liga']['nav']))
          {
          ...
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_liga']['nav']))
          {
   ...
   function nmgp_barra_top_mobile()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Gb_Free_cmp']))
      {
          $Tem_pdf_res = "n";
              ...
              $this->nm_btn_exist['pdf'][] = "pdf_top";
          $nm_saida->saida("            <div id=\"div_pdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_sales_detail_reporte_cliente/grid_sales_detail_reporte_cliente_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&lpapel=279&apapel=216&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid,resume&nm_all_modules=grid,resume,chart&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&password=n&summary_export_columns=S&pdf_zip=N&origem=cons&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_sales_detail_reporte_cliente&KeepThis=true&TB_iframe=true&modal=true", "group_4", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_word_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['word'][] = "word_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_sales_detail_reporte_cliente/grid_sales_detail_reporte_cliente_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_4", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_xml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['xml'][] = "xml_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "xml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_sales_detail_reporte_cliente/grid_sales_detail_reporte_cliente_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_xml_res . "&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_4", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div id=\"div_csv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $this->nm_btn_exist['csv'][] = "csv_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "csv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_sales_detail_reporte_cliente/grid_sales_detail_reporte_cliente_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_csv_res . "&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume,chart&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_4", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_5_top = true;</script>\r\n");
      ...
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_sales_detail_reporte_cliente/grid_sales_detail_reporte_cliente_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_sales_detail_reporte_cliente/grid_sales_detail_reporte_cliente_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_5", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_5_top = true;</script>\r\n");
          ...
          $nm_saida->saida("            <div id=\"div_ordcmp_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_sales_detail_reporte_cliente/grid_sales_detail_reporte_cliente_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_sales_detail_reporte_cliente/grid_sales_detail_reporte_cliente_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_5", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_5_top = true;</script>\r\n");
          ...
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['SC_Groupby_hide']))
              {
                  $Q_count++;
   ...
   function JS_grid_search()
   {
    ...
    function getFieldHighlight($filter_type, $field, $str_value, $str_value_original='')
    {
        ...
        {
            if (
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'][ $field ]) &&
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'][ $field . "_cond" ]) &&
                !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'][ $field ]) &&
                (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'][ $field . "_cond"] == 'qp' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'][ $field . "_cond"] == 'eq' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'][ $field . "_cond"] == 'ii'
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'][ $field . "_cond"] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'][ $field ], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'][ $field ], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'][ $field ], '/');
                        $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'][ $field . "_cond"] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'][ $field ], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                ...
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'][ $field . "_cond"] == 'ii')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'][ $field ], substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'][ $field ]))) == 0)
                    {
                        $str_value = $str_html_ini. substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'][ $field ])) .$str_html_fim . substr($str_value, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campos_busca'][ $field ]));
                    }
                }
            }
        }
        ...
        {
            if(
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['fast_search'][0]) &&
                (
                    (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['fast_search'][0] == 'SC_all_Cmp' &&
                    ...
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['fast_search'][0] == $field ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['fast_search'][0], $field . '_VLS_') !== false ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['fast_search'][0], '_VLS_' . $field) !== false
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['fast_search'][1] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(!empty($str_value_original) && $str_value_original != '&nbsp;' && strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['fast_search'][2], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['fast_search'][2], '/');
                        $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['fast_search'][1] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
...
//--- 
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_sales_detail_reporte_cliente', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_sales_detail_reporte_cliente\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_sales_detail_reporte_cliente_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"grid_sales_detail_reporte_cliente_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_sales_detail_reporte_cliente']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_sales_detail_reporte_cliente_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sales_detail_reporte_cliente']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_sales_detail_reporte_cliente')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_sales_detail_reporte_cliente', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
