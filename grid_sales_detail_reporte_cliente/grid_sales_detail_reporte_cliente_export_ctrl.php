<?php
@session_start() ;
$_SESSION['scriptcase']['grid_sales_detail_reporte_cliente']['sc_process_barr'] = true;
require_once('../grid_sales_detail_reporte_cliente/index.php');
unset($_SESSION['scriptcase']['grid_sales_detail_reporte_cliente']['sc_process_barr']);
$ExportCtrl = new grid_sales_detail_reporte_cliente_export_control;
$ExportCtrl->Export_barr();

class grid_sales_detail_reporte_cliente_export_control
{
