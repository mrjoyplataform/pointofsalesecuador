...
<?php
   ...
   $Ord_Cmp = new grid_sales_detail_reporte_cliente_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_sales_detail_reporte_cliente_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id_sales"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["id_sales"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["id_sales"] : "Id Sales";
   $tab_ger_campos['fechatrans'] = "on";
   $tab_def_campos['fechatrans'] = "fechatrans";
   $tab_labels["fechatrans"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["fechatrans"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["fechatrans"] : "Fechatrans";
   $tab_ger_campos['codproducto'] = "on";
   $tab_def_campos['codproducto'] = "codproducto";
   $tab_labels["codproducto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["codproducto"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["codproducto"] : "Codproducto";
   $tab_ger_campos['producto'] = "on";
   $tab_def_campos['producto'] = "producto";
   $tab_labels["producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["producto"] : "Producto";
   $tab_ger_campos['quantity'] = "on";
   $tab_def_campos['quantity'] = "quantity";
   $tab_labels["quantity"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["quantity"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["quantity"] : "Quantity";
   $tab_ger_campos['item_total'] = "on";
   $tab_def_campos['item_total'] = "item_total";
   $tab_labels["item_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["item_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["item_total"] : "Item Total";
   $tab_ger_campos['valor_siniva'] = "on";
   $tab_def_campos['valor_siniva'] = "valor_siniva";
   $tab_labels["valor_siniva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["valor_siniva"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["valor_siniva"] : "Valor Siniva";
   $tab_ger_campos['valor_unitario'] = "on";
   $tab_def_campos['valor_unitario'] = "valor_unitario";
   $tab_labels["valor_unitario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["valor_unitario"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["valor_unitario"] : "Valor Unitario";
   $tab_ger_campos['cuentaventa'] = "on";
   $tab_def_campos['cuentaventa'] = "cuentaventa";
   $tab_labels["cuentaventa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["cuentaventa"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["cuentaventa"] : "Cuentaventa";
   $tab_ger_campos['idcaja'] = "on";
   $tab_def_campos['idcaja'] = "idcaja";
   $tab_labels["idcaja"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["idcaja"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["idcaja"] : "Idcaja";
   $tab_ger_campos['factura'] = "on";
   $tab_def_campos['factura'] = "factura";
   $tab_labels["factura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["factura"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["factura"] : "Factura";
   $tab_ger_campos['uniqueid'] = "on";
   $tab_def_campos['uniqueid'] = "uniqueid";
   $tab_labels["uniqueid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["uniqueid"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["uniqueid"] : "Uniqueid";
   $tab_ger_campos['entrada'] = "on";
   $tab_def_campos['entrada'] = "entrada";
   $tab_labels["entrada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["entrada"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["entrada"] : "Entrada";
   $tab_ger_campos['jugador'] = "on";
   $tab_def_campos['jugador'] = "jugador";
   $tab_labels["jugador"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["jugador"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["jugador"] : "Jugador";
   $tab_ger_campos['visitante'] = "on";
   $tab_def_campos['visitante'] = "visitante";
   $tab_labels["visitante"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["visitante"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["visitante"] : "Visitante";
   $tab_ger_campos['tarjeta'] = "on";
   $tab_def_campos['tarjeta'] = "tarjeta";
   $tab_labels["tarjeta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["tarjeta"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["tarjeta"] : "Tarjeta";
   $tab_ger_campos['tokens'] = "on";
   $tab_def_campos['tokens'] = "tokens";
   $tab_labels["tokens"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["tokens"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["tokens"] : "Tokens";
   $tab_ger_campos['minutos'] = "on";
   $tab_def_campos['minutos'] = "minutos";
   $tab_labels["minutos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["minutos"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["minutos"] : "Minutos";
   $tab_ger_campos['comida'] = "on";
   $tab_def_campos['comida'] = "comida";
   $tab_labels["comida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["comida"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["comida"] : "Comida";
   $tab_ger_campos['tarjetarfid'] = "on";
   $tab_def_campos['tarjetarfid'] = "tarjetarfid";
   $tab_labels["tarjetarfid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["tarjetarfid"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["tarjetarfid"] : "Tarjetarfid";
   $tab_ger_campos['rfid_pulsera'] = "on";
   $tab_def_campos['rfid_pulsera'] = "rfid_pulsera";
   $tab_labels["rfid_pulsera"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["rfid_pulsera"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['labels']["rfid_pulsera"] : "Rfid Pulsera";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_sales_detail_reporte_cliente_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_sales_detail_reporte_cliente']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
