<?php
//
class form_devices_leds_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_devices_leds_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_devices_leds_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_devices_leds_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_devices_leds_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_devices_leds_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_devices_leds_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_devices_leds_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_devices_leds_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_devices_leds_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_devices_leds_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_devices_leds_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_devices_leds_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_devices_leds_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_devices_leds_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_devices_leds_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_devices_leds_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_devices_leds_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_devices_leds_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_devices_leds_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_devices_leds_mob']['upload_field_info']['foto1'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_devices_leds_mob',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_devices_leds_mob']['upload_field_info']['foto2'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_devices_leds_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_devices_leds_mob']['upload_field_info']['foto3'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_devices_leds_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_devices_leds_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_devices_leds_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_devices_leds_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_devices_leds_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_devices_leds_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_devices_leds_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " devices";
      ...
      $_SESSION['scriptcase']['error_icon']['form_devices_leds_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_devices_leds_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['upload_field_ul_name'][$this->foto1_ul_name]))
          {
              $this->NM_ajax_info['param']['foto1_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['upload_field_ul_name'][$this->foto1_ul_name];
          }
      ...
      elseif (isset($this->foto1_ul_name) && '' != $this->foto1_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['upload_field_ul_name'][$this->foto1_ul_name]))
          {
              $this->foto1_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['upload_field_ul_name'][$this->foto1_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['upload_field_ul_name'][$this->foto2_ul_name]))
          {
              $this->NM_ajax_info['param']['foto2_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['upload_field_ul_name'][$this->foto2_ul_name];
          }
      ...
      elseif (isset($this->foto2_ul_name) && '' != $this->foto2_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['upload_field_ul_name'][$this->foto2_ul_name]))
          {
              $this->foto2_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['upload_field_ul_name'][$this->foto2_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['upload_field_ul_name'][$this->foto3_ul_name]))
          {
              $this->NM_ajax_info['param']['foto3_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['upload_field_ul_name'][$this->foto3_ul_name];
          }
      ...
      elseif (isset($this->foto3_ul_name) && '' != $this->foto3_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['upload_field_ul_name'][$this->foto3_ul_name]))
          {
              $this->foto3_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['upload_field_ul_name'][$this->foto3_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_devices_leds_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_devices_leds_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_devices_leds_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['dados_form'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_devices_leds_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_devices_leds/form_devices_leds_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_devices_leds_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_devices_leds_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_devices_leds_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_devices_leds/form_devices_leds_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_devices_leds_mob_erro.class.php"); 
      }
      $this->Erro      = new form_devices_leds_mob_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['sc_max_reg']) == "all")
      {
      ...
      if ($this->nmgp_opcao == "fast_search")  
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['opcao']))
         { 
             if ($this->cod_device != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_devices_leds_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      ...
      if ($this->nmgp_opcao == "incluir" || $this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "excluir") 
      {
          ...
          $this->cod_grupo = sc_strip_script($this->cod_grupo, $_SESSION['scriptcase']['charset']);
          $this->cod_grupo = sc_strip_tags($this->cod_grupo, $_SESSION['scriptcase']['charset']);
          ...
          $this->ult_rfid = sc_strip_script($this->ult_rfid, $_SESSION['scriptcase']['charset']);
          $this->ult_rfid = sc_strip_tags($this->ult_rfid, $_SESSION['scriptcase']['charset']);
          ...
          $this->serialrfid = sc_strip_script($this->serialrfid, $_SESSION['scriptcase']['charset']);
          $this->serialrfid = sc_strip_tags($this->serialrfid, $_SESSION['scriptcase']['charset']);
          $this->url_1 = sc_strip_script($this->url_1, $_SESSION['scriptcase']['charset']);
          $this->url_1 = sc_strip_tags($this->url_1, $_SESSION['scriptcase']['charset']);
          $this->url_2 = sc_strip_script($this->url_2, $_SESSION['scriptcase']['charset']);
          $this->url_2 = sc_strip_tags($this->url_2, $_SESSION['scriptcase']['charset']);
          $this->url_3 = sc_strip_script($this->url_3, $_SESSION['scriptcase']['charset']);
          $this->url_3 = sc_strip_tags($this->url_3, $_SESSION['scriptcase']['charset']);
          $this->rfid_read = sc_strip_script($this->rfid_read, $_SESSION['scriptcase']['charset']);
          $this->rfid_read = sc_strip_tags($this->rfid_read, $_SESSION['scriptcase']['charset']);
          $this->url_accion = sc_strip_script($this->url_accion, $_SESSION['scriptcase']['charset']);
          $this->url_accion = sc_strip_tags($this->url_accion, $_SESSION['scriptcase']['charset']);
          $this->url_atraccion = sc_strip_script($this->url_atraccion, $_SESSION['scriptcase']['charset']);
          $this->url_atraccion = sc_strip_tags($this->url_atraccion, $_SESSION['scriptcase']['charset']);
          $this->uhfip = sc_strip_script($this->uhfip, $_SESSION['scriptcase']['charset']);
          $this->uhfip = sc_strip_tags($this->uhfip, $_SESSION['scriptcase']['charset']);
          $this->url_reader = sc_strip_script($this->url_reader, $_SESSION['scriptcase']['charset']);
          $this->url_reader = sc_strip_tags($this->url_reader, $_SESSION['scriptcase']['charset']);
          $this->cod_rfid900 = sc_strip_script($this->cod_rfid900, $_SESSION['scriptcase']['charset']);
          $this->cod_rfid900 = sc_strip_tags($this->cod_rfid900, $_SESSION['scriptcase']['charset']);
          $this->mensaje = sc_strip_script($this->mensaje, $_SESSION['scriptcase']['charset']);
          $this->mensaje = sc_strip_tags($this->mensaje, $_SESSION['scriptcase']['charset']);
          $this->tipolector = sc_strip_script($this->tipolector, $_SESSION['scriptcase']['charset']);
          $this->tipolector = sc_strip_tags($this->tipolector, $_SESSION['scriptcase']['charset']);
          $this->url_accion_bg = sc_strip_script($this->url_accion_bg, $_SESSION['scriptcase']['charset']);
          $this->url_accion_bg = sc_strip_tags($this->url_accion_bg, $_SESSION['scriptcase']['charset']);
          $this->url_inicio = sc_strip_script($this->url_inicio, $_SESSION['scriptcase']['charset']);
          $this->url_inicio = sc_strip_tags($this->url_inicio, $_SESSION['scriptcase']['charset']);
          $this->ledstripe1 = sc_strip_script($this->ledstripe1, $_SESSION['scriptcase']['charset']);
          $this->ledstripe1 = sc_strip_tags($this->ledstripe1, $_SESSION['scriptcase']['charset']);
          $this->ledstripe2 = sc_strip_script($this->ledstripe2, $_SESSION['scriptcase']['charset']);
          $this->ledstripe2 = sc_strip_tags($this->ledstripe2, $_SESSION['scriptcase']['charset']);
          $this->ledstripe3 = sc_strip_script($this->ledstripe3, $_SESSION['scriptcase']['charset']);
          $this->ledstripe3 = sc_strip_tags($this->ledstripe3, $_SESSION['scriptcase']['charset']);
          $this->ledstripe4 = sc_strip_script($this->ledstripe4, $_SESSION['scriptcase']['charset']);
          $this->ledstripe4 = sc_strip_tags($this->ledstripe4, $_SESSION['scriptcase']['charset']);
          $this->lasteffect = sc_strip_script($this->lasteffect, $_SESSION['scriptcase']['charset']);
          $this->lasteffect = sc_strip_tags($this->lasteffect, $_SESSION['scriptcase']['charset']);
          $this->color = sc_strip_script($this->color, $_SESSION['scriptcase']['charset']);
          $this->color = sc_strip_tags($this->color, $_SESSION['scriptcase']['charset']);
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_devices_leds_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_devices_leds_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_devices_leds_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_devices_leds_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
    ...
    function ValidateField_activa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->activa, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Activa; " ; 
                  if (!isset($Campos_Erros['activa']))
    ...
    function ValidateField_valor_default(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->valor_default, 17, 2, -0, 1.0E+19, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_acepta_tiempo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->acepta_tiempo, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_acepta_tokens(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->acepta_tokens, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_tipo_dev(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->tipo_dev, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_direccion_torno(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->direccion_torno, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_timeout_rfid(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->timeout_rfid, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_discapacitado(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->discapacitado, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_numcaja(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->numcaja, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Numcaja; " ; 
                  if (!isset($Campos_Erros['numcaja']))
    ...
    function ValidateField_empleado(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->empleado, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_tokens(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->tokens, 17, 2, -0, 1.0E+19, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Tokens; " ; 
                  if (!isset($Campos_Erros['tokens']))
    ...
    function ValidateField_bidireccion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->bidireccion, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_cod_devicee(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->cod_devicee, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_rfid_estado(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->rfid_estado, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $hasError = true;
...
//--------------------------------------------------------------------------------------
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'form_devices_leds_mob_doc_name.php';
              }
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['dados_form']['foto1']) && $this->foto1_limpa != "S")
          {
              $this->foto1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['dados_form']['foto1'];
          }
      } 
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['dados_form']['foto2']) && $this->foto2_limpa != "S")
          {
              $this->foto2 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['dados_form']['foto2'];
          }
      } 
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['dados_form']['foto3']) && $this->foto3_limpa != "S")
          {
              $this->foto3 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['dados_form']['foto3'];
          }
      } 
   }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['cod_device']['keyVal'] = form_devices_leds_mob_pack_protect_string($this->nmgp_dados_form['cod_device']);
          }
   } // ajax_return_values
   ...
   $out_foto1 = '';
   $out1_foto1 = '';
   if ('' != $this->foto1_ul_name && @is_file($this->Ini->root . $this->Ini->path_imag_temp . '/' . $this->foto1_ul_name))
   {
       $this->foto1 = @file_get_contents($this->Ini->root . $this->Ini->path_imag_temp . '/' . $this->foto1_ul_name);
   }
   ...
   $out_foto2 = '';
   $out1_foto2 = '';
   if ('' != $this->foto2_ul_name && @is_file($this->Ini->root . $this->Ini->path_imag_temp . '/' . $this->foto2_ul_name))
   {
       $this->foto2 = @file_get_contents($this->Ini->root . $this->Ini->path_imag_temp . '/' . $this->foto2_ul_name);
   }
   ...
   $out_foto3 = '';
   $out1_foto3 = '';
   if ('' != $this->foto3_ul_name && @is_file($this->Ini->root . $this->Ini->path_imag_temp . '/' . $this->foto3_ul_name))
   {
       $this->foto3 = @file_get_contents($this->Ini->root . $this->Ini->path_imag_temp . '/' . $this->foto3_ul_name);
   }
   ...
   function ajax_return_values_color($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['foto1_salva'] = array(
                      'row'     => '',
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              { 
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (cod_activo, cod_grupo, device_name, estado, ult_rfid, ult_fecha, acepta_tiempo, acepta_tokens, dev_ip, timeout_rfid, discapacitado, numcaja, empleado, serialrfid, bidireccion, cod_deviceE, url_1, url_2, url_3, foto1, foto2, foto3, pin_relay1, pin_relay2, rfid_read, rfid_estado, rfid_fecha, url_accion, url_atraccion, uhfip, url_reader, cod_rfid900, mensaje, url_accion_bg, url_inicio, ledstripe1, ledstripe2, ledstripe3, ledstripe4, lasteffect, color $compl_insert) VALUES ('$this->cod_activo', '$this->cod_grupo', '$this->device_name', $this->estado, '$this->ult_rfid', " . $this->Ini->date_delim . $this->ult_fecha . $this->Ini->date_delim1 . ", $this->acepta_tiempo, $this->acepta_tokens, '$this->dev_ip', $this->timeout_rfid, $this->discapacitado, $this->numcaja, $this->empleado, '$this->serialrfid', $this->bidireccion, $this->cod_devicee, '$this->url_1', '$this->url_2', '$this->url_3', '', '', '', $this->pin_relay1, $this->pin_relay2, '$this->rfid_read', $this->rfid_estado, '$this->rfid_fecha', '$this->url_accion', '$this->url_atraccion', '$this->uhfip', '$this->url_reader', '$this->cod_rfid900', '$this->mensaje', '$this->url_accion_bg', '$this->url_inicio', '$this->ledstripe1', '$this->ledstripe2', '$this->ledstripe3', '$this->ledstripe4', '$this->lasteffect', '$this->color' $compl_insert_val)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $compl_insert     = ""; 
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              {
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "cod_activo, cod_grupo, device_name, estado, ult_rfid, ult_fecha, acepta_tiempo, acepta_tokens, dev_ip, timeout_rfid, discapacitado, numcaja, empleado, serialrfid, bidireccion, cod_deviceE, url_1, url_2, url_3, foto1, foto2, foto3, pin_relay1, pin_relay2, rfid_read, rfid_estado, rfid_fecha, url_accion, url_atraccion, uhfip, url_reader, cod_rfid900, mensaje, url_accion_bg, url_inicio, ledstripe1, ledstripe2, ledstripe3, ledstripe4, lasteffect, color $compl_insert) VALUES (" . $NM_seq_auto . "'$this->cod_activo', '$this->cod_grupo', '$this->device_name', $this->estado, '$this->ult_rfid', " . $this->Ini->date_delim . $this->ult_fecha . $this->Ini->date_delim1 . ", $this->acepta_tiempo, $this->acepta_tokens, '$this->dev_ip', $this->timeout_rfid, $this->discapacitado, $this->numcaja, $this->empleado, '$this->serialrfid', $this->bidireccion, $this->cod_devicee, '$this->url_1', '$this->url_2', '$this->url_3', EMPTY_BLOB(), EMPTY_BLOB(), EMPTY_BLOB(), $this->pin_relay1, $this->pin_relay2, '$this->rfid_read', $this->rfid_estado, TO_DATE('$this->rfid_fecha', 'yyyy-mm-dd hh24:mi:ss'), '$this->url_accion', '$this->url_atraccion', '$this->uhfip', '$this->url_reader', '$this->cod_rfid900', '$this->mensaje', '$this->url_accion_bg', '$this->url_inicio', '$this->ledstripe1', '$this->ledstripe2', '$this->ledstripe3', '$this->ledstripe4', '$this->lasteffect', '$this->color' $compl_insert_val)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  $compl_insert     = ""; 
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "cod_activo, cod_grupo, device_name, estado, ult_rfid, ult_fecha, acepta_tiempo, acepta_tokens, dev_ip, timeout_rfid, discapacitado, numcaja, empleado, serialrfid, bidireccion, cod_deviceE, url_1, url_2, url_3, foto1, foto2, foto3, pin_relay1, pin_relay2, rfid_read, rfid_estado, rfid_fecha, url_accion, url_atraccion, uhfip, url_reader, cod_rfid900, mensaje, url_accion_bg, url_inicio, ledstripe1, ledstripe2, ledstripe3, ledstripe4, lasteffect, color $compl_insert) VALUES (" . $NM_seq_auto . "'$this->cod_activo', '$this->cod_grupo', '$this->device_name', $this->estado, '$this->ult_rfid', EXTEND('$this->ult_fecha', YEAR TO FRACTION), $this->acepta_tiempo, $this->acepta_tokens, '$this->dev_ip', $this->timeout_rfid, $this->discapacitado, $this->numcaja, $this->empleado, '$this->serialrfid', $this->bidireccion, $this->cod_devicee, '$this->url_1', '$this->url_2', '$this->url_3', null, null, null, $this->pin_relay1, $this->pin_relay2, '$this->rfid_read', $this->rfid_estado, '$this->rfid_fecha', '$this->url_accion', '$this->url_atraccion', '$this->uhfip', '$this->url_reader', '$this->cod_rfid900', '$this->mensaje', '$this->url_accion_bg', '$this->url_inicio', '$this->ledstripe1', '$this->ledstripe2', '$this->ledstripe3', '$this->ledstripe4', '$this->lasteffect', '$this->color' $compl_insert_val)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
              {
                  $compl_insert     = ""; 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['parms'] = "cod_device?#?$this->cod_device?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_devices_leds_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['total'] = $qt_geral_reg_form_devices_leds_mob;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->cod_device))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_devices_leds_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_start'] > $qt_geral_reg_form_devices_leds_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_start'] = $qt_geral_reg_form_devices_leds_mob; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_devices_leds_mob) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_start']) ;  
              } 
          } 
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['parms'] = "cod_device?#?$this->cod_device?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['sub_dir'][0]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['sub_dir'][1]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['sub_dir'][2]  = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_start'] < $qt_geral_reg_form_devices_leds_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['reg_start'] + 1;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
       ...
       if (isset($temp_out_foto3))
       {
        ...
        $this->initFormPages();
    include_once("form_devices_leds_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['table_refresh'])
        {
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_devices_leds_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['total'] = $qt_geral_reg_form_devices_leds_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_devices_leds_mob_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_devices_leds_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_devices_leds_mob_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['masterValue']))
{
...
<?php
  exit;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['ordem_ord'] == " desc") {
