  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_devices_leds_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_devices_leds_mob_form();
	}
...
?>
  ...
  // ---------- Validate cod_device
  function do_ajax_form_devices_leds_mob_validate_cod_device()
  {
    var nomeCampo_cod_device = "cod_device";
    var var_cod_device = scAjaxGetFieldHidden(nomeCampo_cod_device);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_cod_device(var_cod_device, var_script_case_init, do_ajax_form_devices_leds_mob_validate_cod_device_cb);
  } // do_ajax_form_devices_leds_mob_validate_cod_device

  function do_ajax_form_devices_leds_mob_validate_cod_device_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_cod_device_cb

  // ---------- Validate cod_activo
  function do_ajax_form_devices_leds_mob_validate_cod_activo()
  {
    var nomeCampo_cod_activo = "cod_activo";
    var var_cod_activo = scAjaxGetFieldText(nomeCampo_cod_activo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_cod_activo(var_cod_activo, var_script_case_init, do_ajax_form_devices_leds_mob_validate_cod_activo_cb);
  } // do_ajax_form_devices_leds_mob_validate_cod_activo

  function do_ajax_form_devices_leds_mob_validate_cod_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_cod_activo_cb

  // ---------- Validate cod_grupo
  function do_ajax_form_devices_leds_mob_validate_cod_grupo()
  {
    var nomeCampo_cod_grupo = "cod_grupo";
    var var_cod_grupo = scAjaxGetFieldText(nomeCampo_cod_grupo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_cod_grupo(var_cod_grupo, var_script_case_init, do_ajax_form_devices_leds_mob_validate_cod_grupo_cb);
  } // do_ajax_form_devices_leds_mob_validate_cod_grupo

  function do_ajax_form_devices_leds_mob_validate_cod_grupo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_cod_grupo_cb

  // ---------- Validate device_name
  function do_ajax_form_devices_leds_mob_validate_device_name()
  {
    var nomeCampo_device_name = "device_name";
    var var_device_name = scAjaxGetFieldText(nomeCampo_device_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_device_name(var_device_name, var_script_case_init, do_ajax_form_devices_leds_mob_validate_device_name_cb);
  } // do_ajax_form_devices_leds_mob_validate_device_name

  function do_ajax_form_devices_leds_mob_validate_device_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_device_name_cb

  // ---------- Validate activa
  function do_ajax_form_devices_leds_mob_validate_activa()
  {
    var nomeCampo_activa = "activa";
    var var_activa = scAjaxGetFieldText(nomeCampo_activa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_activa(var_activa, var_script_case_init, do_ajax_form_devices_leds_mob_validate_activa_cb);
  } // do_ajax_form_devices_leds_mob_validate_activa

  function do_ajax_form_devices_leds_mob_validate_activa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_activa_cb

  // ---------- Validate estado
  function do_ajax_form_devices_leds_mob_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldText(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_estado(var_estado, var_script_case_init, do_ajax_form_devices_leds_mob_validate_estado_cb);
  } // do_ajax_form_devices_leds_mob_validate_estado

  function do_ajax_form_devices_leds_mob_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_estado_cb

  // ---------- Validate ult_rfid
  function do_ajax_form_devices_leds_mob_validate_ult_rfid()
  {
    var nomeCampo_ult_rfid = "ult_rfid";
    var var_ult_rfid = scAjaxGetFieldText(nomeCampo_ult_rfid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_ult_rfid(var_ult_rfid, var_script_case_init, do_ajax_form_devices_leds_mob_validate_ult_rfid_cb);
  } // do_ajax_form_devices_leds_mob_validate_ult_rfid

  function do_ajax_form_devices_leds_mob_validate_ult_rfid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_ult_rfid_cb

  // ---------- Validate ult_fecha
  function do_ajax_form_devices_leds_mob_validate_ult_fecha()
  {
    var nomeCampo_ult_fecha = "ult_fecha";
    var var_ult_fecha = scAjaxGetFieldText(nomeCampo_ult_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_ult_fecha(var_ult_fecha, var_script_case_init, do_ajax_form_devices_leds_mob_validate_ult_fecha_cb);
  } // do_ajax_form_devices_leds_mob_validate_ult_fecha

  function do_ajax_form_devices_leds_mob_validate_ult_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_ult_fecha_cb

  // ---------- Validate valor_default
  function do_ajax_form_devices_leds_mob_validate_valor_default()
  {
    var nomeCampo_valor_default = "valor_default";
    var var_valor_default = scAjaxGetFieldText(nomeCampo_valor_default);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_valor_default(var_valor_default, var_script_case_init, do_ajax_form_devices_leds_mob_validate_valor_default_cb);
  } // do_ajax_form_devices_leds_mob_validate_valor_default

  function do_ajax_form_devices_leds_mob_validate_valor_default_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_valor_default_cb

  // ---------- Validate acepta_tiempo
  function do_ajax_form_devices_leds_mob_validate_acepta_tiempo()
  {
    var nomeCampo_acepta_tiempo = "acepta_tiempo";
    var var_acepta_tiempo = scAjaxGetFieldText(nomeCampo_acepta_tiempo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_acepta_tiempo(var_acepta_tiempo, var_script_case_init, do_ajax_form_devices_leds_mob_validate_acepta_tiempo_cb);
  } // do_ajax_form_devices_leds_mob_validate_acepta_tiempo

  function do_ajax_form_devices_leds_mob_validate_acepta_tiempo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_acepta_tiempo_cb

  // ---------- Validate acepta_tokens
  function do_ajax_form_devices_leds_mob_validate_acepta_tokens()
  {
    var nomeCampo_acepta_tokens = "acepta_tokens";
    var var_acepta_tokens = scAjaxGetFieldText(nomeCampo_acepta_tokens);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_acepta_tokens(var_acepta_tokens, var_script_case_init, do_ajax_form_devices_leds_mob_validate_acepta_tokens_cb);
  } // do_ajax_form_devices_leds_mob_validate_acepta_tokens

  function do_ajax_form_devices_leds_mob_validate_acepta_tokens_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_acepta_tokens_cb

  // ---------- Validate dev_ip
  function do_ajax_form_devices_leds_mob_validate_dev_ip()
  {
    var nomeCampo_dev_ip = "dev_ip";
    var var_dev_ip = scAjaxGetFieldText(nomeCampo_dev_ip);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_dev_ip(var_dev_ip, var_script_case_init, do_ajax_form_devices_leds_mob_validate_dev_ip_cb);
  } // do_ajax_form_devices_leds_mob_validate_dev_ip

  function do_ajax_form_devices_leds_mob_validate_dev_ip_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dev_ip";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_dev_ip_cb

  // ---------- Validate tipo_dev
  function do_ajax_form_devices_leds_mob_validate_tipo_dev()
  {
    var nomeCampo_tipo_dev = "tipo_dev";
    var var_tipo_dev = scAjaxGetFieldText(nomeCampo_tipo_dev);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_tipo_dev(var_tipo_dev, var_script_case_init, do_ajax_form_devices_leds_mob_validate_tipo_dev_cb);
  } // do_ajax_form_devices_leds_mob_validate_tipo_dev

  function do_ajax_form_devices_leds_mob_validate_tipo_dev_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_tipo_dev_cb

  // ---------- Validate direccion_torno
  function do_ajax_form_devices_leds_mob_validate_direccion_torno()
  {
    var nomeCampo_direccion_torno = "direccion_torno";
    var var_direccion_torno = scAjaxGetFieldText(nomeCampo_direccion_torno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_direccion_torno(var_direccion_torno, var_script_case_init, do_ajax_form_devices_leds_mob_validate_direccion_torno_cb);
  } // do_ajax_form_devices_leds_mob_validate_direccion_torno

  function do_ajax_form_devices_leds_mob_validate_direccion_torno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_direccion_torno_cb

  // ---------- Validate timeout_rfid
  function do_ajax_form_devices_leds_mob_validate_timeout_rfid()
  {
    var nomeCampo_timeout_rfid = "timeout_rfid";
    var var_timeout_rfid = scAjaxGetFieldText(nomeCampo_timeout_rfid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_timeout_rfid(var_timeout_rfid, var_script_case_init, do_ajax_form_devices_leds_mob_validate_timeout_rfid_cb);
  } // do_ajax_form_devices_leds_mob_validate_timeout_rfid

  function do_ajax_form_devices_leds_mob_validate_timeout_rfid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_timeout_rfid_cb

  // ---------- Validate discapacitado
  function do_ajax_form_devices_leds_mob_validate_discapacitado()
  {
    var nomeCampo_discapacitado = "discapacitado";
    var var_discapacitado = scAjaxGetFieldText(nomeCampo_discapacitado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_discapacitado(var_discapacitado, var_script_case_init, do_ajax_form_devices_leds_mob_validate_discapacitado_cb);
  } // do_ajax_form_devices_leds_mob_validate_discapacitado

  function do_ajax_form_devices_leds_mob_validate_discapacitado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_discapacitado_cb

  // ---------- Validate numcaja
  function do_ajax_form_devices_leds_mob_validate_numcaja()
  {
    var nomeCampo_numcaja = "numcaja";
    var var_numcaja = scAjaxGetFieldText(nomeCampo_numcaja);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_numcaja(var_numcaja, var_script_case_init, do_ajax_form_devices_leds_mob_validate_numcaja_cb);
  } // do_ajax_form_devices_leds_mob_validate_numcaja

  function do_ajax_form_devices_leds_mob_validate_numcaja_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numcaja";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_numcaja_cb

  // ---------- Validate empleado
  function do_ajax_form_devices_leds_mob_validate_empleado()
  {
    var nomeCampo_empleado = "empleado";
    var var_empleado = scAjaxGetFieldText(nomeCampo_empleado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_empleado(var_empleado, var_script_case_init, do_ajax_form_devices_leds_mob_validate_empleado_cb);
  } // do_ajax_form_devices_leds_mob_validate_empleado

  function do_ajax_form_devices_leds_mob_validate_empleado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_empleado_cb

  // ---------- Validate tokens
  function do_ajax_form_devices_leds_mob_validate_tokens()
  {
    var nomeCampo_tokens = "tokens";
    var var_tokens = scAjaxGetFieldText(nomeCampo_tokens);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_tokens(var_tokens, var_script_case_init, do_ajax_form_devices_leds_mob_validate_tokens_cb);
  } // do_ajax_form_devices_leds_mob_validate_tokens

  function do_ajax_form_devices_leds_mob_validate_tokens_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tokens";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_tokens_cb

  // ---------- Validate serialrfid
  function do_ajax_form_devices_leds_mob_validate_serialrfid()
  {
    var nomeCampo_serialrfid = "serialrfid";
    var var_serialrfid = scAjaxGetFieldText(nomeCampo_serialrfid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_serialrfid(var_serialrfid, var_script_case_init, do_ajax_form_devices_leds_mob_validate_serialrfid_cb);
  } // do_ajax_form_devices_leds_mob_validate_serialrfid

  function do_ajax_form_devices_leds_mob_validate_serialrfid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_serialrfid_cb

  // ---------- Validate bidireccion
  function do_ajax_form_devices_leds_mob_validate_bidireccion()
  {
    var nomeCampo_bidireccion = "bidireccion";
    var var_bidireccion = scAjaxGetFieldText(nomeCampo_bidireccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_bidireccion(var_bidireccion, var_script_case_init, do_ajax_form_devices_leds_mob_validate_bidireccion_cb);
  } // do_ajax_form_devices_leds_mob_validate_bidireccion

  function do_ajax_form_devices_leds_mob_validate_bidireccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_bidireccion_cb

  // ---------- Validate cod_devicee
  function do_ajax_form_devices_leds_mob_validate_cod_devicee()
  {
    var nomeCampo_cod_devicee = "cod_devicee";
    var var_cod_devicee = scAjaxGetFieldText(nomeCampo_cod_devicee);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_cod_devicee(var_cod_devicee, var_script_case_init, do_ajax_form_devices_leds_mob_validate_cod_devicee_cb);
  } // do_ajax_form_devices_leds_mob_validate_cod_devicee

  function do_ajax_form_devices_leds_mob_validate_cod_devicee_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_cod_devicee_cb

  // ---------- Validate url_1
  function do_ajax_form_devices_leds_mob_validate_url_1()
  {
    var nomeCampo_url_1 = "url_1";
    var var_url_1 = scAjaxGetFieldText(nomeCampo_url_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_url_1(var_url_1, var_script_case_init, do_ajax_form_devices_leds_mob_validate_url_1_cb);
  } // do_ajax_form_devices_leds_mob_validate_url_1

  function do_ajax_form_devices_leds_mob_validate_url_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "url_1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_url_1_cb

  // ---------- Validate url_2
  function do_ajax_form_devices_leds_mob_validate_url_2()
  {
    var nomeCampo_url_2 = "url_2";
    var var_url_2 = scAjaxGetFieldText(nomeCampo_url_2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_url_2(var_url_2, var_script_case_init, do_ajax_form_devices_leds_mob_validate_url_2_cb);
  } // do_ajax_form_devices_leds_mob_validate_url_2

  function do_ajax_form_devices_leds_mob_validate_url_2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "url_2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_url_2_cb

  // ---------- Validate url_3
  function do_ajax_form_devices_leds_mob_validate_url_3()
  {
    var nomeCampo_url_3 = "url_3";
    var var_url_3 = scAjaxGetFieldText(nomeCampo_url_3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_url_3(var_url_3, var_script_case_init, do_ajax_form_devices_leds_mob_validate_url_3_cb);
  } // do_ajax_form_devices_leds_mob_validate_url_3

  function do_ajax_form_devices_leds_mob_validate_url_3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "url_3";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_url_3_cb

  // ---------- Validate foto1
  function do_ajax_form_devices_leds_mob_validate_foto1()
  {
    var nomeCampo_foto1 = "foto1";
    var var_foto1 = scAjaxGetFieldText(nomeCampo_foto1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_foto1(var_foto1, var_script_case_init, do_ajax_form_devices_leds_mob_validate_foto1_cb);
  } // do_ajax_form_devices_leds_mob_validate_foto1

  function do_ajax_form_devices_leds_mob_validate_foto1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "foto1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_foto1_cb

  // ---------- Validate foto2
  function do_ajax_form_devices_leds_mob_validate_foto2()
  {
    var nomeCampo_foto2 = "foto2";
    var var_foto2 = scAjaxGetFieldText(nomeCampo_foto2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_foto2(var_foto2, var_script_case_init, do_ajax_form_devices_leds_mob_validate_foto2_cb);
  } // do_ajax_form_devices_leds_mob_validate_foto2

  function do_ajax_form_devices_leds_mob_validate_foto2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "foto2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_foto2_cb

  // ---------- Validate foto3
  function do_ajax_form_devices_leds_mob_validate_foto3()
  {
    var nomeCampo_foto3 = "foto3";
    var var_foto3 = scAjaxGetFieldText(nomeCampo_foto3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_foto3(var_foto3, var_script_case_init, do_ajax_form_devices_leds_mob_validate_foto3_cb);
  } // do_ajax_form_devices_leds_mob_validate_foto3

  function do_ajax_form_devices_leds_mob_validate_foto3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "foto3";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_foto3_cb

  // ---------- Validate pin_relay1
  function do_ajax_form_devices_leds_mob_validate_pin_relay1()
  {
    var nomeCampo_pin_relay1 = "pin_relay1";
    var var_pin_relay1 = scAjaxGetFieldText(nomeCampo_pin_relay1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_pin_relay1(var_pin_relay1, var_script_case_init, do_ajax_form_devices_leds_mob_validate_pin_relay1_cb);
  } // do_ajax_form_devices_leds_mob_validate_pin_relay1

  function do_ajax_form_devices_leds_mob_validate_pin_relay1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_pin_relay1_cb

  // ---------- Validate pin_relay2
  function do_ajax_form_devices_leds_mob_validate_pin_relay2()
  {
    var nomeCampo_pin_relay2 = "pin_relay2";
    var var_pin_relay2 = scAjaxGetFieldText(nomeCampo_pin_relay2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_pin_relay2(var_pin_relay2, var_script_case_init, do_ajax_form_devices_leds_mob_validate_pin_relay2_cb);
  } // do_ajax_form_devices_leds_mob_validate_pin_relay2

  function do_ajax_form_devices_leds_mob_validate_pin_relay2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_pin_relay2_cb

  // ---------- Validate rfid_read
  function do_ajax_form_devices_leds_mob_validate_rfid_read()
  {
    var nomeCampo_rfid_read = "rfid_read";
    var var_rfid_read = scAjaxGetFieldText(nomeCampo_rfid_read);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_rfid_read(var_rfid_read, var_script_case_init, do_ajax_form_devices_leds_mob_validate_rfid_read_cb);
  } // do_ajax_form_devices_leds_mob_validate_rfid_read

  function do_ajax_form_devices_leds_mob_validate_rfid_read_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_rfid_read_cb

  // ---------- Validate rfid_estado
  function do_ajax_form_devices_leds_mob_validate_rfid_estado()
  {
    var nomeCampo_rfid_estado = "rfid_estado";
    var var_rfid_estado = scAjaxGetFieldText(nomeCampo_rfid_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_rfid_estado(var_rfid_estado, var_script_case_init, do_ajax_form_devices_leds_mob_validate_rfid_estado_cb);
  } // do_ajax_form_devices_leds_mob_validate_rfid_estado

  function do_ajax_form_devices_leds_mob_validate_rfid_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_rfid_estado_cb

  // ---------- Validate rfid_fecha
  function do_ajax_form_devices_leds_mob_validate_rfid_fecha()
  {
    var nomeCampo_rfid_fecha = "rfid_fecha";
    var var_rfid_fecha = scAjaxGetFieldText(nomeCampo_rfid_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_rfid_fecha(var_rfid_fecha, var_script_case_init, do_ajax_form_devices_leds_mob_validate_rfid_fecha_cb);
  } // do_ajax_form_devices_leds_mob_validate_rfid_fecha

  function do_ajax_form_devices_leds_mob_validate_rfid_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_rfid_fecha_cb

  // ---------- Validate url_accion
  function do_ajax_form_devices_leds_mob_validate_url_accion()
  {
    var nomeCampo_url_accion = "url_accion";
    var var_url_accion = scAjaxGetFieldText(nomeCampo_url_accion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_url_accion(var_url_accion, var_script_case_init, do_ajax_form_devices_leds_mob_validate_url_accion_cb);
  } // do_ajax_form_devices_leds_mob_validate_url_accion

  function do_ajax_form_devices_leds_mob_validate_url_accion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_url_accion_cb

  // ---------- Validate url_atraccion
  function do_ajax_form_devices_leds_mob_validate_url_atraccion()
  {
    var nomeCampo_url_atraccion = "url_atraccion";
    var var_url_atraccion = scAjaxGetFieldText(nomeCampo_url_atraccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_url_atraccion(var_url_atraccion, var_script_case_init, do_ajax_form_devices_leds_mob_validate_url_atraccion_cb);
  } // do_ajax_form_devices_leds_mob_validate_url_atraccion

  function do_ajax_form_devices_leds_mob_validate_url_atraccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_url_atraccion_cb

  // ---------- Validate uhfip
  function do_ajax_form_devices_leds_mob_validate_uhfip()
  {
    var nomeCampo_uhfip = "uhfip";
    var var_uhfip = scAjaxGetFieldText(nomeCampo_uhfip);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_uhfip(var_uhfip, var_script_case_init, do_ajax_form_devices_leds_mob_validate_uhfip_cb);
  } // do_ajax_form_devices_leds_mob_validate_uhfip

  function do_ajax_form_devices_leds_mob_validate_uhfip_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "uhfip";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_uhfip_cb

  // ---------- Validate url_reader
  function do_ajax_form_devices_leds_mob_validate_url_reader()
  {
    var nomeCampo_url_reader = "url_reader";
    var var_url_reader = scAjaxGetFieldText(nomeCampo_url_reader);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_url_reader(var_url_reader, var_script_case_init, do_ajax_form_devices_leds_mob_validate_url_reader_cb);
  } // do_ajax_form_devices_leds_mob_validate_url_reader

  function do_ajax_form_devices_leds_mob_validate_url_reader_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_url_reader_cb

  // ---------- Validate cod_rfid900
  function do_ajax_form_devices_leds_mob_validate_cod_rfid900()
  {
    var nomeCampo_cod_rfid900 = "cod_rfid900";
    var var_cod_rfid900 = scAjaxGetFieldText(nomeCampo_cod_rfid900);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_cod_rfid900(var_cod_rfid900, var_script_case_init, do_ajax_form_devices_leds_mob_validate_cod_rfid900_cb);
  } // do_ajax_form_devices_leds_mob_validate_cod_rfid900

  function do_ajax_form_devices_leds_mob_validate_cod_rfid900_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_cod_rfid900_cb

  // ---------- Validate mensaje
  function do_ajax_form_devices_leds_mob_validate_mensaje()
  {
    var nomeCampo_mensaje = "mensaje";
    var var_mensaje = scAjaxGetFieldText(nomeCampo_mensaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_mensaje(var_mensaje, var_script_case_init, do_ajax_form_devices_leds_mob_validate_mensaje_cb);
  } // do_ajax_form_devices_leds_mob_validate_mensaje

  function do_ajax_form_devices_leds_mob_validate_mensaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mensaje";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_mensaje_cb

  // ---------- Validate tipolector
  function do_ajax_form_devices_leds_mob_validate_tipolector()
  {
    var nomeCampo_tipolector = "tipolector";
    var var_tipolector = scAjaxGetFieldText(nomeCampo_tipolector);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_tipolector(var_tipolector, var_script_case_init, do_ajax_form_devices_leds_mob_validate_tipolector_cb);
  } // do_ajax_form_devices_leds_mob_validate_tipolector

  function do_ajax_form_devices_leds_mob_validate_tipolector_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_tipolector_cb

  // ---------- Validate url_accion_bg
  function do_ajax_form_devices_leds_mob_validate_url_accion_bg()
  {
    var nomeCampo_url_accion_bg = "url_accion_bg";
    var var_url_accion_bg = scAjaxGetFieldText(nomeCampo_url_accion_bg);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_url_accion_bg(var_url_accion_bg, var_script_case_init, do_ajax_form_devices_leds_mob_validate_url_accion_bg_cb);
  } // do_ajax_form_devices_leds_mob_validate_url_accion_bg

  function do_ajax_form_devices_leds_mob_validate_url_accion_bg_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_url_accion_bg_cb

  // ---------- Validate url_inicio
  function do_ajax_form_devices_leds_mob_validate_url_inicio()
  {
    var nomeCampo_url_inicio = "url_inicio";
    var var_url_inicio = scAjaxGetFieldText(nomeCampo_url_inicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_url_inicio(var_url_inicio, var_script_case_init, do_ajax_form_devices_leds_mob_validate_url_inicio_cb);
  } // do_ajax_form_devices_leds_mob_validate_url_inicio

  function do_ajax_form_devices_leds_mob_validate_url_inicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_url_inicio_cb

  // ---------- Validate ledstripe1
  function do_ajax_form_devices_leds_mob_validate_ledstripe1()
  {
    var nomeCampo_ledstripe1 = "ledstripe1";
    var var_ledstripe1 = scAjaxGetFieldText(nomeCampo_ledstripe1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_ledstripe1(var_ledstripe1, var_script_case_init, do_ajax_form_devices_leds_mob_validate_ledstripe1_cb);
  } // do_ajax_form_devices_leds_mob_validate_ledstripe1

  function do_ajax_form_devices_leds_mob_validate_ledstripe1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_ledstripe1_cb

  // ---------- Validate ledstripe2
  function do_ajax_form_devices_leds_mob_validate_ledstripe2()
  {
    var nomeCampo_ledstripe2 = "ledstripe2";
    var var_ledstripe2 = scAjaxGetFieldText(nomeCampo_ledstripe2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_ledstripe2(var_ledstripe2, var_script_case_init, do_ajax_form_devices_leds_mob_validate_ledstripe2_cb);
  } // do_ajax_form_devices_leds_mob_validate_ledstripe2

  function do_ajax_form_devices_leds_mob_validate_ledstripe2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_ledstripe2_cb

  // ---------- Validate ledstripe3
  function do_ajax_form_devices_leds_mob_validate_ledstripe3()
  {
    var nomeCampo_ledstripe3 = "ledstripe3";
    var var_ledstripe3 = scAjaxGetFieldText(nomeCampo_ledstripe3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_ledstripe3(var_ledstripe3, var_script_case_init, do_ajax_form_devices_leds_mob_validate_ledstripe3_cb);
  } // do_ajax_form_devices_leds_mob_validate_ledstripe3

  function do_ajax_form_devices_leds_mob_validate_ledstripe3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_ledstripe3_cb

  // ---------- Validate ledstripe4
  function do_ajax_form_devices_leds_mob_validate_ledstripe4()
  {
    var nomeCampo_ledstripe4 = "ledstripe4";
    var var_ledstripe4 = scAjaxGetFieldText(nomeCampo_ledstripe4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_ledstripe4(var_ledstripe4, var_script_case_init, do_ajax_form_devices_leds_mob_validate_ledstripe4_cb);
  } // do_ajax_form_devices_leds_mob_validate_ledstripe4

  function do_ajax_form_devices_leds_mob_validate_ledstripe4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_ledstripe4_cb

  // ---------- Validate lasteffect
  function do_ajax_form_devices_leds_mob_validate_lasteffect()
  {
    var nomeCampo_lasteffect = "lasteffect";
    var var_lasteffect = scAjaxGetFieldText(nomeCampo_lasteffect);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_lasteffect(var_lasteffect, var_script_case_init, do_ajax_form_devices_leds_mob_validate_lasteffect_cb);
  } // do_ajax_form_devices_leds_mob_validate_lasteffect

  function do_ajax_form_devices_leds_mob_validate_lasteffect_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_lasteffect_cb

  // ---------- Validate color
  function do_ajax_form_devices_leds_mob_validate_color()
  {
    var nomeCampo_color = "color";
    var var_color = scAjaxGetFieldText(nomeCampo_color);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_leds_mob_validate_color(var_color, var_script_case_init, do_ajax_form_devices_leds_mob_validate_color_cb);
  } // do_ajax_form_devices_leds_mob_validate_color

  function do_ajax_form_devices_leds_mob_validate_color_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "color";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_leds_mob_validate_color_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_devices_leds_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_devices_leds_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_devices_leds_mob_submit_form(var_cod_device, var_cod_activo, var_cod_grupo, var_device_name, var_activa, var_estado, var_ult_rfid, var_ult_fecha, var_valor_default, var_acepta_tiempo, var_acepta_tokens, var_dev_ip, var_tipo_dev, var_direccion_torno, var_timeout_rfid, var_discapacitado, var_numcaja, var_empleado, var_tokens, var_serialrfid, var_bidireccion, var_cod_devicee, var_url_1, var_url_2, var_url_3, var_foto1, var_foto2, var_foto3, var_pin_relay1, var_pin_relay2, var_rfid_read, var_rfid_estado, var_rfid_fecha, var_url_accion, var_url_atraccion, var_uhfip, var_url_reader, var_cod_rfid900, var_mensaje, var_tipolector, var_url_accion_bg, var_url_inicio, var_ledstripe1, var_ledstripe2, var_ledstripe3, var_ledstripe4, var_lasteffect, var_color, var_foto1_ul_name, var_foto1_ul_type, var_foto2_ul_name, var_foto2_ul_type, var_foto3_ul_name, var_foto3_ul_type, var_foto1_limpa, var_foto2_limpa, var_foto3_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_devices_leds_mob_submit_form_cb);
  } // do_ajax_form_devices_leds_mob_submit_form

  function do_ajax_form_devices_leds_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_devices_leds_mob_submit_form_cb_after_alert);
  } // do_ajax_form_devices_leds_mob_submit_form_cb
  function do_ajax_form_devices_leds_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_devices_leds_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_devices_leds_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_devices_leds_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_devices_leds_mob_navigate_form();
    }
  }

  function perform_ajax_form_devices_leds_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_devices_leds_mob_navigate_form(var_cod_device, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_devices_leds_mob_navigate_form_cb);
  } // do_ajax_form_devices_leds_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_leds_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_devices_leds_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_devices_leds_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_devices_leds_mob_navigate_form_cb
  function do_ajax_form_devices_leds_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_devices_leds_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_devices_leds_mob_navigate_form_cb_after_alert

  function sc_hide_form_devices_leds_mob_form()
  {
