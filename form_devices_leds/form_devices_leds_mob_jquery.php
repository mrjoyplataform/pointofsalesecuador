...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_ult_fecha_hora' + iSeqRow).bind('blur', function() { sc_form_devices_leds_ult_fecha_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_devices_leds_ult_fecha_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_rfid_fecha_hora' + iSeqRow).bind('blur', function() { sc_form_devices_leds_rfid_fecha_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_devices_leds_rfid_fecha_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_devices_leds_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_ult_fecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_devices_leds_mob_validate_ult_fecha(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_rfid_fecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_devices_leds_mob_validate_rfid_fecha(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_foto1" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_devices_leds_mob_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_devices_leds_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
