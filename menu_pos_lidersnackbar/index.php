<?php
include_once('menu_pos_lidersnackbar_session.php');
...
$_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_path_prod']      = "";
$_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_perfil']         = "conn_pos";
$_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_path_imag_temp'] = "";
$_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_usa_grupo']      = "";
...
//check prod
if(empty($_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_path_prod']))
{
   /*check prod*/$_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
}
//check tmp
if(empty($_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_path_imag_temp']))
{
   /*check tmp*/$_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
}
...
class menu_pos_lidersnackbar_class
{
  var $Db;
 ...
 function menu_pos_lidersnackbar_menu()
 {
    global $menu_pos_lidersnackbar_menuData;
...
$nm_versao_sc  = "" ; 
$_SESSION['scriptcase']['menu_pos_lidersnackbar']['contr_erro'] = 'off';
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menu_pos_lidersnackbar'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menu_pos_lidersnackbar'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menu_pos_lidersnackbar'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_path_prod'] . "/third";
$url_third      = $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "menu_pos_lidersnackbar/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$path_lib_php   = $str_root . $path_link . "_lib/lib/php";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_path_imag_temp'];
$menu_largura   = '250';
$menu_mobile_hide          = 'S';
...
if(function_exists('set_php_timezone')) set_php_timezone('menu_pos_lidersnackbar');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/menu_pos_lidersnackbar_erro.php");
}
include_once(dirname(__FILE__) . "/menu_pos_lidersnackbar_erro.class.php"); 
$this->Erro = new menu_pos_lidersnackbar_erro();
$str_path = substr($_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_conexao']);
}
/* Definiciones de las rutas */
$menu_pos_lidersnackbar_menuData          = array();
$menu_pos_lidersnackbar_menuData['path']  = array();
$menu_pos_lidersnackbar_menuData['url']   = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menu_pos_lidersnackbar_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menu_pos_lidersnackbar_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menu_pos_lidersnackbar_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menu_pos_lidersnackbar_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menu_pos_lidersnackbar_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menu_pos_lidersnackbar_menuData['url']['web']   = str_replace("\\", '/', $menu_pos_lidersnackbar_menuData['url']['web']);
$menu_pos_lidersnackbar_menuData['path']['root'] = substr($menu_pos_lidersnackbar_menuData['path']['sys'],  0, -1 * strlen($menu_pos_lidersnackbar_menuData['url']['web']));
$menu_pos_lidersnackbar_menuData['path']['app']  = substr($menu_pos_lidersnackbar_menuData['path']['sys'],  0, strrpos($menu_pos_lidersnackbar_menuData['path']['sys'],  '/'));
$menu_pos_lidersnackbar_menuData['path']['link'] = substr($menu_pos_lidersnackbar_menuData['path']['app'],  0, strrpos($menu_pos_lidersnackbar_menuData['path']['app'],  '/'));
$menu_pos_lidersnackbar_menuData['path']['link'] = substr($menu_pos_lidersnackbar_menuData['path']['link'], 0, strrpos($menu_pos_lidersnackbar_menuData['path']['link'], '/')) . '/';
$menu_pos_lidersnackbar_menuData['path']['app'] .= '/';
$menu_pos_lidersnackbar_menuData['url']['app']   = substr($menu_pos_lidersnackbar_menuData['url']['web'],  0, strrpos($menu_pos_lidersnackbar_menuData['url']['web'],  '/'));
$menu_pos_lidersnackbar_menuData['url']['link']  = substr($menu_pos_lidersnackbar_menuData['url']['app'],  0, strrpos($menu_pos_lidersnackbar_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_usa_grupo'] == "S")
{
    $menu_pos_lidersnackbar_menuData['url']['link']  = substr($menu_pos_lidersnackbar_menuData['url']['link'], 0, strrpos($menu_pos_lidersnackbar_menuData['url']['link'], '/'));
}
$menu_pos_lidersnackbar_menuData['url']['link']  .= '/';
$menu_pos_lidersnackbar_menuData['url']['app']   .= '/';

$_SESSION['scriptcase']['menu_pos_lidersnackbar']['sc_apl_link'] = $menu_pos_lidersnackbar_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['menu_pos_lidersnackbar']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['menu_pos_lidersnackbar']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['menu_pos_lidersnackbar']['actual_lang']) || $_SESSION['scriptcase']['menu_pos_lidersnackbar']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['menu_pos_lidersnackbar']['actual_lang'] = $this->str_lang;
...
if ($_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_usa_grupo'] != "S")
{
    ...
    $_SESSION['scriptcase']['menu_atual'] = "menu_pos_lidersnackbar";
    $_SESSION['scriptcase']['menu_apls']['menu_pos_lidersnackbar'] = array();
    if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
    {
        foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
        {
            if (isset($_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_conexao']) && $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_conexao'] == $NM_con_orig)
            {
/*NM*/          $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_conexao'] = $NM_con_dest;
            }
            if (isset($_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_perfil']) && $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_perfil'] == $NM_con_orig)
            {
/*NM*/          $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_perfil'] = $NM_con_dest;
            }
            if (isset($_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_con_' . $NM_con_orig]))
            {
                $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_con_' . $NM_con_orig] = $NM_con_dest;
            }
        }
    }
...
if (isset($_SESSION['scriptcase']['menu_pos_lidersnackbar']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['menu_pos_lidersnackbar']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['menu_pos_lidersnackbar']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['menu_pos_lidersnackbar']['session_timeout']);
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['menu_pos_lidersnackbar']['session_timeout']['redir']))
{
...
if (isset($script_case_init))
{
    $_SESSION['sc_session'][1]['menu_pos_lidersnackbar']['init'] = $script_case_init;
}
elseif (!isset($_SESSION['sc_session'][1]['menu_pos_lidersnackbar']['init']))
{
    $_SESSION['sc_session'][1]['menu_pos_lidersnackbar']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menu_pos_lidersnackbar']['init'];
...
{
    if(function_exists("nm_check_perfil_exists")) nm_check_perfil_exists($path_libs, $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_path_prod']);
    $_SESSION['sc_session'][1]['SC_Check_Perfil'] = true;
}
$nm_falta_var    = ""; 
$nm_falta_var_db = ""; 
if (isset($_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_conexao']))
{
    db_conect_devel($_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_path_prod'], 'pointofsales', 2); 
}
if (isset($_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_perfil']))
{
   $_SESSION['scriptcase']['glo_perfil'] = $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_perfil'];
}
...
if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
{
    ...
    if (strlen($SC_temp) == 2)
    {
       $_SESSION['scriptcase']['menu_pos_lidersnackbar']['SC_sep_date']  = substr($SC_temp, 0, 1); 
       $_SESSION['scriptcase']['menu_pos_lidersnackbar']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
   }
   else
    {
       $_SESSION['scriptcase']['menu_pos_lidersnackbar']['SC_sep_date']  = $SC_temp; 
       $_SESSION['scriptcase']['menu_pos_lidersnackbar']['SC_sep_date1'] = $SC_temp; 
   }
}
...
if (!empty($nm_falta_var) || !empty($nm_falta_var_db))
{
    ...
    { 
        if (isset($_SESSION['sc_session'][1]['menu_pos_lidersnackbar']['sc_outra_jan']) && $_SESSION['sc_session'][1]['menu_pos_lidersnackbar']['sc_outra_jan'])
        {
...
if (in_array(strtolower($nm_tpbanco), $this->nm_bases_oracle))
{
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['menu_pos_lidersnackbar']['decimal_db'] = ".";
} 
//
$this->NM_gera_log_insert("Scriptcase", "access");
if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menu_pos_lidersnackbar'))
{
    $_SESSION['sc_session'][1]['menu_pos_lidersnackbar']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menu_pos_lidersnackbar'] = "javascript:window.close()";
}

/* Menú de configuración de las variables */
$menu_pos_lidersnackbar_menuData['iframe'] = TRUE;

$menu_pos_lidersnackbar_menuData['height'] = '100%';
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_product_snackbar") . "/grid_product_snackbar_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_product_snackbar']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_product_snackbar'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="menu_pos_lidersnackbar_message.js"></script>
...
?> 
        ...
        <script  type="text/javascript">
                        ...
                        $(document).ready(function () {
                                ...
                                $('#css3menut').jstree({
                                        'state' : { 'key' : 'menu_pos_lidersnackbar', 'filter' : function (k) { delete k.core.selected; return k; } },
                                        'plugins' : [ 'state']
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[1]))
{
 ...
 $nm_var_lab[2] = "Detalle de ventas por producto";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[2]))
{
 ...
 $nm_var_lab[3] = "Ventas por forma pago";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[4]))
{
 ...
 $nm_var_lab[5] = "Gráfica venta por producto";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[5]))
{
 ...
 $nm_var_lab[6] = "Reporte de Facturas";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[6]))
{
 ...
 $nm_var_lab[7] = "Detalle de productos y clientes";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[9]))
{
 ...
 $nm_var_lab[10] = "Listado de productos";
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_pos_lidersnackbar'];
$menu_pos_lidersnackbar_menuData['data'] = array();
$nextLevelToBeWrite = false;
$str_disabled = "N";
$str_link = "menu_pos_lidersnackbar_form_php.php?sc_item_menu=item_69&sc_apl_menu=dashboard&sc_apl_link=" . urlencode($menu_pos_lidersnackbar_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['dashboard']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['dashboard']) != "on")
{
    ...
    $menu_pos_lidersnackbar_menuData['data'][] = array(
        ...
        'target'   => " item-target=\"" . $this->menu_pos_lidersnackbar_target('_self') . "\"",
        'sc_id'    => "item_69",
...
$str_disabled = "N";
$str_link = "menu_pos_lidersnackbar_form_php.php?sc_item_menu=item_70&sc_apl_menu=grid_sales_detail_reporte&sc_apl_link=" . urlencode($menu_pos_lidersnackbar_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_usa_grupo'] . "";
...
$str_disabled = "N";
$str_link = "menu_pos_lidersnackbar_form_php.php?sc_item_menu=item_10&sc_apl_menu=grid_sales&sc_apl_link=" . urlencode($menu_pos_lidersnackbar_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_usa_grupo'] . "";
...
$str_disabled = "N";
$str_link = "menu_pos_lidersnackbar_form_php.php?sc_item_menu=item_19&sc_apl_menu=chart_sales&sc_apl_link=" . urlencode($menu_pos_lidersnackbar_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_usa_grupo'] . "";
...
$str_disabled = "N";
$str_link = "menu_pos_lidersnackbar_form_php.php?sc_item_menu=item_60&sc_apl_menu=chart_view_sales_detail_group_todo&sc_apl_link=" . urlencode($menu_pos_lidersnackbar_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_usa_grupo'] . "";
...
$str_disabled = "N";
$str_link = "menu_pos_lidersnackbar_form_php.php?sc_item_menu=item_46&sc_apl_menu=grid_v_ele_reporte_facturas&sc_apl_link=" . urlencode($menu_pos_lidersnackbar_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_usa_grupo'] . "";
...
$str_disabled = "N";
$str_link = "menu_pos_lidersnackbar_form_php.php?sc_item_menu=item_71&sc_apl_menu=grid_detail_sales_todo&sc_apl_link=" . urlencode($menu_pos_lidersnackbar_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_usa_grupo'] . "";
...
$str_disabled = "N";
$str_link = "menu_pos_lidersnackbar_form_php.php?sc_item_menu=item_72&sc_apl_menu=grid_product_snackbar&sc_apl_link=" . urlencode($menu_pos_lidersnackbar_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_product_snackbar']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_product_snackbar']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
...
$str_disabled = "N";
$str_link = "menu_pos_lidersnackbar_form_php.php?sc_item_menu=item_52&sc_apl_menu=grid_product_listado&sc_apl_link=" . urlencode($menu_pos_lidersnackbar_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_usa_grupo'] . "";
...
$str_disabled = "N";
$str_link = "menu_pos_lidersnackbar_form_php.php?sc_item_menu=item_73&sc_apl_menu=grid_purchase_reporte&sc_apl_link=" . urlencode($menu_pos_lidersnackbar_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_usa_grupo'] . "";
...
$str_disabled = "N";
$str_link = "menu_pos_lidersnackbar_form_php.php?sc_item_menu=item_13&sc_apl_menu=grid_view_movim_inventario&sc_apl_link=" . urlencode($menu_pos_lidersnackbar_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_usa_grupo'] . "";
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_pos_lidersnackbar']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['menu_pos_lidersnackbar']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'menu_pos_lidersnackbar');
    $menu_pos_lidersnackbar_menuData['data'] = $str_menu_usu;
}
if (is_file("menu_pos_lidersnackbar_help.txt"))
{
    $Arq_WebHelp = file("menu_pos_lidersnackbar_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menu_pos_lidersnackbar_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->menu_pos_lidersnackbar_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'  => "text",
                    'display_position'    => "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menu_pos_lidersnackbar']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menu_pos_lidersnackbar']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($menu_pos_lidersnackbar_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['menu_pos_lidersnackbar']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($menu_pos_lidersnackbar_menuData['data'][$i_menu]);
       }
    ...
    $menu_pos_lidersnackbar_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['menu_pos_lidersnackbar']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menu_pos_lidersnackbar']))
{
    $disable_menu = false;
    foreach ($menu_pos_lidersnackbar_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['menu_pos_lidersnackbar']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $menu_pos_lidersnackbar_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
<?php
    ...
    { 
    $_SESSION['scriptcase']['menu_pos_lidersnackbar']['apl_inicial'] = "";
    $link_default = " onclick=\"openMenuItem('iframe_menu_pos_lidersnackbar');\" item-href=\"menu_pos_lidersnackbar_form_php.php?sc_item_menu=menu_pos_lidersnackbar&sc_apl_menu=dashboard_sucursal_odoo&sc_apl_link=" . urlencode($menu_pos_lidersnackbar_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_pos_lidersnackbar_iframe\"";
    } 
    else
    { 
        $_SESSION['scriptcase']['menu_pos_lidersnackbar']['apl_inicial'] = ($NM_scr_iframe != "") ? $NM_scr_iframe : "menu_pos_lidersnackbar_pag_ini.php";
    } 
    $_SESSION['scriptcase']['menu_pos_lidersnackbar']['path_link'] = $path_link;
?>
        ...
        <td class="scMenuTTableM" valign="top">
                <table cellpadding=0 cellspacing=0>
                    <tr>
                       <td>
                      <?php
                      echo $this->menu_pos_lidersnackbar_escreveMenu($menu_pos_lidersnackbar_menuData['data']);
                      ?>
                            </td>
                    </tr>
                </table>
...
<div class="ui-layout-center">
  <table cellspacing=0 cellpadding=0 style="height: 100%; width: 100%" cellpadding=0 cellspacing=0>
    ...
    $(document).ready(function () {
        ...
        <iframe name="menu_pos_lidersnackbar_iframe" id="iframe_menu_pos_lidersnackbar" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;" src="<?php echo $_SESSION['scriptcase']['menu_pos_lidersnackbar']['apl_inicial']?>"<?php echo $link_default ?>></iframe>
<?php
?>
        </td>
      </tr>
...
Iframe_atual = "menu_pos_lidersnackbar_iframe";
...
<?php
 $seq = 0;
echo "Tab_iframes[" . $seq . "] = \"menu_pos_lidersnackbar\";\r\n";
echo "Tab_labels['menu_pos_lidersnackbar'] = \"Dashboard General\";\r\n";
echo "Tab_hints['menu_pos_lidersnackbar'] = \"Dashboard General\";\r\n";
echo "Tab_abas['menu_pos_lidersnackbar']   = \"none\";\r\n";
echo "Tab_refresh['menu_pos_lidersnackbar']   = \"\";\r\n";
echo "Tab_icons['menu_pos_lidersnackbar'] = \"scriptcase__NM__ico__NM__sc_menu_home_e.png\";\r\n";
echo "Tab_icons_inactive['menu_pos_lidersnackbar'] = \"scriptcase__NM__ico__NM__sc_menu_home_d.png\";\r\n";
echo "Tab_icon_fa['menu_pos_lidersnackbar']   = \"\";\r\n";
echo "Tab_icon_fa_inactive['menu_pos_lidersnackbar']   = \"\";\r\n";
echo "Tab_display['menu_pos_lidersnackbar']   = \"\";\r\n";
echo "Tab_display_position['menu_pos_lidersnackbar']   = \"\";\r\n";
echo "Tab_links['menu_pos_lidersnackbar']   = \"\";\r\n";
         $seq++;
 if(isset($menu_pos_lidersnackbar_menuData['data']) && !empty($menu_pos_lidersnackbar_menuData['data']))
 {
   foreach ($menu_pos_lidersnackbar_menuData['data'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
 ...
 if(isset($menu_pos_lidersnackbar_menuData['data_vertical']) && !empty($menu_pos_lidersnackbar_menuData['data_vertical']))
 {
   foreach ($menu_pos_lidersnackbar_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         if(empty($dados_menu['hint']))
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl)
{
    ...
    iframe.name = 'menu_pos_lidersnackbar_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    var home_style="";
    if(str_id === 'menu_pos_lidersnackbar'){ home_style=";padding-left:4px;min-height:14px;"; }
...
if(str_id !== 'menu_pos_lidersnackbar'){
...
{
    $('#iframe_menu_pos_lidersnackbar').hide();
    if (Aba_atual != "")
    {
    ...
    if (str_id == "")
    {
        $('#iframe_menu_pos_lidersnackbar').show();
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            {
                $('#Iframe_control').append('<iframe id="iframe_'+ Tab_iframes[i] +'" name="menu_pos_lidersnackbar_'+ Tab_iframes[i] +'_iframe" frameborder="0" class="scMenuIframe" style="display: none; width: 100%; height: 100%;" src=""></iframe>');
            }
            ...
            if (Tab_iframes[i] != 'menu_pos_lidersnackbar') 
            {
                Iframe_atual = "menu_pos_lidersnackbar_" + Tab_iframes[i] + '_iframe';
            }
...
{
    if(str_id === 'menu_pos_lidersnackbar') { return false; }
    ...
    if (Aba_atual == str_id)
    {
        ...
        if (str_id == "" && Aba_atual != "menu_pos_lidersnackbar")
        {
            document.getElementById('iframe_menu_pos_lidersnackbar').click();
        }
        else
        {
            mudaIframe(str_id);
...
{
  str_target_sv = "";
  if (str_id != "iframe_menu_pos_lidersnackbar")
  {
      str_target_sv = str_id + "_iframe";
      str_id        = str_id.replace("menu_pos_lidersnackbar_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_menu_pos_lidersnackbar', 'menu_pos_lidersnackbar');
    if (str_target == "menu_pos_lidersnackbar_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
    ...
    if(str_target != '_blank' && $('#iframe_menu_pos_lidersnackbar').length)
        $('#iframe_menu_pos_lidersnackbar')[0].contentWindow.focus();
  }
}
<?php
if (isset($link_default) && !empty($link_default))
{
    echo "   document.getElementById('iframe_menu_pos_lidersnackbar').click();\r\n";
}
?>
</script>
</body>
...
/* Control de Target */
function menu_pos_lidersnackbar_escreveMenu($arr_menu)
{
    $aMenuItemList = array();
            ...
            <?php
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    ?>
                    <li <?php echo $iconHtml; ?> class="scMenuTItems scMenuTItem" style="<?php echo $li_style; ?>"><a href="javascript:" onclick="openMenuItem('menu_pos_lidersnackbar_<?php echo $aMenuItemList[$i]['id']; ?>'); <?php echo $focusFrame; ?>" item-href="<?php echo $aMenuItemList[$i]['link']; ?>" id="<?php echo $aMenuItemList[$i]['id']; ?>" title="<?php echo $aMenuItemList[$i]['hint']; ?>"<?php echo $aMenuItemList[$i]['target']; ?> class="scMenuTItem"><?php echo $aMenuItemList[$i]['label']; ?></a>
                    <?php
                  }
                }
                if ($aMenuItemList[$i + 1] && $aMenuItemList[$i]['level'] == $aMenuItemList[$i + 1]['level']) {
...
/* Control de Target */
   function menu_pos_lidersnackbar_target($str_target)
   {
       global $menu_pos_lidersnackbar_menuData;
       ...
       elseif ($menu_pos_lidersnackbar_menuData['iframe'])
       {
           return 'menu_pos_lidersnackbar_iframe';
       }
       else
       {
           return $str_target;
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "javascript:parent.nm_out_menu('menu_pos_lidersnackbar_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_pos_lidersnackbar_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_usa_grupo'] . "')";  
               }
               else
               {
                    $str_line['link'] = "menu_pos_lidersnackbar_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_pos_lidersnackbar_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_usa_grupo'] . ""; 
               }
           }
           elseif ($arr_item['target'] == '_parent')
           {
               $str_line['link'] = "javascript:parent.nm_out_menu('" . $_SESSION['scriptcase']['sc_saida_menu_pos_lidersnackbar'] . "')"; 
           }
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->menu_pos_lidersnackbar_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['menu_pos_lidersnackbar']['sc_init'][$apl_menu] = rand(2, 10000);
        $_SESSION['sc_session'][$_SESSION['scriptcase']['menu_pos_lidersnackbar']['sc_init'][$apl_menu]] = array();
        return  $_SESSION['scriptcase']['menu_pos_lidersnackbar']['sc_init'][$apl_menu];
   }
...
//
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['scriptcase']['menu_pos_lidersnackbar']['SC_sep_date']) && !empty($_SESSION['scriptcase']['menu_pos_lidersnackbar']['SC_sep_date']))
       {
           $delim  = $_SESSION['scriptcase']['menu_pos_lidersnackbar']['SC_sep_date'];
           $delim1 = $_SESSION['scriptcase']['menu_pos_lidersnackbar']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'menu_pos_lidersnackbar', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'menu_pos_lidersnackbar', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'menu_pos_lidersnackbar', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_path_imag_temp'] . "/sc_apl_default_pointofsales.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu_pos_lidersnackbar']['glo_nm_path_imag_temp'] . "/sc_apl_default_pointofsales.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "menu_pos_lidersnackbar") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['menu_pos_lidersnackbar']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['menu_pos_lidersnackbar']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['menu_pos_lidersnackbar']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_pointofsales'])) {
            $_SESSION['scriptcase']['menu_pos_lidersnackbar']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_pointofsales'];
        }
    }
}
...
$contr_menu_pos_lidersnackbar = new menu_pos_lidersnackbar_class;
$contr_menu_pos_lidersnackbar->menu_pos_lidersnackbar_menu();
