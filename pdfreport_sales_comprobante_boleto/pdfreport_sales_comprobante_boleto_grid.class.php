<?php
class pdfreport_sales_comprobante_boleto_grid
{
   var $Ini;
   var $Erro;
   var $Pdf;
...
//
   ...
   $_SESSION['scriptcase']['pdfreport_sales_comprobante_boleto']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("pdfreport_sales_comprobante_boleto", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_sales_comprobante_boleto']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_sales_comprobante_boleto']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_sales_comprobante_boleto']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_sales_comprobante_boleto']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['where_pesq'];  
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['id_sales'] = "Id Sales";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['sales_price'] = "Sales Price";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['sales_discount'] = "Sales Discount";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['total'] = "Total";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['datesales'] = "Datesales";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['id_status'] = "Id Status";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['idcaja'] = "Idcaja";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['idcliente'] = "Idcliente";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['cliente'] = "Cliente";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['direccion'] = "Direccion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['telefono'] = "Telefono";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['factura'] = "Factura";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['serie'] = "Serie";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['clave_acceso'] = "Clave Acceso";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['enviosri'] = "Enviosri";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['fechaenvio'] = "Fechaenvio";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['uniqueid'] = "Uniqueid";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['estado'] = "Estado";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['fechaid'] = "Fechaid";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['importe_recibido'] = "Importe Recibido";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['codigoid'] = "Codigoid";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['totalsinimpuestos'] = "Total Sin Impuestos";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['totaldescuento'] = "Total Descuento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['baseimponible'] = "Base Imponible";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['valoriva'] = "Valoriva";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['importetotal'] = "Importe Total";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['idpago'] = "Idpago";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['totalpago'] = "Totalpago";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['cliente_email'] = "Cliente Email";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['idempleado'] = "Idempleado";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['idturno'] = "Idturno";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['facturaxml'] = "Facturaxml";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['facturaxml64'] = "Facturaxml 64";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['codpago_sri'] = "Codpago Sri";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['lineas'] = "lineas";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['lineas_item_total'] = "Item Total";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['lineas_producto'] = "Producto";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['lineas_quantity'] = "Quantity";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['labels']['logo'] = "logo";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_sales_comprobante_boleto']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_sales_comprobante_boleto']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_sales_comprobante_boleto']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf->AddPage();
      $this->Pdf_init();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['qt_col_grid']) 
      {  
          ...
          { 
            ...
            $cell_datesales = array('posx' => '41.802579166661396', 'posy' => '16.10050437499797', 'data' => $this->datesales[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '7', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_idcliente = array('posx' => '3.8702720833328454', 'posy' => '28.658343749996387', 'data' => $this->idcliente[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '7', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_cliente = array('posx' => '4.1371308333328125', 'posy' => '34.953574999995595', 'data' => $this->cliente[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '7', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_direccion = array('posx' => '3.873288333332846', 'posy' => '41.7740041666614', 'data' => $this->direccion[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '7', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_telefono = array('posx' => '42.787358333327944', 'posy' => '29.011827083329678', 'data' => $this->telefono[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '7', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_uniqueid = array('posx' => '14.94969916666478', 'posy' => '55.621237499992986', 'data' => $this->uniqueid[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_cliente_email = array('posx' => '4.135622708332812', 'posy' => '48.6849208333272', 'data' => $this->cliente_email[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '7', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_lineas_quantity = array('posx' => '6', 'posy' => '109.72985208331949', 'data' => $this->lineas_quantity[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '8', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            $cell_lineas_item_total = array('posx' => '60', 'posy' => '109.72985208331949', 'data' => $this->lineas_item_total[$this->nm_grid_colunas], 'width'      => '3', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '8', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            $cell_lineas_producto = array('posx' => '10', 'posy' => '109.72985208331949', 'data' => $this->lineas_producto[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '7', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            $cell_logo = array('posx' => '19.261137499997574', 'posy' => '-0.2645833333333', 'data' => $this->logo[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => '12', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_serie = array('posx' => '4.478363958332769', 'posy' => '16.648456458331232', 'data' => $this->serie[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '7', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_autorizacion = array('posx' => '3.9574787499995008', 'posy' => '23.0036687499971', 'data' => $this->clave_acceso[$this->nm_grid_colunas], 'width'      => '0', 'align'      => 'L', 'font_type'  => 'helvetica', 'font_size'  => '7', 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $this->Pdf->SetY(109.72985208331949);
   ...
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0, $opc="")
   {
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['iframe_print']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_sales_comprobante_boleto']['iframe_print'] )
      {
          $target = "_parent";
      }
   ?>
