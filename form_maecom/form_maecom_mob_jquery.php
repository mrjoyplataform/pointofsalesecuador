...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_fecfact31_hora' + iSeqRow).bind('blur', function() { sc_form_maecom_fecfact31_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_maecom_fecfact31_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_fecped31_hora' + iSeqRow).bind('blur', function() { sc_form_maecom_fecped31_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_maecom_fecped31_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_fecdocpr31_hora' + iSeqRow).bind('blur', function() { sc_form_maecom_fecdocpr31_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_maecom_fecdocpr31_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_fecvencidocpr_hora' + iSeqRow).bind('blur', function() { sc_form_maecom_fecvencidocpr_onblur(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_maecom_fecvencidocpr_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_maecom_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecfact31" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_maecom_mob_validate_fecfact31(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fecped31" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_maecom_mob_validate_fecped31(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fectrasfer31" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_maecom_mob_validate_fectrasfer31(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fecdocpr31" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_maecom_mob_validate_fecdocpr31(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fecvencidocpr" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_maecom_mob_validate_fecvencidocpr(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fecemb" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_maecom_mob_validate_fecemb(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_maecom_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
