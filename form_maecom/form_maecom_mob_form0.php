...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_maecom/form_maecom_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_maecom_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_maecom_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['form_maecom']['error_buffer']) && '' != $_SESSION['scriptcase']['form_maecom']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_maecom']['error_buffer'];
}
...
<?php
 include_once("form_maecom_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_maecom_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_maecom_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_maecom_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
?>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tipodocto31_line" id="hidden_field_data_tipodocto31" style="<?php echo $sStyleHidden_tipodocto31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipodocto31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tipodocto31_label" style=""><span id="id_label_tipodocto31"><?php echo $this->nm_new_label['tipodocto31']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['tipodocto31']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['tipodocto31'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nofact31_line" id="hidden_field_data_nofact31" style="<?php echo $sStyleHidden_nofact31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nofact31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nofact31_label" style=""><span id="id_label_nofact31"><?php echo $this->nm_new_label['nofact31']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['nofact31']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['nofact31'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nocte31_line" id="hidden_field_data_nocte31" style="<?php echo $sStyleHidden_nocte31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nocte31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nocte31_label" style=""><span id="id_label_nocte31"><?php echo $this->nm_new_label['nocte31']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['nocte31']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['nocte31'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nomcte31_line" id="hidden_field_data_nomcte31" style="<?php echo $sStyleHidden_nomcte31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nomcte31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nomcte31_label" style=""><span id="id_label_nomcte31"><?php echo $this->nm_new_label['nomcte31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_localid31_line" id="hidden_field_data_localid31" style="<?php echo $sStyleHidden_localid31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_localid31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_localid31_label" style=""><span id="id_label_localid31"><?php echo $this->nm_new_label['localid31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cvectenegro31_line" id="hidden_field_data_cvectenegro31" style="<?php echo $sStyleHidden_cvectenegro31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cvectenegro31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cvectenegro31_label" style=""><span id="id_label_cvectenegro31"><?php echo $this->nm_new_label['cvectenegro31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_vtabta31_line" id="hidden_field_data_vtabta31" style="<?php echo $sStyleHidden_vtabta31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_vtabta31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_vtabta31_label" style=""><span id="id_label_vtabta31"><?php echo $this->nm_new_label['vtabta31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_descto31_line" id="hidden_field_data_descto31" style="<?php echo $sStyleHidden_descto31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_descto31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_descto31_label" style=""><span id="id_label_descto31"><?php echo $this->nm_new_label['descto31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_flete31_line" id="hidden_field_data_flete31" style="<?php echo $sStyleHidden_flete31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_flete31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_flete31_label" style=""><span id="id_label_flete31"><?php echo $this->nm_new_label['flete31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_itm31_line" id="hidden_field_data_itm31" style="<?php echo $sStyleHidden_itm31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_itm31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_itm31_label" style=""><span id="id_label_itm31"><?php echo $this->nm_new_label['itm31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_novend31_line" id="hidden_field_data_novend31" style="<?php echo $sStyleHidden_novend31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_novend31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_novend31_label" style=""><span id="id_label_novend31"><?php echo $this->nm_new_label['novend31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fecfact31_line" id="hidden_field_data_fecfact31" style="<?php echo $sStyleHidden_fecfact31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecfact31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fecfact31_label" style=""><span id="id_label_fecfact31"><?php echo $this->nm_new_label['fecfact31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_condpag31_line" id="hidden_field_data_condpag31" style="<?php echo $sStyleHidden_condpag31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_condpag31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_condpag31_label" style=""><span id="id_label_condpag31"><?php echo $this->nm_new_label['condpag31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nopagos31_line" id="hidden_field_data_nopagos31" style="<?php echo $sStyleHidden_nopagos31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nopagos31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nopagos31_label" style=""><span id="id_label_nopagos31"><?php echo $this->nm_new_label['nopagos31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_formapago31_line" id="hidden_field_data_formapago31" style="<?php echo $sStyleHidden_formapago31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_formapago31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_formapago31_label" style=""><span id="id_label_formapago31"><?php echo $this->nm_new_label['formapago31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_obra31_line" id="hidden_field_data_obra31" style="<?php echo $sStyleHidden_obra31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_obra31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_obra31_label" style=""><span id="id_label_obra31"><?php echo $this->nm_new_label['obra31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_orden31_line" id="hidden_field_data_orden31" style="<?php echo $sStyleHidden_orden31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_orden31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_orden31_label" style=""><span id="id_label_orden31"><?php echo $this->nm_new_label['orden31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cvnegra31_line" id="hidden_field_data_cvnegra31" style="<?php echo $sStyleHidden_cvnegra31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cvnegra31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cvnegra31_label" style=""><span id="id_label_cvnegra31"><?php echo $this->nm_new_label['cvnegra31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_status31_line" id="hidden_field_data_status31" style="<?php echo $sStyleHidden_status31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_status31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_status31_label" style=""><span id="id_label_status31"><?php echo $this->nm_new_label['status31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cvimpto31_line" id="hidden_field_data_cvimpto31" style="<?php echo $sStyleHidden_cvimpto31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cvimpto31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cvimpto31_label" style=""><span id="id_label_cvimpto31"><?php echo $this->nm_new_label['cvimpto31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cvanulado31_line" id="hidden_field_data_cvanulado31" style="<?php echo $sStyleHidden_cvanulado31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cvanulado31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cvanulado31_label" style=""><span id="id_label_cvanulado31"><?php echo $this->nm_new_label['cvanulado31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_efectivo31_line" id="hidden_field_data_efectivo31" style="<?php echo $sStyleHidden_efectivo31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_efectivo31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_efectivo31_label" style=""><span id="id_label_efectivo31"><?php echo $this->nm_new_label['efectivo31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cheque31_line" id="hidden_field_data_cheque31" style="<?php echo $sStyleHidden_cheque31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cheque31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cheque31_label" style=""><span id="id_label_cheque31"><?php echo $this->nm_new_label['cheque31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tarjeta31_line" id="hidden_field_data_tarjeta31" style="<?php echo $sStyleHidden_tarjeta31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tarjeta31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tarjeta31_label" style=""><span id="id_label_tarjeta31"><?php echo $this->nm_new_label['tarjeta31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_acuenta31_line" id="hidden_field_data_acuenta31" style="<?php echo $sStyleHidden_acuenta31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_acuenta31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_acuenta31_label" style=""><span id="id_label_acuenta31"><?php echo $this->nm_new_label['acuenta31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nobanco31_line" id="hidden_field_data_nobanco31" style="<?php echo $sStyleHidden_nobanco31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nobanco31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nobanco31_label" style=""><span id="id_label_nobanco31"><?php echo $this->nm_new_label['nobanco31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nombanco31_line" id="hidden_field_data_nombanco31" style="<?php echo $sStyleHidden_nombanco31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nombanco31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nombanco31_label" style=""><span id="id_label_nombanco31"><?php echo $this->nm_new_label['nombanco31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nocheque31_line" id="hidden_field_data_nocheque31" style="<?php echo $sStyleHidden_nocheque31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nocheque31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nocheque31_label" style=""><span id="id_label_nocheque31"><?php echo $this->nm_new_label['nocheque31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_notarjeta31_line" id="hidden_field_data_notarjeta31" style="<?php echo $sStyleHidden_notarjeta31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_notarjeta31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_notarjeta31_label" style=""><span id="id_label_notarjeta31"><?php echo $this->nm_new_label['notarjeta31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nomtarjeta31_line" id="hidden_field_data_nomtarjeta31" style="<?php echo $sStyleHidden_nomtarjeta31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nomtarjeta31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nomtarjeta31_label" style=""><span id="id_label_nomtarjeta31"><?php echo $this->nm_new_label['nomtarjeta31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cvdivisa31_line" id="hidden_field_data_cvdivisa31" style="<?php echo $sStyleHidden_cvdivisa31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cvdivisa31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cvdivisa31_label" style=""><span id="id_label_cvdivisa31"><?php echo $this->nm_new_label['cvdivisa31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_valdivisa31_line" id="hidden_field_data_valdivisa31" style="<?php echo $sStyleHidden_valdivisa31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valdivisa31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_valdivisa31_label" style=""><span id="id_label_valdivisa31"><?php echo $this->nm_new_label['valdivisa31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_lineaprod31_line" id="hidden_field_data_lineaprod31" style="<?php echo $sStyleHidden_lineaprod31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_lineaprod31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_lineaprod31_label" style=""><span id="id_label_lineaprod31"><?php echo $this->nm_new_label['lineaprod31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_intereses31_line" id="hidden_field_data_intereses31" style="<?php echo $sStyleHidden_intereses31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_intereses31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_intereses31_label" style=""><span id="id_label_intereses31"><?php echo $this->nm_new_label['intereses31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nopedido31_line" id="hidden_field_data_nopedido31" style="<?php echo $sStyleHidden_nopedido31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nopedido31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nopedido31_label" style=""><span id="id_label_nopedido31"><?php echo $this->nm_new_label['nopedido31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fecped31_line" id="hidden_field_data_fecped31" style="<?php echo $sStyleHidden_fecped31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecped31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fecped31_label" style=""><span id="id_label_fecped31"><?php echo $this->nm_new_label['fecped31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ruc31_line" id="hidden_field_data_ruc31" style="<?php echo $sStyleHidden_ruc31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ruc31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ruc31_label" style=""><span id="id_label_ruc31"><?php echo $this->nm_new_label['ruc31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tel31_line" id="hidden_field_data_tel31" style="<?php echo $sStyleHidden_tel31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tel31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tel31_label" style=""><span id="id_label_tel31"><?php echo $this->nm_new_label['tel31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_transpor31_line" id="hidden_field_data_transpor31" style="<?php echo $sStyleHidden_transpor31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_transpor31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_transpor31_label" style=""><span id="id_label_transpor31"><?php echo $this->nm_new_label['transpor31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cvtransfer31_line" id="hidden_field_data_cvtransfer31" style="<?php echo $sStyleHidden_cvtransfer31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cvtransfer31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cvtransfer31_label" style=""><span id="id_label_cvtransfer31"><?php echo $this->nm_new_label['cvtransfer31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fectrasfer31_line" id="hidden_field_data_fectrasfer31" style="<?php echo $sStyleHidden_fectrasfer31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fectrasfer31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fectrasfer31_label" style=""><span id="id_label_fectrasfer31"><?php echo $this->nm_new_label['fectrasfer31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_desctofp31_line" id="hidden_field_data_desctofp31" style="<?php echo $sStyleHidden_desctofp31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_desctofp31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_desctofp31_label" style=""><span id="id_label_desctofp31"><?php echo $this->nm_new_label['desctofp31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_catcte31_line" id="hidden_field_data_catcte31" style="<?php echo $sStyleHidden_catcte31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_catcte31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_catcte31_label" style=""><span id="id_label_catcte31"><?php echo $this->nm_new_label['catcte31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_recargos31_line" id="hidden_field_data_recargos31" style="<?php echo $sStyleHidden_recargos31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_recargos31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_recargos31_label" style=""><span id="id_label_recargos31"><?php echo $this->nm_new_label['recargos31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ice31_line" id="hidden_field_data_ice31" style="<?php echo $sStyleHidden_ice31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ice31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ice31_label" style=""><span id="id_label_ice31"><?php echo $this->nm_new_label['ice31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fecdocpr31_line" id="hidden_field_data_fecdocpr31" style="<?php echo $sStyleHidden_fecdocpr31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecdocpr31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fecdocpr31_label" style=""><span id="id_label_fecdocpr31"><?php echo $this->nm_new_label['fecdocpr31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tipocomp31_line" id="hidden_field_data_tipocomp31" style="<?php echo $sStyleHidden_tipocomp31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipocomp31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tipocomp31_label" style=""><span id="id_label_tipocomp31"><?php echo $this->nm_new_label['tipocomp31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_conta31_line" id="hidden_field_data_conta31" style="<?php echo $sStyleHidden_conta31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_conta31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_conta31_label" style=""><span id="id_label_conta31"><?php echo $this->nm_new_label['conta31']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fecvencidocpr_line" id="hidden_field_data_fecvencidocpr" style="<?php echo $sStyleHidden_fecvencidocpr; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecvencidocpr_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fecvencidocpr_label" style=""><span id="id_label_fecvencidocpr"><?php echo $this->nm_new_label['fecvencidocpr']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_totsiniva31_line" id="hidden_field_data_totsiniva31" style="<?php echo $sStyleHidden_totsiniva31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_totsiniva31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_totsiniva31_label" style=""><span id="id_label_totsiniva31"><?php echo $this->nm_new_label['totsiniva31']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['totsiniva31']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['totsiniva31'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fecemb_line" id="hidden_field_data_fecemb" style="<?php echo $sStyleHidden_fecemb; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecemb_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fecemb_label" style=""><span id="id_label_fecemb"><?php echo $this->nm_new_label['fecemb']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_norefrendo_line" id="hidden_field_data_norefrendo" style="<?php echo $sStyleHidden_norefrendo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_norefrendo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_norefrendo_label" style=""><span id="id_label_norefrendo"><?php echo $this->nm_new_label['norefrendo']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_baseice_line" id="hidden_field_data_baseice" style="<?php echo $sStyleHidden_baseice; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_baseice_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_baseice_label" style=""><span id="id_label_baseice"><?php echo $this->nm_new_label['baseice']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ncodret43_line" id="hidden_field_data_ncodret43" style="<?php echo $sStyleHidden_ncodret43; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ncodret43_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ncodret43_label" style=""><span id="id_label_ncodret43"><?php echo $this->nm_new_label['ncodret43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['ncodret43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['ncodret43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nbaseret43_line" id="hidden_field_data_nbaseret43" style="<?php echo $sStyleHidden_nbaseret43; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nbaseret43_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nbaseret43_label" style=""><span id="id_label_nbaseret43"><?php echo $this->nm_new_label['nbaseret43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['nbaseret43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['nbaseret43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_npctjeret43_line" id="hidden_field_data_npctjeret43" style="<?php echo $sStyleHidden_npctjeret43; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_npctjeret43_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_npctjeret43_label" style=""><span id="id_label_npctjeret43"><?php echo $this->nm_new_label['npctjeret43']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_contrato_line" id="hidden_field_data_contrato" style="<?php echo $sStyleHidden_contrato; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_contrato_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_contrato_label" style=""><span id="id_label_contrato"><?php echo $this->nm_new_label['contrato']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_compra_general_line" id="hidden_field_data_compra_general" style="<?php echo $sStyleHidden_compra_general; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_compra_general_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_compra_general_label" style=""><span id="id_label_compra_general"><?php echo $this->nm_new_label['compra_general']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_distribucion_rubros_line" id="hidden_field_data_distribucion_rubros" style="<?php echo $sStyleHidden_distribucion_rubros; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_distribucion_rubros_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_distribucion_rubros_label" style=""><span id="id_label_distribucion_rubros"><?php echo $this->nm_new_label['distribucion_rubros']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['distribucion_rubros']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['distribucion_rubros'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_dstoley_line" id="hidden_field_data_dstoley" style="<?php echo $sStyleHidden_dstoley; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dstoley_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_dstoley_label" style=""><span id="id_label_dstoley"><?php echo $this->nm_new_label['dstoley']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['dstoley']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['dstoley'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_remgas31_line" id="hidden_field_data_remgas31" style="<?php echo $sStyleHidden_remgas31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_remgas31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_remgas31_label" style=""><span id="id_label_remgas31"><?php echo $this->nm_new_label['remgas31']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['remgas31']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['remgas31'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_estado_electronico_line" id="hidden_field_data_estado_electronico" style="<?php echo $sStyleHidden_estado_electronico; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_estado_electronico_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_estado_electronico_label" style=""><span id="id_label_estado_electronico"><?php echo $this->nm_new_label['estado_electronico']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['estado_electronico']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['estado_electronico'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_coddest31_line" id="hidden_field_data_coddest31" style="<?php echo $sStyleHidden_coddest31; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_coddest31_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_coddest31_label" style=""><span id="id_label_coddest31"><?php echo $this->nm_new_label['coddest31']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['coddest31']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['php_cmp_required']['coddest31'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
    dbParentFrame[0].contentWindow.scAjaxDetailValue('<?php echo $cmp_master ?>', '<?php echo $val_master ?>');
<?php
        }
        unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['masterValue']);
?>
}
<?php
    }
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_maecom_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_maecom_mob");
 parent.scAjaxDetailHeight("form_maecom_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
{
<?php
if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['sc_modal'])
{
?>
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_maecom_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
