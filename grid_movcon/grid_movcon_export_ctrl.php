<?php
@session_start() ;
$_SESSION['scriptcase']['grid_movcon']['sc_process_barr'] = true;
require_once('../grid_movcon/index.php');
unset($_SESSION['scriptcase']['grid_movcon']['sc_process_barr']);
$ExportCtrl = new grid_movcon_export_control;
$ExportCtrl->Export_barr();

class grid_movcon_export_control
{
