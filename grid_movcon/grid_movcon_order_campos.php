...
<?php
   ...
   $Ord_Cmp = new grid_movcon_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_movcon_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_movcon']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_movcon']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['ctahiscon'] = "ctahiscon";
   $tab_labels["ctahiscon"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movcon']['labels']["ctahiscon"])) ? $_SESSION['sc_session'][$sc_init]['grid_movcon']['labels']["ctahiscon"] : "Ctahiscon";
   $tab_ger_campos['fechahis'] = "on";
   $tab_def_campos['fechahis'] = "fechahis";
   $tab_labels["fechahis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movcon']['labels']["fechahis"])) ? $_SESSION['sc_session'][$sc_init]['grid_movcon']['labels']["fechahis"] : "Fechahis";
   $tab_ger_campos['tipocomptehis'] = "on";
   $tab_def_campos['tipocomptehis'] = "tipocomptehis";
   $tab_labels["tipocomptehis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movcon']['labels']["tipocomptehis"])) ? $_SESSION['sc_session'][$sc_init]['grid_movcon']['labels']["tipocomptehis"] : "Tipocomptehis";
   $tab_ger_campos['numcomptehis'] = "on";
   $tab_def_campos['numcomptehis'] = "numcomptehis";
   $tab_labels["numcomptehis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movcon']['labels']["numcomptehis"])) ? $_SESSION['sc_session'][$sc_init]['grid_movcon']['labels']["numcomptehis"] : "Numcomptehis";
   $tab_ger_campos['ocurrenciahis'] = "on";
   $tab_def_campos['ocurrenciahis'] = "ocurrenciahis";
   $tab_labels["ocurrenciahis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movcon']['labels']["ocurrenciahis"])) ? $_SESSION['sc_session'][$sc_init]['grid_movcon']['labels']["ocurrenciahis"] : "Ocurrenciahis";
   $tab_ger_campos['nochequehis'] = "on";
   $tab_def_campos['nochequehis'] = "nochequehis";
   $tab_labels["nochequehis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movcon']['labels']["nochequehis"])) ? $_SESSION['sc_session'][$sc_init]['grid_movcon']['labels']["nochequehis"] : "Nochequehis";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_movcon']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_movcon']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_movcon']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_movcon']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_movcon']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_movcon']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_movcon']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_movcon']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_movcon']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_movcon']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_movcon']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_movcon']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_movcon_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_movcon']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_movcon']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_movcon']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_movcon']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_movcon']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
