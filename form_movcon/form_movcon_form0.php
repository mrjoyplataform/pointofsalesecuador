...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_movcon/form_movcon_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_movcon_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_movcon_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['link_info']['remove_border']) {
...
<?php
 include_once("form_movcon_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_movcon'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_movcon'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ctahiscon_label" id="hidden_field_label_ctahiscon" style="<?php echo $sStyleHidden_ctahiscon; ?>"><span id="id_label_ctahiscon"><?php echo $this->nm_new_label['ctahiscon']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['ctahiscon']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['ctahiscon'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_ctahiscon_line" id="hidden_field_data_ctahiscon" style="<?php echo $sStyleHidden_ctahiscon; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ctahiscon_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fechahis_label" id="hidden_field_label_fechahis" style="<?php echo $sStyleHidden_fechahis; ?>"><span id="id_label_fechahis"><?php echo $this->nm_new_label['fechahis']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['fechahis']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['fechahis'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_fechahis_line" id="hidden_field_data_fechahis" style="<?php echo $sStyleHidden_fechahis; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fechahis_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipocomptehis_label" id="hidden_field_label_tipocomptehis" style="<?php echo $sStyleHidden_tipocomptehis; ?>"><span id="id_label_tipocomptehis"><?php echo $this->nm_new_label['tipocomptehis']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['tipocomptehis']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['tipocomptehis'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_numcomptehis_label" id="hidden_field_label_numcomptehis" style="<?php echo $sStyleHidden_numcomptehis; ?>"><span id="id_label_numcomptehis"><?php echo $this->nm_new_label['numcomptehis']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['numcomptehis']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['numcomptehis'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_numcomptehis_line" id="hidden_field_data_numcomptehis" style="<?php echo $sStyleHidden_numcomptehis; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_numcomptehis_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ocurrenciahis_label" id="hidden_field_label_ocurrenciahis" style="<?php echo $sStyleHidden_ocurrenciahis; ?>"><span id="id_label_ocurrenciahis"><?php echo $this->nm_new_label['ocurrenciahis']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['ocurrenciahis']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['ocurrenciahis'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_ocurrenciahis_line" id="hidden_field_data_ocurrenciahis" style="<?php echo $sStyleHidden_ocurrenciahis; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ocurrenciahis_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nochequehis_label" id="hidden_field_label_nochequehis" style="<?php echo $sStyleHidden_nochequehis; ?>"><span id="id_label_nochequehis"><?php echo $this->nm_new_label['nochequehis']; ?></span></TD>
    <TD class="scFormDataOdd css_nochequehis_line" id="hidden_field_data_nochequehis" style="<?php echo $sStyleHidden_nochequehis; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nochequehis_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dethis_label" id="hidden_field_label_dethis" style="<?php echo $sStyleHidden_dethis; ?>"><span id="id_label_dethis"><?php echo $this->nm_new_label['dethis']; ?></span></TD>
    <TD class="scFormDataOdd css_dethis_line" id="hidden_field_data_dethis" style="<?php echo $sStyleHidden_dethis; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dethis_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_db1cr2his_label" id="hidden_field_label_db1cr2his" style="<?php echo $sStyleHidden_db1cr2his; ?>"><span id="id_label_db1cr2his"><?php echo $this->nm_new_label['db1cr2his']; ?></span></TD>
    <TD class="scFormDataOdd css_db1cr2his_line" id="hidden_field_data_db1cr2his" style="<?php echo $sStyleHidden_db1cr2his; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_db1cr2his_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_valorhis_label" id="hidden_field_label_valorhis" style="<?php echo $sStyleHidden_valorhis; ?>"><span id="id_label_valorhis"><?php echo $this->nm_new_label['valorhis']; ?></span></TD>
    <TD class="scFormDataOdd css_valorhis_line" id="hidden_field_data_valorhis" style="<?php echo $sStyleHidden_valorhis; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valorhis_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sdoctahis_label" id="hidden_field_label_sdoctahis" style="<?php echo $sStyleHidden_sdoctahis; ?>"><span id="id_label_sdoctahis"><?php echo $this->nm_new_label['sdoctahis']; ?></span></TD>
    <TD class="scFormDataOdd css_sdoctahis_line" id="hidden_field_data_sdoctahis" style="<?php echo $sStyleHidden_sdoctahis; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sdoctahis_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_estado_label" id="hidden_field_label_estado" style="<?php echo $sStyleHidden_estado; ?>"><span id="id_label_estado"><?php echo $this->nm_new_label['estado']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['estado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['estado'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cvtransferhis_label" id="hidden_field_label_cvtransferhis" style="<?php echo $sStyleHidden_cvtransferhis; ?>"><span id="id_label_cvtransferhis"><?php echo $this->nm_new_label['cvtransferhis']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['cvtransferhis']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['cvtransferhis'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_cvtransferhis_line" id="hidden_field_data_cvtransferhis" style="<?php echo $sStyleHidden_cvtransferhis; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cvtransferhis_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ctamodulo_label" id="hidden_field_label_ctamodulo" style="<?php echo $sStyleHidden_ctamodulo; ?>"><span id="id_label_ctamodulo"><?php echo $this->nm_new_label['ctamodulo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['ctamodulo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['ctamodulo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_ctamodulo_line" id="hidden_field_data_ctamodulo" style="<?php echo $sStyleHidden_ctamodulo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ctamodulo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_doccons_label" id="hidden_field_label_doccons" style="<?php echo $sStyleHidden_doccons; ?>"><span id="id_label_doccons"><?php echo $this->nm_new_label['doccons']; ?></span></TD>
    <TD class="scFormDataOdd css_doccons_line" id="hidden_field_data_doccons" style="<?php echo $sStyleHidden_doccons; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_doccons_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_beneficiario_label" id="hidden_field_label_beneficiario" style="<?php echo $sStyleHidden_beneficiario; ?>"><span id="id_label_beneficiario"><?php echo $this->nm_new_label['beneficiario']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['beneficiario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['beneficiario'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_beneficiario_line" id="hidden_field_data_beneficiario" style="<?php echo $sStyleHidden_beneficiario; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_beneficiario_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_conciliado_label" id="hidden_field_label_conciliado" style="<?php echo $sStyleHidden_conciliado; ?>"><span id="id_label_conciliado"><?php echo $this->nm_new_label['conciliado']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['conciliado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['conciliado'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_conciliado_line" id="hidden_field_data_conciliado" style="<?php echo $sStyleHidden_conciliado; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_conciliado_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_codcons_label" id="hidden_field_label_codcons" style="<?php echo $sStyleHidden_codcons; ?>"><span id="id_label_codcons"><?php echo $this->nm_new_label['codcons']; ?></span></TD>
    <TD class="scFormDataOdd css_codcons_line" id="hidden_field_data_codcons" style="<?php echo $sStyleHidden_codcons; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_codcons_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_manualcons_label" id="hidden_field_label_manualcons" style="<?php echo $sStyleHidden_manualcons; ?>"><span id="id_label_manualcons"><?php echo $this->nm_new_label['manualcons']; ?></span></TD>
    <TD class="scFormDataOdd css_manualcons_line" id="hidden_field_data_manualcons" style="<?php echo $sStyleHidden_manualcons; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_manualcons_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cerradocons_label" id="hidden_field_label_cerradocons" style="<?php echo $sStyleHidden_cerradocons; ?>"><span id="id_label_cerradocons"><?php echo $this->nm_new_label['cerradocons']; ?></span></TD>
    <TD class="scFormDataOdd css_cerradocons_line" id="hidden_field_data_cerradocons" style="<?php echo $sStyleHidden_cerradocons; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cerradocons_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fechconciliado_label" id="hidden_field_label_fechconciliado" style="<?php echo $sStyleHidden_fechconciliado; ?>"><span id="id_label_fechconciliado"><?php echo $this->nm_new_label['fechconciliado']; ?></span></TD>
    <TD class="scFormDataOdd css_fechconciliado_line" id="hidden_field_data_fechconciliado" style="<?php echo $sStyleHidden_fechconciliado; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fechconciliado_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fechcerrado_label" id="hidden_field_label_fechcerrado" style="<?php echo $sStyleHidden_fechcerrado; ?>"><span id="id_label_fechcerrado"><?php echo $this->nm_new_label['fechcerrado']; ?></span></TD>
    <TD class="scFormDataOdd css_fechcerrado_line" id="hidden_field_data_fechcerrado" style="<?php echo $sStyleHidden_fechcerrado; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fechcerrado_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipocomptehis_cierre_label" id="hidden_field_label_tipocomptehis_cierre" style="<?php echo $sStyleHidden_tipocomptehis_cierre; ?>"><span id="id_label_tipocomptehis_cierre"><?php echo $this->nm_new_label['tipocomptehis_cierre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['tipocomptehis_cierre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['tipocomptehis_cierre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cc01_label" id="hidden_field_label_cc01" style="<?php echo $sStyleHidden_cc01; ?>"><span id="id_label_cc01"><?php echo $this->nm_new_label['cc01']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['cc01']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['cc01'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_cc01_line" id="hidden_field_data_cc01" style="<?php echo $sStyleHidden_cc01; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cc01_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cc02_label" id="hidden_field_label_cc02" style="<?php echo $sStyleHidden_cc02; ?>"><span id="id_label_cc02"><?php echo $this->nm_new_label['cc02']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['cc02']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['cc02'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_cc02_line" id="hidden_field_data_cc02" style="<?php echo $sStyleHidden_cc02; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cc02_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cc03_label" id="hidden_field_label_cc03" style="<?php echo $sStyleHidden_cc03; ?>"><span id="id_label_cc03"><?php echo $this->nm_new_label['cc03']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['cc03']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['cc03'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_cc03_line" id="hidden_field_data_cc03" style="<?php echo $sStyleHidden_cc03; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cc03_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cc04_label" id="hidden_field_label_cc04" style="<?php echo $sStyleHidden_cc04; ?>"><span id="id_label_cc04"><?php echo $this->nm_new_label['cc04']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['cc04']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['cc04'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_cc04_line" id="hidden_field_data_cc04" style="<?php echo $sStyleHidden_cc04; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cc04_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cc05_label" id="hidden_field_label_cc05" style="<?php echo $sStyleHidden_cc05; ?>"><span id="id_label_cc05"><?php echo $this->nm_new_label['cc05']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['cc05']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['cc05'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_cc05_line" id="hidden_field_data_cc05" style="<?php echo $sStyleHidden_cc05; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cc05_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pord_label" id="hidden_field_label_pord" style="<?php echo $sStyleHidden_pord; ?>"><span id="id_label_pord"><?php echo $this->nm_new_label['pord']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['pord']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['pord'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_pord_line" id="hidden_field_data_pord" style="<?php echo $sStyleHidden_pord; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_pord_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idb_label" id="hidden_field_label_idb" style="<?php echo $sStyleHidden_idb; ?>"><span id="id_label_idb"><?php echo $this->nm_new_label['idb']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['idb']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['idb'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipodoc_label" id="hidden_field_label_tipodoc" style="<?php echo $sStyleHidden_tipodoc; ?>"><span id="id_label_tipodoc"><?php echo $this->nm_new_label['tipodoc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['tipodoc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['tipodoc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_numdoc_label" id="hidden_field_label_numdoc" style="<?php echo $sStyleHidden_numdoc; ?>"><span id="id_label_numdoc"><?php echo $this->nm_new_label['numdoc']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['numdoc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['numdoc'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_numdoc_line" id="hidden_field_data_numdoc" style="<?php echo $sStyleHidden_numdoc; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_numdoc_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_modulo_label" id="hidden_field_label_modulo" style="<?php echo $sStyleHidden_modulo; ?>"><span id="id_label_modulo"><?php echo $this->nm_new_label['modulo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['modulo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['modulo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_modulo_line" id="hidden_field_data_modulo" style="<?php echo $sStyleHidden_modulo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_modulo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cvanuladohis_label" id="hidden_field_label_cvanuladohis" style="<?php echo $sStyleHidden_cvanuladohis; ?>"><span id="id_label_cvanuladohis"><?php echo $this->nm_new_label['cvanuladohis']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['cvanuladohis']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['cvanuladohis'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_cvanuladohis_line" id="hidden_field_data_cvanuladohis" style="<?php echo $sStyleHidden_cvanuladohis; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cvanuladohis_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_estado_anio_label" id="hidden_field_label_estado_anio" style="<?php echo $sStyleHidden_estado_anio; ?>"><span id="id_label_estado_anio"><?php echo $this->nm_new_label['estado_anio']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['estado_anio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['estado_anio'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_estado_anio_line" id="hidden_field_data_estado_anio" style="<?php echo $sStyleHidden_estado_anio; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_estado_anio_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_numcomptehis_cierre_label" id="hidden_field_label_numcomptehis_cierre" style="<?php echo $sStyleHidden_numcomptehis_cierre; ?>"><span id="id_label_numcomptehis_cierre"><?php echo $this->nm_new_label['numcomptehis_cierre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['numcomptehis_cierre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['php_cmp_required']['numcomptehis_cierre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_numcomptehis_cierre_line" id="hidden_field_data_numcomptehis_cierre" style="<?php echo $sStyleHidden_numcomptehis_cierre; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_numcomptehis_cierre_line" style="vertical-align: top;padding: 0px">
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_movcon");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_movcon");
 parent.scAjaxDetailHeight("form_movcon", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_movcon']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
