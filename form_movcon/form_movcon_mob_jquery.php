...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_fechahis_hora' + iSeqRow).bind('blur', function() { sc_form_movcon_fechahis_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_movcon_fechahis_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_fechconciliado_hora' + iSeqRow).bind('blur', function() { sc_form_movcon_fechconciliado_onblur(this, iSeqRow) })
                                                 .bind('focus', function() { sc_form_movcon_fechconciliado_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_fechcerrado_hora' + iSeqRow).bind('blur', function() { sc_form_movcon_fechcerrado_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_movcon_fechcerrado_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_movcon_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fechahis" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_movcon_mob_validate_fechahis(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechconciliado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_movcon_mob_validate_fechconciliado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechcerrado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_movcon_mob_validate_fechcerrado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_movcon_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
