<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="idcustomer" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idcustomer']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_customer_clubmrjoy"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_detal']))
  {
?>  
...
function sc_inline_form(seqRow, keyParams, width, height)
{
  ...
  nm_gp_submit('<?php echo $this->Ini->link_form_customer_clubmrjoy_inline ?>', '<?php echo $this->nm_location ?>', 'NM_btn_insert*scinN*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scoutNMSC_modal*scinok*scoutsc_redir_atualiz*scinok*scoutsc_inline_call*scinY*scoutsc_seq_row*scin' + seqRow + '*scout' + callParams, '', 'modal', height, width);
}

function sc_inline_form_add(width, height)
{
  nm_gp_submit('<?php echo $this->Ini->link_form_customer_clubmrjoy_inline ?>', '<?php echo $this->nm_location ?>', 'NM_btn_insert*scinY*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scoutNMSC_modal*scinok*scoutsc_redir_atualiz*scinok*scoutsc_inline_call*scinY*scoutnmgp_opcao*scinnovo*scout', '', 'modal', height, width);
}
...
{
    document.getElementById('form_customer_clubmrjoy_form0').style.width='1px';
    document.getElementById('form_customer_clubmrjoy_form0').style.height='0px';
    document.getElementById('form_customer_clubmrjoy_form0').style.display='none';
    document.getElementById('form_customer_clubmrjoy_form0').style.overflow='scroll';
    document.getElementById('form_customer_clubmrjoy_form1').style.width='1px';
    document.getElementById('form_customer_clubmrjoy_form1').style.height='0px';
    document.getElementById('form_customer_clubmrjoy_form1').style.display='none';
    document.getElementById('form_customer_clubmrjoy_form1').style.overflow='scroll';
    document.getElementById('form_customer_clubmrjoy_form2').style.width='1px';
    document.getElementById('form_customer_clubmrjoy_form2').style.height='0px';
    document.getElementById('form_customer_clubmrjoy_form2').style.display='none';
    document.getElementById('form_customer_clubmrjoy_form2').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['pdf_view']) {
?>
...
?>
   ...
   if ("form_customer_clubmrjoy_form2" == N_pagina) {
