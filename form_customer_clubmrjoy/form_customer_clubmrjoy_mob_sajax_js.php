  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_customer_clubmrjoy_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_customer_clubmrjoy_mob_form();
	}
...
?>
  ...
  // ---------- Validate idcustomer
  function do_ajax_form_customer_clubmrjoy_mob_validate_idcustomer()
  {
    var nomeCampo_idcustomer = "idcustomer";
    var var_idcustomer = scAjaxGetFieldText(nomeCampo_idcustomer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_mob_validate_idcustomer(var_idcustomer, var_script_case_init, do_ajax_form_customer_clubmrjoy_mob_validate_idcustomer_cb);
  } // do_ajax_form_customer_clubmrjoy_mob_validate_idcustomer

  function do_ajax_form_customer_clubmrjoy_mob_validate_idcustomer_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_mob_validate_idcustomer_cb

  // ---------- Validate nombre
  function do_ajax_form_customer_clubmrjoy_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_customer_clubmrjoy_mob_validate_nombre_cb);
  } // do_ajax_form_customer_clubmrjoy_mob_validate_nombre

  function do_ajax_form_customer_clubmrjoy_mob_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_mob_validate_nombre_cb

  // ---------- Validate correo
  function do_ajax_form_customer_clubmrjoy_mob_validate_correo()
  {
    var nomeCampo_correo = "correo";
    var var_correo = scAjaxGetFieldText(nomeCampo_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_mob_validate_correo(var_correo, var_script_case_init, do_ajax_form_customer_clubmrjoy_mob_validate_correo_cb);
  } // do_ajax_form_customer_clubmrjoy_mob_validate_correo

  function do_ajax_form_customer_clubmrjoy_mob_validate_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "correo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_mob_validate_correo_cb

  // ---------- Validate celular
  function do_ajax_form_customer_clubmrjoy_mob_validate_celular()
  {
    var nomeCampo_celular = "celular";
    var var_celular = scAjaxGetFieldText(nomeCampo_celular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_mob_validate_celular(var_celular, var_script_case_init, do_ajax_form_customer_clubmrjoy_mob_validate_celular_cb);
  } // do_ajax_form_customer_clubmrjoy_mob_validate_celular

  function do_ajax_form_customer_clubmrjoy_mob_validate_celular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "celular";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_mob_validate_celular_cb

  // ---------- Validate cliente_tipo
  function do_ajax_form_customer_clubmrjoy_mob_validate_cliente_tipo()
  {
    var nomeCampo_cliente_tipo = "cliente_tipo";
    var var_cliente_tipo = scAjaxGetFieldSelect(nomeCampo_cliente_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_mob_validate_cliente_tipo(var_cliente_tipo, var_script_case_init, do_ajax_form_customer_clubmrjoy_mob_validate_cliente_tipo_cb);
  } // do_ajax_form_customer_clubmrjoy_mob_validate_cliente_tipo

  function do_ajax_form_customer_clubmrjoy_mob_validate_cliente_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_mob_validate_cliente_tipo_cb

  // ---------- Validate provincia
  function do_ajax_form_customer_clubmrjoy_mob_validate_provincia()
  {
    var nomeCampo_provincia = "provincia";
    var var_provincia = scAjaxGetFieldSelect(nomeCampo_provincia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_mob_validate_provincia(var_provincia, var_script_case_init, do_ajax_form_customer_clubmrjoy_mob_validate_provincia_cb);
  } // do_ajax_form_customer_clubmrjoy_mob_validate_provincia

  function do_ajax_form_customer_clubmrjoy_mob_validate_provincia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_mob_validate_provincia_cb

  // ---------- Validate canton
  function do_ajax_form_customer_clubmrjoy_mob_validate_canton()
  {
    var nomeCampo_canton = "canton";
    var var_canton = scAjaxGetFieldSelect(nomeCampo_canton);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_mob_validate_canton(var_canton, var_script_case_init, do_ajax_form_customer_clubmrjoy_mob_validate_canton_cb);
  } // do_ajax_form_customer_clubmrjoy_mob_validate_canton

  function do_ajax_form_customer_clubmrjoy_mob_validate_canton_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "canton";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_mob_validate_canton_cb

  // ---------- Validate parroquia
  function do_ajax_form_customer_clubmrjoy_mob_validate_parroquia()
  {
    var nomeCampo_parroquia = "parroquia";
    var var_parroquia = scAjaxGetFieldSelect(nomeCampo_parroquia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_mob_validate_parroquia(var_parroquia, var_script_case_init, do_ajax_form_customer_clubmrjoy_mob_validate_parroquia_cb);
  } // do_ajax_form_customer_clubmrjoy_mob_validate_parroquia

  function do_ajax_form_customer_clubmrjoy_mob_validate_parroquia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_mob_validate_parroquia_cb

  // ---------- Validate direccion
  function do_ajax_form_customer_clubmrjoy_mob_validate_direccion()
  {
    var nomeCampo_direccion = "direccion";
    var var_direccion = scAjaxGetFieldText(nomeCampo_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_mob_validate_direccion(var_direccion, var_script_case_init, do_ajax_form_customer_clubmrjoy_mob_validate_direccion_cb);
  } // do_ajax_form_customer_clubmrjoy_mob_validate_direccion

  function do_ajax_form_customer_clubmrjoy_mob_validate_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_mob_validate_direccion_cb

  // ---------- Validate sector
  function do_ajax_form_customer_clubmrjoy_mob_validate_sector()
  {
    var nomeCampo_sector = "sector";
    var var_sector = scAjaxGetFieldText(nomeCampo_sector);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_mob_validate_sector(var_sector, var_script_case_init, do_ajax_form_customer_clubmrjoy_mob_validate_sector_cb);
  } // do_ajax_form_customer_clubmrjoy_mob_validate_sector

  function do_ajax_form_customer_clubmrjoy_mob_validate_sector_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sector";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_mob_validate_sector_cb

  // ---------- Validate family
  function do_ajax_form_customer_clubmrjoy_mob_validate_family()
  {
    var nomeCampo_family = "family";
    var var_family = scAjaxGetFieldText(nomeCampo_family);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_mob_validate_family(var_family, var_script_case_init, do_ajax_form_customer_clubmrjoy_mob_validate_family_cb);
  } // do_ajax_form_customer_clubmrjoy_mob_validate_family

  function do_ajax_form_customer_clubmrjoy_mob_validate_family_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "family";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_mob_validate_family_cb

  // ---------- Refresh provincia
  function do_ajax_form_customer_clubmrjoy_mob_refresh_provincia()
  {
    var var_provincia = scAjaxGetFieldSelect("provincia");
    var var_canton = scAjaxGetFieldSelect("canton");
    var var_nmgp_refresh_fields = "canton_#fld#_parroquia";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_customer_clubmrjoy_mob_refresh_provincia(var_provincia, var_canton, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_customer_clubmrjoy_mob_refresh_provincia_cb);
  } // do_ajax_form_customer_clubmrjoy_mob_refresh_provincia

  function do_ajax_form_customer_clubmrjoy_mob_refresh_provincia_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_customer_clubmrjoy_mob_refresh_canton();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_mob_refresh_provincia_cb

  // ---------- Refresh canton
  function do_ajax_form_customer_clubmrjoy_mob_refresh_canton()
  {
    var var_canton = scAjaxGetFieldSelect("canton");
    var var_nmgp_refresh_fields = "parroquia";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_customer_clubmrjoy_mob_refresh_canton(var_canton, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_customer_clubmrjoy_mob_refresh_canton_cb);
  } // do_ajax_form_customer_clubmrjoy_mob_refresh_canton

  function do_ajax_form_customer_clubmrjoy_mob_refresh_canton_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_mob_refresh_canton_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_customer_clubmrjoy_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_customer_clubmrjoy_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_cliente_tipo = scAjaxGetFieldSelect("cliente_tipo");
    var var_provincia = scAjaxGetFieldSelect("provincia");
    var var_canton = scAjaxGetFieldSelect("canton");
    var var_parroquia = scAjaxGetFieldSelect("parroquia");
    ...
    scAjaxProcOn();
    x_ajax_form_customer_clubmrjoy_mob_submit_form(var_idcustomer, var_nombre, var_correo, var_celular, var_cliente_tipo, var_provincia, var_canton, var_parroquia, var_direccion, var_sector, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_customer_clubmrjoy_mob_submit_form_cb);
  } // do_ajax_form_customer_clubmrjoy_mob_submit_form

  function do_ajax_form_customer_clubmrjoy_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_customer_clubmrjoy_mob_submit_form_cb_after_alert);
  } // do_ajax_form_customer_clubmrjoy_mob_submit_form_cb
  function do_ajax_form_customer_clubmrjoy_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_customer_clubmrjoy_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_customer_family_mob"] = "off";

  function do_ajax_form_customer_clubmrjoy_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_customer_clubmrjoy_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_customer_clubmrjoy_mob_navigate_form();
    }
  }

  function perform_ajax_form_customer_clubmrjoy_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_customer_family_mob"] = "on";
    x_ajax_form_customer_clubmrjoy_mob_navigate_form(var_idcustomer, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_customer_clubmrjoy_mob_navigate_form_cb);
  } // do_ajax_form_customer_clubmrjoy_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_customer_clubmrjoy_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_customer_family_mob"] && "nmsc_iframe_liga_form_customer_family_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_customer_family_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_customer_family_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_customer_family_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_customer_family_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_customer_family_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_customer_clubmrjoy_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_customer_clubmrjoy_mob_navigate_form_cb
  function do_ajax_form_customer_clubmrjoy_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_customer_clubmrjoy_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_customer_clubmrjoy_mob_navigate_form_cb_after_alert

  function sc_hide_form_customer_clubmrjoy_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_customer_family_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "idcustomer";
  ajax_field_list[1] = "nombre";
  ajax_field_list[2] = "correo";
  ajax_field_list[3] = "celular";
  ajax_field_list[4] = "cliente_tipo";
  ajax_field_list[5] = "provincia";
  ajax_field_list[6] = "canton";
  ajax_field_list[7] = "parroquia";
  ajax_field_list[8] = "direccion";
  ajax_field_list[9] = "sector";
  ajax_field_list[10] = "family";
  ...
  var ajax_error_list = {
    "idcustomer": {"label": "Cédula", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "family": {"label": "Family", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["family"][1] = "family";
  ...
  var ajax_field_id = {
    ...
    "family": new Array("hidden_field_label_family", "hidden_field_data_family")
  };
