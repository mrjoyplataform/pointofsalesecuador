  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_customer_clubmrjoy" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_customer_clubmrjoy_form();
	}
...
?>
  ...
  // ---------- Validate idcustomer
  function do_ajax_form_customer_clubmrjoy_validate_idcustomer()
  {
    var nomeCampo_idcustomer = "idcustomer";
    var var_idcustomer = scAjaxGetFieldText(nomeCampo_idcustomer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_validate_idcustomer(var_idcustomer, var_script_case_init, do_ajax_form_customer_clubmrjoy_validate_idcustomer_cb);
  } // do_ajax_form_customer_clubmrjoy_validate_idcustomer

  function do_ajax_form_customer_clubmrjoy_validate_idcustomer_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_validate_idcustomer_cb

  // ---------- Validate nombre
  function do_ajax_form_customer_clubmrjoy_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_customer_clubmrjoy_validate_nombre_cb);
  } // do_ajax_form_customer_clubmrjoy_validate_nombre

  function do_ajax_form_customer_clubmrjoy_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_validate_nombre_cb

  // ---------- Validate correo
  function do_ajax_form_customer_clubmrjoy_validate_correo()
  {
    var nomeCampo_correo = "correo";
    var var_correo = scAjaxGetFieldText(nomeCampo_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_validate_correo(var_correo, var_script_case_init, do_ajax_form_customer_clubmrjoy_validate_correo_cb);
  } // do_ajax_form_customer_clubmrjoy_validate_correo

  function do_ajax_form_customer_clubmrjoy_validate_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "correo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_validate_correo_cb

  // ---------- Validate celular
  function do_ajax_form_customer_clubmrjoy_validate_celular()
  {
    var nomeCampo_celular = "celular";
    var var_celular = scAjaxGetFieldText(nomeCampo_celular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_validate_celular(var_celular, var_script_case_init, do_ajax_form_customer_clubmrjoy_validate_celular_cb);
  } // do_ajax_form_customer_clubmrjoy_validate_celular

  function do_ajax_form_customer_clubmrjoy_validate_celular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "celular";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_validate_celular_cb

  // ---------- Validate cliente_tipo
  function do_ajax_form_customer_clubmrjoy_validate_cliente_tipo()
  {
    var nomeCampo_cliente_tipo = "cliente_tipo";
    var var_cliente_tipo = scAjaxGetFieldSelect(nomeCampo_cliente_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_validate_cliente_tipo(var_cliente_tipo, var_script_case_init, do_ajax_form_customer_clubmrjoy_validate_cliente_tipo_cb);
  } // do_ajax_form_customer_clubmrjoy_validate_cliente_tipo

  function do_ajax_form_customer_clubmrjoy_validate_cliente_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_validate_cliente_tipo_cb

  // ---------- Validate provincia
  function do_ajax_form_customer_clubmrjoy_validate_provincia()
  {
    var nomeCampo_provincia = "provincia";
    var var_provincia = scAjaxGetFieldSelect(nomeCampo_provincia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_validate_provincia(var_provincia, var_script_case_init, do_ajax_form_customer_clubmrjoy_validate_provincia_cb);
  } // do_ajax_form_customer_clubmrjoy_validate_provincia

  function do_ajax_form_customer_clubmrjoy_validate_provincia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_validate_provincia_cb

  // ---------- Validate canton
  function do_ajax_form_customer_clubmrjoy_validate_canton()
  {
    var nomeCampo_canton = "canton";
    var var_canton = scAjaxGetFieldSelect(nomeCampo_canton);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_validate_canton(var_canton, var_script_case_init, do_ajax_form_customer_clubmrjoy_validate_canton_cb);
  } // do_ajax_form_customer_clubmrjoy_validate_canton

  function do_ajax_form_customer_clubmrjoy_validate_canton_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "canton";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_validate_canton_cb

  // ---------- Validate parroquia
  function do_ajax_form_customer_clubmrjoy_validate_parroquia()
  {
    var nomeCampo_parroquia = "parroquia";
    var var_parroquia = scAjaxGetFieldSelect(nomeCampo_parroquia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_validate_parroquia(var_parroquia, var_script_case_init, do_ajax_form_customer_clubmrjoy_validate_parroquia_cb);
  } // do_ajax_form_customer_clubmrjoy_validate_parroquia

  function do_ajax_form_customer_clubmrjoy_validate_parroquia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_validate_parroquia_cb

  // ---------- Validate direccion
  function do_ajax_form_customer_clubmrjoy_validate_direccion()
  {
    var nomeCampo_direccion = "direccion";
    var var_direccion = scAjaxGetFieldText(nomeCampo_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_validate_direccion(var_direccion, var_script_case_init, do_ajax_form_customer_clubmrjoy_validate_direccion_cb);
  } // do_ajax_form_customer_clubmrjoy_validate_direccion

  function do_ajax_form_customer_clubmrjoy_validate_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_validate_direccion_cb

  // ---------- Validate sector
  function do_ajax_form_customer_clubmrjoy_validate_sector()
  {
    var nomeCampo_sector = "sector";
    var var_sector = scAjaxGetFieldText(nomeCampo_sector);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_validate_sector(var_sector, var_script_case_init, do_ajax_form_customer_clubmrjoy_validate_sector_cb);
  } // do_ajax_form_customer_clubmrjoy_validate_sector

  function do_ajax_form_customer_clubmrjoy_validate_sector_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sector";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_validate_sector_cb

  // ---------- Validate family
  function do_ajax_form_customer_clubmrjoy_validate_family()
  {
    var nomeCampo_family = "family";
    var var_family = scAjaxGetFieldText(nomeCampo_family);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_clubmrjoy_validate_family(var_family, var_script_case_init, do_ajax_form_customer_clubmrjoy_validate_family_cb);
  } // do_ajax_form_customer_clubmrjoy_validate_family

  function do_ajax_form_customer_clubmrjoy_validate_family_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "family";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_validate_family_cb

  // ---------- Refresh provincia
  function do_ajax_form_customer_clubmrjoy_refresh_provincia()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_customer_clubmrjoy_refresh_provincia(var_provincia, var_canton, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_customer_clubmrjoy_refresh_provincia_cb);
  } // do_ajax_form_customer_clubmrjoy_refresh_provincia

  function do_ajax_form_customer_clubmrjoy_refresh_provincia_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_refresh_provincia_cb

  // ---------- Refresh canton
  function do_ajax_form_customer_clubmrjoy_refresh_canton()
  {
    var var_canton = scAjaxGetFieldSelect("canton");
    var var_nmgp_refresh_fields = "parroquia";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_customer_clubmrjoy_refresh_canton(var_canton, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_customer_clubmrjoy_refresh_canton_cb);
  } // do_ajax_form_customer_clubmrjoy_refresh_canton

  function do_ajax_form_customer_clubmrjoy_refresh_canton_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_clubmrjoy_refresh_canton_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_customer_clubmrjoy_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_customer_clubmrjoy_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_customer_clubmrjoy_submit_form(var_idcustomer, var_nombre, var_correo, var_celular, var_cliente_tipo, var_provincia, var_canton, var_parroquia, var_direccion, var_sector, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_customer_clubmrjoy_submit_form_cb);
  } // do_ajax_form_customer_clubmrjoy_submit_form

  function do_ajax_form_customer_clubmrjoy_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_customer_clubmrjoy_submit_form_cb_after_alert);
  } // do_ajax_form_customer_clubmrjoy_submit_form_cb
  function do_ajax_form_customer_clubmrjoy_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_customer_clubmrjoy_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_customer_family"] = "off";

  function do_ajax_form_customer_clubmrjoy_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_customer_clubmrjoy_navigate_form, function() {});
    } else {
      perform_ajax_form_customer_clubmrjoy_navigate_form();
    }
  }

  function perform_ajax_form_customer_clubmrjoy_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_customer_family"] = "on";
    x_ajax_form_customer_clubmrjoy_navigate_form(var_idcustomer, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_customer_clubmrjoy_navigate_form_cb);
  } // do_ajax_form_customer_clubmrjoy_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_customer_clubmrjoy_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_customer_family"] && "nmsc_iframe_liga_form_customer_family" != scMasterDetailIframe["nmsc_iframe_liga_form_customer_family"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_customer_family"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_customer_family').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_customer_family').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_customer_family').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_customer_clubmrjoy_navigate_form_cb_after_alert);
  } // do_ajax_form_customer_clubmrjoy_navigate_form_cb
  function do_ajax_form_customer_clubmrjoy_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_customer_clubmrjoy_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_customer_clubmrjoy_navigate_form_cb_after_alert

  function sc_hide_form_customer_clubmrjoy_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_customer_family"])
    {
      return true;
    }
    return false;
