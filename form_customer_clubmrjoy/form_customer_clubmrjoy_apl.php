<?php
//
class form_customer_clubmrjoy_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_customer_clubmrjoy']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_customer_clubmrjoy']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_customer_clubmrjoy']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_customer_clubmrjoy']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_customer_clubmrjoy']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_customer_clubmrjoy']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_customer_clubmrjoy']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_customer_clubmrjoy']['form_customer_family_script_case_init'] ]['form_customer_family']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_customer_clubmrjoy']['form_customer_family_script_case_init'] ]['form_customer_family']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_customer_clubmrjoy']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_customer_clubmrjoy']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_customer_clubmrjoy']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_customer_clubmrjoy']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_customer_clubmrjoy']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_customer_clubmrjoy']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_customer_clubmrjoy']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_customer_clubmrjoy']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_customer_clubmrjoy']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_customer_clubmrjoy']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_customer_clubmrjoy']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_customer_clubmrjoy_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_customer_clubmrjoy']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_customer_clubmrjoy']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_customer_clubmrjoy'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_customer_clubmrjoy']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_customer_clubmrjoy']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_customer_clubmrjoy') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_customer_clubmrjoy']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " customer_clubmrjoy";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_customer_clubmrjoy")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_customer_clubmrjoy']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_customer_clubmrjoy'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_clubmrjoy']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_customer_clubmrjoy']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_clubmrjoy']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_customer_clubmrjoy']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_clubmrjoy']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_customer_clubmrjoy']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_clubmrjoy']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_customer_clubmrjoy']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_customer_clubmrjoy']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_customer_clubmrjoy']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_customer_clubmrjoy'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_customer_clubmrjoy'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_clubmrjoy']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_customer_clubmrjoy']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_customer_clubmrjoy']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_clubmrjoy']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_customer_clubmrjoy']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_customer_clubmrjoy']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_clubmrjoy']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_customer_clubmrjoy']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_customer_clubmrjoy']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_customer_clubmrjoy", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_customer_clubmrjoy_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_customer_clubmrjoy_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_customer_clubmrjoy/form_customer_clubmrjoy_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_customer_clubmrjoy_erro.class.php"); 
      }
      $this->Erro      = new form_customer_clubmrjoy_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['opcao']))
         { 
             if ($this->idcustomer != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_clubmrjoy']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_customer_clubmrjoy']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_customer_clubmrjoy']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['form_customer_family_script_case_init'] ]['form_customer_family']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['form_customer_family_script_case_init'] ]['form_customer_family']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['form_customer_family_script_case_init'] ]['form_customer_family']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['form_customer_family_script_case_init'] ]['form_customer_family']['total']);
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_customer_family') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_customer_family') . "/form_customer_family_apl.php");
          $this->form_customer_family = new form_customer_family_apl;
      }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['dados_select'];
     }
   }
   ...
   function controle()
   {
      ...
      $this->ini_controle();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Gera_log_access'])
      {
          $this->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Gera_log_access'] = false;
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_customer_clubmrjoy.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_customer_clubmrjoy_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_customer_clubmrjoy"> 
...
//--------------------------------------------------------------------------------------
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['SC_sep_date']))
       {
           $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['SC_sep_date'];
           $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['SC_sep_date1'];
       }
       ...
       if (in_array(strtolower($this->Ini->nm_con_conn_pos['tpbanco']), $this->Ini->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Ini->nm_db_conn_pos->qstr($usr) . ", 'form_customer_clubmrjoy', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Ini->nm_db_conn_pos->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($this->Ini->nm_con_conn_pos['tpbanco']), $this->Ini->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Ini->nm_db_conn_pos->qstr($usr) . ", 'form_customer_clubmrjoy', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Ini->nm_db_conn_pos->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Ini->nm_db_conn_pos->qstr($usr) . ", 'form_customer_clubmrjoy', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Ini->nm_db_conn_pos->qstr($texto) . ")"; 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_customer_clubmrjoy']) || !is_array($this->NM_ajax_info['errList']['geral_form_customer_clubmrjoy']))
              {
                  $this->NM_ajax_info['errList']['geral_form_customer_clubmrjoy'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_customer_clubmrjoy'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_idcustomer(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['php_cmp_required']['idcustomer']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['php_cmp_required']['idcustomer'] == "on")) 
      { 
          if ($this->idcustomer == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_nombre(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['php_cmp_required']['nombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['php_cmp_required']['nombre'] == "on")) 
      { 
          if ($this->nombre == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_correo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['php_cmp_required']['correo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['php_cmp_required']['correo'] == "on") 
          { 
              $hasError = true;
              $Campos_Falta[] = "Correo" ; 
              if (!isset($Campos_Erros['correo']))
    ...
    function ValidateField_celular(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['php_cmp_required']['celular']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['php_cmp_required']['celular'] == "on")) 
      { 
          if ($this->celular == "")  
          { 
              $hasError = true;
...
;
    ...
    function ValidateField_cliente_tipo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->cliente_tipo == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['php_cmp_required']['cliente_tipo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['php_cmp_required']['cliente_tipo'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->cliente_tipo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_cliente_tipo']) && !in_array($this->cliente_tipo, $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_cliente_tipo']))
          {
              $hasError = true;
    ...
    function ValidateField_provincia(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->provincia == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['php_cmp_required']['provincia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['php_cmp_required']['provincia'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->provincia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_provincia']) && !in_array($this->provincia, $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_provincia']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['provincia']))
    ...
    function ValidateField_canton(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->canton == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['php_cmp_required']['canton']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['php_cmp_required']['canton'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "Canton" ; 
          ...
          if (!empty($this->canton) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_canton']) && !in_array($this->canton, $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_canton']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['canton']))
    ...
    function ValidateField_parroquia(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->parroquia == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['php_cmp_required']['parroquia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['php_cmp_required']['parroquia'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->parroquia) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_parroquia']) && !in_array($this->parroquia, $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_parroquia']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['parroquia']))
    ...
    function ValidateField_direccion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['php_cmp_required']['direccion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['php_cmp_required']['direccion'] == "on")) 
      { 
          if ($this->direccion == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_sector(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['php_cmp_required']['sector']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['php_cmp_required']['sector'] == "on")) 
      { 
          if ($this->sector == "")  
          { 
              $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idcustomer']['keyVal'] = form_customer_clubmrjoy_pack_protect_string($this->nmgp_dados_form['idcustomer']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['form_customer_family_script_case_init'] ]['form_customer_family']['foreign_key']['idcustomer'] = $this->nmgp_dados_form['idcustomer'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['form_customer_family_script_case_init'] ]['form_customer_family']['where_filter'] = "idcustomer = '" . $this->nmgp_dados_form['idcustomer'] . "'";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['form_customer_family_script_case_init'] ]['form_customer_family']['where_detal']  = "idcustomer = '" . $this->nmgp_dados_form['idcustomer'] . "'";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['form_customer_family_script_case_init'] ]['form_customer_family']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['form_customer_family_script_case_init'] ]['form_customer_family']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['form_customer_family_script_case_init'] ]['form_customer_family']['total']);
          }
...
$aLookup[] = array(form_customer_clubmrjoy_pack_protect_string('') => str_replace('<', '&lt;',form_customer_clubmrjoy_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_cliente_tipo'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_customer_clubmrjoy_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_customer_clubmrjoy_pack_protect_string(NM_charset_to_utf8($rs->fields[0]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['cliente_tipo']['valList'][$i] = form_customer_clubmrjoy_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_provincia']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_provincia'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_provincia']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_provincia'] = array(); 
}
$aLookup[] = array(form_customer_clubmrjoy_pack_protect_string('') => str_replace('<', '&lt;',form_customer_clubmrjoy_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_provincia'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_customer_clubmrjoy_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_customer_clubmrjoy_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_provincia'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['provincia']['valList'][$i] = form_customer_clubmrjoy_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_canton']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_canton'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_canton']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_canton'] = array(); 
}
$aLookup[] = array(form_customer_clubmrjoy_pack_protect_string('') => str_replace('<', '&lt;',form_customer_clubmrjoy_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_canton'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_canton'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['canton']['valList'][$i] = form_customer_clubmrjoy_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_parroquia']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_parroquia'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_parroquia']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_parroquia'] = array(); 
}
$aLookup[] = array(form_customer_clubmrjoy_pack_protect_string('') => str_replace('<', '&lt;',form_customer_clubmrjoy_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_parroquia'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['Lookup_parroquia'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['parroquia']['valList'][$i] = form_customer_clubmrjoy_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_family($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['total']);
              }
              ...
              $this->NM_gera_log_new();
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              ...
              $this->form_customer_family->ini_controle();
              if ($this->form_customer_family->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['parms'] = "idcustomer?#?$this->idcustomer?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
      ...
      { 
          ...
          $qt_geral_reg_form_customer_clubmrjoy = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['total'] = $qt_geral_reg_form_customer_clubmrjoy;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idcustomer))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_customer_clubmrjoy = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_start'] > $qt_geral_reg_form_customer_clubmrjoy)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_start'] = $qt_geral_reg_form_customer_clubmrjoy; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_customer_clubmrjoy) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_start']) ;  
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_start'] < $qt_geral_reg_form_customer_clubmrjoy;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['opcao']   = '';
          }
      } 
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_family']['embutida_parms'] = "gidc*scin" . $this->nmgp_dados_form['idcustomer'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scoutlink_remove_margin*scinok*scoutlink_remove_border*scinok*scout";
  }
// 
//-- 
...
// 
   function NM_gera_log_old() 
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['dados_select']))
       {
           $nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['dados_select'];
...
// 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
        include_once("form_customer_clubmrjoy_form0.php");
        include_once("form_customer_clubmrjoy_form1.php");
        include_once("form_customer_clubmrjoy_form2.php");
        $this->hideFormPages();
 }
...
<?php
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_customer_clubmrjoy = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['total'] = $qt_geral_reg_form_customer_clubmrjoy;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_customer_clubmrjoy_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_customer_clubmrjoy_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_customer_clubmrjoy_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer_clubmrjoy']['ordem_ord'] == " desc") {
