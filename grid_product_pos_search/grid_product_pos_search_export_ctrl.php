<?php
@session_start() ;
$_SESSION['scriptcase']['grid_product_pos_search']['sc_process_barr'] = true;
require_once('../grid_product_pos_search/index.php');
unset($_SESSION['scriptcase']['grid_product_pos_search']['sc_process_barr']);
$ExportCtrl = new grid_product_pos_search_export_control;
$ExportCtrl->Export_barr();

class grid_product_pos_search_export_control
{
