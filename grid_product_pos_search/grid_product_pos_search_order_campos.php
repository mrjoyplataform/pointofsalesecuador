...
<?php
   ...
   $Ord_Cmp = new grid_product_pos_search_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_product_pos_search_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id_product"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['labels']["id_product"])) ? $_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['labels']["id_product"] : "Id Product";
   $tab_ger_campos['product_name'] = "on";
   $tab_def_campos['product_name'] = "product_name";
   $tab_labels["product_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['labels']["product_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['labels']["product_name"] : "Product Name";
   $tab_ger_campos['product_code'] = "on";
   $tab_def_campos['product_code'] = "product_code";
   $tab_labels["product_code"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['labels']["product_code"])) ? $_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['labels']["product_code"] : "Product Code";
   $tab_ger_campos['id_status'] = "on";
   $tab_def_campos['id_status'] = "id_status";
   $tab_labels["id_status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['labels']["id_status"])) ? $_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['labels']["id_status"] : "Id Status";
   $tab_ger_campos['dateproduct'] = "on";
   $tab_def_campos['dateproduct'] = "dateproduct";
   $tab_labels["dateproduct"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['labels']["dateproduct"])) ? $_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['labels']["dateproduct"] : "Dateproduct";
   $tab_ger_campos['product_value'] = "on";
   $tab_def_campos['product_value'] = "product_value";
   $tab_labels["product_value"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['labels']["product_value"])) ? $_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['labels']["product_value"] : "Product Value";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_product_pos_search_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_product_pos_search']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
