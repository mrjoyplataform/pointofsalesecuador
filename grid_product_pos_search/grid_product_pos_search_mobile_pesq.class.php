...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_product_name_cond" name="product_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_product_name'), this, 'product_name')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_product_code_cond" name="product_code_cond" onChange="nm_campos_between(document.getElementById('id_vis_product_code'), this, 'product_code')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_id_status_cond" name="id_status_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_status'), this, 'id_status')">
      ...
      <br><span id="id_hide_id_status"  <?php echo $str_hide_id_status?>><INPUT  type="text" id="SC_id_status" name="id_status" value="<?php echo NM_encode_input($id_status) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
