...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_category_' + iSeqRow).bind('change', function() { sc_form_category_id_category__onchange(this, iSeqRow) });
  $('#id_sc_field_category_' + iSeqRow).bind('blur', function() { sc_form_category_category__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_category_category__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_category_category__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_category_id_category__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_category_category__onblur(oThis, iSeqRow) {
  do_ajax_form_category_validate_category_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_category_category__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_category_category__onfocus(oThis, iSeqRow) {
...
function scHidePage(pageNo) {
	$("#id_form_category_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_category')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
