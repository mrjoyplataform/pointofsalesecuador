...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_product_kiosko"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_product_kiosko"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_product_kiosko']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_product_kiosko']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_product_kiosko']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_product_kiosko']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_product_kiosko']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_product_kiosko</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_product_kiosko']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_product_kiosko']['embutida_filho'] as $ind => $sc_init)
          {
