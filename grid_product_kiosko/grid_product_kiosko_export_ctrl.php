<?php
@session_start() ;
$_SESSION['scriptcase']['grid_product_kiosko']['sc_process_barr'] = true;
require_once('../grid_product_kiosko/index.php');
unset($_SESSION['scriptcase']['grid_product_kiosko']['sc_process_barr']);
$ExportCtrl = new grid_product_kiosko_export_control;
$ExportCtrl->Export_barr();

class grid_product_kiosko_export_control
{
