...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_v_ele_pagos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_v_ele_pagos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_ele_pagos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_v_ele_pagos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_ele_pagos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_v_ele_pagos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_v_ele_pagos']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_v_ele_pagos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_v_ele_pagos']['embutida_filho'] as $ind => $sc_init)
          {
