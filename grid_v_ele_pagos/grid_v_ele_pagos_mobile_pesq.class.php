...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "total";$Nm_numeric[] = "id";$Nm_numeric[] = "total";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_forma_pago_cond" name="forma_pago_cond" onChange="nm_campos_between(document.getElementById('id_vis_forma_pago'), this, 'forma_pago')">
      ...
      <br><span id="id_hide_forma_pago"  <?php echo $str_hide_forma_pago?>><?php
      if ($forma_pago != "")
      {
      $forma_pago_look = substr($this->Db->qstr($forma_pago), 1, -1); 
      $nmgp_def_dados = array(); 
