...
<?php
   ...
   $Ord_Cmp = new grid_v_ele_pagos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_ele_pagos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['labels']["id"] : "Id";
   $tab_ger_campos['codigo'] = "on";
   $tab_def_campos['codigo'] = "codigo";
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['labels']["codigo"] : "Codigo";
   $tab_ger_campos['numero'] = "on";
   $tab_def_campos['numero'] = "numero";
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['labels']["numero"] : "Numero";
   $tab_ger_campos['forma_pago'] = "on";
   $tab_def_campos['forma_pago'] = "forma_pago";
   $tab_labels["forma_pago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['labels']["forma_pago"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['labels']["forma_pago"] : "Forma Pago";
   $tab_ger_campos['forma_pago_descripcion'] = "on";
   $tab_def_campos['forma_pago_descripcion'] = "forma_pago_descripcion";
   $tab_labels["forma_pago_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['labels']["forma_pago_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['labels']["forma_pago_descripcion"] : "Forma Pago Descripcion";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['labels']["total"] : "Total";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_ele_pagos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_ele_pagos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
