<?php
include_once('menu_pos_cajero_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_path_prod']      = "";
    $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_perfil']         = "conn_pos";
    $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_usa_grupo']      = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class menu_pos_cajero_class
{
  var $Db;
 ...
 function menu_pos_cajero_menu()
 {
    global $menu_pos_cajero_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['menu_pos_cajero']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "menu_pos_cajero/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('menu_pos_cajero');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/menu_pos_cajero_erro.php");
}
include_once(dirname(__FILE__) . "/menu_pos_cajero_erro.class.php"); 
$this->Erro = new menu_pos_cajero_erro();
$str_path = substr($_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_conexao']);
}

/* Definiciones de las rutas */
$menu_pos_cajero_menuData         = array();
$menu_pos_cajero_menuData['path'] = array();
$menu_pos_cajero_menuData['url']  = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menu_pos_cajero_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menu_pos_cajero_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menu_pos_cajero_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menu_pos_cajero_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menu_pos_cajero_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menu_pos_cajero_menuData['url']['web']   = str_replace("\\", '/', $menu_pos_cajero_menuData['url']['web']);
$menu_pos_cajero_menuData['path']['root'] = substr($menu_pos_cajero_menuData['path']['sys'],  0, -1 * strlen($menu_pos_cajero_menuData['url']['web']));
$menu_pos_cajero_menuData['path']['app']  = substr($menu_pos_cajero_menuData['path']['sys'],  0, strrpos($menu_pos_cajero_menuData['path']['sys'],  '/'));
$menu_pos_cajero_menuData['path']['link'] = substr($menu_pos_cajero_menuData['path']['app'],  0, strrpos($menu_pos_cajero_menuData['path']['app'],  '/'));
$menu_pos_cajero_menuData['path']['link'] = substr($menu_pos_cajero_menuData['path']['link'], 0, strrpos($menu_pos_cajero_menuData['path']['link'], '/')) . '/';
$menu_pos_cajero_menuData['path']['app'] .= '/';
$menu_pos_cajero_menuData['url']['app']   = substr($menu_pos_cajero_menuData['url']['web'],  0, strrpos($menu_pos_cajero_menuData['url']['web'],  '/'));
$menu_pos_cajero_menuData['url']['link']  = substr($menu_pos_cajero_menuData['url']['app'],  0, strrpos($menu_pos_cajero_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_usa_grupo'] == "S")
{
    $menu_pos_cajero_menuData['url']['link']  = substr($menu_pos_cajero_menuData['url']['link'], 0, strrpos($menu_pos_cajero_menuData['url']['link'], '/'));
}
$menu_pos_cajero_menuData['url']['link']  .= '/';
$menu_pos_cajero_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['menu_pos_cajero']['sc_apl_link'] = $menu_pos_cajero_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['menu_pos_cajero']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['menu_pos_cajero']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['menu_pos_cajero']['actual_lang']) || $_SESSION['scriptcase']['menu_pos_cajero']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['menu_pos_cajero']['actual_lang'] = $this->str_lang;
...
include_once("menu_pos_cajero_toolbar.php");
...
if ($_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "menu_pos_cajero";
     $_SESSION['scriptcase']['menu_apls']['menu_pos_cajero'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_conexao']) && $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_perfil']) && $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_pos_cajero']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['menu_pos_cajero']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['menu_pos_cajero']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['menu_pos_cajero']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['menu_pos_cajero']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['menu_pos_cajero']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['menu_pos_cajero']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['menu_pos_cajero']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['menu_pos_cajero']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['menu_pos_cajero']['init']))
{
    $_SESSION['sc_session'][1]['menu_pos_cajero']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menu_pos_cajero']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['menu_pos_cajero']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menu_pos_cajero'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menu_pos_cajero'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menu_pos_cajero'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$this->sc_Include($path_libs . "/nm_ini_lib.php", "F", "nm_dir_normaliza") ; 
/* Dados do menu em sessao */
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menu_pos_cajero'))
{
    $_SESSION['sc_session'][1]['menu_pos_cajero']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menu_pos_cajero'] = "javascript:window.close()";
}
/* Menú de configuración de las variables */
$menu_pos_cajero_menuData['iframe'] = TRUE;
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[4]))
{
 ...
 $nm_var_lab[5] = "Ingreso de tarjetas";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[4]))
{
 ...
 $nm_var_hint[5] = "Ingresa las tarjetas RFID al sistema";
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_pos_cajero'];
$menu_pos_cajero_menuData['data'] .= "item_14|.|" . $nm_var_lab[0] . "||" . $nm_var_hint[0] . "||_self|\n";
$menu_pos_cajero_menuData['data'] .= "item_20|..|" . $nm_var_lab[1] . "||" . $nm_var_hint[1] . "||_self|\n";
$menu_pos_cajero_menuData['data'] .= "item_12|.|" . $nm_var_lab[2] . "||" . $nm_var_hint[2] . "||_self|\n";
$menu_pos_cajero_menuData['data'] .= "item_21|.|" . $nm_var_lab[3] . "||" . $nm_var_hint[3] . "||_self|\n";
$menu_pos_cajero_menuData['data'] .= "item_23|.|" . $nm_var_lab[4] . "||" . $nm_var_hint[4] . "||_self|\n";
...
{
    $menu_pos_cajero_menuData['data'] .= "item_24|..|" . $nm_var_lab[5] . "|menu_pos_cajero_form_php.php?sc_item_menu=item_24&sc_apl_menu=dashboard_rfid_reader_ingresar_tarjeta&sc_apl_link=" . urlencode($menu_pos_cajero_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->menu_pos_cajero_target('_self') . "|" . "\n";
}
else
{
    $menu_pos_cajero_menuData['data'] .= "item_24|..|" . $nm_var_lab[5] . "||||_self|disabled\n";
}
$menu_pos_cajero_menuData['data'] .= "item_25|..|" . $nm_var_lab[6] . "||" . $nm_var_hint[6] . "||_self|\n";
$menu_pos_cajero_menuData['data'] .= "item_26|..|" . $nm_var_lab[7] . "||" . $nm_var_hint[7] . "||_self|\n";
$menu_pos_cajero_menuData['data'] .= "item_27|..|" . $nm_var_lab[8] . "||" . $nm_var_hint[8] . "||_self|\n";
$menu_pos_cajero_menuData['data'] .= "item_17|.|" . $nm_var_lab[9] . "||" . $nm_var_hint[9] . "||_self|\n";
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_pos_cajero'];
$menu_pos_cajero_menuData['data'] .= "item_9|.|" . $this->Nm_lang['lang_exit'] . "|$saida_apl|" . $nm_var_hint[10] . "||_parent|\n";
...
$menu_pos_cajero_menuData['data'] = array();
$str_disabled = "N";
$str_link = "#";
$str_icon = "";
$icon_aba = "";
...
$str_disabled = "N";
$str_link = "menu_pos_cajero_form_php.php?sc_item_menu=item_24&sc_apl_menu=dashboard_rfid_reader_ingresar_tarjeta&sc_apl_link=" . urlencode($menu_pos_cajero_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['dashboard_rfid_reader_ingresar_tarjeta']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['dashboard_rfid_reader_ingresar_tarjeta']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_pos_cajero_menuData['data'][] = array(
        ...
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " item-target=\"" . $this->menu_pos_cajero_target('_self') . "\"",
        'sc_id'    => "item_24",
        'disabled' => $str_disabled,
        'display'     => "text_fontawesomeicon",
        'display_position'=> "text_right",
...
$menu_pos_cajero_menuData['data'][] = array(
    ...
    'icon_aba' => $icon_aba,
    'icon_aba_inactive' => $icon_aba_inactive,
    'target'   => " item-target=\"" . $this->menu_pos_cajero_target('_parent') . "\"",
    'sc_id'    => "item_9",
    'disabled' => $str_disabled,
    'display'     => "text_fontawesomeicon",
    'display_position'=> "text_right",
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_pos_cajero']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['menu_pos_cajero']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'menu_pos_cajero');
    $menu_pos_cajero_menuData['data'] = $str_menu_usu;
}
if (is_file("menu_pos_cajero_help.txt"))
{
    $Arq_WebHelp = file("menu_pos_cajero_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menu_pos_cajero_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->menu_pos_cajero_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menu_pos_cajero']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menu_pos_cajero']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($menu_pos_cajero_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['menu_pos_cajero']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($menu_pos_cajero_menuData['data'][$i_menu]);
       }
    ...
    $menu_pos_cajero_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['menu_pos_cajero']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menu_pos_cajero']))
{
    $disable_menu = false;
    foreach ($menu_pos_cajero_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['menu_pos_cajero']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $menu_pos_cajero_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* Cabecera HTML */
if ($menu_pos_cajero_menuData['iframe'])
{
    $menu_pos_cajero_menuData['height'] = '100%';
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
<script type="text/javascript">
   ...
   {
           var str_location = document.getElementById('iframe_menu_pos_cajero').contentWindow.location.toString();
...
{
    $menu_pos_cajero_menuData['height'] = '30px';
}
...
<script  type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/jquery.contextmenu.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/contextmenu.css" /> 
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="menu_pos_cajero_message.js"></script>
...
Iframe_atual = "menu_pos_cajero_iframe";
...
<?php
 $seq = 0;
echo "Tab_iframes[" . $seq . "] = \"menu_pos_cajero\";\r\n";
echo "Tab_labels['menu_pos_cajero'] = \"\";\r\n";
echo "Tab_hints['menu_pos_cajero'] = \"\";\r\n";
echo "Tab_abas['menu_pos_cajero']   = \"none\";\r\n";
echo "Tab_refresh['menu_pos_cajero']   = \"\";\r\n";
echo "Tab_icons['menu_pos_cajero'] = \"scriptcase__NM__ico__NM__sc_menu_home_e.png\";\r\n";
echo "Tab_icons_inactive['menu_pos_cajero'] = \"scriptcase__NM__ico__NM__sc_menu_home_d.png\";\r\n";
echo "Tab_icon_fa['menu_pos_cajero']   = \"\";\r\n";
echo "Tab_icon_fa_inactive['menu_pos_cajero']   = \"\";\r\n";
echo "Tab_display['menu_pos_cajero']   = \"\";\r\n";
echo "Tab_display_position['menu_pos_cajero']   = \"\";\r\n";
echo "Tab_links['menu_pos_cajero']   = \"\";\r\n";
         $seq++;
 if(isset($menu_pos_cajero_menuData['data']) && !empty($menu_pos_cajero_menuData['data']))
 {
   foreach ($menu_pos_cajero_menuData['data'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
 ...
 if(isset($menu_pos_cajero_menuData['data_vertical']) && !empty($menu_pos_cajero_menuData['data_vertical']))
 {
   foreach ($menu_pos_cajero_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         if(empty($dados_menu['hint']))
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl)
{
    ...
    iframe.name = 'menu_pos_cajero_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    var home_style="";
    if(str_id === 'menu_pos_cajero'){ home_style=";padding-left:4px;min-height:14px;"; }
...
function mudaIframe(str_id)
{
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            {
                $('#Iframe_control').append('<iframe id="iframe_'+ Tab_iframes[i] +'" name="menu_pos_cajero_'+ Tab_iframes[i] +'_iframe" frameborder="0" class="scMenuIframe" style="display: none; width: 100%; height: 100%;" src=""></iframe>');
            }
            ...
            if (Tab_iframes[i] != 'menu_pos_cajero') 
            {
                Iframe_atual = "menu_pos_cajero_" + Tab_iframes[i] + '_iframe';
            }
...
{
  str_target_sv = "";
  if (str_id != "iframe_menu_pos_cajero")
  {
      str_target_sv = str_id + "_iframe";
      str_id        = str_id.replace("menu_pos_cajero_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_menu_pos_cajero', 'menu_pos_cajero');
    if (str_target == "menu_pos_cajero_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
        str_target = (str_target_sv != "") ? str_target_sv : str_target;
        mudaIframe(str_id);
        if (str_id != "menu_pos_cajero")
        {
            $('#links_abas').css('display','');
            $('#id_links_abas').css('display','');
        }
        if (str_id != "menu_pos_cajero" && Tab_abas[str_id] != 'show')
        {
            createAba(str_id);
      scToggleOverflow();
        }
    ...
    if(str_target != '_blank' && $('#iframe_menu_pos_cajero').length)
        $('#iframe_menu_pos_cajero')[0].contentWindow.focus();
  }
}
</script>
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $menu_pos_cajero_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCss scMenuLine" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->menu_pos_cajero_escreveMenu($menu_pos_cajero_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Control de iframe */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $menu_pos_cajero_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
...
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_menu_pos_cajero');\" item-href=\"menu_pos_cajero_form_php.php?sc_item_menu=menu_pos_cajero&sc_apl_menu=chart_sales&sc_apl_link=" . urlencode($menu_pos_cajero_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_pos_cajero_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "menu_pos_cajero_pag_ini.php");
} 
?>
      <iframe id="iframe_menu_pos_cajero" name="menu_pos_cajero_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
}
?></div></td>
  </tr>
...
{
    echo "<script>";
    echo "   document.getElementById('iframe_menu_pos_cajero').click()";
    echo "</script>";
}
...
/* Control de Target */
function menu_pos_cajero_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function menu_pos_cajero_target($str_target)
{
    global $menu_pos_cajero_menuData;
    ...
    elseif ($menu_pos_cajero_menuData['iframe'])
    {
        return 'menu_pos_cajero_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $menu_pos_cajero_menuData, $path_imag_cab)
{
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "menu_pos_cajero_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_pos_cajero_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "menu_pos_cajero_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_pos_cajero_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->menu_pos_cajero_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['menu_pos_cajero']['sc_init'][$apl_menu] = rand(2, 10000);
        $_SESSION['sc_session'][$_SESSION['scriptcase']['menu_pos_cajero']['sc_init'][$apl_menu]] = array();
        return  $_SESSION['scriptcase']['menu_pos_cajero']['sc_init'][$apl_menu];
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_path_imag_temp'] . "/sc_apl_default_pointofsales.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu_pos_cajero']['glo_nm_path_imag_temp'] . "/sc_apl_default_pointofsales.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "menu_pos_cajero") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['menu_pos_cajero']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['menu_pos_cajero']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['menu_pos_cajero']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_pointofsales'])) {
            $_SESSION['scriptcase']['menu_pos_cajero']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_pointofsales'];
        }
    }
}
...
$contr_menu_pos_cajero = new menu_pos_cajero_class;
$contr_menu_pos_cajero->menu_pos_cajero_menu();
