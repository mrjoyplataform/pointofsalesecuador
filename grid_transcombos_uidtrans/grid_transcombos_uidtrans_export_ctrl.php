<?php
@session_start() ;
$_SESSION['scriptcase']['grid_transcombos_uidtrans']['sc_process_barr'] = true;
require_once('../grid_transcombos_uidtrans/index.php');
unset($_SESSION['scriptcase']['grid_transcombos_uidtrans']['sc_process_barr']);
$ExportCtrl = new grid_transcombos_uidtrans_export_control;
$ExportCtrl->Export_barr();

class grid_transcombos_uidtrans_export_control
{
