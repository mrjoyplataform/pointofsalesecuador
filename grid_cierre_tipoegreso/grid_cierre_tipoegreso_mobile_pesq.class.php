...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idegreso";$Nm_numeric[] = "activo";$Nm_numeric[] = "idegreso";$Nm_numeric[] = "activo";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idegreso_cond" name="idegreso_cond" onChange="nm_campos_between(document.getElementById('id_vis_idegreso'), this, 'idegreso')">
      ...
      <br><span id="id_hide_idegreso"  <?php echo $str_hide_idegreso?>><INPUT  type="text" id="SC_idegreso" name="idegreso" value="<?php echo NM_encode_input($idegreso) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_activo_cond" name="activo_cond" onChange="nm_campos_between(document.getElementById('id_vis_activo'), this, 'activo')">
      ...
      <br><span id="id_hide_activo"  <?php echo $str_hide_activo?>><INPUT  type="text" id="SC_activo" name="activo" value="<?php echo NM_encode_input($activo) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
