<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cierre_tipoegreso']['sc_process_barr'] = true;
require_once('../grid_cierre_tipoegreso/index.php');
unset($_SESSION['scriptcase']['grid_cierre_tipoegreso']['sc_process_barr']);
$ExportCtrl = new grid_cierre_tipoegreso_export_control;
$ExportCtrl->Export_barr();

class grid_cierre_tipoegreso_export_control
{
