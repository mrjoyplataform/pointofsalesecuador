...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____registro_boleto_ceibos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____registro_boleto_ceibos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['registro_boleto_ceibos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['registro_boleto_ceibos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['registro_boleto_ceibos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['registro_boleto_ceibos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['registro_boleto_ceibos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>registro_boleto_ceibos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['registro_boleto_ceibos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['registro_boleto_ceibos']['embutida_filho'] as $ind => $sc_init)
          {
