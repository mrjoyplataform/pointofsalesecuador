<?php
@session_start() ;
$_SESSION['scriptcase']['registro_boleto_ceibos']['sc_process_barr'] = true;
require_once('../registro_boleto_ceibos/index.php');
unset($_SESSION['scriptcase']['registro_boleto_ceibos']['sc_process_barr']);
$ExportCtrl = new registro_boleto_ceibos_export_control;
$ExportCtrl->Export_barr();

class registro_boleto_ceibos_export_control
{
...
<HEAD>
 <TITLE>Registro de Boletos <?php echo $_SESSION['fullphone'] ?></TITLE>
