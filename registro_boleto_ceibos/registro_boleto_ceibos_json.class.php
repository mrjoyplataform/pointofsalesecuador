...
class registro_boleto_ceibos_json
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "registro_boleto_ceibos/registro_boleto_ceibos_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['json_format'];
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['json_return']);
      ...
      $this->Arquivo     .= ".json";
      $this->Tit_doc      = "registro_boleto_ceibos.json";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['json_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['json_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['json_name'] .= ".json";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['json_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['json_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['json_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['json_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['json_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['json_name']);
      }
...
$_SESSION['scriptcase']['registro_boleto_ceibos']['contr_erro'] = 'off'; 
      ...
      { 
          ...
          { 
              ...
              require_once($this->Ini->path_aplicacao . "registro_boleto_ceibos_res_json.class.php");
              $this->Res = new registro_boleto_ceibos_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['json_res_grid']);
          } 
      }
   ...
   function NM_export_boletopic()
   {
         ...
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->boletopic;
   }
   //----- qrboleto
   ...
   {
         $this->characterpic = NM_charset_to_utf8($this->characterpic);
         if ($this->Json_use_label)
         {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->characterpic;
   }
   //----- nombre
   ...
   function NM_export_edad()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->edad;
   }
   //----- genero
   ...
   function NM_export_coin()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->coin;
   }
   //----- puntos
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['json_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['json_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Registro de Boletos <?php echo $_SESSION['fullphone'] ?> :: JSON</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['registro_boleto_ceibos']['json_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
