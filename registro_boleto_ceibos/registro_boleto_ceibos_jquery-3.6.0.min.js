...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        if (!SC_Proc_Mobile) {
            document.getElementById('nmsc_iframe_liga_A_registro_boleto_ceibos').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_E_registro_boleto_ceibos').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_D_registro_boleto_ceibos').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_B_registro_boleto_ceibos').src = 'NM_Blank_Page.htm';
            document.getElementById('nmsc_iframe_liga_A_registro_boleto_ceibos').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_E_registro_boleto_ceibos').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_D_registro_boleto_ceibos').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_B_registro_boleto_ceibos').style.height = '0px';
            document.getElementById('nmsc_iframe_liga_A_registro_boleto_ceibos').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_E_registro_boleto_ceibos').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_D_registro_boleto_ceibos').style.width  = '0px';
            document.getElementById('nmsc_iframe_liga_B_registro_boleto_ceibos').style.width  = '0px';
        }
        if (oResp["setValue"]) {
