<?php
@session_start() ;
$_SESSION['scriptcase']['grid_sales_pdf_reimpresion']['sc_process_barr'] = true;
require_once('../grid_sales_pdf_reimpresion/index.php');
unset($_SESSION['scriptcase']['grid_sales_pdf_reimpresion']['sc_process_barr']);
$ExportCtrl = new grid_sales_pdf_reimpresion_export_control;
$ExportCtrl->Export_barr();

class grid_sales_pdf_reimpresion_export_control
{
