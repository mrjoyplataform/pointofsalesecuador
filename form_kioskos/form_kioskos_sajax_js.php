  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_kioskos" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idkiosko_
  function do_ajax_form_kioskos_validate_idkiosko_(iNumLinha)
  {
    var nomeCampo_idkiosko_ = "idkiosko_" + iNumLinha;
    var var_idkiosko_ = scAjaxGetFieldText(nomeCampo_idkiosko_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kioskos_validate_idkiosko_(var_idkiosko_, iNumLinha, var_script_case_init, do_ajax_form_kioskos_validate_idkiosko__cb);
  } // do_ajax_form_kioskos_validate_idkiosko_

  function do_ajax_form_kioskos_validate_idkiosko__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idkiosko_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idkiosko_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idkiosko_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idkiosko_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kioskos_validate_idkiosko__cb

  // ---------- Validate nombre_
  function do_ajax_form_kioskos_validate_nombre_(iNumLinha)
  {
    var nomeCampo_nombre_ = "nombre_" + iNumLinha;
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kioskos_validate_nombre_(var_nombre_, iNumLinha, var_script_case_init, do_ajax_form_kioskos_validate_nombre__cb);
  } // do_ajax_form_kioskos_validate_nombre_

  function do_ajax_form_kioskos_validate_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kioskos_validate_nombre__cb

  // ---------- Validate activo_
  function do_ajax_form_kioskos_validate_activo_(iNumLinha)
  {
    var nomeCampo_activo_ = "activo_" + iNumLinha;
    var var_activo_ = scAjaxGetFieldText(nomeCampo_activo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kioskos_validate_activo_(var_activo_, iNumLinha, var_script_case_init, do_ajax_form_kioskos_validate_activo__cb);
  } // do_ajax_form_kioskos_validate_activo_

  function do_ajax_form_kioskos_validate_activo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kioskos_validate_activo__cb

  // ---------- Validate codigo_
  function do_ajax_form_kioskos_validate_codigo_(iNumLinha)
  {
    var nomeCampo_codigo_ = "codigo_" + iNumLinha;
    var var_codigo_ = scAjaxGetFieldText(nomeCampo_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kioskos_validate_codigo_(var_codigo_, iNumLinha, var_script_case_init, do_ajax_form_kioskos_validate_codigo__cb);
  } // do_ajax_form_kioskos_validate_codigo_

  function do_ajax_form_kioskos_validate_codigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kioskos_validate_codigo__cb

  // ---------- Validate cargo_
  function do_ajax_form_kioskos_validate_cargo_(iNumLinha)
  {
    var nomeCampo_cargo_ = "cargo_" + iNumLinha;
    var var_cargo_ = scAjaxGetFieldText(nomeCampo_cargo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kioskos_validate_cargo_(var_cargo_, iNumLinha, var_script_case_init, do_ajax_form_kioskos_validate_cargo__cb);
  } // do_ajax_form_kioskos_validate_cargo_

  function do_ajax_form_kioskos_validate_cargo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kioskos_validate_cargo__cb

  // ---------- Validate menu_default_
  function do_ajax_form_kioskos_validate_menu_default_(iNumLinha)
  {
    var nomeCampo_menu_default_ = "menu_default_" + iNumLinha;
    var var_menu_default_ = scAjaxGetFieldText(nomeCampo_menu_default_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kioskos_validate_menu_default_(var_menu_default_, iNumLinha, var_script_case_init, do_ajax_form_kioskos_validate_menu_default__cb);
  } // do_ajax_form_kioskos_validate_menu_default_

  function do_ajax_form_kioskos_validate_menu_default__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "menu_default_" + iLineNumber;
    }
    else
    {
      sFieldValid = "menu_default_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "menu_default_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "menu_default_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_kioskos_validate_menu_default__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_kioskos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_kioskos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_kioskos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_kioskos_add_new_line_cb);
  } // do_ajax_form_kioskos_add_new_line

  function do_ajax_form_kioskos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_kioskos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_kioskos_backup_line(iNumLinha)
  {
    var var_idkiosko_ = scAjaxGetFieldText("idkiosko_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_kioskos_backup_line(var_idkiosko_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_kioskos_backup_line_cb);
  } // do_ajax_form_kioskos_backup_line

  function do_ajax_form_kioskos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_kioskos_backup_line_cb

  function do_ajax_form_kioskos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_kioskos_cancel_insert

  function do_ajax_form_kioskos_cancel_update(iSeqVert)
  {
    do_ajax_form_kioskos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_kioskos_cancel_update

  function do_ajax_form_kioskos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_kioskos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_kioskos_table_refresh()
  {
    var var_idkiosko_ = document.F2.idkiosko_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_kioskos_table_refresh(var_idkiosko_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_kioskos_table_refresh_cb);
  } //  do_ajax_form_kioskos_table_refresh

  function do_ajax_form_kioskos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idkiosko_.value = scAjaxGetKeyValue("idkiosko_");
    ...
    scAjaxAlert(do_ajax_form_kioskos_table_refresh_cb_after_alert);
  } // do_ajax_form_kioskos_table_refresh_cb
  function do_ajax_form_kioskos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_kioskos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_kioskos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_kioskos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_activo_ = scAjaxGetFieldText("activo_" + iNumLinha);
    var var_codigo_ = scAjaxGetFieldText("codigo_" + iNumLinha);
    var var_cargo_ = scAjaxGetFieldText("cargo_" + iNumLinha);
    var var_menu_default_ = scAjaxGetFieldText("menu_default_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_kioskos_submit_form(var_idkiosko_, var_nombre_, var_activo_, var_codigo_, var_cargo_, var_menu_default_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_kioskos_submit_form_cb);
  } // do_ajax_form_kioskos_submit_form

  function do_ajax_form_kioskos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idkiosko_" + sc_num_ult_line);
      ...
      scAjaxHideErrorDisplay("menu_default_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_kioskos_submit_form_cb_after_alert);
  } // do_ajax_form_kioskos_submit_form_cb
  function do_ajax_form_kioskos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_kioskos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_kioskos_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_kioskos_navigate_form, function() {});
    } else {
      perform_ajax_form_kioskos_navigate_form();
    }
  }

  function perform_ajax_form_kioskos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_kioskos_cancel_insert(sc_form_kioskos_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idkiosko_" + iNavForm);
      ...
      scAjaxHideErrorDisplay("menu_default_" + iNavForm);
    }
    var var_idkiosko_ = document.F2.idkiosko_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_kioskos_navigate_form(var_idkiosko_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_kioskos_navigate_form_cb);
  } // do_ajax_form_kioskos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_kioskos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_kioskos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idkiosko_.value = scAjaxGetKeyValue("idkiosko_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_kioskos_navigate_form_cb_after_alert);
  } // do_ajax_form_kioskos_navigate_form_cb
  function do_ajax_form_kioskos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_kioskos_navigate_form_cb_after_alert

    function sc_form_kioskos_get_last_line_number()
    {
    ...
    } //sc_form_kioskos_get_last_line_number

  function sc_hide_form_kioskos_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idkiosko_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "menu_default_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idkiosko_" + iNumLinha] = {"label": "Idkiosko<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["menu_default_" + iNumLinha] = {"label": "Menu Default<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idkiosko_"][iNumLinha] = "idkiosko_" + iNumLinha;
    ...
    ajax_field_mult["menu_default_"][iNumLinha] = "menu_default_" + iNumLinha;
    ajax_field_id["idkiosko_" + iNumLinha] = new Array("hidden_field_label_idkiosko_", "hidden_field_data_idkiosko_" + iNumLinha);
    ...
    ajax_field_id["menu_default_" + iNumLinha] = new Array("hidden_field_label_menu_default_", "hidden_field_data_menu_default_" + iNumLinha);
    ajax_error_count["idkiosko_" + iNumLinha] = "off";
    ...
    ajax_error_count["menu_default_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idkiosko_" + iNumLinha] = "on";
    ...
    ajax_read_only["menu_default_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["menu_default_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idkiosko_" + iNumLinha] = null;
    ...
    ajax_error_list["menu_default_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idkiosko_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idkiosko_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idkiosko_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idkiosko_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idkiosko_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["menu_default_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["menu_default_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["menu_default_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["menu_default_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["menu_default_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idkiosko_'])) ? $this->nmgp_cmp_readonly['idkiosko_'] : 'on';
?>
    scAjaxFieldRead("idkiosko_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['menu_default_'])) ? $this->nmgp_cmp_readonly['menu_default_'] : 'off';
?>
    scAjaxFieldRead("menu_default_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idkiosko_" + iSeq, "on");
    ...
    scAjaxFieldRead("menu_default_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idkiosko_" + iRow] || "on" == ajax_error_count["nombre_" + iRow] || "on" == ajax_error_count["activo_" + iRow] || "on" == ajax_error_count["codigo_" + iRow] || "on" == ajax_error_count["cargo_" + iRow] || "on" == ajax_error_count["menu_default_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idkiosko_" + iRow).addClass("scFormErrorLine");
      ...
      $("#hidden_field_data_cargo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_menu_default_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idkiosko_" + iRow] && "off" == ajax_error_count["nombre_" + iRow] && "off" == ajax_error_count["activo_" + iRow] && "off" == ajax_error_count["codigo_" + iRow] && "off" == ajax_error_count["cargo_" + iRow] && "off" == ajax_error_count["menu_default_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idkiosko_" + iRow] = "off";
        ...
        ajax_error_count["menu_default_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idkiosko_" + iRow).removeClass("scFormErrorLine");
      ...
      $("#hidden_field_data_cargo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_menu_default_" + iRow).removeClass("scFormErrorLine");
    }
  }
