...
class grid_reporte_sales_formapago_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_sucursal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['sucursal'];
          $this->array_total_datesales = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['datesales'];
          $this->array_total_cuentaventa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['cuentaventa'];
      }
      else
      {
          $this->array_total_sucursal = array();
   ...
   function completeMatrix()
   {
       ...
       $Lab_sucursal = "Sucursal";
       $Lab_datesales = "Datesales";
       $Lab_datesales =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", $Lab_datesales);
       $Lab_cuentaventa = "Cuentaventa";
       }
       $this->comp_field = array(
           $Lab_sucursal,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['summarizing_fields_order']['datesales_sucursal_cuentaventa_producto']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['summarizing_fields_order']['datesales_sucursal_cuentaventa_producto'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['summarizing_fields_order']['datesales_sucursal_cuentaventa_producto'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['summarizing_fields_display']['datesales_sucursal_cuentaventa_producto'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['summarizing_fields_display']['datesales_sucursal_cuentaventa_producto'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['summarizing_fields_display']['datesales_sucursal_cuentaventa_producto'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['summarizing_fields_display']['datesales_sucursal_cuentaventa_producto'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['summarizing_fields_display']['datesales_sucursal_cuentaventa_producto'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['summarizing_fields_display']['datesales_sucursal_cuentaventa_producto'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['summarizing_fields_display']['datesales_sucursal_cuentaventa_producto'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_sucursal as $i_sucursal => $d_sucursal) {
           if (!in_array($i_sucursal, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_sucursal[3] ] = $d_sucursal[2];
               $this->comp_label[0][ $d_sucursal[3] ] = $d_sucursal[2];
           }
           foreach ($this->array_total_datesales[$i_sucursal] as $i_datesales => $d_datesales) {
               if (!in_array($i_datesales, $this->comp_label[1][ $d_sucursal[3] ], true)) {
                   $this->comp_index[1][ $d_datesales[3] ] = $d_datesales[2];
                   $this->comp_label[1][ $d_sucursal[3] ][ $d_datesales[3] ] = $d_datesales[2];
               }
               foreach ($this->array_total_cuentaventa[$i_sucursal][$i_datesales] as $i_cuentaventa => $d_cuentaventa) {
                   if (!in_array($i_cuentaventa, $this->comp_label[2][ $d_sucursal[3] ][ $d_datesales[3] ], true)) {
                       $this->comp_index[2][ $d_cuentaventa[3] ] = $d_cuentaventa[2];
                       $this->comp_label[2][ $d_sucursal[3] ][ $d_datesales[3] ][ $d_cuentaventa[3] ] = $d_cuentaventa[2];
                   }
               }
           }
       }
       ...
       $this->comp_links_fl = array(
           ...
           array('name' => 'datesales', 'prot' => '@aspass@'),
           array('name' => 'cuentaventa', 'prot' => '@aspass@'),
       );
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order_level'] = -1;
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_sucursal => $l_sucursal) {
           if (isset($this->array_total_sucursal[$i_sucursal])) {
               $this->comp_group[$i_sucursal] = array();
           }
           foreach ($this->comp_label[1][$i_sucursal] as $i_datesales => $l_datesales) {
               if (isset($this->array_total_datesales[$i_sucursal][$i_datesales])) {
                   $this->comp_group[$i_sucursal][$i_datesales] = array();
               }
               foreach ($this->comp_label[2][$i_sucursal][$i_datesales] as $i_cuentaventa => $l_cuentaventa) {
                   if (isset($this->array_total_cuentaventa[$i_sucursal][$i_datesales][$i_cuentaventa])) {
                       $this->comp_group[$i_sucursal][$i_datesales][$i_cuentaventa] = array();
                   }
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       ...
       elseif (1 == $level) {
           $return = $this->array_total_datesales;
       }
       elseif (2 == $level) {
           $return = $this->array_total_cuentaventa;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      ...
      ksort($this->array_total_datesales);
      ksort($this->array_total_cuentaventa);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_valor_siniva, $quebra_sucursal, $quebra_datesales, $quebra_cuentaventa, $quebra_sucursal_orig, $quebra_datesales_orig, $quebra_cuentaventa_orig)
   {
      //----- Sucursal
      if (!isset($this->array_total_sucursal[$quebra_sucursal_orig]))
      {
         $this->array_total_sucursal[$quebra_sucursal_orig][0] = 1;
         $this->array_total_sucursal[$quebra_sucursal_orig][1] = $sum_valor_siniva;
         $this->array_total_sucursal[$quebra_sucursal_orig][2] = $quebra_sucursal;
         $this->array_total_sucursal[$quebra_sucursal_orig][3] = $quebra_sucursal_orig;
      }
      else
      {
         $this->array_total_sucursal[$quebra_sucursal_orig][0]++;
         $this->array_total_sucursal[$quebra_sucursal_orig][1] = bcadd($this->array_total_sucursal[$quebra_sucursal_orig][1], $sum_valor_siniva, 10);
      }
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "
      if (!isset($this->array_total_datesales[$quebra_sucursal_orig][$quebra_datesales_orig]))
      {
         $this->array_total_datesales[$quebra_sucursal_orig][$quebra_datesales_orig][0] = 1;
         $this->array_total_datesales[$quebra_sucursal_orig][$quebra_datesales_orig][1] = $sum_valor_siniva;
         $this->array_total_datesales[$quebra_sucursal_orig][$quebra_datesales_orig][2] = $quebra_datesales;
         $this->array_total_datesales[$quebra_sucursal_orig][$quebra_datesales_orig][3] = $quebra_datesales_orig;
      }
      else
      {
         $this->array_total_datesales[$quebra_sucursal_orig][$quebra_datesales_orig][0]++;
         $this->array_total_datesales[$quebra_sucursal_orig][$quebra_datesales_orig][1] = bcadd($this->array_total_datesales[$quebra_sucursal_orig][$quebra_datesales_orig][1], $sum_valor_siniva, 10);
      }
      //----- Cuentaventa
      if (!isset($this->array_total_cuentaventa[$quebra_sucursal_orig][$quebra_datesales_orig][$quebra_cuentaventa_orig]))
      {
         $this->array_total_cuentaventa[$quebra_sucursal_orig][$quebra_datesales_orig][$quebra_cuentaventa_orig][0] = 1;
         $this->array_total_cuentaventa[$quebra_sucursal_orig][$quebra_datesales_orig][$quebra_cuentaventa_orig][1] = $sum_valor_siniva;
         $this->array_total_cuentaventa[$quebra_sucursal_orig][$quebra_datesales_orig][$quebra_cuentaventa_orig][2] = $quebra_cuentaventa;
         $this->array_total_cuentaventa[$quebra_sucursal_orig][$quebra_datesales_orig][$quebra_cuentaventa_orig][3] = $quebra_cuentaventa_orig;
      }
      else
      {
         $this->array_total_cuentaventa[$quebra_sucursal_orig][$quebra_datesales_orig][$quebra_cuentaventa_orig][0]++;
         $this->array_total_cuentaventa[$quebra_sucursal_orig][$quebra_datesales_orig][$quebra_cuentaventa_orig][1] = bcadd($this->array_total_cuentaventa[$quebra_sucursal_orig][$quebra_datesales_orig][$quebra_cuentaventa_orig][1], $sum_valor_siniva, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $format       = $this->Ini->Get_Gb_date_format('', 'datesales');
     $campos_order = $this->Ini->Get_date_order_groupby("datesales", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'cuentaventa');
     $campos_order = $this->Ini->Get_date_order_groupby("cuentaventa", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $Prefix_dat = $this->Ini->Get_Gb_prefix_date_format('datesales_sucursal_cuentaventa_producto', 'datesales');
            $TP_Time    = (in_array('datesales', $this->Ini->Cmp_Sql_Time)) ? "0000-00-00 " : "";
            $this->datesales_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->datesales, $Format_tst);
            $this->datesales = $this->Ini->GB_date_format($TP_Time . $this->datesales, $Format_tst, $Prefix_dat, "N", "F/Y");
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->valor_siniva, $this->sucursal, $this->datesales, $this->cuentaventa, $this->sucursal_orig,  $this->datesales_orig,  $this->cuentaventa_orig);
            }
   }
//
