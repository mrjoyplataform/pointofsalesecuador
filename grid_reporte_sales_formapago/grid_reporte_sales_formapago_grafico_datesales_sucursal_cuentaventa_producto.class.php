...
<?php
   ...
   function inicializa_vars()
   {
      ...
      //---- Label
      $this->label    = array();
      $this->label[0] = "Sucursal";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['contr_label_graf']['sucursal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['contr_label_graf']['sucursal']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['contr_label_graf']['sucursal'];
      }
      $this->label[1] = "" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['contr_label_graf']['datesales']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['contr_label_graf']['datesales']))
      {
         $this->label[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['contr_label_graf']['datesales'];
      }
      $this->label[2] = "Cuentaventa";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['contr_label_graf']['cuentaventa']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['contr_label_graf']['cuentaventa']))
      {
         $this->label[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['contr_label_graf']['cuentaventa'];
      }
   }
