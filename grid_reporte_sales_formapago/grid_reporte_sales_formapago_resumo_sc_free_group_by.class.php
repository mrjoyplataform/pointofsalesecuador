...
class grid_reporte_sales_formapago_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['dashboard_info']['under_dashboard'] ? "off" : "on";

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_reporte_sales_formapago'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_reporte_sales_formapago'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_sales_formapago']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_sales_formapago']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_sales_formapago']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_reporte_sales_formapago']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_reporte_sales_formapago']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pesq_tab_label']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pesq_tab_label'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pesq_tab_label'] .= "datesales?#?" . "Datesales" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pesq_tab_label'] .= "sucursal?#?" . "Sucursal" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pesq_tab_label'] .= "cuentaventa?#?" . "Cuentaventa" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pesq_tab_label'] .= "jugador?#?" . "Jugador" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pesq_tab_label'] .= "visitante?#?" . "Visitante" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pesq_tab_label'] .= "comida?#?" . "Comida" . "?@?";
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['grid_search_add']))
      {
          $this->monta_css();
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pesq_tab_label'];
          ...
          $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['grid_search_add']['seq'];
          $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['grid_search_add']['cmp'];
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['grid_search_add']);
          exit;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['dyn_search_ch_bi']))
      {
          ob_start();
          $tmp_opc = $opc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['dyn_search_ch_bi']['opc'];
          $this->Ini->process_cond_bi($opc, $bi_dt1, $bi_dt2);
          $NM_func_dyn_ch_bi = "formata_bi_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['dyn_search_ch_bi']['cmp'];
          ...
          $oJson = new Services_JSON();
          echo $oJson->encode($this->Arr_result);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['dyn_search_ch_bi']);
          exit;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['opcao'] != "pdf")
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              $Arr_tot_name = "array_total_" . $cmp_gb;
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['sucursal'] = $this->array_total_sucursal;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['cuentaventa'] = $this->array_total_cuentaventa;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['jugador'] = $this->array_total_jugador;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['visitante'] = $this->array_total_visitante;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['entrada'] = $this->array_total_entrada;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['comida'] = $this->array_total_comida;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['producto'] = $this->array_total_producto;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['codproducto'] = $this->array_total_codproducto;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['idcliente'] = $this->array_total_idcliente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['datesales'] = $this->array_total_datesales;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['datesales_scgb_192'] = $this->array_total_datesales_scgb_192;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['datesales_scgb_203'] = $this->array_total_datesales_scgb_203;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['datesales_scgb_193'] = $this->array_total_datesales_scgb_193;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['datesales_scgb_195'] = $this->array_total_datesales_scgb_195;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['datesales_scgb_196'] = $this->array_total_datesales_scgb_196;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['datesales_scgb_197'] = $this->array_total_datesales_scgb_197;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['datesales_scgb_198'] = $this->array_total_datesales_scgb_198;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['datesales_scgb_199'] = $this->array_total_datesales_scgb_199;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['datesales_scgb_200'] = $this->array_total_datesales_scgb_200;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['datesales_scgb_201'] = $this->array_total_datesales_scgb_201;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['datesales_scgb_202'] = $this->array_total_datesales_scgb_202;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['datesales_scgb_204'] = $this->array_total_datesales_scgb_204;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total']['datesales_scgb_194'] = $this->array_total_datesales_scgb_194;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['json_use_label'])
       {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['sucursal'] = $Lab_sucursal; 
       $prep_field['cuentaventa'] = $Lab_cuentaventa;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['cuentaventa'] = $Lab_cuentaventa; 
       $prep_field['jugador'] = $Lab_jugador;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['jugador'] = $Lab_jugador; 
       $prep_field['visitante'] = $Lab_visitante;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['visitante'] = $Lab_visitante; 
       $prep_field['entrada'] = $Lab_entrada;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['entrada'] = $Lab_entrada; 
       $prep_field['comida'] = $Lab_comida;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['comida'] = $Lab_comida; 
       $prep_field['producto'] = $Lab_producto;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['producto'] = $Lab_producto; 
       $prep_field['codproducto'] = $Lab_codproducto;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['codproducto'] = $Lab_codproducto; 
       $prep_field['idcliente'] = $Lab_idcliente;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['idcliente'] = $Lab_idcliente; 
       $prep_field['datesales'] = $Lab_datesales;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales'] = $Lab_datesales; 
       $prep_field['datesales_scgb_192'] = $Lab_datesales_scgb_192;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_192'] = $Lab_datesales_scgb_192; 
       $prep_field['datesales_scgb_203'] = $Lab_datesales_scgb_203;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_203'] = $Lab_datesales_scgb_203; 
       $prep_field['datesales_scgb_193'] = $Lab_datesales_scgb_193;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_193'] = $Lab_datesales_scgb_193; 
       $prep_field['datesales_scgb_195'] = $Lab_datesales_scgb_195;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_195'] = $Lab_datesales_scgb_195; 
       $prep_field['datesales_scgb_196'] = $Lab_datesales_scgb_196;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_196'] = $Lab_datesales_scgb_196; 
       $prep_field['datesales_scgb_197'] = $Lab_datesales_scgb_197;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_197'] = $Lab_datesales_scgb_197; 
       $prep_field['datesales_scgb_198'] = $Lab_datesales_scgb_198;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_198'] = $Lab_datesales_scgb_198; 
       $prep_field['datesales_scgb_199'] = $Lab_datesales_scgb_199;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_199'] = $Lab_datesales_scgb_199; 
       $prep_field['datesales_scgb_200'] = $Lab_datesales_scgb_200;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_200'] = $Lab_datesales_scgb_200; 
       $prep_field['datesales_scgb_201'] = $Lab_datesales_scgb_201;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_201'] = $Lab_datesales_scgb_201; 
       $prep_field['datesales_scgb_202'] = $Lab_datesales_scgb_202;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_202'] = $Lab_datesales_scgb_202; 
       $prep_field['datesales_scgb_204'] = $Lab_datesales_scgb_204;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_204'] = $Lab_datesales_scgb_204; 
       $prep_field['datesales_scgb_194'] = $Lab_datesales_scgb_194;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_194'] = $Lab_datesales_scgb_194; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['id_sales_detail']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['id_sales_detail'] = "Id Sales Detail"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['unit_cost']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['unit_cost'] = "Unit Cost"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['unit_value']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['unit_value'] = "Unit Value"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['quantity']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['quantity'] = "Quantity"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['discount']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['discount'] = "Discount"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['item_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['item_total'] = "Item Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['id_product']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['id_product'] = "Id Product"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['uniqueidtrans']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['uniqueidtrans'] = "Uniqueidtrans"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['fechatrans']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['fechatrans'] = "Fechatrans"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['valor_siniva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['valor_siniva'] = "Valor Siniva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['valor_unitario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['valor_unitario'] = "Valor Unitario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['codproducto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['codproducto'] = "Codproducto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['producto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['producto'] = "Producto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['entrada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['entrada'] = "Entrada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['jugador']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['jugador'] = "Jugador"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['visitante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['visitante'] = "Visitante"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['tarjeta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['tarjeta'] = "Tarjeta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['tokens']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['tokens'] = "Tokens"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['minutos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['minutos'] = "Minutos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['comida']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['comida'] = "Comida"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['cuentaventa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['cuentaventa'] = "Cuentaventa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['sucursal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['sucursal'] = "Sucursal"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['id_sales']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['id_sales'] = "Id Sales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['sales_price']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['sales_price'] = "Sales Price"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['sales_discount']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['sales_discount'] = "Sales Discount"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['total'] = "Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['id_status']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['id_status'] = "Id Status"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['idcaja']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['idcaja'] = "Idcaja"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['idcliente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['idcliente'] = "Idcliente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['cliente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['cliente'] = "Cliente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['direccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['direccion'] = "Direccion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['telefono'] = "Telefono"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['factura']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['factura'] = "Factura"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['serie']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['serie'] = "Serie"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['clave_acceso']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['clave_acceso'] = "Clave Acceso"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['enviosri']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['enviosri'] = "Enviosri"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['fechaenvio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['fechaenvio'] = "Fechaenvio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['uniqueid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['uniqueid'] = "Uniqueid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['estado'] = "Estado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['fechaid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['fechaid'] = "Fechaid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['importe_recibido']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['importe_recibido'] = "Importe Recibido"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['codigoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['codigoid'] = "Codigoid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['totalsinimpuestos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['totalsinimpuestos'] = "Total Sin Impuestos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['totaldescuento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['totaldescuento'] = "Total Descuento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['baseimponible']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['baseimponible'] = "Base Imponible"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['valoriva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['valoriva'] = "Valoriva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['importetotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['importetotal'] = "Importe Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['idpago']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['idpago'] = "Idpago"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['totalpago']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['totalpago'] = "Totalpago"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['cliente_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['cliente_email'] = "Cliente Email"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['idempleado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['idempleado'] = "Idempleado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['idturno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['idturno'] = "Idturno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['codpago_sri']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['codpago_sri'] = "Codpago Sri"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['imprime']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['imprime'] = "Imprime"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['comprobante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['comprobante'] = "Comprobante"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_192']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_192'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_203']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_203'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_193']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_193'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_195']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_195'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_196']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_196'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_197']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_197'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_198']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_198'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_199']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_199'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_200']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_200'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_201']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_201'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_202']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_202'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_204']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_204'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_194']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['labels']['datesales_scgb_194'] = "Datesales"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_reporte_sales_formapago@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['proc_pdf_vert'])
   {
     $this->comp_tab_hover = true;
   }
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_charts'];
	}
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_reporte_sales_formapago_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_reporte_sales_formapago_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
         ...
         { 
            ...
            { 
                $seq_search = 1;
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['grid_pesq'] as $cmp => $def)
                {
                   $Seq_grid      = $seq_search;
                   $Cmp_grid      = $cmp;
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_reporte_sales_formapago']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_reporte_sales_formapago']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_reporte_sales_formapago']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_reporte_sales_formapago']) . "_";
               } 
           }
       }
   ...
   function resumo_final()
   {
      ...
      if (!$this->NM_res_sem_reg && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['opcao'] != "pdf")
      {
          $this->grafico_bot();
      }
      if ("out" == $this->NM_tipo)
   ...
   function inicializa_vars()
   {
      ...
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new grid_reporte_sales_formapago_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " reporte_sales</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_reporte_sales_formapago_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_reporte_sales_formapago_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_reporte_sales_formapago_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_reporte_sales_formapago/grid_reporte_sales_formapago_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_prod . "/third/jquery_plugin/thickbox/thickbox.css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_reporte_sales_formapago_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_reporte_sales_formapago_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_reporte_sales_formapago_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['num_css'] . '.css');
     ...
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $vertical_center = '';
          $nm_saida->saida(" <BODY id=\"grid_summary\" class=\"" . $this->css_scGridPage . "\" style=\"" . $remove_margin . $vertical_center . "\">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_formapago/grid_reporte_sales_formapago_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_formapago/grid_reporte_sales_formapago_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_reporte_sales_formapago&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_formapago/grid_reporte_sales_formapago_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_formapago/grid_reporte_sales_formapago_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_reporte_sales_formapago/grid_reporte_sales_formapago_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_reporte_sales_formapago/grid_reporte_sales_formapago_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_reporte_sales_formapago_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("grid_reporte_sales_formapago_help.txt"); 
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rword_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['word'][] = "Rword_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_formapago/grid_reporte_sales_formapago_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xml'][] = "Rxml_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_formapago/grid_reporte_sales_formapago_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_reporte_sales_formapago']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_reporte_sales_formapago']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_reporte_sales_formapago_config_pivot.php?nome_apl=grid_reporte_sales_formapago&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_reporte_sales_formapago_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_reporte_sales_formapago/grid_reporte_sales_formapago_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
      $nm_saida->saida("       }\r\n");
      $nm_saida->saida("       else\r\n");
      $nm_saida->saida("       {\r\n");
      ...
      $nm_saida->saida("               document.Fdoc_word.action = \"grid_reporte_sales_formapago_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("               document.Fprint.action = \"grid_reporte_sales_formapago_export_ctrl.php\";\r\n");
      $nm_saida->saida("           }\r\n");
      $nm_saida->saida("           else\r\n");
      $nm_saida->saida("           {\r\n");
      ...
      $nm_saida->saida("               document.Fexport.action = \"grid_reporte_sales_formapago_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['grid_reporte_sales_formapago_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_reporte_sales_formapago@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("          nm_submit_modal(\"" . $this->Ini->path_link . "grid_reporte_sales_formapago/grid_reporte_sales_formapago_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_reporte_sales_formapago_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_reporte_sales_formapago/grid_reporte_sales_formapago_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['print_all'];
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pdf_res'])
       {
           $nm_saida->saida("<TR>\r\n");
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['skip_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_charts']);
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               grid_reporte_sales_formapago_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['this_chart_label'] = '';
       ...
       if ($bChartFP)
       {
           ...
           grid_reporte_sales_formapago_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
           fwrite($this->progress_fp, 90 . "_#NM#_" . $lang_protect . "...\n");
           fclose($this->progress_fp);
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['chart_list']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['chart_list'] as $arr_chart)
       {
           $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
       $nm_saida->saida("<b><div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_btns_chrt_pdff_hint'] . "</H1></div></b>\r\n");
           $nm_saida->saida("<table><tr><td>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   $bPDF = false;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new grid_reporte_sales_formapago_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
           ...
           grid_reporte_sales_formapago_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
           grid_reporte_sales_formapago_pdf_progress_call("\n", $this->Ini->Nm_lang);
           grid_reporte_sales_formapago_pdf_progress_call("\n", $this->Ini->Nm_lang);
           grid_reporte_sales_formapago_pdf_progress_call("100\n", $this->Ini->Nm_lang);
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pivot_charts'] as $chart_index => $chart_data)
       {
           ...
           if ($bPDF)
           {
               ...
               if ($this->progress_fp)
               {
                   grid_reporte_sales_formapago_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "/" . $iChartTotal . "...\n", $this->Ini->Nm_lang, true);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['ajax_nav'])
      {
       ...
       $nm_saida->saida("</TABLE>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $jugador = $Busca_temp['jugador']; 
          $tmp_pos = strpos($jugador, "##@@");
          if ($tmp_pos !== false && !is_array($jugador))
          {
              $jugador = substr($jugador, 0, $tmp_pos);
          }
          $visitante = $Busca_temp['visitante']; 
          $tmp_pos = strpos($visitante, "##@@");
          if ($tmp_pos !== false && !is_array($visitante))
          {
              $visitante = substr($visitante, 0, $tmp_pos);
          }
          $comida = $Busca_temp['comida']; 
          $tmp_pos = strpos($comida, "##@@");
          if ($tmp_pos !== false && !is_array($comida))
          {
              $comida = substr($comida, 0, $tmp_pos);
          }
      } 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['cond_pesq'], 0, $trab_pos);
     ...
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['proc_pdf_vert']) {
      ...
      $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " reporte_sales</div>\r\n");
   ...
   //---- 
   function adiciona_registro($sum_valor_siniva, $quebra_sucursal, $quebra_cuentaventa, $quebra_jugador, $quebra_visitante, $quebra_entrada, $quebra_comida, $quebra_producto, $quebra_codproducto, $quebra_idcliente, $quebra_datesales, $quebra_datesales_scgb_192, $quebra_datesales_scgb_203, $quebra_datesales_scgb_193, $quebra_datesales_scgb_195, $quebra_datesales_scgb_196, $quebra_datesales_scgb_197, $quebra_datesales_scgb_198, $quebra_datesales_scgb_199, $quebra_datesales_scgb_200, $quebra_datesales_scgb_201, $quebra_datesales_scgb_202, $quebra_datesales_scgb_204, $quebra_datesales_scgb_194, $quebra_sucursal_orig, $quebra_cuentaventa_orig, $quebra_jugador_orig, $quebra_visitante_orig, $quebra_entrada_orig, $quebra_comida_orig, $quebra_producto_orig, $quebra_codproducto_orig, $quebra_idcliente_orig, $quebra_datesales_orig, $quebra_datesales_scgb_192_orig, $quebra_datesales_scgb_203_orig, $quebra_datesales_scgb_193_orig, $quebra_datesales_scgb_195_orig, $quebra_datesales_scgb_196_orig, $quebra_datesales_scgb_197_orig, $quebra_datesales_scgb_198_orig, $quebra_datesales_scgb_199_orig, $quebra_datesales_scgb_200_orig, $quebra_datesales_scgb_201_orig, $quebra_datesales_scgb_202_orig, $quebra_datesales_scgb_204_orig, $quebra_datesales_scgb_194_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_valor_siniva . ';
          ...
          {
              $this->' . $arr_name . '[0]++;
              $this->' . $arr_name . '[1] = bcadd($this->' . $arr_name . '[1], ' . $sum_valor_siniva . ', 10);
          }
          ');
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
//
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
                        ...
                        if ($cmp == "jugador")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "jugador";
                           $lin_obj = $this->grid_search_jugador($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "visitante")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "visitante";
                           $lin_obj = $this->grid_search_visitante($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "comida")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "comida";
                           $lin_obj = $this->grid_search_comida($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['grid_pesq']))
           { 
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('datesales','sucursal','cuentaventa','jugador','visitante','comida');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['grid_pesq']) < 6)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_sucursal($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['psq_check_ret']['sucursal'] = array();
       $sucursal_look = substr($this->Db->qstr($sucursal), 1, -1); 
       $nmgp_def_dados  = ""; 
       $nm_comando = "SELECT idsucursal, nombre  FROM sucursales  ORDER BY nombre"; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['psq_check_ret']['sucursal'][] = trim($rs->fields[0]);
   ...
   function grid_search_cuentaventa($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['psq_check_ret']['cuentaventa'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['psq_check_ret']['cuentaventa'][] = trim($rs->fields[0]);
   ...
   function grid_search_jugador($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_jugador_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_jugador_cond_" . $ind . "' name='cond_grid_search_jugador_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       $selected = ($opc == "eq") ? " selected" : "";
       $lin_obj .= "        <option value='eq'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_exac'] . "</option>";
       $lin_obj .= "       </select>";
       if ($opc == "nu" || $opc == "nn" || $opc == "ep" || $opc == "ne")
       ...
       $lin_obj .= "       <span id=\"grid_jugador_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['psq_check_ret']['jugador'] = array();
       $nmgp_def_dados  = ""; 
       $nmgp_def_dados .= "?#??#?N?@?"; 
       $nmgp_def_dados .= "SI?#?1?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['psq_check_ret']['jugador'][] = "1";
       $nmgp_def_dados .= "NO?#?0?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['psq_check_ret']['jugador'][] = "0";
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' id=\"grid_search_jugador_val_" . $ind . "\" name=\"val_grid_search_jugador_" . $ind . "\"  size=1>";
       $delimitador = "##@@";
       $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
       $nm_opcoes  = explode("?@?", $nm_opcoesx);
       $val = isset($val[0]) ? $val[0] : array();
       foreach ($nm_opcoes as $nm_opcao)
       {
          if (!empty($nm_opcao))
          {
             ...
             {
                $jugador_sel = ("S" == $nm_opc_sel) ? " selected" : "";
             }
             $lin_obj .= "       <OPTION value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\"" . $jugador_sel . ">" . $nm_opc_val . "</OPTION>";
          }
       }
       $lin_obj .= "    </SELECT>";
       $lin_obj .= "       </span>";
   ...
   function grid_search_visitante($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_visitante_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_visitante_cond_" . $ind . "' name='cond_grid_search_visitante_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       $selected = ($opc == "eq") ? " selected" : "";
       $lin_obj .= "        <option value='eq'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_exac'] . "</option>";
       $lin_obj .= "       </select>";
       if ($opc == "nu" || $opc == "nn" || $opc == "ep" || $opc == "ne")
       ...
       $lin_obj .= "       <span id=\"grid_visitante_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['psq_check_ret']['visitante'] = array();
       $nmgp_def_dados  = ""; 
       $nmgp_def_dados .= "?#??#?N?@?"; 
       $nmgp_def_dados .= "SI?#?1?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['psq_check_ret']['visitante'][] = "1";
       $nmgp_def_dados .= "NO?#?0?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['psq_check_ret']['visitante'][] = "0";
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' id=\"grid_search_visitante_val_" . $ind . "\" name=\"val_grid_search_visitante_" . $ind . "\"  size=1>";
       $delimitador = "##@@";
       $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
       $nm_opcoes  = explode("?@?", $nm_opcoesx);
       $val = isset($val[0]) ? $val[0] : array();
       foreach ($nm_opcoes as $nm_opcao)
       {
          if (!empty($nm_opcao))
          {
             ...
             {
                $visitante_sel = ("S" == $nm_opc_sel) ? " selected" : "";
             }
             $lin_obj .= "       <OPTION value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\"" . $visitante_sel . ">" . $nm_opc_val . "</OPTION>";
          }
       }
       $lin_obj .= "    </SELECT>";
       $lin_obj .= "       </span>";
   ...
   function grid_search_comida($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_comida_" . $ind . "' style='display:none; z-index: 10'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_comida_cond_" . $ind . "' name='cond_grid_search_comida_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       $selected = ($opc == "eq") ? " selected" : "";
       $lin_obj .= "        <option value='eq'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_exac'] . "</option>";
       $lin_obj .= "       </select>";
       if ($opc == "nu" || $opc == "nn" || $opc == "ep" || $opc == "ne")
       ...
       $lin_obj .= "       <span id=\"grid_comida_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['psq_check_ret']['comida'] = array();
       $nmgp_def_dados  = ""; 
       $nmgp_def_dados .= "?#??#?N?@?"; 
       $nmgp_def_dados .= "SI?#?1?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['psq_check_ret']['comida'][] = "1";
       $nmgp_def_dados .= "NO?#?0?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['psq_check_ret']['comida'][] = "0";
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' id=\"grid_search_comida_val_" . $ind . "\" name=\"val_grid_search_comida_" . $ind . "\"  size=1>";
       $delimitador = "##@@";
       $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
       $nm_opcoes  = explode("?@?", $nm_opcoesx);
       $val = isset($val[0]) ? $val[0] : array();
       foreach ($nm_opcoes as $nm_opcao)
       {
          if (!empty($nm_opcao))
          {
             ...
             {
                $comida_sel = ("S" == $nm_opc_sel) ? " selected" : "";
             }
             $lin_obj .= "       <OPTION value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\"" . $comida_sel . ">" . $nm_opc_val . "</OPTION>";
          }
       }
       $lin_obj .= "    </SELECT>";
       $lin_obj .= "       </span>";
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "pointofsales/grid_reporte_sales_formapago";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida(" function sc_grid_reporte_sales_formapago_valida_mes(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_reporte_sales_formapago_valida_dia(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['datesales_mes'] =  'sc_grid_reporte_sales_formapago_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['datesales_dia'] =  'sc_grid_reporte_sales_formapago_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['datesales_v2__mes'] =  'sc_grid_reporte_sales_formapago_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['datesales_v2__dia'] =  'sc_grid_reporte_sales_formapago_valida_dia(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_formapago']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['datesales_mes']", 'value' => 'sc_grid_reporte_sales_formapago_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['datesales_dia']", 'value' => 'sc_grid_reporte_sales_formapago_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['datesales_v2__mes']", 'value' => 'sc_grid_reporte_sales_formapago_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['datesales_v2__dia']", 'value' => 'sc_grid_reporte_sales_formapago_valida_dia(this)');
       } 
       ...
       $nm_saida->saida("                     result  = grid_search_get_Dselelect(obj_dyn + i + '_dest');\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'jugador')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     result  = grid_search_get_select(obj_dyn + i, '');\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'visitante')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     result  = grid_search_get_select(obj_dyn + i, '');\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'comida')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     result  = grid_search_get_select(obj_dyn + i, '');\r\n");
       $nm_saida->saida("                 }\r\n");
