...
Table_sv_fil[0] = "datesales";
Table_sv_fil[1] = "sucursal";
Table_sv_fil[2] = "cuentaventa";
Table_sv_fil[3] = "jugador";
Table_sv_fil[4] = "visitante";
Table_sv_fil[5] = "comida";
function ajax_select_filter(parm)
{
    ...
    $.ajax({
     ...
     .done(function(json_sel_fil) {
        ...
        if ($("#SC_datesales_cond") && search_get_sel_txt("SC_datesales_cond").substring(0, 3) == "bi_") {
            formata_bi_datesales(search_get_sel_txt("SC_datesales_cond"), SC_datesales_bi_opc, SC_datesales_bi_dt);
        }
