...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_reporte_sales_formapago"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_reporte_sales_formapago"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_sales_formapago']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_reporte_sales_formapago']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_sales_formapago']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_reporte_sales_formapago']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_reporte_sales_formapago']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_reporte_sales_formapago</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_sales_formapago']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_reporte_sales_formapago']['embutida_filho'] as $ind => $sc_init)
          {
