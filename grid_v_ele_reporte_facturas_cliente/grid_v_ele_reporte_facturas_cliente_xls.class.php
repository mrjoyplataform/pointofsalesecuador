...
class grid_v_ele_reporte_facturas_cliente_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_v_ele_reporte_facturas_cliente/grid_v_ele_reporte_facturas_cliente_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_v_ele_reporte_facturas_cliente_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_v_ele_reporte_facturas_cliente.zip";
          $this->Arquivo   .= "_grid_v_ele_reporte_facturas_cliente" . $this->Xls_tp;
          $this->Tit_doc    = "grid_v_ele_reporte_facturas_cliente" . $this->Xls_tp;
          $this->Tit_zip    = "grid_v_ele_reporte_facturas_cliente.zip";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $pos      = strrpos($this->Ini->link_grid_v_ele_facturas_detalle_cons_emb, '/');
      $link_xls = substr($this->Ini->link_grid_v_ele_facturas_detalle_cons_emb, 0, $pos) . "/grid_v_ele_facturas_detalle_xls.class.php";
      if (!is_file($this->Ini->link_grid_v_ele_facturas_detalle_cons_emb) || !is_file($link_xls))
      {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          if (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_facturas_detalle']['embutida'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_facturas_detalle']['embutida_label'] = true;
              $GLOBALS["script_case_init"] = $this->Ini->sc_page;
   ...
   function NM_export_detalle()
   {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_facturas_detalle']['embutida'] = true;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_facturas_detalle']['nolabel'] = true;
         if (method_exists($this->grid_v_ele_facturas_detalle, "controle"))
         {
             $this->grid_v_ele_facturas_detalle->controle();
             if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['xls_file'] = $this->Xls_f;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas_cliente']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
