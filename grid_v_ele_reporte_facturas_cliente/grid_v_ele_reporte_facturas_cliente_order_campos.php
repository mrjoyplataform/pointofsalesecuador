<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_v_ele_reporte_facturas_cliente']['glo_nm_path_imag_temp'] . "/sc_apl_default_pointofsales.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_v_ele_reporte_facturas_cliente_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_v_ele_reporte_facturas_cliente_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["numero"] : "Numero";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['documento'] = "on";
   $tab_def_campos['documento'] = "documento";
   $tab_labels["documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["documento"] : "Documento";
   $tab_ger_campos['razon_social'] = "on";
   $tab_def_campos['razon_social'] = "razon_social";
   $tab_labels["razon_social"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["razon_social"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["razon_social"] : "Razon Social";
   $tab_ger_campos['estado'] = "on";
   $tab_def_campos['estado'] = "estado";
   $tab_labels["estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["estado"] : "Estado";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["total"] : "Total";
   $tab_ger_campos['total_sin_iva'] = "on";
   $tab_def_campos['total_sin_iva'] = "total_sin_iva";
   $tab_labels["total_sin_iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["total_sin_iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["total_sin_iva"] : "Total Sin Iva";
   $tab_ger_campos['total_con_iva'] = "on";
   $tab_def_campos['total_con_iva'] = "total_con_iva";
   $tab_labels["total_con_iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["total_con_iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["total_con_iva"] : "Total Con Iva";
   $tab_ger_campos['iva'] = "on";
   $tab_def_campos['iva'] = "iva";
   $tab_labels["iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["iva"] : "Iva";
   $tab_ger_campos['ice'] = "on";
   $tab_def_campos['ice'] = "ice";
   $tab_labels["ice"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["ice"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["ice"] : "Ice";
   $tab_ger_campos['descuentos'] = "on";
   $tab_def_campos['descuentos'] = "descuentos";
   $tab_labels["descuentos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["descuentos"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["descuentos"] : "Descuentos";
   $tab_ger_campos['correo_electronico'] = "on";
   $tab_def_campos['correo_electronico'] = "correo_electronico";
   $tab_labels["correo_electronico"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["correo_electronico"])) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['labels']["correo_electronico"] : "Correo Electronico";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_v_ele_reporte_facturas_cliente_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_v_ele_reporte_facturas_cliente']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
