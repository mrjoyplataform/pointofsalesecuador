...
function ajax_select_filter(parm)
{
    ...
    $.ajax({
     ...
     .done(function(json_sel_fil) {
        ...
        if ($("#SC_fecha_registro_cond") && search_get_sel_txt("SC_fecha_registro_cond").substring(0, 3) == "bi_") {
            formata_bi_fecha_registro(search_get_sel_txt("SC_fecha_registro_cond"), SC_fecha_registro_bi_opc, SC_fecha_registro_bi_dt);
        }
