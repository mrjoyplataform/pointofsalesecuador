...
class grid_view_boletos_pendientes_salida_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_fecha_registro;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_fecha_registro = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_view_boletos_pendientes_salida']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_view_boletos_pendientes_salida']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['arr_total']['estado'] = $this->array_total_estado;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['arr_total']['fecha_registro'] = $this->array_total_fecha_registro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['arr_total']['idproducto'] = $this->array_total_idproducto;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['json_use_label'])
       {
          $Lab_estado = "estado";
          $Lab_fecha_registro = "fecha_registro";
          $Lab_idproducto = "idproducto";
       }
       else
       {
       $Lab_estado = "Estado";
       $Lab_fecha_registro = "Fecha Registro";
       $Lab_fecha_registro =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", $Lab_fecha_registro);
       $Lab_idproducto = "Idproducto";
       }
       $prep_field = array();
       $prep_field['estado'] = $Lab_estado;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['estado'] = $Lab_estado; 
       $prep_field['fecha_registro'] = $Lab_fecha_registro;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['fecha_registro'] = $Lab_fecha_registro; 
       $prep_field['idproducto'] = $Lab_idproducto;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['idproducto'] = $Lab_idproducto; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['qrboleto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['qrboleto'] = "Qrboleto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['codrfid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['codrfid'] = "Codrfid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['fecha_registro']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['fecha_registro'] = "Fecha Registro"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['uidtrans']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['uidtrans'] = "Uidtrans"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['idsale']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['idsale'] = "Idsale"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['idproducto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['idproducto'] = "Idproducto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['ultdevice']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['ultdevice'] = "Ultdevice"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['ultfecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['ultfecha'] = "Ultfecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['estado'] = "Estado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['nombre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['nombre'] = "Nombre"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['fecha_nacimiento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['fecha_nacimiento'] = "Fecha Nacimiento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['genero']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['genero'] = "Genero"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['username']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['username'] = "Username"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['fecha_activacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['fecha_activacion'] = "Fecha Activacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['fecha_entrada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['fecha_entrada'] = "Fecha Entrada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['fecha_salida']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['fecha_salida'] = "Fecha Salida"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['producto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['producto'] = "Producto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['entrada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['entrada'] = "Entrada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['jugador']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['jugador'] = "Jugador"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['visitante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['visitante'] = "Visitante"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['tarjeta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['tarjeta'] = "Tarjeta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['tokens']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['tokens'] = "Tokens"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['minutos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['minutos'] = "Minutos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['comida']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['comida'] = "Comida"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['puntos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['puntos'] = "Puntos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['registro']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['registro'] = "Registro"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['idchar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['labels']['idchar'] = "Idchar"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['fecha_registro']['alin'] = "''";
       $Arr_parms['fecha_registro']['link'] = "S";
       ...
       $Arr_parms['fecha_registro']['fill'] = "true";
       $Arr_parms['fecha_registro']['order'] = "value";
       $Arr_parms['fecha_registro']['order_start'] = 'asc';
       $Arr_parms['fecha_registro']['order_invert'] = 'false';
       $Arr_parms['fecha_registro']['order_enabled'] = 'true';
       $Arr_parms['fecha_registro']['order_datatype'] = 'timestamp';
       ...
       $prep_links_fl['fecha_registro'] = array(0 => 'fecha_registro', 1 => '@aspass@');
       $prep_links_fl['idproducto'] = array(0 => 'idproducto', 1 => '');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_view_boletos_pendientes_salida@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_estado)),
           ...
           '1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fecha_registro',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_fecha_registro)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_charts'];
	}
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_view_boletos_pendientes_salida_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_view_boletos_pendientes_salida_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_view_boletos_pendientes_salida_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " view_boletos_pendientes_salida</TITLE>\r\n");
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_view_boletos_pendientes_salida/grid_view_boletos_pendientes_salida_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_view_boletos_pendientes_salida_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_view_boletos_pendientes_salida_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_view_boletos_pendientes_salida_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['num_css'] . '.css');
     ...
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_view_boletos_pendientes_salida/grid_view_boletos_pendientes_salida_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_view_boletos_pendientes_salida&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_view_boletos_pendientes_salida/grid_view_boletos_pendientes_salida_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_view_boletos_pendientes_salida/grid_view_boletos_pendientes_salida_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_view_boletos_pendientes_salida/grid_view_boletos_pendientes_salida_config_graf_flash.php?nome_apl=grid_view_boletos_pendientes_salida&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_view_boletos_pendientes_salida_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rpdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['pdf'][] = "Rpdf_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_view_boletos_pendientes_salida/grid_view_boletos_pendientes_salida_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_view_boletos_pendientes_salida&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xml'][] = "Rxml_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_view_boletos_pendientes_salida/grid_view_boletos_pendientes_salida_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_view_boletos_pendientes_salida']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_view_boletos_pendientes_salida']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_view_boletos_pendientes_salida_config_pivot.php?nome_apl=grid_view_boletos_pendientes_salida&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("          nm_submit_modal(\"" . $this->Ini->path_link . "grid_view_boletos_pendientes_salida/grid_view_boletos_pendientes_salida_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_view_boletos_pendientes_salida_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_view_boletos_pendientes_salida/grid_view_boletos_pendientes_salida_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $fecha_registro = $Busca_temp['fecha_registro']; 
          $tmp_pos = strpos($fecha_registro, "##@@");
          if ($tmp_pos !== false && !is_array($fecha_registro))
          {
   ...
   //---- 
   function adiciona_registro($sum_entrada, $quebra_estado, $quebra_fecha_registro, $quebra_idproducto, $quebra_estado_orig, $quebra_fecha_registro_orig, $quebra_idproducto_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_view_boletos_pendientes_salida']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->codrfid = $rs_res->fields[1] ;  
            $this->fecha_registro = $rs_res->fields[2] ;  
            $this->uidtrans = $rs_res->fields[3] ;  
            $this->idsale = $rs_res->fields[4] ;  
            $this->idproducto = $rs_res->fields[5] ;  
            $this->ultdevice = $rs_res->fields[6] ;  
            $this->ultfecha = $rs_res->fields[7] ;  
            $this->estado = $rs_res->fields[8] ;  
            $this->nombre = $rs_res->fields[9] ;  
            $this->fecha_nacimiento = $rs_res->fields[10] ;  
            $this->genero = $rs_res->fields[11] ;  
            $this->username = $rs_res->fields[12] ;  
            $this->fecha_activacion = $rs_res->fields[13] ;  
            $this->fecha_entrada = $rs_res->fields[14] ;  
            $this->fecha_salida = $rs_res->fields[15] ;  
            $this->producto = $rs_res->fields[16] ;  
            $this->entrada = $rs_res->fields[17] ;  
            $this->jugador = $rs_res->fields[18] ;  
            $this->visitante = $rs_res->fields[19] ;  
            $this->tarjeta = $rs_res->fields[20] ;  
            $this->tokens = $rs_res->fields[21] ;  
            $this->minutos = $rs_res->fields[22] ;  
            $this->comida = $rs_res->fields[23] ;  
            $this->puntos = $rs_res->fields[24] ;  
            $this->registro = $rs_res->fields[25] ;  
            $this->idchar = $rs_res->fields[26] ;  
            $this->estado_orig = $this->estado;
            $this->fecha_registro_orig = $this->fecha_registro;
            $this->idproducto_orig = $this->idproducto;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->entrada, $this->estado, $this->fecha_registro, $this->idproducto, $this->estado_orig,  $this->fecha_registro_orig,  $this->idproducto_orig);
            }
   }
//
