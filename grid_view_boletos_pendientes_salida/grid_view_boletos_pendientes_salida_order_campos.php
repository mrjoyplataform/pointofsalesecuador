<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_view_boletos_pendientes_salida']['glo_nm_path_imag_temp'] . "/sc_apl_default_pointofsales.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_view_boletos_pendientes_salida_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_view_boletos_pendientes_salida_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['qrboleto'] = "on";
   $tab_def_campos['qrboleto'] = "qrboleto";
   $tab_labels["qrboleto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["qrboleto"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["qrboleto"] : "Qrboleto";
   $tab_ger_campos['codrfid'] = "on";
   $tab_def_campos['codrfid'] = "codrfid";
   $tab_labels["codrfid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["codrfid"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["codrfid"] : "Codrfid";
   $tab_ger_campos['fecha_registro'] = "on";
   $tab_def_campos['fecha_registro'] = "fecha_registro";
   $tab_labels["fecha_registro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["fecha_registro"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["fecha_registro"] : "Fecha Registro";
   $tab_ger_campos['uidtrans'] = "on";
   $tab_def_campos['uidtrans'] = "uidtrans";
   $tab_labels["uidtrans"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["uidtrans"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["uidtrans"] : "Uidtrans";
   $tab_ger_campos['idsale'] = "on";
   $tab_def_campos['idsale'] = "idsale";
   $tab_labels["idsale"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["idsale"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["idsale"] : "Idsale";
   $tab_ger_campos['idproducto'] = "on";
   $tab_def_campos['idproducto'] = "idproducto";
   $tab_labels["idproducto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["idproducto"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["idproducto"] : "Idproducto";
   $tab_ger_campos['ultdevice'] = "on";
   $tab_def_campos['ultdevice'] = "ultdevice";
   $tab_labels["ultdevice"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["ultdevice"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["ultdevice"] : "Ultdevice";
   $tab_ger_campos['ultfecha'] = "on";
   $tab_def_campos['ultfecha'] = "ultfecha";
   $tab_labels["ultfecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["ultfecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["ultfecha"] : "Ultfecha";
   $tab_ger_campos['estado'] = "on";
   $tab_def_campos['estado'] = "estado";
   $tab_labels["estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["estado"] : "Estado";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "nombre";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["nombre"] : "Nombre";
   $tab_ger_campos['fecha_nacimiento'] = "on";
   $tab_def_campos['fecha_nacimiento'] = "fecha_nacimiento";
   $tab_labels["fecha_nacimiento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["fecha_nacimiento"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["fecha_nacimiento"] : "Fecha Nacimiento";
   $tab_ger_campos['genero'] = "on";
   $tab_def_campos['genero'] = "genero";
   $tab_labels["genero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["genero"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["genero"] : "Genero";
   $tab_ger_campos['username'] = "on";
   $tab_def_campos['username'] = "username";
   $tab_labels["username"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["username"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["username"] : "Username";
   $tab_ger_campos['fecha_activacion'] = "on";
   $tab_def_campos['fecha_activacion'] = "fecha_activacion";
   $tab_labels["fecha_activacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["fecha_activacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["fecha_activacion"] : "Fecha Activacion";
   $tab_ger_campos['fecha_entrada'] = "on";
   $tab_def_campos['fecha_entrada'] = "fecha_entrada";
   $tab_labels["fecha_entrada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["fecha_entrada"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["fecha_entrada"] : "Fecha Entrada";
   $tab_ger_campos['fecha_salida'] = "on";
   $tab_def_campos['fecha_salida'] = "fecha_salida";
   $tab_labels["fecha_salida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["fecha_salida"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["fecha_salida"] : "Fecha Salida";
   $tab_ger_campos['producto'] = "on";
   $tab_def_campos['producto'] = "producto";
   $tab_labels["producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["producto"] : "Producto";
   $tab_ger_campos['entrada'] = "on";
   $tab_def_campos['entrada'] = "entrada";
   $tab_labels["entrada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["entrada"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["entrada"] : "Entrada";
   $tab_ger_campos['jugador'] = "on";
   $tab_def_campos['jugador'] = "jugador";
   $tab_labels["jugador"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["jugador"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["jugador"] : "Jugador";
   $tab_ger_campos['visitante'] = "on";
   $tab_def_campos['visitante'] = "visitante";
   $tab_labels["visitante"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["visitante"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["visitante"] : "Visitante";
   $tab_ger_campos['tarjeta'] = "on";
   $tab_def_campos['tarjeta'] = "tarjeta";
   $tab_labels["tarjeta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["tarjeta"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["tarjeta"] : "Tarjeta";
   $tab_ger_campos['tokens'] = "on";
   $tab_def_campos['tokens'] = "tokens";
   $tab_labels["tokens"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["tokens"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["tokens"] : "Tokens";
   $tab_ger_campos['minutos'] = "on";
   $tab_def_campos['minutos'] = "minutos";
   $tab_labels["minutos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["minutos"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["minutos"] : "Minutos";
   $tab_ger_campos['comida'] = "on";
   $tab_def_campos['comida'] = "comida";
   $tab_labels["comida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["comida"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["comida"] : "Comida";
   $tab_ger_campos['puntos'] = "on";
   $tab_def_campos['puntos'] = "puntos";
   $tab_labels["puntos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["puntos"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["puntos"] : "Puntos";
   $tab_ger_campos['registro'] = "on";
   $tab_def_campos['registro'] = "registro";
   $tab_labels["registro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["registro"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["registro"] : "Registro";
   $tab_ger_campos['idchar'] = "on";
   $tab_def_campos['idchar'] = "idchar";
   $tab_labels["idchar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["idchar"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['labels']["idchar"] : "Idchar";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> view_boletos_pendientes_salida</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_view_boletos_pendientes_salida_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_view_boletos_pendientes_salida']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
