...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_att_registro_username"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_att_registro_username"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_att_registro_username']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_att_registro_username']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_att_registro_username']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_att_registro_username']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_att_registro_username']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_att_registro_username</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_att_registro_username']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_att_registro_username']['embutida_filho'] as $ind => $sc_init)
          {
