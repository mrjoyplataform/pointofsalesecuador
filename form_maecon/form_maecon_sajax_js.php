  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_maecon" == sTestField)
        {
...
?>
  ...
  // ---------- Validate ctamaecon
  function do_ajax_form_maecon_validate_ctamaecon()
  {
    var nomeCampo_ctamaecon = "ctamaecon";
    var var_ctamaecon = scAjaxGetFieldText(nomeCampo_ctamaecon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecon_validate_ctamaecon(var_ctamaecon, var_script_case_init, do_ajax_form_maecon_validate_ctamaecon_cb);
  } // do_ajax_form_maecon_validate_ctamaecon

  function do_ajax_form_maecon_validate_ctamaecon_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecon_validate_ctamaecon_cb

  // ---------- Validate nomcta
  function do_ajax_form_maecon_validate_nomcta()
  {
    var nomeCampo_nomcta = "nomcta";
    var var_nomcta = scAjaxGetFieldText(nomeCampo_nomcta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecon_validate_nomcta(var_nomcta, var_script_case_init, do_ajax_form_maecon_validate_nomcta_cb);
  } // do_ajax_form_maecon_validate_nomcta

  function do_ajax_form_maecon_validate_nomcta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nomcta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecon_validate_nomcta_cb

  // ---------- Validate catctamaecon
  function do_ajax_form_maecon_validate_catctamaecon()
  {
    var nomeCampo_catctamaecon = "catctamaecon";
    var var_catctamaecon = scAjaxGetFieldText(nomeCampo_catctamaecon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecon_validate_catctamaecon(var_catctamaecon, var_script_case_init, do_ajax_form_maecon_validate_catctamaecon_cb);
  } // do_ajax_form_maecon_validate_catctamaecon

  function do_ajax_form_maecon_validate_catctamaecon_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecon_validate_catctamaecon_cb

  // ---------- Validate centrocos
  function do_ajax_form_maecon_validate_centrocos()
  {
    var nomeCampo_centrocos = "centrocos";
    var var_centrocos = scAjaxGetFieldText(nomeCampo_centrocos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecon_validate_centrocos(var_centrocos, var_script_case_init, do_ajax_form_maecon_validate_centrocos_cb);
  } // do_ajax_form_maecon_validate_centrocos

  function do_ajax_form_maecon_validate_centrocos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecon_validate_centrocos_cb

  // ---------- Validate manejacentrocos
  function do_ajax_form_maecon_validate_manejacentrocos()
  {
    var nomeCampo_manejacentrocos = "manejacentrocos";
    var var_manejacentrocos = scAjaxGetFieldText(nomeCampo_manejacentrocos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecon_validate_manejacentrocos(var_manejacentrocos, var_script_case_init, do_ajax_form_maecon_validate_manejacentrocos_cb);
  } // do_ajax_form_maecon_validate_manejacentrocos

  function do_ajax_form_maecon_validate_manejacentrocos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecon_validate_manejacentrocos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_maecon_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_maecon_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_maecon_submit_form(var_ctamaecon, var_nomcta, var_catctamaecon, var_centrocos, var_manejacentrocos, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_maecon_submit_form_cb);
  } // do_ajax_form_maecon_submit_form

  function do_ajax_form_maecon_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_maecon_submit_form_cb_after_alert);
  } // do_ajax_form_maecon_submit_form_cb
  function do_ajax_form_maecon_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_maecon_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_maecon_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_maecon_navigate_form, function() {});
    } else {
      perform_ajax_form_maecon_navigate_form();
    }
  }

  function perform_ajax_form_maecon_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_maecon_navigate_form(var_ctamaecon, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_maecon_navigate_form_cb);
  } // do_ajax_form_maecon_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecon']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_maecon_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_maecon_navigate_form_cb_after_alert);
  } // do_ajax_form_maecon_navigate_form_cb
  function do_ajax_form_maecon_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_maecon_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_maecon_navigate_form_cb_after_alert

  function sc_hide_form_maecon_form()
  {
