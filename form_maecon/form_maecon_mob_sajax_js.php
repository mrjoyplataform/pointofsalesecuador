  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_maecon_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate ctamaecon
  function do_ajax_form_maecon_mob_validate_ctamaecon()
  {
    var nomeCampo_ctamaecon = "ctamaecon";
    var var_ctamaecon = scAjaxGetFieldText(nomeCampo_ctamaecon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecon_mob_validate_ctamaecon(var_ctamaecon, var_script_case_init, do_ajax_form_maecon_mob_validate_ctamaecon_cb);
  } // do_ajax_form_maecon_mob_validate_ctamaecon

  function do_ajax_form_maecon_mob_validate_ctamaecon_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ctamaecon";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecon_mob_validate_ctamaecon_cb

  // ---------- Validate nomcta
  function do_ajax_form_maecon_mob_validate_nomcta()
  {
    var nomeCampo_nomcta = "nomcta";
    var var_nomcta = scAjaxGetFieldText(nomeCampo_nomcta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecon_mob_validate_nomcta(var_nomcta, var_script_case_init, do_ajax_form_maecon_mob_validate_nomcta_cb);
  } // do_ajax_form_maecon_mob_validate_nomcta

  function do_ajax_form_maecon_mob_validate_nomcta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nomcta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecon_mob_validate_nomcta_cb

  // ---------- Validate catctamaecon
  function do_ajax_form_maecon_mob_validate_catctamaecon()
  {
    var nomeCampo_catctamaecon = "catctamaecon";
    var var_catctamaecon = scAjaxGetFieldText(nomeCampo_catctamaecon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecon_mob_validate_catctamaecon(var_catctamaecon, var_script_case_init, do_ajax_form_maecon_mob_validate_catctamaecon_cb);
  } // do_ajax_form_maecon_mob_validate_catctamaecon

  function do_ajax_form_maecon_mob_validate_catctamaecon_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "catctamaecon";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecon_mob_validate_catctamaecon_cb

  // ---------- Validate centrocos
  function do_ajax_form_maecon_mob_validate_centrocos()
  {
    var nomeCampo_centrocos = "centrocos";
    var var_centrocos = scAjaxGetFieldText(nomeCampo_centrocos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecon_mob_validate_centrocos(var_centrocos, var_script_case_init, do_ajax_form_maecon_mob_validate_centrocos_cb);
  } // do_ajax_form_maecon_mob_validate_centrocos

  function do_ajax_form_maecon_mob_validate_centrocos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "centrocos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecon_mob_validate_centrocos_cb

  // ---------- Validate manejacentrocos
  function do_ajax_form_maecon_mob_validate_manejacentrocos()
  {
    var nomeCampo_manejacentrocos = "manejacentrocos";
    var var_manejacentrocos = scAjaxGetFieldText(nomeCampo_manejacentrocos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maecon_mob_validate_manejacentrocos(var_manejacentrocos, var_script_case_init, do_ajax_form_maecon_mob_validate_manejacentrocos_cb);
  } // do_ajax_form_maecon_mob_validate_manejacentrocos

  function do_ajax_form_maecon_mob_validate_manejacentrocos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "manejacentrocos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maecon_mob_validate_manejacentrocos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_maecon_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_maecon_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_ctamaecon = scAjaxGetFieldText("ctamaecon");
    var var_nomcta = scAjaxGetFieldText("nomcta");
    var var_catctamaecon = scAjaxGetFieldText("catctamaecon");
    var var_centrocos = scAjaxGetFieldText("centrocos");
    var var_manejacentrocos = scAjaxGetFieldText("manejacentrocos");
    ...
    scAjaxProcOn();
    x_ajax_form_maecon_mob_submit_form(var_ctamaecon, var_nomcta, var_catctamaecon, var_centrocos, var_manejacentrocos, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_maecon_mob_submit_form_cb);
  } // do_ajax_form_maecon_mob_submit_form

  function do_ajax_form_maecon_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("ctamaecon");
      scAjaxHideErrorDisplay("nomcta");
      scAjaxHideErrorDisplay("catctamaecon");
      scAjaxHideErrorDisplay("centrocos");
      scAjaxHideErrorDisplay("manejacentrocos");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_maecon_mob_submit_form_cb_after_alert);
  } // do_ajax_form_maecon_mob_submit_form_cb
  function do_ajax_form_maecon_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_maecon_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_maecon_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_maecon_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_maecon_mob_navigate_form();
    }
  }

  function perform_ajax_form_maecon_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("centrocos");
    scAjaxHideErrorDisplay("manejacentrocos");
    var var_ctamaecon = document.F2.ctamaecon.value;
    ...
    scAjaxProcOn();
    x_ajax_form_maecon_mob_navigate_form(var_ctamaecon, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_maecon_mob_navigate_form_cb);
  } // do_ajax_form_maecon_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_maecon_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_maecon_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.ctamaecon.value = scAjaxGetKeyValue("ctamaecon");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_maecon_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_maecon_mob_navigate_form_cb
  function do_ajax_form_maecon_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_maecon_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_maecon_mob_navigate_form_cb_after_alert

  function sc_hide_form_maecon_mob_form()
  {
  ...
  ajax_field_list[0] = "ctamaecon";
  ajax_field_list[1] = "nomcta";
  ajax_field_list[2] = "catctamaecon";
  ajax_field_list[3] = "centrocos";
  ajax_field_list[4] = "manejacentrocos";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "ctamaecon": {"label": "Ctamaecon", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nomcta": {"label": "Nomcta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "catctamaecon": {"label": "Catctamaecon", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "centrocos": {"label": "Centrocos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "manejacentrocos": {"label": "Maneja Centro Cos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "ctamaecon": new Array(),
    "nomcta": new Array(),
    "catctamaecon": new Array(),
    "centrocos": new Array(),
    "manejacentrocos": new Array()
  };
  ajax_field_mult["ctamaecon"][1] = "ctamaecon";
  ajax_field_mult["nomcta"][1] = "nomcta";
  ajax_field_mult["catctamaecon"][1] = "catctamaecon";
  ajax_field_mult["centrocos"][1] = "centrocos";
  ajax_field_mult["manejacentrocos"][1] = "manejacentrocos";

  var ajax_field_id = {
    "ctamaecon": new Array("hidden_field_label_ctamaecon", "hidden_field_data_ctamaecon"),
    "nomcta": new Array("hidden_field_label_nomcta", "hidden_field_data_nomcta"),
    "catctamaecon": new Array("hidden_field_label_catctamaecon", "hidden_field_data_catctamaecon"),
    "centrocos": new Array("hidden_field_label_centrocos", "hidden_field_data_centrocos"),
    "manejacentrocos": new Array("hidden_field_label_manejacentrocos", "hidden_field_data_manejacentrocos")
  };
