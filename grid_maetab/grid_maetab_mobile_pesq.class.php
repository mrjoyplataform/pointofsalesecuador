...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "ad1tab";$Nm_numeric[] = "ad2tab";$Nm_numeric[] = "ad3tab";$Nm_numeric[] = "ad4tab";$Nm_numeric[] = "ad5tab";$Nm_numeric[] = "ad6tab";$Nm_numeric[] = "ad1tab";$Nm_numeric[] = "ad2tab";$Nm_numeric[] = "ad3tab";$Nm_numeric[] = "ad4tab";$Nm_numeric[] = "ad5tab";$Nm_numeric[] = "ad6tab";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_ad1tab_cond" name="ad1tab_cond" onChange="nm_campos_between(document.getElementById('id_vis_ad1tab'), this, 'ad1tab')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_numtab_cond" name="numtab_cond" onChange="nm_campos_between(document.getElementById('id_vis_numtab'), this, 'numtab')">
      ...
      <br><span id="id_hide_numtab"  <?php echo $str_hide_numtab?>><?php
      if ($numtab != "")
      {
      $numtab_look = substr($this->Db->qstr($numtab), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_codtab_cond" name="codtab_cond" onChange="nm_campos_between(document.getElementById('id_vis_codtab'), this, 'codtab')">
      ...
      <br><span id="id_hide_codtab"  <?php echo $str_hide_codtab?>><?php
      if ($codtab != "")
      {
      $codtab_look = substr($this->Db->qstr($codtab), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nomtab_cond" name="nomtab_cond" onChange="nm_campos_between(document.getElementById('id_vis_nomtab'), this, 'nomtab')">
      ...
      <br><span id="id_hide_nomtab"  <?php echo $str_hide_nomtab?>><?php
      if ($nomtab != "")
      {
      $nomtab_look = substr($this->Db->qstr($nomtab), 1, -1); 
      $nmgp_def_dados = array(); 
