...
<?php
   ...
   $Ord_Cmp = new grid_maetab_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_maetab_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_maetab']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_maetab']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['numtab'] = "numtab";
   $tab_labels["numtab"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maetab']['labels']["numtab"])) ? $_SESSION['sc_session'][$sc_init]['grid_maetab']['labels']["numtab"] : "Numtab";
   $tab_ger_campos['codtab'] = "on";
   $tab_def_campos['codtab'] = "codtab";
   $tab_labels["codtab"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maetab']['labels']["codtab"])) ? $_SESSION['sc_session'][$sc_init]['grid_maetab']['labels']["codtab"] : "Codtab";
   $tab_ger_campos['nomtab'] = "on";
   $tab_def_campos['nomtab'] = "nomtab";
   $tab_labels["nomtab"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maetab']['labels']["nomtab"])) ? $_SESSION['sc_session'][$sc_init]['grid_maetab']['labels']["nomtab"] : "Nomtab";
   $tab_ger_campos['ad1tab'] = "on";
   $tab_def_campos['ad1tab'] = "ad1tab";
   $tab_labels["ad1tab"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maetab']['labels']["ad1tab"])) ? $_SESSION['sc_session'][$sc_init]['grid_maetab']['labels']["ad1tab"] : "Ad 1tab";
   $tab_ger_campos['ad2tab'] = "on";
   $tab_def_campos['ad2tab'] = "ad2tab";
   $tab_labels["ad2tab"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maetab']['labels']["ad2tab"])) ? $_SESSION['sc_session'][$sc_init]['grid_maetab']['labels']["ad2tab"] : "Ad 2tab";
   $tab_ger_campos['ad3tab'] = "on";
   $tab_def_campos['ad3tab'] = "ad3tab";
   $tab_labels["ad3tab"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_maetab']['labels']["ad3tab"])) ? $_SESSION['sc_session'][$sc_init]['grid_maetab']['labels']["ad3tab"] : "Ad 3tab";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_maetab']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_maetab']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_maetab']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_maetab']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_maetab']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_maetab']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_maetab']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_maetab']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_maetab']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_maetab']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_maetab']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_maetab']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_maetab_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_maetab']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_maetab']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_maetab']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_maetab']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_maetab']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
