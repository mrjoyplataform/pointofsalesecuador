<?php
@session_start() ;
$_SESSION['scriptcase']['grid_maetab']['sc_process_barr'] = true;
require_once('../grid_maetab/index.php');
unset($_SESSION['scriptcase']['grid_maetab']['sc_process_barr']);
$ExportCtrl = new grid_maetab_export_control;
$ExportCtrl->Export_barr();

class grid_maetab_export_control
{
