...
class grid_maetab_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_maetab_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_maetab_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_maetab_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_numtab')
      {
          $numtab = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_numtab($numtab);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_codtab')
      {
          $codtab = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_codtab($codtab);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nomtab')
      {
          $nomtab = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nomtab($nomtab);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> maetab</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_maetab/grid_maetab_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_maetab_ajax_search.js"></script>
 <script type="text/javascript" src="grid_maetab_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_maetab_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_maetab']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_maetab']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_ad1tab_cond#NMF#' + search_get_sel_txt('SC_ad1tab_cond') + '@NMF@';
  str_out += 'SC_ad1tab#NMF#' + search_get_text('SC_ad1tab') + '@NMF@';
  str_out += 'SC_numtab_cond#NMF#' + search_get_sel_txt('SC_numtab_cond') + '@NMF@';
  str_out += 'SC_numtab#NMF#' + search_get_text('SC_numtab') + '@NMF@';
  str_out += 'id_ac_numtab#NMF#' + search_get_text('id_ac_numtab') + '@NMF@';
  str_out += 'SC_codtab_cond#NMF#' + search_get_sel_txt('SC_codtab_cond') + '@NMF@';
  str_out += 'SC_codtab#NMF#' + search_get_text('SC_codtab') + '@NMF@';
  str_out += 'id_ac_codtab#NMF#' + search_get_text('id_ac_codtab') + '@NMF@';
  str_out += 'SC_nomtab_cond#NMF#' + search_get_sel_txt('SC_nomtab_cond') + '@NMF@';
  str_out += 'SC_nomtab#NMF#' + search_get_text('SC_nomtab') + '@NMF@';
  str_out += 'id_ac_nomtab#NMF#' + search_get_text('id_ac_nomtab') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_numtab").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_numtab").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_numtab",
          max_itens: "10",
          cod_desc: "N",
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_numtab").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_codtab").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_codtab").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_codtab",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_codtab").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_nomtab").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_nomtab").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nomtab",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> maetab</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             $ad1tab_cond, $ad1tab,
             $numtab_cond, $numtab, $numtab_autocomp,
             $codtab_cond, $codtab, $codtab_autocomp,
             $nomtab_cond, $nomtab, $nomtab_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $ad1tab = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']['ad1tab']; 
          $ad1tab_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']['ad1tab_cond']; 
          $numtab = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']['numtab']; 
          $numtab_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']['numtab_cond']; 
          $codtab = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']['codtab']; 
          $codtab_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']['codtab_cond']; 
          $nomtab = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']['nomtab']; 
          $nomtab_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']['nomtab_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']['NM_operador']; 
          if (strtoupper($ad1tab_cond) != "II" && strtoupper($ad1tab_cond) != "QP" && strtoupper($ad1tab_cond) != "NP" && strtoupper($ad1tab_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($ad1tab, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "2", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($ad1tab_cond) || empty($ad1tab_cond))
      {
         $ad1tab_cond = "gt";
      }
      if (!isset($numtab_cond) || empty($numtab_cond))
      {
         $numtab_cond = "qp";
      }
      if (!isset($codtab_cond) || empty($codtab_cond))
      {
         $codtab_cond = "qp";
      }
      if (!isset($nomtab_cond) || empty($nomtab_cond))
      {
         $nomtab_cond = "qp";
      }
      ...
      $str_hide_ad1tab = (in_array($ad1tab_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_numtab = (in_array($numtab_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_codtab = (in_array($codtab_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nomtab = (in_array($nomtab_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($ad1tab) || $ad1tab == "")
      {
          $ad1tab = "";
      }
      if (isset($ad1tab) && !empty($ad1tab))
      {
         $tmp_pos = strpos($ad1tab, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $ad1tab = substr($ad1tab, 0, $tmp_pos);
         }
      }
      if (!isset($numtab) || $numtab == "")
      {
          $numtab = "";
      }
      if (isset($numtab) && !empty($numtab))
      {
         $tmp_pos = strpos($numtab, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $numtab = substr($numtab, 0, $tmp_pos);
         }
      }
      if (!isset($codtab) || $codtab == "")
      {
          $codtab = "";
      }
      if (isset($codtab) && !empty($codtab))
      {
         $tmp_pos = strpos($codtab, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $codtab = substr($codtab, 0, $tmp_pos);
         }
      }
      if (!isset($nomtab) || $nomtab == "")
      {
          $nomtab = "";
      }
      if (isset($nomtab) && !empty($nomtab))
      {
         $tmp_pos = strpos($nomtab, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nomtab = substr($nomtab, 0, $tmp_pos);
         }
      }
?>
 <?php
...
?>
<?php
   if (is_file("grid_maetab_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_maetab']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_maetab']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_ad1tab_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['ad1tab'])) ? $this->New_label['ad1tab'] : "Ad 1tab"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_ad1tab_cond" name="ad1tab_cond" onChange="nm_campos_between(document.getElementById('id_vis_ad1tab'), this, 'ad1tab')">
       <OPTION value="gt" <?php if ("gt" == $ad1tab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $ad1tab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $ad1tab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ad1tab" <?php echo $str_hide_ad1tab?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['ad1tab'])) ? $this->New_label['ad1tab'] : "Ad 1tab";
 $nmgp_tab_label .= "ad1tab?#?" . $SC_Label . "?@?";
...
<INPUT  type="text" id="SC_ad1tab" name="ad1tab" value="<?php echo NM_encode_input($ad1tab) ?>" size=18 alt="{datatype: 'decimal', maxLength: 18, precision: 2, decimalSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['dec_num'] ?>', thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_numtab_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['numtab'])) ? $this->New_label['numtab'] : "Numtab"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_numtab_cond" name="numtab_cond" onChange="nm_campos_between(document.getElementById('id_vis_numtab'), this, 'numtab')">
       <OPTION value="qp" <?php if ("qp" == $numtab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $numtab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $numtab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $numtab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_numtab" <?php echo $str_hide_numtab?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['numtab'])) ? $this->New_label['numtab'] : "Numtab";
 $nmgp_tab_label .= "numtab?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $numtab;
      }
?>
<INPUT  type="text" id="SC_numtab" name="numtab" value="<?php echo NM_encode_input($numtab) ?>"  size=4 alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_numtab" name="numtab_autocomp" size="4"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_codtab_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['codtab'])) ? $this->New_label['codtab'] : "Codtab"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_codtab_cond" name="codtab_cond" onChange="nm_campos_between(document.getElementById('id_vis_codtab'), this, 'codtab')">
       <OPTION value="qp" <?php if ("qp" == $codtab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $codtab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $codtab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $codtab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_codtab" <?php echo $str_hide_codtab?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['codtab'])) ? $this->New_label['codtab'] : "Codtab";
 $nmgp_tab_label .= "codtab?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $codtab;
      }
?>
<INPUT  type="text" id="SC_codtab" name="codtab" value="<?php echo NM_encode_input($codtab) ?>"  size=5 alt="{datatype: 'text', maxLength: 5, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_codtab" name="codtab_autocomp" size="5"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 5, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_nomtab_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nomtab'])) ? $this->New_label['nomtab'] : "Nomtab"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_nomtab_cond" name="nomtab_cond" onChange="nm_campos_between(document.getElementById('id_vis_nomtab'), this, 'nomtab')">
       <OPTION value="qp" <?php if ("qp" == $nomtab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nomtab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nomtab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nomtab_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nomtab" <?php echo $str_hide_nomtab?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['nomtab'])) ? $this->New_label['nomtab'] : "Nomtab";
 $nmgp_tab_label .= "nomtab?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $nomtab;
      }
?>
<INPUT  type="text" id="SC_nomtab" name="nomtab" value="<?php echo NM_encode_input($nomtab) ?>"  size=50 alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nomtab" name="nomtab_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.ad1tab_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_ad1tab'), document.F1.ad1tab_cond, 'ad1tab');
   document.F1.ad1tab.value = "";
   document.F1.numtab_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_numtab'), document.F1.numtab_cond, 'numtab');
   document.F1.numtab.value = "";
   document.F1.numtab_autocomp.value = "";
   document.F1.codtab_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_codtab'), document.F1.codtab_cond, 'codtab');
   document.F1.codtab.value = "";
   document.F1.codtab_autocomp.value = "";
   document.F1.nomtab_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nomtab'), document.F1.nomtab_cond, 'nomtab');
   document.F1.nomtab.value = "";
   document.F1.nomtab_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_ad1tab_cond'] = 'cond';
      $tp_fields['SC_ad1tab'] = 'text';
      $tp_fields['SC_numtab_cond'] = 'cond';
      $tp_fields['SC_numtab'] = 'text_aut';
      $tp_fields['id_ac_numtab'] = 'text_aut';
      $tp_fields['SC_codtab_cond'] = 'cond';
      $tp_fields['SC_codtab'] = 'text_aut';
      $tp_fields['id_ac_codtab'] = 'text_aut';
      $tp_fields['SC_nomtab_cond'] = 'cond';
      $tp_fields['SC_nomtab'] = 'text_aut';
      $tp_fields['id_ac_nomtab'] = 'text_aut';
   ...
   {
      global $ad1tab_cond, $ad1tab,
             $numtab_cond, $numtab, $numtab_autocomp,
             $codtab_cond, $codtab, $codtab_autocomp,
             $nomtab_cond, $nomtab, $nomtab_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($numtab_autocomp) && empty($numtab))
      {
          $numtab = $numtab_autocomp;
      }
      if (!empty($codtab_autocomp) && empty($codtab))
      {
          $codtab = $codtab_autocomp;
      }
      if (!empty($nomtab_autocomp) && empty($nomtab))
      {
          $nomtab = $nomtab_autocomp;
      }
      $ad1tab_cond_salva = $ad1tab_cond; 
      if (!isset($ad1tab_input_2) || $ad1tab_input_2 == "")
      {
          $ad1tab_input_2 = $ad1tab;
      }
      $numtab_cond_salva = $numtab_cond; 
      if (!isset($numtab_input_2) || $numtab_input_2 == "")
      {
          $numtab_input_2 = $numtab;
      }
      $codtab_cond_salva = $codtab_cond; 
      if (!isset($codtab_input_2) || $codtab_input_2 == "")
      {
          $codtab_input_2 = $codtab;
      }
      $nomtab_cond_salva = $nomtab_cond; 
      if (!isset($nomtab_input_2) || $nomtab_input_2 == "")
      {
          $nomtab_input_2 = $nomtab;
      }
      if ($ad1tab_cond != "in")
      {
          if ($C_formatado)
          {
              nm_limpa_valor($ad1tab, $_SESSION['scriptcase']['reg_conf']['dec_num'], $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']['ad1tab'] = $ad1tab; 
      if (is_array($ad1tab) && !empty($ad1tab))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['Grid_search'][$I_Grid]['val'][0] = $ad1tab;
      }
      elseif ($ad1tab_cond_salva == "nu" || $ad1tab_cond_salva == "nn" || $ad1tab_cond_salva == "ep" || $ad1tab_cond_salva == "ne" || !empty($ad1tab))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['Grid_search'][$I_Grid]['val'][0][0] = $ad1tab;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']['ad1tab_cond'] = $ad1tab_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['Grid_search'][$I_Grid]['cmp'] = "ad1tab"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['Grid_search'][$I_Grid]['opc'] = $ad1tab_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq']['ad1tab'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']['numtab'] = $numtab; 
      if (is_array($numtab) && !empty($numtab))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['Grid_search'][$I_Grid]['val'][0] = $numtab;
      }
      elseif ($numtab_cond_salva == "nu" || $numtab_cond_salva == "nn" || $numtab_cond_salva == "ep" || $numtab_cond_salva == "ne" || !empty($numtab))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['Grid_search'][$I_Grid]['val'][0][0] = $numtab;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']['numtab_cond'] = $numtab_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['Grid_search'][$I_Grid]['cmp'] = "numtab"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['Grid_search'][$I_Grid]['opc'] = $numtab_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq']['numtab'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']['codtab'] = $codtab; 
      if (is_array($codtab) && !empty($codtab))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['Grid_search'][$I_Grid]['val'][0] = $codtab;
      }
      elseif ($codtab_cond_salva == "nu" || $codtab_cond_salva == "nn" || $codtab_cond_salva == "ep" || $codtab_cond_salva == "ne" || !empty($codtab))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['Grid_search'][$I_Grid]['val'][0][0] = $codtab;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']['codtab_cond'] = $codtab_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['Grid_search'][$I_Grid]['cmp'] = "codtab"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['Grid_search'][$I_Grid]['opc'] = $codtab_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq']['codtab'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']['nomtab'] = $nomtab; 
      if (is_array($nomtab) && !empty($nomtab))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['Grid_search'][$I_Grid]['val'][0] = $nomtab;
      }
      elseif ($nomtab_cond_salva == "nu" || $nomtab_cond_salva == "nn" || $nomtab_cond_salva == "ep" || $nomtab_cond_salva == "ne" || !empty($nomtab))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['Grid_search'][$I_Grid]['val'][0][0] = $nomtab;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']['nomtab_cond'] = $nomtab_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['Grid_search'][$I_Grid]['cmp'] = "nomtab"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['Grid_search'][$I_Grid]['opc'] = $nomtab_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['grid_pesq']['nomtab'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca'] = $Temp_Busca;
      }
      if ($ad1tab_cond != "in" && $ad1tab_cond != "bw" && !empty($ad1tab) && !is_numeric($ad1tab))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Ad 1tab";
      }
      if ($ad1tab_cond == "bw" && ((!empty($ad1tab) && !is_numeric($ad1tab)) || (!empty($ad1tab_input_2) && !is_numeric($ad1tab_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Ad 1tab";
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      $this->cmp_formatado['ad1tab'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($numtab != '') {
      $numtab_look = substr($this->Db->qstr($numtab), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['numtab'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['numtab'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['numtab'] = $numtab;
      }
      $nmgp_def_dados = array();
    if ($codtab != '') {
      $codtab_look = substr($this->Db->qstr($codtab), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['codtab'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['codtab'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['codtab'] = $codtab;
      }
      $nmgp_def_dados = array();
    if ($nomtab != '') {
      $nomtab_look = substr($this->Db->qstr($nomtab), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nomtab'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['nomtab'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nomtab'] = $nomtab;
      }

      //----- $ad1tab
      $this->Date_part = false;
      if (isset($ad1tab) || $ad1tab_cond == "nu" || $ad1tab_cond == "nn" || $ad1tab_cond == "ep" || $ad1tab_cond == "ne")
      {
         $this->monta_condicao("ad1tab", $ad1tab_cond, $ad1tab, "", "ad1tab");
      }

      //----- $numtab
      $this->Date_part = false;
      if (isset($numtab) || $numtab_cond == "nu" || $numtab_cond == "nn" || $numtab_cond == "ep" || $numtab_cond == "ne")
      {
         $this->monta_condicao("numtab", $numtab_cond, $numtab, "", "numtab");
      }

      //----- $codtab
      $this->Date_part = false;
      if (isset($codtab) || $codtab_cond == "nu" || $codtab_cond == "nn" || $codtab_cond == "ep" || $codtab_cond == "ne")
      {
         $this->monta_condicao("codtab", $codtab_cond, $codtab, "", "codtab");
      }

      //----- $nomtab
      $this->Date_part = false;
      if (isset($nomtab) || $nomtab_cond == "nu" || $nomtab_cond == "nn" || $nomtab_cond == "ep" || $nomtab_cond == "ne")
      {
         $this->monta_condicao("nomtab", $nomtab_cond, $nomtab, "", "nomtab");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_maetab']['cond_pesq'] .= $this->NM_operador;
