<?php
@session_start() ;
$_SESSION['scriptcase']['grid_sales_detail_temp2']['sc_process_barr'] = true;
require_once('../grid_sales_detail_temp2/index.php');
unset($_SESSION['scriptcase']['grid_sales_detail_temp2']['sc_process_barr']);
$ExportCtrl = new grid_sales_detail_temp2_export_control;
$ExportCtrl->Export_barr();

class grid_sales_detail_temp2_export_control
{
