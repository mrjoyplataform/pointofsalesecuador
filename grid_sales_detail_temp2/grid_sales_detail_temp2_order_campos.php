...
<?php
   ...
   $Ord_Cmp = new grid_sales_detail_temp2_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_sales_detail_temp2_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["quantity"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['labels']["quantity"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['labels']["quantity"] : "Cantidad";
   $tab_ger_campos['imagen'] = "on";
   $tab_def_campos['imagen'] = "imagen";
   $tab_labels["imagen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['labels']["imagen"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['labels']["imagen"] : "Imagen";
   $tab_ger_campos['product_name'] = "on";
   $tab_def_campos['product_name'] = "product_name";
   $tab_labels["product_name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['labels']["product_name"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['labels']["product_name"] : "Product Name";
   $tab_ger_campos['item_total'] = "on";
   $tab_def_campos['item_total'] = "item_total";
   $tab_labels["item_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['labels']["item_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['labels']["item_total"] : "Total";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_sales_detail_temp2_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_sales_detail_temp2']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
