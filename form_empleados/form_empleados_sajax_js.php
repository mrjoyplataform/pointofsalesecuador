...
?>
  ...
  // ---------- Validate idempleado
  function do_ajax_form_empleados_validate_idempleado()
  {
    var nomeCampo_idempleado = "idempleado";
    var var_idempleado = scAjaxGetFieldText(nomeCampo_idempleado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleados_validate_idempleado(var_idempleado, var_script_case_init, do_ajax_form_empleados_validate_idempleado_cb);
  } // do_ajax_form_empleados_validate_idempleado

  function do_ajax_form_empleados_validate_idempleado_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleados_validate_idempleado_cb

  // ---------- Validate nombre
  function do_ajax_form_empleados_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleados_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_empleados_validate_nombre_cb);
  } // do_ajax_form_empleados_validate_nombre

  function do_ajax_form_empleados_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleados_validate_nombre_cb

  // ---------- Validate activo
  function do_ajax_form_empleados_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldRadio(nomeCampo_activo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleados_validate_activo(var_activo, var_script_case_init, do_ajax_form_empleados_validate_activo_cb);
  } // do_ajax_form_empleados_validate_activo

  function do_ajax_form_empleados_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleados_validate_activo_cb

  // ---------- Validate cargo
  function do_ajax_form_empleados_validate_cargo()
  {
    var nomeCampo_cargo = "cargo";
    var var_cargo = scAjaxGetFieldText(nomeCampo_cargo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleados_validate_cargo(var_cargo, var_script_case_init, do_ajax_form_empleados_validate_cargo_cb);
  } // do_ajax_form_empleados_validate_cargo

  function do_ajax_form_empleados_validate_cargo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cargo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleados_validate_cargo_cb

  // ---------- Validate menu_default
  function do_ajax_form_empleados_validate_menu_default()
  {
    var nomeCampo_menu_default = "menu_default";
    var var_menu_default = scAjaxGetFieldSelect(nomeCampo_menu_default);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleados_validate_menu_default(var_menu_default, var_script_case_init, do_ajax_form_empleados_validate_menu_default_cb);
  } // do_ajax_form_empleados_validate_menu_default

  function do_ajax_form_empleados_validate_menu_default_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleados_validate_menu_default_cb

  // ---------- Validate admin
  function do_ajax_form_empleados_validate_admin()
  {
    var nomeCampo_admin = "admin";
    var var_admin = scAjaxGetFieldRadio(nomeCampo_admin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empleados_validate_admin(var_admin, var_script_case_init, do_ajax_form_empleados_validate_admin_cb);
  } // do_ajax_form_empleados_validate_admin

  function do_ajax_form_empleados_validate_admin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "admin";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empleados_validate_admin_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_empleados_submit_page_0(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_empleados_submit_page_0(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      url: "form_empleados.php",
      method: "POST",
      dataType: "json",
      data: {
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_empleados_submit_page_cb_0(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_empleados_submit_page_0

  function do_ajax_form_empleados_submit_page_cb_0(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
  ...
  } // do_ajax_form_empleados_submit_page_cb_0

  function do_ajax_form_empleados_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_empleados_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_empleados_submit_form(var_idempleado, var_nombre, var_activo, var_cargo, var_menu_default, var_admin, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_empleados_submit_form_cb);
...
?>
  ...
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_empleados_navigate_form, function() {});
    } else {
      perform_ajax_form_empleados_navigate_form();
    }
  }

  function perform_ajax_form_empleados_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_empleados_navigate_form(var_idempleado, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_empleados_navigate_form_cb);
