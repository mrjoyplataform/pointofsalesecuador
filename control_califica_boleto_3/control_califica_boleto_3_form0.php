...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>control_califica_boleto_3/control_califica_boleto_3_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("control_califica_boleto_3_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('control_califica_boleto_3_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['link_info']['remove_border']) {
...
<?php
 include_once("control_califica_boleto_3_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_califica_boleto_3'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_califica_boleto_3'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['empty_filter'] = true;
       }
  }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("control_califica_boleto_3");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("control_califica_boleto_3");
 parent.scAjaxDetailHeight("control_califica_boleto_3", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['control_califica_boleto_3']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
