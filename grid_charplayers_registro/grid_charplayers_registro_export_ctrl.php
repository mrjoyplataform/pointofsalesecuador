<?php
@session_start() ;
$_SESSION['scriptcase']['grid_charplayers_registro']['sc_process_barr'] = true;
require_once('../grid_charplayers_registro/index.php');
unset($_SESSION['scriptcase']['grid_charplayers_registro']['sc_process_barr']);
$ExportCtrl = new grid_charplayers_registro_export_control;
$ExportCtrl->Export_barr();

class grid_charplayers_registro_export_control
{
