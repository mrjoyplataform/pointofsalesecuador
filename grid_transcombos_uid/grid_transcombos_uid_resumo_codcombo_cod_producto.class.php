...
class grid_transcombos_uid_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_cod_producto = array();
   ...
   {
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_transcombos_uid']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_transcombos_uid']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['contr_total_geral'] == "OK")
      {
          $this->array_total_cod_producto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['arr_total']['cod_producto'];
      }
      else
      {
          $this->array_total_cod_producto = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['arr_total']['cod_producto'] = $this->array_total_cod_producto;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['json_use_label'])
       {
          $Lab_cod_producto = "cod_producto";
       }
       else
       {
       $Lab_cod_producto = "Producto";
       }
       $this->comp_field = array(
           $Lab_cod_producto,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['labels']['cod_producto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['labels']['cod_producto'] = "Producto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['labels']['cantidad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['labels']['cantidad'] = "Cantidad"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['labels']['idtrans']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['labels']['idtrans'] = "Idtrans"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['labels']['fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['labels']['fecha'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['labels']['valor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['labels']['valor'] = "Valor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['labels']['estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['labels']['estado'] = "Estado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['labels']['uniqueid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['labels']['uniqueid'] = "Uniqueid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['labels']['codcombo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['labels']['codcombo'] = "Codcombo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['labels']['idcaja']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['labels']['idcaja'] = "Idcaja"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['labels']['uniqueidtrans']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['labels']['uniqueidtrans'] = "Uniqueidtrans"; 
       }
       //-----
       $this->comp_field_nm = array(
           'cod_producto' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['summarizing_fields_order']['codcombo_cod_producto']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['summarizing_fields_order']['codcombo_cod_producto'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['summarizing_fields_order']['codcombo_cod_producto'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['summarizing_fields_display']['codcombo_cod_producto'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['summarizing_fields_display']['codcombo_cod_producto'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['summarizing_fields_display']['codcombo_cod_producto'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['summarizing_fields_display']['codcombo_cod_producto'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['summarizing_fields_display']['codcombo_cod_producto'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['summarizing_fields_display']['codcombo_cod_producto'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['summarizing_fields_display']['codcombo_cod_producto'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_cod_producto as $i_cod_producto => $d_cod_producto) {
           if (!in_array($i_cod_producto, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_cod_producto[3] ] = $d_cod_producto[2];
               $this->comp_label[0][ $d_cod_producto[3] ] = $d_cod_producto[2];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_cod_producto => $l_cod_producto) {
           if (isset($this->array_total_cod_producto[$i_cod_producto])) {
               $this->comp_group[$i_cod_producto] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_cod_producto;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_transcombos_uid@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['proc_pdf_vert']){ 
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_transcombos_uid_total.class.php"); 
      }
      ...
      $this->Total   = new grid_transcombos_uid_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_codcombo_cod_producto("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_cod_producto);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " transcombos</TITLE>\r\n");
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_transcombos_uid/grid_transcombos_uid_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_transcombos_uid_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_transcombos_uid_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_transcombos_uid_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['num_css'] . '.css');
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_transcombos_uid']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_transcombos_uid']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_transcombos_uid_config_pivot.php?nome_apl=grid_transcombos_uid&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_transcombos_uid_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_transcombos_uid/grid_transcombos_uid_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $idtrans = $Busca_temp['idtrans']; 
          $tmp_pos = strpos($idtrans, "##@@");
          if ($tmp_pos !== false && !is_array($idtrans))
          {
              $idtrans = substr($idtrans, 0, $tmp_pos);
          }
          $cod_producto = $Busca_temp['cod_producto']; 
          $tmp_pos = strpos($cod_producto, "##@@");
          if ($tmp_pos !== false && !is_array($cod_producto))
          {
              $cod_producto = substr($cod_producto, 0, $tmp_pos);
          }
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['cond_pesq'], 0, $trab_pos);
     ...
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transcombos_uid']['proc_pdf_vert']) {
      ...
      $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">" . $this->Ini->Nm_lang['lang_othr_smry_title'] . " transcombos</div>\r\n");
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $quebra_cod_producto, $quebra_cod_producto_orig)
   {
      //----- Producto
      if (!isset($this->array_total_cod_producto[$quebra_cod_producto_orig]))
      {
         $this->array_total_cod_producto[$quebra_cod_producto_orig][0] = 1;
         $this->array_total_cod_producto[$quebra_cod_producto_orig][1] = $sum_cantidad;
         $this->array_total_cod_producto[$quebra_cod_producto_orig][2] = $quebra_cod_producto;
         $this->array_total_cod_producto[$quebra_cod_producto_orig][3] = $quebra_cod_producto_orig;
      }
      else
      {
         $this->array_total_cod_producto[$quebra_cod_producto_orig][0]++;
         $this->array_total_cod_producto[$quebra_cod_producto_orig][1] = bcadd($this->array_total_cod_producto[$quebra_cod_producto_orig][1], $sum_cantidad, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'cod_producto');
     $campos_order = $this->Ini->Get_date_order_groupby("cod_producto", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->cod_producto = $rs_res->fields[0] ;  
            $this->cantidad = $rs_res->fields[1] ;  
            $this->idtrans = $rs_res->fields[2] ;  
            $this->fecha = $rs_res->fields[3] ;  
            $this->valor = $rs_res->fields[4] ;  
            $this->valor =  str_replace(",", ".", $this->valor);
            $this->estado = $rs_res->fields[5] ;  
            $this->look_cod_producto = $this->cod_producto; 
            $this->Lookup->lookup_cod_producto($this->look_cod_producto, $this->cod_producto) ; 
            $this->cod_producto_orig = $this->cod_producto;
            $this->cod_producto = $this->look_cod_producto ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->cod_producto, $this->cod_producto_orig);
            }
   }
//
