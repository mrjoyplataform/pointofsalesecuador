...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_transcombos_uid"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_transcombos_uid"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_transcombos_uid']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_transcombos_uid']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_transcombos_uid']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_transcombos_uid']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_transcombos_uid']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_transcombos_uid</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_transcombos_uid']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_transcombos_uid']['embutida_filho'] as $ind => $sc_init)
          {
