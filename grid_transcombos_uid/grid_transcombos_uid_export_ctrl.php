<?php
@session_start() ;
$_SESSION['scriptcase']['grid_transcombos_uid']['sc_process_barr'] = true;
require_once('../grid_transcombos_uid/index.php');
unset($_SESSION['scriptcase']['grid_transcombos_uid']['sc_process_barr']);
$ExportCtrl = new grid_transcombos_uid_export_control;
$ExportCtrl->Export_barr();

class grid_transcombos_uid_export_control
{
