<?php
@session_start() ;
$_SESSION['scriptcase']['grid_att_tiempos_detalle']['sc_process_barr'] = true;
require_once('../grid_att_tiempos_detalle/index.php');
unset($_SESSION['scriptcase']['grid_att_tiempos_detalle']['sc_process_barr']);
$ExportCtrl = new grid_att_tiempos_detalle_export_control;
$ExportCtrl->Export_barr();

class grid_att_tiempos_detalle_export_control
{
