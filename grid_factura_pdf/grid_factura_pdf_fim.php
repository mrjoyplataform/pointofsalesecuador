...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_factura_pdf"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_factura_pdf"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_factura_pdf']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_factura_pdf']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_factura_pdf']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_factura_pdf']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_factura_pdf']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_factura_pdf']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_factura_pdf']['embutida_filho'] as $ind => $sc_init)
          {
