...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_devices_arcade/form_devices_arcade_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_devices_arcade_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_devices_arcade_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['link_info']['remove_border']) {
...
<?php
 include_once("form_devices_arcade_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_devices_arcade'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_devices_arcade'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cod_grupo_label" id="hidden_field_label_cod_grupo" style="<?php echo $sStyleHidden_cod_grupo; ?>"><span id="id_label_cod_grupo"><?php echo $this->nm_new_label['cod_grupo']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ult_rfid_label" id="hidden_field_label_ult_rfid" style="<?php echo $sStyleHidden_ult_rfid; ?>"><span id="id_label_ult_rfid"><?php echo $this->nm_new_label['ult_rfid']; ?></span></TD>
    <TD class="scFormDataOdd css_ult_rfid_line" id="hidden_field_data_ult_rfid" style="<?php echo $sStyleHidden_ult_rfid; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ult_rfid_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ult_fecha_label" id="hidden_field_label_ult_fecha" style="<?php echo $sStyleHidden_ult_fecha; ?>"><span id="id_label_ult_fecha"><?php echo $this->nm_new_label['ult_fecha']; ?></span></TD>
    <TD class="scFormDataOdd css_ult_fecha_line" id="hidden_field_data_ult_fecha" style="<?php echo $sStyleHidden_ult_fecha; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ult_fecha_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_valor_default_label" id="hidden_field_label_valor_default" style="<?php echo $sStyleHidden_valor_default; ?>"><span id="id_label_valor_default"><?php echo $this->nm_new_label['valor_default']; ?></span></TD>
    <TD class="scFormDataOdd css_valor_default_line" id="hidden_field_data_valor_default" style="<?php echo $sStyleHidden_valor_default; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valor_default_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_acepta_tiempo_label" id="hidden_field_label_acepta_tiempo" style="<?php echo $sStyleHidden_acepta_tiempo; ?>"><span id="id_label_acepta_tiempo"><?php echo $this->nm_new_label['acepta_tiempo']; ?></span></TD>
    <TD class="scFormDataOdd css_acepta_tiempo_line" id="hidden_field_data_acepta_tiempo" style="<?php echo $sStyleHidden_acepta_tiempo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_acepta_tiempo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_dev_ip_line" id="hidden_field_data_dev_ip" style="<?php echo $sStyleHidden_dev_ip; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dev_ip_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipo_dev_label" id="hidden_field_label_tipo_dev" style="<?php echo $sStyleHidden_tipo_dev; ?>"><span id="id_label_tipo_dev"><?php echo $this->nm_new_label['tipo_dev']; ?></span></TD>
    <TD class="scFormDataOdd css_tipo_dev_line" id="hidden_field_data_tipo_dev" style="<?php echo $sStyleHidden_tipo_dev; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_dev_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_direccion_torno_label" id="hidden_field_label_direccion_torno" style="<?php echo $sStyleHidden_direccion_torno; ?>"><span id="id_label_direccion_torno"><?php echo $this->nm_new_label['direccion_torno']; ?></span></TD>
    <TD class="scFormDataOdd css_direccion_torno_line" id="hidden_field_data_direccion_torno" style="<?php echo $sStyleHidden_direccion_torno; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_direccion_torno_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_timeout_rfid_label" id="hidden_field_label_timeout_rfid" style="<?php echo $sStyleHidden_timeout_rfid; ?>"><span id="id_label_timeout_rfid"><?php echo $this->nm_new_label['timeout_rfid']; ?></span></TD>
    <TD class="scFormDataOdd css_timeout_rfid_line" id="hidden_field_data_timeout_rfid" style="<?php echo $sStyleHidden_timeout_rfid; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_timeout_rfid_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_discapacitado_label" id="hidden_field_label_discapacitado" style="<?php echo $sStyleHidden_discapacitado; ?>"><span id="id_label_discapacitado"><?php echo $this->nm_new_label['discapacitado']; ?></span></TD>
    <TD class="scFormDataOdd css_discapacitado_line" id="hidden_field_data_discapacitado" style="<?php echo $sStyleHidden_discapacitado; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_discapacitado_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_numcaja_label" id="hidden_field_label_numcaja" style="<?php echo $sStyleHidden_numcaja; ?>"><span id="id_label_numcaja"><?php echo $this->nm_new_label['numcaja']; ?></span></TD>
    <TD class="scFormDataOdd css_numcaja_line" id="hidden_field_data_numcaja" style="<?php echo $sStyleHidden_numcaja; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_numcaja_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_empleado_label" id="hidden_field_label_empleado" style="<?php echo $sStyleHidden_empleado; ?>"><span id="id_label_empleado"><?php echo $this->nm_new_label['empleado']; ?></span></TD>
    <TD class="scFormDataOdd css_empleado_line" id="hidden_field_data_empleado" style="<?php echo $sStyleHidden_empleado; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_empleado_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_serialrfid_label" id="hidden_field_label_serialrfid" style="<?php echo $sStyleHidden_serialrfid; ?>"><span id="id_label_serialrfid"><?php echo $this->nm_new_label['serialrfid']; ?></span></TD>
    <TD class="scFormDataOdd css_serialrfid_line" id="hidden_field_data_serialrfid" style="<?php echo $sStyleHidden_serialrfid; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_serialrfid_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_bidireccion_label" id="hidden_field_label_bidireccion" style="<?php echo $sStyleHidden_bidireccion; ?>"><span id="id_label_bidireccion"><?php echo $this->nm_new_label['bidireccion']; ?></span></TD>
    <TD class="scFormDataOdd css_bidireccion_line" id="hidden_field_data_bidireccion" style="<?php echo $sStyleHidden_bidireccion; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bidireccion_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cod_devicee_label" id="hidden_field_label_cod_devicee" style="<?php echo $sStyleHidden_cod_devicee; ?>"><span id="id_label_cod_devicee"><?php echo $this->nm_new_label['cod_devicee']; ?></span></TD>
    <TD class="scFormDataOdd css_cod_devicee_line" id="hidden_field_data_cod_devicee" style="<?php echo $sStyleHidden_cod_devicee; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cod_devicee_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_url_1_label" id="hidden_field_label_url_1" style="<?php echo $sStyleHidden_url_1; ?>"><span id="id_label_url_1"><?php echo $this->nm_new_label['url_1']; ?></span></TD>
    <TD class="scFormDataOdd css_url_1_line" id="hidden_field_data_url_1" style="<?php echo $sStyleHidden_url_1; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_url_1_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_url_2_label" id="hidden_field_label_url_2" style="<?php echo $sStyleHidden_url_2; ?>"><span id="id_label_url_2"><?php echo $this->nm_new_label['url_2']; ?></span></TD>
    <TD class="scFormDataOdd css_url_2_line" id="hidden_field_data_url_2" style="<?php echo $sStyleHidden_url_2; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_url_2_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_url_3_label" id="hidden_field_label_url_3" style="<?php echo $sStyleHidden_url_3; ?>"><span id="id_label_url_3"><?php echo $this->nm_new_label['url_3']; ?></span></TD>
    <TD class="scFormDataOdd css_url_3_line" id="hidden_field_data_url_3" style="<?php echo $sStyleHidden_url_3; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_url_3_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_foto1_label" id="hidden_field_label_foto1" style="<?php echo $sStyleHidden_foto1; ?>"><span id="id_label_foto1"><?php echo $this->nm_new_label['foto1']; ?></span></TD>
    <TD class="scFormDataOdd css_foto1_line" id="hidden_field_data_foto1" style="<?php echo $sStyleHidden_foto1; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_foto1_line" style="vertical-align: top;padding: 0px">
...
<div id="id_sc_dragdrop_foto1" class="scFormDataDragNDrop"  style="<?php echo $sStyleReadInp_foto1 ?>"><i class='fas fa-cloud-upload-alt'></i><br/>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_foto2_label" id="hidden_field_label_foto2" style="<?php echo $sStyleHidden_foto2; ?>"><span id="id_label_foto2"><?php echo $this->nm_new_label['foto2']; ?></span></TD>
    <TD class="scFormDataOdd css_foto2_line" id="hidden_field_data_foto2" style="<?php echo $sStyleHidden_foto2; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_foto2_line" style="vertical-align: top;padding: 0px">
...
<div id="id_sc_dragdrop_foto2" class="scFormDataDragNDrop"  style="<?php echo $sStyleReadInp_foto2 ?>"><i class='fas fa-cloud-upload-alt'></i><br/>
<?php echo $this->Ini->Nm_lang['lang_errm_mu_dragimg'] ?></div>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_foto3_label" id="hidden_field_label_foto3" style="<?php echo $sStyleHidden_foto3; ?>"><span id="id_label_foto3"><?php echo $this->nm_new_label['foto3']; ?></span></TD>
    <TD class="scFormDataOdd css_foto3_line" id="hidden_field_data_foto3" style="<?php echo $sStyleHidden_foto3; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_foto3_line" style="vertical-align: top;padding: 0px">
...
<div id="id_sc_dragdrop_foto3" class="scFormDataDragNDrop"  style="<?php echo $sStyleReadInp_foto3 ?>"><i class='fas fa-cloud-upload-alt'></i><br/>
<?php echo $this->Ini->Nm_lang['lang_errm_mu_dragimg'] ?></div>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_rfid_read_label" id="hidden_field_label_rfid_read" style="<?php echo $sStyleHidden_rfid_read; ?>"><span id="id_label_rfid_read"><?php echo $this->nm_new_label['rfid_read']; ?></span></TD>
    <TD class="scFormDataOdd css_rfid_read_line" id="hidden_field_data_rfid_read" style="<?php echo $sStyleHidden_rfid_read; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rfid_read_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_rfid_estado_label" id="hidden_field_label_rfid_estado" style="<?php echo $sStyleHidden_rfid_estado; ?>"><span id="id_label_rfid_estado"><?php echo $this->nm_new_label['rfid_estado']; ?></span></TD>
    <TD class="scFormDataOdd css_rfid_estado_line" id="hidden_field_data_rfid_estado" style="<?php echo $sStyleHidden_rfid_estado; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rfid_estado_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_rfid_fecha_label" id="hidden_field_label_rfid_fecha" style="<?php echo $sStyleHidden_rfid_fecha; ?>"><span id="id_label_rfid_fecha"><?php echo $this->nm_new_label['rfid_fecha']; ?></span></TD>
    <TD class="scFormDataOdd css_rfid_fecha_line" id="hidden_field_data_rfid_fecha" style="<?php echo $sStyleHidden_rfid_fecha; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rfid_fecha_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_uhfip_label" id="hidden_field_label_uhfip" style="<?php echo $sStyleHidden_uhfip; ?>"><span id="id_label_uhfip"><?php echo $this->nm_new_label['uhfip']; ?></span></TD>
    <TD class="scFormDataOdd css_uhfip_line" id="hidden_field_data_uhfip" style="<?php echo $sStyleHidden_uhfip; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_uhfip_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_url_reader_label" id="hidden_field_label_url_reader" style="<?php echo $sStyleHidden_url_reader; ?>"><span id="id_label_url_reader"><?php echo $this->nm_new_label['url_reader']; ?></span></TD>
    <TD class="scFormDataOdd css_url_reader_line" id="hidden_field_data_url_reader" style="<?php echo $sStyleHidden_url_reader; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_url_reader_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cod_rfid900_label" id="hidden_field_label_cod_rfid900" style="<?php echo $sStyleHidden_cod_rfid900; ?>"><span id="id_label_cod_rfid900"><?php echo $this->nm_new_label['cod_rfid900']; ?></span></TD>
    <TD class="scFormDataOdd css_cod_rfid900_line" id="hidden_field_data_cod_rfid900" style="<?php echo $sStyleHidden_cod_rfid900; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cod_rfid900_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_mensaje_line" id="hidden_field_data_mensaje" style="<?php echo $sStyleHidden_mensaje; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mensaje_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipolector_label" id="hidden_field_label_tipolector" style="<?php echo $sStyleHidden_tipolector; ?>"><span id="id_label_tipolector"><?php echo $this->nm_new_label['tipolector']; ?></span></TD>
    <TD class="scFormDataOdd css_tipolector_line" id="hidden_field_data_tipolector" style="<?php echo $sStyleHidden_tipolector; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipolector_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_url_accion_bg_label" id="hidden_field_label_url_accion_bg" style="<?php echo $sStyleHidden_url_accion_bg; ?>"><span id="id_label_url_accion_bg"><?php echo $this->nm_new_label['url_accion_bg']; ?></span></TD>
    <TD class="scFormDataOdd css_url_accion_bg_line" id="hidden_field_data_url_accion_bg" style="<?php echo $sStyleHidden_url_accion_bg; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_url_accion_bg_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_url_inicio_label" id="hidden_field_label_url_inicio" style="<?php echo $sStyleHidden_url_inicio; ?>"><span id="id_label_url_inicio"><?php echo $this->nm_new_label['url_inicio']; ?></span></TD>
    <TD class="scFormDataOdd css_url_inicio_line" id="hidden_field_data_url_inicio" style="<?php echo $sStyleHidden_url_inicio; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_url_inicio_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ledstripe1_label" id="hidden_field_label_ledstripe1" style="<?php echo $sStyleHidden_ledstripe1; ?>"><span id="id_label_ledstripe1"><?php echo $this->nm_new_label['ledstripe1']; ?></span></TD>
    <TD class="scFormDataOdd css_ledstripe1_line" id="hidden_field_data_ledstripe1" style="<?php echo $sStyleHidden_ledstripe1; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ledstripe1_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ledstripe2_label" id="hidden_field_label_ledstripe2" style="<?php echo $sStyleHidden_ledstripe2; ?>"><span id="id_label_ledstripe2"><?php echo $this->nm_new_label['ledstripe2']; ?></span></TD>
    <TD class="scFormDataOdd css_ledstripe2_line" id="hidden_field_data_ledstripe2" style="<?php echo $sStyleHidden_ledstripe2; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ledstripe2_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ledstripe3_label" id="hidden_field_label_ledstripe3" style="<?php echo $sStyleHidden_ledstripe3; ?>"><span id="id_label_ledstripe3"><?php echo $this->nm_new_label['ledstripe3']; ?></span></TD>
    <TD class="scFormDataOdd css_ledstripe3_line" id="hidden_field_data_ledstripe3" style="<?php echo $sStyleHidden_ledstripe3; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ledstripe3_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ledstripe4_label" id="hidden_field_label_ledstripe4" style="<?php echo $sStyleHidden_ledstripe4; ?>"><span id="id_label_ledstripe4"><?php echo $this->nm_new_label['ledstripe4']; ?></span></TD>
    <TD class="scFormDataOdd css_ledstripe4_line" id="hidden_field_data_ledstripe4" style="<?php echo $sStyleHidden_ledstripe4; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ledstripe4_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_lasteffect_label" id="hidden_field_label_lasteffect" style="<?php echo $sStyleHidden_lasteffect; ?>"><span id="id_label_lasteffect"><?php echo $this->nm_new_label['lasteffect']; ?></span></TD>
    <TD class="scFormDataOdd css_lasteffect_line" id="hidden_field_data_lasteffect" style="<?php echo $sStyleHidden_lasteffect; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_lasteffect_line" style="vertical-align: top;padding: 0px">
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['sound']))
    {
        $this->nm_new_label['sound'] = "Sound";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $sound = $this->sound;
   $sStyleHidden_sound = '';
   if (isset($this->nmgp_cmp_hidden['sound']) && $this->nmgp_cmp_hidden['sound'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['sound']);
       $sStyleHidden_sound = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_sound = 'display: none;';
   $sStyleReadInp_sound = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['sound']) && $this->nmgp_cmp_readonly['sound'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['sound']);
       $sStyleReadLab_sound = '';
       $sStyleReadInp_sound = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['sound']) && $this->nmgp_cmp_hidden['sound'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="sound" value="<?php echo $this->form_encode_input($sound) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_sound_label" id="hidden_field_label_sound" style="<?php echo $sStyleHidden_sound; ?>"><span id="id_label_sound"><?php echo $this->nm_new_label['sound']; ?></span></TD>
    <TD class="scFormDataOdd css_sound_line" id="hidden_field_data_sound" style="<?php echo $sStyleHidden_sound; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sound_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["sound"]) &&  $this->nmgp_cmp_readonly["sound"] == "on") { 

 ?>
<input type="hidden" name="sound" value="<?php echo $this->form_encode_input($sound) . "\">" . $sound . ""; ?>
<?php } else { ?>
<span id="id_read_on_sound" class="sc-ui-readonly-sound css_sound_line" style="<?php echo $sStyleReadLab_sound; ?>"><?php echo $this->form_format_readonly("sound", $this->form_encode_input($this->sound)); ?></span><span id="id_read_off_sound" class="css_read_off_sound<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_sound; ?>">
 <input class="sc-js-input scFormObjectOdd css_sound_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_sound" type=text name="sound" value="<?php echo $this->form_encode_input($sound) ?>"
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_sound_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_sound_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['points']))
    {
        $this->nm_new_label['points'] = "Points";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $points = $this->points;
   $sStyleHidden_points = '';
   if (isset($this->nmgp_cmp_hidden['points']) && $this->nmgp_cmp_hidden['points'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['points']);
       $sStyleHidden_points = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_points = 'display: none;';
   $sStyleReadInp_points = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['points']) && $this->nmgp_cmp_readonly['points'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['points']);
       $sStyleReadLab_points = '';
       $sStyleReadInp_points = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['points']) && $this->nmgp_cmp_hidden['points'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="points" value="<?php echo $this->form_encode_input($points) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_points_label" id="hidden_field_label_points" style="<?php echo $sStyleHidden_points; ?>"><span id="id_label_points"><?php echo $this->nm_new_label['points']; ?></span></TD>
    <TD class="scFormDataOdd css_points_line" id="hidden_field_data_points" style="<?php echo $sStyleHidden_points; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_points_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["points"]) &&  $this->nmgp_cmp_readonly["points"] == "on") { 

 ?>
<input type="hidden" name="points" value="<?php echo $this->form_encode_input($points) . "\">" . $points . ""; ?>
<?php } else { ?>
<span id="id_read_on_points" class="sc-ui-readonly-points css_points_line" style="<?php echo $sStyleReadLab_points; ?>"><?php echo $this->form_format_readonly("points", $this->form_encode_input($this->points)); ?></span><span id="id_read_off_points" class="css_read_off_points<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_points; ?>">
 <input class="sc-js-input scFormObjectOdd css_points_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_points" type=text name="points" value="<?php echo $this->form_encode_input($points) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=11"; } ?> alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['points']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['points']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['points']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_points_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_points_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['speak']))
    {
        $this->nm_new_label['speak'] = "Speak";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $speak = $this->speak;
   $sStyleHidden_speak = '';
   if (isset($this->nmgp_cmp_hidden['speak']) && $this->nmgp_cmp_hidden['speak'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['speak']);
       $sStyleHidden_speak = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_speak = 'display: none;';
   $sStyleReadInp_speak = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['speak']) && $this->nmgp_cmp_readonly['speak'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['speak']);
       $sStyleReadLab_speak = '';
       $sStyleReadInp_speak = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['speak']) && $this->nmgp_cmp_hidden['speak'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="speak" value="<?php echo $this->form_encode_input($speak) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_speak_label" id="hidden_field_label_speak" style="<?php echo $sStyleHidden_speak; ?>"><span id="id_label_speak"><?php echo $this->nm_new_label['speak']; ?></span></TD>
    <TD class="scFormDataOdd css_speak_line" id="hidden_field_data_speak" style="<?php echo $sStyleHidden_speak; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_speak_line" style="vertical-align: top;padding: 0px">
<?php
$speak_val = str_replace('<br />', '__SC_BREAK_LINE__', nl2br($speak));

?>

<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["speak"]) &&  $this->nmgp_cmp_readonly["speak"] == "on") { 

 ?>
<input type="hidden" name="speak" value="<?php echo $this->form_encode_input($speak) . "\">" . $speak_val . ""; ?>
<?php } else { ?>
<span id="id_read_on_speak" class="sc-ui-readonly-speak css_speak_line" style="<?php echo $sStyleReadLab_speak; ?>"><?php echo $this->form_format_readonly("speak", $this->form_encode_input($speak_val)); ?></span><span id="id_read_off_speak" class="css_read_off_speak<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_speak; ?>">
 <textarea class="sc-js-input scFormObjectOdd css_speak_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="white-space: pre-wrap;" name="speak" id="id_sc_field_speak" rows="2" cols="50"
 alt="{datatype: 'text', maxLength: 32767, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" >
<?php echo $speak; ?>
</textarea>
</span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_speak_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_speak_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['typereader']))
    {
        $this->nm_new_label['typereader'] = "Typereader";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $typereader = $this->typereader;
   $sStyleHidden_typereader = '';
   if (isset($this->nmgp_cmp_hidden['typereader']) && $this->nmgp_cmp_hidden['typereader'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['typereader']);
       $sStyleHidden_typereader = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_typereader = 'display: none;';
   $sStyleReadInp_typereader = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['typereader']) && $this->nmgp_cmp_readonly['typereader'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['typereader']);
       $sStyleReadLab_typereader = '';
       $sStyleReadInp_typereader = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['typereader']) && $this->nmgp_cmp_hidden['typereader'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="typereader" value="<?php echo $this->form_encode_input($typereader) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_typereader_label" id="hidden_field_label_typereader" style="<?php echo $sStyleHidden_typereader; ?>"><span id="id_label_typereader"><?php echo $this->nm_new_label['typereader']; ?></span></TD>
    <TD class="scFormDataOdd css_typereader_line" id="hidden_field_data_typereader" style="<?php echo $sStyleHidden_typereader; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_typereader_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["typereader"]) &&  $this->nmgp_cmp_readonly["typereader"] == "on") { 

 ?>
<input type="hidden" name="typereader" value="<?php echo $this->form_encode_input($typereader) . "\">" . $typereader . ""; ?>
<?php } else { ?>
<span id="id_read_on_typereader" class="sc-ui-readonly-typereader css_typereader_line" style="<?php echo $sStyleReadLab_typereader; ?>"><?php echo $this->form_format_readonly("typereader", $this->form_encode_input($this->typereader)); ?></span><span id="id_read_off_typereader" class="css_read_off_typereader<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_typereader; ?>">
 <input class="sc-js-input scFormObjectOdd css_typereader_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_typereader" type=text name="typereader" value="<?php echo $this->form_encode_input($typereader) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=45"; } ?> maxlength=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_typereader_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_typereader_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_devices_arcade");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_devices_arcade");
 parent.scAjaxDetailHeight("form_devices_arcade", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_arcade']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
