...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_rfiduhf"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_rfiduhf"]);
   }
   ...
   if (isset($_SESSION['scriptcase']['refresh']['grid_rfiduhf']))
   {
       unset($_SESSION['scriptcase']['refresh']['grid_rfiduhf']);
   }
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_rfiduhf']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_rfiduhf']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_rfiduhf']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_rfiduhf']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_rfiduhf']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_rfiduhf']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_rfiduhf']['embutida_filho'] as $ind => $sc_init)
          {
