<?php
@session_start() ;
$_SESSION['scriptcase']['grid_rfiduhf']['sc_process_barr'] = true;
require_once('../grid_rfiduhf/index.php');
unset($_SESSION['scriptcase']['grid_rfiduhf']['sc_process_barr']);
$ExportCtrl = new grid_rfiduhf_export_control;
$ExportCtrl->Export_barr();

class grid_rfiduhf_export_control
{
