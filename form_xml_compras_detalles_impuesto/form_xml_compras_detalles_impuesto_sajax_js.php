  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_xml_compras_detalles_impuesto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_xml_compras_detalles_impuesto_form();
	}
...
?>
  ...
  // ---------- Validate idlinea_
  function do_ajax_form_xml_compras_detalles_impuesto_validate_idlinea_(iNumLinha)
  {
    var nomeCampo_idlinea_ = "idlinea_" + iNumLinha;
    var var_idlinea_ = scAjaxGetFieldHidden(nomeCampo_idlinea_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_detalles_impuesto_validate_idlinea_(var_idlinea_, iNumLinha, var_script_case_init, do_ajax_form_xml_compras_detalles_impuesto_validate_idlinea__cb);
  } // do_ajax_form_xml_compras_detalles_impuesto_validate_idlinea_

  function do_ajax_form_xml_compras_detalles_impuesto_validate_idlinea__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_detalles_impuesto_validate_idlinea__cb

  // ---------- Validate claveacceso_
  function do_ajax_form_xml_compras_detalles_impuesto_validate_claveacceso_(iNumLinha)
  {
    var nomeCampo_claveacceso_ = "claveacceso_" + iNumLinha;
    var var_claveacceso_ = scAjaxGetFieldText(nomeCampo_claveacceso_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_detalles_impuesto_validate_claveacceso_(var_claveacceso_, iNumLinha, var_script_case_init, do_ajax_form_xml_compras_detalles_impuesto_validate_claveacceso__cb);
  } // do_ajax_form_xml_compras_detalles_impuesto_validate_claveacceso_

  function do_ajax_form_xml_compras_detalles_impuesto_validate_claveacceso__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_detalles_impuesto_validate_claveacceso__cb

  // ---------- Validate codigo_
  function do_ajax_form_xml_compras_detalles_impuesto_validate_codigo_(iNumLinha)
  {
    var nomeCampo_codigo_ = "codigo_" + iNumLinha;
    var var_codigo_ = scAjaxGetFieldText(nomeCampo_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_detalles_impuesto_validate_codigo_(var_codigo_, iNumLinha, var_script_case_init, do_ajax_form_xml_compras_detalles_impuesto_validate_codigo__cb);
  } // do_ajax_form_xml_compras_detalles_impuesto_validate_codigo_

  function do_ajax_form_xml_compras_detalles_impuesto_validate_codigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_detalles_impuesto_validate_codigo__cb

  // ---------- Validate codigoporcentaje_
  function do_ajax_form_xml_compras_detalles_impuesto_validate_codigoporcentaje_(iNumLinha)
  {
    var nomeCampo_codigoporcentaje_ = "codigoporcentaje_" + iNumLinha;
    var var_codigoporcentaje_ = scAjaxGetFieldText(nomeCampo_codigoporcentaje_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_detalles_impuesto_validate_codigoporcentaje_(var_codigoporcentaje_, iNumLinha, var_script_case_init, do_ajax_form_xml_compras_detalles_impuesto_validate_codigoporcentaje__cb);
  } // do_ajax_form_xml_compras_detalles_impuesto_validate_codigoporcentaje_

  function do_ajax_form_xml_compras_detalles_impuesto_validate_codigoporcentaje__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "codigoporcentaje_" + iLineNumber;
    }
    else
    {
      sFieldValid = "codigoporcentaje_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "codigoporcentaje_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "codigoporcentaje_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_detalles_impuesto_validate_codigoporcentaje__cb

  // ---------- Validate tarifa_
  function do_ajax_form_xml_compras_detalles_impuesto_validate_tarifa_(iNumLinha)
  {
    var nomeCampo_tarifa_ = "tarifa_" + iNumLinha;
    var var_tarifa_ = scAjaxGetFieldText(nomeCampo_tarifa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_detalles_impuesto_validate_tarifa_(var_tarifa_, iNumLinha, var_script_case_init, do_ajax_form_xml_compras_detalles_impuesto_validate_tarifa__cb);
  } // do_ajax_form_xml_compras_detalles_impuesto_validate_tarifa_

  function do_ajax_form_xml_compras_detalles_impuesto_validate_tarifa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tarifa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tarifa_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tarifa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tarifa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_detalles_impuesto_validate_tarifa__cb

  // ---------- Validate baseimponible_
  function do_ajax_form_xml_compras_detalles_impuesto_validate_baseimponible_(iNumLinha)
  {
    var nomeCampo_baseimponible_ = "baseimponible_" + iNumLinha;
    var var_baseimponible_ = scAjaxGetFieldText(nomeCampo_baseimponible_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_detalles_impuesto_validate_baseimponible_(var_baseimponible_, iNumLinha, var_script_case_init, do_ajax_form_xml_compras_detalles_impuesto_validate_baseimponible__cb);
  } // do_ajax_form_xml_compras_detalles_impuesto_validate_baseimponible_

  function do_ajax_form_xml_compras_detalles_impuesto_validate_baseimponible__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "baseimponible_" + iLineNumber;
    }
    else
    {
      sFieldValid = "baseimponible_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "baseimponible_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "baseimponible_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_detalles_impuesto_validate_baseimponible__cb

  // ---------- Validate valor_
  function do_ajax_form_xml_compras_detalles_impuesto_validate_valor_(iNumLinha)
  {
    var nomeCampo_valor_ = "valor_" + iNumLinha;
    var var_valor_ = scAjaxGetFieldText(nomeCampo_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_detalles_impuesto_validate_valor_(var_valor_, iNumLinha, var_script_case_init, do_ajax_form_xml_compras_detalles_impuesto_validate_valor__cb);
  } // do_ajax_form_xml_compras_detalles_impuesto_validate_valor_

  function do_ajax_form_xml_compras_detalles_impuesto_validate_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_detalles_impuesto_validate_valor__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_xml_compras_detalles_impuesto_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_xml_compras_detalles_impuesto_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_xml_compras_detalles_impuesto_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_xml_compras_detalles_impuesto_add_new_line_cb);
  } // do_ajax_form_xml_compras_detalles_impuesto_add_new_line

  function do_ajax_form_xml_compras_detalles_impuesto_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_xml_compras_detalles_impuesto_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_xml_compras_detalles_impuesto_backup_line(iNumLinha)
  {
    var var_idlinea_ = scAjaxGetFieldHidden("idlinea_" + iNumLinha);
    var var_claveacceso_ = scAjaxGetFieldText("claveacceso_" + iNumLinha);
    var var_codigo_ = scAjaxGetFieldText("codigo_" + iNumLinha);
    var var_codigoporcentaje_ = scAjaxGetFieldText("codigoporcentaje_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_detalles_impuesto_backup_line(var_idlinea_, var_claveacceso_, var_codigo_, var_codigoporcentaje_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_xml_compras_detalles_impuesto_backup_line_cb);
  } // do_ajax_form_xml_compras_detalles_impuesto_backup_line

  function do_ajax_form_xml_compras_detalles_impuesto_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_xml_compras_detalles_impuesto_backup_line_cb

  function do_ajax_form_xml_compras_detalles_impuesto_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_xml_compras_detalles_impuesto_cancel_insert

  function do_ajax_form_xml_compras_detalles_impuesto_cancel_update(iSeqVert)
  {
    do_ajax_form_xml_compras_detalles_impuesto_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_xml_compras_detalles_impuesto_cancel_update

  function do_ajax_form_xml_compras_detalles_impuesto_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_xml_compras_detalles_impuesto_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_xml_compras_detalles_impuesto_table_refresh()
  {
    ...
    var var_codigoporcentaje_ = document.F2.codigoporcentaje_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_xml_compras_detalles_impuesto_table_refresh(var_idlinea_, var_claveacceso_, var_codigo_, var_codigoporcentaje_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_xml_compras_detalles_impuesto_table_refresh_cb);
  } //  do_ajax_form_xml_compras_detalles_impuesto_table_refresh

  function do_ajax_form_xml_compras_detalles_impuesto_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.codigoporcentaje_.value = scAjaxGetKeyValue("codigoporcentaje_");
    ...
    scAjaxAlert(do_ajax_form_xml_compras_detalles_impuesto_table_refresh_cb_after_alert);
  } // do_ajax_form_xml_compras_detalles_impuesto_table_refresh_cb
  function do_ajax_form_xml_compras_detalles_impuesto_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_xml_compras_detalles_impuesto_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_xml_compras_detalles_impuesto_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_xml_compras_detalles_impuesto_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_codigo_ = scAjaxGetFieldText("codigo_" + iNumLinha);
    var var_codigoporcentaje_ = scAjaxGetFieldText("codigoporcentaje_" + iNumLinha);
    var var_tarifa_ = scAjaxGetFieldText("tarifa_" + iNumLinha);
    var var_baseimponible_ = scAjaxGetFieldText("baseimponible_" + iNumLinha);
...
?>
    x_ajax_form_xml_compras_detalles_impuesto_submit_form(var_idlinea_, var_claveacceso_, var_codigo_, var_codigoporcentaje_, var_tarifa_, var_baseimponible_, var_valor_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_xml_compras_detalles_impuesto_submit_form_cb);
  } // do_ajax_form_xml_compras_detalles_impuesto_submit_form

  function do_ajax_form_xml_compras_detalles_impuesto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("codigoporcentaje_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tarifa_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("baseimponible_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_xml_compras_detalles_impuesto_submit_form_cb_after_alert);
  } // do_ajax_form_xml_compras_detalles_impuesto_submit_form_cb
  function do_ajax_form_xml_compras_detalles_impuesto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_xml_compras_detalles_impuesto_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_xml_compras_detalles_impuesto_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_xml_compras_detalles_impuesto_navigate_form, function() {});
    } else {
      perform_ajax_form_xml_compras_detalles_impuesto_navigate_form();
    }
  }

  function perform_ajax_form_xml_compras_detalles_impuesto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_xml_compras_detalles_impuesto_cancel_insert(sc_form_xml_compras_detalles_impuesto_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("codigoporcentaje_" + iNavForm);
      scAjaxHideErrorDisplay("tarifa_" + iNavForm);
      scAjaxHideErrorDisplay("baseimponible_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_xml_compras_detalles_impuesto_navigate_form(var_idlinea_, var_claveacceso_, var_codigo_, var_codigoporcentaje_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_xml_compras_detalles_impuesto_navigate_form_cb);
  } // do_ajax_form_xml_compras_detalles_impuesto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_detalles_impuesto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_xml_compras_detalles_impuesto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.codigoporcentaje_.value = scAjaxGetKeyValue("codigoporcentaje_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_xml_compras_detalles_impuesto_navigate_form_cb_after_alert);
  } // do_ajax_form_xml_compras_detalles_impuesto_navigate_form_cb
  function do_ajax_form_xml_compras_detalles_impuesto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_xml_compras_detalles_impuesto_navigate_form_cb_after_alert

    function sc_form_xml_compras_detalles_impuesto_get_last_line_number()
    {
    ...
    } //sc_form_xml_compras_detalles_impuesto_get_last_line_number

  function sc_hide_form_xml_compras_detalles_impuesto_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "codigoporcentaje_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tarifa_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "baseimponible_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["codigoporcentaje_" + iNumLinha] = {"label": "Codigo Porcentaje<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tarifa_" + iNumLinha] = {"label": "Tarifa<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["baseimponible_" + iNumLinha] = {"label": "Base Imponible<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["codigoporcentaje_"][iNumLinha] = "codigoporcentaje_" + iNumLinha;
    ajax_field_mult["tarifa_"][iNumLinha] = "tarifa_" + iNumLinha;
    ajax_field_mult["baseimponible_"][iNumLinha] = "baseimponible_" + iNumLinha;
    ...
    ajax_field_id["codigoporcentaje_" + iNumLinha] = new Array("hidden_field_label_codigoporcentaje_", "hidden_field_data_codigoporcentaje_" + iNumLinha);
    ajax_field_id["tarifa_" + iNumLinha] = new Array("hidden_field_label_tarifa_", "hidden_field_data_tarifa_" + iNumLinha);
    ajax_field_id["baseimponible_" + iNumLinha] = new Array("hidden_field_label_baseimponible_", "hidden_field_data_baseimponible_" + iNumLinha);
    ...
    ajax_error_count["codigoporcentaje_" + iNumLinha] = "off";
    ajax_error_count["tarifa_" + iNumLinha] = "off";
    ajax_error_count["baseimponible_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["codigoporcentaje_" + iNumLinha] = "on";
    ajax_read_only["tarifa_" + iNumLinha] = "off";
    ajax_read_only["baseimponible_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["codigo_" + iNumLinha] = "on";
    ajax_read_only["codigoporcentaje_" + iNumLinha] = "on";
    ajax_read_only["tarifa_" + iNumLinha] = "on";
    ajax_read_only["baseimponible_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["codigoporcentaje_" + iNumLinha] = null;
    ajax_error_list["tarifa_" + iNumLinha] = null;
    ajax_error_list["baseimponible_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    ...
    "codigo_": new Array(),
    "codigoporcentaje_": new Array(),
    "tarifa_": new Array(),
    "baseimponible_": new Array(),
    "valor_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["codigoporcentaje_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["codigoporcentaje_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["codigoporcentaje_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["codigoporcentaje_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["codigoporcentaje_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tarifa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tarifa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tarifa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tarifa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tarifa_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["baseimponible_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["baseimponible_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["baseimponible_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["baseimponible_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["baseimponible_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['codigoporcentaje_'])) ? $this->nmgp_cmp_readonly['codigoporcentaje_'] : 'on';
?>
    scAjaxFieldRead("codigoporcentaje_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tarifa_'])) ? $this->nmgp_cmp_readonly['tarifa_'] : 'off';
?>
    scAjaxFieldRead("tarifa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['baseimponible_'])) ? $this->nmgp_cmp_readonly['baseimponible_'] : 'off';
?>
    scAjaxFieldRead("baseimponible_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("codigoporcentaje_" + iSeq, "on");
    scAjaxFieldRead("tarifa_" + iSeq, "on");
    scAjaxFieldRead("baseimponible_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idlinea_" + iRow] || "on" == ajax_error_count["claveacceso_" + iRow] || "on" == ajax_error_count["codigo_" + iRow] || "on" == ajax_error_count["codigoporcentaje_" + iRow] || "on" == ajax_error_count["tarifa_" + iRow] || "on" == ajax_error_count["baseimponible_" + iRow] || "on" == ajax_error_count["valor_" + iRow]))
    {
      ...
      $("#hidden_field_data_codigoporcentaje_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tarifa_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_baseimponible_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idlinea_" + iRow] && "off" == ajax_error_count["claveacceso_" + iRow] && "off" == ajax_error_count["codigo_" + iRow] && "off" == ajax_error_count["codigoporcentaje_" + iRow] && "off" == ajax_error_count["tarifa_" + iRow] && "off" == ajax_error_count["baseimponible_" + iRow] && "off" == ajax_error_count["valor_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["codigoporcentaje_" + iRow] = "off";
        ajax_error_count["tarifa_" + iRow] = "off";
        ajax_error_count["baseimponible_" + iRow] = "off";
      ...
      $("#hidden_field_data_codigoporcentaje_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tarifa_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_baseimponible_" + iRow).removeClass("scFormErrorLine");
