<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="idlinea_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idlinea_']); ?>">
<input type="hidden" name="claveacceso_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['claveacceso_']); ?>">
<input type="hidden" name="codigo_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['codigo_']); ?>">
<input type="hidden" name="codigoporcentaje_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['codigoporcentaje_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_xml_compras_detalles_impuesto"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_xml_compras_detalles_impuesto_submit_form(y, z);
