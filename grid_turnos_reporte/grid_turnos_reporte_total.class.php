...
class grid_turnos_reporte_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_turnos_reporte']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_turnos_reporte']['campos_busca']))
      { 
   ...
   function quebra_geral_sc_free_group_by($res_limit=false)
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(entrega_efectivo), sum(entrega_tarjeta), sum(total_entrega), sum(sistema_efectivo), sum(sistema_tarjeta), sum(sistema_total), sum(diferencia) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][2] = $rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $rt->fields[2] = (string)$rt->fields[2]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][3] = $rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $rt->fields[3] = (string)$rt->fields[3]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][4] = $rt->fields[3]; 
      $rt->fields[4] = str_replace(",", ".", $rt->fields[4]);
      $rt->fields[4] = (string)$rt->fields[4]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][5] = $rt->fields[4]; 
      $rt->fields[5] = str_replace(",", ".", $rt->fields[5]);
      $rt->fields[5] = (string)$rt->fields[5]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][6] = $rt->fields[5]; 
      $rt->fields[6] = str_replace(",", ".", $rt->fields[6]);
      $rt->fields[6] = (string)$rt->fields[6]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][7] = $rt->fields[6]; 
      $rt->fields[7] = str_replace(",", ".", $rt->fields[7]);
      $rt->fields[7] = (string)$rt->fields[7]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][8] = $rt->fields[7]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['contr_total_geral'] = "OK";
   } 
   ...
   function quebra_estado_sc_free_group_by($estado, $Where_qb, $Cmp_Name) 
   {
      ...
      $tot_estado[0] = NM_encode_input(sc_strip_script($estado)) ; 
      $tot_estado[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_estado[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_estado[3] = (string)$rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $tot_estado[4] = (string)$rt->fields[3]; 
      $rt->fields[4] = str_replace(",", ".", $rt->fields[4]);
      $tot_estado[5] = (string)$rt->fields[4]; 
      $rt->fields[5] = str_replace(",", ".", $rt->fields[5]);
      $tot_estado[6] = (string)$rt->fields[5]; 
      $rt->fields[6] = str_replace(",", ".", $rt->fields[6]);
      $tot_estado[7] = (string)$rt->fields[6]; 
      $rt->fields[7] = str_replace(",", ".", $rt->fields[7]);
      $tot_estado[8] = (string)$rt->fields[7]; 
      $rt->Close(); 
   ...
   function quebra_idempleado_sc_free_group_by($idempleado, $Where_qb, $Cmp_Name) 
   {
      ...
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_idempleado[3] = (string)$rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $tot_idempleado[4] = (string)$rt->fields[3]; 
      $rt->fields[4] = str_replace(",", ".", $rt->fields[4]);
      $tot_idempleado[5] = (string)$rt->fields[4]; 
      $rt->fields[5] = str_replace(",", ".", $rt->fields[5]);
      $tot_idempleado[6] = (string)$rt->fields[5]; 
      $rt->fields[6] = str_replace(",", ".", $rt->fields[6]);
      $tot_idempleado[7] = (string)$rt->fields[6]; 
      $rt->fields[7] = str_replace(",", ".", $rt->fields[7]);
      $tot_idempleado[8] = (string)$rt->fields[7]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_idempleado;
   } 

   //-----  idcaja
   function quebra_idcaja_sc_free_group_by($idcaja, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $idempleado;
      $tot_idcaja = array() ;  
      ...
      $tot_idcaja[0] = NM_encode_input(sc_strip_script($idcaja)) ; 
      $tot_idcaja[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_idcaja[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_idcaja[3] = (string)$rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $tot_idcaja[4] = (string)$rt->fields[3]; 
      $rt->fields[4] = str_replace(",", ".", $rt->fields[4]);
      $tot_idcaja[5] = (string)$rt->fields[4]; 
      $rt->fields[5] = str_replace(",", ".", $rt->fields[5]);
      $tot_idcaja[6] = (string)$rt->fields[5]; 
      $rt->fields[6] = str_replace(",", ".", $rt->fields[6]);
      $tot_idcaja[7] = (string)$rt->fields[6]; 
      $rt->fields[7] = str_replace(",", ".", $rt->fields[7]);
      $tot_idcaja[8] = (string)$rt->fields[7]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_idcaja;
   } 

   //-----  fecha_cierre
   function quebra_fecha_cierre_sc_free_group_by($fecha_cierre, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $idempleado;
      $tot_fecha_cierre = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(entrega_efectivo), sum(entrega_tarjeta), sum(total_entrega), sum(sistema_efectivo), sum(sistema_tarjeta), sum(sistema_total), sum(diferencia) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['where_pesq']; 
      } 
      ...
      $tot_fecha_cierre[0] = NM_encode_input(sc_strip_script($fecha_cierre)) ; 
      $tot_fecha_cierre[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_fecha_cierre[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_fecha_cierre[3] = (string)$rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $tot_fecha_cierre[4] = (string)$rt->fields[3]; 
      $rt->fields[4] = str_replace(",", ".", $rt->fields[4]);
      $tot_fecha_cierre[5] = (string)$rt->fields[4]; 
      $rt->fields[5] = str_replace(",", ".", $rt->fields[5]);
      $tot_fecha_cierre[6] = (string)$rt->fields[5]; 
      $rt->fields[6] = str_replace(",", ".", $rt->fields[6]);
      $tot_fecha_cierre[7] = (string)$rt->fields[6]; 
      $rt->fields[7] = str_replace(",", ".", $rt->fields[7]);
      $tot_fecha_cierre[8] = (string)$rt->fields[7]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_fecha_cierre;
   } 

   //-----  fecha_apertura
   function quebra_fecha_apertura_sc_free_group_by($fecha_apertura, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $idempleado;
      $tot_fecha_apertura = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(entrega_efectivo), sum(entrega_tarjeta), sum(total_entrega), sum(sistema_efectivo), sum(sistema_tarjeta), sum(sistema_total), sum(diferencia) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['where_pesq']; 
      } 
      ...
      $tot_fecha_apertura[0] = NM_encode_input(sc_strip_script($fecha_apertura)) ; 
      $tot_fecha_apertura[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_fecha_apertura[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_fecha_apertura[3] = (string)$rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $tot_fecha_apertura[4] = (string)$rt->fields[3]; 
      $rt->fields[4] = str_replace(",", ".", $rt->fields[4]);
      $tot_fecha_apertura[5] = (string)$rt->fields[4]; 
      $rt->fields[5] = str_replace(",", ".", $rt->fields[5]);
      $tot_fecha_apertura[6] = (string)$rt->fields[5]; 
      $rt->fields[6] = str_replace(",", ".", $rt->fields[6]);
      $tot_fecha_apertura[7] = (string)$rt->fields[6]; 
      $rt->fields[7] = str_replace(",", ".", $rt->fields[7]);
      $tot_fecha_apertura[8] = (string)$rt->fields[7]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_fecha_apertura;
   } 
   ...
   {
      global $nm_lang, $detalle, $cierrecaja, $continuar, $idempleado;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('estado' => "estado",'idempleado' => "idempleado",'idcaja' => "idcaja",'fecha_cierre' => "fecha_cierre",'fecha_apertura' => "fecha_apertura");
      $cmps_quebra_atual = array();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['SC_Gb_Free_cmp'] as $cmp => $resto)
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_sc_free_group_by($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $cmp_sql_tp_num = array('idturno' => 'N','idcaja' => 'N','fondo_inicial' => 'N','estado' => 'N','diferencia' => 'N','total_entrega' => 'N','numero_trans' => 'N','entrega_efectivo' => 'N','entrega_tarjeta' => 'N','sistema_efectivo' => 'N','sistema_tarjeta' => 'N','sistema_total' => 'N','total_pagos' => 'N');
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
         $cmd_simp = "select count(*), sum(entrega_efectivo), sum(entrega_tarjeta), sum(total_entrega), sum(sistema_efectivo), sum(sistema_tarjeta), sum(sistema_total), sum(diferencia)#@#cmps_quebras#@# from " . $this->Ini->nm_tabela . " " . $where_ok;
         ...
         $comando .= "select entrega_efectivo as SC_metric1,entrega_tarjeta as SC_metric2,total_entrega as SC_metric3,sistema_efectivo as SC_metric4,sistema_tarjeta as SC_metric5,sistema_total as SC_metric6,diferencia as SC_metric7, " . $cmps_quebras1 . " from " . $this->Ini->nm_tabela . " " .  $where_ok . ") SC_sel1 INNER JOIN (";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
      ...
      $format_dimensions['estado']['reg'] = "S";
      $format_dimensions['estado']['msk'] = "";
      $format_dimensions['idempleado']['reg'] = "S";
      $format_dimensions['idempleado']['msk'] = "";
      $format_dimensions['idcaja']['reg'] = "S";
      $format_dimensions['idcaja']['msk'] = "";
      $format_dimensions['fecha_cierre']['reg'] = "S";
      $format_dimensions['fecha_cierre']['msk'] = "";
      $format_dimensions['fecha_apertura']['reg'] = "S";
      $format_dimensions['fecha_apertura']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              ...
              if ($Cada_dim == "estado") {
                  $this->Lookup->lookup_sc_free_group_by_estado($$Cada_dim); 
              }
