...
class grid_turnos_reporte_csv
{
   ...
   function inicializa_vars()
   {
     global $nm_lang;
      ...
      if (method_exists($this->Tot,$Gb_geral))
      {
          ...
          {
              $this->sum_entrega_efectivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][2];
              $this->sum_entrega_tarjeta = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][3];
              $this->sum_total_entrega = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][4];
              $this->sum_sistema_efectivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][5];
              $this->sum_sistema_tarjeta = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][6];
              $this->sum_sistema_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][7];
              $this->sum_diferencia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][8];
          }
      }
      $this->Csv_password = "";
      $this->Arquivo   = "sc_csv";
      $this->Arquivo  .= "_" . date("YmdHis") . "_" . rand(0, 1000);
      $this->Arq_zip   = $this->Arquivo . "_grid_turnos_reporte.zip";
      $this->Arquivo  .= "_grid_turnos_reporte";
      $this->Arquivo  .= ".csv";
      $this->Tit_doc   = "grid_turnos_reporte.csv";
      $this->Tit_zip   = "grid_turnos_reporte.zip";
      $this->Label_CSV = "N";
      $this->Delim_dados = "\"";
      $this->Delim_col   = ";";
      $this->Delim_line  = "\r\n";
      ...
      if (!$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['csv_return']);
          if ($this->Tem_csv_res) {
   ...
   function grava_arquivo()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['csv_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['csv_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['csv_name'] .= ".csv";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['csv_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['csv_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['csv_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['csv_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['csv_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['csv_name']);
      }
      ...
      { 
          ...
          { 
              ...
              if ($Cada_col == "cierrecaja" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
              {
                  $col_sep = ($this->NM_prim_col > 0) ? $this->Delim_col : "";
                  $conteudo = str_replace($this->Delim_dados, $this->Delim_dados . $this->Delim_dados, $SC_Label);
                  $this->csv_registro .= $col_sep . $this->Delim_dados . $conteudo . $this->Delim_dados;
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['where_pesq'];
      ...
      { 
          ...
          { 
              ...
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['where_resumo'] . ")"; 
          } 
      } 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['order_grid'];
...
$_SESSION['scriptcase']['grid_turnos_reporte']['contr_erro'] = 'off'; 
      ...
      { 
          ...
          $this->Res = new grid_turnos_reporte_res_csv();
          $this->prep_modulos("Res");
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['csv_res_grid'] = true;
          $this->Res->monta_csv();
      } 
      if (!$this->Ini->sc_export_ajax) {
      ...
      { 
          ...
          { 
              $str_zip    = "";
              $Arq_res    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['csv_res_file'];
              ...
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['csv_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['csv_res_file']);
          }
          unlink($Arq_input);
   ...
   //----- cierrecaja
   function NM_export_cierrecaja()
   {
      $col_sep = ($this->NM_prim_col > 0) ? $this->Delim_col : "";
      $conteudo = str_replace($this->Delim_dados, $this->Delim_dados . $this->Delim_dados, $this->cierrecaja);
      $this->csv_registro .= $col_sep . $this->Delim_dados . $conteudo . $this->Delim_dados;
      $this->NM_prim_col++;
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte'][$path_doc_md5][1] = $this->Tit_doc;
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte'][$path_doc_md5][1] = $this->Tit_doc;
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['csv_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
