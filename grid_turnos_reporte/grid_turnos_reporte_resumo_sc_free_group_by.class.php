...
class grid_turnos_reporte_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_idempleado;
   var $array_total_idcaja;
   var $array_total_fecha_cierre;
   var $array_total_fecha_apertura;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_idempleado     = array();
      $this->array_total_idcaja         = array();
      $this->array_total_fecha_cierre   = array();
      $this->array_total_fecha_apertura = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_turnos_reporte']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_turnos_reporte']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][7];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][4];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][2];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][3];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][5];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][6];
      $this->array_total_geral[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][8];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['arr_total']['estado'] = $this->array_total_estado;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['arr_total']['idempleado'] = $this->array_total_idempleado;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['arr_total']['idcaja'] = $this->array_total_idcaja;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['arr_total']['fecha_cierre'] = $this->array_total_fecha_cierre;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['arr_total']['fecha_apertura'] = $this->array_total_fecha_apertura;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['json_use_label'])
       {
          $Lab_estado = "estado";
          $Lab_idempleado = "idempleado";
          $Lab_idcaja = "idcaja";
          $Lab_fecha_cierre = "fecha_cierre";
          $Lab_fecha_apertura = "fecha_apertura";
       }
       else
       {
       $Lab_estado = "Estado";
       $Lab_idempleado = "Idempleado";
       $Lab_idcaja = "Idcaja";
       $Lab_fecha_cierre = "Fecha Cierre";
       $Lab_fecha_cierre =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", $Lab_fecha_cierre);
       $Lab_fecha_apertura = "Fecha Apertura";
       $Lab_fecha_apertura =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", $Lab_fecha_apertura);
       }
       $prep_field = array();
       $prep_field['estado'] = $Lab_estado;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['estado'] = $Lab_estado; 
       $prep_field['idempleado'] = $Lab_idempleado;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['idempleado'] = $Lab_idempleado; 
       $prep_field['idcaja'] = $Lab_idcaja;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['idcaja'] = $Lab_idcaja; 
       $prep_field['fecha_cierre'] = $Lab_fecha_cierre;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['fecha_cierre'] = $Lab_fecha_cierre; 
       $prep_field['fecha_apertura'] = $Lab_fecha_apertura;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['fecha_apertura'] = $Lab_fecha_apertura; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['idturno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['idturno'] = "Idturno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['idempleado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['idempleado'] = "Idempleado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['idcaja']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['idcaja'] = "Idcaja"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['estado'] = "Estado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['fecha_apertura']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['fecha_apertura'] = "Fecha Apertura"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['fecha_cierre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['fecha_cierre'] = "Fecha Cierre"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['fondo_inicial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['fondo_inicial'] = "Fondo Inicial"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['entrega_efectivo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['entrega_efectivo'] = "Entrega Efectivo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['entrega_tarjeta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['entrega_tarjeta'] = "Entrega Tarjeta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['total_entrega']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['total_entrega'] = "Total Entrega"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['numero_trans']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['numero_trans'] = "Numero Trans"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['sistema_efectivo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['sistema_efectivo'] = "Sistema Efectivo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['sistema_tarjeta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['sistema_tarjeta'] = "Sistema Tarjeta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['sistema_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['sistema_total'] = "Sistema Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['diferencia']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['diferencia'] = "Diferencia"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['detalle']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['detalle'] = "detalle"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['cierrecaja']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['cierrecaja'] = "cierrecaja"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['total_pagos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['total_pagos'] = "Total Pagos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['continuar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['labels']['continuar'] = ""; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       //-----
       $this->comp_sum = array(
           2 => "Sistema Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           3 => "Total Entrega (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           4 => "Entrega Efectivo (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           5 => "Entrega Tarjeta (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           6 => "Sistema Efectivo (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           7 => "Sistema Tarjeta (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           8 => "Diferencia (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "sistema_total", 'show' => true),
           3 => array('field' => "total_entrega", 'show' => true),
           4 => array('field' => "entrega_efectivo", 'show' => true),
           5 => array('field' => "entrega_tarjeta", 'show' => true),
           6 => array('field' => "sistema_efectivo", 'show' => true),
           7 => array('field' => "sistema_tarjeta", 'show' => true),
           8 => array('field' => "diferencia", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_sistema_total_sum",
           3 => "css_total_entrega_sum",
           4 => "css_entrega_efectivo_sum",
           5 => "css_entrega_tarjeta_sum",
           6 => "css_sistema_efectivo_sum",
           7 => "css_sistema_tarjeta_sum",
           8 => "css_diferencia_sum",
       );
       ...
       $this->comp_sum_nm = array(
           2 => "sistema_total_sum",
           3 => "total_entrega_sum",
           4 => "entrega_efectivo_sum",
           5 => "entrega_tarjeta_sum",
           6 => "sistema_efectivo_sum",
           7 => "sistema_tarjeta_sum",
           8 => "diferencia_sum",
       );
      ...
      for ($ix = 0; $ix < sizeof($Arr_gb); $ix++)
      {
          ...
          $Str_gb .= "         \$this->comp_index[" . $ix . "][\$dados_" . $Arr_gb[$ix] . "[9] ] = \$dados_" . $Arr_gb[$ix] . "[8];";
          $Str_gb .= "         \$this->comp_label[" . $ix . "]" . $Arr_lab[$ix] . "[ \$dados_" . $Arr_gb[$ix] . "[9] ] = \$dados_" . $Arr_gb[$ix] . "[8];";
          $Str_gb .= "    }";
      }
      for ($ix = 0; $ix < sizeof($Arr_gb); $ix++)
      {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['idempleado']['alin'] = "''";
       $Arr_parms['idempleado']['link'] = "S";
       $Arr_parms['idcaja']['alin'] = "''";
       $Arr_parms['idcaja']['link'] = "S";
       $Arr_parms['fecha_cierre']['alin'] = "''";
       $Arr_parms['fecha_cierre']['link'] = "S";
       $Arr_parms['fecha_apertura']['alin'] = "''";
       $Arr_parms['fecha_apertura']['link'] = "S";
       ...
       $Arr_parms['estado']['order_enabled'] = 'true';
       $Arr_parms['estado']['order_datatype'] = 'int';
       $Arr_parms['idempleado']['fill'] = "true";
       $Arr_parms['idempleado']['order'] = "label";
       $Arr_parms['idempleado']['order_start'] = 'asc';
       $Arr_parms['idempleado']['order_invert'] = 'false';
       $Arr_parms['idempleado']['order_enabled'] = 'true';
       $Arr_parms['idempleado']['order_datatype'] = 'varchar';
       $Arr_parms['idcaja']['fill'] = "true";
       $Arr_parms['idcaja']['order'] = "label";
       $Arr_parms['idcaja']['order_start'] = 'asc';
       $Arr_parms['idcaja']['order_invert'] = 'false';
       $Arr_parms['idcaja']['order_enabled'] = 'true';
       $Arr_parms['idcaja']['order_datatype'] = 'int';
       $Arr_parms['fecha_cierre']['fill'] = "true";
       $Arr_parms['fecha_cierre']['order'] = "value";
       $Arr_parms['fecha_cierre']['order_start'] = 'asc';
       $Arr_parms['fecha_cierre']['order_invert'] = 'false';
       $Arr_parms['fecha_cierre']['order_enabled'] = 'true';
       $Arr_parms['fecha_cierre']['order_datatype'] = 'datetime';
       $Arr_parms['fecha_apertura']['fill'] = "true";
       $Arr_parms['fecha_apertura']['order'] = "value";
       $Arr_parms['fecha_apertura']['order_start'] = 'asc';
       $Arr_parms['fecha_apertura']['order_invert'] = 'false';
       $Arr_parms['fecha_apertura']['order_enabled'] = 'true';
       $Arr_parms['fecha_apertura']['order_datatype'] = 'datetime';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['estado'] = array(0 => 'estado', 1 => '');
       $prep_links_fl['idempleado'] = array(0 => 'idempleado', 1 => '@aspass@');
       $prep_links_fl['idcaja'] = array(0 => 'idcaja', 1 => '');
       $prep_links_fl['fecha_cierre'] = array(0 => 'fecha_cierre', 1 => '@aspass@');
       $prep_links_fl['fecha_apertura'] = array(0 => 'fecha_apertura', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_turnos_reporte@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function resumo_final()
   {
      ...
      if (!$this->NM_res_sem_reg && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['opcao'] != "pdf")
      {
          $this->grafico_bot();
      }
      if ("out" == $this->NM_tipo)
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_turnos_reporte_total.class.php"); 
      }
      ...
      $this->Total   = new grid_turnos_reporte_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_turnos_reporte/grid_turnos_reporte_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_turnos_reporte_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_turnos_reporte_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_turnos_reporte_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['num_css'] . '.css');
     ...
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_turnos_reporte/grid_turnos_reporte_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_turnos_reporte&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_turnos_reporte/grid_turnos_reporte_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_turnos_reporte&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_turnos_reporte/grid_turnos_reporte_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_turnos_reporte/grid_turnos_reporte_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "nm_gp_res_print('grid,resume');", "nm_gp_res_print('grid,resume');", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "", "", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_turnos_reporte_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rpdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['pdf'][] = "Rpdf_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_turnos_reporte/grid_turnos_reporte_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume&nm_all_modules=grid,resume&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_turnos_reporte&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xml'][] = "Rxml_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_turnos_reporte/grid_turnos_reporte_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rcsv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['csv'][] = "Rcsv_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_turnos_reporte/grid_turnos_reporte_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rprinttop\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['print'][] = "Rprint_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "nm_gp_res_print('grid,resume');", "nm_gp_res_print('grid,resume');", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "", "", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_turnos_reporte']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_turnos_reporte']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_turnos_reporte_config_pivot.php?nome_apl=grid_turnos_reporte&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("          nm_submit_modal(\"" . $this->Ini->path_link . "grid_turnos_reporte/grid_turnos_reporte_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_turnos_reporte_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_turnos_reporte/grid_turnos_reporte_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_bot()
 {
   ...
   $bPDF = false;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new grid_turnos_reporte_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_charts']);
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
           ...
           grid_turnos_reporte_pdf_progress_call("\n", $this->Ini->Nm_lang);
           grid_turnos_reporte_pdf_progress_call("\n", $this->Ini->Nm_lang);
           grid_turnos_reporte_pdf_progress_call("100\n", $this->Ini->Nm_lang);
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['pivot_charts'] as $chart_index => $chart_data)
       {
           $qtd_col++;
           if ($qtd_col > $lim_col)
           {
           ...
           if ($bPDF)
           {
               ...
               if ($this->progress_fp)
               {
                   grid_turnos_reporte_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "/" . $iChartTotal . "...\n", $this->Ini->Nm_lang, true);
       ...
       if ($bChartFP)
       {
           ...
           grid_turnos_reporte_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['ajax_nav'])
      {
       ...
       $nm_saida->saida("</TABLE>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
       }
   }
 }
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $fecha_apertura = $Busca_temp['fecha_apertura']; 
          $tmp_pos = strpos($fecha_apertura, "##@@");
          if ($tmp_pos !== false && !is_array($fecha_apertura))
          {
              $fecha_apertura = substr($fecha_apertura, 0, $tmp_pos);
          }
          $fecha_apertura_2 = $Busca_temp['fecha_apertura_input_2']; 
          $idcaja = $Busca_temp['idcaja']; 
          $tmp_pos = strpos($idcaja, "##@@");
          if ($tmp_pos !== false && !is_array($idcaja))
          {
              $idcaja = substr($idcaja, 0, $tmp_pos);
          }
          ...
          $idempleado = $Busca_temp['idempleado']; 
          $tmp_pos = strpos($idempleado, "##@@");
          if ($tmp_pos !== false && !is_array($idempleado))
          {
              $idempleado = substr($idempleado, 0, $tmp_pos);
          }
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($sum_entrega_efectivo, $sum_entrega_tarjeta, $sum_total_entrega, $sum_sistema_efectivo, $sum_sistema_tarjeta, $sum_sistema_total, $sum_diferencia, $quebra_estado, $quebra_idempleado, $quebra_idcaja, $quebra_fecha_cierre, $quebra_fecha_apertura, $quebra_estado_orig, $quebra_idempleado_orig, $quebra_idcaja_orig, $quebra_fecha_cierre_orig, $quebra_fecha_apertura_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_turnos_reporte']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          $cmp_look   = "Cmp_formt";
          $cmp_orig   = "Cmp_arg";
          if (empty($sum_entrega_efectivo)) {$sum_entrega_efectivo = '0';}
          if (empty($sum_entrega_tarjeta)) {$sum_entrega_tarjeta = '0';}
          if (empty($sum_total_entrega)) {$sum_total_entrega = '0';}
          if (empty($sum_sistema_efectivo)) {$sum_sistema_efectivo = '0';}
          if (empty($sum_sistema_tarjeta)) {$sum_sistema_tarjeta = '0';}
          if (empty($sum_sistema_total)) {$sum_sistema_total = '0';}
          if (empty($sum_diferencia)) {$sum_diferencia = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_entrega_efectivo . ';
              $this->' . $arr_name . '[2] = ' . $sum_entrega_tarjeta . ';
              $this->' . $arr_name . '[3] = ' . $sum_total_entrega . ';
              $this->' . $arr_name . '[4] = ' . $sum_sistema_efectivo . ';
              $this->' . $arr_name . '[5] = ' . $sum_sistema_tarjeta . ';
              $this->' . $arr_name . '[6] = ' . $sum_sistema_total . ';
              $this->' . $arr_name . '[7] = ' . $sum_diferencia . ';
              $this->' . $arr_name . '[8] = "' . addslashes($$cmp_look) . '";
              $this->' . $arr_name . '[9] = "' . $$cmp_orig . '";
          }
          else
          {
              $this->' . $arr_name . '[0]++;
              $this->' . $arr_name . '[1] = bcadd($this->' . $arr_name . '[1], ' . $sum_entrega_efectivo . ', 10);
              $this->' . $arr_name . '[2] = bcadd($this->' . $arr_name . '[2], ' . $sum_entrega_tarjeta . ', 10);
              $this->' . $arr_name . '[3] = bcadd($this->' . $arr_name . '[3], ' . $sum_total_entrega . ', 10);
              $this->' . $arr_name . '[4] = bcadd($this->' . $arr_name . '[4], ' . $sum_sistema_efectivo . ', 10);
              $this->' . $arr_name . '[5] = bcadd($this->' . $arr_name . '[5], ' . $sum_sistema_tarjeta . ', 10);
              $this->' . $arr_name . '[6] = bcadd($this->' . $arr_name . '[6], ' . $sum_sistema_total . ', 10);
              $this->' . $arr_name . '[7] = bcadd($this->' . $arr_name . '[7], ' . $sum_diferencia . ', 10);
          }
          ');
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->idturno = $rs_res->fields[0] ;  
            $this->idempleado = $rs_res->fields[1] ;  
            $this->idcaja = $rs_res->fields[2] ;  
            $this->estado = $rs_res->fields[3] ;  
            $this->fecha_apertura = $rs_res->fields[4] ;  
            $this->fecha_cierre = $rs_res->fields[5] ;  
            $this->fondo_inicial = $rs_res->fields[6] ;  
            $this->fondo_inicial =  str_replace(",", ".", $this->fondo_inicial);
            $this->entrega_efectivo = $rs_res->fields[7] ;  
            $this->entrega_efectivo =  str_replace(",", ".", $this->entrega_efectivo);
            $this->entrega_tarjeta = $rs_res->fields[8] ;  
            $this->entrega_tarjeta =  str_replace(",", ".", $this->entrega_tarjeta);
            $this->total_entrega = $rs_res->fields[9] ;  
            $this->total_entrega =  str_replace(",", ".", $this->total_entrega);
            $this->numero_trans = $rs_res->fields[10] ;  
            $this->sistema_efectivo = $rs_res->fields[11] ;  
            $this->sistema_efectivo =  str_replace(",", ".", $this->sistema_efectivo);
            $this->sistema_tarjeta = $rs_res->fields[12] ;  
            $this->sistema_tarjeta =  str_replace(",", ".", $this->sistema_tarjeta);
            $this->sistema_total = $rs_res->fields[13] ;  
            $this->sistema_total =  str_replace(",", ".", $this->sistema_total);
            $this->diferencia = $rs_res->fields[14] ;  
            $this->diferencia =  str_replace(",", ".", $this->diferencia);
            $this->estado_orig = $this->estado;
            $this->idempleado_orig = $this->idempleado;
            $this->idcaja_orig = $this->idcaja;
            $this->fecha_cierre_orig = $this->fecha_cierre;
            $this->fecha_apertura_orig = $this->fecha_apertura;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->entrega_efectivo, $this->entrega_tarjeta, $this->total_entrega, $this->sistema_efectivo, $this->sistema_tarjeta, $this->sistema_total, $this->diferencia, $this->estado, $this->idempleado, $this->idcaja, $this->fecha_cierre, $this->fecha_apertura, $this->estado_orig,  $this->idempleado_orig,  $this->idcaja_orig,  $this->fecha_cierre_orig,  $this->fecha_apertura_orig);
            }
   }
//
