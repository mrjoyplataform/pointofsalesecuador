...
Table_sv_fil[0] = "fecha_apertura";
Table_sv_fil[1] = "idcaja";
Table_sv_fil[2] = "estado";
Table_sv_fil[3] = "idempleado";
Table_sv_fil[4] = "fecha_cierre";
function ajax_select_filter(parm)
{
    ...
    $.ajax({
     ...
     .done(function(json_sel_fil) {
        ...
        if ($("#SC_fecha_apertura_cond") && search_get_sel_txt("SC_fecha_apertura_cond").substring(0, 3) == "bi_") {
            formata_bi_fecha_apertura(search_get_sel_txt("SC_fecha_apertura_cond"), SC_fecha_apertura_bi_opc, SC_fecha_apertura_bi_dt);
        }
