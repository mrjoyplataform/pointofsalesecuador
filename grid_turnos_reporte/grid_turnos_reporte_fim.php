...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_turnos_reporte"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_turnos_reporte"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_turnos_reporte']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_turnos_reporte']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_turnos_reporte']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_turnos_reporte']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_turnos_reporte']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_turnos_reporte</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_turnos_reporte']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_turnos_reporte']['embutida_filho'] as $ind => $sc_init)
          {
