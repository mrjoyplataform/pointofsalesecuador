<?php
@session_start() ;
$_SESSION['scriptcase']['grid_turnos_reporte']['sc_process_barr'] = true;
require_once('../grid_turnos_reporte/index.php');
unset($_SESSION['scriptcase']['grid_turnos_reporte']['sc_process_barr']);
$ExportCtrl = new grid_turnos_reporte_export_control;
$ExportCtrl->Export_barr();

class grid_turnos_reporte_export_control
{
