  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_devices_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate cod_device
  function do_ajax_form_devices_mob_validate_cod_device()
  {
    var nomeCampo_cod_device = "cod_device";
    var var_cod_device = scAjaxGetFieldHidden(nomeCampo_cod_device);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_mob_validate_cod_device(var_cod_device, var_script_case_init, do_ajax_form_devices_mob_validate_cod_device_cb);
  } // do_ajax_form_devices_mob_validate_cod_device

  function do_ajax_form_devices_mob_validate_cod_device_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_mob_validate_cod_device_cb

  // ---------- Validate dev_ip
  function do_ajax_form_devices_mob_validate_dev_ip()
  {
    var nomeCampo_dev_ip = "dev_ip";
    var var_dev_ip = scAjaxGetFieldHidden(nomeCampo_dev_ip);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_mob_validate_dev_ip(var_dev_ip, var_script_case_init, do_ajax_form_devices_mob_validate_dev_ip_cb);
  } // do_ajax_form_devices_mob_validate_dev_ip

  function do_ajax_form_devices_mob_validate_dev_ip_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dev_ip";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_mob_validate_dev_ip_cb

  // ---------- Validate cod_grupo
  function do_ajax_form_devices_mob_validate_cod_grupo()
  {
    var nomeCampo_cod_grupo = "cod_grupo";
    var var_cod_grupo = scAjaxGetFieldSelect(nomeCampo_cod_grupo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_mob_validate_cod_grupo(var_cod_grupo, var_script_case_init, do_ajax_form_devices_mob_validate_cod_grupo_cb);
  } // do_ajax_form_devices_mob_validate_cod_grupo

  function do_ajax_form_devices_mob_validate_cod_grupo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_mob_validate_cod_grupo_cb

  // ---------- Validate url_atraccion
  function do_ajax_form_devices_mob_validate_url_atraccion()
  {
    var nomeCampo_url_atraccion = "url_atraccion";
    var var_url_atraccion = scAjaxGetFieldText(nomeCampo_url_atraccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_mob_validate_url_atraccion(var_url_atraccion, var_script_case_init, do_ajax_form_devices_mob_validate_url_atraccion_cb);
  } // do_ajax_form_devices_mob_validate_url_atraccion

  function do_ajax_form_devices_mob_validate_url_atraccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_mob_validate_url_atraccion_cb

  // ---------- Validate url_accion
  function do_ajax_form_devices_mob_validate_url_accion()
  {
    var nomeCampo_url_accion = "url_accion";
    var var_url_accion = scAjaxGetFieldText(nomeCampo_url_accion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_mob_validate_url_accion(var_url_accion, var_script_case_init, do_ajax_form_devices_mob_validate_url_accion_cb);
  } // do_ajax_form_devices_mob_validate_url_accion

  function do_ajax_form_devices_mob_validate_url_accion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_mob_validate_url_accion_cb

  // ---------- Validate device_name
  function do_ajax_form_devices_mob_validate_device_name()
  {
    var nomeCampo_device_name = "device_name";
    var var_device_name = scAjaxGetFieldText(nomeCampo_device_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_mob_validate_device_name(var_device_name, var_script_case_init, do_ajax_form_devices_mob_validate_device_name_cb);
  } // do_ajax_form_devices_mob_validate_device_name

  function do_ajax_form_devices_mob_validate_device_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_mob_validate_device_name_cb

  // ---------- Validate activa
  function do_ajax_form_devices_mob_validate_activa()
  {
    var nomeCampo_activa = "activa";
    var var_activa = scAjaxGetFieldRadio(nomeCampo_activa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_mob_validate_activa(var_activa, var_script_case_init, do_ajax_form_devices_mob_validate_activa_cb);
  } // do_ajax_form_devices_mob_validate_activa

  function do_ajax_form_devices_mob_validate_activa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_mob_validate_activa_cb

  // ---------- Validate acepta_tokens
  function do_ajax_form_devices_mob_validate_acepta_tokens()
  {
    var nomeCampo_acepta_tokens = "acepta_tokens";
    var var_acepta_tokens = scAjaxGetFieldRadio(nomeCampo_acepta_tokens);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_mob_validate_acepta_tokens(var_acepta_tokens, var_script_case_init, do_ajax_form_devices_mob_validate_acepta_tokens_cb);
  } // do_ajax_form_devices_mob_validate_acepta_tokens

  function do_ajax_form_devices_mob_validate_acepta_tokens_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_mob_validate_acepta_tokens_cb

  // ---------- Validate tokens
  function do_ajax_form_devices_mob_validate_tokens()
  {
    var nomeCampo_tokens = "tokens";
    var var_tokens = scAjaxGetFieldText(nomeCampo_tokens);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_mob_validate_tokens(var_tokens, var_script_case_init, do_ajax_form_devices_mob_validate_tokens_cb);
  } // do_ajax_form_devices_mob_validate_tokens

  function do_ajax_form_devices_mob_validate_tokens_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tokens";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_mob_validate_tokens_cb

  // ---------- Validate pin_relay1
  function do_ajax_form_devices_mob_validate_pin_relay1()
  {
    var nomeCampo_pin_relay1 = "pin_relay1";
    var var_pin_relay1 = scAjaxGetFieldText(nomeCampo_pin_relay1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_mob_validate_pin_relay1(var_pin_relay1, var_script_case_init, do_ajax_form_devices_mob_validate_pin_relay1_cb);
  } // do_ajax_form_devices_mob_validate_pin_relay1

  function do_ajax_form_devices_mob_validate_pin_relay1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_mob_validate_pin_relay1_cb

  // ---------- Validate pin_relay2
  function do_ajax_form_devices_mob_validate_pin_relay2()
  {
    var nomeCampo_pin_relay2 = "pin_relay2";
    var var_pin_relay2 = scAjaxGetFieldText(nomeCampo_pin_relay2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_mob_validate_pin_relay2(var_pin_relay2, var_script_case_init, do_ajax_form_devices_mob_validate_pin_relay2_cb);
  } // do_ajax_form_devices_mob_validate_pin_relay2

  function do_ajax_form_devices_mob_validate_pin_relay2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_mob_validate_pin_relay2_cb

  // ---------- Validate cod_activo
  function do_ajax_form_devices_mob_validate_cod_activo()
  {
    var nomeCampo_cod_activo = "cod_activo";
    var var_cod_activo = scAjaxGetFieldText(nomeCampo_cod_activo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devices_mob_validate_cod_activo(var_cod_activo, var_script_case_init, do_ajax_form_devices_mob_validate_cod_activo_cb);
  } // do_ajax_form_devices_mob_validate_cod_activo

  function do_ajax_form_devices_mob_validate_cod_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devices_mob_validate_cod_activo_cb

  // ---------- Event onchange cod_grupo
  function do_ajax_form_devices_mob_event_cod_grupo_onchange()
  {
    var var_cod_grupo = scAjaxGetFieldSelect("cod_grupo");
    var var_url_atraccion = scAjaxGetFieldText("url_atraccion");
    var var_url_accion = scAjaxGetFieldText("url_accion");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_devices_mob_event_cod_grupo_onchange(var_cod_grupo, var_url_atraccion, var_url_accion, var_script_case_init, do_ajax_form_devices_mob_event_cod_grupo_onchange_cb);
  } // do_ajax_form_devices_mob_event_cod_grupo_onchange

  function do_ajax_form_devices_mob_event_cod_grupo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cod_grupo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_devices_mob_event_cod_grupo_onchange_cb_after_alert);
  } // do_ajax_form_devices_mob_event_cod_grupo_onchange_cb
  function do_ajax_form_devices_mob_event_cod_grupo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_devices_mob_event_cod_grupo_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_devices_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_devices_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_cod_device = scAjaxGetFieldHidden("cod_device");
    var var_dev_ip = scAjaxGetFieldHidden("dev_ip");
    var var_cod_grupo = scAjaxGetFieldSelect("cod_grupo");
    var var_url_atraccion = scAjaxGetFieldText("url_atraccion");
    var var_url_accion = scAjaxGetFieldText("url_accion");
    var var_device_name = scAjaxGetFieldText("device_name");
    var var_activa = scAjaxGetFieldRadio("activa");
    var var_acepta_tokens = scAjaxGetFieldRadio("acepta_tokens");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_devices_mob_submit_form(var_cod_device, var_dev_ip, var_cod_grupo, var_url_atraccion, var_url_accion, var_device_name, var_activa, var_acepta_tokens, var_tokens, var_pin_relay1, var_pin_relay2, var_cod_activo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_devices_mob_submit_form_cb);
  } // do_ajax_form_devices_mob_submit_form

  function do_ajax_form_devices_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_devices_mob_submit_form_cb_after_alert);
  } // do_ajax_form_devices_mob_submit_form_cb
  function do_ajax_form_devices_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_devices_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_devices_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_devices_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_devices_mob_navigate_form();
    }
  }

  function perform_ajax_form_devices_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_devices_mob_navigate_form(var_cod_device, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_devices_mob_navigate_form_cb);
  } // do_ajax_form_devices_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_devices_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_devices_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_devices_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_devices_mob_navigate_form_cb
  function do_ajax_form_devices_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_devices_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_devices_mob_navigate_form_cb_after_alert

  function sc_hide_form_devices_mob_form()
  {
  ...
  ajax_field_list[1] = "dev_ip";
  ajax_field_list[2] = "cod_grupo";
  ajax_field_list[3] = "url_atraccion";
  ajax_field_list[4] = "url_accion";
  ajax_field_list[5] = "device_name";
  ajax_field_list[6] = "activa";
  ajax_field_list[7] = "acepta_tokens";
  ajax_field_list[8] = "tokens";
  ajax_field_list[9] = "pin_relay1";
  ajax_field_list[10] = "pin_relay2";
  ajax_field_list[11] = "cod_activo";
  ...
  var ajax_error_list = {
    ...
    "cod_grupo": {"label": "Tipo/Grupo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
