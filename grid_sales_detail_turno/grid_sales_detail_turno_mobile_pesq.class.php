...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_sales_detail_cond" name="id_sales_detail_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_sales_detail'), this, 'id_sales_detail')">
      ...
      <br><span id="id_hide_id_sales_detail"  <?php echo $str_hide_id_sales_detail?>><INPUT  type="text" id="SC_id_sales_detail" name="id_sales_detail" value="<?php echo NM_encode_input($id_sales_detail) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_id_sales_cond" name="id_sales_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_sales'), this, 'id_sales')">
      ...
      <br><span id="id_hide_id_sales"  <?php echo $str_hide_id_sales?>><INPUT  type="text" id="SC_id_sales" name="id_sales" value="<?php echo NM_encode_input($id_sales) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_unit_cost_cond" name="unit_cost_cond" onChange="nm_campos_between(document.getElementById('id_vis_unit_cost'), this, 'unit_cost')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_unit_value_cond" name="unit_value_cond" onChange="nm_campos_between(document.getElementById('id_vis_unit_value'), this, 'unit_value')">
