<?php
@session_start() ;
$_SESSION['scriptcase']['grid_sales_detail_turno']['sc_process_barr'] = true;
require_once('../grid_sales_detail_turno/index.php');
unset($_SESSION['scriptcase']['grid_sales_detail_turno']['sc_process_barr']);
$ExportCtrl = new grid_sales_detail_turno_export_control;
$ExportCtrl->Export_barr();

class grid_sales_detail_turno_export_control
{
