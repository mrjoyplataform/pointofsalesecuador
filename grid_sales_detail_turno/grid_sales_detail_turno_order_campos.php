...
<?php
   ...
   $Ord_Cmp = new grid_sales_detail_turno_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_sales_detail_turno_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id_sales_detail"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['labels']["id_sales_detail"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['labels']["id_sales_detail"] : "Id Sales Detail";
   $tab_ger_campos['id_sales'] = "on";
   $tab_def_campos['id_sales'] = "id_sales";
   $tab_labels["id_sales"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['labels']["id_sales"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['labels']["id_sales"] : "Id Sales";
   $tab_ger_campos['unit_cost'] = "on";
   $tab_def_campos['unit_cost'] = "unit_cost";
   $tab_labels["unit_cost"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['labels']["unit_cost"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['labels']["unit_cost"] : "Unit Cost";
   $tab_ger_campos['unit_value'] = "on";
   $tab_def_campos['unit_value'] = "unit_value";
   $tab_labels["unit_value"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['labels']["unit_value"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['labels']["unit_value"] : "Unit Value";
   $tab_ger_campos['quantity'] = "on";
   $tab_def_campos['quantity'] = "quantity";
   $tab_labels["quantity"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['labels']["quantity"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['labels']["quantity"] : "Quantity";
   $tab_ger_campos['discount'] = "on";
   $tab_def_campos['discount'] = "discount";
   $tab_labels["discount"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['labels']["discount"])) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['labels']["discount"] : "Discount";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_sales_detail_turno_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_sales_detail_turno']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
