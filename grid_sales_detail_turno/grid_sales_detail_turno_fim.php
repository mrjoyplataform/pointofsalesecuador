...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_sales_detail_turno"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_sales_detail_turno"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_sales_detail_turno']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_sales_detail_turno']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_sales_detail_turno']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_sales_detail_turno']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_sales_detail_turno']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_sales_detail_turno</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_sales_detail_turno']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_sales_detail_turno']['embutida_filho'] as $ind => $sc_init)
          {
