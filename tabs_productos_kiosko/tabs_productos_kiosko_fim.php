...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____tabs_productos_kiosko"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____tabs_productos_kiosko"]);
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']['tabs_productos_kiosko']))
   {
       unset($_SESSION['scriptcase']['sc_aba_iframe']['tabs_productos_kiosko']);
   }
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['tabs_productos_kiosko']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['tabs_productos_kiosko']['sc_outra_jan'])
   {
       $fecha_janela = true;
   }
   $fecha_modal = false;
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['tabs_productos_kiosko']['aba_saida']) && $_SESSION['sc_session'][$script_case_init]['tabs_productos_kiosko']['aba_saida'] == "modal")
   {
       unset($_SESSION['sc_session'][$script_case_init]['tabs_productos_kiosko']['aba_saida']);
       $fecha_modal = true;
   }
