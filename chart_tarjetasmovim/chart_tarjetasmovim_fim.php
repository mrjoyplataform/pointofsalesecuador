...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____chart_tarjetasmovim"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____chart_tarjetasmovim"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_tarjetasmovim']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_tarjetasmovim']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_tarjetasmovim']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_tarjetasmovim']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_tarjetasmovim']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_tarjetasmovim</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_tarjetasmovim']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_tarjetasmovim']['embutida_filho'] as $ind => $sc_init)
          {
