...
<?php
   ...
   $Ord_Cmp = new grid_turnos_abiertos_idcaja_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_turnos_abiertos_idcaja_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idturno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['labels']["idturno"])) ? $_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['labels']["idturno"] : "Idturno";
   $tab_ger_campos['fecha_apertura'] = "on";
   $tab_def_campos['fecha_apertura'] = "fecha_apertura";
   $tab_labels["fecha_apertura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['labels']["fecha_apertura"])) ? $_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['labels']["fecha_apertura"] : "Fecha Apertura";
   $tab_ger_campos['fondo_inicial'] = "on";
   $tab_def_campos['fondo_inicial'] = "fondo_inicial";
   $tab_labels["fondo_inicial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['labels']["fondo_inicial"])) ? $_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['labels']["fondo_inicial"] : "Fondo Inicial";
   $tab_ger_campos['continuar'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['continuar'] = "continuar";
   }
   else
   {
       $tab_def_campos['continuar'] = "";
   }
   $tab_labels["continuar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['labels']["continuar"])) ? $_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['labels']["continuar"] : "";
   $tab_ger_campos['continuar'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_turnos_abiertos_idcaja_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_turnos_abiertos_idcaja']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
