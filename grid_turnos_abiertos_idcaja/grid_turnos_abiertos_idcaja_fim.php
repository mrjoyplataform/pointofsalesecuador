...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_turnos_abiertos_idcaja"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_turnos_abiertos_idcaja"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_turnos_abiertos_idcaja']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_turnos_abiertos_idcaja']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_turnos_abiertos_idcaja']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_turnos_abiertos_idcaja']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_turnos_abiertos_idcaja']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_turnos_abiertos_idcaja</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_turnos_abiertos_idcaja']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_turnos_abiertos_idcaja']['embutida_filho'] as $ind => $sc_init)
          {
