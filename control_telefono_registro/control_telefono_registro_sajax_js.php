  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_telefono_registro" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_telefono_registro_form();
	}
...
?>
  ...
  // ---------- Validate codpais
  function do_ajax_control_telefono_registro_validate_codpais()
  {
    var nomeCampo_codpais = "codpais";
    var var_codpais = scAjaxGetFieldSelect(nomeCampo_codpais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_telefono_registro_validate_codpais(var_codpais, var_script_case_init, do_ajax_control_telefono_registro_validate_codpais_cb);
  } // do_ajax_control_telefono_registro_validate_codpais

  function do_ajax_control_telefono_registro_validate_codpais_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_telefono_registro_validate_codpais_cb

  // ---------- Validate codpais2
  function do_ajax_control_telefono_registro_validate_codpais2()
  {
    var nomeCampo_codpais2 = "codpais2";
    var var_codpais2 = scAjaxGetFieldSelect(nomeCampo_codpais2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_telefono_registro_validate_codpais2(var_codpais2, var_script_case_init, do_ajax_control_telefono_registro_validate_codpais2_cb);
  } // do_ajax_control_telefono_registro_validate_codpais2

  function do_ajax_control_telefono_registro_validate_codpais2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_telefono_registro_validate_codpais2_cb

  // ---------- Validate celular
  function do_ajax_control_telefono_registro_validate_celular()
  {
    var nomeCampo_celular = "celular";
    var var_celular = scAjaxGetFieldText(nomeCampo_celular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_telefono_registro_validate_celular(var_celular, var_script_case_init, do_ajax_control_telefono_registro_validate_celular_cb);
  } // do_ajax_control_telefono_registro_validate_celular

  function do_ajax_control_telefono_registro_validate_celular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "celular";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_telefono_registro_validate_celular_cb

  // ---------- Validate userid
  function do_ajax_control_telefono_registro_validate_userid()
  {
    var nomeCampo_userid = "userid";
    var var_userid = scAjaxGetFieldHidden(nomeCampo_userid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_telefono_registro_validate_userid(var_userid, var_script_case_init, do_ajax_control_telefono_registro_validate_userid_cb);
  } // do_ajax_control_telefono_registro_validate_userid

  function do_ajax_control_telefono_registro_validate_userid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "userid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_telefono_registro_validate_userid_cb

  // ---------- Refresh codpais
  function do_ajax_control_telefono_registro_refresh_codpais()
  {
    var var_codpais = scAjaxGetFieldSelect("codpais");
    var var_nmgp_refresh_fields = "codpais2";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_control_telefono_registro_refresh_codpais(var_codpais, var_nmgp_refresh_fields, var_script_case_init, do_ajax_control_telefono_registro_refresh_codpais_cb);
  } // do_ajax_control_telefono_registro_refresh_codpais

  function do_ajax_control_telefono_registro_refresh_codpais_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_telefono_registro_refresh_codpais_cb

  // ---------- Event onchange celular
  function do_ajax_control_telefono_registro_event_celular_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_control_telefono_registro_event_celular_onchange(var_celular, var_userid, var_codpais2, var_codpais, var_nombre, var_script_case_init, do_ajax_control_telefono_registro_event_celular_onchange_cb);
  } // do_ajax_control_telefono_registro_event_celular_onchange

  function do_ajax_control_telefono_registro_event_celular_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "celular";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_telefono_registro_event_celular_onchange_cb_after_alert);
  } // do_ajax_control_telefono_registro_event_celular_onchange_cb
  function do_ajax_control_telefono_registro_event_celular_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_telefono_registro_event_celular_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_telefono_registro_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_telefono_registro_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_codpais = scAjaxGetFieldSelect("codpais");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_control_telefono_registro_submit_form(var_codpais, var_codpais2, var_celular, var_userid, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_control_telefono_registro_submit_form_cb);
  } // do_ajax_control_telefono_registro_submit_form

  function do_ajax_control_telefono_registro_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_telefono_registro_submit_form_cb_after_alert);
  } // do_ajax_control_telefono_registro_submit_form_cb
  function do_ajax_control_telefono_registro_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_telefono_registro_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_telefono_registro_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_control_telefono_registro_navigate_form, function() {});
    } else {
      perform_ajax_control_telefono_registro_navigate_form();
    }
  }

  function perform_ajax_control_telefono_registro_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_telefono_registro_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_telefono_registro']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_telefono_registro_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_telefono_registro_navigate_form_cb_after_alert);
  } // do_ajax_control_telefono_registro_navigate_form_cb
  function do_ajax_control_telefono_registro_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_control_telefono_registro_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_telefono_registro_navigate_form_cb_after_alert

  function sc_hide_control_telefono_registro_form()
  {
