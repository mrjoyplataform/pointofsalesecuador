<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['grid_menu']['glo_nm_perfil']          = "conn_info";
...
class grid_menu_ini
{
   ...
   var $Gd_missing;
   var $sc_site_ssl;
   var $link_grid_submenu_cons_emb;
   var $nm_cont_lin;
   var $nm_limite_lin;
...
// 
    ...
    if (!$_SESSION['sc_session'][$this->sc_page]['grid_menu']['embutida'])
    {
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_menu']['grid_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['grid_menu']['grid_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['grid_menu']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
      if (isset($_GET['nmgp_opcao']) && $_GET['nmgp_opcao'] == "ajax_aut_comp_dyn_search")
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_menu']['dyn_search_aut_comp']['cmp'] = $_GET['field'];
          $_SESSION['sc_session'][$this->sc_page]['grid_menu']['opcao'] = $_GET['origem'];
...
<?php
      ...
      $Tmp_apl_lig = "grid_submenu";
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/grid_submenu_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/grid_submenu_ini.txt");
          if (isset($Friendly[0]) && !empty($Friendly[0]))
          {
              $Tmp_apl_lig = trim($Friendly[0]);
          }
      }
      if (is_file($this->root . $this->path_link . $Tmp_apl_lig . "/grid_submenu_ini.txt"))
      {
          $L_md5 = file($this->root . $this->path_link . $Tmp_apl_lig . "/grid_submenu_ini.txt");
          if (isset($L_md5[6]) && trim($L_md5[6]) == "LigMd5")
          {
              $this->sc_lig_md5["grid_submenu"] = 'S';
          }
      }
      $this->sc_lig_target["C_@scinf_submenu"] = '';
      $this->sc_lig_target["C_@scinf_submenu_@scinf_grid_submenu"] = '';
      if ($_SESSION['sc_session'][$this->sc_page]['grid_menu']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_menu']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_menu']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_menu']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_menu']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_menu']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_menu']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_menu']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_menu']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_menu']['link_info']['remove_border'] = true;
        }

      $this->link_grid_submenu_cons_emb =  $this->root . $this->path_link  . "" . SC_dir_app_name('grid_submenu') . "/index.php" ; 
      if ($Tp_init == "Path_sub")
      {
          return;
      }
...
// 
      ...
      $_SESSION['sc_session'][$script_case_init]['grid_submenu']['ind_tree'] = 0;
      if (!isset($_SESSION['sc_session'][$script_case_init]['grid_menu']['emb_linha']))
      {
          $_SESSION['sc_session'][$script_case_init]['grid_menu']['emb_linha'] = 0;
      }
   }
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_menu']['glo_nm_conexao'], $this->root . $this->path_prod, 'pointofsales', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
class grid_menu_sub_css
{
   function __construct()
   {
      ...
      $_SESSION['sc_session'][$script_case_init]['grid_submenu']['SC_herda_css'] = "S"; 
      $_SESSION['sc_session'][$script_case_init]['grid_submenu']['embutida'] = true;
      include_once ($this->Ini->link_grid_submenu_cons_emb);
      $this->grid_submenu = new grid_submenu_sub_css ;
      $_SESSION['sc_session'][$script_case_init]['grid_submenu']['embutida'] = false;
   ...
   function controle($linhas = 0)
   {
      ...
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['sc_modal']))
      {
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_menu']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_menu']['label'] = "" . $this->Ini->Nm_lang['lang_othr_grid_title'] . " menu";
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['field_order'][] = "opcion";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['field_order'][] = "mm";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['field_order'][] = "opc";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['field_order'][] = "rg";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['field_order'][] = "accion";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['field_order'][] = "users";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['usr_cmp_sel']['mm'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['usr_cmp_sel']['opc'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['usr_cmp_sel']['rg'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['usr_cmp_sel']['accion'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['usr_cmp_sel']['users'] = "off";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['opc_liga']['inicial']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['opc_liga']['inicial'];
          }
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['opcao'] == "grid_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['opcao'] == "grid_search_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['opcao'] == "grid_search")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['opcao'] == "grid_search_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['orig_pesq'] = 'res';
          } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['opcao'] == "grid_search_change_fil" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['opcao'] == "grid_search_change_fil_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['opcao'] == "grid_search_change_fil")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['opcao'] == "grid_search_change_fil_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['orig_pesq'] = 'res';
          } 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
...
//
      ...
      { 
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['where_pesq_lookup'] = "";
...
<?php
  ...
  function close_emb()
  {
   ...
   function SC_proc_grid_search($Parms)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['tmp_busca'] = array();
       foreach ($tmp as $cada_f)
       {
           $dats = explode("_DYN_", $cada_f);
           if ($dats[1] == "del_grid_search_all")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['grid_pesq'] as $ind => $dados)
               {
                   $this->proc_del_grid_search($ind, true);
               }
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['grid_pesq']);
               continue;
           }
           ...
           {
               $busca[$dats[0]] = $dats[1];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['tmp_busca'][$dats[0]] = (isset($fields[$ix]['vls'][0])) ? $fields[$ix]['vls'][0][0] : "";
               if (isset($fields[$ix]['vls'][1]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['tmp_busca'][$dats[0] . '_input_2'] = $fields[$ix]['vls'][1][0];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['tmp_busca'][$dats[0] . '_cond'] = $dats[1];
           }
           $ix++;
      }
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['tmp_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['tmp_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['tmp_busca'] as $ind => $dados)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['campos_busca'][$ind] = $dados;
      }
      if (!$_SESSION['scriptcase']['proc_mobile']) 
      { 
          require_once($this->Ini->path_aplicacao . "grid_menu_pesq.class.php"); 
   ...
   {
      if (is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['campos_busca'][$cmp_del]))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['campos_busca'][$cmp_del] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['campos_busca'][$cmp_del . "_input_2"] = array();
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['campos_busca'][$cmp_del] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['campos_busca'][$cmp_del . "_input_2"] = "";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['campos_busca'][$cmp_del . "_cond"] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_menu']['grid_pesq'][$cmp_del]);
   }
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_pointofsales.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_pointofsales.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_pointofsales'])) {
               $_SESSION['scriptcase']['grid_menu']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_pointofsales'];
           }
       }
   }
...
// 
       ...
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_menu']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['grid_menu']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
