...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_menu"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_menu"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_menu']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_menu']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_menu']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_menu']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_menu']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_menu']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_menu']['embutida_filho'] as $ind => $sc_init)
          {
