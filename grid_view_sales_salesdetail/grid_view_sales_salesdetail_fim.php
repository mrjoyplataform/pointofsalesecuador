...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_view_sales_salesdetail"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_view_sales_salesdetail"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_view_sales_salesdetail']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_view_sales_salesdetail']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_view_sales_salesdetail']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_view_sales_salesdetail']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_view_sales_salesdetail']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_view_sales_salesdetail</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_view_sales_salesdetail']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_view_sales_salesdetail']['embutida_filho'] as $ind => $sc_init)
          {
