<?php
@session_start() ;
$_SESSION['scriptcase']['grid_view_sales_salesdetail']['sc_process_barr'] = true;
require_once('../grid_view_sales_salesdetail/index.php');
unset($_SESSION['scriptcase']['grid_view_sales_salesdetail']['sc_process_barr']);
$ExportCtrl = new grid_view_sales_salesdetail_export_control;
$ExportCtrl->Export_barr();

class grid_view_sales_salesdetail_export_control
{
