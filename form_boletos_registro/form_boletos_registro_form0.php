...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_boletos_registro/form_boletos_registro_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_boletos_registro_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_boletos_registro_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['link_info']['remove_border']) {
...
<?php
 include_once("form_boletos_registro_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_boletos_registro'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_boletos_registro'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['Lookup_genero'][] = 'F'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['Lookup_genero'][] = 'M'; ?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['btn_label']['exit'];
        }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_boletos_registro");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_boletos_registro");
 parent.scAjaxDetailHeight("form_boletos_registro", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
