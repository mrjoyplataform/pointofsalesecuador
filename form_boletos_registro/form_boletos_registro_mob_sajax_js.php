  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_boletos_registro_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_boletos_registro_mob_form();
	}
...
?>
  ...
  // ---------- Validate nombre
  function do_ajax_form_boletos_registro_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_boletos_registro_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_boletos_registro_mob_validate_nombre_cb);
  } // do_ajax_form_boletos_registro_mob_validate_nombre

  function do_ajax_form_boletos_registro_mob_validate_nombre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_boletos_registro_mob_validate_nombre_cb

  // ---------- Validate fecha_nacimiento
  function do_ajax_form_boletos_registro_mob_validate_fecha_nacimiento()
  {
    var nomeCampo_fecha_nacimiento = "fecha_nacimiento";
    var nomeCampo_fecha_nacimiento_dia = "fecha_nacimiento_dia";
    var nomeCampo_fecha_nacimiento_mes = "fecha_nacimiento_mes";
    var nomeCampo_fecha_nacimiento_ano = "fecha_nacimiento_ano";
    var var_fecha_nacimiento = scAjaxGetFieldText(nomeCampo_fecha_nacimiento);
    var var_fecha_nacimiento_dia = scAjaxGetFieldText(nomeCampo_fecha_nacimiento_dia);
    var var_fecha_nacimiento_mes = scAjaxGetFieldText(nomeCampo_fecha_nacimiento_mes);
    var var_fecha_nacimiento_ano = scAjaxGetFieldText(nomeCampo_fecha_nacimiento_ano);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_boletos_registro_mob_validate_fecha_nacimiento(var_fecha_nacimiento, var_fecha_nacimiento_dia, var_fecha_nacimiento_mes, var_fecha_nacimiento_ano, var_script_case_init, do_ajax_form_boletos_registro_mob_validate_fecha_nacimiento_cb);
  } // do_ajax_form_boletos_registro_mob_validate_fecha_nacimiento

  function do_ajax_form_boletos_registro_mob_validate_fecha_nacimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_boletos_registro_mob_validate_fecha_nacimiento_cb

  // ---------- Validate genero
  function do_ajax_form_boletos_registro_mob_validate_genero()
  {
    var nomeCampo_genero = "genero";
    var var_genero = scAjaxGetFieldRadio(nomeCampo_genero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_boletos_registro_mob_validate_genero(var_genero, var_script_case_init, do_ajax_form_boletos_registro_mob_validate_genero_cb);
  } // do_ajax_form_boletos_registro_mob_validate_genero

  function do_ajax_form_boletos_registro_mob_validate_genero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "genero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_boletos_registro_mob_validate_genero_cb

  // ---------- Validate username
  function do_ajax_form_boletos_registro_mob_validate_username()
  {
    var nomeCampo_username = "username";
    var var_username = scAjaxGetFieldHidden(nomeCampo_username);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_boletos_registro_mob_validate_username(var_username, var_script_case_init, do_ajax_form_boletos_registro_mob_validate_username_cb);
  } // do_ajax_form_boletos_registro_mob_validate_username

  function do_ajax_form_boletos_registro_mob_validate_username_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_boletos_registro_mob_validate_username_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_boletos_registro_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_boletos_registro_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nombre = scAjaxGetFieldText("nombre");
    var var_fecha_nacimiento_mes = scAjaxGetFieldSelect("fecha_nacimiento_mes");
    var var_fecha_nacimiento_dia = scAjaxGetFieldSelect("fecha_nacimiento_dia");
    var var_fecha_nacimiento_ano = scAjaxGetFieldSelect("fecha_nacimiento_ano");
    var var_genero = scAjaxGetFieldRadio("genero");
    var var_username = scAjaxGetFieldHidden("username");
    var var_qrboleto = scAjaxGetFieldText("qrboleto");
    var var_codrfid = scAjaxGetFieldText("codrfid");
    ...
    scAjaxProcOn();
    x_ajax_form_boletos_registro_mob_submit_form(var_nombre, var_fecha_nacimiento_mes, var_fecha_nacimiento_dia, var_fecha_nacimiento_ano, var_genero, var_username, var_qrboleto, var_codrfid, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_boletos_registro_mob_submit_form_cb);
  } // do_ajax_form_boletos_registro_mob_submit_form

  function do_ajax_form_boletos_registro_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("username");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_boletos_registro_mob_submit_form_cb_after_alert);
  } // do_ajax_form_boletos_registro_mob_submit_form_cb
  function do_ajax_form_boletos_registro_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_boletos_registro_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_boletos_registro_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_boletos_registro_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_boletos_registro_mob_navigate_form();
    }
  }

  function perform_ajax_form_boletos_registro_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("genero");
    scAjaxHideErrorDisplay("username");
    var var_qrboleto = document.F2.qrboleto.value;
    var var_codrfid = document.F2.codrfid.value;
    ...
    scAjaxProcOn();
    x_ajax_form_boletos_registro_mob_navigate_form(var_qrboleto, var_codrfid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_boletos_registro_mob_navigate_form_cb);
  } // do_ajax_form_boletos_registro_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_boletos_registro_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.qrboleto.value = scAjaxGetKeyValue("qrboleto");
    document.F2.codrfid.value = scAjaxGetKeyValue("codrfid");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_boletos_registro_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_boletos_registro_mob_navigate_form_cb
  function do_ajax_form_boletos_registro_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_boletos_registro_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_boletos_registro_mob_navigate_form_cb_after_alert

  function sc_hide_form_boletos_registro_mob_form()
  {
  ...
  ajax_field_list[1] = "fecha_nacimiento";
  ajax_field_list[2] = "genero";
  ajax_field_list[3] = "username";
  ...
  var ajax_error_list = {
    ...
    "username": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
