  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_boletos_registro" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_boletos_registro_form();
	}
...
?>
  ...
  // ---------- Validate nombre
  function do_ajax_form_boletos_registro_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_boletos_registro_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_boletos_registro_validate_nombre_cb);
  } // do_ajax_form_boletos_registro_validate_nombre

  function do_ajax_form_boletos_registro_validate_nombre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_boletos_registro_validate_nombre_cb

  // ---------- Validate fecha_nacimiento
  function do_ajax_form_boletos_registro_validate_fecha_nacimiento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_boletos_registro_validate_fecha_nacimiento(var_fecha_nacimiento, var_fecha_nacimiento_dia, var_fecha_nacimiento_mes, var_fecha_nacimiento_ano, var_script_case_init, do_ajax_form_boletos_registro_validate_fecha_nacimiento_cb);
  } // do_ajax_form_boletos_registro_validate_fecha_nacimiento

  function do_ajax_form_boletos_registro_validate_fecha_nacimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_boletos_registro_validate_fecha_nacimiento_cb

  // ---------- Validate genero
  function do_ajax_form_boletos_registro_validate_genero()
  {
    var nomeCampo_genero = "genero";
    var var_genero = scAjaxGetFieldRadio(nomeCampo_genero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_boletos_registro_validate_genero(var_genero, var_script_case_init, do_ajax_form_boletos_registro_validate_genero_cb);
  } // do_ajax_form_boletos_registro_validate_genero

  function do_ajax_form_boletos_registro_validate_genero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "genero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_boletos_registro_validate_genero_cb

  // ---------- Validate username
  function do_ajax_form_boletos_registro_validate_username()
  {
    var nomeCampo_username = "username";
    var var_username = scAjaxGetFieldHidden(nomeCampo_username);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_boletos_registro_validate_username(var_username, var_script_case_init, do_ajax_form_boletos_registro_validate_username_cb);
  } // do_ajax_form_boletos_registro_validate_username

  function do_ajax_form_boletos_registro_validate_username_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_boletos_registro_validate_username_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_boletos_registro_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_boletos_registro_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_boletos_registro_submit_form(var_nombre, var_fecha_nacimiento_mes, var_fecha_nacimiento_dia, var_fecha_nacimiento_ano, var_genero, var_username, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_boletos_registro_submit_form_cb);
  } // do_ajax_form_boletos_registro_submit_form

  function do_ajax_form_boletos_registro_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_boletos_registro_submit_form_cb_after_alert);
  } // do_ajax_form_boletos_registro_submit_form_cb
  function do_ajax_form_boletos_registro_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_boletos_registro_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_boletos_registro_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_boletos_registro_navigate_form, function() {});
    } else {
      perform_ajax_form_boletos_registro_navigate_form();
    }
  }

  function perform_ajax_form_boletos_registro_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_boletos_registro_navigate_form(var_qrboleto, var_codrfid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_boletos_registro_navigate_form_cb);
  } // do_ajax_form_boletos_registro_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_boletos_registro']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_boletos_registro_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_boletos_registro_navigate_form_cb_after_alert);
  } // do_ajax_form_boletos_registro_navigate_form_cb
  function do_ajax_form_boletos_registro_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_boletos_registro_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_boletos_registro_navigate_form_cb_after_alert

  function sc_hide_form_boletos_registro_form()
  {
