...
?>
  ...
  // ---------- Validate idcustomer
  function do_ajax_form_customer_validate_idcustomer()
  {
    var nomeCampo_idcustomer = "idcustomer";
    var var_idcustomer = scAjaxGetFieldText(nomeCampo_idcustomer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_validate_idcustomer(var_idcustomer, var_script_case_init, do_ajax_form_customer_validate_idcustomer_cb);
  } // do_ajax_form_customer_validate_idcustomer

  function do_ajax_form_customer_validate_idcustomer_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_validate_idcustomer_cb

  // ---------- Validate nombre
  function do_ajax_form_customer_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_customer_validate_nombre_cb);
  } // do_ajax_form_customer_validate_nombre

  function do_ajax_form_customer_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_validate_nombre_cb

  // ---------- Validate correo
  function do_ajax_form_customer_validate_correo()
  {
    var nomeCampo_correo = "correo";
    var var_correo = scAjaxGetFieldText(nomeCampo_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_validate_correo(var_correo, var_script_case_init, do_ajax_form_customer_validate_correo_cb);
  } // do_ajax_form_customer_validate_correo

  function do_ajax_form_customer_validate_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "correo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_validate_correo_cb

  // ---------- Validate celular
  function do_ajax_form_customer_validate_celular()
  {
    var nomeCampo_celular = "celular";
    var var_celular = scAjaxGetFieldText(nomeCampo_celular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_validate_celular(var_celular, var_script_case_init, do_ajax_form_customer_validate_celular_cb);
  } // do_ajax_form_customer_validate_celular

  function do_ajax_form_customer_validate_celular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "celular";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_validate_celular_cb

  // ---------- Validate idinterno
  function do_ajax_form_customer_validate_idinterno()
  {
    var nomeCampo_idinterno = "idinterno";
    var var_idinterno = scAjaxGetFieldText(nomeCampo_idinterno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_validate_idinterno(var_idinterno, var_script_case_init, do_ajax_form_customer_validate_idinterno_cb);
  } // do_ajax_form_customer_validate_idinterno

  function do_ajax_form_customer_validate_idinterno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_validate_idinterno_cb

  // ---------- Validate direccion
  function do_ajax_form_customer_validate_direccion()
  {
    var nomeCampo_direccion = "direccion";
    var var_direccion = scAjaxGetFieldText(nomeCampo_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_validate_direccion(var_direccion, var_script_case_init, do_ajax_form_customer_validate_direccion_cb);
  } // do_ajax_form_customer_validate_direccion

  function do_ajax_form_customer_validate_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_validate_direccion_cb

  // ---------- Validate tipodoc
  function do_ajax_form_customer_validate_tipodoc()
  {
    var nomeCampo_tipodoc = "tipodoc";
    var var_tipodoc = scAjaxGetFieldText(nomeCampo_tipodoc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_customer_validate_tipodoc(var_tipodoc, var_script_case_init, do_ajax_form_customer_validate_tipodoc_cb);
  } // do_ajax_form_customer_validate_tipodoc

  function do_ajax_form_customer_validate_tipodoc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipodoc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_customer_validate_tipodoc_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_customer_submit_form()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_customer_submit_form(var_idcustomer, var_nombre, var_correo, var_celular, var_idinterno, var_direccion, var_tipodoc, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_customer_submit_form_cb);
...
?>
  ...
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_customer_navigate_form, function() {});
    } else {
  ...
  function perform_ajax_form_customer_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_customer_navigate_form(var_idcustomer, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_customer_navigate_form_cb);
