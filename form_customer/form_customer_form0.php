...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " customer"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " customer"); } ?></TITLE>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer']['fast_search'][2] : "";
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idcustomer_label" id="hidden_field_label_idcustomer" style="<?php echo $sStyleHidden_idcustomer; ?>"><span id="id_label_idcustomer"><?php echo $this->nm_new_label['idcustomer']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_customer']['php_cmp_required']['idcustomer']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_customer']['php_cmp_required']['idcustomer'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
