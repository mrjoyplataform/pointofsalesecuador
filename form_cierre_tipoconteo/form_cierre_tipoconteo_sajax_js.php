  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cierre_tipoconteo" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cierre_tipoconteo_form();
	}
...
?>
  ...
  // ---------- Validate idtipo_
  function do_ajax_form_cierre_tipoconteo_validate_idtipo_(iNumLinha)
  {
    var nomeCampo_idtipo_ = "idtipo_" + iNumLinha;
    var var_idtipo_ = scAjaxGetFieldHidden(nomeCampo_idtipo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_tipoconteo_validate_idtipo_(var_idtipo_, iNumLinha, var_script_case_init, do_ajax_form_cierre_tipoconteo_validate_idtipo__cb);
  } // do_ajax_form_cierre_tipoconteo_validate_idtipo_

  function do_ajax_form_cierre_tipoconteo_validate_idtipo__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idtipo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idtipo_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idtipo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idtipo_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_tipoconteo_validate_idtipo__cb

  // ---------- Validate descrip_
  function do_ajax_form_cierre_tipoconteo_validate_descrip_(iNumLinha)
  {
    var nomeCampo_descrip_ = "descrip_" + iNumLinha;
    var var_descrip_ = scAjaxGetFieldText(nomeCampo_descrip_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_tipoconteo_validate_descrip_(var_descrip_, iNumLinha, var_script_case_init, do_ajax_form_cierre_tipoconteo_validate_descrip__cb);
  } // do_ajax_form_cierre_tipoconteo_validate_descrip_

  function do_ajax_form_cierre_tipoconteo_validate_descrip__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_tipoconteo_validate_descrip__cb

  // ---------- Validate valor_
  function do_ajax_form_cierre_tipoconteo_validate_valor_(iNumLinha)
  {
    var nomeCampo_valor_ = "valor_" + iNumLinha;
    var var_valor_ = scAjaxGetFieldText(nomeCampo_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_tipoconteo_validate_valor_(var_valor_, iNumLinha, var_script_case_init, do_ajax_form_cierre_tipoconteo_validate_valor__cb);
  } // do_ajax_form_cierre_tipoconteo_validate_valor_

  function do_ajax_form_cierre_tipoconteo_validate_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cierre_tipoconteo_validate_valor__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_cierre_tipoconteo_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_cierre_tipoconteo_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cierre_tipoconteo_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_cierre_tipoconteo_add_new_line_cb);
  } // do_ajax_form_cierre_tipoconteo_add_new_line

  function do_ajax_form_cierre_tipoconteo_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_cierre_tipoconteo_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_cierre_tipoconteo_backup_line(iNumLinha)
  {
    var var_idtipo_ = scAjaxGetFieldHidden("idtipo_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cierre_tipoconteo_backup_line(var_idtipo_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_cierre_tipoconteo_backup_line_cb);
  } // do_ajax_form_cierre_tipoconteo_backup_line

  function do_ajax_form_cierre_tipoconteo_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_cierre_tipoconteo_backup_line_cb

  function do_ajax_form_cierre_tipoconteo_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_cierre_tipoconteo_cancel_insert

  function do_ajax_form_cierre_tipoconteo_cancel_update(iSeqVert)
  {
    do_ajax_form_cierre_tipoconteo_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_cierre_tipoconteo_cancel_update

  function do_ajax_form_cierre_tipoconteo_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_cierre_tipoconteo_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_cierre_tipoconteo_table_refresh()
  {
    var var_idtipo_ = document.F2.idtipo_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_cierre_tipoconteo_table_refresh(var_idtipo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cierre_tipoconteo_table_refresh_cb);
  } //  do_ajax_form_cierre_tipoconteo_table_refresh

  function do_ajax_form_cierre_tipoconteo_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idtipo_.value = scAjaxGetKeyValue("idtipo_");
    ...
    scAjaxAlert(do_ajax_form_cierre_tipoconteo_table_refresh_cb_after_alert);
  } // do_ajax_form_cierre_tipoconteo_table_refresh_cb
  function do_ajax_form_cierre_tipoconteo_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_cierre_tipoconteo_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_cierre_tipoconteo_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_cierre_tipoconteo_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_cierre_tipoconteo_submit_form(var_idtipo_, var_descrip_, var_valor_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_cierre_tipoconteo_submit_form_cb);
  } // do_ajax_form_cierre_tipoconteo_submit_form

  function do_ajax_form_cierre_tipoconteo_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idtipo_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cierre_tipoconteo_submit_form_cb_after_alert);
  } // do_ajax_form_cierre_tipoconteo_submit_form_cb
  function do_ajax_form_cierre_tipoconteo_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cierre_tipoconteo_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cierre_tipoconteo_navigate_form()
  {
    perform_ajax_form_cierre_tipoconteo_navigate_form();
  }

  function perform_ajax_form_cierre_tipoconteo_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_cierre_tipoconteo_cancel_insert(sc_form_cierre_tipoconteo_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idtipo_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cierre_tipoconteo_navigate_form(var_idtipo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cierre_tipoconteo_navigate_form_cb);
  } // do_ajax_form_cierre_tipoconteo_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cierre_tipoconteo']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cierre_tipoconteo_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idtipo_.value = scAjaxGetKeyValue("idtipo_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cierre_tipoconteo_navigate_form_cb_after_alert);
  } // do_ajax_form_cierre_tipoconteo_navigate_form_cb
  function do_ajax_form_cierre_tipoconteo_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_cierre_tipoconteo_navigate_form_cb_after_alert

    function sc_form_cierre_tipoconteo_get_last_line_number()
    {
    ...
    } //sc_form_cierre_tipoconteo_get_last_line_number

  function sc_hide_form_cierre_tipoconteo_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idtipo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "descrip_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "valor_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idtipo_" + iNumLinha] = {"label": "Idtipo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["idtipo_"][iNumLinha] = "idtipo_" + iNumLinha;
    ajax_field_mult["descrip_"][iNumLinha] = "descrip_" + iNumLinha;
    ajax_field_mult["valor_"][iNumLinha] = "valor_" + iNumLinha;
    ajax_field_id["idtipo_" + iNumLinha] = new Array("hidden_field_label_idtipo_", "hidden_field_data_idtipo_" + iNumLinha);
    ...
    ajax_error_count["idtipo_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["idtipo_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["idtipo_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idtipo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idtipo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idtipo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idtipo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idtipo_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idtipo_'])) ? $this->nmgp_cmp_readonly['idtipo_'] : 'on';
?>
    scAjaxFieldRead("idtipo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("idtipo_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idtipo_" + iRow] || "on" == ajax_error_count["descrip_" + iRow] || "on" == ajax_error_count["valor_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idtipo_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idtipo_" + iRow] && "off" == ajax_error_count["descrip_" + iRow] && "off" == ajax_error_count["valor_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idtipo_" + iRow] = "off";
      ...
      $("#hidden_field_data_idtipo_" + iRow).removeClass("scFormErrorLine");
