...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idtipo_' + iSeqRow).bind('blur', function() { sc_form_cierre_tipoconteo_idtipo__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_cierre_tipoconteo_idtipo__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_cierre_tipoconteo_idtipo__onfocus(this, iSeqRow) });
  $('#id_sc_field_descrip_' + iSeqRow).bind('blur', function() { sc_form_cierre_tipoconteo_descrip__onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_cierre_tipoconteo_descrip__onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_cierre_tipoconteo_descrip__onfocus(this, iSeqRow) });
  $('#id_sc_field_valor_' + iSeqRow).bind('blur', function() { sc_form_cierre_tipoconteo_valor__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_cierre_tipoconteo_valor__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_cierre_tipoconteo_valor__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_cierre_tipoconteo_idtipo__onblur(oThis, iSeqRow) {
  do_ajax_form_cierre_tipoconteo_validate_idtipo_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_cierre_tipoconteo_idtipo__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_cierre_tipoconteo_idtipo__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_cierre_tipoconteo_descrip__onblur(oThis, iSeqRow) {
  do_ajax_form_cierre_tipoconteo_validate_descrip_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_cierre_tipoconteo_descrip__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_cierre_tipoconteo_descrip__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_cierre_tipoconteo_valor__onblur(oThis, iSeqRow) {
  do_ajax_form_cierre_tipoconteo_validate_valor_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_cierre_tipoconteo_valor__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_cierre_tipoconteo_valor__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function displayChange_block_0(status) {
	displayChange_field("idtipo_", "", status);
...
function scHidePage(pageNo) {
	$("#id_form_cierre_tipoconteo_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_cierre_tipoconteo')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
