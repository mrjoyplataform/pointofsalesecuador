<?php
   include_once('blank_pago_factura_ceibos_session.php');
   @ini_set('session.cookie_httponly', 0);
   @ini_set('session.use_only_cookies', 0);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_perfil']          = "conn_pos";
   $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class blank_pago_factura_ceibos_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "blank_pago_factura_ceibos"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20211110"; 
      $this->nm_hr_criacao   = "221332"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['blank_pago_factura_ceibos']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['blank_pago_factura_ceibos']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['blank_pago_factura_ceibos']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/blank_pago_factura_ceibos';
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['blank_pago_factura_ceibos']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['blank_pago_factura_ceibos']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['blank_pago_factura_ceibos']['actual_lang']) || $_SESSION['scriptcase']['blank_pago_factura_ceibos']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['blank_pago_factura_ceibos']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("blank_pago_factura_ceibos_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blank_pago_factura_ceibos"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blank_pago_factura_ceibos"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['link_info']['remove_border'] = true;
        }
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['blank_pago_factura_ceibos']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['blank_pago_factura_ceibos']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['blank_pago_factura_ceibos']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['blank_pago_factura_ceibos']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "blank_pago_factura_ceibos_erro.class.php"); 
      $this->Erro = new blank_pago_factura_ceibos_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('blank_pago_factura_ceibos'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['blank_pago_factura_ceibos']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['blank_pago_factura_ceibos']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['blank_pago_factura_ceibos']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['blank_pago_factura_ceibos']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['blank_pago_factura_ceibos']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['blank_pago_factura_ceibos']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_conexao']) && $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_perfil']) && $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['embutida_init']) 
      {
          ...
          if (!isset($_SESSION['filefactura'])) 
          {
              $this->nm_falta_var .= "filefactura; ";
          }
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_conexao'], $this->root . $this->path_prod, 'pointofsales', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blank_pago_factura_ceibos']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class blank_pago_factura_ceibos_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new blank_pago_factura_ceibos_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['blank_pago_factura_ceibos']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['blank_pago_factura_ceibos']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['blank_pago_factura_ceibos']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['blank_pago_factura_ceibos'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_pago_factura_ceibos']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_pago_factura_ceibos']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('blank_pago_factura_ceibos') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_pago_factura_ceibos']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "blank_pago_factura_ceibos")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['blank_pago_factura_ceibos']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['blank_pago_factura_ceibos']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['blank_pago_factura_ceibos']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "blank_pago_factura_ceibos_erro.class.php"); 
      $this->Erro      = new blank_pago_factura_ceibos_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      header("Referrer-Policy: unsafe-url");
      $_SESSION['scriptcase']['blank_pago_factura_ceibos']['contr_erro'] = 'on';
if (!isset($_SESSION['filefactura'])) {$_SESSION['filefactura'] = "";}
if (!isset($this->sc_temp_filefactura)) {$this->sc_temp_filefactura = (isset($_SESSION['filefactura'])) ? $_SESSION['filefactura'] : "";}
if (!isset($_SESSION['facturanum'])) {$_SESSION['facturanum'] = "";}
if (!isset($this->sc_temp_facturanum)) {$this->sc_temp_facturanum = (isset($_SESSION['facturanum'])) ? $_SESSION['facturanum'] : "";}
if (!isset($_SESSION['rutapdf'])) {$_SESSION['rutapdf'] = "";}
if (!isset($this->sc_temp_rutapdf)) {$this->sc_temp_rutapdf = (isset($_SESSION['rutapdf'])) ? $_SESSION['rutapdf'] : "";}
if (!isset($_SESSION['clavesri'])) {$_SESSION['clavesri'] = "";}
...
$sql="select  texto from  params  where idparams='factura_urlext'";
...
$sql="select  texto from  params  where idparams='factura_filepath'";
...
if (isset($this->rs[0][0]))     
{
	...
	$filepath = $this->rs[0][0];

}


$sql="select  texto from  params  where idparams='factura_get'";
...
if (isset($this->rs[0][0]))     
{
    $factura_get = $this->rs[0][0];

}



$sql="select  concat(texto,year(now()),'/',lpad(month(now()),2,'0'),'/') from  params  where idparams='factura_pdf'";
...
$sql="select  concat(texto,year(now()),'/',lpad(month(now()),2,'0'),'/') from  params  where idparams='factura_xml'";
...
$sql="update transcombos set estado=1 where uniqueid='$this->sc_temp_uid'";
...
$sql="select id_product,codproducto,producto,valor_unitario,valor_siniva,quantity,unit_value,item_total,jugador,visitante from sales_detail where id_sales=$idsale";
...
foreach ($this->dataset  as $d) {
	...
	$impuesto = $xml->createElement('impuesto');
	$impuesto = $impuestos->appendChild($impuesto);
	$cbc = $xml->createElement('codigo', '002');
	$cbc = $impuesto->appendChild($cbc);
	$cbc = $xml->createElement('codigoPorcentaje', '002');
	$cbc = $impuesto->appendChild($cbc);
	$cbc = $xml->createElement('tarifa', '002');
	$cbc = $impuesto->appendChild($cbc);
	$cbc = $xml->createElement('baseImponible', '002');
	$cbc = $impuesto->appendChild($cbc);
	$cbc = $xml->createElement('valor', '002');
	$cbc = $impuesto->appendChild($cbc); 
...
$remotefile=$urlext.$claveAcceso.'.pdf';


$remotefilepdf=$factura_pdf.$claveAcceso.'.pdf';

$remotefilexml=$factura_xml.$claveAcceso.'.xml';





$sql="update sales set clave_acceso='$claveAcceso',serie='$facturaserie', facturaxml='$remotefilexml',facturaxml64='',imprime=1,comprobante='$remotefile' where uniqueid='$this->sc_temp_uid'";
...
$this->sc_temp_rutapdf=$remotefilepdf;



$this->sc_temp_facturanum=$facturaserie;
...
$this->sc_temp_filefactura=$remotefilepdf;


$cmd='sudo chmod 777 -R '.$factura_pdf."<br>";
echo exec($cmd);


$cmd='sudo cp '.$remotefilepdf." /data/php7.3/wwwroot/mrjoy/facturas/";
echo exec($cmd);


$cmd="sudo chmod 777 -R  /data/php7.3/wwwroot/mrjoy/facturas/";
echo exec($cmd);
...
$cmd="sudo chmod 777 -R /home/factura/app/quijotelui_seopi/comprobante";

echo exec($cmd);



$sql="update sales set clave_acceso='$claveAcceso',serie='$facturaserie', facturaxml='$remotefilexml',facturapdf='$pdf_file',imprime=1,comprobante='$remotefile' where uniqueid='$this->sc_temp_uid'";
...
#echo exec($cmd);
 ...
 if (isset($this->sc_temp_rutapdf)) {$_SESSION['rutapdf'] = $this->sc_temp_rutapdf;}
 if (isset($this->sc_temp_facturanum)) {$_SESSION['facturanum'] = $this->sc_temp_facturanum;}
 if (isset($this->sc_temp_filefactura)) {$_SESSION['filefactura'] = $this->sc_temp_filefactura;}
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('dashboard_comprobante_pdf') . "/", $this->nm_location, "ncomp?#?" . NM_encode_input("0") . "?@?" . "clavesri?#?" . NM_encode_input($claveAcceso) . "?@?","_parent", 440, 630, "ret_self");
 };
if (isset($this->sc_temp_idcaja)) {$_SESSION['idcaja'] = $this->sc_temp_idcaja;}
if (isset($this->sc_temp_uid)) {$_SESSION['uid'] = $this->sc_temp_uid;}
if (isset($this->sc_temp_ncomp)) {$_SESSION['ncomp'] = $this->sc_temp_ncomp;}
...
if (isset($this->sc_temp_facturanum)) {$_SESSION['facturanum'] = $this->sc_temp_facturanum;}
if (isset($this->sc_temp_filefactura)) {$_SESSION['filefactura'] = $this->sc_temp_filefactura;}
$_SESSION['scriptcase']['blank_pago_factura_ceibos']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
   ...
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0, $opc="")
   {
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['blank_pago_factura_ceibos'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['blank_pago_factura_ceibos']['iframe_print']) && $_SESSION['sc_session'][$this->Ini->sc_page]['blank_pago_factura_ceibos']['iframe_print'] )
      {
          $target = "_parent";
      }
   ?>
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_blank_pago_factura_ceibos($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_imag_temp'] . "/sc_apl_default_pointofsales.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['blank_pago_factura_ceibos']['glo_nm_path_imag_temp'] . "/sc_apl_default_pointofsales.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "blank_pago_factura_ceibos") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['blank_pago_factura_ceibos']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['blank_pago_factura_ceibos']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['blank_pago_factura_ceibos']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_pointofsales'])) {
               $_SESSION['scriptcase']['blank_pago_factura_ceibos']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_pointofsales'];
           }
       }
   }
   ...
   if (isset($_POST["idcaja"])) 
   {
       ...
       nm_limpa_str_blank_pago_factura_ceibos($_SESSION["idcaja"]);
   }
   ...
   if (isset($_POST["uid"])) 
   {
       ...
       nm_limpa_str_blank_pago_factura_ceibos($_SESSION["uid"]);
   }
   if (isset($_GET["uid"])) 
   {
   ...
   if (isset($_POST["ncomp"])) 
   {
       ...
       nm_limpa_str_blank_pago_factura_ceibos($_SESSION["ncomp"]);
   }
   if (isset($_GET["ncomp"])) 
   {
   ...
   if (isset($_POST["clavesri"])) 
   {
       ...
       nm_limpa_str_blank_pago_factura_ceibos($_SESSION["clavesri"]);
   }
   ...
   if (isset($_POST["rutapdf"])) 
   {
       $_SESSION["rutapdf"] = $_POST["rutapdf"];
       nm_limpa_str_blank_pago_factura_ceibos($_SESSION["rutapdf"]);
   }
   if (isset($_GET["rutapdf"])) 
   {
       $_SESSION["rutapdf"] = $_GET["rutapdf"];
       nm_limpa_str_blank_pago_factura_ceibos($_SESSION["rutapdf"]);
   }
   if (!isset($_SESSION["rutapdf"])) 
   {
       $_SESSION["rutapdf"] = "";
   }
   if (isset($_POST["filefactura"])) 
   {
       $_SESSION["filefactura"] = $_POST["filefactura"];
       nm_limpa_str_blank_pago_factura_ceibos($_SESSION["filefactura"]);
   }
   if (isset($_GET["filefactura"])) 
   {
       $_SESSION["filefactura"] = $_GET["filefactura"];
       nm_limpa_str_blank_pago_factura_ceibos($_SESSION["filefactura"]);
   }
   if (!isset($_SESSION["filefactura"])) 
   {
       $_SESSION["filefactura"] = "";
   }
   if (isset($_POST["facturanum"])) 
   {
       $_SESSION["facturanum"] = $_POST["facturanum"];
       nm_limpa_str_blank_pago_factura_ceibos($_SESSION["facturanum"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['blank_pago_factura_ceibos']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['blank_pago_factura_ceibos']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['blank_pago_factura_ceibos']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "blank_pago_factura_ceibos";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'blank_pago_factura_ceibos' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['blank_pago_factura_ceibos']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['blank_pago_factura_ceibos']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['blank_pago_factura_ceibos']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['blank_pago_factura_ceibos']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['blank_pago_factura_ceibos']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('blank_pago_factura_ceibos' == $sReferer || 'blank_pago_factura_ceibos_' == substr($sReferer, 0, 26))
       {
           $_SESSION['sc_session'][$script_case_init]['blank_pago_factura_ceibos']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'blank_pago_factura_ceibos')
   {
       $_SESSION['sc_session'][$script_case_init]['blank_pago_factura_ceibos']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['blank_pago_factura_ceibos']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/blank_pago_factura_ceibos_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_blank_pago_factura_ceibos($cadapar[1]);
       ...
       if (isset($rutapdf)) 
       {
           $_SESSION['rutapdf'] = $rutapdf;
           nm_limpa_str_blank_pago_factura_ceibos($_SESSION["rutapdf"]);
       }
       if (isset($filefactura)) 
       {
           $_SESSION['filefactura'] = $filefactura;
           nm_limpa_str_blank_pago_factura_ceibos($_SESSION["filefactura"]);
       }
       if (isset($facturanum)) 
       {
   ...
   $contr_blank_pago_factura_ceibos = new blank_pago_factura_ceibos_apl();
   $contr_blank_pago_factura_ceibos->controle();
//
   function nm_limpa_str_blank_pago_factura_ceibos(&$str)
   {
   }
?>
