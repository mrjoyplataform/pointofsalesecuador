...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____chart_cube_sales_resumen"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____chart_cube_sales_resumen"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_cube_sales_resumen']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_cube_sales_resumen']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_cube_sales_resumen']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_cube_sales_resumen']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_cube_sales_resumen']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_cube_sales_resumen</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_cube_sales_resumen']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_cube_sales_resumen']['embutida_filho'] as $ind => $sc_init)
          {
