<?php
@session_start() ;
$_SESSION['scriptcase']['chart_cube_sales_resumen']['sc_process_barr'] = true;
require_once('../chart_cube_sales_resumen/index.php');
unset($_SESSION['scriptcase']['chart_cube_sales_resumen']['sc_process_barr']);
$ExportCtrl = new chart_cube_sales_resumen_export_control;
$ExportCtrl->Export_barr();

class chart_cube_sales_resumen_export_control
{
