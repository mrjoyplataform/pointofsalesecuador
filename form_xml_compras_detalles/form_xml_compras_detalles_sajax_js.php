  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_xml_compras_detalles" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_xml_compras_detalles_form();
	}
...
?>
  ...
  // ---------- Validate idlinea_
  function do_ajax_form_xml_compras_detalles_validate_idlinea_(iNumLinha)
  {
    var nomeCampo_idlinea_ = "idlinea_" + iNumLinha;
    var var_idlinea_ = scAjaxGetFieldText(nomeCampo_idlinea_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_detalles_validate_idlinea_(var_idlinea_, iNumLinha, var_script_case_init, do_ajax_form_xml_compras_detalles_validate_idlinea__cb);
  } // do_ajax_form_xml_compras_detalles_validate_idlinea_

  function do_ajax_form_xml_compras_detalles_validate_idlinea__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idlinea_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idlinea_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idlinea_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idlinea_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_detalles_validate_idlinea__cb

  // ---------- Validate claveacceso_
  function do_ajax_form_xml_compras_detalles_validate_claveacceso_(iNumLinha)
  {
    var nomeCampo_claveacceso_ = "claveacceso_" + iNumLinha;
    var var_claveacceso_ = scAjaxGetFieldText(nomeCampo_claveacceso_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_detalles_validate_claveacceso_(var_claveacceso_, iNumLinha, var_script_case_init, do_ajax_form_xml_compras_detalles_validate_claveacceso__cb);
  } // do_ajax_form_xml_compras_detalles_validate_claveacceso_

  function do_ajax_form_xml_compras_detalles_validate_claveacceso__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "claveacceso_" + iLineNumber;
    }
    else
    {
      sFieldValid = "claveacceso_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "claveacceso_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "claveacceso_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_detalles_validate_claveacceso__cb

  // ---------- Validate codigoprincipal_
  function do_ajax_form_xml_compras_detalles_validate_codigoprincipal_(iNumLinha)
  {
    var nomeCampo_codigoprincipal_ = "codigoprincipal_" + iNumLinha;
    var var_codigoprincipal_ = scAjaxGetFieldText(nomeCampo_codigoprincipal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_detalles_validate_codigoprincipal_(var_codigoprincipal_, iNumLinha, var_script_case_init, do_ajax_form_xml_compras_detalles_validate_codigoprincipal__cb);
  } // do_ajax_form_xml_compras_detalles_validate_codigoprincipal_

  function do_ajax_form_xml_compras_detalles_validate_codigoprincipal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "codigoprincipal_" + iLineNumber;
    }
    else
    {
      sFieldValid = "codigoprincipal_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "codigoprincipal_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "codigoprincipal_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_detalles_validate_codigoprincipal__cb

  // ---------- Validate descripcion_
  function do_ajax_form_xml_compras_detalles_validate_descripcion_(iNumLinha)
  {
    var nomeCampo_descripcion_ = "descripcion_" + iNumLinha;
    var var_descripcion_ = scAjaxGetFieldText(nomeCampo_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_detalles_validate_descripcion_(var_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_xml_compras_detalles_validate_descripcion__cb);
  } // do_ajax_form_xml_compras_detalles_validate_descripcion_

  function do_ajax_form_xml_compras_detalles_validate_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_detalles_validate_descripcion__cb

  // ---------- Validate cantidad_
  function do_ajax_form_xml_compras_detalles_validate_cantidad_(iNumLinha)
  {
    var nomeCampo_cantidad_ = "cantidad_" + iNumLinha;
    var var_cantidad_ = scAjaxGetFieldText(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_detalles_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_xml_compras_detalles_validate_cantidad__cb);
  } // do_ajax_form_xml_compras_detalles_validate_cantidad_

  function do_ajax_form_xml_compras_detalles_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_detalles_validate_cantidad__cb

  // ---------- Validate preciounitario_
  function do_ajax_form_xml_compras_detalles_validate_preciounitario_(iNumLinha)
  {
    var nomeCampo_preciounitario_ = "preciounitario_" + iNumLinha;
    var var_preciounitario_ = scAjaxGetFieldText(nomeCampo_preciounitario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_detalles_validate_preciounitario_(var_preciounitario_, iNumLinha, var_script_case_init, do_ajax_form_xml_compras_detalles_validate_preciounitario__cb);
  } // do_ajax_form_xml_compras_detalles_validate_preciounitario_

  function do_ajax_form_xml_compras_detalles_validate_preciounitario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "preciounitario_" + iLineNumber;
    }
    else
    {
      sFieldValid = "preciounitario_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "preciounitario_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "preciounitario_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_detalles_validate_preciounitario__cb

  // ---------- Validate descuento_
  function do_ajax_form_xml_compras_detalles_validate_descuento_(iNumLinha)
  {
    var nomeCampo_descuento_ = "descuento_" + iNumLinha;
    var var_descuento_ = scAjaxGetFieldText(nomeCampo_descuento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_detalles_validate_descuento_(var_descuento_, iNumLinha, var_script_case_init, do_ajax_form_xml_compras_detalles_validate_descuento__cb);
  } // do_ajax_form_xml_compras_detalles_validate_descuento_

  function do_ajax_form_xml_compras_detalles_validate_descuento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_detalles_validate_descuento__cb

  // ---------- Validate preciototalsinimpuesto_
  function do_ajax_form_xml_compras_detalles_validate_preciototalsinimpuesto_(iNumLinha)
  {
    var nomeCampo_preciototalsinimpuesto_ = "preciototalsinimpuesto_" + iNumLinha;
    var var_preciototalsinimpuesto_ = scAjaxGetFieldText(nomeCampo_preciototalsinimpuesto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_detalles_validate_preciototalsinimpuesto_(var_preciototalsinimpuesto_, iNumLinha, var_script_case_init, do_ajax_form_xml_compras_detalles_validate_preciototalsinimpuesto__cb);
  } // do_ajax_form_xml_compras_detalles_validate_preciototalsinimpuesto_

  function do_ajax_form_xml_compras_detalles_validate_preciototalsinimpuesto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "preciototalsinimpuesto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "preciototalsinimpuesto_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "preciototalsinimpuesto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "preciototalsinimpuesto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_detalles_validate_preciototalsinimpuesto__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_xml_compras_detalles_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_xml_compras_detalles_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_xml_compras_detalles_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_xml_compras_detalles_add_new_line_cb);
  } // do_ajax_form_xml_compras_detalles_add_new_line

  function do_ajax_form_xml_compras_detalles_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_xml_compras_detalles_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_xml_compras_detalles_backup_line(iNumLinha)
  {
    var var_idlinea_ = scAjaxGetFieldText("idlinea_" + iNumLinha);
    var var_claveacceso_ = scAjaxGetFieldText("claveacceso_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_detalles_backup_line(var_idlinea_, var_claveacceso_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_xml_compras_detalles_backup_line_cb);
  } // do_ajax_form_xml_compras_detalles_backup_line

  function do_ajax_form_xml_compras_detalles_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_xml_compras_detalles_backup_line_cb

  function do_ajax_form_xml_compras_detalles_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_xml_compras_detalles_cancel_insert

  function do_ajax_form_xml_compras_detalles_cancel_update(iSeqVert)
  {
    do_ajax_form_xml_compras_detalles_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_xml_compras_detalles_cancel_update

  function do_ajax_form_xml_compras_detalles_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_xml_compras_detalles_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_xml_compras_detalles_table_refresh()
  {
    var var_idlinea_ = document.F2.idlinea_.value;
    var var_claveacceso_ = document.F2.claveacceso_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_xml_compras_detalles_table_refresh(var_idlinea_, var_claveacceso_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_xml_compras_detalles_table_refresh_cb);
  } //  do_ajax_form_xml_compras_detalles_table_refresh

  function do_ajax_form_xml_compras_detalles_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idlinea_.value = scAjaxGetKeyValue("idlinea_");
    document.F2.claveacceso_.value = scAjaxGetKeyValue("claveacceso_");
    ...
    scAjaxAlert(do_ajax_form_xml_compras_detalles_table_refresh_cb_after_alert);
  } // do_ajax_form_xml_compras_detalles_table_refresh_cb
  function do_ajax_form_xml_compras_detalles_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_xml_compras_detalles_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_xml_compras_detalles_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_xml_compras_detalles_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_idlinea_ = scAjaxGetFieldText("idlinea_" + iNumLinha);
    var var_claveacceso_ = scAjaxGetFieldText("claveacceso_" + iNumLinha);
    var var_codigoprincipal_ = scAjaxGetFieldText("codigoprincipal_" + iNumLinha);
    var var_descripcion_ = scAjaxGetFieldText("descripcion_" + iNumLinha);
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iNumLinha);
    var var_preciounitario_ = scAjaxGetFieldText("preciounitario_" + iNumLinha);
    var var_descuento_ = scAjaxGetFieldText("descuento_" + iNumLinha);
    var var_preciototalsinimpuesto_ = scAjaxGetFieldText("preciototalsinimpuesto_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_xml_compras_detalles_submit_form(var_idlinea_, var_claveacceso_, var_codigoprincipal_, var_descripcion_, var_cantidad_, var_preciounitario_, var_descuento_, var_preciototalsinimpuesto_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_xml_compras_detalles_submit_form_cb);
  } // do_ajax_form_xml_compras_detalles_submit_form

  function do_ajax_form_xml_compras_detalles_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idlinea_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("claveacceso_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("codigoprincipal_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("descripcion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cantidad_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("preciounitario_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("descuento_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("preciototalsinimpuesto_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_xml_compras_detalles_submit_form_cb_after_alert);
  } // do_ajax_form_xml_compras_detalles_submit_form_cb
  function do_ajax_form_xml_compras_detalles_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_xml_compras_detalles_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_xml_compras_detalles_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_xml_compras_detalles_navigate_form, function() {});
    } else {
      perform_ajax_form_xml_compras_detalles_navigate_form();
    }
  }

  function perform_ajax_form_xml_compras_detalles_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_xml_compras_detalles_cancel_insert(sc_form_xml_compras_detalles_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idlinea_" + iNavForm);
      scAjaxHideErrorDisplay("claveacceso_" + iNavForm);
      scAjaxHideErrorDisplay("codigoprincipal_" + iNavForm);
      scAjaxHideErrorDisplay("descripcion_" + iNavForm);
      scAjaxHideErrorDisplay("cantidad_" + iNavForm);
      scAjaxHideErrorDisplay("preciounitario_" + iNavForm);
      scAjaxHideErrorDisplay("descuento_" + iNavForm);
      scAjaxHideErrorDisplay("preciototalsinimpuesto_" + iNavForm);
    }
    var var_idlinea_ = document.F2.idlinea_.value;
    var var_claveacceso_ = document.F2.claveacceso_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_xml_compras_detalles_navigate_form(var_idlinea_, var_claveacceso_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_xml_compras_detalles_navigate_form_cb);
  } // do_ajax_form_xml_compras_detalles_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_detalles']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_xml_compras_detalles_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idlinea_.value = scAjaxGetKeyValue("idlinea_" + var_last_index);
    document.F2.claveacceso_.value = scAjaxGetKeyValue("claveacceso_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_xml_compras_detalles_navigate_form_cb_after_alert);
  } // do_ajax_form_xml_compras_detalles_navigate_form_cb
  function do_ajax_form_xml_compras_detalles_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_xml_compras_detalles_navigate_form_cb_after_alert

    function sc_form_xml_compras_detalles_get_last_line_number()
    {
    ...
    } //sc_form_xml_compras_detalles_get_last_line_number

  function sc_hide_form_xml_compras_detalles_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idlinea_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "claveacceso_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "codigoprincipal_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cantidad_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "preciounitario_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "descuento_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "preciototalsinimpuesto_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idlinea_" + iNumLinha] = {"label": "Idlinea<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["claveacceso_" + iNumLinha] = {"label": "Clave Acceso<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["codigoprincipal_" + iNumLinha] = {"label": "Codigo Principal<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["preciounitario_" + iNumLinha] = {"label": "Precio Unitario<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["preciototalsinimpuesto_" + iNumLinha] = {"label": "Precio Total Sin Impuesto<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idlinea_"][iNumLinha] = "idlinea_" + iNumLinha;
    ajax_field_mult["claveacceso_"][iNumLinha] = "claveacceso_" + iNumLinha;
    ajax_field_mult["codigoprincipal_"][iNumLinha] = "codigoprincipal_" + iNumLinha;
    ajax_field_mult["descripcion_"][iNumLinha] = "descripcion_" + iNumLinha;
    ajax_field_mult["cantidad_"][iNumLinha] = "cantidad_" + iNumLinha;
    ajax_field_mult["preciounitario_"][iNumLinha] = "preciounitario_" + iNumLinha;
    ajax_field_mult["descuento_"][iNumLinha] = "descuento_" + iNumLinha;
    ajax_field_mult["preciototalsinimpuesto_"][iNumLinha] = "preciototalsinimpuesto_" + iNumLinha;
    ajax_field_id["idlinea_" + iNumLinha] = new Array("hidden_field_label_idlinea_", "hidden_field_data_idlinea_" + iNumLinha);
    ajax_field_id["claveacceso_" + iNumLinha] = new Array("hidden_field_label_claveacceso_", "hidden_field_data_claveacceso_" + iNumLinha);
    ajax_field_id["codigoprincipal_" + iNumLinha] = new Array("hidden_field_label_codigoprincipal_", "hidden_field_data_codigoprincipal_" + iNumLinha);
    ...
    ajax_field_id["preciounitario_" + iNumLinha] = new Array("hidden_field_label_preciounitario_", "hidden_field_data_preciounitario_" + iNumLinha);
    ajax_field_id["descuento_" + iNumLinha] = new Array("hidden_field_label_descuento_", "hidden_field_data_descuento_" + iNumLinha);
    ajax_field_id["preciototalsinimpuesto_" + iNumLinha] = new Array("hidden_field_label_preciototalsinimpuesto_", "hidden_field_data_preciototalsinimpuesto_" + iNumLinha);
    ajax_error_count["idlinea_" + iNumLinha] = "off";
    ajax_error_count["claveacceso_" + iNumLinha] = "off";
    ajax_error_count["codigoprincipal_" + iNumLinha] = "off";
    ajax_error_count["descripcion_" + iNumLinha] = "off";
    ajax_error_count["cantidad_" + iNumLinha] = "off";
    ajax_error_count["preciounitario_" + iNumLinha] = "off";
    ajax_error_count["descuento_" + iNumLinha] = "off";
    ajax_error_count["preciototalsinimpuesto_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idlinea_" + iNumLinha] = "on";
    ajax_read_only["claveacceso_" + iNumLinha] = "on";
    ajax_read_only["codigoprincipal_" + iNumLinha] = "off";
    ajax_read_only["descripcion_" + iNumLinha] = "off";
    ajax_read_only["cantidad_" + iNumLinha] = "off";
    ajax_read_only["preciounitario_" + iNumLinha] = "off";
    ajax_read_only["descuento_" + iNumLinha] = "off";
    ajax_read_only["preciototalsinimpuesto_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["idlinea_" + iNumLinha] = "on";
    ajax_read_only["claveacceso_" + iNumLinha] = "on";
    ajax_read_only["codigoprincipal_" + iNumLinha] = "on";
    ajax_read_only["descripcion_" + iNumLinha] = "on";
    ajax_read_only["cantidad_" + iNumLinha] = "on";
    ajax_read_only["preciounitario_" + iNumLinha] = "on";
    ajax_read_only["descuento_" + iNumLinha] = "on";
    ajax_read_only["preciototalsinimpuesto_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idlinea_" + iNumLinha] = null;
    ajax_error_list["claveacceso_" + iNumLinha] = null;
    ajax_error_list["codigoprincipal_" + iNumLinha] = null;
    ajax_error_list["descripcion_" + iNumLinha] = null;
    ajax_error_list["cantidad_" + iNumLinha] = null;
    ajax_error_list["preciounitario_" + iNumLinha] = null;
    ajax_error_list["descuento_" + iNumLinha] = null;
    ajax_error_list["preciototalsinimpuesto_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idlinea_": new Array(),
    "claveacceso_": new Array(),
    "codigoprincipal_": new Array(),
    "descripcion_": new Array(),
    "cantidad_": new Array(),
    "preciounitario_": new Array(),
    "descuento_": new Array(),
    "preciototalsinimpuesto_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idlinea_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idlinea_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idlinea_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idlinea_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idlinea_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["claveacceso_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["claveacceso_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["claveacceso_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["claveacceso_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["claveacceso_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["codigoprincipal_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["codigoprincipal_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["codigoprincipal_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["codigoprincipal_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["codigoprincipal_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["preciounitario_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["preciounitario_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["preciounitario_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["preciounitario_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["preciounitario_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["preciototalsinimpuesto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["preciototalsinimpuesto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["preciototalsinimpuesto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["preciototalsinimpuesto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["preciototalsinimpuesto_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idlinea_'])) ? $this->nmgp_cmp_readonly['idlinea_'] : 'on';
?>
    scAjaxFieldRead("idlinea_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['claveacceso_'])) ? $this->nmgp_cmp_readonly['claveacceso_'] : 'on';
?>
    scAjaxFieldRead("claveacceso_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['codigoprincipal_'])) ? $this->nmgp_cmp_readonly['codigoprincipal_'] : 'off';
?>
    scAjaxFieldRead("codigoprincipal_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['preciounitario_'])) ? $this->nmgp_cmp_readonly['preciounitario_'] : 'off';
?>
    scAjaxFieldRead("preciounitario_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['preciototalsinimpuesto_'])) ? $this->nmgp_cmp_readonly['preciototalsinimpuesto_'] : 'off';
?>
    scAjaxFieldRead("preciototalsinimpuesto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idlinea_" + iSeq, "on");
    scAjaxFieldRead("claveacceso_" + iSeq, "on");
    scAjaxFieldRead("codigoprincipal_" + iSeq, "on");
    scAjaxFieldRead("descripcion_" + iSeq, "on");
    scAjaxFieldRead("cantidad_" + iSeq, "on");
    scAjaxFieldRead("preciounitario_" + iSeq, "on");
    scAjaxFieldRead("descuento_" + iSeq, "on");
    scAjaxFieldRead("preciototalsinimpuesto_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idlinea_" + iRow] || "on" == ajax_error_count["claveacceso_" + iRow] || "on" == ajax_error_count["codigoprincipal_" + iRow] || "on" == ajax_error_count["descripcion_" + iRow] || "on" == ajax_error_count["cantidad_" + iRow] || "on" == ajax_error_count["preciounitario_" + iRow] || "on" == ajax_error_count["descuento_" + iRow] || "on" == ajax_error_count["preciototalsinimpuesto_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idlinea_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_claveacceso_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_codigoprincipal_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_descripcion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cantidad_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_preciounitario_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_descuento_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_preciototalsinimpuesto_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idlinea_" + iRow] && "off" == ajax_error_count["claveacceso_" + iRow] && "off" == ajax_error_count["codigoprincipal_" + iRow] && "off" == ajax_error_count["descripcion_" + iRow] && "off" == ajax_error_count["cantidad_" + iRow] && "off" == ajax_error_count["preciounitario_" + iRow] && "off" == ajax_error_count["descuento_" + iRow] && "off" == ajax_error_count["preciototalsinimpuesto_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idlinea_" + iRow] = "off";
        ajax_error_count["claveacceso_" + iRow] = "off";
        ajax_error_count["codigoprincipal_" + iRow] = "off";
        ajax_error_count["descripcion_" + iRow] = "off";
        ajax_error_count["cantidad_" + iRow] = "off";
        ajax_error_count["preciounitario_" + iRow] = "off";
        ajax_error_count["descuento_" + iRow] = "off";
        ajax_error_count["preciototalsinimpuesto_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idlinea_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_claveacceso_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_codigoprincipal_" + iRow).removeClass("scFormErrorLine");
      ...
      $("#hidden_field_data_preciounitario_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_descuento_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_preciototalsinimpuesto_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("preciototalsinimpuesto_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
