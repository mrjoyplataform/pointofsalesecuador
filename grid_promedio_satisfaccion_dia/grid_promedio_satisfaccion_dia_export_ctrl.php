<?php
@session_start() ;
$_SESSION['scriptcase']['grid_promedio_satisfaccion_dia']['sc_process_barr'] = true;
require_once('../grid_promedio_satisfaccion_dia/index.php');
unset($_SESSION['scriptcase']['grid_promedio_satisfaccion_dia']['sc_process_barr']);
$ExportCtrl = new grid_promedio_satisfaccion_dia_export_control;
$ExportCtrl->Export_barr();

class grid_promedio_satisfaccion_dia_export_control
{
