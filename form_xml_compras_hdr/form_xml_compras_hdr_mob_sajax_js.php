  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_xml_compras_hdr_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_xml_compras_hdr_mob_form();
	}
...
?>
  ...
  function do_ajax_form_xml_compras_hdr_mob_validate_claveacceso()
  {
    var nomeCampo_claveacceso = "claveacceso";
    var var_claveacceso = scAjaxGetFieldText(nomeCampo_claveacceso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_claveacceso(var_claveacceso, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_claveacceso_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_claveacceso

  function do_ajax_form_xml_compras_hdr_mob_validate_claveacceso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "claveacceso";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_claveacceso_cb

  // ---------- Validate ambiente
  function do_ajax_form_xml_compras_hdr_mob_validate_ambiente()
  {
    var nomeCampo_ambiente = "ambiente";
    var var_ambiente = scAjaxGetFieldText(nomeCampo_ambiente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_ambiente(var_ambiente, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_ambiente_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_ambiente

  function do_ajax_form_xml_compras_hdr_mob_validate_ambiente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ambiente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_ambiente_cb

  // ---------- Validate tipoemision
  function do_ajax_form_xml_compras_hdr_mob_validate_tipoemision()
  {
    var nomeCampo_tipoemision = "tipoemision";
    var var_tipoemision = scAjaxGetFieldText(nomeCampo_tipoemision);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_tipoemision(var_tipoemision, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_tipoemision_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_tipoemision

  function do_ajax_form_xml_compras_hdr_mob_validate_tipoemision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipoemision";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_tipoemision_cb

  // ---------- Validate razonsocial
  function do_ajax_form_xml_compras_hdr_mob_validate_razonsocial()
  {
    var nomeCampo_razonsocial = "razonsocial";
    var var_razonsocial = scAjaxGetFieldText(nomeCampo_razonsocial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_razonsocial(var_razonsocial, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_razonsocial_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_razonsocial

  function do_ajax_form_xml_compras_hdr_mob_validate_razonsocial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "razonsocial";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_razonsocial_cb

  // ---------- Validate nombrecomercial
  function do_ajax_form_xml_compras_hdr_mob_validate_nombrecomercial()
  {
    var nomeCampo_nombrecomercial = "nombrecomercial";
    var var_nombrecomercial = scAjaxGetFieldText(nomeCampo_nombrecomercial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_nombrecomercial(var_nombrecomercial, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_nombrecomercial_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_nombrecomercial

  function do_ajax_form_xml_compras_hdr_mob_validate_nombrecomercial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombrecomercial";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_nombrecomercial_cb

  // ---------- Validate ruc
  function do_ajax_form_xml_compras_hdr_mob_validate_ruc()
  {
    var nomeCampo_ruc = "ruc";
    var var_ruc = scAjaxGetFieldText(nomeCampo_ruc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_ruc(var_ruc, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_ruc_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_ruc

  function do_ajax_form_xml_compras_hdr_mob_validate_ruc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ruc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_ruc_cb

  // ---------- Validate coddoc
  function do_ajax_form_xml_compras_hdr_mob_validate_coddoc()
  {
    var nomeCampo_coddoc = "coddoc";
    var var_coddoc = scAjaxGetFieldText(nomeCampo_coddoc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_coddoc(var_coddoc, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_coddoc_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_coddoc

  function do_ajax_form_xml_compras_hdr_mob_validate_coddoc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "coddoc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_coddoc_cb

  // ---------- Validate estab
  function do_ajax_form_xml_compras_hdr_mob_validate_estab()
  {
    var nomeCampo_estab = "estab";
    var var_estab = scAjaxGetFieldText(nomeCampo_estab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_estab(var_estab, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_estab_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_estab

  function do_ajax_form_xml_compras_hdr_mob_validate_estab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_estab_cb

  // ---------- Validate ptoemi
  function do_ajax_form_xml_compras_hdr_mob_validate_ptoemi()
  {
    var nomeCampo_ptoemi = "ptoemi";
    var var_ptoemi = scAjaxGetFieldText(nomeCampo_ptoemi);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_ptoemi(var_ptoemi, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_ptoemi_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_ptoemi

  function do_ajax_form_xml_compras_hdr_mob_validate_ptoemi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ptoemi";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_ptoemi_cb

  // ---------- Validate secuencial
  function do_ajax_form_xml_compras_hdr_mob_validate_secuencial()
  {
    var nomeCampo_secuencial = "secuencial";
    var var_secuencial = scAjaxGetFieldText(nomeCampo_secuencial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_secuencial(var_secuencial, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_secuencial_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_secuencial

  function do_ajax_form_xml_compras_hdr_mob_validate_secuencial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_secuencial_cb

  // ---------- Validate dirmatriz
  function do_ajax_form_xml_compras_hdr_mob_validate_dirmatriz()
  {
    var nomeCampo_dirmatriz = "dirmatriz";
    var var_dirmatriz = scAjaxGetFieldText(nomeCampo_dirmatriz);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_dirmatriz(var_dirmatriz, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_dirmatriz_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_dirmatriz

  function do_ajax_form_xml_compras_hdr_mob_validate_dirmatriz_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dirmatriz";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_dirmatriz_cb

  // ---------- Validate fechaemision
  function do_ajax_form_xml_compras_hdr_mob_validate_fechaemision()
  {
    var nomeCampo_fechaemision = "fechaemision";
    var var_fechaemision = scAjaxGetFieldText(nomeCampo_fechaemision);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_fechaemision(var_fechaemision, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_fechaemision_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_fechaemision

  function do_ajax_form_xml_compras_hdr_mob_validate_fechaemision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_fechaemision_cb

  // ---------- Validate tipoidentificacioncomprador
  function do_ajax_form_xml_compras_hdr_mob_validate_tipoidentificacioncomprador()
  {
    var nomeCampo_tipoidentificacioncomprador = "tipoidentificacioncomprador";
    var var_tipoidentificacioncomprador = scAjaxGetFieldText(nomeCampo_tipoidentificacioncomprador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_tipoidentificacioncomprador(var_tipoidentificacioncomprador, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_tipoidentificacioncomprador_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_tipoidentificacioncomprador

  function do_ajax_form_xml_compras_hdr_mob_validate_tipoidentificacioncomprador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipoidentificacioncomprador";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_tipoidentificacioncomprador_cb

  // ---------- Validate razonsocialcomprador
  function do_ajax_form_xml_compras_hdr_mob_validate_razonsocialcomprador()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_razonsocialcomprador(var_razonsocialcomprador, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_razonsocialcomprador_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_razonsocialcomprador

  function do_ajax_form_xml_compras_hdr_mob_validate_razonsocialcomprador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_razonsocialcomprador_cb

  // ---------- Validate identificacioncomprador
  function do_ajax_form_xml_compras_hdr_mob_validate_identificacioncomprador()
  {
    var nomeCampo_identificacioncomprador = "identificacioncomprador";
    var var_identificacioncomprador = scAjaxGetFieldText(nomeCampo_identificacioncomprador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_identificacioncomprador(var_identificacioncomprador, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_identificacioncomprador_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_identificacioncomprador

  function do_ajax_form_xml_compras_hdr_mob_validate_identificacioncomprador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "identificacioncomprador";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_identificacioncomprador_cb

  // ---------- Validate totalsinimpuestos
  function do_ajax_form_xml_compras_hdr_mob_validate_totalsinimpuestos()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_totalsinimpuestos(var_totalsinimpuestos, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_totalsinimpuestos_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_totalsinimpuestos

  function do_ajax_form_xml_compras_hdr_mob_validate_totalsinimpuestos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_totalsinimpuestos_cb

  // ---------- Validate totaldescuento
  function do_ajax_form_xml_compras_hdr_mob_validate_totaldescuento()
  {
    var nomeCampo_totaldescuento = "totaldescuento";
    var var_totaldescuento = scAjaxGetFieldText(nomeCampo_totaldescuento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_totaldescuento(var_totaldescuento, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_totaldescuento_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_totaldescuento

  function do_ajax_form_xml_compras_hdr_mob_validate_totaldescuento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_totaldescuento_cb

  // ---------- Validate totalconimpuestos
  function do_ajax_form_xml_compras_hdr_mob_validate_totalconimpuestos()
  {
    var nomeCampo_totalconimpuestos = "totalconimpuestos";
    var var_totalconimpuestos = scAjaxGetFieldText(nomeCampo_totalconimpuestos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_totalconimpuestos(var_totalconimpuestos, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_totalconimpuestos_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_totalconimpuestos

  function do_ajax_form_xml_compras_hdr_mob_validate_totalconimpuestos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "totalconimpuestos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_totalconimpuestos_cb

  // ---------- Validate propina
  function do_ajax_form_xml_compras_hdr_mob_validate_propina()
  {
    var nomeCampo_propina = "propina";
    var var_propina = scAjaxGetFieldText(nomeCampo_propina);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_propina(var_propina, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_propina_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_propina

  function do_ajax_form_xml_compras_hdr_mob_validate_propina_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "propina";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_propina_cb

  // ---------- Validate importetotal
  function do_ajax_form_xml_compras_hdr_mob_validate_importetotal()
  {
    var nomeCampo_importetotal = "importetotal";
    var var_importetotal = scAjaxGetFieldText(nomeCampo_importetotal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_importetotal(var_importetotal, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_importetotal_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_importetotal

  function do_ajax_form_xml_compras_hdr_mob_validate_importetotal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_importetotal_cb

  // ---------- Validate moneda
  function do_ajax_form_xml_compras_hdr_mob_validate_moneda()
  {
    var nomeCampo_moneda = "moneda";
    var var_moneda = scAjaxGetFieldText(nomeCampo_moneda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_moneda(var_moneda, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_moneda_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_moneda

  function do_ajax_form_xml_compras_hdr_mob_validate_moneda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "moneda";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_moneda_cb

  // ---------- Validate fecharegistro
  function do_ajax_form_xml_compras_hdr_mob_validate_fecharegistro()
  {
    var nomeCampo_fecharegistro = "fecharegistro";
    var var_fecharegistro = scAjaxGetFieldText(nomeCampo_fecharegistro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_fecharegistro(var_fecharegistro, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_fecharegistro_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_fecharegistro

  function do_ajax_form_xml_compras_hdr_mob_validate_fecharegistro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_fecharegistro_cb

  // ---------- Validate estado
  function do_ajax_form_xml_compras_hdr_mob_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldText(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_xml_compras_hdr_mob_validate_estado(var_estado, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_validate_estado_cb);
  } // do_ajax_form_xml_compras_hdr_mob_validate_estado

  function do_ajax_form_xml_compras_hdr_mob_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_xml_compras_hdr_mob_validate_estado_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_xml_compras_hdr_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_xml_compras_hdr_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_claveacceso = scAjaxGetFieldText("claveacceso");
    var var_ambiente = scAjaxGetFieldText("ambiente");
    var var_tipoemision = scAjaxGetFieldText("tipoemision");
    var var_razonsocial = scAjaxGetFieldText("razonsocial");
    var var_nombrecomercial = scAjaxGetFieldText("nombrecomercial");
    var var_ruc = scAjaxGetFieldText("ruc");
    var var_coddoc = scAjaxGetFieldText("coddoc");
    ...
    var var_dirmatriz = scAjaxGetFieldText("dirmatriz");
    var var_fechaemision = scAjaxGetFieldText("fechaemision");
    var var_tipoidentificacioncomprador = scAjaxGetFieldText("tipoidentificacioncomprador");
    var var_razonsocialcomprador = scAjaxGetFieldText("razonsocialcomprador");
    var var_identificacioncomprador = scAjaxGetFieldText("identificacioncomprador");
    var var_totalsinimpuestos = scAjaxGetFieldText("totalsinimpuestos");
    var var_totaldescuento = scAjaxGetFieldText("totaldescuento");
    var var_totalconimpuestos = scAjaxGetFieldText("totalconimpuestos");
    var var_propina = scAjaxGetFieldText("propina");
    var var_importetotal = scAjaxGetFieldText("importetotal");
    var var_moneda = scAjaxGetFieldText("moneda");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_xml_compras_hdr_mob_submit_form(var_claveacceso, var_ambiente, var_tipoemision, var_razonsocial, var_nombrecomercial, var_ruc, var_coddoc, var_estab, var_ptoemi, var_secuencial, var_dirmatriz, var_fechaemision, var_tipoidentificacioncomprador, var_razonsocialcomprador, var_identificacioncomprador, var_totalsinimpuestos, var_totaldescuento, var_totalconimpuestos, var_propina, var_importetotal, var_moneda, var_fecharegistro, var_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_submit_form_cb);
  } // do_ajax_form_xml_compras_hdr_mob_submit_form

  function do_ajax_form_xml_compras_hdr_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("claveacceso");
      scAjaxHideErrorDisplay("ambiente");
      scAjaxHideErrorDisplay("tipoemision");
      scAjaxHideErrorDisplay("razonsocial");
      scAjaxHideErrorDisplay("nombrecomercial");
      scAjaxHideErrorDisplay("ruc");
      scAjaxHideErrorDisplay("coddoc");
      scAjaxHideErrorDisplay("estab");
      scAjaxHideErrorDisplay("ptoemi");
      scAjaxHideErrorDisplay("secuencial");
      scAjaxHideErrorDisplay("dirmatriz");
      scAjaxHideErrorDisplay("fechaemision");
      scAjaxHideErrorDisplay("tipoidentificacioncomprador");
      scAjaxHideErrorDisplay("razonsocialcomprador");
      scAjaxHideErrorDisplay("identificacioncomprador");
      scAjaxHideErrorDisplay("totalsinimpuestos");
      scAjaxHideErrorDisplay("totaldescuento");
      scAjaxHideErrorDisplay("totalconimpuestos");
      scAjaxHideErrorDisplay("propina");
      scAjaxHideErrorDisplay("importetotal");
      scAjaxHideErrorDisplay("moneda");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_xml_compras_hdr_mob_submit_form_cb_after_alert);
  } // do_ajax_form_xml_compras_hdr_mob_submit_form_cb
  function do_ajax_form_xml_compras_hdr_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_xml_compras_hdr_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_xml_compras_hdr_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_xml_compras_hdr_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_xml_compras_hdr_mob_navigate_form();
    }
  }

  function perform_ajax_form_xml_compras_hdr_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("fecharegistro");
    scAjaxHideErrorDisplay("estado");
    var var_claveacceso = document.F2.claveacceso.value;
    ...
    scAjaxProcOn();
    x_ajax_form_xml_compras_hdr_mob_navigate_form(var_claveacceso, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_xml_compras_hdr_mob_navigate_form_cb);
  } // do_ajax_form_xml_compras_hdr_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_xml_compras_hdr_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.claveacceso.value = scAjaxGetKeyValue("claveacceso");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_xml_compras_hdr_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_xml_compras_hdr_mob_navigate_form_cb
  function do_ajax_form_xml_compras_hdr_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_xml_compras_hdr_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_xml_compras_hdr_mob_navigate_form_cb_after_alert

  function sc_hide_form_xml_compras_hdr_mob_form()
  {
  ...
  ajax_field_list[0] = "claveacceso";
  ajax_field_list[1] = "ambiente";
  ajax_field_list[2] = "tipoemision";
  ajax_field_list[3] = "razonsocial";
  ajax_field_list[4] = "nombrecomercial";
  ajax_field_list[5] = "ruc";
  ajax_field_list[6] = "coddoc";
  ajax_field_list[7] = "estab";
  ajax_field_list[8] = "ptoemi";
  ajax_field_list[9] = "secuencial";
  ajax_field_list[10] = "dirmatriz";
  ajax_field_list[11] = "fechaemision";
  ajax_field_list[12] = "tipoidentificacioncomprador";
  ajax_field_list[13] = "razonsocialcomprador";
  ajax_field_list[14] = "identificacioncomprador";
  ajax_field_list[15] = "totalsinimpuestos";
  ajax_field_list[16] = "totaldescuento";
  ajax_field_list[17] = "totalconimpuestos";
  ajax_field_list[18] = "propina";
  ajax_field_list[19] = "importetotal";
  ajax_field_list[20] = "moneda";
  ajax_field_list[21] = "fecharegistro";
  ajax_field_list[22] = "estado";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "claveacceso": {"label": "Clave Acceso", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ambiente": {"label": "Ambiente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipoemision": {"label": "Tipo Emision", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "razonsocial": {"label": "Razon Social", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nombrecomercial": {"label": "Nombre Comercial", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ruc": {"label": "Ruc", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "coddoc": {"label": "Cod Doc", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "estab": {"label": "Estab", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ptoemi": {"label": "Pto Emi", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "secuencial": {"label": "Secuencial", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "dirmatriz": {"label": "Dir Matriz", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fechaemision": {"label": "Fecha Emision", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipoidentificacioncomprador": {"label": "Tipo Identificacion Comprador", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "razonsocialcomprador": {"label": "Razon Social Comprador", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "identificacioncomprador": {"label": "Identificacion Comprador", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "totaldescuento": {"label": "Total Descuento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "totalconimpuestos": {"label": "Total Con Impuestos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "propina": {"label": "Propina", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "moneda": {"label": "Moneda", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecharegistro": {"label": "Fecharegistro", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "claveacceso": new Array(),
    "ambiente": new Array(),
    "tipoemision": new Array(),
    "razonsocial": new Array(),
    "nombrecomercial": new Array(),
    "ruc": new Array(),
    "coddoc": new Array(),
    "estab": new Array(),
    "ptoemi": new Array(),
    ...
    "tipoidentificacioncomprador": new Array(),
    "razonsocialcomprador": new Array(),
    "identificacioncomprador": new Array(),
    "totalsinimpuestos": new Array(),
    "totaldescuento": new Array(),
    "totalconimpuestos": new Array(),
    "propina": new Array(),
  ...
  ajax_field_mult["claveacceso"][1] = "claveacceso";
  ajax_field_mult["ambiente"][1] = "ambiente";
  ajax_field_mult["tipoemision"][1] = "tipoemision";
  ajax_field_mult["razonsocial"][1] = "razonsocial";
  ajax_field_mult["nombrecomercial"][1] = "nombrecomercial";
  ajax_field_mult["ruc"][1] = "ruc";
  ajax_field_mult["coddoc"][1] = "coddoc";
  ajax_field_mult["estab"][1] = "estab";
  ajax_field_mult["ptoemi"][1] = "ptoemi";
  ajax_field_mult["secuencial"][1] = "secuencial";
  ajax_field_mult["dirmatriz"][1] = "dirmatriz";
  ajax_field_mult["fechaemision"][1] = "fechaemision";
  ajax_field_mult["tipoidentificacioncomprador"][1] = "tipoidentificacioncomprador";
  ajax_field_mult["razonsocialcomprador"][1] = "razonsocialcomprador";
  ajax_field_mult["identificacioncomprador"][1] = "identificacioncomprador";
  ajax_field_mult["totalsinimpuestos"][1] = "totalsinimpuestos";
  ajax_field_mult["totaldescuento"][1] = "totaldescuento";
  ajax_field_mult["totalconimpuestos"][1] = "totalconimpuestos";
  ajax_field_mult["propina"][1] = "propina";
  ajax_field_mult["importetotal"][1] = "importetotal";
  ajax_field_mult["moneda"][1] = "moneda";
  ajax_field_mult["fecharegistro"][1] = "fecharegistro";
  ajax_field_mult["estado"][1] = "estado";

  var ajax_field_id = {
    "claveacceso": new Array("hidden_field_label_claveacceso", "hidden_field_data_claveacceso"),
    "ambiente": new Array("hidden_field_label_ambiente", "hidden_field_data_ambiente"),
    "tipoemision": new Array("hidden_field_label_tipoemision", "hidden_field_data_tipoemision"),
    "razonsocial": new Array("hidden_field_label_razonsocial", "hidden_field_data_razonsocial"),
    "nombrecomercial": new Array("hidden_field_label_nombrecomercial", "hidden_field_data_nombrecomercial"),
    "ruc": new Array("hidden_field_label_ruc", "hidden_field_data_ruc"),
    "coddoc": new Array("hidden_field_label_coddoc", "hidden_field_data_coddoc"),
    "estab": new Array("hidden_field_label_estab", "hidden_field_data_estab"),
    "ptoemi": new Array("hidden_field_label_ptoemi", "hidden_field_data_ptoemi"),
    "secuencial": new Array("hidden_field_label_secuencial", "hidden_field_data_secuencial"),
    "dirmatriz": new Array("hidden_field_label_dirmatriz", "hidden_field_data_dirmatriz"),
    "fechaemision": new Array("hidden_field_label_fechaemision", "hidden_field_data_fechaemision"),
    "tipoidentificacioncomprador": new Array("hidden_field_label_tipoidentificacioncomprador", "hidden_field_data_tipoidentificacioncomprador"),
    "razonsocialcomprador": new Array("hidden_field_label_razonsocialcomprador", "hidden_field_data_razonsocialcomprador"),
    "identificacioncomprador": new Array("hidden_field_label_identificacioncomprador", "hidden_field_data_identificacioncomprador"),
    ...
    "totalconimpuestos": new Array("hidden_field_label_totalconimpuestos", "hidden_field_data_totalconimpuestos"),
    "propina": new Array("hidden_field_label_propina", "hidden_field_data_propina"),
    "importetotal": new Array("hidden_field_label_importetotal", "hidden_field_data_importetotal"),
    "moneda": new Array("hidden_field_label_moneda", "hidden_field_data_moneda"),
  ...
  var ajax_read_only = {
    ...
    "dirmatriz": "off",
    "fechaemision": "off",
    "tipoidentificacioncomprador": "off",
    "razonsocialcomprador": "off",
    "identificacioncomprador": "off",
    "totalsinimpuestos": "on",
    "totaldescuento": "on",
    "totalconimpuestos": "on",
    "propina": "on",
    "importetotal": "on",
    "moneda": "off",
    "fecharegistro": "on",
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("tipoidentificacioncomprador" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("identificacioncomprador" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
