...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_fecharegistro_hora' + iSeqRow).bind('blur', function() { sc_form_xml_compras_hdr_fecharegistro_onblur(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_xml_compras_hdr_fecharegistro_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_xml_compras_hdr_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fechaemision" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_xml_compras_hdr_mob_validate_fechaemision(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fecharegistro" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_xml_compras_hdr_mob_validate_fecharegistro(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_xml_compras_hdr_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
