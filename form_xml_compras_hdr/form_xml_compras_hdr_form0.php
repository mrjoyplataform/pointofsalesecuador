...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_xml_compras_hdr/form_xml_compras_hdr_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_xml_compras_hdr_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_xml_compras_hdr_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['link_info']['remove_border']) {
...
<?php
 include_once("form_xml_compras_hdr_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_xml_compras_hdr'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_xml_compras_hdr'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_claveacceso_label" id="hidden_field_label_claveacceso" style="<?php echo $sStyleHidden_claveacceso; ?>"><span id="id_label_claveacceso"><?php echo $this->nm_new_label['claveacceso']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['php_cmp_required']['claveacceso']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['php_cmp_required']['claveacceso'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_claveacceso_line" id="hidden_field_data_claveacceso" style="<?php echo $sStyleHidden_claveacceso; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_claveacceso_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ambiente_label" id="hidden_field_label_ambiente" style="<?php echo $sStyleHidden_ambiente; ?>"><span id="id_label_ambiente"><?php echo $this->nm_new_label['ambiente']; ?></span></TD>
    <TD class="scFormDataOdd css_ambiente_line" id="hidden_field_data_ambiente" style="<?php echo $sStyleHidden_ambiente; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ambiente_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipoemision_label" id="hidden_field_label_tipoemision" style="<?php echo $sStyleHidden_tipoemision; ?>"><span id="id_label_tipoemision"><?php echo $this->nm_new_label['tipoemision']; ?></span></TD>
    <TD class="scFormDataOdd css_tipoemision_line" id="hidden_field_data_tipoemision" style="<?php echo $sStyleHidden_tipoemision; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipoemision_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_razonsocial_label" id="hidden_field_label_razonsocial" style="<?php echo $sStyleHidden_razonsocial; ?>"><span id="id_label_razonsocial"><?php echo $this->nm_new_label['razonsocial']; ?></span></TD>
    <TD class="scFormDataOdd css_razonsocial_line" id="hidden_field_data_razonsocial" style="<?php echo $sStyleHidden_razonsocial; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_razonsocial_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nombrecomercial_label" id="hidden_field_label_nombrecomercial" style="<?php echo $sStyleHidden_nombrecomercial; ?>"><span id="id_label_nombrecomercial"><?php echo $this->nm_new_label['nombrecomercial']; ?></span></TD>
    <TD class="scFormDataOdd css_nombrecomercial_line" id="hidden_field_data_nombrecomercial" style="<?php echo $sStyleHidden_nombrecomercial; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nombrecomercial_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ruc_label" id="hidden_field_label_ruc" style="<?php echo $sStyleHidden_ruc; ?>"><span id="id_label_ruc"><?php echo $this->nm_new_label['ruc']; ?></span></TD>
    <TD class="scFormDataOdd css_ruc_line" id="hidden_field_data_ruc" style="<?php echo $sStyleHidden_ruc; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ruc_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_coddoc_label" id="hidden_field_label_coddoc" style="<?php echo $sStyleHidden_coddoc; ?>"><span id="id_label_coddoc"><?php echo $this->nm_new_label['coddoc']; ?></span></TD>
    <TD class="scFormDataOdd css_coddoc_line" id="hidden_field_data_coddoc" style="<?php echo $sStyleHidden_coddoc; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_coddoc_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_estab_label" id="hidden_field_label_estab" style="<?php echo $sStyleHidden_estab; ?>"><span id="id_label_estab"><?php echo $this->nm_new_label['estab']; ?></span></TD>
    <TD class="scFormDataOdd css_estab_line" id="hidden_field_data_estab" style="<?php echo $sStyleHidden_estab; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_estab_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ptoemi_label" id="hidden_field_label_ptoemi" style="<?php echo $sStyleHidden_ptoemi; ?>"><span id="id_label_ptoemi"><?php echo $this->nm_new_label['ptoemi']; ?></span></TD>
    <TD class="scFormDataOdd css_ptoemi_line" id="hidden_field_data_ptoemi" style="<?php echo $sStyleHidden_ptoemi; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ptoemi_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_dirmatriz_label" id="hidden_field_label_dirmatriz" style="<?php echo $sStyleHidden_dirmatriz; ?>"><span id="id_label_dirmatriz"><?php echo $this->nm_new_label['dirmatriz']; ?></span></TD>
    <TD class="scFormDataOdd css_dirmatriz_line" id="hidden_field_data_dirmatriz" style="<?php echo $sStyleHidden_dirmatriz; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_dirmatriz_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fechaemision_label" id="hidden_field_label_fechaemision" style="<?php echo $sStyleHidden_fechaemision; ?>"><span id="id_label_fechaemision"><?php echo $this->nm_new_label['fechaemision']; ?></span></TD>
    <TD class="scFormDataOdd css_fechaemision_line" id="hidden_field_data_fechaemision" style="<?php echo $sStyleHidden_fechaemision; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fechaemision_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipoidentificacioncomprador_label" id="hidden_field_label_tipoidentificacioncomprador" style="<?php echo $sStyleHidden_tipoidentificacioncomprador; ?>"><span id="id_label_tipoidentificacioncomprador"><?php echo $this->nm_new_label['tipoidentificacioncomprador']; ?></span></TD>
    <TD class="scFormDataOdd css_tipoidentificacioncomprador_line" id="hidden_field_data_tipoidentificacioncomprador" style="<?php echo $sStyleHidden_tipoidentificacioncomprador; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipoidentificacioncomprador_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_razonsocialcomprador_label" id="hidden_field_label_razonsocialcomprador" style="<?php echo $sStyleHidden_razonsocialcomprador; ?>"><span id="id_label_razonsocialcomprador"><?php echo $this->nm_new_label['razonsocialcomprador']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_identificacioncomprador_label" id="hidden_field_label_identificacioncomprador" style="<?php echo $sStyleHidden_identificacioncomprador; ?>"><span id="id_label_identificacioncomprador"><?php echo $this->nm_new_label['identificacioncomprador']; ?></span></TD>
    <TD class="scFormDataOdd css_identificacioncomprador_line" id="hidden_field_data_identificacioncomprador" style="<?php echo $sStyleHidden_identificacioncomprador; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_identificacioncomprador_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_totalsinimpuestos_label" id="hidden_field_label_totalsinimpuestos" style="<?php echo $sStyleHidden_totalsinimpuestos; ?>"><span id="id_label_totalsinimpuestos"><?php echo $this->nm_new_label['totalsinimpuestos']; ?></span></TD>
    <TD class="scFormDataOdd css_totalsinimpuestos_line" id="hidden_field_data_totalsinimpuestos" style="<?php echo $sStyleHidden_totalsinimpuestos; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_totalsinimpuestos_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_totaldescuento_label" id="hidden_field_label_totaldescuento" style="<?php echo $sStyleHidden_totaldescuento; ?>"><span id="id_label_totaldescuento"><?php echo $this->nm_new_label['totaldescuento']; ?></span></TD>
    <TD class="scFormDataOdd css_totaldescuento_line" id="hidden_field_data_totaldescuento" style="<?php echo $sStyleHidden_totaldescuento; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_totaldescuento_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_totalconimpuestos_label" id="hidden_field_label_totalconimpuestos" style="<?php echo $sStyleHidden_totalconimpuestos; ?>"><span id="id_label_totalconimpuestos"><?php echo $this->nm_new_label['totalconimpuestos']; ?></span></TD>
    <TD class="scFormDataOdd css_totalconimpuestos_line" id="hidden_field_data_totalconimpuestos" style="<?php echo $sStyleHidden_totalconimpuestos; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_totalconimpuestos_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_propina_label" id="hidden_field_label_propina" style="<?php echo $sStyleHidden_propina; ?>"><span id="id_label_propina"><?php echo $this->nm_new_label['propina']; ?></span></TD>
    <TD class="scFormDataOdd css_propina_line" id="hidden_field_data_propina" style="<?php echo $sStyleHidden_propina; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_propina_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_importetotal_label" id="hidden_field_label_importetotal" style="<?php echo $sStyleHidden_importetotal; ?>"><span id="id_label_importetotal"><?php echo $this->nm_new_label['importetotal']; ?></span></TD>
    <TD class="scFormDataOdd css_importetotal_line" id="hidden_field_data_importetotal" style="<?php echo $sStyleHidden_importetotal; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_importetotal_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_moneda_label" id="hidden_field_label_moneda" style="<?php echo $sStyleHidden_moneda; ?>"><span id="id_label_moneda"><?php echo $this->nm_new_label['moneda']; ?></span></TD>
    <TD class="scFormDataOdd css_moneda_line" id="hidden_field_data_moneda" style="<?php echo $sStyleHidden_moneda; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_moneda_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fecharegistro_label" id="hidden_field_label_fecharegistro" style="<?php echo $sStyleHidden_fecharegistro; ?>"><span id="id_label_fecharegistro"><?php echo $this->nm_new_label['fecharegistro']; ?></span></TD>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_xml_compras_hdr");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_xml_compras_hdr");
 parent.scAjaxDetailHeight("form_xml_compras_hdr", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_xml_compras_hdr']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
