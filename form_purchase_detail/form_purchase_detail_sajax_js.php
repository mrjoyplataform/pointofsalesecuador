  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_purchase_detail" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_purchase_detail_form();
	}
...
?>
  ...
  // ---------- Validate id_product_
  function do_ajax_form_purchase_detail_validate_id_product_(iNumLinha)
  {
    var nomeCampo_id_product_ = "id_product_" + iNumLinha;
    var var_id_product_ = scAjaxGetFieldSelect(nomeCampo_id_product_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_purchase_detail_validate_id_product_(var_id_product_, iNumLinha, var_script_case_init, do_ajax_form_purchase_detail_validate_id_product__cb);
  } // do_ajax_form_purchase_detail_validate_id_product_

  function do_ajax_form_purchase_detail_validate_id_product__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_product_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_product_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "id_product_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_product_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_purchase_detail_validate_id_product__cb

  // ---------- Validate quantity_
  function do_ajax_form_purchase_detail_validate_quantity_(iNumLinha)
  {
    var nomeCampo_quantity_ = "quantity_" + iNumLinha;
    var var_quantity_ = scAjaxGetFieldText(nomeCampo_quantity_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_purchase_detail_validate_quantity_(var_quantity_, iNumLinha, var_script_case_init, do_ajax_form_purchase_detail_validate_quantity__cb);
  } // do_ajax_form_purchase_detail_validate_quantity_

  function do_ajax_form_purchase_detail_validate_quantity__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_purchase_detail_validate_quantity__cb

  // ---------- Validate unit_cost_
  function do_ajax_form_purchase_detail_validate_unit_cost_(iNumLinha)
  {
    var nomeCampo_unit_cost_ = "unit_cost_" + iNumLinha;
    var var_unit_cost_ = scAjaxGetFieldText(nomeCampo_unit_cost_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_purchase_detail_validate_unit_cost_(var_unit_cost_, iNumLinha, var_script_case_init, do_ajax_form_purchase_detail_validate_unit_cost__cb);
  } // do_ajax_form_purchase_detail_validate_unit_cost_

  function do_ajax_form_purchase_detail_validate_unit_cost__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "unit_cost_" + iLineNumber;
    }
    else
    {
      sFieldValid = "unit_cost_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "unit_cost_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "unit_cost_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_purchase_detail_validate_unit_cost__cb

  // ---------- Validate total_
  function do_ajax_form_purchase_detail_validate_total_(iNumLinha)
  {
    var nomeCampo_total_ = "total_" + iNumLinha;
    var var_total_ = scAjaxGetFieldText(nomeCampo_total_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_purchase_detail_validate_total_(var_total_, iNumLinha, var_script_case_init, do_ajax_form_purchase_detail_validate_total__cb);
  } // do_ajax_form_purchase_detail_validate_total_

  function do_ajax_form_purchase_detail_validate_total__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_purchase_detail_validate_total__cb

  // ---------- Validate id_purchase_detail_
  function do_ajax_form_purchase_detail_validate_id_purchase_detail_(iNumLinha)
  {
    var nomeCampo_id_purchase_detail_ = "id_purchase_detail_" + iNumLinha;
    var var_id_purchase_detail_ = scAjaxGetFieldHidden(nomeCampo_id_purchase_detail_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_purchase_detail_validate_id_purchase_detail_(var_id_purchase_detail_, iNumLinha, var_script_case_init, do_ajax_form_purchase_detail_validate_id_purchase_detail__cb);
  } // do_ajax_form_purchase_detail_validate_id_purchase_detail_

  function do_ajax_form_purchase_detail_validate_id_purchase_detail__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_purchase_detail_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_purchase_detail_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "id_purchase_detail_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_purchase_detail_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_purchase_detail_validate_id_purchase_detail__cb

  // ---------- Event onchange id_product_
  function do_ajax_form_purchase_detail_event_id_product__onchange(iSeqForm)
  {
    var var_id_product_ = scAjaxGetFieldSelect("id_product_" + iSeqForm);
    var var_unit_cost_ = scAjaxGetFieldText("unit_cost_" + iSeqForm);
    ...
    scAjaxProcOn(true);
    x_ajax_form_purchase_detail_event_id_product__onchange(var_id_product_, var_unit_cost_, var_quantity_, var_total_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_purchase_detail_event_id_product__onchange_cb);
  } // do_ajax_form_purchase_detail_event_id_product__onchange

  function do_ajax_form_purchase_detail_event_id_product__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_purchase_detail_event_id_product__onchange_cb_after_alert);
  } // do_ajax_form_purchase_detail_event_id_product__onchange_cb
  function do_ajax_form_purchase_detail_event_id_product__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_purchase_detail_event_id_product__onchange_cb_after_alert

  // ---------- Event onchange quantity_
  function do_ajax_form_purchase_detail_event_quantity__onchange(iSeqForm)
  {
    var var_total_ = scAjaxGetFieldText("total_" + iSeqForm);
    var var_unit_cost_ = scAjaxGetFieldText("unit_cost_" + iSeqForm);
    var var_quantity_ = scAjaxGetFieldText("quantity_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_purchase_detail_event_quantity__onchange(var_total_, var_unit_cost_, var_quantity_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_purchase_detail_event_quantity__onchange_cb);
  } // do_ajax_form_purchase_detail_event_quantity__onchange

  function do_ajax_form_purchase_detail_event_quantity__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_purchase_detail_event_quantity__onchange_cb_after_alert);
  } // do_ajax_form_purchase_detail_event_quantity__onchange_cb
  function do_ajax_form_purchase_detail_event_quantity__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_purchase_detail_event_quantity__onchange_cb_after_alert

  // ---------- Event onchange unit_cost_
  function do_ajax_form_purchase_detail_event_unit_cost__onchange(iSeqForm)
  {
    var var_total_ = scAjaxGetFieldText("total_" + iSeqForm);
    var var_unit_cost_ = scAjaxGetFieldText("unit_cost_" + iSeqForm);
    var var_quantity_ = scAjaxGetFieldText("quantity_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_purchase_detail_event_unit_cost__onchange(var_total_, var_unit_cost_, var_quantity_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_purchase_detail_event_unit_cost__onchange_cb);
  } // do_ajax_form_purchase_detail_event_unit_cost__onchange

  function do_ajax_form_purchase_detail_event_unit_cost__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_purchase_detail_event_unit_cost__onchange_cb_after_alert);
  } // do_ajax_form_purchase_detail_event_unit_cost__onchange_cb
  function do_ajax_form_purchase_detail_event_unit_cost__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_purchase_detail_event_unit_cost__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_purchase_detail_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_purchase_detail_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_purchase_detail_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_purchase_detail_add_new_line_cb);
  } // do_ajax_form_purchase_detail_add_new_line

  function do_ajax_form_purchase_detail_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_purchase_detail_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_purchase_detail_backup_line(iNumLinha)
  {
    var var_id_purchase_detail_ = scAjaxGetFieldHidden("id_purchase_detail_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_purchase_detail_backup_line(var_id_purchase_detail_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_purchase_detail_backup_line_cb);
  } // do_ajax_form_purchase_detail_backup_line

  function do_ajax_form_purchase_detail_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_purchase_detail_backup_line_cb

  function do_ajax_form_purchase_detail_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_purchase_detail_cancel_insert

  function do_ajax_form_purchase_detail_cancel_update(iSeqVert)
  {
    do_ajax_form_purchase_detail_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_purchase_detail_cancel_update

  function do_ajax_form_purchase_detail_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_purchase_detail_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_purchase_detail_table_refresh()
  {
    var var_id_purchase_detail_ = document.F2.id_purchase_detail_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_purchase_detail_table_refresh(var_id_purchase_detail_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_purchase_detail_table_refresh_cb);
  } //  do_ajax_form_purchase_detail_table_refresh

  function do_ajax_form_purchase_detail_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_purchase_detail_.value = scAjaxGetKeyValue("id_purchase_detail_");
    ...
    scAjaxAlert(do_ajax_form_purchase_detail_table_refresh_cb_after_alert);
  } // do_ajax_form_purchase_detail_table_refresh_cb
  function do_ajax_form_purchase_detail_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_purchase_detail_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_purchase_detail_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_purchase_detail_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_id_product_ = scAjaxGetFieldSelect("id_product_" + iNumLinha);
    var var_quantity_ = scAjaxGetFieldText("quantity_" + iNumLinha);
    var var_unit_cost_ = scAjaxGetFieldText("unit_cost_" + iNumLinha);
...
?>
    x_ajax_form_purchase_detail_submit_form(var_id_product_, var_quantity_, var_unit_cost_, var_total_, var_id_purchase_detail_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_purchase_detail_submit_form_cb);
  } // do_ajax_form_purchase_detail_submit_form

  function do_ajax_form_purchase_detail_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_product_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("quantity_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("unit_cost_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("total_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("id_purchase_detail_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_purchase_detail_submit_form_cb_after_alert);
  } // do_ajax_form_purchase_detail_submit_form_cb
  function do_ajax_form_purchase_detail_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_purchase_detail_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_purchase_detail_navigate_form()
  {
    perform_ajax_form_purchase_detail_navigate_form();
  }

  function perform_ajax_form_purchase_detail_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_purchase_detail_cancel_insert(sc_form_purchase_detail_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("id_product_" + iNavForm);
      scAjaxHideErrorDisplay("quantity_" + iNavForm);
      scAjaxHideErrorDisplay("unit_cost_" + iNavForm);
      scAjaxHideErrorDisplay("total_" + iNavForm);
      scAjaxHideErrorDisplay("id_purchase_detail_" + iNavForm);
    }
    var var_id_purchase_detail_ = document.F2.id_purchase_detail_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_purchase_detail_navigate_form(var_id_purchase_detail_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_purchase_detail_navigate_form_cb);
  } // do_ajax_form_purchase_detail_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_purchase_detail']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_purchase_detail_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_purchase_detail_.value = scAjaxGetKeyValue("id_purchase_detail_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_purchase_detail_navigate_form_cb_after_alert);
  } // do_ajax_form_purchase_detail_navigate_form_cb
  function do_ajax_form_purchase_detail_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_purchase_detail_navigate_form_cb_after_alert

    function sc_form_purchase_detail_get_last_line_number()
    {
    ...
    } //sc_form_purchase_detail_get_last_line_number

  function sc_hide_form_purchase_detail_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_product_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "quantity_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "unit_cost_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "total_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_purchase_detail_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_product_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_purchase_detail_fld_id_product'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["quantity_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_purchase_detail_fld_quantity'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["unit_cost_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_purchase_detail_fld_unit_cost'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["id_purchase_detail_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_purchase_detail_fld_id_purchase_detail'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_product_"][iNumLinha] = "id_product_" + iNumLinha;
    ajax_field_mult["quantity_"][iNumLinha] = "quantity_" + iNumLinha;
    ajax_field_mult["unit_cost_"][iNumLinha] = "unit_cost_" + iNumLinha;
    ajax_field_mult["total_"][iNumLinha] = "total_" + iNumLinha;
    ajax_field_mult["id_purchase_detail_"][iNumLinha] = "id_purchase_detail_" + iNumLinha;
    ajax_field_id["id_product_" + iNumLinha] = new Array("hidden_field_label_id_product_", "hidden_field_data_id_product_" + iNumLinha);
    ajax_field_id["quantity_" + iNumLinha] = new Array("hidden_field_label_quantity_", "hidden_field_data_quantity_" + iNumLinha);
    ajax_field_id["unit_cost_" + iNumLinha] = new Array("hidden_field_label_unit_cost_", "hidden_field_data_unit_cost_" + iNumLinha);
    ajax_field_id["total_" + iNumLinha] = new Array("hidden_field_label_total_", "hidden_field_data_total_" + iNumLinha);
    ajax_error_count["id_product_" + iNumLinha] = "off";
    ajax_error_count["quantity_" + iNumLinha] = "off";
    ajax_error_count["unit_cost_" + iNumLinha] = "off";
    ajax_error_count["total_" + iNumLinha] = "off";
    ajax_error_count["id_purchase_detail_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_product_" + iNumLinha] = "off";
    ajax_read_only["quantity_" + iNumLinha] = "off";
    ajax_read_only["unit_cost_" + iNumLinha] = "off";
    ajax_read_only["total_" + iNumLinha] = "off";
    ajax_read_only["id_purchase_detail_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["id_product_" + iNumLinha] = "on";
    ajax_read_only["quantity_" + iNumLinha] = "on";
    ajax_read_only["unit_cost_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["id_product_" + iNumLinha] = null;
    ajax_error_list["quantity_" + iNumLinha] = null;
    ajax_error_list["unit_cost_" + iNumLinha] = null;
    ajax_error_list["total_" + iNumLinha] = null;
    ajax_error_list["id_purchase_detail_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "id_product_": new Array(),
    "quantity_": new Array(),
    "unit_cost_": new Array(),
    "total_": new Array(),
    "id_purchase_detail_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_product_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_product_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_product_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_product_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_product_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["unit_cost_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["unit_cost_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["unit_cost_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["unit_cost_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["unit_cost_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["id_purchase_detail_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_purchase_detail_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_purchase_detail_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_purchase_detail_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_purchase_detail_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_product_'])) ? $this->nmgp_cmp_readonly['id_product_'] : 'off';
?>
    scAjaxFieldRead("id_product_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['unit_cost_'])) ? $this->nmgp_cmp_readonly['unit_cost_'] : 'off';
?>
    scAjaxFieldRead("unit_cost_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_purchase_detail_'])) ? $this->nmgp_cmp_readonly['id_purchase_detail_'] : 'on';
?>
    scAjaxFieldRead("id_purchase_detail_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_product_" + iSeq, "on");
    scAjaxFieldRead("quantity_" + iSeq, "on");
    scAjaxFieldRead("unit_cost_" + iSeq, "on");
    scAjaxFieldRead("total_" + iSeq, "on");
    scAjaxFieldRead("id_purchase_detail_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_product_" + iRow] || "on" == ajax_error_count["quantity_" + iRow] || "on" == ajax_error_count["unit_cost_" + iRow] || "on" == ajax_error_count["total_" + iRow] || "on" == ajax_error_count["id_purchase_detail_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_product_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_quantity_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_unit_cost_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_total_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_purchase_detail_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_product_" + iRow] && "off" == ajax_error_count["quantity_" + iRow] && "off" == ajax_error_count["unit_cost_" + iRow] && "off" == ajax_error_count["total_" + iRow] && "off" == ajax_error_count["id_purchase_detail_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_product_" + iRow] = "off";
        ajax_error_count["quantity_" + iRow] = "off";
        ajax_error_count["unit_cost_" + iRow] = "off";
        ajax_error_count["total_" + iRow] = "off";
        ajax_error_count["id_purchase_detail_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_id_product_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_quantity_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_unit_cost_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_total_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_id_purchase_detail_" + iRow).removeClass("scFormErrorLine");
    }
  }
