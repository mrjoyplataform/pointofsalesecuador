...
<?php
   ...
   function monta_form()
   {
      ...
      { 
          ...
          $menu_default = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['campos_busca']['menu_default']; 
          $menu_default_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['campos_busca']['menu_default_cond']; 
          $idempleado = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['campos_busca']['idempleado']; 
          $idempleado_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['campos_busca']['idempleado_cond']; 
          ...
          $activo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['campos_busca']['activo']; 
          $activo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['campos_busca']['activo_cond']; 
...
<?php
   ...
   function trata_campos()
   {
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['campos_busca']['menu_default'] = $menu_default; 
      if (is_array($menu_default) && !empty($menu_default))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['Grid_search'][$I_Grid]['val'][0] = $menu_default;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['Grid_search'][$I_Grid]['val'][0][0] = $menu_default;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['campos_busca']['menu_default_cond'] = $menu_default_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['Grid_search'][$I_Grid]['cmp'] = "menu_default"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['Grid_search'][$I_Grid]['opc'] = $menu_default_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['grid_pesq']['menu_default'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['campos_busca']['idempleado'] = $idempleado; 
      if (is_array($idempleado) && !empty($idempleado))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['Grid_search'][$I_Grid]['val'][0] = $idempleado;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['Grid_search'][$I_Grid]['val'][0][0] = $idempleado;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['campos_busca']['idempleado_cond'] = $idempleado_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['Grid_search'][$I_Grid]['cmp'] = "idempleado"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['Grid_search'][$I_Grid]['opc'] = $idempleado_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['grid_pesq']['idempleado'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['campos_busca']['activo'] = $activo; 
      if (is_array($activo) && !empty($activo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['Grid_search'][$I_Grid]['val'][0] = $activo;
      }
      elseif ($activo_cond_salva == "nu" || $activo_cond_salva == "nn" || $activo_cond_salva == "ep" || $activo_cond_salva == "ne" || !empty($activo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['Grid_search'][$I_Grid]['val'][0][0] = $activo;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['campos_busca']['activo_cond'] = $activo_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['Grid_search'][$I_Grid]['cmp'] = "activo"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['Grid_search'][$I_Grid]['opc'] = $activo_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['grid_pesq']['activo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_empleados']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
