  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_purchase_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_purchase_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_supplier
  function do_ajax_form_purchase_mob_validate_id_supplier()
  {
    var nomeCampo_id_supplier = "id_supplier";
    var var_id_supplier = scAjaxGetFieldSelect(nomeCampo_id_supplier);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_purchase_mob_validate_id_supplier(var_id_supplier, var_script_case_init, do_ajax_form_purchase_mob_validate_id_supplier_cb);
  } // do_ajax_form_purchase_mob_validate_id_supplier

  function do_ajax_form_purchase_mob_validate_id_supplier_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_supplier";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_purchase_mob_validate_id_supplier_cb

  // ---------- Validate datepurchase
  function do_ajax_form_purchase_mob_validate_datepurchase()
  {
    var nomeCampo_datepurchase = "datepurchase";
    var var_datepurchase = scAjaxGetFieldHidden(nomeCampo_datepurchase);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_purchase_mob_validate_datepurchase(var_datepurchase, var_script_case_init, do_ajax_form_purchase_mob_validate_datepurchase_cb);
  } // do_ajax_form_purchase_mob_validate_datepurchase

  function do_ajax_form_purchase_mob_validate_datepurchase_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "datepurchase";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_purchase_mob_validate_datepurchase_cb

  // ---------- Validate total
  function do_ajax_form_purchase_mob_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldText(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_purchase_mob_validate_total(var_total, var_script_case_init, do_ajax_form_purchase_mob_validate_total_cb);
  } // do_ajax_form_purchase_mob_validate_total

  function do_ajax_form_purchase_mob_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_purchase_mob_validate_total_cb

  // ---------- Validate id_status
  function do_ajax_form_purchase_mob_validate_id_status()
  {
    var nomeCampo_id_status = "id_status";
    var var_id_status = scAjaxGetFieldSelect(nomeCampo_id_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_purchase_mob_validate_id_status(var_id_status, var_script_case_init, do_ajax_form_purchase_mob_validate_id_status_cb);
  } // do_ajax_form_purchase_mob_validate_id_status

  function do_ajax_form_purchase_mob_validate_id_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_purchase_mob_validate_id_status_cb

  // ---------- Validate factura_proveedor
  function do_ajax_form_purchase_mob_validate_factura_proveedor()
  {
    var nomeCampo_factura_proveedor = "factura_proveedor";
    var var_factura_proveedor = scAjaxGetFieldText(nomeCampo_factura_proveedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_purchase_mob_validate_factura_proveedor(var_factura_proveedor, var_script_case_init, do_ajax_form_purchase_mob_validate_factura_proveedor_cb);
  } // do_ajax_form_purchase_mob_validate_factura_proveedor

  function do_ajax_form_purchase_mob_validate_factura_proveedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "factura_proveedor";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_purchase_mob_validate_factura_proveedor_cb

  // ---------- Validate comment
  function do_ajax_form_purchase_mob_validate_comment()
  {
    var nomeCampo_comment = "comment";
    var var_comment = scAjaxGetFieldText(nomeCampo_comment);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_purchase_mob_validate_comment(var_comment, var_script_case_init, do_ajax_form_purchase_mob_validate_comment_cb);
  } // do_ajax_form_purchase_mob_validate_comment

  function do_ajax_form_purchase_mob_validate_comment_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "comment";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_purchase_mob_validate_comment_cb

  // ---------- Validate detail
  function do_ajax_form_purchase_mob_validate_detail()
  {
    var nomeCampo_detail = "detail";
    var var_detail = scAjaxGetFieldText(nomeCampo_detail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_purchase_mob_validate_detail(var_detail, var_script_case_init, do_ajax_form_purchase_mob_validate_detail_cb);
  } // do_ajax_form_purchase_mob_validate_detail

  function do_ajax_form_purchase_mob_validate_detail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detail";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_purchase_mob_validate_detail_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_purchase_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_purchase_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_supplier = scAjaxGetFieldSelect("id_supplier");
    var var_datepurchase = scAjaxGetFieldHidden("datepurchase");
    var var_total = scAjaxGetFieldText("total");
    var var_id_status = scAjaxGetFieldSelect("id_status");
    var var_factura_proveedor = scAjaxGetFieldText("factura_proveedor");
    var var_comment = scAjaxGetFieldText("comment");
    var var_id_purchase = scAjaxGetFieldText("id_purchase");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_purchase_mob_submit_form(var_id_supplier, var_datepurchase, var_total, var_id_status, var_factura_proveedor, var_comment, var_id_purchase, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_purchase_mob_submit_form_cb);
  } // do_ajax_form_purchase_mob_submit_form

  function do_ajax_form_purchase_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_supplier");
      scAjaxHideErrorDisplay("datepurchase");
      scAjaxHideErrorDisplay("total");
      scAjaxHideErrorDisplay("id_status");
      scAjaxHideErrorDisplay("factura_proveedor");
      scAjaxHideErrorDisplay("comment");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_purchase_mob_submit_form_cb_after_alert);
  } // do_ajax_form_purchase_mob_submit_form_cb
  function do_ajax_form_purchase_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_purchase_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_purchase_detail_mob"] = "off";

  function do_ajax_form_purchase_mob_navigate_form()
  {
    perform_ajax_form_purchase_mob_navigate_form();
  }

  function perform_ajax_form_purchase_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("comment");
    scAjaxHideErrorDisplay("detail");
    var var_id_purchase = document.F2.id_purchase.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_purchase_detail_mob"] = "on";
    x_ajax_form_purchase_mob_navigate_form(var_id_purchase, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_purchase_mob_navigate_form_cb);
  } // do_ajax_form_purchase_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_purchase_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_purchase_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_purchase.value = scAjaxGetKeyValue("id_purchase");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_purchase_detail_mob"] && "nmsc_iframe_liga_form_purchase_detail_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_purchase_detail_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_purchase_detail_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_purchase_detail_mob').contentWindow.nm_move('apl_detalhe', true, '400');
        document.getElementById('nmsc_iframe_liga_form_purchase_detail_mob').style.height = "400";
        document.getElementById('nmsc_iframe_liga_form_purchase_detail_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_purchase_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_purchase_mob_navigate_form_cb
  function do_ajax_form_purchase_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_purchase_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_purchase_mob_navigate_form_cb_after_alert

  function sc_hide_form_purchase_mob_form()
  {
  ...
  function do_ajax_form_purchase_mob_lkpedt_refresh_id_supplier()
  {
    var var_id_supplier = scAjaxGetFieldSelect("id_supplier");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_supplier";
    x_ajax_form_purchase_mob_lkpedt_refresh_id_supplier(var_id_supplier, nmgp_refresh_fields, var_script_case_init, do_ajax_form_purchase_mob_lkpedt_refresh_id_supplier_cb);
  } // do_ajax_form_purchase_mob_lkpedt_refresh_id_supplier

  function do_ajax_form_purchase_mob_lkpedt_refresh_id_supplier_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_purchase_mob_lkpedt_refresh_id_supplier_cb
  ...
  {
    if ("off" == scStatusDetail["form_purchase_detail_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "id_supplier";
  ajax_field_list[1] = "datepurchase";
  ajax_field_list[2] = "total";
  ajax_field_list[3] = "id_status";
  ajax_field_list[4] = "factura_proveedor";
  ajax_field_list[5] = "comment";
  ...
  var ajax_error_list = {
    "id_supplier": {"label": "<?php echo $this->Ini->Nm_lang['lang_purchase_fld_id_supplier'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "datepurchase": {"label": "<?php echo $this->Ini->Nm_lang['lang_purchase_fld_datepurchase'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "total": {"label": "<?php echo $this->Ini->Nm_lang['lang_purchase_fld_total'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_status": {"label": "<?php echo $this->Ini->Nm_lang['lang_purchase_fld_id_status'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "factura_proveedor": {"label": "Factura Proveedor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "comment": {"label": "Comentario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "id_supplier": new Array(),
    "datepurchase": new Array(),
    "total": new Array(),
    "id_status": new Array(),
    "factura_proveedor": new Array(),
    "comment": new Array(),
    "detail": new Array()
  };
  ajax_field_mult["id_supplier"][1] = "id_supplier";
  ajax_field_mult["datepurchase"][1] = "datepurchase";
  ajax_field_mult["total"][1] = "total";
  ajax_field_mult["id_status"][1] = "id_status";
  ajax_field_mult["factura_proveedor"][1] = "factura_proveedor";
  ajax_field_mult["comment"][1] = "comment";
  ajax_field_mult["detail"][1] = "detail";

  var ajax_field_id = {
    "id_supplier": new Array("hidden_field_label_id_supplier", "hidden_field_data_id_supplier"),
    "datepurchase": new Array("hidden_field_label_datepurchase", "hidden_field_data_datepurchase"),
    "total": new Array("hidden_field_label_total", "hidden_field_data_total"),
    "factura_proveedor": new Array("hidden_field_label_factura_proveedor", "hidden_field_data_factura_proveedor"),
    "comment": new Array("hidden_field_label_comment", "hidden_field_data_comment"),
