...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_datepurchase_hora' + iSeqRow).bind('blur', function() { sc_form_purchase_datepurchase_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_purchase_datepurchase_onfocus(this, iSeqRow) });
...
function displayChange_field_detail(row, status) {
    var fieldId;
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_purchase_detail_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_purchase_detail_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_purchase_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_datepurchase" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_purchase_mob_validate_datepurchase(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_purchase_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
