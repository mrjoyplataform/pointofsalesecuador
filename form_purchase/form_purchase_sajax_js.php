  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_purchase" == sTestField)
        {
...
?>
  ...
  function do_ajax_form_purchase_validate_id_supplier()
  {
    var nomeCampo_id_supplier = "id_supplier";
    var var_id_supplier = scAjaxGetFieldSelect(nomeCampo_id_supplier);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_purchase_validate_id_supplier(var_id_supplier, var_script_case_init, do_ajax_form_purchase_validate_id_supplier_cb);
  } // do_ajax_form_purchase_validate_id_supplier

  function do_ajax_form_purchase_validate_id_supplier_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_purchase_validate_id_supplier_cb

  // ---------- Validate datepurchase
  function do_ajax_form_purchase_validate_datepurchase()
  {
    var nomeCampo_datepurchase = "datepurchase";
    var var_datepurchase = scAjaxGetFieldHidden(nomeCampo_datepurchase);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_purchase_validate_datepurchase(var_datepurchase, var_script_case_init, do_ajax_form_purchase_validate_datepurchase_cb);
  } // do_ajax_form_purchase_validate_datepurchase

  function do_ajax_form_purchase_validate_datepurchase_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_purchase_validate_datepurchase_cb

  // ---------- Validate total
  function do_ajax_form_purchase_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldText(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_purchase_validate_total(var_total, var_script_case_init, do_ajax_form_purchase_validate_total_cb);
  } // do_ajax_form_purchase_validate_total

  function do_ajax_form_purchase_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_purchase_validate_total_cb

  // ---------- Validate id_status
  function do_ajax_form_purchase_validate_id_status()
  {
    var nomeCampo_id_status = "id_status";
    var var_id_status = scAjaxGetFieldSelect(nomeCampo_id_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_purchase_validate_id_status(var_id_status, var_script_case_init, do_ajax_form_purchase_validate_id_status_cb);
  } // do_ajax_form_purchase_validate_id_status

  function do_ajax_form_purchase_validate_id_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_purchase_validate_id_status_cb

  // ---------- Validate factura_proveedor
  function do_ajax_form_purchase_validate_factura_proveedor()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_purchase_validate_factura_proveedor(var_factura_proveedor, var_script_case_init, do_ajax_form_purchase_validate_factura_proveedor_cb);
  } // do_ajax_form_purchase_validate_factura_proveedor

  function do_ajax_form_purchase_validate_factura_proveedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_purchase_validate_factura_proveedor_cb

  // ---------- Validate comment
  function do_ajax_form_purchase_validate_comment()
  {
    var nomeCampo_comment = "comment";
    var var_comment = scAjaxGetFieldText(nomeCampo_comment);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_purchase_validate_comment(var_comment, var_script_case_init, do_ajax_form_purchase_validate_comment_cb);
  } // do_ajax_form_purchase_validate_comment

  function do_ajax_form_purchase_validate_comment_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "comment";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_purchase_validate_comment_cb

  // ---------- Validate detail
  function do_ajax_form_purchase_validate_detail()
  {
    var nomeCampo_detail = "detail";
    var var_detail = scAjaxGetFieldText(nomeCampo_detail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_purchase_validate_detail(var_detail, var_script_case_init, do_ajax_form_purchase_validate_detail_cb);
  } // do_ajax_form_purchase_validate_detail

  function do_ajax_form_purchase_validate_detail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detail";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_purchase_validate_detail_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_purchase_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_purchase_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_purchase_submit_form(var_id_supplier, var_datepurchase, var_total, var_id_status, var_factura_proveedor, var_comment, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_purchase_submit_form_cb);
  } // do_ajax_form_purchase_submit_form

  function do_ajax_form_purchase_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_purchase_submit_form_cb_after_alert);
  } // do_ajax_form_purchase_submit_form_cb
  function do_ajax_form_purchase_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_purchase_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_purchase_detail"] = "off";

  function do_ajax_form_purchase_navigate_form()
  {
    perform_ajax_form_purchase_navigate_form();
  }

  function perform_ajax_form_purchase_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_purchase_detail"] = "on";
    x_ajax_form_purchase_navigate_form(var_id_purchase, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_purchase_navigate_form_cb);
  } // do_ajax_form_purchase_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_purchase']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_purchase_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_purchase_detail"] && "nmsc_iframe_liga_form_purchase_detail" != scMasterDetailIframe["nmsc_iframe_liga_form_purchase_detail"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_purchase_detail"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_purchase_detail').contentWindow.nm_move('apl_detalhe', true, '400');
        document.getElementById('nmsc_iframe_liga_form_purchase_detail').style.height = "400";
        document.getElementById('nmsc_iframe_liga_form_purchase_detail').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_purchase_navigate_form_cb_after_alert);
  } // do_ajax_form_purchase_navigate_form_cb
  function do_ajax_form_purchase_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_purchase_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_purchase_navigate_form_cb_after_alert

  function sc_hide_form_purchase_form()
  {
  ...
  function do_ajax_form_purchase_lkpedt_refresh_id_supplier()
  {
    var var_id_supplier = scAjaxGetFieldSelect("id_supplier");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_supplier";
    x_ajax_form_purchase_lkpedt_refresh_id_supplier(var_id_supplier, nmgp_refresh_fields, var_script_case_init, do_ajax_form_purchase_lkpedt_refresh_id_supplier_cb);
  } // do_ajax_form_purchase_lkpedt_refresh_id_supplier

  function do_ajax_form_purchase_lkpedt_refresh_id_supplier_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_purchase_lkpedt_refresh_id_supplier_cb
  ...
  {
    if ("off" == scStatusDetail["form_purchase_detail"])
    {
      return true;
    }
    return false;
