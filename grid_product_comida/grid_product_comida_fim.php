...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_product_comida"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_product_comida"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_product_comida']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_product_comida']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_product_comida']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_product_comida']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_product_comida']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_product_comida</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_product_comida']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_product_comida']['embutida_filho'] as $ind => $sc_init)
          {
