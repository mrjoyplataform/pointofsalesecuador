  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ele_parametros" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_ele_parametros_form();
	}
...
?>
  ...
  // ---------- Validate id_
  function do_ajax_form_ele_parametros_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldText(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ele_parametros_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_ele_parametros_validate_id__cb);
  } // do_ajax_form_ele_parametros_validate_id_

  function do_ajax_form_ele_parametros_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ele_parametros_validate_id__cb

  // ---------- Validate nombre_
  function do_ajax_form_ele_parametros_validate_nombre_(iNumLinha)
  {
    var nomeCampo_nombre_ = "nombre_" + iNumLinha;
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ele_parametros_validate_nombre_(var_nombre_, iNumLinha, var_script_case_init, do_ajax_form_ele_parametros_validate_nombre__cb);
  } // do_ajax_form_ele_parametros_validate_nombre_

  function do_ajax_form_ele_parametros_validate_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ele_parametros_validate_nombre__cb

  // ---------- Validate valor_
  function do_ajax_form_ele_parametros_validate_valor_(iNumLinha)
  {
    var nomeCampo_valor_ = "valor_" + iNumLinha;
    var var_valor_ = scAjaxGetFieldText(nomeCampo_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ele_parametros_validate_valor_(var_valor_, iNumLinha, var_script_case_init, do_ajax_form_ele_parametros_validate_valor__cb);
  } // do_ajax_form_ele_parametros_validate_valor_

  function do_ajax_form_ele_parametros_validate_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ele_parametros_validate_valor__cb

  // ---------- Validate observacion_
  function do_ajax_form_ele_parametros_validate_observacion_(iNumLinha)
  {
    var nomeCampo_observacion_ = "observacion_" + iNumLinha;
    var var_observacion_ = scAjaxGetFieldText(nomeCampo_observacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ele_parametros_validate_observacion_(var_observacion_, iNumLinha, var_script_case_init, do_ajax_form_ele_parametros_validate_observacion__cb);
  } // do_ajax_form_ele_parametros_validate_observacion_

  function do_ajax_form_ele_parametros_validate_observacion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ele_parametros_validate_observacion__cb

  // ---------- Validate estado_
  function do_ajax_form_ele_parametros_validate_estado_(iNumLinha)
  {
    var nomeCampo_estado_ = "estado_" + iNumLinha;
    var var_estado_ = scAjaxGetFieldText(nomeCampo_estado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ele_parametros_validate_estado_(var_estado_, iNumLinha, var_script_case_init, do_ajax_form_ele_parametros_validate_estado__cb);
  } // do_ajax_form_ele_parametros_validate_estado_

  function do_ajax_form_ele_parametros_validate_estado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ele_parametros_validate_estado__cb

  // ---------- Validate tipo_
  function do_ajax_form_ele_parametros_validate_tipo_(iNumLinha)
  {
    var nomeCampo_tipo_ = "tipo_" + iNumLinha;
    var var_tipo_ = scAjaxGetFieldText(nomeCampo_tipo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ele_parametros_validate_tipo_(var_tipo_, iNumLinha, var_script_case_init, do_ajax_form_ele_parametros_validate_tipo__cb);
  } // do_ajax_form_ele_parametros_validate_tipo_

  function do_ajax_form_ele_parametros_validate_tipo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ele_parametros_validate_tipo__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_ele_parametros_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_ele_parametros_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_ele_parametros_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_ele_parametros_add_new_line_cb);
  } // do_ajax_form_ele_parametros_add_new_line

  function do_ajax_form_ele_parametros_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_ele_parametros_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_ele_parametros_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ele_parametros_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_ele_parametros_backup_line_cb);
  } // do_ajax_form_ele_parametros_backup_line

  function do_ajax_form_ele_parametros_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_ele_parametros_backup_line_cb

  function do_ajax_form_ele_parametros_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_ele_parametros_cancel_insert

  function do_ajax_form_ele_parametros_cancel_update(iSeqVert)
  {
    do_ajax_form_ele_parametros_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_ele_parametros_cancel_update

  function do_ajax_form_ele_parametros_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_ele_parametros_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_ele_parametros_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_ele_parametros_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ele_parametros_table_refresh_cb);
  } //  do_ajax_form_ele_parametros_table_refresh

  function do_ajax_form_ele_parametros_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_ele_parametros_table_refresh_cb_after_alert);
  } // do_ajax_form_ele_parametros_table_refresh_cb
  function do_ajax_form_ele_parametros_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_ele_parametros_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_ele_parametros_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_ele_parametros_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_ele_parametros_submit_form(var_id_, var_nombre_, var_valor_, var_observacion_, var_estado_, var_tipo_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ele_parametros_submit_form_cb);
  } // do_ajax_form_ele_parametros_submit_form

  function do_ajax_form_ele_parametros_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_ele_parametros_submit_form_cb_after_alert);
  } // do_ajax_form_ele_parametros_submit_form_cb
  function do_ajax_form_ele_parametros_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ele_parametros_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_ele_parametros_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_ele_parametros_navigate_form, function() {});
    } else {
      perform_ajax_form_ele_parametros_navigate_form();
    }
  }

  function perform_ajax_form_ele_parametros_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_ele_parametros_cancel_insert(sc_form_ele_parametros_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_ele_parametros_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ele_parametros_navigate_form_cb);
  } // do_ajax_form_ele_parametros_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ele_parametros']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ele_parametros_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ele_parametros_navigate_form_cb_after_alert);
  } // do_ajax_form_ele_parametros_navigate_form_cb
  function do_ajax_form_ele_parametros_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_ele_parametros_navigate_form_cb_after_alert

    function sc_form_ele_parametros_get_last_line_number()
    {
    ...
    } //sc_form_ele_parametros_get_last_line_number

  function sc_hide_form_ele_parametros_form()
  {
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["nombre_" + iRow] || "on" == ajax_error_count["valor_" + iRow] || "on" == ajax_error_count["observacion_" + iRow] || "on" == ajax_error_count["estado_" + iRow] || "on" == ajax_error_count["tipo_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["nombre_" + iRow] && "off" == ajax_error_count["valor_" + iRow] && "off" == ajax_error_count["observacion_" + iRow] && "off" == ajax_error_count["estado_" + iRow] && "off" == ajax_error_count["tipo_" + iRow]))
    {
      if (bErrorRow)
      {
