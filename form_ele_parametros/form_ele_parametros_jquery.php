...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_' + iSeqRow).bind('blur', function() { sc_form_ele_parametros_id__onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_form_ele_parametros_id__onchange(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_ele_parametros_id__onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre_' + iSeqRow).bind('blur', function() { sc_form_ele_parametros_nombre__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_ele_parametros_nombre__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_ele_parametros_nombre__onfocus(this, iSeqRow) });
  $('#id_sc_field_valor_' + iSeqRow).bind('blur', function() { sc_form_ele_parametros_valor__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_ele_parametros_valor__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_ele_parametros_valor__onfocus(this, iSeqRow) });
  $('#id_sc_field_observacion_' + iSeqRow).bind('blur', function() { sc_form_ele_parametros_observacion__onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_ele_parametros_observacion__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_ele_parametros_observacion__onfocus(this, iSeqRow) });
  $('#id_sc_field_estado_' + iSeqRow).bind('blur', function() { sc_form_ele_parametros_estado__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_ele_parametros_estado__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_ele_parametros_estado__onfocus(this, iSeqRow) });
  $('#id_sc_field_tipo_' + iSeqRow).bind('blur', function() { sc_form_ele_parametros_tipo__onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_ele_parametros_tipo__onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_ele_parametros_tipo__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_ele_parametros_id__onblur(oThis, iSeqRow) {
  do_ajax_form_ele_parametros_validate_id_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_ele_parametros_id__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_ele_parametros_id__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_ele_parametros_nombre__onblur(oThis, iSeqRow) {
  do_ajax_form_ele_parametros_validate_nombre_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_ele_parametros_nombre__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_ele_parametros_nombre__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_ele_parametros_valor__onblur(oThis, iSeqRow) {
  do_ajax_form_ele_parametros_validate_valor_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_ele_parametros_valor__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_ele_parametros_valor__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_ele_parametros_observacion__onblur(oThis, iSeqRow) {
  do_ajax_form_ele_parametros_validate_observacion_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_ele_parametros_observacion__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_ele_parametros_observacion__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_ele_parametros_estado__onblur(oThis, iSeqRow) {
  do_ajax_form_ele_parametros_validate_estado_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_ele_parametros_estado__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_ele_parametros_estado__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_ele_parametros_tipo__onblur(oThis, iSeqRow) {
  do_ajax_form_ele_parametros_validate_tipo_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_ele_parametros_tipo__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_ele_parametros_tipo__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function scHidePage(pageNo) {
	$("#id_form_ele_parametros_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_ele_parametros')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
