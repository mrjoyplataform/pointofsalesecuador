...
class grid_v_ele_reporte_facturas_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_v_ele_reporte_facturas/grid_v_ele_reporte_facturas_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new grid_v_ele_reporte_facturas_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_v_ele_reporte_facturas.zip";
          $this->Arquivo   .= "_grid_v_ele_reporte_facturas" . $this->Xls_tp;
          $this->Tit_doc    = "grid_v_ele_reporte_facturas" . $this->Xls_tp;
          $this->Tit_zip    = "grid_v_ele_reporte_facturas.zip";
      ...
      require_once($this->Ini->path_aplicacao . "grid_v_ele_reporte_facturas_total.class.php"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['where_pesq'];
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['order_grid'];
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_total_sin_iva()
   {
         ...
         if (is_numeric($this->total_sin_iva))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->total_sin_iva);
         $this->Xls_col++;
   }
   //----- total_con_iva
   function NM_export_total_con_iva()
   {
         ...
         if (is_numeric($this->total_con_iva))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->total_con_iva);
         $this->Xls_col++;
   }
   //----- iva
   ...
   function NM_export_ice()
   {
         ...
         if (is_numeric($this->ice))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->ice);
         $this->Xls_col++;
   }
   //----- descuentos
   ...
   function NM_export_correo_electronico()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->correo_electronico, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->correo_electronico, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- id
   ...
   //----- total_sin_iva
   function NM_sub_cons_total_sin_iva()
   {
         $this->total_sin_iva = NM_charset_to_utf8($this->total_sin_iva);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->total_sin_iva;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- total_con_iva
   function NM_sub_cons_total_con_iva()
   {
         $this->total_con_iva = NM_charset_to_utf8($this->total_con_iva);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->total_con_iva;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- ice
   function NM_sub_cons_ice()
   {
         $this->ice = NM_charset_to_utf8($this->ice);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->ice;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- correo_electronico
   function NM_sub_cons_correo_electronico()
   {
         $this->correo_electronico = html_entity_decode($this->correo_electronico, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->correo_electronico = strip_tags($this->correo_electronico);
         $this->correo_electronico = NM_charset_to_utf8($this->correo_electronico);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->correo_electronico;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE>REPORTE DE FACTURAS :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_v_ele_reporte_facturas']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
