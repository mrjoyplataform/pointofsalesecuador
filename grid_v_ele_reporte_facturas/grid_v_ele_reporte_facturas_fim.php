...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_v_ele_reporte_facturas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_v_ele_reporte_facturas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_ele_reporte_facturas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_v_ele_reporte_facturas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_v_ele_reporte_facturas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_v_ele_reporte_facturas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_v_ele_reporte_facturas']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_v_ele_reporte_facturas</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_v_ele_reporte_facturas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_v_ele_reporte_facturas']['embutida_filho'] as $ind => $sc_init)
          {
