...
class grid_reporte_sales_contab_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_reporte_sales_contab']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_reporte_sales_contab']['campos_busca']))
      { 
   ...
   function quebra_geral_sc_free_group_by($res_limit=false)
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(item_total), sum(valor_siniva) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['tot_geral'][2] = $rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $rt->fields[2] = (string)$rt->fields[2]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['tot_geral'][3] = $rt->fields[2]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['contr_total_geral'] = "OK";
   } 
   ...
   function quebra_geral_datesales_sucursal_cuentaventa_producto($res_limit=false)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(valor_siniva) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['where_pesq']; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(valor_siniva) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['where_pesq']; 
   ...
   function quebra_geral__NM_SC_($res_limit=false)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['where_pesq']; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['where_pesq']; 
   ...
   //-----  sucursal
   function quebra_sucursal_datesales_sucursal_cuentaventa_producto($sucursal, $arg_sum_sucursal) 
   {
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['where_pesq'])) 
      { 
         $nm_comando .= " where sucursal" . $arg_sum_sucursal ; 
      } 
      else 
      { 
         $nm_comando .= " and sucursal" . $arg_sum_sucursal ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
   ...
   //-----  datesales
   function quebra_datesales_datesales_sucursal_cuentaventa_producto($sucursal, $datesales, $arg_sum_sucursal, $arg_sum_datesales) 
   {
      global $tot_datesales, $cuentaventa;
      $tot_datesales = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(valor_siniva) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['where_pesq']; 
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['where_pesq'])) 
      { 
         $nm_comando .= " where sucursal" . $arg_sum_sucursal . " and " .  $this->Sc_groupby_datesales . $arg_sum_datesales ; 
      } 
      else 
      { 
         $nm_comando .= " and sucursal" . $arg_sum_sucursal . " and " .  $this->Sc_groupby_datesales . $arg_sum_datesales ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
   ...
   //-----  cuentaventa
   function quebra_cuentaventa_datesales_sucursal_cuentaventa_producto($sucursal, $datesales, $cuentaventa, $arg_sum_sucursal, $arg_sum_datesales, $arg_sum_cuentaventa) 
   {
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['where_pesq'])) 
      { 
         $nm_comando .= " where sucursal" . $arg_sum_sucursal . " and " .  $this->Sc_groupby_datesales . $arg_sum_datesales . " and cuentaventa" . $arg_sum_cuentaventa ; 
      } 
      else 
      { 
         $nm_comando .= " and sucursal" . $arg_sum_sucursal . " and " .  $this->Sc_groupby_datesales . $arg_sum_datesales . " and cuentaventa" . $arg_sum_cuentaventa ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
   ...
   function Calc_resumo_sc_free_group_by($destino_resumo)
   {
      ...
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['SC_Ind_Groupby'];
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['SC_Gb_Free_cmp'] as $cmp => $resto)
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_sc_free_group_by($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
         $cmd_simp = "select count(*), sum(item_total), sum(valor_siniva)#@#cmps_quebras#@# from " . $this->Ini->nm_tabela . " " . $where_ok;
         $comando  = "select count(*), sum(SC_metric1), sum(SC_metric2)#@#cmps_quebras#@# from (";
         $comando .= "select item_total as SC_metric1,valor_siniva as SC_metric2, " . $cmps_quebras1 . " from " . $this->Ini->nm_tabela . " " .  $where_ok . ") SC_sel1 INNER JOIN (";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
   ...
   function Calc_resumo_datesales_sucursal_cuentaventa_producto($destino_resumo)
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['where_pesq'];
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('sucursal' => "sucursal",'datesales' => "datesales",'cuentaventa' => "cuentaventa");
      $cmps_quebra_atual = array("sucursal","datesales","cuentaventa");
      $ult_cmp_quebra_atual = $cmps_quebra_atual[(count($cmps_quebra_atual) - 1)];
      $arr_tots = "";
      $join     = "";
      $group    = "";
   ...
   function Res_Totaliza_datesales_sucursal_cuentaventa_producto($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
         $cmd_simp = "select count(*), sum(valor_siniva)#@#cmps_quebras#@# from " . $this->Ini->nm_tabela . " " . $where_ok;
         $comando  = "select count(*), sum(SC_metric1)#@#cmps_quebras#@# from (";
         $comando .= "select valor_siniva as SC_metric1, " . $cmps_quebras1 . " from " . $this->Ini->nm_tabela . " " .  $where_ok . ") SC_sel1 INNER JOIN (";
         $comando .= "select " . $cmps_quebras2 . " from " . $this->Ini->nm_tabela . " " .  $where_ok . " group by " . $group . $sc_having . ") SC_sel2 ";
         $comando .= " ON " . $join;
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      ...
      $format_dimensions['sucursal']['reg'] = "S";
      $format_dimensions['sucursal']['msk'] = "";
      $format_dimensions['datesales']['reg'] = "N";
      $format_dimensions['datesales']['msk'] = "F/Y";
      $format_dimensions['cuentaventa']['reg'] = "S";
      $format_dimensions['cuentaventa']['msk'] = "";
      while (!$rt->EOF)
      {
          ...
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              ...
              if ($Cada_dim == "cuentaventa") {
                  $this->Lookup->lookup_datesales_sucursal_cuentaventa_producto_cuentaventa($$Cada_dim,  $cuentaventa);
              }
              if (null === $$Cada_dim)
              {
                  $$Cada_dim = '';
