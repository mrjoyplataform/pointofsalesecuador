...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_reporte_sales_contab"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_reporte_sales_contab"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_sales_contab']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_reporte_sales_contab']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_sales_contab']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_reporte_sales_contab']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_reporte_sales_contab']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_reporte_sales_contab</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_sales_contab']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_reporte_sales_contab']['embutida_filho'] as $ind => $sc_init)
          {
