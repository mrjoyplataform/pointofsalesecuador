...
class grid_reporte_sales_contab_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_sucursal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['sucursal'];
          $this->array_total_datesales = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['datesales'];
          $this->array_total_cuentaventa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['cuentaventa'];
      }
      else
      {
          $this->array_total_sucursal = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['tot_geral'][2];
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['summarizing_fields_order']['datesales_sucursal_cuentaventa_producto']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['summarizing_fields_order']['datesales_sucursal_cuentaventa_producto'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['summarizing_fields_order']['datesales_sucursal_cuentaventa_producto'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['summarizing_fields_display']['datesales_sucursal_cuentaventa_producto'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['summarizing_fields_display']['datesales_sucursal_cuentaventa_producto'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['summarizing_fields_display']['datesales_sucursal_cuentaventa_producto'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['summarizing_fields_display']['datesales_sucursal_cuentaventa_producto'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['summarizing_fields_display']['datesales_sucursal_cuentaventa_producto'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['summarizing_fields_display']['datesales_sucursal_cuentaventa_producto'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['summarizing_fields_display']['datesales_sucursal_cuentaventa_producto'] as $i_sum => $d_sum)
           {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order_level'] = -1;
       }
