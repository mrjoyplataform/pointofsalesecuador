...
class grid_reporte_sales_contab_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['dashboard_info']['under_dashboard'] ? "off" : "on";

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_reporte_sales_contab'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_reporte_sales_contab'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_sales_contab']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_sales_contab']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_sales_contab']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_reporte_sales_contab']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_reporte_sales_contab']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['campos_busca'];
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pesq_tab_label']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pesq_tab_label'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pesq_tab_label'] .= "datesales?#?" . "Datesales" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pesq_tab_label'] .= "sucursal?#?" . "Sucursal" . "?@?";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pesq_tab_label'] .= "cuentaventa?#?" . "Cuentaventa" . "?@?";
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['grid_search_add']))
      {
          $this->monta_css();
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pesq_tab_label'];
          ...
          $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['grid_search_add']['seq'];
          $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['grid_search_add']['cmp'];
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['grid_search_add']);
          exit;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['dyn_search_ch_bi']))
      {
          ob_start();
          $tmp_opc = $opc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['dyn_search_ch_bi']['opc'];
          $this->Ini->process_cond_bi($opc, $bi_dt1, $bi_dt2);
          $NM_func_dyn_ch_bi = "formata_bi_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['dyn_search_ch_bi']['cmp'];
          ...
          $oJson = new Services_JSON();
          echo $oJson->encode($this->Arr_result);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['dyn_search_ch_bi']);
          exit;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['opcao'] != "pdf")
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              $Arr_tot_name = "array_total_" . $cmp_gb;
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['tot_geral'][3];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['sucursal'] = $this->array_total_sucursal;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['cuentaventa'] = $this->array_total_cuentaventa;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['jugador'] = $this->array_total_jugador;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['visitante'] = $this->array_total_visitante;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['entrada'] = $this->array_total_entrada;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['comida'] = $this->array_total_comida;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['producto'] = $this->array_total_producto;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['codproducto'] = $this->array_total_codproducto;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['idcliente'] = $this->array_total_idcliente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['datesales'] = $this->array_total_datesales;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['datesales_scgb_192'] = $this->array_total_datesales_scgb_192;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['datesales_scgb_203'] = $this->array_total_datesales_scgb_203;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['datesales_scgb_193'] = $this->array_total_datesales_scgb_193;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['datesales_scgb_195'] = $this->array_total_datesales_scgb_195;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['datesales_scgb_196'] = $this->array_total_datesales_scgb_196;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['datesales_scgb_197'] = $this->array_total_datesales_scgb_197;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['datesales_scgb_198'] = $this->array_total_datesales_scgb_198;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['datesales_scgb_199'] = $this->array_total_datesales_scgb_199;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['datesales_scgb_200'] = $this->array_total_datesales_scgb_200;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['datesales_scgb_201'] = $this->array_total_datesales_scgb_201;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['datesales_scgb_202'] = $this->array_total_datesales_scgb_202;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['datesales_scgb_204'] = $this->array_total_datesales_scgb_204;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total']['datesales_scgb_194'] = $this->array_total_datesales_scgb_194;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['json_use_label'])
       {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['sucursal'] = $Lab_sucursal; 
       $prep_field['cuentaventa'] = $Lab_cuentaventa;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['cuentaventa'] = $Lab_cuentaventa; 
       $prep_field['jugador'] = $Lab_jugador;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['jugador'] = $Lab_jugador; 
       $prep_field['visitante'] = $Lab_visitante;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['visitante'] = $Lab_visitante; 
       $prep_field['entrada'] = $Lab_entrada;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['entrada'] = $Lab_entrada; 
       $prep_field['comida'] = $Lab_comida;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['comida'] = $Lab_comida; 
       $prep_field['producto'] = $Lab_producto;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['producto'] = $Lab_producto; 
       $prep_field['codproducto'] = $Lab_codproducto;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['codproducto'] = $Lab_codproducto; 
       $prep_field['idcliente'] = $Lab_idcliente;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['idcliente'] = $Lab_idcliente; 
       $prep_field['datesales'] = $Lab_datesales;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales'] = $Lab_datesales; 
       $prep_field['datesales_scgb_192'] = $Lab_datesales_scgb_192;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_192'] = $Lab_datesales_scgb_192; 
       $prep_field['datesales_scgb_203'] = $Lab_datesales_scgb_203;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_203'] = $Lab_datesales_scgb_203; 
       $prep_field['datesales_scgb_193'] = $Lab_datesales_scgb_193;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_193'] = $Lab_datesales_scgb_193; 
       $prep_field['datesales_scgb_195'] = $Lab_datesales_scgb_195;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_195'] = $Lab_datesales_scgb_195; 
       $prep_field['datesales_scgb_196'] = $Lab_datesales_scgb_196;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_196'] = $Lab_datesales_scgb_196; 
       $prep_field['datesales_scgb_197'] = $Lab_datesales_scgb_197;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_197'] = $Lab_datesales_scgb_197; 
       $prep_field['datesales_scgb_198'] = $Lab_datesales_scgb_198;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_198'] = $Lab_datesales_scgb_198; 
       $prep_field['datesales_scgb_199'] = $Lab_datesales_scgb_199;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_199'] = $Lab_datesales_scgb_199; 
       $prep_field['datesales_scgb_200'] = $Lab_datesales_scgb_200;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_200'] = $Lab_datesales_scgb_200; 
       $prep_field['datesales_scgb_201'] = $Lab_datesales_scgb_201;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_201'] = $Lab_datesales_scgb_201; 
       $prep_field['datesales_scgb_202'] = $Lab_datesales_scgb_202;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_202'] = $Lab_datesales_scgb_202; 
       $prep_field['datesales_scgb_204'] = $Lab_datesales_scgb_204;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_204'] = $Lab_datesales_scgb_204; 
       $prep_field['datesales_scgb_194'] = $Lab_datesales_scgb_194;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_194'] = $Lab_datesales_scgb_194; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['id_sales_detail']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['id_sales_detail'] = "Id Sales Detail"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['unit_cost']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['unit_cost'] = "Unit Cost"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['unit_value']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['unit_value'] = "Unit Value"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['quantity']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['quantity'] = "Quantity"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['discount']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['discount'] = "Discount"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['item_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['item_total'] = "Item Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['id_product']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['id_product'] = "Id Product"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['uniqueidtrans']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['uniqueidtrans'] = "Uniqueidtrans"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['fechatrans']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['fechatrans'] = "Fechatrans"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['valor_siniva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['valor_siniva'] = "Valor Siniva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['valor_unitario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['valor_unitario'] = "Valor Unitario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['codproducto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['codproducto'] = "Codproducto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['producto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['producto'] = "Producto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['entrada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['entrada'] = "Entrada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['jugador']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['jugador'] = "Jugador"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['visitante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['visitante'] = "Visitante"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['tarjeta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['tarjeta'] = "Tarjeta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['tokens']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['tokens'] = "Tokens"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['minutos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['minutos'] = "Minutos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['comida']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['comida'] = "Comida"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['cuentaventa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['cuentaventa'] = "Cuentaventa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['sucursal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['sucursal'] = "Sucursal"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['id_sales']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['id_sales'] = "Id Sales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['sales_price']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['sales_price'] = "Sales Price"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['sales_discount']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['sales_discount'] = "Sales Discount"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['total'] = "Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['id_status']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['id_status'] = "Id Status"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['idcaja']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['idcaja'] = "Idcaja"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['idcliente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['idcliente'] = "Idcliente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['cliente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['cliente'] = "Cliente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['direccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['direccion'] = "Direccion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['telefono']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['telefono'] = "Telefono"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['factura']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['factura'] = "Factura"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['serie']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['serie'] = "Serie"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['clave_acceso']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['clave_acceso'] = "Clave Acceso"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['enviosri']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['enviosri'] = "Enviosri"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['fechaenvio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['fechaenvio'] = "Fechaenvio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['uniqueid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['uniqueid'] = "Uniqueid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['estado'] = "Estado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['fechaid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['fechaid'] = "Fechaid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['importe_recibido']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['importe_recibido'] = "Importe Recibido"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['codigoid']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['codigoid'] = "Codigoid"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['totalsinimpuestos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['totalsinimpuestos'] = "Total Sin Impuestos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['totaldescuento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['totaldescuento'] = "Total Descuento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['baseimponible']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['baseimponible'] = "Base Imponible"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['valoriva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['valoriva'] = "Valoriva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['importetotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['importetotal'] = "Importe Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['idpago']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['idpago'] = "Idpago"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['totalpago']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['totalpago'] = "Totalpago"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['cliente_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['cliente_email'] = "Cliente Email"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['idempleado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['idempleado'] = "Idempleado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['idturno']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['idturno'] = "Idturno"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['codpago_sri']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['codpago_sri'] = "Codpago Sri"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['imprime']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['imprime'] = "Imprime"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['comprobante']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['comprobante'] = "Comprobante"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_192']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_192'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_203']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_203'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_193']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_193'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_195']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_195'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_196']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_196'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_197']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_197'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_198']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_198'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_199']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_199'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_200']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_200'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_201']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_201'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_202']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_202'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_204']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_204'] = "Datesales"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_194']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['labels']['datesales_scgb_194'] = "Datesales"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_reporte_sales_contab@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['proc_pdf_vert'])
   {
     $this->comp_tab_hover = true;
   }
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_charts'];
	}
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_reporte_sales_contab_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_reporte_sales_contab_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['proc_pdf_vert']){ 
   ...
   function formatValue($total, $valor_campo)
   {
       ...
       if ($total == 1)
       {
           nmgp_Form_Num_Val($valor_campo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "2", "S", "12", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']);
       }
       if ($total == 2)
       {
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
         ...
         { 
            ...
            { 
                $seq_search = 1;
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['grid_pesq'] as $cmp => $def)
                {
                   $Seq_grid      = $seq_search;
                   $Cmp_grid      = $cmp;
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_reporte_sales_contab']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_reporte_sales_contab']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_reporte_sales_contab']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_reporte_sales_contab']) . "_";
               } 
           }
       }
   ...
   function resumo_final()
   {
      ...
      if (!$this->NM_res_sem_reg && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['opcao'] != "pdf")
      {
          $this->grafico_bot();
      }
      if ("out" == $this->NM_tipo)
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_reporte_sales_contab_total.class.php"); 
      }
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new grid_reporte_sales_contab_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_reporte_sales_contab_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_reporte_sales_contab_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_reporte_sales_contab_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_reporte_sales_contab/grid_reporte_sales_contab_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_prod . "/third/jquery_plugin/thickbox/thickbox.css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_reporte_sales_contab_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_reporte_sales_contab_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_reporte_sales_contab_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['num_css'] . '.css');
     ...
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $vertical_center = '';
          $nm_saida->saida(" <BODY id=\"grid_summary\" class=\"" . $this->css_scGridPage . "\" style=\"" . $remove_margin . $vertical_center . "\">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_contab/grid_reporte_sales_contab_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_contab/grid_reporte_sales_contab_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_reporte_sales_contab&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_contab/grid_reporte_sales_contab_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_contab/grid_reporte_sales_contab_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_contab/grid_reporte_sales_contab_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_reporte_sales_contab/grid_reporte_sales_contab_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_reporte_sales_contab/grid_reporte_sales_contab_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + G)", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_reporte_sales_contab_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("grid_reporte_sales_contab_help.txt"); 
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rpdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['pdf'][] = "Rpdf_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + P)", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_contab/grid_reporte_sales_contab_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_reporte_sales_contab&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rword_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['word'][] = "Rword_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + W)", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_contab/grid_reporte_sales_contab_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xml'][] = "Rxml_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_contab/grid_reporte_sales_contab_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rcsv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['csv'][] = "Rcsv_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_reporte_sales_contab/grid_reporte_sales_contab_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_reporte_sales_contab']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_reporte_sales_contab']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_reporte_sales_contab_config_pivot.php?nome_apl=grid_reporte_sales_contab&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_reporte_sales_contab_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("               document.Fdoc_word.action = \"grid_reporte_sales_contab_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("               document.Fprint.action = \"grid_reporte_sales_contab_export_ctrl.php\";\r\n");
      $nm_saida->saida("           }\r\n");
      $nm_saida->saida("           else\r\n");
      $nm_saida->saida("           {\r\n");
      ...
      $nm_saida->saida("               document.Fexport.action = \"grid_reporte_sales_contab_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['grid_reporte_sales_contab_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_reporte_sales_contab@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("          nm_submit_modal(\"" . $this->Ini->path_link . "grid_reporte_sales_contab/grid_reporte_sales_contab_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_reporte_sales_contab_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_reporte_sales_contab/grid_reporte_sales_contab_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['print_all'];
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pdf_res'])
       {
           $nm_saida->saida("<TR>\r\n");
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['skip_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_charts']);
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               grid_reporte_sales_contab_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['this_chart_label'] = '';
       ...
       if ($bChartFP)
       {
           ...
           grid_reporte_sales_contab_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
           fwrite($this->progress_fp, 90 . "_#NM#_" . $lang_protect . "...\n");
           fclose($this->progress_fp);
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['chart_list']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['chart_list'] as $arr_chart)
       {
           $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
       $nm_saida->saida("<b><div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_btns_chrt_pdff_hint'] . "</H1></div></b>\r\n");
           $nm_saida->saida("<table><tr><td>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   $bPDF = false;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new grid_reporte_sales_contab_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
           ...
           grid_reporte_sales_contab_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
           grid_reporte_sales_contab_pdf_progress_call("\n", $this->Ini->Nm_lang);
           grid_reporte_sales_contab_pdf_progress_call("\n", $this->Ini->Nm_lang);
           grid_reporte_sales_contab_pdf_progress_call("100\n", $this->Ini->Nm_lang);
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['pivot_charts'] as $chart_index => $chart_data)
       {
           ...
           if ($bPDF)
           {
               ...
               if ($this->progress_fp)
               {
                   grid_reporte_sales_contab_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "/" . $iChartTotal . "...\n", $this->Ini->Nm_lang, true);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['ajax_nav'])
      {
       ...
       $nm_saida->saida("</TABLE>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($sum_item_total, $sum_valor_siniva, $quebra_sucursal, $quebra_cuentaventa, $quebra_jugador, $quebra_visitante, $quebra_entrada, $quebra_comida, $quebra_producto, $quebra_codproducto, $quebra_idcliente, $quebra_datesales, $quebra_datesales_scgb_192, $quebra_datesales_scgb_203, $quebra_datesales_scgb_193, $quebra_datesales_scgb_195, $quebra_datesales_scgb_196, $quebra_datesales_scgb_197, $quebra_datesales_scgb_198, $quebra_datesales_scgb_199, $quebra_datesales_scgb_200, $quebra_datesales_scgb_201, $quebra_datesales_scgb_202, $quebra_datesales_scgb_204, $quebra_datesales_scgb_194, $quebra_sucursal_orig, $quebra_cuentaventa_orig, $quebra_jugador_orig, $quebra_visitante_orig, $quebra_entrada_orig, $quebra_comida_orig, $quebra_producto_orig, $quebra_codproducto_orig, $quebra_idcliente_orig, $quebra_datesales_orig, $quebra_datesales_scgb_192_orig, $quebra_datesales_scgb_203_orig, $quebra_datesales_scgb_193_orig, $quebra_datesales_scgb_195_orig, $quebra_datesales_scgb_196_orig, $quebra_datesales_scgb_197_orig, $quebra_datesales_scgb_198_orig, $quebra_datesales_scgb_199_orig, $quebra_datesales_scgb_200_orig, $quebra_datesales_scgb_201_orig, $quebra_datesales_scgb_202_orig, $quebra_datesales_scgb_204_orig, $quebra_datesales_scgb_194_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_item_total . ';
              $this->' . $arr_name . '[2] = ' . $sum_valor_siniva . ';
          ...
          {
              $this->' . $arr_name . '[0]++;
              $this->' . $arr_name . '[1] = bcadd($this->' . $arr_name . '[1], ' . $sum_item_total . ', 10);
              $this->' . $arr_name . '[2] = bcadd($this->' . $arr_name . '[2], ' . $sum_valor_siniva . ', 10);
          }
          ');
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['where_pesq']; 
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
//
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['grid_pesq']))
           { 
   ...
   function grid_search_add_tag()
   {
       ...
       if (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['grid_pesq']) < 3)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_sucursal($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['psq_check_ret']['sucursal'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['psq_check_ret']['sucursal'][] = trim($rs->fields[0]);
   ...
   function grid_search_cuentaventa($ind, $ajax, $opc="", $val=array(), $label='')
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['psq_check_ret']['cuentaventa'] = array();
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
       { 
          while (!$rs->EOF) 
          { 
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['psq_check_ret']['cuentaventa'][] = trim($rs->fields[0]);
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "pointofsales/grid_reporte_sales_contab";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida(" function sc_grid_reporte_sales_contab_valida_mes(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_reporte_sales_contab_valida_dia(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['datesales_mes'] =  'sc_grid_reporte_sales_contab_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['datesales_dia'] =  'sc_grid_reporte_sales_contab_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['datesales_v2__mes'] =  'sc_grid_reporte_sales_contab_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['datesales_v2__dia'] =  'sc_grid_reporte_sales_contab_valida_dia(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_sales_contab']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['datesales_mes']", 'value' => 'sc_grid_reporte_sales_contab_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['datesales_dia']", 'value' => 'sc_grid_reporte_sales_contab_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['datesales_v2__mes']", 'value' => 'sc_grid_reporte_sales_contab_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['datesales_v2__dia']", 'value' => 'sc_grid_reporte_sales_contab_valida_dia(this)');
       } 
