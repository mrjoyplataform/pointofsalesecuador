...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_sales_detail_temp"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_sales_detail_temp"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_sales_detail_temp']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_sales_detail_temp']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_sales_detail_temp']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_sales_detail_temp']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_sales_detail_temp']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_sales_detail_temp</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_sales_detail_temp']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_sales_detail_temp']['embutida_filho'] as $ind => $sc_init)
          {
