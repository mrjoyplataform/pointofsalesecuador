<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_status_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_status_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_status"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_status_submit_form(y, z);
