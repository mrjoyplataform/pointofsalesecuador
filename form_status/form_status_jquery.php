...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_status_' + iSeqRow).bind('change', function() { sc_form_status_id_status__onchange(this, iSeqRow) });
  $('#id_sc_field_status_' + iSeqRow).bind('blur', function() { sc_form_status_status__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_status_status__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_status_status__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_status_id_status__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_status_status__onblur(oThis, iSeqRow) {
  do_ajax_form_status_validate_status_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_status_status__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_status_status__onfocus(oThis, iSeqRow) {
...
function scHidePage(pageNo) {
	$("#id_form_status_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_status')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
