<?php
@session_start() ;
$_SESSION['scriptcase']['boletos_pendientes_dia']['sc_process_barr'] = true;
require_once('../boletos_pendientes_dia/index.php');
unset($_SESSION['scriptcase']['boletos_pendientes_dia']['sc_process_barr']);
$ExportCtrl = new boletos_pendientes_dia_export_control;
$ExportCtrl->Export_barr();

class boletos_pendientes_dia_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> boletos</TITLE>
