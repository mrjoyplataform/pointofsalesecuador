<?php
@session_start() ;
$_SESSION['scriptcase']['grid_sales_detail_temp_resumen']['sc_process_barr'] = true;
require_once('../grid_sales_detail_temp_resumen/index.php');
unset($_SESSION['scriptcase']['grid_sales_detail_temp_resumen']['sc_process_barr']);
$ExportCtrl = new grid_sales_detail_temp_resumen_export_control;
$ExportCtrl->Export_barr();

class grid_sales_detail_temp_resumen_export_control
{
