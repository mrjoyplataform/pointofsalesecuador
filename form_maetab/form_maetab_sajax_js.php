  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_maetab" == sTestField)
        {
...
?>
  ...
  // ---------- Validate numtab
  function do_ajax_form_maetab_validate_numtab()
  {
    var nomeCampo_numtab = "numtab";
    var var_numtab = scAjaxGetFieldText(nomeCampo_numtab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_validate_numtab(var_numtab, var_script_case_init, do_ajax_form_maetab_validate_numtab_cb);
  } // do_ajax_form_maetab_validate_numtab

  function do_ajax_form_maetab_validate_numtab_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_validate_numtab_cb

  // ---------- Validate codtab
  function do_ajax_form_maetab_validate_codtab()
  {
    var nomeCampo_codtab = "codtab";
    var var_codtab = scAjaxGetFieldText(nomeCampo_codtab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_validate_codtab(var_codtab, var_script_case_init, do_ajax_form_maetab_validate_codtab_cb);
  } // do_ajax_form_maetab_validate_codtab

  function do_ajax_form_maetab_validate_codtab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codtab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_validate_codtab_cb

  // ---------- Validate nomtab
  function do_ajax_form_maetab_validate_nomtab()
  {
    var nomeCampo_nomtab = "nomtab";
    var var_nomtab = scAjaxGetFieldText(nomeCampo_nomtab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_validate_nomtab(var_nomtab, var_script_case_init, do_ajax_form_maetab_validate_nomtab_cb);
  } // do_ajax_form_maetab_validate_nomtab

  function do_ajax_form_maetab_validate_nomtab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nomtab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_validate_nomtab_cb

  // ---------- Validate ad1tab
  function do_ajax_form_maetab_validate_ad1tab()
  {
    var nomeCampo_ad1tab = "ad1tab";
    var var_ad1tab = scAjaxGetFieldText(nomeCampo_ad1tab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_validate_ad1tab(var_ad1tab, var_script_case_init, do_ajax_form_maetab_validate_ad1tab_cb);
  } // do_ajax_form_maetab_validate_ad1tab

  function do_ajax_form_maetab_validate_ad1tab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ad1tab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_validate_ad1tab_cb

  // ---------- Validate ad2tab
  function do_ajax_form_maetab_validate_ad2tab()
  {
    var nomeCampo_ad2tab = "ad2tab";
    var var_ad2tab = scAjaxGetFieldText(nomeCampo_ad2tab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_validate_ad2tab(var_ad2tab, var_script_case_init, do_ajax_form_maetab_validate_ad2tab_cb);
  } // do_ajax_form_maetab_validate_ad2tab

  function do_ajax_form_maetab_validate_ad2tab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ad2tab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_validate_ad2tab_cb

  // ---------- Validate ad3tab
  function do_ajax_form_maetab_validate_ad3tab()
  {
    var nomeCampo_ad3tab = "ad3tab";
    var var_ad3tab = scAjaxGetFieldText(nomeCampo_ad3tab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_validate_ad3tab(var_ad3tab, var_script_case_init, do_ajax_form_maetab_validate_ad3tab_cb);
  } // do_ajax_form_maetab_validate_ad3tab

  function do_ajax_form_maetab_validate_ad3tab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ad3tab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_validate_ad3tab_cb

  // ---------- Validate ad4tab
  function do_ajax_form_maetab_validate_ad4tab()
  {
    var nomeCampo_ad4tab = "ad4tab";
    var var_ad4tab = scAjaxGetFieldText(nomeCampo_ad4tab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_validate_ad4tab(var_ad4tab, var_script_case_init, do_ajax_form_maetab_validate_ad4tab_cb);
  } // do_ajax_form_maetab_validate_ad4tab

  function do_ajax_form_maetab_validate_ad4tab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ad4tab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_validate_ad4tab_cb

  // ---------- Validate ad5tab
  function do_ajax_form_maetab_validate_ad5tab()
  {
    var nomeCampo_ad5tab = "ad5tab";
    var var_ad5tab = scAjaxGetFieldText(nomeCampo_ad5tab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_validate_ad5tab(var_ad5tab, var_script_case_init, do_ajax_form_maetab_validate_ad5tab_cb);
  } // do_ajax_form_maetab_validate_ad5tab

  function do_ajax_form_maetab_validate_ad5tab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ad5tab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_validate_ad5tab_cb

  // ---------- Validate ad6tab
  function do_ajax_form_maetab_validate_ad6tab()
  {
    var nomeCampo_ad6tab = "ad6tab";
    var var_ad6tab = scAjaxGetFieldText(nomeCampo_ad6tab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_validate_ad6tab(var_ad6tab, var_script_case_init, do_ajax_form_maetab_validate_ad6tab_cb);
  } // do_ajax_form_maetab_validate_ad6tab

  function do_ajax_form_maetab_validate_ad6tab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ad6tab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_validate_ad6tab_cb

  // ---------- Validate ad7tab
  function do_ajax_form_maetab_validate_ad7tab()
  {
    var nomeCampo_ad7tab = "ad7tab";
    var var_ad7tab = scAjaxGetFieldText(nomeCampo_ad7tab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_validate_ad7tab(var_ad7tab, var_script_case_init, do_ajax_form_maetab_validate_ad7tab_cb);
  } // do_ajax_form_maetab_validate_ad7tab

  function do_ajax_form_maetab_validate_ad7tab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ad7tab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_validate_ad7tab_cb

  // ---------- Validate ad8tab
  function do_ajax_form_maetab_validate_ad8tab()
  {
    var nomeCampo_ad8tab = "ad8tab";
    var var_ad8tab = scAjaxGetFieldText(nomeCampo_ad8tab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_validate_ad8tab(var_ad8tab, var_script_case_init, do_ajax_form_maetab_validate_ad8tab_cb);
  } // do_ajax_form_maetab_validate_ad8tab

  function do_ajax_form_maetab_validate_ad8tab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ad8tab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_validate_ad8tab_cb

  // ---------- Validate block
  function do_ajax_form_maetab_validate_block()
  {
    var nomeCampo_block = "block";
    var var_block = scAjaxGetFieldText(nomeCampo_block);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_validate_block(var_block, var_script_case_init, do_ajax_form_maetab_validate_block_cb);
  } // do_ajax_form_maetab_validate_block

  function do_ajax_form_maetab_validate_block_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "block";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_validate_block_cb

  // ---------- Validate ad9tab
  function do_ajax_form_maetab_validate_ad9tab()
  {
    var nomeCampo_ad9tab = "ad9tab";
    var var_ad9tab = scAjaxGetFieldText(nomeCampo_ad9tab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_validate_ad9tab(var_ad9tab, var_script_case_init, do_ajax_form_maetab_validate_ad9tab_cb);
  } // do_ajax_form_maetab_validate_ad9tab

  function do_ajax_form_maetab_validate_ad9tab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ad9tab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_validate_ad9tab_cb

  // ---------- Validate ad0tab
  function do_ajax_form_maetab_validate_ad0tab()
  {
    var nomeCampo_ad0tab = "ad0tab";
    var var_ad0tab = scAjaxGetFieldText(nomeCampo_ad0tab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_validate_ad0tab(var_ad0tab, var_script_case_init, do_ajax_form_maetab_validate_ad0tab_cb);
  } // do_ajax_form_maetab_validate_ad0tab

  function do_ajax_form_maetab_validate_ad0tab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ad0tab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_validate_ad0tab_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_maetab_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_maetab_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_maetab_submit_form(var_numtab, var_codtab, var_nomtab, var_ad1tab, var_ad2tab, var_ad3tab, var_ad4tab, var_ad5tab, var_ad6tab, var_ad7tab, var_ad8tab, var_block, var_ad9tab, var_ad0tab, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_maetab_submit_form_cb);
  } // do_ajax_form_maetab_submit_form

  function do_ajax_form_maetab_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_maetab_submit_form_cb_after_alert);
  } // do_ajax_form_maetab_submit_form_cb
  function do_ajax_form_maetab_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_maetab_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_maetab_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_maetab_navigate_form, function() {});
    } else {
      perform_ajax_form_maetab_navigate_form();
    }
  }

  function perform_ajax_form_maetab_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_maetab_navigate_form(var_numtab, var_codtab, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_maetab_navigate_form_cb);
  } // do_ajax_form_maetab_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_maetab']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_maetab_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_maetab_navigate_form_cb_after_alert);
  } // do_ajax_form_maetab_navigate_form_cb
  function do_ajax_form_maetab_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_maetab_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_maetab_navigate_form_cb_after_alert

  function sc_hide_form_maetab_form()
  {
