  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_maetab_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate numtab
  function do_ajax_form_maetab_mob_validate_numtab()
  {
    var nomeCampo_numtab = "numtab";
    var var_numtab = scAjaxGetFieldText(nomeCampo_numtab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_mob_validate_numtab(var_numtab, var_script_case_init, do_ajax_form_maetab_mob_validate_numtab_cb);
  } // do_ajax_form_maetab_mob_validate_numtab

  function do_ajax_form_maetab_mob_validate_numtab_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_mob_validate_numtab_cb

  // ---------- Validate codtab
  function do_ajax_form_maetab_mob_validate_codtab()
  {
    var nomeCampo_codtab = "codtab";
    var var_codtab = scAjaxGetFieldText(nomeCampo_codtab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_mob_validate_codtab(var_codtab, var_script_case_init, do_ajax_form_maetab_mob_validate_codtab_cb);
  } // do_ajax_form_maetab_mob_validate_codtab

  function do_ajax_form_maetab_mob_validate_codtab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codtab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_mob_validate_codtab_cb

  // ---------- Validate nomtab
  function do_ajax_form_maetab_mob_validate_nomtab()
  {
    var nomeCampo_nomtab = "nomtab";
    var var_nomtab = scAjaxGetFieldText(nomeCampo_nomtab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_mob_validate_nomtab(var_nomtab, var_script_case_init, do_ajax_form_maetab_mob_validate_nomtab_cb);
  } // do_ajax_form_maetab_mob_validate_nomtab

  function do_ajax_form_maetab_mob_validate_nomtab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nomtab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_mob_validate_nomtab_cb

  // ---------- Validate ad1tab
  function do_ajax_form_maetab_mob_validate_ad1tab()
  {
    var nomeCampo_ad1tab = "ad1tab";
    var var_ad1tab = scAjaxGetFieldText(nomeCampo_ad1tab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_mob_validate_ad1tab(var_ad1tab, var_script_case_init, do_ajax_form_maetab_mob_validate_ad1tab_cb);
  } // do_ajax_form_maetab_mob_validate_ad1tab

  function do_ajax_form_maetab_mob_validate_ad1tab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ad1tab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_mob_validate_ad1tab_cb

  // ---------- Validate ad2tab
  function do_ajax_form_maetab_mob_validate_ad2tab()
  {
    var nomeCampo_ad2tab = "ad2tab";
    var var_ad2tab = scAjaxGetFieldText(nomeCampo_ad2tab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_mob_validate_ad2tab(var_ad2tab, var_script_case_init, do_ajax_form_maetab_mob_validate_ad2tab_cb);
  } // do_ajax_form_maetab_mob_validate_ad2tab

  function do_ajax_form_maetab_mob_validate_ad2tab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ad2tab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_mob_validate_ad2tab_cb

  // ---------- Validate ad3tab
  function do_ajax_form_maetab_mob_validate_ad3tab()
  {
    var nomeCampo_ad3tab = "ad3tab";
    var var_ad3tab = scAjaxGetFieldText(nomeCampo_ad3tab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_mob_validate_ad3tab(var_ad3tab, var_script_case_init, do_ajax_form_maetab_mob_validate_ad3tab_cb);
  } // do_ajax_form_maetab_mob_validate_ad3tab

  function do_ajax_form_maetab_mob_validate_ad3tab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ad3tab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_mob_validate_ad3tab_cb

  // ---------- Validate ad4tab
  function do_ajax_form_maetab_mob_validate_ad4tab()
  {
    var nomeCampo_ad4tab = "ad4tab";
    var var_ad4tab = scAjaxGetFieldText(nomeCampo_ad4tab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_mob_validate_ad4tab(var_ad4tab, var_script_case_init, do_ajax_form_maetab_mob_validate_ad4tab_cb);
  } // do_ajax_form_maetab_mob_validate_ad4tab

  function do_ajax_form_maetab_mob_validate_ad4tab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ad4tab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_mob_validate_ad4tab_cb

  // ---------- Validate ad5tab
  function do_ajax_form_maetab_mob_validate_ad5tab()
  {
    var nomeCampo_ad5tab = "ad5tab";
    var var_ad5tab = scAjaxGetFieldText(nomeCampo_ad5tab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_mob_validate_ad5tab(var_ad5tab, var_script_case_init, do_ajax_form_maetab_mob_validate_ad5tab_cb);
  } // do_ajax_form_maetab_mob_validate_ad5tab

  function do_ajax_form_maetab_mob_validate_ad5tab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ad5tab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_mob_validate_ad5tab_cb

  // ---------- Validate ad6tab
  function do_ajax_form_maetab_mob_validate_ad6tab()
  {
    var nomeCampo_ad6tab = "ad6tab";
    var var_ad6tab = scAjaxGetFieldText(nomeCampo_ad6tab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_mob_validate_ad6tab(var_ad6tab, var_script_case_init, do_ajax_form_maetab_mob_validate_ad6tab_cb);
  } // do_ajax_form_maetab_mob_validate_ad6tab

  function do_ajax_form_maetab_mob_validate_ad6tab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ad6tab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_mob_validate_ad6tab_cb

  // ---------- Validate ad7tab
  function do_ajax_form_maetab_mob_validate_ad7tab()
  {
    var nomeCampo_ad7tab = "ad7tab";
    var var_ad7tab = scAjaxGetFieldText(nomeCampo_ad7tab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_mob_validate_ad7tab(var_ad7tab, var_script_case_init, do_ajax_form_maetab_mob_validate_ad7tab_cb);
  } // do_ajax_form_maetab_mob_validate_ad7tab

  function do_ajax_form_maetab_mob_validate_ad7tab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ad7tab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_mob_validate_ad7tab_cb

  // ---------- Validate ad8tab
  function do_ajax_form_maetab_mob_validate_ad8tab()
  {
    var nomeCampo_ad8tab = "ad8tab";
    var var_ad8tab = scAjaxGetFieldText(nomeCampo_ad8tab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_mob_validate_ad8tab(var_ad8tab, var_script_case_init, do_ajax_form_maetab_mob_validate_ad8tab_cb);
  } // do_ajax_form_maetab_mob_validate_ad8tab

  function do_ajax_form_maetab_mob_validate_ad8tab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ad8tab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_mob_validate_ad8tab_cb

  // ---------- Validate block
  function do_ajax_form_maetab_mob_validate_block()
  {
    var nomeCampo_block = "block";
    var var_block = scAjaxGetFieldText(nomeCampo_block);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_mob_validate_block(var_block, var_script_case_init, do_ajax_form_maetab_mob_validate_block_cb);
  } // do_ajax_form_maetab_mob_validate_block

  function do_ajax_form_maetab_mob_validate_block_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "block";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_mob_validate_block_cb

  // ---------- Validate ad9tab
  function do_ajax_form_maetab_mob_validate_ad9tab()
  {
    var nomeCampo_ad9tab = "ad9tab";
    var var_ad9tab = scAjaxGetFieldText(nomeCampo_ad9tab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_mob_validate_ad9tab(var_ad9tab, var_script_case_init, do_ajax_form_maetab_mob_validate_ad9tab_cb);
  } // do_ajax_form_maetab_mob_validate_ad9tab

  function do_ajax_form_maetab_mob_validate_ad9tab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ad9tab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_mob_validate_ad9tab_cb

  // ---------- Validate ad0tab
  function do_ajax_form_maetab_mob_validate_ad0tab()
  {
    var nomeCampo_ad0tab = "ad0tab";
    var var_ad0tab = scAjaxGetFieldText(nomeCampo_ad0tab);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_maetab_mob_validate_ad0tab(var_ad0tab, var_script_case_init, do_ajax_form_maetab_mob_validate_ad0tab_cb);
  } // do_ajax_form_maetab_mob_validate_ad0tab

  function do_ajax_form_maetab_mob_validate_ad0tab_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ad0tab";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_maetab_mob_validate_ad0tab_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_maetab_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_maetab_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_numtab = scAjaxGetFieldText("numtab");
    var var_codtab = scAjaxGetFieldText("codtab");
    var var_nomtab = scAjaxGetFieldText("nomtab");
    var var_ad1tab = scAjaxGetFieldText("ad1tab");
    var var_ad2tab = scAjaxGetFieldText("ad2tab");
    var var_ad3tab = scAjaxGetFieldText("ad3tab");
    var var_ad4tab = scAjaxGetFieldText("ad4tab");
    var var_ad5tab = scAjaxGetFieldText("ad5tab");
    var var_ad6tab = scAjaxGetFieldText("ad6tab");
    var var_ad7tab = scAjaxGetFieldText("ad7tab");
    var var_ad8tab = scAjaxGetFieldText("ad8tab");
    var var_block = scAjaxGetFieldText("block");
    var var_ad9tab = scAjaxGetFieldText("ad9tab");
    var var_ad0tab = scAjaxGetFieldText("ad0tab");
    ...
    scAjaxProcOn();
    x_ajax_form_maetab_mob_submit_form(var_numtab, var_codtab, var_nomtab, var_ad1tab, var_ad2tab, var_ad3tab, var_ad4tab, var_ad5tab, var_ad6tab, var_ad7tab, var_ad8tab, var_block, var_ad9tab, var_ad0tab, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_maetab_mob_submit_form_cb);
  } // do_ajax_form_maetab_mob_submit_form

  function do_ajax_form_maetab_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("numtab");
      scAjaxHideErrorDisplay("codtab");
      scAjaxHideErrorDisplay("nomtab");
      scAjaxHideErrorDisplay("ad1tab");
      scAjaxHideErrorDisplay("ad2tab");
      scAjaxHideErrorDisplay("ad3tab");
      scAjaxHideErrorDisplay("ad4tab");
      scAjaxHideErrorDisplay("ad5tab");
      scAjaxHideErrorDisplay("ad6tab");
      scAjaxHideErrorDisplay("ad7tab");
      scAjaxHideErrorDisplay("ad8tab");
      scAjaxHideErrorDisplay("block");
      scAjaxHideErrorDisplay("ad9tab");
      scAjaxHideErrorDisplay("ad0tab");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_maetab_mob_submit_form_cb_after_alert);
  } // do_ajax_form_maetab_mob_submit_form_cb
  function do_ajax_form_maetab_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_maetab_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_maetab_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_maetab_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_maetab_mob_navigate_form();
    }
  }

  function perform_ajax_form_maetab_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("ad9tab");
    scAjaxHideErrorDisplay("ad0tab");
    var var_numtab = document.F2.numtab.value;
    var var_codtab = document.F2.codtab.value;
    ...
    scAjaxProcOn();
    x_ajax_form_maetab_mob_navigate_form(var_numtab, var_codtab, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_maetab_mob_navigate_form_cb);
  } // do_ajax_form_maetab_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_maetab_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_maetab_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.numtab.value = scAjaxGetKeyValue("numtab");
    document.F2.codtab.value = scAjaxGetKeyValue("codtab");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_maetab_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_maetab_mob_navigate_form_cb
  function do_ajax_form_maetab_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_maetab_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_maetab_mob_navigate_form_cb_after_alert

  function sc_hide_form_maetab_mob_form()
  {
  ...
  ajax_field_list[0] = "numtab";
  ajax_field_list[1] = "codtab";
  ajax_field_list[2] = "nomtab";
  ajax_field_list[3] = "ad1tab";
  ajax_field_list[4] = "ad2tab";
  ajax_field_list[5] = "ad3tab";
  ajax_field_list[6] = "ad4tab";
  ajax_field_list[7] = "ad5tab";
  ajax_field_list[8] = "ad6tab";
  ajax_field_list[9] = "ad7tab";
  ajax_field_list[10] = "ad8tab";
  ajax_field_list[11] = "block";
  ajax_field_list[12] = "ad9tab";
  ajax_field_list[13] = "ad0tab";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "numtab": {"label": "Numtab", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "codtab": {"label": "Codtab", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nomtab": {"label": "Nomtab", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ad1tab": {"label": "Ad 1tab", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ad2tab": {"label": "Ad 2tab", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ad3tab": {"label": "Ad 3tab", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ad4tab": {"label": "Ad 4tab", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ad5tab": {"label": "Ad 5tab", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ad6tab": {"label": "Ad 6tab", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ad7tab": {"label": "Ad 7tab", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ad8tab": {"label": "Ad 8tab", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "block": {"label": "Block", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ad9tab": {"label": "Ad 9tab", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ad0tab": {"label": "Ad 0tab", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["numtab"][1] = "numtab";
  ajax_field_mult["codtab"][1] = "codtab";
  ajax_field_mult["nomtab"][1] = "nomtab";
  ajax_field_mult["ad1tab"][1] = "ad1tab";
  ajax_field_mult["ad2tab"][1] = "ad2tab";
  ajax_field_mult["ad3tab"][1] = "ad3tab";
  ajax_field_mult["ad4tab"][1] = "ad4tab";
  ajax_field_mult["ad5tab"][1] = "ad5tab";
  ajax_field_mult["ad6tab"][1] = "ad6tab";
  ajax_field_mult["ad7tab"][1] = "ad7tab";
  ajax_field_mult["ad8tab"][1] = "ad8tab";
  ajax_field_mult["block"][1] = "block";
  ajax_field_mult["ad9tab"][1] = "ad9tab";
  ajax_field_mult["ad0tab"][1] = "ad0tab";

  var ajax_field_id = {
    "numtab": new Array("hidden_field_label_numtab", "hidden_field_data_numtab"),
    "codtab": new Array("hidden_field_label_codtab", "hidden_field_data_codtab"),
    "nomtab": new Array("hidden_field_label_nomtab", "hidden_field_data_nomtab"),
    "ad1tab": new Array("hidden_field_label_ad1tab", "hidden_field_data_ad1tab"),
    "ad2tab": new Array("hidden_field_label_ad2tab", "hidden_field_data_ad2tab"),
    "ad3tab": new Array("hidden_field_label_ad3tab", "hidden_field_data_ad3tab"),
    "ad4tab": new Array("hidden_field_label_ad4tab", "hidden_field_data_ad4tab"),
    "ad5tab": new Array("hidden_field_label_ad5tab", "hidden_field_data_ad5tab"),
    "ad6tab": new Array("hidden_field_label_ad6tab", "hidden_field_data_ad6tab"),
    "ad7tab": new Array("hidden_field_label_ad7tab", "hidden_field_data_ad7tab"),
    "ad8tab": new Array("hidden_field_label_ad8tab", "hidden_field_data_ad8tab"),
    "block": new Array("hidden_field_label_block", "hidden_field_data_block"),
    "ad9tab": new Array("hidden_field_label_ad9tab", "hidden_field_data_ad9tab"),
    "ad0tab": new Array("hidden_field_label_ad0tab", "hidden_field_data_ad0tab")
  };
