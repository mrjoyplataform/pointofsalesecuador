...
class grid_movimtorno_resumo
{
   ...
   function completeMatrix()
   {
       ...
       $prep_field['cod_device'] = $Lab_cod_device;
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movimtorno']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movimtorno']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movimtorno']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movimtorno']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movimtorno']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movimtorno']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movimtorno']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movimtorno']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movimtorno']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movimtorno']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['cod_device']['alin'] = "''";
       $Arr_parms['cod_device']['link'] = "S";
       ...
       $Arr_parms['cod_device']['fill'] = "true";
       $Arr_parms['cod_device']['order'] = "label";
       $Arr_parms['cod_device']['order_start'] = 'asc';
       $Arr_parms['cod_device']['order_invert'] = 'false';
       $Arr_parms['cod_device']['order_enabled'] = 'true';
       $Arr_parms['cod_device']['order_datatype'] = 'int';
       $Arr_parms['usuario']['fill'] = "false";
       $Arr_parms['usuario']['order'] = "label";
       $Arr_parms['usuario']['order_start'] = 'asc';
       $Arr_parms['usuario']['order_invert'] = 'false';
       $Arr_parms['usuario']['order_enabled'] = 'true';
       $Arr_parms['usuario']['order_datatype'] = 'varchar';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movimtorno']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       $prep_links_fl['cod_device'] = array(0 => 'cod_device', 1 => '');
       $prep_links_fl['usuario'] = array(0 => 'usuario', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movimtorno']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movimtorno']['pivot_order_level'] = 0;
       }
   ...
   function buildChart()
   {
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movimtorno']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
...
{ 
   ...
   $nm_saida->saida("          nm_submit_modal(\"" . $this->Ini->path_link . "grid_movimtorno/grid_movimtorno_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movimtorno']['SC_Gb_Free_cmp']))
      {
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_fecha, $quebra_cod_device, $quebra_usuario, $quebra_fecha_orig, $quebra_cod_device_orig, $quebra_usuario_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movimtorno']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_movimtorno']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_movimtorno']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->fecha, $this->cod_device, $this->usuario, $this->fecha_orig,  $this->cod_device_orig,  $this->usuario_orig);
            }
   }
//
