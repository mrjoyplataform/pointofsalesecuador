...
<?php
   ...
   $Ord_Cmp = new grid_movimtorno_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_movimtorno_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_movimtorno']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_movimtorno']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idreg"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movimtorno']['labels']["idreg"])) ? $_SESSION['sc_session'][$sc_init]['grid_movimtorno']['labels']["idreg"] : "Idreg";
   $tab_ger_campos['cod_device'] = "on";
   $tab_def_campos['cod_device'] = "cod_device";
   $tab_labels["cod_device"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movimtorno']['labels']["cod_device"])) ? $_SESSION['sc_session'][$sc_init]['grid_movimtorno']['labels']["cod_device"] : "Cod Device";
   $tab_ger_campos['boleto'] = "on";
   $tab_def_campos['boleto'] = "boleto";
   $tab_labels["boleto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movimtorno']['labels']["boleto"])) ? $_SESSION['sc_session'][$sc_init]['grid_movimtorno']['labels']["boleto"] : "Boleto";
   $tab_ger_campos['usuario'] = "on";
   $tab_def_campos['usuario'] = "usuario";
   $tab_labels["usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movimtorno']['labels']["usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_movimtorno']['labels']["usuario"] : "Usuario";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_movimtorno']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_movimtorno']['labels']["fecha"] : "Fecha";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_movimtorno']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_movimtorno']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_movimtorno']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_movimtorno']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_movimtorno']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_movimtorno']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_movimtorno']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_movimtorno']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_movimtorno']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_movimtorno']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_movimtorno']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_movimtorno']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_movimtorno_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_movimtorno']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_movimtorno']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_movimtorno']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_movimtorno']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_movimtorno']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
