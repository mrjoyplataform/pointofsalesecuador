<?php
@session_start() ;
$_SESSION['scriptcase']['grid_movimtorno']['sc_process_barr'] = true;
require_once('../grid_movimtorno/index.php');
unset($_SESSION['scriptcase']['grid_movimtorno']['sc_process_barr']);
$ExportCtrl = new grid_movimtorno_export_control;
$ExportCtrl->Export_barr();

class grid_movimtorno_export_control
{
