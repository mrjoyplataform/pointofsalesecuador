...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " movpag"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " movpag"); } ?></TITLE>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_movpag/form_movpag_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_movpag_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_movpag_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['link_info']['remove_border']) {
...
<?php
 include_once("form_movpag_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_movpag'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_movpag'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_codcte43_label" id="hidden_field_label_codcte43" style="<?php echo $sStyleHidden_codcte43; ?>"><span id="id_label_codcte43"><?php echo $this->nm_new_label['codcte43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['codcte43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['codcte43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_numdoc43_label" id="hidden_field_label_numdoc43" style="<?php echo $sStyleHidden_numdoc43; ?>"><span id="id_label_numdoc43"><?php echo $this->nm_new_label['numdoc43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['numdoc43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['numdoc43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ocurren43_label" id="hidden_field_label_ocurren43" style="<?php echo $sStyleHidden_ocurren43; ?>"><span id="id_label_ocurren43"><?php echo $this->nm_new_label['ocurren43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['ocurren43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['ocurren43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cvanioant43_label" id="hidden_field_label_cvanioant43" style="<?php echo $sStyleHidden_cvanioant43; ?>"><span id="id_label_cvanioant43"><?php echo $this->nm_new_label['cvanioant43']; ?></span></TD>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['tipoimp43']))
    {
        $this->nm_new_label['tipoimp43'] = "Tipoimp 43";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $tipoimp43 = $this->tipoimp43;
   $sStyleHidden_tipoimp43 = '';
   if (isset($this->nmgp_cmp_hidden['tipoimp43']) && $this->nmgp_cmp_hidden['tipoimp43'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['tipoimp43']);
       $sStyleHidden_tipoimp43 = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_tipoimp43 = 'display: none;';
   $sStyleReadInp_tipoimp43 = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['tipoimp43']) && $this->nmgp_cmp_readonly['tipoimp43'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['tipoimp43']);
       $sStyleReadLab_tipoimp43 = '';
       $sStyleReadInp_tipoimp43 = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['tipoimp43']) && $this->nmgp_cmp_hidden['tipoimp43'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="tipoimp43" value="<?php echo $this->form_encode_input($tipoimp43) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipoimp43_label" id="hidden_field_label_tipoimp43" style="<?php echo $sStyleHidden_tipoimp43; ?>"><span id="id_label_tipoimp43"><?php echo $this->nm_new_label['tipoimp43']; ?></span></TD>
    <TD class="scFormDataOdd css_tipoimp43_line" id="hidden_field_data_tipoimp43" style="<?php echo $sStyleHidden_tipoimp43; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipoimp43_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["tipoimp43"]) &&  $this->nmgp_cmp_readonly["tipoimp43"] == "on") { 

 ?>
<input type="hidden" name="tipoimp43" value="<?php echo $this->form_encode_input($tipoimp43) . "\">" . $tipoimp43 . ""; ?>
<?php } else { ?>
<span id="id_read_on_tipoimp43" class="sc-ui-readonly-tipoimp43 css_tipoimp43_line" style="<?php echo $sStyleReadLab_tipoimp43; ?>"><?php echo $this->form_format_readonly("tipoimp43", $this->form_encode_input($this->tipoimp43)); ?></span><span id="id_read_off_tipoimp43" class="css_read_off_tipoimp43<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_tipoimp43; ?>">
 <input class="sc-js-input scFormObjectOdd css_tipoimp43_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_tipoimp43" type=text name="tipoimp43" value="<?php echo $this->form_encode_input($tipoimp43) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=10"; } ?> alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['tipoimp43']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['tipoimp43']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['tipoimp43']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_tipoimp43_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_tipoimp43_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['porcimp43']))
    {
        $this->nm_new_label['porcimp43'] = "Porcimp 43";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $porcimp43 = $this->porcimp43;
   $sStyleHidden_porcimp43 = '';
   if (isset($this->nmgp_cmp_hidden['porcimp43']) && $this->nmgp_cmp_hidden['porcimp43'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['porcimp43']);
       $sStyleHidden_porcimp43 = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_porcimp43 = 'display: none;';
   $sStyleReadInp_porcimp43 = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['porcimp43']) && $this->nmgp_cmp_readonly['porcimp43'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['porcimp43']);
       $sStyleReadLab_porcimp43 = '';
       $sStyleReadInp_porcimp43 = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['porcimp43']) && $this->nmgp_cmp_hidden['porcimp43'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="porcimp43" value="<?php echo $this->form_encode_input($porcimp43) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_porcimp43_label" id="hidden_field_label_porcimp43" style="<?php echo $sStyleHidden_porcimp43; ?>"><span id="id_label_porcimp43"><?php echo $this->nm_new_label['porcimp43']; ?></span></TD>
    <TD class="scFormDataOdd css_porcimp43_line" id="hidden_field_data_porcimp43" style="<?php echo $sStyleHidden_porcimp43; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_porcimp43_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["porcimp43"]) &&  $this->nmgp_cmp_readonly["porcimp43"] == "on") { 

 ?>
<input type="hidden" name="porcimp43" value="<?php echo $this->form_encode_input($porcimp43) . "\">" . $porcimp43 . ""; ?>
<?php } else { ?>
<span id="id_read_on_porcimp43" class="sc-ui-readonly-porcimp43 css_porcimp43_line" style="<?php echo $sStyleReadLab_porcimp43; ?>"><?php echo $this->form_format_readonly("porcimp43", $this->form_encode_input($this->porcimp43)); ?></span><span id="id_read_off_porcimp43" class="css_read_off_porcimp43<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_porcimp43; ?>">
 <input class="sc-js-input scFormObjectOdd css_porcimp43_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_porcimp43" type=text name="porcimp43" value="<?php echo $this->form_encode_input($porcimp43) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=5"; } ?> alt="{datatype: 'decimal', maxLength: 5, precision: 2, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['porcimp43']['symbol_dec']); ?>', thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['porcimp43']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['porcimp43']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['porcimp43']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_porcimp43_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_porcimp43_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['bienserv43']))
    {
        $this->nm_new_label['bienserv43'] = "Bienserv 43";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $bienserv43 = $this->bienserv43;
   $sStyleHidden_bienserv43 = '';
   if (isset($this->nmgp_cmp_hidden['bienserv43']) && $this->nmgp_cmp_hidden['bienserv43'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['bienserv43']);
       $sStyleHidden_bienserv43 = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_bienserv43 = 'display: none;';
   $sStyleReadInp_bienserv43 = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['bienserv43']) && $this->nmgp_cmp_readonly['bienserv43'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['bienserv43']);
       $sStyleReadLab_bienserv43 = '';
       $sStyleReadInp_bienserv43 = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['bienserv43']) && $this->nmgp_cmp_hidden['bienserv43'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="bienserv43" value="<?php echo $this->form_encode_input($bienserv43) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_bienserv43_label" id="hidden_field_label_bienserv43" style="<?php echo $sStyleHidden_bienserv43; ?>"><span id="id_label_bienserv43"><?php echo $this->nm_new_label['bienserv43']; ?></span></TD>
    <TD class="scFormDataOdd css_bienserv43_line" id="hidden_field_data_bienserv43" style="<?php echo $sStyleHidden_bienserv43; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bienserv43_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["bienserv43"]) &&  $this->nmgp_cmp_readonly["bienserv43"] == "on") { 

 ?>
<input type="hidden" name="bienserv43" value="<?php echo $this->form_encode_input($bienserv43) . "\">" . $bienserv43 . ""; ?>
<?php } else { ?>
<span id="id_read_on_bienserv43" class="sc-ui-readonly-bienserv43 css_bienserv43_line" style="<?php echo $sStyleReadLab_bienserv43; ?>"><?php echo $this->form_format_readonly("bienserv43", $this->form_encode_input($this->bienserv43)); ?></span><span id="id_read_off_bienserv43" class="css_read_off_bienserv43<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_bienserv43; ?>">
 <input class="sc-js-input scFormObjectOdd css_bienserv43_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_bienserv43" type=text name="bienserv43" value="<?php echo $this->form_encode_input($bienserv43) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=20"; } ?> maxlength=255 alt="{datatype: 'text', maxLength: 255, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_bienserv43_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_bienserv43_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_credgast43_label" id="hidden_field_label_credgast43" style="<?php echo $sStyleHidden_credgast43; ?>"><span id="id_label_credgast43"><?php echo $this->nm_new_label['credgast43']; ?></span></TD>
    <TD class="scFormDataOdd css_credgast43_line" id="hidden_field_data_credgast43" style="<?php echo $sStyleHidden_credgast43; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_credgast43_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fecvencompra43_label" id="hidden_field_label_fecvencompra43" style="<?php echo $sStyleHidden_fecvencompra43; ?>"><span id="id_label_fecvencompra43"><?php echo $this->nm_new_label['fecvencompra43']; ?></span></TD>
    <TD class="scFormDataOdd css_fecvencompra43_line" id="hidden_field_data_fecvencompra43" style="<?php echo $sStyleHidden_fecvencompra43; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecvencompra43_line" style="vertical-align: top;padding: 0px">
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['sdoexeact43']))
    {
        $this->nm_new_label['sdoexeact43'] = "Sdoexeact 43";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $sStyleHidden_sdoexeact43 = '';
   if (isset($this->nmgp_cmp_hidden['sdoexeact43']) && $this->nmgp_cmp_hidden['sdoexeact43'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['sdoexeact43']);
       $sStyleHidden_sdoexeact43 = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_sdoexeact43 = 'display: none;';
   $sStyleReadInp_sdoexeact43 = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['sdoexeact43']) && $this->nmgp_cmp_readonly['sdoexeact43'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['sdoexeact43']);
       $sStyleReadLab_sdoexeact43 = '';
       $sStyleReadInp_sdoexeact43 = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['sdoexeact43']) && $this->nmgp_cmp_hidden['sdoexeact43'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="sdoexeact43" value="<?php echo $this->form_encode_input($sdoexeact43) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_sdoexeact43_label" id="hidden_field_label_sdoexeact43" style="<?php echo $sStyleHidden_sdoexeact43; ?>"><span id="id_label_sdoexeact43"><?php echo $this->nm_new_label['sdoexeact43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['sdoexeact43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['sdoexeact43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_sdoexeact43_line" id="hidden_field_data_sdoexeact43" style="<?php echo $sStyleHidden_sdoexeact43; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sdoexeact43_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["sdoexeact43"]) &&  $this->nmgp_cmp_readonly["sdoexeact43"] == "on") { 

 ?>
<input type="hidden" name="sdoexeact43" value="<?php echo $this->form_encode_input($sdoexeact43) . "\">" . $sdoexeact43 . ""; ?>
<?php } else { ?>
<span id="id_read_on_sdoexeact43" class="sc-ui-readonly-sdoexeact43 css_sdoexeact43_line" style="<?php echo $sStyleReadLab_sdoexeact43; ?>"><?php echo $this->form_format_readonly("sdoexeact43", $this->form_encode_input($this->sdoexeact43)); ?></span><span id="id_read_off_sdoexeact43" class="css_read_off_sdoexeact43<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_sdoexeact43; ?>">
 <input class="sc-js-input scFormObjectOdd css_sdoexeact43_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_sdoexeact43" type=text name="sdoexeact43" value="<?php echo $this->form_encode_input($sdoexeact43) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=18"; } ?> alt="{datatype: 'decimal', maxLength: 18, precision: 2, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['sdoexeact43']['symbol_dec']); ?>', thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['sdoexeact43']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['sdoexeact43']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['sdoexeact43']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_sdoexeact43_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_sdoexeact43_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['sdoregact43']))
    {
        $this->nm_new_label['sdoregact43'] = "Sdoregact 43";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $sdoregact43 = $this->sdoregact43;
   $sStyleHidden_sdoregact43 = '';
   if (isset($this->nmgp_cmp_hidden['sdoregact43']) && $this->nmgp_cmp_hidden['sdoregact43'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['sdoregact43']);
       $sStyleHidden_sdoregact43 = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_sdoregact43 = 'display: none;';
   $sStyleReadInp_sdoregact43 = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['sdoregact43']) && $this->nmgp_cmp_readonly['sdoregact43'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['sdoregact43']);
       $sStyleReadLab_sdoregact43 = '';
       $sStyleReadInp_sdoregact43 = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['sdoregact43']) && $this->nmgp_cmp_hidden['sdoregact43'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="sdoregact43" value="<?php echo $this->form_encode_input($sdoregact43) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_sdoregact43_label" id="hidden_field_label_sdoregact43" style="<?php echo $sStyleHidden_sdoregact43; ?>"><span id="id_label_sdoregact43"><?php echo $this->nm_new_label['sdoregact43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['sdoregact43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['sdoregact43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_sdoregact43_line" id="hidden_field_data_sdoregact43" style="<?php echo $sStyleHidden_sdoregact43; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sdoregact43_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["sdoregact43"]) &&  $this->nmgp_cmp_readonly["sdoregact43"] == "on") { 

 ?>
<input type="hidden" name="sdoregact43" value="<?php echo $this->form_encode_input($sdoregact43) . "\">" . $sdoregact43 . ""; ?>
<?php } else { ?>
<span id="id_read_on_sdoregact43" class="sc-ui-readonly-sdoregact43 css_sdoregact43_line" style="<?php echo $sStyleReadLab_sdoregact43; ?>"><?php echo $this->form_format_readonly("sdoregact43", $this->form_encode_input($this->sdoregact43)); ?></span><span id="id_read_off_sdoregact43" class="css_read_off_sdoregact43<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_sdoregact43; ?>">
 <input class="sc-js-input scFormObjectOdd css_sdoregact43_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_sdoregact43" type=text name="sdoregact43" value="<?php echo $this->form_encode_input($sdoregact43) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=18"; } ?> alt="{datatype: 'decimal', maxLength: 18, precision: 2, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['sdoregact43']['symbol_dec']); ?>', thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['sdoregact43']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['sdoregact43']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['sdoregact43']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_sdoregact43_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_sdoregact43_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_conta43_label" id="hidden_field_label_conta43" style="<?php echo $sStyleHidden_conta43; ?>"><span id="id_label_conta43"><?php echo $this->nm_new_label['conta43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['conta43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['conta43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cvanulado43_label" id="hidden_field_label_cvanulado43" style="<?php echo $sStyleHidden_cvanulado43; ?>"><span id="id_label_cvanulado43"><?php echo $this->nm_new_label['cvanulado43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['cvanulado43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['cvanulado43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['baseret43']))
    {
        $this->nm_new_label['baseret43'] = "Baseret 43";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $baseret43 = $this->baseret43;
   $sStyleHidden_baseret43 = '';
   if (isset($this->nmgp_cmp_hidden['baseret43']) && $this->nmgp_cmp_hidden['baseret43'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['baseret43']);
       $sStyleHidden_baseret43 = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_baseret43 = 'display: none;';
   $sStyleReadInp_baseret43 = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['baseret43']) && $this->nmgp_cmp_readonly['baseret43'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['baseret43']);
       $sStyleReadLab_baseret43 = '';
       $sStyleReadInp_baseret43 = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['baseret43']) && $this->nmgp_cmp_hidden['baseret43'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="baseret43" value="<?php echo $this->form_encode_input($baseret43) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_baseret43_label" id="hidden_field_label_baseret43" style="<?php echo $sStyleHidden_baseret43; ?>"><span id="id_label_baseret43"><?php echo $this->nm_new_label['baseret43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['baseret43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['baseret43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_baseret43_line" id="hidden_field_data_baseret43" style="<?php echo $sStyleHidden_baseret43; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_baseret43_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["baseret43"]) &&  $this->nmgp_cmp_readonly["baseret43"] == "on") { 

 ?>
<input type="hidden" name="baseret43" value="<?php echo $this->form_encode_input($baseret43) . "\">" . $baseret43 . ""; ?>
<?php } else { ?>
<span id="id_read_on_baseret43" class="sc-ui-readonly-baseret43 css_baseret43_line" style="<?php echo $sStyleReadLab_baseret43; ?>"><?php echo $this->form_format_readonly("baseret43", $this->form_encode_input($this->baseret43)); ?></span><span id="id_read_off_baseret43" class="css_read_off_baseret43<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_baseret43; ?>">
 <input class="sc-js-input scFormObjectOdd css_baseret43_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_baseret43" type=text name="baseret43" value="<?php echo $this->form_encode_input($baseret43) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=18"; } ?> alt="{datatype: 'decimal', maxLength: 18, precision: 2, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['baseret43']['symbol_dec']); ?>', thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['baseret43']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['baseret43']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['baseret43']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_baseret43_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_baseret43_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['ret_con_iva43']))
    {
        $this->nm_new_label['ret_con_iva43'] = "Ret Con Iva 43";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $ret_con_iva43 = $this->ret_con_iva43;
   $sStyleHidden_ret_con_iva43 = '';
   if (isset($this->nmgp_cmp_hidden['ret_con_iva43']) && $this->nmgp_cmp_hidden['ret_con_iva43'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['ret_con_iva43']);
       $sStyleHidden_ret_con_iva43 = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_ret_con_iva43 = 'display: none;';
   $sStyleReadInp_ret_con_iva43 = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['ret_con_iva43']) && $this->nmgp_cmp_readonly['ret_con_iva43'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['ret_con_iva43']);
       $sStyleReadLab_ret_con_iva43 = '';
       $sStyleReadInp_ret_con_iva43 = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['ret_con_iva43']) && $this->nmgp_cmp_hidden['ret_con_iva43'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="ret_con_iva43" value="<?php echo $this->form_encode_input($ret_con_iva43) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_ret_con_iva43_label" id="hidden_field_label_ret_con_iva43" style="<?php echo $sStyleHidden_ret_con_iva43; ?>"><span id="id_label_ret_con_iva43"><?php echo $this->nm_new_label['ret_con_iva43']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['ret_con_iva43']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['ret_con_iva43'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_ret_con_iva43_line" id="hidden_field_data_ret_con_iva43" style="<?php echo $sStyleHidden_ret_con_iva43; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ret_con_iva43_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["ret_con_iva43"]) &&  $this->nmgp_cmp_readonly["ret_con_iva43"] == "on") { 

 ?>
<input type="hidden" name="ret_con_iva43" value="<?php echo $this->form_encode_input($ret_con_iva43) . "\">" . $ret_con_iva43 . ""; ?>
<?php } else { ?>
<span id="id_read_on_ret_con_iva43" class="sc-ui-readonly-ret_con_iva43 css_ret_con_iva43_line" style="<?php echo $sStyleReadLab_ret_con_iva43; ?>"><?php echo $this->form_format_readonly("ret_con_iva43", $this->form_encode_input($this->ret_con_iva43)); ?></span><span id="id_read_off_ret_con_iva43" class="css_read_off_ret_con_iva43<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_ret_con_iva43; ?>">
 <input class="sc-js-input scFormObjectOdd css_ret_con_iva43_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_ret_con_iva43" type=text name="ret_con_iva43" value="<?php echo $this->form_encode_input($ret_con_iva43) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=1"; } ?> maxlength=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_ret_con_iva43_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_ret_con_iva43_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['retenciones43']))
    {
        $this->nm_new_label['retenciones43'] = "Retenciones 43";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $retenciones43 = $this->retenciones43;
   $sStyleHidden_retenciones43 = '';
   if (isset($this->nmgp_cmp_hidden['retenciones43']) && $this->nmgp_cmp_hidden['retenciones43'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['retenciones43']);
       $sStyleHidden_retenciones43 = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_retenciones43 = 'display: none;';
   $sStyleReadInp_retenciones43 = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['retenciones43']) && $this->nmgp_cmp_readonly['retenciones43'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['retenciones43']);
       $sStyleReadLab_retenciones43 = '';
       $sStyleReadInp_retenciones43 = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['retenciones43']) && $this->nmgp_cmp_hidden['retenciones43'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="retenciones43" value="<?php echo $this->form_encode_input($retenciones43) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_retenciones43_label" id="hidden_field_label_retenciones43" style="<?php echo $sStyleHidden_retenciones43; ?>"><span id="id_label_retenciones43"><?php echo $this->nm_new_label['retenciones43']; ?></span></TD>
    <TD class="scFormDataOdd css_retenciones43_line" id="hidden_field_data_retenciones43" style="<?php echo $sStyleHidden_retenciones43; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_retenciones43_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["retenciones43"]) &&  $this->nmgp_cmp_readonly["retenciones43"] == "on") { 

 ?>
<input type="hidden" name="retenciones43" value="<?php echo $this->form_encode_input($retenciones43) . "\">" . $retenciones43 . ""; ?>
<?php } else { ?>
<span id="id_read_on_retenciones43" class="sc-ui-readonly-retenciones43 css_retenciones43_line" style="<?php echo $sStyleReadLab_retenciones43; ?>"><?php echo $this->form_format_readonly("retenciones43", $this->form_encode_input($this->retenciones43)); ?></span><span id="id_read_off_retenciones43" class="css_read_off_retenciones43<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_retenciones43; ?>">
 <input class="sc-js-input scFormObjectOdd css_retenciones43_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_retenciones43" type=text name="retenciones43" value="<?php echo $this->form_encode_input($retenciones43) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=50"; } ?> maxlength=255 alt="{datatype: 'text', maxLength: 255, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_retenciones43_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_retenciones43_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_banco_label" id="hidden_field_label_banco" style="<?php echo $sStyleHidden_banco; ?>"><span id="id_label_banco"><?php echo $this->nm_new_label['banco']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['banco']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['banco'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_numero_transferencia_label" id="hidden_field_label_numero_transferencia" style="<?php echo $sStyleHidden_numero_transferencia; ?>"><span id="id_label_numero_transferencia"><?php echo $this->nm_new_label['numero_transferencia']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['numero_transferencia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['numero_transferencia'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_numero_transferencia_line" id="hidden_field_data_numero_transferencia" style="<?php echo $sStyleHidden_numero_transferencia; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_numero_transferencia_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_estado_electronico_label" id="hidden_field_label_estado_electronico" style="<?php echo $sStyleHidden_estado_electronico; ?>"><span id="id_label_estado_electronico"><?php echo $this->nm_new_label['estado_electronico']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['estado_electronico']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['estado_electronico'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_proyecto_label" id="hidden_field_label_proyecto" style="<?php echo $sStyleHidden_proyecto; ?>"><span id="id_label_proyecto"><?php echo $this->nm_new_label['proyecto']; ?></span></TD>
    <TD class="scFormDataOdd css_proyecto_line" id="hidden_field_data_proyecto" style="<?php echo $sStyleHidden_proyecto; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_proyecto_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_rubro_label" id="hidden_field_label_rubro" style="<?php echo $sStyleHidden_rubro; ?>"><span id="id_label_rubro"><?php echo $this->nm_new_label['rubro']; ?></span></TD>
    <TD class="scFormDataOdd css_rubro_line" id="hidden_field_data_rubro" style="<?php echo $sStyleHidden_rubro; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rubro_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_categoria_label" id="hidden_field_label_categoria" style="<?php echo $sStyleHidden_categoria; ?>"><span id="id_label_categoria"><?php echo $this->nm_new_label['categoria']; ?></span></TD>
    <TD class="scFormDataOdd css_categoria_line" id="hidden_field_data_categoria" style="<?php echo $sStyleHidden_categoria; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_categoria_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipo_documento_atado_label" id="hidden_field_label_tipo_documento_atado" style="<?php echo $sStyleHidden_tipo_documento_atado; ?>"><span id="id_label_tipo_documento_atado"><?php echo $this->nm_new_label['tipo_documento_atado']; ?></span></TD>
    <TD class="scFormDataOdd css_tipo_documento_atado_line" id="hidden_field_data_tipo_documento_atado" style="<?php echo $sStyleHidden_tipo_documento_atado; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_documento_atado_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_numero_documento_atado_label" id="hidden_field_label_numero_documento_atado" style="<?php echo $sStyleHidden_numero_documento_atado; ?>"><span id="id_label_numero_documento_atado"><?php echo $this->nm_new_label['numero_documento_atado']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_valor_superior_al_maximo_label" id="hidden_field_label_valor_superior_al_maximo" style="<?php echo $sStyleHidden_valor_superior_al_maximo; ?>"><span id="id_label_valor_superior_al_maximo"><?php echo $this->nm_new_label['valor_superior_al_maximo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['valor_superior_al_maximo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['php_cmp_required']['valor_superior_al_maximo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_valor_superior_al_maximo_line" id="hidden_field_data_valor_superior_al_maximo" style="<?php echo $sStyleHidden_valor_superior_al_maximo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valor_superior_al_maximo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_distribucion_retencion_label" id="hidden_field_label_distribucion_retencion" style="<?php echo $sStyleHidden_distribucion_retencion; ?>"><span id="id_label_distribucion_retencion"><?php echo $this->nm_new_label['distribucion_retencion']; ?></span></TD>
    <TD class="scFormDataOdd css_distribucion_retencion_line" id="hidden_field_data_distribucion_retencion" style="<?php echo $sStyleHidden_distribucion_retencion; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_distribucion_retencion_line" style="vertical-align: top;padding: 0px">
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_movpag");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_movpag");
 parent.scAjaxDetailHeight("form_movpag", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_movpag']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
