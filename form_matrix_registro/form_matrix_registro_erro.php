...
$old_error_handler = set_error_handler("form_matrix_registro_scriptcase_error_handler");

function form_matrix_registro_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_matrix_registro']['contr_erro']) && $_SESSION['scriptcase']['form_matrix_registro']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_matrix_registro->contr_form_matrix_registro->Apl_com_erro = true;
            if ($inicial_form_matrix_registro->contr_form_matrix_registro->NM_ajax_flag)
            {
                $inicial_form_matrix_registro->contr_form_matrix_registro->NM_ajax_info['errList']['geral_form_matrix_registro'][] = $msg;
                return;
            }
            form_matrix_registro_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_matrix_registro_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_matrix_registro'])  && '' != $_SESSION['scriptcase']['error_icon']['form_matrix_registro'])  ? $_SESSION['scriptcase']['error_icon']['form_matrix_registro']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_matrix_registro']) && '' != $_SESSION['scriptcase']['error_span_title']['form_matrix_registro']) ? $_SESSION['scriptcase']['error_span_title']['form_matrix_registro'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_matrix_registro']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_matrix_registro']) ? $_SESSION['scriptcase']['error_icon_title']['form_matrix_registro'] : '';
?>
