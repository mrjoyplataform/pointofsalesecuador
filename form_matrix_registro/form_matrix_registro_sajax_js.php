  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_matrix_registro" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_matrix_registro_form();
	}
...
?>
  ...
  // ---------- Validate nombre
  function do_ajax_form_matrix_registro_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_matrix_registro_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_matrix_registro_validate_nombre_cb);
  } // do_ajax_form_matrix_registro_validate_nombre

  function do_ajax_form_matrix_registro_validate_nombre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_matrix_registro_validate_nombre_cb

  // ---------- Validate apellido
  function do_ajax_form_matrix_registro_validate_apellido()
  {
    var nomeCampo_apellido = "apellido";
    var var_apellido = scAjaxGetFieldText(nomeCampo_apellido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_matrix_registro_validate_apellido(var_apellido, var_script_case_init, do_ajax_form_matrix_registro_validate_apellido_cb);
  } // do_ajax_form_matrix_registro_validate_apellido

  function do_ajax_form_matrix_registro_validate_apellido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_matrix_registro_validate_apellido_cb

  // ---------- Validate genre
  function do_ajax_form_matrix_registro_validate_genre()
  {
    var nomeCampo_genre = "genre";
    var var_genre = scAjaxGetFieldText(nomeCampo_genre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_matrix_registro_validate_genre(var_genre, var_script_case_init, do_ajax_form_matrix_registro_validate_genre_cb);
  } // do_ajax_form_matrix_registro_validate_genre

  function do_ajax_form_matrix_registro_validate_genre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "genre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_matrix_registro_validate_genre_cb

  // ---------- Validate nickname
  function do_ajax_form_matrix_registro_validate_nickname()
  {
    var nomeCampo_nickname = "nickname";
    var var_nickname = scAjaxGetFieldText(nomeCampo_nickname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_matrix_registro_validate_nickname(var_nickname, var_script_case_init, do_ajax_form_matrix_registro_validate_nickname_cb);
  } // do_ajax_form_matrix_registro_validate_nickname

  function do_ajax_form_matrix_registro_validate_nickname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_matrix_registro_validate_nickname_cb

  // ---------- Validate birth_date
  function do_ajax_form_matrix_registro_validate_birth_date()
  {
    var nomeCampo_birth_date = "birth_date";
    var var_birth_date = scAjaxGetFieldText(nomeCampo_birth_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_matrix_registro_validate_birth_date(var_birth_date, var_script_case_init, do_ajax_form_matrix_registro_validate_birth_date_cb);
  } // do_ajax_form_matrix_registro_validate_birth_date

  function do_ajax_form_matrix_registro_validate_birth_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_matrix_registro_validate_birth_date_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_matrix_registro_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_matrix_registro_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_matrix_registro_submit_form(var_nombre, var_apellido, var_genre, var_nickname, var_birth_date, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_matrix_registro_submit_form_cb);
  } // do_ajax_form_matrix_registro_submit_form

  function do_ajax_form_matrix_registro_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_matrix_registro_submit_form_cb_after_alert);
  } // do_ajax_form_matrix_registro_submit_form_cb
  function do_ajax_form_matrix_registro_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_matrix_registro_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_matrix_registro_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_matrix_registro_navigate_form, function() {});
    } else {
      perform_ajax_form_matrix_registro_navigate_form();
    }
  }

  function perform_ajax_form_matrix_registro_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_matrix_registro_navigate_form(var_idreg, var_uniqueidqr, var_fecha_registro, var_estado, var_rfid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_matrix_registro_navigate_form_cb);
  } // do_ajax_form_matrix_registro_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_matrix_registro_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_matrix_registro_navigate_form_cb_after_alert);
  } // do_ajax_form_matrix_registro_navigate_form_cb
  function do_ajax_form_matrix_registro_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_matrix_registro_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_matrix_registro_navigate_form_cb_after_alert

  function sc_hide_form_matrix_registro_form()
  {
