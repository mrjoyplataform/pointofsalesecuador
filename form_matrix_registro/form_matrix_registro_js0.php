...
<input type="hidden" name="uniqueidqr" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['uniqueidqr']); ?>">
<input type="hidden" name="fecha_registro" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['fecha_registro']); ?>">
<input type="hidden" name="estado" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['estado']); ?>">
<input type="hidden" name="rfid" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['rfid']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_matrix_registro"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_detal']))
  {
?>  
