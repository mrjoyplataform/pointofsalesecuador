  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_matrix_registro_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_matrix_registro_mob_form();
	}
...
?>
  ...
  // ---------- Validate nombre
  function do_ajax_form_matrix_registro_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_matrix_registro_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_matrix_registro_mob_validate_nombre_cb);
  } // do_ajax_form_matrix_registro_mob_validate_nombre

  function do_ajax_form_matrix_registro_mob_validate_nombre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_matrix_registro_mob_validate_nombre_cb

  // ---------- Validate apellido
  function do_ajax_form_matrix_registro_mob_validate_apellido()
  {
    var nomeCampo_apellido = "apellido";
    var var_apellido = scAjaxGetFieldText(nomeCampo_apellido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_matrix_registro_mob_validate_apellido(var_apellido, var_script_case_init, do_ajax_form_matrix_registro_mob_validate_apellido_cb);
  } // do_ajax_form_matrix_registro_mob_validate_apellido

  function do_ajax_form_matrix_registro_mob_validate_apellido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_matrix_registro_mob_validate_apellido_cb

  // ---------- Validate genre
  function do_ajax_form_matrix_registro_mob_validate_genre()
  {
    var nomeCampo_genre = "genre";
    var var_genre = scAjaxGetFieldText(nomeCampo_genre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_matrix_registro_mob_validate_genre(var_genre, var_script_case_init, do_ajax_form_matrix_registro_mob_validate_genre_cb);
  } // do_ajax_form_matrix_registro_mob_validate_genre

  function do_ajax_form_matrix_registro_mob_validate_genre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "genre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_matrix_registro_mob_validate_genre_cb

  // ---------- Validate nickname
  function do_ajax_form_matrix_registro_mob_validate_nickname()
  {
    var nomeCampo_nickname = "nickname";
    var var_nickname = scAjaxGetFieldText(nomeCampo_nickname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_matrix_registro_mob_validate_nickname(var_nickname, var_script_case_init, do_ajax_form_matrix_registro_mob_validate_nickname_cb);
  } // do_ajax_form_matrix_registro_mob_validate_nickname

  function do_ajax_form_matrix_registro_mob_validate_nickname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nickname";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_matrix_registro_mob_validate_nickname_cb

  // ---------- Validate birth_date
  function do_ajax_form_matrix_registro_mob_validate_birth_date()
  {
    var nomeCampo_birth_date = "birth_date";
    var var_birth_date = scAjaxGetFieldText(nomeCampo_birth_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_matrix_registro_mob_validate_birth_date(var_birth_date, var_script_case_init, do_ajax_form_matrix_registro_mob_validate_birth_date_cb);
  } // do_ajax_form_matrix_registro_mob_validate_birth_date

  function do_ajax_form_matrix_registro_mob_validate_birth_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "birth_date";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_matrix_registro_mob_validate_birth_date_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_matrix_registro_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_matrix_registro_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nombre = scAjaxGetFieldText("nombre");
    var var_apellido = scAjaxGetFieldText("apellido");
    var var_genre = scAjaxGetFieldText("genre");
    var var_nickname = scAjaxGetFieldText("nickname");
    var var_birth_date = scAjaxGetFieldText("birth_date");
    var var_idreg = scAjaxGetFieldText("idreg");
    var var_uniqueidqr = scAjaxGetFieldText("uniqueidqr");
    var var_fecha_registro = scAjaxGetFieldText("fecha_registro");
    var var_estado = scAjaxGetFieldText("estado");
    var var_rfid = scAjaxGetFieldText("rfid");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_matrix_registro_mob_submit_form(var_nombre, var_apellido, var_genre, var_nickname, var_birth_date, var_idreg, var_uniqueidqr, var_fecha_registro, var_estado, var_rfid, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_matrix_registro_mob_submit_form_cb);
  } // do_ajax_form_matrix_registro_mob_submit_form

  function do_ajax_form_matrix_registro_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("genre");
      scAjaxHideErrorDisplay("nickname");
      scAjaxHideErrorDisplay("birth_date");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_matrix_registro_mob_submit_form_cb_after_alert);
  } // do_ajax_form_matrix_registro_mob_submit_form_cb
  function do_ajax_form_matrix_registro_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_matrix_registro_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_matrix_registro_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_matrix_registro_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_matrix_registro_mob_navigate_form();
    }
  }

  function perform_ajax_form_matrix_registro_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_uniqueidqr = document.F2.uniqueidqr.value;
    var var_fecha_registro = document.F2.fecha_registro.value;
    var var_estado = document.F2.estado.value;
    var var_rfid = document.F2.rfid.value;
    ...
    scAjaxProcOn();
    x_ajax_form_matrix_registro_mob_navigate_form(var_idreg, var_uniqueidqr, var_fecha_registro, var_estado, var_rfid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_matrix_registro_mob_navigate_form_cb);
  } // do_ajax_form_matrix_registro_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_matrix_registro_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.uniqueidqr.value = scAjaxGetKeyValue("uniqueidqr");
    document.F2.fecha_registro.value = scAjaxGetKeyValue("fecha_registro");
    document.F2.estado.value = scAjaxGetKeyValue("estado");
    document.F2.rfid.value = scAjaxGetKeyValue("rfid");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_matrix_registro_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_matrix_registro_mob_navigate_form_cb
  function do_ajax_form_matrix_registro_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_matrix_registro_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_matrix_registro_mob_navigate_form_cb_after_alert

  function sc_hide_form_matrix_registro_mob_form()
  {
  ...
  ajax_field_list[1] = "apellido";
  ajax_field_list[2] = "genre";
  ajax_field_list[3] = "nickname";
  ajax_field_list[4] = "birth_date";
  ...
  var ajax_error_list = {
    ...
    "genre": {"label": "Genre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nickname": {"label": "Nickname", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "birth_date": {"label": "Birth Date", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["genre"][1] = "genre";
  ajax_field_mult["nickname"][1] = "nickname";
  ajax_field_mult["birth_date"][1] = "birth_date";
  ...
  var ajax_field_id = {
    ...
    "genre": new Array("hidden_field_label_genre", "hidden_field_data_genre"),
    "nickname": new Array("hidden_field_label_nickname", "hidden_field_data_nickname"),
    "birth_date": new Array("hidden_field_label_birth_date", "hidden_field_data_birth_date")
  };
