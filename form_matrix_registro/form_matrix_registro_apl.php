<?php
//
class form_matrix_registro_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_matrix_registro']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_matrix_registro']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_matrix_registro']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_matrix_registro']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_matrix_registro']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_matrix_registro']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_matrix_registro']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_matrix_registro']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_matrix_registro']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_matrix_registro']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_matrix_registro']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_matrix_registro']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_matrix_registro']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_matrix_registro']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_matrix_registro']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_matrix_registro']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_matrix_registro']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_matrix_registro_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_matrix_registro']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_matrix_registro']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_matrix_registro'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_matrix_registro']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_matrix_registro']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_matrix_registro') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_matrix_registro']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " matrix";
      ...
      $_SESSION['scriptcase']['error_icon']['form_matrix_registro']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_matrix_registro'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_matrix_registro']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_matrix_registro'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_matrix_registro'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_matrix_registro", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_matrix_registro/form_matrix_registro_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_matrix_registro_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_matrix_registro_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_matrix_registro_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_matrix_registro/form_matrix_registro_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_matrix_registro_erro.class.php"); 
      }
      $this->Erro      = new form_matrix_registro_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['opcao']))
         { 
             if ($this->idreg != "" || $this->uniqueidqr != "" || $this->fecha_registro != "" || $this->estado != "" || $this->rfid != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_matrix_registro']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_matrix_registro.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_matrix_registro_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_matrix_registro"> 
...
//---
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idreg']['keyVal'] = form_matrix_registro_pack_protect_string($this->nmgp_dados_form['idreg']);
              $this->NM_ajax_info['fldList']['uniqueidqr']['keyVal'] = form_matrix_registro_pack_protect_string($this->nmgp_dados_form['uniqueidqr']);
              $this->NM_ajax_info['fldList']['fecha_registro']['keyVal'] = form_matrix_registro_pack_protect_string($this->nmgp_dados_form['fecha_registro']);
              $this->NM_ajax_info['fldList']['estado']['keyVal'] = form_matrix_registro_pack_protect_string($this->nmgp_dados_form['estado']);
              $this->NM_ajax_info['fldList']['rfid']['keyVal'] = form_matrix_registro_pack_protect_string($this->nmgp_dados_form['rfid']);
          }
   } // ajax_return_values
   ...
   function ajax_return_values_birth_date($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['parms'] = "idreg?#?$this->idreg?@?uniqueidqr?#?$this->uniqueidqr?@?fecha_registro?#?$this->fecha_registro?@?estado?#?$this->estado?@?rfid?#?$this->rfid?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_matrix_registro = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['total'] = $qt_geral_reg_form_matrix_registro;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idreg) && !empty($this->uniqueidqr) && !empty($this->fecha_registro) && !empty($this->estado) && !empty($this->rfid))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_matrix_registro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_start'] > $qt_geral_reg_form_matrix_registro)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_start'] = $qt_geral_reg_form_matrix_registro; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_matrix_registro) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_start'] < $qt_geral_reg_form_matrix_registro;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_matrix_registro_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['table_refresh'])
        {
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_matrix_registro = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['total'] = $qt_geral_reg_form_matrix_registro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_matrix_registro_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_matrix_registro_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_matrix_registro_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_matrix_registro']['ordem_ord'] == " desc") {
