...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "efectivo";$Nm_numeric[] = "efectivo";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_efectivo_cond" name="efectivo_cond" onChange="nm_campos_between(document.getElementById('id_vis_efectivo'), this, 'efectivo')">
      ...
      <br><span id="id_hide_efectivo"  <?php echo $str_hide_efectivo?>><INPUT  type="text" id="SC_efectivo" name="efectivo" value="<?php echo NM_encode_input($efectivo) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idpays_type_cond" name="idpays_type_cond" onChange="nm_campos_between(document.getElementById('id_vis_idpays_type'), this, 'idpays_type')">
      ...
      <br><span id="id_hide_idpays_type"  <?php echo $str_hide_idpays_type?>><?php
      if ($idpays_type != "")
      {
      $idpays_type_look = substr($this->Db->qstr($idpays_type), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_descrip_cond" name="descrip_cond" onChange="nm_campos_between(document.getElementById('id_vis_descrip'), this, 'descrip')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_imagen_cond" name="imagen_cond" onChange="nm_campos_between(document.getElementById('id_vis_imagen'), this, 'imagen')">
      ...
      <br><span id="id_hide_imagen"  <?php echo $str_hide_imagen?>><INPUT  type="text" id="SC_imagen" name="imagen" value="<?php echo NM_encode_input($imagen) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
 </TD>
