...
<?php
   ...
   $Ord_Cmp = new grid_pays_type_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_pays_type_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pays_type']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pays_type']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idpays_type'] = "idpays_type";
   $tab_labels["idpays_type"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pays_type']['labels']["idpays_type"])) ? $_SESSION['sc_session'][$sc_init]['grid_pays_type']['labels']["idpays_type"] : "Idpays Type";
   $tab_ger_campos['descrip'] = "on";
   $tab_def_campos['descrip'] = "descrip";
   $tab_labels["descrip"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pays_type']['labels']["descrip"])) ? $_SESSION['sc_session'][$sc_init]['grid_pays_type']['labels']["descrip"] : "Descrip";
   $tab_ger_campos['imagen'] = "on";
   $tab_def_campos['imagen'] = "imagen";
   $tab_labels["imagen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pays_type']['labels']["imagen"])) ? $_SESSION['sc_session'][$sc_init]['grid_pays_type']['labels']["imagen"] : "Imagen";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pays_type']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_pays_type']['labels']["tipo"] : "Tipo";
   $tab_ger_campos['efectivo'] = "on";
   $tab_def_campos['efectivo'] = "efectivo";
   $tab_labels["efectivo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pays_type']['labels']["efectivo"])) ? $_SESSION['sc_session'][$sc_init]['grid_pays_type']['labels']["efectivo"] : "Efectivo";
   $tab_ger_campos['imagen'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_pays_type']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_pays_type']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_pays_type']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pays_type']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pays_type']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_pays_type']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_pays_type']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_pays_type']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_pays_type']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_pays_type']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_pays_type']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_pays_type']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_pays_type_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_pays_type']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_pays_type']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_pays_type']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_pays_type']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_pays_type']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
