<?php
@session_start() ;
$_SESSION['scriptcase']['grid_pays_type']['sc_process_barr'] = true;
require_once('../grid_pays_type/index.php');
unset($_SESSION['scriptcase']['grid_pays_type']['sc_process_barr']);
$ExportCtrl = new grid_pays_type_export_control;
$ExportCtrl->Export_barr();

class grid_pays_type_export_control
{
