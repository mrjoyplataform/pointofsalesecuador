...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_pays_type"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_pays_type"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_pays_type'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pays_type']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_pays_type']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pays_type']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_pays_type']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_pays_type']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_pays_type']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_pays_type']['embutida_filho'] as $ind => $sc_init)
          {
