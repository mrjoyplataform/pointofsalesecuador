...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_product";$Nm_numeric[] = "quantity";$Nm_numeric[] = "item_total";$Nm_numeric[] = "idturno";$Nm_numeric[] = "id_product";$Nm_numeric[] = "quantity";$Nm_numeric[] = "item_total";$Nm_numeric[] = "idturno";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_item_total_cond" name="item_total_cond" onChange="nm_campos_between(document.getElementById('id_vis_item_total'), this, 'item_total')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idturno_cond" name="idturno_cond" onChange="nm_campos_between(document.getElementById('id_vis_idturno'), this, 'idturno')">
      ...
      <br><span id="id_hide_idturno"  <?php echo $str_hide_idturno?>><INPUT  type="text" id="SC_idturno" name="idturno" value="<?php echo NM_encode_input($idturno) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
