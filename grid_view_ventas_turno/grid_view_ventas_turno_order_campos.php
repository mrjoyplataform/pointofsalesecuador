...
<?php
   ...
   $Ord_Cmp = new grid_view_ventas_turno_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_view_ventas_turno_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id_product"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['labels']["id_product"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['labels']["id_product"] : "Id Product";
   $tab_ger_campos['quantity'] = "on";
   $tab_def_campos['quantity'] = "quantity";
   $tab_labels["quantity"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['labels']["quantity"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['labels']["quantity"] : "Quantity";
   $tab_ger_campos['item_total'] = "on";
   $tab_def_campos['item_total'] = "item_total";
   $tab_labels["item_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['labels']["item_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['labels']["item_total"] : "Item Total";
   $tab_ger_campos['idturno'] = "on";
   $tab_def_campos['idturno'] = "idturno";
   $tab_labels["idturno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['labels']["idturno"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['labels']["idturno"] : "Idturno";
   $tab_ger_campos['serie'] = "on";
   $tab_def_campos['serie'] = "serie";
   $tab_labels["serie"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['labels']["serie"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['labels']["serie"] : "Factura";
   $tab_ger_campos['idcliente'] = "on";
   $tab_def_campos['idcliente'] = "idcliente";
   $tab_labels["idcliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['labels']["idcliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['labels']["idcliente"] : "Idcliente";
   $tab_ger_campos['idempleado'] = "on";
   $tab_def_campos['idempleado'] = "idempleado";
   $tab_labels["idempleado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['labels']["idempleado"])) ? $_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['labels']["idempleado"] : "Idempleado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_view_ventas_turno_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_view_ventas_turno']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
