...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "activo";$Nm_numeric[] = "activo";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_menu_default_cond" name="menu_default_cond" onChange="nm_campos_between(document.getElementById('id_vis_menu_default'), this, 'menu_default')">
      ...
      <br><span id="id_hide_menu_default"  <?php echo $str_hide_menu_default?>><INPUT  type="text" id="SC_menu_default" name="menu_default" value="<?php echo NM_encode_input($menu_default) ?>" size="50" maxlength="32767" class="scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idempleado_cond" name="idempleado_cond" onChange="nm_campos_between(document.getElementById('id_vis_idempleado'), this, 'idempleado')">
      ...
      <br><span id="id_hide_idempleado"  <?php echo $str_hide_idempleado?>><?php
      if ($idempleado != "")
      {
      $idempleado_look = substr($this->Db->qstr($idempleado), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_activo_cond" name="activo_cond" onChange="nm_campos_between(document.getElementById('id_vis_activo'), this, 'activo')">
      ...
      <br><span id="id_hide_activo"  <?php echo $str_hide_activo?>><INPUT  type="text" id="SC_activo" name="activo" value="<?php echo NM_encode_input($activo) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
