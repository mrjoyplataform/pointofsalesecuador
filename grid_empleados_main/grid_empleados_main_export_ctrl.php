<?php
@session_start() ;
$_SESSION['scriptcase']['grid_empleados_main']['sc_process_barr'] = true;
require_once('../grid_empleados_main/index.php');
unset($_SESSION['scriptcase']['grid_empleados_main']['sc_process_barr']);
$ExportCtrl = new grid_empleados_main_export_control;
$ExportCtrl->Export_barr();

class grid_empleados_main_export_control
{
