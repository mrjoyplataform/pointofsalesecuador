...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_empleados_main"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_empleados_main"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_empleados_main']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_empleados_main']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_empleados_main']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_empleados_main']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_empleados_main']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_empleados_main</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_empleados_main']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_empleados_main']['embutida_filho'] as $ind => $sc_init)
          {
