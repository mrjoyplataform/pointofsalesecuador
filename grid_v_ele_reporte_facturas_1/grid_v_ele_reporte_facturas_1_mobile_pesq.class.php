...
<HTML>
<HEAD>
 <TITLE> v_ele_reporte_facturas</TITLE>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_establecimiento_cond" name="establecimiento_cond" onChange="nm_campos_between(document.getElementById('id_vis_establecimiento'), this, 'establecimiento')">
