...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_dateproduct_hora' + iSeqRow).bind('blur', function() { sc_form_product_dateproduct_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_product_dateproduct_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_product_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_dateproduct" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_product_mob_validate_dateproduct(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_ultfechaventa" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_product_mob_validate_ultfechaventa(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_image" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_product_mob_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_product_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
