...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["clubmrjoy" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["clubmrjoy" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["clubmrjoy" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_product' + iSeqRow).bind('change', function() { sc_form_product_id_product_onchange(this, iSeqRow) });
  $('#id_sc_field_product_name' + iSeqRow).bind('blur', function() { sc_form_product_product_name_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_product_product_name_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_product_product_name_onfocus(this, iSeqRow) });
  $('#id_sc_field_product_code' + iSeqRow).bind('blur', function() { sc_form_product_product_code_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_product_product_code_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_product_product_code_onfocus(this, iSeqRow) });
  $('#id_sc_field_id_status' + iSeqRow).bind('blur', function() { sc_form_product_id_status_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_product_id_status_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_product_id_status_onfocus(this, iSeqRow) });
  $('#id_sc_field_dateproduct' + iSeqRow).bind('blur', function() { sc_form_product_dateproduct_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_product_dateproduct_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_product_dateproduct_onfocus(this, iSeqRow) });
  $('#id_sc_field_dateproduct_hora' + iSeqRow).bind('blur', function() { sc_form_product_dateproduct_hora_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_product_dateproduct_hora_onchange(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_product_dateproduct_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_product_value' + iSeqRow).bind('blur', function() { sc_form_product_product_value_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_product_product_value_onchange(this, iSeqRow) })
                                           .bind('click', function() { sc_form_product_product_value_onclick(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_product_product_value_onfocus(this, iSeqRow) });
  $('#id_sc_field_product_cost' + iSeqRow).bind('blur', function() { sc_form_product_product_cost_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_product_product_cost_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_product_product_cost_onfocus(this, iSeqRow) });
  $('#id_sc_field_discount' + iSeqRow).bind('blur', function() { sc_form_product_discount_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_product_discount_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_product_discount_onfocus(this, iSeqRow) });
  $('#id_sc_field_stock' + iSeqRow).bind('blur', function() { sc_form_product_stock_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_product_stock_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_product_stock_onfocus(this, iSeqRow) });
  $('#id_sc_field_id_category' + iSeqRow).bind('blur', function() { sc_form_product_id_category_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_product_id_category_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_product_id_category_onfocus(this, iSeqRow) });
  $('#id_sc_field_image' + iSeqRow).bind('blur', function() { sc_form_product_image_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_product_image_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_product_image_onfocus(this, iSeqRow) });
  $('#id_sc_field_service' + iSeqRow).bind('blur', function() { sc_form_product_service_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_product_service_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_product_service_onfocus(this, iSeqRow) });
  $('#id_sc_field_kiosko' + iSeqRow).bind('blur', function() { sc_form_product_kiosko_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_product_kiosko_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_product_kiosko_onfocus(this, iSeqRow) });
  $('#id_sc_field_entrada' + iSeqRow).bind('blur', function() { sc_form_product_entrada_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_product_entrada_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_product_entrada_onfocus(this, iSeqRow) });
  $('#id_sc_field_jugador' + iSeqRow).bind('blur', function() { sc_form_product_jugador_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_product_jugador_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_product_jugador_onfocus(this, iSeqRow) });
  $('#id_sc_field_visitante' + iSeqRow).bind('blur', function() { sc_form_product_visitante_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_product_visitante_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_product_visitante_onfocus(this, iSeqRow) });
  $('#id_sc_field_tarjeta' + iSeqRow).bind('blur', function() { sc_form_product_tarjeta_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_product_tarjeta_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_product_tarjeta_onfocus(this, iSeqRow) });
  $('#id_sc_field_minutos' + iSeqRow).bind('blur', function() { sc_form_product_minutos_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_product_minutos_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_product_minutos_onfocus(this, iSeqRow) });
  $('#id_sc_field_tokens' + iSeqRow).bind('blur', function() { sc_form_product_tokens_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_product_tokens_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_product_tokens_onfocus(this, iSeqRow) });
  $('#id_sc_field_comida' + iSeqRow).bind('blur', function() { sc_form_product_comida_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_product_comida_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_product_comida_onfocus(this, iSeqRow) });
  $('#id_sc_field_score' + iSeqRow).bind('blur', function() { sc_form_product_score_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_product_score_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_product_score_onfocus(this, iSeqRow) });
  $('#id_sc_field_poriva' + iSeqRow).bind('blur', function() { sc_form_product_poriva_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_product_poriva_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_product_poriva_onfocus(this, iSeqRow) });
  $('#id_sc_field_cuentaventa' + iSeqRow).bind('blur', function() { sc_form_product_cuentaventa_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_product_cuentaventa_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_product_cuentaventa_onfocus(this, iSeqRow) });
  $('#id_sc_field_unidad' + iSeqRow).bind('blur', function() { sc_form_product_unidad_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_product_unidad_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_product_unidad_onfocus(this, iSeqRow) });
  $('#id_sc_field_tipoitem' + iSeqRow).bind('blur', function() { sc_form_product_tipoitem_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_product_tipoitem_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_product_tipoitem_onfocus(this, iSeqRow) });
  $('#id_sc_field_cuentacompra' + iSeqRow).bind('blur', function() { sc_form_product_cuentacompra_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_product_cuentacompra_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_product_cuentacompra_onfocus(this, iSeqRow) });
  $('#id_sc_field_precioventa' + iSeqRow).bind('blur', function() { sc_form_product_precioventa_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_product_precioventa_onchange(this, iSeqRow) })
                                         .bind('click', function() { sc_form_product_precioventa_onclick(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_product_precioventa_onfocus(this, iSeqRow) });
  $('#id_sc_field_puntoventa' + iSeqRow).bind('blur', function() { sc_form_product_puntoventa_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_product_puntoventa_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_product_puntoventa_onfocus(this, iSeqRow) });
  $('#id_sc_field_orden' + iSeqRow).bind('blur', function() { sc_form_product_orden_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_product_orden_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_product_orden_onfocus(this, iSeqRow) });
  $('#id_sc_field_arcade_clasic' + iSeqRow).bind('change', function() { sc_form_product_arcade_clasic_onchange(this, iSeqRow) });
  $('#id_sc_field_ultfechaventa' + iSeqRow).bind('change', function() { sc_form_product_ultfechaventa_onchange(this, iSeqRow) });
  $('#id_sc_field_ultfechaventa_hora' + iSeqRow).bind('change', function() { sc_form_product_ultfechaventa_hora_onchange(this, iSeqRow) });
  $('#id_sc_field_ingrediente' + iSeqRow).bind('change', function() { sc_form_product_ingrediente_onchange(this, iSeqRow) });
  $('#id_sc_field_clubmrjoy' + iSeqRow).bind('blur', function() { sc_form_product_clubmrjoy_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_product_clubmrjoy_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_product_clubmrjoy_onfocus(this, iSeqRow) });
  $('#id_sc_field_combos_recetas' + iSeqRow).bind('blur', function() { sc_form_product_combos_recetas_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_product_combos_recetas_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_product_combos_recetas_onfocus(this, iSeqRow) });
  ...
  $('.sc-ui-radio-clubmrjoy' + iSeqRow).on('click', function() { scMarkFormAsChanged(); });
} // scJQEventsAdd

function sc_form_product_id_product_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_product_name_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_product_name();
  scCssBlur(oThis);
}

function sc_form_product_product_name_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_product_name_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_product_code_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_product_code();
  scCssBlur(oThis);
}

function sc_form_product_product_code_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_product_code_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_id_status_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_id_status();
  scCssBlur(oThis);
}

function sc_form_product_id_status_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_id_status_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_dateproduct_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_dateproduct();
  scCssBlur(oThis);
}

function sc_form_product_dateproduct_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_dateproduct();
  scCssBlur(oThis);
}

function sc_form_product_dateproduct_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_dateproduct_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_dateproduct_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_dateproduct_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_product_value_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_product_value();
  scCssBlur(oThis);
}

function sc_form_product_product_value_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_product_value_onclick(oThis, iSeqRow) {
  do_ajax_form_product_event_product_value_onclick();
}

function sc_form_product_product_value_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_product_cost_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_product_cost();
  scCssBlur(oThis);
}

function sc_form_product_product_cost_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_product_cost_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_discount_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_discount();
  scCssBlur(oThis);
}

function sc_form_product_discount_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_discount_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_stock_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_stock();
  scCssBlur(oThis);
}

function sc_form_product_stock_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_stock_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_id_category_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_id_category();
  scCssBlur(oThis);
}

function sc_form_product_id_category_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_id_category_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_image_onblur(oThis, iSeqRow) {
  scCssBlur(oThis);
}

function sc_form_product_image_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_image_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_form_product_service_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_service();
  scCssBlur(oThis);
}

function sc_form_product_service_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_service_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_kiosko_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_kiosko();
  scCssBlur(oThis);
}

function sc_form_product_kiosko_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_kiosko_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_entrada_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_entrada();
  scCssBlur(oThis);
}

function sc_form_product_entrada_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_entrada_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_jugador_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_jugador();
  scCssBlur(oThis);
}

function sc_form_product_jugador_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_jugador_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_visitante_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_visitante();
  scCssBlur(oThis);
}

function sc_form_product_visitante_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_visitante_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_tarjeta_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_tarjeta();
  scCssBlur(oThis);
}

function sc_form_product_tarjeta_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_tarjeta_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_minutos_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_minutos();
  scCssBlur(oThis);
}

function sc_form_product_minutos_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_minutos_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_tokens_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_tokens();
  scCssBlur(oThis);
}

function sc_form_product_tokens_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_tokens_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_comida_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_comida();
  scCssBlur(oThis);
}

function sc_form_product_comida_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_comida_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_score_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_score();
  scCssBlur(oThis);
}

function sc_form_product_score_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_score_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_poriva_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_poriva();
  scCssBlur(oThis);
}

function sc_form_product_poriva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_poriva_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_cuentaventa_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_cuentaventa();
  scCssBlur(oThis);
}

function sc_form_product_cuentaventa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_cuentaventa_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_unidad_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_unidad();
  scCssBlur(oThis);
}

function sc_form_product_unidad_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_unidad_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_tipoitem_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_tipoitem();
  scCssBlur(oThis);
}

function sc_form_product_tipoitem_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_tipoitem_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_cuentacompra_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_cuentacompra();
  scCssBlur(oThis);
}

function sc_form_product_cuentacompra_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_cuentacompra_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_precioventa_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_precioventa();
  scCssBlur(oThis);
}

function sc_form_product_precioventa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_precioventa_onclick(oThis, iSeqRow) {
  do_ajax_form_product_event_precioventa_onclick();
}

function sc_form_product_precioventa_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_puntoventa_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_puntoventa();
  scCssBlur(oThis);
}

function sc_form_product_puntoventa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_puntoventa_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_orden_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_orden();
  scCssBlur(oThis);
}

function sc_form_product_orden_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_orden_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_arcade_clasic_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_ultfechaventa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_ultfechaventa_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_ingrediente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_clubmrjoy_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_clubmrjoy();
  scCssBlur(oThis);
}

function sc_form_product_clubmrjoy_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_clubmrjoy_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_product_combos_recetas_onblur(oThis, iSeqRow) {
  do_ajax_form_product_validate_combos_recetas();
  scCssBlur(oThis);
}

function sc_form_product_combos_recetas_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_product_combos_recetas_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_block_3(status) {
	...
	displayChange_field("clubmrjoy", "", status);
}
...
function displayChange_row(row, status) {
	...
	displayChange_field_clubmrjoy(row, status);
}
...
function displayChange_field_combos_recetas(row, status) {
    var fieldId;
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_product_combo")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_product_combo")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_clubmrjoy(row, status) {
    var fieldId;
}
...
function scHidePage(pageNo) {
	$("#id_form_product_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_dateproduct" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_product_validate_dateproduct(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_ultfechaventa" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_product_validate_ultfechaventa(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_product')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
