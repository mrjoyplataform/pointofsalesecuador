...
class grid_promedio_satisfaccion_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_promedio_califica;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_promedio_califica = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_promedio_satisfaccion']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_promedio_satisfaccion']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['contr_total_geral'] == "OK")
      {
          $this->array_total_promedio_califica = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['arr_total']['promedio_califica'];
          $this->array_total_idproducto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['arr_total']['idproducto'];
      }
      else
      {
          $this->array_total_promedio_califica = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['tot_geral'][3];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['arr_total']['promedio_califica'] = $this->array_total_promedio_califica;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['arr_total']['idproducto'] = $this->array_total_idproducto;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['json_use_label'])
       {
          $Lab_promedio_califica = "promedio_califica";
          $Lab_idproducto = "idproducto";
       }
       else
       {
       $Lab_promedio_califica = "Promedio Califica";
       $Lab_idproducto = "Idproducto";
       }
       $this->comp_field = array(
           $Lab_promedio_califica,
           $Lab_idproducto,
       );
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['labels']['promedio_califica'] = $Lab_promedio_califica; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['labels']['idproducto'] = $Lab_idproducto; 

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['labels']['fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['labels']['fecha'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['labels']['idproducto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['labels']['idproducto'] = "Idproducto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['labels']['cantidad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['labels']['cantidad'] = "Cantidad"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['labels']['promedio_califica']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['labels']['promedio_califica'] = "Promedio Califica"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['labels']['califica']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['labels']['califica'] = "Califica"; 
       }
       //-----
       $this->comp_field_nm = array(
           'promedio_califica' => 0,
       ...
       $this->comp_sum = array(
           2 => "Cantidad ",
           3 => "Promedio Califica (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['summarizing_fields_order']['califica']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['summarizing_fields_order']['califica'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['summarizing_fields_order']['califica'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['summarizing_fields_display']['califica'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['summarizing_fields_display']['califica'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['summarizing_fields_display']['califica'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['summarizing_fields_display']['califica'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['summarizing_fields_display']['califica'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['summarizing_fields_display']['califica'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['summarizing_fields_display']['califica'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           3 => array('field' => "promedio_califica", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_cantidad_avg",
           3 => "css_promedio_califica_avg",
       );

       //-----
       $this->comp_sum_nm = array(
           2 => "cantidad_avg",
           3 => "promedio_califica_avg",
       );

       //-----
       foreach ($this->array_total_promedio_califica as $i_promedio_califica => $d_promedio_califica) {
           if (!in_array($i_promedio_califica, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_promedio_califica[4] ] = $d_promedio_califica[3];
               $this->comp_label[0][ $d_promedio_califica[4] ] = $d_promedio_califica[3];
           }
           foreach ($this->array_total_idproducto[$i_promedio_califica] as $i_idproducto => $d_idproducto) {
               if (!in_array($i_idproducto, $this->comp_label[1][ $d_promedio_califica[4] ], true)) {
                   $this->comp_index[1][ $d_idproducto[4] ] = $d_idproducto[3];
                   $this->comp_label[1][ $d_promedio_califica[4] ][ $d_idproducto[4] ] = $d_idproducto[3];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'promedio_califica', 'prot' => ''),
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_promedio_califica => $l_promedio_califica) {
           if (isset($this->array_total_promedio_califica[$i_promedio_califica])) {
               $this->comp_group[$i_promedio_califica] = array();
           }
           foreach ($this->comp_label[1][$i_promedio_califica] as $i_idproducto => $l_idproducto) {
               if (isset($this->array_total_idproducto[$i_promedio_califica][$i_idproducto])) {
                   $this->comp_group[$i_promedio_califica][$i_idproducto] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_promedio_califica;
       }
       elseif (1 == $level) {
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_promedio_satisfaccion@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               'title'    => $this->getChartText(strip_tags("Cantidad ")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'promedio_califica',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_promedio_califica)),
               'label_y'  => $this->getChartText(strip_tags("Cantidad ")),
               'format'   => $this->formatChartValue(1),
           ),
           '0|2' => array(
               'title'    => $this->getChartText(strip_tags("Promedio Califica (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'promedio_califica',
               'field_y'  => $this->comp_sum_nm[3],
               'label_x'  => $this->getChartText(strip_tags($Lab_promedio_califica)),
               'label_y'  => $this->getChartText(strip_tags("Promedio Califica (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_promedio_satisfaccion_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_promedio_satisfaccion_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_promedio_satisfaccion_total.class.php"); 
      }
      ...
      $this->Total   = new grid_promedio_satisfaccion_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_promedio_califica);
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_promedio_satisfaccion/grid_promedio_satisfaccion_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_promedio_satisfaccion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_promedio_satisfaccion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_promedio_satisfaccion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['num_css'] . '.css');
     ...
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_promedio_satisfaccion/grid_promedio_satisfaccion_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_promedio_satisfaccion/grid_promedio_satisfaccion_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_promedio_satisfaccion/grid_promedio_satisfaccion_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_promedio_satisfaccion/grid_promedio_satisfaccion_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_promedio_satisfaccion/grid_promedio_satisfaccion_config_graf_flash.php?nome_apl=grid_promedio_satisfaccion&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_promedio_satisfaccion_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rpdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['pdf'][] = "Rpdf_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_promedio_satisfaccion/grid_promedio_satisfaccion_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=s&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&nm_label_group=N&nm_all_cab=S&nm_all_label=S&pdf_zip=N&nm_orient_grid=2&origem=res&language=es&conf_socor=N&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_promedio_satisfaccion&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rword_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['word'][] = "Rword_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_promedio_satisfaccion/grid_promedio_satisfaccion_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xml'][] = "Rxml_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_promedio_satisfaccion/grid_promedio_satisfaccion_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid,resume,chart&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rcsv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['csv'][] = "Rcsv_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_promedio_satisfaccion/grid_promedio_satisfaccion_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid,resume,chart&nm_all_modules=grid,resume,chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_promedio_satisfaccion']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_promedio_satisfaccion']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_promedio_satisfaccion_config_pivot.php?nome_apl=grid_promedio_satisfaccion&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_promedio_satisfaccion_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_promedio_satisfaccion/grid_promedio_satisfaccion_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($avg_cantidad, $avg_promedio_califica, $quebra_promedio_califica, $quebra_idproducto, $quebra_promedio_califica_orig, $quebra_idproducto_orig)
   {
      //----- Promedio Califica
      if (!isset($this->array_total_promedio_califica[$quebra_promedio_califica_orig]))
      {
         $this->array_total_promedio_califica[$quebra_promedio_califica_orig][0] = 1;
         $this->array_total_promedio_califica[$quebra_promedio_califica_orig][1] = $avg_cantidad;
         $this->array_total_promedio_califica[$quebra_promedio_califica_orig][2] = $avg_promedio_califica;
         $this->array_total_promedio_califica[$quebra_promedio_califica_orig][3] = $quebra_promedio_califica;
         $this->array_total_promedio_califica[$quebra_promedio_califica_orig][4] = $quebra_promedio_califica_orig;
      }
      else
      {
         $this->array_total_promedio_califica[$quebra_promedio_califica_orig][0]++;
         $this->array_total_promedio_califica[$quebra_promedio_califica_orig][1] = bcadd($this->array_total_promedio_califica[$quebra_promedio_califica_orig][1], $avg_cantidad, 10);
         $this->array_total_promedio_califica[$quebra_promedio_califica_orig][2] = bcadd($this->array_total_promedio_califica[$quebra_promedio_califica_orig][2], $avg_promedio_califica, 10);
      }
      //----- Idproducto
      if (!isset($this->array_total_idproducto[$quebra_promedio_califica_orig][$quebra_idproducto_orig]))
      {
         $this->array_total_idproducto[$quebra_promedio_califica_orig][$quebra_idproducto_orig][0] = 1;
         $this->array_total_idproducto[$quebra_promedio_califica_orig][$quebra_idproducto_orig][1] = $avg_cantidad;
         $this->array_total_idproducto[$quebra_promedio_califica_orig][$quebra_idproducto_orig][2] = $avg_promedio_califica;
         $this->array_total_idproducto[$quebra_promedio_califica_orig][$quebra_idproducto_orig][3] = $quebra_idproducto;
         $this->array_total_idproducto[$quebra_promedio_califica_orig][$quebra_idproducto_orig][4] = $quebra_idproducto_orig;
      }
      else
      {
         $this->array_total_idproducto[$quebra_promedio_califica_orig][$quebra_idproducto_orig][0]++;
         $this->array_total_idproducto[$quebra_promedio_califica_orig][$quebra_idproducto_orig][1] = bcadd($this->array_total_idproducto[$quebra_promedio_califica_orig][$quebra_idproducto_orig][1], $avg_cantidad, 10);
         $this->array_total_idproducto[$quebra_promedio_califica_orig][$quebra_idproducto_orig][2] = bcadd($this->array_total_idproducto[$quebra_promedio_califica_orig][$quebra_idproducto_orig][2], $avg_promedio_califica, 10);
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'promedio_califica');
     $campos_order = $this->Ini->Get_date_order_groupby("promedio_califica", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->idproducto = $rs_res->fields[1] ;  
            $this->cantidad = $rs_res->fields[2] ;  
            $this->promedio_califica = $rs_res->fields[3] ;  
            $this->califica = $rs_res->fields[4] ;  
            ...
            $this->promedio_califica_orig = $this->promedio_califica;
            $this->idproducto_orig = $this->idproducto;
            $this->idproducto = $this->look_idproducto ;
            $this->promedio_califica = $this->look_promedio_califica ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->promedio_califica, $this->promedio_califica, $this->idproducto, $this->promedio_califica_orig,  $this->idproducto_orig);
            }
   }
//
