...
<?php
   ...
   $Ord_Cmp = new grid_promedio_satisfaccion_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_promedio_satisfaccion_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['idproducto'] = "on";
   $tab_def_campos['idproducto'] = "idproducto";
   $tab_labels["idproducto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['labels']["idproducto"])) ? $_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['labels']["idproducto"] : "Idproducto";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['labels']["cantidad"] : "Cantidad";
   $tab_ger_campos['promedio_califica'] = "on";
   $tab_def_campos['promedio_califica'] = "promedio_califica";
   $tab_labels["promedio_califica"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['labels']["promedio_califica"])) ? $_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['labels']["promedio_califica"] : "Promedio Califica";
   $tab_ger_campos['califica'] = "on";
   $tab_def_campos['califica'] = "califica";
   $tab_labels["califica"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['labels']["califica"])) ? $_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['labels']["califica"] : "Califica";
   $tab_ger_campos['califica'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_promedio_satisfaccion_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_promedio_satisfaccion']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
