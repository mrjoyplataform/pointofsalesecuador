...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_promedio_satisfaccion"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_promedio_satisfaccion"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_promedio_satisfaccion']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_promedio_satisfaccion']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_promedio_satisfaccion']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_promedio_satisfaccion']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_promedio_satisfaccion']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_promedio_satisfaccion</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_promedio_satisfaccion']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_promedio_satisfaccion']['embutida_filho'] as $ind => $sc_init)
          {
