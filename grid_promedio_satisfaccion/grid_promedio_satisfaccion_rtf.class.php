...
class grid_promedio_satisfaccion_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_promedio_satisfaccion.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['rtf_name']);
      }
   ...
   function NM_export_promedio_califica()
   {
         ...
         $this->look_promedio_califica = str_replace('<', '&lt;', $this->look_promedio_califica);
         $this->look_promedio_califica = str_replace('>', '&gt;', $this->look_promedio_califica);
         $this->Texto_tag .= "<td>" . $this->look_promedio_califica . "</td>\r\n";
   }
   //----- califica
   function NM_export_califica()
   {
         $this->califica = NM_charset_to_utf8($this->califica);
         $this->califica = str_replace('<', '&lt;', $this->califica);
         $this->califica = str_replace('>', '&gt;', $this->califica);
         $this->Texto_tag .= "<td>" . $this->califica . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
