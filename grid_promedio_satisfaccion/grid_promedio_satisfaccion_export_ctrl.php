<?php
@session_start() ;
$_SESSION['scriptcase']['grid_promedio_satisfaccion']['sc_process_barr'] = true;
require_once('../grid_promedio_satisfaccion/index.php');
unset($_SESSION['scriptcase']['grid_promedio_satisfaccion']['sc_process_barr']);
$ExportCtrl = new grid_promedio_satisfaccion_export_control;
$ExportCtrl->Export_barr();

class grid_promedio_satisfaccion_export_control
{
