...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->NM_tit_val[1]     = strip_tags("Cantidad (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")");
      $this->NM_ind_val[1]     = 1;
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['contr_label_graf'][$cmp_gb]) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['contr_label_graf'][$cmp_gb]))
          {
             $this->label[$x] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['contr_label_graf'][$cmp_gb];
          }
          $x++;
      }
   }
