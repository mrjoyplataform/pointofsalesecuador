...
class grid_promedio_satisfaccion_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_promedio_satisfaccion']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_promedio_satisfaccion']['campos_busca']))
      { 
   ...
   function quebra_geral_sc_free_group_by($res_limit=false)
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), avg(cantidad), avg(promedio_califica) from (SELECT *,(select imagen from boletos_califica where valor=promedio_califica) as califica FROM view_boletos_califca) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['where_pesq']; 
      } 
      else 
      { 
          $nm_comando = "select count(*), avg(cantidad), avg(promedio_califica) from (SELECT *,(select imagen from boletos_califica where valor=promedio_califica) as califica FROM view_boletos_califca) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['tot_geral'][2] = $rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $rt->fields[2] = (string)$rt->fields[2]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['tot_geral'][3] = $rt->fields[2]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['contr_total_geral'] = "OK";
   } 
   ...
   function quebra_geral__NM_SC_($res_limit=false)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*) from (SELECT *,(select imagen from boletos_califica where valor=promedio_califica) as califica FROM view_boletos_califca) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['where_pesq']; 
      } 
      else 
      { 
          $nm_comando = "select count(*) from (SELECT *,(select imagen from boletos_califica where valor=promedio_califica) as califica FROM view_boletos_califca) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['where_pesq']; 
   ...
   //-----  promedio_califica
   function quebra_promedio_califica_califica($promedio_califica, $arg_sum_promedio_califica) 
   {
      global $tot_promedio_califica, $idproducto, $promedio_califica;
      $tot_promedio_califica = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), avg(cantidad), avg(promedio_califica) from (SELECT *,(select imagen from boletos_califica where valor=promedio_califica) as califica FROM view_boletos_califca) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['where_pesq']; 
      } 
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['where_pesq'])) 
      { 
         $nm_comando .= " where promedio_califica" . $arg_sum_promedio_califica ; 
      } 
      else 
      { 
         $nm_comando .= " and promedio_califica" . $arg_sum_promedio_califica ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
      ...
      $tot_promedio_califica[0] = NM_encode_input(sc_strip_script($promedio_califica)) ; 
      $tot_promedio_califica[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_promedio_califica[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_promedio_califica[3] = (string)$rt->fields[2]; 
      $rt->Close(); 
   } 

   //-----  idproducto
   function quebra_idproducto_califica($promedio_califica, $idproducto, $arg_sum_promedio_califica, $arg_sum_idproducto) 
   {
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['where_pesq'])) 
      { 
         $nm_comando .= " where promedio_califica" . $arg_sum_promedio_califica . " and idproducto" . $arg_sum_idproducto ; 
      } 
      else 
      { 
         $nm_comando .= " and promedio_califica" . $arg_sum_promedio_califica . " and idproducto" . $arg_sum_idproducto ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
   ...
   function Calc_resumo_sc_free_group_by($destino_resumo)
   {
      ...
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('fecha' => "fecha",'idproducto' => "idproducto");
      $cmps_quebra_atual = array();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['SC_Gb_Free_cmp'] as $cmp => $resto)
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_sc_free_group_by($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
   ...
   function Calc_resumo_califica($destino_resumo)
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['where_pesq'];
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_promedio_satisfaccion']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('promedio_califica' => "promedio_califica",'idproducto' => "idproducto");
      $cmps_quebra_atual = array("promedio_califica","idproducto");
      $ult_cmp_quebra_atual = $cmps_quebra_atual[(count($cmps_quebra_atual) - 1)];
      $arr_tots = "";
      $join     = "";
      $group    = "";
   ...
   function Res_Totaliza_califica($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $format_dimensions = array();
      $format_dimensions['promedio_califica']['reg'] = "S";
      $format_dimensions['promedio_califica']['msk'] = "";
      $format_dimensions['idproducto']['reg'] = "S";
      $format_dimensions['idproducto']['msk'] = "";
      while (!$rt->EOF)
      {
          ...
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              ...
              $$Cada_dim = $SC_prep['fmt'];
              $$SC_orig = $SC_prep['orig'];
              if ($Cada_dim == "promedio_califica") {
                  $this->Lookup->lookup_califica_promedio_califica($$Cada_dim,  $promedio_califica);
              }
              if ($Cada_dim == "idproducto") {
