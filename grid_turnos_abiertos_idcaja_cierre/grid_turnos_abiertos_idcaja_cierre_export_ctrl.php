<?php
@session_start() ;
$_SESSION['scriptcase']['grid_turnos_abiertos_idcaja_cierre']['sc_process_barr'] = true;
require_once('../grid_turnos_abiertos_idcaja_cierre/index.php');
unset($_SESSION['scriptcase']['grid_turnos_abiertos_idcaja_cierre']['sc_process_barr']);
$ExportCtrl = new grid_turnos_abiertos_idcaja_cierre_export_control;
$ExportCtrl->Export_barr();

class grid_turnos_abiertos_idcaja_cierre_export_control
{
