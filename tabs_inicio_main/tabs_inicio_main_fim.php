...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____tabs_inicio_main"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____tabs_inicio_main"]);
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']['tabs_inicio_main']))
   {
       unset($_SESSION['scriptcase']['sc_aba_iframe']['tabs_inicio_main']);
   }
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['tabs_inicio_main']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['tabs_inicio_main']['sc_outra_jan'])
   {
       $fecha_janela = true;
   }
   $fecha_modal = false;
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['tabs_inicio_main']['aba_saida']) && $_SESSION['sc_session'][$script_case_init]['tabs_inicio_main']['aba_saida'] == "modal")
   {
       unset($_SESSION['sc_session'][$script_case_init]['tabs_inicio_main']['aba_saida']);
       $fecha_modal = true;
   }
