...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = " #lowerI#";
      $nm_fim_lower = "#lowerF#";
      $Nm_datas[] = "fechaEmision";$Nm_datas[] = "fechaEmision";$Nm_numeric[] = "totalsinimpuestos";$Nm_numeric[] = "totaldescuento";$Nm_numeric[] = "totalconimpuestos";$Nm_numeric[] = "propina";$Nm_numeric[] = "importetotal";$Nm_numeric[] = "estado";$Nm_numeric[] = "idfile";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nombrecomercial_cond" name="nombrecomercial_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombrecomercial'), this, 'nombrecomercial')">
      ...
      <br><span id="id_hide_nombrecomercial"  <?php echo $str_hide_nombrecomercial?>><?php
      if ($nombrecomercial != "")
      {
      $nombrecomercial_look = substr($this->Db->qstr($nombrecomercial), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_ambiente_cond" name="ambiente_cond" onChange="nm_campos_between(document.getElementById('id_vis_ambiente'), this, 'ambiente')">
      ...
      <br><span id="id_hide_ambiente"  <?php echo $str_hide_ambiente?>><?php
      if ($ambiente != "")
      {
      $ambiente_look = substr($this->Db->qstr($ambiente), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_tipoemision_cond" name="tipoemision_cond" onChange="nm_campos_between(document.getElementById('id_vis_tipoemision'), this, 'tipoemision')">
      ...
      <br><span id="id_hide_tipoemision"  <?php echo $str_hide_tipoemision?>><?php
      if ($tipoemision != "")
      {
      $tipoemision_look = substr($this->Db->qstr($tipoemision), 1, -1); 
      $nmgp_def_dados = array(); 
