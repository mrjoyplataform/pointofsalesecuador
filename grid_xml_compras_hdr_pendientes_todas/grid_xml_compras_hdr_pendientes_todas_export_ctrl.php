<?php
@session_start() ;
$_SESSION['scriptcase']['grid_xml_compras_hdr_pendientes_todas']['sc_process_barr'] = true;
require_once('../grid_xml_compras_hdr_pendientes_todas/index.php');
unset($_SESSION['scriptcase']['grid_xml_compras_hdr_pendientes_todas']['sc_process_barr']);
$ExportCtrl = new grid_xml_compras_hdr_pendientes_todas_export_control;
$ExportCtrl->Export_barr();

class grid_xml_compras_hdr_pendientes_todas_export_control
{
