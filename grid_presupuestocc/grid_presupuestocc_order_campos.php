...
<?php
   ...
   $Ord_Cmp = new grid_presupuestocc_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_presupuestocc_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['ctacontprecc'] = "ctacontprecc";
   $tab_labels["ctacontprecc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['labels']["ctacontprecc"])) ? $_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['labels']["ctacontprecc"] : "Ctacontprecc";
   $tab_ger_campos['anoprecc'] = "on";
   $tab_def_campos['anoprecc'] = "anoprecc";
   $tab_labels["anoprecc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['labels']["anoprecc"])) ? $_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['labels']["anoprecc"] : "Anoprecc";
   $tab_ger_campos['mescc'] = "on";
   $tab_def_campos['mescc'] = "mescc";
   $tab_labels["mescc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['labels']["mescc"])) ? $_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['labels']["mescc"] : "Mescc";
   $tab_ger_campos['valorcc'] = "on";
   $tab_def_campos['valorcc'] = "valorcc";
   $tab_labels["valorcc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['labels']["valorcc"])) ? $_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['labels']["valorcc"] : "Valorcc";
   $tab_ger_campos['cc01'] = "on";
   $tab_def_campos['cc01'] = "cc01";
   $tab_labels["cc01"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['labels']["cc01"])) ? $_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['labels']["cc01"] : "Cc 01";
   $tab_ger_campos['cc02'] = "on";
   $tab_def_campos['cc02'] = "cc02";
   $tab_labels["cc02"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['labels']["cc02"])) ? $_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['labels']["cc02"] : "Cc 02";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_presupuestocc_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_presupuestocc']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
