...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_presupuestocc"]))
   {
      unset($_SESSION['session_sec_aplicacao']["pointofsales_____grid_presupuestocc"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_presupuestocc'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_presupuestocc']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_presupuestocc']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_presupuestocc']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_presupuestocc']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_presupuestocc']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_presupuestocc</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_presupuestocc']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_presupuestocc']['embutida_filho'] as $ind => $sc_init)
          {
