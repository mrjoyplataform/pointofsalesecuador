<?php
@session_start() ;
$_SESSION['scriptcase']['grid_presupuestocc']['sc_process_barr'] = true;
require_once('../grid_presupuestocc/index.php');
unset($_SESSION['scriptcase']['grid_presupuestocc']['sc_process_barr']);
$ExportCtrl = new grid_presupuestocc_export_control;
$ExportCtrl->Export_barr();

class grid_presupuestocc_export_control
{
