...
class grid_presupuestocc_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_presupuestocc_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_presupuestocc_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_presupuestocc_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_ctacontprecc')
      {
          $ctacontprecc = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_ctacontprecc($ctacontprecc);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_anoprecc')
      {
          $anoprecc = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_anoprecc($anoprecc);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> presupuestocc</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_presupuestocc/grid_presupuestocc_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_presupuestocc_ajax_search.js"></script>
 <script type="text/javascript" src="grid_presupuestocc_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_presupuestocc_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_presupuestocc']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_presupuestocc']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_valorcc_cond#NMF#' + search_get_sel_txt('SC_valorcc_cond') + '@NMF@';
  str_out += 'SC_valorcc#NMF#' + search_get_text('SC_valorcc') + '@NMF@';
  str_out += 'SC_ctacontprecc_cond#NMF#' + search_get_sel_txt('SC_ctacontprecc_cond') + '@NMF@';
  str_out += 'SC_ctacontprecc#NMF#' + search_get_text('SC_ctacontprecc') + '@NMF@';
  str_out += 'id_ac_ctacontprecc#NMF#' + search_get_text('id_ac_ctacontprecc') + '@NMF@';
  str_out += 'SC_anoprecc_cond#NMF#' + search_get_sel_txt('SC_anoprecc_cond') + '@NMF@';
  str_out += 'SC_anoprecc#NMF#' + search_get_text('SC_anoprecc') + '@NMF@';
  str_out += 'id_ac_anoprecc#NMF#' + search_get_text('id_ac_anoprecc') + '@NMF@';
  str_out += 'SC_mescc_cond#NMF#' + search_get_sel_txt('SC_mescc_cond') + '@NMF@';
  str_out += 'SC_mescc#NMF#' + search_get_text('SC_mescc') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_ctacontprecc").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_ctacontprecc").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_ctacontprecc",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_ctacontprecc").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_ctacontprecc").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_anoprecc").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_anoprecc").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_anoprecc",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> presupuestocc</div>
...
<?php
   ...
   {
      global 
             $valorcc_cond, $valorcc,
             $ctacontprecc_cond, $ctacontprecc, $ctacontprecc_autocomp,
             $anoprecc_cond, $anoprecc, $anoprecc_autocomp,
             $mescc_cond, $mescc,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $valorcc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']['valorcc']; 
          $valorcc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']['valorcc_cond']; 
          $ctacontprecc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']['ctacontprecc']; 
          $ctacontprecc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']['ctacontprecc_cond']; 
          $anoprecc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']['anoprecc']; 
          $anoprecc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']['anoprecc_cond']; 
          $mescc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']['mescc']; 
          $mescc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']['mescc_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']['NM_operador']; 
          if (strtoupper($valorcc_cond) != "II" && strtoupper($valorcc_cond) != "QP" && strtoupper($valorcc_cond) != "NP" && strtoupper($valorcc_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($valorcc, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "2", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($mescc_cond) != "II" && strtoupper($mescc_cond) != "QP" && strtoupper($mescc_cond) != "NP" && strtoupper($mescc_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($mescc, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($valorcc_cond) || empty($valorcc_cond))
      {
         $valorcc_cond = "gt";
      }
      if (!isset($ctacontprecc_cond) || empty($ctacontprecc_cond))
      {
         $ctacontprecc_cond = "qp";
      }
      if (!isset($anoprecc_cond) || empty($anoprecc_cond))
      {
         $anoprecc_cond = "qp";
      }
      if (!isset($mescc_cond) || empty($mescc_cond))
      {
         $mescc_cond = "gt";
      }
      ...
      $str_hide_valorcc = (in_array($valorcc_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_ctacontprecc = (in_array($ctacontprecc_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_anoprecc = (in_array($anoprecc_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_mescc = (in_array($mescc_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($valorcc) || $valorcc == "")
      {
          $valorcc = "";
      }
      if (isset($valorcc) && !empty($valorcc))
      {
         $tmp_pos = strpos($valorcc, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $valorcc = substr($valorcc, 0, $tmp_pos);
         }
      }
      if (!isset($ctacontprecc) || $ctacontprecc == "")
      {
          $ctacontprecc = "";
      }
      if (isset($ctacontprecc) && !empty($ctacontprecc))
      {
         $tmp_pos = strpos($ctacontprecc, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $ctacontprecc = substr($ctacontprecc, 0, $tmp_pos);
         }
      }
      if (!isset($anoprecc) || $anoprecc == "")
      {
          $anoprecc = "";
      }
      if (isset($anoprecc) && !empty($anoprecc))
      {
         $tmp_pos = strpos($anoprecc, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $anoprecc = substr($anoprecc, 0, $tmp_pos);
         }
      }
      if (!isset($mescc) || $mescc == "")
      {
          $mescc = "";
      }
      if (isset($mescc) && !empty($mescc))
      {
         $tmp_pos = strpos($mescc, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $mescc = substr($mescc, 0, $tmp_pos);
         }
      }
?>
 <?php
...
?>
<?php
   if (is_file("grid_presupuestocc_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_presupuestocc']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_presupuestocc']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_valorcc_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['valorcc'])) ? $this->New_label['valorcc'] : "Valorcc"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_valorcc_cond" name="valorcc_cond" onChange="nm_campos_between(document.getElementById('id_vis_valorcc'), this, 'valorcc')">
       <OPTION value="gt" <?php if ("gt" == $valorcc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $valorcc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $valorcc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_valorcc" <?php echo $str_hide_valorcc?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['valorcc'])) ? $this->New_label['valorcc'] : "Valorcc";
 $nmgp_tab_label .= "valorcc?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_valorcc" name="valorcc" value="<?php echo NM_encode_input($valorcc) ?>" size=18 alt="{datatype: 'decimal', maxLength: 18, precision: 2, decimalSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['dec_num'] ?>', thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_ctacontprecc_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['ctacontprecc'])) ? $this->New_label['ctacontprecc'] : "Ctacontprecc"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_ctacontprecc_cond" name="ctacontprecc_cond" onChange="nm_campos_between(document.getElementById('id_vis_ctacontprecc'), this, 'ctacontprecc')">
       <OPTION value="qp" <?php if ("qp" == $ctacontprecc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $ctacontprecc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $ctacontprecc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $ctacontprecc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ctacontprecc" <?php echo $str_hide_ctacontprecc?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['ctacontprecc'])) ? $this->New_label['ctacontprecc'] : "Ctacontprecc";
 $nmgp_tab_label .= "ctacontprecc?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $ctacontprecc;
      }
?>
<INPUT  type="text" id="SC_ctacontprecc" name="ctacontprecc" value="<?php echo NM_encode_input($ctacontprecc) ?>"  size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_ctacontprecc" name="ctacontprecc_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_anoprecc_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['anoprecc'])) ? $this->New_label['anoprecc'] : "Anoprecc"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_anoprecc_cond" name="anoprecc_cond" onChange="nm_campos_between(document.getElementById('id_vis_anoprecc'), this, 'anoprecc')">
       <OPTION value="qp" <?php if ("qp" == $anoprecc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $anoprecc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $anoprecc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $anoprecc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_anoprecc" <?php echo $str_hide_anoprecc?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['anoprecc'])) ? $this->New_label['anoprecc'] : "Anoprecc";
 $nmgp_tab_label .= "anoprecc?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $anoprecc;
      }
?>
<INPUT  type="text" id="SC_anoprecc" name="anoprecc" value="<?php echo NM_encode_input($anoprecc) ?>"  size=4 alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_anoprecc" name="anoprecc_autocomp" size="4"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 4, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_mescc_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['mescc'])) ? $this->New_label['mescc'] : "Mescc"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_mescc_cond" name="mescc_cond" onChange="nm_campos_between(document.getElementById('id_vis_mescc'), this, 'mescc')">
       <OPTION value="gt" <?php if ("gt" == $mescc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $mescc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $mescc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_mescc" <?php echo $str_hide_mescc?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['mescc'])) ? $this->New_label['mescc'] : "Mescc";
 $nmgp_tab_label .= "mescc?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_mescc" name="mescc" value="<?php echo NM_encode_input($mescc) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.valorcc_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_valorcc'), document.F1.valorcc_cond, 'valorcc');
   document.F1.valorcc.value = "";
   document.F1.ctacontprecc_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_ctacontprecc'), document.F1.ctacontprecc_cond, 'ctacontprecc');
   document.F1.ctacontprecc.value = "";
   document.F1.ctacontprecc_autocomp.value = "";
   document.F1.anoprecc_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_anoprecc'), document.F1.anoprecc_cond, 'anoprecc');
   document.F1.anoprecc.value = "";
   document.F1.anoprecc_autocomp.value = "";
   document.F1.mescc_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_mescc'), document.F1.mescc_cond, 'mescc');
   document.F1.mescc.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_valorcc_cond'] = 'cond';
      $tp_fields['SC_valorcc'] = 'text';
      $tp_fields['SC_ctacontprecc_cond'] = 'cond';
      $tp_fields['SC_ctacontprecc'] = 'text_aut';
      $tp_fields['id_ac_ctacontprecc'] = 'text_aut';
      $tp_fields['SC_anoprecc_cond'] = 'cond';
      $tp_fields['SC_anoprecc'] = 'text_aut';
      $tp_fields['id_ac_anoprecc'] = 'text_aut';
      $tp_fields['SC_mescc_cond'] = 'cond';
      $tp_fields['SC_mescc'] = 'text';
   ...
   {
      global $valorcc_cond, $valorcc,
             $ctacontprecc_cond, $ctacontprecc, $ctacontprecc_autocomp,
             $anoprecc_cond, $anoprecc, $anoprecc_autocomp,
             $mescc_cond, $mescc, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($ctacontprecc_autocomp) && empty($ctacontprecc))
      {
          $ctacontprecc = $ctacontprecc_autocomp;
      }
      if (!empty($anoprecc_autocomp) && empty($anoprecc))
      {
          $anoprecc = $anoprecc_autocomp;
      }
      $valorcc_cond_salva = $valorcc_cond; 
      if (!isset($valorcc_input_2) || $valorcc_input_2 == "")
      {
          $valorcc_input_2 = $valorcc;
      }
      $ctacontprecc_cond_salva = $ctacontprecc_cond; 
      if (!isset($ctacontprecc_input_2) || $ctacontprecc_input_2 == "")
      {
          $ctacontprecc_input_2 = $ctacontprecc;
      }
      $anoprecc_cond_salva = $anoprecc_cond; 
      if (!isset($anoprecc_input_2) || $anoprecc_input_2 == "")
      {
          $anoprecc_input_2 = $anoprecc;
      }
      $mescc_cond_salva = $mescc_cond; 
      if (!isset($mescc_input_2) || $mescc_input_2 == "")
      {
          $mescc_input_2 = $mescc;
      }
      if ($valorcc_cond != "in")
      {
          if ($C_formatado)
          {
              nm_limpa_valor($valorcc, $_SESSION['scriptcase']['reg_conf']['dec_num'], $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
      }
      if ($mescc_cond != "in")
      {
          nm_limpa_numero($mescc, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']['valorcc'] = $valorcc; 
      if (is_array($valorcc) && !empty($valorcc))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['Grid_search'][$I_Grid]['val'][0] = $valorcc;
      }
      elseif ($valorcc_cond_salva == "nu" || $valorcc_cond_salva == "nn" || $valorcc_cond_salva == "ep" || $valorcc_cond_salva == "ne" || !empty($valorcc))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['Grid_search'][$I_Grid]['val'][0][0] = $valorcc;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']['valorcc_cond'] = $valorcc_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['Grid_search'][$I_Grid]['cmp'] = "valorcc"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['Grid_search'][$I_Grid]['opc'] = $valorcc_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq']['valorcc'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']['ctacontprecc'] = $ctacontprecc; 
      if (is_array($ctacontprecc) && !empty($ctacontprecc))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['Grid_search'][$I_Grid]['val'][0] = $ctacontprecc;
      }
      elseif ($ctacontprecc_cond_salva == "nu" || $ctacontprecc_cond_salva == "nn" || $ctacontprecc_cond_salva == "ep" || $ctacontprecc_cond_salva == "ne" || !empty($ctacontprecc))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['Grid_search'][$I_Grid]['val'][0][0] = $ctacontprecc;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']['ctacontprecc_cond'] = $ctacontprecc_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['Grid_search'][$I_Grid]['cmp'] = "ctacontprecc"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['Grid_search'][$I_Grid]['opc'] = $ctacontprecc_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq']['ctacontprecc'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']['anoprecc'] = $anoprecc; 
      if (is_array($anoprecc) && !empty($anoprecc))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['Grid_search'][$I_Grid]['val'][0] = $anoprecc;
      }
      elseif ($anoprecc_cond_salva == "nu" || $anoprecc_cond_salva == "nn" || $anoprecc_cond_salva == "ep" || $anoprecc_cond_salva == "ne" || !empty($anoprecc))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['Grid_search'][$I_Grid]['val'][0][0] = $anoprecc;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']['anoprecc_cond'] = $anoprecc_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['Grid_search'][$I_Grid]['cmp'] = "anoprecc"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['Grid_search'][$I_Grid]['opc'] = $anoprecc_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq']['anoprecc'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']['mescc'] = $mescc; 
      if (is_array($mescc) && !empty($mescc))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['Grid_search'][$I_Grid]['val'][0] = $mescc;
      }
      elseif ($mescc_cond_salva == "nu" || $mescc_cond_salva == "nn" || $mescc_cond_salva == "ep" || $mescc_cond_salva == "ne" || !empty($mescc))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['Grid_search'][$I_Grid]['val'][0][0] = $mescc;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']['mescc_cond'] = $mescc_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['Grid_search'][$I_Grid]['cmp'] = "mescc"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['Grid_search'][$I_Grid]['opc'] = $mescc_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['grid_pesq']['mescc'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca'] = $Temp_Busca;
      }
      if ($valorcc_cond != "in" && $valorcc_cond != "bw" && !empty($valorcc) && !is_numeric($valorcc))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Valorcc";
      }
      if ($valorcc_cond == "bw" && ((!empty($valorcc) && !is_numeric($valorcc)) || (!empty($valorcc_input_2) && !is_numeric($valorcc_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Valorcc";
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      $this->cmp_formatado['valorcc'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($ctacontprecc != '') {
      $ctacontprecc_look = substr($this->Db->qstr($ctacontprecc), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['ctacontprecc'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['ctacontprecc'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['ctacontprecc'] = $ctacontprecc;
      }
      $nmgp_def_dados = array();
    if ($anoprecc != '') {
      $anoprecc_look = substr($this->Db->qstr($anoprecc), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['anoprecc'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['anoprecc'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['anoprecc'] = $anoprecc;
      }
      $Conteudo = $mescc;
      if (strtoupper($mescc_cond) != "II" && strtoupper($mescc_cond) != "QP" && strtoupper($mescc_cond) != "NP" && strtoupper($mescc_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['mescc'] = $Conteudo;

      //----- $valorcc
      $this->Date_part = false;
      if (isset($valorcc) || $valorcc_cond == "nu" || $valorcc_cond == "nn" || $valorcc_cond == "ep" || $valorcc_cond == "ne")
      {
         $this->monta_condicao("valorcc", $valorcc_cond, $valorcc, "", "valorcc");
      }

      //----- $ctacontprecc
      $this->Date_part = false;
      if (isset($ctacontprecc) || $ctacontprecc_cond == "nu" || $ctacontprecc_cond == "nn" || $ctacontprecc_cond == "ep" || $ctacontprecc_cond == "ne")
      {
         $this->monta_condicao("ctacontprecc", $ctacontprecc_cond, $ctacontprecc, "", "ctacontprecc");
      }

      //----- $anoprecc
      $this->Date_part = false;
      if (isset($anoprecc) || $anoprecc_cond == "nu" || $anoprecc_cond == "nn" || $anoprecc_cond == "ep" || $anoprecc_cond == "ne")
      {
         $this->monta_condicao("anoprecc", $anoprecc_cond, $anoprecc, "", "anoprecc");
      }

      //----- $mescc
      $this->Date_part = false;
      if (isset($mescc) || $mescc_cond == "nu" || $mescc_cond == "nn" || $mescc_cond == "ep" || $mescc_cond == "ne")
      {
         $this->monta_condicao("mescc", $mescc_cond, $mescc, "", "mescc");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_presupuestocc']['cond_pesq'] .= $this->NM_operador;
