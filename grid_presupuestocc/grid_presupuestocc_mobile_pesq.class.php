...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "mescc";$Nm_numeric[] = "valorcc";$Nm_numeric[] = "cantidad";$Nm_numeric[] = "precio_sin_iva";$Nm_numeric[] = "cantidad_consumida";$Nm_numeric[] = "valor_consumido";$Nm_numeric[] = "cantidad_modificada";$Nm_numeric[] = "precio_modificado";$Nm_numeric[] = "precio_sin_iva_modificado";$Nm_numeric[] = "mescc";$Nm_numeric[] = "valorcc";$Nm_numeric[] = "cantidad";$Nm_numeric[] = "precio_sin_iva";$Nm_numeric[] = "cantidad_consumida";$Nm_numeric[] = "valor_consumido";$Nm_numeric[] = "cantidad_modificada";$Nm_numeric[] = "precio_modificado";$Nm_numeric[] = "precio_sin_iva_modificado";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_valorcc_cond" name="valorcc_cond" onChange="nm_campos_between(document.getElementById('id_vis_valorcc'), this, 'valorcc')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_ctacontprecc_cond" name="ctacontprecc_cond" onChange="nm_campos_between(document.getElementById('id_vis_ctacontprecc'), this, 'ctacontprecc')">
      ...
      <br><span id="id_hide_ctacontprecc"  <?php echo $str_hide_ctacontprecc?>><?php
      if ($ctacontprecc != "")
      {
      $ctacontprecc_look = substr($this->Db->qstr($ctacontprecc), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_anoprecc_cond" name="anoprecc_cond" onChange="nm_campos_between(document.getElementById('id_vis_anoprecc'), this, 'anoprecc')">
      ...
      <br><span id="id_hide_anoprecc"  <?php echo $str_hide_anoprecc?>><?php
      if ($anoprecc != "")
      {
      $anoprecc_look = substr($this->Db->qstr($anoprecc), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_mescc_cond" name="mescc_cond" onChange="nm_campos_between(document.getElementById('id_vis_mescc'), this, 'mescc')">
      ...
      <br><span id="id_hide_mescc"  <?php echo $str_hide_mescc?>><INPUT  type="text" id="SC_mescc" name="mescc" value="<?php echo NM_encode_input($mescc) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
